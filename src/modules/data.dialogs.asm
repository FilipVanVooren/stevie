...
txt.hint.basic2    stri 'Press SPACE to unpack BASIC program to editor. Session: Current=',>02,>03,' Visited=',>1d,>1e
txt.hint.basic     stri 'Pick session 1-5. Press F9 in TI Basic to return here.'
