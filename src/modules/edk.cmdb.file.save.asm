...
!       sla   tmp0,8               ; LSB to MSB 
        ...
        jmp   edk.act.cmdb.save.file
        ;-------------------------------------------------------
        ; Save all lines in editor buffer
        ;-------------------------------------------------------
edk.act.cmdb.save.all:
