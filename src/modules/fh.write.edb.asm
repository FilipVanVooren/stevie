...
fh.file.write.edb:
        ...
        ;------------------------------------------------------
        li    tmp0,fh.fopmode.savefile
                                    ; We are going to save a file
...
fh.file.write.edb.check_fioerr:     
        ...
        jne   fh.file.write.edb.check_setpage 
                                    ; No, goto (1d)
        b     @fh.file.write.edb.error  
        ...
        ;------------------------------------------------------ 
fh.file.write.edb.check_setpage:        
        ...
        jlt   fh.file.write.edb.process_line
        ...
        ; Step 2: Process line
        ;------------------------------------------------------
fh.file.write.edb.process_line:
        ...
        jeq   fh.file.write.edb.prepindex.emptyline
                                    ; Handle empty line
        ;------------------------------------------------------
