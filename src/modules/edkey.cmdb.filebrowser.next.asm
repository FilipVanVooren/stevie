...
edkey.action.filebrowser.next:
        ...
        jmp   edkey.action.filebrowser.next.checkdialog
        ;-------------------------------------------------------
        ; Next page
        ;-------------------------------------------------------
