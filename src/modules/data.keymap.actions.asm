...
keymap_actions.cmdb:
        ...
        data  edk.act.cmdb.close.dialog
        ;-------------------------------------------------------
        ; Dialog: File
        ;-------------------------------------------------------
        byte  key.uc.n, id.dialog.file
        data  edk.act.cmdb.file.new
        ...
        data  edk.act.cmdb.load

        byte  key.fctn.e, id.dialog.open
        data  edk.act.cmdb.pick.prev

        byte  key.fctn.x, id.dialog.open
        data  edk.act.cmdb.pick.next

        byte  key.space, id.dialog.open
        data  edk.act.cmdb.updir
        ...
        data  edk.act.cmdb.clip.1

        byte  key.num.2, id.dialog.clipboard
        data  edk.act.cmdb.clip.2

        byte  key.num.3, id.dialog.clipboard
        data  edk.act.cmdb.clip.3
        ;-------------------------------------------------------
        ...
        data  edk.act.cmdb.save

        byte  key.fctn.6, id.dialog.save
        data  edk.act.cmdb.lineterm.toggle
        ;-------------------------------------------------------
        ...
        data  edk.act.cmdb.goto
        ;-------------------------------------------------------
        ; Dialog: find
        ;-------------------------------------------------------
        byte  key.enter, id.dialog.find
        data  edk.act.cmdb.find.search
        ;-------------------------------------------------------
        ; Dialog: Help
        ;-------------------------------------------------------
        ...
        data  edk.act.cmdb.file.directory.tipi

        byte  key.ctrl.1, pane.focus.cmdb
        data  edk.act.cmdb.file.directory.1

        byte  key.ctrl.2, pane.focus.cmdb
        data  edk.act.cmdb.file.directory.2

        byte  key.ctrl.3, pane.focus.cmdb
        data  edk.act.cmdb.file.directory.3

        byte  key.ctrl.4, pane.focus.cmdb
        data  edk.act.cmdb.file.directory.4

        byte  key.ctrl.5, pane.focus.cmdb
        data  edk.act.cmdb.file.directory.5

        byte  key.ctrl.6, pane.focus.cmdb
        data  edk.act.cmdb.file.directory.6

        byte  key.ctrl.7, pane.focus.cmdb
        data  edk.act.cmdb.file.directory.7

        byte  key.ctrl.8, pane.focus.cmdb
        data  edk.act.cmdb.file.directory.8

        byte  key.ctrl.9, pane.focus.cmdb
        data  edk.act.cmdb.file.directory.9

        byte  key.ctrl.a, pane.focus.cmdb
        data  edk.act.cmdb.file.directory.scs1        

        byte  key.ctrl.b, pane.focus.cmdb
        data  edk.act.cmdb.file.directory.scs2

        byte  key.ctrl.c, pane.focus.cmdb
        data  edk.act.cmdb.file.directory.scs3

        byte  key.ctrl.i, pane.focus.cmdb
        data  edk.act.cmdb.file.directory.ide1        

        byte  key.ctrl.f, pane.focus.cmdb
        data  edk.act.cmdb.file.directory.ide2

        byte  key.ctrl.g, pane.focus.cmdb
        data  edk.act.cmdb.file.directory.ide3

        byte  key.ctrl.s, pane.focus.cmdb
        data  edk.act.filebrowser.prevcol

        byte  key.ctrl.d, pane.focus.cmdb
        data  edk.act.filebrowser.nextcol

        byte  key.ctrl.e, pane.focus.cmdb
        data  edk.act.filebrowser.prevpage

        byte  key.ctrl.x, pane.focus.cmdb
        data  edk.act.filebrowser.nextpage
