...
edk.act.del_char.sanity2:        
        ...
        jmp  edk.act.del_char.exit
        ;-------------------------------------------------------
        ; Assert 3 - Abort if row length > 80
        ;-------------------------------------------------------
edk.act.del_char.sanity3:        
        ci    tmp2,colrow
        jle   edk.act.del_char.prep
...
edk.act.del_line:
        ...
        bl    @fb.refresh           ; Refresh frame buffer with EB content
                                    ...
                                    ; /
        b     @edk.act.up      ; Move cursor one line up
        ;-------------------------------------------------------
        ; Delete line in editor buffer
        ;-------------------------------------------------------
edk.act.del_line.doit:
...
edk.act.del_line.refresh:        
        ...
        jlt   edk.act.del_line.exit

        b     @edk.act.up      ; Move cursor one line up        
        ;-------------------------------------------------------
        ; Exit
        ;-------------------------------------------------------
edk.act.del_line.exit:
        b     @edk.act.home           ; Move cursor to home and return
edk.act.del_line.exit2:
        b     @edkey.keyscan.hook.debounce ; Back to editor main