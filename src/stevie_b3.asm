...
main:
        ...
        copy  "dialog.open.asm"         ; Dialog "Open file"
        ...
        copy  "dialog.delete.asm"       ; Dialog "Delete file"
        copy  "dialog.run.asm"          ; Dialog "Run program image (EA5)"
        copy  "dialog.cat.asm"          ; Dialog "Catalog"
