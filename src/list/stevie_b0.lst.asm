...
0008               ***************************************************************
0009               * File: stevie_b0.asm               ; Version 210419-373084
0010               *
0011               * Bank 0 "Jill"
0012               *
0013               ***************************************************************
...
0260 6269 ....             text  'Build-ID  210419-373084'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0041 67E6 06A0  32         bl    @cpym2v
     67E8 2488 
0042 67EA 3F00             data  >3f00,f18chk_gpu,6    ; Copy F18A GPU code to VRAM
     67EC 2792 
     67EE 0006 
...
0091               ********|*****|*********************|**************************
0092 682E C20B  18 f18rst  mov   r11,tmp4              ; Save R11
0093                       ;------------------------------------------------------
0094                       ; Reset all F18a VDP registers to power-on defaults
0095                       ;------------------------------------------------------
0096 6830 06A0  32         bl    @putvr
     6832 2334 
0097 6834 3280             data  >3280                 ; F18a VR50 (>32), MSB 8=1
0098               
0099 6836 06A0  32         bl    @putvr                ; VR1/57, value 00011100
     6838 2334 
0100 683A 391C             data  >391c                 ; Lock the F18a
0101 683C 0458  20         b     *tmp4                 ; Exit
0102               
0103               
0104               
0105               ***************************************************************
...
0119               ********|*****|*********************|**************************
0120 683E C20B  18 f18fwv  mov   r11,tmp4              ; Save R11
0121 6840 20A0  38         coc   @wbit1,config         ; CONFIG bit 1 set ?
     6842 201E 
0122 6844 1609  14         jne   f18fw1
0123               ***************************************************************
0124               * Read F18A major/minor version
0125               ***************************************************************
0126 6846 C120  34         mov   @vdps,tmp0            ; Clear VDP status register
     6848 8802 
0127 684A 06A0  32         bl    @putvr                ; Write to VR#15 for setting F18A status
     684C 2334 
0128 684E 0F0E             data  >0f0e                 ; register to read (0e=VR#14)
0129 6850 04C4  14         clr   tmp0
0130 6852 D120  34         movb  @vdps,tmp0
     6854 8802 
0131 6856 0984  56         srl   tmp0,8
0132 6858 0458  20 f18fw1  b     *tmp4                 ; Exit
**** **** ****     > runlib.asm
0143               
...
0016               ********|*****|*********************|**************************
0017 685A C83B  50 hchar   mov   *r11+,@wyx            ; Set YX position
     685C 832A 
0018 685E D17B  28         movb  *r11+,tmp1
0019 6860 0985  56 hcharx  srl   tmp1,8                ; Byte to write
0020 6862 D1BB  28         movb  *r11+,tmp2
0021 6864 0986  56         srl   tmp2,8                ; Repeat count
0022 6866 C1CB  18         mov   r11,tmp3
0023 6868 06A0  32         bl    @yx2pnt               ; Get VDP address into TMP0
     686A 23FC 
0024               *--------------------------------------------------------------
0025               *    Draw line
0026               *--------------------------------------------------------------
0027 686C 020B  20         li    r11,hchar1
     686E 27DE 
0028 6870 0460  28         b     @xfilv                ; Draw
     6872 2296 
0029               *--------------------------------------------------------------
0030               *    Do housekeeping
0031               *--------------------------------------------------------------
0032 6874 8817  46 hchar1  c     *tmp3,@w$ffff         ; End-Of-List marker found ?
     6876 2022 
0033 6878 1302  14         jeq   hchar2                ; Yes, exit
0034 687A C2C7  18         mov   tmp3,r11
0035 687C 10EE  14         jmp   hchar                 ; Next one
0036 687E 05C7  14 hchar2  inct  tmp3
0037 6880 0457  20         b     *tmp3                 ; Exit
**** **** ****     > runlib.asm
0147               
0151               
0155               
...
0015               ********|*****|*********************|**************************
0016 6882 40A0  34 realkb  szc   @wbit0,config         ; Reset bit 0 in CONFIG register
     6884 2020 
0017 6886 020C  20         li    r12,>0024
     6888 0024 
0018 688A 020F  20         li    r15,kbsmal            ; Default is KBSMAL table
     688C 2888 
0019 688E 04C6  14         clr   tmp2
0020 6890 30C6  56         ldcr  tmp2,>0003            ; Lower case by default
0021               *--------------------------------------------------------------
0022               * SHIFT key pressed ?
0023               *--------------------------------------------------------------
0024 6892 04CC  14         clr   r12
0025 6894 1F08  20         tb    >0008                 ; Shift-key ?
0026 6896 1302  14         jeq   realk1                ; No
0027 6898 020F  20         li    r15,kbshft            ; Yes, use KBSHIFT table
     689A 28B8 
0028               *--------------------------------------------------------------
0029               * FCTN key pressed ?
0030               *--------------------------------------------------------------
0031 689C 1F07  20 realk1  tb    >0007                 ; FNCTN-key ?
0032 689E 1302  14         jeq   realk2                ; No
0033 68A0 020F  20         li    r15,kbfctn            ; Yes, use KBFCTN table
     68A2 28E8 
0034               *--------------------------------------------------------------
0035               * CTRL key pressed ?
0036               *--------------------------------------------------------------
0037 68A4 1F09  20 realk2  tb    >0009                 ; CTRL-key ?
0038 68A6 1302  14         jeq   realk3                ; No
0039 68A8 020F  20         li    r15,kbctrl            ; Yes, use KBCTRL table
     68AA 2918 
0040               *--------------------------------------------------------------
0041               * ALPHA LOCK key down ?
0042               *--------------------------------------------------------------
0043 68AC 40A0  34 realk3  szc   @wbit10,config        ; CONFIG register bit 10=0
     68AE 200C 
0044 68B0 1E15  20         sbz   >0015                 ; Set P5
0045 68B2 1F07  20         tb    >0007                 ; ALPHA-Lock key down?
0046 68B4 1302  14         jeq   realk4                ; No
0047 68B6 E0A0  34         soc   @wbit10,config        ; Yes, CONFIG register bit 10=1
     68B8 200C 
0048               *--------------------------------------------------------------
0049               * Scan keyboard column
0050               *--------------------------------------------------------------
0051 68BA 1D15  20 realk4  sbo   >0015                 ; Reset P5
0052 68BC 0206  20         li    tmp2,6                ; Bitcombination for CRU, column counter
     68BE 0006 
0053 68C0 0606  14 realk5  dec   tmp2
0054 68C2 020C  20         li    r12,>24               ; CRU address for P2-P4
     68C4 0024 
0055 68C6 06C6  14         swpb  tmp2
0056 68C8 30C6  56         ldcr  tmp2,3                ; Transfer bit combination
0057 68CA 06C6  14         swpb  tmp2
0058 68CC 020C  20         li    r12,6                 ; CRU read address
     68CE 0006 
0059 68D0 3607  64         stcr  tmp3,8                ; Transfer 8 bits into R2HB
0060 68D2 0547  14         inv   tmp3                  ;
0061 68D4 0247  22         andi  tmp3,>ff00            ; Clear TMP3LB
     68D6 FF00 
0062               *--------------------------------------------------------------
0063               * Scan keyboard row
0064               *--------------------------------------------------------------
0065 68D8 04C5  14         clr   tmp1                  ; Use TMP1 as row counter from now on
0066 68DA 0A17  56 realk6  sla   tmp3,1                ; R2 bitcombos scanned by shifting left.
0067 68DC 1807  14         joc   realk8                ; If no carry after 8 loops, then no key
0068 68DE 0585  14 realk7  inc   tmp1                  ; was pressed on that line.
0069 68E0 0285  22         ci    tmp1,8
     68E2 0008 
0070 68E4 1AFA  14         jl    realk6
0071 68E6 C186  18         mov   tmp2,tmp2             ; All 6 columns processed ?
0072 68E8 1BEB  14         jh    realk5                ; No, next column
0073 68EA 1016  14         jmp   realkz                ; Yes, exit
0074               *--------------------------------------------------------------
0075               * Check for match in data table
0076               *--------------------------------------------------------------
0077 68EC C206  18 realk8  mov   tmp2,tmp4
0078 68EE 0A38  56         sla   tmp4,3                ; TMP4 = TMP2 * 8
0079 68F0 A205  18         a     tmp1,tmp4             ; TMP4 = TMP4 + TMP1
0080 68F2 A20F  18         a     r15,tmp4              ; TMP4 = TMP4 + base addr of data table(R15)
0081 68F4 D618  38         movb  *tmp4,*tmp4           ; Is the byte on that address = >00 ?
0082 68F6 13F3  14         jeq   realk7                ; Yes, discard & continue scanning
0083                                                   ; (FCTN, SHIFT, CTRL)
0084               *--------------------------------------------------------------
0085               * Determine ASCII value of key
0086               *--------------------------------------------------------------
0087 68F8 D198  26 realk9  movb  *tmp4,tmp2            ; Real keypress. It's safe to reuse TMP2 now
0088 68FA 20A0  38         coc   @wbit10,config        ; ALPHA-Lock key down ?
     68FC 200C 
0089 68FE 1608  14         jne   realka                ; No, continue saving key
0090 6900 9806  38         cb    tmp2,@kbsmal+42       ; Is ASCII of key pressed < 97 ('a') ?
     6902 28B2 
0091 6904 1A05  14         jl    realka
0092 6906 9806  38         cb    tmp2,@kbsmal+40       ; and ASCII of key pressed > 122 ('z') ?
     6908 28B0 
0093 690A 1B02  14         jh    realka                ; No, continue
0094 690C 0226  22         ai    tmp2,->2000           ; ASCII = ASCII-32 (lowercase to uppercase!)
     690E E000 
0095 6910 C806  38 realka  mov   tmp2,@waux1           ; Store ASCII value of key in WAUX1
     6912 833C 
0096 6914 E0A0  34         soc   @wbit11,config        ; Set ANYKEY flag in CONFIG register
     6916 200A 
0097 6918 020F  20 realkz  li    r15,vdpw              ; \ Setup VDP write address again after
     691A 8C00 
0098                                                   ; / using R15 as temp storage
0099 691C 045B  20         b     *r11                  ; Exit
0100               ********|*****|*********************|**************************
0101 691E FF00     kbsmal  data  >ff00,>0000,>ff0d,>203D
     6920 0000 
     6922 FF0D 
     6924 203D 
0102 6926 ....             text  'xws29ol.'
0103 692E ....             text  'ced38ik,'
0104 6936 ....             text  'vrf47ujm'
0105 693E ....             text  'btg56yhn'
0106 6946 ....             text  'zqa10p;/'
0107 694E FF00     kbshft  data  >ff00,>0000,>ff0d,>202B
     6950 0000 
     6952 FF0D 
     6954 202B 
0108 6956 ....             text  'XWS@(OL>'
0109 695E ....             text  'CED#*IK<'
0110 6966 ....             text  'VRF$&UJM'
0111 696E ....             text  'BTG%^YHN'
0112 6976 ....             text  'ZQA!)P:-'
0113 697E FF00     kbfctn  data  >ff00,>0000,>ff0d,>2005
     6980 0000 
     6982 FF0D 
     6984 2005 
0114 6986 0A7E             data  >0a7e,>0804,>0f27,>c2B9
     6988 0804 
     698A 0F27 
     698C C2B9 
0115 698E 600B             data  >600b,>0907,>063f,>c1B8
     6990 0907 
     6992 063F 
     6994 C1B8 
0116 6996 7F5B             data  >7f5b,>7b02,>015f,>c0C3
     6998 7B02 
     699A 015F 
     699C C0C3 
0117 699E BE5D             data  >be5d,>7d0e,>0cc6,>bfC4
     69A0 7D0E 
     69A2 0CC6 
     69A4 BFC4 
0118 69A6 5CB9             data  >5cb9,>7c03,>bc22,>bdBA
     69A8 7C03 
     69AA BC22 
     69AC BDBA 
0119 69AE FF00     kbctrl  data  >ff00,>0000,>ff0d,>209D
     69B0 0000 
     69B2 FF0D 
     69B4 209D 
0120 69B6 9897             data  >9897,>93b2,>9f8f,>8c9B
     69B8 93B2 
     69BA 9F8F 
     69BC 8C9B 
0121 69BE 8385             data  >8385,>84b3,>9e89,>8b80
     69C0 84B3 
     69C2 9E89 
     69C4 8B80 
0122 69C6 9692             data  >9692,>86b4,>b795,>8a8D
     69C8 86B4 
     69CA B795 
     69CC 8A8D 
0123 69CE 8294             data  >8294,>87b5,>b698,>888E
     69D0 87B5 
     69D2 B698 
     69D4 888E 
0124 69D6 9A91             data  >9a91,>81b1,>b090,>9cBB
     69D8 81B1 
     69DA B090 
     69DC 9CBB 
**** **** ****     > runlib.asm
...
0022               ********|*****|*********************|**************************
0023 69DE C13B  30 mkhex   mov   *r11+,tmp0            ; P0: Address of word
0024 69E0 C83B  50         mov   *r11+,@waux3          ; P1: Pointer to string buffer
     69E2 8340 
0025 69E4 04E0  34         clr   @waux1
     69E6 833C 
0026 69E8 04E0  34         clr   @waux2
     69EA 833E 
0027 69EC 0207  20         li    tmp3,waux1            ; We store results in WAUX1 and WAUX2
     69EE 833C 
0028 69F0 C114  26         mov   *tmp0,tmp0            ; Get word
0029               *--------------------------------------------------------------
0030               *    Convert nibbles to bytes (is in wrong order)
0031               *--------------------------------------------------------------
0032 69F2 0205  20         li    tmp1,4                ; 4 nibbles
     69F4 0004 
0033 69F6 C184  18 mkhex1  mov   tmp0,tmp2             ; Make work copy
0034 69F8 0246  22         andi  tmp2,>000f            ; Only keep LSN
     69FA 000F 
0035                       ;------------------------------------------------------
0036                       ; Determine offset for ASCII char
0037                       ;------------------------------------------------------
0038 69FC 0286  22         ci    tmp2,>000a
     69FE 000A 
0039 6A00 1105  14         jlt   mkhex1.digit09
0040                       ;------------------------------------------------------
0041                       ; Add ASCII offset for digits A-F
0042                       ;------------------------------------------------------
0043               mkhex1.digitaf:
0044 6A02 C21B  26         mov   *r11,tmp4
0045 6A04 0988  56         srl   tmp4,8                ; Right justify
0046 6A06 0228  22         ai    tmp4,-10              ; Adjust offset for 'A-F'
     6A08 FFF6 
0047 6A0A 1003  14         jmp   mkhex2
0048               
0049               mkhex1.digit09:
0050                       ;------------------------------------------------------
0051                       ; Add ASCII offset for digits 0-9
0052                       ;------------------------------------------------------
0053 6A0C C21B  26         mov   *r11,tmp4
0054 6A0E 0248  22         andi  tmp4,>00ff            ; Only keep LSB
     6A10 00FF 
0055               
0056 6A12 A188  18 mkhex2  a     tmp4,tmp2             ; Add ASCII-offset
0057 6A14 06C6  14         swpb  tmp2
0058 6A16 DDC6  32         movb  tmp2,*tmp3+           ; Save byte
0059 6A18 0944  56         srl   tmp0,4                ; Next nibble
0060 6A1A 0605  14         dec   tmp1
0061 6A1C 16EC  14         jne   mkhex1                ; Repeat until all nibbles processed
0062 6A1E 0242  22         andi  config,>bfff          ; Reset bit 1 in config register
     6A20 BFFF 
0063               *--------------------------------------------------------------
0064               *    Build first 2 bytes in correct order
0065               *--------------------------------------------------------------
0066 6A22 C160  34         mov   @waux3,tmp1           ; Get pointer
     6A24 8340 
0067 6A26 04D5  26         clr   *tmp1                 ; Set length byte to 0
0068 6A28 0585  14         inc   tmp1                  ; Next byte, not word!
0069 6A2A C120  34         mov   @waux2,tmp0
     6A2C 833E 
0070 6A2E 06C4  14         swpb  tmp0
0071 6A30 DD44  32         movb  tmp0,*tmp1+
0072 6A32 06C4  14         swpb  tmp0
0073 6A34 DD44  32         movb  tmp0,*tmp1+
0074               *--------------------------------------------------------------
0075               *    Set length byte
0076               *--------------------------------------------------------------
0077 6A36 C120  34         mov   @waux3,tmp0           ; Get start of string buffer
     6A38 8340 
0078 6A3A D520  46         movb  @hb$04,*tmp0          ; Set lengh byte to 4
     6A3C 2016 
0079 6A3E 05CB  14         inct  r11                   ; Skip Parameter P2
0080               *--------------------------------------------------------------
0081               *    Build last 2 bytes in correct order
0082               *--------------------------------------------------------------
0083 6A40 C120  34         mov   @waux1,tmp0
     6A42 833C 
0084 6A44 06C4  14         swpb  tmp0
0085 6A46 DD44  32         movb  tmp0,*tmp1+
0086 6A48 06C4  14         swpb  tmp0
0087 6A4A DD44  32         movb  tmp0,*tmp1+
0088               *--------------------------------------------------------------
0089               *    Display hex number ?
0090               *--------------------------------------------------------------
0091 6A4C 20A0  38         coc   @wbit0,config         ; Check if 'display' bit is set
     6A4E 2020 
0092 6A50 1301  14         jeq   mkhex3                ; Yes, so show at current YX position
0093 6A52 045B  20         b     *r11                  ; Exit
0094               *--------------------------------------------------------------
0095               *  Display hex number on screen at current YX position
0096               *--------------------------------------------------------------
0097 6A54 0242  22 mkhex3  andi  config,>7fff          ; Reset bit 0
     6A56 7FFF 
0098 6A58 C160  34         mov   @waux3,tmp1           ; Get Pointer to string
     6A5A 8340 
0099 6A5C 0460  28         b     @xutst0               ; Display string
     6A5E 2422 
0100 6A60 0610     prefix  data  >0610                 ; Length byte + blank
0101               
0102               
0103               
0104               ***************************************************************
...
0120               ********|*****|*********************|**************************
0121 6A62 C83B  50 puthex  mov   *r11+,@wyx            ; Set cursor
     6A64 832A 
0122 6A66 0262  22         ori   config,>8000          ; CONFIG register bit 0=1
     6A68 8000 
0123 6A6A 10B9  14         jmp   mkhex                 ; Convert number and display
0124               
**** **** ****     > runlib.asm
0183               
...
0018               ********|*****|*********************|**************************
0019 6A6C 0207  20 mknum   li    tmp3,5                ; Digit counter
     6A6E 0005 
0020 6A70 C17B  30         mov   *r11+,tmp1            ; \ Get 16 bit unsigned number
0021 6A72 C155  26         mov   *tmp1,tmp1            ; /
0022 6A74 C23B  30         mov   *r11+,tmp4            ; Pointer to string buffer
0023 6A76 0228  22         ai    tmp4,4                ; Get end of buffer
     6A78 0004 
0024 6A7A 0206  20         li    tmp2,10               ; Divide by 10 to isolate last digit
     6A7C 000A 
0025               *--------------------------------------------------------------
0026               *  Do string conversion
0027               *--------------------------------------------------------------
0028 6A7E 04C4  14 mknum1  clr   tmp0                  ; Clear the high word of the dividend
0029 6A80 3D06  128         div   tmp2,tmp0             ; (TMP0:TMP1) / 10 (TMP2)
0030 6A82 06C5  14         swpb  tmp1                  ; Move to high-byte for writing to buffer
0031 6A84 B15B  26         ab    *r11,tmp1             ; Add offset for ASCII digit
0032 6A86 D605  30         movb  tmp1,*tmp4            ; Write remainder to string buffer
0033 6A88 C144  18         mov   tmp0,tmp1             ; Move integer result into R4 for next digit
0034 6A8A 0608  14         dec   tmp4                  ; Adjust string pointer for next digit
0035 6A8C 0607  14         dec   tmp3                  ; Decrease counter
0036 6A8E 16F7  14         jne   mknum1                ; Do next digit
0037               *--------------------------------------------------------------
0038               *  Replace leading 0's with fill character
0039               *--------------------------------------------------------------
0040 6A90 0207  20         li    tmp3,4                ; Check first 4 digits
     6A92 0004 
0041 6A94 0588  14         inc   tmp4                  ; Too far, back to buffer start
0042 6A96 C11B  26         mov   *r11,tmp0
0043 6A98 0A84  56         sla   tmp0,8                ; Only keep fill character in HB
0044 6A9A 96D8  38 mknum2  cb    *tmp4,*r11            ; Digit = 0 ?
0045 6A9C 1305  14         jeq   mknum4                ; Yes, replace with fill character
0046 6A9E 05CB  14 mknum3  inct  r11
0047 6AA0 20A0  38         coc   @wbit0,config         ; Check if 'display' bit is set
     6AA2 2020 
0048 6AA4 1305  14         jeq   mknum5                ; Yes, so show at current YX position
0049 6AA6 045B  20         b     *r11                  ; Exit
0050 6AA8 DE04  32 mknum4  movb  tmp0,*tmp4+           ; Replace leading 0 with fill character
0051 6AAA 0607  14         dec   tmp3                  ; 4th digit processed ?
0052 6AAC 13F8  14         jeq   mknum3                ; Yes, exit
0053 6AAE 10F5  14         jmp   mknum2                ; No, next one
0054               *--------------------------------------------------------------
0055               *  Display integer on screen at current YX position
0056               *--------------------------------------------------------------
0057 6AB0 0242  22 mknum5  andi  config,>7fff          ; Reset bit 0
     6AB2 7FFF 
0058 6AB4 C10B  18         mov   r11,tmp0
0059 6AB6 0224  22         ai    tmp0,-4
     6AB8 FFFC 
0060 6ABA C154  26         mov   *tmp0,tmp1            ; Get buffer address
0061 6ABC 0206  20         li    tmp2,>0500            ; String length = 5
     6ABE 0500 
0062 6AC0 0460  28         b     @xutstr               ; Display string
     6AC2 2424 
0063               
0064               
0065               
...
0091               ********|*****|*********************|**************************
0092               trimnum:
0093 6AC4 C13B  30         mov   *r11+,tmp0            ; Get pointer to input string
0094 6AC6 C17B  30         mov   *r11+,tmp1            ; Get pointer to output string
0095 6AC8 C1BB  30         mov   *r11+,tmp2            ; Get padding character
0096 6ACA 06C6  14         swpb  tmp2                  ; LO <-> HI
0097 6ACC 0207  20         li    tmp3,5                ; Set counter
     6ACE 0005 
0098                       ;------------------------------------------------------
0099                       ; Scan for padding character from left to right
0100                       ;------------------------------------------------------:
0101               trimnum_scan:
0102 6AD0 9194  26         cb    *tmp0,tmp2            ; Matches padding character ?
0103 6AD2 1604  14         jne   trimnum_setlen        ; No, exit loop
0104 6AD4 0584  14         inc   tmp0                  ; Next character
0105 6AD6 0607  14         dec   tmp3                  ; Last digit reached ?
0106 6AD8 1301  14         jeq   trimnum_setlen        ; yes, exit loop
0107 6ADA 10FA  14         jmp   trimnum_scan
0108                       ;------------------------------------------------------
0109                       ; Scan completed, set length byte new string
0110                       ;------------------------------------------------------
0111               trimnum_setlen:
0112 6ADC 06C7  14         swpb  tmp3                  ; LO <-> HI
0113 6ADE DD47  32         movb  tmp3,*tmp1+           ; Update string-length in work buffer
0114 6AE0 06C7  14         swpb  tmp3                  ; LO <-> HI
0115                       ;------------------------------------------------------
0116                       ; Start filling new string
0117                       ;------------------------------------------------------
0118               trimnum_fill:
0119 6AE2 DD74  42         movb  *tmp0+,*tmp1+         ; Copy character
0120 6AE4 0607  14         dec   tmp3                  ; Last character ?
0121 6AE6 16FD  14         jne   trimnum_fill          ; Not yet, repeat
0122 6AE8 045B  20         b     *r11                  ; Return
0123               
0124               
0125               
0126               
...
0138               ********|*****|*********************|**************************
0139 6AEA C83B  50 putnum  mov   *r11+,@wyx            ; Set cursor
     6AEC 832A 
0140 6AEE 0262  22         ori   config,>8000          ; CONFIG register bit 0=1
     6AF0 8000 
0141 6AF2 10BC  14         jmp   mknum                 ; Convert number and display
**** **** ****     > runlib.asm
0187               
0191               
0195               
...
0020               ********|*****|*********************|**************************
0021               string.ltrim:
0022 6AF4 0649  14         dect  stack
0023 6AF6 C64B  30         mov   r11,*stack            ; Save return address
0024 6AF8 0649  14         dect  stack
0025 6AFA C644  30         mov   tmp0,*stack           ; Push tmp0
0026 6AFC 0649  14         dect  stack
0027 6AFE C645  30         mov   tmp1,*stack           ; Push tmp1
0028 6B00 0649  14         dect  stack
0029 6B02 C646  30         mov   tmp2,*stack           ; Push tmp2
0030 6B04 0649  14         dect  stack
0031 6B06 C647  30         mov   tmp3,*stack           ; Push tmp3
0032                       ;-----------------------------------------------------------------------
0033                       ; Get parameter values
0034                       ;-----------------------------------------------------------------------
0035 6B08 C13B  30         mov   *r11+,tmp0            ; Pointer to length-prefixed string
0036 6B0A C17B  30         mov   *r11+,tmp1            ; RAM work buffer
0037 6B0C C1BB  30         mov   *r11+,tmp2            ; Fill character
0038 6B0E 100A  14         jmp   !
0039                       ;-----------------------------------------------------------------------
0040                       ; Register version
0041                       ;-----------------------------------------------------------------------
0042               xstring.ltrim:
0043 6B10 0649  14         dect  stack
0044 6B12 C64B  30         mov   r11,*stack            ; Save return address
0045 6B14 0649  14         dect  stack
0046 6B16 C644  30         mov   tmp0,*stack           ; Push tmp0
0047 6B18 0649  14         dect  stack
0048 6B1A C645  30         mov   tmp1,*stack           ; Push tmp1
0049 6B1C 0649  14         dect  stack
0050 6B1E C646  30         mov   tmp2,*stack           ; Push tmp2
0051 6B20 0649  14         dect  stack
0052 6B22 C647  30         mov   tmp3,*stack           ; Push tmp3
0053                       ;-----------------------------------------------------------------------
0054                       ; Start
0055                       ;-----------------------------------------------------------------------
0056 6B24 C1D4  26 !       mov   *tmp0,tmp3
0057 6B26 06C7  14         swpb  tmp3                  ; LO <-> HI
0058 6B28 0247  22         andi  tmp3,>00ff            ; Discard HI byte tmp2 (only keep length)
     6B2A 00FF 
0059 6B2C 0A86  56         sla   tmp2,8                ; LO -> HI fill character
0060                       ;-----------------------------------------------------------------------
0061                       ; Scan string from left to right and compare with fill character
0062                       ;-----------------------------------------------------------------------
0063               string.ltrim.scan:
0064 6B2E 9194  26         cb    *tmp0,tmp2            ; Do we have a fill character?
0065 6B30 1604  14         jne   string.ltrim.move     ; No, now move string left
0066 6B32 0584  14         inc   tmp0                  ; Next byte
0067 6B34 0607  14         dec   tmp3                  ; Shorten string length
0068 6B36 1301  14         jeq   string.ltrim.move     ; Exit if all characters processed
0069 6B38 10FA  14         jmp   string.ltrim.scan     ; Scan next characer
0070                       ;-----------------------------------------------------------------------
0071                       ; Copy part of string to RAM work buffer (This is the left-justify)
0072                       ;-----------------------------------------------------------------------
0073               string.ltrim.move:
0074 6B3A 9194  26         cb    *tmp0,tmp2            ; Do we have a fill character?
0075 6B3C C1C7  18         mov   tmp3,tmp3             ; String length = 0 ?
0076 6B3E 1306  14         jeq   string.ltrim.panic    ; File length assert
0077 6B40 C187  18         mov   tmp3,tmp2
0078 6B42 06C7  14         swpb  tmp3                  ; HI <-> LO
0079 6B44 DD47  32         movb  tmp3,*tmp1+           ; Set new string length byte in RAM workbuf
0080               
0081 6B46 06A0  32         bl    @xpym2m               ; tmp0 = Memory source address
     6B48 24E2 
0082                                                   ; tmp1 = Memory target address
0083                                                   ; tmp2 = Number of bytes to copy
0084 6B4A 1004  14         jmp   string.ltrim.exit
0085                       ;-----------------------------------------------------------------------
0086                       ; CPU crash
0087                       ;-----------------------------------------------------------------------
0088               string.ltrim.panic:
0089 6B4C C80B  38         mov   r11,@>ffce            ; \ Save caller address
     6B4E FFCE 
0090 6B50 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     6B52 2026 
0091                       ;----------------------------------------------------------------------
0092                       ; Exit
0093                       ;----------------------------------------------------------------------
0094               string.ltrim.exit:
0095 6B54 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0096 6B56 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0097 6B58 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0098 6B5A C139  30         mov   *stack+,tmp0          ; Pop tmp0
0099 6B5C C2F9  30         mov   *stack+,r11           ; Pop r11
0100 6B5E 045B  20         b     *r11                  ; Return to caller
0101               
0102               
0103               
0104               
...
0121               ********|*****|*********************|**************************
0122               string.getlenc:
0123 6B60 0649  14         dect  stack
0124 6B62 C64B  30         mov   r11,*stack            ; Save return address
0125 6B64 05D9  26         inct  *stack                ; Skip "data P0"
0126 6B66 05D9  26         inct  *stack                ; Skip "data P1"
0127 6B68 0649  14         dect  stack
0128 6B6A C644  30         mov   tmp0,*stack           ; Push tmp0
0129 6B6C 0649  14         dect  stack
0130 6B6E C645  30         mov   tmp1,*stack           ; Push tmp1
0131 6B70 0649  14         dect  stack
0132 6B72 C646  30         mov   tmp2,*stack           ; Push tmp2
0133                       ;-----------------------------------------------------------------------
0134                       ; Get parameter values
0135                       ;-----------------------------------------------------------------------
0136 6B74 C13B  30         mov   *r11+,tmp0            ; Pointer to C-style string
0137 6B76 C17B  30         mov   *r11+,tmp1            ; String termination character
0138 6B78 1008  14         jmp   !
0139                       ;-----------------------------------------------------------------------
0140                       ; Register version
0141                       ;-----------------------------------------------------------------------
0142               xstring.getlenc:
0143 6B7A 0649  14         dect  stack
0144 6B7C C64B  30         mov   r11,*stack            ; Save return address
0145 6B7E 0649  14         dect  stack
0146 6B80 C644  30         mov   tmp0,*stack           ; Push tmp0
0147 6B82 0649  14         dect  stack
0148 6B84 C645  30         mov   tmp1,*stack           ; Push tmp1
0149 6B86 0649  14         dect  stack
0150 6B88 C646  30         mov   tmp2,*stack           ; Push tmp2
0151                       ;-----------------------------------------------------------------------
0152                       ; Start
0153                       ;-----------------------------------------------------------------------
0154 6B8A 0A85  56 !       sla   tmp1,8                ; LSB to MSB
0155 6B8C 04C6  14         clr   tmp2                  ; Loop counter
0156                       ;-----------------------------------------------------------------------
0157                       ; Scan string for termination character
0158                       ;-----------------------------------------------------------------------
0159               string.getlenc.loop:
0160 6B8E 0586  14         inc   tmp2
0161 6B90 9174  28         cb    *tmp0+,tmp1           ; Compare character
0162 6B92 1304  14         jeq   string.getlenc.putlength
0163                       ;-----------------------------------------------------------------------
0164                       ; Assert on string length
0165                       ;-----------------------------------------------------------------------
0166 6B94 0286  22         ci    tmp2,255
     6B96 00FF 
0167 6B98 1505  14         jgt   string.getlenc.panic
0168 6B9A 10F9  14         jmp   string.getlenc.loop
0169                       ;-----------------------------------------------------------------------
0170                       ; Return length
0171                       ;-----------------------------------------------------------------------
0172               string.getlenc.putlength:
0173 6B9C 0606  14         dec   tmp2                  ; One time adjustment
0174 6B9E C806  38         mov   tmp2,@waux1           ; Store length
     6BA0 833C 
0175 6BA2 1004  14         jmp   string.getlenc.exit   ; Exit
0176                       ;-----------------------------------------------------------------------
0177                       ; CPU crash
0178                       ;-----------------------------------------------------------------------
0179               string.getlenc.panic:
0180 6BA4 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     6BA6 FFCE 
0181 6BA8 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     6BAA 2026 
0182                       ;----------------------------------------------------------------------
0183                       ; Exit
0184                       ;----------------------------------------------------------------------
0185               string.getlenc.exit:
0186 6BAC C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0187 6BAE C179  30         mov   *stack+,tmp1          ; Pop tmp1
0188 6BB0 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0189 6BB2 C2F9  30         mov   *stack+,r11           ; Pop r11
0190 6BB4 045B  20         b     *r11                  ; Return to caller
**** **** ****     > runlib.asm
0207               
0211               
0216               
...
0055               ********|*****|*********************|**************************
0056 6BB6 A400     dsrlnk  data  dsrlnk.dsrlws         ; dsrlnk workspace
0057 6BB8 2B24             data  dsrlnk.init           ; Entry point
0058                       ;------------------------------------------------------
0059                       ; DSRLNK entry point
0060                       ;------------------------------------------------------
0061               dsrlnk.init:
0062 6BBA C17E  30         mov   *r14+,r5              ; Get pgm type for link
0063 6BBC C805  38         mov   r5,@dsrlnk.sav8a      ; Save data following blwp @dsrlnk (8 or >a)
     6BBE A428 
0064 6BC0 53E0  34         szcb  @hb$20,r15            ; Reset equal bit in status register
     6BC2 201C 
0065 6BC4 C020  34         mov   @>8356,r0             ; Get pointer to PAB+9 in VDP
     6BC6 8356 
0066 6BC8 C240  18         mov   r0,r9                 ; Save pointer
0067                       ;------------------------------------------------------
0068                       ; Fetch file descriptor length from PAB
0069                       ;------------------------------------------------------
0070 6BCA 0229  22         ai    r9,>fff8              ; Adjust r9 to addr PAB byte 1
     6BCC FFF8 
0071                                                   ; FLAG byte->(pabaddr+9)-8
0072 6BCE C809  38         mov   r9,@dsrlnk.flgptr     ; Save pointer to PAB byte 1
     6BD0 A434 
0073                       ;---------------------------; Inline VSBR start
0074 6BD2 06C0  14         swpb  r0                    ;
0075 6BD4 D800  38         movb  r0,@vdpa              ; Send low byte
     6BD6 8C02 
0076 6BD8 06C0  14         swpb  r0                    ;
0077 6BDA D800  38         movb  r0,@vdpa              ; Send high byte
     6BDC 8C02 
0078 6BDE D0E0  34         movb  @vdpr,r3              ; Read byte from VDP RAM
     6BE0 8800 
0079                       ;---------------------------; Inline VSBR end
0080 6BE2 0983  56         srl   r3,8                  ; Move to low byte
0081               
0082                       ;------------------------------------------------------
0083                       ; Fetch file descriptor device name from PAB
0084                       ;------------------------------------------------------
0085 6BE4 0704  14         seto  r4                    ; Init counter
0086 6BE6 0202  20         li    r2,dsrlnk.namsto      ; Point to 8-byte CPU buffer
     6BE8 A420 
0087 6BEA 0580  14 !       inc   r0                    ; Point to next char of name
0088 6BEC 0584  14         inc   r4                    ; Increment char counter
0089 6BEE 0284  22         ci    r4,>0007              ; Check if length more than 7 chars
     6BF0 0007 
0090 6BF2 1571  14         jgt   dsrlnk.error.devicename_invalid
0091                                                   ; Yes, error
0092 6BF4 80C4  18         c     r4,r3                 ; End of name?
0093 6BF6 130C  14         jeq   dsrlnk.device_name.get_length
0094                                                   ; Yes
0095               
0096                       ;---------------------------; Inline VSBR start
0097 6BF8 06C0  14         swpb  r0                    ;
0098 6BFA D800  38         movb  r0,@vdpa              ; Send low byte
     6BFC 8C02 
0099 6BFE 06C0  14         swpb  r0                    ;
0100 6C00 D800  38         movb  r0,@vdpa              ; Send high byte
     6C02 8C02 
0101 6C04 D060  34         movb  @vdpr,r1              ; Read byte from VDP RAM
     6C06 8800 
...
0106                       ;------------------------------------------------------
0107 6C08 DC81  32         movb  r1,*r2+               ; Move into buffer
0108 6C0A 9801  38         cb    r1,@dsrlnk.period     ; Is character a '.'
     6C0C 2C8C 
0109 6C0E 16ED  14         jne   -!                    ; No, loop next char
0110                       ;------------------------------------------------------
0111                       ; Determine device name length
0112                       ;------------------------------------------------------
0113               dsrlnk.device_name.get_length:
0114 6C10 C104  18         mov   r4,r4                 ; Check if length = 0
0115 6C12 1361  14         jeq   dsrlnk.error.devicename_invalid
0116                                                   ; Yes, error
0117 6C14 04E0  34         clr   @>83d0
     6C16 83D0 
0118 6C18 C804  38         mov   r4,@>8354             ; Save name length for search (length
     6C1A 8354 
0119                                                   ; goes to >8355 but overwrites >8354!)
0120 6C1C C804  38         mov   r4,@dsrlnk.savlen     ; Save name length for nextr dsrlnk call
     6C1E A432 
0121               
0122 6C20 0584  14         inc   r4                    ; Adjust for dot
0123 6C22 A804  38         a     r4,@>8356             ; Point to position after name
     6C24 8356 
0124 6C26 C820  54         mov   @>8356,@dsrlnk.savpab ; Save pointer for next dsrlnk call
     6C28 8356 
     6C2A A42E 
0125                       ;------------------------------------------------------
...
0129 6C2C 02E0  18         lwpi  >83e0                 ; Use GPL WS
     6C2E 83E0 
0130 6C30 04C1  14         clr   r1                    ; Version found of dsr
0131 6C32 020C  20         li    r12,>0f00             ; Init cru address
     6C34 0F00 
0132                       ;------------------------------------------------------
0133                       ; Turn off ROM on current card
0134                       ;------------------------------------------------------
0135               dsrlnk.dsrscan.cardoff:
0136 6C36 C30C  18         mov   r12,r12               ; Anything to turn off?
0137 6C38 1301  14         jeq   dsrlnk.dsrscan.cardloop
0138                                                   ; No, loop over cards
0139 6C3A 1E00  20         sbz   0                     ; Yes, turn off
0140                       ;------------------------------------------------------
0141                       ; Loop over cards and look if DSR present
0142                       ;------------------------------------------------------
0143               dsrlnk.dsrscan.cardloop:
0144 6C3C 022C  22         ai    r12,>0100             ; Next ROM to turn on
     6C3E 0100 
0145 6C40 04E0  34         clr   @>83d0                ; Clear in case we are done
     6C42 83D0 
0146 6C44 028C  22         ci    r12,>2000             ; Card scan complete? (>1000 to >1F00)
     6C46 2000 
0147 6C48 1344  14         jeq   dsrlnk.error.nodsr_found
0148                                                   ; Yes, no matching DSR found
0149 6C4A C80C  38         mov   r12,@>83d0            ; Save address of next cru
     6C4C 83D0 
0150                       ;------------------------------------------------------
0151                       ; Look at card ROM (@>4000 eq 'AA' ?)
0152                       ;------------------------------------------------------
0153 6C4E 1D00  20         sbo   0                     ; Turn on ROM
0154 6C50 0202  20         li    r2,>4000              ; Start at beginning of ROM
     6C52 4000 
0155 6C54 9812  46         cb    *r2,@dsrlnk.$aa00     ; Check for a valid DSR header
     6C56 2C88 
0156 6C58 16EE  14         jne   dsrlnk.dsrscan.cardoff
...
0164                       ;------------------------------------------------------
0165 6C5A A0A0  34         a     @dsrlnk.dstype,r2     ; Goto first pointer (byte 8 or 10)
     6C5C A40A 
0166 6C5E 1003  14         jmp   dsrlnk.dsrscan.getentry
0167                       ;------------------------------------------------------
0168                       ; Next DSR entry
0169                       ;------------------------------------------------------
0170               dsrlnk.dsrscan.nextentry:
0171 6C60 C0A0  34         mov   @>83d2,r2             ; Offset 0 > Fetch link to next DSR or
     6C62 83D2 
0172                                                   ; subprogram
0173               
0174 6C64 1D00  20         sbo   0                     ; Turn ROM back on
0175                       ;------------------------------------------------------
0176                       ; Get DSR entry
0177                       ;------------------------------------------------------
0178               dsrlnk.dsrscan.getentry:
0179 6C66 C092  26         mov   *r2,r2                ; Is address a zero? (end of chain?)
0180 6C68 13E6  14         jeq   dsrlnk.dsrscan.cardoff
0181                                                   ; Yes, no more DSRs or programs to check
0182 6C6A C802  38         mov   r2,@>83d2             ; Offset 0 > Store link to next DSR or
     6C6C 83D2 
0183                                                   ; subprogram
0184               
0185 6C6E 05C2  14         inct  r2                    ; Offset 2 > Has call address of current
0186                                                   ; DSR/subprogram code
0187               
0188 6C70 C272  30         mov   *r2+,r9               ; Store call address in r9. Move r2 to
0189                                                   ; offset 4 (DSR/subprogram name)
0190                       ;------------------------------------------------------
0191                       ; Check file descriptor in DSR
0192                       ;------------------------------------------------------
0193 6C72 04C5  14         clr   r5                    ; Remove any old stuff
0194 6C74 D160  34         movb  @>8355,r5             ; Get length as counter
     6C76 8355 
0195 6C78 1309  14         jeq   dsrlnk.dsrscan.call_dsr
0196                                                   ; If zero, do not further check, call DSR
0197                                                   ; program
0198               
0199 6C7A 9C85  32         cb    r5,*r2+               ; See if length matches
0200 6C7C 16F1  14         jne   dsrlnk.dsrscan.nextentry
0201                                                   ; No, length does not match.
0202                                                   ; Go process next DSR entry
0203               
0204 6C7E 0985  56         srl   r5,8                  ; Yes, move to low byte
0205 6C80 0206  20         li    r6,dsrlnk.namsto      ; Point to 8-byte CPU buffer
     6C82 A420 
0206 6C84 9CB6  42 !       cb    *r6+,*r2+             ; Compare byte in CPU buffer with byte in
0207                                                   ; DSR ROM
0208 6C86 16EC  14         jne   dsrlnk.dsrscan.nextentry
0209                                                   ; Try next DSR entry if no match
0210 6C88 0605  14         dec   r5                    ; Update loop counter
0211 6C8A 16FC  14         jne   -!                    ; Loop until full length checked
0212                       ;------------------------------------------------------
0213                       ; Call DSR program in card/device
0214                       ;------------------------------------------------------
0215               dsrlnk.dsrscan.call_dsr:
0216 6C8C 0581  14         inc   r1                    ; Next version found
0217 6C8E C80C  38         mov   r12,@dsrlnk.savcru    ; Save CRU address
     6C90 A42A 
0218 6C92 C809  38         mov   r9,@dsrlnk.savent     ; Save DSR entry address
     6C94 A42C 
0219 6C96 C801  38         mov   r1,@dsrlnk.savver     ; Save DSR Version number
     6C98 A430 
0220               
0221 6C9A 020F  20         li    r15,>8C02             ; Set VDP port address, needed to prevent
     6C9C 8C02 
0222                                                   ; lockup of TI Disk Controller DSR.
0223               
0224 6C9E 0699  24         bl    *r9                   ; Execute DSR
0225                       ;
0226                       ; Depending on IO result the DSR in card ROM does RET
0227                       ; or (INCT R11 + RET), meaning either (1) or (2) get executed.
0228                       ;
0229 6CA0 10DF  14         jmp   dsrlnk.dsrscan.nextentry
0230                                                   ; (1) error return
0231 6CA2 1E00  20         sbz   0                     ; (2) turn off card/device if good return
0232 6CA4 02E0  18         lwpi  dsrlnk.dsrlws         ; (2) restore workspace
     6CA6 A400 
0233 6CA8 C009  18         mov   r9,r0                 ; Point to flag byte (PAB+1) in VDP PAB
0234                       ;------------------------------------------------------
0235                       ; Returned from DSR
0236                       ;------------------------------------------------------
0237               dsrlnk.dsrscan.return_dsr:
0238 6CAA C060  34         mov   @dsrlnk.sav8a,r1      ; get back data following blwp @dsrlnk
     6CAC A428 
0239                                                   ; (8 or >a)
0240 6CAE 0281  22         ci    r1,8                  ; was it 8?
     6CB0 0008 
0241 6CB2 1303  14         jeq   dsrlnk.dsrscan.dsr.8  ; yes, jump: normal dsrlnk
0242 6CB4 D060  34         movb  @>8350,r1             ; no, we have a data >a.
     6CB6 8350 
0243                                                   ; Get error byte from @>8350
0244 6CB8 1008  14         jmp   dsrlnk.dsrscan.dsr.a  ; go and return error byte to the caller
0245               
0246                       ;------------------------------------------------------
...
0251 6CBA 06C0  14         swpb  r0                    ;
0252 6CBC D800  38         movb  r0,@vdpa              ; send low byte
     6CBE 8C02 
0253 6CC0 06C0  14         swpb  r0                    ;
0254 6CC2 D800  38         movb  r0,@vdpa              ; send high byte
     6CC4 8C02 
0255 6CC6 D060  34         movb  @vdpr,r1              ; read byte from VDP ram
     6CC8 8800 
...
0262 6CCA 09D1  56         srl   r1,13                 ; just keep error bits
0263 6CCC 1605  14         jne   dsrlnk.error.io_error
0264                                                   ; handle IO error
0265 6CCE 0380  18         rtwp                        ; Return from DSR workspace to caller
0266                                                   ; workspace
0267               
0268                       ;------------------------------------------------------
...
0272 6CD0 1E00  20         sbz   >00                   ; Turn card off, nomatter what
0273               dsrlnk.error.nodsr_found:
0274 6CD2 02E0  18         lwpi  dsrlnk.dsrlws         ; No DSR found, restore workspace
     6CD4 A400 
0275               dsrlnk.error.devicename_invalid:
0276 6CD6 04C1  14         clr   r1                    ; clear flag for error 0 = bad device name
0277               dsrlnk.error.io_error:
0278 6CD8 06C1  14         swpb  r1                    ; put error in hi byte
0279 6CDA D741  30         movb  r1,*r13               ; store error flags in callers r0
0280 6CDC F3E0  34         socb  @hb$20,r15            ; \ Set equal bit in copy of status register
     6CDE 201C 
0281                                                   ; / to indicate error
0282 6CE0 0380  18         rtwp                        ; Return from DSR workspace to caller
0283                                                   ; workspace
0284               
0285               
0286               ***************************************************************
...
0307               ********|*****|*********************|**************************
0308               dsrlnk.reuse:
0309 6CE2 A400             data  dsrlnk.dsrlws         ; dsrlnk workspace
0310 6CE4 2C50             data  dsrlnk.reuse.init     ; entry point
0311                       ;------------------------------------------------------
0312                       ; DSRLNK entry point
0313                       ;------------------------------------------------------
0314               dsrlnk.reuse.init:
0315 6CE6 02E0  18         lwpi  >83e0                 ; Use GPL WS
     6CE8 83E0 
0316               
0317 6CEA 53E0  34         szcb  @hb$20,r15            ; reset equal bit in status register
     6CEC 201C 
0318                       ;------------------------------------------------------
0319                       ; Restore dsrlnk variables of previous DSR call
0320                       ;------------------------------------------------------
0321 6CEE 020B  20         li    r11,dsrlnk.savcru     ; Get pointer to last used CRU
     6CF0 A42A 
0322 6CF2 C33B  30         mov   *r11+,r12             ; Get CRU address         < @dsrlnk.savcru
0323 6CF4 C27B  30         mov   *r11+,r9              ; Get DSR entry address   < @dsrlnk.savent
0324 6CF6 C83B  50         mov   *r11+,@>8356          ; \ Get pointer to Device name or
     6CF8 8356 
0325                                                   ; / or subprogram in PAB  < @dsrlnk.savpab
0326 6CFA C07B  30         mov   *r11+,R1              ; Get DSR Version number  < @dsrlnk.savver
0327 6CFC C81B  46         mov   *r11,@>8354           ; Get device name length  < @dsrlnk.savlen
     6CFE 8354 
0328                       ;------------------------------------------------------
0329                       ; Call DSR program in card/device
0330                       ;------------------------------------------------------
0331 6D00 020F  20         li    r15,>8C02             ; Set VDP port address, needed to prevent
     6D02 8C02 
0332                                                   ; lockup of TI Disk Controller DSR.
0333               
0334 6D04 1D00  20         sbo   >00                   ; Open card/device ROM
0335               
0336 6D06 9820  54         cb    @>4000,@dsrlnk.$aa00  ; Valid identifier found?
     6D08 4000 
     6D0A 2C88 
0337 6D0C 16E2  14         jne   dsrlnk.error.nodsr_found
0338                                                   ; No, error code 0 = Bad Device name
0339                                                   ; The above jump may happen only in case of
0340                                                   ; either card hardware malfunction or if
0341                                                   ; there are 2 cards opened at the same time.
0342               
0343 6D0E 0699  24         bl    *r9                   ; Execute DSR
0344                       ;
0345                       ; Depending on IO result the DSR in card ROM does RET
0346                       ; or (INCT R11 + RET), meaning either (1) or (2) get executed.
0347                       ;
0348 6D10 10DF  14         jmp   dsrlnk.error.nodsr_found_off
0349                                                   ; (1) error return
0350 6D12 1E00  20         sbz   >00                   ; (2) turn off card ROM if good return
0351                       ;------------------------------------------------------
0352                       ; Now check if any DSR error occured
0353                       ;------------------------------------------------------
0354 6D14 02E0  18         lwpi  dsrlnk.dsrlws         ; Restore workspace
     6D16 A400 
0355 6D18 C020  34         mov   @dsrlnk.flgptr,r0     ; Get pointer to VDP PAB byte 1
     6D1A A434 
0356               
0357 6D1C 10C6  14         jmp   dsrlnk.dsrscan.return_dsr
0358                                                   ; Rest is the same as with normal DSRLNK
0359               
0360               
0361               ********************************************************************************
0362               
0363 6D1E AA00     dsrlnk.$aa00      data   >aa00      ; Used for identifying DSR header
0364 6D20 0008     dsrlnk.$0008      data   >0008      ; 8 is the data that usually follows
0365                                                   ; a @blwp @dsrlnk
0366 6D22 ....     dsrlnk.period     text  '.'         ; For finding end of device name
0367               
0368                       even
**** **** ****     > runlib.asm
...
0043               ********|*****|*********************|**************************
0044               file.open:
0045 6D24 C03B  30         mov   *r11+,r0              ; Get file descriptor (P0)
0046 6D26 C07B  30         mov   *r11+,r1              ; Get file type/mode
0047               *--------------------------------------------------------------
0048               * Initialisation
0049               *--------------------------------------------------------------
0050               xfile.open:
0051 6D28 0649  14         dect  stack
0052 6D2A C64B  30         mov   r11,*stack            ; Save return address
0053                       ;------------------------------------------------------
0054                       ; Initialisation
0055                       ;------------------------------------------------------
0056 6D2C 0204  20         li    tmp0,dsrlnk.savcru
     6D2E A42A 
0057 6D30 04F4  30         clr   *tmp0+                ; Clear @dsrlnk.savcru
0058 6D32 04F4  30         clr   *tmp0+                ; Clear @dsrlnk.savent
0059 6D34 04F4  30         clr   *tmp0+                ; Clear @dsrlnk.savver
0060 6D36 04D4  26         clr   *tmp0                 ; Clear @dsrlnk.pabflg
0061                       ;------------------------------------------------------
0062                       ; Set pointer to VDP disk buffer header
0063                       ;------------------------------------------------------
0064 6D38 0205  20         li    tmp1,>37D7            ; \ VDP Disk buffer header
     6D3A 37D7 
0065 6D3C C805  38         mov   tmp1,@>8370           ; | Pointer at Fixed scratchpad
     6D3E 8370 
0066                                                   ; / location
0067 6D40 C801  38         mov   r1,@fh.filetype       ; Set file type/mode
     6D42 A44C 
0068 6D44 04C5  14         clr   tmp1                  ; io.op.open
0069 6D46 101F  14         jmp   _file.record.fop      ; Do file operation
0070               
0071               
0072               
0073               ***************************************************************
...
0089               ********|*****|*********************|**************************
0090               file.close:
0091 6D48 C03B  30         mov   *r11+,r0              ; Get file descriptor (P0)
0092               *--------------------------------------------------------------
0093               * Initialisation
0094               *--------------------------------------------------------------
0095               xfile.close:
0096 6D4A 0649  14         dect  stack
0097 6D4C C64B  30         mov   r11,*stack            ; Save return address
0098 6D4E 0205  20         li    tmp1,io.op.close      ; io.op.close
     6D50 0001 
0099 6D52 1019  14         jmp   _file.record.fop      ; Do file operation
0100               
0101               
0102               ***************************************************************
...
0120 6D54 C03B  30         mov   *r11+,r0              ; Get file descriptor (P0)
0121               *--------------------------------------------------------------
0122               * Initialisation
0123               *--------------------------------------------------------------
0124 6D56 0649  14         dect  stack
0125 6D58 C64B  30         mov   r11,*stack            ; Save return address
0126               
0127 6D5A 0205  20         li    tmp1,io.op.read       ; io.op.read
     6D5C 0002 
0128 6D5E 1013  14         jmp   _file.record.fop      ; Do file operation
0129               
0130               
0131               
0132               ***************************************************************
...
0150 6D60 C03B  30         mov   *r11+,r0              ; Get file descriptor (P0)
0151               *--------------------------------------------------------------
0152               * Initialisation
0153               *--------------------------------------------------------------
0154 6D62 0649  14         dect  stack
0155 6D64 C64B  30         mov   r11,*stack            ; Save return address
0156               
0157 6D66 C100  18         mov   r0,tmp0               ; VDP write address (PAB byte 0)
0158 6D68 0224  22         ai    tmp0,5                ; Position to PAB byte 5
     6D6A 0005 
0159               
0160 6D6C C160  34         mov   @fh.reclen,tmp1       ; Get record length
     6D6E A43E 
0161               
0162 6D70 06A0  32         bl    @xvputb               ; Write character count to PAB
     6D72 22CE 
0163                                                   ; \ i  tmp0 = VDP target address
0164                                                   ; / i  tmp1 = Byte to write
0165               
0166 6D74 0205  20         li    tmp1,io.op.write      ; io.op.write
     6D76 0003 
0167 6D78 1006  14         jmp   _file.record.fop      ; Do file operation
0168               
0169               
0170               
0171               file.record.seek:
0172 6D7A 1000  14         nop
0173               
0174               
0175               file.image.load:
0176 6D7C 1000  14         nop
0177               
0178               
0179               file.image.save:
0180 6D7E 1000  14         nop
0181               
0182               
0183               file.delete:
0184 6D80 1000  14         nop
0185               
0186               
0187               file.rename:
0188 6D82 1000  14         nop
0189               
0190               
0191               file.status:
0192 6D84 1000  14         nop
0193               
0194               
0195               
0196               ***************************************************************
...
0226                       ;------------------------------------------------------
0227 6D86 C800  38         mov   r0,@fh.pab.ptr        ; Backup of pointer to current VDP PAB
     6D88 A436 
0228                       ;------------------------------------------------------
0229                       ; Set file opcode in VDP PAB
0230                       ;------------------------------------------------------
0231 6D8A C100  18         mov   r0,tmp0               ; VDP write address (PAB byte 0)
0232               
0233 6D8C A160  34         a     @fh.offsetopcode,tmp1 ; Inject offset for file I/O opcode
     6D8E A44E 
0234                                                   ; >00 = Data buffer in VDP RAM
0235                                                   ; >40 = Data buffer in CPU RAM
0236               
0237 6D90 06A0  32         bl    @xvputb               ; Write file I/O opcode to VDP
     6D92 22CE 
...
0242                       ;------------------------------------------------------
0243 6D94 C100  18         mov   r0,tmp0               ; VDP write address (PAB byte 0)
0244 6D96 0584  14         inc   tmp0                  ; Next byte in PAB
0245 6D98 C160  34         mov   @fh.filetype,tmp1     ; Get file type/mode
     6D9A A44C 
0246               
0247 6D9C 06A0  32         bl    @xvputb               ; Write file type/mode to VDP
     6D9E 22CE 
...
0252                       ;------------------------------------------------------
0253 6DA0 0220  22 !       ai    r0,9                  ; Move to file descriptor length
     6DA2 0009 
0254 6DA4 C800  38         mov   r0,@>8356             ; Pass file descriptor to DSRLNK
     6DA6 8356 
0255               *--------------------------------------------------------------
0256               * Call DSRLINK for doing file operation
0257               *--------------------------------------------------------------
0258 6DA8 C820  54         mov   @>8322,@waux1         ; Save word at @>8322
     6DAA 8322 
     6DAC 833C 
0259               
0260 6DAE C120  34         mov   @dsrlnk.savcru,tmp0   ; Call optimized or standard version?
     6DB0 A42A 
0261 6DB2 1504  14         jgt   _file.record.fop.optimized
0262                                                   ; Optimized version
0263               
0264                       ;------------------------------------------------------
0265                       ; First IO call. Call standard DSRLNK
0266                       ;------------------------------------------------------
0267 6DB4 0420  54         blwp  @dsrlnk               ; Call DSRLNK
     6DB6 2B20 
0268 6DB8 0008                   data >8               ; \ i  p0 = >8 (DSR)
0269                                                   ; / o  r0 = Copy of VDP PAB byte 1
0270 6DBA 1002  14         jmp  _file.record.fop.pab   ; Return PAB to caller
0271               
0272                       ;------------------------------------------------------
0273                       ; Recurring IO call. Call optimized DSRLNK
0274                       ;------------------------------------------------------
0275               _file.record.fop.optimized:
0276 6DBC 0420  54         blwp  @dsrlnk.reuse         ; Call DSRLNK
     6DBE 2C4C 
0277               
0278               *--------------------------------------------------------------
...
0282 6DC0 02C6  12         stst  tmp2                  ; Store status register contents in tmp2
0283                                                   ; Upon DSRLNK return status register EQ bit
0284                                                   ; 1 = No file error
0285                                                   ; 0 = File error occured
0286               
0287 6DC2 C820  54         mov   @waux1,@>8322         ; Restore word at @>8322
     6DC4 833C 
     6DC6 8322 
0288               *--------------------------------------------------------------
0289               * Get PAB byte 5 from VDP ram into tmp1 (character count)
0290               *--------------------------------------------------------------
0291 6DC8 C120  34         mov   @fh.pab.ptr,tmp0      ; Get VDP address of current PAB
     6DCA A436 
0292 6DCC 0224  22         ai    tmp0,5                ; Get address of VDP PAB byte 5
     6DCE 0005 
0293 6DD0 06A0  32         bl    @xvgetb               ; VDP read PAB status byte into tmp0
     6DD2 22E6 
0294 6DD4 C144  18         mov   tmp0,tmp1             ; Move to destination
0295               *--------------------------------------------------------------
0296               * Get PAB byte 1 from VDP ram into tmp0 (status)
0297               *--------------------------------------------------------------
0298 6DD6 C100  18         mov   r0,tmp0               ; VDP PAB byte 1 (status)
...
0319 6DD8 C2F9  30         mov   *stack+,r11           ; Pop R11
0320 6DDA 045B  20         b     *r11                  ; Return to caller
**** **** ****     > runlib.asm
0222               
0223               *//////////////////////////////////////////////////////////////
0224               *                            TIMERS
...
0019               ********|*****|*********************|**************************
0020 6DDC 0300  24 tmgr    limi  0                     ; No interrupt processing
     6DDE 0000 
0021               *--------------------------------------------------------------
0022               * Read VDP status register
0023               *--------------------------------------------------------------
0024 6DE0 D360  34 tmgr1   movb  @vdps,r13             ; Save copy of VDP status register in R13
     6DE2 8802 
0025               *--------------------------------------------------------------
0026               * Latch sprite collision flag
0027               *--------------------------------------------------------------
0028 6DE4 2360  38         coc   @wbit2,r13            ; C flag on ?
     6DE6 201C 
0029 6DE8 1602  14         jne   tmgr1a                ; No, so move on
0030 6DEA E0A0  34         soc   @wbit12,config        ; Latch bit 12 in config register
     6DEC 2008 
0031               *--------------------------------------------------------------
0032               * Interrupt flag
0033               *--------------------------------------------------------------
0034 6DEE 2360  38 tmgr1a  coc   @wbit0,r13            ; Interupt flag set ?
     6DF0 2020 
0035 6DF2 1311  14         jeq   tmgr4                 ; Yes, process slots 0..n
0036               *--------------------------------------------------------------
...
0046               *--------------------------------------------------------------
0047 6DF4 20A0  38 tmgr2   coc   @wbit8,config         ; Kernel thread blocked ?
     6DF6 2010 
0048 6DF8 1305  14         jeq   tmgr3                 ; Yes, skip to user hook
0049 6DFA 20A0  38         coc   @wbit9,config         ; Kernel thread enabled ?
     6DFC 200E 
0050 6DFE 1602  14         jne   tmgr3                 ; No, skip to user hook
0051 6E00 0460  28         b     @kthread              ; Run kernel thread
     6E02 2DE4 
0052               *--------------------------------------------------------------
0053               * Run user hook
0054               *--------------------------------------------------------------
0055 6E04 20A0  38 tmgr3   coc   @wbit6,config         ; User hook blocked ?
     6E06 2014 
0056 6E08 13EB  14         jeq   tmgr1
0057 6E0A 20A0  38         coc   @wbit7,config         ; User hook enabled ?
     6E0C 2012 
0058 6E0E 16E8  14         jne   tmgr1
0059 6E10 C120  34         mov   @wtiusr,tmp0
     6E12 832E 
0060 6E14 0454  20         b     *tmp0                 ; Run user hook
0061               *--------------------------------------------------------------
0062               * Do internal housekeeping
0063               *--------------------------------------------------------------
0064 6E16 40A0  34 tmgr4   szc   @tmdat,config         ; Unblock kernel thread and user hook
     6E18 2DE2 
0065 6E1A C10A  18         mov   r10,tmp0
0066 6E1C 0244  22         andi  tmp0,>00ff            ; Clear HI byte
     6E1E 00FF 
0067 6E20 20A0  38         coc   @wbit2,config         ; PAL flag set ?
     6E22 201C 
0068 6E24 1303  14         jeq   tmgr5
0069 6E26 0284  22         ci    tmp0,60               ; 1 second reached ?
     6E28 003C 
0070 6E2A 1002  14         jmp   tmgr6
0071 6E2C 0284  22 tmgr5   ci    tmp0,50
     6E2E 0032 
0072 6E30 1101  14 tmgr6   jlt   tmgr7                 ; No, continue
0073 6E32 1001  14         jmp   tmgr8
0074 6E34 058A  14 tmgr7   inc   r10                   ; Increase tick counter
0075               *--------------------------------------------------------------
0076               * Loop over slots
0077               *--------------------------------------------------------------
0078 6E36 C120  34 tmgr8   mov   @wtitab,tmp0          ; Pointer to timer table
     6E38 832C 
0079 6E3A 024A  22         andi  r10,>ff00             ; Use R10LB as slot counter. Reset.
     6E3C FF00 
0080 6E3E C1D4  26 tmgr9   mov   *tmp0,tmp3            ; Is slot empty ?
0081 6E40 1316  14         jeq   tmgr11                ; Yes, get next slot
0082               *--------------------------------------------------------------
0083               *  Check if slot should be executed
0084               *--------------------------------------------------------------
0085 6E42 05C4  14         inct  tmp0                  ; Second word of slot data
0086 6E44 0594  26         inc   *tmp0                 ; Update tick count in slot
0087 6E46 C194  26         mov   *tmp0,tmp2            ; Get second word of slot data
0088 6E48 9820  54         cb    @tmp2hb,@tmp2lb       ; Slot target count = Slot internal counter ?
     6E4A 830C 
     6E4C 830D 
0089 6E4E 1608  14         jne   tmgr10                ; No, get next slot
0090 6E50 0246  22         andi  tmp2,>ff00            ; Clear internal counter
     6E52 FF00 
0091 6E54 C506  30         mov   tmp2,*tmp0            ; Update timer table
0092               *--------------------------------------------------------------
0093               *  Run slot, we only need TMP0 to survive
0094               *--------------------------------------------------------------
0095 6E56 C804  38         mov   tmp0,@wtitmp          ; Save TMP0
     6E58 8330 
0096 6E5A 0697  24         bl    *tmp3                 ; Call routine in slot
0097 6E5C C120  34 slotok  mov   @wtitmp,tmp0          ; Restore TMP0
     6E5E 8330 
0098               *--------------------------------------------------------------
0099               *  Prepare for next slot
0100               *--------------------------------------------------------------
0101 6E60 058A  14 tmgr10  inc   r10                   ; Next slot
0102 6E62 9820  54         cb    @r10lb,@btihi         ; Last slot done ?
     6E64 8315 
     6E66 8314 
0103 6E68 1504  14         jgt   tmgr12                ; yes, Wait for next VDP interrupt
0104 6E6A 05C4  14         inct  tmp0                  ; Offset for next slot
0105 6E6C 10E8  14         jmp   tmgr9                 ; Process next slot
0106 6E6E 05C4  14 tmgr11  inct  tmp0                  ; Skip 2nd word of slot data
0107 6E70 10F7  14         jmp   tmgr10                ; Process next slot
0108 6E72 024A  22 tmgr12  andi  r10,>ff00             ; Use R10LB as tick counter. Reset.
     6E74 FF00 
0109 6E76 10B4  14         jmp   tmgr1
0110 6E78 0280     tmdat   data  >0280                 ; Bit 8 (kernel thread) and bit 6 (user hook)
0111               
**** **** ****     > runlib.asm
...
0014               ********|*****|*********************|**************************
0015 6E7A E0A0  34 kthread soc   @wbit8,config         ; Block kernel thread
     6E7C 2010 
0016               *--------------------------------------------------------------
...
0037               *--------------------------------------------------------------
0041 6E7E 06A0  32         bl    @realkb               ; Scan full keyboard
     6E80 27EC 
0043               *--------------------------------------------------------------
0044               kthread_exit
0045 6E82 0460  28         b     @tmgr3                ; Exit
     6E84 2D6E 
**** **** ****     > runlib.asm
...
0016               ********|*****|*********************|**************************
0017 6E86 C83B  50 mkhook  mov   *r11+,@wtiusr         ; Set user hook address
     6E88 832E 
0018 6E8A E0A0  34         soc   @wbit7,config         ; Enable user hook
     6E8C 2012 
0019 6E8E 045B  20 mkhoo1  b     *r11                  ; Return
...
0026               *  BL    @CLHOOK
0027               ********|*****|*********************|**************************
0028 6E90 04E0  34 clhook  clr   @wtiusr               ; Unset user hook address
     6E92 832E 
0029 6E94 0242  22         andi  config,>feff          ; Disable user hook (bit 7=0)
     6E96 FEFF 
0030 6E98 045B  20         b     *r11                  ; Return
**** **** ****     > runlib.asm
0230               
...
0016               ********|*****|*********************|**************************
0017 6E9A C13B  30 mkslot  mov   *r11+,tmp0
0018 6E9C C17B  30         mov   *r11+,tmp1
0019               *--------------------------------------------------------------
0020               *  Calculate address of slot
0021               *--------------------------------------------------------------
0022 6E9E C184  18         mov   tmp0,tmp2
0023 6EA0 0966  56         srl   tmp2,6                ; Right align & TMP2 = TMP2 * 4
0024 6EA2 A1A0  34         a     @wtitab,tmp2          ; Add table base
     6EA4 832C 
0025               *--------------------------------------------------------------
0026               *  Add slot to table
0027               *--------------------------------------------------------------
0028 6EA6 CD85  34         mov   tmp1,*tmp2+           ; Store address of subroutine
0029 6EA8 0A84  56         sla   tmp0,8                ; Get rid of slot number
0030 6EAA C584  30         mov   tmp0,*tmp2            ; Store target count and reset tick count
0031               *--------------------------------------------------------------
0032               *  Check for end of list
0033               *--------------------------------------------------------------
0034 6EAC 881B  46         c     *r11,@w$ffff          ; End of list ?
     6EAE 2022 
0035 6EB0 1301  14         jeq   mkslo1                ; Yes, exit
0036 6EB2 10F3  14         jmp   mkslot                ; Process next entry
0037               *--------------------------------------------------------------
0038               *  Exit
0039               *--------------------------------------------------------------
0040 6EB4 05CB  14 mkslo1  inct  r11
0041 6EB6 045B  20         b     *r11                  ; Exit
0042               
0043               
0044               ***************************************************************
...
0050               *  P0 = Slot number
0051               ********|*****|*********************|**************************
0052 6EB8 C13B  30 clslot  mov   *r11+,tmp0
0053 6EBA 0A24  56 xlslot  sla   tmp0,2                ; TMP0 = TMP0*4
0054 6EBC A120  34         a     @wtitab,tmp0          ; Add table base
     6EBE 832C 
0055 6EC0 04F4  30         clr   *tmp0+                ; Clear 1st word of slot
0056 6EC2 04D4  26         clr   *tmp0                 ; Clear 2nd word of slot
0057 6EC4 045B  20         b     *r11                  ; Exit
0058               
0059               
0060               ***************************************************************
...
0066               *  P0 = Slot number
0067               ********|*****|*********************|**************************
0068 6EC6 C13B  30 rsslot  mov   *r11+,tmp0
0069 6EC8 0A24  56         sla   tmp0,2                ; TMP0 = TMP0*4
0070 6ECA A120  34         a     @wtitab,tmp0          ; Add table base
     6ECC 832C 
0071 6ECE 05C4  14         inct  tmp0                  ; Skip 1st word of slot
0072 6ED0 C154  26         mov   *tmp0,tmp1
0073 6ED2 0245  22         andi  tmp1,>ff00            ; Clear LSB (loop counter)
     6ED4 FF00 
0074 6ED6 C505  30         mov   tmp1,*tmp0
0075 6ED8 045B  20         b     *r11                  ; Exit
**** **** ****     > runlib.asm
0234               
0235               
0236               
...
0253               ********|*****|*********************|**************************
0260 6EDA 04E0  34 runlib  clr   @>8302                ; Reset exit flag (R1 in workspace WS1!)
     6EDC 8302 
0262               *--------------------------------------------------------------
0263               * Alternative entry point
0264               *--------------------------------------------------------------
0265 6EDE 0300  24 runli1  limi  0                     ; Turn off interrupts
     6EE0 0000 
0266 6EE2 02E0  18         lwpi  ws1                   ; Activate workspace 1
     6EE4 8300 
0267 6EE6 C0E0  34         mov   @>83c0,r3             ; Get random seed from OS monitor
     6EE8 83C0 
0268               *--------------------------------------------------------------
0269               * Clear scratch-pad memory from R4 upwards
0270               *--------------------------------------------------------------
0271 6EEA 0202  20 runli2  li    r2,>8308
     6EEC 8308 
0272 6EEE 04F2  30 runli3  clr   *r2+                  ; Clear scratchpad >8306->83FF
0273 6EF0 0282  22         ci    r2,>8400
     6EF2 8400 
0274 6EF4 16FC  14         jne   runli3
0275               *--------------------------------------------------------------
0276               * Exit to TI-99/4A title screen ?
0277               *--------------------------------------------------------------
0278 6EF6 0281  22 runli3a ci    r1,>ffff              ; Exit flag set ?
     6EF8 FFFF 
0279 6EFA 1602  14         jne   runli4                ; No, continue
0280 6EFC 0420  54         blwp  @0                    ; Yes, bye bye
     6EFE 0000 
0281               *--------------------------------------------------------------
0282               * Determine if VDP is PAL or NTSC
0283               *--------------------------------------------------------------
0284 6F00 C803  38 runli4  mov   r3,@waux1             ; Store random seed
     6F02 833C 
0285 6F04 04C1  14         clr   r1                    ; Reset counter
0286 6F06 0202  20         li    r2,10                 ; We test 10 times
     6F08 000A 
0287 6F0A C0E0  34 runli5  mov   @vdps,r3
     6F0C 8802 
0288 6F0E 20E0  38         coc   @wbit0,r3             ; Interupt flag set ?
     6F10 2020 
0289 6F12 1302  14         jeq   runli6
0290 6F14 0581  14         inc   r1                    ; Increase counter
0291 6F16 10F9  14         jmp   runli5
0292 6F18 0602  14 runli6  dec   r2                    ; Next test
0293 6F1A 16F7  14         jne   runli5
0294 6F1C 0281  22         ci    r1,>1250              ; Max for NTSC reached ?
     6F1E 1250 
0295 6F20 1202  14         jle   runli7                ; No, so it must be NTSC
0296 6F22 0262  22         ori   config,palon          ; Yes, it must be PAL, set flag
     6F24 201C 
0297               *--------------------------------------------------------------
0298               * Copy machine code to scratchpad (prepare tight loop)
0299               *--------------------------------------------------------------
0300 6F26 06A0  32 runli7  bl    @loadmc
     6F28 221C 
0301               *--------------------------------------------------------------
0302               * Initialize registers, memory, ...
0303               *--------------------------------------------------------------
0304 6F2A 04C1  14 runli9  clr   r1
0305 6F2C 04C2  14         clr   r2
0306 6F2E 04C3  14         clr   r3
0307 6F30 0209  20         li    stack,sp2.stktop      ; Set top of stack (grows downwards!)
     6F32 3000 
0308 6F34 020F  20         li    r15,vdpw              ; Set VDP write address
     6F36 8C00 
0312               *--------------------------------------------------------------
0313               * Setup video memory
0314               *--------------------------------------------------------------
0316 6F38 0280  22         ci    r0,>4a4a              ; Crash flag set?
     6F3A 4A4A 
0317 6F3C 1605  14         jne   runlia
0318 6F3E 06A0  32         bl    @filv                 ; Clear 12K VDP memory instead
     6F40 2290 
0319 6F42 0000             data  >0000,>00,>3000       ; of 16K, so that PABs survive
     6F44 0000 
     6F46 3000 
0324 6F48 06A0  32 runlia  bl    @filv
     6F4A 2290 
0325 6F4C 0FC0             data  pctadr,spfclr,16      ; Load color table
     6F4E 00F4 
     6F50 0010 
0326               *--------------------------------------------------------------
0327               * Check if there is a F18A present
0328               *--------------------------------------------------------------
0332 6F52 06A0  32         bl    @f18unl               ; Unlock the F18A
     6F54 2734 
0333 6F56 06A0  32         bl    @f18chk               ; Check if F18A is there
     6F58 274E 
0334 6F5A 06A0  32         bl    @f18lck               ; Lock the F18A again
     6F5C 2744 
0335               
0336 6F5E 06A0  32         bl    @putvr                ; Reset all F18a extended registers
     6F60 2334 
0337 6F62 3201                   data >3201            ; F18a VR50 (>32), bit 1
0339               *--------------------------------------------------------------
...
0349               *--------------------------------------------------------------
0350 6F64 06A0  32 runlic  bl    @vidtab               ; Load video mode table into VDP
     6F66 22FA 
0351 6F68 3386             data  spvmod                ; Equate selected video mode table
0352 6F6A 0204  20         li    tmp0,spfont           ; Get font option
     6F6C 000C 
0353 6F6E 0544  14         inv   tmp0                  ; NOFONT (>FFFF) specified ?
0354 6F70 1304  14         jeq   runlid                ; Yes, skip it
0355 6F72 06A0  32         bl    @ldfnt
     6F74 2362 
0356 6F76 1100             data  fntadr,spfont         ; Load specified font
     6F78 000C 
0357               *--------------------------------------------------------------
0358               * Did a system crash occur before runlib was called?
0359               *--------------------------------------------------------------
0360 6F7A 0280  22 runlid  ci    r0,>4a4a              ; Crash flag set?
     6F7C 4A4A 
0361 6F7E 1602  14         jne   runlie                ; No, continue
0362 6F80 0460  28         b     @cpu.crash.main       ; Yes, back to crash handler
     6F82 2086 
0363               *--------------------------------------------------------------
0364               * Branch to main program
0365               *--------------------------------------------------------------
0366 6F84 0262  22 runlie  ori   config,>0040          ; Enable kernel thread (bit 9 on)
     6F86 0040 
0367 6F88 0460  28         b     @main                 ; Give control to main program
     6F8A 3000 
**** **** ****     > stevie_b0.asm.373084
0124                                                   ; Spectra 2
0125                       ;------------------------------------------------------
...
0127                       ;------------------------------------------------------
0128 6F8C DEAD             data  >dead,>beef,>dead,>beef
     6F8E BEEF 
     6F90 DEAD 
     6F92 BEEF 
0130               
0134 6F94 2EFE                   data $                ; Bank 0 ROM size OK.
0136               
0137 6F96 ....             bss  300                    ; Fill remaining space with >00
0138               
0139               ***************************************************************
...
0146                       ;------------------------------------------------------
0147               main:
0148 70C2 04E0  34         clr   @bank1                ; Activate bank 1 "James"
     70C4 6002 
0149 70C6 0460  28         b     @kickstart.code2      ; Jump to entry routine
     70C8 6036 
0150                       ;------------------------------------------------------
...
0020               ********|*****|*********************|**************************
0021               rom.farjump:
0022 70CA C13B  30         mov   *r11+,tmp0            ; P0
0023 70CC C17B  30         mov   *r11+,tmp1            ; P1
0024 70CE C1BB  30         mov   *r11+,tmp2            ; P2
0025                       ;------------------------------------------------------
0026                       ; Push registers to value stack (but not r11!)
0027                       ;------------------------------------------------------
0028               xrom.farjump:
0029 70D0 0649  14         dect  stack
0030 70D2 C644  30         mov   tmp0,*stack           ; Push tmp0
0031 70D4 0649  14         dect  stack
0032 70D6 C645  30         mov   tmp1,*stack           ; Push tmp1
0033 70D8 0649  14         dect  stack
0034 70DA C646  30         mov   tmp2,*stack           ; Push tmp2
0035 70DC 0649  14         dect  stack
0036 70DE C647  30         mov   tmp3,*stack           ; Push tmp3
0037                       ;------------------------------------------------------
0038                       ; Push to farjump return stack
0039                       ;------------------------------------------------------
0040 70E0 0284  22         ci    tmp0,>6000            ; Invalid bank write address?
     70E2 6000 
0041 70E4 110C  14         jlt   rom.farjump.bankswitch.failed1
0042                                                   ; Crash if null value in bank write address
0043               
0044 70E6 C1E0  34         mov   @tv.fj.stackpnt,tmp3  ; Get farjump stack pointer
     70E8 A026 
0045 70EA 0647  14         dect  tmp3
0046 70EC C5CB  30         mov   r11,*tmp3             ; Push return address to farjump stack
0047 70EE 0647  14         dect  tmp3
0048 70F0 C5C6  30         mov   tmp2,*tmp3            ; Push source ROM bank to farjump stack
0049 70F2 C807  38         mov   tmp3,@tv.fj.stackpnt  ; Set farjump stack pointer
     70F4 A026 
0050                       ;------------------------------------------------------
0051                       ; Bankswitch to target bank
0052                       ;------------------------------------------------------
0053               rom.farjump.bankswitch:
0054 70F6 04D4  26         clr   *tmp0                 ; Switch to target ROM bank
0055 70F8 C115  26         mov   *tmp1,tmp0            ; Deref value in vector address
0056 70FA 1301  14         jeq   rom.farjump.bankswitch.failed1
0057                                                   ; Crash if null-pointer in vector
0058 70FC 1004  14         jmp   rom.farjump.bankswitch.call
0059                                                   ; Call function in target bank
0060                       ;------------------------------------------------------
0061                       ; Assert 1 failed before bank-switch
0062                       ;------------------------------------------------------
0063               rom.farjump.bankswitch.failed1:
0064 70FE C80B  38         mov   r11,@>ffce            ; \ Save caller address
     7100 FFCE 
0065 7102 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     7104 2026 
0066                       ;------------------------------------------------------
0067                       ; Call function in target bank
0068                       ;------------------------------------------------------
0069               rom.farjump.bankswitch.call:
0070 7106 0694  24         bl    *tmp0                 ; Call function
0071                       ;------------------------------------------------------
0072                       ; Bankswitch back to source bank
0073                       ;------------------------------------------------------
0074               rom.farjump.return:
0075 7108 C120  34         mov   @tv.fj.stackpnt,tmp0  ; Get farjump stack pointer
     710A A026 
0076 710C C154  26         mov   *tmp0,tmp1            ; Get bank write address of caller
0077 710E 130D  14         jeq   rom.farjump.bankswitch.failed2
0078                                                   ; Crash if null-pointer in address
0079               
0080 7110 04F4  30         clr   *tmp0+                ; Remove bank write address from
0081                                                   ; farjump stack
0082               
0083 7112 C2D4  26         mov   *tmp0,r11             ; Get return addr of caller for return
0084               
0085 7114 04F4  30         clr   *tmp0+                ; Remove return address of caller from
0086                                                   ; farjump stack
0087               
0088 7116 028B  22         ci    r11,>6000
     7118 6000 
0089 711A 1107  14         jlt   rom.farjump.bankswitch.failed2
0090 711C 028B  22         ci    r11,>7fff
     711E 7FFF 
0091 7120 1504  14         jgt   rom.farjump.bankswitch.failed2
0092               
0093 7122 C804  38         mov   tmp0,@tv.fj.stackpnt  ; Update farjump return stack pointer
     7124 A026 
0094 7126 04D5  26         clr   *tmp1                 ; Switch to bank of caller
0095 7128 1004  14         jmp   rom.farjump.exit
0096                       ;------------------------------------------------------
0097                       ; Assert 2 failed after bank-switch
0098                       ;------------------------------------------------------
0099               rom.farjump.bankswitch.failed2:
0100 712A C80B  38         mov   r11,@>ffce            ; \ Save caller address
     712C FFCE 
0101 712E 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     7130 2026 
0102                       ;-------------------------------------------------------
0103                       ; Exit
0104                       ;-------------------------------------------------------
0105               rom.farjump.exit:
0106 7132 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0107 7134 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0108 7136 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0109 7138 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0110 713A 045B  20         b     *r11                  ; Return to caller
**** **** ****     > ram.resident.3000.asm
...
0021 713E C64B  30         mov   r11,*stack            ; Save return address
0022 7140 0649  14         dect  stack
0023 7142 C644  30         mov   tmp0,*stack           ; Push tmp0
0024 7144 0649  14         dect  stack
0025 7146 C645  30         mov   tmp1,*stack           ; Push tmp1
0026                       ;------------------------------------------------------
0027                       ; Initialize
0028                       ;------------------------------------------------------
0029 7148 0204  20         li    tmp0,fb.top
     714A A600 
0030 714C C804  38         mov   tmp0,@fb.top.ptr      ; Set pointer to framebuffer
     714E A100 
0031 7150 04E0  34         clr   @fb.topline           ; Top line in framebuffer
     7152 A104 
0032 7154 04E0  34         clr   @fb.row               ; Current row=0
     7156 A106 
0033 7158 04E0  34         clr   @fb.column            ; Current column=0
     715A A10C 
0034               
0035 715C 0204  20         li    tmp0,colrow
     715E 0050 
0036 7160 C804  38         mov   tmp0,@fb.colsline     ; Columns per row=80
     7162 A10E 
0037                       ;------------------------------------------------------
0038                       ; Determine size of rows on screen
0039                       ;------------------------------------------------------
0040 7164 C160  34         mov   @tv.ruler.visible,tmp1
     7166 A010 
0041 7168 1303  14         jeq   !                     ; Skip if ruler is hidden
0042 716A 0204  20         li    tmp0,pane.botrow-2
     716C 001B 
0043 716E 1002  14         jmp   fb.init.cont
0044 7170 0204  20 !       li    tmp0,pane.botrow-1
     7172 001C 
0045                       ;------------------------------------------------------
0046                       ; Continue initialisation
0047                       ;------------------------------------------------------
0048               fb.init.cont:
0049 7174 C804  38         mov   tmp0,@fb.scrrows      ; Physical rows on screen for fb
     7176 A11A 
0050 7178 C804  38         mov   tmp0,@fb.scrrows.max  ; Maximum number of physical rows for fb
     717A A11C 
0051               
0052 717C 04E0  34         clr   @tv.pane.focus        ; Frame buffer has focus!
     717E A022 
0053 7180 04E0  34         clr   @fb.colorize          ; Don't colorize M1/M2 lines
     7182 A110 
0054 7184 0720  34         seto  @fb.dirty             ; Set dirty flag (trigger screen update)
     7186 A116 
0055 7188 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     718A A118 
0056                       ;------------------------------------------------------
0057                       ; Clear frame buffer
0058                       ;------------------------------------------------------
0059 718C 06A0  32         bl    @film
     718E 2238 
0060 7190 A600             data  fb.top,>00,fb.size    ; Clear it all the way
     7192 0000 
     7194 0960 
0061                       ;------------------------------------------------------
0062                       ; Exit
0063                       ;------------------------------------------------------
0064               fb.init.exit:
0065 7196 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0066 7198 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0067 719A C2F9  30         mov   *stack+,r11           ; Pop r11
0068 719C 045B  20         b     *r11                  ; Return to caller
0069               
**** **** ****     > ram.resident.3000.asm
...
0044               ********|*****|*********************|**************************
0045               idx.init:
0046 719E 0649  14         dect  stack
0047 71A0 C64B  30         mov   r11,*stack            ; Save return address
0048 71A2 0649  14         dect  stack
0049 71A4 C644  30         mov   tmp0,*stack           ; Push tmp0
0050                       ;------------------------------------------------------
0051                       ; Initialize
0052                       ;------------------------------------------------------
0053 71A6 0204  20         li    tmp0,idx.top
     71A8 B000 
0054 71AA C804  38         mov   tmp0,@edb.index.ptr   ; Set pointer to index in editor structure
     71AC A202 
0055               
0056 71AE C120  34         mov   @tv.sams.b000,tmp0
     71B0 A006 
0057 71B2 C804  38         mov   tmp0,@idx.sams.page   ; Set current SAMS page
     71B4 A500 
0058 71B6 C804  38         mov   tmp0,@idx.sams.lopage ; Set 1st SAMS page
     71B8 A502 
0059                       ;------------------------------------------------------
0060                       ; Clear all index pages
0061                       ;------------------------------------------------------
0062 71BA 0224  22         ai    tmp0,4                ; \ Let's clear all index pages
     71BC 0004 
0063 71BE C804  38         mov   tmp0,@idx.sams.hipage ; /
     71C0 A504 
0064               
0065 71C2 06A0  32         bl    @_idx.sams.mapcolumn.on
     71C4 311E 
0066                                                   ; Index in continuous memory region
0067               
0068 71C6 06A0  32         bl    @film
     71C8 2238 
0069 71CA B000                   data idx.top,>00,idx.size * 5
     71CC 0000 
     71CE 5000 
0070                                                   ; Clear index
0071               
0072 71D0 06A0  32         bl    @_idx.sams.mapcolumn.off
     71D2 3152 
0073                                                   ; Restore memory window layout
0074               
0075 71D4 C820  54         mov   @idx.sams.lopage,@idx.sams.hipage
     71D6 A502 
     71D8 A504 
...
0079                       ;------------------------------------------------------
0080               idx.init.exit:
0081 71DA C139  30         mov   *stack+,tmp0          ; Pop tmp0
0082 71DC C2F9  30         mov   *stack+,r11           ; Pop r11
0083 71DE 045B  20         b     *r11                  ; Return to caller
0084               
0085               
0086               ***************************************************************
...
0096 71E0 0649  14         dect  stack
0097 71E2 C64B  30         mov   r11,*stack            ; Push return address
0098 71E4 0649  14         dect  stack
0099 71E6 C644  30         mov   tmp0,*stack           ; Push tmp0
0100 71E8 0649  14         dect  stack
0101 71EA C645  30         mov   tmp1,*stack           ; Push tmp1
0102 71EC 0649  14         dect  stack
0103 71EE C646  30         mov   tmp2,*stack           ; Push tmp2
0104               *--------------------------------------------------------------
0105               * Map index pages into memory window  (b000-ffff)
0106               *--------------------------------------------------------------
0107 71F0 C120  34         mov   @idx.sams.lopage,tmp0 ; Get lowest index page
     71F2 A502 
0108 71F4 0205  20         li    tmp1,idx.top
     71F6 B000 
0109 71F8 0206  20         li    tmp2,5                ; Set loop counter. all pages of index
     71FA 0005 
0110                       ;-------------------------------------------------------
0111                       ; Loop over banks
0112                       ;-------------------------------------------------------
0113 71FC 06A0  32 !       bl    @xsams.page.set       ; Set SAMS page
     71FE 2578 
0114                                                   ; \ i  tmp0  = SAMS page number
0115                                                   ; / i  tmp1  = Memory address
0116               
0117 7200 0584  14         inc   tmp0                  ; Next SAMS index page
0118 7202 0225  22         ai    tmp1,>1000            ; Next memory region
     7204 1000 
0119 7206 0606  14         dec   tmp2                  ; Update loop counter
0120 7208 15F9  14         jgt   -!                    ; Next iteration
0121               *--------------------------------------------------------------
0122               * Exit
0123               *--------------------------------------------------------------
0124               _idx.sams.mapcolumn.on.exit:
0125 720A C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0126 720C C179  30         mov   *stack+,tmp1          ; Pop tmp1
0127 720E C139  30         mov   *stack+,tmp0          ; Pop tmp0
0128 7210 C2F9  30         mov   *stack+,r11           ; Pop return address
0129 7212 045B  20         b     *r11                  ; Return to caller
0130               
0131               
0132               ***************************************************************
...
0145 7214 0649  14         dect  stack
0146 7216 C64B  30         mov   r11,*stack            ; Push return address
0147 7218 0649  14         dect  stack
0148 721A C644  30         mov   tmp0,*stack           ; Push tmp0
0149 721C 0649  14         dect  stack
0150 721E C645  30         mov   tmp1,*stack           ; Push tmp1
0151 7220 0649  14         dect  stack
0152 7222 C646  30         mov   tmp2,*stack           ; Push tmp2
0153 7224 0649  14         dect  stack
0154 7226 C647  30         mov   tmp3,*stack           ; Push tmp3
0155               *--------------------------------------------------------------
0156               * Map index pages into memory window  (b000-????)
0157               *--------------------------------------------------------------
0158 7228 0205  20         li    tmp1,idx.top
     722A B000 
0159 722C 0206  20         li    tmp2,5                ; Always 5 pages
     722E 0005 
0160 7230 0207  20         li    tmp3,tv.sams.b000     ; Pointer to fist SAMS page
     7232 A006 
0161                       ;-------------------------------------------------------
0162                       ; Loop over table in memory (@tv.sams.b000:@tv.sams.f000)
0163                       ;-------------------------------------------------------
0164 7234 C137  30 !       mov   *tmp3+,tmp0           ; Get SAMS page
0165               
0166 7236 06A0  32         bl    @xsams.page.set       ; Set SAMS page
     7238 2578 
0167                                                   ; \ i  tmp0  = SAMS page number
0168                                                   ; / i  tmp1  = Memory address
0169               
0170 723A 0225  22         ai    tmp1,>1000            ; Next memory region
     723C 1000 
0171 723E 0606  14         dec   tmp2                  ; Update loop counter
0172 7240 15F9  14         jgt   -!                    ; Next iteration
0173               *--------------------------------------------------------------
0174               * Exit
0175               *--------------------------------------------------------------
0176               _idx.sams.mapcolumn.off.exit:
0177 7242 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0178 7244 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0179 7246 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0180 7248 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0181 724A C2F9  30         mov   *stack+,r11           ; Pop return address
0182 724C 045B  20         b     *r11                  ; Return to caller
0183               
0184               
0185               
0186               ***************************************************************
...
0206 724E 0649  14         dect  stack
0207 7250 C64B  30         mov   r11,*stack            ; Save return address
0208 7252 0649  14         dect  stack
0209 7254 C644  30         mov   tmp0,*stack           ; Push tmp0
0210 7256 0649  14         dect  stack
0211 7258 C645  30         mov   tmp1,*stack           ; Push tmp1
0212 725A 0649  14         dect  stack
0213 725C C646  30         mov   tmp2,*stack           ; Push tmp2
0214                       ;------------------------------------------------------
0215                       ; Determine SAMS index page
0216                       ;------------------------------------------------------
0217 725E C184  18         mov   tmp0,tmp2             ; Line number
0218 7260 04C5  14         clr   tmp1                  ; MSW (tmp1) = 0 / LSW (tmp2) = Line number
0219 7262 0204  20         li    tmp0,2048             ; Index entries in 4K SAMS page
     7264 0800 
0220               
0221 7266 3D44  128         div   tmp0,tmp1             ; \ Divide 32 bit value by 2048
0222                                                   ; | tmp1 = quotient  (SAMS page offset)
0223                                                   ; / tmp2 = remainder
0224               
0225 7268 0A16  56         sla   tmp2,1                ; line number * 2
0226 726A C806  38         mov   tmp2,@outparm1        ; Offset index entry
     726C 2F30 
0227               
0228 726E A160  34         a     @idx.sams.lopage,tmp1 ; Add SAMS page base
     7270 A502 
0229 7272 8805  38         c     tmp1,@idx.sams.page   ; Page already active?
     7274 A500 
0230               
0231 7276 130E  14         jeq   _idx.samspage.get.exit
0232                                                   ; Yes, so exit
0233                       ;------------------------------------------------------
0234                       ; Activate SAMS index page
0235                       ;------------------------------------------------------
0236 7278 C805  38         mov   tmp1,@idx.sams.page   ; Set current SAMS page
     727A A500 
0237 727C C805  38         mov   tmp1,@tv.sams.b000    ; Also keep SAMS window synced in Stevie
     727E A006 
0238               
0239 7280 C105  18         mov   tmp1,tmp0             ; Destination SAMS page
0240 7282 0205  20         li    tmp1,>b000            ; Memory window for index page
     7284 B000 
0241               
0242 7286 06A0  32         bl    @xsams.page.set       ; Switch to SAMS page
     7288 2578 
...
0247                       ;------------------------------------------------------
0248 728A 8804  38         c     tmp0,@idx.sams.hipage ; New highest page?
     728C A504 
0249 728E 1202  14         jle   _idx.samspage.get.exit
0250                                                   ; No, exit
0251 7290 C804  38         mov   tmp0,@idx.sams.hipage ; Yes, set highest SAMS index page
     7292 A504 
0252                       ;------------------------------------------------------
0253                       ; Exit
0254                       ;------------------------------------------------------
0255               _idx.samspage.get.exit:
0256 7294 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0257 7296 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0258 7298 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0259 729A C2F9  30         mov   *stack+,r11           ; Pop r11
0260 729C 045B  20         b     *r11                  ; Return to caller
**** **** ****     > ram.resident.3000.asm
...
0027                       ; Initialize
0028                       ;------------------------------------------------------
0029 72A6 0204  20         li    tmp0,edb.top          ; \
     72A8 C000 
0030 72AA C804  38         mov   tmp0,@edb.top.ptr     ; / Set pointer to top of editor buffer
     72AC A200 
0031 72AE C804  38         mov   tmp0,@edb.next_free.ptr
     72B0 A208 
0032                                                   ; Set pointer to next free line
0033               
0034 72B2 0720  34         seto  @edb.insmode          ; Turn on insert mode for this editor buffer
     72B4 A20A 
0035               
0036 72B6 0204  20         li    tmp0,1
     72B8 0001 
0037 72BA C804  38         mov   tmp0,@edb.lines       ; Lines=1
     72BC A204 
0038               
0039 72BE 0720  34         seto  @edb.block.m1         ; Reset block start line
     72C0 A20C 
0040 72C2 0720  34         seto  @edb.block.m2         ; Reset block end line
     72C4 A20E 
0041               
0042 72C6 0204  20         li    tmp0,txt.newfile      ; "New file"
     72C8 3506 
0043 72CA C804  38         mov   tmp0,@edb.filename.ptr
     72CC A212 
0044               
0045 72CE 0204  20         li    tmp0,txt.filetype.none
     72D0 35C6 
0046 72D2 C804  38         mov   tmp0,@edb.filetype.ptr
     72D4 A214 
0047               
0048               edb.init.exit:
0049                       ;------------------------------------------------------
0050                       ; Exit
0051                       ;------------------------------------------------------
0052 72D6 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0053 72D8 C2F9  30         mov   *stack+,r11           ; Pop r11
0054 72DA 045B  20         b     *r11                  ; Return to caller
0055               
0056               
0057               
0058               
...
0020               ********|*****|*********************|**************************
0021               cmdb.init:
0022 72DC 0649  14         dect  stack
0023 72DE C64B  30         mov   r11,*stack            ; Save return address
0024 72E0 0649  14         dect  stack
0025 72E2 C644  30         mov   tmp0,*stack           ; Push tmp0
0026                       ;------------------------------------------------------
0027                       ; Initialize
0028                       ;------------------------------------------------------
0029 72E4 0204  20         li    tmp0,cmdb.top         ; \ Set pointer to command buffer
     72E6 D000 
0030 72E8 C804  38         mov   tmp0,@cmdb.top.ptr    ; /
     72EA A300 
0031               
0032 72EC 04E0  34         clr   @cmdb.visible         ; Hide command buffer
     72EE A302 
0033 72F0 0204  20         li    tmp0,4
     72F2 0004 
0034 72F4 C804  38         mov   tmp0,@cmdb.scrrows    ; Set current command buffer size
     72F6 A306 
0035 72F8 C804  38         mov   tmp0,@cmdb.default    ; Set default command buffer size
     72FA A308 
0036               
0037 72FC 04E0  34         clr   @cmdb.lines           ; Number of lines in cmdb buffer
     72FE A316 
0038 7300 04E0  34         clr   @cmdb.dirty           ; Command buffer is clean
     7302 A318 
0039 7304 04E0  34         clr   @cmdb.action.ptr      ; Reset action to execute pointer
     7306 A324 
0040                       ;------------------------------------------------------
0041                       ; Clear command buffer
0042                       ;------------------------------------------------------
0043 7308 06A0  32         bl    @film
     730A 2238 
0044 730C D000             data  cmdb.top,>00,cmdb.size
     730E 0000 
     7310 1000 
...
0048                       ; Exit
0049                       ;------------------------------------------------------
0050 7312 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0051 7314 C2F9  30         mov   *stack+,r11           ; Pop r11
0052 7316 045B  20         b     *r11                  ; Return to caller
**** **** ****     > ram.resident.3000.asm
...
0027                       ; Initialize
0028                       ;------------------------------------------------------
0029 7320 04E0  34         clr   @tv.error.visible     ; Set to hidden
     7322 A028 
0030               
0031 7324 06A0  32         bl    @film
     7326 2238 
0032 7328 A02A                   data tv.error.msg,0,160
     732A 0000 
     732C 00A0 
0033                       ;-------------------------------------------------------
0034                       ; Exit
0035                       ;-------------------------------------------------------
0036               errline.exit:
0037 732E C139  30         mov   *stack+,tmp0          ; Pop tmp0
0038 7330 C2F9  30         mov   *stack+,r11           ; Pop R11
0039 7332 045B  20         b     *r11                  ; Return to caller
0040               
**** **** ****     > ram.resident.3000.asm
...
0027                       ; Initialize
0028                       ;------------------------------------------------------
0029 733C 0204  20         li    tmp0,1                ; \ Set default color scheme
     733E 0001 
0030 7340 C804  38         mov   tmp0,@tv.colorscheme  ; /
     7342 A012 
0031               
0032 7344 04E0  34         clr   @tv.task.oneshot      ; Reset pointer to oneshot task
     7346 A024 
0033 7348 E0A0  34         soc   @wbit10,config        ; Assume ALPHA LOCK is down
     734A 200C 
0034               
0035 734C 0204  20         li    tmp0,fj.bottom
     734E F000 
0036 7350 C804  38         mov   tmp0,@tv.fj.stackpnt  ; Set pointer to farjump return stack
     7352 A026 
0037                       ;-------------------------------------------------------
0038                       ; Exit
0039                       ;-------------------------------------------------------
0040               tv.init.exit:
0041 7354 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0042 7356 C2F9  30         mov   *stack+,r11           ; Pop R11
0043 7358 045B  20         b     *r11                  ; Return to caller
0044               
0045               
0046               
0047               ***************************************************************
...
0063               ***************************************************************
0064               tv.reset:
0065 735A 0649  14         dect  stack
0066 735C C64B  30         mov   r11,*stack            ; Save return address
0067                       ;------------------------------------------------------
0068                       ; Reset editor
0069                       ;------------------------------------------------------
0070 735E 06A0  32         bl    @cmdb.init            ; Initialize command buffer
     7360 321A 
0071 7362 06A0  32         bl    @edb.init             ; Initialize editor buffer
     7364 31DC 
0072 7366 06A0  32         bl    @idx.init             ; Initialize index
     7368 30DC 
0073 736A 06A0  32         bl    @fb.init              ; Initialize framebuffer
     736C 307A 
0074 736E 06A0  32         bl    @errline.init         ; Initialize error line
     7370 3256 
0075                       ;------------------------------------------------------
0076                       ; Remove markers and shortcuts
0077                       ;------------------------------------------------------
0078 7372 06A0  32         bl    @hchar
     7374 27C4 
0079 7376 0034                   byte 0,52,32,18           ; Remove markers
     7378 2012 
0080 737A 1D00                   byte pane.botrow,0,32,50  ; Remove block shortcuts
     737C 2032 
0081 737E FFFF                   data eol
0082                       ;-------------------------------------------------------
0083                       ; Exit
0084                       ;-------------------------------------------------------
0085               tv.reset.exit:
0086 7380 C2F9  30         mov   *stack+,r11           ; Pop R11
0087 7382 045B  20         b     *r11                  ; Return to caller
**** **** ****     > ram.resident.3000.asm
...
0020 7384 0649  14         dect  stack
0021 7386 C64B  30         mov   r11,*stack            ; Save return address
0022 7388 0649  14         dect  stack
0023 738A C644  30         mov   tmp0,*stack           ; Push tmp0
0024                       ;------------------------------------------------------
0025                       ; Initialize
0026                       ;------------------------------------------------------
0027 738C 06A0  32         bl    @mknum                ; Convert unsigned number to string
     738E 29D6 
0028 7390 2F20                   data parm1            ; \ i p0  = Pointer to 16bit unsigned number
0029 7392 2F6A                   data rambuf           ; | i p1  = Pointer to 5 byte string buffer
0030 7394 3020                   byte 48               ; | i p2H = Offset for ASCII digit 0
0031                             byte 32               ; / i p2L = Char for replacing leading 0's
0032               
0033 7396 0204  20         li    tmp0,unpacked.string
     7398 2F44 
0034 739A 04F4  30         clr   *tmp0+                ; Clear string 01
0035 739C 04F4  30         clr   *tmp0+                ; Clear string 23
0036 739E 04F4  30         clr   *tmp0+                ; Clear string 34
0037               
0038 73A0 06A0  32         bl    @trimnum              ; Trim unsigned number string
     73A2 2A2E 
0039 73A4 2F6A                   data rambuf           ; \ i p0  = Pointer to 5 byte string buffer
0040 73A6 2F44                   data unpacked.string  ; | i p1  = Pointer to output buffer
0041 73A8 0020                   data 32               ; / i p2  = Padding char to match against
0042                       ;-------------------------------------------------------
0043                       ; Exit
0044                       ;-------------------------------------------------------
0045               tv.unpack.uint16.exit:
0046 73AA C139  30         mov   *stack+,tmp0          ; Pop tmp0
0047 73AC C2F9  30         mov   *stack+,r11           ; Pop r11
0048 73AE 045B  20         b     *r11                  ; Return to caller
0049               
0050               
0051               
0052               
...
0071               ***************************************************************
0072               tv.pad.string:
0073 73B0 0649  14         dect  stack
0074 73B2 C64B  30         mov   r11,*stack            ; Push return address
0075 73B4 0649  14         dect  stack
0076 73B6 C644  30         mov   tmp0,*stack           ; Push tmp0
0077 73B8 0649  14         dect  stack
0078 73BA C645  30         mov   tmp1,*stack           ; Push tmp1
0079 73BC 0649  14         dect  stack
0080 73BE C646  30         mov   tmp2,*stack           ; Push tmp2
0081 73C0 0649  14         dect  stack
0082 73C2 C647  30         mov   tmp3,*stack           ; Push tmp3
0083                       ;------------------------------------------------------
0084                       ; Asserts
0085                       ;------------------------------------------------------
0086 73C4 C120  34         mov   @parm1,tmp0           ; \ Get string prefix (length-byte)
     73C6 2F20 
0087 73C8 D194  26         movb  *tmp0,tmp2            ; /
0088 73CA 0986  56         srl   tmp2,8                ; Right align
0089 73CC C1C6  18         mov   tmp2,tmp3             ; Make copy of length-byte for later use
0090               
0091 73CE 8806  38         c     tmp2,@parm2           ; String length > requested length?
     73D0 2F22 
0092 73D2 1520  14         jgt   tv.pad.string.panic   ; Yes, crash
0093                       ;------------------------------------------------------
0094                       ; Copy string to buffer
0095                       ;------------------------------------------------------
0096 73D4 C120  34         mov   @parm1,tmp0           ; Get source address
     73D6 2F20 
0097 73D8 C160  34         mov   @parm4,tmp1           ; Get destination address
     73DA 2F26 
0098 73DC 0586  14         inc   tmp2                  ; Also include length-byte in copy
0099               
0100 73DE 0649  14         dect  stack
0101 73E0 C647  30         mov   tmp3,*stack           ; Push tmp3 (get overwritten by xpym2m)
0102               
0103 73E2 06A0  32         bl    @xpym2m               ; Copy length-prefix string to buffer
     73E4 24E2 
0104                                                   ; \ i  tmp0 = Source CPU memory address
0105                                                   ; | i  tmp1 = Target CPU memory address
0106                                                   ; / i  tmp2 = Number of bytes to copy
0107               
0108 73E6 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0109                       ;------------------------------------------------------
0110                       ; Set length of new string
0111                       ;------------------------------------------------------
0112 73E8 C120  34         mov   @parm2,tmp0           ; Get requested length
     73EA 2F22 
0113 73EC 0A84  56         sla   tmp0,8                ; Left align
0114 73EE C160  34         mov   @parm4,tmp1           ; Get pointer to buffer
     73F0 2F26 
0115 73F2 D544  30         movb  tmp0,*tmp1            ; Set new length of string
0116 73F4 A147  18         a     tmp3,tmp1             ; \ Skip to end of string
0117 73F6 0585  14         inc   tmp1                  ; /
0118                       ;------------------------------------------------------
0119                       ; Prepare for padding string
0120                       ;------------------------------------------------------
0121 73F8 C1A0  34         mov   @parm2,tmp2           ; \ Get number of bytes to fill
     73FA 2F22 
0122 73FC 6187  18         s     tmp3,tmp2             ; |
0123 73FE 0586  14         inc   tmp2                  ; /
0124               
0125 7400 C120  34         mov   @parm3,tmp0           ; Get byte to padd
     7402 2F24 
0126 7404 0A84  56         sla   tmp0,8                ; Left align
0127                       ;------------------------------------------------------
0128                       ; Right-pad string to destination length
0129                       ;------------------------------------------------------
0130               tv.pad.string.loop:
0131 7406 DD44  32         movb  tmp0,*tmp1+           ; Pad character
0132 7408 0606  14         dec   tmp2                  ; Update loop counter
0133 740A 15FD  14         jgt   tv.pad.string.loop    ; Next character
0134               
0135 740C C820  54         mov   @parm4,@outparm1      ; Set pointer to padded string
     740E 2F26 
     7410 2F30 
0136 7412 1004  14         jmp   tv.pad.string.exit    ; Exit
0137                       ;-----------------------------------------------------------------------
0138                       ; CPU crash
0139                       ;-----------------------------------------------------------------------
0140               tv.pad.string.panic:
0141 7414 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     7416 FFCE 
0142 7418 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     741A 2026 
0143                       ;------------------------------------------------------
0144                       ; Exit
0145                       ;------------------------------------------------------
0146               tv.pad.string.exit:
0147 741C C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0148 741E C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0149 7420 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0150 7422 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0151 7424 C2F9  30         mov   *stack+,r11           ; Pop r11
0152 7426 045B  20         b     *r11                  ; Return to caller
**** **** ****     > ram.resident.3000.asm
...
0017 7428 0649  14         dect  stack
0018 742A C64B  30         mov   r11,*stack            ; Save return address
0019                       ;------------------------------------------------------
0020                       ; Set SAMS standard layout
0021                       ;------------------------------------------------------
0022 742C 06A0  32         bl    @sams.layout
     742E 25E4 
0023 7430 339E                   data mem.sams.layout.data
0024               
0025 7432 06A0  32         bl    @sams.layout.copy
     7434 2648 
0026 7436 A000                   data tv.sams.2000     ; Get SAMS windows
0027               
0028 7438 C820  54         mov   @tv.sams.c000,@edb.sams.page
     743A A008 
     743C A216 
0029 743E C820  54         mov   @edb.sams.page,@edb.sams.hipage
     7440 A216 
     7442 A218 
...
0035 7444 C2F9  30         mov   *stack+,r11           ; Pop r11
0036 7446 045B  20         b     *r11                  ; Return to caller
**** **** ****     > ram.resident.3000.asm
...
0031               ***************************************************************
0032               stevie.tx8030:
0033 7448 04F0             byte  >04,>f0,>00,>3f,>02,>43,>05,SPFCLR,0,80
     744A 003F 
     744C 0243 
     744E 05F4 
     7450 0050 
0034               
0035               romsat:
0036 7452 0000             data  >0000,>0001             ; Cursor YX, initial shape and colour
     7454 0001 
0037 7456 0000             data  >0000,>0301             ; Current line indicator
     7458 0301 
0038 745A 0820             data  >0820,>0401             ; Current line indicator
     745C 0401 
0039               nosprite:
0040 745E D000             data  >d000                   ; End-of-Sprites list
0041               
0042               
0043               ***************************************************************
...
0047 7460 2000             data  >2000,>0002           ; >2000-2fff, SAMS page >02
     7462 0002 
0048 7464 3000             data  >3000,>0003           ; >3000-3fff, SAMS page >03
     7466 0003 
0049 7468 A000             data  >a000,>000a           ; >a000-afff, SAMS page >0a
     746A 000A 
0050               
0051 746C B000             data  >b000,>0010           ; >b000-bfff, SAMS page >10
     746E 0010 
0052                                                   ; \ The index can allocate
0053                                                   ; / pages >10 to >2f.
0054               
0055 7470 C000             data  >c000,>0030           ; >c000-cfff, SAMS page >30
     7472 0030 
0056                                                   ; \ Editor buffer can allocate
0057                                                   ; / pages >30 to >ff.
0058               
0059 7474 D000             data  >d000,>000d           ; >d000-dfff, SAMS page >0d
     7476 000D 
0060 7478 E000             data  >e000,>000e           ; >e000-efff, SAMS page >0e
     747A 000E 
0061 747C F000             data  >f000,>000f           ; >f000-ffff, SAMS page >0f
     747E 000F 
0062               
0063               
0064               
...
0117 7480 F417             data  >f417,>f171,>1b1f,>71b1 ; 1  White on blue with cyan touch
     7482 F171 
     7484 1B1F 
     7486 71B1 
0118 7488 A11A             data  >a11a,>f0ff,>1f1a,>f1ff ; 2  Dark yellow on black
     748A F0FF 
     748C 1F1A 
     748E F1FF 
0119 7490 2112             data  >2112,>f0ff,>1f12,>f1f6 ; 3  Dark green on black
     7492 F0FF 
     7494 1F12 
     7496 F1F6 
0120 7498 F41F             data  >f41f,>1e11,>1a17,>1e11 ; 4  White on blue
     749A 1E11 
     749C 1A17 
     749E 1E11 
0121 74A0 E11E             data  >e11e,>e1ff,>1f1e,>e1ff ; 5  Grey on black
     74A2 E1FF 
     74A4 1F1E 
     74A6 E1FF 
0122 74A8 1771             data  >1771,>1016,>1b71,>1711 ; 6  Black on cyan
     74AA 1016 
     74AC 1B71 
     74AE 1711 
0123 74B0 1FF1             data  >1ff1,>1011,>f1f1,>1f11 ; 7  Black on white
     74B2 1011 
     74B4 F1F1 
     74B6 1F11 
0124 74B8 1AF1             data  >1af1,>a1ff,>1f1f,>f11f ; 8  Black on dark yellow
     74BA A1FF 
     74BC 1F1F 
     74BE F11F 
0125 74C0 21F0             data  >21f0,>12ff,>1b12,>12ff ; 9  Dark green on black
     74C2 12FF 
     74C4 1B12 
     74C6 12FF 
0126 74C8 F5F1             data  >f5f1,>e1ff,>1b1f,>f131 ; 10 White on light blue
     74CA E1FF 
     74CC 1B1F 
     74CE F131 
0127                       even
0128               
0129               tv.tabs.table:
0130 74D0 0007             byte  0,7,12,25               ; \   Default tab positions as used
     74D2 0C19 
0131 74D4 1E2D             byte  30,45,59,79             ; |   in Editor/Assembler module.
     74D6 3B4F 
0132 74D8 FF00             byte  >ff,0,0,0               ; |
     74DA 0000 
0133 74DC 0000             byte  0,0,0,0                 ; |   Up to 20 positions supported.
     74DE 0000 
0134 74E0 0000             byte  0,0,0,0                 ; /   >ff means end-of-list.
     74E2 0000 
0135                       even
**** **** ****     > ram.resident.3000.asm
...
0012 74E4 4B42             byte  75
0013 74E5 ....             text  'Build: 210419-373084 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0014                       even
0015               
0016               ;--------------------------------------------------------------
...
0018               ;--------------------------------------------------------------
0019               txt.delim
0020 7530 012C             byte  1
0021 7531 ....             text  ','
0022                       even
0023               
0024               txt.bottom
0025 7532 0520             byte  5
0026 7533 ....             text  '  BOT'
0027                       even
0028               
0029               txt.ovrwrite
0030 7538 034F             byte  3
0031 7539 ....             text  'OVR'
0032                       even
0033               
0034               txt.insert
0035 753C 0349             byte  3
0036 753D ....             text  'INS'
0037                       even
0038               
0039               txt.star
0040 7540 012A             byte  1
0041 7541 ....             text  '*'
0042                       even
0043               
0044               txt.loading
0045 7542 0A4C             byte  10
0046 7543 ....             text  'Loading...'
0047                       even
0048               
0049               txt.saving
0050 754E 0A53             byte  10
0051 754F ....             text  'Saving....'
0052                       even
0053               
0054               txt.block.del
0055 755A 1244             byte  18
0056 755B ....             text  'Deleting block....'
0057                       even
0058               
0059               txt.block.copy
0060 756E 1143             byte  17
0061 756F ....             text  'Copying block....'
0062                       even
0063               
0064               txt.block.move
0065 7580 104D             byte  16
0066 7581 ....             text  'Moving block....'
0067                       even
0068               
0069               txt.block.save
0070 7592 1D53             byte  29
0071 7593 ....             text  'Saving block to DV80 file....'
0072                       even
0073               
0074               txt.fastmode
0075 75B0 0846             byte  8
0076 75B1 ....             text  'Fastmode'
0077                       even
0078               
0079               txt.kb
0080 75BA 026B             byte  2
0081 75BB ....             text  'kb'
0082                       even
0083               
0084               txt.lines
0085 75BE 054C             byte  5
0086 75BF ....             text  'Lines'
0087                       even
0088               
0089               txt.bufnum
0090 75C4 0323             byte  3
0091 75C5 ....             text  '#1 '
0092                       even
0093               
0094               txt.newfile
0095 75C8 0A5B             byte  10
0096 75C9 ....             text  '[New file]'
0097                       even
0098               
0099               txt.filetype.dv80
0100 75D4 0444             byte  4
0101 75D5 ....             text  'DV80'
0102                       even
0103               
0104               txt.m1
0105 75DA 034D             byte  3
0106 75DB ....             text  'M1='
0107                       even
0108               
0109               txt.m2
0110 75DE 034D             byte  3
0111 75DF ....             text  'M2='
0112                       even
0113               
0114               txt.stevie
0115 75E2 0D53             byte  13
0116 75E3 ....             text  'STEVIE 1.1F  '
0117                       even
0118               
0119               txt.keys.default
0120 75F0 1546             byte  21
0121 75F1 ....             text  'F0=Help  ^Open  ^Save'
0122                       even
0123               
0124               txt.keys.block
0125 7606 2B5E             byte  43
0126 7607 ....             text  '^Del  ^Copy  ^Move  ^Goto M1  ^Reset  ^Save'
0127                       even
0128               
0129 7632 ....     txt.ruler          text    '.........'
0130                                  byte    18
0131 763C ....                        text    '.........'
0132                                  byte    19
0133 7646 ....                        text    '.........'
...
0146               
0147               
0148 7682 010F     txt.alpha.up       data >010f
0149 7684 010E     txt.alpha.down     data >010e
0150 7686 0110     txt.vertline       data >0110
0151               
0152               txt.clear
0153 7688 0420             byte  4
0154 7689 ....             text  '    '
0155                       even
0156               
...
0162               ;--------------------------------------------------------------
0163 768E 1301     txt.head.load      byte 19,1,3,32
     7690 0320 
0164 7692 ....                        text 'Open DV80 file '
0165                                  byte 2
0166               txt.hint.load
0167 76A2 4746             byte  71
0168 76A3 ....             text  'Fastmode uses CPU RAM instead of VDP RAM for file buffer (HRD/HDX/IDE).'
0169                       even
0170               
0171               txt.keys.load
0172 76EA 3946             byte  57
0173 76EB ....             text  'F9=Back    F3=Clear    F5=Fastmode    F-H=Home    F-L=End'
0174                       even
0175               
0176               txt.keys.load2
0177 7724 3946             byte  57
0178 7725 ....             text  'F9=Back    F3=Clear   *F5=Fastmode    F-H=Home    F-L=End'
0179                       even
0180               
0181               
0182               ;--------------------------------------------------------------
...
0184               ;--------------------------------------------------------------
0185 775E 1301     txt.head.save      byte 19,1,3,32
     7760 0320 
0186 7762 ....                        text 'Save DV80 file '
0187                                  byte 2
0188 7772 2301     txt.head.save2     byte 35,1,3,32
     7774 0320 
0189 7776 ....                        text 'Save marked block to DV80 file '
0190                                  byte 2
0191               txt.hint.save
0192 7796 0120             byte  1
0193 7797 ....             text  ' '
0194                       even
0195               
0196               txt.keys.save
0197 7798 2A46             byte  42
0198 7799 ....             text  'F9=Back    F3=Clear    F-H=Home    F-L=End'
0199                       even
0200               
0201               
0202               ;--------------------------------------------------------------
...
0204               ;--------------------------------------------------------------
0205 77C4 1401     txt.head.unsaved   byte 20,1,3,32
     77C6 0320 
0206 77C8 ....                        text 'Unsaved changes '
0207 77D8 0232                        byte 2
0208               txt.info.unsaved
0209                       byte  50
0210 77DA ....             text  'You are about to lose changes to the current file!'
0211                       even
0212               
0213               txt.hint.unsaved
0214 780C 3950             byte  57
0215 780D ....             text  'Press F6 to proceed without saving or ENTER to save file.'
0216                       even
0217               
0218               txt.keys.unsaved
0219 7846 2846             byte  40
0220 7847 ....             text  'F9=Back    F6=Proceed    ENTER=Save file'
0221                       even
0222               
0223               
0224               ;--------------------------------------------------------------
0225               ; Dialog "About"
0226               ;--------------------------------------------------------------
0227 7870 0A01     txt.head.about     byte 10,1,3,32
     7872 0320 
0228 7874 ....                        text 'About '
0229 787A 0200                        byte 2
0230               
0231               txt.info.about
0232                       byte  0
0233 787C ....             text
...
0235               
0236               txt.hint.about
0237 787C 2650             byte  38
0238 787D ....             text  'Press F9 or ENTER to return to editor.'
0239                       even
0240               
0241 78A4 3D46     txt.keys.about     byte 61
0242 78A5 ....                        text 'F9=Back    ENTER=Back   ALPHA LOCK Up= '
0243 78CC 0F20                        byte 15
0244 78CD ....                        text '   ALPHA LOCK Down= '
0245                                  byte 14
0246               
0247               ;--------------------------------------------------------------
...
0249               ;--------------------------------------------------------------
0250               txt.ioerr.load
0251 78E2 2049             byte  32
0252 78E3 ....             text  'I/O error. Failed loading file: '
0253                       even
0254               
0255               txt.ioerr.save
0256 7904 2049             byte  32
0257 7905 ....             text  'I/O error. Failed saving file:  '
0258                       even
0259               
0260               txt.memfull.load
0261 7926 4049             byte  64
0262 7927 ....             text  'Index memory full. Could not fully load file into editor buffer.'
0263                       even
0264               
0265               txt.io.nofile
0266 7968 2149             byte  33
0267 7969 ....             text  'I/O error. No filename specified.'
0268                       even
0269               
0270               txt.block.inside
0271 798A 3445             byte  52
0272 798B ....             text  'Error. Copy/Move target must be outside block M1-M2.'
0273                       even
0274               
0275               
0276               
...
0281 79C0 013E             byte  1
0282 79C1 ....             text  '>'
0283                       even
0284               
0285               txt.colorscheme
0286 79C2 0D43             byte  13
0287 79C3 ....             text  'Color scheme:'
0288                       even
0289               
**** **** ****     > ram.resident.3000.asm
...
**** **** ****     > stevie_b0.asm.373084
0154               
0158 79D8 3916                   data $                ; Bank 0 ROM size OK.
0160               
0161                       ;------------------------------------------------------
0162                       ; Data patterns
0163                       ;------------------------------------------------------
...
0041               
0042               alphalock:
0043 7A6A 0000             data  >0000,>00e0,>e0e0,>e0e0 ; 14. alpha lock down
     7A6C 00E0 
     7A6E E0E0 
     7A70 E0E0 
0044 7A72 00E0             data  >00e0,>e0e0,>e0e0,>0000 ; 15. alpha lock up
     7A74 E0E0 
     7A76 E0E0 
     7A78 0000 
0045               
0046               vertline:
0047 7A7A 1010             data  >1010,>1010,>1010,>1010 ; 16. Vertical line
     7A7C 1010 
     7A7E 1010 
     7A80 1010 
0048 7A82 0000             data  >0000,>0000,>3030,>3030 ; 17. Tab indicator
     7A84 0000 
     7A86 3030 
     7A88 3030 
0049               
0050               
0051               low.digits:
0052                       ; digits 1-4 (18-21)
0053 7A8A 0000             byte >00,>00,>00,>10,>30,>10,>10,>38
     7A8C 0010 
     7A8E 3010 
     7A90 1038 
0054 7A92 0000             byte >00,>00,>00,>38,>08,>38,>20,>38
     7A94 0038 
     7A96 0838 
     7A98 2038 
0055 7A9A 0000             byte >00,>00,>00,>38,>08,>38,>08,>38
     7A9C 0038 
     7A9E 0838 
     7AA0 0838 
0056 7AA2 0000             byte >00,>00,>00,>28,>28,>38,>08,>08
     7AA4 0028 
     7AA6 2838 
     7AA8 0808 
0057                       ; digits 5-8 (22-25)
0058 7AAA 0000             byte >00,>00,>00,>38,>20,>38,>08,>38
     7AAC 0038 
     7AAE 2038 
     7AB0 0838 
0059 7AB2 0000             byte >00,>00,>00,>38,>20,>38,>28,>38
     7AB4 0038 
     7AB6 2038 
     7AB8 2838 
0060 7ABA 0000             byte >00,>00,>00,>38,>08,>10,>20,>20
     7ABC 0038 
     7ABE 0810 
     7AC0 2020 
0061 7AC2 0000             byte >00,>00,>00,>38,>28,>38,>28,>38
     7AC4 0038 
     7AC6 2838 
     7AC8 2838 
**** **** ****     > stevie_b0.asm.373084
...
0167                       ;------------------------------------------------------
0171 7ACA 3A08                   data $                ; Bank 0 ROM size OK.
0173                       ;-------------------------------------------------------
