...
0008               ***************************************************************
0009               * File: stevie_b0.asm               ; Version 211029-1919380
0010               *
0011               * Bank 0 "Jill"
...
0270 6267   42             text  'Build-ID  211029-1919380'
     6268 7569     
     626A 6C64     
     626C 2D49     
     626E 4420     
...
0062               
0063               txt.clearmem
0064 763A 13               byte  19
0065 763B   43             text  "Clearing memory...."
     763C 6C65     
     763E 6172     
     7640 696E     
     7642 6720     
...
0073               txt.kb
0074 7658 02               byte  2
0075 7659   6B             text  'kb'
     765A 62       
0076                       even
0077               
0078               txt.lines
0079 765C 05               byte  5
0080 765D   4C             text  'Lines'
     765E 696E     
     7660 6573     
0081                       even
0082               
0083               txt.newfile
0084 7662 0A               byte  10
0085 7663   5B             text  '[New file]'
     7664 4E65     
     7666 7720     
     7668 6669     
     766A 6C65     
...
0093               txt.m1
0094 7674 03               byte  3
0095 7675   4D             text  'M1='
     7676 313D     
0096                       even
0097               
0098               txt.m2
0099 7678 03               byte  3
0100 7679   4D             text  'M2='
     767A 323D     
0101                       even
0102               
0103               txt.keys.default
0104 767C 07               byte  7
0105 767D   46             text  'F9-Menu'
     767E 392D     
     7680 4D65     
     7682 6E75     
0106                       even
0107               
0108               txt.keys.block
0109 7684 2C               byte  44
0110 7685   46             text  'F9-Back  ^Copy  ^Move  ^Del  ^Save  ^Goto-M1'
     7686 392D     
     7688 4261     
     768A 636B     
     768C 2020     
...
0111                       even
0112               
0113 76B2 2E2E     txt.ruler          text    '.........'
     76B4 2E2E     
     76B6 2E2E     
     76B8 2E2E     
     76BA 2E       
0114 76BB   12                        byte    18
0115 76BC 2E2E                        text    '.........'
     76BE 2E2E     
     76C0 2E2E     
     76C2 2E2E     
     76C4 2E       
0116 76C5   13                        byte    19
0117 76C6 2E2E                        text    '.........'
     76C8 2E2E     
     76CA 2E2E     
     76CC 2E2E     
     76CE 2E       
0118 76CF   14                        byte    20
0119 76D0 2E2E                        text    '.........'
     76D2 2E2E     
     76D4 2E2E     
     76D6 2E2E     
     76D8 2E       
0120 76D9   15                        byte    21
0121 76DA 2E2E                        text    '.........'
     76DC 2E2E     
     76DE 2E2E     
     76E0 2E2E     
     76E2 2E       
0122 76E3   16                        byte    22
0123 76E4 2E2E                        text    '.........'
     76E6 2E2E     
     76E8 2E2E     
     76EA 2E2E     
     76EC 2E       
0124 76ED   17                        byte    23
0125 76EE 2E2E                        text    '.........'
     76F0 2E2E     
     76F2 2E2E     
     76F4 2E2E     
     76F6 2E       
0126 76F7   18                        byte    24
0127 76F8 2E2E                        text    '.........'
     76FA 2E2E     
     76FC 2E2E     
     76FE 2E2E     
     7700 2E       
0128 7701   19                        byte    25
0129                                  even
0130 7702 020E     txt.alpha.down     data >020e,>0f00
     7704 0F00     
0131 7706 0110     txt.vertline       data >0110
0132 7708 011C     txt.keymarker      byte 1,28
0133               
0134               txt.ws1
0135 770A 01               byte  1
0136 770B   20             text  ' '
...
0164               ;--------------------------------------------------------------
0165               txt.ioerr.load
0166 7720 20               byte  32
0167 7721   49             text  'I/O error. Failed loading file: '
     7722 2F4F     
     7724 2065     
     7726 7272     
     7728 6F72     
...
0169               
0170               txt.ioerr.save
0171 7742 20               byte  32
0172 7743   49             text  'I/O error. Failed saving file:  '
     7744 2F4F     
     7746 2065     
     7748 7272     
     774A 6F72     
...
0176 7764 40               byte  64
0177 7765   49             text  'Index memory full. Could not fully load file into editor buffer.'
     7766 6E64     
     7768 6578     
     776A 206D     
     776C 656D     
...
0179               
0180               txt.io.nofile
0181 77A6 21               byte  33
0182 77A7   49             text  'I/O error. No filename specified.'
     77A8 2F4F     
     77AA 2065     
     77AC 7272     
     77AE 6F72     
...
0186 77C8 34               byte  52
0187 77C9   45             text  'Error. Copy/Move target must be outside block M1-M2.'
     77CA 7272     
     77CC 6F72     
     77CE 2E20     
     77D0 436F     
...
0200 7800 0D               byte  13
0201 7801   43             text  'Color scheme:'
     7802 6F6C     
     7804 6F72     
     7806 2073     
     7808 6368     
...
0090                       ;------------------------------------------------------
0091               main:
0092 780E 04E0  34         clr   @bank1.rom            ; Activate bank 1 "James" ROM
     7810 6002     
0093               
0097               
0098 7812 0460  28         b     @kickstart.code2      ; Jump to entry routine
     7814 6046     
0099                       ;------------------------------------------------------
0100                       ; Memory full check
0101                       ;------------------------------------------------------
0103               
0107 7816 379C                   data $                ; Bank 0 ROM size OK.
0109               *--------------------------------------------------------------
