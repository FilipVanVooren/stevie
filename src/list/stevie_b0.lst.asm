...
0008               ***************************************************************
0009               * File: stevie_b0.asm               ; Version 210708-2036470
0010               *
0011               * Bank 0 "Jill"
0012               *
0013               ***************************************************************
...
0045 6011 ....             text  'STEVIE 1.1L (F18A)'
0046                       even
0047               
0049               
**** **** ****     > stevie_b0.asm.2036470
...
0260 625D ....             text  'Build-ID  210708-2036470'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0013 74F1 ....             text  'STEVIE 1.1L'
0014                       even
0015               
0016               txt.about.build
0017 74FC 4C42             byte  76
0018 74FD ....             text  'Build: 210708-2036470 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0113 75F8 1B45             byte  27
0114 75F9 ....             text  'Editor: ^Help, ^File, ^Quit'
0115                       even
0116               
0117               txt.keys.block
0118 7614 3342             byte  51
0119 7615 ....             text  'Block: F9=Back, ^Del, ^Copy, ^Move, ^Goto M1, ^Save'
0120                       even
0121               
0122 7648 ....     txt.ruler          text    '.........'
0123                                  byte    18
0124 7652 ....                        text    '.........'
0125                                  byte    19
0126 765C ....                        text    '.........'
...
0137                                  byte    25
0138                                  even
0139 7698 020E     txt.alpha.down     data >020e,>0f00
     769A 0F00 
0140 769C 0110     txt.vertline       data >0110
0141 769E 011C     txt.keymarker      byte 1,28
0142               
0143               txt.ws1
0144 76A0 0120             byte  1
0145 76A1 ....             text  ' '
0146                       even
0147               
0148               txt.ws2
0149 76A2 0220             byte  2
0150 76A3 ....             text  '  '
0151                       even
0152               
0153               txt.ws3
0154 76A6 0320             byte  3
0155 76A7 ....             text  '   '
0156                       even
0157               
0158               txt.ws4
0159 76AA 0420             byte  4
0160 76AB ....             text  '    '
0161                       even
0162               
0163               txt.ws5
0164 76B0 0520             byte  5
0165 76B1 ....             text  '     '
0166                       even
0167               
...
0173               ;--------------------------------------------------------------
0174 76B6 1301     txt.head.load      byte 19,1,3,32
     76B8 0320 
0175 76BA ....                        text 'Open DV80 file '
0176                                  byte 2
0177               txt.hint.load
0178 76CA 3D53             byte  61
0179 76CB ....             text  'Select Fastmode for file buffer in CPU RAM (HRD/HDX/IDE only)'
0180                       even
0181               
0182               
0183 7708 3C46     txt.keys.load      byte 60
0184 7709 ....                        text 'File'
0185                                  byte 27
0186 770E ....                        text 'Open: F9=Back, F3=Clear, F5=Fastmode, F-H=Home, F-L=End '
0187               
0188 7746 3D46     txt.keys.load2     byte 61
0189 7747 ....                        text 'File'
0190                                  byte 27
0191 774C ....                        text 'Open: F9=Back, F3=Clear, *F5=Fastmode, F-H=Home, F-L=End '
0192               
0193               ;--------------------------------------------------------------
0194               ; Dialog Save DV 80 file
0195               ;--------------------------------------------------------------
0196 7786 0103     txt.head.save      byte 19,1,3,32
     7788 2053 
0197 7789 ....                        text 'Save DV80 file '
0198 7798 0223                        byte 2
0199 779A 0103     txt.head.save2     byte 35,1,3,32
     779C 2053 
0200 779D ....                        text 'Save marked block to DV80 file '
0201 77BC 0201                        byte 2
0202               txt.hint.save
0203                       byte  1
0204 77BE ....             text  ' '
0205                       even
0206               
0207               
0208 77C0 2F46     txt.keys.save      byte 47
0209 77C1 ....                        text 'File'
0210                                  byte 27
0211 77C6 ....                        text 'Save: F9=Back, F3=Clear, F-H=Home, F-L=End'
0212               
0213               ;--------------------------------------------------------------
...
0230 7854 2D43             byte  45
0231 7855 ....             text  'Confirm: F9=Back, F6=Proceed, ENTER=Save file'
0232                       even
0233               
0234               
0235               ;--------------------------------------------------------------
0236               ; Dialog "About"
0237               ;--------------------------------------------------------------
0238 7882 0A01     txt.head.about     byte 10,1,3,32
     7884 0320 
0239 7886 ....                        text 'About '
0240 788C 0200                        byte 2
0241               
0242               txt.info.about
0243                       byte  0
0244 788E ....             text
...
0246               
0247               txt.hint.about
0248 788E 1D50             byte  29
0249 788F ....             text  'Press F9 to return to editor.'
0250                       even
0251               
0252 78AC 2148     txt.keys.about     byte 33
0253 78AD ....                        text 'Help: F9=Back, '
0254 78BC 0E0F                        byte 14,15
0255 78BE ....                        text '=Alpha Lock down'
0256               
0257               
0258               ;--------------------------------------------------------------
0259               ; Dialog "File"
0260               ;--------------------------------------------------------------
0261 78CE 0901     txt.head.file      byte 9,1,3,32
     78D0 0320 
0262 78D2 ....                        text 'File '
0263                                  byte 2
0264               
0265               txt.info.file
0266 78D8 0F4E             byte  15
0267 78D9 ....             text  'New, Open, Save'
0268                       even
0269               
0270 78E8 0005     pos.info.file      byte 0,5,11,>ff
     78EA 0BFF 
0271               txt.hint.file
0272 78EC 2650             byte  38
0273 78ED ....             text  'Press N,O,S or F9 to return to editor.'
0274                       even
0275               
0276               txt.keys.file
0277 7914 0D46             byte  13
0278 7915 ....             text  'File: F9=Back'
0279                       even
0280               
0281               
0282               
...
0286               ;--------------------------------------------------------------
0287               txt.ioerr.load
0288 7922 2049             byte  32
0289 7923 ....             text  'I/O error. Failed loading file: '
0290                       even
0291               
0292               txt.ioerr.save
0293 7944 2049             byte  32
0294 7945 ....             text  'I/O error. Failed saving file:  '
0295                       even
0296               
0297               txt.memfull.load
0298 7966 4049             byte  64
0299 7967 ....             text  'Index memory full. Could not fully load file into editor buffer.'
0300                       even
0301               
0302               txt.io.nofile
0303 79A8 2149             byte  33
0304 79A9 ....             text  'I/O error. No filename specified.'
0305                       even
0306               
0307               txt.block.inside
0308 79CA 3445             byte  52
0309 79CB ....             text  'Error. Copy/Move target must be outside block M1-M2.'
0310                       even
0311               
0312               
0313               ;--------------------------------------------------------------
...
0317 7A00 013E             byte  1
0318 7A01 ....             text  '>'
0319                       even
0320               
0321               txt.colorscheme
0322 7A02 0D43             byte  13
0323 7A03 ....             text  'Color scheme:'
0324                       even
0325               
**** **** ****     > ram.resident.3000.asm
...
0021                       ;------------------------------------------------------
0022 7A10 DEAD             data  >dead,>beef,>dead,>beef
     7A12 BEEF 
     7A14 DEAD 
     7A16 BEEF 
**** **** ****     > stevie_b0.asm.2036470
0133               
0137 7A18 395E                   data $                ; Bank 0 ROM size OK.
0139                       ;------------------------------------------------------
0140                       ; Bank specific vector table
0141                       ;------------------------------------------------------
0145 7A1A 3960                   data $                ; Bank 0 ROM size OK.
0147               
0148               *--------------------------------------------------------------
