...
0008               ***************************************************************
0009               * File: stevie_b0.asm               ; Version 210606-1584346
0010               *
0011               * Bank 0 "Jill"
0012               *
0013               ***************************************************************
...
0107 6088 06A0  32         bl    @cpym2v
     608A 248A 
0108 608C 1008                   data >1008,patterns,29*8
     608E 3988 
     6090 00E8 
0109                       ;-------------------------------------------------------
0110                       ; Exit
...
0260 6269 ....             text  'Build-ID  210606-1584346'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0350 6F68 06A0  32 runlic  bl    @vidtab               ; Load video mode table into VDP
     6F6A 22FC 
0351 6F6C 339A             data  spvmod                ; Equate selected video mode table
...
0150               
0154               
0155 70CA 0460  28         b     @kickstart.code2      ; Jump to entry routine
     70CC 6036 
0156                       ;------------------------------------------------------
...
0039 70E4 0284  22         ci    tmp0,>6000            ; Invalid bank write address?
     70E6 6000 
0040 70E8 1111  14         jlt   rom.farjump.bankswitch.failed1
...
0071 7106 C115  26         mov   *tmp1,tmp0            ; Deref value in vector address
0072 7108 1301  14         jeq   rom.farjump.bankswitch.failed1
0073                                                   ; Crash if null-pointer in vector
0074 710A 1004  14         jmp   rom.farjump.bankswitch.call
0075                                                   ; Call function in target bank
0076                       ;------------------------------------------------------
0077                       ; Assert 1 failed before bank-switch
0078                       ;------------------------------------------------------
0079               rom.farjump.bankswitch.failed1:
0080 710C C80B  38         mov   r11,@>ffce            ; \ Save caller address
     710E FFCE 
0081 7110 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     7112 2026 
0082                       ;------------------------------------------------------
0083                       ; Call function in target bank
0084                       ;------------------------------------------------------
0085               rom.farjump.bankswitch.call:
0086 7114 0694  24         bl    *tmp0                 ; Call function
0087                       ;------------------------------------------------------
0088                       ; Bankswitch back to source bank
0089                       ;------------------------------------------------------
0090               rom.farjump.return:
0091 7116 C120  34         mov   @tv.fj.stackpnt,tmp0  ; Get farjump stack pointer
     7118 A026 
0092 711A C154  26         mov   *tmp0,tmp1            ; Get bank write address of caller
0093 711C 1312  14         jeq   rom.farjump.bankswitch.failed2
0094                                                   ; Crash if null-pointer in address
0095               
0096 711E 04F4  30         clr   *tmp0+                ; Remove bank write address from
0097                                                   ; farjump stack
0098               
0099 7120 C2D4  26         mov   *tmp0,r11             ; Get return addr of caller for return
0100               
0101 7122 04F4  30         clr   *tmp0+                ; Remove return address of caller from
0102                                                   ; farjump stack
0103               
0104 7124 028B  22         ci    r11,>6000
     7126 6000 
0105 7128 110C  14         jlt   rom.farjump.bankswitch.failed2
0106 712A 028B  22         ci    r11,>7fff
     712C 7FFF 
0107 712E 1509  14         jgt   rom.farjump.bankswitch.failed2
0108               
0109 7130 C804  38         mov   tmp0,@tv.fj.stackpnt  ; Update farjump return stack pointer
     7132 A026 
0110               
0114               
0115                       ;------------------------------------------------------
...
0119 7134 04D5  26         clr   *tmp1                 ; Switch to source ROM bank 8K >6000
0120 7136 1009  14         jmp   rom.farjump.exit
0121                       ;------------------------------------------------------
0122                       ; Bankswitch to source 4K ROM / 4K RAM banks (FG99 advanced mode)
0123                       ;------------------------------------------------------
0124               rom.farjump.bankswitch.src.advfg99:
0125 7138 04D5  26         clr   *tmp1                 ; Switch to source ROM bank 4K >6000
0126 713A 0225  22         ai    tmp1,>0800
     713C 0800 
0127 713E 04D5  26         clr   *tmp1                 ; Switch to source RAM bank 4K >7000
0128 7140 1004  14         jmp   rom.farjump.exit
0129                       ;------------------------------------------------------
0130                       ; Assert 2 failed after bank-switch
0131                       ;------------------------------------------------------
0132               rom.farjump.bankswitch.failed2:
0133 7142 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     7144 FFCE 
0134 7146 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     7148 2026 
0135                       ;-------------------------------------------------------
0136                       ; Exit
0137                       ;-------------------------------------------------------
0138               rom.farjump.exit:
0139 714A C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0140 714C C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0141 714E C179  30         mov   *stack+,tmp1          ; Pop tmp1
0142 7150 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0143 7152 045B  20         b     *r11                  ; Return to caller
**** **** ****     > ram.resident.3000.asm
...
0017 7440 0649  14         dect  stack
0018 7442 C64B  30         mov   r11,*stack            ; Save return address
0019                       ;------------------------------------------------------
0020                       ; Set SAMS standard layout
0021                       ;------------------------------------------------------
0022 7444 06A0  32         bl    @sams.layout
     7446 25E6 
0023 7448 33B2                   data mem.sams.layout.data
0024               
0025 744A 06A0  32         bl    @sams.layout.copy
     744C 264A 
0026 744E A000                   data tv.sams.2000     ; Get SAMS windows
0027               
0028 7450 C820  54         mov   @tv.sams.c000,@edb.sams.page
     7452 A008 
     7454 A216 
0029 7456 C820  54         mov   @edb.sams.page,@edb.sams.hipage
     7458 A216 
     745A A218 
...
0035 745C C2F9  30         mov   *stack+,r11           ; Pop r11
0036 745E 045B  20         b     *r11                  ; Return to caller
**** **** ****     > ram.resident.3000.asm
...
0031               ***************************************************************
0032               stevie.tx8030:
0033 7460 04F0             byte  >04,>f0,>00,>3f,>02,>43,>05,SPFCLR,0,80
     7462 003F 
     7464 0243 
     7466 05F4 
     7468 0050 
0034               
0035               romsat:
0036 746A 0000             data  >0000,>0201             ; Cursor YX, initial shape and colour
     746C 0201 
0037 746E 0000             data  >0000,>0301             ; Current line indicator
     7470 0301 
0038 7472 0820             data  >0820,>0401             ; Current line indicator
     7474 0401 
0039               nosprite:
0040 7476 D000             data  >d000                   ; End-of-Sprites list
0041               
0042               
0043               ***************************************************************
...
0047 7478 2000             data  >2000,>0002           ; >2000-2fff, SAMS page >02
     747A 0002 
0048 747C 3000             data  >3000,>0003           ; >3000-3fff, SAMS page >03
     747E 0003 
0049 7480 A000             data  >a000,>000a           ; >a000-afff, SAMS page >0a
     7482 000A 
0050               
0051 7484 B000             data  >b000,>0010           ; >b000-bfff, SAMS page >10
     7486 0010 
0052                                                   ; \ The index can allocate
0053                                                   ; / pages >10 to >2f.
0054               
0055 7488 C000             data  >c000,>0030           ; >c000-cfff, SAMS page >30
     748A 0030 
0056                                                   ; \ Editor buffer can allocate
0057                                                   ; / pages >30 to >ff.
0058               
0059 748C D000             data  >d000,>000d           ; >d000-dfff, SAMS page >0d
     748E 000D 
0060 7490 E000             data  >e000,>000e           ; >e000-efff, SAMS page >0e
     7492 000E 
0061 7494 F000             data  >f000,>000f           ; >f000-ffff, SAMS page >0f
     7496 000F 
0062               
0063               
0064               
...
0117 7498 F417             data  >f417,>f171,>1b1f,>71b1 ; 1  White on blue with cyan touch
     749A F171 
     749C 1B1F 
     749E 71B1 
0118 74A0 A11A             data  >a11a,>f0ff,>1f1a,>f1ff ; 2  Dark yellow on black
     74A2 F0FF 
     74A4 1F1A 
     74A6 F1FF 
0119 74A8 2112             data  >2112,>f0ff,>1f12,>f1f6 ; 3  Dark green on black
     74AA F0FF 
     74AC 1F12 
     74AE F1F6 
0120 74B0 F41F             data  >f41f,>1e11,>1a17,>1e11 ; 4  White on blue
     74B2 1E11 
     74B4 1A17 
     74B6 1E11 
0121 74B8 E11E             data  >e11e,>e1ff,>1f1e,>e1ff ; 5  Grey on black
     74BA E1FF 
     74BC 1F1E 
     74BE E1FF 
0122 74C0 1771             data  >1771,>1016,>1b71,>1711 ; 6  Black on cyan
     74C2 1016 
     74C4 1B71 
     74C6 1711 
0123 74C8 1FF1             data  >1ff1,>1011,>f1f1,>1f11 ; 7  Black on white
     74CA 1011 
     74CC F1F1 
     74CE 1F11 
0124 74D0 1AF1             data  >1af1,>a1ff,>1f1f,>f11f ; 8  Black on dark yellow
     74D2 A1FF 
     74D4 1F1F 
     74D6 F11F 
0125 74D8 21F0             data  >21f0,>12ff,>1b12,>12ff ; 9  Dark green on black
     74DA 12FF 
     74DC 1B12 
     74DE 12FF 
0126 74E0 F5F1             data  >f5f1,>e1ff,>1b1f,>f131 ; 10 White on light blue
     74E2 E1FF 
     74E4 1B1F 
     74E6 F131 
0127                       even
0128               
0129               tv.tabs.table:
0130 74E8 0007             byte  0,7,12,25               ; \   Default tab positions as used
     74EA 0C19 
0131 74EC 1E2D             byte  30,45,59,79             ; |   in Editor/Assembler module.
     74EE 3B4F 
0132 74F0 FF00             byte  >ff,0,0,0               ; |
     74F2 0000 
0133 74F4 0000             byte  0,0,0,0                 ; |   Up to 20 positions supported.
     74F6 0000 
0134 74F8 0000             byte  0,0,0,0                 ; /   >ff means end-of-list.
     74FA 0000 
0135                       even
**** **** ****     > ram.resident.3000.asm
...
0010               ;--------------------------------------------------------------
0011               txt.stevie
0012 74FC 0B53             byte  11
0013 74FD ....             text  'STEVIE 1.1K'
0014                       even
0015               
0016               txt.about.build
0017 7508 4C42             byte  76
0018 7509 ....             text  'Build: 210606-1584346 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
0023 7556 012C             byte  1
0024 7557 ....             text  ','
0025                       even
0026               
0027               txt.bottom
0028 7558 0520             byte  5
0029 7559 ....             text  '  BOT'
0030                       even
0031               
0032               txt.ovrwrite
0033 755E 034F             byte  3
0034 755F ....             text  'OVR'
0035                       even
0036               
0037               txt.insert
0038 7562 0349             byte  3
0039 7563 ....             text  'INS'
0040                       even
0041               
0042               txt.star
0043 7566 012A             byte  1
0044 7567 ....             text  '*'
0045                       even
0046               
0047               txt.loading
0048 7568 0A4C             byte  10
0049 7569 ....             text  'Loading...'
0050                       even
0051               
0052               txt.saving
0053 7574 0A53             byte  10
0054 7575 ....             text  'Saving....'
0055                       even
0056               
0057               txt.block.del
0058 7580 1244             byte  18
0059 7581 ....             text  'Deleting block....'
0060                       even
0061               
0062               txt.block.copy
0063 7594 1143             byte  17
0064 7595 ....             text  'Copying block....'
0065                       even
0066               
0067               txt.block.move
0068 75A6 104D             byte  16
0069 75A7 ....             text  'Moving block....'
0070                       even
0071               
0072               txt.block.save
0073 75B8 1D53             byte  29
0074 75B9 ....             text  'Saving block to DV80 file....'
0075                       even
0076               
0077               txt.fastmode
0078 75D6 0846             byte  8
0079 75D7 ....             text  'Fastmode'
0080                       even
0081               
0082               txt.kb
0083 75E0 026B             byte  2
0084 75E1 ....             text  'kb'
0085                       even
0086               
0087               txt.lines
0088 75E4 054C             byte  5
0089 75E5 ....             text  'Lines'
0090                       even
0091               
0092               txt.newfile
0093 75EA 0A5B             byte  10
0094 75EB ....             text  '[New file]'
0095                       even
0096               
0097               txt.filetype.dv80
0098 75F6 0444             byte  4
0099 75F7 ....             text  'DV80'
0100                       even
0101               
0102               txt.m1
0103 75FC 034D             byte  3
0104 75FD ....             text  'M1='
0105                       even
0106               
0107               txt.m2
0108 7600 034D             byte  3
0109 7601 ....             text  'M2='
0110                       even
0111               
0112               txt.keys.default
0113 7604 1B45             byte  27
0114 7605 ....             text  'Editor: ^Help, ^File, ^Quit'
0115                       even
0116               
0117               txt.keys.block
0118 7620 3342             byte  51
0119 7621 ....             text  'Block: F9=Back, ^Del, ^Copy, ^Move, ^Goto M1, ^Save'
0120                       even
0121               
0122 7654 ....     txt.ruler          text    '.........'
0123                                  byte    18
0124 765E ....                        text    '.........'
0125                                  byte    19
0126 7668 ....                        text    '.........'
...
0137                                  byte    25
0138                                  even
0139 76A4 020E     txt.alpha.down     data >020e,>0f00
     76A6 0F00 
0140 76A8 0110     txt.vertline       data >0110
0141 76AA 011C     txt.keymarker      byte 1,28
0142               
0143               txt.ws1
0144 76AC 0120             byte  1
0145 76AD ....             text  ' '
0146                       even
0147               
0148               txt.ws2
0149 76AE 0220             byte  2
0150 76AF ....             text  '  '
0151                       even
0152               
0153               txt.ws3
0154 76B2 0320             byte  3
0155 76B3 ....             text  '   '
0156                       even
0157               
0158               txt.ws4
0159 76B6 0420             byte  4
0160 76B7 ....             text  '    '
0161                       even
0162               
0163               txt.ws5
0164 76BC 0520             byte  5
0165 76BD ....             text  '     '
0166                       even
0167               
...
0173               ;--------------------------------------------------------------
0174 76C2 1301     txt.head.load      byte 19,1,3,32
     76C4 0320 
0175 76C6 ....                        text 'Open DV80 file '
0176                                  byte 2
0177               txt.hint.load
0178 76D6 3D53             byte  61
0179 76D7 ....             text  'Select Fastmode for file buffer in CPU RAM (HRD/HDX/IDE only)'
0180                       even
0181               
0182               
0183 7714 3C46     txt.keys.load      byte 60
0184 7715 ....                        text 'File'
0185                                  byte 27
0186 771A ....                        text 'Open: F9=Back, F3=Clear, F5=Fastmode, F-H=Home, F-L=End '
0187               
0188 7752 3D46     txt.keys.load2     byte 61
0189 7753 ....                        text 'File'
0190                                  byte 27
0191 7758 ....                        text 'Open: F9=Back, F3=Clear, *F5=Fastmode, F-H=Home, F-L=End '
0192               
0193               ;--------------------------------------------------------------
0194               ; Dialog Save DV 80 file
0195               ;--------------------------------------------------------------
0196 7792 0103     txt.head.save      byte 19,1,3,32
     7794 2053 
0197 7795 ....                        text 'Save DV80 file '
0198 77A4 0223                        byte 2
0199 77A6 0103     txt.head.save2     byte 35,1,3,32
     77A8 2053 
0200 77A9 ....                        text 'Save marked block to DV80 file '
0201 77C8 0201                        byte 2
0202               txt.hint.save
0203                       byte  1
0204 77CA ....             text  ' '
0205                       even
0206               
0207               
0208 77CC 2F46     txt.keys.save      byte 47
0209 77CD ....                        text 'File'
0210                                  byte 27
0211 77D2 ....                        text 'Save: F9=Back, F3=Clear, F-H=Home, F-L=End'
0212               
0213               ;--------------------------------------------------------------
0214               ; Dialog "Unsaved changes"
0215               ;--------------------------------------------------------------
0216 77FC 1401     txt.head.unsaved   byte 20,1,3,32
     77FE 0320 
0217 7800 ....                        text 'Unsaved changes '
0218 7810 0221                        byte 2
0219               txt.info.unsaved
0220                       byte  33
0221 7812 ....             text  'Warning! Unsaved changes in file.'
0222                       even
0223               
0224               txt.hint.unsaved
0225 7834 2A50             byte  42
0226 7835 ....             text  'Press F6 to proceed or ENTER to save file.'
0227                       even
0228               
0229               txt.keys.unsaved
0230 7860 2D43             byte  45
0231 7861 ....             text  'Confirm: F9=Back, F6=Proceed, ENTER=Save file'
0232                       even
0233               
0234               
0235               ;--------------------------------------------------------------
0236               ; Dialog "About"
0237               ;--------------------------------------------------------------
0238 788E 0A01     txt.head.about     byte 10,1,3,32
     7890 0320 
0239 7892 ....                        text 'About '
0240 7898 0200                        byte 2
0241               
0242               txt.info.about
0243                       byte  0
0244 789A ....             text
...
0246               
0247               txt.hint.about
0248 789A 1D50             byte  29
0249 789B ....             text  'Press F9 to return to editor.'
0250                       even
0251               
0252 78B8 2148     txt.keys.about     byte 33
0253 78B9 ....                        text 'Help: F9=Back, '
0254 78C8 0E0F                        byte 14,15
0255 78CA ....                        text '=Alpha Lock down'
0256               
0257               
0258               ;--------------------------------------------------------------
0259               ; Dialog "File"
0260               ;--------------------------------------------------------------
0261 78DA 0901     txt.head.file      byte 9,1,3,32
     78DC 0320 
0262 78DE ....                        text 'File '
0263                                  byte 2
0264               
0265               txt.info.file
0266 78E4 0F4E             byte  15
0267 78E5 ....             text  'New, Open, Save'
0268                       even
0269               
0270 78F4 0005     pos.info.file      byte 0,5,11,>ff
     78F6 0BFF 
0271               txt.hint.file
0272 78F8 2650             byte  38
0273 78F9 ....             text  'Press N,O,S or F9 to return to editor.'
0274                       even
0275               
0276               txt.keys.file
0277 7920 0D46             byte  13
0278 7921 ....             text  'File: F9=Back'
0279                       even
0280               
0281               
0282               
...
0286               ;--------------------------------------------------------------
0287               txt.ioerr.load
0288 792E 2049             byte  32
0289 792F ....             text  'I/O error. Failed loading file: '
0290                       even
0291               
0292               txt.ioerr.save
0293 7950 2049             byte  32
0294 7951 ....             text  'I/O error. Failed saving file:  '
0295                       even
0296               
0297               txt.memfull.load
0298 7972 4049             byte  64
0299 7973 ....             text  'Index memory full. Could not fully load file into editor buffer.'
0300                       even
0301               
0302               txt.io.nofile
0303 79B4 2149             byte  33
0304 79B5 ....             text  'I/O error. No filename specified.'
0305                       even
0306               
0307               txt.block.inside
0308 79D6 3445             byte  52
0309 79D7 ....             text  'Error. Copy/Move target must be outside block M1-M2.'
0310                       even
0311               
0312               
0313               ;--------------------------------------------------------------
...
0317 7A0C 013E             byte  1
0318 7A0D ....             text  '>'
0319                       even
0320               
0321               txt.colorscheme
0322 7A0E 0D43             byte  13
0323 7A0F ....             text  'Color scheme:'
0324                       even
0325               
**** **** ****     > ram.resident.3000.asm
...
0021                       ;------------------------------------------------------
0022 7A1C DEAD             data  >dead,>beef,>dead,>beef
     7A1E BEEF 
     7A20 DEAD 
     7A22 BEEF 
**** **** ****     > stevie_b0.asm.1584346
0160               
0164 7A24 395E                   data $                ; Bank 0 ROM size OK.
0166               
0167                       ;------------------------------------------------------
0168                       ; Data patterns
0169                       ;------------------------------------------------------
...
0006               ;--------------------------------------------------------------
0007               cursors:
0008 7A26 0000             byte  >00,>00,>00,>00,>00,>00,>00,>1c ; Cursor 1 - Insert mode
     7A28 0000 
     7A2A 0000 
     7A2C 001C 
0009 7A2E 1010             byte  >10,>10,>10,>10,>10,>10,>10,>00 ; Cursor 2 - Insert mode
     7A30 1010 
     7A32 1010 
     7A34 1000 
0010 7A36 1C1C             byte  >1c,>1c,>1c,>1c,>1c,>1c,>1c,>00 ; Cursor 3 - Overwrite mode
     7A38 1C1C 
     7A3A 1C1C 
     7A3C 1C00 
0011 7A3E 0001             byte  >00,>01,>03,>07,>07,>03,>01,>00 ; Current line indicator    <
     7A40 0307 
     7A42 0703 
     7A44 0100 
0012 7A46 1C08             byte  >1c,>08,>00,>00,>00,>00,>00,>00 ; Current column indicator  v
     7A48 0000 
     7A4A 0000 
     7A4C 0000 
0013               
...
0020               ;--------------------------------------------------------------
0021               patterns:
0022 7A4E 0000             data  >0000,>0000,>ff00,>0000 ; 01. Single line
     7A50 0000 
     7A52 FF00 
     7A54 0000 
0023 7A56 8080             data  >8080,>8080,>ff80,>8080 ; 02. Connector |-
     7A58 8080 
     7A5A FF80 
     7A5C 8080 
0024 7A5E 0404             data  >0404,>0404,>ff04,>0404 ; 03. Connector -|
     7A60 0404 
     7A62 FF04 
     7A64 0404 
0025               
0026               patterns.box:
0027 7A66 0000             data  >0000,>0000,>ff80,>bfa0 ; 04. Top left corner
     7A68 0000 
     7A6A FF80 
     7A6C BFA0 
0028 7A6E 0000             data  >0000,>0000,>fc04,>f414 ; 05. Top right corner
     7A70 0000 
     7A72 FC04 
     7A74 F414 
0029 7A76 A0A0             data  >a0a0,>a0a0,>a0a0,>a0a0 ; 06. Left vertical double line
     7A78 A0A0 
     7A7A A0A0 
     7A7C A0A0 
0030 7A7E 1414             data  >1414,>1414,>1414,>1414 ; 07. Right vertical double line
     7A80 1414 
     7A82 1414 
     7A84 1414 
0031 7A86 A0A0             data  >a0a0,>a0a0,>bf80,>ff00 ; 08. Bottom left corner
     7A88 A0A0 
     7A8A BF80 
     7A8C FF00 
0032 7A8E 1414             data  >1414,>1414,>f404,>fc00 ; 09. Bottom right corner
     7A90 1414 
     7A92 F404 
     7A94 FC00 
0033 7A96 0000             data  >0000,>c0c0,>c0c0,>0080 ; 10. Double line top left corner
     7A98 C0C0 
     7A9A C0C0 
     7A9C 0080 
0034 7A9E 0000             data  >0000,>0f0f,>0f0f,>0000 ; 11. Double line top right corner
     7AA0 0F0F 
     7AA2 0F0F 
     7AA4 0000 
0035               
0036               
0037               patterns.cr:
0038 7AA6 6C48             data  >6c48,>6c48,>4800,>7c00 ; 12. FF (Form Feed)
     7AA8 6C48 
     7AAA 4800 
     7AAC 7C00 
0039 7AAE 0024             data  >0024,>64fc,>6020,>0000 ; 13. CR (Carriage return) - arrow
     7AB0 64FC 
     7AB2 6020 
     7AB4 0000 
0040               
0041               
0042               alphalock:
0043 7AB6 FFC0             data  >ffc0,>8894,>9c94,>c0ff ; 14. alpha lock down - char1
     7AB8 8894 
     7ABA 9C94 
     7ABC C0FF 
0044 7ABE FC0C             data  >fc0c,>4444,>4474,>0cfc ; 15. alpha lock down - char2
     7AC0 4444 
     7AC2 4474 
     7AC4 0CFC 
0045               
0046               
0047               vertline:
0048 7AC6 1010             data  >1010,>1010,>1010,>1010 ; 16. Vertical line
     7AC8 1010 
     7ACA 1010 
     7ACC 1010 
0049 7ACE 0000             data  >0000,>0000,>3030,>3030 ; 17. Tab indicator
     7AD0 0000 
     7AD2 3030 
     7AD4 3030 
0050               
...
0054 7AD6 0000             byte >00,>00,>00,>10,>30,>10,>10,>38
     7AD8 0010 
     7ADA 3010 
     7ADC 1038 
0055 7ADE 0000             byte >00,>00,>00,>38,>08,>38,>20,>38
     7AE0 0038 
     7AE2 0838 
     7AE4 2038 
0056 7AE6 0000             byte >00,>00,>00,>38,>08,>38,>08,>38
     7AE8 0038 
     7AEA 0838 
     7AEC 0838 
0057 7AEE 0000             byte >00,>00,>00,>28,>28,>38,>08,>08
     7AF0 0028 
     7AF2 2838 
     7AF4 0808 
0058                       ; digits 5-8 (22-25)
0059 7AF6 0000             byte >00,>00,>00,>38,>20,>38,>08,>38
     7AF8 0038 
     7AFA 2038 
     7AFC 0838 
0060 7AFE 0000             byte >00,>00,>00,>38,>20,>38,>28,>38
     7B00 0038 
     7B02 2038 
     7B04 2838 
0061 7B06 0000             byte >00,>00,>00,>38,>08,>10,>20,>20
     7B08 0038 
     7B0A 0810 
     7B0C 2020 
0062 7B0E 0000             byte >00,>00,>00,>38,>28,>38,>28,>38
     7B10 0038 
     7B12 2838 
     7B14 2838 
0063               
0064 7B16 007F     cursor: data  >007f,>7f7f,>7f7f,>7f7f ; 26. Cursor
     7B18 7F7F 
     7B1A 7F7F 
     7B1C 7F7F 
0065 7B1E 0000     arrow:  data  >0000,>0010,>08fc,>0810 ; 27. Arrow
     7B20 0010 
     7B22 08FC 
     7B24 0810 
0066 7B26 00FF     hline:  data  >00ff,>0000,>0000,>0000 ; 28. Key marker
     7B28 0000 
     7B2A 0000 
     7B2C 0000 
**** **** ****     > stevie_b0.asm.1584346
...
0173                       ;------------------------------------------------------
0177 7B2E 3A68                   data $                ; Bank 0 ROM size OK.
0179                       ;-------------------------------------------------------
