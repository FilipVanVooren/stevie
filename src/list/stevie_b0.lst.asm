...
0008               ***************************************************************
0009               * File: stevie_b0.asm               ; Version 210608-1959432
0010               *
0011               * Bank 0 "Jill"
0012               *
0013               ***************************************************************
...
0097 608A 0649  14         dect  stack
0098 608C C64B  30         mov   r11,*stack            ; Push return address
0099                       ;-------------------------------------------------------
0100                       ; Dump sprite patterns from ROM to VDP SDT
0101                       ;-------------------------------------------------------
0102 608E 06A0  32         bl    @cpym2v
     6090 248A 
0103 6092 2800                   data sprpdt,cursors,5*8
     6094 3960 
     6096 0028 
0104                       ;-------------------------------------------------------
0105                       ; Dump character patterns from ROM to VDP PDT
0106                       ;-------------------------------------------------------
0107 6098 06A0  32         bl    @cpym2v
     609A 248A 
0108 609C 1008                   data >1008,patterns,29*8
     609E 3988 
     60A0 00E8 
0109                       ;-------------------------------------------------------
0110                       ; Exit
...
0113 60A2 C2F9  30         mov   *stack+,r11           ; Pop R11
0114 60A4 045B  20         b     *r11                  ; Return to task
0115               
0116               
0117               
0118               
...
0012 60A6 0000     w$0000  data  >0000                 ; >0000 0000000000000000
0013 60A8 0001     w$0001  data  >0001                 ; >0001 0000000000000001
0014 60AA 0002     w$0002  data  >0002                 ; >0002 0000000000000010
0015 60AC 0004     w$0004  data  >0004                 ; >0004 0000000000000100
0016 60AE 0008     w$0008  data  >0008                 ; >0008 0000000000001000
0017 60B0 0010     w$0010  data  >0010                 ; >0010 0000000000010000
0018 60B2 0020     w$0020  data  >0020                 ; >0020 0000000000100000
0019 60B4 0040     w$0040  data  >0040                 ; >0040 0000000001000000
0020 60B6 0080     w$0080  data  >0080                 ; >0080 0000000010000000
0021 60B8 0100     w$0100  data  >0100                 ; >0100 0000000100000000
0022 60BA 0200     w$0200  data  >0200                 ; >0200 0000001000000000
0023 60BC 0400     w$0400  data  >0400                 ; >0400 0000010000000000
0024 60BE 0800     w$0800  data  >0800                 ; >0800 0000100000000000
0025 60C0 1000     w$1000  data  >1000                 ; >1000 0001000000000000
0026 60C2 2000     w$2000  data  >2000                 ; >2000 0010000000000000
0027 60C4 4000     w$4000  data  >4000                 ; >4000 0100000000000000
0028 60C6 8000     w$8000  data  >8000                 ; >8000 1000000000000000
0029 60C8 FFFF     w$ffff  data  >ffff                 ; >ffff 1111111111111111
0030 60CA D000     w$d000  data  >d000                 ; >d000
0031               *--------------------------------------------------------------
...
0036               ********|*****|*********************|**************************
0037               cpu.crash:
0038 60CC 022B  22         ai    r11,-4                ; Remove opcode offset
     60CE FFFC 
0039               *--------------------------------------------------------------
0040               *    Save registers to high memory
0041               *--------------------------------------------------------------
0042 60D0 C800  38         mov   r0,@>ffe0
     60D2 FFE0 
0043 60D4 C801  38         mov   r1,@>ffe2
     60D6 FFE2 
0044 60D8 C802  38         mov   r2,@>ffe4
     60DA FFE4 
0045 60DC C803  38         mov   r3,@>ffe6
     60DE FFE6 
0046 60E0 C804  38         mov   r4,@>ffe8
     60E2 FFE8 
0047 60E4 C805  38         mov   r5,@>ffea
     60E6 FFEA 
0048 60E8 C806  38         mov   r6,@>ffec
     60EA FFEC 
0049 60EC C807  38         mov   r7,@>ffee
     60EE FFEE 
0050 60F0 C808  38         mov   r8,@>fff0
     60F2 FFF0 
0051 60F4 C809  38         mov   r9,@>fff2
     60F6 FFF2 
0052 60F8 C80A  38         mov   r10,@>fff4
     60FA FFF4 
0053 60FC C80B  38         mov   r11,@>fff6
     60FE FFF6 
0054 6100 C80C  38         mov   r12,@>fff8
     6102 FFF8 
0055 6104 C80D  38         mov   r13,@>fffa
     6106 FFFA 
0056 6108 C80E  38         mov   r14,@>fffc
     610A FFFC 
0057 610C C80F  38         mov   r15,@>ffff
     610E FFFF 
0058 6110 02A0  12         stwp  r0
0059 6112 C800  38         mov   r0,@>ffdc
     6114 FFDC 
0060 6116 02C0  12         stst  r0
0061 6118 C800  38         mov   r0,@>ffde
     611A FFDE 
0062               *--------------------------------------------------------------
0063               *    Reset system
0064               *--------------------------------------------------------------
0065               cpu.crash.reset:
0066 611C 02E0  18         lwpi  ws1                   ; Activate workspace 1
     611E 8300 
0067 6120 04E0  34         clr   @>8302                ; Reset exit flag (R1 in workspace WS1!)
     6122 8302 
0068 6124 0200  20         li    r0,>4a4a              ; Note that a crash occured (Flag = >4a4a)
     6126 4A4A 
0069 6128 0460  28         b     @runli1               ; Initialize system again (VDP, Memory, etc.)
     612A 2E4C 
0070               *--------------------------------------------------------------
...
0076                       ;------------------------------------------------------
0077 612C 06A0  32         bl    @vidtab               ; Load video mode table into VDP
     612E 22FC 
0078 6130 21EC                   data graph1           ; Equate selected video mode table
0079               
0080 6132 06A0  32         bl    @ldfnt
     6134 2364 
0081 6136 0900                   data >0900,fnopt3     ; Load font (upper & lower case)
     6138 000C 
0082               
0083 613A 06A0  32         bl    @filv
     613C 2292 
0084 613E 0380                   data >0380,>f0,32*24  ; Load color table
     6140 00F0 
     6142 0300 
0085                       ;------------------------------------------------------
0086                       ; Show crash details
0087                       ;------------------------------------------------------
0088 6144 06A0  32         bl    @putat                ; Show crash message
     6146 2446 
0089 6148 0000                   data >0000,cpu.crash.msg.crashed
     614A 2178 
0090               
0091 614C 06A0  32         bl    @puthex               ; Put hex value on screen
     614E 29D0 
0092 6150 0015                   byte 0,21             ; \ i  p0 = YX position
0093 6152 FFF6                   data >fff6            ; | i  p1 = Pointer to 16 bit word
0094 6154 2F6A                   data rambuf           ; | i  p2 = Pointer to ram buffer
0095 6156 4130                   byte 65,48            ; | i  p3 = MSB offset for ASCII digit a-f
0096                                                   ; /         LSB offset for ASCII digit 0-9
0097                       ;------------------------------------------------------
0098                       ; Show caller details
0099                       ;------------------------------------------------------
0100 6158 06A0  32         bl    @putat                ; Show caller message
     615A 2446 
0101 615C 0100                   data >0100,cpu.crash.msg.caller
     615E 218E 
0102               
0103 6160 06A0  32         bl    @puthex               ; Put hex value on screen
     6162 29D0 
0104 6164 0115                   byte 1,21             ; \ i  p0 = YX position
0105 6166 FFCE                   data >ffce            ; | i  p1 = Pointer to 16 bit word
0106 6168 2F6A                   data rambuf           ; | i  p2 = Pointer to ram buffer
0107 616A 4130                   byte 65,48            ; | i  p3 = MSB offset for ASCII digit a-f
0108                                                   ; /         LSB offset for ASCII digit 0-9
0109                       ;------------------------------------------------------
0110                       ; Display labels
0111                       ;------------------------------------------------------
0112 616C 06A0  32         bl    @putat
     616E 2446 
0113 6170 0300                   byte 3,0
0114 6172 21AA                   data cpu.crash.msg.wp
0115 6174 06A0  32         bl    @putat
     6176 2446 
0116 6178 0400                   byte 4,0
0117 617A 21B0                   data cpu.crash.msg.st
0118 617C 06A0  32         bl    @putat
     617E 2446 
0119 6180 1600                   byte 22,0
0120 6182 21B6                   data cpu.crash.msg.source
0121 6184 06A0  32         bl    @putat
     6186 2446 
0122 6188 1700                   byte 23,0
0123 618A 21D2                   data cpu.crash.msg.id
0124                       ;------------------------------------------------------
0125                       ; Show crash registers WP, ST, R0 - R15
0126                       ;------------------------------------------------------
0127 618C 06A0  32         bl    @at                   ; Put cursor at YX
     618E 26D2 
0128 6190 0304                   byte 3,4              ; \ i p0 = YX position
0129                                                   ; /
0130               
0131 6192 0204  20         li    tmp0,>ffdc            ; Crash registers >ffdc - >ffff
     6194 FFDC 
0132 6196 04C6  14         clr   tmp2                  ; Loop counter
0133               
0134               cpu.crash.showreg:
0135 6198 C034  30         mov   *tmp0+,r0             ; Move crash register content to r0
0136               
0137 619A 0649  14         dect  stack
0138 619C C644  30         mov   tmp0,*stack           ; Push tmp0
0139 619E 0649  14         dect  stack
0140 61A0 C645  30         mov   tmp1,*stack           ; Push tmp1
0141 61A2 0649  14         dect  stack
0142 61A4 C646  30         mov   tmp2,*stack           ; Push tmp2
0143                       ;------------------------------------------------------
0144                       ; Display crash register number
0145                       ;------------------------------------------------------
0146               cpu.crash.showreg.label:
0147 61A6 C046  18         mov   tmp2,r1               ; Save register number
0148 61A8 0286  22         ci    tmp2,1                ; Skip labels WP/ST?
     61AA 0001 
0149 61AC 121C  14         jle   cpu.crash.showreg.content
0150                                                   ; Yes, skip
0151               
0152 61AE 0641  14         dect  r1                    ; Adjust because of "dummy" WP/ST registers
0153 61B0 06A0  32         bl    @mknum
     61B2 29DA 
0154 61B4 8302                   data r1hb             ; \ i  p0 = Pointer to 16 bit unsigned word
0155 61B6 2F6A                   data rambuf           ; | i  p1 = Pointer to ram buffer
0156 61B8 3020                   byte 48,32            ; | i  p2 = MSB offset for ASCII digit a-f
0157                                                   ; /         LSB offset for ASCII digit 0-9
0158               
0159 61BA 06A0  32         bl    @setx                 ; Set cursor X position
     61BC 26E8 
0160 61BE 0000                   data 0                ; \ i  p0 =  Cursor Y position
0161                                                   ; /
0162               
0163 61C0 06A0  32         bl    @putstr               ; Put length-byte prefixed string at current YX
     61C2 2422 
0164 61C4 2F6A                   data rambuf           ; \ i  p0 = Pointer to ram buffer
0165                                                   ; /
0166               
0167 61C6 06A0  32         bl    @setx                 ; Set cursor X position
     61C8 26E8 
0168 61CA 0002                   data 2                ; \ i  p0 =  Cursor Y position
0169                                                   ; /
0170               
0171 61CC 0281  22         ci    r1,10
     61CE 000A 
0172 61D0 1102  14         jlt   !
0173 61D2 0620  34         dec   @wyx                  ; x=x-1
     61D4 832A 
0174               
0175 61D6 06A0  32 !       bl    @putstr
     61D8 2422 
0176 61DA 21A4                   data cpu.crash.msg.r
0177               
0178 61DC 06A0  32         bl    @mknum
     61DE 29DA 
0179 61E0 8302                   data r1hb             ; \ i  p0 = Pointer to 16 bit unsigned word
0180 61E2 2F6A                   data rambuf           ; | i  p1 = Pointer to ram buffer
0181 61E4 3020                   byte 48,32            ; | i  p2 = MSB offset for ASCII digit a-f
0182                                                   ; /         LSB offset for ASCII digit 0-9
0183                       ;------------------------------------------------------
0184                       ; Display crash register content
0185                       ;------------------------------------------------------
0186               cpu.crash.showreg.content:
0187 61E6 06A0  32         bl    @mkhex                ; Convert hex word to string
     61E8 294C 
0188 61EA 8300                   data r0hb             ; \ i  p0 = Pointer to 16 bit word
0189 61EC 2F6A                   data rambuf           ; | i  p1 = Pointer to ram buffer
0190 61EE 4130                   byte 65,48            ; | i  p2 = MSB offset for ASCII digit a-f
0191                                                   ; /         LSB offset for ASCII digit 0-9
0192               
0193 61F0 06A0  32         bl    @setx                 ; Set cursor X position
     61F2 26E8 
0194 61F4 0004                   data 4                ; \ i  p0 =  Cursor Y position
0195                                                   ; /
0196               
0197 61F6 06A0  32         bl    @putstr               ; Put '  >'
     61F8 2422 
0198 61FA 21A6                   data cpu.crash.msg.marker
0199               
0200 61FC 06A0  32         bl    @setx                 ; Set cursor X position
     61FE 26E8 
0201 6200 0007                   data 7                ; \ i  p0 =  Cursor Y position
0202                                                   ; /
0203               
0204 6202 06A0  32         bl    @putstr               ; Put length-byte prefixed string at current YX
     6204 2422 
0205 6206 2F6A                   data rambuf           ; \ i  p0 = Pointer to ram buffer
0206                                                   ; /
0207               
0208 6208 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0209 620A C179  30         mov   *stack+,tmp1          ; Pop tmp1
0210 620C C139  30         mov   *stack+,tmp0          ; Pop tmp0
0211               
0212 620E 06A0  32         bl    @down                 ; y=y+1
     6210 26D8 
0213               
0214 6212 0586  14         inc   tmp2
0215 6214 0286  22         ci    tmp2,17
     6216 0011 
0216 6218 12BF  14         jle   cpu.crash.showreg     ; Show next register
0217                       ;------------------------------------------------------
0218                       ; Kernel takes over
0219                       ;------------------------------------------------------
0220 621A 0460  28         b     @tmgr                 ; Start kernel again for polling keyboard
     621C 2D4A 
0221               
0222               
0223               cpu.crash.msg.crashed
0224 621E 1553             byte  21
0225 621F ....             text  'System crashed near >'
0226                       even
0227               
0228               cpu.crash.msg.caller
0229 6234 1543             byte  21
0230 6235 ....             text  'Caller address near >'
0231                       even
0232               
0233               cpu.crash.msg.r
0234 624A 0152             byte  1
0235 624B ....             text  'R'
0236                       even
0237               
0238               cpu.crash.msg.marker
0239 624C 0320             byte  3
0240 624D ....             text  '  >'
0241                       even
0242               
0243               cpu.crash.msg.wp
0244 6250 042A             byte  4
0245 6251 ....             text  '**WP'
0246                       even
0247               
0248               cpu.crash.msg.st
0249 6256 042A             byte  4
0250 6257 ....             text  '**ST'
0251                       even
0252               
0253               cpu.crash.msg.source
0254 625C 1B53             byte  27
0255 625D ....             text  'Source    stevie_b0.lst.asm'
0256                       even
0257               
0258               cpu.crash.msg.id
0259 6278 1842             byte  24
0260 6279 ....             text  'Build-ID  210608-1959432'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0006               *--------------------------------------------------------------
0007 6292 00E2     graph1  byte  >00,>e2,>00,>0e,>01,>06,>02,SPFBCK,0,32
     6294 000E 
     6296 0106 
     6298 0204 
     629A 0020 
...
0031               *--------------------------------------------------------------
0032 629C 00F2     tx4024  byte  >00,>f2,>00,>0e,>01,>06,>00,SPFCLR,0,40
     629E 000E 
     62A0 0106 
     62A2 00F4 
     62A4 0028 
...
0057               *--------------------------------------------------------------
0058 62A6 04F0     tx8024  byte  >04,>f0,>00,>3f,>02,>40,>03,SPFCLR,0,80
     62A8 003F 
     62AA 0240 
     62AC 03F4 
     62AE 0050 
...
0083               *--------------------------------------------------------------
0084 62B0 04F0     tx8030  byte  >04,>f0,>00,>3f,>02,>40,>03,SPFCLR,0,80
     62B2 003F 
     62B4 0240 
     62B6 03F4 
     62B8 0050 
...
0013 62BA 0606     mccode  data  >0606                 ; |         dec   r6 (tmp2)
0014 62BC 16FD             data  >16fd                 ; |         jne   mcloop
0015 62BE 045B             data  >045b                 ; /         b     *r11
0016               *--------------------------------------------------------------
0017               * ; Machine code for reading from the speech synthesizer
0018               * ; The SRC instruction takes 12 uS for execution in scratchpad RAM.
0019               * ; Is required for the 12 uS delay. It destroys R5.
0020               *--------------------------------------------------------------
0021 62C0 D114     spcode  data  >d114                 ; \         movb  *r4,r4 (tmp0)
0022 62C2 0BC5             data  >0bc5                 ; /         src   r5,12  (tmp1)
0023                       even
0024               
0025               
0026               ***************************************************************
...
0034               ********|*****|*********************|**************************
0035               loadmc:
0036 62C4 0201  20         li    r1,mccode             ; Machinecode to patch
     62C6 2214 
0037 62C8 0202  20         li    r2,mcloop+2           ; Scratch-pad reserved for machine code
     62CA 8322 
0038 62CC CCB1  46         mov   *r1+,*r2+             ; Copy 1st instruction
0039 62CE CCB1  46         mov   *r1+,*r2+             ; Copy 2nd instruction
0040 62D0 CCB1  46         mov   *r1+,*r2+             ; Copy 3rd instruction
0041 62D2 045B  20         b     *r11                  ; Return to caller
0042               
0043               
0044               *//////////////////////////////////////////////////////////////
...
0055               ********|*****|*********************|**************************
0056 62D4 C0F9  30 popr3   mov   *stack+,r3
0057 62D6 C0B9  30 popr2   mov   *stack+,r2
0058 62D8 C079  30 popr1   mov   *stack+,r1
0059 62DA C039  30 popr0   mov   *stack+,r0
0060 62DC C2F9  30 poprt   mov   *stack+,r11
0061 62DE 045B  20         b     *r11
0062               
0063               
0064               
0065               *//////////////////////////////////////////////////////////////
...
0084               ********|*****|*********************|**************************
0085 62E0 C13B  30 film    mov   *r11+,tmp0            ; Memory start
0086 62E2 C17B  30         mov   *r11+,tmp1            ; Byte to fill
0087 62E4 C1BB  30         mov   *r11+,tmp2            ; Repeat count
0088               *--------------------------------------------------------------
0089               * Assert
0090               *--------------------------------------------------------------
0091 62E6 C1C6  18 xfilm   mov   tmp2,tmp3             ; Bytes to fill = 0 ?
0092 62E8 1604  14         jne   filchk                ; No, continue checking
0093               
0094 62EA C80B  38         mov   r11,@>ffce            ; \ Save caller address
     62EC FFCE 
0095 62EE 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     62F0 2026 
0096               *--------------------------------------------------------------
0097               *       Check: 1 byte fill
0098               *--------------------------------------------------------------
0099 62F2 D820  54 filchk  movb  @tmp1lb,@tmp1hb       ; Duplicate value
     62F4 830B 
     62F6 830A 
0100               
0101 62F8 0286  22         ci    tmp2,1                ; Bytes to fill = 1 ?
     62FA 0001 
0102 62FC 1602  14         jne   filchk2
0103 62FE DD05  32         movb  tmp1,*tmp0+
0104 6300 045B  20         b     *r11                  ; Exit
0105               *--------------------------------------------------------------
0106               *       Check: 2 byte fill
0107               *--------------------------------------------------------------
0108 6302 0286  22 filchk2 ci    tmp2,2                ; Byte to fill = 2 ?
     6304 0002 
0109 6306 1603  14         jne   filchk3
0110 6308 DD05  32         movb  tmp1,*tmp0+           ; Deal with possible uneven start address
0111 630A DD05  32         movb  tmp1,*tmp0+
0112 630C 045B  20         b     *r11                  ; Exit
0113               *--------------------------------------------------------------
0114               *       Check: Handle uneven start address
0115               *--------------------------------------------------------------
0116 630E C1C4  18 filchk3 mov   tmp0,tmp3
0117 6310 0247  22         andi  tmp3,1                ; TMP3=1 -> ODD else EVEN
     6312 0001 
0118 6314 1305  14         jeq   fil16b
0119 6316 DD05  32         movb  tmp1,*tmp0+           ; Copy 1st byte
0120 6318 0606  14         dec   tmp2
0121 631A 0286  22         ci    tmp2,2                ; Do we only have 1 word left?
     631C 0002 
0122 631E 13F1  14         jeq   filchk2               ; Yes, copy word and exit
0123               *--------------------------------------------------------------
0124               *       Fill memory with 16 bit words
0125               *--------------------------------------------------------------
0126 6320 C1C6  18 fil16b  mov   tmp2,tmp3
0127 6322 0247  22         andi  tmp3,1                ; TMP3=1 -> ODD else EVEN
     6324 0001 
0128 6326 1301  14         jeq   dofill
0129 6328 0606  14         dec   tmp2                  ; Make TMP2 even
0130 632A CD05  34 dofill  mov   tmp1,*tmp0+
0131 632C 0646  14         dect  tmp2
0132 632E 16FD  14         jne   dofill
0133               *--------------------------------------------------------------
0134               * Fill last byte if ODD
0135               *--------------------------------------------------------------
0136 6330 C1C7  18         mov   tmp3,tmp3
0137 6332 1301  14         jeq   fil.exit
0138 6334 DD05  32         movb  tmp1,*tmp0+
0139               fil.exit:
0140 6336 045B  20         b     *r11
0141               
0142               
0143               ***************************************************************
...
0158               ********|*****|*********************|**************************
0159 6338 C13B  30 filv    mov   *r11+,tmp0            ; Memory start
0160 633A C17B  30         mov   *r11+,tmp1            ; Byte to fill
0161 633C C1BB  30         mov   *r11+,tmp2            ; Repeat count
0162               *--------------------------------------------------------------
0163               *    Setup VDP write address
0164               *--------------------------------------------------------------
0165 633E 0264  22 xfilv   ori   tmp0,>4000
     6340 4000 
0166 6342 06C4  14         swpb  tmp0
0167 6344 D804  38         movb  tmp0,@vdpa
     6346 8C02 
0168 6348 06C4  14         swpb  tmp0
0169 634A D804  38         movb  tmp0,@vdpa
     634C 8C02 
0170               *--------------------------------------------------------------
0171               *    Fill bytes in VDP memory
0172               *--------------------------------------------------------------
0173 634E 020F  20         li    r15,vdpw              ; Set VDP write address
     6350 8C00 
0174 6352 06C5  14         swpb  tmp1
0175 6354 C820  54         mov   @filzz,@mcloop        ; Setup move command
     6356 22B8 
     6358 8320 
0176 635A 0460  28         b     @mcloop               ; Write data to VDP
     635C 8320 
0177               *--------------------------------------------------------------
0181 635E D7C5     filzz   data  >d7c5                 ; MOVB TMP1,*R15
0183               
0184               
0185               
0186               *//////////////////////////////////////////////////////////////
...
0200               ********|*****|*********************|**************************
0201 6360 0264  22 vdwa    ori   tmp0,>4000            ; Prepare VDP address for write
     6362 4000 
0202 6364 06C4  14 vdra    swpb  tmp0
0203 6366 D804  38         movb  tmp0,@vdpa
     6368 8C02 
0204 636A 06C4  14         swpb  tmp0
0205 636C D804  38         movb  tmp0,@vdpa            ; Set VDP address
     636E 8C02 
0206 6370 045B  20         b     *r11                  ; Exit
0207               
0208               ***************************************************************
...
0216               ********|*****|*********************|**************************
0217 6372 C13B  30 vputb   mov   *r11+,tmp0            ; Get VDP target address
0218 6374 C17B  30         mov   *r11+,tmp1            ; Get byte to write
0219               *--------------------------------------------------------------
0220               * Set VDP write address
0221               *--------------------------------------------------------------
0222 6376 0264  22 xvputb  ori   tmp0,>4000            ; Prepare VDP address for write
     6378 4000 
0223 637A 06C4  14         swpb  tmp0                  ; \
0224 637C D804  38         movb  tmp0,@vdpa            ; | Set VDP write address
     637E 8C02 
0225 6380 06C4  14         swpb  tmp0                  ; | inlined @vdwa call
0226 6382 D804  38         movb  tmp0,@vdpa            ; /
     6384 8C02 
0227               *--------------------------------------------------------------
0228               * Write byte
0229               *--------------------------------------------------------------
0230 6386 06C5  14         swpb  tmp1                  ; LSB to MSB
0231 6388 D7C5  30         movb  tmp1,*r15             ; Write byte
0232 638A 045B  20         b     *r11                  ; Exit
0233               
0234               
0235               ***************************************************************
...
0250               ********|*****|*********************|**************************
0251 638C C13B  30 vgetb   mov   *r11+,tmp0            ; Get VDP source address
0252               *--------------------------------------------------------------
0253               * Set VDP read address
0254               *--------------------------------------------------------------
0255 638E 06C4  14 xvgetb  swpb  tmp0                  ; \
0256 6390 D804  38         movb  tmp0,@vdpa            ; | Set VDP read address
     6392 8C02 
0257 6394 06C4  14         swpb  tmp0                  ; | inlined @vdra call
0258 6396 D804  38         movb  tmp0,@vdpa            ; /
     6398 8C02 
0259               *--------------------------------------------------------------
0260               * Read byte
0261               *--------------------------------------------------------------
0262 639A D120  34         movb  @vdpr,tmp0            ; Read byte
     639C 8800 
0263 639E 0984  56         srl   tmp0,8                ; Right align
0264 63A0 045B  20         b     *r11                  ; Exit
0265               
0266               
0267               ***************************************************************
...
0282               ********|*****|*********************|**************************
0283 63A2 C13B  30 vidtab  mov   *r11+,tmp0            ; Get video mode table
0284 63A4 C394  26 xidtab  mov   *tmp0,r14             ; Store copy of VDP#0 and #1 in RAM
0285               *--------------------------------------------------------------
0286               * Calculate PNT base address
0287               *--------------------------------------------------------------
0288 63A6 C144  18         mov   tmp0,tmp1
0289 63A8 05C5  14         inct  tmp1
0290 63AA D155  26         movb  *tmp1,tmp1            ; Get value for VDP#2
0291 63AC 0245  22         andi  tmp1,>ff00            ; Only keep MSB
     63AE FF00 
0292 63B0 0A25  56         sla   tmp1,2                ; TMP1 *= 400
0293 63B2 C805  38         mov   tmp1,@wbase           ; Store calculated base
     63B4 8328 
0294               *--------------------------------------------------------------
0295               * Dump VDP shadow registers
0296               *--------------------------------------------------------------
0297 63B6 0205  20         li    tmp1,>8000            ; Start with VDP register 0
     63B8 8000 
0298 63BA 0206  20         li    tmp2,8
     63BC 0008 
0299 63BE D834  48 vidta1  movb  *tmp0+,@tmp1lb        ; Write value to VDP register
     63C0 830B 
0300 63C2 06C5  14         swpb  tmp1
0301 63C4 D805  38         movb  tmp1,@vdpa
     63C6 8C02 
0302 63C8 06C5  14         swpb  tmp1
0303 63CA D805  38         movb  tmp1,@vdpa
     63CC 8C02 
0304 63CE 0225  22         ai    tmp1,>0100
     63D0 0100 
0305 63D2 0606  14         dec   tmp2
0306 63D4 16F4  14         jne   vidta1                ; Next register
0307 63D6 C814  46         mov   *tmp0,@wcolmn         ; Store # of columns per row
     63D8 833A 
0308 63DA 045B  20         b     *r11
0309               
0310               
0311               ***************************************************************
...
0324               ********|*****|*********************|**************************
0325 63DC C13B  30 putvr   mov   *r11+,tmp0
0326 63DE 0264  22 putvrx  ori   tmp0,>8000
     63E0 8000 
0327 63E2 06C4  14         swpb  tmp0
0328 63E4 D804  38         movb  tmp0,@vdpa
     63E6 8C02 
0329 63E8 06C4  14         swpb  tmp0
0330 63EA D804  38         movb  tmp0,@vdpa
     63EC 8C02 
0331 63EE 045B  20         b     *r11
0332               
0333               
0334               ***************************************************************
...
0337               *  BL   @PUTV01
0338               ********|*****|*********************|**************************
0339 63F0 C20B  18 putv01  mov   r11,tmp4              ; Save R11
0340 63F2 C10E  18         mov   r14,tmp0
0341 63F4 0984  56         srl   tmp0,8
0342 63F6 06A0  32         bl    @putvrx               ; Write VR#0
     63F8 2338 
0343 63FA 0204  20         li    tmp0,>0100
     63FC 0100 
0344 63FE D820  54         movb  @r14lb,@tmp0lb
     6400 831D 
     6402 8309 
0345 6404 06A0  32         bl    @putvrx               ; Write VR#1
     6406 2338 
0346 6408 0458  20         b     *tmp4                 ; Exit
0347               
0348               
0349               ***************************************************************
...
0359               ********|*****|*********************|**************************
0360 640A C20B  18 ldfnt   mov   r11,tmp4              ; Save R11
0361 640C 05CB  14         inct  r11                   ; Get 2nd parameter (font options)
0362 640E C11B  26         mov   *r11,tmp0             ; Get P0
0363 6410 0242  22         andi  config,>7fff          ; CONFIG register bit 0=0
     6412 7FFF 
0364 6414 2120  38         coc   @wbit0,tmp0
     6416 2020 
0365 6418 1604  14         jne   ldfnt1
0366 641A 0262  22         ori   config,>8000          ; CONFIG register bit 0=1
     641C 8000 
0367 641E 0244  22         andi  tmp0,>7fff            ; Parameter value bit 0=0
     6420 7FFF 
0368               *--------------------------------------------------------------
0369               * Read font table address from GROM into tmp1
0370               *--------------------------------------------------------------
0371 6422 C124  34 ldfnt1  mov   @tmp006(tmp0),tmp0    ; Load GROM index address into tmp0
     6424 23E6 
0372 6426 D804  38         movb  tmp0,@grmwa           ; Setup GROM source byte 1 for reading
     6428 9C02 
0373 642A 06C4  14         swpb  tmp0
0374 642C D804  38         movb  tmp0,@grmwa           ; Setup GROM source byte 2 for reading
     642E 9C02 
0375 6430 D160  34         movb  @grmrd,tmp1           ; Read font table address byte 1
     6432 9800 
0376 6434 06C5  14         swpb  tmp1
0377 6436 D160  34         movb  @grmrd,tmp1           ; Read font table address byte 2
     6438 9800 
0378 643A 06C5  14         swpb  tmp1
0379               *--------------------------------------------------------------
0380               * Setup GROM source address from tmp1
0381               *--------------------------------------------------------------
0382 643C D805  38         movb  tmp1,@grmwa
     643E 9C02 
0383 6440 06C5  14         swpb  tmp1
0384 6442 D805  38         movb  tmp1,@grmwa           ; Setup GROM address for reading
     6444 9C02 
0385               *--------------------------------------------------------------
0386               * Setup VDP target address
0387               *--------------------------------------------------------------
0388 6446 C118  26         mov   *tmp4,tmp0            ; Get P1 (VDP destination)
0389 6448 06A0  32         bl    @vdwa                 ; Setup VDP destination address
     644A 22BA 
0390 644C 05C8  14         inct  tmp4                  ; R11=R11+2
0391 644E C158  26         mov   *tmp4,tmp1            ; Get font options into TMP1
0392 6450 0245  22         andi  tmp1,>7fff            ; Parameter value bit 0=0
     6452 7FFF 
0393 6454 C1A5  34         mov   @tmp006+2(tmp1),tmp2  ; Get number of patterns to copy
     6456 23E8 
0394 6458 C165  34         mov   @tmp006+4(tmp1),tmp1  ; 7 or 8 byte pattern ?
     645A 23EA 
0395               *--------------------------------------------------------------
0396               * Copy from GROM to VRAM
0397               *--------------------------------------------------------------
0398 645C 0B15  56 ldfnt2  src   tmp1,1                ; Carry set ?
0399 645E 1812  14         joc   ldfnt4                ; Yes, go insert a >00
0400 6460 D120  34         movb  @grmrd,tmp0
     6462 9800 
0401               *--------------------------------------------------------------
0402               *   Make font fat
0403               *--------------------------------------------------------------
0404 6464 20A0  38         coc   @wbit0,config         ; Fat flag set ?
     6466 2020 
0405 6468 1603  14         jne   ldfnt3                ; No, so skip
0406 646A D1C4  18         movb  tmp0,tmp3
0407 646C 0917  56         srl   tmp3,1
0408 646E E107  18         soc   tmp3,tmp0
0409               *--------------------------------------------------------------
0410               *   Dump byte to VDP and do housekeeping
0411               *--------------------------------------------------------------
0412 6470 D804  38 ldfnt3  movb  tmp0,@vdpw            ; Dump byte to VRAM
     6472 8C00 
0413 6474 0606  14         dec   tmp2
0414 6476 16F2  14         jne   ldfnt2
0415 6478 05C8  14         inct  tmp4                  ; R11=R11+2
0416 647A 020F  20         li    r15,vdpw              ; Set VDP write address
     647C 8C00 
0417 647E 0242  22         andi  config,>7fff          ; CONFIG register bit 0=0
     6480 7FFF 
0418 6482 0458  20         b     *tmp4                 ; Exit
0419 6484 D820  54 ldfnt4  movb  @hb$00,@vdpw          ; Insert byte >00 into VRAM
     6486 2000 
     6488 8C00 
0420 648A 10E8  14         jmp   ldfnt2
0421               *--------------------------------------------------------------
0422               * Fonts pointer table
0423               *--------------------------------------------------------------
0424 648C 004C     tmp006  data  >004c,64*8,>0000      ; Pointer to TI title screen font
     648E 0200 
     6490 0000 
0425 6492 004E             data  >004e,64*7,>0101      ; Pointer to upper case font
     6494 01C0 
     6496 0101 
0426 6498 004E             data  >004e,96*7,>0101      ; Pointer to upper & lower case font
     649A 02A0 
     649C 0101 
0427 649E 0050             data  >0050,32*7,>0101      ; Pointer to lower case font
     64A0 00E0 
     64A2 0101 
0428               
0429               
...
0443               *  TMP0, R14, R15
0444               ********|*****|*********************|**************************
0445 64A4 C10E  18 yx2pnt  mov   r14,tmp0              ; Save VDP#0 & VDP#1
0446 64A6 C3A0  34         mov   @wyx,r14              ; Get YX
     64A8 832A 
0447 64AA 098E  56         srl   r14,8                 ; Right justify (remove X)
0448 64AC 3BA0  72         mpy   @wcolmn,r14           ; pos = Y * (columns per row)
     64AE 833A 
0449               *--------------------------------------------------------------
0450               * Do rest of calculation with R15 (16 bit part is there)
0451               * Re-use R14
0452               *--------------------------------------------------------------
0453 64B0 C3A0  34         mov   @wyx,r14              ; Get YX
     64B2 832A 
0454 64B4 024E  22         andi  r14,>00ff             ; Remove Y
     64B6 00FF 
0455 64B8 A3CE  18         a     r14,r15               ; pos = pos + X
0456 64BA A3E0  34         a     @wbase,r15            ; pos = pos + (PNT base address)
     64BC 8328 
0457               *--------------------------------------------------------------
0458               * Clean up before exit
0459               *--------------------------------------------------------------
0460 64BE C384  18         mov   tmp0,r14              ; Restore VDP#0 & VDP#1
0461 64C0 C10F  18         mov   r15,tmp0              ; Return pos in TMP0
0462 64C2 020F  20         li    r15,vdpw              ; VDP write address
     64C4 8C00 
0463 64C6 045B  20         b     *r11
0464               
0465               
0466               
0467               ***************************************************************
...
0479               *  tmp1, tmp2, tmp3
0480               ********|*****|*********************|**************************
0481 64C8 C17B  30 putstr  mov   *r11+,tmp1
0482 64CA D1B5  28 xutst0  movb  *tmp1+,tmp2           ; Get length byte
0483 64CC C1CB  18 xutstr  mov   r11,tmp3
0484 64CE 06A0  32         bl    @yx2pnt               ; Get VDP destination address
     64D0 23FE 
0485 64D2 C2C7  18         mov   tmp3,r11
0486 64D4 0986  56         srl   tmp2,8                ; Right justify length byte
0487               *--------------------------------------------------------------
0488               * Put string
0489               *--------------------------------------------------------------
0490 64D6 C186  18         mov   tmp2,tmp2             ; Length = 0 ?
0491 64D8 1305  14         jeq   !                     ; Yes, crash and burn
0492               
0493 64DA 0286  22         ci    tmp2,255              ; Length > 255 ?
     64DC 00FF 
0494 64DE 1502  14         jgt   !                     ; Yes, crash and burn
0495               
0496 64E0 0460  28         b     @xpym2v               ; Display string
     64E2 2490 
0497               *--------------------------------------------------------------
0498               * Crash handler
0499               *--------------------------------------------------------------
0500 64E4 C80B  38 !       mov   r11,@>ffce            ; \ Save caller address
     64E6 FFCE 
0501 64E8 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     64EA 2026 
0502               
0503               
0504               
...
0516               ********|*****|*********************|**************************
0517 64EC C83B  50 putat   mov   *r11+,@wyx            ; Set YX position
     64EE 832A 
0518 64F0 0460  28         b     @putstr
     64F2 2422 
0519               
0520               
0521               ***************************************************************
...
0537               ********|*****|*********************|**************************
0538               putlst:
0539 64F4 0649  14         dect  stack
0540 64F6 C64B  30         mov   r11,*stack            ; Save return address
0541 64F8 0649  14         dect  stack
0542 64FA C644  30         mov   tmp0,*stack           ; Push tmp0
0543                       ;------------------------------------------------------
0544                       ; Dump strings to VDP
0545                       ;------------------------------------------------------
0546               putlst.loop:
0547 64FC D1D5  26         movb  *tmp1,tmp3            ; Get string length byte
0548 64FE 0987  56         srl   tmp3,8                ; Right align
0549               
0550 6500 0649  14         dect  stack
0551 6502 C645  30         mov   tmp1,*stack           ; Push tmp1
0552 6504 0649  14         dect  stack
0553 6506 C646  30         mov   tmp2,*stack           ; Push tmp2
0554 6508 0649  14         dect  stack
0555 650A C647  30         mov   tmp3,*stack           ; Push tmp3
0556               
0557 650C 06A0  32         bl    @xutst0               ; Display string
     650E 2424 
0558                                                   ; \ i  tmp1 = Pointer to string
0559                                                   ; / i  @wyx = Cursor position at
0560               
0561 6510 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0562 6512 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0563 6514 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0564               
0565 6516 06A0  32         bl    @down                 ; Move cursor down
     6518 26D8 
0566               
0567 651A A147  18         a     tmp3,tmp1             ; Add string length to pointer
0568 651C 0585  14         inc   tmp1                  ; Consider length byte
0569 651E 2560  38         czc   @w$0001,tmp1          ; Is address even ?
     6520 2002 
0570 6522 1301  14         jeq   !                     ; Yes, skip adjustment
0571 6524 0585  14         inc   tmp1                  ; Make address even
0572 6526 0606  14 !       dec   tmp2
0573 6528 15E9  14         jgt   putlst.loop
0574                       ;------------------------------------------------------
0575                       ; Exit
0576                       ;------------------------------------------------------
0577               putlst.exit:
0578 652A C139  30         mov   *stack+,tmp0          ; Pop tmp0
0579 652C C2F9  30         mov   *stack+,r11           ; Pop r11
0580 652E 045B  20         b     *r11                  ; Return
**** **** ****     > runlib.asm
0091               
...
0019               ********|*****|*********************|**************************
0020 6530 C13B  30 cpym2v  mov   *r11+,tmp0            ; VDP Start address
0021 6532 C17B  30         mov   *r11+,tmp1            ; RAM/ROM start address
0022 6534 C1BB  30         mov   *r11+,tmp2            ; Bytes to copy
0023               *--------------------------------------------------------------
0024               *    Assert
0025               *--------------------------------------------------------------
0026 6536 C186  18 xpym2v  mov   tmp2,tmp2             ; Bytes to copy = 0 ?
0027 6538 1604  14         jne   !                     ; No, continue
0028               
0029 653A C80B  38         mov   r11,@>ffce            ; \ Save caller address
     653C FFCE 
0030 653E 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     6540 2026 
0031               *--------------------------------------------------------------
0032               *    Setup VDP write address
0033               *--------------------------------------------------------------
0034 6542 0264  22 !       ori   tmp0,>4000
     6544 4000 
0035 6546 06C4  14         swpb  tmp0
0036 6548 D804  38         movb  tmp0,@vdpa
     654A 8C02 
0037 654C 06C4  14         swpb  tmp0
0038 654E D804  38         movb  tmp0,@vdpa
     6550 8C02 
0039               *--------------------------------------------------------------
0040               *    Copy bytes from CPU memory to VRAM
0041               *--------------------------------------------------------------
0042 6552 020F  20         li    r15,vdpw              ; Set VDP write address
     6554 8C00 
0043 6556 C820  54         mov   @tmp008,@mcloop       ; Setup copy command
     6558 24BA 
     655A 8320 
0044 655C 0460  28         b     @mcloop               ; Write data to VDP and return
     655E 8320 
0045               *--------------------------------------------------------------
0046               * Data
0047               *--------------------------------------------------------------
0048 6560 D7F5     tmp008  data  >d7f5                 ; MOVB *TMP1+,*R15
**** **** ****     > runlib.asm
0095               
...
0018               *  TMP2 = Number of bytes to copy
0019               ********|*****|*********************|**************************
0020 6562 C13B  30 cpyv2m  mov   *r11+,tmp0            ; VDP source address
0021 6564 C17B  30         mov   *r11+,tmp1            ; Target address in RAM
0022 6566 C1BB  30         mov   *r11+,tmp2            ; Bytes to copy
0023               *--------------------------------------------------------------
0024               *    Setup VDP read address
0025               *--------------------------------------------------------------
0026 6568 06C4  14 xpyv2m  swpb  tmp0
0027 656A D804  38         movb  tmp0,@vdpa
     656C 8C02 
0028 656E 06C4  14         swpb  tmp0
0029 6570 D804  38         movb  tmp0,@vdpa
     6572 8C02 
0030               *--------------------------------------------------------------
0031               *    Copy bytes from VDP memory to RAM
0032               *--------------------------------------------------------------
0033 6574 020F  20         li    r15,vdpr              ; Set VDP read address
     6576 8800 
0034 6578 C820  54         mov   @tmp007,@mcloop       ; Setup copy command
     657A 24DC 
     657C 8320 
0035 657E 0460  28         b     @mcloop               ; Read data from VDP
     6580 8320 
0036 6582 DD5F     tmp007  data  >dd5f                 ; MOVB *R15,*TMP+
**** **** ****     > runlib.asm
0099               
...
0023               ********|*****|*********************|**************************
0024 6584 C13B  30 cpym2m  mov   *r11+,tmp0            ; Memory source address
0025 6586 C17B  30         mov   *r11+,tmp1            ; Memory target address
0026 6588 C1BB  30         mov   *r11+,tmp2            ; Number of bytes to copy
0027               *--------------------------------------------------------------
0028               * Do some checks first
0029               *--------------------------------------------------------------
0030 658A C186  18 xpym2m  mov   tmp2,tmp2             ; Bytes to copy = 0 ?
0031 658C 1604  14         jne   cpychk                ; No, continue checking
0032               
0033 658E C80B  38         mov   r11,@>ffce            ; \ Save caller address
     6590 FFCE 
0034 6592 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     6594 2026 
0035               *--------------------------------------------------------------
0036               *    Check: 1 byte copy
0037               *--------------------------------------------------------------
0038 6596 0286  22 cpychk  ci    tmp2,1                ; Bytes to copy = 1 ?
     6598 0001 
0039 659A 1603  14         jne   cpym0                 ; No, continue checking
0040 659C DD74  42         movb  *tmp0+,*tmp1+         ; Copy byte
0041 659E 04C6  14         clr   tmp2                  ; Reset counter
0042 65A0 045B  20         b     *r11                  ; Return to caller
0043               *--------------------------------------------------------------
0044               *    Check: Uneven address handling
0045               *--------------------------------------------------------------
0046 65A2 0242  22 cpym0   andi  config,>7fff          ; Clear CONFIG bit 0
     65A4 7FFF 
0047 65A6 C1C4  18         mov   tmp0,tmp3
0048 65A8 0247  22         andi  tmp3,1
     65AA 0001 
0049 65AC 1618  14         jne   cpyodd                ; Odd source address handling
0050 65AE C1C5  18 cpym1   mov   tmp1,tmp3
0051 65B0 0247  22         andi  tmp3,1
     65B2 0001 
0052 65B4 1614  14         jne   cpyodd                ; Odd target address handling
0053               *--------------------------------------------------------------
0054               * 8 bit copy
0055               *--------------------------------------------------------------
0056 65B6 20A0  38 cpym2   coc   @wbit0,config         ; CONFIG bit 0 set ?
     65B8 2020 
0057 65BA 1605  14         jne   cpym3
0058 65BC C820  54         mov   @tmp011,@mcloop       ; Setup byte copy command
     65BE 253E 
     65C0 8320 
0059 65C2 0460  28         b     @mcloop               ; Copy memory and exit
     65C4 8320 
0060               *--------------------------------------------------------------
0061               * 16 bit copy
0062               *--------------------------------------------------------------
0063 65C6 C1C6  18 cpym3   mov   tmp2,tmp3
0064 65C8 0247  22         andi  tmp3,1                ; TMP3=1 -> ODD else EVEN
     65CA 0001 
0065 65CC 1301  14         jeq   cpym4
0066 65CE 0606  14         dec   tmp2                  ; Make TMP2 even
0067 65D0 CD74  46 cpym4   mov   *tmp0+,*tmp1+
0068 65D2 0646  14         dect  tmp2
0069 65D4 16FD  14         jne   cpym4
0070               *--------------------------------------------------------------
0071               * Copy last byte if ODD
0072               *--------------------------------------------------------------
0073 65D6 C1C7  18         mov   tmp3,tmp3
0074 65D8 1301  14         jeq   cpymz
0075 65DA D554  38         movb  *tmp0,*tmp1
0076 65DC 045B  20 cpymz   b     *r11                  ; Return to caller
0077               *--------------------------------------------------------------
0078               * Handle odd source/target address
0079               *--------------------------------------------------------------
0080 65DE 0262  22 cpyodd  ori   config,>8000          ; Set CONFIG bit 0
     65E0 8000 
0081 65E2 10E9  14         jmp   cpym2
0082 65E4 DD74     tmp011  data  >dd74                 ; MOVB *TMP0+,*TMP1+
**** **** ****     > runlib.asm
0103               
0107               
0111               
...
0060               ********|*****|*********************|**************************
0061               sams.page.get:
0062 65E6 C13B  30         mov   *r11+,tmp0            ; Memory address
0063               xsams.page.get:
0064 65E8 0649  14         dect  stack
0065 65EA C64B  30         mov   r11,*stack            ; Push return address
0066 65EC 0649  14         dect  stack
0067 65EE C640  30         mov   r0,*stack             ; Push r0
0068 65F0 0649  14         dect  stack
0069 65F2 C64C  30         mov   r12,*stack            ; Push r12
0070               *--------------------------------------------------------------
0071               * Determine memory bank
0072               *--------------------------------------------------------------
0073 65F4 09C4  56         srl   tmp0,12               ; Reduce address to 4K chunks
0074 65F6 0A14  56         sla   tmp0,1                ; Registers are 2 bytes appart
0075               
0076 65F8 0224  22         ai    tmp0,>4000            ; Add base address of "DSR" space
     65FA 4000 
0077 65FC C804  38         mov   tmp0,@waux2           ; Save address of SAMS register
     65FE 833E 
0078               *--------------------------------------------------------------
0079               * Get SAMS page number
0080               *--------------------------------------------------------------
0081 6600 020C  20         li    r12,>1e00             ; SAMS CRU address
     6602 1E00 
0082 6604 04C0  14         clr   r0
0083 6606 1D00  20         sbo   0                     ; Enable access to SAMS registers
0084 6608 D014  26         movb  *tmp0,r0              ; Get SAMS page number
0085 660A D100  18         movb  r0,tmp0
0086 660C 0984  56         srl   tmp0,8                ; Right align
0087 660E C804  38         mov   tmp0,@waux1           ; Save SAMS page number
     6610 833C 
0088 6612 1E00  20         sbz   0                     ; Disable access to SAMS registers
0089               *--------------------------------------------------------------
0090               * Exit
0091               *--------------------------------------------------------------
0092               sams.page.get.exit:
0093 6614 C339  30         mov   *stack+,r12           ; Pop r12
0094 6616 C039  30         mov   *stack+,r0            ; Pop r0
0095 6618 C2F9  30         mov   *stack+,r11           ; Pop return address
0096 661A 045B  20         b     *r11                  ; Return to caller
0097               
0098               
0099               
0100               
...
0129               ********|*****|*********************|**************************
0130               sams.page.set:
0131 661C C13B  30         mov   *r11+,tmp0            ; Get SAMS page
0132 661E C17B  30         mov   *r11+,tmp1            ; Get memory address
0133               xsams.page.set:
0134 6620 0649  14         dect  stack
0135 6622 C64B  30         mov   r11,*stack            ; Push return address
0136 6624 0649  14         dect  stack
0137 6626 C640  30         mov   r0,*stack             ; Push r0
0138 6628 0649  14         dect  stack
0139 662A C64C  30         mov   r12,*stack            ; Push r12
0140 662C 0649  14         dect  stack
0141 662E C644  30         mov   tmp0,*stack           ; Push tmp0
0142 6630 0649  14         dect  stack
0143 6632 C645  30         mov   tmp1,*stack           ; Push tmp1
0144               *--------------------------------------------------------------
0145               * Determine memory bank
0146               *--------------------------------------------------------------
0147 6634 09C5  56         srl   tmp1,12               ; Reduce address to 4K chunks
0148 6636 0A15  56         sla   tmp1,1                ; Registers are 2 bytes appart
0149               *--------------------------------------------------------------
0150               * Assert on SAMS page number
0151               *--------------------------------------------------------------
0152 6638 0284  22         ci    tmp0,255              ; Crash if page > 255
     663A 00FF 
0153 663C 150D  14         jgt   !
0154               *--------------------------------------------------------------
0155               * Assert on SAMS register
0156               *--------------------------------------------------------------
0157 663E 0285  22         ci    tmp1,>1e              ; r@401e   >f000 - >ffff
     6640 001E 
0158 6642 150A  14         jgt   !
0159 6644 0285  22         ci    tmp1,>04              ; r@4004   >2000 - >2fff
     6646 0004 
0160 6648 1107  14         jlt   !
0161 664A 0285  22         ci    tmp1,>12              ; r@4014   >a000 - >ffff
     664C 0012 
0162 664E 1508  14         jgt   sams.page.set.switch_page
0163 6650 0285  22         ci    tmp1,>06              ; r@4006   >3000 - >3fff
     6652 0006 
0164 6654 1501  14         jgt   !
0165 6656 1004  14         jmp   sams.page.set.switch_page
0166                       ;------------------------------------------------------
0167                       ; Crash the system
0168                       ;------------------------------------------------------
0169 6658 C80B  38 !       mov   r11,@>ffce            ; \ Save caller address
     665A FFCE 
0170 665C 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     665E 2026 
0171               *--------------------------------------------------------------
0172               * Switch memory bank to specified SAMS page
0173               *--------------------------------------------------------------
0174               sams.page.set.switch_page
0175 6660 020C  20         li    r12,>1e00             ; SAMS CRU address
     6662 1E00 
0176 6664 C004  18         mov   tmp0,r0               ; Must be in r0 for CRU use
0177 6666 06C0  14         swpb  r0                    ; LSB to MSB
0178 6668 1D00  20         sbo   0                     ; Enable access to SAMS registers
0179 666A D940  38         movb  r0,@>4000(tmp1)       ; Set SAMS bank number
     666C 4000 
0180 666E 1E00  20         sbz   0                     ; Disable access to SAMS registers
0181               *--------------------------------------------------------------
0182               * Exit
0183               *--------------------------------------------------------------
0184               sams.page.set.exit:
0185 6670 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0186 6672 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0187 6674 C339  30         mov   *stack+,r12           ; Pop r12
0188 6676 C039  30         mov   *stack+,r0            ; Pop r0
0189 6678 C2F9  30         mov   *stack+,r11           ; Pop return address
0190 667A 045B  20         b     *r11                  ; Return to caller
0191               
0192               
0193               
0194               
...
0204 667C 020C  20         li    r12,>1e00             ; SAMS CRU address
     667E 1E00 
0205 6680 1D01  20         sbo   1                     ; Enable SAMS mapper
0206               *--------------------------------------------------------------
0207               * Exit
0208               *--------------------------------------------------------------
0209               sams.mapping.on.exit:
0210 6682 045B  20         b     *r11                  ; Return to caller
0211               
0212               
0213               
0214               
...
0227 6684 020C  20         li    r12,>1e00             ; SAMS CRU address
     6686 1E00 
0228 6688 1E01  20         sbz   1                     ; Disable SAMS mapper
0229               *--------------------------------------------------------------
0230               * Exit
0231               *--------------------------------------------------------------
0232               sams.mapping.off.exit:
0233 668A 045B  20         b     *r11                  ; Return to caller
0234               
0235               
0236               
0237               
...
0258               ********|*****|*********************|**************************
0259               sams.layout:
0260 668C C1FB  30         mov   *r11+,tmp3            ; Get P0
0261               xsams.layout:
0262 668E 0649  14         dect  stack
0263 6690 C64B  30         mov   r11,*stack            ; Save return address
0264 6692 0649  14         dect  stack
0265 6694 C644  30         mov   tmp0,*stack           ; Save tmp0
0266 6696 0649  14         dect  stack
0267 6698 C645  30         mov   tmp1,*stack           ; Save tmp1
0268 669A 0649  14         dect  stack
0269 669C C646  30         mov   tmp2,*stack           ; Save tmp2
0270 669E 0649  14         dect  stack
0271 66A0 C647  30         mov   tmp3,*stack           ; Save tmp3
0272                       ;------------------------------------------------------
0273                       ; Initialize
0274                       ;------------------------------------------------------
0275 66A2 0206  20         li    tmp2,8                ; Set loop counter
     66A4 0008 
0276                       ;------------------------------------------------------
0277                       ; Set SAMS memory pages
0278                       ;------------------------------------------------------
0279               sams.layout.loop:
0280 66A6 C177  30         mov   *tmp3+,tmp1           ; Get memory address
0281 66A8 C137  30         mov   *tmp3+,tmp0           ; Get SAMS page
0282               
0283 66AA 06A0  32         bl    @xsams.page.set       ; \ Switch SAMS page
     66AC 257A 
0284                                                   ; | i  tmp0 = SAMS page
0285                                                   ; / i  tmp1 = Memory address
0286               
0287 66AE 0606  14         dec   tmp2                  ; Next iteration
0288 66B0 16FA  14         jne   sams.layout.loop      ; Loop until done
0289                       ;------------------------------------------------------
0290                       ; Exit
0291                       ;------------------------------------------------------
0292               sams.init.exit:
0293 66B2 06A0  32         bl    @sams.mapping.on      ; \ Turn on SAMS mapping for
     66B4 25D6 
0294                                                   ; / activating changes.
0295               
0296 66B6 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0297 66B8 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0298 66BA C179  30         mov   *stack+,tmp1          ; Pop tmp1
0299 66BC C139  30         mov   *stack+,tmp0          ; Pop tmp0
0300 66BE C2F9  30         mov   *stack+,r11           ; Pop r11
0301 66C0 045B  20         b     *r11                  ; Return to caller
0302               
0303               
0304               
0305               ***************************************************************
...
0318 66C2 0649  14         dect  stack
0319 66C4 C64B  30         mov   r11,*stack            ; Save return address
0320                       ;------------------------------------------------------
0321                       ; Set SAMS standard layout
0322                       ;------------------------------------------------------
0323 66C6 06A0  32         bl    @sams.layout
     66C8 25E6 
0324 66CA 262A                   data sams.layout.standard
0325                       ;------------------------------------------------------
0326                       ; Exit
0327                       ;------------------------------------------------------
0328               sams.layout.reset.exit:
0329 66CC C2F9  30         mov   *stack+,r11           ; Pop r11
0330 66CE 045B  20         b     *r11                  ; Return to caller
0331               ***************************************************************
0332               * SAMS standard page layout table (16 words)
0333               *--------------------------------------------------------------
0334               sams.layout.standard:
0335 66D0 2000             data  >2000,>0002           ; >2000-2fff, SAMS page >02
     66D2 0002 
0336 66D4 3000             data  >3000,>0003           ; >3000-3fff, SAMS page >03
     66D6 0003 
0337 66D8 A000             data  >a000,>000a           ; >a000-afff, SAMS page >0a
     66DA 000A 
0338 66DC B000             data  >b000,>000b           ; >b000-bfff, SAMS page >0b
     66DE 000B 
0339 66E0 C000             data  >c000,>000c           ; >c000-cfff, SAMS page >0c
     66E2 000C 
0340 66E4 D000             data  >d000,>000d           ; >d000-dfff, SAMS page >0d
     66E6 000D 
0341 66E8 E000             data  >e000,>000e           ; >e000-efff, SAMS page >0e
     66EA 000E 
0342 66EC F000             data  >f000,>000f           ; >f000-ffff, SAMS page >0f
     66EE 000F 
0343               
0344               
0345               
...
0363 66F0 C1FB  30         mov   *r11+,tmp3            ; Get P0
0364               
0365 66F2 0649  14         dect  stack
0366 66F4 C64B  30         mov   r11,*stack            ; Push return address
0367 66F6 0649  14         dect  stack
0368 66F8 C644  30         mov   tmp0,*stack           ; Push tmp0
0369 66FA 0649  14         dect  stack
0370 66FC C645  30         mov   tmp1,*stack           ; Push tmp1
0371 66FE 0649  14         dect  stack
0372 6700 C646  30         mov   tmp2,*stack           ; Push tmp2
0373 6702 0649  14         dect  stack
0374 6704 C647  30         mov   tmp3,*stack           ; Push tmp3
0375                       ;------------------------------------------------------
0376                       ; Copy SAMS layout
0377                       ;------------------------------------------------------
0378 6706 0205  20         li    tmp1,sams.layout.copy.data
     6708 2682 
0379 670A 0206  20         li    tmp2,8                ; Set loop counter
     670C 0008 
0380                       ;------------------------------------------------------
0381                       ; Set SAMS memory pages
0382                       ;------------------------------------------------------
0383               sams.layout.copy.loop:
0384 670E C135  30         mov   *tmp1+,tmp0           ; Get memory address
0385 6710 06A0  32         bl    @xsams.page.get       ; \ Get SAMS page
     6712 2542 
0386                                                   ; | i  tmp0   = Memory address
0387                                                   ; / o  @waux1 = SAMS page
0388               
0389 6714 CDE0  50         mov   @waux1,*tmp3+         ; Copy SAMS page number
     6716 833C 
0390               
0391 6718 0606  14         dec   tmp2                  ; Next iteration
0392 671A 16F9  14         jne   sams.layout.copy.loop ; Loop until done
0393                       ;------------------------------------------------------
0394                       ; Exit
0395                       ;------------------------------------------------------
0396               sams.layout.copy.exit:
0397 671C C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0398 671E C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0399 6720 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0400 6722 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0401 6724 C2F9  30         mov   *stack+,r11           ; Pop r11
0402 6726 045B  20         b     *r11                  ; Return to caller
0403               ***************************************************************
0404               * SAMS memory range table (8 words)
0405               *--------------------------------------------------------------
0406               sams.layout.copy.data:
0407 6728 2000             data  >2000                 ; >2000-2fff
0408 672A 3000             data  >3000                 ; >3000-3fff
0409 672C A000             data  >a000                 ; >a000-afff
0410 672E B000             data  >b000                 ; >b000-bfff
0411 6730 C000             data  >c000                 ; >c000-cfff
0412 6732 D000             data  >d000                 ; >d000-dfff
0413 6734 E000             data  >e000                 ; >e000-efff
0414 6736 F000             data  >f000                 ; >f000-ffff
0415               
**** **** ****     > runlib.asm
0115               
...
0007               *  BL @SCROFF
0008               ********|*****|*********************|**************************
0009 6738 024E  22 scroff  andi  r14,>ffbf             ; VDP#R1 bit 1=0 (Disable screen display)
     673A FFBF 
0010 673C 0460  28         b     @putv01
     673E 234A 
0011               
0012               ***************************************************************
...
0015               *  BL @SCRON
0016               ********|*****|*********************|**************************
0017 6740 026E  22 scron   ori   r14,>0040             ; VDP#R1 bit 1=1 (Enable screen display)
     6742 0040 
0018 6744 0460  28         b     @putv01
     6746 234A 
0019               
0020               ***************************************************************
...
0023               *  BL @INTOFF
0024               ********|*****|*********************|**************************
0025 6748 024E  22 intoff  andi  r14,>ffdf             ; VDP#R1 bit 2=0 (Disable VDP interrupt)
     674A FFDF 
0026 674C 0460  28         b     @putv01
     674E 234A 
0027               
0028               ***************************************************************
...
0031               *  BL @INTON
0032               ********|*****|*********************|**************************
0033 6750 026E  22 inton   ori   r14,>0020             ; VDP#R1 bit 2=1 (Enable VDP interrupt)
     6752 0020 
0034 6754 0460  28         b     @putv01
     6756 234A 
**** **** ****     > runlib.asm
0119               
...
0008               *  BL @SMAG1X
0009               ********|*****|*********************|**************************
0010 6758 024E  22 smag1x  andi  r14,>fffe             ; VDP#R1 bit 7=0 (Sprite magnification 1x)
     675A FFFE 
0011 675C 0460  28         b     @putv01
     675E 234A 
0012               
0013               ***************************************************************
...
0016               *  BL @SMAG2X
0017               ********|*****|*********************|**************************
0018 6760 026E  22 smag2x  ori   r14,>0001             ; VDP#R1 bit 7=1 (Sprite magnification 2x)
     6762 0001 
0019 6764 0460  28         b     @putv01
     6766 234A 
0020               
0021               ***************************************************************
...
0024               *  BL @S8X8
0025               ********|*****|*********************|**************************
0026 6768 024E  22 s8x8    andi  r14,>fffd             ; VDP#R1 bit 6=0 (Sprite size 8x8)
     676A FFFD 
0027 676C 0460  28         b     @putv01
     676E 234A 
0028               
0029               ***************************************************************
...
0032               *  BL @S16X16
0033               ********|*****|*********************|**************************
0034 6770 026E  22 s16x16  ori   r14,>0002             ; VDP#R1 bit 6=1 (Sprite size 16x16)
     6772 0002 
0035 6774 0460  28         b     @putv01
     6776 234A 
**** **** ****     > runlib.asm
0123               
...
0017               ********|*****|*********************|**************************
0018 6778 C83B  50 at      mov   *r11+,@wyx
     677A 832A 
0019 677C 045B  20         b     *r11
0020               
0021               
0022               ***************************************************************
...
0025               *  bl   @down
0026               ********|*****|*********************|**************************
0027 677E B820  54 down    ab    @hb$01,@wyx
     6780 2012 
     6782 832A 
0028 6784 045B  20         b     *r11
0029               
0030               
0031               ***************************************************************
...
0034               *  bl   @up
0035               ********|*****|*********************|**************************
0036 6786 7820  54 up      sb    @hb$01,@wyx
     6788 2012 
     678A 832A 
0037 678C 045B  20         b     *r11
0038               
0039               
0040               ***************************************************************
...
0047               *  TMP0
0048               ********|*****|*********************|**************************
0049 678E C13B  30 setx    mov   *r11+,tmp0            ; Set cursor X position
0050 6790 D120  34 xsetx   movb  @wyx,tmp0             ; Overwrite Y position
     6792 832A 
0051 6794 C804  38         mov   tmp0,@wyx             ; Save as new YX position
     6796 832A 
0052 6798 045B  20         b     *r11
**** **** ****     > runlib.asm
0127               
...
0020               ********|*****|*********************|**************************
0021 679A C120  34 yx2px   mov   @wyx,tmp0
     679C 832A 
0022 679E C18B  18 yx2pxx  mov   r11,tmp2              ; Save return address
0023 67A0 06C4  14         swpb  tmp0                  ; Y<->X
0024 67A2 04C5  14         clr   tmp1                  ; Clear before copy
0025 67A4 D144  18         movb  tmp0,tmp1             ; Copy X to TMP1
0026               *--------------------------------------------------------------
0027               * X pixel - Special F18a 80 colums treatment
0028               *--------------------------------------------------------------
0029 67A6 20A0  38         coc   @wbit1,config         ; f18a present ?
     67A8 201E 
0030 67AA 1609  14         jne   yx2pxx_normal         ; No, skip 80 cols handling
0031 67AC 8820  54         c     @wcolmn,@yx2pxx_c80   ; 80 columns mode enabled ?
     67AE 833A 
     67B0 2734 
0032 67B2 1605  14         jne   yx2pxx_normal         ; No, skip 80 cols handling
0033               
0034 67B4 0A15  56         sla   tmp1,1                ; X = X * 2
0035 67B6 B144  18         ab    tmp0,tmp1             ; X = X + (original X)
0036 67B8 0225  22         ai    tmp1,>0500            ; X = X + 5 (F18a mystery offset)
     67BA 0500 
0037 67BC 1002  14         jmp   yx2pxx_y_calc
0038               *--------------------------------------------------------------
0039               * X pixel - Normal VDP treatment
0040               *--------------------------------------------------------------
0041               yx2pxx_normal:
0042 67BE D144  18         movb  tmp0,tmp1             ; Copy X to TMP1
0043               *--------------------------------------------------------------
0044 67C0 0A35  56         sla   tmp1,3                ; X=X*8
0045               *--------------------------------------------------------------
0046               * Calculate Y pixel position
0047               *--------------------------------------------------------------
0048               yx2pxx_y_calc:
0049 67C2 0A34  56         sla   tmp0,3                ; Y=Y*8
0050 67C4 D105  18         movb  tmp1,tmp0
0051 67C6 06C4  14         swpb  tmp0                  ; X<->Y
0052 67C8 20A0  38 yx2pi1  coc   @wbit0,config         ; Skip sprite adjustment ?
     67CA 2020 
0053 67CC 1305  14         jeq   yx2pi3                ; Yes, exit
0054               *--------------------------------------------------------------
0055               * Adjust for Y sprite location
0056               * See VDP Programmers Guide, Section 9.2.1
0057               *--------------------------------------------------------------
0058 67CE 7120  34 yx2pi2  sb    @hb$01,tmp0           ; Adjust Y. Top of screen is at >FF
     67D0 2012 
0059 67D2 9120  34         cb    @hb$d0,tmp0           ; Y position = >D0 ?
     67D4 2024 
0060 67D6 13FB  14         jeq   yx2pi2                ; Yes, but that's not allowed, adjust
0061 67D8 0456  20 yx2pi3  b     *tmp2                 ; Exit
0062               *--------------------------------------------------------------
0063               * Local constants
0064               *--------------------------------------------------------------
0065               yx2pxx_c80:
0066 67DA 0050            data   80
0067               
0068               
**** **** ****     > runlib.asm
0131               
...
0011               *  bl   @f18unl
0012               ********|*****|*********************|**************************
0013 67DC C20B  18 f18unl  mov   r11,tmp4              ; Save R11
0014 67DE 06A0  32         bl    @putvr                ; Write once
     67E0 2336 
0015 67E2 391C             data  >391c                 ; VR1/57, value 00011100
0016 67E4 06A0  32         bl    @putvr                ; Write twice
     67E6 2336 
0017 67E8 391C             data  >391c                 ; VR1/57, value 00011100
0018 67EA 0458  20         b     *tmp4                 ; Exit
0019               
0020               
0021               ***************************************************************
...
0024               *  bl   @f18lck
0025               ********|*****|*********************|**************************
0026 67EC C20B  18 f18lck  mov   r11,tmp4              ; Save R11
0027 67EE 06A0  32         bl    @putvr                ; VR1/57, value 00011100
     67F0 2336 
0028 67F2 391C             data  >391c
0029 67F4 0458  20         b     *tmp4                 ; Exit
0030               
0031               
0032               ***************************************************************
...
0039               ********|*****|*********************|**************************
0040 67F6 C20B  18 f18chk  mov   r11,tmp4              ; Save R11
0041 67F8 06A0  32         bl    @cpym2v
     67FA 248A 
0042 67FC 3F00             data  >3f00,f18chk_gpu,8    ; Copy F18A GPU code to VRAM
     67FE 2794 
     6800 0008 
0043 6802 06A0  32         bl    @putvr
     6804 2336 
0044 6806 363F             data  >363f                 ; Load MSB of GPU PC (>3f) into VR54 (>36)
0045 6808 06A0  32         bl    @putvr
     680A 2336 
0046 680C 3700             data  >3700                 ; Load LSB of GPU PC (>00) into VR55 (>37)
0047                                                   ; GPU code should run now
0048               ***************************************************************
0049               * VDP @>3f00 == 0 ? F18A present : F18a not present
0050               ***************************************************************
0051 680E 0204  20         li    tmp0,>3f00
     6810 3F00 
0052 6812 06A0  32         bl    @vdra                 ; Set VDP read address to >3f00
     6814 22BE 
0053 6816 D120  34         movb  @vdpr,tmp0            ; Read MSB byte
     6818 8800 
0054 681A 0984  56         srl   tmp0,8
0055 681C D120  34         movb  @vdpr,tmp0            ; Read LSB byte
     681E 8800 
0056 6820 C104  18         mov   tmp0,tmp0             ; For comparing with 0
0057 6822 1303  14         jeq   f18chk_yes
0058               f18chk_no:
0059 6824 0242  22         andi  config,>bfff          ; CONFIG Register bit 1=0
     6826 BFFF 
0060 6828 1002  14         jmp   f18chk_exit
0061               f18chk_yes:
0062 682A 0262  22         ori   config,>4000          ; CONFIG Register bit 1=1
     682C 4000 
0063               f18chk_exit:
0064 682E 06A0  32         bl    @filv                 ; Clear VDP mem >3f00->3f07
     6830 2292 
0065 6832 3F00             data  >3f00,>00,6
     6834 0000 
     6836 0006 
0066 6838 0458  20         b     *tmp4                 ; Exit
0067               ***************************************************************
0068               * GPU code
0069               ********|*****|*********************|**************************
0070               f18chk_gpu
0071 683A 04E0             data  >04e0                 ; 3f00 \ 04e0  clr @>3f00
0072 683C 3F00             data  >3f00                 ; 3f02 / 3f00
0073 683E 0340             data  >0340                 ; 3f04   0340  idle
0074 6840 10FF             data  >10ff                 ; 3f06   10ff  jmp $
0075               
0076               
0077               ***************************************************************
...
0092               ********|*****|*********************|**************************
0093 6842 C20B  18 f18rst  mov   r11,tmp4              ; Save R11
0094                       ;------------------------------------------------------
0095                       ; Reset all F18a VDP registers to power-on defaults
0096                       ;------------------------------------------------------
0097 6844 06A0  32         bl    @putvr
     6846 2336 
0098 6848 3280             data  >3280                 ; F18a VR50 (>32), MSB 8=1
0099               
0100 684A 06A0  32         bl    @putvr                ; VR1/57, value 00011100
     684C 2336 
0101 684E 391C             data  >391c                 ; Lock the F18a
0102 6850 0458  20         b     *tmp4                 ; Exit
0103               
0104               
0105               
0106               ***************************************************************
...
0120               ********|*****|*********************|**************************
0121 6852 C20B  18 f18fwv  mov   r11,tmp4              ; Save R11
0122 6854 20A0  38         coc   @wbit1,config         ; CONFIG bit 1 set ?
     6856 201E 
0123 6858 1609  14         jne   f18fw1
0124               ***************************************************************
0125               * Read F18A major/minor version
0126               ***************************************************************
0127 685A C120  34         mov   @vdps,tmp0            ; Clear VDP status register
     685C 8802 
0128 685E 06A0  32         bl    @putvr                ; Write to VR#15 for setting F18A status
     6860 2336 
0129 6862 0F0E             data  >0f0e                 ; register to read (0e=VR#14)
0130 6864 04C4  14         clr   tmp0
0131 6866 D120  34         movb  @vdps,tmp0
     6868 8802 
0132 686A 0984  56         srl   tmp0,8
0133 686C 0458  20 f18fw1  b     *tmp4                 ; Exit
**** **** ****     > runlib.asm
0143               
...
0057 6BCC 2B28             data  dsrlnk.init           ; Entry point
0058                       ;------------------------------------------------------
...
0310 6CF8 2C54             data  dsrlnk.reuse.init     ; entry point
0311                       ;------------------------------------------------------
...
0253               ********|*****|*********************|**************************
0260 6EEE 04E0  34 runlib  clr   @>8302                ; Reset exit flag (R1 in workspace WS1!)
     6EF0 8302 
0262               *--------------------------------------------------------------
0263               * Alternative entry point
0264               *--------------------------------------------------------------
0265 6EF2 0300  24 runli1  limi  0                     ; Turn off interrupts
     6EF4 0000 
0266 6EF6 02E0  18         lwpi  ws1                   ; Activate workspace 1
     6EF8 8300 
0267 6EFA C0E0  34         mov   @>83c0,r3             ; Get random seed from OS monitor
     6EFC 83C0 
0268               *--------------------------------------------------------------
0269               * Clear scratch-pad memory from R4 upwards
0270               *--------------------------------------------------------------
0271 6EFE 0202  20 runli2  li    r2,>8308
     6F00 8308 
0272 6F02 04F2  30 runli3  clr   *r2+                  ; Clear scratchpad >8306->83FF
0273 6F04 0282  22         ci    r2,>8400
     6F06 8400 
0274 6F08 16FC  14         jne   runli3
0275               *--------------------------------------------------------------
0276               * Exit to TI-99/4A title screen ?
0277               *--------------------------------------------------------------
0278 6F0A 0281  22 runli3a ci    r1,>ffff              ; Exit flag set ?
     6F0C FFFF 
0279 6F0E 1602  14         jne   runli4                ; No, continue
0280 6F10 0420  54         blwp  @0                    ; Yes, bye bye
     6F12 0000 
0281               *--------------------------------------------------------------
0282               * Determine if VDP is PAL or NTSC
0283               *--------------------------------------------------------------
0284 6F14 C803  38 runli4  mov   r3,@waux1             ; Store random seed
     6F16 833C 
0285 6F18 04C1  14         clr   r1                    ; Reset counter
0286 6F1A 0202  20         li    r2,10                 ; We test 10 times
     6F1C 000A 
0287 6F1E C0E0  34 runli5  mov   @vdps,r3
     6F20 8802 
0288 6F22 20E0  38         coc   @wbit0,r3             ; Interupt flag set ?
     6F24 2020 
0289 6F26 1302  14         jeq   runli6
0290 6F28 0581  14         inc   r1                    ; Increase counter
0291 6F2A 10F9  14         jmp   runli5
0292 6F2C 0602  14 runli6  dec   r2                    ; Next test
0293 6F2E 16F7  14         jne   runli5
0294 6F30 0281  22         ci    r1,>1250              ; Max for NTSC reached ?
     6F32 1250 
0295 6F34 1202  14         jle   runli7                ; No, so it must be NTSC
0296 6F36 0262  22         ori   config,palon          ; Yes, it must be PAL, set flag
     6F38 201C 
0297               *--------------------------------------------------------------
0298               * Copy machine code to scratchpad (prepare tight loop)
0299               *--------------------------------------------------------------
0300 6F3A 06A0  32 runli7  bl    @loadmc
     6F3C 221E 
0301               *--------------------------------------------------------------
0302               * Initialize registers, memory, ...
0303               *--------------------------------------------------------------
0304 6F3E 04C1  14 runli9  clr   r1
0305 6F40 04C2  14         clr   r2
0306 6F42 04C3  14         clr   r3
0307 6F44 0209  20         li    stack,sp2.stktop      ; Set top of stack (grows downwards!)
     6F46 3000 
0308 6F48 020F  20         li    r15,vdpw              ; Set VDP write address
     6F4A 8C00 
0312               *--------------------------------------------------------------
0313               * Setup video memory
0314               *--------------------------------------------------------------
0316 6F4C 0280  22         ci    r0,>4a4a              ; Crash flag set?
     6F4E 4A4A 
0317 6F50 1605  14         jne   runlia
0318 6F52 06A0  32         bl    @filv                 ; Clear 12K VDP memory instead
     6F54 2292 
0319 6F56 0000             data  >0000,>00,>3000       ; of 16K, so that PABs survive
     6F58 0000 
     6F5A 3000 
0324 6F5C 06A0  32 runlia  bl    @filv
     6F5E 2292 
0325 6F60 0FC0             data  pctadr,spfclr,16      ; Load color table
     6F62 00F4 
     6F64 0010 
0326               *--------------------------------------------------------------
0327               * Check if there is a F18A present
0328               *--------------------------------------------------------------
0332 6F66 06A0  32         bl    @f18unl               ; Unlock the F18A
     6F68 2736 
0333 6F6A 06A0  32         bl    @f18chk               ; Check if F18A is there
     6F6C 2750 
0334 6F6E 06A0  32         bl    @f18lck               ; Lock the F18A again
     6F70 2746 
0335               
0336 6F72 06A0  32         bl    @putvr                ; Reset all F18a extended registers
     6F74 2336 
0337 6F76 3201                   data >3201            ; F18a VR50 (>32), bit 1
0339               *--------------------------------------------------------------
...
0349               *--------------------------------------------------------------
0350 6F78 06A0  32 runlic  bl    @vidtab               ; Load video mode table into VDP
     6F7A 22FC 
0351 6F7C 339A             data  spvmod                ; Equate selected video mode table
0352 6F7E 0204  20         li    tmp0,spfont           ; Get font option
     6F80 000C 
0353 6F82 0544  14         inv   tmp0                  ; NOFONT (>FFFF) specified ?
0354 6F84 1304  14         jeq   runlid                ; Yes, skip it
0355 6F86 06A0  32         bl    @ldfnt
     6F88 2364 
0356 6F8A 1100             data  fntadr,spfont         ; Load specified font
     6F8C 000C 
0357               *--------------------------------------------------------------
0358               * Did a system crash occur before runlib was called?
0359               *--------------------------------------------------------------
0360 6F8E 0280  22 runlid  ci    r0,>4a4a              ; Crash flag set?
     6F90 4A4A 
0361 6F92 1602  14         jne   runlie                ; No, continue
0362 6F94 0460  28         b     @cpu.crash.main       ; Yes, back to crash handler
     6F96 2086 
0363               *--------------------------------------------------------------
0364               * Branch to main program
0365               *--------------------------------------------------------------
0366 6F98 0262  22 runlie  ori   config,>0040          ; Enable kernel thread (bit 9 on)
     6F9A 0040 
0367 6F9C 0460  28         b     @main                 ; Give control to main program
     6F9E 3000 
**** **** ****     > stevie_b0.asm.1959432
0125                                                   ; Spectra 2
0126                       ;------------------------------------------------------
...
0128                       ;------------------------------------------------------
0129 6FA0 DEAD             data  >dead,>beef,>dead,>beef
     6FA2 BEEF 
     6FA4 DEAD 
     6FA6 BEEF 
0131               
0135 6FA8 2F02                   data $                ; Bank 0 ROM size OK.
0137               
0138 6FAA ....             bss  300                    ; Fill remaining space with >00
0139               
0140               ***************************************************************
...
0150               
0154               
0155 70DA 0460  28         b     @kickstart.code2      ; Jump to entry routine
     70DC 6046 
0156                       ;------------------------------------------------------
...
0019               ********|*****|*********************|**************************
0020               rom.farjump:
0021 70DE C13B  30         mov   *r11+,tmp0            ; P0
0022 70E0 C17B  30         mov   *r11+,tmp1            ; P1
0023 70E2 C1BB  30         mov   *r11+,tmp2            ; P2
0024                       ;------------------------------------------------------
0025                       ; Push registers to value stack (but not r11!)
0026                       ;------------------------------------------------------
0027               xrom.farjump:
0028 70E4 0649  14         dect  stack
0029 70E6 C644  30         mov   tmp0,*stack           ; Push tmp0
0030 70E8 0649  14         dect  stack
0031 70EA C645  30         mov   tmp1,*stack           ; Push tmp1
0032 70EC 0649  14         dect  stack
0033 70EE C646  30         mov   tmp2,*stack           ; Push tmp2
0034 70F0 0649  14         dect  stack
0035 70F2 C647  30         mov   tmp3,*stack           ; Push tmp3
0036                       ;------------------------------------------------------
0037                       ; Push to farjump return stack
0038                       ;------------------------------------------------------
0039 70F4 0284  22         ci    tmp0,>6000            ; Invalid bank write address?
     70F6 6000 
0040 70F8 1111  14         jlt   rom.farjump.bankswitch.failed1
0041                                                   ; Crash if bogus value in bank write address
0042               
0043 70FA C1E0  34         mov   @tv.fj.stackpnt,tmp3  ; Get farjump stack pointer
     70FC A026 
0044 70FE 0647  14         dect  tmp3
0045 7100 C5CB  30         mov   r11,*tmp3             ; Push return address to farjump stack
0046 7102 0647  14         dect  tmp3
0047 7104 C5C6  30         mov   tmp2,*tmp3            ; Push source ROM bank to farjump stack
0048 7106 C807  38         mov   tmp3,@tv.fj.stackpnt  ; Set farjump stack pointer
     7108 A026 
0049               
0053               
0054                       ;------------------------------------------------------
...
0058 710A 04D4  26         clr   *tmp0                 ; Switch to target ROM bank 8K >6000
0059 710C 1004  14         jmp   rom.farjump.bankswitch.tgt.done
0060                       ;------------------------------------------------------
0061                       ; Bankswitch to target 4K ROM / 4K RAM banks (FG99 advanced mode)
0062                       ;------------------------------------------------------
0063               rom.farjump.bankswitch.tgt.advfg99:
0064 710E 04D4  26         clr   *tmp0                 ; Switch to target ROM bank 4K >6000
0065 7110 0224  22         ai    tmp0,>0800
     7112 0800 
0066 7114 04D4  26         clr   *tmp0                 ; Switch to target RAM bank 4K >7000
0067                       ;------------------------------------------------------
0068                       ; Bankswitch to target bank(s) completed
0069                       ;------------------------------------------------------
0070               rom.farjump.bankswitch.tgt.done:
0071 7116 C115  26         mov   *tmp1,tmp0            ; Deref value in vector address
0072 7118 1301  14         jeq   rom.farjump.bankswitch.failed1
0073                                                   ; Crash if null-pointer in vector
0074 711A 1004  14         jmp   rom.farjump.bankswitch.call
0075                                                   ; Call function in target bank
0076                       ;------------------------------------------------------
0077                       ; Assert 1 failed before bank-switch
0078                       ;------------------------------------------------------
0079               rom.farjump.bankswitch.failed1:
0080 711C C80B  38         mov   r11,@>ffce            ; \ Save caller address
     711E FFCE 
0081 7120 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     7122 2026 
0082                       ;------------------------------------------------------
0083                       ; Call function in target bank
0084                       ;------------------------------------------------------
0085               rom.farjump.bankswitch.call:
0086 7124 0694  24         bl    *tmp0                 ; Call function
0087                       ;------------------------------------------------------
0088                       ; Bankswitch back to source bank
0089                       ;------------------------------------------------------
0090               rom.farjump.return:
0091 7126 C120  34         mov   @tv.fj.stackpnt,tmp0  ; Get farjump stack pointer
     7128 A026 
0092 712A C154  26         mov   *tmp0,tmp1            ; Get bank write address of caller
0093 712C 1312  14         jeq   rom.farjump.bankswitch.failed2
0094                                                   ; Crash if null-pointer in address
0095               
0096 712E 04F4  30         clr   *tmp0+                ; Remove bank write address from
0097                                                   ; farjump stack
0098               
0099 7130 C2D4  26         mov   *tmp0,r11             ; Get return addr of caller for return
0100               
0101 7132 04F4  30         clr   *tmp0+                ; Remove return address of caller from
0102                                                   ; farjump stack
0103               
0104 7134 028B  22         ci    r11,>6000
     7136 6000 
0105 7138 110C  14         jlt   rom.farjump.bankswitch.failed2
0106 713A 028B  22         ci    r11,>7fff
     713C 7FFF 
0107 713E 1509  14         jgt   rom.farjump.bankswitch.failed2
0108               
0109 7140 C804  38         mov   tmp0,@tv.fj.stackpnt  ; Update farjump return stack pointer
     7142 A026 
0110               
0114               
0115                       ;------------------------------------------------------
...
0119 7144 04D5  26         clr   *tmp1                 ; Switch to source ROM bank 8K >6000
0120 7146 1009  14         jmp   rom.farjump.exit
0121                       ;------------------------------------------------------
0122                       ; Bankswitch to source 4K ROM / 4K RAM banks (FG99 advanced mode)
0123                       ;------------------------------------------------------
0124               rom.farjump.bankswitch.src.advfg99:
0125 7148 04D5  26         clr   *tmp1                 ; Switch to source ROM bank 4K >6000
0126 714A 0225  22         ai    tmp1,>0800
     714C 0800 
0127 714E 04D5  26         clr   *tmp1                 ; Switch to source RAM bank 4K >7000
0128 7150 1004  14         jmp   rom.farjump.exit
0129                       ;------------------------------------------------------
0130                       ; Assert 2 failed after bank-switch
0131                       ;------------------------------------------------------
0132               rom.farjump.bankswitch.failed2:
0133 7152 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     7154 FFCE 
0134 7156 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     7158 2026 
0135                       ;-------------------------------------------------------
0136                       ; Exit
0137                       ;-------------------------------------------------------
0138               rom.farjump.exit:
0139 715A C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0140 715C C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0141 715E C179  30         mov   *stack+,tmp1          ; Pop tmp1
0142 7160 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0143 7162 045B  20         b     *r11                  ; Return to caller
**** **** ****     > ram.resident.3000.asm
...
0059 71B4 06A0  32         bl    @film
     71B6 223A 
0060 71B8 A600             data  fb.top,>00,fb.size    ; Clear it all the way
     71BA 0000 
     71BC 0960 
0061                       ;------------------------------------------------------
0062                       ; Exit
...
0043 7330 06A0  32         bl    @film
     7332 223A 
0044 7334 D000             data  cmdb.top,>00,cmdb.size
     7336 0000 
     7338 1000 
...
0031 734C 06A0  32         bl    @film
     734E 223A 
0032 7350 A02A                   data tv.error.msg,0,160
     7352 0000 
     7354 00A0 
0033                       ;-------------------------------------------------------
0034                       ; Exit
...
0027 73B4 06A0  32         bl    @mknum                ; Convert unsigned number to string
     73B6 29DA 
0028 73B8 2F20                   data parm1            ; \ i p0  = Pointer to 16bit unsigned number
0029 73BA 2F6A                   data rambuf           ; | i p1  = Pointer to 5 byte string buffer
...
0038 73C8 06A0  32         bl    @trimnum              ; Trim unsigned number string
     73CA 2A32 
0039 73CC 2F6A                   data rambuf           ; \ i p0  = Pointer to 5 byte string buffer
0040 73CE 2F44                   data unpacked.string  ; | i p1  = Pointer to output buffer
...
0017 7450 0649  14         dect  stack
0018 7452 C64B  30         mov   r11,*stack            ; Save return address
0019                       ;------------------------------------------------------
0020                       ; Set SAMS standard layout
0021                       ;------------------------------------------------------
0022 7454 06A0  32         bl    @sams.layout
     7456 25E6 
0023 7458 33B2                   data mem.sams.layout.data
0024               
0025 745A 06A0  32         bl    @sams.layout.copy
     745C 264A 
0026 745E A000                   data tv.sams.2000     ; Get SAMS windows
0027               
0028 7460 C820  54         mov   @tv.sams.c000,@edb.sams.page
     7462 A008 
     7464 A216 
0029 7466 C820  54         mov   @edb.sams.page,@edb.sams.hipage
     7468 A216 
     746A A218 
...
0035 746C C2F9  30         mov   *stack+,r11           ; Pop r11
0036 746E 045B  20         b     *r11                  ; Return to caller
**** **** ****     > ram.resident.3000.asm
...
0031               ***************************************************************
0032               stevie.tx8030:
0033 7470 04F0             byte  >04,>f0,>00,>3f,>02,>43,>05,SPFCLR,0,80
     7472 003F 
     7474 0243 
     7476 05F4 
     7478 0050 
0034               
0035               romsat:
0036 747A 0000             data  >0000,>0201             ; Cursor YX, initial shape and colour
     747C 0201 
0037 747E 0000             data  >0000,>0301             ; Current line indicator
     7480 0301 
0038 7482 0820             data  >0820,>0401             ; Current line indicator
     7484 0401 
0039               nosprite:
0040 7486 D000             data  >d000                   ; End-of-Sprites list
0041               
0042               
0043               ***************************************************************
...
0047 7488 2000             data  >2000,>0002           ; >2000-2fff, SAMS page >02
     748A 0002 
0048 748C 3000             data  >3000,>0003           ; >3000-3fff, SAMS page >03
     748E 0003 
0049 7490 A000             data  >a000,>000a           ; >a000-afff, SAMS page >0a
     7492 000A 
0050               
0051 7494 B000             data  >b000,>0010           ; >b000-bfff, SAMS page >10
     7496 0010 
0052                                                   ; \ The index can allocate
0053                                                   ; / pages >10 to >2f.
0054               
0055 7498 C000             data  >c000,>0030           ; >c000-cfff, SAMS page >30
     749A 0030 
0056                                                   ; \ Editor buffer can allocate
0057                                                   ; / pages >30 to >ff.
0058               
0059 749C D000             data  >d000,>000d           ; >d000-dfff, SAMS page >0d
     749E 000D 
0060 74A0 E000             data  >e000,>000e           ; >e000-efff, SAMS page >0e
     74A2 000E 
0061 74A4 F000             data  >f000,>000f           ; >f000-ffff, SAMS page >0f
     74A6 000F 
0062               
0063               
0064               
...
0117 74A8 F417             data  >f417,>f171,>1b1f,>71b1 ; 1  White on blue with cyan touch
     74AA F171 
     74AC 1B1F 
     74AE 71B1 
0118 74B0 A11A             data  >a11a,>f0ff,>1f1a,>f1ff ; 2  Dark yellow on black
     74B2 F0FF 
     74B4 1F1A 
     74B6 F1FF 
0119 74B8 2112             data  >2112,>f0ff,>1f12,>f1f6 ; 3  Dark green on black
     74BA F0FF 
     74BC 1F12 
     74BE F1F6 
0120 74C0 F41F             data  >f41f,>1e11,>1a17,>1e11 ; 4  White on blue
     74C2 1E11 
     74C4 1A17 
     74C6 1E11 
0121 74C8 E11E             data  >e11e,>e1ff,>1f1e,>e1ff ; 5  Grey on black
     74CA E1FF 
     74CC 1F1E 
     74CE E1FF 
0122 74D0 1771             data  >1771,>1016,>1b71,>1711 ; 6  Black on cyan
     74D2 1016 
     74D4 1B71 
     74D6 1711 
0123 74D8 1FF1             data  >1ff1,>1011,>f1f1,>1f11 ; 7  Black on white
     74DA 1011 
     74DC F1F1 
     74DE 1F11 
0124 74E0 1AF1             data  >1af1,>a1ff,>1f1f,>f11f ; 8  Black on dark yellow
     74E2 A1FF 
     74E4 1F1F 
     74E6 F11F 
0125 74E8 21F0             data  >21f0,>12ff,>1b12,>12ff ; 9  Dark green on black
     74EA 12FF 
     74EC 1B12 
     74EE 12FF 
0126 74F0 F5F1             data  >f5f1,>e1ff,>1b1f,>f131 ; 10 White on light blue
     74F2 E1FF 
     74F4 1B1F 
     74F6 F131 
0127                       even
0128               
0129               tv.tabs.table:
0130 74F8 0007             byte  0,7,12,25               ; \   Default tab positions as used
     74FA 0C19 
0131 74FC 1E2D             byte  30,45,59,79             ; |   in Editor/Assembler module.
     74FE 3B4F 
0132 7500 FF00             byte  >ff,0,0,0               ; |
     7502 0000 
0133 7504 0000             byte  0,0,0,0                 ; |   Up to 20 positions supported.
     7506 0000 
0134 7508 0000             byte  0,0,0,0                 ; /   >ff means end-of-list.
     750A 0000 
0135                       even
**** **** ****     > ram.resident.3000.asm
...
0010               ;--------------------------------------------------------------
0011               txt.stevie
0012 750C 0B53             byte  11
0013 750D ....             text  'STEVIE 1.1K'
0014                       even
0015               
0016               txt.about.build
0017 7518 4C42             byte  76
0018 7519 ....             text  'Build: 210608-1959432 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
0023 7566 012C             byte  1
0024 7567 ....             text  ','
0025                       even
0026               
0027               txt.bottom
0028 7568 0520             byte  5
0029 7569 ....             text  '  BOT'
0030                       even
0031               
0032               txt.ovrwrite
0033 756E 034F             byte  3
0034 756F ....             text  'OVR'
0035                       even
0036               
0037               txt.insert
0038 7572 0349             byte  3
0039 7573 ....             text  'INS'
0040                       even
0041               
0042               txt.star
0043 7576 012A             byte  1
0044 7577 ....             text  '*'
0045                       even
0046               
0047               txt.loading
0048 7578 0A4C             byte  10
0049 7579 ....             text  'Loading...'
0050                       even
0051               
0052               txt.saving
0053 7584 0A53             byte  10
0054 7585 ....             text  'Saving....'
0055                       even
0056               
0057               txt.block.del
0058 7590 1244             byte  18
0059 7591 ....             text  'Deleting block....'
0060                       even
0061               
0062               txt.block.copy
0063 75A4 1143             byte  17
0064 75A5 ....             text  'Copying block....'
0065                       even
0066               
0067               txt.block.move
0068 75B6 104D             byte  16
0069 75B7 ....             text  'Moving block....'
0070                       even
0071               
0072               txt.block.save
0073 75C8 1D53             byte  29
0074 75C9 ....             text  'Saving block to DV80 file....'
0075                       even
0076               
0077               txt.fastmode
0078 75E6 0846             byte  8
0079 75E7 ....             text  'Fastmode'
0080                       even
0081               
0082               txt.kb
0083 75F0 026B             byte  2
0084 75F1 ....             text  'kb'
0085                       even
0086               
0087               txt.lines
0088 75F4 054C             byte  5
0089 75F5 ....             text  'Lines'
0090                       even
0091               
0092               txt.newfile
0093 75FA 0A5B             byte  10
0094 75FB ....             text  '[New file]'
0095                       even
0096               
0097               txt.filetype.dv80
0098 7606 0444             byte  4
0099 7607 ....             text  'DV80'
0100                       even
0101               
0102               txt.m1
0103 760C 034D             byte  3
0104 760D ....             text  'M1='
0105                       even
0106               
0107               txt.m2
0108 7610 034D             byte  3
0109 7611 ....             text  'M2='
0110                       even
0111               
0112               txt.keys.default
0113 7614 1B45             byte  27
0114 7615 ....             text  'Editor: ^Help, ^File, ^Quit'
0115                       even
0116               
0117               txt.keys.block
0118 7630 3342             byte  51
0119 7631 ....             text  'Block: F9=Back, ^Del, ^Copy, ^Move, ^Goto M1, ^Save'
0120                       even
0121               
0122 7664 ....     txt.ruler          text    '.........'
0123                                  byte    18
0124 766E ....                        text    '.........'
0125                                  byte    19
0126 7678 ....                        text    '.........'
...
0137                                  byte    25
0138                                  even
0139 76B4 020E     txt.alpha.down     data >020e,>0f00
     76B6 0F00 
0140 76B8 0110     txt.vertline       data >0110
0141 76BA 011C     txt.keymarker      byte 1,28
0142               
0143               txt.ws1
0144 76BC 0120             byte  1
0145 76BD ....             text  ' '
0146                       even
0147               
0148               txt.ws2
0149 76BE 0220             byte  2
0150 76BF ....             text  '  '
0151                       even
0152               
0153               txt.ws3
0154 76C2 0320             byte  3
0155 76C3 ....             text  '   '
0156                       even
0157               
0158               txt.ws4
0159 76C6 0420             byte  4
0160 76C7 ....             text  '    '
0161                       even
0162               
0163               txt.ws5
0164 76CC 0520             byte  5
0165 76CD ....             text  '     '
0166                       even
0167               
...
0173               ;--------------------------------------------------------------
0174 76D2 1301     txt.head.load      byte 19,1,3,32
     76D4 0320 
0175 76D6 ....                        text 'Open DV80 file '
0176                                  byte 2
0177               txt.hint.load
0178 76E6 3D53             byte  61
0179 76E7 ....             text  'Select Fastmode for file buffer in CPU RAM (HRD/HDX/IDE only)'
0180                       even
0181               
0182               
0183 7724 3C46     txt.keys.load      byte 60
0184 7725 ....                        text 'File'
0185                                  byte 27
0186 772A ....                        text 'Open: F9=Back, F3=Clear, F5=Fastmode, F-H=Home, F-L=End '
0187               
0188 7762 3D46     txt.keys.load2     byte 61
0189 7763 ....                        text 'File'
0190                                  byte 27
0191 7768 ....                        text 'Open: F9=Back, F3=Clear, *F5=Fastmode, F-H=Home, F-L=End '
0192               
0193               ;--------------------------------------------------------------
0194               ; Dialog Save DV 80 file
0195               ;--------------------------------------------------------------
0196 77A2 0103     txt.head.save      byte 19,1,3,32
     77A4 2053 
0197 77A5 ....                        text 'Save DV80 file '
0198 77B4 0223                        byte 2
0199 77B6 0103     txt.head.save2     byte 35,1,3,32
     77B8 2053 
0200 77B9 ....                        text 'Save marked block to DV80 file '
0201 77D8 0201                        byte 2
0202               txt.hint.save
0203                       byte  1
0204 77DA ....             text  ' '
0205                       even
0206               
0207               
0208 77DC 2F46     txt.keys.save      byte 47
0209 77DD ....                        text 'File'
0210                                  byte 27
0211 77E2 ....                        text 'Save: F9=Back, F3=Clear, F-H=Home, F-L=End'
0212               
0213               ;--------------------------------------------------------------
0214               ; Dialog "Unsaved changes"
0215               ;--------------------------------------------------------------
0216 780C 1401     txt.head.unsaved   byte 20,1,3,32
     780E 0320 
0217 7810 ....                        text 'Unsaved changes '
0218 7820 0221                        byte 2
0219               txt.info.unsaved
0220                       byte  33
0221 7822 ....             text  'Warning! Unsaved changes in file.'
0222                       even
0223               
0224               txt.hint.unsaved
0225 7844 2A50             byte  42
0226 7845 ....             text  'Press F6 to proceed or ENTER to save file.'
0227                       even
0228               
0229               txt.keys.unsaved
0230 7870 2D43             byte  45
0231 7871 ....             text  'Confirm: F9=Back, F6=Proceed, ENTER=Save file'
0232                       even
0233               
0234               
0235               ;--------------------------------------------------------------
0236               ; Dialog "About"
0237               ;--------------------------------------------------------------
0238 789E 0A01     txt.head.about     byte 10,1,3,32
     78A0 0320 
0239 78A2 ....                        text 'About '
0240 78A8 0200                        byte 2
0241               
0242               txt.info.about
0243                       byte  0
0244 78AA ....             text
...
0246               
0247               txt.hint.about
0248 78AA 1D50             byte  29
0249 78AB ....             text  'Press F9 to return to editor.'
0250                       even
0251               
0252 78C8 2148     txt.keys.about     byte 33
0253 78C9 ....                        text 'Help: F9=Back, '
0254 78D8 0E0F                        byte 14,15
0255 78DA ....                        text '=Alpha Lock down'
0256               
0257               
0258               ;--------------------------------------------------------------
0259               ; Dialog "File"
0260               ;--------------------------------------------------------------
0261 78EA 0901     txt.head.file      byte 9,1,3,32
     78EC 0320 
0262 78EE ....                        text 'File '
0263                                  byte 2
0264               
0265               txt.info.file
0266 78F4 0F4E             byte  15
0267 78F5 ....             text  'New, Open, Save'
0268                       even
0269               
0270 7904 0005     pos.info.file      byte 0,5,11,>ff
     7906 0BFF 
0271               txt.hint.file
0272 7908 2650             byte  38
0273 7909 ....             text  'Press N,O,S or F9 to return to editor.'
0274                       even
0275               
0276               txt.keys.file
0277 7930 0D46             byte  13
0278 7931 ....             text  'File: F9=Back'
0279                       even
0280               
0281               
0282               
...
0286               ;--------------------------------------------------------------
0287               txt.ioerr.load
0288 793E 2049             byte  32
0289 793F ....             text  'I/O error. Failed loading file: '
0290                       even
0291               
0292               txt.ioerr.save
0293 7960 2049             byte  32
0294 7961 ....             text  'I/O error. Failed saving file:  '
0295                       even
0296               
0297               txt.memfull.load
0298 7982 4049             byte  64
0299 7983 ....             text  'Index memory full. Could not fully load file into editor buffer.'
0300                       even
0301               
0302               txt.io.nofile
0303 79C4 2149             byte  33
0304 79C5 ....             text  'I/O error. No filename specified.'
0305                       even
0306               
0307               txt.block.inside
0308 79E6 3445             byte  52
0309 79E7 ....             text  'Error. Copy/Move target must be outside block M1-M2.'
0310                       even
0311               
0312               
0313               ;--------------------------------------------------------------
...
0317 7A1C 013E             byte  1
0318 7A1D ....             text  '>'
0319                       even
0320               
0321               txt.colorscheme
0322 7A1E 0D43             byte  13
0323 7A1F ....             text  'Color scheme:'
0324                       even
0325               
**** **** ****     > ram.resident.3000.asm
...
0021                       ;------------------------------------------------------
0022 7A2C DEAD             data  >dead,>beef,>dead,>beef
     7A2E BEEF 
     7A30 DEAD 
     7A32 BEEF 
**** **** ****     > stevie_b0.asm.1959432
0160               
0164 7A34 395E                   data $                ; Bank 0 ROM size OK.
0166               
0167                       ;------------------------------------------------------
0168                       ; Data patterns
0169                       ;------------------------------------------------------
...
0006               ;--------------------------------------------------------------
0007               cursors:
0008 7A36 0000             byte  >00,>00,>00,>00,>00,>00,>00,>1c ; Cursor 1 - Insert mode
     7A38 0000 
     7A3A 0000 
     7A3C 001C 
0009 7A3E 1010             byte  >10,>10,>10,>10,>10,>10,>10,>00 ; Cursor 2 - Insert mode
     7A40 1010 
     7A42 1010 
     7A44 1000 
0010 7A46 1C1C             byte  >1c,>1c,>1c,>1c,>1c,>1c,>1c,>00 ; Cursor 3 - Overwrite mode
     7A48 1C1C 
     7A4A 1C1C 
     7A4C 1C00 
0011 7A4E 0001             byte  >00,>01,>03,>07,>07,>03,>01,>00 ; Current line indicator    <
     7A50 0307 
     7A52 0703 
     7A54 0100 
0012 7A56 1C08             byte  >1c,>08,>00,>00,>00,>00,>00,>00 ; Current column indicator  v
     7A58 0000 
     7A5A 0000 
     7A5C 0000 
0013               
...
0020               ;--------------------------------------------------------------
0021               patterns:
0022 7A5E 0000             data  >0000,>0000,>ff00,>0000 ; 01. Single line
     7A60 0000 
     7A62 FF00 
     7A64 0000 
0023 7A66 8080             data  >8080,>8080,>ff80,>8080 ; 02. Connector |-
     7A68 8080 
     7A6A FF80 
     7A6C 8080 
0024 7A6E 0404             data  >0404,>0404,>ff04,>0404 ; 03. Connector -|
     7A70 0404 
     7A72 FF04 
     7A74 0404 
0025               
0026               patterns.box:
0027 7A76 0000             data  >0000,>0000,>ff80,>bfa0 ; 04. Top left corner
     7A78 0000 
     7A7A FF80 
     7A7C BFA0 
0028 7A7E 0000             data  >0000,>0000,>fc04,>f414 ; 05. Top right corner
     7A80 0000 
     7A82 FC04 
     7A84 F414 
0029 7A86 A0A0             data  >a0a0,>a0a0,>a0a0,>a0a0 ; 06. Left vertical double line
     7A88 A0A0 
     7A8A A0A0 
     7A8C A0A0 
0030 7A8E 1414             data  >1414,>1414,>1414,>1414 ; 07. Right vertical double line
     7A90 1414 
     7A92 1414 
     7A94 1414 
0031 7A96 A0A0             data  >a0a0,>a0a0,>bf80,>ff00 ; 08. Bottom left corner
     7A98 A0A0 
     7A9A BF80 
     7A9C FF00 
0032 7A9E 1414             data  >1414,>1414,>f404,>fc00 ; 09. Bottom right corner
     7AA0 1414 
     7AA2 F404 
     7AA4 FC00 
0033 7AA6 0000             data  >0000,>c0c0,>c0c0,>0080 ; 10. Double line top left corner
     7AA8 C0C0 
     7AAA C0C0 
     7AAC 0080 
0034 7AAE 0000             data  >0000,>0f0f,>0f0f,>0000 ; 11. Double line top right corner
     7AB0 0F0F 
     7AB2 0F0F 
     7AB4 0000 
0035               
0036               
0037               patterns.cr:
0038 7AB6 6C48             data  >6c48,>6c48,>4800,>7c00 ; 12. FF (Form Feed)
     7AB8 6C48 
     7ABA 4800 
     7ABC 7C00 
0039 7ABE 0024             data  >0024,>64fc,>6020,>0000 ; 13. CR (Carriage return) - arrow
     7AC0 64FC 
     7AC2 6020 
     7AC4 0000 
0040               
0041               
0042               alphalock:
0043 7AC6 FFC0             data  >ffc0,>8894,>9c94,>c0ff ; 14. alpha lock down - char1
     7AC8 8894 
     7ACA 9C94 
     7ACC C0FF 
0044 7ACE FC0C             data  >fc0c,>4444,>4474,>0cfc ; 15. alpha lock down - char2
     7AD0 4444 
     7AD2 4474 
     7AD4 0CFC 
0045               
0046               
0047               vertline:
0048 7AD6 1010             data  >1010,>1010,>1010,>1010 ; 16. Vertical line
     7AD8 1010 
     7ADA 1010 
     7ADC 1010 
0049 7ADE 0000             data  >0000,>0000,>3030,>3030 ; 17. Tab indicator
     7AE0 0000 
     7AE2 3030 
     7AE4 3030 
0050               
...
0054 7AE6 0000             byte >00,>00,>00,>10,>30,>10,>10,>38
     7AE8 0010 
     7AEA 3010 
     7AEC 1038 
0055 7AEE 0000             byte >00,>00,>00,>38,>08,>38,>20,>38
     7AF0 0038 
     7AF2 0838 
     7AF4 2038 
0056 7AF6 0000             byte >00,>00,>00,>38,>08,>38,>08,>38
     7AF8 0038 
     7AFA 0838 
     7AFC 0838 
0057 7AFE 0000             byte >00,>00,>00,>28,>28,>38,>08,>08
     7B00 0028 
     7B02 2838 
     7B04 0808 
0058                       ; digits 5-8 (22-25)
0059 7B06 0000             byte >00,>00,>00,>38,>20,>38,>08,>38
     7B08 0038 
     7B0A 2038 
     7B0C 0838 
0060 7B0E 0000             byte >00,>00,>00,>38,>20,>38,>28,>38
     7B10 0038 
     7B12 2038 
     7B14 2838 
0061 7B16 0000             byte >00,>00,>00,>38,>08,>10,>20,>20
     7B18 0038 
     7B1A 0810 
     7B1C 2020 
0062 7B1E 0000             byte >00,>00,>00,>38,>28,>38,>28,>38
     7B20 0038 
     7B22 2838 
     7B24 2838 
0063               
0064 7B26 007F     cursor: data  >007f,>7f7f,>7f7f,>7f7f ; 26. Cursor
     7B28 7F7F 
     7B2A 7F7F 
     7B2C 7F7F 
0065 7B2E 0000     arrow:  data  >0000,>0010,>08fc,>0810 ; 27. Arrow
     7B30 0010 
     7B32 08FC 
     7B34 0810 
0066 7B36 00FF     hline:  data  >00ff,>0000,>0000,>0000 ; 28. Key marker
     7B38 0000 
     7B3A 0000 
     7B3C 0000 
**** **** ****     > stevie_b0.asm.1959432
...
0173                       ;------------------------------------------------------
0177 7B3E 3A68                   data $                ; Bank 0 ROM size OK.
0179               
0180               *--------------------------------------------------------------
0181               * Video mode configuration for SP2
0182               *--------------------------------------------------------------
0183      00F4     spfclr  equ   >f4                   ; Foreground/Background color for font.
0184      0004     spfbck  equ   >04                   ; Screen background color.
0185      339A     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
