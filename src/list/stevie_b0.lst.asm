...
0008               ***************************************************************
0009               * File: stevie_b0.asm               ; Version 201206-93881
0010               *
0011               * Bank 0 "Jill"
0012               *
0013               ***************************************************************
...
0094 6128 2F64                   data rambuf           ; | i  p2 = Pointer to ram buffer
...
0106 613C 2F64                   data rambuf           ; | i  p2 = Pointer to ram buffer
...
0155 618A 2F64                   data rambuf           ; | i  p1 = Pointer to ram buffer
...
0163 6194 06A0  32         bl    @putstr               ; Put length-byte prefixed string at current YX
     6196 2420 
0164 6198 2F64                   data rambuf           ; \ i  p0 = Pointer to ram buffer
0165                                                   ; /
0166               
...
0180 61B6 2F64                   data rambuf           ; | i  p1 = Pointer to ram buffer
...
0189 61C0 2F64                   data rambuf           ; | i  p1 = Pointer to ram buffer
...
0204 61D6 06A0  32         bl    @putstr               ; Put length-byte prefixed string at current YX
     61D8 2420 
0205 61DA 2F64                   data rambuf           ; \ i  p0 = Pointer to ram buffer
0206                                                   ; /
0207               
...
0260 624D ....             text  'Build-ID  201206-93881'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0350 6F0C 06A0  32 runlic  bl    @vidtab               ; Load video mode table into VDP
     6F0E 22FA 
0351 6F10 32A6             data  spvmod                ; Equate selected video mode table
...
0123                       ;------------------------------------------------------
0124 6F34 DEAD             data  >dead,>beef,>dead,>beef
     6F36 BEEF 
     6F38 DEAD 
     6F3A BEEF 
0126               
0130 6F3C 2EC2                   data $                ; Bank 0 ROM size OK.
0132               
0133 6F3E ....             bss  300                    ; Fill remaining space with >00
0134               
0135               ***************************************************************
...
0142                       ;------------------------------------------------------
0143               main:
0144 706A 04E0  34         clr   @bank1                ; Activate bank 1 "James"
     706C 6002 
0145 706E 0460  28         b     @kickstart.code2      ; Jump to entry routine
     7070 6036 
0146                       ;------------------------------------------------------
...
0040 7088 0284  22         ci    tmp0,>6002            ; Invalid bank write address?
     708A 6002 
0041 708C 110C  14         jlt   rb.farjump.bankswitch.failed1
...
0056 70A2 1301  14         jeq   rb.farjump.bankswitch.failed1
0057                                                   ; Crash if null-pointer in vector
0058 70A4 1004  14         jmp   rb.farjump.bankswitch.call
...
0077 70B6 130D  14         jeq   rb.farjump.bankswitch.failed2
...
0088 70BE 028B  22         ci    r11,>6000
     70C0 6000 
0089 70C2 1107  14         jlt   rb.farjump.bankswitch.failed2
0090 70C4 028B  22         ci    r11,>7fff
     70C6 7FFF 
0091 70C8 1504  14         jgt   rb.farjump.bankswitch.failed2
0092               
...
0095 70D0 1004  14         jmp   rb.farjump.exit
0096                       ;------------------------------------------------------
...
0043                       ;------------------------------------------------------
0044 711C 06A0  32         bl    @film
     711E 2238 
0045 7120 A600             data  fb.top,>00,fb.size    ; Clear it all the way
     7122 0000 
     7124 0960 
0046                       ;------------------------------------------------------
0047                       ; Exit
0048                       ;------------------------------------------------------
0049               fb.init.exit:
0050 7126 C2F9  30         mov   *stack+,r11           ; Pop r11
0051 7128 045B  20         b     *r11                  ; Return to caller
0052               
**** **** ****     > mem.resident.3000.asm
...
0044               ********|*****|*********************|**************************
0045               idx.init:
0046 712A 0649  14         dect  stack
0047 712C C64B  30         mov   r11,*stack            ; Save return address
0048 712E 0649  14         dect  stack
0049 7130 C644  30         mov   tmp0,*stack           ; Push tmp0
0050                       ;------------------------------------------------------
0051                       ; Initialize
0052                       ;------------------------------------------------------
0053 7132 0204  20         li    tmp0,idx.top
     7134 B000 
0054 7136 C804  38         mov   tmp0,@edb.index.ptr   ; Set pointer to index in editor structure
     7138 A202 
0055               
0056 713A C120  34         mov   @tv.sams.b000,tmp0
     713C A006 
0057 713E C804  38         mov   tmp0,@idx.sams.page   ; Set current SAMS page
     7140 A500 
0058 7142 C804  38         mov   tmp0,@idx.sams.lopage ; Set 1st SAMS page
     7144 A502 
0059 7146 C804  38         mov   tmp0,@idx.sams.hipage ; Set last SAMS page
     7148 A504 
0060                       ;------------------------------------------------------
0061                       ; Clear index page
0062                       ;------------------------------------------------------
0063 714A 06A0  32         bl    @film
     714C 2238 
0064 714E B000                   data idx.top,>00,idx.size
     7150 0000 
     7152 1000 
0065                                                   ; Clear index
0066                       ;------------------------------------------------------
...
0068                       ;------------------------------------------------------
0069               idx.init.exit:
0070 7154 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0071 7156 C2F9  30         mov   *stack+,r11           ; Pop r11
0072 7158 045B  20         b     *r11                  ; Return to caller
0073               
0074               
0075               
0076               ***************************************************************
...
0097 715A 0649  14         dect  stack
0098 715C C64B  30         mov   r11,*stack            ; Push return address
0099 715E 0649  14         dect  stack
0100 7160 C644  30         mov   tmp0,*stack           ; Push tmp0
0101 7162 0649  14         dect  stack
0102 7164 C645  30         mov   tmp1,*stack           ; Push tmp1
0103 7166 0649  14         dect  stack
0104 7168 C646  30         mov   tmp2,*stack           ; Push tmp2
0105               *--------------------------------------------------------------
0106               * Map index pages into memory window  (b000-ffff)
0107               *--------------------------------------------------------------
0108 716A C120  34         mov   @idx.sams.lopage,tmp0 ; Get lowest index page
     716C A502 
0109 716E 0205  20         li    tmp1,idx.top
     7170 B000 
0110               
0111 7172 C1A0  34         mov   @idx.sams.hipage,tmp2 ; Get highest index page
     7174 A504 
0112 7176 0586  14         inc   tmp2                  ; +1 loop adjustment
0113 7178 61A0  34         s     @idx.sams.lopage,tmp2 ; Set loop counter
     717A A502 
0114                       ;-------------------------------------------------------
0115                       ; Sanity check
0116                       ;-------------------------------------------------------
0117 717C 0286  22         ci    tmp2,5                ; Crash if too many index pages
     717E 0005 
0118 7180 1104  14         jlt   !
0119 7182 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     7184 FFCE 
0120 7186 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     7188 2026 
0121                       ;-------------------------------------------------------
0122                       ; Loop over banks
0123                       ;-------------------------------------------------------
0124 718A 06A0  32 !       bl    @xsams.page.set       ; Set SAMS page
     718C 253C 
0125                                                   ; \ i  tmp0  = SAMS page number
0126                                                   ; / i  tmp1  = Memory address
0127               
0128 718E 0584  14         inc   tmp0                  ; Next SAMS index page
0129 7190 0225  22         ai    tmp1,>1000            ; Next memory region
     7192 1000 
0130 7194 0606  14         dec   tmp2                  ; Update loop counter
0131 7196 15F9  14         jgt   -!                    ; Next iteration
0132               *--------------------------------------------------------------
0133               * Exit
0134               *--------------------------------------------------------------
0135               _idx.sams.mapcolumn.on.exit:
0136 7198 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0137 719A C179  30         mov   *stack+,tmp1          ; Pop tmp1
0138 719C C139  30         mov   *stack+,tmp0          ; Pop tmp0
0139 719E C2F9  30         mov   *stack+,r11           ; Pop return address
0140 71A0 045B  20         b     *r11                  ; Return to caller
0141               
0142               
0143               ***************************************************************
...
0156 71A2 0649  14         dect  stack
0157 71A4 C64B  30         mov   r11,*stack            ; Push return address
0158 71A6 0649  14         dect  stack
0159 71A8 C644  30         mov   tmp0,*stack           ; Push tmp0
0160 71AA 0649  14         dect  stack
0161 71AC C645  30         mov   tmp1,*stack           ; Push tmp1
0162 71AE 0649  14         dect  stack
0163 71B0 C646  30         mov   tmp2,*stack           ; Push tmp2
0164 71B2 0649  14         dect  stack
0165 71B4 C647  30         mov   tmp3,*stack           ; Push tmp3
0166               *--------------------------------------------------------------
0167               * Map index pages into memory window  (b000-?????)
0168               *--------------------------------------------------------------
0169 71B6 0205  20         li    tmp1,idx.top
     71B8 B000 
0170 71BA 0206  20         li    tmp2,5                ; Always 5 pages
     71BC 0005 
0171 71BE 0207  20         li    tmp3,tv.sams.b000     ; Pointer to fist SAMS page
     71C0 A006 
0172                       ;-------------------------------------------------------
0173                       ; Loop over table in memory (@tv.sams.b000:@tv.sams.f000)
0174                       ;-------------------------------------------------------
0175 71C2 C137  30 !       mov   *tmp3+,tmp0           ; Get SAMS page
0176               
0177 71C4 06A0  32         bl    @xsams.page.set       ; Set SAMS page
     71C6 253C 
0178                                                   ; \ i  tmp0  = SAMS page number
0179                                                   ; / i  tmp1  = Memory address
0180               
0181 71C8 0225  22         ai    tmp1,>1000            ; Next memory region
     71CA 1000 
0182 71CC 0606  14         dec   tmp2                  ; Update loop counter
0183 71CE 15F9  14         jgt   -!                    ; Next iteration
0184               *--------------------------------------------------------------
0185               * Exit
0186               *--------------------------------------------------------------
0187               _idx.sams.mapcolumn.off.exit:
0188 71D0 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0189 71D2 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0190 71D4 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0191 71D6 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0192 71D8 C2F9  30         mov   *stack+,r11           ; Pop return address
0193 71DA 045B  20         b     *r11                  ; Return to caller
0194               
0195               
0196               
0197               ***************************************************************
...
0217 71DC 0649  14         dect  stack
0218 71DE C64B  30         mov   r11,*stack            ; Save return address
0219 71E0 0649  14         dect  stack
0220 71E2 C644  30         mov   tmp0,*stack           ; Push tmp0
0221 71E4 0649  14         dect  stack
0222 71E6 C645  30         mov   tmp1,*stack           ; Push tmp1
0223 71E8 0649  14         dect  stack
0224 71EA C646  30         mov   tmp2,*stack           ; Push tmp2
0225                       ;------------------------------------------------------
0226                       ; Determine SAMS index page
0227                       ;------------------------------------------------------
0228 71EC C184  18         mov   tmp0,tmp2             ; Line number
0229 71EE 04C5  14         clr   tmp1                  ; MSW (tmp1) = 0 / LSW (tmp2) = Line number
0230 71F0 0204  20         li    tmp0,2048             ; Index entries in 4K SAMS page
     71F2 0800 
0231               
0232 71F4 3D44  128         div   tmp0,tmp1             ; \ Divide 32 bit value by 2048
0233                                                   ; | tmp1 = quotient  (SAMS page offset)
0234                                                   ; / tmp2 = remainder
0235               
0236 71F6 0A16  56         sla   tmp2,1                ; line number * 2
0237 71F8 C806  38         mov   tmp2,@outparm1        ; Offset index entry
     71FA 2F30 
0238               
0239 71FC A160  34         a     @idx.sams.lopage,tmp1 ; Add SAMS page base
     71FE A502 
0240 7200 8805  38         c     tmp1,@idx.sams.page   ; Page already active?
     7202 A500 
0241               
0242 7204 130E  14         jeq   _idx.samspage.get.exit
0243                                                   ; Yes, so exit
0244                       ;------------------------------------------------------
0245                       ; Activate SAMS index page
0246                       ;------------------------------------------------------
0247 7206 C805  38         mov   tmp1,@idx.sams.page   ; Set current SAMS page
     7208 A500 
0248 720A C805  38         mov   tmp1,@tv.sams.b000    ; Also keep SAMS window synced in Stevie
     720C A006 
0249               
0250 720E C105  18         mov   tmp1,tmp0             ; Destination SAMS page
0251 7210 0205  20         li    tmp1,>b000            ; Memory window for index page
     7212 B000 
0252               
0253 7214 06A0  32         bl    @xsams.page.set       ; Switch to SAMS page
     7216 253C 
...
0258                       ;------------------------------------------------------
0259 7218 8804  38         c     tmp0,@idx.sams.hipage ; New highest page?
     721A A504 
0260 721C 1202  14         jle   _idx.samspage.get.exit
0261                                                   ; No, exit
0262 721E C804  38         mov   tmp0,@idx.sams.hipage ; Yes, set highest SAMS index page
     7220 A504 
0263                       ;------------------------------------------------------
0264                       ; Exit
0265                       ;------------------------------------------------------
0266               _idx.samspage.get.exit:
0267 7222 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0268 7224 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0269 7226 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0270 7228 C2F9  30         mov   *stack+,r11           ; Pop r11
0271 722A 045B  20         b     *r11                  ; Return to caller
**** **** ****     > mem.resident.3000.asm
...
0027                       ; Initialize
0028                       ;------------------------------------------------------
0029 7234 0204  20         li    tmp0,edb.top          ; \
     7236 C000 
0030 7238 C804  38         mov   tmp0,@edb.top.ptr     ; / Set pointer to top of editor buffer
     723A A200 
0031 723C C804  38         mov   tmp0,@edb.next_free.ptr
     723E A208 
0032                                                   ; Set pointer to next free line
0033               
0034 7240 0720  34         seto  @edb.insmode          ; Turn on insert mode for this editor buffer
     7242 A20A 
0035               
0036 7244 0204  20         li    tmp0,1
     7246 0001 
0037 7248 C804  38         mov   tmp0,@edb.lines       ; Lines=1
     724A A204 
0038               
0039 724C 04E0  34         clr   @edb.block.m1         ; Reset block start line
     724E A20C 
0040 7250 04E0  34         clr   @edb.block.m2         ; Reset block end line
     7252 A20E 
0041 7254 04E0  34         clr   @edb.block.m3         ; Reset block target line
     7256 A210 
0042               
0043 7258 0204  20         li    tmp0,txt.newfile      ; "New file"
     725A 3572 
0044 725C C804  38         mov   tmp0,@edb.filename.ptr
     725E A212 
0045               
0046 7260 0204  20         li    tmp0,txt.filetype.none
     7262 3584 
0047 7264 C804  38         mov   tmp0,@edb.filetype.ptr
     7266 A214 
0048               
0049               edb.init.exit:
0050                       ;------------------------------------------------------
0051                       ; Exit
0052                       ;------------------------------------------------------
0053 7268 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0054 726A C2F9  30         mov   *stack+,r11           ; Pop r11
0055 726C 045B  20         b     *r11                  ; Return to caller
0056               
0057               
0058               
0059               
...
0027                       ; Initialize
0028                       ;------------------------------------------------------
0029 7276 0204  20         li    tmp0,cmdb.top         ; \ Set pointer to command buffer
     7278 D000 
0030 727A C804  38         mov   tmp0,@cmdb.top.ptr    ; /
     727C A300 
0031               
0032 727E 04E0  34         clr   @cmdb.visible         ; Hide command buffer
     7280 A302 
0033 7282 0204  20         li    tmp0,4
     7284 0004 
0034 7286 C804  38         mov   tmp0,@cmdb.scrrows    ; Set current command buffer size
     7288 A306 
0035 728A C804  38         mov   tmp0,@cmdb.default    ; Set default command buffer size
     728C A308 
0036               
0037 728E 04E0  34         clr   @cmdb.lines           ; Number of lines in cmdb buffer
     7290 A316 
0038 7292 04E0  34         clr   @cmdb.dirty           ; Command buffer is clean
     7294 A318 
0039 7296 04E0  34         clr   @cmdb.action.ptr      ; Reset action to execute pointer
     7298 A324 
0040                       ;------------------------------------------------------
0041                       ; Clear command buffer
0042                       ;------------------------------------------------------
0043 729A 06A0  32         bl    @film
     729C 2238 
0044 729E D000             data  cmdb.top,>00,cmdb.size
     72A0 0000 
     72A2 1000 
...
0027                       ; Initialize
0028                       ;------------------------------------------------------
0029 72B2 04E0  34         clr   @tv.error.visible     ; Set to hidden
     72B4 A024 
0030               
0031 72B6 06A0  32         bl    @film
     72B8 2238 
0032 72BA A026                   data tv.error.msg,0,160
     72BC 0000 
     72BE 00A0 
0033               
0034 72C0 0204  20         li    tmp0,>A000            ; Length of error message (160 bytes)
     72C2 A000 
0035 72C4 D804  38         movb  tmp0,@tv.error.msg    ; Set length byte
     72C6 A026 
0036                       ;-------------------------------------------------------
0037                       ; Exit
0038                       ;-------------------------------------------------------
0039               errline.exit:
0040 72C8 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0041 72CA C2F9  30         mov   *stack+,r11           ; Pop R11
0042 72CC 045B  20         b     *r11                  ; Return to caller
0043               
**** **** ****     > mem.resident.3000.asm
...
0027                       ; Initialize
0028                       ;------------------------------------------------------
0029 72D6 0204  20         li    tmp0,1                ; \ Set default color scheme
     72D8 0001 
0030 72DA C804  38         mov   tmp0,@tv.colorscheme  ; /
     72DC A012 
0031               
0032 72DE 04E0  34         clr   @tv.task.oneshot      ; Reset pointer to oneshot task
     72E0 A020 
0033 72E2 E0A0  34         soc   @wbit10,config        ; Assume ALPHA LOCK is down
     72E4 200C 
0034               
0035 72E6 0204  20         li    tmp0,fj.bottom
     72E8 F000 
0036 72EA C804  38         mov   tmp0,@tv.fj.stackpnt  ; Set pointer to farjump return stack
     72EC A022 
0037                       ;-------------------------------------------------------
0038                       ; Exit
0039                       ;-------------------------------------------------------
0040               tv.init.exit:
0041 72EE C139  30         mov   *stack+,tmp0          ; Pop tmp0
0042 72F0 C2F9  30         mov   *stack+,r11           ; Pop R11
0043 72F2 045B  20         b     *r11                  ; Return to caller
0044               
0045               
0046               
0047               ***************************************************************
...
0063               ***************************************************************
0064               tv.reset:
0065 72F4 0649  14         dect  stack
0066 72F6 C64B  30         mov   r11,*stack            ; Save return address
0067                       ;------------------------------------------------------
0068                       ; Reset editor
0069                       ;------------------------------------------------------
0070 72F8 06A0  32         bl    @cmdb.init            ; Initialize command buffer
     72FA 3204 
0071 72FC 06A0  32         bl    @edb.init             ; Initialize editor buffer
     72FE 31C2 
0072 7300 06A0  32         bl    @idx.init             ; Initialize index
     7302 30C0 
0073 7304 06A0  32         bl    @fb.init              ; Initialize framebuffer
     7306 307A 
0074 7308 06A0  32         bl    @errline.init         ; Initialize error line
     730A 3240 
0075                       ;-------------------------------------------------------
0076                       ; Exit
0077                       ;-------------------------------------------------------
0078               tv.reset.exit:
0079 730C C2F9  30         mov   *stack+,r11           ; Pop R11
0080 730E 045B  20         b     *r11                  ; Return to caller
**** **** ****     > mem.resident.3000.asm
...
0031               ***************************************************************
0032               stevie.tx8030:
0033 7310 04F0             byte  >04,>f0,>00,>3f,>02,>43,>05,SPFCLR,0,80
     7312 003F 
     7314 0243 
     7316 05F4 
     7318 0050 
0034               
0035               romsat:
0036 731A 0303             data  >0303,>0001             ; Cursor YX, initial shape and colour
     731C 0001 
0037               
0038               cursors:
0039 731E 0000             data  >0000,>0000,>0000,>001c ; Cursor 1 - Insert mode
     7320 0000 
     7322 0000 
     7324 001C 
0040 7326 1010             data  >1010,>1010,>1010,>1000 ; Cursor 2 - Insert mode
     7328 1010 
     732A 1010 
     732C 1000 
0041 732E 1C1C             data  >1c1c,>1c1c,>1c1c,>1c00 ; Cursor 3 - Overwrite mode
     7330 1C1C 
     7332 1C1C 
     7334 1C00 
0042               
0043               patterns:
0044 7336 0000             data  >0000,>0000,>00ff,>0000 ; 01. Single line
     7338 0000 
     733A 00FF 
     733C 0000 
0045 733E 0080             data  >0080,>0000,>ff00,>ff00 ; 02. Ruler + double line bottom
     7340 0000 
     7342 FF00 
     7344 FF00 
0046               
0047               patterns.box:
0048 7346 0000             data  >0000,>0000,>ff00,>ff00 ; 03. Double line bottom
     7348 0000 
     734A FF00 
     734C FF00 
0049 734E 0000             data  >0000,>0000,>ff80,>bfa0 ; 04. Top left corner
     7350 0000 
     7352 FF80 
     7354 BFA0 
0050 7356 0000             data  >0000,>0000,>fc04,>f414 ; 05. Top right corner
     7358 0000 
     735A FC04 
     735C F414 
0051 735E A0A0             data  >a0a0,>a0a0,>a0a0,>a0a0 ; 06. Left vertical double line
     7360 A0A0 
     7362 A0A0 
     7364 A0A0 
0052 7366 1414             data  >1414,>1414,>1414,>1414 ; 07. Right vertical double line
     7368 1414 
     736A 1414 
     736C 1414 
0053 736E A0A0             data  >a0a0,>a0a0,>bf80,>ff00 ; 08. Bottom left corner
     7370 A0A0 
     7372 BF80 
     7374 FF00 
0054 7376 1414             data  >1414,>1414,>f404,>fc00 ; 09. Bottom right corner
     7378 1414 
     737A F404 
     737C FC00 
0055 737E 0000             data  >0000,>c0c0,>c0c0,>0080 ; 10. Double line top left corner
     7380 C0C0 
     7382 C0C0 
     7384 0080 
0056 7386 0000             data  >0000,>0f0f,>0f0f,>0000 ; 11. Double line top right corner
     7388 0F0F 
     738A 0F0F 
     738C 0000 
0057               
0058               
0059               patterns.cr:
0060 738E 6C48             data  >6c48,>6c48,>4800,>7c00 ; 12. FF (Form Feed)
     7390 6C48 
     7392 4800 
     7394 7C00 
0061 7396 0024             data  >0024,>64fc,>6020,>0000 ; 13. CR (Carriage return) - arrow
     7398 64FC 
     739A 6020 
     739C 0000 
0062               
0063               
0064               alphalock:
0065 739E 0000             data  >0000,>00e0,>e0e0,>e0e0 ; 14. alpha lock down
     73A0 00E0 
     73A2 E0E0 
     73A4 E0E0 
0066 73A6 00E0             data  >00e0,>e0e0,>e0e0,>0000 ; 15. alpha lock up
     73A8 E0E0 
     73AA E0E0 
     73AC 0000 
0067               
0068               
0069               vertline:
0070 73AE 1010             data  >1010,>1010,>1010,>1010 ; 16. Vertical line
     73B0 1010 
     73B2 1010 
     73B4 1010 
0071               
...
0077 73B6 2000             data  >2000,>0002           ; >2000-2fff, SAMS page >02
     73B8 0002 
0078 73BA 3000             data  >3000,>0003           ; >3000-3fff, SAMS page >03
     73BC 0003 
0079 73BE A000             data  >a000,>000a           ; >a000-afff, SAMS page >0a
     73C0 000A 
0080               
0081 73C2 B000             data  >b000,>0010           ; >b000-bfff, SAMS page >10
     73C4 0010 
0082                                                   ; \ The index can allocate
0083                                                   ; / pages >10 to >2f.
0084               
0085 73C6 C000             data  >c000,>0030           ; >c000-cfff, SAMS page >30
     73C8 0030 
0086                                                   ; \ Editor buffer can allocate
0087                                                   ; / pages >30 to >ff.
0088               
0089 73CA D000             data  >d000,>000d           ; >d000-dfff, SAMS page >0d
     73CC 000D 
0090 73CE E000             data  >e000,>000e           ; >e000-efff, SAMS page >0e
     73D0 000E 
0091 73D2 F000             data  >f000,>000f           ; >f000-ffff, SAMS page >0f
     73D4 000F 
0092               
0093               
0094               
...
0129 73D6 F41F      data  >f41f,>f001,>1b4f,>0000 ; 1  whit/dblue  | black/whit  | whit  | black
     73D8 F001 
     73DA 1B4F 
     73DC 0000 
0130 73DE F41C      data  >f41c,>f00f,>1b4f,>0000 ; 2  whit/dblue  | black/dgreen| whit  | whit
     73E0 F00F 
     73E2 1B4F 
     73E4 0000 
0131 73E6 A11A      data  >a11a,>f00f,>1f1a,>0000 ; 3  yel/black   | black/dyel  | whit  | whit
     73E8 F00F 
     73EA 1F1A 
     73EC 0000 
0132 73EE 2112      data  >2112,>f00f,>1b12,>0000 ; 4  mgreen/black| black/mgreen| white | whit
     73F0 F00F 
     73F2 1B12 
     73F4 0000 
0133 73F6 E11E      data  >e11e,>f00f,>1b1e,>0000 ; 5  grey/black  | black/grey  | white | whit
     73F8 F00F 
     73FA 1B1E 
     73FC 0000 
0134 73FE 1771      data  >1771,>1006,>1b71,>0000 ; 6  black/cyan  | cyan/black  | black | ?
     7400 1006 
     7402 1B71 
     7404 0000 
0135 7406 1FF1      data  >1ff1,>1001,>1bf1,>0000 ; 7  black/whit  | whit/black  | black | black
     7408 1001 
     740A 1BF1 
     740C 0000 
0136 740E A1F0      data  >a1f0,>1a0f,>1b1a,>0000 ; 8  dyel/black  | whit/trnsp  | inver | whit
     7410 1A0F 
     7412 1B1A 
     7414 0000 
0137 7416 21F0      data  >21f0,>f20f,>1b12,>0000 ; 9  mgreen/black| whit/trnsp  | inver | whit
     7418 F20F 
     741A 1B12 
     741C 0000 
0138               
...
0012 741E 0C53             byte  12
0013 741F ....             text  'Stevie V01.H'
0014                       even
0015               
0016               txt.about.purpose
0017 742C 2350             byte  35
0018 742D ....             text  'Programming Editor for the TI-99/4a'
0019                       even
0020               
0021               txt.about.author
0022 7450 1D32             byte  29
0023 7451 ....             text  '2018-2020 by Filip Van Vooren'
0024                       even
0025               
0026               txt.about.website
0027 746E 1B68             byte  27
0028 746F ....             text  'https://stevie.oratronik.de'
0029                       even
0030               
0031               txt.about.build
0032 748A 1342             byte  19
0033 748B ....             text  'Build: 201206-93881'
0034                       even
0035               
0036               
0037               txt.about.msg1
0038 749E 2446             byte  36
0039 749F ....             text  'FCTN-7 (F7)   Help, shortcuts, about'
0040                       even
0041               
0042               txt.about.msg2
0043 74C4 2246             byte  34
0044 74C5 ....             text  'FCTN-9 (F9)   Toggle edit/cmd mode'
0045                       even
0046               
0047               txt.about.msg3
0048 74E8 1946             byte  25
0049 74E9 ....             text  'FCTN-+        Quit Stevie'
0050                       even
0051               
0052               txt.about.msg4
0053 7502 1C43             byte  28
0054 7503 ....             text  'CTRL-L (^L)   Load DV80 file'
0055                       even
0056               
0057               txt.about.msg5
0058 7520 1C43             byte  28
0059 7521 ....             text  'CTRL-K (^K)   Save DV80 file'
0060                       even
0061               
0062               txt.about.msg6
0063 753E 1A43             byte  26
0064 753F ....             text  'CTRL-Z (^Z)   Cycle colors'
0065                       even
0066               
0067               
0068 755A 380F     txt.about.msg7     byte    56,15
0069 755C ....                        text    ' ALPHA LOCK up     '
0070                                  byte    14
0071 7570 ....                        text    ' ALPHA LOCK down   '
0072 7583 ....                        text    '  * Text changed'
0073               
0074               
0075               ;--------------------------------------------------------------
...
0082               
0083               txt.marker
0084 7596 052A             byte  5
0085 7597 ....             text  '*EOF*'
0086                       even
0087               
0088               txt.bottom
0089 759C 0520             byte  5
0090 759D ....             text  '  BOT'
0091                       even
0092               
0093               txt.ovrwrite
0094 75A2 034F             byte  3
0095 75A3 ....             text  'OVR'
0096                       even
0097               
0098               txt.insert
0099 75A6 0349             byte  3
0100 75A7 ....             text  'INS'
0101                       even
0102               
0103               txt.star
0104 75AA 012A             byte  1
0105 75AB ....             text  '*'
0106                       even
0107               
0108               txt.loading
0109 75AC 0A4C             byte  10
0110 75AD ....             text  'Loading...'
0111                       even
0112               
0113               txt.saving
0114 75B8 0A53             byte  10
0115 75B9 ....             text  'Saving....'
0116                       even
0117               
0118               txt.fastmode
0119 75C4 0846             byte  8
0120 75C5 ....             text  'Fastmode'
0121                       even
0122               
0123               txt.kb
0124 75CE 026B             byte  2
0125 75CF ....             text  'kb'
0126                       even
0127               
0128               txt.lines
0129 75D2 054C             byte  5
0130 75D3 ....             text  'Lines'
0131                       even
0132               
0133               txt.bufnum
0134 75D8 0323             byte  3
0135 75D9 ....             text  '#1 '
0136                       even
0137               
0138               txt.newfile
0139 75DC 0A5B             byte  10
0140 75DD ....             text  '[New file]'
0141                       even
0142               
0143               txt.filetype.dv80
0144 75E8 0444             byte  4
0145 75E9 ....             text  'DV80'
0146                       even
0147               
0148               txt.filetype.none
0149 75EE 0420             byte  4
0150 75EF ....             text  '    '
0151                       even
0152               
0153               txt.clear
0154 75F4 0820             byte  8
0155 75F5 ....             text  '        '
0156                       even
0157               
0158               txt.m1.set
0159 75FE 024D             byte  2
0160 75FF ....             text  'M1'
0161                       even
0162               
0163               txt.m2.set
0164 7602 024D             byte  2
0165 7603 ....             text  'M2'
0166                       even
0167               
0168               
0169               
0170 7606 010F     txt.alpha.up       data >010f
0171 7608 010E     txt.alpha.down     data >010e
0172 760A 0110     txt.vertline       data >0110
0173               
0174               
0175               ;--------------------------------------------------------------
...
0177               ;--------------------------------------------------------------
0178               txt.head.load
0179 760C 0F4C             byte  15
0180 760D ....             text  'Load DV80 file '
0181                       even
0182               
0183               txt.hint.load
0184 761C 4D48             byte  77
0185 761D ....             text  'HINT: Fastmode uses CPU RAM instead of VDP RAM for file buffer (HRD/HDX/IDE).'
0186                       even
0187               
0188               txt.keys.load
0189 766A 3746             byte  55
0190 766B ....             text  'F9=Back    F3=Clear    F5=Fastmode    ^A=Home    ^F=End'
0191                       even
0192               
0193               txt.keys.load2
0194 76A2 3746             byte  55
0195 76A3 ....             text  'F9=Back    F3=Clear   *F5=Fastmode    ^A=Home    ^F=End'
0196                       even
0197               
0198               
0199               ;--------------------------------------------------------------
...
0201               ;--------------------------------------------------------------
0202               txt.head.save
0203 76DA 0F53             byte  15
0204 76DB ....             text  'Save DV80 file '
0205                       even
0206               
0207               txt.hint.save
0208 76EA 3F48             byte  63
0209 76EB ....             text  'HINT: Fastmode uses CPU RAM instead of VDP RAM for file buffer.'
0210                       even
0211               
0212               txt.keys.save
0213 772A 2846             byte  40
0214 772B ....             text  'F9=Back    F3=Clear    ^A=Home    ^F=End'
0215                       even
0216               
0217               
0218               ;--------------------------------------------------------------
...
0222 7754 1055             byte  16
0223 7755 ....             text  'Unsaved changes '
0224                       even
0225               
0226               txt.info.unsaved
0227 7766 3259             byte  50
0228 7767 ....             text  'You are about to lose changes to the current file!'
0229                       even
0230               
0231               txt.hint.unsaved
0232 779A 3F48             byte  63
0233 779B ....             text  'HINT: Press F6 to proceed without saving or ENTER to save file.'
0234                       even
0235               
0236               txt.keys.unsaved
0237 77DA 2846             byte  40
0238 77DB ....             text  'F9=Back    F6=Proceed    ENTER=Save file'
0239                       even
0240               
0241               
0242               
...
0246               ;--------------------------------------------------------------
0247               txt.head.block
0248 7804 1C42             byte  28
0249 7805 ....             text  'Block move/copy/delete/save '
0250                       even
0251               
0252               txt.info.block
0253 7822 394D             byte  57
0254 7823 ....             text  'M1=[     ] start     M2=[     ] end     M3=[     ] target'
0255                       even
0256               
0257               txt.hint.block
0258 785C 4748             byte  71
0259 785D ....             text  'HINT: Mark M1 (start) with ^1, M2 (end) with ^2 and M3 (target) with ^3'
0260                       even
0261               
0262               txt.keys.block
0263 78A4 4546             byte  69
0264 78A5 ....             text  'F9=Back   ^M=Move   ^C=Copy   ^D=Delete   ^S=Save   ^R=Reset M1/M2/M3'
0265                       even
0266               
0267               
0268               
...
0271               ;--------------------------------------------------------------
0272               txt.head.about
0273 78EA 0D41             byte  13
0274 78EB ....             text  'About Stevie '
0275                       even
0276               
0277               txt.hint.about
0278 78F8 2C48             byte  44
0279 78F9 ....             text  'HINT: Press F9 or ENTER to return to editor.'
0280                       even
0281               
0282               txt.keys.about
0283 7926 1546             byte  21
0284 7927 ....             text  'F9=Back    ENTER=Back'
0285                       even
0286               
0287               
0288               ;--------------------------------------------------------------
...
0290               ;--------------------------------------------------------------
0291               txt.ioerr.load
0292 793C 2049             byte  32
0293 793D ....             text  'I/O error. Failed loading file: '
0294                       even
0295               
0296               txt.ioerr.save
0297 795E 1F49             byte  31
0298 795F ....             text  'I/O error. Failed saving file: '
0299                       even
0300               
0301               txt.io.nofile
0302 797E 2149             byte  33
0303 797F ....             text  'I/O error. No filename specified.'
0304                       even
0305               
0306               
0307               
...
0310               ;--------------------------------------------------------------
0311               txt.cmdb.title
0312 79A0 0E43             byte  14
0313 79A1 ....             text  'Command buffer'
0314                       even
0315               
0316               txt.cmdb.prompt
0317 79B0 013E             byte  1
0318 79B1 ....             text  '>'
0319                       even
0320               
0321               
0322 79B2 0C0A     txt.stevie         byte    12
0323                                  byte    10
0324 79B4 ....                        text    'stevie V01.H'
0325 79C0 0B00                        byte    11
0326                                  even
0327               
0328               txt.colorscheme
0329 79C2 0643             byte  6
0330 79C3 ....             text  'Color:'
0331                       even
0332               
0333               
**** **** ****     > mem.resident.3000.asm
...
0103               *---------------------------------------------------------------
0104               txt.fctn.0
0105 79CA 0866             byte  8
0106 79CB ....             text  'fctn + 0'
0107                       even
0108               
0109               txt.fctn.1
0110 79D4 0866             byte  8
0111 79D5 ....             text  'fctn + 1'
0112                       even
0113               
0114               txt.fctn.2
0115 79DE 0866             byte  8
0116 79DF ....             text  'fctn + 2'
0117                       even
0118               
0119               txt.fctn.3
0120 79E8 0866             byte  8
0121 79E9 ....             text  'fctn + 3'
0122                       even
0123               
0124               txt.fctn.4
0125 79F2 0866             byte  8
0126 79F3 ....             text  'fctn + 4'
0127                       even
0128               
0129               txt.fctn.5
0130 79FC 0866             byte  8
0131 79FD ....             text  'fctn + 5'
0132                       even
0133               
0134               txt.fctn.6
0135 7A06 0866             byte  8
0136 7A07 ....             text  'fctn + 6'
0137                       even
0138               
0139               txt.fctn.7
0140 7A10 0866             byte  8
0141 7A11 ....             text  'fctn + 7'
0142                       even
0143               
0144               txt.fctn.8
0145 7A1A 0866             byte  8
0146 7A1B ....             text  'fctn + 8'
0147                       even
0148               
0149               txt.fctn.9
0150 7A24 0866             byte  8
0151 7A25 ....             text  'fctn + 9'
0152                       even
0153               
0154               txt.fctn.a
0155 7A2E 0866             byte  8
0156 7A2F ....             text  'fctn + a'
0157                       even
0158               
0159               txt.fctn.b
0160 7A38 0866             byte  8
0161 7A39 ....             text  'fctn + b'
0162                       even
0163               
0164               txt.fctn.c
0165 7A42 0866             byte  8
0166 7A43 ....             text  'fctn + c'
0167                       even
0168               
0169               txt.fctn.d
0170 7A4C 0866             byte  8
0171 7A4D ....             text  'fctn + d'
0172                       even
0173               
0174               txt.fctn.e
0175 7A56 0866             byte  8
0176 7A57 ....             text  'fctn + e'
0177                       even
0178               
0179               txt.fctn.f
0180 7A60 0866             byte  8
0181 7A61 ....             text  'fctn + f'
0182                       even
0183               
0184               txt.fctn.g
0185 7A6A 0866             byte  8
0186 7A6B ....             text  'fctn + g'
0187                       even
0188               
0189               txt.fctn.h
0190 7A74 0866             byte  8
0191 7A75 ....             text  'fctn + h'
0192                       even
0193               
0194               txt.fctn.i
0195 7A7E 0866             byte  8
0196 7A7F ....             text  'fctn + i'
0197                       even
0198               
0199               txt.fctn.j
0200 7A88 0866             byte  8
0201 7A89 ....             text  'fctn + j'
0202                       even
0203               
0204               txt.fctn.k
0205 7A92 0866             byte  8
0206 7A93 ....             text  'fctn + k'
0207                       even
0208               
0209               txt.fctn.l
0210 7A9C 0866             byte  8
0211 7A9D ....             text  'fctn + l'
0212                       even
0213               
0214               txt.fctn.m
0215 7AA6 0866             byte  8
0216 7AA7 ....             text  'fctn + m'
0217                       even
0218               
0219               txt.fctn.n
0220 7AB0 0866             byte  8
0221 7AB1 ....             text  'fctn + n'
0222                       even
0223               
0224               txt.fctn.o
0225 7ABA 0866             byte  8
0226 7ABB ....             text  'fctn + o'
0227                       even
0228               
0229               txt.fctn.p
0230 7AC4 0866             byte  8
0231 7AC5 ....             text  'fctn + p'
0232                       even
0233               
0234               txt.fctn.q
0235 7ACE 0866             byte  8
0236 7ACF ....             text  'fctn + q'
0237                       even
0238               
0239               txt.fctn.r
0240 7AD8 0866             byte  8
0241 7AD9 ....             text  'fctn + r'
0242                       even
0243               
0244               txt.fctn.s
0245 7AE2 0866             byte  8
0246 7AE3 ....             text  'fctn + s'
0247                       even
0248               
0249               txt.fctn.t
0250 7AEC 0866             byte  8
0251 7AED ....             text  'fctn + t'
0252                       even
0253               
0254               txt.fctn.u
0255 7AF6 0866             byte  8
0256 7AF7 ....             text  'fctn + u'
0257                       even
0258               
0259               txt.fctn.v
0260 7B00 0866             byte  8
0261 7B01 ....             text  'fctn + v'
0262                       even
0263               
0264               txt.fctn.w
0265 7B0A 0866             byte  8
0266 7B0B ....             text  'fctn + w'
0267                       even
0268               
0269               txt.fctn.x
0270 7B14 0866             byte  8
0271 7B15 ....             text  'fctn + x'
0272                       even
0273               
0274               txt.fctn.y
0275 7B1E 0866             byte  8
0276 7B1F ....             text  'fctn + y'
0277                       even
0278               
0279               txt.fctn.z
0280 7B28 0866             byte  8
0281 7B29 ....             text  'fctn + z'
0282                       even
0283               
0284               *---------------------------------------------------------------
...
0286               *---------------------------------------------------------------
0287               txt.fctn.dot
0288 7B32 0866             byte  8
0289 7B33 ....             text  'fctn + .'
0290                       even
0291               
0292               txt.fctn.plus
0293 7B3C 0866             byte  8
0294 7B3D ....             text  'fctn + +'
0295                       even
0296               
0297               
0298               txt.ctrl.dot
0299 7B46 0863             byte  8
0300 7B47 ....             text  'ctrl + .'
0301                       even
0302               
0303               txt.ctrl.comma
0304 7B50 0863             byte  8
0305 7B51 ....             text  'ctrl + ,'
0306                       even
0307               
0308               *---------------------------------------------------------------
...
0310               *---------------------------------------------------------------
0311               txt.ctrl.0
0312 7B5A 0863             byte  8
0313 7B5B ....             text  'ctrl + 0'
0314                       even
0315               
0316               txt.ctrl.1
0317 7B64 0863             byte  8
0318 7B65 ....             text  'ctrl + 1'
0319                       even
0320               
0321               txt.ctrl.2
0322 7B6E 0863             byte  8
0323 7B6F ....             text  'ctrl + 2'
0324                       even
0325               
0326               txt.ctrl.3
0327 7B78 0863             byte  8
0328 7B79 ....             text  'ctrl + 3'
0329                       even
0330               
0331               txt.ctrl.4
0332 7B82 0863             byte  8
0333 7B83 ....             text  'ctrl + 4'
0334                       even
0335               
0336               txt.ctrl.5
0337 7B8C 0863             byte  8
0338 7B8D ....             text  'ctrl + 5'
0339                       even
0340               
0341               txt.ctrl.6
0342 7B96 0863             byte  8
0343 7B97 ....             text  'ctrl + 6'
0344                       even
0345               
0346               txt.ctrl.7
0347 7BA0 0863             byte  8
0348 7BA1 ....             text  'ctrl + 7'
0349                       even
0350               
0351               txt.ctrl.8
0352 7BAA 0863             byte  8
0353 7BAB ....             text  'ctrl + 8'
0354                       even
0355               
0356               txt.ctrl.9
0357 7BB4 0863             byte  8
0358 7BB5 ....             text  'ctrl + 9'
0359                       even
0360               
0361               txt.ctrl.a
0362 7BBE 0863             byte  8
0363 7BBF ....             text  'ctrl + a'
0364                       even
0365               
0366               txt.ctrl.b
0367 7BC8 0863             byte  8
0368 7BC9 ....             text  'ctrl + b'
0369                       even
0370               
0371               txt.ctrl.c
0372 7BD2 0863             byte  8
0373 7BD3 ....             text  'ctrl + c'
0374                       even
0375               
0376               txt.ctrl.d
0377 7BDC 0863             byte  8
0378 7BDD ....             text  'ctrl + d'
0379                       even
0380               
0381               txt.ctrl.e
0382 7BE6 0863             byte  8
0383 7BE7 ....             text  'ctrl + e'
0384                       even
0385               
0386               txt.ctrl.f
0387 7BF0 0863             byte  8
0388 7BF1 ....             text  'ctrl + f'
0389                       even
0390               
0391               txt.ctrl.g
0392 7BFA 0863             byte  8
0393 7BFB ....             text  'ctrl + g'
0394                       even
0395               
0396               txt.ctrl.h
0397 7C04 0863             byte  8
0398 7C05 ....             text  'ctrl + h'
0399                       even
0400               
0401               txt.ctrl.i
0402 7C0E 0863             byte  8
0403 7C0F ....             text  'ctrl + i'
0404                       even
0405               
0406               txt.ctrl.j
0407 7C18 0863             byte  8
0408 7C19 ....             text  'ctrl + j'
0409                       even
0410               
0411               txt.ctrl.k
0412 7C22 0863             byte  8
0413 7C23 ....             text  'ctrl + k'
0414                       even
0415               
0416               txt.ctrl.l
0417 7C2C 0863             byte  8
0418 7C2D ....             text  'ctrl + l'
0419                       even
0420               
0421               txt.ctrl.m
0422 7C36 0863             byte  8
0423 7C37 ....             text  'ctrl + m'
0424                       even
0425               
0426               txt.ctrl.n
0427 7C40 0863             byte  8
0428 7C41 ....             text  'ctrl + n'
0429                       even
0430               
0431               txt.ctrl.o
0432 7C4A 0863             byte  8
0433 7C4B ....             text  'ctrl + o'
0434                       even
0435               
0436               txt.ctrl.p
0437 7C54 0863             byte  8
0438 7C55 ....             text  'ctrl + p'
0439                       even
0440               
0441               txt.ctrl.q
0442 7C5E 0863             byte  8
0443 7C5F ....             text  'ctrl + q'
0444                       even
0445               
0446               txt.ctrl.r
0447 7C68 0863             byte  8
0448 7C69 ....             text  'ctrl + r'
0449                       even
0450               
0451               txt.ctrl.s
0452 7C72 0863             byte  8
0453 7C73 ....             text  'ctrl + s'
0454                       even
0455               
0456               txt.ctrl.t
0457 7C7C 0863             byte  8
0458 7C7D ....             text  'ctrl + t'
0459                       even
0460               
0461               txt.ctrl.u
0462 7C86 0863             byte  8
0463 7C87 ....             text  'ctrl + u'
0464                       even
0465               
0466               txt.ctrl.v
0467 7C90 0863             byte  8
0468 7C91 ....             text  'ctrl + v'
0469                       even
0470               
0471               txt.ctrl.w
0472 7C9A 0863             byte  8
0473 7C9B ....             text  'ctrl + w'
0474                       even
0475               
0476               txt.ctrl.x
0477 7CA4 0863             byte  8
0478 7CA5 ....             text  'ctrl + x'
0479                       even
0480               
0481               txt.ctrl.y
0482 7CAE 0863             byte  8
0483 7CAF ....             text  'ctrl + y'
0484                       even
0485               
0486               txt.ctrl.z
0487 7CB8 0863             byte  8
0488 7CB9 ....             text  'ctrl + z'
0489                       even
0490               
0491               *---------------------------------------------------------------
...
0501               *---------------------------------------------------------------
0502               txt.enter
0503 7CCC 0565             byte  5
0504 7CCD ....             text  'enter'
0505                       even
0506               
**** **** ****     > mem.resident.3000.asm
0017                       ;------------------------------------------------------
...
0019                       ;------------------------------------------------------
0020 7CD2 DEAD             data  >dead,>beef,>dead,>beef
     7CD4 BEEF 
     7CD6 DEAD 
     7CD8 BEEF 
**** **** ****     > stevie_b0.asm.93881
0150               
0154 7CDA 3C70                   data $                ; Bank 0 ROM size OK.
0156                       ;-----------------------------------------------------------------------
0157                       ; Bank specific vector table
0158                       ;-----------------------------------------------------------------------
0162 7CDC 3C72                   data $                ; Bank 0 ROM size OK.
0164                       ;-------------------------------------------------------
0165                       ; Vector table bank 0: >7f9c - >7fff
0166                       ;-------------------------------------------------------
0167                       copy  "rb.vectors.bank0.asm"
**** **** ****     > rb.vectors.bank0.asm
0001               * FILE......: rb.vectors.bank0.asm
...
0175      32A6     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
