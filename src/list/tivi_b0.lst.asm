...
0008               ***************************************************************
0009               * File: tivi_b0.asm                 ; Version 200509-6386
0010               
0011               
0012               ***************************************************************
...
0007               *              (c)2018-2020 // Filip van Vooren
0008               ***************************************************************
0009               * File: equates.asm                 ; Version 200509-6386
0010               *--------------------------------------------------------------
...
0031 6015 ....             text  'TIVI 200509-6386'
0032                       even
0033               
0041               
0042               *--------------------------------------------------------------
...
0249 6223 ....             text  'Build-ID  200509-6386'
0250                       even
0251               
**** **** ****     > runlib.asm
...
0318 65FC 06A0  32         bl    @sams.layout
     65FE 2560 
0319 6600 25A4                   data sams.layout.standard
0320                       ;------------------------------------------------------
0321                       ; Exit
0322                       ;------------------------------------------------------
...
0372                       ;------------------------------------------------------
0373 663C 0205  20         li    tmp1,sams.layout.copy.data
     663E 25FC 
...
0387 6650 16F9  14         jne   sams.layout.copy.loop ; Loop until done
0388                       ;------------------------------------------------------
0389                       ; Exit
0390                       ;------------------------------------------------------
...
0015               *  P1LB = Number of times to repeat
0016               ********|*****|*********************|**************************
0017 67CA C83B  50 vchar   mov   *r11+,@wyx            ; Set YX position
     67CC 832A 
0018 67CE C1CB  18         mov   r11,tmp3              ; Save R11 in TMP3
0019 67D0 C220  34 vchar1  mov   @wcolmn,tmp4          ; Get columns per row
     67D2 833A 
0020 67D4 06A0  32         bl    @yx2pnt               ; Get VDP address into TMP0
     67D6 23D8 
0021 67D8 D177  28         movb  *tmp3+,tmp1           ; Byte to write
0022 67DA D1B7  28         movb  *tmp3+,tmp2
0023 67DC 0986  56         srl   tmp2,8                ; Repeat count
0024               *--------------------------------------------------------------
0025               *    Setup VDP write address
0026               *--------------------------------------------------------------
0027 67DE 06A0  32 vchar2  bl    @vdwa                 ; Setup VDP write address
     67E0 2294 
0028               *--------------------------------------------------------------
0029               *    Dump tile to VDP and do housekeeping
0030               *--------------------------------------------------------------
0031 67E2 D7C5  30         movb  tmp1,*r15             ; Dump tile to VDP
0032 67E4 A108  18         a     tmp4,tmp0             ; Next row
0033 67E6 0606  14         dec   tmp2
0034 67E8 16FA  14         jne   vchar2
0035 67EA 8817  46         c     *tmp3,@w$ffff         ; End-Of-List marker found ?
     67EC 202C 
0036 67EE 1303  14         jeq   vchar3                ; Yes, exit
0037 67F0 C837  50         mov   *tmp3+,@wyx           ; Save YX position
     67F2 832A 
0038 67F4 10ED  14         jmp   vchar1                ; Next one
0039 67F6 05C7  14 vchar3  inct  tmp3
0040 67F8 0457  20         b     *tmp3                 ; Exit
0041               
0042               ***************************************************************
...
0048               ***************************************************************
0049 67FA C20B  18 xvchar  mov   r11,tmp4              ; Save return address
0050 67FC C804  38         mov   tmp0,@wyx             ; Set cursor position
     67FE 832A 
0051 6800 06C5  14         swpb  tmp1                  ; Byte to write into MSB
0052 6802 C1E0  34         mov   @wcolmn,tmp3          ; Get columns per row
     6804 833A 
0053 6806 06A0  32         bl    @yx2pnt               ; Get VDP address into TMP0
     6808 23D8 
0054               *--------------------------------------------------------------
0055               *    Setup VDP write address
0056               *--------------------------------------------------------------
0057 680A 06A0  32 xvcha1  bl    @vdwa                 ; Setup VDP write address
     680C 2294 
0058               *--------------------------------------------------------------
0059               *    Dump tile to VDP and do housekeeping
0060               *--------------------------------------------------------------
0061 680E D7C5  30         movb  tmp1,*r15             ; Dump tile to VDP
0062 6810 A120  34         a     @wcolmn,tmp0          ; Next row
     6812 833A 
0063 6814 0606  14         dec   tmp2
0064 6816 16F9  14         jne   xvcha1
0065 6818 0458  20         b     *tmp4                 ; Exit
**** **** ****     > runlib.asm
0150               
0154               
0158               
...
0015               ********|*****|*********************|**************************
0016 681A 40A0  34 realkb  szc   @wbit0,config         ; Reset bit 0 in CONFIG register
     681C 202A 
0017 681E 020C  20         li    r12,>0024
     6820 0024 
0018 6822 020F  20         li    r15,kbsmal            ; Default is KBSMAL table
     6824 2850 
0019 6826 04C6  14         clr   tmp2
0020 6828 30C6  56         ldcr  tmp2,>0003            ; Lower case by default
0021               *--------------------------------------------------------------
0022               * SHIFT key pressed ?
0023               *--------------------------------------------------------------
0024 682A 04CC  14         clr   r12
0025 682C 1F08  20         tb    >0008                 ; Shift-key ?
0026 682E 1302  14         jeq   realk1                ; No
0027 6830 020F  20         li    r15,kbshft            ; Yes, use KBSHIFT table
     6832 2880 
0028               *--------------------------------------------------------------
0029               * FCTN key pressed ?
0030               *--------------------------------------------------------------
0031 6834 1F07  20 realk1  tb    >0007                 ; FNCTN-key ?
0032 6836 1302  14         jeq   realk2                ; No
0033 6838 020F  20         li    r15,kbfctn            ; Yes, use KBFCTN table
     683A 28B0 
0034               *--------------------------------------------------------------
0035               * CTRL key pressed ?
0036               *--------------------------------------------------------------
0037 683C 1F09  20 realk2  tb    >0009                 ; CTRL-key ?
0038 683E 1302  14         jeq   realk3                ; No
0039 6840 020F  20         li    r15,kbctrl            ; Yes, use KBCTRL table
     6842 28E0 
0040               *--------------------------------------------------------------
0041               * ALPHA LOCK key down ?
0042               *--------------------------------------------------------------
0043 6844 1E15  20 realk3  sbz   >0015                 ; Set P5
0044 6846 1F07  20         tb    >0007                 ; ALPHA-Lock key ?
0045 6848 1302  14         jeq   realk4                ; No,  CONFIG register bit 0 = 0
0046 684A E0A0  34         soc   @wbit0,config         ; Yes, CONFIG register bit 0 = 1
     684C 202A 
0047               *--------------------------------------------------------------
0048               * Scan keyboard column
0049               *--------------------------------------------------------------
0050 684E 1D15  20 realk4  sbo   >0015                 ; Reset P5
0051 6850 0206  20         li    tmp2,6                ; Bitcombination for CRU, column counter
     6852 0006 
0052 6854 0606  14 realk5  dec   tmp2
0053 6856 020C  20         li    r12,>24               ; CRU address for P2-P4
     6858 0024 
0054 685A 06C6  14         swpb  tmp2
0055 685C 30C6  56         ldcr  tmp2,3                ; Transfer bit combination
0056 685E 06C6  14         swpb  tmp2
0057 6860 020C  20         li    r12,6                 ; CRU read address
     6862 0006 
0058 6864 3607  64         stcr  tmp3,8                ; Transfer 8 bits into R2HB
0059 6866 0547  14         inv   tmp3                  ;
0060 6868 0247  22         andi  tmp3,>ff00            ; Clear TMP3LB
     686A FF00 
0061               *--------------------------------------------------------------
0062               * Scan keyboard row
0063               *--------------------------------------------------------------
0064 686C 04C5  14         clr   tmp1                  ; Use TMP1 as row counter from now on
0065 686E 0A17  56 realk6  sla   tmp3,1                ; R2 bitcombinations scanned by shifting left.
0066 6870 1807  14         joc   realk8                ; If no carry after 8 loops, then it means no key
0067 6872 0585  14 realk7  inc   tmp1                  ; was pressed on that line.
0068 6874 0285  22         ci    tmp1,8
     6876 0008 
0069 6878 1AFA  14         jl    realk6
0070 687A C186  18         mov   tmp2,tmp2             ; All 6 columns processed ?
0071 687C 1BEB  14         jh    realk5                ; No, next column
0072 687E 1016  14         jmp   realkz                ; Yes, exit
0073               *--------------------------------------------------------------
0074               * Check for match in data table
0075               *--------------------------------------------------------------
0076 6880 C206  18 realk8  mov   tmp2,tmp4
0077 6882 0A38  56         sla   tmp4,3                ; TMP4 = TMP2 * 8
0078 6884 A205  18         a     tmp1,tmp4             ; TMP4 = TMP4 + TMP1
0079 6886 A20F  18         a     r15,tmp4              ; TMP4 = TMP4 + base address of data table (R15)
0080 6888 D618  38         movb  *tmp4,*tmp4           ; Is the byte on that address = >00 ?
0081 688A 13F3  14         jeq   realk7                ; Yes, then discard and continue scanning (FCTN, SHIFT, CTRL)
0082               *--------------------------------------------------------------
0083               * Determine ASCII value of key
0084               *--------------------------------------------------------------
0085 688C D198  26 realk9  movb  *tmp4,tmp2            ; Real keypress. It's safe to reuse TMP2 now
0086 688E 20A0  38         coc   @wbit0,config         ; ALPHA-Lock key pressed ?
     6890 202A 
0087 6892 1608  14         jne   realka                ; No, continue saving key
0088 6894 9806  38         cb    tmp2,@kbsmal+42       ; Is ASCII of key pressed < 97 ('a') ?
     6896 287A 
0089 6898 1A05  14         jl    realka
0090 689A 9806  38         cb    tmp2,@kbsmal+40       ; and ASCII of key pressed > 122 ('z') ?
     689C 2878 
0091 689E 1B02  14         jh    realka                ; No, continue
0092 68A0 0226  22         ai    tmp2,->2000           ; ASCII = ASCII - 32 (lowercase to uppercase!)
     68A2 E000 
0093 68A4 C806  38 realka  mov   tmp2,@waux1           ; Store ASCII value of key in WAUX1
     68A6 833C 
0094 68A8 E0A0  34         soc   @wbit11,config        ; Set ANYKEY flag in CONFIG register
     68AA 2014 
0095 68AC 020F  20 realkz  li    r15,vdpw              ; Setup VDP write address again after using R15 as temp storage
     68AE 8C00 
0096 68B0 045B  20         b     *r11                  ; Exit
0097               ********|*****|*********************|**************************
0098 68B2 FF00     kbsmal  data  >ff00,>0000,>ff0d,>203D
     68B4 0000 
     68B6 FF0D 
     68B8 203D 
0099 68BA ....             text  'xws29ol.'
0100 68C2 ....             text  'ced38ik,'
0101 68CA ....             text  'vrf47ujm'
0102 68D2 ....             text  'btg56yhn'
0103 68DA ....             text  'zqa10p;/'
0104 68E2 FF00     kbshft  data  >ff00,>0000,>ff0d,>202B
     68E4 0000 
     68E6 FF0D 
     68E8 202B 
0105 68EA ....             text  'XWS@(OL>'
0106 68F2 ....             text  'CED#*IK<'
0107 68FA ....             text  'VRF$&UJM'
0108 6902 ....             text  'BTG%^YHN'
0109 690A ....             text  'ZQA!)P:-'
0110 6912 FF00     kbfctn  data  >ff00,>0000,>ff0d,>2005
     6914 0000 
     6916 FF0D 
     6918 2005 
0111 691A 0A7E             data  >0a7e,>0804,>0f27,>c2B9
     691C 0804 
     691E 0F27 
     6920 C2B9 
0112 6922 600B             data  >600b,>0907,>063f,>c1B8
     6924 0907 
     6926 063F 
     6928 C1B8 
0113 692A 7F5B             data  >7f5b,>7b02,>015f,>c0C3
     692C 7B02 
     692E 015F 
     6930 C0C3 
0114 6932 BE5D             data  >be5d,>7d0e,>0cc6,>bfC4
     6934 7D0E 
     6936 0CC6 
     6938 BFC4 
0115 693A 5CB9             data  >5cb9,>7c03,>bc22,>bdBA
     693C 7C03 
     693E BC22 
     6940 BDBA 
0116 6942 FF00     kbctrl  data  >ff00,>0000,>ff0d,>209D
     6944 0000 
     6946 FF0D 
     6948 209D 
0117 694A 9897             data  >9897,>93b2,>9f8f,>8c9B
     694C 93B2 
     694E 9F8F 
     6950 8C9B 
0118 6952 8385             data  >8385,>84b3,>9e89,>8b80
     6954 84B3 
     6956 9E89 
     6958 8B80 
0119 695A 9692             data  >9692,>86b4,>b795,>8a8D
     695C 86B4 
     695E B795 
     6960 8A8D 
0120 6962 8294             data  >8294,>87b5,>b698,>888E
     6964 87B5 
     6966 B698 
     6968 888E 
0121 696A 9A91             data  >9a91,>81b1,>b090,>9cBB
     696C 81B1 
     696E B090 
     6970 9CBB 
**** **** ****     > runlib.asm
...
0022               ********|*****|*********************|**************************
0023 6972 C13B  30 mkhex   mov   *r11+,tmp0            ; P0: Address of word
0024 6974 C83B  50         mov   *r11+,@waux3          ; P1: Pointer to string buffer
     6976 8340 
0025 6978 04E0  34         clr   @waux1
     697A 833C 
0026 697C 04E0  34         clr   @waux2
     697E 833E 
0027 6980 0207  20         li    tmp3,waux1            ; We store results in WAUX1 and WAUX2
     6982 833C 
0028 6984 C114  26         mov   *tmp0,tmp0            ; Get word
0029               *--------------------------------------------------------------
0030               *    Convert nibbles to bytes (is in wrong order)
0031               *--------------------------------------------------------------
0032 6986 0205  20         li    tmp1,4                ; 4 nibbles
     6988 0004 
0033 698A C184  18 mkhex1  mov   tmp0,tmp2             ; Make work copy
0034 698C 0246  22         andi  tmp2,>000f            ; Only keep LSN
     698E 000F 
0035                       ;------------------------------------------------------
0036                       ; Determine offset for ASCII char
0037                       ;------------------------------------------------------
0038 6990 0286  22         ci    tmp2,>000a
     6992 000A 
0039 6994 1105  14         jlt   mkhex1.digit09
0040                       ;------------------------------------------------------
0041                       ; Add ASCII offset for digits A-F
0042                       ;------------------------------------------------------
0043               mkhex1.digitaf:
0044 6996 C21B  26         mov   *r11,tmp4
0045 6998 0988  56         srl   tmp4,8                ; Right justify
0046 699A 0228  22         ai    tmp4,-10              ; Adjust offset for 'A-F'
     699C FFF6 
0047 699E 1003  14         jmp   mkhex2
0048               
0049               mkhex1.digit09:
0050                       ;------------------------------------------------------
0051                       ; Add ASCII offset for digits 0-9
0052                       ;------------------------------------------------------
0053 69A0 C21B  26         mov   *r11,tmp4
0054 69A2 0248  22         andi  tmp4,>00ff            ; Only keep LSB
     69A4 00FF 
0055               
0056 69A6 A188  18 mkhex2  a     tmp4,tmp2             ; Add ASCII-offset
0057 69A8 06C6  14         swpb  tmp2
0058 69AA DDC6  32         movb  tmp2,*tmp3+           ; Save byte
0059 69AC 0944  56         srl   tmp0,4                ; Next nibble
0060 69AE 0605  14         dec   tmp1
0061 69B0 16EC  14         jne   mkhex1                ; Repeat until all nibbles processed
0062 69B2 0242  22         andi  config,>bfff          ; Reset bit 1 in config register
     69B4 BFFF 
0063               *--------------------------------------------------------------
0064               *    Build first 2 bytes in correct order
0065               *--------------------------------------------------------------
0066 69B6 C160  34         mov   @waux3,tmp1           ; Get pointer
     69B8 8340 
0067 69BA 04D5  26         clr   *tmp1                 ; Set length byte to 0
0068 69BC 0585  14         inc   tmp1                  ; Next byte, not word!
0069 69BE C120  34         mov   @waux2,tmp0
     69C0 833E 
0070 69C2 06C4  14         swpb  tmp0
0071 69C4 DD44  32         movb  tmp0,*tmp1+
0072 69C6 06C4  14         swpb  tmp0
0073 69C8 DD44  32         movb  tmp0,*tmp1+
0074               *--------------------------------------------------------------
0075               *    Set length byte
0076               *--------------------------------------------------------------
0077 69CA C120  34         mov   @waux3,tmp0           ; Get start of string buffer
     69CC 8340 
0078 69CE D520  46         movb  @hb$04,*tmp0          ; Set lengh byte to 4
     69D0 2020 
0079 69D2 05CB  14         inct  r11                   ; Skip Parameter P2
0080               *--------------------------------------------------------------
0081               *    Build last 2 bytes in correct order
0082               *--------------------------------------------------------------
0083 69D4 C120  34         mov   @waux1,tmp0
     69D6 833C 
0084 69D8 06C4  14         swpb  tmp0
0085 69DA DD44  32         movb  tmp0,*tmp1+
0086 69DC 06C4  14         swpb  tmp0
0087 69DE DD44  32         movb  tmp0,*tmp1+
0088               *--------------------------------------------------------------
0089               *    Display hex number ?
0090               *--------------------------------------------------------------
0091 69E0 20A0  38         coc   @wbit0,config         ; Check if 'display' bit is set
     69E2 202A 
0092 69E4 1301  14         jeq   mkhex3                ; Yes, so show at current YX position
0093 69E6 045B  20         b     *r11                  ; Exit
0094               *--------------------------------------------------------------
0095               *  Display hex number on screen at current YX position
0096               *--------------------------------------------------------------
0097 69E8 0242  22 mkhex3  andi  config,>7fff          ; Reset bit 0
     69EA 7FFF 
0098 69EC C160  34         mov   @waux3,tmp1           ; Get Pointer to string
     69EE 8340 
0099 69F0 0460  28         b     @xutst0               ; Display string
     69F2 23FE 
0100 69F4 0610     prefix  data  >0610                 ; Length byte + blank
0101               
0102               
0103               
0104               ***************************************************************
...
0120               ********|*****|*********************|**************************
0121 69F6 C83B  50 puthex  mov   *r11+,@wyx            ; Set cursor
     69F8 832A 
0122 69FA 0262  22         ori   config,>8000          ; CONFIG register bit 0=1
     69FC 8000 
0123 69FE 10B9  14         jmp   mkhex                 ; Convert number and display
0124               
**** **** ****     > runlib.asm
0182               
...
0018               ********|*****|*********************|**************************
0019 6A00 0207  20 mknum   li    tmp3,5                ; Digit counter
     6A02 0005 
0020 6A04 C17B  30         mov   *r11+,tmp1            ; \ Get 16 bit unsigned number
0021 6A06 C155  26         mov   *tmp1,tmp1            ; /
0022 6A08 C23B  30         mov   *r11+,tmp4            ; Pointer to string buffer
0023 6A0A 0228  22         ai    tmp4,4                ; Get end of buffer
     6A0C 0004 
0024 6A0E 0206  20         li    tmp2,10               ; Divide by 10 to isolate last digit
     6A10 000A 
0025               *--------------------------------------------------------------
0026               *  Do string conversion
0027               *--------------------------------------------------------------
0028 6A12 04C4  14 mknum1  clr   tmp0                  ; Clear the high word of the dividend
0029 6A14 3D06  128         div   tmp2,tmp0             ; (TMP0:TMP1) / 10 (TMP2)
0030 6A16 06C5  14         swpb  tmp1                  ; Move to high-byte for writing to buffer
0031 6A18 B15B  26         ab    *r11,tmp1             ; Add offset for ASCII digit
0032 6A1A D605  30         movb  tmp1,*tmp4            ; Write remainder to string buffer
0033 6A1C C144  18         mov   tmp0,tmp1             ; Move integer result into R4 for the next digit
0034 6A1E 0608  14         dec   tmp4                  ; Adjust string pointer for next digit
0035 6A20 0607  14         dec   tmp3                  ; Decrease counter
0036 6A22 16F7  14         jne   mknum1                ; Do next digit
0037               *--------------------------------------------------------------
0038               *  Replace leading 0's with fill character
0039               *--------------------------------------------------------------
0040 6A24 0207  20         li    tmp3,4                ; Check first 4 digits
     6A26 0004 
0041 6A28 0588  14         inc   tmp4                  ; Too far, back to buffer start
0042 6A2A C11B  26         mov   *r11,tmp0
0043 6A2C 0A84  56         sla   tmp0,8                ; Only keep fill character in HB
0044 6A2E 96D8  38 mknum2  cb    *tmp4,*r11            ; Digit = 0 ?
0045 6A30 1305  14         jeq   mknum4                ; Yes, replace with fill character
0046 6A32 05CB  14 mknum3  inct  r11
0047 6A34 20A0  38         coc   @wbit0,config         ; Check if 'display' bit is set
     6A36 202A 
0048 6A38 1305  14         jeq   mknum5                ; Yes, so show at current YX position
0049 6A3A 045B  20         b     *r11                  ; Exit
0050 6A3C DE04  32 mknum4  movb  tmp0,*tmp4+           ; Replace leading 0 with fill character
0051 6A3E 0607  14         dec   tmp3                  ; 4th digit processed ?
0052 6A40 13F8  14         jeq   mknum3                ; Yes, exit
0053 6A42 10F5  14         jmp   mknum2                ; No, next one
0054               *--------------------------------------------------------------
0055               *  Display integer on screen at current YX position
0056               *--------------------------------------------------------------
0057 6A44 0242  22 mknum5  andi  config,>7fff          ; Reset bit 0
     6A46 7FFF 
0058 6A48 C10B  18         mov   r11,tmp0
0059 6A4A 0224  22         ai    tmp0,-4
     6A4C FFFC 
0060 6A4E C154  26         mov   *tmp0,tmp1            ; Get buffer address
0061 6A50 0206  20         li    tmp2,>0500            ; String length = 5
     6A52 0500 
0062 6A54 0460  28         b     @xutstr               ; Display string
     6A56 2400 
0063               
0064               
0065               
...
0090               ********|*****|*********************|**************************
0091               trimnum:
0092 6A58 C13B  30         mov   *r11+,tmp0            ; Get pointer to input string
0093 6A5A C17B  30         mov   *r11+,tmp1            ; Get pointer to output string
0094 6A5C C1BB  30         mov   *r11+,tmp2            ; Get padding character
0095 6A5E 06C6  14         swpb  tmp2                  ; LO <-> HI
0096 6A60 0207  20         li    tmp3,5                ; Set counter
     6A62 0005 
0097                       ;------------------------------------------------------
0098                       ; Scan for padding character from left to right
0099                       ;------------------------------------------------------:
0100               trimnum_scan:
0101 6A64 9194  26         cb    *tmp0,tmp2            ; Matches padding character ?
0102 6A66 1604  14         jne   trimnum_setlen        ; No, exit loop
0103 6A68 0584  14         inc   tmp0                  ; Next character
0104 6A6A 0607  14         dec   tmp3                  ; Last digit reached ?
0105 6A6C 1301  14         jeq   trimnum_setlen        ; yes, exit loop
0106 6A6E 10FA  14         jmp   trimnum_scan
0107                       ;------------------------------------------------------
0108                       ; Scan completed, set length byte new string
0109                       ;------------------------------------------------------
0110               trimnum_setlen:
0111 6A70 06C7  14         swpb  tmp3                  ; LO <-> HI
0112 6A72 DD47  32         movb  tmp3,*tmp1+           ; Update string-length in work buffer
0113 6A74 06C7  14         swpb  tmp3                  ; LO <-> HI
0114                       ;------------------------------------------------------
0115                       ; Start filling new string
0116                       ;------------------------------------------------------
0117               trimnum_fill
0118 6A76 DD74  42         movb  *tmp0+,*tmp1+         ; Copy character
0119 6A78 0607  14         dec   tmp3                  ; Last character ?
0120 6A7A 16FD  14         jne   trimnum_fill          ; Not yet, repeat
0121 6A7C 045B  20         b     *r11                  ; Return
0122               
0123               
0124               
0125               
...
0137               ********|*****|*********************|**************************
0138 6A7E C83B  50 putnum  mov   *r11+,@wyx            ; Set cursor
     6A80 832A 
0139 6A82 0262  22         ori   config,>8000          ; CONFIG register bit 0=1
     6A84 8000 
0140 6A86 10BC  14         jmp   mknum                 ; Convert number and display
**** **** ****     > runlib.asm
0186               
0190               
0194               
...
0022 6A88 C800  38         mov   r0,@cpu.scrpad.tgt    ; Save @>8300 (r0)
     6A8A 3E00 
0023 6A8C C801  38         mov   r1,@cpu.scrpad.tgt+2  ; Save @>8302 (r1)
     6A8E 3E02 
0024 6A90 C802  38         mov   r2,@cpu.scrpad.tgt+4  ; Save @>8304 (r2)
     6A92 3E04 
0025                       ;------------------------------------------------------
0026                       ; Prepare for copy loop
0027                       ;------------------------------------------------------
0028 6A94 0200  20         li    r0,>8306              ; Scratpad source address
     6A96 8306 
0029 6A98 0201  20         li    r1,cpu.scrpad.tgt+6   ; RAM target address
     6A9A 3E06 
0030 6A9C 0202  20         li    r2,62                 ; Loop counter
     6A9E 003E 
0031                       ;------------------------------------------------------
0032                       ; Copy memory range >8306 - >83ff
0033                       ;------------------------------------------------------
0034               cpu.scrpad.backup.copy:
0035 6AA0 CC70  46         mov   *r0+,*r1+
0036 6AA2 CC70  46         mov   *r0+,*r1+
0037 6AA4 0642  14         dect  r2
0038 6AA6 16FC  14         jne   cpu.scrpad.backup.copy
0039 6AA8 C820  54         mov   @>83fe,@cpu.scrpad.tgt + >fe
     6AAA 83FE 
     6AAC 3EFE 
0040                                                   ; Copy last word
0041                       ;------------------------------------------------------
...
0043                       ;------------------------------------------------------
0044 6AAE C020  34         mov   @cpu.scrpad.tgt,r0    ; Restore r0
     6AB0 3E00 
0045 6AB2 C060  34         mov   @cpu.scrpad.tgt+2,r1  ; Restore r1
     6AB4 3E02 
0046 6AB6 C0A0  34         mov   @cpu.scrpad.tgt+4,r2  ; Restore r2
     6AB8 3E04 
0047                       ;------------------------------------------------------
0048                       ; Exit
0049                       ;------------------------------------------------------
0050               cpu.scrpad.backup.exit:
0051 6ABA 045B  20         b     *r11                  ; Return to caller
0052               
0053               
0054               ***************************************************************
...
0069                       ;------------------------------------------------------
0070 6ABC C820  54         mov   @cpu.scrpad.tgt,@>8300
     6ABE 3E00 
     6AC0 8300 
0071 6AC2 C820  54         mov   @cpu.scrpad.tgt + 2,@>8302
     6AC4 3E02 
     6AC6 8302 
0072 6AC8 C820  54         mov   @cpu.scrpad.tgt + 4,@>8304
     6ACA 3E04 
     6ACC 8304 
0073                       ;------------------------------------------------------
0074                       ; save current r0 - r2 (WS can be outside scratchpad!)
0075                       ;------------------------------------------------------
0076 6ACE C800  38         mov   r0,@cpu.scrpad.tgt
     6AD0 3E00 
0077 6AD2 C801  38         mov   r1,@cpu.scrpad.tgt + 2
     6AD4 3E02 
0078 6AD6 C802  38         mov   r2,@cpu.scrpad.tgt + 4
     6AD8 3E04 
0079                       ;------------------------------------------------------
0080                       ; Prepare for copy loop, WS
0081                       ;------------------------------------------------------
0082 6ADA 0200  20         li    r0,cpu.scrpad.tgt + 6
     6ADC 3E06 
0083 6ADE 0201  20         li    r1,>8306
     6AE0 8306 
0084 6AE2 0202  20         li    r2,62
     6AE4 003E 
0085                       ;------------------------------------------------------
0086                       ; Copy memory range @cpu.scrpad.tgt <-> @cpu.scrpad.tgt + >ff
0087                       ;------------------------------------------------------
0088               cpu.scrpad.restore.copy:
0089 6AE6 CC70  46         mov   *r0+,*r1+
0090 6AE8 CC70  46         mov   *r0+,*r1+
0091 6AEA 0642  14         dect  r2
0092 6AEC 16FC  14         jne   cpu.scrpad.restore.copy
0093 6AEE C820  54         mov   @cpu.scrpad.tgt + > fe,@>83fe
     6AF0 3EFE 
     6AF2 83FE 
0094                                                   ; Copy last word
0095                       ;------------------------------------------------------
...
0097                       ;------------------------------------------------------
0098 6AF4 C020  34         mov   @cpu.scrpad.tgt,r0
     6AF6 3E00 
0099 6AF8 C060  34         mov   @cpu.scrpad.tgt + 2,r1
     6AFA 3E02 
0100 6AFC C0A0  34         mov   @cpu.scrpad.tgt + 4,r2
     6AFE 3E04 
0101                       ;------------------------------------------------------
0102                       ; Exit
0103                       ;------------------------------------------------------
0104               cpu.scrpad.restore.exit:
0105 6B00 045B  20         b     *r11                  ; Return to caller
**** **** ****     > runlib.asm
...
0025 6B02 C17B  30         mov   *r11+,tmp1            ; tmp1 = Memory target address
0026                       ;------------------------------------------------------
0027                       ; Copy scratchpad memory to destination
0028                       ;------------------------------------------------------
0029               xcpu.scrpad.pgout:
0030 6B04 0204  20         li    tmp0,>8300            ; tmp0 = Memory source address
     6B06 8300 
0031 6B08 C1C5  18         mov   tmp1,tmp3             ; tmp3 = copy of tmp1
0032 6B0A 0206  20         li    tmp2,128              ; tmp2 = Words to copy
     6B0C 0080 
0033                       ;------------------------------------------------------
0034                       ; Copy memory
0035                       ;------------------------------------------------------
0036 6B0E CD74  46 !       mov   *tmp0+,*tmp1+         ; Copy word
0037 6B10 0606  14         dec   tmp2
0038 6B12 16FD  14         jne   -!                    ; Loop until done
0039                       ;------------------------------------------------------
0040                       ; Switch to new workspace
0041                       ;------------------------------------------------------
0042 6B14 C347  18         mov   tmp3,r13              ; R13=WP   (pop tmp1 from stack)
0043 6B16 020E  20         li    r14,cpu.scrpad.pgout.after.rtwp
     6B18 2ABC 
0044                                                   ; R14=PC
0045 6B1A 04CF  14         clr   r15                   ; R15=STATUS
0046                       ;------------------------------------------------------
0047                       ; If we get here, WS was copied to specified
0048                       ; destination.  Also contents of r13,r14,r15
0049                       ; are about to be overwritten by rtwp instruction.
0050                       ;------------------------------------------------------
0051 6B1C 0380  18         rtwp                        ; Activate copied workspace
0052                                                   ; in non-scratchpad memory!
0053               
0054               cpu.scrpad.pgout.after.rtwp:
0055 6B1E 0460  28         b     @cpu.scrpad.restore   ; Restore scratchpad memory from @>2000
     6B20 2A5A 
0056               
0057                       ;------------------------------------------------------
0058                       ; Exit
...
0061 6B22 045B  20         b     *r11                  ; Return to caller
0062               
0063               
0064               ***************************************************************
...
0078 6B24 C13B  30         mov   *r11+,tmp0            ; tmp0 = Memory source address
0079                       ;------------------------------------------------------
0080                       ; Copy scratchpad memory to destination
0081                       ;------------------------------------------------------
0082               xcpu.scrpad.pgin:
0083 6B26 0205  20         li    tmp1,>8300            ; tmp1 = Memory destination address
     6B28 8300 
0084 6B2A 0206  20         li    tmp2,128              ; tmp2 = Words to copy
     6B2C 0080 
0085                       ;------------------------------------------------------
0086                       ; Copy memory
0087                       ;------------------------------------------------------
0088 6B2E CD74  46 !       mov   *tmp0+,*tmp1+         ; Copy word
0089 6B30 0606  14         dec   tmp2
0090 6B32 16FD  14         jne   -!                    ; Loop until done
0091                       ;------------------------------------------------------
0092                       ; Switch workspace to scratchpad memory
0093                       ;------------------------------------------------------
0094 6B34 02E0  18         lwpi  >8300                 ; Activate copied workspace
     6B36 8300 
0095                       ;------------------------------------------------------
0096                       ; Exit
0097                       ;------------------------------------------------------
0098               cpu.scrpad.pgin.$$:
0099 6B38 045B  20         b     *r11                  ; Return to caller
**** **** ****     > runlib.asm
0211               
...
0040               ********|*****|*********************|**************************
0041 6B3A A400     dsrlnk  data  dsrlnk.dsrlws         ; dsrlnk workspace
0042 6B3C 2ADC             data  dsrlnk.init           ; entry point
0043                       ;------------------------------------------------------
0044                       ; DSRLNK entry point
0045                       ;------------------------------------------------------
0046               dsrlnk.init:
0047 6B3E C17E  30         mov   *r14+,r5              ; get pgm type for link
0048 6B40 C805  38         mov   r5,@dsrlnk.sav8a      ; save data following blwp @dsrlnk (8 or >a)
     6B42 8322 
0049 6B44 53E0  34         szcb  @hb$20,r15            ; reset equal bit
     6B46 2026 
0050 6B48 C020  34         mov   @>8356,r0             ; get ptr to pab
     6B4A 8356 
0051 6B4C C240  18         mov   r0,r9                 ; save ptr
0052                       ;------------------------------------------------------
0053                       ; Fetch file descriptor length from PAB
0054                       ;------------------------------------------------------
0055 6B4E 0229  22         ai    r9,>fff8              ; adjust r9 to addr PAB flag->(pabaddr+9)-8
     6B50 FFF8 
0056               
0057                       ;---------------------------; Inline VSBR start
0058 6B52 06C0  14         swpb  r0                    ;
0059 6B54 D800  38         movb  r0,@vdpa              ; send low byte
     6B56 8C02 
0060 6B58 06C0  14         swpb  r0                    ;
0061 6B5A D800  38         movb  r0,@vdpa              ; send high byte
     6B5C 8C02 
0062 6B5E D0E0  34         movb  @vdpr,r3              ; read byte from VDP ram
     6B60 8800 
0063                       ;---------------------------; Inline VSBR end
0064 6B62 0983  56         srl   r3,8                  ; Move to low byte
0065               
0066                       ;------------------------------------------------------
0067                       ; Fetch file descriptor device name from PAB
0068                       ;------------------------------------------------------
0069 6B64 0704  14         seto  r4                    ; init counter
0070 6B66 0202  20         li    r2,dsrlnk.namsto      ; point to 8-byte CPU buffer
     6B68 A420 
0071 6B6A 0580  14 !       inc   r0                    ; point to next char of name
0072 6B6C 0584  14         inc   r4                    ; incr char counter
0073 6B6E 0284  22         ci    r4,>0007              ; see if length more than 7 chars
     6B70 0007 
0074 6B72 1565  14         jgt   dsrlnk.error.devicename_invalid
0075                                                   ; yes, error
0076 6B74 80C4  18         c     r4,r3                 ; end of name?
0077 6B76 130C  14         jeq   dsrlnk.device_name.get_length
0078                                                   ; yes
0079               
0080                       ;---------------------------; Inline VSBR start
0081 6B78 06C0  14         swpb  r0                    ;
0082 6B7A D800  38         movb  r0,@vdpa              ; send low byte
     6B7C 8C02 
0083 6B7E 06C0  14         swpb  r0                    ;
0084 6B80 D800  38         movb  r0,@vdpa              ; send high byte
     6B82 8C02 
0085 6B84 D060  34         movb  @vdpr,r1              ; read byte from VDP ram
     6B86 8800 
...
0090                       ;------------------------------------------------------
0091 6B88 DC81  32         movb  r1,*r2+               ; move into buffer
0092 6B8A 9801  38         cb    r1,@dsrlnk.period     ; is character a '.'
     6B8C 2BEC 
0093 6B8E 16ED  14         jne   -!                    ; no, loop next char
0094                       ;------------------------------------------------------
0095                       ; Determine device name length
0096                       ;------------------------------------------------------
0097               dsrlnk.device_name.get_length:
0098 6B90 C104  18         mov   r4,r4                 ; Check if length = 0
0099 6B92 1355  14         jeq   dsrlnk.error.devicename_invalid
0100                                                   ; yes, error
0101 6B94 04E0  34         clr   @>83d0
     6B96 83D0 
0102 6B98 C804  38         mov   r4,@>8354             ; save name length for search
     6B9A 8354 
0103 6B9C 0584  14         inc   r4                    ; adjust for dot
0104 6B9E A804  38         a     r4,@>8356             ; point to position after name
     6BA0 8356 
0105                       ;------------------------------------------------------
0106                       ; Prepare for DSR scan >1000 - >1f00
0107                       ;------------------------------------------------------
0108               dsrlnk.dsrscan.start:
0109 6BA2 02E0  18         lwpi  >83e0                 ; Use GPL WS
     6BA4 83E0 
0110 6BA6 04C1  14         clr   r1                    ; version found of dsr
0111 6BA8 020C  20         li    r12,>0f00             ; init cru addr
     6BAA 0F00 
0112                       ;------------------------------------------------------
0113                       ; Turn off ROM on current card
0114                       ;------------------------------------------------------
0115               dsrlnk.dsrscan.cardoff:
0116 6BAC C30C  18         mov   r12,r12               ; anything to turn off?
0117 6BAE 1301  14         jeq   dsrlnk.dsrscan.cardloop
0118                                                   ; no, loop over cards
0119 6BB0 1E00  20         sbz   0                     ; yes, turn off
0120                       ;------------------------------------------------------
0121                       ; Loop over cards and look if DSR present
0122                       ;------------------------------------------------------
0123               dsrlnk.dsrscan.cardloop:
0124 6BB2 022C  22         ai    r12,>0100             ; next rom to turn on
     6BB4 0100 
0125 6BB6 04E0  34         clr   @>83d0                ; clear in case we are done
     6BB8 83D0 
0126 6BBA 028C  22         ci    r12,>2000             ; Card scan complete? (>1000 to >1F00)
     6BBC 2000 
0127 6BBE 133D  14         jeq   dsrlnk.error.nodsr_found
0128                                                   ; yes, no matching DSR found
0129 6BC0 C80C  38         mov   r12,@>83d0            ; save addr of next cru
     6BC2 83D0 
0130                       ;------------------------------------------------------
0131                       ; Look at card ROM (@>4000 eq 'AA' ?)
0132                       ;------------------------------------------------------
0133 6BC4 1D00  20         sbo   0                     ; turn on rom
0134 6BC6 0202  20         li    r2,>4000              ; start at beginning of rom
     6BC8 4000 
0135 6BCA 9812  46         cb    *r2,@dsrlnk.$aa00     ; check for a valid DSR header
     6BCC 2BE8 
0136 6BCE 16EE  14         jne   dsrlnk.dsrscan.cardoff
...
0144                       ;------------------------------------------------------
0145 6BD0 A0A0  34         a     @dsrlnk.dstype,r2     ; go to first pointer (byte 8 or 10)
     6BD2 A40A 
0146 6BD4 1003  14         jmp   dsrlnk.dsrscan.getentry
0147                       ;------------------------------------------------------
0148                       ; Next DSR entry
0149                       ;------------------------------------------------------
0150               dsrlnk.dsrscan.nextentry:
0151 6BD6 C0A0  34         mov   @>83d2,r2             ; Offset 0 > Fetch link to next DSR or
     6BD8 83D2 
0152                                                   ; subprogram
0153               
0154 6BDA 1D00  20         sbo   0                     ; turn rom back on
0155                       ;------------------------------------------------------
0156                       ; Get DSR entry
0157                       ;------------------------------------------------------
0158               dsrlnk.dsrscan.getentry:
0159 6BDC C092  26         mov   *r2,r2                ; is addr a zero? (end of chain?)
0160 6BDE 13E6  14         jeq   dsrlnk.dsrscan.cardoff
0161                                                   ; yes, no more DSRs or programs to check
0162 6BE0 C802  38         mov   r2,@>83d2             ; Offset 0 > Store link to next DSR or
     6BE2 83D2 
0163                                                   ; subprogram
0164               
0165 6BE4 05C2  14         inct  r2                    ; Offset 2 > Has call address of current
0166                                                   ; DSR/subprogram code
0167               
0168 6BE6 C272  30         mov   *r2+,r9               ; Store call address in r9. Move r2 to
0169                                                   ; offset 4 (DSR/subprogram name)
0170                       ;------------------------------------------------------
0171                       ; Check file descriptor in DSR
0172                       ;------------------------------------------------------
0173 6BE8 04C5  14         clr   r5                    ; Remove any old stuff
0174 6BEA D160  34         movb  @>8355,r5             ; get length as counter
     6BEC 8355 
0175 6BEE 130B  14         jeq   dsrlnk.dsrscan.call_dsr
0176                                                   ; if zero, do not further check, call DSR
0177                                                   ; program
0178               
0179 6BF0 9C85  32         cb    r5,*r2+               ; see if length matches
0180 6BF2 16F1  14         jne   dsrlnk.dsrscan.nextentry
0181                                                   ; no, length does not match. Go process next
0182                                                   ; DSR entry
0183               
0184 6BF4 0985  56         srl   r5,8                  ; yes, move to low byte
0185 6BF6 0206  20         li    r6,dsrlnk.namsto      ; Point to 8-byte CPU buffer
     6BF8 A420 
0186 6BFA 9CB6  42 !       cb    *r6+,*r2+             ; Compare byte in CPU buffer with byte in
0187                                                   ; DSR ROM
0188 6BFC 16EC  14         jne   dsrlnk.dsrscan.nextentry
0189                                                   ; try next DSR entry if no match
0190 6BFE 0605  14         dec   r5                    ; loop until full length checked
0191 6C00 16FC  14         jne   -!
0192                       ;------------------------------------------------------
0193                       ; Device name/Subprogram match
0194                       ;------------------------------------------------------
0195               dsrlnk.dsrscan.match:
0196 6C02 C802  38         mov   r2,@>83d2             ; DSR entry addr must be saved at @>83d2
     6C04 83D2 
0197               
0198                       ;------------------------------------------------------
...
0202 6C06 0581  14         inc   r1                    ; next version found
0203 6C08 0699  24         bl    *r9                   ; go run routine
0204                       ;
0205                       ; Depending on IO result the DSR in card ROM does RET
0206                       ; or (INCT R11 + RET), meaning either (1) or (2) get executed.
0207                       ;
0208 6C0A 10E5  14         jmp   dsrlnk.dsrscan.nextentry
0209                                                   ; (1) error return
0210 6C0C 1E00  20         sbz   0                     ; (2) turn off rom if good return
0211 6C0E 02E0  18         lwpi  dsrlnk.dsrlws         ; (2) restore workspace
     6C10 A400 
0212 6C12 C009  18         mov   r9,r0                 ; point to flag in pab
0213 6C14 C060  34         mov   @dsrlnk.sav8a,r1      ; get back data following blwp @dsrlnk
     6C16 8322 
0214                                                   ; (8 or >a)
0215 6C18 0281  22         ci    r1,8                  ; was it 8?
     6C1A 0008 
0216 6C1C 1303  14         jeq   dsrlnk.dsrscan.dsr.8  ; yes, jump: normal dsrlnk
0217 6C1E D060  34         movb  @>8350,r1             ; no, we have a data >a.
     6C20 8350 
0218                                                   ; Get error byte from @>8350
0219 6C22 1008  14         jmp   dsrlnk.dsrscan.dsr.a  ; go and return error byte to the caller
0220               
0221                       ;------------------------------------------------------
...
0226 6C24 06C0  14         swpb  r0                    ;
0227 6C26 D800  38         movb  r0,@vdpa              ; send low byte
     6C28 8C02 
0228 6C2A 06C0  14         swpb  r0                    ;
0229 6C2C D800  38         movb  r0,@vdpa              ; send high byte
     6C2E 8C02 
0230 6C30 D060  34         movb  @vdpr,r1              ; read byte from VDP ram
     6C32 8800 
...
0237 6C34 09D1  56         srl   r1,13                 ; just keep error bits
0238 6C36 1604  14         jne   dsrlnk.error.io_error
0239                                                   ; handle IO error
0240 6C38 0380  18         rtwp                        ; Return from DSR workspace to caller
0241                                                   ; workspace
0242               
0243                       ;------------------------------------------------------
...
0247 6C3A 02E0  18         lwpi  dsrlnk.dsrlws         ; No DSR found, restore workspace
     6C3C A400 
0248               dsrlnk.error.devicename_invalid:
0249 6C3E 04C1  14         clr   r1                    ; clear flag for error 0 = bad device name
0250               dsrlnk.error.io_error:
0251 6C40 06C1  14         swpb  r1                    ; put error in hi byte
0252 6C42 D741  30         movb  r1,*r13               ; store error flags in callers r0
0253 6C44 F3E0  34         socb  @hb$20,r15            ; set equal bit to indicate error
     6C46 2026 
0254 6C48 0380  18         rtwp                        ; Return from DSR workspace to caller
0255                                                   ; workspace
0256               
0257               ********************************************************************************
0258               
0259 6C4A AA00     dsrlnk.$aa00      data   >aa00      ; Used for identifying DSR header
0260 6C4C 0008     dsrlnk.$0008      data   >0008      ; 8 is the data that usually follows
0261                                                   ; a @blwp @dsrlnk
0262 6C4E ....     dsrlnk.period     text  '.'         ; For finding end of device name
0263               
0264                       even
**** **** ****     > runlib.asm
...
0041               ********|*****|*********************|**************************
0042               file.open:
0043 6C50 C03B  30         mov   *r11+,r0              ; Get file descriptor (P0)
0044               *--------------------------------------------------------------
0045               * Initialisation
0046               *--------------------------------------------------------------
0047               xfile.open:
0048 6C52 C04B  18         mov   r11,r1                ; Save return address
0049 6C54 C800  38         mov   r0,@file.pab.ptr      ; Backup of pointer to current VDP PAB
     6C56 A428 
0050 6C58 C100  18         mov   r0,tmp0               ; VDP write address (PAB byte 0)
0051 6C5A 04C5  14         clr   tmp1                  ; io.op.open
0052 6C5C 06A0  32         bl    @xvputb               ; Write file opcode to VDP
     6C5E 22AA 
0053               file.open_init:
0054 6C60 0220  22         ai    r0,9                  ; Move to file descriptor length
     6C62 0009 
0055 6C64 C800  38         mov   r0,@>8356             ; Pass file descriptor to DSRLNK
     6C66 8356 
0056               *--------------------------------------------------------------
0057               * Main
0058               *--------------------------------------------------------------
0059               file.open_main:
0060 6C68 0420  54         blwp  @dsrlnk               ; Call DSRLNK
     6C6A 2AD8 
0061 6C6C 0008             data  8                     ; Level 2 IO call
0062               *--------------------------------------------------------------
0063               * Exit
0064               *--------------------------------------------------------------
0065               file.open_exit:
0066 6C6E 1029  14         jmp   file.record.pab.details
...
0088               ********|*****|*********************|**************************
0089               file.close:
0090 6C70 C03B  30         mov   *r11+,r0              ; Get file descriptor (P0)
0091               *--------------------------------------------------------------
0092               * Initialisation
0093               *--------------------------------------------------------------
0094               xfile.close:
0095 6C72 C04B  18         mov   r11,r1                ; Save return address
0096 6C74 C800  38         mov   r0,@file.pab.ptr      ; Backup of pointer to current VDP PAB
     6C76 A428 
0097 6C78 C100  18         mov   r0,tmp0               ; VDP write address (PAB byte 0)
0098 6C7A 0205  20         li    tmp1,io.op.close      ; io.op.close
     6C7C 0001 
0099 6C7E 06A0  32         bl    @xvputb               ; Write file opcode to VDP
     6C80 22AA 
0100               file.close_init:
0101 6C82 0220  22         ai    r0,9                  ; Move to file descriptor length
     6C84 0009 
0102 6C86 C800  38         mov   r0,@>8356             ; Pass file descriptor to DSRLNK
     6C88 8356 
0103               *--------------------------------------------------------------
0104               * Main
0105               *--------------------------------------------------------------
0106               file.close_main:
0107 6C8A 0420  54         blwp  @dsrlnk               ; Call DSRLNK
     6C8C 2AD8 
0108 6C8E 0008             data  8                     ;
0109               *--------------------------------------------------------------
0110               * Exit
0111               *--------------------------------------------------------------
0112               file.close_exit:
0113 6C90 1018  14         jmp   file.record.pab.details
...
0139 6C92 C03B  30         mov   *r11+,r0              ; Get file descriptor (P0)
0140               *--------------------------------------------------------------
0141               * Initialisation
0142               *--------------------------------------------------------------
0143               xfile.record.read:
0144 6C94 C04B  18         mov   r11,r1                ; Save return address
0145 6C96 C800  38         mov   r0,@file.pab.ptr      ; Backup of pointer to current VDP PAB
     6C98 A428 
0146 6C9A C100  18         mov   r0,tmp0               ; VDP write address (PAB byte 0)
0147 6C9C 0205  20         li    tmp1,io.op.read       ; io.op.read
     6C9E 0002 
0148 6CA0 06A0  32         bl    @xvputb               ; Write file opcode to VDP
     6CA2 22AA 
0149               file.record.read_init:
0150 6CA4 0220  22         ai    r0,9                  ; Move to file descriptor length
     6CA6 0009 
0151 6CA8 C800  38         mov   r0,@>8356             ; Pass file descriptor to DSRLNK
     6CAA 8356 
0152               *--------------------------------------------------------------
0153               * Main
0154               *--------------------------------------------------------------
0155               file.record.read_main:
0156 6CAC 0420  54         blwp  @dsrlnk               ; Call DSRLNK
     6CAE 2AD8 
0157 6CB0 0008             data  8                     ;
0158               *--------------------------------------------------------------
0159               * Exit
0160               *--------------------------------------------------------------
0161               file.record.read_exit:
0162 6CB2 1007  14         jmp   file.record.pab.details
...
0170 6CB4 1000  14         nop
0171               
0172               
0173               file.record.seek:
0174 6CB6 1000  14         nop
0175               
0176               
0177               file.image.load:
0178 6CB8 1000  14         nop
0179               
0180               
0181               file.image.save:
0182 6CBA 1000  14         nop
0183               
0184               
0185               file.delete:
0186 6CBC 1000  14         nop
0187               
0188               
0189               file.rename:
0190 6CBE 1000  14         nop
0191               
0192               
0193               file.status:
0194 6CC0 1000  14         nop
0195               
0196               
0197               
0198               ***************************************************************
...
0211 6CC2 02C6  12         stst  tmp2                  ; Store status register contents in tmp2
...
0217               *--------------------------------------------------------------
0218 6CC4 C120  34         mov   @file.pab.ptr,tmp0    ; Get VDP address of current PAB
     6CC6 A428 
0219 6CC8 0224  22         ai    tmp0,5                ; Get address of VDP PAB byte 5
     6CCA 0005 
0220 6CCC 06A0  32         bl    @xvgetb               ; VDP read PAB status byte into tmp0
     6CCE 22C2 
0221 6CD0 C144  18         mov   tmp0,tmp1             ; Move to destination
0222               *--------------------------------------------------------------
0223               * Get PAB byte 1 from VDP ram into tmp0 (status)
0224               *--------------------------------------------------------------
0225 6CD2 C100  18         mov   r0,tmp0               ; VDP PAB byte 1 (status)
...
0249 6CD4 0451  20         b     *r1                   ; Return to caller
**** **** ****     > runlib.asm
0217               
0218               *//////////////////////////////////////////////////////////////
0219               *                            TIMERS
...
0019               ********|*****|*********************|**************************
0020 6CD6 0300  24 tmgr    limi  0                     ; No interrupt processing
     6CD8 0000 
0021               *--------------------------------------------------------------
0022               * Read VDP status register
0023               *--------------------------------------------------------------
0024 6CDA D360  34 tmgr1   movb  @vdps,r13             ; Save copy of VDP status register in R13
     6CDC 8802 
0025               *--------------------------------------------------------------
0026               * Latch sprite collision flag
0027               *--------------------------------------------------------------
0028 6CDE 2360  38         coc   @wbit2,r13            ; C flag on ?
     6CE0 2026 
0029 6CE2 1602  14         jne   tmgr1a                ; No, so move on
0030 6CE4 E0A0  34         soc   @wbit12,config        ; Latch bit 12 in config register
     6CE6 2012 
0031               *--------------------------------------------------------------
0032               * Interrupt flag
0033               *--------------------------------------------------------------
0034 6CE8 2360  38 tmgr1a  coc   @wbit0,r13            ; Interupt flag set ?
     6CEA 202A 
0035 6CEC 1311  14         jeq   tmgr4                 ; Yes, process slots 0..n
0036               *--------------------------------------------------------------
...
0046               *--------------------------------------------------------------
0047 6CEE 20A0  38 tmgr2   coc   @wbit8,config         ; Kernel thread blocked ?
     6CF0 201A 
0048 6CF2 1305  14         jeq   tmgr3                 ; Yes, skip to user hook
0049 6CF4 20A0  38         coc   @wbit9,config         ; Kernel thread enabled ?
     6CF6 2018 
0050 6CF8 1602  14         jne   tmgr3                 ; No, skip to user hook
0051 6CFA 0460  28         b     @kthread              ; Run kernel thread
     6CFC 2D12 
0052               *--------------------------------------------------------------
0053               * Run user hook
0054               *--------------------------------------------------------------
0055 6CFE 20A0  38 tmgr3   coc   @wbit6,config         ; User hook blocked ?
     6D00 201E 
0056 6D02 13EB  14         jeq   tmgr1
0057 6D04 20A0  38         coc   @wbit7,config         ; User hook enabled ?
     6D06 201C 
0058 6D08 16E8  14         jne   tmgr1
0059 6D0A C120  34         mov   @wtiusr,tmp0
     6D0C 832E 
0060 6D0E 0454  20         b     *tmp0                 ; Run user hook
0061               *--------------------------------------------------------------
0062               * Do internal housekeeping
0063               *--------------------------------------------------------------
0064 6D10 40A0  34 tmgr4   szc   @tmdat,config         ; Unblock kernel thread and user hook
     6D12 2D10 
0065 6D14 C10A  18         mov   r10,tmp0
0066 6D16 0244  22         andi  tmp0,>00ff            ; Clear HI byte
     6D18 00FF 
0067 6D1A 20A0  38         coc   @wbit2,config         ; PAL flag set ?
     6D1C 2026 
0068 6D1E 1303  14         jeq   tmgr5
0069 6D20 0284  22         ci    tmp0,60               ; 1 second reached ?
     6D22 003C 
0070 6D24 1002  14         jmp   tmgr6
0071 6D26 0284  22 tmgr5   ci    tmp0,50
     6D28 0032 
0072 6D2A 1101  14 tmgr6   jlt   tmgr7                 ; No, continue
0073 6D2C 1001  14         jmp   tmgr8
0074 6D2E 058A  14 tmgr7   inc   r10                   ; Increase tick counter
0075               *--------------------------------------------------------------
0076               * Loop over slots
0077               *--------------------------------------------------------------
0078 6D30 C120  34 tmgr8   mov   @wtitab,tmp0          ; Pointer to timer table
     6D32 832C 
0079 6D34 024A  22         andi  r10,>ff00             ; Use R10LB as slot counter. Reset.
     6D36 FF00 
0080 6D38 C1D4  26 tmgr9   mov   *tmp0,tmp3            ; Is slot empty ?
0081 6D3A 1316  14         jeq   tmgr11                ; Yes, get next slot
0082               *--------------------------------------------------------------
0083               *  Check if slot should be executed
0084               *--------------------------------------------------------------
0085 6D3C 05C4  14         inct  tmp0                  ; Second word of slot data
0086 6D3E 0594  26         inc   *tmp0                 ; Update tick count in slot
0087 6D40 C194  26         mov   *tmp0,tmp2            ; Get second word of slot data
0088 6D42 9820  54         cb    @tmp2hb,@tmp2lb       ; Slot target count = Slot internal counter ?
     6D44 830C 
     6D46 830D 
0089 6D48 1608  14         jne   tmgr10                ; No, get next slot
0090 6D4A 0246  22         andi  tmp2,>ff00            ; Clear internal counter
     6D4C FF00 
0091 6D4E C506  30         mov   tmp2,*tmp0            ; Update timer table
0092               *--------------------------------------------------------------
0093               *  Run slot, we only need TMP0 to survive
0094               *--------------------------------------------------------------
0095 6D50 C804  38         mov   tmp0,@wtitmp          ; Save TMP0
     6D52 8330 
0096 6D54 0697  24         bl    *tmp3                 ; Call routine in slot
0097 6D56 C120  34 slotok  mov   @wtitmp,tmp0          ; Restore TMP0
     6D58 8330 
0098               *--------------------------------------------------------------
0099               *  Prepare for next slot
0100               *--------------------------------------------------------------
0101 6D5A 058A  14 tmgr10  inc   r10                   ; Next slot
0102 6D5C 9820  54         cb    @r10lb,@btihi         ; Last slot done ?
     6D5E 8315 
     6D60 8314 
0103 6D62 1504  14         jgt   tmgr12                ; yes, Wait for next VDP interrupt
0104 6D64 05C4  14         inct  tmp0                  ; Offset for next slot
0105 6D66 10E8  14         jmp   tmgr9                 ; Process next slot
0106 6D68 05C4  14 tmgr11  inct  tmp0                  ; Skip 2nd word of slot data
0107 6D6A 10F7  14         jmp   tmgr10                ; Process next slot
0108 6D6C 024A  22 tmgr12  andi  r10,>ff00             ; Use R10LB as tick counter. Reset.
     6D6E FF00 
0109 6D70 10B4  14         jmp   tmgr1
0110 6D72 0280     tmdat   data  >0280                 ; Bit 8 (kernel thread) and bit 6 (user hook)
0111               
**** **** ****     > runlib.asm
...
0014               ********|*****|*********************|**************************
0015 6D74 E0A0  34 kthread soc   @wbit8,config         ; Block kernel thread
     6D76 201A 
0016               *--------------------------------------------------------------
...
0037               *--------------------------------------------------------------
0041 6D78 06A0  32         bl    @realkb               ; Scan full keyboard
     6D7A 27B8 
0043               *--------------------------------------------------------------
0044               kthread_exit
0045 6D7C 0460  28         b     @tmgr3                ; Exit
     6D7E 2C9C 
**** **** ****     > runlib.asm
...
0016               ********|*****|*********************|**************************
0017 6D80 C83B  50 mkhook  mov   *r11+,@wtiusr         ; Set user hook address
     6D82 832E 
0018 6D84 E0A0  34         soc   @wbit7,config         ; Enable user hook
     6D86 201C 
0019 6D88 045B  20 mkhoo1  b     *r11                  ; Return
...
0026               *  BL    @CLHOOK
0027               ********|*****|*********************|**************************
0028 6D8A 04E0  34 clhook  clr   @wtiusr               ; Unset user hook address
     6D8C 832E 
0029 6D8E 0242  22         andi  config,>feff          ; Disable user hook (bit 7=0)
     6D90 FEFF 
0030 6D92 045B  20         b     *r11                  ; Return
**** **** ****     > runlib.asm
0225               
...
0016               ********|*****|*********************|**************************
0017 6D94 C13B  30 mkslot  mov   *r11+,tmp0
0018 6D96 C17B  30         mov   *r11+,tmp1
0019               *--------------------------------------------------------------
0020               *  Calculate address of slot
0021               *--------------------------------------------------------------
0022 6D98 C184  18         mov   tmp0,tmp2
0023 6D9A 0966  56         srl   tmp2,6                ; Right align & TMP2 = TMP2 * 4
0024 6D9C A1A0  34         a     @wtitab,tmp2          ; Add table base
     6D9E 832C 
0025               *--------------------------------------------------------------
0026               *  Add slot to table
0027               *--------------------------------------------------------------
0028 6DA0 CD85  34         mov   tmp1,*tmp2+           ; Store address of subroutine
0029 6DA2 0A84  56         sla   tmp0,8                ; Get rid of slot number
0030 6DA4 C584  30         mov   tmp0,*tmp2            ; Store target count and reset tick count
0031               *--------------------------------------------------------------
0032               *  Check for end of list
0033               *--------------------------------------------------------------
0034 6DA6 881B  46         c     *r11,@w$ffff          ; End of list ?
     6DA8 202C 
0035 6DAA 1301  14         jeq   mkslo1                ; Yes, exit
0036 6DAC 10F3  14         jmp   mkslot                ; Process next entry
0037               *--------------------------------------------------------------
0038               *  Exit
0039               *--------------------------------------------------------------
0040 6DAE 05CB  14 mkslo1  inct  r11
0041 6DB0 045B  20         b     *r11                  ; Exit
0042               
0043               
0044               ***************************************************************
...
0050               *  P0 = Slot number
0051               ********|*****|*********************|**************************
0052 6DB2 C13B  30 clslot  mov   *r11+,tmp0
0053 6DB4 0A24  56 xlslot  sla   tmp0,2                ; TMP0 = TMP0*4
0054 6DB6 A120  34         a     @wtitab,tmp0          ; Add table base
     6DB8 832C 
0055 6DBA 04F4  30         clr   *tmp0+                ; Clear 1st word of slot
0056 6DBC 04D4  26         clr   *tmp0                 ; Clear 2nd word of slot
0057 6DBE 045B  20         b     *r11                  ; Exit
**** **** ****     > runlib.asm
0229               
0230               
0231               
...
0248               ********|*****|*********************|**************************
0250 6DC0 06A0  32 runlib  bl    @cpu.scrpad.backup    ; Backup scratchpad memory to
     6DC2 2A26 
0251                                                   ; @cpu.scrpad.tgt (>00..>ff)
0252               
0253 6DC4 04E0  34         clr   @>8302                ; Reset exit flag (R1 in workspace WS1!)
     6DC6 8302 
0257               *--------------------------------------------------------------
0258               * Alternative entry point
0259               *--------------------------------------------------------------
0260 6DC8 0300  24 runli1  limi  0                     ; Turn off interrupts
     6DCA 0000 
0261 6DCC 02E0  18         lwpi  ws1                   ; Activate workspace 1
     6DCE 8300 
0262 6DD0 C0E0  34         mov   @>83c0,r3             ; Get random seed from OS monitor
     6DD2 83C0 
0263               *--------------------------------------------------------------
0264               * Clear scratch-pad memory from R4 upwards
0265               *--------------------------------------------------------------
0266 6DD4 0202  20 runli2  li    r2,>8308
     6DD6 8308 
0267 6DD8 04F2  30 runli3  clr   *r2+                  ; Clear scratchpad >8306->83FF
0268 6DDA 0282  22         ci    r2,>8400
     6DDC 8400 
0269 6DDE 16FC  14         jne   runli3
0270               *--------------------------------------------------------------
0271               * Exit to TI-99/4A title screen ?
0272               *--------------------------------------------------------------
0273 6DE0 0281  22 runli3a ci    r1,>ffff              ; Exit flag set ?
     6DE2 FFFF 
0274 6DE4 1602  14         jne   runli4                ; No, continue
0275 6DE6 0420  54         blwp  @0                    ; Yes, bye bye
     6DE8 0000 
0276               *--------------------------------------------------------------
0277               * Determine if VDP is PAL or NTSC
0278               *--------------------------------------------------------------
0279 6DEA C803  38 runli4  mov   r3,@waux1             ; Store random seed
     6DEC 833C 
0280 6DEE 04C1  14         clr   r1                    ; Reset counter
0281 6DF0 0202  20         li    r2,10                 ; We test 10 times
     6DF2 000A 
0282 6DF4 C0E0  34 runli5  mov   @vdps,r3
     6DF6 8802 
0283 6DF8 20E0  38         coc   @wbit0,r3             ; Interupt flag set ?
     6DFA 202A 
0284 6DFC 1302  14         jeq   runli6
0285 6DFE 0581  14         inc   r1                    ; Increase counter
0286 6E00 10F9  14         jmp   runli5
0287 6E02 0602  14 runli6  dec   r2                    ; Next test
0288 6E04 16F7  14         jne   runli5
0289 6E06 0281  22         ci    r1,>1250              ; Max for NTSC reached ?
     6E08 1250 
0290 6E0A 1202  14         jle   runli7                ; No, so it must be NTSC
0291 6E0C 0262  22         ori   config,palon          ; Yes, it must be PAL, set flag
     6E0E 2026 
0292               *--------------------------------------------------------------
0293               * Copy machine code to scratchpad (prepare tight loop)
0294               *--------------------------------------------------------------
0295 6E10 0201  20 runli7  li    r1,mccode             ; Machinecode to patch
     6E12 21FE 
0296 6E14 0202  20         li    r2,mcloop+2           ; Scratch-pad reserved for machine code
     6E16 8322 
0297 6E18 CCB1  46         mov   *r1+,*r2+             ; Copy 1st instruction
0298 6E1A CCB1  46         mov   *r1+,*r2+             ; Copy 2nd instruction
0299 6E1C CCB1  46         mov   *r1+,*r2+             ; Copy 3rd instruction
0300               *--------------------------------------------------------------
0301               * Initialize registers, memory, ...
0302               *--------------------------------------------------------------
0303 6E1E 04C1  14 runli9  clr   r1
0304 6E20 04C2  14         clr   r2
0305 6E22 04C3  14         clr   r3
0306 6E24 0209  20         li    stack,>8400           ; Set stack
     6E26 8400 
0307 6E28 020F  20         li    r15,vdpw              ; Set VDP write address
     6E2A 8C00 
0311               *--------------------------------------------------------------
0312               * Setup video memory
0313               *--------------------------------------------------------------
0315 6E2C 0280  22         ci    r0,>4a4a              ; Crash flag set?
     6E2E 4A4A 
0316 6E30 1605  14         jne   runlia
0317 6E32 06A0  32         bl    @filv                 ; Clear 12K VDP memory instead
     6E34 226C 
0318 6E36 0000             data  >0000,>00,>3fff       ; of 16K, so that PABs survive
     6E38 0000 
     6E3A 3FFF 
0323 6E3C 06A0  32 runlia  bl    @filv
     6E3E 226C 
0324 6E40 0FC0             data  pctadr,spfclr,16      ; Load color table
     6E42 00F4 
     6E44 0010 
0325               *--------------------------------------------------------------
0326               * Check if there is a F18A present
0327               *--------------------------------------------------------------
0331 6E46 06A0  32         bl    @f18unl               ; Unlock the F18A
     6E48 26B0 
0332 6E4A 06A0  32         bl    @f18chk               ; Check if F18A is there
     6E4C 26CA 
0333 6E4E 06A0  32         bl    @f18lck               ; Lock the F18A again
     6E50 26C0 
0335               *--------------------------------------------------------------
...
0345               *--------------------------------------------------------------
0346 6E52 06A0  32 runlic  bl    @vidtab               ; Load video mode table into VDP
     6E54 22D6 
0347 6E56 21F4             data  spvmod                ; Equate selected video mode table
0348 6E58 0204  20         li    tmp0,spfont           ; Get font option
     6E5A 000C 
0349 6E5C 0544  14         inv   tmp0                  ; NOFONT (>FFFF) specified ?
0350 6E5E 1304  14         jeq   runlid                ; Yes, skip it
0351 6E60 06A0  32         bl    @ldfnt
     6E62 233E 
0352 6E64 1100             data  fntadr,spfont         ; Load specified font
     6E66 000C 
0353               *--------------------------------------------------------------
0354               * Did a system crash occur before runlib was called?
0355               *--------------------------------------------------------------
0356 6E68 0280  22 runlid  ci    r0,>4a4a              ; Crash flag set?
     6E6A 4A4A 
0357 6E6C 1602  14         jne   runlie                ; No, continue
0358 6E6E 0460  28         b     @cpu.crash.main       ; Yes, back to crash handler
     6E70 2090 
0359               *--------------------------------------------------------------
0360               * Branch to main program
0361               *--------------------------------------------------------------
0362 6E72 0262  22 runlie  ori   config,>0040          ; Enable kernel thread (bit 9 on)
     6E74 0040 
0363 6E76 0460  28         b     @main                 ; Give control to main program
     6E78 6050 
**** **** ****     > tivi_b0.asm.6386
0051               
0055 6E7A 2E18                   data $                ; Bank 0 ROM size OK.
0057               
0058               
0059               *--------------------------------------------------------------
0060               
