...
0008               ***************************************************************
0009               * File: stevie_b5.asm               ; Version 210909-57793
0010               *
0011               * Bank 5 "Jumbo"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210909-57793'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0046                       ;------------------------------------------------------
0047 2F06 DEAD             data >dead,>beef,>dead,>beef
     2F08 BEEF 
     2F0A DEAD 
     2F0C BEEF 
0049               ***************************************************************
...
0018 3459 ....             text  'Build: 210909-57793 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0079 6046 06A0  32         bl    @cpu.crash            ; Should never get here
     6048 2026 
0080                       ;-----------------------------------------------------------------------
0081                       ; Patterns
0082                       ;-----------------------------------------------------------------------
0083                       copy  "patterns.vdpdump.asm"
...
**** **** ****     > stevie_b5.asm.57793
0084                                                   ; Dump patterns to VDP
0085                       copy  "data.patterns.asm"   ; Pattern definitions sprites & chars
**** **** ****     > data.patterns.asm
...
0088                       ;-----------------------------------------------------------------------
0089                       copy  "rom.stubs.bank5.asm" ; Stubs for functions in other banks
**** **** ****     > rom.stubs.bank5.asm
