...
0008               ***************************************************************
0009               * File: stevie_b5.asm               ; Version 220227-1602410
0010               *
0011               * Bank 5 "Jumbo"
...
0270 21ED   42             text  'Build-ID  220227-1602410'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0030 32CC 600A                   data bankid           ; / i  p2 = Source ROM bank for return
0031               
...
0071 63AA 3732                   data txt.block.del    ; Display "Deleting block...."
0072                       ;------------------------------------------------------
...
0074 645C 06A0  32         bl    @cpym2m
     645E 24EE     
0075 6460 3A4E                   data txt.block.inside,tv.error.msg,53
     6462 A230     
     6464 0035     
0076               
...
0102 648E 3746                   data txt.block.copy   ; Display "Copying block...."
...
0108 6498 3758                   data txt.block.move   ; Display "Moving block...."
0109                       ;------------------------------------------------------
...
0094      3664     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
