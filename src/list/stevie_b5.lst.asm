...
0008               ***************************************************************
0009               * File: stevie_b5.asm               ; Version 211115-2041520
0010               *
0011               * Bank 5 "Jumbo"
...
0270 6231   42             text  'Build-ID  211115-2041520'
     6232 7569     
     6234 6C64     
     6236 2D49     
     6238 4420     
...
0037 617C 8820  54         c     @edb.block.m1,@w$ffff ; Marker M1 unset?
     617E A50C     
     6180 2022     
0038 6182 132B  14         jeq   edb.block.clip.exit   ; Yes, exit early
0039               
0040 6184 8820  54         c     @edb.block.m2,@w$ffff ; Marker M2 unset?
     6186 A50E     
     6188 2022     
0041 618A 1327  14         jeq   edb.block.clip.exit   ; Yes, exit early
0042               
0043 618C 8820  54         c     @edb.block.m1,@edb.block.m2
     618E A50C     
     6190 A50E     
0044                                                   ; M1 > M2 ?
0045 6192 1523  14         jgt   edb.block.clip.exit   ; Yes, exit early
0046                       ;------------------------------------------------------
0047                       ; Generate clipboard device/file name
0048                       ;------------------------------------------------------
0049 6194 06A0  32         bl    @cpym2m
     6196 24EE     
0050 6198 A56A                   data edb.clip.filename,heap.top,80
     619A F000     
     619C 0050     
0051               
...
0056                       ;------------------------------------------------------
0057 61A4 C120  34         mov   @edb.clip.filename,tmp0
     61A6 A56A     
...
0076 61D0 C820  54         mov   @edb.block.m2,@parm3  ; Last line to save (base 0) + 1
     61D2 A50E     
     61D4 A004     
0077 61D6 06A0  32         bl    @fm.savefile          ; Save DV80 file
     61D8 6302     
...
0084                       ; Exit
0085                       ;------------------------------------------------------
0086               edb.block.clip.exit:
0087 61DA C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0088 61DC C179  30         mov   *stack+,tmp1          ; Pop tmp1
0089 61DE C139  30         mov   *stack+,tmp0          ; Pop tmp0
0090 61E0 C2F9  30         mov   *stack+,r11           ; Pop R11
0091 61E2 045B  20         b     *r11                  ; Return to caller
                   < stevie_b5.asm.55995
...
0017 61E4 0649  14         dect  stack
0018 61E6 C64B  30         mov   r11,*stack            ; Push return address
0019 61E8 0649  14         dect  stack
0020 61EA C660  46         mov   @wyx,*stack           ; Push cursor position
     61EC 832A     
0021                       ;------------------------------------------------------
0022                       ; Clear markers
0023                       ;------------------------------------------------------
0024 61EE 0720  34         seto  @edb.block.m1         ; \ Remove markers M1 and M2
     61F0 A50C     
0025 61F2 0720  34         seto  @edb.block.m2         ; /
     61F4 A50E     
0026               
0027 61F6 0720  34         seto  @fb.colorize          ; Set colorize flag
     61F8 A310     
0028 61FA 0720  34         seto  @fb.dirty             ; Trigger refresh
     61FC A316     
0029 61FE 0720  34         seto  @fb.status.dirty      ; Trigger status lines update
     6200 A318     
0030                       ;------------------------------------------------------
0031                       ; Reload color scheme
0032                       ;------------------------------------------------------
0033 6202 0720  34         seto  @parm1
     6204 A000     
0034 6206 06A0  32         bl    @pane.action.colorscheme.load
     6208 6314     
...
0039                       ; Remove markers
0040                       ;------------------------------------------------------
0041 620A C820  54         mov   @tv.color,@parm1      ; Set normal color
     620C A218     
     620E A000     
0042 6210 06A0  32         bl    @pane.action.colorscheme.statlines
     6212 6326     
0043                                                   ; Set color combination for status lines
0044                                                   ; \ i  @parm1 = Color combination
0045                                                   ; /
0046               
0047 6214 06A0  32         bl    @hchar
     6216 27DC     
0048 6218 0034                   byte 0,52,32,18           ; Remove markers
     621A 2012     
0049 621C 1D00                   byte pane.botrow,0,32,55  ; Remove block shortcuts
     621E 2037     
0050 6220 FFFF                   data eol
0051                       ;------------------------------------------------------
0052                       ; Exit
0053                       ;------------------------------------------------------
0054               edb.block.reset.exit:
0055 6222 C839  50         mov   *stack+,@wyx          ; Pop cursor position
     6224 832A     
0056 6226 C2F9  30         mov   *stack+,r11           ; Pop r11
0057 6228 045B  20         b     *r11                  ; Return to caller
                   < stevie_b5.asm.55995
...
0030 622A 0649  14         dect  stack
0031 622C C64B  30         mov   r11,*stack            ; Save return address
0032 622E 0649  14         dect  stack
0033 6230 C644  30         mov   tmp0,*stack           ; Push tmp0
0034 6232 0649  14         dect  stack
0035 6234 C645  30         mov   tmp1,*stack           ; Push tmp1
0036 6236 0649  14         dect  stack
0037 6238 C646  30         mov   tmp2,*stack           ; Push tmp2
0038               
0039 623A 04E0  34         clr   @outparm1             ; No action (>0000)
     623C A010     
0040                       ;------------------------------------------------------
0041                       ; Asserts
0042                       ;------------------------------------------------------
0043 623E C120  34         mov   @edb.block.m1,tmp0    ; \
     6240 A50C     
0044 6242 0584  14         inc   tmp0                  ; | M1 unset?
0045 6244 133F  14         jeq   edb.block.delete.exit ; / Yes, exit early
0046               
0047 6246 C160  34         mov   @edb.block.m2,tmp1    ; \
     6248 A50E     
0048 624A 0584  14         inc   tmp0                  ; | M2 unset?
0049 624C 133B  14         jeq   edb.block.delete.exit ; / Yes, exit early
0050                       ;------------------------------------------------------
0051                       ; Check message to display
0052                       ;------------------------------------------------------
0053 624E C120  34         mov   @parm1,tmp0           ; Message flag cleared?
     6250 A000     
0054 6252 160E  14         jne   edb.block.delete.prep ; No, skip message display
0055                       ;------------------------------------------------------
0056                       ; Display "Deleting...."
0057                       ;------------------------------------------------------
0058 6254 C820  54         mov   @tv.busycolor,@parm1  ; Get busy color
     6256 A21C     
     6258 A000     
0059               
0060 625A 06A0  32         bl    @pane.action.colorscheme.statlines
     625C 6326     
0061                                                   ; Set color combination for status lines
0062                                                   ; \ i  @parm1 = Color combination
0063                                                   ; /
0064               
0065 625E 06A0  32         bl    @hchar
     6260 27DC     
0066 6262 1D00                   byte pane.botrow,0,32,55
     6264 2037     
0067 6266 FFFF                   data eol              ; Remove markers and block shortcuts
0068               
0069 6268 06A0  32         bl    @putat
     626A 2456     
0070 626C 1D00                   byte pane.botrow,0
0071 626E 3588                   data txt.block.del    ; Display "Deleting block...."
0072                       ;------------------------------------------------------
0073                       ; Prepare for delete
0074                       ;------------------------------------------------------
0075               edb.block.delete.prep:
0076 6270 C120  34         mov   @edb.block.m1,tmp0    ; Get M1
     6272 A50C     
0077 6274 0604  14         dec   tmp0                  ; Base 0
0078               
0079 6276 C160  34         mov   @edb.block.m2,tmp1    ; Get M2
     6278 A50E     
0080 627A 0605  14         dec   tmp1                  ; Base 0
0081               
0082 627C C804  38         mov   tmp0,@parm1           ; Delete line on M1
     627E A000     
0083 6280 C820  54         mov   @edb.lines,@parm2     ; Last line to reorganize
     6282 A504     
     6284 A002     
0084 6286 0620  34         dec   @parm2                ; Base 0
     6288 A002     
0085               
0086 628A C185  18         mov   tmp1,tmp2             ; \
0087 628C 6184  18         s     tmp0,tmp2             ; | Setup loop counter
0088 628E 0586  14         inc   tmp2                  ; /
0089                       ;------------------------------------------------------
0090                       ; Delete block
0091                       ;------------------------------------------------------
0092               edb.block.delete.loop:
0093 6290 06A0  32         bl    @idx.entry.delete     ; Reorganize index
     6292 62CC     
0094                                                   ; \ i  @parm1 = Line in editor buffer
0095                                                   ; / i  @parm2 = Last line for index reorg
0096               
0097 6294 0620  34         dec   @edb.lines            ; \ One line removed from editor buffer
     6296 A504     
0098 6298 0620  34         dec   @parm2                ; /
     629A A002     
0099               
0100 629C 0606  14         dec   tmp2
0101 629E 15F8  14         jgt   edb.block.delete.loop ; Next line
0102 62A0 0720  34         seto  @edb.dirty            ; Editor buffer dirty (text changed!)
     62A2 A506     
0103                       ;------------------------------------------------------
0104                       ; Set topline for framebuffer refresh
0105                       ;------------------------------------------------------
0106 62A4 8820  54         c     @fb.topline,@edb.lines
     62A6 A304     
     62A8 A504     
0107                                                   ; Beyond editor buffer?
0108 62AA 1504  14         jgt   !                     ; Yes, goto line 1
0109               
0110 62AC C820  54         mov   @fb.topline,@parm1    ; Set line to start with
     62AE A304     
     62B0 A000     
0111 62B2 1002  14         jmp   edb.block.delete.fb.refresh
0112 62B4 04E0  34 !       clr   @parm1                ; Set line to start with
     62B6 A000     
0113                       ;------------------------------------------------------
0114                       ; Refresh framebuffer and reset block markers
0115                       ;------------------------------------------------------
0116               edb.block.delete.fb.refresh:
0117 62B8 06A0  32         bl    @fb.refresh           ; \ Refresh frame buffer
     62BA 62DE     
0118                                                   ; | i  @parm1 = Line to start with
0119                                                   ; /             (becomes @fb.topline)
0120               
0121 62BC 06A0  32         bl    @edb.block.reset      ; Reset block markers M1/M2
     62BE 61E4     
0122               
0123 62C0 0720  34         seto  @outparm1             ; Delete completed
     62C2 A010     
0124                       ;------------------------------------------------------
0125                       ; Exit
0126                       ;------------------------------------------------------
0127               edb.block.delete.exit:
0128 62C4 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0129 62C6 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0130 62C8 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0131 62CA C2F9  30         mov   *stack+,r11           ; Pop R11
                   < stevie_b5.asm.55995
0068                       ;-----------------------------------------------------------------------
0069                       ; Stubs
0070                       ;-----------------------------------------------------------------------
...
0010 62CC 0649  14         dect  stack
0011 62CE C64B  30         mov   r11,*stack            ; Save return address
0012                       ;------------------------------------------------------
0013                       ; Call function in bank 1
0014                       ;------------------------------------------------------
0015 62D0 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     62D2 30A4     
0016 62D4 6002                   data bank1.rom        ; | i  p0 = bank address
0017 62D6 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0018 62D8 600A                   data bankid           ; / i  p2 = Source ROM bank for return
0019                       ;------------------------------------------------------
0020                       ; Exit
0021                       ;------------------------------------------------------
0022 62DA C2F9  30         mov   *stack+,r11           ; Pop r11
0023 62DC 045B  20         b     *r11                  ; Return to caller
0024               
0025               
0026               ***************************************************************
...
0029               ********|*****|*********************|**************************
0030               fb.refresh:
0031 62DE 0649  14         dect  stack
0032 62E0 C64B  30         mov   r11,*stack            ; Save return address
0033                       ;------------------------------------------------------
0034                       ; Call function in bank 1
0035                       ;------------------------------------------------------
0036 62E2 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     62E4 30A4     
0037 62E6 6002                   data bank1.rom        ; | i  p0 = bank address
0038 62E8 7FE6                   data vec.20           ; | i  p1 = Vector with target address
0039 62EA 600A                   data bankid           ; / i  p2 = Source ROM bank for return
0040                       ;------------------------------------------------------
0041                       ; Exit
0042                       ;------------------------------------------------------
0043 62EC C2F9  30         mov   *stack+,r11           ; Pop r11
0044 62EE 045B  20         b     *r11                  ; Return to caller
0045               
0046               
0047               ***************************************************************
...
0050               ********|*****|*********************|**************************
0051               fb.row2line:
0052 62F0 0649  14         dect  stack
0053 62F2 C64B  30         mov   r11,*stack            ; Save return address
0054                       ;------------------------------------------------------
0055                       ; Call function in bank 1
0056                       ;------------------------------------------------------
0057 62F4 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     62F6 30A4     
0058 62F8 6002                   data bank1.rom        ; | i  p0 = bank address
0059 62FA 7FEA                   data vec.22           ; | i  p1 = Vector with target address
0060 62FC 600A                   data bankid           ; / i  p2 = Source ROM bank for return
0061                       ;------------------------------------------------------
0062                       ; Exit
0063                       ;------------------------------------------------------
0064 62FE C2F9  30         mov   *stack+,r11           ; Pop r11
0065 6300 045B  20         b     *r11                  ; Return to caller
0066               
0067               
0068               ***************************************************************
...
0071               ********|*****|*********************|**************************
0072               fm.savefile:
0073 6302 0649  14         dect  stack
0074 6304 C64B  30         mov   r11,*stack            ; Save return address
0075                       ;------------------------------------------------------
0076                       ; Call function in bank 2
0077                       ;------------------------------------------------------
0078 6306 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6308 30A4     
0079 630A 6004                   data bank2.rom        ; | i  p0 = bank address
0080 630C 7FC6                   data vec.4            ; | i  p1 = Vector with target address
0081 630E 600A                   data bankid           ; / i  p2 = Source ROM bank for return
0082                       ;------------------------------------------------------
0083                       ; Exit
0084                       ;------------------------------------------------------
0085 6310 C2F9  30         mov   *stack+,r11           ; Pop r11
0086 6312 045B  20         b     *r11                  ; Return to caller
0087               
0088               
0089               ***************************************************************
...
0094 6314 0649  14         dect  stack
0095 6316 C64B  30         mov   r11,*stack            ; Save return address
0096                       ;------------------------------------------------------
0097                       ; Call function in bank 1
0098                       ;------------------------------------------------------
0099 6318 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     631A 30A4     
0100 631C 6002                   data bank1.rom        ; | i  p0 = bank address
0101 631E 7FFC                   data vec.31           ; | i  p1 = Vector with target address
0102 6320 600A                   data bankid           ; / i  p2 = Source ROM bank for return
0103                       ;------------------------------------------------------
0104                       ; Exit
0105                       ;------------------------------------------------------
0106 6322 C2F9  30         mov   *stack+,r11           ; Pop r11
0107 6324 045B  20         b     *r11                  ; Return to caller
0108               
0109               
0110               ***************************************************************
...
0115 6326 0649  14         dect  stack
0116 6328 C64B  30         mov   r11,*stack            ; Save return address
0117                       ;------------------------------------------------------
0118                       ; Call function in bank 1
0119                       ;------------------------------------------------------
0120 632A 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     632C 30A4     
0121 632E 6002                   data bank1.rom        ; | i  p0 = bank address
0122 6330 7FFE                   data vec.32           ; | i  p1 = Vector with target address
0123 6332 600A                   data bankid           ; / i  p2 = Source ROM bank for return
0124                       ;------------------------------------------------------
0125                       ; Exit
0126                       ;------------------------------------------------------
0127 6334 C2F9  30         mov   *stack+,r11           ; Pop r11
0128 6336 045B  20         b     *r11                  ; Return to caller
                   < stevie_b5.asm.55995
0072                       ;-----------------------------------------------------------------------
...
0080                       ;-----------------------------------------------------------------------
0081               cpu.crash.showbank:
0082                       aorg >7fb0
0083 7FB0 06A0  32         bl    @putat
     7FB2 2456     
0084 7FB4 0314                   byte 3,20
0085 7FB6 7FBA                   data cpu.crash.showbank.bankstr
0086 7FB8 10FF  14         jmp   $
0087               cpu.crash.showbank.bankstr:
0088               
0089 7FBA 05               byte  5
0090 7FBB   52             text  'ROM#5'
     7FBC 4F4D     
     7FBE 2335     
0091                       even
0092               
...
0095                       ;-----------------------------------------------------------------------
0096                       aorg  >7fc0
0097                       copy  "rom.vectors.bank5.asm"
...
0013 7FCC 61E4     vec.7   data  edb.block.reset       ;
...
0105      346E     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
