...
0008               ***************************************************************
0009               * File: stevie_b5.asm               ; Version 211113-2120310
0010               *
0011               * Bank 5 "Jumbo"
...
0270 6231   42             text  'Build-ID  211113-2120310'
     6232 7569     
     6234 6C64     
     6236 2D49     
     6238 4420     
...
0008               ********|*****|*********************|**************************
0009               fb.refresh:
0010 61E4 0649  14         dect  stack
0011 61E6 C64B  30         mov   r11,*stack            ; Save return address
0012                       ;------------------------------------------------------
0013                       ; Call function in bank 1
0014                       ;------------------------------------------------------
0015 61E8 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     61EA 30A4     
0016 61EC 6002                   data bank1.rom        ; | i  p0 = bank address
0017 61EE 7FE6                   data vec.20           ; | i  p1 = Vector with target address
0018 61F0 600A                   data bankid           ; / i  p2 = Source ROM bank for return
0019                       ;------------------------------------------------------
0020                       ; Exit
0021                       ;------------------------------------------------------
0022 61F2 C2F9  30         mov   *stack+,r11           ; Pop r11
0023 61F4 045B  20         b     *r11                  ; Return to caller
0024               
0025               
0026               ***************************************************************
...
0029               ********|*****|*********************|**************************
0030               fb.row2line:
0031 61F6 0649  14         dect  stack
0032 61F8 C64B  30         mov   r11,*stack            ; Save return address
0033                       ;------------------------------------------------------
0034                       ; Call function in bank 1
0035                       ;------------------------------------------------------
0036 61FA 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     61FC 30A4     
0037 61FE 6002                   data bank1.rom        ; | i  p0 = bank address
0038 6200 7FEA                   data vec.22           ; | i  p1 = Vector with target address
0039 6202 600A                   data bankid           ; / i  p2 = Source ROM bank for return
0040                       ;------------------------------------------------------
0041                       ; Exit
0042                       ;------------------------------------------------------
0043 6204 C2F9  30         mov   *stack+,r11           ; Pop r11
0044 6206 045B  20         b     *r11                  ; Return to caller
0045               
0046               
0047               ***************************************************************
...
0050               ********|*****|*********************|**************************
0051               fm.savefile:
0052 6208 0649  14         dect  stack
0053 620A C64B  30         mov   r11,*stack            ; Save return address
0054                       ;------------------------------------------------------
0055                       ; Call function in bank 2
0056                       ;------------------------------------------------------
0057 620C 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     620E 30A4     
0058 6210 6004                   data bank2.rom        ; | i  p0 = bank address
0059 6212 7FC6                   data vec.4            ; | i  p1 = Vector with target address
0060 6214 600A                   data bankid           ; / i  p2 = Source ROM bank for return
0061                       ;------------------------------------------------------
0062                       ; Exit
0063                       ;------------------------------------------------------
0064 6216 C2F9  30         mov   *stack+,r11           ; Pop r11
0065 6218 045B  20         b     *r11                  ; Return to caller
                   < stevie_b5.asm.80437
0070                       ;-----------------------------------------------------------------------
...
0093                       ;-----------------------------------------------------------------------
0094                       aorg  >7fc0
0095                       copy  "rom.vectors.bank5.asm"
