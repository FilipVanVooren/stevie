...
0008               ***************************************************************
0009               * File: stevie_b5.asm               ; Version 220107-1656030
0010               *
0011               * Bank 5 "Jumbo"
...
0270 21ED   42             text  'Build-ID  220107-1656030'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0030 33B8 600A                   data bankid           ; / i  p2 = Source ROM bank for return
0031               
...
0071 63F0 37D8                   data txt.block.del    ; Display "Deleting block...."
0072                       ;------------------------------------------------------
...
0074 64A2 06A0  32         bl    @cpym2m
     64A4 24EE     
0075 64A6 3A6A                   data txt.block.inside,tv.error.msg,53
     64A8 A22E     
     64AA 0035     
0076               
...
0102 64D4 37EC                   data txt.block.copy   ; Display "Copying block...."
...
0108 64DE 37FE                   data txt.block.move   ; Display "Moving block...."
0109                       ;------------------------------------------------------
...
0108      370A     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
