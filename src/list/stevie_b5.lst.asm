...
0008               ***************************************************************
0009               * File: stevie_b5.asm               ; Version 211012-10275
0010               *
0011               * Bank 5 "Jumbo"
0012               *
0013               ***************************************************************
...
0255 61FB   53             text  'Source    stevie_b5.lst.asm'
     61FC 6F75     
     61FE 7263     
     6200 6520     
     6202 2020     
...
0259 6216 16               byte  22
0260 6217   42             text  'Build-ID  211012-10275'
     6218 7569     
     621A 6C64     
     621C 2D49     
     621E 4420     
...
0101 6984 FF00     kbsmal  data  >ff00,>0000,>ff0d,>203D
     ...
     6988 FF0D     
     698A 203D     
0102 698C 7877             text  'xws29ol.'
     698E 7332     
     6990 396F     
     6992 6C2E     
0103 6994 6365             text  'ced38ik,'
     6996 6433     
     6998 3869     
     699A 6B2C     
0104 699C 7672             text  'vrf47ujm'
     699E 6634     
     69A0 3775     
     69A2 6A6D     
0105 69A4 6274             text  'btg56yhn'
     69A6 6735     
     69A8 3679     
     69AA 686E     
0106 69AC 7A71             text  'zqa10p;/'
     69AE 6131     
     69B0 3070     
     69B2 3B2F     
0107 69B4 FF00     kbshft  data  >ff00,>0000,>ff0d,>202B
     ...
     69B8 FF0D     
     69BA 202B     
0108 69BC 5857             text  'XWS@(OL>'
     69BE 5340     
     69C0 284F     
     69C2 4C3E     
0109 69C4 4345             text  'CED#*IK<'
     69C6 4423     
     69C8 2A49     
     69CA 4B3C     
0110 69CC 5652             text  'VRF$&UJM'
     69CE 4624     
     69D0 2655     
     69D2 4A4D     
0111 69D4 4254             text  'BTG%^YHN'
     69D6 4725     
     69D8 5E59     
     69DA 484E     
0112 69DC 5A51             text  'ZQA!)P:-'
     69DE 4121     
     69E0 2950     
     69E2 3A2D     
...
0365                                                   ; a @blwp @dsrlnk
0366 6E4C 2E       dsrlnk.period     text  '.'         ; For finding end of device name
0367               
0368                       even
                   < runlib.asm
...
0049               ********|*****|*********************|**************************
0050               idx.init:
0051 71BE 0649  14         dect  stack
0052 71C0 C64B  30         mov   r11,*stack            ; Save return address
0053 71C2 0649  14         dect  stack
0054 71C4 C644  30         mov   tmp0,*stack           ; Push tmp0
0055                       ;------------------------------------------------------
0056                       ; Initialize
0057                       ;------------------------------------------------------
0058 71C6 0204  20         li    tmp0,idx.top
     71C8 B000     
0059 71CA C804  38         mov   tmp0,@edb.index.ptr   ; Set pointer to index in editor structure
     71CC A502     
0060               
0061 71CE C120  34         mov   @tv.sams.b000,tmp0
     71D0 A206     
0062 71D2 C804  38         mov   tmp0,@idx.sams.page   ; Set current SAMS page
     71D4 A600     
0063 71D6 C804  38         mov   tmp0,@idx.sams.lopage ; Set 1st SAMS page
     71D8 A602     
0064                       ;------------------------------------------------------
0065                       ; Clear all index pages
0066                       ;------------------------------------------------------
0067 71DA 0224  22         ai    tmp0,4                ; \ Let's clear all index pages
     71DC 0004     
0068 71DE C804  38         mov   tmp0,@idx.sams.hipage ; /
     71E0 A604     
0069               
0070 71E2 06A0  32         bl    @_idx.sams.mapcolumn.on
     71E4 31BC     
0071                                                   ; Index in continuous memory region
0072               
0073 71E6 06A0  32         bl    @film
     71E8 222E     
0074 71EA B000                   data idx.top,>00,idx.size * 5
     71EC 0000     
     71EE 5000     
0075                                                   ; Clear index
0076               
0077 71F0 06A0  32         bl    @_idx.sams.mapcolumn.off
     71F2 31F0     
0078                                                   ; Restore memory window layout
0079               
0080 71F4 C820  54         mov   @idx.sams.lopage,@idx.sams.hipage
     71F6 A602     
     71F8 A604     
...
0084                       ;------------------------------------------------------
0085               idx.init.exit:
0086 71FA C139  30         mov   *stack+,tmp0          ; Pop tmp0
0087 71FC C2F9  30         mov   *stack+,r11           ; Pop r11
0088 71FE 045B  20         b     *r11                  ; Return to caller
0089               
0090               
0091               ***************************************************************
...
0101 7200 0649  14         dect  stack
0102 7202 C64B  30         mov   r11,*stack            ; Push return address
0103 7204 0649  14         dect  stack
0104 7206 C644  30         mov   tmp0,*stack           ; Push tmp0
0105 7208 0649  14         dect  stack
0106 720A C645  30         mov   tmp1,*stack           ; Push tmp1
0107 720C 0649  14         dect  stack
0108 720E C646  30         mov   tmp2,*stack           ; Push tmp2
0109               *--------------------------------------------------------------
0110               * Map index pages into memory window  (b000-ffff)
0111               *--------------------------------------------------------------
0112 7210 C120  34         mov   @idx.sams.lopage,tmp0 ; Get lowest index page
     7212 A602     
0113 7214 0205  20         li    tmp1,idx.top
     7216 B000     
0114 7218 0206  20         li    tmp2,5                ; Set loop counter. all pages of index
     721A 0005     
0115                       ;-------------------------------------------------------
0116                       ; Loop over banks
0117                       ;-------------------------------------------------------
0118 721C 06A0  32 !       bl    @xsams.page.set       ; Set SAMS page
     721E 256E     
0119                                                   ; \ i  tmp0  = SAMS page number
0120                                                   ; / i  tmp1  = Memory address
0121               
0122 7220 0584  14         inc   tmp0                  ; Next SAMS index page
0123 7222 0225  22         ai    tmp1,>1000            ; Next memory region
     7224 1000     
0124 7226 0606  14         dec   tmp2                  ; Update loop counter
0125 7228 15F9  14         jgt   -!                    ; Next iteration
0126               *--------------------------------------------------------------
0127               * Exit
0128               *--------------------------------------------------------------
0129               _idx.sams.mapcolumn.on.exit:
0130 722A C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0131 722C C179  30         mov   *stack+,tmp1          ; Pop tmp1
0132 722E C139  30         mov   *stack+,tmp0          ; Pop tmp0
0133 7230 C2F9  30         mov   *stack+,r11           ; Pop return address
0134 7232 045B  20         b     *r11                  ; Return to caller
0135               
0136               
0137               ***************************************************************
...
0150 7234 0649  14         dect  stack
0151 7236 C64B  30         mov   r11,*stack            ; Push return address
0152 7238 0649  14         dect  stack
0153 723A C644  30         mov   tmp0,*stack           ; Push tmp0
0154 723C 0649  14         dect  stack
0155 723E C645  30         mov   tmp1,*stack           ; Push tmp1
0156 7240 0649  14         dect  stack
0157 7242 C646  30         mov   tmp2,*stack           ; Push tmp2
0158 7244 0649  14         dect  stack
0159 7246 C647  30         mov   tmp3,*stack           ; Push tmp3
0160               *--------------------------------------------------------------
0161               * Map index pages into memory window  (b000-????)
0162               *--------------------------------------------------------------
0163 7248 0205  20         li    tmp1,idx.top
     724A B000     
0164 724C 0206  20         li    tmp2,5                ; Always 5 pages
     724E 0005     
0165 7250 0207  20         li    tmp3,tv.sams.b000     ; Pointer to fist SAMS page
     7252 A206     
0166                       ;-------------------------------------------------------
0167                       ; Loop over table in memory (@tv.sams.b000:@tv.sams.f000)
0168                       ;-------------------------------------------------------
0169 7254 C137  30 !       mov   *tmp3+,tmp0           ; Get SAMS page
0170               
0171 7256 06A0  32         bl    @xsams.page.set       ; Set SAMS page
     7258 256E     
0172                                                   ; \ i  tmp0  = SAMS page number
0173                                                   ; / i  tmp1  = Memory address
0174               
0175 725A 0225  22         ai    tmp1,>1000            ; Next memory region
     725C 1000     
0176 725E 0606  14         dec   tmp2                  ; Update loop counter
0177 7260 15F9  14         jgt   -!                    ; Next iteration
0178               *--------------------------------------------------------------
0179               * Exit
0180               *--------------------------------------------------------------
0181               _idx.sams.mapcolumn.off.exit:
0182 7262 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0183 7264 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0184 7266 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0185 7268 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0186 726A C2F9  30         mov   *stack+,r11           ; Pop return address
0187 726C 045B  20         b     *r11                  ; Return to caller
0188               
0189               
0190               
0191               ***************************************************************
...
0211 726E 0649  14         dect  stack
0212 7270 C64B  30         mov   r11,*stack            ; Save return address
0213 7272 0649  14         dect  stack
0214 7274 C644  30         mov   tmp0,*stack           ; Push tmp0
0215 7276 0649  14         dect  stack
0216 7278 C645  30         mov   tmp1,*stack           ; Push tmp1
0217 727A 0649  14         dect  stack
0218 727C C646  30         mov   tmp2,*stack           ; Push tmp2
0219                       ;------------------------------------------------------
0220                       ; Determine SAMS index page
0221                       ;------------------------------------------------------
0222 727E C184  18         mov   tmp0,tmp2             ; Line number
0223 7280 04C5  14         clr   tmp1                  ; MSW (tmp1) = 0 / LSW (tmp2) = Line number
0224 7282 0204  20         li    tmp0,2048             ; Index entries in 4K SAMS page
     7284 0800     
0225               
0226 7286 3D44 128         div   tmp0,tmp1             ; \ Divide 32 bit value by 2048
0227                                                   ; | tmp1 = quotient  (SAMS page offset)
0228                                                   ; / tmp2 = remainder
0229               
0230 7288 0A16  56         sla   tmp2,1                ; line number * 2
0231 728A C806  38         mov   tmp2,@outparm1        ; Offset index entry
     728C A010     
0232               
0233 728E A160  34         a     @idx.sams.lopage,tmp1 ; Add SAMS page base
     7290 A602     
0234 7292 8805  38         c     tmp1,@idx.sams.page   ; Page already active?
     7294 A600     
0235               
0236 7296 130E  14         jeq   _idx.samspage.get.exit
0237                                                   ; Yes, so exit
0238                       ;------------------------------------------------------
0239                       ; Activate SAMS index page
0240                       ;------------------------------------------------------
0241 7298 C805  38         mov   tmp1,@idx.sams.page   ; Set current SAMS page
     729A A600     
0242 729C C805  38         mov   tmp1,@tv.sams.b000    ; Also keep SAMS window synced in Stevie
     729E A206     
0243               
0244 72A0 C105  18         mov   tmp1,tmp0             ; Destination SAMS page
0245 72A2 0205  20         li    tmp1,>b000            ; Memory window for index page
     72A4 B000     
0246               
0247 72A6 06A0  32         bl    @xsams.page.set       ; Switch to SAMS page
     72A8 256E     
...
0252                       ;------------------------------------------------------
0253 72AA 8804  38         c     tmp0,@idx.sams.hipage ; New highest page?
     72AC A604     
0254 72AE 1202  14         jle   _idx.samspage.get.exit
0255                                                   ; No, exit
0256 72B0 C804  38         mov   tmp0,@idx.sams.hipage ; Yes, set highest SAMS index page
     72B2 A604     
0257                       ;------------------------------------------------------
0258                       ; Exit
0259                       ;------------------------------------------------------
0260               _idx.samspage.get.exit:
0261 72B4 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0262 72B6 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0263 72B8 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0264 72BA C2F9  30         mov   *stack+,r11           ; Pop r11
0265 72BC 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0030 73B4 30                     byte 48               ; | i p2H = Offset for ASCII digit 0
0031 73B5   20                   byte 32               ; / i p2L = Char for replacing leading 0's
0032               
...
0105 74A8 A000             data  >a000,>000a           ; >a000-afff, SAMS page >0a
     74AA 000A     
0106 74AC B000             data  >b000,>0020           ; >b000-bfff, SAMS page >20
     74AE 0020     
0107                                                   ;   Index can allocate
0108                                                   ;   pages >20 to >3f.
0109 74B0 C000             data  >c000,>0040           ; >c000-cfff, SAMS page >40
     74B2 0040     
0110                                                   ;   Editor buffer can allocate
0111                                                   ;   pages >40 to >ff.
0112 74B4 D000             data  >d000,>000d           ; >d000-dfff, SAMS page >0d
     74B6 000D     
0113 74B8 E000             data  >e000,>000e           ; >e000-efff, SAMS page >0e
     74BA 000E     
0114 74BC F000             data  >f000,>000f           ; >f000-ffff, SAMS page >0f
     74BE 000F     
0115               
0116               
0117               ***************************************************************
...
0121 74C0 2000             data  >2000,>0002           ; >2000-2fff, SAMS page >02
     74C2 0002     
0122 74C4 3000             data  >3000,>0003           ; >3000-3fff, SAMS page >03
     74C6 0003     
0123 74C8 A000             data  >a000,>000a           ; >a000-afff, SAMS page >0a
     74CA 000A     
0124 74CC B000             data  >b000,>0030           ; >b000-bfff, SAMS page >30
     74CE 0030     
0125 74D0 C000             data  >c000,>0031           ; >c000-cfff, SAMS page >31
     74D2 0031     
0126 74D4 D000             data  >d000,>0032           ; >d000-dfff, SAMS page >32
     74D6 0032     
0127 74D8 E000             data  >e000,>0033           ; >e000-efff, SAMS page >33
     74DA 0033     
0128 74DC F000             data  >f000,>0034           ; >f000-ffff, SAMS page >34
     74DE 0034     
0129               
0130               
0131               ***************************************************************
...
0135 74E0 2000             data  >2000,>0002           ; >2000-2fff, SAMS page >02
     74E2 0002     
0136 74E4 3000             data  >3000,>0003           ; >3000-3fff, SAMS page >03
     74E6 0003     
0137 74E8 A000             data  >a000,>000a           ; >a000-afff, SAMS page >0a
     74EA 000A     
0138 74EC B000             data  >b000,>0004           ; >b000-bfff, SAMS page >04
     74EE 0004     
0139 74F0 C000             data  >c000,>0005           ; >c000-cfff, SAMS page >05
     74F2 0005     
0140 74F4 D000             data  >d000,>0006           ; >d000-dfff, SAMS page >06
     74F6 0006     
0141 74F8 E000             data  >e000,>0007           ; >e000-efff, SAMS page >07
     74FA 0007     
0142 74FC F000             data  >f000,>0008           ; >f000-ffff, SAMS page >08
     74FE 0008     
0143               
0144               
0145               
...
0196 7500 F417             data  >f417,>f171,>1b1f,>71b1 ; 1  White on blue with cyan touch
     7502 F171     
     7504 1B1F     
     7506 71B1     
0197 7508 A11A             data  >a11a,>f0ff,>1f1a,>f1ff ; 2  Dark yellow on black
     750A F0FF     
     750C 1F1A     
     750E F1FF     
0198 7510 2112             data  >2112,>f0ff,>1f12,>f1f6 ; 3  Dark green on black
     7512 F0FF     
     7514 1F12     
     7516 F1F6     
0199 7518 F41F             data  >f41f,>1e11,>1a17,>1e11 ; 4  White on blue
     751A 1E11     
     751C 1A17     
     751E 1E11     
0200 7520 E11E             data  >e11e,>e1ff,>1f1e,>e1ff ; 5  Grey on black
     7522 E1FF     
     7524 1F1E     
     7526 E1FF     
0201 7528 1771             data  >1771,>1016,>1b71,>1711 ; 6  Black on cyan
     752A 1016     
     752C 1B71     
     752E 1711     
0202 7530 1FF1             data  >1ff1,>1011,>f1f1,>1f11 ; 7  Black on white
     7532 1011     
     7534 F1F1     
     7536 1F11     
0203 7538 1AF1             data  >1af1,>a1ff,>1f1f,>f11f ; 8  Black on dark yellow
     753A A1FF     
     753C 1F1F     
     753E F11F     
0204 7540 21F0             data  >21f0,>12ff,>1b12,>12ff ; 9  Dark green on black
     7542 12FF     
     7544 1B12     
     7546 12FF     
0205 7548 F5F1             data  >f5f1,>e1ff,>1b1f,>f131 ; 10 White on light blue
     754A E1FF     
     754C 1B1F     
     754E F131     
0206                       even
0207               
0208               tv.tabs.table:
0209 7550 0007             byte  0,7,12,25               ; \   Default tab positions as used
     7552 0C19     
0210 7554 1E2D             byte  30,45,59,79             ; |   in Editor/Assembler module.
     7556 3B4F     
0211 7558 FF00             byte  >ff,0,0,0               ; |
     755A 0000     
0212 755C 0000             byte  0,0,0,0                 ; |   Up to 20 positions supported.
     755E 0000     
0213 7560 0000             byte  0,0,0,0                 ; /   >ff means end-of-list.
     7562 0000     
0214                       even
                   < ram.resident.asm
...
0018               txt.ovrwrite
0019 756C 03               byte  3
0020 756D   4F             text  'OVR'
     756E 5652     
0021                       even
0022               
0023               txt.insert
0024 7570 03               byte  3
0025 7571   49             text  'INS'
     7572 4E53     
0026                       even
0027               
0028               txt.star
...
0032               
0033               txt.loading
0034 7576 0A               byte  10
0035 7577   4C             text  'Loading...'
     7578 6F61     
     757A 6469     
     757C 6E67     
     757E 2E2E     
...
0037               
0038               txt.saving
0039 7582 0A               byte  10
0040 7583   53             text  'Saving....'
     7584 6176     
     7586 696E     
     7588 672E     
     758A 2E2E     
...
0042               
0043               txt.block.del
0044 758E 12               byte  18
0045 758F   44             text  'Deleting block....'
     7590 656C     
     7592 6574     
     7594 696E     
     7596 6720     
...
0047               
0048               txt.block.copy
0049 75A2 11               byte  17
0050 75A3   43             text  'Copying block....'
     75A4 6F70     
     75A6 7969     
     75A8 6E67     
     75AA 2062     
...
0052               
0053               txt.block.move
0054 75B4 10               byte  16
0055 75B5   4D             text  'Moving block....'
     75B6 6F76     
     75B8 696E     
     75BA 6720     
     75BC 626C     
...
0057               
0058               txt.block.save
0059 75C6 1D               byte  29
0060 75C7   53             text  'Saving block to DV80 file....'
     75C8 6176     
     75CA 696E     
     75CC 6720     
     75CE 626C     
...
0068               txt.kb
0069 75EE 02               byte  2
0070 75EF   6B             text  'kb'
     75F0 62       
0071                       even
0072               
0073               txt.lines
0074 75F2 05               byte  5
0075 75F3   4C             text  'Lines'
     75F4 696E     
     75F6 6573     
0076                       even
0077               
0078               txt.newfile
0079 75F8 0A               byte  10
0080 75F9   5B             text  '[New file]'
     75FA 4E65     
     75FC 7720     
     75FE 6669     
     7600 6C65     
...
0088               txt.m1
0089 760A 03               byte  3
0090 760B   4D             text  'M1='
     760C 313D     
0091                       even
0092               
0093               txt.m2
0094 760E 03               byte  3
0095 760F   4D             text  'M2='
     7610 323D     
0096                       even
0097               
0098               txt.keys.default
0099 7612 07               byte  7
0100 7613   46             text  'F9-Menu'
     7614 392D     
     7616 4D65     
     7618 6E75     
0101                       even
0102               
0103               txt.keys.block
0104 761A 2C               byte  44
0105 761B   46             text  'F9-Back  ^Copy  ^Move  ^Del  ^Save  ^Goto-M1'
     761C 392D     
     761E 4261     
     7620 636B     
     7622 2020     
...
0106                       even
0107               
0108 7648 2E2E     txt.ruler          text    '.........'
     764A 2E2E     
     764C 2E2E     
     764E 2E2E     
     7650 2E       
0109 7651   12                        byte    18
0110 7652 2E2E                        text    '.........'
     7654 2E2E     
     7656 2E2E     
     7658 2E2E     
     765A 2E       
0111 765B   13                        byte    19
0112 765C 2E2E                        text    '.........'
     765E 2E2E     
     7660 2E2E     
     7662 2E2E     
     7664 2E       
0113 7665   14                        byte    20
0114 7666 2E2E                        text    '.........'
     7668 2E2E     
     766A 2E2E     
     766C 2E2E     
     766E 2E       
0115 766F   15                        byte    21
0116 7670 2E2E                        text    '.........'
     7672 2E2E     
     7674 2E2E     
     7676 2E2E     
     7678 2E       
0117 7679   16                        byte    22
0118 767A 2E2E                        text    '.........'
     767C 2E2E     
     767E 2E2E     
     7680 2E2E     
     7682 2E       
0119 7683   17                        byte    23
0120 7684 2E2E                        text    '.........'
     7686 2E2E     
     7688 2E2E     
     768A 2E2E     
     768C 2E       
0121 768D   18                        byte    24
0122 768E 2E2E                        text    '.........'
     7690 2E2E     
     7692 2E2E     
     7694 2E2E     
     7696 2E       
0123 7697   19                        byte    25
0124                                  even
0125 7698 020E     txt.alpha.down     data >020e,>0f00
     769A 0F00     
0126 769C 0110     txt.vertline       data >0110
0127 769E 011C     txt.keymarker      byte 1,28
0128               
0129               txt.ws1
0130 76A0 01               byte  1
0131 76A1   20             text  ' '
...
0152                       even
0153               
0154      3666     txt.filetype.none  equ txt.ws4
0155               
0156               
0157               ;--------------------------------------------------------------
...
0159               ;--------------------------------------------------------------
0160               txt.ioerr.load
0161 76B6 20               byte  32
0162 76B7   49             text  'I/O error. Failed loading file: '
     76B8 2F4F     
     76BA 2065     
     76BC 7272     
     76BE 6F72     
...
0164               
0165               txt.ioerr.save
0166 76D8 20               byte  32
0167 76D9   49             text  'I/O error. Failed saving file:  '
     76DA 2F4F     
     76DC 2065     
     76DE 7272     
     76E0 6F72     
...
0171 76FA 40               byte  64
0172 76FB   49             text  'Index memory full. Could not fully load file into editor buffer.'
     76FC 6E64     
     76FE 6578     
     7700 206D     
     7702 656D     
...
0174               
0175               txt.io.nofile
0176 773C 21               byte  33
0177 773D   49             text  'I/O error. No filename specified.'
     773E 2F4F     
     7740 2065     
     7742 7272     
     7744 6F72     
...
0181 775E 34               byte  52
0182 775F   45             text  'Error. Copy/Move target must be outside block M1-M2.'
     7760 7272     
     7762 6F72     
     7764 2E20     
     7766 436F     
...
0195 7796 0D               byte  13
0196 7797   43             text  'Color scheme:'
     7798 6F6C     
     779A 6F72     
     779C 2073     
     779E 6368     
...
0046                       ;------------------------------------------------------
0047 77A4 04E0  34         clr   @bank1.rom            ; Activate bank 1 "James" ROM
     77A6 6002     
0048               
0052               
0053 77A8 0460  28         b     @kickstart.code2      ; Jump to entry routine
     77AA 6046     
0054               ***************************************************************
...
0088      3430     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
