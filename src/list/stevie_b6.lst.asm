...
0008               ***************************************************************
0009               * File: stevie_b6.asm               ; Version 220430-2036510
0010               *
0011               * Bank 6 "Jenifer"
...
0022               * BANK 6
0023               ********|*****|*********************|**************************
0024      600C     bankid  equ   bank6.rom             ; Set bank identifier to current bank
0025                       aorg  >6000
...
0270 21ED   42             text  'Build-ID  220430-2036510'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0030 32C0 600C                   data bankid           ; / i  p2 = Source ROM bank for return
0031               
...
0057                       ; Patterns
0058                       ;-----------------------------------------------------------------------
0059                       copy  "patterns.vdpdump.asm"
...
0025 6064 045B  20         b     *r11                  ; Return to task
                   < stevie_b6.asm.25214
0060                                                   ; Dump patterns to VDP
0061                       copy  "data.patterns.asm"   ; Pattern definitions sprites & chars
     **** ****     > data.patterns.asm
...
0064                       ; Stubs
0065                       ;-----------------------------------------------------------------------
0066                       copy  "rom.stubs.bank6.asm" ; Bank specific stubs
     **** ****     > rom.stubs.bank6.asm
...
0083                       ; Vector table
0084                       ;-----------------------------------------------------------------------
0085                       copy  "rom.vectors.bank6.asm"
