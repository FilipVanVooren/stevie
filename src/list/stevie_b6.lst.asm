...
0008               ***************************************************************
0009               * File: stevie_b6.asm               ; Version 220226-2020500
0010               *
0011               * Bank 6 "Jenifer"
...
0270 21ED   42             text  'Build-ID  220226-2020500'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0030 328A 600C                   data bankid           ; / i  p2 = Source ROM bank for return
0031               
...
0081                       ; Vector table
0082                       ;-----------------------------------------------------------------------
0083                       copy  "rom.vectors.bank6.asm"
...
0018               
0019 7FC0 604A     vec.1   data  vdp.patterns.dump     ; Dump sprite/character patterns to VDP
...
0090      3622     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
