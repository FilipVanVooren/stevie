...
0008               ***************************************************************
0009               * File: stevie_b6.asm               ; Version 220106-2127440
0010               *
0011               * Bank 6 "Jenifer"
...
0270 21ED   42             text  'Build-ID  220106-2127440'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0030 3374 600C                   data bankid           ; / i  p2 = Source ROM bank for return
0031               
...
0103      36C6     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
