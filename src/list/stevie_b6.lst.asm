...
0008               ***************************************************************
0009               * File: stevie_b6.asm               ; Version 211229-1853120
0010               *
0011               * Bank 6 "Jenifer"
...
0270 21ED   42             text  'Build-ID  211229-1853120'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0031 338E 600C                   data bankid           ; / i  p2 = Source ROM bank for return
0032               
...
0103      3626     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
