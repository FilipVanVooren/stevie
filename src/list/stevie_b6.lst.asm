...
0008               ***************************************************************
0009               * File: stevie_b6.asm               ; Version 210909-58200
0010               *
0011               * Bank 6 "Jenifer"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210909-58200'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0018 3459 ....             text  'Build: 210909-58200 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0082                       ;-----------------------------------------------------------------------
0083                       copy  "rom.stubs.bank6.asm" ; Stubs for functions in other banks
**** **** ****     > rom.stubs.bank6.asm
...
0102      33B0     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
