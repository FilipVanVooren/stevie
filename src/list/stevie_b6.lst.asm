...
0008               ***************************************************************
0009               * File: stevie_b6.asm               ; Version 220430-2019410
0010               *
0011               * Bank 6 "Jenifer"
...
0021               * BANK 6
0022               ********|*****|*********************|**************************
0023      600C     bankid  equ   bank6.rom             ; Set bank identifier to current bank
0024                       aorg  >6000
...
0270 21ED   42             text  'Build-ID  220430-2019410'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0056                       ; Patterns
0057                       ;-----------------------------------------------------------------------
0058                       copy  "patterns.vdpdump.asm"
...
0025 6064 045B  20         b     *r11                  ; Return to task
                   < stevie_b6.asm.19546
0059                                                   ; Dump patterns to VDP
0060                       copy  "data.patterns.asm"   ; Pattern definitions sprites & chars
     **** ****     > data.patterns.asm
...
0063                       ; Stubs
0064                       ;-----------------------------------------------------------------------
0065                       copy  "rom.stubs.bank6.asm" ; Bank specific stubs
     **** ****     > rom.stubs.bank6.asm
...
0082                       ; Vector table
0083                       ;-----------------------------------------------------------------------
0084                       copy  "rom.vectors.bank6.asm"
...
0050 7FFE 2026     vec.32  data  cpu.crash             ;
                   < stevie_b6.asm.19546
0085                                                   ; Vector table bank 6
0086               *--------------------------------------------------------------
0087               * Video mode configuration
0088               *--------------------------------------------------------------
0089      00F4     spfclr  equ   >f4                   ; Foreground/Background color for font.
0090      0004     spfbck  equ   >04                   ; Screen background color.
0091      3650     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
0092      000C     spfont  equ   fnopt3                ; Font to load. See LDFONT for details.
0093      0050     colrow  equ   80                    ; Columns per row
0094      0FC0     pctadr  equ   >0fc0                 ; VDP color table base
0095      1100     fntadr  equ   >1100                 ; VDP font start address (in PDT range)
0096      2180     sprsat  equ   >2180                 ; VDP sprite attribute table
0097      2800     sprpdt  equ   >2800                 ; VDP sprite pattern table
