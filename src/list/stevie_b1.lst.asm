...
0008               ***************************************************************
0009               * File: stevie_b1.asm               ; Version 211227-2135000
0010               *
0011               * Bank 1 "James"
0012               * Editor core
0013               ***************************************************************
...
0170      A02C     tibasic.status    equ  core1.top + 44  ; TI Basic status flags
0171                                                      ; 0000 = Initialize TI-Basic
0172                                                      ; 0001 = TI-Basic reentry
0173      A02E     trmpvector        equ  core1.top + 46  ; Vector trampoline (if p1|tmp1 = >ffff)
0174      A030     ramsat            equ  core1.top + 48  ; Sprite Attr. Table in RAM (14 bytes)
0175      A040     timers            equ  core1.top + 64  ; Timers (80 bytes)
0176      A090     core1.free        equ  core1.top + 144 ; End of structure
0177               *--------------------------------------------------------------
0178               * Stevie core 2 RAM                   @>a100-a1ff   (256 bytes)
0179               *--------------------------------------------------------------
0180      A100     core2.top         equ  >a100           ; Structure begin
0181      A100     rambuf            equ  core2.top       ; RAM workbuffer
0182      A200     core2.free        equ  core2.top + 256 ; End of structure
0183               *--------------------------------------------------------------
0184               * Stevie Editor shared structures     @>a200-a2ff   (256 bytes)
0185               *--------------------------------------------------------------
0186      A200     tv.top            equ  >a200           ; Structure begin
0187      A200     tv.sams.2000      equ  tv.top + 0      ; SAMS window >2000-2fff
0188      A202     tv.sams.3000      equ  tv.top + 2      ; SAMS window >3000-3fff
0189      A204     tv.sams.a000      equ  tv.top + 4      ; SAMS window >a000-afff
0190      A206     tv.sams.b000      equ  tv.top + 6      ; SAMS window >b000-bfff
0191      A208     tv.sams.c000      equ  tv.top + 8      ; SAMS window >c000-cfff
0192      A20A     tv.sams.d000      equ  tv.top + 10     ; SAMS window >d000-dfff
0193      A20C     tv.sams.e000      equ  tv.top + 12     ; SAMS window >e000-efff
0194      A20E     tv.sams.f000      equ  tv.top + 14     ; SAMS window >f000-ffff
0195      A210     tv.ruler.visible  equ  tv.top + 16     ; Show ruler with tab positions
0196      A212     tv.colorscheme    equ  tv.top + 18     ; Current color scheme (0-xx)
0197      A214     tv.curshape       equ  tv.top + 20     ; Cursor shape and color (sprite)
0198      A216     tv.curcolor       equ  tv.top + 22     ; Cursor color1 + color2 (color scheme)
0199      A218     tv.color          equ  tv.top + 24     ; FG/BG-color framebuffer + status lines
0200      A21A     tv.markcolor      equ  tv.top + 26     ; FG/BG-color marked lines in framebuffer
0201      A21C     tv.busycolor      equ  tv.top + 28     ; FG/BG-color bottom line when busy
0202      A21E     tv.rulercolor     equ  tv.top + 30     ; FG/BG-color ruler line
0203      A220     tv.cmdb.hcolor    equ  tv.top + 32     ; FG/BG-color command buffer header line
0204      A222     tv.pane.focus     equ  tv.top + 34     ; Identify pane that has focus
0205      A224     tv.task.oneshot   equ  tv.top + 36     ; Pointer to one-shot routine
...
0227      A310     fb.colorize       equ  fb.struct + 16  ; M1/M2 colorize refresh required
0228      A312     fb.curtoggle      equ  fb.struct + 18  ; Cursor shape toggle
0229      A314     fb.yxsave         equ  fb.struct + 20  ; Copy of cursor YX position
0230      A316     fb.dirty          equ  fb.struct + 22  ; Frame buffer dirty flag
0231      A318     fb.status.dirty   equ  fb.struct + 24  ; Status line(s) dirty flag
0232      A31A     fb.scrrows        equ  fb.struct + 26  ; Rows on physical screen for framebuffer
0233      A31C     fb.scrrows.max    equ  fb.struct + 28  ; Max # of rows on physical screen for fb
0234      A31E     fb.ruler.sit      equ  fb.struct + 30  ; 80 char ruler  (no length-prefix!)
0235      A36E     fb.ruler.tat      equ  fb.struct + 110 ; 80 char colors (no length-prefix!)
0236      A3BE     fb.free           equ  fb.struct + 190 ; End of structure
0237               *--------------------------------------------------------------
...
0241               ;***********************************************************************
0242               ; ATTENTION
0243               ; The dsrlnk variables must form a continuous memory block and keep
0244               ; their order!
0245               ;***********************************************************************
0246      A400     dsrlnk.dsrlws     equ  fh.struct       ; Address of dsrlnk workspace 32 bytes
0247      A420     dsrlnk.namsto     equ  fh.struct + 32  ; 8-byte RAM buf for holding device name
0248      A428     dsrlnk.sav8a      equ  fh.struct + 40  ; Save parm (8 or A) after "blwp @dsrlnk"
0249      A42A     dsrlnk.savcru     equ  fh.struct + 42  ; CRU address of device in prev. DSR call
0250      A42C     dsrlnk.savent     equ  fh.struct + 44  ; DSR entry addr of prev. DSR call
0251      A42E     dsrlnk.savpab     equ  fh.struct + 46  ; Pointer to Device or Subprogram in PAB
0252      A430     dsrlnk.savver     equ  fh.struct + 48  ; Version used in prev. DSR call
0253      A432     dsrlnk.savlen     equ  fh.struct + 50  ; Length of DSR name of prev. DSR call
0254      A434     dsrlnk.flgptr     equ  fh.struct + 52  ; Pointer to VDP PAB byte 1 (flag byte)
0255      A436     fh.pab.ptr        equ  fh.struct + 54  ; Pointer to VDP PAB, for level 3 FIO
0256      A438     fh.pabstat        equ  fh.struct + 56  ; Copy of VDP PAB status byte
0257      A43A     fh.ioresult       equ  fh.struct + 58  ; DSRLNK IO-status after file operation
0258      A43C     fh.records        equ  fh.struct + 60  ; File records counter
0259      A43E     fh.reclen         equ  fh.struct + 62  ; Current record length
0260      A440     fh.kilobytes      equ  fh.struct + 64  ; Kilobytes processed (read/written)
0261      A442     fh.counter        equ  fh.struct + 66  ; Counter used in stevie file operations
0262      A444     fh.fname.ptr      equ  fh.struct + 68  ; Pointer to device and filename
0263      A446     fh.sams.page      equ  fh.struct + 70  ; Current SAMS page during file operation
0264      A448     fh.sams.hipage    equ  fh.struct + 72  ; Highest SAMS page in file operation
0265      A44A     fh.fopmode        equ  fh.struct + 74  ; FOP mode (File Operation Mode)
0266      A44C     fh.filetype       equ  fh.struct + 76  ; Value for filetype/mode (PAB byte 1)
0267      A44E     fh.offsetopcode   equ  fh.struct + 78  ; Set to >40 for skipping VDP buffer
0268      A450     fh.callback1      equ  fh.struct + 80  ; Pointer to callback function 1
0269      A452     fh.callback2      equ  fh.struct + 82  ; Pointer to callback function 2
0270      A454     fh.callback3      equ  fh.struct + 84  ; Pointer to callback function 3
0271      A456     fh.callback4      equ  fh.struct + 86  ; Pointer to callback function 4
0272      A458     fh.callback5      equ  fh.struct + 88  ; Pointer to callback function 5
0273      A45A     fh.workmode       equ  fh.struct + 90  ; Working mode (used in callbacks)
0274      A45C     fh.kilobytes.prev equ  fh.struct + 92  ; Kilobytes processed (previous)
0275      A45E     fh.line           equ  fh.struct + 94  ; Editor buffer line currently processing
0276      A460     fh.temp1          equ  fh.struct + 96  ; Temporary variable 1
0277      A462     fh.temp2          equ  fh.struct + 98  ; Temporary variable 2
0278      A464     fh.temp3          equ  fh.struct +100  ; Temporary variable 3
0279      A466     fh.membuffer      equ  fh.struct +102  ; 80 bytes file memory buffer
0280      A4B6     fh.free           equ  fh.struct +182  ; End of structure
0281      0960     fh.vrecbuf        equ  >0960           ; VDP address record buffer
0282      0A60     fh.vpab           equ  >0a60           ; VDP address PAB
0283               *--------------------------------------------------------------
0284               * Editor buffer structure             @>a500-a5ff   (256 bytes)
0285               *--------------------------------------------------------------
0286      A500     edb.struct        equ  >a500           ; Begin structure
0287      A500     edb.top.ptr       equ  edb.struct      ; Pointer to editor buffer
0288      A502     edb.index.ptr     equ  edb.struct + 2  ; Pointer to index
0289      A504     edb.lines         equ  edb.struct + 4  ; Total lines in editor buffer - 1
0290      A506     edb.dirty         equ  edb.struct + 6  ; Editor buffer dirty (Text changed!)
0291      A508     edb.next_free.ptr equ  edb.struct + 8  ; Pointer to next free line
0292      A50A     edb.insmode       equ  edb.struct + 10 ; Insert mode (>ffff = insert)
0293      A50C     edb.block.m1      equ  edb.struct + 12 ; Block start line marker (>ffff = unset)
0294      A50E     edb.block.m2      equ  edb.struct + 14 ; Block end line marker   (>ffff = unset)
0295      A510     edb.block.var     equ  edb.struct + 16 ; Local var used in block operation
0296      A512     edb.filename.ptr  equ  edb.struct + 18 ; Pointer to length-prefixed string
0297                                                      ; with current filename.
0298      A514     edb.filetype.ptr  equ  edb.struct + 20 ; Pointer to length-prefixed string
0299                                                      ; with current file type.
0300      A516     edb.sams.page     equ  edb.struct + 22 ; Current SAMS page
0301      A518     edb.sams.hipage   equ  edb.struct + 24 ; Highest SAMS page in use
0302      A51A     edb.filename      equ  edb.struct + 26 ; 80 characters inline buffer reserved
0303                                                      ; for filename, but not always used.
0304      A56A     edb.free          equ  edb.struct + 106; End of structure
0305               *--------------------------------------------------------------
0306               * Index structure                     @>a600-a6ff   (256 bytes)
0307               *--------------------------------------------------------------
0308      A600     idx.struct        equ  >a600           ; stevie index structure
0309      A600     idx.sams.page     equ  idx.struct      ; Current SAMS page
0310      A602     idx.sams.lopage   equ  idx.struct + 2  ; Lowest SAMS page
0311      A604     idx.sams.hipage   equ  idx.struct + 4  ; Highest SAMS page
0312      A606     idx.free          equ  idx.struct + 6  ; End of structure
0313               *--------------------------------------------------------------
0314               * Command buffer structure            @>a700-a7ff   (256 bytes)
0315               *--------------------------------------------------------------
0316      A700     cmdb.struct       equ  >a700           ; Command Buffer structure
0317      A700     cmdb.top.ptr      equ  cmdb.struct     ; Pointer to command buffer (history)
0318      A702     cmdb.visible      equ  cmdb.struct + 2 ; Command buffer visible? (>ffff=visible)
0319      A704     cmdb.fb.yxsave    equ  cmdb.struct + 4 ; Copy of FB WYX when entering cmdb pane
0320      A706     cmdb.scrrows      equ  cmdb.struct + 6 ; Current size of CMDB pane (in rows)
0321      A708     cmdb.default      equ  cmdb.struct + 8 ; Default size of CMDB pane (in rows)
0322      A70A     cmdb.cursor       equ  cmdb.struct + 10; Screen YX of cursor in CMDB pane
0323      A70C     cmdb.yxsave       equ  cmdb.struct + 12; Copy of WYX
0324      A70E     cmdb.yxtop        equ  cmdb.struct + 14; YX position of CMDB pane header line
0325      A710     cmdb.yxprompt     equ  cmdb.struct + 16; YX position of command buffer prompt
0326      A712     cmdb.column       equ  cmdb.struct + 18; Current column in command buffer pane
0327      A714     cmdb.length       equ  cmdb.struct + 20; Length of current row in CMDB
0328      A716     cmdb.lines        equ  cmdb.struct + 22; Total lines in CMDB
0329      A718     cmdb.dirty        equ  cmdb.struct + 24; Command buffer dirty (Text changed!)
0330      A71A     cmdb.dialog       equ  cmdb.struct + 26; Dialog identifier
0331      A71C     cmdb.panhead      equ  cmdb.struct + 28; Pointer to string pane header
0332      A71E     cmdb.paninfo      equ  cmdb.struct + 30; Pointer to string pane info (1st line)
0333      A720     cmdb.panhint      equ  cmdb.struct + 32; Pointer to string pane hint (2nd line)
0334      A722     cmdb.panmarkers   equ  cmdb.struct + 34; Pointer to key marker list  (3rd line)
0335      A724     cmdb.pankeys      equ  cmdb.struct + 36; Pointer to string pane keys (stat line)
0336      A726     cmdb.action.ptr   equ  cmdb.struct + 38; Pointer to function to execute
0337      A728     cmdb.cmdall       equ  cmdb.struct + 40; Current command including length-byte
...
0340      A77A     cmdb.panhead.buf  equ  cmdb.struct +122; String buffer for pane header
0341      A7AC     cmdb.dflt.fname   equ  cmdb.struct +172; Default for filename
0342      A800     cmdb.free         equ  cmdb.struct +256; End of structure
0343               *--------------------------------------------------------------
0344               * Paged-out scratchpad memory         @>ad00-aeff   (256 bytes)
0345               *--------------------------------------------------------------
0346      7E00     cpu.scrpad.src    equ  >7e00           ; \ Dump of OS monitor scratchpad
0347                                                      ; / stored in cartridge ROM bank7.asm
0348               
0349      F960     cpu.scrpad.tgt    equ  >f960           ; \ Target copy of OS monitor scratchpad
0350                                                      ; | in high-memory.
0351                                                      ; /
0352               
0353      AD00     cpu.scrpad.moved  equ  >ad00           ; Stevie scratchpad memory when paged-out
0354                                                      ; because of TI Basic/External program
0355               *--------------------------------------------------------------
...
0270 21ED   42             text  'Build-ID  211227-2135000'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0075 2C36 0201  20         li    r1,>8300
     2C38 8300     
0076 2C3A 0202  20         li    r2,64
     2C3C 0040     
0077                       ;------------------------------------------------------
0078                       ; Copy memory range @cpu.scrpad.tgt <-> @cpu.scrpad.tgt + >ff
0079                       ;------------------------------------------------------
0080               cpu.scrpad.restore.copy:
0081 2C3E CC70  46         mov   *r0+,*r1+
0082 2C40 CC70  46         mov   *r0+,*r1+
0083 2C42 0602  14         dec   r2
0084 2C44 16FC  14         jne   cpu.scrpad.restore.copy
0085                       ;------------------------------------------------------
0086                       ; Exit
0087                       ;------------------------------------------------------
0088               cpu.scrpad.restore.exit:
0089 2C46 045B  20         b     *r11                  ; Return to caller
                   < runlib.asm
...
0038 2C48 C15B  26         mov   *r11,tmp1             ; tmp1 = Memory target address
0039                       ;------------------------------------------------------
0040                       ; Copy registers r0-r7
0041                       ;------------------------------------------------------
0042 2C4A CD40  34         mov   r0,*tmp1+             ; Backup r0
0043 2C4C CD41  34         mov   r1,*tmp1+             ; Backup r1
0044 2C4E CD42  34         mov   r2,*tmp1+             ; Backup r2
0045 2C50 CD43  34         mov   r3,*tmp1+             ; Backup r3
0046 2C52 CD44  34         mov   r4,*tmp1+             ; Backup r4
0047 2C54 CD45  34         mov   r5,*tmp1+             ; Backup r5 (is tmp1, so is bogus)
0048 2C56 CD46  34         mov   r6,*tmp1+             ; Backup r6
0049 2C58 CD47  34         mov   r7,*tmp1+             ; Backup r7
0050                       ;------------------------------------------------------
0051                       ; Copy scratchpad memory to destination
0052                       ;------------------------------------------------------
0053               xcpu.scrpad.pgout:
0054 2C5A 0204  20         li    tmp0,>8310            ; tmp0 = Memory source address
     2C5C 8310     
0055                                                   ;        as of register r8
0056 2C5E 0206  20         li    tmp2,15               ; tmp2 = 15 iterations
     2C60 000F     
0057                       ;------------------------------------------------------
0058                       ; Copy memory
0059                       ;------------------------------------------------------
0060 2C62 CD74  46 !       mov   *tmp0+,*tmp1+         ; Copy word 1
0061 2C64 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 2
0062 2C66 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 3
0063 2C68 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 4
0064 2C6A CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 5
0065 2C6C CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 6
0066 2C6E CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 7
0067 2C70 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 8
0068 2C72 0606  14         dec   tmp2
0069 2C74 16F6  14         jne   -!                    ; Loop until done
0070                       ;------------------------------------------------------
0071                       ; Switch to newly copied workspace
0072                       ;------------------------------------------------------
0073 2C76 C37B  30         mov   *r11+,r13             ; R13=WP   (pop tmp1 from stack)
0074 2C78 020E  20         li    r14,cpu.scrpad.pgout.after.rtwp
     2C7A 2C80     
0075                                                   ; R14=PC
0076 2C7C 04CF  14         clr   r15                   ; R15=STATUS
0077                       ;------------------------------------------------------
0078                       ; If we get here, WS was copied to specified
0079                       ; destination.  Also contents of r13,r14,r15
0080                       ; are about to be overwritten by rtwp instruction.
0081                       ;------------------------------------------------------
0082 2C7E 0380  18         rtwp                        ; Activate copied workspace
0083                                                   ; in non-scratchpad memory!
0084               
0085               cpu.scrpad.pgout.after.rtwp:
0086 2C80 0460  28         b     @cpu.scrpad.restore   ; Restore scratchpad memory
     2C82 2C32     
...
0093 2C84 045B  20         b     *r11                  ; Return to caller
0094               
0095               
0096               ***************************************************************
...
0119 2C86 C13B  30         mov   *r11+,tmp0            ; tmp0 = Memory source address
0120                       ;------------------------------------------------------
0121                       ; Copy scratchpad memory to destination
0122                       ;------------------------------------------------------
0123               xcpu.scrpad.pgin:
0124 2C88 0205  20         li    tmp1,>8300            ; tmp1 = Memory destination address
     2C8A 8300     
0125 2C8C 0206  20         li    tmp2,16               ; tmp2 = 256/16
     2C8E 0010     
0126                       ;------------------------------------------------------
0127                       ; Copy memory
0128                       ;------------------------------------------------------
0129 2C90 CD74  46 !       mov   *tmp0+,*tmp1+         ; Copy word 1
0130 2C92 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 2
0131 2C94 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 3
0132 2C96 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 4
0133 2C98 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 5
0134 2C9A CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 6
0135 2C9C CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 7
0136 2C9E CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 8
0137 2CA0 0606  14         dec   tmp2
0138 2CA2 16F6  14         jne   -!                    ; Loop until done
0139                       ;------------------------------------------------------
0140                       ; Switch workspace to scratchpad memory
0141                       ;------------------------------------------------------
0142 2CA4 02E0  18         lwpi  >8300                 ; Activate copied workspace
     2CA6 8300     
0143                       ;------------------------------------------------------
0144                       ; Exit
0145                       ;------------------------------------------------------
0146               cpu.scrpad.pgin.exit:
0147 2CA8 045B  20         b     *r11                  ; Return to caller
                   < runlib.asm
0222               
...
0055               ********|*****|*********************|**************************
0056 2CAA A400     dsrlnk  data  dsrlnk.dsrlws         ; dsrlnk workspace
0057 2CAC 2CAE             data  dsrlnk.init           ; Entry point
0058                       ;------------------------------------------------------
0059                       ; DSRLNK entry point
0060                       ;------------------------------------------------------
0061               dsrlnk.init:
0062 2CAE C17E  30         mov   *r14+,r5              ; Get pgm type for link
0063 2CB0 C805  38         mov   r5,@dsrlnk.sav8a      ; Save data following blwp @dsrlnk (8 or >a)
     2CB2 A428     
0064 2CB4 53E0  34         szcb  @hb$20,r15            ; Reset equal bit in status register
     2CB6 201C     
0065 2CB8 C020  34         mov   @>8356,r0             ; Get pointer to PAB+9 in VDP
     2CBA 8356     
0066 2CBC C240  18         mov   r0,r9                 ; Save pointer
0067                       ;------------------------------------------------------
0068                       ; Fetch file descriptor length from PAB
0069                       ;------------------------------------------------------
0070 2CBE 0229  22         ai    r9,>fff8              ; Adjust r9 to addr PAB byte 1
     2CC0 FFF8     
0071                                                   ; FLAG byte->(pabaddr+9)-8
0072 2CC2 C809  38         mov   r9,@dsrlnk.flgptr     ; Save pointer to PAB byte 1
     2CC4 A434     
0073                       ;---------------------------; Inline VSBR start
0074 2CC6 06C0  14         swpb  r0                    ;
0075 2CC8 D800  38         movb  r0,@vdpa              ; Send low byte
     2CCA 8C02     
0076 2CCC 06C0  14         swpb  r0                    ;
0077 2CCE D800  38         movb  r0,@vdpa              ; Send high byte
     2CD0 8C02     
0078 2CD2 D0E0  34         movb  @vdpr,r3              ; Read byte from VDP RAM
     2CD4 8800     
0079                       ;---------------------------; Inline VSBR end
0080 2CD6 0983  56         srl   r3,8                  ; Move to low byte
0081               
0082                       ;------------------------------------------------------
0083                       ; Fetch file descriptor device name from PAB
0084                       ;------------------------------------------------------
0085 2CD8 0704  14         seto  r4                    ; Init counter
0086 2CDA 0202  20         li    r2,dsrlnk.namsto      ; Point to 8-byte CPU buffer
     2CDC A420     
0087 2CDE 0580  14 !       inc   r0                    ; Point to next char of name
0088 2CE0 0584  14         inc   r4                    ; Increment char counter
0089 2CE2 0284  22         ci    r4,>0007              ; Check if length more than 7 chars
     2CE4 0007     
0090 2CE6 1571  14         jgt   dsrlnk.error.devicename_invalid
0091                                                   ; Yes, error
0092 2CE8 80C4  18         c     r4,r3                 ; End of name?
0093 2CEA 130C  14         jeq   dsrlnk.device_name.get_length
0094                                                   ; Yes
0095               
0096                       ;---------------------------; Inline VSBR start
0097 2CEC 06C0  14         swpb  r0                    ;
0098 2CEE D800  38         movb  r0,@vdpa              ; Send low byte
     2CF0 8C02     
0099 2CF2 06C0  14         swpb  r0                    ;
0100 2CF4 D800  38         movb  r0,@vdpa              ; Send high byte
     2CF6 8C02     
0101 2CF8 D060  34         movb  @vdpr,r1              ; Read byte from VDP RAM
     2CFA 8800     
...
0106                       ;------------------------------------------------------
0107 2CFC DC81  32         movb  r1,*r2+               ; Move into buffer
0108 2CFE 9801  38         cb    r1,@dsrlnk.period     ; Is character a '.'
     2D00 2E16     
0109 2D02 16ED  14         jne   -!                    ; No, loop next char
0110                       ;------------------------------------------------------
0111                       ; Determine device name length
0112                       ;------------------------------------------------------
0113               dsrlnk.device_name.get_length:
0114 2D04 C104  18         mov   r4,r4                 ; Check if length = 0
0115 2D06 1361  14         jeq   dsrlnk.error.devicename_invalid
0116                                                   ; Yes, error
0117 2D08 04E0  34         clr   @>83d0
     2D0A 83D0     
0118 2D0C C804  38         mov   r4,@>8354             ; Save name length for search (length
     2D0E 8354     
0119                                                   ; goes to >8355 but overwrites >8354!)
0120 2D10 C804  38         mov   r4,@dsrlnk.savlen     ; Save name length for nextr dsrlnk call
     2D12 A432     
0121               
0122 2D14 0584  14         inc   r4                    ; Adjust for dot
0123 2D16 A804  38         a     r4,@>8356             ; Point to position after name
     2D18 8356     
0124 2D1A C820  54         mov   @>8356,@dsrlnk.savpab ; Save pointer for next dsrlnk call
     2D1C 8356     
     2D1E A42E     
0125                       ;------------------------------------------------------
...
0129 2D20 02E0  18         lwpi  >83e0                 ; Use GPL WS
     2D22 83E0     
0130 2D24 04C1  14         clr   r1                    ; Version found of dsr
0131 2D26 020C  20         li    r12,>0f00             ; Init cru address
     2D28 0F00     
0132                       ;------------------------------------------------------
0133                       ; Turn off ROM on current card
0134                       ;------------------------------------------------------
0135               dsrlnk.dsrscan.cardoff:
0136 2D2A C30C  18         mov   r12,r12               ; Anything to turn off?
0137 2D2C 1301  14         jeq   dsrlnk.dsrscan.cardloop
0138                                                   ; No, loop over cards
0139 2D2E 1E00  20         sbz   0                     ; Yes, turn off
0140                       ;------------------------------------------------------
0141                       ; Loop over cards and look if DSR present
0142                       ;------------------------------------------------------
0143               dsrlnk.dsrscan.cardloop:
0144 2D30 022C  22         ai    r12,>0100             ; Next ROM to turn on
     2D32 0100     
0145 2D34 04E0  34         clr   @>83d0                ; Clear in case we are done
     2D36 83D0     
0146 2D38 028C  22         ci    r12,>2000             ; Card scan complete? (>1000 to >1F00)
     2D3A 2000     
0147 2D3C 1344  14         jeq   dsrlnk.error.nodsr_found
0148                                                   ; Yes, no matching DSR found
0149 2D3E C80C  38         mov   r12,@>83d0            ; Save address of next cru
     2D40 83D0     
0150                       ;------------------------------------------------------
0151                       ; Look at card ROM (@>4000 eq 'AA' ?)
0152                       ;------------------------------------------------------
0153 2D42 1D00  20         sbo   0                     ; Turn on ROM
0154 2D44 0202  20         li    r2,>4000              ; Start at beginning of ROM
     2D46 4000     
0155 2D48 9812  46         cb    *r2,@dsrlnk.$aa00     ; Check for a valid DSR header
     2D4A 2E12     
0156 2D4C 16EE  14         jne   dsrlnk.dsrscan.cardoff
...
0164                       ;------------------------------------------------------
0165 2D4E A0A0  34         a     @dsrlnk.dstype,r2     ; Goto first pointer (byte 8 or 10)
     2D50 A40A     
0166 2D52 1003  14         jmp   dsrlnk.dsrscan.getentry
0167                       ;------------------------------------------------------
0168                       ; Next DSR entry
0169                       ;------------------------------------------------------
0170               dsrlnk.dsrscan.nextentry:
0171 2D54 C0A0  34         mov   @>83d2,r2             ; Offset 0 > Fetch link to next DSR or
     2D56 83D2     
0172                                                   ; subprogram
0173               
0174 2D58 1D00  20         sbo   0                     ; Turn ROM back on
0175                       ;------------------------------------------------------
0176                       ; Get DSR entry
0177                       ;------------------------------------------------------
0178               dsrlnk.dsrscan.getentry:
0179 2D5A C092  26         mov   *r2,r2                ; Is address a zero? (end of chain?)
0180 2D5C 13E6  14         jeq   dsrlnk.dsrscan.cardoff
0181                                                   ; Yes, no more DSRs or programs to check
0182 2D5E C802  38         mov   r2,@>83d2             ; Offset 0 > Store link to next DSR or
     2D60 83D2     
0183                                                   ; subprogram
0184               
0185 2D62 05C2  14         inct  r2                    ; Offset 2 > Has call address of current
0186                                                   ; DSR/subprogram code
0187               
0188 2D64 C272  30         mov   *r2+,r9               ; Store call address in r9. Move r2 to
0189                                                   ; offset 4 (DSR/subprogram name)
0190                       ;------------------------------------------------------
0191                       ; Check file descriptor in DSR
0192                       ;------------------------------------------------------
0193 2D66 04C5  14         clr   r5                    ; Remove any old stuff
0194 2D68 D160  34         movb  @>8355,r5             ; Get length as counter
     2D6A 8355     
0195 2D6C 1309  14         jeq   dsrlnk.dsrscan.call_dsr
0196                                                   ; If zero, do not further check, call DSR
0197                                                   ; program
0198               
0199 2D6E 9C85  32         cb    r5,*r2+               ; See if length matches
0200 2D70 16F1  14         jne   dsrlnk.dsrscan.nextentry
0201                                                   ; No, length does not match.
0202                                                   ; Go process next DSR entry
0203               
0204 2D72 0985  56         srl   r5,8                  ; Yes, move to low byte
0205 2D74 0206  20         li    r6,dsrlnk.namsto      ; Point to 8-byte CPU buffer
     2D76 A420     
0206 2D78 9CB6  42 !       cb    *r6+,*r2+             ; Compare byte in CPU buffer with byte in
0207                                                   ; DSR ROM
0208 2D7A 16EC  14         jne   dsrlnk.dsrscan.nextentry
0209                                                   ; Try next DSR entry if no match
0210 2D7C 0605  14         dec   r5                    ; Update loop counter
0211 2D7E 16FC  14         jne   -!                    ; Loop until full length checked
0212                       ;------------------------------------------------------
0213                       ; Call DSR program in card/device
0214                       ;------------------------------------------------------
0215               dsrlnk.dsrscan.call_dsr:
0216 2D80 0581  14         inc   r1                    ; Next version found
0217 2D82 C80C  38         mov   r12,@dsrlnk.savcru    ; Save CRU address
     2D84 A42A     
0218 2D86 C809  38         mov   r9,@dsrlnk.savent     ; Save DSR entry address
     2D88 A42C     
0219 2D8A C801  38         mov   r1,@dsrlnk.savver     ; Save DSR Version number
     2D8C A430     
0220               
0221 2D8E 020F  20         li    r15,>8C02             ; Set VDP port address, needed to prevent
     2D90 8C02     
0222                                                   ; lockup of TI Disk Controller DSR.
0223               
0224 2D92 0699  24         bl    *r9                   ; Execute DSR
0225                       ;
0226                       ; Depending on IO result the DSR in card ROM does RET
0227                       ; or (INCT R11 + RET), meaning either (1) or (2) get executed.
0228                       ;
0229 2D94 10DF  14         jmp   dsrlnk.dsrscan.nextentry
0230                                                   ; (1) error return
0231 2D96 1E00  20         sbz   0                     ; (2) turn off card/device if good return
0232 2D98 02E0  18         lwpi  dsrlnk.dsrlws         ; (2) restore workspace
     2D9A A400     
0233 2D9C C009  18         mov   r9,r0                 ; Point to flag byte (PAB+1) in VDP PAB
0234                       ;------------------------------------------------------
0235                       ; Returned from DSR
0236                       ;------------------------------------------------------
0237               dsrlnk.dsrscan.return_dsr:
0238 2D9E C060  34         mov   @dsrlnk.sav8a,r1      ; get back data following blwp @dsrlnk
     2DA0 A428     
0239                                                   ; (8 or >a)
0240 2DA2 0281  22         ci    r1,8                  ; was it 8?
     2DA4 0008     
0241 2DA6 1303  14         jeq   dsrlnk.dsrscan.dsr.8  ; yes, jump: normal dsrlnk
0242 2DA8 D060  34         movb  @>8350,r1             ; no, we have a data >a.
     2DAA 8350     
0243                                                   ; Get error byte from @>8350
0244 2DAC 1008  14         jmp   dsrlnk.dsrscan.dsr.a  ; go and return error byte to the caller
0245               
0246                       ;------------------------------------------------------
...
0251 2DAE 06C0  14         swpb  r0                    ;
0252 2DB0 D800  38         movb  r0,@vdpa              ; send low byte
     2DB2 8C02     
0253 2DB4 06C0  14         swpb  r0                    ;
0254 2DB6 D800  38         movb  r0,@vdpa              ; send high byte
     2DB8 8C02     
0255 2DBA D060  34         movb  @vdpr,r1              ; read byte from VDP ram
     2DBC 8800     
...
0262 2DBE 09D1  56         srl   r1,13                 ; just keep error bits
0263 2DC0 1605  14         jne   dsrlnk.error.io_error
0264                                                   ; handle IO error
0265 2DC2 0380  18         rtwp                        ; Return from DSR workspace to caller
0266                                                   ; workspace
0267               
0268                       ;------------------------------------------------------
...
0272 2DC4 1E00  20         sbz   >00                   ; Turn card off, nomatter what
0273               dsrlnk.error.nodsr_found:
0274 2DC6 02E0  18         lwpi  dsrlnk.dsrlws         ; No DSR found, restore workspace
     2DC8 A400     
0275               dsrlnk.error.devicename_invalid:
0276 2DCA 04C1  14         clr   r1                    ; clear flag for error 0 = bad device name
0277               dsrlnk.error.io_error:
0278 2DCC 06C1  14         swpb  r1                    ; put error in hi byte
0279 2DCE D741  30         movb  r1,*r13               ; store error flags in callers r0
0280 2DD0 F3E0  34         socb  @hb$20,r15            ; \ Set equal bit in copy of status register
     2DD2 201C     
0281                                                   ; / to indicate error
0282 2DD4 0380  18         rtwp                        ; Return from DSR workspace to caller
0283                                                   ; workspace
0284               
0285               
0286               ***************************************************************
...
0307               ********|*****|*********************|**************************
0308               dsrlnk.reuse:
0309 2DD6 A400             data  dsrlnk.dsrlws         ; dsrlnk workspace
0310 2DD8 2DDA             data  dsrlnk.reuse.init     ; entry point
0311                       ;------------------------------------------------------
0312                       ; DSRLNK entry point
0313                       ;------------------------------------------------------
0314               dsrlnk.reuse.init:
0315 2DDA 02E0  18         lwpi  >83e0                 ; Use GPL WS
     2DDC 83E0     
0316               
0317 2DDE 53E0  34         szcb  @hb$20,r15            ; reset equal bit in status register
     2DE0 201C     
0318                       ;------------------------------------------------------
0319                       ; Restore dsrlnk variables of previous DSR call
0320                       ;------------------------------------------------------
0321 2DE2 020B  20         li    r11,dsrlnk.savcru     ; Get pointer to last used CRU
     2DE4 A42A     
0322 2DE6 C33B  30         mov   *r11+,r12             ; Get CRU address         < @dsrlnk.savcru
0323 2DE8 C27B  30         mov   *r11+,r9              ; Get DSR entry address   < @dsrlnk.savent
0324 2DEA C83B  50         mov   *r11+,@>8356          ; \ Get pointer to Device name or
     2DEC 8356     
0325                                                   ; / or subprogram in PAB  < @dsrlnk.savpab
0326 2DEE C07B  30         mov   *r11+,R1              ; Get DSR Version number  < @dsrlnk.savver
0327 2DF0 C81B  46         mov   *r11,@>8354           ; Get device name length  < @dsrlnk.savlen
     2DF2 8354     
0328                       ;------------------------------------------------------
0329                       ; Call DSR program in card/device
0330                       ;------------------------------------------------------
0331 2DF4 020F  20         li    r15,>8C02             ; Set VDP port address, needed to prevent
     2DF6 8C02     
0332                                                   ; lockup of TI Disk Controller DSR.
0333               
0334 2DF8 1D00  20         sbo   >00                   ; Open card/device ROM
0335               
0336 2DFA 9820  54         cb    @>4000,@dsrlnk.$aa00  ; Valid identifier found?
     2DFC 4000     
     2DFE 2E12     
0337 2E00 16E2  14         jne   dsrlnk.error.nodsr_found
0338                                                   ; No, error code 0 = Bad Device name
0339                                                   ; The above jump may happen only in case of
0340                                                   ; either card hardware malfunction or if
0341                                                   ; there are 2 cards opened at the same time.
0342               
0343 2E02 0699  24         bl    *r9                   ; Execute DSR
0344                       ;
0345                       ; Depending on IO result the DSR in card ROM does RET
0346                       ; or (INCT R11 + RET), meaning either (1) or (2) get executed.
0347                       ;
0348 2E04 10DF  14         jmp   dsrlnk.error.nodsr_found_off
0349                                                   ; (1) error return
0350 2E06 1E00  20         sbz   >00                   ; (2) turn off card ROM if good return
0351                       ;------------------------------------------------------
0352                       ; Now check if any DSR error occured
0353                       ;------------------------------------------------------
0354 2E08 02E0  18         lwpi  dsrlnk.dsrlws         ; Restore workspace
     2E0A A400     
0355 2E0C C020  34         mov   @dsrlnk.flgptr,r0     ; Get pointer to VDP PAB byte 1
     2E0E A434     
0356               
0357 2E10 10C6  14         jmp   dsrlnk.dsrscan.return_dsr
0358                                                   ; Rest is the same as with normal DSRLNK
0359               
0360               
0361               ********************************************************************************
0362               
0363 2E12 AA00     dsrlnk.$aa00      data   >aa00      ; Used for identifying DSR header
0364 2E14 0008     dsrlnk.$0008      data   >0008      ; 8 is the data that usually follows
0365                                                   ; a @blwp @dsrlnk
0366 2E16 2E       dsrlnk.period     text  '.'         ; For finding end of device name
0367               
0368                       even
                   < runlib.asm
...
0043               ********|*****|*********************|**************************
0044               file.open:
0045 2E18 C03B  30         mov   *r11+,r0              ; Get file descriptor (P0)
0046 2E1A C07B  30         mov   *r11+,r1              ; Get file type/mode
0047               *--------------------------------------------------------------
0048               * Initialisation
0049               *--------------------------------------------------------------
0050               xfile.open:
0051 2E1C 0649  14         dect  stack
0052 2E1E C64B  30         mov   r11,*stack            ; Save return address
0053                       ;------------------------------------------------------
0054                       ; Initialisation
0055                       ;------------------------------------------------------
0056 2E20 0204  20         li    tmp0,dsrlnk.savcru
     2E22 A42A     
0057 2E24 04F4  30         clr   *tmp0+                ; Clear @dsrlnk.savcru
0058 2E26 04F4  30         clr   *tmp0+                ; Clear @dsrlnk.savent
0059 2E28 04F4  30         clr   *tmp0+                ; Clear @dsrlnk.savver
0060 2E2A 04D4  26         clr   *tmp0                 ; Clear @dsrlnk.pabflg
0061                       ;------------------------------------------------------
0062                       ; Set pointer to VDP disk buffer header
0063                       ;------------------------------------------------------
0064 2E2C 0205  20         li    tmp1,>37D7            ; \ VDP Disk buffer header
     2E2E 37D7     
0065 2E30 C805  38         mov   tmp1,@>8370           ; | Pointer at Fixed scratchpad
     2E32 8370     
0066                                                   ; / location
0067 2E34 C801  38         mov   r1,@fh.filetype       ; Set file type/mode
     2E36 A44C     
0068 2E38 04C5  14         clr   tmp1                  ; io.op.open
0069 2E3A 101F  14         jmp   _file.record.fop      ; Do file operation
0070               
0071               
0072               
0073               ***************************************************************
...
0089               ********|*****|*********************|**************************
0090               file.close:
0091 2E3C C03B  30         mov   *r11+,r0              ; Get file descriptor (P0)
0092               *--------------------------------------------------------------
0093               * Initialisation
0094               *--------------------------------------------------------------
0095               xfile.close:
0096 2E3E 0649  14         dect  stack
0097 2E40 C64B  30         mov   r11,*stack            ; Save return address
0098 2E42 0205  20         li    tmp1,io.op.close      ; io.op.close
     2E44 0001     
0099 2E46 1019  14         jmp   _file.record.fop      ; Do file operation
0100               
0101               
0102               ***************************************************************
...
0120 2E48 C03B  30         mov   *r11+,r0              ; Get file descriptor (P0)
0121               *--------------------------------------------------------------
0122               * Initialisation
0123               *--------------------------------------------------------------
0124 2E4A 0649  14         dect  stack
0125 2E4C C64B  30         mov   r11,*stack            ; Save return address
0126               
0127 2E4E 0205  20         li    tmp1,io.op.read       ; io.op.read
     2E50 0002     
0128 2E52 1013  14         jmp   _file.record.fop      ; Do file operation
0129               
0130               
0131               
0132               ***************************************************************
...
0150 2E54 C03B  30         mov   *r11+,r0              ; Get file descriptor (P0)
0151               *--------------------------------------------------------------
0152               * Initialisation
0153               *--------------------------------------------------------------
0154 2E56 0649  14         dect  stack
0155 2E58 C64B  30         mov   r11,*stack            ; Save return address
0156               
0157 2E5A C100  18         mov   r0,tmp0               ; VDP write address (PAB byte 0)
0158 2E5C 0224  22         ai    tmp0,5                ; Position to PAB byte 5
     2E5E 0005     
0159               
0160 2E60 C160  34         mov   @fh.reclen,tmp1       ; Get record length
     2E62 A43E     
0161               
0162 2E64 06A0  32         bl    @xvputb               ; Write character count to PAB
     2E66 22E0     
0163                                                   ; \ i  tmp0 = VDP target address
0164                                                   ; / i  tmp1 = Byte to write
0165               
0166 2E68 0205  20         li    tmp1,io.op.write      ; io.op.write
     2E6A 0003     
0167 2E6C 1006  14         jmp   _file.record.fop      ; Do file operation
0168               
0169               
0170               
0171               file.record.seek:
0172 2E6E 1000  14         nop
0173               
0174               
0175               file.image.load:
0176 2E70 1000  14         nop
0177               
0178               
0179               file.image.save:
0180 2E72 1000  14         nop
0181               
0182               
0183               file.delete:
0184 2E74 1000  14         nop
0185               
0186               
0187               file.rename:
0188 2E76 1000  14         nop
0189               
0190               
0191               file.status:
0192 2E78 1000  14         nop
0193               
0194               
0195               
0196               ***************************************************************
...
0226                       ;------------------------------------------------------
0227 2E7A C800  38         mov   r0,@fh.pab.ptr        ; Backup of pointer to current VDP PAB
     2E7C A436     
0228                       ;------------------------------------------------------
0229                       ; Set file opcode in VDP PAB
0230                       ;------------------------------------------------------
0231 2E7E C100  18         mov   r0,tmp0               ; VDP write address (PAB byte 0)
0232               
0233 2E80 A160  34         a     @fh.offsetopcode,tmp1 ; Inject offset for file I/O opcode
     2E82 A44E     
0234                                                   ; >00 = Data buffer in VDP RAM
0235                                                   ; >40 = Data buffer in CPU RAM
0236               
0237 2E84 06A0  32         bl    @xvputb               ; Write file I/O opcode to VDP
     2E86 22E0     
...
0242                       ;------------------------------------------------------
0243 2E88 C100  18         mov   r0,tmp0               ; VDP write address (PAB byte 0)
0244 2E8A 0584  14         inc   tmp0                  ; Next byte in PAB
0245 2E8C C160  34         mov   @fh.filetype,tmp1     ; Get file type/mode
     2E8E A44C     
0246               
0247 2E90 06A0  32         bl    @xvputb               ; Write file type/mode to VDP
     2E92 22E0     
...
0252                       ;------------------------------------------------------
0253 2E94 0220  22 !       ai    r0,9                  ; Move to file descriptor length
     2E96 0009     
0254 2E98 C800  38         mov   r0,@>8356             ; Pass file descriptor to DSRLNK
     2E9A 8356     
0255               *--------------------------------------------------------------
0256               * Call DSRLINK for doing file operation
0257               *--------------------------------------------------------------
0258 2E9C C820  54         mov   @>8322,@waux1         ; Save word at @>8322
     2E9E 8322     
     2EA0 833C     
0259               
0260 2EA2 C120  34         mov   @dsrlnk.savcru,tmp0   ; Call optimized or standard version?
     2EA4 A42A     
0261 2EA6 1504  14         jgt   _file.record.fop.optimized
0262                                                   ; Optimized version
0263               
0264                       ;------------------------------------------------------
0265                       ; First IO call. Call standard DSRLNK
0266                       ;------------------------------------------------------
0267 2EA8 0420  54         blwp  @dsrlnk               ; Call DSRLNK
     2EAA 2CAA     
0268 2EAC 0008                   data >8               ; \ i  p0 = >8 (DSR)
0269                                                   ; / o  r0 = Copy of VDP PAB byte 1
0270 2EAE 1002  14         jmp  _file.record.fop.pab   ; Return PAB to caller
0271               
0272                       ;------------------------------------------------------
0273                       ; Recurring IO call. Call optimized DSRLNK
0274                       ;------------------------------------------------------
0275               _file.record.fop.optimized:
0276 2EB0 0420  54         blwp  @dsrlnk.reuse         ; Call DSRLNK
     2EB2 2DD6     
0277               
0278               *--------------------------------------------------------------
...
0282 2EB4 02C6  12         stst  tmp2                  ; Store status register contents in tmp2
0283                                                   ; Upon DSRLNK return status register EQ bit
0284                                                   ; 1 = No file error
0285                                                   ; 0 = File error occured
0286               
0287 2EB6 C820  54         mov   @waux1,@>8322         ; Restore word at @>8322
     2EB8 833C     
     2EBA 8322     
0288               *--------------------------------------------------------------
0289               * Get PAB byte 5 from VDP ram into tmp1 (character count)
0290               *--------------------------------------------------------------
0291 2EBC C120  34         mov   @fh.pab.ptr,tmp0      ; Get VDP address of current PAB
     2EBE A436     
0292 2EC0 0224  22         ai    tmp0,5                ; Get address of VDP PAB byte 5
     2EC2 0005     
0293 2EC4 06A0  32         bl    @xvgetb               ; VDP read PAB status byte into tmp0
     2EC6 22F8     
0294 2EC8 C144  18         mov   tmp0,tmp1             ; Move to destination
0295               *--------------------------------------------------------------
0296               * Get PAB byte 1 from VDP ram into tmp0 (status)
0297               *--------------------------------------------------------------
0298 2ECA C100  18         mov   r0,tmp0               ; VDP PAB byte 1 (status)
...
0319 2ECC C2F9  30         mov   *stack+,r11           ; Pop R11
0320 2ECE 045B  20         b     *r11                  ; Return to caller
                   < runlib.asm
0228               
0229               *//////////////////////////////////////////////////////////////
0230               *                            TIMERS
...
0019               ********|*****|*********************|**************************
0020 2ED0 0300  24 tmgr    limi  0                     ; No interrupt processing
     2ED2 0000     
0021               *--------------------------------------------------------------
0022               * Read VDP status register
0023               *--------------------------------------------------------------
0024 2ED4 D360  34 tmgr1   movb  @vdps,r13             ; Save copy of VDP status register in R13
     2ED6 8802     
0025               *--------------------------------------------------------------
0026               * Latch sprite collision flag
0027               *--------------------------------------------------------------
0028 2ED8 2360  38         coc   @wbit2,r13            ; C flag on ?
     2EDA 201C     
0029 2EDC 1602  14         jne   tmgr1a                ; No, so move on
0030 2EDE E0A0  34         soc   @wbit12,config        ; Latch bit 12 in config register
     2EE0 2008     
0031               *--------------------------------------------------------------
0032               * Interrupt flag
0033               *--------------------------------------------------------------
0034 2EE2 2360  38 tmgr1a  coc   @wbit0,r13            ; Interupt flag set ?
     2EE4 2020     
0035 2EE6 1311  14         jeq   tmgr4                 ; Yes, process slots 0..n
0036               *--------------------------------------------------------------
...
0046               *--------------------------------------------------------------
0047 2EE8 20A0  38 tmgr2   coc   @wbit8,config         ; Kernel thread blocked ?
     2EEA 2010     
0048 2EEC 1305  14         jeq   tmgr3                 ; Yes, skip to user hook
0049 2EEE 20A0  38         coc   @wbit9,config         ; Kernel thread enabled ?
     2EF0 200E     
0050 2EF2 1602  14         jne   tmgr3                 ; No, skip to user hook
0051 2EF4 0460  28         b     @kthread              ; Run kernel thread
     2EF6 2F6E     
0052               *--------------------------------------------------------------
0053               * Run user hook
0054               *--------------------------------------------------------------
0055 2EF8 20A0  38 tmgr3   coc   @wbit6,config         ; User hook blocked ?
     2EFA 2014     
0056 2EFC 13EB  14         jeq   tmgr1
0057 2EFE 20A0  38         coc   @wbit7,config         ; User hook enabled ?
     2F00 2012     
0058 2F02 16E8  14         jne   tmgr1
0059 2F04 C120  34         mov   @wtiusr,tmp0
     2F06 832E     
0060 2F08 0454  20         b     *tmp0                 ; Run user hook
0061               *--------------------------------------------------------------
0062               * Do internal housekeeping
0063               *--------------------------------------------------------------
0064 2F0A 40A0  34 tmgr4   szc   @tmdat,config         ; Unblock kernel thread and user hook
     2F0C 2F6C     
0065 2F0E C10A  18         mov   r10,tmp0
0066 2F10 0244  22         andi  tmp0,>00ff            ; Clear HI byte
     2F12 00FF     
0067 2F14 20A0  38         coc   @wbit2,config         ; PAL flag set ?
     2F16 201C     
0068 2F18 1303  14         jeq   tmgr5
0069 2F1A 0284  22         ci    tmp0,60               ; 1 second reached ?
     2F1C 003C     
0070 2F1E 1002  14         jmp   tmgr6
0071 2F20 0284  22 tmgr5   ci    tmp0,50
     2F22 0032     
0072 2F24 1101  14 tmgr6   jlt   tmgr7                 ; No, continue
0073 2F26 1001  14         jmp   tmgr8
0074 2F28 058A  14 tmgr7   inc   r10                   ; Increase tick counter
0075               *--------------------------------------------------------------
0076               * Loop over slots
0077               *--------------------------------------------------------------
0078 2F2A C120  34 tmgr8   mov   @wtitab,tmp0          ; Pointer to timer table
     2F2C 832C     
0079 2F2E 024A  22         andi  r10,>ff00             ; Use R10LB as slot counter. Reset.
     2F30 FF00     
0080 2F32 C1D4  26 tmgr9   mov   *tmp0,tmp3            ; Is slot empty ?
0081 2F34 1316  14         jeq   tmgr11                ; Yes, get next slot
0082               *--------------------------------------------------------------
0083               *  Check if slot should be executed
0084               *--------------------------------------------------------------
0085 2F36 05C4  14         inct  tmp0                  ; Second word of slot data
0086 2F38 0594  26         inc   *tmp0                 ; Update tick count in slot
0087 2F3A C194  26         mov   *tmp0,tmp2            ; Get second word of slot data
0088 2F3C 9820  54         cb    @tmp2hb,@tmp2lb       ; Slot target count = Slot internal counter ?
     2F3E 830C     
     2F40 830D     
0089 2F42 1608  14         jne   tmgr10                ; No, get next slot
0090 2F44 0246  22         andi  tmp2,>ff00            ; Clear internal counter
     2F46 FF00     
0091 2F48 C506  30         mov   tmp2,*tmp0            ; Update timer table
0092               *--------------------------------------------------------------
0093               *  Run slot, we only need TMP0 to survive
0094               *--------------------------------------------------------------
0095 2F4A C804  38         mov   tmp0,@wtitmp          ; Save TMP0
     2F4C 8330     
0096 2F4E 0697  24         bl    *tmp3                 ; Call routine in slot
0097 2F50 C120  34 slotok  mov   @wtitmp,tmp0          ; Restore TMP0
     2F52 8330     
0098               *--------------------------------------------------------------
0099               *  Prepare for next slot
0100               *--------------------------------------------------------------
0101 2F54 058A  14 tmgr10  inc   r10                   ; Next slot
0102 2F56 9820  54         cb    @r10lb,@btihi         ; Last slot done ?
     2F58 8315     
     2F5A 8314     
0103 2F5C 1504  14         jgt   tmgr12                ; yes, Wait for next VDP interrupt
0104 2F5E 05C4  14         inct  tmp0                  ; Offset for next slot
0105 2F60 10E8  14         jmp   tmgr9                 ; Process next slot
0106 2F62 05C4  14 tmgr11  inct  tmp0                  ; Skip 2nd word of slot data
0107 2F64 10F7  14         jmp   tmgr10                ; Process next slot
0108 2F66 024A  22 tmgr12  andi  r10,>ff00             ; Use R10LB as tick counter. Reset.
     2F68 FF00     
0109 2F6A 10B4  14         jmp   tmgr1
0110 2F6C 0280     tmdat   data  >0280                 ; Bit 8 (kernel thread) and bit 6 (user hook)
0111               
                   < runlib.asm
...
0014               ********|*****|*********************|**************************
0015 2F6E E0A0  34 kthread soc   @wbit8,config         ; Block kernel thread
     2F70 2010     
0016               *--------------------------------------------------------------
0017               * Run sound player
0018               *--------------------------------------------------------------
0022 2F72 20A0  38         coc   @wbit13,config        ; Sound player on ?
     2F74 2006     
0023 2F76 1602  14         jne   kthread_kb
0024 2F78 06A0  32         bl    @sdpla1               ; Run sound player
     2F7A 284A     
0026               *--------------------------------------------------------------
...
0037               *--------------------------------------------------------------
0041 2F7C 06A0  32         bl    @realkb               ; Scan full keyboard
     2F7E 28CA     
0043               *--------------------------------------------------------------
0044               kthread_exit
0045 2F80 0460  28         b     @tmgr3                ; Exit
     2F82 2EF8     
                   < runlib.asm
...
0016               ********|*****|*********************|**************************
0017 2F84 C83B  50 mkhook  mov   *r11+,@wtiusr         ; Set user hook address
     2F86 832E     
0018 2F88 E0A0  34         soc   @wbit7,config         ; Enable user hook
     2F8A 2012     
0019 2F8C 045B  20 mkhoo1  b     *r11                  ; Return
0020      2ED4     hookok  equ   tmgr1                 ; Exit point for user hook
0021               
0022               
0023               ***************************************************************
...
0026               *  BL    @CLHOOK
0027               ********|*****|*********************|**************************
0028 2F8E 04E0  34 clhook  clr   @wtiusr               ; Unset user hook address
     2F90 832E     
0029 2F92 0242  22         andi  config,>feff          ; Disable user hook (bit 7=0)
     2F94 FEFF     
0030 2F96 045B  20         b     *r11                  ; Return
                   < runlib.asm
0236               
...
0016               ********|*****|*********************|**************************
0017 2F98 C13B  30 mkslot  mov   *r11+,tmp0
0018 2F9A C17B  30         mov   *r11+,tmp1
0019               *--------------------------------------------------------------
0020               *  Calculate address of slot
0021               *--------------------------------------------------------------
0022 2F9C C184  18         mov   tmp0,tmp2
0023 2F9E 0966  56         srl   tmp2,6                ; Right align & TMP2 = TMP2 * 4
0024 2FA0 A1A0  34         a     @wtitab,tmp2          ; Add table base
     2FA2 832C     
0025               *--------------------------------------------------------------
0026               *  Add slot to table
0027               *--------------------------------------------------------------
0028 2FA4 CD85  34         mov   tmp1,*tmp2+           ; Store address of subroutine
0029 2FA6 0A84  56         sla   tmp0,8                ; Get rid of slot number
0030 2FA8 C584  30         mov   tmp0,*tmp2            ; Store target count and reset tick count
0031               *--------------------------------------------------------------
0032               *  Check for end of list
0033               *--------------------------------------------------------------
0034 2FAA 881B  46         c     *r11,@w$ffff          ; End of list ?
     2FAC 2022     
0035 2FAE 1301  14         jeq   mkslo1                ; Yes, exit
0036 2FB0 10F3  14         jmp   mkslot                ; Process next entry
0037               *--------------------------------------------------------------
0038               *  Exit
0039               *--------------------------------------------------------------
0040 2FB2 05CB  14 mkslo1  inct  r11
0041 2FB4 045B  20         b     *r11                  ; Exit
0042               
0043               
0044               ***************************************************************
...
0050               *  P0 = Slot number
0051               ********|*****|*********************|**************************
0052 2FB6 C13B  30 clslot  mov   *r11+,tmp0
0053 2FB8 0A24  56 xlslot  sla   tmp0,2                ; TMP0 = TMP0*4
0054 2FBA A120  34         a     @wtitab,tmp0          ; Add table base
     2FBC 832C     
0055 2FBE 04F4  30         clr   *tmp0+                ; Clear 1st word of slot
0056 2FC0 04D4  26         clr   *tmp0                 ; Clear 2nd word of slot
0057 2FC2 045B  20         b     *r11                  ; Exit
0058               
0059               
0060               ***************************************************************
...
0066               *  P0 = Slot number
0067               ********|*****|*********************|**************************
0068 2FC4 C13B  30 rsslot  mov   *r11+,tmp0
0069 2FC6 0A24  56         sla   tmp0,2                ; TMP0 = TMP0*4
0070 2FC8 A120  34         a     @wtitab,tmp0          ; Add table base
     2FCA 832C     
0071 2FCC 05C4  14         inct  tmp0                  ; Skip 1st word of slot
0072 2FCE C154  26         mov   *tmp0,tmp1
0073 2FD0 0245  22         andi  tmp1,>ff00            ; Clear LSB (loop counter)
     2FD2 FF00     
0074 2FD4 C505  30         mov   tmp1,*tmp0
0075 2FD6 045B  20         b     *r11                  ; Exit
                   < runlib.asm
0240               
0241               
0242               
...
0259               ********|*****|*********************|**************************
0266 2FD8 04E0  34 runlib  clr   @>8302                ; Reset exit flag (R1 in workspace WS1!)
     2FDA 8302     
0268               *--------------------------------------------------------------
0269               * Alternative entry point
0270               *--------------------------------------------------------------
0271 2FDC 0300  24 runli1  limi  0                     ; Turn off interrupts
     2FDE 0000     
0272 2FE0 02E0  18         lwpi  ws1                   ; Activate workspace 1
     2FE2 8300     
0273 2FE4 C0E0  34         mov   @>83c0,r3             ; Get random seed from OS monitor
     2FE6 83C0     
0274               *--------------------------------------------------------------
0275               * Clear scratch-pad memory from R4 upwards
0276               *--------------------------------------------------------------
0277 2FE8 0202  20 runli2  li    r2,>8308
     2FEA 8308     
0278 2FEC 04F2  30 runli3  clr   *r2+                  ; Clear scratchpad >8306->83FF
0279 2FEE 0282  22         ci    r2,>8400
     2FF0 8400     
0280 2FF2 16FC  14         jne   runli3
0281               *--------------------------------------------------------------
0282               * Exit to TI-99/4A title screen ?
0283               *--------------------------------------------------------------
0284 2FF4 0281  22 runli3a ci    r1,>ffff              ; Exit flag set ?
     2FF6 FFFF     
0285 2FF8 1602  14         jne   runli4                ; No, continue
0286 2FFA 0420  54         blwp  @0                    ; Yes, bye bye
     2FFC 0000     
0287               *--------------------------------------------------------------
0288               * Determine if VDP is PAL or NTSC
0289               *--------------------------------------------------------------
0290 2FFE C803  38 runli4  mov   r3,@waux1             ; Store random seed
     3000 833C     
0291 3002 04C1  14         clr   r1                    ; Reset counter
0292 3004 0202  20         li    r2,10                 ; We test 10 times
     3006 000A     
0293 3008 C0E0  34 runli5  mov   @vdps,r3
     300A 8802     
0294 300C 20E0  38         coc   @wbit0,r3             ; Interupt flag set ?
     300E 2020     
0295 3010 1302  14         jeq   runli6
0296 3012 0581  14         inc   r1                    ; Increase counter
0297 3014 10F9  14         jmp   runli5
0298 3016 0602  14 runli6  dec   r2                    ; Next test
0299 3018 16F7  14         jne   runli5
0300 301A 0281  22         ci    r1,>1250              ; Max for NTSC reached ?
     301C 1250     
0301 301E 1202  14         jle   runli7                ; No, so it must be NTSC
0302 3020 0262  22         ori   config,palon          ; Yes, it must be PAL, set flag
     3022 201C     
0303               *--------------------------------------------------------------
0304               * Copy machine code to scratchpad (prepare tight loop)
0305               *--------------------------------------------------------------
0306 3024 06A0  32 runli7  bl    @loadmc
     3026 222E     
0307               *--------------------------------------------------------------
0308               * Initialize registers, memory, ...
0309               *--------------------------------------------------------------
0310 3028 04C1  14 runli9  clr   r1
0311 302A 04C2  14         clr   r2
0312 302C 04C3  14         clr   r3
0313 302E 0209  20         li    stack,sp2.stktop      ; Set top of stack (grows downwards!)
     3030 83A0     
0314 3032 020F  20         li    r15,vdpw              ; Set VDP write address
     3034 8C00     
0316 3036 06A0  32         bl    @mute                 ; Mute sound generators
     3038 280E     
0318               *--------------------------------------------------------------
0319               * Setup video memory
0320               *--------------------------------------------------------------
0322 303A 0280  22         ci    r0,>4a4a              ; Crash flag set?
     303C 4A4A     
0323 303E 1605  14         jne   runlia
0324 3040 06A0  32         bl    @filv                 ; Clear 12K VDP memory instead
     3042 22A2     
0325 3044 0000             data  >0000,>00,>3000       ; of 16K, so that PABs survive
     3046 0000     
     3048 3000     
0330 304A 06A0  32 runlia  bl    @filv
     304C 22A2     
0331 304E 0FC0             data  pctadr,spfclr,16      ; Load color table
     3050 00F4     
     3052 0010     
0332               *--------------------------------------------------------------
0333               * Check if there is a F18A present
0334               *--------------------------------------------------------------
0338 3054 06A0  32         bl    @f18unl               ; Unlock the F18A
     3056 273E     
0339 3058 06A0  32         bl    @f18chk               ; Check if F18A is there \
     305A 2768     
0340 305C 06A0  32         bl    @f18chk               ; Check if F18A is there | js99er bug?
     305E 2768     
0341 3060 06A0  32         bl    @f18chk               ; Check if F18A is there /
     3062 2768     
0342 3064 06A0  32         bl    @f18lck               ; Lock the F18A again
     3066 2754     
0343               
0344 3068 06A0  32         bl    @putvr                ; Reset all F18a extended registers
     306A 2346     
0345 306C 3201                   data >3201            ; F18a VR50 (>32), bit 1
0347               *--------------------------------------------------------------
...
0357               *--------------------------------------------------------------
0358 306E 06A0  32 runlic  bl    @vidtab               ; Load video mode table into VDP
     3070 230C     
0359 3072 362C             data  spvmod                ; Equate selected video mode table
0360 3074 0204  20         li    tmp0,spfont           ; Get font option
     3076 000C     
0361 3078 0544  14         inv   tmp0                  ; NOFONT (>FFFF) specified ?
0362 307A 1304  14         jeq   runlid                ; Yes, skip it
0363 307C 06A0  32         bl    @ldfnt
     307E 2374     
0364 3080 1100             data  fntadr,spfont         ; Load specified font
     3082 000C     
0365               *--------------------------------------------------------------
0366               * Did a system crash occur before runlib was called?
0367               *--------------------------------------------------------------
0368 3084 0280  22 runlid  ci    r0,>4a4a              ; Crash flag set?
     3086 4A4A     
0369 3088 1602  14         jne   runlie                ; No, continue
0370 308A 0460  28         b     @cpu.crash.main       ; Yes, back to crash handler
     308C 2086     
0371               *--------------------------------------------------------------
0372               * Branch to main program
0373               *--------------------------------------------------------------
0374 308E 0262  22 runlie  ori   config,>0040          ; Enable kernel thread (bit 9 on)
     3090 0040     
...
0019               ********|*****|*********************|**************************
0020               rom.farjump:
0021 3096 C13B  30         mov   *r11+,tmp0            ; P0
0022 3098 C17B  30         mov   *r11+,tmp1            ; P1
0023 309A C1BB  30         mov   *r11+,tmp2            ; P2
0024                       ;------------------------------------------------------
0025                       ; Push registers to value stack (but not r11!)
0026                       ;------------------------------------------------------
0027               xrom.farjump:
0028 309C 0649  14         dect  stack
0029 309E C644  30         mov   tmp0,*stack           ; Push tmp0
0030 30A0 0649  14         dect  stack
0031 30A2 C645  30         mov   tmp1,*stack           ; Push tmp1
0032 30A4 0649  14         dect  stack
0033 30A6 C646  30         mov   tmp2,*stack           ; Push tmp2
0034 30A8 0649  14         dect  stack
0035 30AA C647  30         mov   tmp3,*stack           ; Push tmp3
0036                       ;------------------------------------------------------
0037                       ; Push to farjump return stack
0038                       ;------------------------------------------------------
0039 30AC 0284  22         ci    tmp0,>6000            ; Invalid bank write address?
     30AE 6000     
0040 30B0 1116  14         jlt   rom.farjump.bankswitch.failed1
0041                                                   ; Crash if bogus value in bank write address
0042               
0043 30B2 C1E0  34         mov   @tv.fj.stackpnt,tmp3  ; Get farjump stack pointer
     30B4 A226     
0044 30B6 0647  14         dect  tmp3
0045 30B8 C5CB  30         mov   r11,*tmp3             ; Push return address to farjump stack
0046 30BA 0647  14         dect  tmp3
0047 30BC C5C6  30         mov   tmp2,*tmp3            ; Push source ROM bank to farjump stack
0048 30BE C807  38         mov   tmp3,@tv.fj.stackpnt  ; Set farjump stack pointer
     30C0 A226     
0049               
0053               
0054                       ;------------------------------------------------------
...
0058 30C2 04D4  26         clr   *tmp0                 ; Switch to target ROM bank 8K >6000
0059 30C4 1004  14         jmp   rom.farjump.bankswitch.tgt.done
0060                       ;------------------------------------------------------
0061                       ; Bankswitch to target 4K ROM / 4K RAM banks (FG99 advanced mode)
0062                       ;------------------------------------------------------
0063               rom.farjump.bankswitch.tgt.advfg99:
0064 30C6 04D4  26         clr   *tmp0                 ; Switch to target ROM bank 4K >6000
0065 30C8 0224  22         ai    tmp0,>0800
     30CA 0800     
0066 30CC 04D4  26         clr   *tmp0                 ; Switch to target RAM bank 4K >7000
0067                       ;------------------------------------------------------
...
0073                       ;------------------------------------------------------
0074 30CE 0285  22         ci    tmp1,>ffff
     30D0 FFFF     
0075 30D2 1602  14         jne   !
0076 30D4 C160  34         mov   @trmpvector,tmp1
     30D6 A02E     
0077                       ;------------------------------------------------------
0078                       ; Deref value in vector
0079                       ;------------------------------------------------------
0080 30D8 C115  26 !       mov   *tmp1,tmp0            ; Deref value in vector address
0081 30DA 1301  14         jeq   rom.farjump.bankswitch.failed1
0082                                                   ; Crash if null-pointer in vector
0083               
0084 30DC 1004  14         jmp   rom.farjump.bankswitch.call
0085                                                   ; Call function in target bank
0086                       ;------------------------------------------------------
0087                       ; Assert 1 failed before bank-switch
0088                       ;------------------------------------------------------
0089               rom.farjump.bankswitch.failed1:
0090 30DE C80B  38         mov   r11,@>ffce            ; \ Save caller address
     30E0 FFCE     
0091 30E2 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     30E4 2026     
0092                       ;------------------------------------------------------
0093                       ; Call function in target bank
0094                       ;------------------------------------------------------
0095               rom.farjump.bankswitch.call:
0096 30E6 0694  24         bl    *tmp0                 ; Call function
0097                       ;------------------------------------------------------
0098                       ; Bankswitch back to source bank
0099                       ;------------------------------------------------------
0100               rom.farjump.return:
0101 30E8 C120  34         mov   @tv.fj.stackpnt,tmp0  ; Get farjump stack pointer
     30EA A226     
0102 30EC C154  26         mov   *tmp0,tmp1            ; Get bank write address of caller
0103 30EE 1312  14         jeq   rom.farjump.bankswitch.failed2
0104                                                   ; Crash if null-pointer in address
0105               
0106 30F0 04F4  30         clr   *tmp0+                ; Remove bank write address from
0107                                                   ; farjump stack
0108               
0109 30F2 C2D4  26         mov   *tmp0,r11             ; Get return addr of caller for return
0110               
0111 30F4 04F4  30         clr   *tmp0+                ; Remove return address of caller from
0112                                                   ; farjump stack
0113               
0114 30F6 028B  22         ci    r11,>6000
     30F8 6000     
0115 30FA 110C  14         jlt   rom.farjump.bankswitch.failed2
0116 30FC 028B  22         ci    r11,>7fff
     30FE 7FFF     
0117 3100 1509  14         jgt   rom.farjump.bankswitch.failed2
0118               
0119 3102 C804  38         mov   tmp0,@tv.fj.stackpnt  ; Update farjump return stack pointer
     3104 A226     
0120               
0124               
0125                       ;------------------------------------------------------
...
0129 3106 04D5  26         clr   *tmp1                 ; Switch to source ROM bank 8K >6000
0130 3108 1009  14         jmp   rom.farjump.exit
0131                       ;------------------------------------------------------
0132                       ; Bankswitch to source 4K ROM / 4K RAM banks (FG99 advanced mode)
0133                       ;------------------------------------------------------
0134               rom.farjump.bankswitch.src.advfg99:
0135 310A 04D5  26         clr   *tmp1                 ; Switch to source ROM bank 4K >6000
0136 310C 0225  22         ai    tmp1,>0800
     310E 0800     
0137 3110 04D5  26         clr   *tmp1                 ; Switch to source RAM bank 4K >7000
0138 3112 1004  14         jmp   rom.farjump.exit
0139                       ;------------------------------------------------------
0140                       ; Assert 2 failed after bank-switch
0141                       ;------------------------------------------------------
0142               rom.farjump.bankswitch.failed2:
0143 3114 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     3116 FFCE     
0144 3118 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     311A 2026     
0145                       ;-------------------------------------------------------
0146                       ; Exit
0147                       ;-------------------------------------------------------
0148               rom.farjump.exit:
0149 311C C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0150 311E C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0151 3120 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0152 3122 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0153 3124 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0018               ********|*****|*********************|**************************
0019               fb.init:
0020 3126 0649  14         dect  stack
0021 3128 C64B  30         mov   r11,*stack            ; Save return address
0022 312A 0649  14         dect  stack
0023 312C C644  30         mov   tmp0,*stack           ; Push tmp0
0024 312E 0649  14         dect  stack
0025 3130 C645  30         mov   tmp1,*stack           ; Push tmp1
0026                       ;------------------------------------------------------
0027                       ; Initialize
0028                       ;------------------------------------------------------
0029 3132 0204  20         li    tmp0,fb.top
     3134 D000     
0030 3136 C804  38         mov   tmp0,@fb.top.ptr      ; Set pointer to framebuffer
     3138 A300     
0031 313A 04E0  34         clr   @fb.topline           ; Top line in framebuffer
     313C A304     
0032 313E 04E0  34         clr   @fb.row               ; Current row=0
     3140 A306     
0033 3142 04E0  34         clr   @fb.column            ; Current column=0
     3144 A30C     
0034               
0035 3146 0204  20         li    tmp0,colrow
     3148 0050     
0036 314A C804  38         mov   tmp0,@fb.colsline     ; Columns per row=80
     314C A30E     
0037                       ;------------------------------------------------------
0038                       ; Determine size of rows on screen
0039                       ;------------------------------------------------------
0040 314E C160  34         mov   @tv.ruler.visible,tmp1
     3150 A210     
0041 3152 1303  14         jeq   !                     ; Skip if ruler is hidden
0042 3154 0204  20         li    tmp0,pane.botrow-2
     3156 001B     
0043 3158 1002  14         jmp   fb.init.cont
0044 315A 0204  20 !       li    tmp0,pane.botrow-1
     315C 001C     
0045                       ;------------------------------------------------------
0046                       ; Continue initialisation
0047                       ;------------------------------------------------------
0048               fb.init.cont:
0049 315E C804  38         mov   tmp0,@fb.scrrows      ; Physical rows on screen for fb
     3160 A31A     
0050 3162 C804  38         mov   tmp0,@fb.scrrows.max  ; Maximum number of physical rows for fb
     3164 A31C     
0051               
0052 3166 04E0  34         clr   @tv.pane.focus        ; Frame buffer has focus!
     3168 A222     
0053 316A 04E0  34         clr   @fb.colorize          ; Don't colorize M1/M2 lines
     316C A310     
0054 316E 0720  34         seto  @fb.dirty             ; Set dirty flag (trigger screen update)
     3170 A316     
0055 3172 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     3174 A318     
0056                       ;------------------------------------------------------
0057                       ; Clear frame buffer
0058                       ;------------------------------------------------------
0059 3176 06A0  32         bl    @film
     3178 224A     
0060 317A D000             data  fb.top,>00,fb.size    ; Clear it all the way
     317C 0000     
     317E 0960     
0061                       ;------------------------------------------------------
0062                       ; Exit
0063                       ;------------------------------------------------------
0064               fb.init.exit:
0065 3180 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0066 3182 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0067 3184 C2F9  30         mov   *stack+,r11           ; Pop r11
0068 3186 045B  20         b     *r11                  ; Return to caller
0069               
                   < ram.resident.asm
...
0049               ********|*****|*********************|**************************
0050               idx.init:
0051 3188 0649  14         dect  stack
0052 318A C64B  30         mov   r11,*stack            ; Save return address
0053 318C 0649  14         dect  stack
0054 318E C644  30         mov   tmp0,*stack           ; Push tmp0
0055                       ;------------------------------------------------------
0056                       ; Initialize
0057                       ;------------------------------------------------------
0058 3190 0204  20         li    tmp0,idx.top
     3192 B000     
0059 3194 C804  38         mov   tmp0,@edb.index.ptr   ; Set pointer to index in editor structure
     3196 A502     
0060               
0061 3198 C120  34         mov   @tv.sams.b000,tmp0
     319A A206     
0062 319C C804  38         mov   tmp0,@idx.sams.page   ; Set current SAMS page
     319E A600     
0063 31A0 C804  38         mov   tmp0,@idx.sams.lopage ; Set 1st SAMS page
     31A2 A602     
0064                       ;------------------------------------------------------
0065                       ; Clear all index pages
0066                       ;------------------------------------------------------
0067 31A4 0224  22         ai    tmp0,4                ; \ Let's clear all index pages
     31A6 0004     
0068 31A8 C804  38         mov   tmp0,@idx.sams.hipage ; /
     31AA A604     
0069               
0070 31AC 06A0  32         bl    @_idx.sams.mapcolumn.on
     31AE 31CA     
0071                                                   ; Index in continuous memory region
0072               
0073 31B0 06A0  32         bl    @film
     31B2 224A     
0074 31B4 B000                   data idx.top,>00,idx.size * 5
     31B6 0000     
     31B8 5000     
0075                                                   ; Clear index
0076               
0077 31BA 06A0  32         bl    @_idx.sams.mapcolumn.off
     31BC 31FE     
0078                                                   ; Restore memory window layout
0079               
0080 31BE C820  54         mov   @idx.sams.lopage,@idx.sams.hipage
     31C0 A602     
     31C2 A604     
...
0084                       ;------------------------------------------------------
0085               idx.init.exit:
0086 31C4 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0087 31C6 C2F9  30         mov   *stack+,r11           ; Pop r11
0088 31C8 045B  20         b     *r11                  ; Return to caller
0089               
0090               
0091               ***************************************************************
...
0101 31CA 0649  14         dect  stack
0102 31CC C64B  30         mov   r11,*stack            ; Push return address
0103 31CE 0649  14         dect  stack
0104 31D0 C644  30         mov   tmp0,*stack           ; Push tmp0
0105 31D2 0649  14         dect  stack
0106 31D4 C645  30         mov   tmp1,*stack           ; Push tmp1
0107 31D6 0649  14         dect  stack
0108 31D8 C646  30         mov   tmp2,*stack           ; Push tmp2
0109               *--------------------------------------------------------------
0110               * Map index pages into memory window  (b000-ffff)
0111               *--------------------------------------------------------------
0112 31DA C120  34         mov   @idx.sams.lopage,tmp0 ; Get lowest index page
     31DC A602     
0113 31DE 0205  20         li    tmp1,idx.top
     31E0 B000     
0114 31E2 0206  20         li    tmp2,5                ; Set loop counter. all pages of index
     31E4 0005     
0115                       ;-------------------------------------------------------
0116                       ; Loop over banks
0117                       ;-------------------------------------------------------
0118 31E6 06A0  32 !       bl    @xsams.page.set       ; Set SAMS page
     31E8 258A     
0119                                                   ; \ i  tmp0  = SAMS page number
0120                                                   ; / i  tmp1  = Memory address
0121               
0122 31EA 0584  14         inc   tmp0                  ; Next SAMS index page
0123 31EC 0225  22         ai    tmp1,>1000            ; Next memory region
     31EE 1000     
0124 31F0 0606  14         dec   tmp2                  ; Update loop counter
0125 31F2 15F9  14         jgt   -!                    ; Next iteration
0126               *--------------------------------------------------------------
0127               * Exit
0128               *--------------------------------------------------------------
0129               _idx.sams.mapcolumn.on.exit:
0130 31F4 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0131 31F6 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0132 31F8 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0133 31FA C2F9  30         mov   *stack+,r11           ; Pop return address
0134 31FC 045B  20         b     *r11                  ; Return to caller
0135               
0136               
0137               ***************************************************************
...
0150 31FE 0649  14         dect  stack
0151 3200 C64B  30         mov   r11,*stack            ; Push return address
0152 3202 0649  14         dect  stack
0153 3204 C644  30         mov   tmp0,*stack           ; Push tmp0
0154 3206 0649  14         dect  stack
0155 3208 C645  30         mov   tmp1,*stack           ; Push tmp1
0156 320A 0649  14         dect  stack
0157 320C C646  30         mov   tmp2,*stack           ; Push tmp2
0158 320E 0649  14         dect  stack
0159 3210 C647  30         mov   tmp3,*stack           ; Push tmp3
0160               *--------------------------------------------------------------
0161               * Map index pages into memory window  (b000-????)
0162               *--------------------------------------------------------------
0163 3212 0205  20         li    tmp1,idx.top
     3214 B000     
0164 3216 0206  20         li    tmp2,5                ; Always 5 pages
     3218 0005     
0165 321A 0207  20         li    tmp3,tv.sams.b000     ; Pointer to fist SAMS page
     321C A206     
0166                       ;-------------------------------------------------------
0167                       ; Loop over table in memory (@tv.sams.b000:@tv.sams.f000)
0168                       ;-------------------------------------------------------
0169 321E C137  30 !       mov   *tmp3+,tmp0           ; Get SAMS page
0170               
0171 3220 06A0  32         bl    @xsams.page.set       ; Set SAMS page
     3222 258A     
0172                                                   ; \ i  tmp0  = SAMS page number
0173                                                   ; / i  tmp1  = Memory address
0174               
0175 3224 0225  22         ai    tmp1,>1000            ; Next memory region
     3226 1000     
0176 3228 0606  14         dec   tmp2                  ; Update loop counter
0177 322A 15F9  14         jgt   -!                    ; Next iteration
0178               *--------------------------------------------------------------
0179               * Exit
0180               *--------------------------------------------------------------
0181               _idx.sams.mapcolumn.off.exit:
0182 322C C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0183 322E C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0184 3230 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0185 3232 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0186 3234 C2F9  30         mov   *stack+,r11           ; Pop return address
0187 3236 045B  20         b     *r11                  ; Return to caller
0188               
0189               
0190               
0191               ***************************************************************
...
0211 3238 0649  14         dect  stack
0212 323A C64B  30         mov   r11,*stack            ; Save return address
0213 323C 0649  14         dect  stack
0214 323E C644  30         mov   tmp0,*stack           ; Push tmp0
0215 3240 0649  14         dect  stack
0216 3242 C645  30         mov   tmp1,*stack           ; Push tmp1
0217 3244 0649  14         dect  stack
0218 3246 C646  30         mov   tmp2,*stack           ; Push tmp2
0219                       ;------------------------------------------------------
0220                       ; Determine SAMS index page
0221                       ;------------------------------------------------------
0222 3248 C184  18         mov   tmp0,tmp2             ; Line number
0223 324A 04C5  14         clr   tmp1                  ; MSW (tmp1) = 0 / LSW (tmp2) = Line number
0224 324C 0204  20         li    tmp0,2048             ; Index entries in 4K SAMS page
     324E 0800     
0225               
0226 3250 3D44 128         div   tmp0,tmp1             ; \ Divide 32 bit value by 2048
0227                                                   ; | tmp1 = quotient  (SAMS page offset)
0228                                                   ; / tmp2 = remainder
0229               
0230 3252 0A16  56         sla   tmp2,1                ; line number * 2
0231 3254 C806  38         mov   tmp2,@outparm1        ; Offset index entry
     3256 A010     
0232               
0233 3258 A160  34         a     @idx.sams.lopage,tmp1 ; Add SAMS page base
     325A A602     
0234 325C 8805  38         c     tmp1,@idx.sams.page   ; Page already active?
     325E A600     
0235               
0236 3260 130E  14         jeq   _idx.samspage.get.exit
0237                                                   ; Yes, so exit
0238                       ;------------------------------------------------------
0239                       ; Activate SAMS index page
0240                       ;------------------------------------------------------
0241 3262 C805  38         mov   tmp1,@idx.sams.page   ; Set current SAMS page
     3264 A600     
0242 3266 C805  38         mov   tmp1,@tv.sams.b000    ; Also keep SAMS window synced in Stevie
     3268 A206     
0243 326A C105  18         mov   tmp1,tmp0             ; Destination SAMS page
0244               
0245 326C 0205  20         li    tmp1,>b000            ; Memory window for index page
     326E B000     
0246               
0247 3270 06A0  32         bl    @xsams.page.set       ; Switch to SAMS page
     3272 258A     
...
0252                       ;------------------------------------------------------
0253 3274 8804  38         c     tmp0,@idx.sams.hipage ; New highest page?
     3276 A604     
0254 3278 1202  14         jle   _idx.samspage.get.exit
0255                                                   ; No, exit
0256 327A C804  38         mov   tmp0,@idx.sams.hipage ; Yes, set highest SAMS index page
     327C A604     
0257                       ;------------------------------------------------------
0258                       ; Exit
0259                       ;------------------------------------------------------
0260               _idx.samspage.get.exit:
0261 327E C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0262 3280 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0263 3282 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0264 3284 C2F9  30         mov   *stack+,r11           ; Pop r11
0265 3286 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0020               ***************************************************************
0021               edb.init:
0022 3288 0649  14         dect  stack
0023 328A C64B  30         mov   r11,*stack            ; Save return address
0024 328C 0649  14         dect  stack
0025 328E C644  30         mov   tmp0,*stack           ; Push tmp0
0026                       ;------------------------------------------------------
0027                       ; Initialize
0028                       ;------------------------------------------------------
0029 3290 0204  20         li    tmp0,edb.top          ; \
     3292 C000     
0030 3294 C804  38         mov   tmp0,@edb.top.ptr     ; / Set pointer to top of editor buffer
     3296 A500     
0031 3298 C804  38         mov   tmp0,@edb.next_free.ptr
     329A A508     
0032                                                   ; Set pointer to next free line
0033               
0034 329C 0720  34         seto  @edb.insmode          ; Turn on insert mode for this editor buffer
     329E A50A     
0035               
0036 32A0 0204  20         li    tmp0,1
     32A2 0001     
0037 32A4 C804  38         mov   tmp0,@edb.lines       ; Lines=1
     32A6 A504     
0038               
0039 32A8 0720  34         seto  @edb.block.m1         ; Reset block start line
     32AA A50C     
0040 32AC 0720  34         seto  @edb.block.m2         ; Reset block end line
     32AE A50E     
0041               
0042 32B0 0204  20         li    tmp0,txt.newfile      ; "New file"
     32B2 3836     
0043 32B4 C804  38         mov   tmp0,@edb.filename.ptr
     32B6 A512     
0044               
0045 32B8 04E0  34         clr   @fh.kilobytes         ; \ Clear kilobytes processed
     32BA A440     
0046 32BC 04E0  34         clr   @fh.kilobytes.prev    ; /
     32BE A45C     
0047               
0048 32C0 0204  20         li    tmp0,txt.filetype.none
     32C2 38F2     
0049 32C4 C804  38         mov   tmp0,@edb.filetype.ptr
     32C6 A514     
0050               
0051               edb.init.exit:
0052                       ;------------------------------------------------------
0053                       ; Exit
0054                       ;------------------------------------------------------
0055 32C8 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0056 32CA C2F9  30         mov   *stack+,r11           ; Pop r11
0057 32CC 045B  20         b     *r11                  ; Return to caller
0058               
0059               
0060               
0061               
...
0026 3312 0649  14         dect  stack
0027 3314 C645  30         mov   tmp1,*stack           ; Push tmp1
0028 3316 0649  14         dect  stack
0029 3318 C646  30         mov   tmp2,*stack           ; Push tmp2
0030                       ;------------------------------------------------------
0031                       ; Initialize
0032                       ;------------------------------------------------------
0033 331A 04E0  34         clr   @tv.error.visible     ; Set to hidden
     331C A228     
0034 331E 0204  20         li    tmp0,3
     3320 0003     
0035 3322 C804  38         mov   tmp0,@tv.error.rows   ; Number of rows in error pane
     3324 A22A     
0036               
0037 3326 06A0  32         bl    @film
     3328 224A     
0038 332A A230                   data tv.error.msg,0,160
     332C 0000     
     332E 00A0     
0039                       ;-------------------------------------------------------
0040                       ; Exit
0041                       ;-------------------------------------------------------
0042               errpane.exit:
0043 3330 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0044 3332 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0045 3334 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0046 3336 C2F9  30         mov   *stack+,r11           ; Pop R11
0047 3338 045B  20         b     *r11                  ; Return to caller
0048               
                   < ram.resident.asm
...
0020               ***************************************************************
0021               tv.init:
0022 333A 0649  14         dect  stack
0023 333C C64B  30         mov   r11,*stack            ; Save return address
0024 333E 0649  14         dect  stack
0025 3340 C644  30         mov   tmp0,*stack           ; Push tmp0
0026 3342 0649  14         dect  stack
0027 3344 C645  30         mov   tmp1,*stack           ; Push tmp1
0028 3346 0649  14         dect  stack
0029 3348 C646  30         mov   tmp2,*stack           ; Push tmp2
0030                       ;------------------------------------------------------
0031                       ; Initialize
0032                       ;------------------------------------------------------
0033 334A 0204  20         li    tmp0,1                ; \ Set default color scheme
     334C 0001     
0034 334E C804  38         mov   tmp0,@tv.colorscheme  ; /
     3350 A212     
0035               
0036 3352 04E0  34         clr   @tv.task.oneshot      ; Reset pointer to oneshot task
     3354 A224     
0037 3356 E0A0  34         soc   @wbit10,config        ; Assume ALPHA LOCK is down
     3358 200C     
0038               
0039 335A 0204  20         li    tmp0,fj.bottom
     335C B000     
0040 335E C804  38         mov   tmp0,@tv.fj.stackpnt  ; Set pointer to farjump return stack
     3360 A226     
0041                       ;------------------------------------------------------
0042                       ; Set defaults
0043                       ;------------------------------------------------------
0044 3362 06A0  32         bl    @cpym2m
     3364 24EE     
0045 3366 39CA                   data def.printer.fname,tv.printer.fname,7
     3368 D960     
     336A 0007     
0046               
0047 336C 06A0  32         bl    @cpym2m
     336E 24EE     
0048 3370 39D2                   data def.clip.fname,tv.clip.fname,10
     3372 D9B0     
     3374 000A     
0049                       ;-------------------------------------------------------
0050                       ; Exit
0051                       ;-------------------------------------------------------
0052               tv.init.exit:
0053 3376 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0054 3378 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0055 337A C139  30         mov   *stack+,tmp0          ; Pop tmp0
0056 337C C2F9  30         mov   *stack+,r11           ; Pop R11
0057 337E 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0022                       ;-------------------------------------------------------
0023 3380 06A0  32         bl    @f18rst               ; Reset and lock the F18A
     3382 27BA     
0024                       ;-------------------------------------------------------
0025                       ; Set SAMS transparent mode
0026                       ;-------------------------------------------------------
0027 3384 06A0  32         bl    @mem.sams.set.legacy  ; Load legacy SAMS page layout
     3386 7D60     
0028               
0029 3388 020C  20         li    r12,>1e00             ; SAMS CRU address
     338A 1E00     
0030 338C 1E01  20         sbz   1                     ; Disable SAMS mapper
0031               
0032 338E 04E0  34         clr   @bank0.rom            ; Activate bank 0
     3390 6000     
0033 3392 0420  54         blwp  @0                    ; Reset to monitor
     3394 0000     
                   < ram.resident.asm
...
0021               ***************************************************************
0022               tv.reset:
0023 3396 0649  14         dect  stack
0024 3398 C64B  30         mov   r11,*stack            ; Save return address
0025                       ;------------------------------------------------------
0026                       ; Reset editor
0027                       ;------------------------------------------------------
0028 339A 06A0  32         bl    @cmdb.init            ; Initialize command buffer
     339C 32CE     
0029 339E 06A0  32         bl    @edb.init             ; Initialize editor buffer
     33A0 3288     
0030 33A2 06A0  32         bl    @idx.init             ; Initialize index
     33A4 3188     
0031 33A6 06A0  32         bl    @fb.init              ; Initialize framebuffer
     33A8 3126     
0032 33AA 06A0  32         bl    @errpane.init         ; Initialize error pane
     33AC 330A     
0033                       ;------------------------------------------------------
0034                       ; Remove markers and shortcuts
0035                       ;------------------------------------------------------
0036 33AE 06A0  32         bl    @hchar
     33B0 27E6     
0037 33B2 0034                   byte 0,52,32,18           ; Remove markers
     33B4 2012     
0038 33B6 1D00                   byte pane.botrow,0,32,51  ; Remove block shortcuts
     33B8 2033     
0039 33BA FFFF                   data eol
0040                       ;-------------------------------------------------------
0041                       ; Exit
0042                       ;-------------------------------------------------------
0043               tv.reset.exit:
0044 33BC C2F9  30         mov   *stack+,r11           ; Pop R11
0045 33BE 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0020 33C0 0649  14         dect  stack
0021 33C2 C64B  30         mov   r11,*stack            ; Save return address
0022 33C4 0649  14         dect  stack
0023 33C6 C644  30         mov   tmp0,*stack           ; Push tmp0
0024                       ;------------------------------------------------------
0025                       ; Initialize
0026                       ;------------------------------------------------------
0027 33C8 06A0  32         bl    @mknum                ; Convert unsigned number to string
     33CA 2AB4     
0028 33CC A000                   data parm1            ; \ i p0  = Pointer to 16bit unsigned number
0029 33CE A100                   data rambuf           ; | i p1  = Pointer to 5 byte string buffer
0030 33D0 30                     byte 48               ; | i p2H = Offset for ASCII digit 0
0031 33D1   20                   byte 32               ; / i p2L = Char for replacing leading 0's
0032               
0033 33D2 0204  20         li    tmp0,unpacked.string
     33D4 A026     
0034 33D6 04F4  30         clr   *tmp0+                ; Clear string 01
0035 33D8 04F4  30         clr   *tmp0+                ; Clear string 23
0036 33DA 04F4  30         clr   *tmp0+                ; Clear string 34
0037               
0038 33DC 06A0  32         bl    @trimnum              ; Trim unsigned number string
     33DE 2B0C     
0039 33E0 A100                   data rambuf           ; \ i p0  = Pointer to 5 byte string buffer
0040 33E2 A026                   data unpacked.string  ; | i p1  = Pointer to output buffer
0041 33E4 0020                   data 32               ; / i p2  = Padding char to match against
0042                       ;-------------------------------------------------------
0043                       ; Exit
0044                       ;-------------------------------------------------------
0045               tv.unpack.uint16.exit:
0046 33E6 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0047 33E8 C2F9  30         mov   *stack+,r11           ; Pop r11
0048 33EA 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0022               ***************************************************************
0023               tv.pad.string:
0024 33EC 0649  14         dect  stack
0025 33EE C64B  30         mov   r11,*stack            ; Push return address
0026 33F0 0649  14         dect  stack
0027 33F2 C644  30         mov   tmp0,*stack           ; Push tmp0
0028 33F4 0649  14         dect  stack
0029 33F6 C645  30         mov   tmp1,*stack           ; Push tmp1
0030 33F8 0649  14         dect  stack
0031 33FA C646  30         mov   tmp2,*stack           ; Push tmp2
0032 33FC 0649  14         dect  stack
0033 33FE C647  30         mov   tmp3,*stack           ; Push tmp3
0034                       ;------------------------------------------------------
0035                       ; Asserts
0036                       ;------------------------------------------------------
0037 3400 C120  34         mov   @parm1,tmp0           ; \ Get string prefix (length-byte)
     3402 A000     
0038 3404 D194  26         movb  *tmp0,tmp2            ; /
0039 3406 0986  56         srl   tmp2,8                ; Right align
0040 3408 C1C6  18         mov   tmp2,tmp3             ; Make copy of length-byte for later use
0041               
0042 340A 8806  38         c     tmp2,@parm2           ; String length > requested length?
     340C A002     
0043 340E 1520  14         jgt   tv.pad.string.panic   ; Yes, crash
0044                       ;------------------------------------------------------
0045                       ; Copy string to buffer
0046                       ;------------------------------------------------------
0047 3410 C120  34         mov   @parm1,tmp0           ; Get source address
     3412 A000     
0048 3414 C160  34         mov   @parm4,tmp1           ; Get destination address
     3416 A006     
0049 3418 0586  14         inc   tmp2                  ; Also include length-byte in copy
0050               
0051 341A 0649  14         dect  stack
0052 341C C647  30         mov   tmp3,*stack           ; Push tmp3 (get overwritten by xpym2m)
0053               
0054 341E 06A0  32         bl    @xpym2m               ; Copy length-prefix string to buffer
     3420 24F4     
0055                                                   ; \ i  tmp0 = Source CPU memory address
0056                                                   ; | i  tmp1 = Target CPU memory address
0057                                                   ; / i  tmp2 = Number of bytes to copy
0058               
0059 3422 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0060                       ;------------------------------------------------------
0061                       ; Set length of new string
0062                       ;------------------------------------------------------
0063 3424 C120  34         mov   @parm2,tmp0           ; Get requested length
     3426 A002     
0064 3428 0A84  56         sla   tmp0,8                ; Left align
0065 342A C160  34         mov   @parm4,tmp1           ; Get pointer to buffer
     342C A006     
0066 342E D544  30         movb  tmp0,*tmp1            ; Set new length of string
0067 3430 A147  18         a     tmp3,tmp1             ; \ Skip to end of string
0068 3432 0585  14         inc   tmp1                  ; /
0069                       ;------------------------------------------------------
0070                       ; Prepare for padding string
0071                       ;------------------------------------------------------
0072 3434 C1A0  34         mov   @parm2,tmp2           ; \ Get number of bytes to fill
     3436 A002     
0073 3438 6187  18         s     tmp3,tmp2             ; |
0074 343A 0586  14         inc   tmp2                  ; /
0075               
0076 343C C120  34         mov   @parm3,tmp0           ; Get byte to padd
     343E A004     
0077 3440 0A84  56         sla   tmp0,8                ; Left align
0078                       ;------------------------------------------------------
0079                       ; Right-pad string to destination length
0080                       ;------------------------------------------------------
0081               tv.pad.string.loop:
0082 3442 DD44  32         movb  tmp0,*tmp1+           ; Pad character
0083 3444 0606  14         dec   tmp2                  ; Update loop counter
0084 3446 15FD  14         jgt   tv.pad.string.loop    ; Next character
0085               
0086 3448 C820  54         mov   @parm4,@outparm1      ; Set pointer to padded string
     344A A006     
     344C A010     
0087 344E 1004  14         jmp   tv.pad.string.exit    ; Exit
0088                       ;-----------------------------------------------------------------------
0089                       ; CPU crash
0090                       ;-----------------------------------------------------------------------
0091               tv.pad.string.panic:
0092 3450 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     3452 FFCE     
0093 3454 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     3456 2026     
0094                       ;------------------------------------------------------
0095                       ; Exit
0096                       ;------------------------------------------------------
0097               tv.pad.string.exit:
0098 3458 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0099 345A C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0100 345C C179  30         mov   *stack+,tmp1          ; Pop tmp1
0101 345E C139  30         mov   *stack+,tmp0          ; Pop tmp0
0102 3460 C2F9  30         mov   *stack+,r11           ; Pop r11
0103 3462 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
0018                       ;-----------------------------------------------------------------------
...
0022 3464 0649  14         dect  stack
0023 3466 C64B  30         mov   r11,*stack            ; Save return address
0024 3468 0649  14         dect  stack
0025 346A C644  30         mov   tmp0,*stack           ; Push tmp0
0026 346C 0649  14         dect  stack
0027 346E C645  30         mov   tmp1,*stack           ; Push tmp1
0028                       ;------------------------------------------------------
0029                       ; Get parameters
0030                       ;------------------------------------------------------
0031 3470 C120  34         mov   @parm1,tmp0           ; Get line number
     3472 A000     
0032 3474 C160  34         mov   @parm2,tmp1           ; Get pointer
     3476 A002     
0033 3478 1312  14         jeq   idx.entry.update.clear
0034                                                   ; Special handling for "null"-pointer
0035                       ;------------------------------------------------------
0036                       ; Calculate LSB value index slot (pointer offset)
0037                       ;------------------------------------------------------
0038 347A 0245  22         andi  tmp1,>0fff            ; Remove high-nibble from pointer
     347C 0FFF     
0039 347E 0945  56         srl   tmp1,4                ; Get offset (divide by 16)
0040                       ;------------------------------------------------------
0041                       ; Calculate MSB value index slot (SAMS page editor buffer)
0042                       ;------------------------------------------------------
0043 3480 06E0  34         swpb  @parm3
     3482 A004     
0044 3484 D160  34         movb  @parm3,tmp1           ; Put SAMS page in MSB
     3486 A004     
0045 3488 06E0  34         swpb  @parm3                ; \ Restore original order again,
     348A A004     
...
0051 348C 06A0  32         bl    @_idx.samspage.get    ; Get SAMS page for index
     348E 3238     
0052                                                   ; \ i  tmp0     = Line number
0053                                                   ; / o  outparm1 = Slot offset in SAMS page
0054               
0055 3490 C120  34         mov   @outparm1,tmp0        ; \ Update index slot
     3492 A010     
0056 3494 C905  38         mov   tmp1,@idx.top(tmp0)   ; /
     3496 B000     
0057 3498 C804  38         mov   tmp0,@outparm1        ; Pointer to updated index entry
     349A A010     
0058 349C 1008  14         jmp   idx.entry.update.exit
0059                       ;------------------------------------------------------
0060                       ; Special handling for "null"-pointer
0061                       ;------------------------------------------------------
0062               idx.entry.update.clear:
0063 349E 06A0  32         bl    @_idx.samspage.get    ; Get SAMS page for index
     34A0 3238     
0064                                                   ; \ i  tmp0     = Line number
0065                                                   ; / o  outparm1 = Slot offset in SAMS page
0066               
0067 34A2 C120  34         mov   @outparm1,tmp0        ; \ Clear index slot
     34A4 A010     
0068 34A6 04E4  34         clr   @idx.top(tmp0)        ; /
     34A8 B000     
0069 34AA C804  38         mov   tmp0,@outparm1        ; Pointer to updated index entry
     34AC A010     
0070                       ;------------------------------------------------------
0071                       ; Exit
0072                       ;------------------------------------------------------
0073               idx.entry.update.exit:
0074 34AE C179  30         mov   *stack+,tmp1          ; Pop tmp1
0075 34B0 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0076 34B2 C2F9  30         mov   *stack+,r11           ; Pop r11
0077 34B4 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0021 34B6 0649  14         dect  stack
0022 34B8 C64B  30         mov   r11,*stack            ; Save return address
0023 34BA 0649  14         dect  stack
0024 34BC C644  30         mov   tmp0,*stack           ; Push tmp0
0025 34BE 0649  14         dect  stack
0026 34C0 C645  30         mov   tmp1,*stack           ; Push tmp1
0027 34C2 0649  14         dect  stack
0028 34C4 C646  30         mov   tmp2,*stack           ; Push tmp2
0029                       ;------------------------------------------------------
0030                       ; Get slot entry
0031                       ;------------------------------------------------------
0032 34C6 C120  34         mov   @parm1,tmp0           ; Line number in editor buffer
     34C8 A000     
0033               
0034 34CA 06A0  32         bl    @_idx.samspage.get    ; Get SAMS page with index slot
     34CC 3238     
0035                                                   ; \ i  tmp0     = Line number
0036                                                   ; / o  outparm1 = Slot offset in SAMS page
0037               
0038 34CE C120  34         mov   @outparm1,tmp0        ; \ Get slot entry
     34D0 A010     
0039 34D2 C164  34         mov   @idx.top(tmp0),tmp1   ; /
     34D4 B000     
0040               
0041 34D6 130C  14         jeq   idx.pointer.get.parm.null
0042                                                   ; Skip if index slot empty
0043                       ;------------------------------------------------------
0044                       ; Calculate MSB (SAMS page)
0045                       ;------------------------------------------------------
0046 34D8 C185  18         mov   tmp1,tmp2             ; \
0047 34DA 0986  56         srl   tmp2,8                ; / Right align SAMS page
0048                       ;------------------------------------------------------
0049                       ; Calculate LSB (pointer address)
0050                       ;------------------------------------------------------
0051 34DC 0245  22         andi  tmp1,>00ff            ; Get rid of MSB (SAMS page)
     34DE 00FF     
0052 34E0 0A45  56         sla   tmp1,4                ; Multiply with 16
0053 34E2 0225  22         ai    tmp1,edb.top          ; Add editor buffer base address
     34E4 C000     
0054                       ;------------------------------------------------------
0055                       ; Return parameters
0056                       ;------------------------------------------------------
0057               idx.pointer.get.parm:
0058 34E6 C805  38         mov   tmp1,@outparm1        ; Index slot -> Pointer
     34E8 A010     
0059 34EA C806  38         mov   tmp2,@outparm2        ; Index slot -> SAMS page
     34EC A012     
0060 34EE 1004  14         jmp   idx.pointer.get.exit
0061                       ;------------------------------------------------------
0062                       ; Special handling for "null"-pointer
0063                       ;------------------------------------------------------
0064               idx.pointer.get.parm.null:
0065 34F0 04E0  34         clr   @outparm1
     34F2 A010     
0066 34F4 04E0  34         clr   @outparm2
     34F6 A012     
0067                       ;------------------------------------------------------
0068                       ; Exit
0069                       ;------------------------------------------------------
0070               idx.pointer.get.exit:
0071 34F8 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0072 34FA C179  30         mov   *stack+,tmp1          ; Pop tmp1
0073 34FC C139  30         mov   *stack+,tmp0          ; Pop tmp0
0074 34FE C2F9  30         mov   *stack+,r11           ; Pop r11
0075 3500 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0016                       ;------------------------------------------------------
0017 3502 0224  22         ai    tmp0,idx.top          ; Add index base to offset
     3504 B000     
0018 3506 C144  18         mov   tmp0,tmp1             ; a = current slot
0019 3508 05C5  14         inct  tmp1                  ; b = current slot + 2
0020                       ;------------------------------------------------------
0021                       ; Loop forward until end of index
0022                       ;------------------------------------------------------
0023               _idx.entry.delete.reorg.loop:
0024 350A CD35  46         mov   *tmp1+,*tmp0+         ; Copy b -> a
0025 350C 0606  14         dec   tmp2                  ; tmp2--
0026 350E 16FD  14         jne   _idx.entry.delete.reorg.loop
0027                                                   ; Loop unless completed
0028 3510 045B  20         b     *r11                  ; Return to caller
0029               
0030               
0031               
0032               ***************************************************************
...
0046 3512 0649  14         dect  stack
0047 3514 C64B  30         mov   r11,*stack            ; Save return address
0048 3516 0649  14         dect  stack
0049 3518 C644  30         mov   tmp0,*stack           ; Push tmp0
0050 351A 0649  14         dect  stack
0051 351C C645  30         mov   tmp1,*stack           ; Push tmp1
0052 351E 0649  14         dect  stack
0053 3520 C646  30         mov   tmp2,*stack           ; Push tmp2
0054 3522 0649  14         dect  stack
0055 3524 C647  30         mov   tmp3,*stack           ; Push tmp3
0056                       ;------------------------------------------------------
0057                       ; Get index slot
0058                       ;------------------------------------------------------
0059 3526 C120  34         mov   @parm1,tmp0           ; Line number in editor buffer
     3528 A000     
0060               
0061 352A 06A0  32         bl    @_idx.samspage.get    ; Get SAMS page for index
     352C 3238     
0062                                                   ; \ i  tmp0     = Line number
0063                                                   ; / o  outparm1 = Slot offset in SAMS page
0064               
0065 352E C120  34         mov   @outparm1,tmp0        ; Index offset
     3530 A010     
0066                       ;------------------------------------------------------
0067                       ; Prepare for index reorg
0068                       ;------------------------------------------------------
0069 3532 C1A0  34         mov   @parm2,tmp2           ; Get last line to check
     3534 A002     
0070 3536 1303  14         jeq   idx.entry.delete.lastline
0071                                                   ; Exit early if last line = 0
0072               
0073 3538 61A0  34         s     @parm1,tmp2           ; Calculate loop
     353A A000     
0074 353C 1504  14         jgt   idx.entry.delete.reorg
0075                                                   ; Reorganize if loop counter > 0
0076                       ;------------------------------------------------------
0077                       ; Special treatment for last line
0078                       ;------------------------------------------------------
0079               idx.entry.delete.lastline:
0080 353E 0224  22         ai    tmp0,idx.top          ; Add index base to offset
     3540 B000     
0081 3542 04D4  26         clr   *tmp0                 ; Clear index entry
0082 3544 1012  14         jmp   idx.entry.delete.exit ; Exit early
0083                       ;------------------------------------------------------
0084                       ; Reorganize index entries
0085                       ;------------------------------------------------------
0086               idx.entry.delete.reorg:
0087 3546 C1E0  34         mov   @parm2,tmp3           ; Get last line to reorganize
     3548 A002     
0088 354A 0287  22         ci    tmp3,2048
     354C 0800     
0089 354E 120A  14         jle   idx.entry.delete.reorg.simple
...
0096 3550 06A0  32         bl    @_idx.sams.mapcolumn.on
     3552 31CA     
...
0101                       ;-------------------------------------------------------
0102 3554 C120  34         mov   @parm1,tmp0           ; Restore line number
     3556 A000     
0103 3558 0A14  56         sla   tmp0,1                ; Calculate offset
0104               
0105 355A 06A0  32         bl    @_idx.entry.delete.reorg
     355C 3502     
0106                                                   ; Reorganize index
0107                                                   ; \ i  tmp0 = Index offset
0108                                                   ; / i  tmp2 = Loop count
0109               
0110 355E 06A0  32         bl    @_idx.sams.mapcolumn.off
     3560 31FE     
0111                                                   ; Restore memory window layout
0112               
0113 3562 1002  14         jmp   !
0114                       ;------------------------------------------------------
0115                       ; Simple index reorganization
0116                       ;------------------------------------------------------
0117               idx.entry.delete.reorg.simple:
0118 3564 06A0  32         bl    @_idx.entry.delete.reorg
     3566 3502     
0119                       ;------------------------------------------------------
0120                       ; Clear index entry (base + offset already set)
0121                       ;------------------------------------------------------
0122 3568 04D4  26 !       clr   *tmp0                 ; Clear index entry
0123                       ;------------------------------------------------------
0124                       ; Exit
0125                       ;------------------------------------------------------
0126               idx.entry.delete.exit:
0127 356A C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0128 356C C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0129 356E C179  30         mov   *stack+,tmp1          ; Pop tmp1
0130 3570 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0131 3572 C2F9  30         mov   *stack+,r11           ; Pop r11
0132 3574 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0015                       ; Assert 1
0016                       ;------------------------------------------------------
0017 3576 0286  22         ci    tmp2,2048*5           ; Crash if loop counter value is unrealistic
     3578 2800     
0018                                                   ; Max. 5 SAMS pages, each with 2048 index
0019                                                   ; entries.
0020               
0021 357A 1204  14         jle   !                     ; Continue if ok
0022                       ;------------------------------------------------------
0023                       ; Crash and burn
0024                       ;------------------------------------------------------
0025               _idx.entry.insert.reorg.crash:
0026 357C C80B  38         mov   r11,@>ffce            ; \ Save caller address
     357E FFCE     
0027 3580 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     3582 2026     
0028                       ;------------------------------------------------------
0029                       ; Reorganize index entries
0030                       ;------------------------------------------------------
0031 3584 0224  22 !       ai    tmp0,idx.top          ; Add index base to offset
     3586 B000     
0032 3588 C144  18         mov   tmp0,tmp1             ; a = current slot
0033 358A 05C5  14         inct  tmp1                  ; b = current slot + 2
0034 358C 0586  14         inc   tmp2                  ; One time adjustment for current line
0035                       ;------------------------------------------------------
0036                       ; Assert 2
0037                       ;------------------------------------------------------
0038 358E C1C6  18         mov   tmp2,tmp3             ; Number of slots to reorganize
0039 3590 0A17  56         sla   tmp3,1                ; adjust to slot size
0040 3592 0507  16         neg   tmp3                  ; tmp3 = -tmp3
0041 3594 A1C4  18         a     tmp0,tmp3             ; tmp3 = tmp3 + tmp0
0042 3596 0287  22         ci    tmp3,idx.top - 4      ; Address before top of index ?
     3598 AFFC     
0043 359A 1504  14         jgt   _idx.entry.insert.reorg.loop
0044                                                   ; No, jump to loop start
0045                       ;------------------------------------------------------
0046                       ; Crash and burn
0047                       ;------------------------------------------------------
0048 359C C80B  38         mov   r11,@>ffce            ; \ Save caller address
     359E FFCE     
0049 35A0 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     35A2 2026     
0050                       ;------------------------------------------------------
0051                       ; Loop backwards from end of index up to insert point
0052                       ;------------------------------------------------------
0053               _idx.entry.insert.reorg.loop:
0054 35A4 C554  38         mov   *tmp0,*tmp1           ; Copy a -> b
0055 35A6 0644  14         dect  tmp0                  ; Move pointer up
0056 35A8 0645  14         dect  tmp1                  ; Move pointer up
0057 35AA 0606  14         dec   tmp2                  ; Next index entry
0058 35AC 15FB  14         jgt   _idx.entry.insert.reorg.loop
0059                                                   ; Repeat until done
0060                       ;------------------------------------------------------
0061                       ; Clear index entry at insert point
0062                       ;------------------------------------------------------
0063 35AE 05C4  14         inct  tmp0                  ; \ Clear index entry for line
0064 35B0 04D4  26         clr   *tmp0                 ; / following insert point
0065               
0066 35B2 045B  20         b     *r11                  ; Return to caller
0067               
0068               
0069               
0070               
...
0088 35B4 0649  14         dect  stack
0089 35B6 C64B  30         mov   r11,*stack            ; Save return address
0090 35B8 0649  14         dect  stack
0091 35BA C644  30         mov   tmp0,*stack           ; Push tmp0
0092 35BC 0649  14         dect  stack
0093 35BE C645  30         mov   tmp1,*stack           ; Push tmp1
0094 35C0 0649  14         dect  stack
0095 35C2 C646  30         mov   tmp2,*stack           ; Push tmp2
0096 35C4 0649  14         dect  stack
0097 35C6 C647  30         mov   tmp3,*stack           ; Push tmp3
0098                       ;------------------------------------------------------
0099                       ; Prepare for index reorg
0100                       ;------------------------------------------------------
0101 35C8 C1A0  34         mov   @parm2,tmp2           ; Get last line to check
     35CA A002     
0102 35CC 61A0  34         s     @parm1,tmp2           ; Calculate loop
     35CE A000     
0103 35D0 130F  14         jeq   idx.entry.insert.reorg.simple
0104                                                   ; Special treatment if last line
0105                       ;------------------------------------------------------
0106                       ; Reorganize index entries
0107                       ;------------------------------------------------------
0108               idx.entry.insert.reorg:
0109 35D2 C1E0  34         mov   @parm2,tmp3
     35D4 A002     
0110 35D6 0287  22         ci    tmp3,2048
     35D8 0800     
0111 35DA 110A  14         jlt   idx.entry.insert.reorg.simple
...
0118 35DC 06A0  32         bl    @_idx.sams.mapcolumn.on
     35DE 31CA     
0119                                                   ; Index in continuous memory region
0120                                                   ; b000 - ffff (5 SAMS pages)
0121               
0122 35E0 C120  34         mov   @parm2,tmp0           ; Last line number in editor buffer
     35E2 A002     
0123 35E4 0A14  56         sla   tmp0,1                ; tmp0 * 2
0124               
0125 35E6 06A0  32         bl    @_idx.entry.insert.reorg
     35E8 3576     
0126                                                   ; Reorganize index
0127                                                   ; \ i  tmp0 = Last line in index
0128                                                   ; / i  tmp2 = Num. of index entries to move
0129               
0130 35EA 06A0  32         bl    @_idx.sams.mapcolumn.off
     35EC 31FE     
0131                                                   ; Restore memory window layout
0132               
0133 35EE 1008  14         jmp   idx.entry.insert.exit
0134                       ;------------------------------------------------------
0135                       ; Simple index reorganization
0136                       ;------------------------------------------------------
0137               idx.entry.insert.reorg.simple:
0138 35F0 C120  34         mov   @parm2,tmp0           ; Last line number in editor buffer
     35F2 A002     
0139               
0140 35F4 06A0  32         bl    @_idx.samspage.get    ; Get SAMS page for index
     35F6 3238     
0141                                                   ; \ i  tmp0     = Line number
0142                                                   ; / o  outparm1 = Slot offset in SAMS page
0143               
0144 35F8 C120  34         mov   @outparm1,tmp0        ; Index offset
     35FA A010     
0145               
0146 35FC 06A0  32         bl    @_idx.entry.insert.reorg
     35FE 3576     
...
0155 3600 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0156 3602 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0157 3604 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0158 3606 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0159 3608 C2F9  30         mov   *stack+,r11           ; Pop r11
0160 360A 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
0025                       ;-----------------------------------------------------------------------
...
0021 360C 0649  14         dect  stack
0022 360E C64B  30         mov   r11,*stack            ; Push return address
0023 3610 0649  14         dect  stack
0024 3612 C660  46         mov   @wyx,*stack           ; Push cursor position
     3614 832A     
0025                       ;-------------------------------------------------------
0026                       ; Clear message
0027                       ;-------------------------------------------------------
0028 3616 06A0  32         bl    @hchar
     3618 27E6     
0029 361A 0034                   byte 0,52,32,18
     361C 2012     
0030 361E FFFF                   data EOL              ; Clear message
0031               
0032 3620 04E0  34         clr   @tv.task.oneshot      ; Reset oneshot task
     3622 A224     
0033                       ;-------------------------------------------------------
0034                       ; Exit
0035                       ;-------------------------------------------------------
0036               pane.topline.oneshot.clearmsg.exit:
0037 3624 C839  50         mov   *stack+,@wyx          ; Pop cursor position
     3626 832A     
0038 3628 C2F9  30         mov   *stack+,r11           ; Pop R11
0039 362A 045B  20         b     *r11                  ; Return to task
                   < ram.resident.asm
...
0031               ***************************************************************
0032               stevie.80x30:
0033 362C 04F0             byte  >04,>f0,>00,>3f,>02,>43,>05,SPFCLR,0,80
     362E 003F     
     3630 0243     
     3632 05F4     
     3634 0050     
...
0038               *--------------------------------------------------------------
0039               tibasic.32x24:
0040 3636 00E2             byte  >00,>e2,>00,>0c,>00,>06,>00,>07,0,32
     3638 000C     
     363A 0006     
     363C 0007     
     363E 0020     
...
0065               *--------------------------------------------------------------
0066               tibasic.32x30:
0067 3640 00E2             byte  >00,>e2,>00,>0c,>00,>06,>00,>07,0,32
     3642 000C     
     3644 0006     
     3646 0007     
     3648 0020     
...
0098 364A 0000             data  >0000,>0001           ; Cursor
     364C 0001     
0099 364E 0000             data  >0000,>0101           ; Current line indicator     <
     3650 0101     
0100 3652 0820             data  >0820,>0201           ; Current column indicator   v
     3654 0201     
0101               nosprite:
0102 3656 D000             data  >d000                 ; End-of-Sprites list
0103               
0104               
0105               
0106               
...
0157 3658 F417             data  >f417,>f171,>1b1f,>71b1 ; 1  White on blue with cyan touch
     365A F171     
     365C 1B1F     
     365E 71B1     
0158 3660 A11A             data  >a11a,>f0ff,>1f1a,>f1ff ; 2  Dark yellow on black
     3662 F0FF     
     3664 1F1A     
     3666 F1FF     
0159 3668 2112             data  >2112,>f0ff,>1f12,>f1f6 ; 3  Dark green on black
     366A F0FF     
     366C 1F12     
     366E F1F6     
0160 3670 F41F             data  >f41f,>1e11,>1a17,>1e11 ; 4  White on blue
     3672 1E11     
     3674 1A17     
     3676 1E11     
0161 3678 E11E             data  >e11e,>e1ff,>1f1e,>e1ff ; 5  Grey on black
     367A E1FF     
     367C 1F1E     
     367E E1FF     
0162 3680 1771             data  >1771,>1016,>1b71,>1711 ; 6  Black on cyan
     3682 1016     
     3684 1B71     
     3686 1711     
0163 3688 1FF1             data  >1ff1,>1011,>f1f1,>1f11 ; 7  Black on white
     368A 1011     
     368C F1F1     
     368E 1F11     
0164 3690 1AF1             data  >1af1,>a1ff,>1f1f,>f11f ; 8  Black on dark yellow
     3692 A1FF     
     3694 1F1F     
     3696 F11F     
0165 3698 21F0             data  >21f0,>12ff,>1b12,>12ff ; 9  Dark green on black
     369A 12FF     
     369C 1B12     
     369E 12FF     
0166 36A0 F5F1             data  >f5f1,>e1ff,>1b1f,>f131 ; 10 White on light blue
     36A2 E1FF     
     36A4 1B1F     
     36A6 F131     
0167                       even
0168               
0169               tv.tabs.table:
0170 36A8 0007             byte  0,7,12,25               ; \   Default tab positions as used
     36AA 0C19     
0171 36AC 1E2D             byte  30,45,59,79             ; |   in Editor/Assembler module.
     36AE 3B4F     
0172 36B0 FF00             byte  >ff,0,0,0               ; |
     36B2 0000     
0173 36B4 0000             byte  0,0,0,0                 ; |   Up to 20 positions supported.
     36B6 0000     
0174 36B8 0000             byte  0,0,0,0                 ; /   >ff means end-of-list.
     36BA 0000     
0175                       even
                   < ram.resident.asm
...
0018               txt.ovrwrite
0019 36C4 03               byte  3
0020 36C5   4F             text  'OVR'
     36C6 5652     
0021                       even
0022               
0023               txt.insert
0024 36C8 03               byte  3
0025 36C9   49             text  'INS'
     36CA 4E53     
0026                       even
0027               
0028               txt.star
...
0032               
0033               txt.loading
0034 36CE 0A               byte  10
0035 36CF   4C             text  'Loading...'
     36D0 6F61     
     36D2 6469     
     36D4 6E67     
     36D6 2E2E     
...
0037               
0038               txt.saving
0039 36DA 0A               byte  10
0040 36DB   53             text  'Saving....'
     36DC 6176     
     36DE 696E     
     36E0 672E     
     36E2 2E2E     
...
0042               
0043               txt.printing
0044 36E6 12               byte  18
0045 36E7   50             text  'Printing file.....'
     36E8 7269     
     36EA 6E74     
     36EC 696E     
     36EE 6720     
...
0047               
0048               txt.block.del
0049 36FA 12               byte  18
0050 36FB   44             text  'Deleting block....'
     36FC 656C     
     36FE 6574     
     3700 696E     
     3702 6720     
...
0052               
0053               txt.block.copy
0054 370E 11               byte  17
0055 370F   43             text  'Copying block....'
     3710 6F70     
     3712 7969     
     3714 6E67     
     3716 2062     
...
0057               
0058               txt.block.move
0059 3720 10               byte  16
0060 3721   4D             text  'Moving block....'
     3722 6F76     
     3724 696E     
     3726 6720     
     3728 626C     
...
0062               
0063               txt.block.save
0064 3732 18               byte  24
0065 3733   53             text  'Saving block to file....'
     3734 6176     
     3736 696E     
     3738 6720     
     373A 626C     
...
0067               
0068               txt.block.clip
0069 374C 18               byte  24
0070 374D   43             text  'Copying to clipboard....'
     374E 6F70     
     3750 7969     
     3752 6E67     
     3754 2074     
...
0074 3766 12               byte  18
0075 3767   50             text  'Printing block....'
     3768 7269     
     376A 6E74     
     376C 696E     
     376E 6720     
...
0077               
0078               txt.clearmem
0079 377A 13               byte  19
0080 377B   43             text  'Clearing memory....'
     377C 6C65     
     377E 6172     
     3780 696E     
     3782 6720     
...
0082               
0083               txt.done.load
0084 378E 0E               byte  14
0085 378F   4C             text  'Load completed'
     3790 6F61     
     3792 6420     
     3794 636F     
     3796 6D70     
...
0089 379E 10               byte  16
0090 379F   49             text  'Insert completed'
     37A0 6E73     
     37A2 6572     
     37A4 7420     
     37A6 636F     
...
0094 37B0 10               byte  16
0095 37B1   41             text  'Append completed'
     37B2 7070     
     37B4 656E     
     37B6 6420     
     37B8 636F     
...
0097               
0098               txt.done.save
0099 37C2 0E               byte  14
0100 37C3   53             text  'Save completed'
     37C4 6176     
     37C6 6520     
     37C8 636F     
     37CA 6D70     
...
0102               
0103               txt.done.copy
0104 37D2 0E               byte  14
0105 37D3   43             text  'Copy completed'
     37D4 6F70     
     37D6 7920     
     37D8 636F     
     37DA 6D70     
...
0107               
0108               txt.done.print
0109 37E2 0F               byte  15
0110 37E3   50             text  'Print completed'
     37E4 7269     
     37E6 6E74     
     37E8 2063     
     37EA 6F6D     
...
0114 37F2 10               byte  16
0115 37F3   44             text  'Delete completed'
     37F4 656C     
     37F6 6574     
     37F8 6520     
     37FA 636F     
...
0119 3804 0F               byte  15
0120 3805   43             text  'Clipboard saved'
     3806 6C69     
     3808 7062     
     380A 6F61     
     380C 7264     
...
0124 3814 0D               byte  13
0125 3815   43             text  'Clipboard set'
     3816 6C69     
     3818 7062     
     381A 6F61     
     381C 7264     
...
0133               txt.kb
0134 382C 02               byte  2
0135 382D   6B             text  'kb'
     382E 62       
0136                       even
0137               
0138               txt.lines
0139 3830 05               byte  5
0140 3831   4C             text  'Lines'
     3832 696E     
     3834 6573     
0141                       even
0142               
0143               txt.newfile
0144 3836 0A               byte  10
0145 3837   5B             text  '[New file]'
     3838 4E65     
     383A 7720     
     383C 6669     
     383E 6C65     
...
0153               txt.m1
0154 3848 03               byte  3
0155 3849   4D             text  'M1='
     384A 313D     
0156                       even
0157               
0158               txt.m2
0159 384C 03               byte  3
0160 384D   4D             text  'M2='
     384E 323D     
0161                       even
0162               
0163               txt.keys.default
0164 3850 07               byte  7
0165 3851   46             text  'F9-Menu'
     3852 392D     
     3854 4D65     
     3856 6E75     
0166                       even
0167               
0168               txt.keys.block
0169 3858 36               byte  54
0170 3859   46             text  'F9-Back  ^Copy  ^Move  ^Del  ^Save  ^Print  ^[1-5]Clip'
     385A 392D     
     385C 4261     
     385E 636B     
     3860 2020     
...
0171                       even
0172               
0173 3890 2E2E     txt.ruler          text    '.........'
     3892 2E2E     
     3894 2E2E     
     3896 2E2E     
     3898 2E       
0174 3899   12                        byte    18
0175 389A 2E2E                        text    '.........'
     389C 2E2E     
     389E 2E2E     
     38A0 2E2E     
     38A2 2E       
0176 38A3   13                        byte    19
0177 38A4 2E2E                        text    '.........'
     38A6 2E2E     
     38A8 2E2E     
     38AA 2E2E     
     38AC 2E       
0178 38AD   14                        byte    20
0179 38AE 2E2E                        text    '.........'
     38B0 2E2E     
     38B2 2E2E     
     38B4 2E2E     
     38B6 2E       
0180 38B7   15                        byte    21
0181 38B8 2E2E                        text    '.........'
     38BA 2E2E     
     38BC 2E2E     
     38BE 2E2E     
     38C0 2E       
0182 38C1   16                        byte    22
0183 38C2 2E2E                        text    '.........'
     38C4 2E2E     
     38C6 2E2E     
     38C8 2E2E     
     38CA 2E       
0184 38CB   17                        byte    23
0185 38CC 2E2E                        text    '.........'
     38CE 2E2E     
     38D0 2E2E     
     38D2 2E2E     
     38D4 2E       
0186 38D5   18                        byte    24
0187 38D6 2E2E                        text    '.........'
     38D8 2E2E     
     38DA 2E2E     
     38DC 2E2E     
     38DE 2E       
0188 38DF   19                        byte    25
0189                                  even
0190 38E0 020E     txt.alpha.down     data >020e,>0f00
     38E2 0F00     
0191 38E4 0110     txt.vertline       data >0110
0192 38E6 011C     txt.keymarker      byte 1,28
0193               
0194               txt.ws1
0195 38E8 01               byte  1
0196 38E9   20             text  ' '
...
0217                       even
0218               
0219      38F2     txt.filetype.none  equ txt.ws4
0220               
0221               
0222               ;--------------------------------------------------------------
...
0224               ;--------------------------------------------------------------
0225               txt.ioerr.load
0226 38FE 15               byte  21
0227 38FF   46             text  'Failed loading file: '
     3900 6169     
     3902 6C65     
     3904 6420     
     3906 6C6F     
...
0229               
0230               txt.ioerr.save
0231 3914 14               byte  20
0232 3915   46             text  'Failed saving file: '
     3916 6169     
     3918 6C65     
     391A 6420     
     391C 7361     
...
0236 392A 1B               byte  27
0237 392B   46             text  'Failed printing to device: '
     392C 6169     
     392E 6C65     
     3930 6420     
     3932 7072     
...
0239               
0240               txt.io.nofile
0241 3946 16               byte  22
0242 3947   4E             text  'No filename specified.'
     3948 6F20     
     394A 6669     
     394C 6C65     
     394E 6E61     
...
0246 395E 2D               byte  45
0247 395F   49             text  'Index full. File too large for editor buffer.'
     3960 6E64     
     3962 6578     
     3964 2066     
     3966 756C     
...
0251 398C 2D               byte  45
0252 398D   43             text  'Copy/Move target must be outside M1-M2 range.'
     398E 6F70     
     3990 792F     
     3992 4D6F     
     3994 7665     
...
0265 39BC 0D               byte  13
0266 39BD   43             text  'Color scheme:'
     39BE 6F6C     
     39C0 6F72     
     39C2 2073     
     39C4 6368     
...
0023 39E6 10               byte  16
0024 39E7   54             text  'TIPI.STEVIE.CLIP'
     39E8 4950     
     39EA 492E     
     39EC 5354     
     39EE 4556     
...
0026               
0027               def.devices
0028 39F8 2F               byte  47
0029 39F9   2C             text  ',DSK,HDX,IDE,PI.,PIO,TIPI.,RD,SCS,SDD,WDS,RS232'
     39FA 4453     
     39FC 4B2C     
     39FE 4844     
     3A00 582C     
...
0040                       ;------------------------------------------------------
0041 3A28 04E0  34         clr   @bank1.rom            ; Activate bank 1 "James" ROM
     3A2A 6002     
0042               
0046               
0047 3A2C 0460  28         b     @kickstart.code2      ; Jump to entry routine
     3A2E 6046     
0048               ***************************************************************
...
0070 608C 06A0  32         bl    @cpym2m
     608E 24EE     
0071 6090 364A                   data romsat,ramsat,14 ; Load sprite SAT
     6092 A030     
     6094 000E     
0072               
...
0131 60E8 06A0  32         bl    @mkhook
     60EA 2F84     
0132 60EC 7330                   data hook.keyscan     ; Setup user hook
0133               
0134 60EE 0460  28         b     @tmgr                 ; Start timers and kthread
     60F0 2ED0     
                   < stevie_b1.asm.68040
0058               
0059                       copy  "mem.sams.setup.stevie.asm"
     **** ****     > mem.sams.setup.stevie.asm
0001               * FILE......: mem.sams.setup.stevie.asm
...
0035 610E 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.68040
0060                                                   ; SAMS memory setup for Stevie
0061                       ;-----------------------------------------------------------------------
0062                       ; Keyboard actions
0063                       ;-----------------------------------------------------------------------
0064                       copy  "edkey.key.process.asm"
...
0138 61B8 0460  28        b     @hook.keyscan.bounce   ; Back to editor main
     61BA 737A     
                   < stevie_b1.asm.68040
0065                                                   ; Process keyboard actions
0066                       ;-----------------------------------------------------------------------
0067                       ; Keyboard actions - Framebuffer (1)
0068                       ;-----------------------------------------------------------------------
0069                       copy  "edkey.fb.mov.leftright.asm"
...
0047 6B36 3814                   data txt.done.clipdev
0048                       ;-------------------------------------------------------
...
0082 6C78 06A0  32        bl    @cmdb.cmd.preset       ; Set preset
     6C7A 7C58     
0083 6C7C 0460  28        b     @hook.keyscan.bounce   ; Back to editor main
     6C7E 737A     
0084               
0085               
0086               
...
0102                       ;------------------------------------------------------
0103 6C80 06A0  32         bl    @hchar
     6C82 27E6     
0104 6C84 0000                   byte 0,0,32,80*2
     6C86 20A0     
0105 6C88 FFFF                   data EOL
0106 6C8A 1000  14         jmp   edkey.action.cmdb.close.dialog
0107               
0108               
0109               
0110               ***************************************************************
...
0124                       ; Close dialog
0125                       ;------------------------------------------------------
0126 6C8C 04E0  34         clr   @cmdb.dialog          ; Reset dialog ID
     6C8E A71A     
0127 6C90 06A0  32         bl    @pane.cursor.blink    ; Show cursor
     6C92 76F8     
0128 6C94 06A0  32         bl    @pane.cmdb.hide       ; Hide command buffer pane
     6C96 7C26     
0129 6C98 0720  34         seto  @fb.status.dirty      ; Trigger status lines update
     6C9A A318     
0130                       ;-------------------------------------------------------
0131                       ; Exit
0132                       ;-------------------------------------------------------
0133               edkey.action.cmdb.close.dialog.exit:
0134 6C9C 0460  28         b     @hook.keyscan.bounce  ; Back to editor main
     6C9E 737A     
                   < stevie_b1.asm.68040
0100                       ;-----------------------------------------------------------------------
...
0022               ********|*****|*********************|**************************
0023               fb.row2line:
0024 6CA0 0649  14         dect  stack
0025 6CA2 C64B  30         mov   r11,*stack            ; Save return address
0026 6CA4 0649  14         dect  stack
0027 6CA6 C644  30         mov   tmp0,*stack           ; Push tmp0
0028                       ;------------------------------------------------------
0029                       ; Calculate line in editor buffer
0030                       ;------------------------------------------------------
0031 6CA8 C120  34         mov   @parm1,tmp0
     6CAA A000     
0032 6CAC A120  34         a     @fb.topline,tmp0
     6CAE A304     
0033 6CB0 C804  38         mov   tmp0,@outparm1
     6CB2 A010     
0034                       ;------------------------------------------------------
0035                       ; Exit
0036                       ;------------------------------------------------------
0037               fb.row2line.exit:
0038 6CB4 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0039 6CB6 C2F9  30         mov   *stack+,r11           ; Pop r11
0040 6CB8 045B  20         b     *r11                  ; Return to caller
0041               
0042               
0043               
0044               
...
0068 6CBA 0649  14         dect  stack
0069 6CBC C64B  30         mov   r11,*stack            ; Save return address
0070 6CBE 0649  14         dect  stack
0071 6CC0 C644  30         mov   tmp0,*stack           ; Push tmp0
0072 6CC2 0649  14         dect  stack
0073 6CC4 C645  30         mov   tmp1,*stack           ; Push tmp1
0074                       ;------------------------------------------------------
0075                       ; Calculate pointer
0076                       ;------------------------------------------------------
0077 6CC6 C120  34         mov   @fb.row,tmp0
     6CC8 A306     
0078 6CCA 3920  72         mpy   @fb.colsline,tmp0     ; tmp1 = row  * colsline
     6CCC A30E     
0079 6CCE A160  34         a     @fb.column,tmp1       ; tmp1 = tmp1 + column
     6CD0 A30C     
0080 6CD2 A160  34         a     @fb.top.ptr,tmp1      ; tmp1 = tmp1 + base
     6CD4 A300     
0081 6CD6 C805  38         mov   tmp1,@fb.current
     6CD8 A302     
0082                       ;------------------------------------------------------
0083                       ; Exit
0084                       ;------------------------------------------------------
0085               fb.calc_pointer.exit:
0086 6CDA C179  30         mov   *stack+,tmp1          ; Pop tmp1
0087 6CDC C139  30         mov   *stack+,tmp0          ; Pop tmp0
0088 6CDE C2F9  30         mov   *stack+,r11           ; Pop r11
0089 6CE0 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.68040
...
0019               ********|*****|*********************|**************************
0020               fb.cursor.up
0021 6CE2 0649  14         dect  stack
0022 6CE4 C64B  30         mov   r11,*stack            ; Save return address
0023                       ;-------------------------------------------------------
0024                       ; Crunch current line if dirty
0025                       ;-------------------------------------------------------
0026 6CE6 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6CE8 A318     
0027 6CEA 8820  54         c     @fb.row.dirty,@w$ffff
     6CEC A30A     
     6CEE 2022     
0028 6CF0 1604  14         jne   fb.cursor.up.cursor
0029 6CF2 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     6CF4 6FA0     
0030 6CF6 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     6CF8 A30A     
0031                       ;-------------------------------------------------------
0032                       ; Move cursor
0033                       ;-------------------------------------------------------
0034               fb.cursor.up.cursor:
0035 6CFA C120  34         mov   @fb.row,tmp0
     6CFC A306     
0036 6CFE 150B  14         jgt   fb.cursor.up.cursor_up
0037                                                   ; Move cursor up if fb.row > 0
0038 6D00 C120  34         mov   @fb.topline,tmp0      ; Do we need to scroll?
     6D02 A304     
0039 6D04 130C  14         jeq   fb.cursor.up.set_cursorx
0040                                                   ; At top, only position cursor X
0041                       ;-------------------------------------------------------
0042                       ; Scroll 1 line
0043                       ;-------------------------------------------------------
0044 6D06 0604  14         dec   tmp0                  ; fb.topline--
0045 6D08 C804  38         mov   tmp0,@parm1           ; Scroll one line up
     6D0A A000     
0046               
0047 6D0C 06A0  32         bl    @fb.refresh           ; \ Refresh frame buffer
     6D0E 6EAA     
0048                                                   ; | i  @parm1 = Line to start with
0049                                                   ; /             (becomes @fb.topline)
0050               
0051 6D10 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     6D12 A310     
0052 6D14 1004  14         jmp   fb.cursor.up.set_cursorx
0053                       ;-------------------------------------------------------
0054                       ; Move cursor up
0055                       ;-------------------------------------------------------
0056               fb.cursor.up.cursor_up:
0057 6D16 0620  34         dec   @fb.row               ; Row-- in screen buffer
     6D18 A306     
0058 6D1A 06A0  32         bl    @up                   ; Row-- VDP cursor
     6D1C 26E8     
0059                       ;-------------------------------------------------------
0060                       ; Check line length and position cursor
0061                       ;-------------------------------------------------------
0062               fb.cursor.up.set_cursorx:
0063 6D1E 06A0  32         bl    @edb.line.getlength2  ; \ Get length current line
     6D20 719A     
0064                                                   ; | i  @fb.row        = Row in frame buffer
0065                                                   ; / o  @fb.row.length = Length of row
0066               
0067 6D22 8820  54         c     @fb.column,@fb.row.length
     6D24 A30C     
     6D26 A308     
0068 6D28 1207  14         jle   fb.cursor.up.exit
0069                       ;-------------------------------------------------------
0070                       ; Adjust cursor column position
0071                       ;-------------------------------------------------------
0072 6D2A C820  54         mov   @fb.row.length,@fb.column
     6D2C A308     
     6D2E A30C     
0073 6D30 C120  34         mov   @fb.column,tmp0
     6D32 A30C     
0074 6D34 06A0  32         bl    @xsetx                ; Set VDP cursor X
     6D36 26F2     
0075                       ;-------------------------------------------------------
0076                       ; Exit
0077                       ;-------------------------------------------------------
0078               fb.cursor.up.exit:
0079 6D38 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6D3A 6CBA     
0080 6D3C C2F9  30         mov   *stack+,r11           ; Pop r11
0081 6D3E 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.68040
...
0019               ********|*****|*********************|**************************
0020               fb.cursor.down:
0021 6D40 0649  14         dect  stack
0022 6D42 C64B  30         mov   r11,*stack            ; Save return address
0023                       ;------------------------------------------------------
0024                       ; Last line?
0025                       ;------------------------------------------------------
0026 6D44 8820  54         c     @fb.row,@edb.lines    ; Last line in editor buffer ?
     6D46 A306     
     6D48 A504     
0027 6D4A 1332  14         jeq   fb.cursor.down.exit
0028                                                   ; Yes, skip further processing
0029 6D4C 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6D4E A318     
0030                       ;-------------------------------------------------------
0031                       ; Crunch current row if dirty
0032                       ;-------------------------------------------------------
0033 6D50 8820  54         c     @fb.row.dirty,@w$ffff
     6D52 A30A     
     6D54 2022     
0034 6D56 1604  14         jne   fb.cursor.down.move
0035 6D58 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     6D5A 6FA0     
0036 6D5C 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     6D5E A30A     
0037                       ;-------------------------------------------------------
0038                       ; Move cursor
0039                       ;-------------------------------------------------------
...
0042                       ; EOF reached?
0043                       ;-------------------------------------------------------
0044 6D60 C120  34         mov   @fb.topline,tmp0
     6D62 A304     
0045 6D64 A120  34         a     @fb.row,tmp0
     6D66 A306     
0046 6D68 8120  34         c     @edb.lines,tmp0       ; fb.topline + fb.row = edb.lines ?
     6D6A A504     
0047 6D6C 1314  14         jeq   fb.cursor.down.set_cursorx
0048                                                   ; Yes, only position cursor X
0049                       ;-------------------------------------------------------
0050                       ; Check if scrolling required
0051                       ;-------------------------------------------------------
0052 6D6E C120  34         mov   @fb.scrrows,tmp0
     6D70 A31A     
0053 6D72 0604  14         dec   tmp0
0054 6D74 8120  34         c     @fb.row,tmp0
     6D76 A306     
0055 6D78 110A  14         jlt   fb.cursor.down.cursor
0056                       ;-------------------------------------------------------
0057                       ; Scroll 1 line
0058                       ;-------------------------------------------------------
0059 6D7A C820  54         mov   @fb.topline,@parm1
     6D7C A304     
     6D7E A000     
0060 6D80 05A0  34         inc   @parm1
     6D82 A000     
0061               
0062 6D84 06A0  32         bl    @fb.refresh           ; \ Refresh frame buffer
     6D86 6EAA     
0063                                                   ; | i  @parm1 = Line to start with
0064                                                   ; /             (becomes @fb.topline)
0065               
0066 6D88 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     6D8A A310     
0067 6D8C 1004  14         jmp   fb.cursor.down.set_cursorx
0068                       ;-------------------------------------------------------
0069                       ; Move cursor down a row, there are still rows left
0070                       ;-------------------------------------------------------
0071               fb.cursor.down.cursor:
0072 6D8E 05A0  34         inc   @fb.row               ; Row++ in screen buffer
     6D90 A306     
0073 6D92 06A0  32         bl    @down                 ; Row++ VDP cursor
     6D94 26E0     
0074                       ;-------------------------------------------------------
0075                       ; Check line length and position cursor
0076                       ;-------------------------------------------------------
0077               fb.cursor.down.set_cursorx:
0078 6D96 06A0  32         bl    @edb.line.getlength2  ; \ Get length current line
     6D98 719A     
0079                                                   ; | i  @fb.row        = Row in frame buffer
0080                                                   ; / o  @fb.row.length = Length of row
0081               
0082 6D9A 8820  54         c     @fb.column,@fb.row.length
     6D9C A30C     
     6D9E A308     
0083 6DA0 1207  14         jle   fb.cursor.down.exit
0084                                                   ; Exit
0085                       ;-------------------------------------------------------
0086                       ; Adjust cursor column position
0087                       ;-------------------------------------------------------
0088 6DA2 C820  54         mov   @fb.row.length,@fb.column
     6DA4 A308     
     6DA6 A30C     
0089 6DA8 C120  34         mov   @fb.column,tmp0
     6DAA A30C     
0090 6DAC 06A0  32         bl    @xsetx                ; Set VDP cursor X
     6DAE 26F2     
0091                       ;-------------------------------------------------------
0092                       ; Exit
0093                       ;-------------------------------------------------------
0094               fb.cursor.down.exit:
0095 6DB0 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6DB2 6CBA     
0096 6DB4 C2F9  30         mov   *stack+,r11           ; Pop r11
0097 6DB6 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.68040
...
0022 6DBA C64B  30         mov   r11,*stack            ; Save return address
0023 6DBC 0649  14         dect  stack
0024 6DBE C644  30         mov   tmp0,*stack           ; Push tmp0
0025                       ;------------------------------------------------------
0026                       ; Cursor home
0027                       ;------------------------------------------------------
0028 6DC0 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6DC2 A318     
0029 6DC4 C120  34         mov   @wyx,tmp0
     6DC6 832A     
0030 6DC8 0244  22         andi  tmp0,>ff00            ; Reset cursor X position to 0
     6DCA FF00     
0031 6DCC C804  38         mov   tmp0,@wyx             ; VDP cursor column=0
     6DCE 832A     
0032 6DD0 04E0  34         clr   @fb.column
     6DD2 A30C     
0033 6DD4 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6DD6 6CBA     
0034 6DD8 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6DDA A318     
0035                       ;-------------------------------------------------------
0036                       ; Exit
0037                       ;-------------------------------------------------------
0038               fb.cursor.home.exit:
0039 6DDC C139  30         mov   *stack+,tmp0          ; Pop tmp0
0040 6DDE C2F9  30         mov   *stack+,r11           ; Pop r11
0041 6DE0 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.68040
...
0018               ********|*****|*********************|**************************
0019               fb.insert.line:
0020 6DE2 0649  14         dect  stack
0021 6DE4 C64B  30         mov   r11,*stack            ; Save return address
0022                       ;-------------------------------------------------------
0023                       ; Initialisation
0024                       ;-------------------------------------------------------
0025 6DE6 0720  34         seto  @edb.dirty            ; Editor buffer dirty (text changed!)
     6DE8 A506     
0026                       ;-------------------------------------------------------
0027                       ; Crunch current line if dirty
0028                       ;-------------------------------------------------------
0029 6DEA 8820  54         c     @fb.row.dirty,@w$ffff
     6DEC A30A     
     6DEE 2022     
0030 6DF0 1604  14         jne   fb.insert.line.insert
0031 6DF2 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     6DF4 6FA0     
0032 6DF6 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     6DF8 A30A     
0033                       ;-------------------------------------------------------
0034                       ; Insert entry in index
0035                       ;-------------------------------------------------------
0036               fb.insert.line.insert:
0037 6DFA 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6DFC 6CBA     
0038 6DFE C820  54         mov   @fb.topline,@parm1
     6E00 A304     
     6E02 A000     
0039 6E04 A820  54         a     @fb.row,@parm1        ; Line number to insert
     6E06 A306     
     6E08 A000     
0040 6E0A C820  54         mov   @edb.lines,@parm2     ; Last line to reorganize
     6E0C A504     
     6E0E A002     
0041               
0042 6E10 06A0  32         bl    @idx.entry.insert     ; Reorganize index
     6E12 35B4     
0043                                                   ; \ i  parm1 = Line for insert
0044                                                   ; / i  parm2 = Last line to reorg
0045               
0046 6E14 05A0  34         inc   @edb.lines            ; One line added to editor buffer
     6E16 A504     
0047 6E18 04E0  34         clr   @fb.row.length        ; Current row length = 0
     6E1A A308     
0048                       ;-------------------------------------------------------
0049                       ; Check/Adjust marker M1
0050                       ;-------------------------------------------------------
0051               fb.insert.line.m1:
0052 6E1C 8820  54         c     @edb.block.m1,@w$ffff ; Marker M1 unset?
     6E1E A50C     
     6E20 2022     
0053 6E22 1308  14         jeq   fb.insert.line.m2
0054                                                   ; Yes, skip to M2 check
0055               
0056 6E24 8820  54         c     @parm1,@edb.block.m1
     6E26 A000     
     6E28 A50C     
0057 6E2A 1504  14         jgt   fb.insert.line.m2
0058 6E2C 05A0  34         inc   @edb.block.m1         ; M1++
     6E2E A50C     
0059 6E30 0720  34         seto  @fb.colorize          ; Set colorize flag
     6E32 A310     
0060                       ;-------------------------------------------------------
0061                       ; Check/Adjust marker M2
0062                       ;-------------------------------------------------------
0063               fb.insert.line.m2:
0064 6E34 8820  54         c     @edb.block.m2,@w$ffff ; Marker M1 unset?
     6E36 A50E     
     6E38 2022     
0065 6E3A 1308  14         jeq   fb.insert.line.refresh
0066                                                   ; Yes, skip to refresh frame buffer
0067               
0068 6E3C 8820  54         c     @parm1,@edb.block.m2
     6E3E A000     
     6E40 A50E     
0069 6E42 1504  14         jgt   fb.insert.line.refresh
0070 6E44 05A0  34         inc   @edb.block.m2         ; M2++
     6E46 A50E     
0071 6E48 0720  34         seto  @fb.colorize          ; Set colorize flag
     6E4A A310     
0072                       ;-------------------------------------------------------
0073                       ; Refresh frame buffer and physical screen
0074                       ;-------------------------------------------------------
0075               fb.insert.line.refresh:
0076 6E4C C820  54         mov   @fb.topline,@parm1
     6E4E A304     
     6E50 A000     
0077               
0078 6E52 06A0  32         bl    @fb.refresh           ; \ Refresh frame buffer
     6E54 6EAA     
0079                                                   ; | i  @parm1 = Line to start with
0080                                                   ; /             (becomes @fb.topline)
0081               
0082 6E56 0720  34         seto  @fb.dirty             ; Trigger screen refresh
     6E58 A316     
0083 6E5A 06A0  32         bl    @fb.cursor.home       ; Move cursor home
     6E5C 6DB8     
0084                       ;-------------------------------------------------------
0085                       ; Exit
0086                       ;-------------------------------------------------------
0087               fb.insert.line.exit:
0088 6E5E C2F9  30         mov   *stack+,r11           ; Pop r11
0089 6E60 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.68040
...
0015 6E62 0649  14         dect  stack
0016 6E64 C64B  30         mov   r11,*stack            ; Save return address
0017                       ;------------------------------------------------------
0018                       ; Prepare for scanning
0019                       ;------------------------------------------------------
0020 6E66 04E0  34         clr   @fb.column
     6E68 A30C     
0021 6E6A 06A0  32         bl    @fb.calc_pointer
     6E6C 6CBA     
0022 6E6E 06A0  32         bl    @edb.line.getlength2  ; Get length current line
     6E70 719A     
0023 6E72 C1A0  34         mov   @fb.row.length,tmp2   ; Set loop counter
     6E74 A308     
0024 6E76 1313  14         jeq   fb.get.firstnonblank.nomatch
0025                                                   ; Exit if empty line
0026 6E78 C120  34         mov   @fb.current,tmp0      ; Pointer to current char
     6E7A A302     
0027 6E7C 04C5  14         clr   tmp1
0028                       ;------------------------------------------------------
0029                       ; Scan line for non-blank character
0030                       ;------------------------------------------------------
0031               fb.get.firstnonblank.loop:
0032 6E7E D174  28         movb  *tmp0+,tmp1           ; Get character
0033 6E80 130E  14         jeq   fb.get.firstnonblank.nomatch
0034                                                   ; Exit if empty line
0035 6E82 0285  22         ci    tmp1,>2000            ; Whitespace?
     6E84 2000     
0036 6E86 1503  14         jgt   fb.get.firstnonblank.match
0037 6E88 0606  14         dec   tmp2                  ; Counter--
0038 6E8A 16F9  14         jne   fb.get.firstnonblank.loop
0039 6E8C 1008  14         jmp   fb.get.firstnonblank.nomatch
0040                       ;------------------------------------------------------
0041                       ; Non-blank character found
0042                       ;------------------------------------------------------
0043               fb.get.firstnonblank.match:
0044 6E8E 6120  34         s     @fb.current,tmp0      ; Calculate column
     6E90 A302     
0045 6E92 0604  14         dec   tmp0
0046 6E94 C804  38         mov   tmp0,@outparm1        ; Save column
     6E96 A010     
0047 6E98 D805  38         movb  tmp1,@outparm2        ; Save character
     6E9A A012     
0048 6E9C 1004  14         jmp   fb.get.firstnonblank.exit
0049                       ;------------------------------------------------------
0050                       ; No non-blank character found
0051                       ;------------------------------------------------------
0052               fb.get.firstnonblank.nomatch:
0053 6E9E 04E0  34         clr   @outparm1             ; X=0
     6EA0 A010     
0054 6EA2 04E0  34         clr   @outparm2             ; Null
     6EA4 A012     
0055                       ;------------------------------------------------------
0056                       ; Exit
0057                       ;------------------------------------------------------
0058               fb.get.firstnonblank.exit:
0059 6EA6 C2F9  30         mov   *stack+,r11           ; Pop r11
0060 6EA8 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.68040
...
0113                       ;-----------------------------------------------------------------------
0114                       copy  "edb.line.mappage.asm"   ; Activate SAMS page for line
...
0149 7148 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.68040
0117                       copy  "edb.line.getlen.asm"    ; Get line length
     **** ****     > edb.line.getlen.asm
...
0125 71BC 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.68040
0118                       copy  "edb.line.copy.asm"      ; Copy line
     **** ****     > edb.line.copy.asm
...
0182 729E 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.68040
0119                       copy  "edb.line.del.asm"       ; Delete line
     **** ****     > edb.line.del.asm
...
0105 732E 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.68040
0120                       ;-----------------------------------------------------------------------
0121                       ; User hook, background tasks
0122                       ;-----------------------------------------------------------------------
0123                       copy  "hook.keyscan.asm"       ; spectra2 user hook: keyboard scan
     **** ****     > hook.keyscan.asm
...
0011               ****************************************************************
0012               hook.keyscan:
0013 7330 20A0  38         coc   @wbit11,config        ; ANYKEY pressed ?
     7332 200A     
0014 7334 161C  14         jne   hook.keyscan.clear_kbbuffer
0015                                                   ; No, clear buffer and exit
0016 7336 C820  54         mov   @waux1,@keycode1      ; Save current key pressed
     7338 833C     
     733A A022     
0017               *---------------------------------------------------------------
0018               * Identical key pressed ?
0019               *---------------------------------------------------------------
0020 733C 40A0  34         szc   @wbit11,config        ; Reset ANYKEY
     733E 200A     
0021 7340 8820  54         c     @keycode1,@keycode2   ; Still pressing previous key?
     7342 A022     
     7344 A024     
0022 7346 1608  14         jne   hook.keyscan.new      ; New key pressed
0023               *---------------------------------------------------------------
0024               * Activate auto-repeat ?
0025               *---------------------------------------------------------------
0026 7348 05A0  34         inc   @keyrptcnt
     734A A020     
0027 734C C120  34         mov   @keyrptcnt,tmp0
     734E A020     
0028 7350 0284  22         ci    tmp0,30
     7352 001E     
0029 7354 1112  14         jlt   hook.keyscan.bounce   ; No, do keyboard bounce delay and return
0030 7356 1002  14         jmp   hook.keyscan.autorepeat
0031               *--------------------------------------------------------------
0032               * New key pressed
0033               *--------------------------------------------------------------
0034               hook.keyscan.new:
0035 7358 04E0  34         clr   @keyrptcnt            ; Reset key-repeat counter
     735A A020     
0036               hook.keyscan.autorepeat:
0037 735C 0204  20         li    tmp0,250              ; \
     735E 00FA     
0038 7360 0604  14 !       dec   tmp0                  ; | Inline keyboard bounce delay
0039 7362 16FE  14         jne   -!                    ; /
0040 7364 C820  54         mov   @keycode1,@keycode2   ; Save as previous key
     7366 A022     
     7368 A024     
0041 736A 0460  28         b     @edkey.key.process    ; Process key
     736C 6110     
0042               *--------------------------------------------------------------
0043               * Clear keyboard buffer if no key pressed
0044               *--------------------------------------------------------------
0045               hook.keyscan.clear_kbbuffer:
0046 736E 04E0  34         clr   @keycode1
     7370 A022     
0047 7372 04E0  34         clr   @keycode2
     7374 A024     
0048 7376 04E0  34         clr   @keyrptcnt
     7378 A020     
0049               *--------------------------------------------------------------
0050               * Delay to avoid key bouncing
0051               *--------------------------------------------------------------
0052               hook.keyscan.bounce:
0053 737A 0204  20         li    tmp0,2000             ; Avoid key bouncing
     737C 07D0     
0054                       ;------------------------------------------------------
0055                       ; Delay loop
0056                       ;------------------------------------------------------
0057               hook.keyscan.bounce.loop:
0058 737E 0604  14         dec   tmp0
0059 7380 16FE  14         jne   hook.keyscan.bounce.loop
0060 7382 0460  28         b     @hookok               ; Return
     7384 2ED4     
0061               
                   < stevie_b1.asm.68040
0124                       copy  "task.vdp.panes.asm"     ; Draw editor panes in VDP
     **** ****     > task.vdp.panes.asm
...
0006               ********|*****|*********************|**************************
0007               task.vdp.panes:
0008 7386 0649  14         dect  stack
0009 7388 C64B  30         mov   r11,*stack            ; Save return address
0010                       ;------------------------------------------------------
0011                       ; Dump panes to VDP memory
0012                       ;------------------------------------------------------
0013 738A 06A0  32         bl    @pane.vdpdump
     738C 7A24     
0014                       ;------------------------------------------------------
0015                       ; Exit task
0016                       ;------------------------------------------------------
0017               task.vdp.panes.exit:
0018 738E C2F9  30         mov   *stack+,r11           ; Pop r11
0019 7390 0460  28         b     @slotok
     7392 2F50     
                   < stevie_b1.asm.68040
0125               
0127               
0128                       copy  "task.vdp.cursor.sat.asm"
...
0008 7394 0649  14         dect  stack
0009 7396 C64B  30         mov   r11,*stack            ; Save return address
0010 7398 0649  14         dect  stack
0011 739A C644  30         mov   tmp0,*stack           ; Push tmp0
0012 739C 0649  14         dect  stack
0013 739E C645  30         mov   tmp1,*stack           ; Push tmp1
0014 73A0 0649  14         dect  stack
0015 73A2 C646  30         mov   tmp2,*stack           ; Push tmp2
0016                       ;------------------------------------------------------
0017                       ; Get pane with focus
0018                       ;------------------------------------------------------
0019 73A4 C120  34         mov   @tv.pane.focus,tmp0   ; Get pane with focus
     73A6 A222     
0020               
0021 73A8 0284  22         ci    tmp0,pane.focus.fb
     73AA 0000     
0022 73AC 130F  14         jeq   task.vdp.copy.sat.fb  ; Frame buffer has focus
0023               
0024 73AE 0284  22         ci    tmp0,pane.focus.cmdb
     73B0 0001     
0025 73B2 1304  14         jeq   task.vdp.copy.sat.cmdb
0026                                                   ; CMDB buffer has focus
0027                       ;------------------------------------------------------
0028                       ; Assert failed. Invalid value
0029                       ;------------------------------------------------------
0030 73B4 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     73B6 FFCE     
0031 73B8 06A0  32         bl    @cpu.crash            ; / Halt system.
     73BA 2026     
0032                       ;------------------------------------------------------
0033                       ; CMDB buffer has focus, position cursor
0034                       ;------------------------------------------------------
0035               task.vdp.copy.sat.cmdb:
0036 73BC C820  54         mov   @cmdb.cursor,@wyx     ; Position cursor in CMDB pane
     73BE A70A     
     73C0 832A     
0037 73C2 E0A0  34         soc   @wbit0,config         ; Sprite adjustment on
     73C4 2020     
0038 73C6 06A0  32         bl    @yx2px                ; \ Calculate pixel position
     73C8 26FC     
0039                                                   ; | i  @WYX = Cursor YX
0040                                                   ; / o  tmp0 = Pixel YX
0041               
0042 73CA 100C  14         jmp   task.vdp.copy.sat.write
0043                       ;------------------------------------------------------
0044                       ; Frame buffer has focus, position cursor
0045                       ;------------------------------------------------------
0046               task.vdp.copy.sat.fb:
0047 73CC E0A0  34         soc   @wbit0,config         ; Sprite adjustment on
     73CE 2020     
0048 73D0 06A0  32         bl    @yx2px                ; \ Calculate pixel position
     73D2 26FC     
...
0054                       ;------------------------------------------------------
0055 73D4 C160  34         mov   @tv.ruler.visible,tmp1
     73D6 A210     
0056 73D8 1303  14         jeq   task.vdp.copy.sat.fb.noruler
0057 73DA 0224  22         ai    tmp0,>1000            ; Adjust VDP cursor because of topline+ruler
     73DC 1000     
0058 73DE 1002  14         jmp   task.vdp.copy.sat.write
0059               
0060               task.vdp.copy.sat.fb.noruler:
0061 73E0 0224  22         ai    tmp0,>0800            ; Adjust VDP cursor because of topline
     73E2 0800     
0062                       ;------------------------------------------------------
0063                       ; Dump sprite attribute table
0064                       ;------------------------------------------------------
0065               task.vdp.copy.sat.write:
0066 73E4 C804  38         mov   tmp0,@ramsat          ; Set cursor YX
     73E6 A030     
0067                       ;------------------------------------------------------
0068                       ; Handle column and row indicators
0069                       ;------------------------------------------------------
0070 73E8 C160  34         mov   @tv.ruler.visible,tmp1
     73EA A210     
0071                                                   ; Ruler visible?
0072 73EC 1314  14         jeq   task.vdp.copy.sat.hide.indicators
0073                                                   ; Not visible, skip
0074               
0075 73EE C160  34         mov   @cmdb.visible,tmp1
     73F0 A702     
0076 73F2 0285  22         ci    tmp1,>ffff            ; CMDB pane visible?
     73F4 FFFF     
0077 73F6 130F  14         jeq   task.vdp.copy.sat.hide.indicators
0078                                                   ; Not visible, skip
0079               
0080 73F8 0244  22         andi  tmp0,>ff00            ; \ Clear X position
     73FA FF00     
0081 73FC 0264  22         ori   tmp0,240              ; | Line indicator on pixel X 240
     73FE 00F0     
0082 7400 C804  38         mov   tmp0,@ramsat+4        ; / Set line indicator    <
     7402 A034     
0083               
0084 7404 C120  34         mov   @ramsat,tmp0
     7406 A030     
0085 7408 0244  22         andi  tmp0,>00ff            ; \ Clear Y position
     740A 00FF     
0086 740C 0264  22         ori   tmp0,>0800            ; | Column indicator on pixel Y 8
     740E 0800     
0087 7410 C804  38         mov   tmp0,@ramsat+8        ; / Set column indicator  v
     7412 A038     
0088               
0089 7414 1005  14         jmp   task.vdp.copy.sat.write2
0090                       ;------------------------------------------------------
0091                       ; Do not show column and row indicators
0092                       ;------------------------------------------------------
0093               task.vdp.copy.sat.hide.indicators:
0094 7416 04C5  14         clr   tmp1
0095 7418 D805  38         movb  tmp1,@ramsat+7        ; \ Hide line indicator    <
     741A A037     
0096                                                   ; / by transparant color
0097 741C D805  38         movb  tmp1,@ramsat+11       ; \ Hide column indicator  v
     741E A03B     
...
0103 7420 06A0  32         bl    @cpym2v               ; Copy sprite SAT to VDP
     7422 249A     
0104 7424 2180                   data sprsat,ramsat,14 ; \ i  p0 = VDP destination
     7426 A030     
     7428 000E     
...
0111 742A C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0112 742C C179  30         mov   *stack+,tmp1          ; Pop tmp1
0113 742E C139  30         mov   *stack+,tmp0          ; Pop tmp0
0114 7430 C2F9  30         mov   *stack+,r11           ; Pop r11
0115 7432 0460  28         b     @slotok               ; Exit task
     7434 2F50     
                   < stevie_b1.asm.68040
0129                                                      ; Copy cursor SAT to VDP
0130                       copy  "task.vdp.cursor.f18a.asm"
...
0008 7436 0649  14         dect  stack
0009 7438 C64B  30         mov   r11,*stack            ; Save return address
0010 743A 0649  14         dect  stack
0011 743C C644  30         mov   tmp0,*stack           ; Push tmp0
0012                       ;------------------------------------------------------
0013                       ; Toggle cursor
0014                       ;------------------------------------------------------
0015 743E 0560  34         inv   @fb.curtoggle         ; Flip cursor shape flag
     7440 A312     
0016 7442 1304  14         jeq   task.vdp.cursor.visible
0017                       ;------------------------------------------------------
0018                       ; Hide cursor
0019                       ;------------------------------------------------------
0020 7444 04C4  14         clr   tmp0
0021 7446 D804  38         movb  tmp0,@ramsat+3        ; Hide cursor
     7448 A033     
0022 744A 1003  14         jmp   task.vdp.cursor.copy.sat
0023                                                   ; Update VDP SAT and exit task
0024                       ;------------------------------------------------------
0025                       ; Show cursor
0026                       ;------------------------------------------------------
0027               task.vdp.cursor.visible:
0028 744C C820  54         mov   @tv.curshape,@ramsat+2
     744E A214     
     7450 A032     
...
0034 7452 06A0  32         bl    @cpym2v               ; Copy sprite SAT to VDP
     7454 249A     
0035 7456 2180                   data sprsat,ramsat,4  ; \ i  p0 = VDP destination
     7458 A030     
     745A 0004     
...
0042 745C C139  30         mov   *stack+,tmp0          ; Pop tmp0
0043 745E C2F9  30         mov   *stack+,r11           ; Pop r11
0044 7460 0460  28         b     @slotok               ; Exit task
     7462 2F50     
                   < stevie_b1.asm.68040
0131                                                      ; Set cursor shape in VDP (blink)
0138               
...
0007               
0008               task.oneshot:
0009 7464 C120  34         mov   @tv.task.oneshot,tmp0  ; Get pointer to one-shot task
     7466 A224     
0010 7468 1301  14         jeq   task.oneshot.exit
0011               
0012 746A 0694  24         bl    *tmp0                  ; Execute one-shot task
0013                       ;------------------------------------------------------
0014                       ; Exit
0015                       ;------------------------------------------------------
0016               task.oneshot.exit:
0017 746C 0460  28         b     @slotok                ; Exit task
     746E 2F50     
                   < stevie_b1.asm.68040
0140                       ;-----------------------------------------------------------------------
...
0020 7470 0649  14         dect  stack
0021 7472 C64B  30         mov   r11,*stack            ; Push return address
0022 7474 0649  14         dect  stack
0023 7476 C644  30         mov   tmp0,*stack           ; Push tmp0
0024               
0025 7478 C120  34         mov   @tv.colorscheme,tmp0  ; Load color scheme index
     747A A212     
0026 747C 0284  22         ci    tmp0,tv.colorscheme.entries
     747E 000A     
0027                                                   ; Last entry reached?
0028 7480 1103  14         jlt   !
0029 7482 0204  20         li    tmp0,1                ; Reset color scheme index
     7484 0001     
0030 7486 1001  14         jmp   pane.action.colorscheme.switch
0031 7488 0584  14 !       inc   tmp0
0032                       ;-------------------------------------------------------
0033                       ; Switch to new color scheme
0034                       ;-------------------------------------------------------
0035               pane.action.colorscheme.switch:
0036 748A C804  38         mov   tmp0,@tv.colorscheme  ; Save index of color scheme
     748C A212     
0037               
0038 748E 06A0  32         bl    @pane.action.colorscheme.load
     7490 74CE     
0039                                                   ; Load current color scheme
0040                       ;-------------------------------------------------------
0041                       ; Show current color palette message
0042                       ;-------------------------------------------------------
0043 7492 C820  54         mov   @wyx,@waux1           ; Save cursor YX position
     7494 832A     
     7496 833C     
0044               
0045 7498 06A0  32         bl    @putnum
     749A 2B32     
0046 749C 003E                   byte 0,62
0047 749E A212                   data tv.colorscheme,rambuf,>3020
     74A0 A100     
     74A2 3020     
0048               
0049 74A4 06A0  32         bl    @putat
     74A6 2456     
0050 74A8 0034                   byte 0,52
0051 74AA 39BC                   data txt.colorscheme  ; Show color palette message
0052               
0053 74AC C820  54         mov   @waux1,@wyx           ; Restore cursor YX position
     74AE 833C     
     74B0 832A     
0054                       ;-------------------------------------------------------
0055                       ; Delay
0056                       ;-------------------------------------------------------
0057 74B2 0204  20         li    tmp0,12000
     74B4 2EE0     
0058 74B6 0604  14 !       dec   tmp0
0059 74B8 16FE  14         jne   -!
0060                       ;-------------------------------------------------------
0061                       ; Setup one shot task for removing message
0062                       ;-------------------------------------------------------
0063 74BA 0204  20         li    tmp0,pane.topline.oneshot.clearmsg
     74BC 360C     
0064 74BE C804  38         mov   tmp0,@tv.task.oneshot
     74C0 A224     
0065               
0066 74C2 06A0  32         bl    @rsslot               ; \ Reset loop counter slot 3
     74C4 2FC4     
0067 74C6 0003                   data 3                ; / for getting consistent delay
0068                       ;-------------------------------------------------------
0069                       ; Exit
0070                       ;-------------------------------------------------------
0071               pane.action.colorscheme.cycle.exit:
0072 74C8 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0073 74CA C2F9  30         mov   *stack+,r11           ; Pop R11
0074 74CC 045B  20         b     *r11                  ; Return to caller
0075               
0076               
0077               
0078               ***************************************************************
...
0097 74CE 0649  14         dect  stack
0098 74D0 C64B  30         mov   r11,*stack            ; Save return address
0099 74D2 0649  14         dect  stack
0100 74D4 C644  30         mov   tmp0,*stack           ; Push tmp0
0101 74D6 0649  14         dect  stack
0102 74D8 C645  30         mov   tmp1,*stack           ; Push tmp1
0103 74DA 0649  14         dect  stack
0104 74DC C646  30         mov   tmp2,*stack           ; Push tmp2
0105 74DE 0649  14         dect  stack
0106 74E0 C647  30         mov   tmp3,*stack           ; Push tmp3
0107 74E2 0649  14         dect  stack
0108 74E4 C648  30         mov   tmp4,*stack           ; Push tmp4
0109 74E6 0649  14         dect  stack
0110 74E8 C660  46         mov   @parm1,*stack         ; Push parm1
     74EA A000     
0111 74EC 0649  14         dect  stack
0112 74EE C660  46         mov   @parm2,*stack         ; Push parm2
     74F0 A002     
0113 74F2 0649  14         dect  stack
0114 74F4 C660  46         mov   @parm3,*stack         ; Push parm3
     74F6 A004     
0115                       ;-------------------------------------------------------
0116                       ; Turn screen off
0117                       ;-------------------------------------------------------
0118 74F8 C120  34         mov   @parm1,tmp0
     74FA A000     
0119 74FC 0284  22         ci    tmp0,>ffff            ; Skip flag set?
     74FE FFFF     
0120 7500 1302  14         jeq   !                     ; Yes, so skip screen off
0121 7502 06A0  32         bl    @scroff               ; Turn screen off
     7504 269A     
0122                       ;-------------------------------------------------------
0123                       ; Get FG/BG colors framebuffer text
0124                       ;-------------------------------------------------------
0125 7506 C120  34 !       mov   @tv.colorscheme,tmp0  ; Get color scheme index
     7508 A212     
0126 750A 0604  14         dec   tmp0                  ; Internally work with base 0
0127               
0128 750C 0A34  56         sla   tmp0,3                ; Offset into color scheme data table
0129 750E 0224  22         ai    tmp0,tv.colorscheme.table
     7510 3658     
0130                                                   ; Add base for color scheme data table
0131 7512 C1F4  30         mov   *tmp0+,tmp3           ; Get colors ABCD
0132 7514 C807  38         mov   tmp3,@tv.color        ; Save colors ABCD
     7516 A218     
0133                       ;-------------------------------------------------------
0134                       ; Get and save cursor color
0135                       ;-------------------------------------------------------
0136 7518 C214  26         mov   *tmp0,tmp4            ; Get colors EFGH
0137 751A 0248  22         andi  tmp4,>00ff            ; Only keep LSB (GH)
     751C 00FF     
0138 751E C808  38         mov   tmp4,@tv.curcolor     ; Save cursor color
     7520 A216     
0139                       ;-------------------------------------------------------
0140                       ; Get FG/BG colors framebuffer marked text & CMDB pane
0141                       ;-------------------------------------------------------
0142 7522 C234  30         mov   *tmp0+,tmp4           ; Get colors EFGH again
0143 7524 0248  22         andi  tmp4,>ff00            ; Only keep MSB (EF)
     7526 FF00     
0144 7528 0988  56         srl   tmp4,8                ; MSB to LSB
0145               
0146 752A C174  30         mov   *tmp0+,tmp1           ; Get colors IJKL
0147 752C C185  18         mov   tmp1,tmp2             ; \ Right align IJ and
0148 752E 0986  56         srl   tmp2,8                ; | save to @tv.busycolor
0149 7530 C806  38         mov   tmp2,@tv.busycolor    ; /
     7532 A21C     
0150               
0151 7534 0245  22         andi  tmp1,>00ff            ; | save KL to @tv.markcolor
     7536 00FF     
0152 7538 C805  38         mov   tmp1,@tv.markcolor    ; /
     753A A21A     
0153               
0154 753C C154  26         mov   *tmp0,tmp1            ; Get colors MNOP
0155 753E 0985  56         srl   tmp1,8                ; \ Right align MN and
0156 7540 C805  38         mov   tmp1,@tv.cmdb.hcolor  ; / save to @tv.cmdb.hcolor
     7542 A220     
0157                       ;-------------------------------------------------------
0158                       ; Check if only CMDB needs to be colorized
0159                       ;-------------------------------------------------------
0160 7544 8820  54         c     @parm3,@w$ffff        ; Only colorize CMDB pane ?
     7546 A004     
     7548 2022     
0161 754A 133E  14         jeq   pane.action.colorscheme.cmdbpane
0162                                                   ; Yes, shortcut jump to CMDB pane
0163                       ;-------------------------------------------------------
0164                       ; Get FG color for ruler
0165                       ;-------------------------------------------------------
0166 754C C154  26         mov   *tmp0,tmp1            ; Get colors MNOP
0167 754E 0245  22         andi  tmp1,>000f            ; Only keep P
     7550 000F     
0168 7552 0A45  56         sla   tmp1,4                ; Make it a FG/BG combination
0169 7554 C805  38         mov   tmp1,@tv.rulercolor   ; Save to @tv.rulercolor
     7556 A21E     
0170                       ;-------------------------------------------------------
0171                       ; Write sprite color of line and column indicators to SAT
0172                       ;-------------------------------------------------------
0173 7558 C154  26         mov   *tmp0,tmp1            ; Get colors MNOP
0174 755A 0245  22         andi  tmp1,>00f0            ; Only keep O
     755C 00F0     
0175 755E 0A45  56         sla   tmp1,4                ; Move O to MSB
0176 7560 D805  38         movb  tmp1,@ramsat+7        ; Line indicator FG color to SAT
     7562 A037     
0177 7564 D805  38         movb  tmp1,@ramsat+11       ; Column indicator FG color to SAT
     7566 A03B     
0178                       ;-------------------------------------------------------
0179                       ; Dump colors to VDP register 7 (text mode)
0180                       ;-------------------------------------------------------
0181 7568 C147  18         mov   tmp3,tmp1             ; Get work copy
0182 756A 0985  56         srl   tmp1,8                ; MSB to LSB (frame buffer colors)
0183 756C 0265  22         ori   tmp1,>0700
     756E 0700     
0184 7570 C105  18         mov   tmp1,tmp0
0185 7572 06A0  32         bl    @putvrx               ; Write VDP register
     7574 2348     
0186                       ;-------------------------------------------------------
0187                       ; Dump colors for frame buffer pane (TAT)
0188                       ;-------------------------------------------------------
0189 7576 C120  34         mov   @tv.ruler.visible,tmp0
     7578 A210     
0190 757A 130A  14         jeq   pane.action.colorscheme.fbdump.noruler
0191               
0192 757C C120  34         mov   @cmdb.dialog,tmp0
     757E A71A     
0193 7580 0284  22         ci    tmp0,id.dialog.help   ; Help dialog active?
     7582 0068     
0194 7584 1305  14         jeq   pane.action.colorscheme.fbdump.noruler
0195                                                   ; Yes, skip ruler
0196                       ;-------------------------------------------------------
0197                       ; Ruler visible on screen (TAT)
0198                       ;-------------------------------------------------------
0199 7586 0204  20         li    tmp0,vdp.fb.toprow.tat+80
     7588 18A0     
0200                                                   ; VDP start address (frame buffer area)
0201               
0202 758A 0206  20         li    tmp2,(pane.botrow-2)*80
     758C 0870     
0203                                                   ; Number of bytes to fill
0204 758E 1004  14         jmp   pane.action.colorscheme.checkcmdb
0205               
0206               pane.action.colorscheme.fbdump.noruler:
0207                       ;-------------------------------------------------------
0208                       ; No ruler visible on screen (TAT)
0209                       ;-------------------------------------------------------
0210 7590 0204  20         li    tmp0,vdp.fb.toprow.tat
     7592 1850     
0211                                                   ; VDP start address (frame buffer area)
0212 7594 0206  20         li    tmp2,(pane.botrow-1)*80
     7596 08C0     
...
0218 7598 C820  54         mov   @cmdb.visible,@cmdb.visible
     759A A702     
     759C A702     
0219 759E 1302  14         jeq   pane.action.colorscheme.fbdump
0220                                                   ; Not visible, skip adjustment
0221 75A0 0226  22         ai    tmp2,-320             ; CMDB adjustment
     75A2 FEC0     
0222                       ;-------------------------------------------------------
0223                       ; Dump colors to VDP (TAT)
0224                       ;-------------------------------------------------------
0225               pane.action.colorscheme.fbdump:
0226 75A4 C147  18         mov   tmp3,tmp1             ; Get work copy of colors ABCD
0227 75A6 0985  56         srl   tmp1,8                ; MSB to LSB (frame buffer colors)
0228               
0229 75A8 06A0  32         bl    @xfilv                ; Fill colors
     75AA 22A8     
...
0235                       ;-------------------------------------------------------
0236 75AC C120  34         mov   @cmdb.dialog,tmp0
     75AE A71A     
0237 75B0 0284  22         ci    tmp0,id.dialog.help   ; Help dialog active?
     75B2 0068     
0238 75B4 1309  14         jeq   pane.action.colorscheme.cmdbpane
0239                                                   ; Yes, skip marked lines
0240               
0241 75B6 C120  34         mov   @parm2,tmp0
     75B8 A002     
0242 75BA 0284  22         ci    tmp0,>ffff            ; Skip colorize flag is on?
     75BC FFFF     
0243 75BE 1304  14         jeq   pane.action.colorscheme.cmdbpane
0244               
0245 75C0 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     75C2 A310     
0246 75C4 06A0  32         bl    @fb.colorlines
     75C6 7CAC     
0247                       ;-------------------------------------------------------
0248                       ; Dump colors for CMDB header line (TAT)
0249                       ;-------------------------------------------------------
0250               pane.action.colorscheme.cmdbpane:
0251 75C8 C120  34         mov   @cmdb.visible,tmp0
     75CA A702     
0252 75CC 1330  14         jeq   pane.action.colorscheme.errpane
0253                                                   ; Skip if CMDB pane is hidden
0254               
0255 75CE 0204  20         li    tmp0,vdp.cmdb.toprow.tat
     75D0 1FD0     
0256                                                   ; VDP start address (CMDB top line)
0257               
0258 75D2 C160  34         mov   @tv.cmdb.hcolor,tmp1  ; set color for header line
     75D4 A220     
0259 75D6 0206  20         li    tmp2,1*67             ; Number of bytes to fill
     75D8 0043     
0260 75DA 06A0  32         bl    @xfilv                ; Fill colors
     75DC 22A8     
...
0266                       ;-------------------------------------------------------
0267 75DE 0204  20         li    tmp0,vdp.cmdb.toprow.tat+67
     75E0 2013     
0268 75E2 C160  34         mov   @tv.cmdb.hcolor,tmp1  ;
     75E4 A220     
0269 75E6 D160  34         movb  @tv.cmdb.hcolor+1,tmp1
     75E8 A221     
0270                                                   ; Copy same value into MSB
0271 75EA 0945  56         srl   tmp1,4                ;
0272 75EC 0245  22         andi  tmp1,>00ff            ; Only keep LSB
     75EE 00FF     
0273               
0274 75F0 0206  20         li    tmp2,13               ; Number of bytes to fill
     75F2 000D     
0275 75F4 06A0  32         bl    @xfilv                ; Fill colors
     75F6 22A8     
...
0281                       ;-------------------------------------------------------
0282 75F8 0204  20         li    tmp0,vdp.cmdb.toprow.tat + 80
     75FA 2020     
0283                                                   ; VDP start address (CMDB top line + 1)
0284 75FC C148  18         mov   tmp4,tmp1             ; Get work copy fg/bg color
0285 75FE 0206  20         li    tmp2,1*80             ; Number of bytes to fill
     7600 0050     
0286 7602 06A0  32         bl    @xfilv                ; Fill colors
     7604 22A8     
0287                                                   ; i \  tmp0 = start address
0288                                                   ; i |  tmp1 = byte to fill
0289                                                   ; i /  tmp2 = number of bytes to fill
0290               
0291 7606 0204  20         li    tmp0,vdp.cmdb.toprow.tat + 160
     7608 2070     
0292                                                   ; VDP start address (CMDB top line + 2)
0293 760A C160  34         mov   @tv.cmdb.hcolor,tmp1  ; Same color as header line
     760C A220     
0294 760E 0206  20         li    tmp2,1*80             ; Number of bytes to fill
     7610 0050     
0295 7612 06A0  32         bl    @xfilv                ; Fill colors
     7614 22A8     
0296                                                   ; i \  tmp0 = start address
0297                                                   ; i |  tmp1 = byte to fill
0298                                                   ; i /  tmp2 = number of bytes to fill
0299               
0300 7616 0204  20         li    tmp0,vdp.cmdb.toprow.tat + 240
     7618 20C0     
0301                                                   ; VDP start address (CMDB top line + 3)
0302 761A C148  18         mov   tmp4,tmp1             ; Get work copy fg/bg color
0303 761C 0206  20         li    tmp2,1*80             ; Number of bytes to fill
     761E 0050     
0304 7620 06A0  32         bl    @xfilv                ; Fill colors
     7622 22A8     
...
0310                       ;-------------------------------------------------------
0311 7624 C120  34         mov   @parm3,tmp0
     7626 A004     
0312 7628 0284  22         ci    tmp0,>ffff            ; Only colorize CMDB pane ?
     762A FFFF     
0313 762C 132F  14         jeq   pane.action.colorscheme.cursorcolor.cmdb
0314                                                   ; Yes, shortcut to CMDB cursor color
0315                       ;-------------------------------------------------------
0316                       ; Dump colors for error pane (TAT)
0317                       ;-------------------------------------------------------
0318               pane.action.colorscheme.errpane:
0319 762E C120  34         mov   @tv.error.visible,tmp0
     7630 A228     
0320 7632 1306  14         jeq   pane.action.colorscheme.statline
0321                                                   ; Skip if error pane is hidden
0322               
0323 7634 0205  20         li    tmp1,>00f6            ; White on dark red
     7636 00F6     
0324 7638 C805  38         mov   tmp1,@parm1           ; Pass color combination
     763A A000     
0325               
0326 763C 06A0  32         bl    @pane.errline.drawcolor
     763E 7824     
...
0334 7640 C160  34         mov   @tv.color,tmp1
     7642 A218     
0335 7644 0245  22         andi  tmp1,>00ff            ; Only keep LSB (status line colors)
     7646 00FF     
0336 7648 C805  38         mov   tmp1,@parm1           ; Set color combination
     764A A000     
0337               
0338               
0339 764C 04E0  34         clr   @parm2                ; Top row on screen
     764E A002     
0340 7650 06A0  32         bl    @colors.line.set      ; Load color combination for line
     7652 7718     
0341                                                   ; \ i  @parm1 = Color combination
0342                                                   ; / i  @parm2 = Row on physical screen
0343               
0344 7654 0205  20         li    tmp1,pane.botrow
     7656 001D     
0345 7658 C805  38         mov   tmp1,@parm2           ; Bottom row on screen
     765A A002     
0346 765C 06A0  32         bl    @colors.line.set      ; Load color combination for line
     765E 7718     
...
0351                       ;-------------------------------------------------------
0352 7660 C160  34         mov   @cmdb.dialog,tmp1
     7662 A71A     
0353 7664 0285  22         ci    tmp1,id.dialog.help   ; Help dialog active?
     7666 0068     
0354 7668 130A  14         jeq   pane.action.colorscheme.cursorcolor
0355                                                   ; Yes, skip ruler
0356               
0357 766A C160  34         mov   @tv.ruler.visible,tmp1
     766C A210     
0358 766E 1307  14         jeq   pane.action.colorscheme.cursorcolor
0359               
0360 7670 06A0  32         bl    @fb.ruler.init        ; Setup ruler with tab-positions in memory
     7672 7C9A     
0361 7674 06A0  32         bl    @cpym2v
     7676 249A     
0362 7678 1850                   data vdp.fb.toprow.tat
0363 767A A36E                   data fb.ruler.tat
0364 767C 0050                   data 80               ; Show ruler colors
0365                       ;-------------------------------------------------------
0366                       ; Dump cursor FG color to sprite table (SAT)
0367                       ;-------------------------------------------------------
0368               pane.action.colorscheme.cursorcolor:
0369 767E C220  34         mov   @tv.curcolor,tmp4     ; Get cursor color
     7680 A216     
0370               
0371 7682 C120  34         mov   @tv.pane.focus,tmp0   ; Get pane with focus
     7684 A222     
0372 7686 0284  22         ci    tmp0,pane.focus.fb    ; Frame buffer has focus?
     7688 0000     
0373 768A 1304  14         jeq   pane.action.colorscheme.cursorcolor.fb
0374                                                   ; Yes, set cursor color
0375               
0376               pane.action.colorscheme.cursorcolor.cmdb:
0377 768C 0248  22         andi  tmp4,>f0              ; Only keep high-nibble -> Word 2 (G)
     768E 00F0     
0378 7690 0A48  56         sla   tmp4,4                ; Move to MSB
0379 7692 1003  14         jmp   !
0380               
0381               pane.action.colorscheme.cursorcolor.fb:
0382 7694 0248  22         andi  tmp4,>0f              ; Only keep low-nibble -> Word 2 (H)
     7696 000F     
0383 7698 0A88  56         sla   tmp4,8                ; Move to MSB
0384               
0385 769A D808  38 !       movb  tmp4,@ramsat+3        ; Update FG color in sprite table (SAT)
     769C A033     
0386 769E D808  38         movb  tmp4,@tv.curshape+1   ; Save cursor color
     76A0 A215     
0387                       ;-------------------------------------------------------
0388                       ; Exit
0389                       ;-------------------------------------------------------
0390               pane.action.colorscheme.load.exit:
0391 76A2 06A0  32         bl    @scron                ; Turn screen on
     76A4 26A2     
0392 76A6 C839  50         mov   *stack+,@parm3        ; Pop @parm3
     76A8 A004     
0393 76AA C839  50         mov   *stack+,@parm2        ; Pop @parm2
     76AC A002     
0394 76AE C839  50         mov   *stack+,@parm1        ; Pop @parm1
     76B0 A000     
0395 76B2 C239  30         mov   *stack+,tmp4          ; Pop tmp4
0396 76B4 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0397 76B6 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0398 76B8 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0399 76BA C139  30         mov   *stack+,tmp0          ; Pop tmp0
0400 76BC C2F9  30         mov   *stack+,r11           ; Pop R11
0401 76BE 045B  20         b     *r11                  ; Return to caller
0402               
0403               
0404               
0405               ***************************************************************
...
0421 76C0 0649  14         dect  stack
0422 76C2 C64B  30         mov   r11,*stack            ; Save return address
0423 76C4 0649  14         dect  stack
0424 76C6 C644  30         mov   tmp0,*stack           ; Push tmp0
0425                       ;------------------------------------------------------
0426                       ; Bottom line
0427                       ;------------------------------------------------------
0428 76C8 0204  20         li    tmp0,pane.botrow
     76CA 001D     
0429 76CC C804  38         mov   tmp0,@parm2           ; Last row on screen
     76CE A002     
0430 76D0 06A0  32         bl    @colors.line.set      ; Load color combination for line
     76D2 7718     
...
0437 76D4 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0438 76D6 C2F9  30         mov   *stack+,r11           ; Pop R11
0439 76D8 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.68040
0144                                                      ; Colorscheme handling in panes
0145                       copy  "pane.cursor.asm"        ; Cursor utility functions
     **** ****     > pane.cursor.asm
...
0020 76DA 0649  14         dect  stack
0021 76DC C64B  30         mov   r11,*stack            ; Save return address
0022                       ;-------------------------------------------------------
0023                       ; Hide cursor
0024                       ;-------------------------------------------------------
0025 76DE 06A0  32         bl    @filv                 ; Clear sprite SAT in VDP RAM
     76E0 22A2     
0026 76E2 2180                   data sprsat,>00,8     ; \ i  p0 = VDP destination
     76E4 0000     
     76E6 0008     
0027                                                   ; | i  p1 = Byte to write
0028                                                   ; / i  p2 = Number of bytes to write
0029               
0030 76E8 06A0  32         bl    @clslot
     76EA 2FB6     
0031 76EC 0001                   data 1                ; Terminate task.vdp.copy.sat
0032               
0033 76EE 06A0  32         bl    @clslot
     76F0 2FB6     
0034 76F2 0002                   data 2                ; Terminate task.vdp.cursor
0035                       ;-------------------------------------------------------
0036                       ; Exit
0037                       ;-------------------------------------------------------
0038               pane.cursor.hide.exit:
0039 76F4 C2F9  30         mov   *stack+,r11           ; Pop R11
0040 76F6 045B  20         b     *r11                  ; Return to caller
0041               
0042               
0043               
0044               ***************************************************************
...
0060 76F8 0649  14         dect  stack
0061 76FA C64B  30         mov   r11,*stack            ; Save return address
0062                       ;-------------------------------------------------------
0063                       ; Hide cursor
0064                       ;-------------------------------------------------------
0065 76FC 06A0  32         bl    @filv                 ; Clear sprite SAT in VDP RAM
     76FE 22A2     
0066 7700 2180                   data sprsat,>00,4     ; \ i  p0 = VDP destination
     7702 0000     
     7704 0004     
...
0069               
0071               
0072 7706 06A0  32         bl    @mkslot
     7708 2F98     
0073 770A 0102                   data >0102,task.vdp.copy.sat ; Task 1 - Update cursor position
     770C 7394     
0074 770E 020F                   data >020f,task.vdp.cursor   ; Task 2 - Toggle cursor shape
     7710 7436     
0075 7712 FFFF                   data eol
0076               
0084               
0085                       ;-------------------------------------------------------
0086                       ; Exit
...
0089 7714 C2F9  30         mov   *stack+,r11           ; Pop R11
0090 7716 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.68040
0146                       ;-----------------------------------------------------------------------
0147                       ; Screen panes
0148                       ;-----------------------------------------------------------------------
0149                       copy  "colors.line.set.asm"    ; Set color combination for line
     **** ****     > colors.line.set.asm
...
0021 7718 0649  14         dect  stack
0022 771A C64B  30         mov   r11,*stack            ; Save return address
0023 771C 0649  14         dect  stack
0024 771E C644  30         mov   tmp0,*stack           ; Push tmp0
0025 7720 0649  14         dect  stack
0026 7722 C645  30         mov   tmp1,*stack           ; Push tmp1
0027 7724 0649  14         dect  stack
0028 7726 C646  30         mov   tmp2,*stack           ; Push tmp2
0029 7728 0649  14         dect  stack
0030 772A C660  46         mov   @parm1,*stack         ; Push parm1
     772C A000     
0031 772E 0649  14         dect  stack
0032 7730 C660  46         mov   @parm2,*stack         ; Push parm2
     7732 A002     
0033                       ;-------------------------------------------------------
0034                       ; Dump colors for line in TAT
0035                       ;-------------------------------------------------------
0036 7734 C120  34         mov   @parm2,tmp0           ; Get target line
     7736 A002     
0037 7738 0205  20         li    tmp1,colrow           ; Columns per row (spectra2)
     773A 0050     
0038 773C 3944  56         mpy   tmp0,tmp1             ; Calculate VDP address (results in tmp2!)
0039               
0040 773E C106  18         mov   tmp2,tmp0             ; Set VDP start address
0041 7740 0224  22         ai    tmp0,vdp.tat.base     ; Add TAT base address
     7742 1800     
0042 7744 C160  34         mov   @parm1,tmp1           ; Get foreground/background color
     7746 A000     
0043 7748 0206  20         li    tmp2,80               ; Number of bytes to fill
     774A 0050     
0044               
0045 774C 06A0  32         bl    @xfilv                ; Fill colors
     774E 22A8     
...
0053 7750 C839  50         mov   *stack+,@parm2        ; Pop @parm2
     7752 A002     
0054 7754 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     7756 A000     
0055 7758 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0056 775A C179  30         mov   *stack+,tmp1          ; Pop tmp1
0057 775C C139  30         mov   *stack+,tmp0          ; Pop tmp0
0058 775E C2F9  30         mov   *stack+,r11           ; Pop R11
0059 7760 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.68040
0150                       copy  "pane.topline.asm"       ; Top line
     **** ****     > pane.topline.asm
...
0015               ********|*****|*********************|**************************
0016               pane.topline:
0017 7762 0649  14         dect  stack
0018 7764 C64B  30         mov   r11,*stack            ; Save return address
0019 7766 0649  14         dect  stack
0020 7768 C644  30         mov   tmp0,*stack           ; Push tmp0
0021 776A 0649  14         dect  stack
0022 776C C660  46         mov   @wyx,*stack           ; Push cursor position
     776E 832A     
0023                       ;------------------------------------------------------
0024                       ; Show current file
0025                       ;------------------------------------------------------
0026               pane.topline.file:
0027 7770 06A0  32         bl    @at
     7772 26DA     
0028 7774 0000                   byte 0,0              ; y=0, x=0
0029               
0030 7776 C820  54         mov   @edb.filename.ptr,@parm1
     7778 A512     
     777A A000     
0031                                                   ; Get string to display
0032 777C 0204  20         li    tmp0,47
     777E 002F     
0033 7780 C804  38         mov   tmp0,@parm2           ; Set requested length
     7782 A002     
0034 7784 0204  20         li    tmp0,32
     7786 0020     
0035 7788 C804  38         mov   tmp0,@parm3           ; Set character to fill
     778A A004     
0036 778C 0204  20         li    tmp0,rambuf
     778E A100     
0037 7790 C804  38         mov   tmp0,@parm4           ; Set pointer to buffer for output string
     7792 A006     
0038               
0039               
0040 7794 06A0  32         bl    @tv.pad.string        ; Pad string to specified length
     7796 33EC     
...
0045                                                   ; /             output string
0046               
0047 7798 C160  34         mov   @outparm1,tmp1        ; \ Display padded filename
     779A A010     
0048 779C 06A0  32         bl    @xutst0               ; /
     779E 2434     
0049                       ;------------------------------------------------------
0050                       ; Show if text was changed in editor buffer
0051                       ;------------------------------------------------------
0052               pane.topline.show_dirty:
0053 77A0 C120  34         mov   @edb.dirty,tmp0
     77A2 A506     
0054 77A4 1305  14         jeq   pane.topline.nochange
0055                       ;------------------------------------------------------
0056                       ; Show "*"
0057                       ;------------------------------------------------------
0058 77A6 06A0  32         bl    @putat
     77A8 2456     
0059 77AA 004F                   byte 0,79             ; y=0, x=79
0060 77AC 36CC                   data txt.star
0061 77AE 1004  14         jmp   pane.topline.showmarkers
0062                       ;------------------------------------------------------
0063                       ; Show " "
0064                       ;------------------------------------------------------
0065               pane.topline.nochange:
0066 77B0 06A0  32         bl    @putat
     77B2 2456     
0067 77B4 004F                   byte 0,79             ; y=0, x=79
0068 77B6 38E8                   data txt.ws1          ; Single white space
0069                       ;------------------------------------------------------
0070                       ; Check if M1/M2 markers need to be shown
0071                       ;------------------------------------------------------
0072               pane.topline.showmarkers:
0073 77B8 C120  34         mov   @edb.block.m1,tmp0    ; \
     77BA A50C     
0074 77BC 0284  22         ci    tmp0,>ffff            ; | Exit early if M1 unset (>ffff)
     77BE FFFF     
0075 77C0 132C  14         jeq   pane.topline.exit     ; /
0076               
0077 77C2 C120  34         mov   @tv.task.oneshot,tmp0 ; \
     77C4 A224     
0078 77C6 0284  22         ci    tmp0,pane.topline.oneshot.clearmsg
     77C8 360C     
0079                                                   ; | Exit early if overlay message visible
0080 77CA 1327  14         jeq   pane.topline.exit     ; /
0081                       ;------------------------------------------------------
0082                       ; Show M1 marker
0083                       ;------------------------------------------------------
0084 77CC 06A0  32         bl    @putat
     77CE 2456     
0085 77D0 0034                   byte 0,52
0086 77D2 3848                   data txt.m1           ; Show M1 marker message
0087               
0088 77D4 C820  54         mov   @edb.block.m1,@parm1
     77D6 A50C     
     77D8 A000     
0089 77DA 06A0  32         bl    @tv.unpack.uint16     ; Unpack 16 bit unsigned integer to string
     77DC 33C0     
0090                                                   ; \ i @parm1           = uint16
0091                                                   ; / o @unpacked.string = Output string
0092               
0093 77DE 0204  20         li    tmp0,>0500
     77E0 0500     
0094 77E2 D804  38         movb  tmp0,@unpacked.string ; Set string length to 5 (padding)
     77E4 A026     
0095               
0096 77E6 06A0  32         bl    @putat
     77E8 2456     
0097 77EA 0037                   byte 0,55
0098 77EC A026                   data unpacked.string  ; Show M1 value
0099                       ;------------------------------------------------------
0100                       ; Show M2 marker
0101                       ;------------------------------------------------------
0102 77EE C120  34         mov   @edb.block.m2,tmp0    ; \
     77F0 A50E     
0103 77F2 0284  22         ci    tmp0,>ffff            ; | Exit early if M2 unset (>ffff)
     77F4 FFFF     
0104 77F6 1311  14         jeq   pane.topline.exit     ; /
0105               
0106 77F8 06A0  32         bl    @putat
     77FA 2456     
0107 77FC 003E                   byte 0,62
0108 77FE 384C                   data txt.m2           ; Show M2 marker message
0109               
0110 7800 C820  54         mov   @edb.block.m2,@parm1
     7802 A50E     
     7804 A000     
0111 7806 06A0  32         bl    @tv.unpack.uint16     ; Unpack 16 bit unsigned integer to string
     7808 33C0     
0112                                                   ; \ i @parm1           = uint16
0113                                                   ; / o @unpacked.string = Output string
0114               
0115 780A 0204  20         li    tmp0,>0500
     780C 0500     
0116 780E D804  38         movb  tmp0,@unpacked.string ; Set string length to 5 (padding)
     7810 A026     
0117               
0118 7812 06A0  32         bl    @putat
     7814 2456     
0119 7816 0041                   byte 0,65
0120 7818 A026                   data unpacked.string  ; Show M2 value
0121                       ;------------------------------------------------------
0122                       ; Exit
0123                       ;------------------------------------------------------
0124               pane.topline.exit:
0125 781A C839  50         mov   *stack+,@wyx          ; Pop cursor position
     781C 832A     
0126 781E C139  30         mov   *stack+,tmp0          ; Pop tmp0
0127 7820 C2F9  30         mov   *stack+,r11           ; Pop r11
0128 7822 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.68040
...
0023 7824 0649  14         dect  stack
0024 7826 C64B  30         mov   r11,*stack            ; Save return address
0025 7828 0649  14         dect  stack
0026 782A C644  30         mov   tmp0,*stack           ; Push tmp0
0027 782C 0649  14         dect  stack
0028 782E C645  30         mov   tmp1,*stack           ; Push tmp1
0029 7830 0649  14         dect  stack
0030 7832 C646  30         mov   tmp2,*stack           ; Push tmp2
0031                       ;-------------------------------------------------------
0032                       ; Determine 1st row in error pane
0033                       ;-------------------------------------------------------
0034 7834 0204  20         li    tmp0,pane.botrow      ; Get rows on screen
     7836 001D     
0035 7838 C144  18         mov   tmp0,tmp1             ; \ Get first row in error pane
0036 783A 6160  34         s     @tv.error.rows,tmp1   ; /
     783C A22A     
0037                       ;-------------------------------------------------------
0038                       ; Dump colors for row
0039                       ;-------------------------------------------------------
0040               pane.errline.drawcolor.loop:
0041 783E C805  38         mov   tmp1,@parm2           ; Row on physical screen
     7840 A002     
0042               
0043 7842 06A0  32         bl    @colors.line.set      ; Load color combination for line
     7844 7718     
0044                                                   ; \ i  @parm1 = Color combination
0045                                                   ; / i  @parm2 = Row on physical screen
0046               
0047 7846 0585  14         inc   tmp1                  ; Next row
0048 7848 8105  18         c     tmp1,tmp0             ; Last row reached?
0049 784A 11F9  14         jlt   pane.errline.drawcolor.loop
0050                                                   ; Not yet, next iteration
0051                       ;-------------------------------------------------------
0052                       ; Exit
0053                       ;-------------------------------------------------------
0054               pane.errline.drawcolor.exit:
0055 784C C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0056 784E C179  30         mov   *stack+,tmp1          ; Pop tmp1
0057 7850 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0058 7852 C2F9  30         mov   *stack+,r11           ; Pop R11
0059 7854 045B  20         b     *r11                  ; Return to caller
0060               
0061               
0062               
0063               
...
0082 7856 0649  14         dect  stack
0083 7858 C64B  30         mov   r11,*stack            ; Save return address
0084 785A 0649  14         dect  stack
0085 785C C644  30         mov   tmp0,*stack           ; Push tmp0
0086 785E 0649  14         dect  stack
0087 7860 C645  30         mov   tmp1,*stack           ; Push tmp1
0088               
0089 7862 0205  20         li    tmp1,>00f6            ; White on dark red
     7864 00F6     
0090 7866 C805  38         mov   tmp1,@parm1
     7868 A000     
0091               
0092 786A 06A0  32         bl    @pane.errline.drawcolor
     786C 7824     
...
0098                       ;------------------------------------------------------
0099 786E 0204  20         li    tmp0,tv.error.msg
     7870 A230     
0100 7872 C804  38         mov   tmp0,@parm1           ; Get pointer to string
     7874 A000     
0101               
0102 7876 0204  20         li    tmp0,240
     7878 00F0     
0103 787A C804  38         mov   tmp0,@parm2           ; Set requested length
     787C A002     
0104               
0105 787E 0204  20         li    tmp0,32
     7880 0020     
0106 7882 C804  38         mov   tmp0,@parm3           ; Set character to fill
     7884 A004     
0107               
0108 7886 0204  20         li    tmp0,rambuf
     7888 A100     
0109 788A C804  38         mov   tmp0,@parm4           ; Set pointer to buffer for output string
     788C A006     
0110               
0111 788E 06A0  32         bl    @tv.pad.string        ; Pad string to specified length
     7890 33EC     
...
0119                       ;------------------------------------------------------
0120 7892 06A0  32         bl    @at
     7894 26DA     
0121 7896 1A00                   byte pane.botrow-3,0  ; Set cursor
0122               
0123 7898 C160  34         mov   @outparm1,tmp1        ; \ Display error message
     789A A010     
0124 789C 06A0  32         bl    @xutst0               ; /
     789E 2434     
0125               
0126 78A0 C120  34         mov   @fb.scrrows.max,tmp0  ; \
     78A2 A31C     
0127 78A4 6120  34         s     @tv.error.rows,tmp0   ; | Adjust number of rows in frame buffer
     78A6 A22A     
0128 78A8 C804  38         mov   tmp0,@fb.scrrows      ; /
     78AA A31A     
0129               
0130 78AC 0720  34         seto  @tv.error.visible     ; Error line is visible
     78AE A228     
0131                       ;------------------------------------------------------
0132                       ; Exit
0133                       ;------------------------------------------------------
0134               pane.errline.show.exit:
0135 78B0 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0136 78B2 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0137 78B4 C2F9  30         mov   *stack+,r11           ; Pop r11
0138 78B6 045B  20         b     *r11                  ; Return to caller
0139               
0140               
0141               
0142               ***************************************************************
...
0160 78B8 0649  14         dect  stack
0161 78BA C64B  30         mov   r11,*stack            ; Save return address
0162 78BC 0649  14         dect  stack
0163 78BE C644  30         mov   tmp0,*stack           ; Push tmp0
0164                       ;------------------------------------------------------
0165                       ; Get color combination
0166                       ;------------------------------------------------------
0167 78C0 06A0  32         bl    @errpane.init         ; Clear error line string in RAM
     78C2 330A     
0168               
0169 78C4 C120  34         mov   @cmdb.visible,tmp0
     78C6 A702     
0170 78C8 1303  14         jeq   pane.errline.hide.fbcolor
0171                       ;------------------------------------------------------
0172                       ; CMDB pane color
0173                       ;------------------------------------------------------
0174 78CA C120  34         mov   @tv.cmdb.hcolor,tmp0  ; Get colors of CMDB header line
     78CC A220     
0175 78CE 1003  14         jmp   !
0176                       ;------------------------------------------------------
0177                       ; Frame buffer color
0178                       ;------------------------------------------------------
0179               pane.errline.hide.fbcolor:
0180 78D0 C120  34         mov   @tv.color,tmp0        ; Get colors
     78D2 A218     
0181 78D4 0984  56         srl   tmp0,8                ; Get rid of status line colors
0182                       ;------------------------------------------------------
0183                       ; Dump colors
0184                       ;------------------------------------------------------
0185 78D6 C804  38 !       mov   tmp0,@parm1           ; set foreground/background color
     78D8 A000     
0186               
0187 78DA 06A0  32         bl    @pane.errline.drawcolor
     78DC 7824     
0188                                                   ; Draw color on rows in error pane
0189                                                   ; \ i  @tv.error.rows = Number of rows
0190                                                   ; / i  @parm1         = Color combination
0191               
0192 78DE 04E0  34         clr   @tv.error.visible     ; Error line no longer visible
     78E0 A228     
0193 78E2 C820  54         mov   @fb.scrrows.max,@fb.scrrows
     78E4 A31C     
     78E6 A31A     
...
0199 78E8 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0200 78EA C2F9  30         mov   *stack+,r11           ; Pop r11
0201 78EC 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.68040
0152                       copy  "pane.botline.asm"       ; Bottom line
     **** ****     > pane.botline.asm
...
0015               ********|*****|*********************|**************************
0016               pane.botline:
0017 78EE 0649  14         dect  stack
0018 78F0 C64B  30         mov   r11,*stack            ; Save return address
0019 78F2 0649  14         dect  stack
0020 78F4 C644  30         mov   tmp0,*stack           ; Push tmp0
0021 78F6 0649  14         dect  stack
0022 78F8 C660  46         mov   @wyx,*stack           ; Push cursor position
     78FA 832A     
0023                       ;------------------------------------------------------
0024                       ; Show block shortcuts if set
0025                       ;------------------------------------------------------
0026 78FC C120  34         mov   @edb.block.m2,tmp0    ; \
     78FE A50E     
0027 7900 0584  14         inc   tmp0                  ; | Skip if M2 unset (>ffff)
0028                                                   ; /
0029 7902 1305  14         jeq   pane.botline.show_keys
0030               
0031 7904 06A0  32         bl    @putat
     7906 2456     
0032 7908 1D00                   byte pane.botrow,0
0033 790A 3858                   data txt.keys.block   ; Show block shortcuts
0034               
0035 790C 1004  14         jmp   pane.botline.show_mode
0036                       ;------------------------------------------------------
0037                       ; Show default message
0038                       ;------------------------------------------------------
0039               pane.botline.show_keys:
0040 790E 06A0  32         bl    @putat
     7910 2456     
0041 7912 1D00                   byte pane.botrow,0
0042 7914 3850                   data txt.keys.default ; Show default shortcuts
0043                       ;------------------------------------------------------
0044                       ; Show text editing mode
0045                       ;------------------------------------------------------
0046               pane.botline.show_mode:
0047 7916 C120  34         mov   @edb.insmode,tmp0
     7918 A50A     
0048 791A 1605  14         jne   pane.botline.show_mode.insert
0049                       ;------------------------------------------------------
0050                       ; Overwrite mode
0051                       ;------------------------------------------------------
0052 791C 06A0  32         bl    @putat
     791E 2456     
0053 7920 1D37                   byte  pane.botrow,55
0054 7922 36C4                   data  txt.ovrwrite
0055 7924 1004  14         jmp   pane.botline.show_linecol
0056                       ;------------------------------------------------------
0057                       ; Insert mode
0058                       ;------------------------------------------------------
0059               pane.botline.show_mode.insert:
0060 7926 06A0  32         bl    @putat
     7928 2456     
0061 792A 1D37                   byte  pane.botrow,55
0062 792C 36C8                   data  txt.insert
0063                       ;------------------------------------------------------
0064                       ; Show "line,column"
0065                       ;------------------------------------------------------
0066               pane.botline.show_linecol:
0067 792E C820  54         mov   @fb.row,@parm1
     7930 A306     
     7932 A000     
0068 7934 06A0  32         bl    @fb.row2line          ; Row to editor line
     7936 6CA0     
0069                                                   ; \ i @fb.topline = Top line in frame buffer
0070                                                   ; | i @parm1      = Row in frame buffer
0071                                                   ; / o @outparm1   = Matching line in EB
0072               
0073 7938 05A0  34         inc   @outparm1             ; Add base 1
     793A A010     
0074                       ;------------------------------------------------------
0075                       ; Show line
0076                       ;------------------------------------------------------
0077 793C 06A0  32         bl    @putnum
     793E 2B32     
0078 7940 1D3B                   byte  pane.botrow,59  ; YX
0079 7942 A010                   data  outparm1,rambuf
     7944 A100     
0080 7946 30                     byte  48              ; ASCII offset
0081 7947   20                   byte  32              ; Padding character
0082                       ;------------------------------------------------------
0083                       ; Show comma
0084                       ;------------------------------------------------------
0085 7948 06A0  32         bl    @putat
     794A 2456     
0086 794C 1D40                   byte  pane.botrow,64
0087 794E 36BC                   data  txt.delim
0088                       ;------------------------------------------------------
0089                       ; Show column
0090                       ;------------------------------------------------------
0091 7950 06A0  32         bl    @film
     7952 224A     
0092 7954 A105                   data rambuf+5,32,12   ; Clear work buffer with space character
     7956 0020     
     7958 000C     
0093               
0094 795A C820  54         mov   @fb.column,@waux1
     795C A30C     
     795E 833C     
0095 7960 05A0  34         inc   @waux1                ; Offset 1
     7962 833C     
0096               
0097 7964 06A0  32         bl    @mknum                ; Convert unsigned number to string
     7966 2AB4     
0098 7968 833C                   data  waux1,rambuf
     796A A100     
0099 796C 30                     byte  48              ; ASCII offset
0100 796D   20                   byte  32              ; Fill character
0101               
0102 796E 06A0  32         bl    @trimnum              ; Trim number to the left
     7970 2B0C     
0103 7972 A100                   data  rambuf,rambuf+5,32
     7974 A105     
     7976 0020     
0104               
0105 7978 0204  20         li    tmp0,>0600            ; "Fix" number length to clear junk chars
     797A 0600     
0106 797C D804  38         movb  tmp0,@rambuf+5        ; Set length byte
     797E A105     
0107               
0108                       ;------------------------------------------------------
0109                       ; Decide if row length is to be shown
0110                       ;------------------------------------------------------
0111 7980 C120  34         mov   @fb.column,tmp0       ; \ Base 1 for comparison
     7982 A30C     
0112 7984 0584  14         inc   tmp0                  ; /
0113 7986 8804  38         c     tmp0,@fb.row.length   ; Check if cursor on last column on row
     7988 A308     
0114 798A 1101  14         jlt   pane.botline.show_linecol.linelen
0115 798C 102B  14         jmp   pane.botline.show_linecol.colstring
0116                                                   ; Yes, skip showing row length
0117                       ;------------------------------------------------------
0118                       ; Add ',' delimiter and length of line to string
0119                       ;------------------------------------------------------
0120               pane.botline.show_linecol.linelen:
0121 798E C120  34         mov   @fb.column,tmp0       ; \
     7990 A30C     
0122 7992 0205  20         li    tmp1,rambuf+7         ; | Determine column position for '-' char
     7994 A107     
0123 7996 0284  22         ci    tmp0,9                ; | based on number of digits in cursor X
     7998 0009     
0124 799A 1101  14         jlt   !                     ; | column.
0125 799C 0585  14         inc   tmp1                  ; /
0126               
0127 799E 0204  20 !       li    tmp0,>2f00            ; \ ASCII '/'
     79A0 2F00     
0128 79A2 DD44  32         movb  tmp0,*tmp1+           ; / Add delimiter to string
0129               
0130 79A4 C805  38         mov   tmp1,@waux1           ; Backup position in ram buffer
     79A6 833C     
0131               
0132 79A8 06A0  32         bl    @mknum
     79AA 2AB4     
0133 79AC A308                   data  fb.row.length,rambuf
     79AE A100     
0134 79B0 30                     byte  48              ; ASCII offset
0135 79B1   20                   byte  32              ; Padding character
0136               
0137 79B2 C160  34         mov   @waux1,tmp1           ; Restore position in ram buffer
     79B4 833C     
0138               
0139 79B6 C120  34         mov   @fb.row.length,tmp0   ; \ Get length of line
     79B8 A308     
0140 79BA 0284  22         ci    tmp0,10               ; /
     79BC 000A     
0141 79BE 110B  14         jlt   pane.botline.show_line.1digit
0142                       ;------------------------------------------------------
0143                       ; Assert
0144                       ;------------------------------------------------------
0145 79C0 0284  22         ci    tmp0,80
     79C2 0050     
0146 79C4 1204  14         jle   pane.botline.show_line.2digits
0147                       ;------------------------------------------------------
0148                       ; Asserts failed
0149                       ;------------------------------------------------------
0150 79C6 C80B  38 !       mov   r11,@>ffce            ; \ Save caller address
     79C8 FFCE     
0151 79CA 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     79CC 2026     
0152                       ;------------------------------------------------------
0153                       ; Show length of line (2 digits)
0154                       ;------------------------------------------------------
0155               pane.botline.show_line.2digits:
0156 79CE 0204  20         li    tmp0,rambuf+3
     79D0 A103     
0157 79D2 DD74  42         movb  *tmp0+,*tmp1+         ; 1st digit row length
0158 79D4 1002  14         jmp   pane.botline.show_line.rest
0159                       ;------------------------------------------------------
0160                       ; Show length of line (1 digits)
0161                       ;------------------------------------------------------
0162               pane.botline.show_line.1digit:
0163 79D6 0204  20         li    tmp0,rambuf+4
     79D8 A104     
0164               pane.botline.show_line.rest:
0165 79DA DD74  42         movb  *tmp0+,*tmp1+         ; 1st/Next digit row length
0166 79DC DD60  48         movb  @rambuf+0,*tmp1+      ; Append a whitespace character
     79DE A100     
0167 79E0 DD60  48         movb  @rambuf+0,*tmp1+      ; Append a whitespace character
     79E2 A100     
0168                       ;------------------------------------------------------
0169                       ; Show column string
0170                       ;------------------------------------------------------
0171               pane.botline.show_linecol.colstring:
0172 79E4 06A0  32         bl    @putat
     79E6 2456     
0173 79E8 1D41                   byte pane.botrow,65
0174 79EA A105                   data rambuf+5         ; Show string
0175                       ;------------------------------------------------------
0176                       ; Show lines in buffer unless on last line in file
0177                       ;------------------------------------------------------
0178 79EC C820  54         mov   @fb.row,@parm1
     79EE A306     
     79F0 A000     
0179 79F2 06A0  32         bl    @fb.row2line
     79F4 6CA0     
0180 79F6 8820  54         c     @edb.lines,@outparm1
     79F8 A504     
     79FA A010     
0181 79FC 1605  14         jne   pane.botline.show_lines_in_buffer
0182               
0183 79FE 06A0  32         bl    @putat
     7A00 2456     
0184 7A02 1D48                   byte pane.botrow,72
0185 7A04 36BE                   data txt.bottom
0186               
0187 7A06 1009  14         jmp   pane.botline.exit
0188                       ;------------------------------------------------------
0189                       ; Show lines in buffer
0190                       ;------------------------------------------------------
0191               pane.botline.show_lines_in_buffer:
0192 7A08 C820  54         mov   @edb.lines,@waux1
     7A0A A504     
     7A0C 833C     
0193               
0194 7A0E 06A0  32         bl    @putnum
     7A10 2B32     
0195 7A12 1D48                   byte pane.botrow,72   ; YX
0196 7A14 833C                   data waux1,rambuf
     7A16 A100     
0197 7A18 30                     byte 48
0198 7A19   20                   byte 32
0199                       ;------------------------------------------------------
0200                       ; Exit
0201                       ;------------------------------------------------------
0202               pane.botline.exit:
0203 7A1A C839  50         mov   *stack+,@wyx          ; Pop cursor position
     7A1C 832A     
0204 7A1E C139  30         mov   *stack+,tmp0          ; Pop tmp0
0205 7A20 C2F9  30         mov   *stack+,r11           ; Pop r11
0206 7A22 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.68040
0153                       copy  "pane.vdpdump.asm"       ; Dump panes to VDP memory
     **** ****     > pane.vdpdump.asm
...
0022               ********|*****|*********************|**************************
0023               pane.vdpdump:
0024 7A24 0649  14         dect  stack
0025 7A26 C64B  30         mov   r11,*stack            ; Save return address
0026 7A28 0649  14         dect  stack
0027 7A2A C644  30         mov   tmp0,*stack           ; Push tmp0
0028 7A2C 0649  14         dect  stack
0029 7A2E C660  46         mov   @wyx,*stack           ; Push cursor position
     7A30 832A     
0030                       ;------------------------------------------------------
0031                       ; ALPHA-Lock key down?
0032                       ;------------------------------------------------------
0033               pane.vdpdump.alpha_lock:
0034 7A32 20A0  38         coc   @wbit10,config
     7A34 200C     
0035 7A36 1305  14         jeq   pane.vdpdump.alpha_lock.down
0036                       ;------------------------------------------------------
0037                       ; AlPHA-Lock is up
0038                       ;------------------------------------------------------
0039 7A38 06A0  32         bl    @putat
     7A3A 2456     
0040 7A3C 1D4E                   byte pane.botrow,78
0041 7A3E 38F2                   data txt.ws4
0042 7A40 1004  14         jmp   pane.vdpdump.cmdb.check
0043                       ;------------------------------------------------------
0044                       ; AlPHA-Lock is down
0045                       ;------------------------------------------------------
0046               pane.vdpdump.alpha_lock.down:
0047 7A42 06A0  32         bl    @putat
     7A44 2456     
0048 7A46 1D4E                   byte pane.botrow,78
0049 7A48 38E0                   data txt.alpha.down
0050                       ;------------------------------------------------------
0051                       ; Command buffer visible ?
0052                       ;------------------------------------------------------
0053               pane.vdpdump.cmdb.check
0054 7A4A C120  34         mov   @cmdb.visible,tmp0    ; CMDB pane visible ?
     7A4C A702     
0055 7A4E 1324  14         jeq   !                     ; No, skip CMDB pane
0056                       ;-------------------------------------------------------
0057                       ; Draw command buffer pane if dirty
0058                       ;-------------------------------------------------------
0059               pane.vdpdump.cmdb.draw:
0060 7A50 C120  34         mov   @cmdb.dirty,tmp0      ; Command buffer dirty?
     7A52 A718     
0061 7A54 1343  14         jeq   pane.vdpdump.exit     ; No, skip update
0062                       ;-------------------------------------------------------
0063                       ; "one-time only" flag set?
0064                       ;-------------------------------------------------------
0065 7A56 0284  22         ci    tmp0,tv.1timeonly
     7A58 00FE     
0066 7A5A 1619  14         jne   pane.vdpdump.cmdb.draw.content
0067                                                   ; No, skip CMDB colorization
0068                       ;-------------------------------------------------------
0069                       ; Colorize the CMDB pane
0070                       ;-------------------------------------------------------
0071               pane.vdpdump.cmdb.draw.colorscheme:
0072 7A5C 0649  14         dect  stack
0073 7A5E C660  46         mov   @parm1,*stack         ; Push @parm1
     7A60 A000     
0074 7A62 0649  14         dect  stack
0075 7A64 C660  46         mov   @parm2,*stack         ; Push @parm2
     7A66 A002     
0076 7A68 0649  14         dect  stack
0077 7A6A C660  46         mov   @parm3,*stack         ; Push @parm3
     7A6C A004     
0078               
0079 7A6E 0720  34         seto  @parm1                ; Do not turn screen off
     7A70 A000     
0080 7A72 0720  34         seto  @parm2                ; Skip colorzing marked lines
     7A74 A002     
0081 7A76 0720  34         seto  @parm3                ; Only colorize CMDB pane
     7A78 A004     
0082               
0083 7A7A 06A0  32         bl    @pane.action.colorscheme.load
     7A7C 74CE     
...
0089                                                   ; /             if >FFFF
0090               
0091 7A7E C839  50         mov   *stack+,@parm3        ; Pop @parm3
     7A80 A004     
0092 7A82 C839  50         mov   *stack+,@parm2        ; Pop @parm2
     7A84 A002     
0093 7A86 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     7A88 A000     
0094               
0095 7A8A 0720  34         seto  @cmdb.dirty           ; Remove special "one-time only" flag
     7A8C A718     
0096                       ;-------------------------------------------------------
0097                       ; Show content in CMDB pane
0098                       ;-------------------------------------------------------
0099               pane.vdpdump.cmdb.draw.content:
0100 7A8E 06A0  32         bl    @pane.cmdb.draw       ; Draw CMDB pane
     7A90 7C30     
0101 7A92 04E0  34         clr   @cmdb.dirty           ; Reset CMDB dirty flag
     7A94 A718     
0102 7A96 1022  14         jmp   pane.vdpdump.exit     ; Exit early
0103                       ;-------------------------------------------------------
0104                       ; Check if frame buffer dirty
0105                       ;-------------------------------------------------------
0106 7A98 C120  34 !       mov   @fb.dirty,tmp0        ; Is frame buffer dirty?
     7A9A A316     
0107 7A9C 130E  14         jeq   pane.vdpdump.statlines
0108                                                   ; No, skip update
0109 7A9E C820  54         mov   @fb.scrrows,@parm1    ; Number of lines to dump
     7AA0 A31A     
     7AA2 A000     
0110               
0111               pane.vdpdump.dump:
0112 7AA4 06A0  32         bl    @fb.vdpdump           ; Dump frame buffer to VDP SIT
     7AA6 7CBE     
...
0117                       ;------------------------------------------------------
0118 7AA8 C120  34         mov   @fb.colorize,tmp0     ; Check if colorization necessary
     7AAA A310     
0119 7AAC 1302  14         jeq   pane.vdpdump.dumped   ; Skip if flag reset
0120               
0121 7AAE 06A0  32         bl    @fb.colorlines        ; Colorize lines M1/M2
     7AB0 7CAC     
0122                       ;-------------------------------------------------------
0123                       ; Finished with frame buffer
0124                       ;-------------------------------------------------------
0125               pane.vdpdump.dumped:
0126 7AB2 04E0  34         clr   @fb.dirty             ; Reset framebuffer dirty flag
     7AB4 A316     
0127 7AB6 0720  34         seto  @fb.status.dirty      ; Do trigger status lines update
     7AB8 A318     
0128                       ;-------------------------------------------------------
0129                       ; Refresh top and bottom line
0130                       ;-------------------------------------------------------
0131               pane.vdpdump.statlines:
0132 7ABA C120  34         mov   @fb.status.dirty,tmp0 ; Are status lines dirty?
     7ABC A318     
0133 7ABE 130E  14         jeq   pane.vdpdump.exit     ; No, skip update
0134               
0135 7AC0 06A0  32         bl    @pane.topline         ; Draw top line
     7AC2 7762     
0136 7AC4 06A0  32         bl    @pane.botline         ; Draw bottom line
     7AC6 78EE     
0137 7AC8 04E0  34         clr   @fb.status.dirty      ; Reset status lines dirty flag
     7ACA A318     
0138                       ;------------------------------------------------------
0139                       ; Show ruler with tab positions
0140                       ;------------------------------------------------------
0141 7ACC C120  34         mov   @tv.ruler.visible,tmp0
     7ACE A210     
0142                                                   ; Should ruler be visible?
0143 7AD0 1305  14         jeq   pane.vdpdump.exit     ; No, so exit
0144               
0145 7AD2 06A0  32         bl    @cpym2v
     7AD4 249A     
0146 7AD6 0050                   data vdp.fb.toprow.sit
0147 7AD8 A31E                   data fb.ruler.sit
0148 7ADA 0050                   data 80               ; Show ruler
0149                       ;------------------------------------------------------
0150                       ; Exit task
0151                       ;------------------------------------------------------
0152               pane.vdpdump.exit:
0153 7ADC C839  50         mov   *stack+,@wyx          ; Pop cursor position
     7ADE 832A     
0154 7AE0 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0155 7AE2 C2F9  30         mov   *stack+,r11           ; Pop r11
0156 7AE4 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.68040
0154                       ;-----------------------------------------------------------------------
0155                       ; Stubs
0156                       ;-----------------------------------------------------------------------
0157                       copy  "rom.stubs.bank1.asm"    ; Bank specific stubs
     **** ****     > rom.stubs.bank1.asm
...
0007               ********|*****|*********************|**************************
0008               fm.loadfile:
0009 7AE6 0649  14         dect  stack
0010 7AE8 C64B  30         mov   r11,*stack            ; Save return address
0011 7AEA 0649  14         dect  stack
0012 7AEC C644  30         mov   tmp0,*stack           ; Push tmp0
0013                       ;------------------------------------------------------
0014                       ; Call function in bank 2
0015                       ;------------------------------------------------------
0016 7AEE 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7AF0 3096     
0017 7AF2 6004                   data bank2.rom        ; | i  p0 = bank address
0018 7AF4 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0019 7AF6 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0020                       ;------------------------------------------------------
0021                       ; Show "Unsaved changes" dialog if editor buffer dirty
0022                       ;------------------------------------------------------
0023 7AF8 C120  34         mov   @outparm1,tmp0
     7AFA A010     
0024 7AFC 1304  14         jeq   fm.loadfile.exit
0025               
0026 7AFE C139  30         mov   *stack+,tmp0          ; Pop tmp0
0027 7B00 C2F9  30         mov   *stack+,r11           ; Pop r11
0028 7B02 0460  28         b     @dialog.unsaved       ; Show dialog and exit
     7B04 7B96     
0029                       ;------------------------------------------------------
0030                       ; Exit
0031                       ;------------------------------------------------------
0032               fm.loadfile.exit:
0033 7B06 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0034 7B08 C2F9  30         mov   *stack+,r11           ; Pop r11
0035 7B0A 045B  20         b     *r11                  ; Return to caller
0036               
0037               
0038               ***************************************************************
...
0041               ********|*****|*********************|**************************
0042               fm.insertfile:
0043 7B0C 0649  14         dect  stack
0044 7B0E C64B  30         mov   r11,*stack            ; Save return address
0045 7B10 0649  14         dect  stack
0046 7B12 C644  30         mov   tmp0,*stack           ; Push tmp0
0047                       ;------------------------------------------------------
0048                       ; Call function in bank 2
0049                       ;------------------------------------------------------
0050 7B14 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7B16 3096     
0051 7B18 6004                   data bank2.rom        ; | i  p0 = bank address
0052 7B1A 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0053 7B1C 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0054                       ;------------------------------------------------------
0055                       ; Exit
0056                       ;------------------------------------------------------
0057               fm.insertfile.exit:
0058 7B1E C139  30         mov   *stack+,tmp0          ; Pop tmp0
0059 7B20 C2F9  30         mov   *stack+,r11           ; Pop r11
0060 7B22 045B  20         b     *r11                  ; Return to caller
0061               
0062               
0063               **************************************************************
...
0068 7B24 0649  14         dect  stack
0069 7B26 C64B  30         mov   r11,*stack            ; Save return address
0070                       ;------------------------------------------------------
0071                       ; Call function in bank 2
0072                       ;------------------------------------------------------
0073 7B28 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7B2A 3096     
0074 7B2C 6004                   data bank2.rom        ; | i  p0 = bank address
0075 7B2E 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0076 7B30 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0077                       ;------------------------------------------------------
0078                       ; Exit
0079                       ;------------------------------------------------------
0080 7B32 C2F9  30         mov   *stack+,r11           ; Pop r11
0081 7B34 045B  20         b     *r11                  ; Return to caller
0082               
0083               
0084               ***************************************************************
...
0087               ********|*****|*********************|**************************
0088               fm.savefile:
0089 7B36 0649  14         dect  stack
0090 7B38 C64B  30         mov   r11,*stack            ; Save return address
0091                       ;------------------------------------------------------
0092                       ; Call function in bank 2
0093                       ;------------------------------------------------------
0094 7B3A 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7B3C 3096     
0095 7B3E 6004                   data bank2.rom        ; | i  p0 = bank address
0096 7B40 7FC6                   data vec.4            ; | i  p1 = Vector with target address
0097 7B42 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0098                       ;------------------------------------------------------
0099                       ; Exit
0100                       ;------------------------------------------------------
0101 7B44 C2F9  30         mov   *stack+,r11           ; Pop r11
0102 7B46 045B  20         b     *r11                  ; Return to caller
0103               
0104               
0105               ***************************************************************
...
0108               ********|*****|*********************|**************************
0109               fm.newfile:
0110 7B48 0649  14         dect  stack
0111 7B4A C64B  30         mov   r11,*stack            ; Save return address
0112                       ;------------------------------------------------------
0113                       ; Call function in bank 2
0114                       ;------------------------------------------------------
0115 7B4C 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7B4E 3096     
0116 7B50 6004                   data bank2.rom        ; | i  p0 = bank address
0117 7B52 7FC8                   data vec.5            ; | i  p1 = Vector with target address
0118 7B54 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0119                       ;------------------------------------------------------
0120                       ; Exit
0121                       ;------------------------------------------------------
0122 7B56 C2F9  30         mov   *stack+,r11           ; Pop r11
0123 7B58 045B  20         b     *r11                  ; Return to caller
0124               
0125               
0126               ***************************************************************
...
0131 7B5A C820  54         mov   @edkey.action.about.vector,@trmpvector
     7B5C 7B62     
     7B5E A02E     
0132 7B60 104A  14         jmp   _trampoline.bank3     ; Show dialog
0133               edkey.action.about.vector:
0134 7B62 7FC0             data  vec.1
0135               
0136               
0137               ***************************************************************
...
0140               ********|*****|*********************|**************************
0141               dialog.load:
0142 7B64 C820  54         mov   @dialog.load.vector,@trmpvector
     7B66 7B6C     
     7B68 A02E     
0143 7B6A 1045  14         jmp   _trampoline.bank3     ; Show dialog
0144               dialog.load.vector:
0145 7B6C 7FC2             data  vec.2
0146               
0147               
0148               ***************************************************************
...
0151               ********|*****|*********************|**************************
0152               dialog.save:
0153 7B6E C820  54         mov   @dialog.save.vector,@trmpvector
     7B70 7B76     
     7B72 A02E     
0154 7B74 1040  14         jmp   _trampoline.bank3     ; Show dialog
0155               dialog.save.vector:
0156 7B76 7FC4             data  vec.3
0157               
0158               
0159               ***************************************************************
...
0162               ********|*****|*********************|**************************
0163               dialog.insert:
0164 7B78 C820  54         mov   @dialog.insert.vector,@trmpvector
     7B7A 7B80     
     7B7C A02E     
0165 7B7E 103B  14         jmp   _trampoline.bank3     ; Show dialog
0166               dialog.insert.vector:
0167 7B80 7FC6             data  vec.4
0168               
0169               
0170               ***************************************************************
...
0173               ********|*****|*********************|**************************
0174               dialog.print:
0175 7B82 C820  54         mov   @dialog.print.vector,@trmpvector
     7B84 7B8A     
     7B86 A02E     
0176 7B88 1036  14         jmp   _trampoline.bank3    ; Show dialog
0177               dialog.print.vector:
0178 7B8A 7FC8             data  vec.5
0179               
0180               
0181               ***************************************************************
...
0184               ********|*****|*********************|**************************
0185               dialog.file:
0186 7B8C C820  54         mov   @dialog.file.vector,@trmpvector
     7B8E 7B94     
     7B90 A02E     
0187 7B92 1031  14         jmp   _trampoline.bank3     ; Show dialog
0188               dialog.file.vector:
0189 7B94 7FCA             data  vec.6
0190               
0191               
0192               ***************************************************************
...
0195               ********|*****|*********************|**************************
0196               dialog.unsaved:
0197 7B96 04E0  34         clr   @cmdb.panmarkers      ; No key markers
     7B98 A722     
0198 7B9A C820  54         mov   @dialog.unsaved.vector,@trmpvector
     7B9C 7BA2     
     7B9E A02E     
0199 7BA0 102A  14         jmp   _trampoline.bank3     ; Show dialog
0200               dialog.unsaved.vector:
0201 7BA2 7FCC             data  vec.7
0202               
0203               
0204               ***************************************************************
...
0209 7BA4 C820  54         mov   @dialog.clipboard.vector,@trmpvector
     7BA6 7BAC     
     7BA8 A02E     
0210 7BAA 1025  14         jmp   _trampoline.bank3     ; Show dialog
0211               dialog.clipboard.vector:
0212 7BAC 7FCE             data  vec.8
0213               
0214               
0215               ***************************************************************
...
0218               ********|*****|*********************|**************************
0219               dialog.clipdev:
0220 7BAE C820  54         mov   @dialog.clipdev.vector,@trmpvector
     7BB0 7BB6     
     7BB2 A02E     
0221 7BB4 1020  14         jmp   _trampoline.bank3     ; Show dialog
0222               dialog.clipdev.vector:
0223 7BB6 7FD0             data  vec.9
0224               
0225               
0226               ***************************************************************
...
0229               ********|*****|*********************|**************************
0230               dialog.config:
0231 7BB8 C820  54         mov   @dialog.config.vector,@trmpvector
     7BBA 7BC0     
     7BBC A02E     
0232 7BBE 101B  14         jmp   _trampoline.bank3     ; Show dialog
0233               dialog.config.vector:
0234 7BC0 7FD2             data  vec.10
0235               
0236               
0237               ***************************************************************
...
0240               ********|*****|*********************|**************************
0241               dialog.append:
0242 7BC2 C820  54         mov   @dialog.append.vector,@trmpvector
     7BC4 7BCA     
     7BC6 A02E     
0243 7BC8 1016  14         jmp   _trampoline.bank3     ; Show dialog
0244               dialog.append.vector:
0245 7BCA 7FD4             data  vec.11
0246               
0247               
0248               ***************************************************************
...
0253 7BCC C820  54         mov   @dialog.cartridge.vector,@trmpvector
     7BCE 7BD4     
     7BD0 A02E     
0254 7BD2 1011  14         jmp   _trampoline.bank3     ; Show dialog
0255               dialog.cartridge.vector:
0256 7BD4 7FD6             data  vec.12
0257               
0258               
0259               ***************************************************************
...
0262               ********|*****|*********************|**************************
0263               dialog.basic:
0264 7BD6 C820  54         mov   @dialog.basic.vector,@trmpvector
     7BD8 7BDE     
     7BDA A02E     
0265 7BDC 100C  14         jmp   _trampoline.bank3     ; Show dialog
0266               dialog.basic.vector:
0267 7BDE 7FD8             data  vec.13
0268               
0269               
0270               ***************************************************************
...
0277                       ;------------------------------------------------------
0278 7BE0 C120  34         mov   @edb.block.m2,tmp0    ; \
     7BE2 A50E     
0279 7BE4 0584  14         inc   tmp0                  ; | Skip if M2 unset (>ffff)
0280                                                   ; /
0281 7BE6 1302  14         jeq   !                     : Block mode inactive, show dialog
0282                       ;------------------------------------------------------
0283                       ; Special treatment for block mode
0284                       ;------------------------------------------------------
0285 7BE8 0460  28         b     @edkey.action.block.reset
     7BEA 67A2     
0286                                                   ; Reset block mode
0287                       ;------------------------------------------------------
0288                       ; Show dialog
0289                       ;------------------------------------------------------
0290 7BEC C820  54 !       mov   @dialog.menu.vector,@trmpvector
     7BEE 7BF4     
     7BF0 A02E     
0291 7BF2 1001  14         jmp   _trampoline.bank3     ; Show dialog
0292               dialog.menu.vector:
0293 7BF4 7FFA             data  vec.30
0294               
0295               
0296               
0297               ***************************************************************
...
0301 7BF6 06A0  32         bl    @pane.cursor.hide     ; Hide cursor
     7BF8 76DA     
0302                       ;------------------------------------------------------
0303                       ; Call routine in specified bank
0304                       ;------------------------------------------------------
0305 7BFA 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7BFC 3096     
0306 7BFE 6006                   data bank3.rom        ; | i  p0 = bank address
0307 7C00 FFFF                   data >ffff            ; | i  p1 = Vector with target address
0308                                                   ; |         (deref @trmpvector)
0309 7C02 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0310                       ;------------------------------------------------------
0311                       ; Exit
0312                       ;------------------------------------------------------
0313 7C04 0460  28         b     @edkey.action.cmdb.show
     7C06 693E     
...
0320               ********|*****|*********************|**************************
0321               error.display:
0322 7C08 C820  54         mov   @error.display.vector,@trmpvector
     7C0A 7C10     
     7C0C A02E     
0323 7C0E 1033  14         jmp   _trampoline.bank3.ret ; Longjump
0324               error.display.vector:
0325 7C10 7FE2             data  vec.18
0326               
0327               
0328               ***************************************************************
...
0333 7C12 C820  54         mov   @pane.show_hintx.vector,@trmpvector
     7C14 7C1A     
     7C16 A02E     
0334 7C18 102E  14         jmp   _trampoline.bank3.ret ; Longjump
0335               pane.show_hintx.vector:
0336 7C1A 7FE4             data  vec.19
0337               
0338               
0339               ***************************************************************
...
0342               ********|*****|*********************|**************************
0343               pane.cmdb.show:
0344 7C1C C820  54         mov   @pane.cmdb.show.vector,@trmpvector
     7C1E 7C24     
     7C20 A02E     
0345 7C22 1029  14         jmp   _trampoline.bank3.ret ; Longjump
0346               pane.cmdb.show.vector:
0347 7C24 7FE6             data  vec.20
0348               
0349               
0350               ***************************************************************
...
0353               ********|*****|*********************|**************************
0354               pane.cmdb.hide:
0355 7C26 C820  54         mov   @pane.cmdb.hide.vector,@trmpvector
     7C28 7C2E     
     7C2A A02E     
0356 7C2C 1024  14         jmp   _trampoline.bank3.ret ; Longjump
0357               pane.cmdb.hide.vector:
0358 7C2E 7FE8             data  vec.21
0359               
0360               
0361               ***************************************************************
...
0364               ********|*****|*********************|**************************
0365               pane.cmdb.draw:
0366 7C30 C820  54         mov   @pane.cmdb.draw.vector,@trmpvector
     7C32 7C38     
     7C34 A02E     
0367 7C36 101F  14         jmp   _trampoline.bank3.ret ; Longjump
0368               pane.cmdb.draw.vector:
0369 7C38 7FEA             data  vec.22
0370               
0371               
0372               ***************************************************************
...
0375               ********|*****|*********************|**************************
0376               cmdb.refresh:
0377 7C3A C820  54         mov   @cmdb.refresh.vector,@trmpvector
     7C3C 7C42     
     7C3E A02E     
0378 7C40 101A  14         jmp   _trampoline.bank3.ret ; Longjump
0379               cmdb.refresh.vector:
0380 7C42 7FEE             data  vec.24
0381               
0382               
0383               ***************************************************************
...
0386               ********|*****|*********************|**************************
0387               cmdb.cmd.clear:
0388 7C44 C820  54         mov   @cmdb.cmd.clear.vector,@trmpvector
     7C46 7C4C     
     7C48 A02E     
0389 7C4A 1015  14         jmp   _trampoline.bank3.ret ; Longjump
0390               cmdb.cmd.clear.vector:
0391 7C4C 7FF0             data  vec.25
0392               
0393               
0394               ***************************************************************
...
0399 7C4E C820  54         mov   @cmdb.cmd.getlength.vector,@trmpvector
     7C50 7C56     
     7C52 A02E     
0400 7C54 1010  14         jmp   _trampoline.bank3.ret ; Longjump
0401               cmdb.cmd.getlength.vector:
0402 7C56 7FF2             data  vec.26
0403               
0404               
0405               ***************************************************************
...
0410 7C58 C820  54         mov   @cmdb.cmd.preset.vector,@trmpvector
     7C5A 7C60     
     7C5C A02E     
0411 7C5E 100B  14         jmp   _trampoline.bank3.ret ; Longjump
0412               cmdb.cmd.preset.vector:
0413 7C60 7FF4             data  vec.27
0414               
0415               
0416               ***************************************************************
...
0419               ********|*****|*********************|**************************
0420               cmdb.cmd.set:
0421 7C62 C820  54         mov   @cmdb.cmd.set.vector,@trmpvector
     7C64 7C6A     
     7C66 A02E     
0422 7C68 1006  14         jmp   _trampoline.bank3.ret ; Longjump
0423               cmdb.cmd.set.vector:
0424 7C6A 7FF6             data  vec.28
0425               
0426               
0427               **************************************************************
0428               * Stub for "fm.fastmode"
0429               * bank3 vec.32
0430               ********|*****|*********************|**************************
0431               fm.fastmode:
0432 7C6C C820  54         mov   @fm.fastmode.vector,@trmpvector
     7C6E 7C74     
     7C70 A02E     
0433 7C72 1001  14         jmp   _trampoline.bank3.ret ; Longjump
0434               fm.fastmode.vector:
0435 7C74 7FFE             data  vec.32
0436               
0437               
0438               
0439               
0440               ***************************************************************
0441               * Trampoline bank 3 with return
0442               ********|*****|*********************|**************************
0443               _trampoline.bank3.ret:
0444 7C76 0649  14         dect  stack
0445 7C78 C64B  30         mov   r11,*stack            ; Save return address
0446                       ;------------------------------------------------------
0447                       ; Call routine in specified bank
0448                       ;------------------------------------------------------
0449 7C7A 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7C7C 3096     
0450 7C7E 6006                   data bank3.rom        ; | i  p0 = bank address
0451 7C80 FFFF                   data >ffff            ; | i  p1 = Vector with target address
0452                                                   ; |         (deref @trmpvector)
0453 7C82 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0454                       ;------------------------------------------------------
0455                       ; Exit
0456                       ;------------------------------------------------------
0457 7C84 C2F9  30         mov   *stack+,r11           ; Pop r11
0458 7C86 045B  20         b     *r11                  ; Return to caller
0459               
0460               
0461               
0462               ***************************************************************
0463               * Stub for "fb.tab.next"
0464               * bank4 vec.1
0465               ********|*****|*********************|**************************
0466               fb.tab.next:
0467 7C88 0649  14         dect  stack
0468 7C8A C64B  30         mov   r11,*stack            ; Save return address
0469                       ;------------------------------------------------------
0470                       ; Put cursor on next tab position
0471                       ;------------------------------------------------------
0472 7C8C 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7C8E 3096     
0473 7C90 6008                   data bank4.rom        ; | i  p0 = bank address
0474 7C92 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0475 7C94 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0476                       ;------------------------------------------------------
0477                       ; Exit
0478                       ;------------------------------------------------------
0479 7C96 C2F9  30         mov   *stack+,r11           ; Pop r11
0480 7C98 045B  20         b     *r11                  ; Return to caller
0481               
0482               
0483               ***************************************************************
0484               * Stub for "fb.ruler.init"
0485               * bank4 vec.2
0486               ********|*****|*********************|**************************
0487               fb.ruler.init:
0488 7C9A 0649  14         dect  stack
0489 7C9C C64B  30         mov   r11,*stack            ; Save return address
0490                       ;------------------------------------------------------
0491                       ; Setup ruler in memory
0492                       ;------------------------------------------------------
0493 7C9E 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7CA0 3096     
0494 7CA2 6008                   data bank4.rom        ; | i  p0 = bank address
0495 7CA4 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0496 7CA6 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0497                       ;------------------------------------------------------
0498                       ; Exit
0499                       ;------------------------------------------------------
0500 7CA8 C2F9  30         mov   *stack+,r11           ; Pop r11
0501 7CAA 045B  20         b     *r11                  ; Return to caller
0502               
0503               
0504               ***************************************************************
0505               * Stub for "fb.colorlines"
0506               * bank4 vec.3
0507               ********|*****|*********************|**************************
0508               fb.colorlines:
0509 7CAC 0649  14         dect  stack
0510 7CAE C64B  30         mov   r11,*stack            ; Save return address
0511                       ;------------------------------------------------------
0512                       ; Colorize frame buffer content
0513                       ;------------------------------------------------------
0514 7CB0 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7CB2 3096     
0515 7CB4 6008                   data bank4.rom        ; | i  p0 = bank address
0516 7CB6 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0517 7CB8 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0518                       ;------------------------------------------------------
0519                       ; Exit
0520                       ;------------------------------------------------------
0521 7CBA C2F9  30         mov   *stack+,r11           ; Pop r11
0522 7CBC 045B  20         b     *r11                  ; Return to caller
0523               
0524               
0525               ***************************************************************
0526               * Stub for "fb.vdpdump"
0527               * bank4 vec.4
0528               ********|*****|*********************|**************************
0529               fb.vdpdump:
0530 7CBE 0649  14         dect  stack
0531 7CC0 C64B  30         mov   r11,*stack            ; Save return address
0532                       ;------------------------------------------------------
0533                       ; Colorize frame buffer content
0534                       ;------------------------------------------------------
0535 7CC2 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7CC4 3096     
0536 7CC6 6008                   data bank4.rom        ; | i  p0 = bank address
0537 7CC8 7FC6                   data vec.4            ; | i  p1 = Vector with target address
0538 7CCA 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0539                       ;------------------------------------------------------
0540                       ; Exit
0541                       ;------------------------------------------------------
0542 7CCC C2F9  30         mov   *stack+,r11           ; Pop r11
0543 7CCE 045B  20         b     *r11                  ; Return to caller
0544               
0545               
0546               
0547               **************************************************************
0548               * Stub for "edb.clear.sams"
0549               * bank5 vec.1
0550               ********|*****|*********************|**************************
0551               edb.clear.sams:
0552 7CD0 C820  54         mov   @edb.clear.sams.vector,@trmpvector
     7CD2 7CD8     
     7CD4 A02E     
0553 7CD6 1029  14         jmp   _trampoline.bank5.ret ; Longjump
0554               edb.clear.sams.vector:
0555 7CD8 7FC0             data  vec.1
0556               
0557               
0558               **************************************************************
0559               * Stub for "edb.hipage.alloc"
0560               * bank5 vec.2
0561               ********|*****|*********************|**************************
0562               edb.hipage.alloc:
0563 7CDA C820  54         mov   @edb.hipage.alloc.vector,@trmpvector
     7CDC 7CE2     
     7CDE A02E     
0564 7CE0 1024  14         jmp   _trampoline.bank5.ret ; Longjump
0565               edb.hipage.alloc.vector:
0566 7CE2 7FC2             data  vec.2
0567               
0568               
0569               **************************************************************
0570               * Stub for "edb.block.mark"
0571               * bank5 vec.3
0572               ********|*****|*********************|**************************
0573               edb.block.mark:
0574 7CE4 C820  54         mov   @edb.block.mark.vector,@trmpvector
     7CE6 7CEC     
     7CE8 A02E     
0575 7CEA 101F  14         jmp   _trampoline.bank5.ret ; Longjump
0576               edb.block.mark.vector:
0577 7CEC 7FC4             data  vec.3
0578               
0579               
0580               **************************************************************
0581               * Stub for "edb.block.mark.m1"
0582               * bank5 vec.4
0583               ********|*****|*********************|**************************
0584               edb.block.mark.m1:
0585 7CEE C820  54         mov   @edb.block.mark.m1.vector,@trmpvector
     7CF0 7CF6     
     7CF2 A02E     
0586 7CF4 101A  14         jmp   _trampoline.bank5.ret ; Longjump
0587               edb.block.mark.m1.vector:
0588 7CF6 7FC6             data  vec.4
0589               
0590               
0591               **************************************************************
0592               * Stub for "edb.block.mark.m2"
0593               * bank5 vec.5
0594               ********|*****|*********************|**************************
0595               edb.block.mark.m2:
0596 7CF8 C820  54         mov   @edb.block.mark.m2.vector,@trmpvector
     7CFA 7D00     
     7CFC A02E     
0597 7CFE 1015  14         jmp   _trampoline.bank5.ret ; Longjump
0598               edb.block.mark.m2.vector:
0599 7D00 7FC8             data  vec.5
0600               
0601               
0602               **************************************************************
0603               * Stub for "edb.block.clip"
0604               * bank5 vec.6
0605               ********|*****|*********************|**************************
0606               edb.block.clip:
0607 7D02 C820  54         mov   @edb.block.clip.vector,@trmpvector
     7D04 7D0A     
     7D06 A02E     
0608 7D08 1010  14         jmp   _trampoline.bank5.ret ; Longjump
0609               edb.block.clip.vector:
0610 7D0A 7FCA             data  vec.6
0611               
0612               
0613               **************************************************************
0614               * Stub for "edb.block.reset"
0615               * bank5 vec.7
0616               ********|*****|*********************|**************************
0617               edb.block.reset:
0618 7D0C C820  54         mov   @edb.block.reset.vector,@trmpvector
     7D0E 7D14     
     7D10 A02E     
0619 7D12 100B  14         jmp   _trampoline.bank5.ret ; Longjump
0620               edb.block.reset.vector:
0621 7D14 7FCC             data  vec.7
0622               
0623               
0624               **************************************************************
0625               * Stub for "edb.block.delete"
0626               * bank5 vec.8
0627               ********|*****|*********************|**************************
0628               edb.block.delete:
0629 7D16 C820  54         mov   @edb.block.delete.vector,@trmpvector
     7D18 7D1E     
     7D1A A02E     
0630 7D1C 1006  14         jmp   _trampoline.bank5.ret ; Longjump
0631               edb.block.delete.vector:
0632 7D1E 7FCE             data  vec.8
0633               
0634               
0635               **************************************************************
0636               * Stub for "edb.block.copy"
0637               * bank5 vec.9
0638               ********|*****|*********************|**************************
0639               edb.block.copy:
0640 7D20 C820  54         mov   @edb.block.copy.vector,@trmpvector
     7D22 7D28     
     7D24 A02E     
0641 7D26 1001  14         jmp   _trampoline.bank5.ret ; Longjump
0642               edb.block.copy.vector:
0643 7D28 7FD0             data  vec.9
0644               
0645               
0646               ***************************************************************
0647               * Trampoline bank 5 with return
0648               ********|*****|*********************|**************************
0649               _trampoline.bank5.ret:
0650 7D2A 0649  14         dect  stack
0651 7D2C C64B  30         mov   r11,*stack            ; Save return address
0652                       ;------------------------------------------------------
0653                       ; Call routine in specified bank
0654                       ;------------------------------------------------------
0655 7D2E 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7D30 3096     
0656 7D32 600A                   data bank5.rom        ; | i  p0 = bank address
0657 7D34 FFFF                   data >ffff            ; | i  p1 = Vector with target address
0658                                                   ; |         (deref @trmpvector)
0659 7D36 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0660                       ;------------------------------------------------------
0661                       ; Exit
0662                       ;------------------------------------------------------
0663 7D38 C2F9  30         mov   *stack+,r11           ; Pop r11
0664 7D3A 045B  20         b     *r11                  ; Return to caller
0665               
0666               
0667               ***************************************************************
0668               * Stub for "vdp.patterns.dump"
0669               * bank6 vec.1
0670               ********|*****|*********************|**************************
0671               vdp.patterns.dump:
0672 7D3C 0649  14         dect  stack
0673 7D3E C64B  30         mov   r11,*stack            ; Save return address
0674                       ;------------------------------------------------------
0675                       ; Dump VDP patterns
0676                       ;------------------------------------------------------
0677 7D40 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7D42 3096     
0678 7D44 600C                   data bank6.rom        ; | i  p0 = bank address
0679 7D46 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0680 7D48 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0681                       ;------------------------------------------------------
0682                       ; Exit
0683                       ;------------------------------------------------------
0684 7D4A C2F9  30         mov   *stack+,r11           ; Pop r11
0685 7D4C 045B  20         b     *r11                  ; Return to caller
0686               
0687               
0688               
0689               ***************************************************************
0690               * Stub for "tibasic"
0691               * bank7 vec.10
0692               ********|*****|*********************|**************************
0693               tibasic:
0694 7D4E 0649  14         dect  stack
0695 7D50 C64B  30         mov   r11,*stack            ; Save return address
0696                       ;------------------------------------------------------
0697                       ; Dump VDP patterns
0698                       ;------------------------------------------------------
0699 7D52 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7D54 3096     
0700 7D56 600E                   data bank7.rom        ; | i  p0 = bank address
0701 7D58 7FD2                   data vec.10           ; | i  p1 = Vector with target address
0702 7D5A 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0703                       ;------------------------------------------------------
0704                       ; Exit
0705                       ;------------------------------------------------------
0706 7D5C C2F9  30         mov   *stack+,r11           ; Pop r11
0707 7D5E 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.68040
0158                       copy  "rom.stubs.bankx.asm"    ; Stubs to include in all banks > 0
     **** ****     > rom.stubs.bankx.asm
...
0038 7D60 0649  14         dect  stack
0039 7D62 C64B  30         mov   r11,*stack            ; Save return address
0040                       ;------------------------------------------------------
0041                       ; Dump VDP patterns
0042                       ;------------------------------------------------------
0043 7D64 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7D66 3096     
0044 7D68 600E                   data bank7.rom        ; | i  p0 = bank address
0045 7D6A 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0046 7D6C 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0047                       ;------------------------------------------------------
0048                       ; Exit
0049                       ;------------------------------------------------------
0050 7D6E C2F9  30         mov   *stack+,r11           ; Pop r11
0051 7D70 045B  20         b     *r11                  ; Return to caller
0052               
0054               
0055               
0056               ***************************************************************
...
0063 7D72 0649  14         dect  stack
0064 7D74 C64B  30         mov   r11,*stack            ; Save return address
0065                       ;------------------------------------------------------
0066                       ; Dump VDP patterns
0067                       ;------------------------------------------------------
0068 7D76 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7D78 3096     
0069 7D7A 600E                   data bank7.rom        ; | i  p0 = bank address
0070 7D7C 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0071 7D7E 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0072                       ;------------------------------------------------------
0073                       ; Exit
0074                       ;------------------------------------------------------
0075 7D80 C2F9  30         mov   *stack+,r11           ; Pop r11
0076 7D82 045B  20         b     *r11                  ; Return to caller
0077               
0079               
0080               
0081               ***************************************************************
...
0088 7D84 0649  14         dect  stack
0089 7D86 C64B  30         mov   r11,*stack            ; Save return address
0090                       ;------------------------------------------------------
0091                       ; Dump VDP patterns
0092                       ;------------------------------------------------------
0093 7D88 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7D8A 3096     
0094 7D8C 600E                   data bank7.rom        ; | i  p0 = bank address
0095 7D8E 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0096 7D90 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0097                       ;------------------------------------------------------
0098                       ; Exit
0099                       ;------------------------------------------------------
0100 7D92 C2F9  30         mov   *stack+,r11           ; Pop r11
0101 7D94 045B  20         b     *r11                  ; Return to caller
0102               
                   < stevie_b1.asm.68040
0159                       ;-----------------------------------------------------------------------
0160                       ; Program data
0161                       ;-----------------------------------------------------------------------
0162                       copy  "data.keymap.actions.asm"; Keyboard actions
...
0009                       ; Movement keys
0010                       ;-------------------------------------------------------
0011 7D96 0D00             byte  key.enter, pane.focus.fb
0012 7D98 65FA             data  edkey.action.enter
0013               
0014 7D9A 0800             byte  key.fctn.s, pane.focus.fb
0015 7D9C 61BC             data  edkey.action.left
0016               
0017 7D9E 0900             byte  key.fctn.d, pane.focus.fb
0018 7DA0 61D6             data  edkey.action.right
0019               
0020 7DA2 0B00             byte  key.fctn.e, pane.focus.fb
0021 7DA4 62CE             data  edkey.action.up
0022               
0023 7DA6 0A00             byte  key.fctn.x, pane.focus.fb
0024 7DA8 62D6             data  edkey.action.down
0025               
0026 7DAA BF00             byte  key.fctn.h, pane.focus.fb
0027 7DAC 61F2             data  edkey.action.home
0028               
0029 7DAE C000             byte  key.fctn.j, pane.focus.fb
0030 7DB0 621C             data  edkey.action.pword
0031               
0032 7DB2 C100             byte  key.fctn.k, pane.focus.fb
0033 7DB4 626E             data  edkey.action.nword
0034               
0035 7DB6 C200             byte  key.fctn.l, pane.focus.fb
0036 7DB8 61FA             data  edkey.action.end
0037               
0038 7DBA 0C00             byte  key.fctn.6, pane.focus.fb
0039 7DBC 62DE             data  edkey.action.ppage
0040               
0041 7DBE 0200             byte  key.fctn.4, pane.focus.fb
0042 7DC0 631A             data  edkey.action.npage
0043               
0044 7DC2 8500             byte  key.ctrl.e, pane.focus.fb
0045 7DC4 62DE             data  edkey.action.ppage
0046               
0047 7DC6 9800             byte  key.ctrl.x, pane.focus.fb
0048 7DC8 631A             data  edkey.action.npage
0049               
0050 7DCA 7F00             byte  key.fctn.v, pane.focus.fb
0051 7DCC 6370             data  edkey.action.topscr
0052               
0053 7DCE BE00             byte  key.fctn.b, pane.focus.fb
0054 7DD0 63BA             data  edkey.action.botscr
0055               
0056 7DD2 9600             byte  key.ctrl.v, pane.focus.fb
0057 7DD4 6354             data  edkey.action.top
0058               
0059 7DD6 8200             byte  key.ctrl.b, pane.focus.fb
0060 7DD8 638A             data  edkey.action.bot
0061                       ;-------------------------------------------------------
0062                       ; Modifier keys - Delete
0063                       ;-------------------------------------------------------
0064 7DDA 0300             byte  key.fctn.1, pane.focus.fb
0065 7DDC 6448             data  edkey.action.del_char
0066               
0067 7DDE 0700             byte  key.fctn.3, pane.focus.fb
0068 7DE0 64FA             data  edkey.action.del_line
0069               
0070 7DE2 8C00             byte  key.ctrl.l, pane.focus.fb
0071 7DE4 64C6             data  edkey.action.del_eol
0072                       ;-------------------------------------------------------
0073                       ; Modifier keys - Insert
0074                       ;-------------------------------------------------------
0075 7DE6 0400             byte  key.fctn.2, pane.focus.fb
0076 7DE8 655C             data  edkey.action.ins_char.ws
0077               
0078 7DEA B900             byte  key.fctn.dot, pane.focus.fb
0079 7DEC 6672             data  edkey.action.ins_onoff
0080               
0081 7DEE 0100             byte  key.fctn.7, pane.focus.fb
0082 7DF0 6860             data  edkey.action.fb.tab.next
0083               
0084 7DF2 9400             byte  key.ctrl.t, pane.focus.fb
0085 7DF4 6860             data  edkey.action.fb.tab.next
0086               
0087 7DF6 0600             byte  key.fctn.8, pane.focus.fb
0088 7DF8 65F2             data  edkey.action.ins_line
0089                       ;-------------------------------------------------------
0090                       ; Block marking/modifier
0091                       ;-------------------------------------------------------
0092 7DFA F000             byte  key.ctrl.space, pane.focus.fb
0093 7DFC 679A             data  edkey.action.block.mark
0094               
0095 7DFE 8300             byte  key.ctrl.c, pane.focus.fb
0096 7E00 673A             data  edkey.action.copyblock_or_clipboard
0097               
0098 7E02 8400             byte  key.ctrl.d, pane.focus.fb
0099 7E04 67EA             data  edkey.action.block.delete
0100               
0101 7E06 8D00             byte  key.ctrl.m, pane.focus.fb
0102 7E08 6814             data  edkey.action.block.move
0103               
0104 7E0A 8700             byte  key.ctrl.g, pane.focus.fb
0105 7E0C 6846             data  edkey.action.block.goto.m1
0106                       ;-------------------------------------------------------
0107                       ; Clipboards
0108                       ;-------------------------------------------------------
0109 7E0E B100             byte  key.ctrl.1, pane.focus.fb
0110 7E10 686E             data  edkey.action.fb.clip.save.1
0111               
0112 7E12 B200             byte  key.ctrl.2, pane.focus.fb
0113 7E14 6874             data  edkey.action.fb.clip.save.2
0114               
0115 7E16 B300             byte  key.ctrl.3, pane.focus.fb
0116 7E18 687A             data  edkey.action.fb.clip.save.3
0117               
0118 7E1A B400             byte  key.ctrl.4, pane.focus.fb
0119 7E1C 6880             data  edkey.action.fb.clip.save.4
0120               
0121 7E1E B500             byte  key.ctrl.5, pane.focus.fb
0122 7E20 6886             data  edkey.action.fb.clip.save.5
0123                       ;-------------------------------------------------------
0124                       ; Other action keys
0125                       ;-------------------------------------------------------
0126 7E22 0500             byte  key.fctn.plus, pane.focus.fb
0127 7E24 672C             data  edkey.action.quit
0128               
0129 7E26 9100             byte  key.ctrl.q, pane.focus.fb
0130 7E28 672C             data  edkey.action.quit
0131               
0132 7E2A 9500             byte  key.ctrl.u, pane.focus.fb
0133 7E2C 66EC             data  edkey.action.toggle.ruler
0134               
0135 7E2E 9A00             byte  key.ctrl.z, pane.focus.fb
0136 7E30 7470             data  pane.action.colorscheme.cycle
0137               
0138 7E32 8000             byte  key.ctrl.comma, pane.focus.fb
0139 7E34 674A             data  edkey.action.fb.fname.dec.load
0140               
0141 7E36 9B00             byte  key.ctrl.dot, pane.focus.fb
0142 7E38 675C             data  edkey.action.fb.fname.inc.load
0143               
0144 7E3A BB00             byte  key.ctrl.slash, pane.focus.fb
0145 7E3C 7BD6             data  dialog.basic
0146                       ;-------------------------------------------------------
0147                       ; Dialog keys
0148                       ;-------------------------------------------------------
0149 7E3E 8100             byte  key.ctrl.a, pane.focus.fb
0150 7E40 7BC2             data  dialog.append
0151               
0152 7E42 8800             byte  key.ctrl.h, pane.focus.fb
0153 7E44 7B5A             data  edkey.action.about
0154               
0155 7E46 8600             byte  key.ctrl.f, pane.focus.fb
0156 7E48 7B8C             data  dialog.file
0157               
0158 7E4A 8900             byte  key.ctrl.i, pane.focus.fb
0159 7E4C 7B78             data  dialog.insert
0160               
0161 7E4E 9300             byte  key.ctrl.s, pane.focus.fb
0162 7E50 7B6E             data  dialog.save
0163               
0164 7E52 8F00             byte  key.ctrl.o, pane.focus.fb
0165 7E54 7B64             data  dialog.load
0166               
0167 7E56 9000             byte  key.ctrl.p, pane.focus.fb
0168 7E58 7B82             data  dialog.print
0169               
0170                       ;
0171                       ; FCTN-9 has multiple purposes, if block mode is on it
0172                       ; resets the block, otherwise show dialog "Main Menu".
0173                       ;
0174 7E5A 0F00             byte  key.fctn.9, pane.focus.fb
0175 7E5C 7BE0             data  dialog.menu
0176                       ;-------------------------------------------------------
0177                       ; End of list
0178                       ;-------------------------------------------------------
0179 7E5E FFFF             data  EOL                           ; EOL
0180               
0181               
0182               
0183               *---------------------------------------------------------------
...
0189                       ;-------------------------------------------------------
0190 7E60 4664             byte  key.uc.f, id.dialog.menu
0191 7E62 7B8C             data  dialog.file
0192               
0193 7E64 4364             byte  key.uc.c, id.dialog.menu
0194 7E66 7BCC             data  dialog.cartridge
0195               
0196 7E68 4864             byte  key.uc.h, id.dialog.menu
0197 7E6A 7B5A             data  edkey.action.about
0198               
0199 7E6C 5164             byte  key.uc.q, id.dialog.menu
0200 7E6E 672C             data  edkey.action.quit
0201                       ;-------------------------------------------------------
0202                       ; Dialog: File
0203                       ;-------------------------------------------------------
0204 7E70 4E69             byte  key.uc.n, id.dialog.file
0205 7E72 6950             data  edkey.action.cmdb.file.new
0206               
0207 7E74 5369             byte  key.uc.s, id.dialog.file
0208 7E76 7B6E             data  dialog.save
0209               
0210 7E78 4F69             byte  key.uc.o, id.dialog.file
0211 7E7A 7B64             data  dialog.load
0212               
0213 7E7C 5069             byte  key.uc.p, id.dialog.file
0214 7E7E 7B82             data  dialog.print
0215               
0216 7E80 4369             byte  key.uc.c, id.dialog.file
0217 7E82 7BB8             data  dialog.config
0218                       ;-------------------------------------------------------
0219                       ; Dialog: Open file
0220                       ;-------------------------------------------------------
0221 7E84 0E0A             byte  key.fctn.5, id.dialog.load
0222 7E86 6C6C             data  edkey.action.cmdb.fastmode.toggle
0223               
0224 7E88 0D0A             byte  key.enter, id.dialog.load
0225 7E8A 6974             data  edkey.action.cmdb.load
0226                       ;-------------------------------------------------------
0227                       ; Dialog: Insert file at line ...
0228                       ;-------------------------------------------------------
0229 7E8C 0E0D             byte  key.fctn.5, id.dialog.insert
0230 7E8E 6C6C             data  edkey.action.cmdb.fastmode.toggle
0231               
0232 7E90 0D0D             byte  key.enter, id.dialog.insert
0233 7E92 69B8             data  edkey.action.cmdb.insert
0234                       ;-------------------------------------------------------
0235                       ; Dialog: Append file
0236                       ;-------------------------------------------------------
0237 7E94 0E0E             byte  key.fctn.5, id.dialog.append
0238 7E96 6C6C             data  edkey.action.cmdb.fastmode.toggle
0239               
0240 7E98 0D0E             byte  key.enter, id.dialog.append
0241 7E9A 6A3A             data  edkey.action.cmdb.append
0242                       ;-------------------------------------------------------
0243                       ; Dialog: Copy clipboard to line ...
0244                       ;-------------------------------------------------------
0245 7E9C 0E67             byte  key.fctn.5, id.dialog.clipboard
0246 7E9E 6C6C             data  edkey.action.cmdb.fastmode.toggle
0247               
0248 7EA0 0167             byte  key.fctn.7, id.dialog.clipboard
0249 7EA2 7BAE             data  dialog.clipdev
0250               
0251 7EA4 3167             byte  key.num.1, id.dialog.clipboard
0252 7EA6 6AAE             data  edkey.action.cmdb.clip.1
0253               
0254 7EA8 3267             byte  key.num.2, id.dialog.clipboard
0255 7EAA 6AB4             data  edkey.action.cmdb.clip.2
0256               
0257 7EAC 3367             byte  key.num.3, id.dialog.clipboard
0258 7EAE 6ABA             data  edkey.action.cmdb.clip.3
0259               
0260 7EB0 3467             byte  key.num.4, id.dialog.clipboard
0261 7EB2 6AC0             data  edkey.action.cmdb.clip.4
0262               
0263 7EB4 3567             byte  key.num.5, id.dialog.clipboard
0264 7EB6 6AC6             data  edkey.action.cmdb.clip.5
0265                       ;-------------------------------------------------------
0266                       ; Dialog: Configure clipboard device
0267                       ;-------------------------------------------------------
0268 7EB8 0D11             byte  key.enter, id.dialog.clipdev
0269 7EBA 6AFA             data  edkey.action.cmdb.clipdev.configure
0270                       ;-------------------------------------------------------
0271                       ; Dialog: Configure
0272                       ;-------------------------------------------------------
0273 7EBC 436C             byte  key.uc.c, id.dialog.config
0274 7EBE 7BAE             data  dialog.clipdev
0275                       ;-------------------------------------------------------
0276                       ; Dialog: Save file
0277                       ;-------------------------------------------------------
0278 7EC0 0D0B             byte  key.enter, id.dialog.save
0279 7EC2 6B4A             data  edkey.action.cmdb.save
0280               
0281 7EC4 0D0C             byte  key.enter, id.dialog.saveblock
0282 7EC6 6B4A             data  edkey.action.cmdb.save
0283                       ;-------------------------------------------------------
0284                       ; Dialog: Print file
0285                       ;-------------------------------------------------------
0286 7EC8 0D0F             byte  key.enter, id.dialog.print
0287 7ECA 6BC6             data  edkey.action.cmdb.print
0288               
0289 7ECC 0D10             byte  key.enter, id.dialog.printblock
0290 7ECE 6BC6             data  edkey.action.cmdb.print
0291                       ;-------------------------------------------------------
0292                       ; Dialog: Unsaved changes
0293                       ;-------------------------------------------------------
0294 7ED0 0C65             byte  key.fctn.6, id.dialog.unsaved
0295 7ED2 6C42             data  edkey.action.cmdb.proceed
0296               
0297 7ED4 2065             byte  key.space, id.dialog.unsaved
0298 7ED6 6C42             data  edkey.action.cmdb.proceed
0299               
0300 7ED8 0D65             byte  key.enter, id.dialog.unsaved
0301 7EDA 7B6E             data  dialog.save
0302                       ;-------------------------------------------------------
0303                       ; Dialog: Cartridge
0304                       ;-------------------------------------------------------
0305 7EDC 426A             byte  key.uc.b, id.dialog.cartridge
0306 7EDE 7BD6             data  dialog.basic
0307                       ;-------------------------------------------------------
0308                       ; Dialog: Basic
0309                       ;-------------------------------------------------------
0310 7EE0 316B             byte  key.num.1, id.dialog.basic
0311 7EE2 7D4E             data  tibasic
0312                       ;-------------------------------------------------------
0313                       ; Dialog: Help
0314                       ;-------------------------------------------------------
0315 7EE4 0F68             byte  key.fctn.9, id.dialog.help
0316 7EE6 6C80             data  edkey.action.cmdb.close.about
0317               
0318 7EE8 0D68             byte  key.enter, id.dialog.help
0319 7EEA 6C80             data  edkey.action.cmdb.close.about
0320                       ;-------------------------------------------------------
0321                       ; Movement keys
0322                       ;-------------------------------------------------------
0323 7EEC 0801             byte  key.fctn.s, pane.focus.cmdb
0324 7EEE 689E             data  edkey.action.cmdb.left
0325               
0326 7EF0 0901             byte  key.fctn.d, pane.focus.cmdb
0327 7EF2 68B0             data  edkey.action.cmdb.right
0328               
0329 7EF4 BF01             byte  key.fctn.h, pane.focus.cmdb
0330 7EF6 68C8             data  edkey.action.cmdb.home
0331               
0332 7EF8 C201             byte  key.fctn.l, pane.focus.cmdb
0333 7EFA 68DC             data  edkey.action.cmdb.end
0334                       ;-------------------------------------------------------
0335                       ; Modifier keys
0336                       ;-------------------------------------------------------
0337 7EFC 0701             byte  key.fctn.3, pane.focus.cmdb
0338 7EFE 68F4             data  edkey.action.cmdb.clear
0339                       ;-------------------------------------------------------
0340                       ; Other action keys
0341                       ;-------------------------------------------------------
0342 7F00 0F01             byte  key.fctn.9, pane.focus.cmdb
0343 7F02 6C8C             data  edkey.action.cmdb.close.dialog
0344               
0345 7F04 0501             byte  key.fctn.plus, pane.focus.cmdb
0346 7F06 672C             data  edkey.action.quit
0347               
0348 7F08 8101             byte  key.ctrl.a, pane.focus.cmdb
0349 7F0A 6C78             data  edkey.action.cmdb.preset
0350               
0351 7F0C 8201             byte  key.ctrl.b, pane.focus.cmdb
0352 7F0E 6C78             data  edkey.action.cmdb.preset
0353               
0354 7F10 8301             byte  key.ctrl.c, pane.focus.cmdb
0355 7F12 6C78             data  edkey.action.cmdb.preset
0356               
0357 7F14 9A01             byte  key.ctrl.z, pane.focus.cmdb
0358 7F16 7470             data  pane.action.colorscheme.cycle
0359                       ;------------------------------------------------------
0360                       ; End of list
0361                       ;-------------------------------------------------------
0362 7F18 FFFF             data  EOL                           ; EOL
                   < stevie_b1.asm.68040
0163                       ;-----------------------------------------------------------------------
0164                       ; Bank full check
0165                       ;-----------------------------------------------------------------------
0169                       ;-----------------------------------------------------------------------
0170                       ; Show ROM bank in CPU crash screen
0171                       ;-----------------------------------------------------------------------
0172               cpu.crash.showbank:
0173                       aorg  >7fb0
0174 7FB0 06A0  32         bl    @putat
     7FB2 2456     
0175 7FB4 0314                   byte 3,20
0176 7FB6 7FBA                   data cpu.crash.showbank.bankstr
0177 7FB8 10FF  14         jmp   $
0178               cpu.crash.showbank.bankstr:
0179               
0180 7FBA 05               byte  5
0181 7FBB   52             text  'ROM#1'
     7FBC 4F4D     
     7FBE 2331     
0182                       even
0183               
...
0186                       ;-----------------------------------------------------------------------
0187                       aorg  >7fc0
0188                       copy  "rom.vectors.bank1.asm"
...
0018 7FD6 7CD0     vec.12  data  edb.clear.sams        ;
0019 7FD8 71BE     vec.13  data  edb.line.copy         ;
...
0025 7FE4 7C44     vec.19  data  cmdb.cmd.clear        ;
0026 7FE6 6EAA     vec.20  data  fb.refresh            ;
0027 7FE8 7CBE     vec.21  data  fb.vdpdump            ;
0028 7FEA 6CA0     vec.22  data  fb.row2line           ;
...
0033 7FF4 78B8     vec.27  data  pane.errline.hide     ;
0034 7FF6 76F8     vec.28  data  pane.cursor.blink     ;
0035 7FF8 76DA     vec.29  data  pane.cursor.hide      ;
0036 7FFA 7856     vec.30  data  pane.errline.show     ;
0037 7FFC 74CE     vec.31  data  pane.action.colorscheme.load
0038 7FFE 76C0     vec.32  data  pane.action.colorscheme.statlines
                   < stevie_b1.asm.68040
0189                                                   ; Vector table bank 1
0190               *--------------------------------------------------------------
0191               * Video mode configuration
0192               *--------------------------------------------------------------
0193      00F4     spfclr  equ   >f4                   ; Foreground/Background color for font.
0194      0004     spfbck  equ   >04                   ; Screen background color.
0195      362C     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
0196      000C     spfont  equ   fnopt3                ; Font to load. See LDFONT for details.
0197      0050     colrow  equ   80                    ; Columns per row
0198      0FC0     pctadr  equ   >0fc0                 ; VDP color table base
0199      1100     fntadr  equ   >1100                 ; VDP font start address (in PDT range)
0200      2180     sprsat  equ   >2180                 ; VDP sprite attribute table
0201      2800     sprpdt  equ   >2800                 ; VDP sprite pattern table
