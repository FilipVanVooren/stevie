...
0008               ***************************************************************
0009               * File: stevie_b1.asm               ; Version 201109-2389682
0010               
...
0007               *              (c)2018-2020 // Filip van Vooren
0008               ***************************************************************
0009               * File: equates.equ                 ; Version 201109-2389682
0010               *--------------------------------------------------------------
...
0260 21DD ....             text  'Build-ID  201109-2389682'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0033 31FF ....             text  'Build: 201109-2389682'
0034                       even
0035               
0036               
0037               txt.about.msg1
...
0114 60DA 06A0  32         bl    @mkhook
     60DC 2DC0 
0115 60DE 7688                   data hook.keyscan     ; Setup user hook
0116               
...
0026 68A8 06A0  32         bl    @sams.layout
     68AA 25B4 
0027 68AC 312A                   data mem.sams.layout.data
0028               
...
0031               ********|*****|*********************|**************************
0032               edb.line.pack:
0033 6CA2 0649  14         dect  stack
0034 6CA4 C64B  30         mov   r11,*stack            ; Save return address
0035 6CA6 0649  14         dect  stack
0036 6CA8 C644  30         mov   tmp0,*stack           ; Push tmp0
0037 6CAA 0649  14         dect  stack
0038 6CAC C645  30         mov   tmp1,*stack           ; Push tmp1
0039 6CAE 0649  14         dect  stack
0040 6CB0 C646  30         mov   tmp2,*stack           ; Push tmp2
0041                       ;------------------------------------------------------
0042                       ; Get values
0043                       ;------------------------------------------------------
0044 6CB2 C820  54         mov   @fb.column,@rambuf    ; Save @fb.column
     6CB4 A10C 
     6CB6 2F64 
0045 6CB8 04E0  34         clr   @fb.column
     6CBA A10C 
0046 6CBC 06A0  32         bl    @fb.calc_pointer      ; Beginning of row
     6CBE 6920 
0047                       ;------------------------------------------------------
0048                       ; Prepare scan
0049                       ;------------------------------------------------------
0050 6CC0 04C4  14         clr   tmp0                  ; Counter
0051 6CC2 C160  34         mov   @fb.current,tmp1      ; Get position
     6CC4 A102 
0052 6CC6 C805  38         mov   tmp1,@rambuf+2        ; Save beginning of row
     6CC8 2F66 
0053                       ;------------------------------------------------------
0054                       ; Scan line for >00 byte termination
0055                       ;------------------------------------------------------
0056               edb.line.pack.scan:
0057 6CCA D1B5  28         movb  *tmp1+,tmp2           ; Get char
0058 6CCC 0986  56         srl   tmp2,8                ; Right justify
0059 6CCE 1309  14         jeq   edb.line.pack.check_setpage
0060                                                   ; Stop scan if >00 found
0061 6CD0 0584  14         inc   tmp0                  ; Increase string length
0062                       ;------------------------------------------------------
0063                       ; Not more than 80 characters
0064                       ;------------------------------------------------------
0065 6CD2 0284  22         ci    tmp0,colrow
     6CD4 0050 
0066 6CD6 1305  14         jeq   edb.line.pack.check_setpage
0067                                                   ; Stop scan if 80 characters processed
0068 6CD8 10F8  14         jmp   edb.line.pack.scan    ; Next character
0069                       ;------------------------------------------------------
0070                       ; Check failed, crash CPU!
0071                       ;------------------------------------------------------
0072               edb.line.pack.crash:
0073 6CDA C80B  38         mov   r11,@>ffce            ; \ Save caller address
     6CDC FFCE 
0074 6CDE 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     6CE0 2030 
0075                       ;------------------------------------------------------
0076                       ; 1a: Check if highest SAMS page needs to be increased
0077                       ;------------------------------------------------------
0078               edb.line.pack.check_setpage:
0079 6CE2 C804  38         mov   tmp0,@rambuf+4        ; Save length of line
     6CE4 2F68 
0080 6CE6 C120  34         mov   @edb.next_free.ptr,tmp0
     6CE8 A208 
0081                                                   ;--------------------------
0082                                                   ; Sanity check
0083                                                   ;--------------------------
0084 6CEA 0284  22         ci    tmp0,edb.top + edb.size
     6CEC D000 
0085                                                   ; Insane address ?
0086 6CEE 15F5  14         jgt   edb.line.pack.crash   ; Yes, crash!
0087                                                   ;--------------------------
0088                                                   ; Check for page overflow
0089                                                   ;--------------------------
0090 6CF0 0244  22         andi  tmp0,>0fff            ; Get rid of highest nibble
     6CF2 0FFF 
0091 6CF4 0224  22         ai    tmp0,82               ; Assume line of 80 chars (+2 bytes prefix)
     6CF6 0052 
0092 6CF8 0284  22         ci    tmp0,>1000 - 16       ; 4K boundary reached?
     6CFA 0FF0 
0093 6CFC 1105  14         jlt   edb.line.pack.setpage ; Not yet, don't increase SAMS page
0094                       ;------------------------------------------------------
0095                       ; 1b: Increase highest SAMS page (copy-on-write!)
0096                       ;------------------------------------------------------
0097 6CFE 05A0  34         inc   @edb.sams.hipage      ; Set highest SAMS page
     6D00 A214 
0098 6D02 C820  54         mov   @edb.top.ptr,@edb.next_free.ptr
     6D04 A200 
     6D06 A208 
...
0104 6D08 C120  34         mov   @edb.sams.hipage,tmp0
     6D0A A214 
0105 6D0C C160  34         mov   @edb.top.ptr,tmp1
     6D0E A200 
0106 6D10 06A0  32         bl    @xsams.page.set       ; Set SAMS page
     6D12 2548 
...
0113 6D14 C820  54         mov   @fb.topline,@parm1    ; \ parm1 = fb.topline + fb.row
     6D16 A104 
     6D18 2F20 
0114 6D1A A820  54         a     @fb.row,@parm1        ; /
     6D1C A106 
     6D1E 2F20 
0115                       ;------------------------------------------------------
...
0119 6D20 C820  54         mov   @edb.next_free.ptr,@parm2
     6D22 A208 
     6D24 2F22 
0120                                                   ; Pointer to new line
0121 6D26 C820  54         mov   @edb.sams.hipage,@parm3
     6D28 A214 
     6D2A 2F24 
0122                                                   ; SAMS page to use
0123               
0124 6D2C 06A0  32         bl    @idx.entry.update     ; Update index
     6D2E 6B02 
...
0131                       ;------------------------------------------------------
0132 6D30 C120  34         mov   @rambuf+2,tmp0        ; Source for memory copy
     6D32 2F66 
0133 6D34 C160  34         mov   @edb.next_free.ptr,tmp1
     6D36 A208 
0134                                                   ; Address of line in editor buffer
0135               
0136 6D38 05E0  34         inct  @edb.next_free.ptr    ; Adjust pointer
     6D3A A208 
0137               
0138 6D3C C1A0  34         mov   @rambuf+4,tmp2        ; Get line length
     6D3E 2F68 
0139 6D40 CD46  34         mov   tmp2,*tmp1+           ; Set line length as line prefix
0140 6D42 1317  14         jeq   edb.line.pack.prepexit
0141                                                   ; Nothing to copy if empty line
0142                       ;------------------------------------------------------
0143                       ; 4. Copy line from framebuffer to editor buffer
0144                       ;------------------------------------------------------
0145               edb.line.pack.copyline:
0146 6D44 0286  22         ci    tmp2,2
     6D46 0002 
0147 6D48 1603  14         jne   edb.line.pack.copyline.checkbyte
0148 6D4A DD74  42         movb  *tmp0+,*tmp1+         ; \ Copy single word on possible
0149 6D4C DD74  42         movb  *tmp0+,*tmp1+         ; / uneven address
0150 6D4E 1007  14         jmp   edb.line.pack.copyline.align16
0151               
0152               edb.line.pack.copyline.checkbyte:
0153 6D50 0286  22         ci    tmp2,1
     6D52 0001 
0154 6D54 1602  14         jne   edb.line.pack.copyline.block
0155 6D56 D554  38         movb  *tmp0,*tmp1           ; Copy single byte
0156 6D58 1002  14         jmp   edb.line.pack.copyline.align16
0157               
0158               edb.line.pack.copyline.block:
0159 6D5A 06A0  32         bl    @xpym2m               ; Copy memory block
     6D5C 24B2 
0160                                                   ; \ i  tmp0 = source
...
0167 6D5E A820  54         a     @rambuf+4,@edb.next_free.ptr
     6D60 2F68 
     6D62 A208 
0168                                                      ; Add length of line
0169               
0170 6D64 C120  34         mov   @edb.next_free.ptr,tmp0  ; \ Round up to next multiple of 16.
     6D66 A208 
0171 6D68 0504  16         neg   tmp0                     ; | tmp0 = tmp0 + (-tmp0 & 15)
0172 6D6A 0244  22         andi  tmp0,15                  ; | Hacker's Delight 2nd Edition
     6D6C 000F 
0173 6D6E A804  38         a     tmp0,@edb.next_free.ptr  ; / Chapter 2
     6D70 A208 
0174                       ;------------------------------------------------------
0175                       ; 6: Restore SAMS page and prepare for exit
0176                       ;------------------------------------------------------
0177               edb.line.pack.prepexit:
0178 6D72 C820  54         mov   @rambuf,@fb.column    ; Retrieve @fb.column
     6D74 2F64 
     6D76 A10C 
0179               
0180 6D78 8820  54         c     @edb.sams.hipage,@edb.sams.page
     6D7A A214 
     6D7C A212 
0181 6D7E 1306  14         jeq   edb.line.pack.exit    ; Exit early if SAMS page already mapped
0182               
0183 6D80 C120  34         mov   @edb.sams.page,tmp0
     6D82 A212 
0184 6D84 C160  34         mov   @edb.top.ptr,tmp1
     6D86 A200 
0185 6D88 06A0  32         bl    @xsams.page.set       ; Set SAMS page
     6D8A 2548 
...
0192 6D8C C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0193 6D8E C179  30         mov   *stack+,tmp1          ; Pop tmp1
0194 6D90 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0195 6D92 C2F9  30         mov   *stack+,r11           ; Pop R11
0196 6D94 045B  20         b     *r11                  ; Return to caller
**** **** ****     > stevie_b1.asm.2389682
...
0033 6D96 0649  14         dect  stack
0034 6D98 C64B  30         mov   r11,*stack            ; Save return address
0035 6D9A 0649  14         dect  stack
0036 6D9C C644  30         mov   tmp0,*stack           ; Push tmp0
0037 6D9E 0649  14         dect  stack
0038 6DA0 C645  30         mov   tmp1,*stack           ; Push tmp1
0039 6DA2 0649  14         dect  stack
0040 6DA4 C646  30         mov   tmp2,*stack           ; Push tmp2
0041                       ;------------------------------------------------------
0042                       ; Sanity check
0043                       ;------------------------------------------------------
0044 6DA6 8820  54         c     @parm1,@edb.lines     ; Beyond editor buffer ?
     6DA8 2F20 
     6DAA A204 
0045 6DAC 1204  14         jle   !
0046 6DAE C80B  38         mov   r11,@>ffce            ; \ Save caller address
     6DB0 FFCE 
0047 6DB2 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     6DB4 2030 
0048                       ;------------------------------------------------------
0049                       ; Save parameters
0050                       ;------------------------------------------------------
0051 6DB6 C820  54 !       mov   @parm1,@rambuf
     6DB8 2F20 
     6DBA 2F64 
0052 6DBC C820  54         mov   @parm2,@rambuf+2
     6DBE 2F22 
     6DC0 2F66 
0053                       ;------------------------------------------------------
0054                       ; Calculate offset in frame buffer
0055                       ;------------------------------------------------------
0056 6DC2 C120  34         mov   @fb.colsline,tmp0
     6DC4 A10E 
0057 6DC6 3920  72         mpy   @parm2,tmp0           ; Offset is in tmp1!
     6DC8 2F22 
0058 6DCA C1A0  34         mov   @fb.top.ptr,tmp2
     6DCC A100 
0059 6DCE A146  18         a     tmp2,tmp1             ; Add base to offset
0060 6DD0 C805  38         mov   tmp1,@rambuf+6        ; Destination row in frame buffer
     6DD2 2F6A 
0061                       ;------------------------------------------------------
0062                       ; Get pointer to line & page-in editor buffer page
0063                       ;------------------------------------------------------
0064 6DD4 C120  34         mov   @parm1,tmp0
     6DD6 2F20 
0065 6DD8 06A0  32         bl    @xmem.edb.sams.mappage
     6DDA 68C6 
...
0072                       ;------------------------------------------------------
0073 6DDC C120  34         mov   @outparm1,tmp0        ; Get pointer to line
     6DDE 2F30 
0074 6DE0 1603  14         jne   edb.line.unpack.getlen
0075                                                   ; Continue if pointer is set
0076               
0077 6DE2 04E0  34         clr   @rambuf+8             ; Set length=0
     6DE4 2F6C 
0078 6DE6 100C  14         jmp   edb.line.unpack.clear
0079                       ;------------------------------------------------------
0080                       ; Get line length
0081                       ;------------------------------------------------------
0082               edb.line.unpack.getlen:
0083 6DE8 C174  30         mov   *tmp0+,tmp1           ; Get line length
0084 6DEA C804  38         mov   tmp0,@rambuf+4        ; Source memory address for block copy
     6DEC 2F68 
0085 6DEE C805  38         mov   tmp1,@rambuf+8        ; Save line length
     6DF0 2F6C 
0086                       ;------------------------------------------------------
0087                       ; Sanity check on line length
0088                       ;------------------------------------------------------
0089 6DF2 0285  22         ci    tmp1,80               ; \ Continue if length <= 80
     6DF4 0050 
0090 6DF6 1204  14         jle   edb.line.unpack.clear ; /
0091                       ;------------------------------------------------------
0092                       ; Crash the system
0093                       ;------------------------------------------------------
0094 6DF8 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     6DFA FFCE 
0095 6DFC 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     6DFE 2030 
0096                       ;------------------------------------------------------
0097                       ; Erase chars from last column until column 80
0098                       ;------------------------------------------------------
0099               edb.line.unpack.clear:
0100 6E00 C120  34         mov   @rambuf+6,tmp0        ; Start of row in frame buffer
     6E02 2F6A 
0101 6E04 A120  34         a     @rambuf+8,tmp0        ; Skip until end of row in frame buffer
     6E06 2F6C 
0102               
0103 6E08 04C5  14         clr   tmp1                  ; Fill with >00
0104 6E0A C1A0  34         mov   @fb.colsline,tmp2
     6E0C A10E 
0105 6E0E 61A0  34         s     @rambuf+8,tmp2        ; Calculate number of bytes to clear
     6E10 2F6C 
0106 6E12 0586  14         inc   tmp2
0107               
0108 6E14 06A0  32         bl    @xfilm                ; Fill CPU memory
     6E16 224A 
...
0116 6E18 C1A0  34         mov   @rambuf+8,tmp2        ; Line length
     6E1A 2F6C 
0117 6E1C 130F  14         jeq   edb.line.unpack.exit  ; Exit if length = 0
0118 6E1E C120  34         mov   @rambuf+4,tmp0        ; Pointer to line in editor buffer
     6E20 2F68 
0119 6E22 C160  34         mov   @rambuf+6,tmp1        ; Pointer to row in frame buffer
     6E24 2F6A 
0120                       ;------------------------------------------------------
0121                       ; Sanity check on line length
0122                       ;------------------------------------------------------
0123               edb.line.unpack.copy:
0124 6E26 0286  22         ci    tmp2,80               ; Check line length
     6E28 0050 
0125 6E2A 1204  14         jle   !
0126                       ;------------------------------------------------------
0127                       ; Crash the system
0128                       ;------------------------------------------------------
0129 6E2C C80B  38         mov   r11,@>ffce            ; \ Save caller address
     6E2E FFCE 
0130 6E30 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     6E32 2030 
0131                       ;------------------------------------------------------
0132                       ; Copy memory block
0133                       ;------------------------------------------------------
0134 6E34 C806  38 !       mov   tmp2,@outparm1        ; Length of unpacked line
     6E36 2F30 
0135               
0136 6E38 06A0  32         bl    @xpym2m               ; Copy line to frame buffer
     6E3A 24B2 
...
0144 6E3C C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0145 6E3E C179  30         mov   *stack+,tmp1          ; Pop tmp1
0146 6E40 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0147 6E42 C2F9  30         mov   *stack+,r11           ; Pop r11
0148 6E44 045B  20         b     *r11                  ; Return to caller
**** **** ****     > stevie_b1.asm.2389682
...
0026 6E46 0649  14         dect  stack
0027 6E48 C64B  30         mov   r11,*stack            ; Push return address
0028 6E4A 0649  14         dect  stack
0029 6E4C C644  30         mov   tmp0,*stack           ; Push tmp0
0030 6E4E 0649  14         dect  stack
0031 6E50 C645  30         mov   tmp1,*stack           ; Push tmp1
0032                       ;------------------------------------------------------
0033                       ; Initialisation
0034                       ;------------------------------------------------------
0035 6E52 04E0  34         clr   @outparm1             ; Reset length
     6E54 2F30 
0036 6E56 04E0  34         clr   @outparm2             ; Reset SAMS bank
     6E58 2F32 
0037                       ;------------------------------------------------------
0038                       ; Map SAMS page
0039                       ;------------------------------------------------------
0040 6E5A C120  34         mov   @parm1,tmp0           ; Get line
     6E5C 2F20 
0041               
0042 6E5E 06A0  32         bl    @xmem.edb.sams.mappage
     6E60 68C6 
...
0047               
0048 6E62 C120  34         mov   @outparm1,tmp0        ; Store pointer in tmp0
     6E64 2F30 
0049 6E66 130A  14         jeq   edb.line.getlength.null
0050                                                   ; Set length to 0 if null-pointer
0051                       ;------------------------------------------------------
0052                       ; Process line prefix
0053                       ;------------------------------------------------------
0054 6E68 C154  26         mov   *tmp0,tmp1            ; Get length into tmp1
0055 6E6A C805  38         mov   tmp1,@outparm1        ; Save length
     6E6C 2F30 
0056                       ;------------------------------------------------------
0057                       ; Sanity check
0058                       ;------------------------------------------------------
0059 6E6E 0285  22         ci    tmp1,80               ; Line length <= 80 ?
     6E70 0050 
0060 6E72 1206  14         jle   edb.line.getlength.exit
0061                                                   ; Yes, exit
0062                       ;------------------------------------------------------
0063                       ; Crash the system
0064                       ;------------------------------------------------------
0065 6E74 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     6E76 FFCE 
0066 6E78 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     6E7A 2030 
0067                       ;------------------------------------------------------
0068                       ; Set length to 0 if null-pointer
0069                       ;------------------------------------------------------
0070               edb.line.getlength.null:
0071 6E7C 04E0  34         clr   @outparm1             ; Set length to 0, was a null-pointer
     6E7E 2F30 
0072                       ;------------------------------------------------------
0073                       ; Exit
0074                       ;------------------------------------------------------
0075               edb.line.getlength.exit:
0076 6E80 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0077 6E82 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0078 6E84 C2F9  30         mov   *stack+,r11           ; Pop r11
0079 6E86 045B  20         b     *r11                  ; Return to caller
0080               
0081               
0082               
0083               ***************************************************************
...
0099 6E88 0649  14         dect  stack
0100 6E8A C64B  30         mov   r11,*stack            ; Save return address
0101 6E8C 0649  14         dect  stack
0102 6E8E C644  30         mov   tmp0,*stack           ; Push tmp0
0103                       ;------------------------------------------------------
0104                       ; Calculate line in editor buffer
0105                       ;------------------------------------------------------
0106 6E90 C120  34         mov   @fb.topline,tmp0      ; Get top line in frame buffer
     6E92 A104 
0107 6E94 A120  34         a     @fb.row,tmp0          ; Get current row in frame buffer
     6E96 A106 
0108                       ;------------------------------------------------------
0109                       ; Get length
0110                       ;------------------------------------------------------
0111 6E98 C804  38         mov   tmp0,@parm1
     6E9A 2F20 
0112 6E9C 06A0  32         bl    @edb.line.getlength
     6E9E 6E46 
0113 6EA0 C820  54         mov   @outparm1,@fb.row.length
     6EA2 2F30 
     6EA4 A108 
...
0119 6EA6 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0120 6EA8 C2F9  30         mov   *stack+,r11           ; Pop R11
0121 6EAA 045B  20         b     *r11                  ; Return to caller
**** **** ****     > stevie_b1.asm.2389682
0150                       ;-----------------------------------------------------------------------
...
0025               ********|*****|*********************|**************************
0026               cmdb.init:
0027 6EAC 0649  14         dect  stack
0028 6EAE C64B  30         mov   r11,*stack            ; Save return address
0029 6EB0 0649  14         dect  stack
0030 6EB2 C644  30         mov   tmp0,*stack           ; Push tmp0
0031                       ;------------------------------------------------------
0032                       ; Initialize
0033                       ;------------------------------------------------------
0034 6EB4 0204  20         li    tmp0,cmdb.top         ; \ Set pointer to command buffer
     6EB6 D000 
0035 6EB8 C804  38         mov   tmp0,@cmdb.top.ptr    ; /
     6EBA A300 
0036               
0037 6EBC 04E0  34         clr   @cmdb.visible         ; Hide command buffer
     6EBE A302 
0038 6EC0 0204  20         li    tmp0,4
     6EC2 0004 
0039 6EC4 C804  38         mov   tmp0,@cmdb.scrrows    ; Set current command buffer size
     6EC6 A306 
0040 6EC8 C804  38         mov   tmp0,@cmdb.default    ; Set default command buffer size
     6ECA A308 
0041               
0042 6ECC 04E0  34         clr   @cmdb.lines           ; Number of lines in cmdb buffer
     6ECE A316 
0043 6ED0 04E0  34         clr   @cmdb.dirty           ; Command buffer is clean
     6ED2 A318 
0044 6ED4 04E0  34         clr   @cmdb.action.ptr      ; Reset action to execute pointer
     6ED6 A322 
0045                       ;------------------------------------------------------
0046                       ; Clear command buffer
0047                       ;------------------------------------------------------
0048 6ED8 06A0  32         bl    @film
     6EDA 2244 
0049 6EDC D000             data  cmdb.top,>00,cmdb.size
     6EDE 0000 
     6EE0 1000 
...
0053                       ; Exit
0054                       ;------------------------------------------------------
0055 6EE2 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0056 6EE4 C2F9  30         mov   *stack+,r11           ; Pop r11
0057 6EE6 045B  20         b     *r11                  ; Return to caller
0058               
0059               
0060               
0061               
...
0081               ********|*****|*********************|**************************
0082               cmdb.refresh:
0083 6EE8 0649  14         dect  stack
0084 6EEA C64B  30         mov   r11,*stack            ; Save return address
0085 6EEC 0649  14         dect  stack
0086 6EEE C644  30         mov   tmp0,*stack           ; Push tmp0
0087 6EF0 0649  14         dect  stack
0088 6EF2 C645  30         mov   tmp1,*stack           ; Push tmp1
0089 6EF4 0649  14         dect  stack
0090 6EF6 C646  30         mov   tmp2,*stack           ; Push tmp2
0091                       ;------------------------------------------------------
0092                       ; Dump Command buffer content
0093                       ;------------------------------------------------------
0094 6EF8 C820  54         mov   @wyx,@cmdb.yxsave     ; Save YX position
     6EFA 832A 
     6EFC A30C 
0095 6EFE C820  54         mov   @cmdb.yxprompt,@wyx   ; Screen position of command line prompt
     6F00 A310 
     6F02 832A 
0096               
0097 6F04 05A0  34         inc   @wyx                  ; X +1 for prompt
     6F06 832A 
0098               
0099 6F08 06A0  32         bl    @yx2pnt               ; Get VDP PNT address for current YX pos.
     6F0A 2408 
0100                                                   ; \ i  @wyx = Cursor position
0101                                                   ; / o  tmp0 = VDP target address
0102               
0103 6F0C 0205  20         li    tmp1,cmdb.cmd         ; Address of current command
     6F0E A325 
0104 6F10 0206  20         li    tmp2,1*79             ; Command length
     6F12 004F 
0105               
0106 6F14 06A0  32         bl    @xpym2v               ; \ Copy CPU memory to VDP memory
     6F16 245E 
...
0112                       ;------------------------------------------------------
0113 6F18 C820  54         mov   @cmdb.yxprompt,@wyx
     6F1A A310 
     6F1C 832A 
0114 6F1E 06A0  32         bl    @putstr
     6F20 242C 
0115 6F22 362C                   data txt.cmdb.prompt
0116               
0117 6F24 C820  54         mov   @cmdb.yxsave,@fb.yxsave
     6F26 A30C 
     6F28 A114 
0118 6F2A C820  54         mov   @cmdb.yxsave,@wyx
     6F2C A30C 
     6F2E 832A 
...
0124 6F30 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0125 6F32 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0126 6F34 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0127 6F36 C2F9  30         mov   *stack+,r11           ; Pop r11
0128 6F38 045B  20         b     *r11                  ; Return to caller
**** **** ****     > stevie_b1.asm.2389682
...
0024               ********|*****|*********************|**************************
0025               cmdb.cmd.clear:
0026 6F3A 0649  14         dect  stack
0027 6F3C C64B  30         mov   r11,*stack            ; Save return address
0028 6F3E 0649  14         dect  stack
0029 6F40 C644  30         mov   tmp0,*stack           ; Push tmp0
0030 6F42 0649  14         dect  stack
0031 6F44 C645  30         mov   tmp1,*stack           ; Push tmp1
0032 6F46 0649  14         dect  stack
0033 6F48 C646  30         mov   tmp2,*stack           ; Push tmp2
0034                       ;------------------------------------------------------
0035                       ; Clear command
0036                       ;------------------------------------------------------
0037 6F4A 04E0  34         clr   @cmdb.cmdlen          ; Reset length
     6F4C A324 
0038 6F4E 06A0  32         bl    @film                 ; Clear command
     6F50 2244 
0039 6F52 A325                   data  cmdb.cmd,>00,80
     6F54 0000 
     6F56 0050 
0040                       ;------------------------------------------------------
0041                       ; Put cursor at beginning of line
0042                       ;------------------------------------------------------
0043 6F58 C120  34         mov   @cmdb.yxprompt,tmp0
     6F5A A310 
0044 6F5C 0584  14         inc   tmp0
0045 6F5E C804  38         mov   tmp0,@cmdb.cursor     ; Position cursor
     6F60 A30A 
0046                       ;------------------------------------------------------
0047                       ; Exit
0048                       ;------------------------------------------------------
0049               cmdb.cmd.clear.exit:
0050 6F62 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0051 6F64 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0052 6F66 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0053 6F68 C2F9  30         mov   *stack+,r11           ; Pop r11
0054 6F6A 045B  20         b     *r11                  ; Return to caller
0055               
0056               
0057               
0058               
...
0079 6F6C 0649  14         dect  stack
0080 6F6E C64B  30         mov   r11,*stack            ; Save return address
0081                       ;-------------------------------------------------------
0082                       ; Get length of null terminated string
0083                       ;-------------------------------------------------------
0084 6F70 06A0  32         bl    @string.getlenc      ; Get length of C-style string
     6F72 2A9A 
0085 6F74 A325                   data cmdb.cmd,0      ; \ i  p0    = Pointer to C-style string
     6F76 0000 
0086                                                  ; | i  p1    = Termination character
0087                                                  ; / o  waux1 = Length of string
0088 6F78 C820  54         mov   @waux1,@outparm1     ; Save length of string
     6F7A 833C 
     6F7C 2F30 
0089                       ;------------------------------------------------------
0090                       ; Exit
...
0093 6F7E C2F9  30         mov   *stack+,r11           ; Pop r11
0094 6F80 045B  20         b     *r11                  ; Return to caller
0095               
0096               
0097               
0098               
...
0119 6F82 0649  14         dect  stack
0120 6F84 C64B  30         mov   r11,*stack            ; Save return address
0121 6F86 0649  14         dect  stack
0122 6F88 C644  30         mov   tmp0,*stack           ; Push tmp0
0123               
0124 6F8A 06A0  32         bl    @cmdb.cmd.getlength   ; Get length of command
     6F8C 6F6C 
0125                                                   ; \ i  @cmdb.cmd
0126                                                   ; / o  @outparm1
0127                       ;------------------------------------------------------
0128                       ; Sanity check
0129                       ;------------------------------------------------------
0130 6F8E C120  34         mov   @outparm1,tmp0        ; Check length
     6F90 2F30 
0131 6F92 1300  14         jeq   cmdb.cmd.history.add.exit
...
0143 6F94 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0144 6F96 C2F9  30         mov   *stack+,r11           ; Pop r11
0145 6F98 045B  20         b     *r11                  ; Return to caller
**** **** ****     > stevie_b1.asm.2389682
...
0024               ***************************************************************
0025               errline.init:
0026 6F9A 0649  14         dect  stack
0027 6F9C C64B  30         mov   r11,*stack            ; Save return address
0028 6F9E 0649  14         dect  stack
0029 6FA0 C644  30         mov   tmp0,*stack           ; Push tmp0
0030                       ;------------------------------------------------------
0031                       ; Initialize
0032                       ;------------------------------------------------------
0033 6FA2 04E0  34         clr   @tv.error.visible     ; Set to hidden
     6FA4 A020 
0034               
0035 6FA6 06A0  32         bl    @film
     6FA8 2244 
0036 6FAA A022                   data tv.error.msg,0,160
     6FAC 0000 
     6FAE 00A0 
0037               
0038 6FB0 0204  20         li    tmp0,>A000            ; Length of error message (160 bytes)
     6FB2 A000 
0039 6FB4 D804  38         movb  tmp0,@tv.error.msg    ; Set length byte
     6FB6 A022 
0040                       ;-------------------------------------------------------
0041                       ; Exit
0042                       ;-------------------------------------------------------
0043               errline.exit:
0044 6FB8 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0045 6FBA C2F9  30         mov   *stack+,r11           ; Pop R11
0046 6FBC 045B  20         b     *r11                  ; Return to caller
0047               
**** **** ****     > stevie_b1.asm.2389682
0156                       ;-----------------------------------------------------------------------
0157                       ; File handling
...
0028 6FBE 0649  14         dect  stack
0029 6FC0 C64B  30         mov   r11,*stack            ; Save return address
0030 6FC2 0649  14         dect  stack
0031 6FC4 C644  30         mov   tmp0,*stack           ; Push tmp0
0032 6FC6 0649  14         dect  stack
0033 6FC8 C645  30         mov   tmp1,*stack           ; Push tmp1
0034 6FCA 0649  14         dect  stack
0035 6FCC C646  30         mov   tmp2,*stack           ; Push tmp2
0036                       ;------------------------------------------------------
0037                       ; Initialisation
0038                       ;------------------------------------------------------
0039 6FCE 04E0  34         clr   @fh.records           ; Reset records counter
     6FD0 A43C 
0040 6FD2 04E0  34         clr   @fh.counter           ; Clear internal counter
     6FD4 A442 
0041 6FD6 04E0  34         clr   @fh.kilobytes         ; \ Clear kilobytes processed
     6FD8 A440 
0042 6FDA 04E0  34         clr   @fh.kilobytes.prev    ; /
     6FDC A458 
0043 6FDE 04E0  34         clr   @fh.pabstat           ; Clear copy of VDP PAB status byte
     6FE0 A438 
0044 6FE2 04E0  34         clr   @fh.ioresult          ; Clear status register contents
     6FE4 A43A 
0045               
0046 6FE6 C120  34         mov   @edb.top.ptr,tmp0
     6FE8 A200 
0047 6FEA 06A0  32         bl    @xsams.page.get       ; Get SAMS page
     6FEC 2510 
0048                                                   ; \ i  tmp0  = Memory address
0049                                                   ; | o  waux1 = SAMS page number
0050                                                   ; / o  waux2 = Address of SAMS register
0051               
0052 6FEE C820  54         mov   @waux1,@fh.sams.page  ; Set current SAMS page
     6FF0 833C 
     6FF2 A446 
0053 6FF4 C820  54         mov   @waux1,@fh.sams.hipage
     6FF6 833C 
     6FF8 A448 
...
0057                       ;------------------------------------------------------
0058 6FFA 0204  20         li    tmp0,fh.fopmode.readfile
     6FFC 0001 
0059                                                   ; We are going to read a file
0060 6FFE C804  38         mov   tmp0,@fh.fopmode      ; Set file operations mode
     7000 A44A 
0061               
0062 7002 C820  54         mov   @parm1,@fh.fname.ptr  ; Pointer to file descriptor
     7004 2F20 
     7006 A444 
0063 7008 C820  54         mov   @parm2,@fh.callback1  ; Callback function "Open file"
     700A 2F22 
     700C A450 
0064 700E C820  54         mov   @parm3,@fh.callback2  ; Callback function "Read line from file"
     7010 2F24 
     7012 A452 
0065 7014 C820  54         mov   @parm4,@fh.callback3  ; Callback function "Close" file"
     7016 2F26 
     7018 A454 
0066 701A C820  54         mov   @parm5,@fh.callback4  ; Callback function "File I/O error"
     701C 2F28 
     701E A456 
0067                       ;------------------------------------------------------
0068                       ; Sanity checks
0069                       ;------------------------------------------------------
0070 7020 C120  34         mov   @fh.callback1,tmp0
     7022 A450 
0071 7024 0284  22         ci    tmp0,>6000            ; Insane address ?
     7026 6000 
0072 7028 1114  14         jlt   fh.file.read.crash    ; Yes, crash!
0073               
0074 702A 0284  22         ci    tmp0,>7fff            ; Insane address ?
     702C 7FFF 
0075 702E 1511  14         jgt   fh.file.read.crash    ; Yes, crash!
0076               
0077 7030 C120  34         mov   @fh.callback2,tmp0
     7032 A452 
0078 7034 0284  22         ci    tmp0,>6000            ; Insane address ?
     7036 6000 
0079 7038 110C  14         jlt   fh.file.read.crash    ; Yes, crash!
0080               
0081 703A 0284  22         ci    tmp0,>7fff            ; Insane address ?
     703C 7FFF 
0082 703E 1509  14         jgt   fh.file.read.crash    ; Yes, crash!
0083               
0084 7040 C120  34         mov   @fh.callback3,tmp0
     7042 A454 
0085 7044 0284  22         ci    tmp0,>6000            ; Insane address ?
     7046 6000 
0086 7048 1104  14         jlt   fh.file.read.crash    ; Yes, crash!
0087               
0088 704A 0284  22         ci    tmp0,>7fff            ; Insane address ?
     704C 7FFF 
0089 704E 1501  14         jgt   fh.file.read.crash    ; Yes, crash!
0090               
0091 7050 1004  14         jmp   fh.file.read.edb.load1
0092                                                   ; All checks passed, continue
0093                       ;------------------------------------------------------
0094                       ; Check failed, crash CPU!
0095                       ;------------------------------------------------------
0096               fh.file.read.crash:
0097 7052 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     7054 FFCE 
0098 7056 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     7058 2030 
0099                       ;------------------------------------------------------
0100                       ; Callback "Before Open file"
0101                       ;------------------------------------------------------
0102               fh.file.read.edb.load1:
0103 705A C120  34         mov   @fh.callback1,tmp0
     705C A450 
0104 705E 0694  24         bl    *tmp0                 ; Run callback function
0105                       ;------------------------------------------------------
0106                       ; Copy PAB header to VDP
0107                       ;------------------------------------------------------
0108               fh.file.read.edb.pabheader:
0109 7060 06A0  32         bl    @cpym2v
     7062 2458 
0110 7064 0A60                   data fh.vpab,fh.file.pab.header,9
     7066 71E6 
     7068 0009 
...
0114                       ;------------------------------------------------------
0115 706A 0204  20         li    tmp0,fh.vpab + 9      ; VDP destination
     706C 0A69 
0116 706E C160  34         mov   @fh.fname.ptr,tmp1    ; Get pointer to file descriptor
     7070 A444 
0117 7072 D195  26         movb  *tmp1,tmp2            ; Get file descriptor length
0118 7074 0986  56         srl   tmp2,8                ; Right justify
0119 7076 0586  14         inc   tmp2                  ; Include length byte as well
0120               
0121 7078 06A0  32         bl    @xpym2v               ; Copy CPU memory to VDP memory
     707A 245E 
...
0126                       ; Open file
0127                       ;------------------------------------------------------
0128 707C 06A0  32         bl    @file.open            ; Open file
     707E 2C5E 
0129 7080 0A60                   data fh.vpab          ; \ i  p0 = Address of PAB in VRAM
0130 7082 0014                   data io.seq.inp.dis.var
0131                                                   ; / i  p1 = File type/mode
0132               
0133 7084 21A0  38         coc   @wbit2,tmp2           ; Equal bit set?
     7086 2026 
0134 7088 1602  14         jne   fh.file.read.edb.check_setpage
0135               
0136 708A 0460  28         b     @fh.file.read.edb.error
     708C 719A 
...
0142 708E C120  34         mov   @edb.next_free.ptr,tmp0
     7090 A208 
0143                                                   ;--------------------------
0144                                                   ; Sanity check
0145                                                   ;--------------------------
0146 7092 0284  22         ci    tmp0,edb.top + edb.size
     7094 D000 
0147                                                   ; Insane address ?
0148 7096 15DD  14         jgt   fh.file.read.crash    ; Yes, crash!
0149                                                   ;--------------------------
0150                                                   ; Check for page overflow
0151                                                   ;--------------------------
0152 7098 0244  22         andi  tmp0,>0fff            ; Get rid of highest nibble
     709A 0FFF 
0153 709C 0224  22         ai    tmp0,82               ; Assume line of 80 chars (+2 bytes prefix)
     709E 0052 
0154 70A0 0284  22         ci    tmp0,>1000 - 16       ; 4K boundary reached?
     70A2 0FF0 
0155 70A4 110E  14         jlt   fh.file.read.edb.record
0156                                                   ; Not yet so skip SAMS page switch
0157                       ;------------------------------------------------------
0158                       ; 1b: Increase SAMS page
0159                       ;------------------------------------------------------
0160 70A6 05A0  34         inc   @fh.sams.page         ; Next SAMS page
     70A8 A446 
0161 70AA C820  54         mov   @fh.sams.page,@fh.sams.hipage
     70AC A446 
     70AE A448 
0162                                                   ; Set highest SAMS page
0163 70B0 C820  54         mov   @edb.top.ptr,@edb.next_free.ptr
     70B2 A200 
     70B4 A208 
...
0167                       ;------------------------------------------------------
0168 70B6 C120  34         mov   @fh.sams.page,tmp0
     70B8 A446 
0169 70BA C160  34         mov   @edb.top.ptr,tmp1
     70BC A200 
0170 70BE 06A0  32         bl    @xsams.page.set       ; Set SAMS page
     70C0 2548 
...
0182 70C2 05A0  34         inc   @fh.records           ; Update counter
     70C4 A43C 
0183 70C6 04E0  34         clr   @fh.reclen            ; Reset record length
     70C8 A43E 
0184               
0185 70CA 0760  38         abs   @fh.offsetopcode
     70CC A44E 
0186 70CE 1310  14         jeq   !                     ; Skip CPU buffer logic if offset = 0
0187                       ;------------------------------------------------------
0188                       ; 2a: Write address of CPU buffer to VDP PAB bytes 2-3
0189                       ;------------------------------------------------------
0190 70D0 C160  34         mov   @edb.next_free.ptr,tmp1
     70D2 A208 
0191 70D4 05C5  14         inct  tmp1
0192 70D6 0204  20         li    tmp0,fh.vpab + 2
     70D8 0A62 
0193               
0194 70DA 0264  22         ori   tmp0,>4000            ; Prepare VDP address for write
     70DC 4000 
0195 70DE 06C4  14         swpb  tmp0                  ; \
0196 70E0 D804  38         movb  tmp0,@vdpa            ; | Set VDP write address
     70E2 8C02 
0197 70E4 06C4  14         swpb  tmp0                  ; | inlined @vdwa call
0198 70E6 D804  38         movb  tmp0,@vdpa            ; /
     70E8 8C02 
0199               
0200 70EA D7C5  30         movb  tmp1,*r15             ; Write MSB
0201 70EC 06C5  14         swpb  tmp1
0202 70EE D7C5  30         movb  tmp1,*r15             ; Write LSB
0203                       ;------------------------------------------------------
0204                       ; 2b: Read file record
0205                       ;------------------------------------------------------
0206 70F0 06A0  32 !       bl    @file.record.read     ; Read file record
     70F2 2C8E 
0207 70F4 0A60                   data fh.vpab          ; \ i  p0   = Address of PAB in VDP RAM
...
0213               
0214 70F6 C804  38         mov   tmp0,@fh.pabstat      ; Save VDP PAB status byte
     70F8 A438 
0215 70FA C805  38         mov   tmp1,@fh.reclen       ; Save bytes read
     70FC A43E 
0216 70FE C806  38         mov   tmp2,@fh.ioresult     ; Save status register contents
     7100 A43A 
0217                       ;------------------------------------------------------
0218                       ; 2c: Calculate kilobytes processed
0219                       ;------------------------------------------------------
0220 7102 A805  38         a     tmp1,@fh.counter      ; Add record length to counter
     7104 A442 
0221 7106 C160  34         mov   @fh.counter,tmp1      ;
     7108 A442 
0222 710A 0285  22         ci    tmp1,1024             ; 1 KB boundary reached ?
     710C 0400 
0223 710E 1106  14         jlt   fh.file.read.edb.check_fioerr
0224                                                   ; Not yet, goto (2d)
0225 7110 05A0  34         inc   @fh.kilobytes
     7112 A440 
0226 7114 0225  22         ai    tmp1,-1024            ; Remove KB portion, only keep bytes
     7116 FC00 
0227 7118 C805  38         mov   tmp1,@fh.counter      ; Update counter
     711A A442 
0228                       ;------------------------------------------------------
0229                       ; 2d: Check if a file error occured
0230                       ;------------------------------------------------------
0231               fh.file.read.edb.check_fioerr:
0232 711C C1A0  34         mov   @fh.ioresult,tmp2
     711E A43A 
0233 7120 21A0  38         coc   @wbit2,tmp2           ; IO error occured?
     7122 2026 
0234 7124 1602  14         jne   fh.file.read.edb.process_line
0235                                                   ; No, goto (3)
0236 7126 0460  28         b     @fh.file.read.edb.error
     7128 719A 
...
0242 712A 0204  20         li    tmp0,fh.vrecbuf       ; VDP source address
     712C 0960 
0243 712E C160  34         mov   @edb.next_free.ptr,tmp1
     7130 A208 
0244                                                   ; RAM target in editor buffer
0245               
0246 7132 C805  38         mov   tmp1,@parm2           ; Needed in step 4b (index update)
     7134 2F22 
0247               
0248 7136 C1A0  34         mov   @fh.reclen,tmp2       ; Number of bytes to copy
     7138 A43E 
0249 713A 131D  14         jeq   fh.file.read.edb.prepindex.emptyline
0250                                                   ; Handle empty line
0251                       ;------------------------------------------------------
0252                       ; 3a: Set length of line in CPU editor buffer
0253                       ;------------------------------------------------------
0254 713C 04D5  26         clr   *tmp1                 ; Clear word before string
0255 713E 0585  14         inc   tmp1                  ; Adjust position for length byte string
0256 7140 DD60  48         movb  @fh.reclen+1,*tmp1+   ; Put line length byte before string
     7142 A43F 
0257               
0258 7144 05E0  34         inct  @edb.next_free.ptr    ; Keep pointer synced with tmp1
     7146 A208 
0259 7148 A806  38         a     tmp2,@edb.next_free.ptr
     714A A208 
0260                                                   ; Add line length
0261               
0262 714C 0760  38         abs   @fh.offsetopcode      ; Use CPU buffer if offset > 0
     714E A44E 
0263 7150 1602  14         jne   fh.file.read.edb.preppointer
0264                       ;------------------------------------------------------
...
0271                       ;
0272 7152 06A0  32         bl    @xpyv2m               ; Copy memory block from VDP to CPU
     7154 2490 
...
0280 7156 C120  34         mov   @edb.next_free.ptr,tmp0  ; \ Round up to next multiple of 16.
     7158 A208 
0281 715A 0504  16         neg   tmp0                     ; | tmp0 = tmp0 + (-tmp0 & 15)
0282 715C 0244  22         andi  tmp0,15                  ; | Hacker's Delight 2nd Edition
     715E 000F 
0283 7160 A804  38         a     tmp0,@edb.next_free.ptr  ; / Chapter 2
     7162 A208 
0284                       ;------------------------------------------------------
0285                       ; Step 4: Update index
0286                       ;------------------------------------------------------
0287               fh.file.read.edb.prepindex:
0288 7164 C820  54         mov   @edb.lines,@parm1     ; \ parm1 = Line number - 1
     7166 A204 
     7168 2F20 
0289 716A 0620  34         dec   @parm1                ; /
     716C 2F20 
0290               
0291                                                   ; parm2 = Must allready be set!
0292 716E C820  54         mov   @fh.sams.page,@parm3  ; parm3 = SAMS page number
     7170 A446 
     7172 2F24 
0293               
0294 7174 1009  14         jmp   fh.file.read.edb.updindex
0295                                                   ; Update index
0296                       ;------------------------------------------------------
0297                       ; 4a: Special handling for empty line
0298                       ;------------------------------------------------------
0299               fh.file.read.edb.prepindex.emptyline:
0300 7176 C820  54         mov   @fh.records,@parm1    ; parm1 = Line number
     7178 A43C 
     717A 2F20 
0301 717C 0620  34         dec   @parm1                ;         Adjust for base 0 index
     717E 2F20 
0302 7180 04E0  34         clr   @parm2                ; parm2 = Pointer to >0000
     7182 2F22 
0303 7184 0720  34         seto  @parm3                ; parm3 = SAMS not used >FFFF
     7186 2F24 
0304                       ;------------------------------------------------------
0305                       ; 4b: Do actual index update
0306                       ;------------------------------------------------------
0307               fh.file.read.edb.updindex:
0308 7188 06A0  32         bl    @idx.entry.update     ; Update index
     718A 6B02 
...
0314                                                   ; /               entry
0315               
0316 718C 05A0  34         inc   @edb.lines            ; lines=lines+1
     718E A204 
0317                       ;------------------------------------------------------
0318                       ; Step 5: Callback "Read line from file"
0319                       ;------------------------------------------------------
0320               fh.file.read.edb.display:
0321 7190 C120  34         mov   @fh.callback2,tmp0    ; Get pointer to "Loading indicator 2"
     7192 A452 
0322 7194 0694  24         bl    *tmp0                 ; Run callback function
0323                       ;------------------------------------------------------
0324                       ; 5a: Next record
0325                       ;------------------------------------------------------
0326               fh.file.read.edb.next:
0327 7196 0460  28         b     @fh.file.read.edb.check_setpage
     7198 708E 
0328                                                   ; Next record
0329                       ;------------------------------------------------------
0330                       ; Error handler
...
0333 719A C120  34         mov   @fh.pabstat,tmp0      ; Get VDP PAB status byte
     719C A438 
0334 719E 0984  56         srl   tmp0,8                ; Right align VDP PAB 1 status byte
0335 71A0 0284  22         ci    tmp0,io.err.eof       ; EOF reached ?
     71A2 0005 
0336 71A4 1309  14         jeq   fh.file.read.edb.eof  ; All good. File closed by DSRLNK
0337                       ;------------------------------------------------------
0338                       ; File error occured
0339                       ;------------------------------------------------------
0340 71A6 06A0  32         bl    @file.close           ; Close file
     71A8 2C82 
0341 71AA 0A60                   data fh.vpab          ; \ i  p0 = Address of PAB in VRAM
0342               
0343 71AC 06A0  32         bl    @mem.sams.layout      ; Restore SAMS windows
     71AE 68A4 
0344                       ;------------------------------------------------------
0345                       ; Callback "File I/O error"
0346                       ;------------------------------------------------------
0347 71B0 C120  34         mov   @fh.callback4,tmp0    ; Get pointer to Callback "File I/O error"
     71B2 A456 
0348 71B4 0694  24         bl    *tmp0                 ; Run callback function
0349 71B6 100D  14         jmp   fh.file.read.edb.exit
0350                       ;------------------------------------------------------
0351                       ; End-Of-File reached
0352                       ;------------------------------------------------------
0353               fh.file.read.edb.eof:
0354 71B8 06A0  32         bl    @file.close           ; Close file
     71BA 2C82 
0355 71BC 0A60                   data fh.vpab          ; \ i  p0 = Address of PAB in VRAM
0356               
0357 71BE 06A0  32         bl    @mem.sams.layout      ; Restore SAMS windows
     71C0 68A4 
0358                       ;------------------------------------------------------
0359                       ; Callback "Close file"
0360                       ;------------------------------------------------------
0361 71C2 C120  34         mov   @fh.callback3,tmp0    ; Get pointer to Callback "Close file"
     71C4 A454 
0362 71C6 0694  24         bl    *tmp0                 ; Run callback function
0363               
0364 71C8 C120  34         mov   @edb.lines,tmp0       ; Get number of lines
     71CA A204 
0365 71CC 1302  14         jeq   fh.file.read.edb.exit ; Exit if lines = 0
0366 71CE 0620  34         dec   @edb.lines            ; One-time adjustment
     71D0 A204 
0367               *--------------------------------------------------------------
0368               * Exit
0369               *--------------------------------------------------------------
0370               fh.file.read.edb.exit:
0371 71D2 C820  54         mov   @fh.sams.hipage,@edb.sams.hipage
     71D4 A448 
     71D6 A214 
0372                                                   ; Set highest SAMS page in use
0373 71D8 04E0  34         clr   @fh.fopmode           ; Set FOP mode to idle operation
     71DA A44A 
0374               
0375 71DC C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0376 71DE C179  30         mov   *stack+,tmp1          ; Pop tmp1
0377 71E0 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0378 71E2 C2F9  30         mov   *stack+,r11           ; Pop R11
0379 71E4 045B  20         b     *r11                  ; Return to caller
0380               
0381               
0382               ***************************************************************
...
0386 71E6 0014             byte  io.op.open            ;  0    - OPEN
0387                       byte  io.seq.inp.dis.var    ;  1    - INPUT, VARIABLE, DISPLAY
0388 71E8 0960             data  fh.vrecbuf            ;  2-3  - Record buffer in VDP memory
0389 71EA 5000             byte  80                    ;  4    - Record length (80 chars max)
0390                       byte  00                    ;  5    - Character count
0391 71EC 0000             data  >0000                 ;  6-7  - Seek record (only for fixed recs)
0392 71EE 0000             byte  >00                   ;  8    - Screen offset (cassette DSR only)
0393                       ;------------------------------------------------------
...
0028 71F0 0649  14         dect  stack
0029 71F2 C64B  30         mov   r11,*stack            ; Save return address
0030 71F4 0649  14         dect  stack
0031 71F6 C644  30         mov   tmp0,*stack           ; Push tmp0
0032 71F8 0649  14         dect  stack
0033 71FA C645  30         mov   tmp1,*stack           ; Push tmp1
0034 71FC 0649  14         dect  stack
0035 71FE C646  30         mov   tmp2,*stack           ; Push tmp2
0036                       ;------------------------------------------------------
0037                       ; Initialisation
0038                       ;------------------------------------------------------
0039 7200 04E0  34         clr   @fh.records           ; Reset records counter
     7202 A43C 
0040 7204 04E0  34         clr   @fh.counter           ; Clear internal counter
     7206 A442 
0041 7208 04E0  34         clr   @fh.kilobytes         ; \ Clear kilobytes processed
     720A A440 
0042 720C 04E0  34         clr   @fh.kilobytes.prev    ; /
     720E A458 
0043 7210 04E0  34         clr   @fh.pabstat           ; Clear copy of VDP PAB status byte
     7212 A438 
0044 7214 04E0  34         clr   @fh.ioresult          ; Clear status register contents
     7216 A43A 
0045                       ;------------------------------------------------------
0046                       ; Save parameters / callback functions
0047                       ;------------------------------------------------------
0048 7218 0204  20         li    tmp0,fh.fopmode.writefile
     721A 0002 
0049                                                   ; We are going to write to a file
0050 721C C804  38         mov   tmp0,@fh.fopmode      ; Set file operations mode
     721E A44A 
0051               
0052 7220 C820  54         mov   @parm1,@fh.fname.ptr  ; Pointer to file descriptor
     7222 2F20 
     7224 A444 
0053 7226 C820  54         mov   @parm2,@fh.callback1  ; Callback function "Open file"
     7228 2F22 
     722A A450 
0054 722C C820  54         mov   @parm3,@fh.callback2  ; Callback function "Write line to file"
     722E 2F24 
     7230 A452 
0055 7232 C820  54         mov   @parm4,@fh.callback3  ; Callback function "Close" file"
     7234 2F26 
     7236 A454 
0056 7238 C820  54         mov   @parm5,@fh.callback4  ; Callback function "File I/O error"
     723A 2F28 
     723C A456 
0057                       ;------------------------------------------------------
0058                       ; Sanity check
0059                       ;------------------------------------------------------
0060 723E C120  34         mov   @fh.callback1,tmp0
     7240 A450 
0061 7242 0284  22         ci    tmp0,>6000            ; Insane address ?
     7244 6000 
0062 7246 1114  14         jlt   fh.file.write.crash   ; Yes, crash!
0063               
0064 7248 0284  22         ci    tmp0,>7fff            ; Insane address ?
     724A 7FFF 
0065 724C 1511  14         jgt   fh.file.write.crash   ; Yes, crash!
0066               
0067 724E C120  34         mov   @fh.callback2,tmp0
     7250 A452 
0068 7252 0284  22         ci    tmp0,>6000            ; Insane address ?
     7254 6000 
0069 7256 110C  14         jlt   fh.file.write.crash   ; Yes, crash!
0070               
0071 7258 0284  22         ci    tmp0,>7fff            ; Insane address ?
     725A 7FFF 
0072 725C 1509  14         jgt   fh.file.write.crash   ; Yes, crash!
0073               
0074 725E C120  34         mov   @fh.callback3,tmp0
     7260 A454 
0075 7262 0284  22         ci    tmp0,>6000            ; Insane address ?
     7264 6000 
0076 7266 1104  14         jlt   fh.file.write.crash   ; Yes, crash!
0077               
0078 7268 0284  22         ci    tmp0,>7fff            ; Insane address ?
     726A 7FFF 
0079 726C 1501  14         jgt   fh.file.write.crash   ; Yes, crash!
0080               
0081 726E 1004  14         jmp   fh.file.write.edb.save1
0082                                                   ; All checks passed, continue.
0083                       ;------------------------------------------------------
0084                       ; Check failed, crash CPU!
0085                       ;------------------------------------------------------
0086               fh.file.write.crash:
0087 7270 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     7272 FFCE 
0088 7274 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     7276 2030 
0089                       ;------------------------------------------------------
0090                       ; Callback "Before Open file"
0091                       ;------------------------------------------------------
0092               fh.file.write.edb.save1:
0093 7278 C120  34         mov   @fh.callback1,tmp0
     727A A450 
0094 727C 0694  24         bl    *tmp0                 ; Run callback function
0095                       ;------------------------------------------------------
0096                       ; Copy PAB header to VDP
0097                       ;------------------------------------------------------
0098               fh.file.write.edb.pabheader:
0099 727E 06A0  32         bl    @cpym2v
     7280 2458 
0100 7282 0A60                   data fh.vpab,fh.file.pab.header,9
     7284 71E6 
     7286 0009 
...
0104                       ;------------------------------------------------------
0105 7288 0204  20         li    tmp0,fh.vpab + 9      ; VDP destination
     728A 0A69 
0106 728C C160  34         mov   @fh.fname.ptr,tmp1    ; Get pointer to file descriptor
     728E A444 
0107 7290 D195  26         movb  *tmp1,tmp2            ; Get file descriptor length
0108 7292 0986  56         srl   tmp2,8                ; Right justify
0109 7294 0586  14         inc   tmp2                  ; Include length byte as well
0110               
0111 7296 06A0  32         bl    @xpym2v               ; Copy CPU memory to VDP memory
     7298 245E 
...
0116                       ; Open file
0117                       ;------------------------------------------------------
0118 729A 06A0  32         bl    @file.open            ; Open file
     729C 2C5E 
0119 729E 0A60                   data fh.vpab          ; \ i  p0 = Address of PAB in VRAM
0120 72A0 0012                   data io.seq.out.dis.var
0121                                                   ; / i  p1 = File type/mode
0122               
0123 72A2 21A0  38         coc   @wbit2,tmp2           ; Equal bit set?
     72A4 2026 
0124 72A6 1338  14         jeq   fh.file.write.edb.error
0125                                                   ; Yes, IO error occured
0126                       ;------------------------------------------------------
0127                       ; Step 1: Write file record
0128                       ;------------------------------------------------------
0129               fh.file.write.edb.record:
0130 72A8 8820  54         c     @fh.records,@edb.lines
     72AA A43C 
     72AC A204 
0131 72AE 133E  14         jeq   fh.file.write.edb.done
0132                                                   ; Exit when all records processed
0133                       ;------------------------------------------------------
0134                       ; 1a: Unpack current line to framebuffer
0135                       ;------------------------------------------------------
0136 72B0 C820  54         mov   @fh.records,@parm1    ; Line to unpack
     72B2 A43C 
     72B4 2F20 
0137 72B6 04E0  34         clr   @parm2                ; 1st row in frame buffer
     72B8 2F22 
0138               
0139 72BA 06A0  32         bl    @edb.line.unpack      ; Unpack line
     72BC 6D96 
...
0145                       ;------------------------------------------------------
0146 72BE 0204  20         li    tmp0,fh.vrecbuf       ; VDP target address
     72C0 0960 
0147 72C2 0205  20         li    tmp1,fb.top           ; Top of frame buffer in CPU memory
     72C4 A600 
0148               
0149 72C6 C1A0  34         mov   @outparm1,tmp2        ; Length of line
     72C8 2F30 
0150 72CA C806  38         mov   tmp2,@fh.reclen       ; Set record length
     72CC A43E 
0151 72CE 1302  14         jeq   !                     ; Skip VDP copy if empty line
0152               
0153 72D0 06A0  32         bl    @xpym2v               ; Copy CPU memory to VDP memory
     72D2 245E 
...
0159                       ;------------------------------------------------------
0160 72D4 06A0  32 !       bl    @file.record.write    ; Write file record
     72D6 2C9A 
0161 72D8 0A60                   data fh.vpab          ; \ i  p0   = Address of PAB in VDP RAM
...
0167               
0168 72DA C804  38         mov   tmp0,@fh.pabstat      ; Save VDP PAB status byte
     72DC A438 
0169 72DE C806  38         mov   tmp2,@fh.ioresult     ; Save status register contents
     72E0 A43A 
0170                       ;------------------------------------------------------
0171                       ; 1d: Calculate kilobytes processed
0172                       ;------------------------------------------------------
0173 72E2 A820  54         a     @fh.reclen,@fh.counter
     72E4 A43E 
     72E6 A442 
0174                                                   ; Add record length to counter
0175 72E8 C160  34         mov   @fh.counter,tmp1      ;
     72EA A442 
0176 72EC 0285  22         ci    tmp1,1024             ; 1 KB boundary reached ?
     72EE 0400 
0177 72F0 1106  14         jlt   fh.file.write.edb.check_fioerr
0178                                                   ; Not yet, goto (1e)
0179 72F2 05A0  34         inc   @fh.kilobytes
     72F4 A440 
0180 72F6 0225  22         ai    tmp1,-1024            ; Remove KB portion, only keep bytes
     72F8 FC00 
0181 72FA C805  38         mov   tmp1,@fh.counter      ; Update counter
     72FC A442 
0182                       ;------------------------------------------------------
0183                       ; 1e: Check if a file error occured
0184                       ;------------------------------------------------------
0185               fh.file.write.edb.check_fioerr:
0186 72FE C1A0  34         mov   @fh.ioresult,tmp2
     7300 A43A 
0187 7302 21A0  38         coc   @wbit2,tmp2           ; IO error occured?
     7304 2026 
0188 7306 1602  14         jne   fh.file.write.edb.display
0189                                                   ; No, goto (2)
0190 7308 0460  28         b     @fh.file.write.edb.error
     730A 7318 
...
0196 730C C120  34         mov   @fh.callback2,tmp0    ; Get pointer to "Saving indicator 2"
     730E A452 
0197 7310 0694  24         bl    *tmp0                 ; Run callback function
0198                       ;------------------------------------------------------
0199                       ; Step 3: Next record
0200                       ;------------------------------------------------------
0201 7312 05A0  34         inc   @fh.records           ; Update counter
     7314 A43C 
0202 7316 10C8  14         jmp   fh.file.write.edb.record
0203                       ;------------------------------------------------------
0204                       ; Error handler
0205                       ;------------------------------------------------------
0206               fh.file.write.edb.error:
0207 7318 C120  34         mov   @fh.pabstat,tmp0      ; Get VDP PAB status byte
     731A A438 
0208 731C 0984  56         srl   tmp0,8                ; Right align VDP PAB 1 status byte
0209                       ;------------------------------------------------------
0210                       ; File error occured
0211                       ;------------------------------------------------------
0212 731E 06A0  32         bl    @file.close           ; Close file
     7320 2C82 
0213 7322 0A60                   data fh.vpab          ; \ i  p0 = Address of PAB in VRAM
0214                       ;------------------------------------------------------
0215                       ; Callback "File I/O error"
0216                       ;------------------------------------------------------
0217 7324 C120  34         mov   @fh.callback4,tmp0    ; Get pointer to Callback "File I/O error"
     7326 A456 
0218 7328 0694  24         bl    *tmp0                 ; Run callback function
0219 732A 1006  14         jmp   fh.file.write.edb.exit
0220                       ;------------------------------------------------------
0221                       ; All records written. Close file
0222                       ;------------------------------------------------------
0223               fh.file.write.edb.done:
0224 732C 06A0  32         bl    @file.close           ; Close file
     732E 2C82 
0225 7330 0A60                   data fh.vpab          ; \ i  p0 = Address of PAB in VRAM
0226                       ;------------------------------------------------------
0227                       ; Callback "Close file"
0228                       ;------------------------------------------------------
0229 7332 C120  34         mov   @fh.callback3,tmp0    ; Get pointer to Callback "Close file"
     7334 A454 
0230 7336 0694  24         bl    *tmp0                 ; Run callback function
0231               *--------------------------------------------------------------
0232               * Exit
0233               *--------------------------------------------------------------
0234               fh.file.write.edb.exit:
0235 7338 04E0  34         clr   @fh.fopmode           ; Set FOP mode to idle operation
     733A A44A 
0236 733C C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0237 733E C179  30         mov   *stack+,tmp1          ; Pop tmp1
0238 7340 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0239 7342 C2F9  30         mov   *stack+,r11           ; Pop R11
0240 7344 045B  20         b     *r11                  ; Return to caller
**** **** ****     > stevie_b1.asm.2389682
...
0020               ********|*****|*********************|**************************
0021               fm.loadfile:
0022 7346 0649  14         dect  stack
0023 7348 C64B  30         mov   r11,*stack            ; Save return address
0024 734A 0649  14         dect  stack
0025 734C C644  30         mov   tmp0,*stack           ; Push tmp0
0026 734E 0649  14         dect  stack
0027 7350 C645  30         mov   tmp1,*stack           ; Push tmp1
0028                       ;-------------------------------------------------------
0029                       ; Show dialog "Unsaved changes" and exit if buffer dirty
0030                       ;-------------------------------------------------------
0031 7352 C160  34         mov   @edb.dirty,tmp1
     7354 A206 
0032 7356 1305  14         jeq   !
0033 7358 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0034 735A C139  30         mov   *stack+,tmp0          ; Pop tmp0
0035 735C C2F9  30         mov   *stack+,r11           ; Pop R11
0036 735E 0460  28         b     @dialog.unsaved       ; Show dialog and exit
     7360 7ED0 
0037                       ;-------------------------------------------------------
0038                       ; Reset editor
0039                       ;-------------------------------------------------------
0040 7362 C804  38 !       mov   tmp0,@parm1           ; Setup file to load
     7364 2F20 
0041 7366 06A0  32         bl    @tv.reset             ; Reset editor
     7368 6888 
0042 736A C820  54         mov   @parm1,@edb.filename.ptr
     736C 2F20 
     736E A20E 
0043                                                   ; Set filename
0044                       ;-------------------------------------------------------
...
0046                       ;-------------------------------------------------------
0047 7370 06A0  32         bl    @filv
     7372 229C 
0048 7374 2180                   data sprsat,>0000,4   ; Turn off sprites (cursor)
     7376 0000 
     7378 0004 
0049               
0050 737A C160  34         mov   @fb.scrrows,tmp1
     737C A118 
0051 737E 3960  72         mpy   @fb.colsline,tmp1     ; columns per line * rows on screen
     7380 A10E 
0052                                                   ; 16 bit part is in tmp2!
0053               
0054 7382 06A0  32         bl    @scroff               ; Turn off screen
     7384 2660 
0055               
0056 7386 04C4  14         clr   tmp0                  ; VDP target address (1nd row on screen!)
0057 7388 0205  20         li    tmp1,32               ; Character to fill
     738A 0020 
0058               
0059 738C 06A0  32         bl    @xfilv                ; Fill VDP memory
     738E 22A2 
0060                                                   ; \ i  tmp0 = VDP target address
0061                                                   ; | i  tmp1 = Byte to fill
0062                                                   ; / i  tmp2 = Bytes to copy
0063               
0064 7390 06A0  32         bl    @pane.action.colorscheme.Load
     7392 794A 
0065                                                   ; Load color scheme and turn on screen
0066                       ;-------------------------------------------------------
0067                       ; Read DV80 file and display
0068                       ;-------------------------------------------------------
0069 7394 0204  20         li    tmp0,fm.loadsave.cb.indicator1
     7396 7456 
0070 7398 C804  38         mov   tmp0,@parm2           ; Register callback 1
     739A 2F22 
0071               
0072 739C 0204  20         li    tmp0,fm.loadsave.cb.indicator2
     739E 74CE 
0073 73A0 C804  38         mov   tmp0,@parm3           ; Register callback 2
     73A2 2F24 
0074               
0075 73A4 0204  20         li    tmp0,fm.loadsave.cb.indicator3
     73A6 7544 
0076 73A8 C804  38         mov   tmp0,@parm4           ; Register callback 3
     73AA 2F26 
0077               
0078 73AC 0204  20         li    tmp0,fm.loadsave.cb.fioerr
     73AE 758A 
0079 73B0 C804  38         mov   tmp0,@parm5           ; Register callback 4
     73B2 2F28 
0080               
0081 73B4 06A0  32         bl    @fh.file.read.edb     ; Read file into editor buffer
     73B6 6FBE 
...
0092               
0093 73B8 04E0  34         clr   @edb.dirty            ; Editor buffer content replaced, not
     73BA A206 
0094                                                   ; longer dirty.
0095               
0096 73BC 0204  20         li    tmp0,txt.filetype.DV80
     73BE 335C 
0097 73C0 C804  38         mov   tmp0,@edb.filetype.ptr
     73C2 A210 
...
0103 73C4 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0104 73C6 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0105 73C8 C2F9  30         mov   *stack+,r11           ; Pop R11
0106 73CA 045B  20         b     *r11                  ; Return to caller
0107               
0108               
0109               ***************************************************************
0110               * fm.fastmode
...
0123               ********|*****|*********************|**************************
0124               fm.fastmode:
0125 73CC 0649  14         dect  stack
0126 73CE C64B  30         mov   r11,*stack            ; Save return address
0127 73D0 0649  14         dect  stack
0128 73D2 C644  30         mov   tmp0,*stack           ; Push tmp0
0129               
0130 73D4 C120  34         mov   @fh.offsetopcode,tmp0
     73D6 A44E 
0131 73D8 1307  14         jeq   !
0132                       ;------------------------------------------------------
0133                       ; Turn fast mode off
0134                       ;------------------------------------------------------
0135 73DA 04E0  34         clr   @fh.offsetopcode      ; Data buffer in VDP RAM
     73DC A44E 
0136 73DE 0204  20         li    tmp0,txt.keys.load
     73E0 33CC 
0137 73E2 C804  38         mov   tmp0,@cmdb.pankeys    ; Keylist in status line
     73E4 A320 
0138 73E6 1008  14         jmp   fm.fastmode.exit
0139                       ;------------------------------------------------------
0140                       ; Turn fast mode on
0141                       ;------------------------------------------------------
0142 73E8 0204  20 !       li    tmp0,>40              ; Data buffer in CPU RAM
     73EA 0040 
0143 73EC C804  38         mov   tmp0,@fh.offsetopcode
     73EE A44E 
0144 73F0 0204  20         li    tmp0,txt.keys.load2
     73F2 3404 
0145 73F4 C804  38         mov   tmp0,@cmdb.pankeys    ; Keylist in status line
     73F6 A320 
0146               *--------------------------------------------------------------
0147               * Exit
0148               *--------------------------------------------------------------
0149               fm.fastmode.exit:
0150 73F8 C139  30         mov   *stack+,tmp0          ; Pop tmp0
...
0023 7400 C64B  30         mov   r11,*stack            ; Save return address
0024 7402 0649  14         dect  stack
0025 7404 C644  30         mov   tmp0,*stack           ; Push tmp0
0026 7406 0649  14         dect  stack
0027 7408 C645  30         mov   tmp1,*stack           ; Push tmp1
0028                       ;-------------------------------------------------------
0029                       ; Save DV80 file
0030                       ;-------------------------------------------------------
0031 740A C804  38         mov   tmp0,@parm1           ; Set device and filename
     740C 2F20 
0032               
0033 740E 0204  20         li    tmp0,fm.loadsave.cb.indicator1
     7410 7456 
0034 7412 C804  38         mov   tmp0,@parm2           ; Register callback 1
     7414 2F22 
0035               
0036 7416 0204  20         li    tmp0,fm.loadsave.cb.indicator2
     7418 74CE 
0037 741A C804  38         mov   tmp0,@parm3           ; Register callback 2
     741C 2F24 
0038               
0039 741E 0204  20         li    tmp0,fm.loadsave.cb.indicator3
     7420 7544 
0040 7422 C804  38         mov   tmp0,@parm4           ; Register callback 3
     7424 2F26 
0041               
0042 7426 0204  20         li    tmp0,fm.loadsave.cb.fioerr
     7428 758A 
0043 742A C804  38         mov   tmp0,@parm5           ; Register callback 4
     742C 2F28 
0044               
0045 742E C820  54         mov   @parm1,@edb.filename.ptr
     7430 2F20 
     7432 A20E 
0046                                                   ; Set current filename
0047               
0048 7434 06A0  32         bl    @filv
     7436 229C 
0049 7438 2180                   data sprsat,>0000,4   ; Turn off sprites (cursor)
     743A 0000 
     743C 0004 
0050               
0051 743E 06A0  32         bl    @fh.file.write.edb    ; Save file from editor buffer
     7440 71F0 
...
0062               
0063 7442 04E0  34         clr   @edb.dirty            ; Editor buffer content replaced, not
     7444 A206 
0064                                                   ; longer dirty.
0065               
0066 7446 0204  20         li    tmp0,txt.filetype.DV80
     7448 335C 
0067 744A C804  38         mov   tmp0,@edb.filetype.ptr
     744C A210 
...
0073 744E C179  30         mov   *stack+,tmp1          ; Pop tmp1
0074 7450 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0075 7452 C2F9  30         mov   *stack+,r11           ; Pop R11
0076 7454 045B  20         b     *r11                  ; Return to caller
**** **** ****     > stevie_b1.asm.2389682
...
0011 7456 0649  14         dect  stack
0012 7458 C64B  30         mov   r11,*stack            ; Save return address
0013 745A 0649  14         dect  stack
0014 745C C644  30         mov   tmp0,*stack           ; Push tmp0
0015 745E 0649  14         dect  stack
0016 7460 C645  30         mov   tmp1,*stack           ; Push tmp1
0017 7462 0649  14         dect  stack
0018 7464 C660  46         mov   @parm1,*stack         ; Push @parm1
     7466 2F20 
0019                       ;------------------------------------------------------
0020                       ; Check file operation mode
0021                       ;------------------------------------------------------
0022 7468 06A0  32         bl    @hchar
     746A 2794 
0023 746C 1D00                   byte pane.botrow,0,32,80
     746E 2050 
0024 7470 FFFF                   data EOL              ; Clear until end of line
0025               
0026 7472 C820  54         mov   @tv.busycolor,@parm1
     7474 A01A 
     7476 2F20 
0027 7478 06A0  32         bl    @pane.action.colorcombo.botline
     747A 7A4A 
0028                                                   ; Load color combinaton for bottom line
0029                                                   ; \ i  @parm1 = Color combination
0030                                                   ; /
0031               
0032 747C C120  34         mov   @fh.fopmode,tmp0      ; Check file operation mode
     747E A44A 
0033               
0034 7480 0284  22         ci    tmp0,fh.fopmode.writefile
     7482 0002 
0035 7484 1303  14         jeq   fm.loadsave.cb.indicator1.saving
0036                                                   ; Saving file?
0037               
0038 7486 0284  22         ci    tmp0,fh.fopmode.readfile
     7488 0001 
0039 748A 1305  14         jeq   fm.loadsave.cb.indicator1.loading
0040                                                   ; Loading file?
0041                       ;------------------------------------------------------
0042                       ; Display Saving....
0043                       ;------------------------------------------------------
0044               fm.loadsave.cb.indicator1.saving:
0045 748C 06A0  32         bl    @putat
     748E 2450 
0046 7490 1D00                   byte pane.botrow,0
0047 7492 332E                   data txt.saving       ; Display "Saving...."
0048 7494 1004  14         jmp   fm.loadsave.cb.indicator1.filename
0049                       ;------------------------------------------------------
0050                       ; Display Loading....
0051                       ;------------------------------------------------------
0052               fm.loadsave.cb.indicator1.loading:
0053 7496 06A0  32         bl    @putat
     7498 2450 
0054 749A 1D00                   byte pane.botrow,0
0055 749C 3322                   data txt.loading      ; Display "Loading...."
0056                       ;------------------------------------------------------
0057                       ; Display device/filename
0058                       ;------------------------------------------------------
0059               fm.loadsave.cb.indicator1.filename:
0060 749E 06A0  32         bl    @at
     74A0 26A0 
0061 74A2 1D0B                   byte pane.botrow,11   ; Cursor YX position
0062 74A4 C160  34         mov   @edb.filename.ptr,tmp1
     74A6 A20E 
0063                                                   ; Get pointer to file descriptor
0064 74A8 06A0  32         bl    @xutst0               ; Display device/filename
     74AA 242E 
0065                       ;------------------------------------------------------
0066                       ; Display separators
0067                       ;------------------------------------------------------
0068 74AC 06A0  32         bl    @putat
     74AE 2450 
0069 74B0 1D47                   byte pane.botrow,71
0070 74B2 336C                   data txt.vertline     ; Vertical line
0071                       ;------------------------------------------------------
0072                       ; Display fast mode
0073                       ;------------------------------------------------------
0074 74B4 0760  38         abs   @fh.offsetopcode
     74B6 A44E 
0075 74B8 1304  14         jeq   fm.loadsave.cb.indicator1.exit
0076               
0077 74BA 06A0  32         bl    @putat
     74BC 2450 
0078 74BE 1D26                   byte pane.botrow,38
0079 74C0 3338                   data txt.fastmode     ; Display "FastMode"
0080                       ;------------------------------------------------------
0081                       ; Exit
0082                       ;------------------------------------------------------
0083               fm.loadsave.cb.indicator1.exit:
0084 74C2 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     74C4 2F20 
0085 74C6 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0086 74C8 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0087 74CA C2F9  30         mov   *stack+,r11           ; Pop R11
0088 74CC 045B  20         b     *r11                  ; Return to caller
0089               
0090               
0091               
0092               
...
0102                       ;------------------------------------------------------
0103 74CE 8820  54         c     @fh.records,@fb.scrrows.max
     74D0 A43C 
     74D2 A11A 
0104 74D4 161B  14         jne   fm.loadsave.cb.indicator2.kb
0105                                                   ; Skip framebuffer refresh
0106                       ;------------------------------------------------------
0107                       ; Refresh framebuffer if first page processed
0108                       ;------------------------------------------------------
0109 74D6 0649  14         dect  stack
0110 74D8 C64B  30         mov   r11,*stack            ; Save return address
0111 74DA 0649  14         dect  stack
0112 74DC C644  30         mov   tmp0,*stack           ; Push tmp0
0113 74DE 0649  14         dect  stack
0114 74E0 C645  30         mov   tmp1,*stack           ; Push tmp1
0115 74E2 0649  14         dect  stack
0116 74E4 C646  30         mov   tmp2,*stack           ; Push tmp2
0117               
0118 74E6 04E0  34         clr   @parm1                ;
     74E8 2F20 
0119 74EA 06A0  32         bl    @fb.refresh           ; Refresh frame buffer
     74EC 6990 
...
0125                       ;------------------------------------------------------
0126 74EE C160  34         mov   @fb.scrrows.max,tmp1
     74F0 A11A 
0127 74F2 3960  72         mpy   @fb.colsline,tmp1     ; columns per line * rows on screen
     74F4 A10E 
0128                                                   ; 16 bit part is in tmp2!
0129 74F6 04C4  14         clr   tmp0                  ; VDP target address (1nd line on screen!)
0130 74F8 C160  34         mov   @fb.top.ptr,tmp1      ; RAM Source address
     74FA A100 
0131               
0132 74FC 06A0  32         bl    @xpym2v               ; Copy to VDP
     74FE 245E 
0133                                                   ; \ i  tmp0 = VDP target address
0134                                                   ; | i  tmp1 = RAM source address
0135                                                   ; / i  tmp2 = Bytes to copy
0136               
0137 7500 04E0  34         clr   @fb.dirty             ; Reset frame buffer dirty flag
     7502 A116 
0138               
0139 7504 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0140 7506 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0141 7508 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0142 750A C2F9  30         mov   *stack+,r11           ; Pop R11
0143               
0144                       ;------------------------------------------------------
0145                       ; Check if updated counters should be displayed
0146                       ;------------------------------------------------------
0147               fm.loadsave.cb.indicator2.kb:
0148 750C 8820  54         c     @fh.kilobytes,@fh.kilobytes.prev
     750E A440 
     7510 A458 
0149 7512 1601  14         jne   !
0150 7514 045B  20         b     *r11                  ; Exit early!
0151                       ;------------------------------------------------------
0152                       ; Display updated counters
0153                       ;------------------------------------------------------
0154 7516 0649  14 !       dect  stack
0155 7518 C64B  30         mov   r11,*stack            ; Save return address
0156               
0157 751A C820  54         mov   @fh.kilobytes,@fh.kilobytes.prev
     751C A440 
     751E A458 
0158                                                   ; Save for compare
0159               
0160 7520 06A0  32         bl    @putnum
     7522 2A24 
0161 7524 1D32                   byte pane.botrow,50   ; Show kilobytes processed
0162 7526 A440                   data fh.kilobytes,rambuf,>3020
     7528 2F64 
     752A 3020 
0163               
0164 752C 06A0  32         bl    @putat
     752E 2450 
0165 7530 1D37                   byte pane.botrow,55
0166 7532 3342                   data txt.kb           ; Show "kb" string
0167               
0168 7534 06A0  32         bl    @putnum
     7536 2A24 
0169 7538 1D49                   byte pane.botrow,73   ; Show lines processed
0170 753A A43C                   data fh.records,rambuf,>3020
     753C 2F64 
     753E 3020 
0171                       ;------------------------------------------------------
0172                       ; Exit
...
0175 7540 C2F9  30         mov   *stack+,r11           ; Pop R11
0176 7542 045B  20         b     *r11                  ; Return to caller
0177               
0178               
0179               
0180               
...
0188 7544 0649  14         dect  stack
0189 7546 C64B  30         mov   r11,*stack            ; Save return address
0190 7548 0649  14         dect  stack
0191 754A C660  46         mov   @parm1,*stack         ; Push @parm1
     754C 2F20 
0192               
0193 754E 06A0  32         bl    @hchar
     7550 2794 
0194 7552 1D00                   byte pane.botrow,0,32,50
     7554 2032 
0195 7556 FFFF                   data EOL              ; Erase loading indicator
0196               
0197 7558 C820  54         mov   @tv.color,@parm1
     755A A018 
     755C 2F20 
0198 755E 06A0  32         bl    @pane.action.colorcombo.botline
     7560 7A4A 
0199                                                   ; Load color combinaton for bottom line
0200                                                   ; \ i  @parm1 = Color combination
0201                                                   ; /
0202               
0203 7562 06A0  32         bl    @putnum
     7564 2A24 
0204 7566 1D32                   byte pane.botrow,50   ; Show kilobytes processed
0205 7568 A440                   data fh.kilobytes,rambuf,>3020
     756A 2F64 
     756C 3020 
0206               
0207 756E 06A0  32         bl    @putat
     7570 2450 
0208 7572 1D37                   byte pane.botrow,55
0209 7574 3342                   data txt.kb           ; Show "kb" string
0210               
0211 7576 06A0  32         bl    @putnum
     7578 2A24 
0212 757A 1D49                   byte pane.botrow,73   ; Show lines processed
0213 757C A43C                   data fh.records,rambuf,>3020
     757E 2F64 
     7580 3020 
0214                       ;------------------------------------------------------
0215                       ; Exit
...
0218 7582 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     7584 2F20 
0219 7586 C2F9  30         mov   *stack+,r11           ; Pop R11
0220 7588 045B  20         b     *r11                  ; Return to caller
0221               
0222               
0223               
0224               *---------------------------------------------------------------
...
0231 758A 0649  14         dect  stack
0232 758C C64B  30         mov   r11,*stack            ; Save return address
0233 758E 0649  14         dect  stack
0234 7590 C644  30         mov   tmp0,*stack           ; Push tmp0
0235 7592 0649  14         dect  stack
0236 7594 C660  46         mov   @parm1,*stack         ; Push @parm1
     7596 2F20 
0237                       ;------------------------------------------------------
0238                       ; Build I/O error message
0239                       ;------------------------------------------------------
0240 7598 06A0  32         bl    @hchar
     759A 2794 
0241 759C 1D00                   byte pane.botrow,0,32,50
     759E 2032 
0242 75A0 FFFF                   data EOL              ; Erase loading indicator
0243               
0244 75A2 C120  34         mov   @fh.fopmode,tmp0      ; Check file operation mode
     75A4 A44A 
0245 75A6 0284  22         ci    tmp0,fh.fopmode.writefile
     75A8 0002 
0246 75AA 1306  14         jeq   fm.loadsave.cb.fioerr.mgs2
0247                       ;------------------------------------------------------
0248                       ; Failed loading file
0249                       ;------------------------------------------------------
0250               fm.loadsave.cb.fioerr.mgs1:
0251 75AC 06A0  32         bl    @cpym2m
     75AE 24AC 
0252 75B0 35B9                   data txt.ioerr.load+1
0253 75B2 A023                   data tv.error.msg+1
0254 75B4 0022                   data 34               ; Error message
0255 75B6 1005  14         jmp   fm.loadsave.cb.fioerr.mgs3
0256                       ;------------------------------------------------------
0257                       ; Failed saving file
0258                       ;------------------------------------------------------
0259               fm.loadsave.cb.fioerr.mgs2:
0260 75B8 06A0  32         bl    @cpym2m
     75BA 24AC 
0261 75BC 35DB                   data txt.ioerr.save+1
0262 75BE A023                   data tv.error.msg+1
0263 75C0 0022                   data 34               ; Error message
0264                       ;------------------------------------------------------
0265                       ; Add filename to error message
0266                       ;------------------------------------------------------
0267               fm.loadsave.cb.fioerr.mgs3:
0268 75C2 C120  34         mov   @edb.filename.ptr,tmp0
     75C4 A20E 
0269 75C6 D194  26         movb  *tmp0,tmp2            ; Get length byte
0270 75C8 0986  56         srl   tmp2,8                ; Right align
0271 75CA 0584  14         inc   tmp0                  ; Skip length byte
0272 75CC 0205  20         li    tmp1,tv.error.msg+33  ; RAM destination address
     75CE A043 
0273               
0274 75D0 06A0  32         bl    @xpym2m               ; \ Copy CPU memory to CPU memory
     75D2 24B2 
...
0280                       ;------------------------------------------------------
0281 75D4 C120  34         mov   @fh.fopmode,tmp0      ; Check file operation mode
     75D6 A44A 
0282               
0283 75D8 0284  22         ci    tmp0,fh.fopmode.readfile
     75DA 0001 
0284 75DC 1608  14         jne   !                     ; Only when reading file
0285               
0286 75DE 0204  20         li    tmp0,txt.newfile      ; New file
     75E0 3350 
0287 75E2 C804  38         mov   tmp0,@edb.filename.ptr
     75E4 A20E 
0288               
0289 75E6 0204  20         li    tmp0,txt.filetype.none
     75E8 3362 
0290 75EA C804  38         mov   tmp0,@edb.filetype.ptr
     75EC A210 
0291                                                   ; Empty filetype string
0292                       ;------------------------------------------------------
0293                       ; Display I/O error message
0294                       ;------------------------------------------------------
0295 75EE 06A0  32 !       bl    @pane.errline.show    ; Show error line
     75F0 7BDC 
0296               
0297 75F2 C820  54         mov   @tv.color,@parm1      ; Restore "normal" color
     75F4 A018 
     75F6 2F20 
0298 75F8 06A0  32         bl    @pane.action.colorcombo.botline
     75FA 7A4A 
...
0306 75FC C839  50         mov   *stack+,@parm1        ; Pop @parm1
     75FE 2F20 
0307 7600 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0308 7602 C2F9  30         mov   *stack+,r11           ; Pop R11
0309 7604 045B  20         b     *r11                  ; Return to caller
**** **** ****     > stevie_b1.asm.2389682
...
0018 7606 0649  14         dect  stack
0019 7608 C64B  30         mov   r11,*stack            ; Save return address
0020 760A 0649  14         dect  stack
0021 760C C644  30         mov   tmp0,*stack           ; Push tmp0
0022 760E 0649  14         dect  stack
0023 7610 C645  30         mov   tmp1,*stack           ; Push tmp1
0024                       ;------------------------------------------------------
0025                       ; Sanity check
0026                       ;------------------------------------------------------
0027 7612 C120  34         mov   @parm1,tmp0           ; Get pointer to filename
     7614 2F20 
0028 7616 1334  14         jeq   fm.browse.fname.suffix.exit
0029                                                   ; Exit early if pointer is nill
0030               
0031 7618 0284  22         ci    tmp0,txt.newfile
     761A 3350 
0032 761C 1331  14         jeq   fm.browse.fname.suffix.exit
0033                                                   ; Exit early if "New file"
0034                       ;------------------------------------------------------
0035                       ; Get last character in filename
0036                       ;------------------------------------------------------
0037 761E D154  26         movb  *tmp0,tmp1            ; Get length of current filename
0038 7620 0985  56         srl   tmp1,8                ; MSB to LSB
0039               
0040 7622 A105  18         a     tmp1,tmp0             ; Move to last character
0041 7624 04C5  14         clr   tmp1
0042 7626 D154  26         movb  *tmp0,tmp1            ; Get character
0043 7628 0985  56         srl   tmp1,8                ; MSB to LSB
0044 762A 132A  14         jeq   fm.browse.fname.suffix.exit
0045                                                   ; Exit early if empty filename
0046                       ;------------------------------------------------------
0047                       ; Check mode (increase/decrease) character ASCII value
0048                       ;------------------------------------------------------
0049 762C C1A0  34         mov   @parm2,tmp2           ; Get mode
     762E 2F22 
0050 7630 1314  14         jeq   fm.browse.fname.suffix.dec
0051                                                   ; Decrease ASCII if mode = 0
0052                       ;------------------------------------------------------
0053                       ; Increase ASCII value last character in filename
0054                       ;------------------------------------------------------
0055               fm.browse.fname.suffix.inc:
0056 7632 0285  22         ci    tmp1,48               ; ASCI  48 (char 0) ?
     7634 0030 
0057 7636 1108  14         jlt   fm.browse.fname.suffix.inc.crash
0058 7638 0285  22         ci    tmp1,57               ; ASCII 57 (char 9) ?
     763A 0039 
0059 763C 1109  14         jlt   !                     ; Next character
0060 763E 130A  14         jeq   fm.browse.fname.suffix.inc.alpha
0061                                                   ; Swith to alpha range A..Z
0062 7640 0285  22         ci    tmp1,90               ; ASCII 132 (char Z) ?
     7642 005A 
0063 7644 131D  14         jeq   fm.browse.fname.suffix.exit
0064                                                   ; Already last alpha character, so exit
0065 7646 1104  14         jlt   !                     ; Next character
0066                       ;------------------------------------------------------
0067                       ; Invalid character, crash and burn
0068                       ;------------------------------------------------------
0069               fm.browse.fname.suffix.inc.crash:
0070 7648 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     764A FFCE 
0071 764C 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     764E 2030 
0072                       ;------------------------------------------------------
0073                       ; Increase ASCII value last character in filename
0074                       ;------------------------------------------------------
0075 7650 0585  14 !       inc   tmp1                  ; Increase ASCII value
0076 7652 1014  14         jmp   fm.browse.fname.suffix.store
0077               fm.browse.fname.suffix.inc.alpha:
0078 7654 0205  20         li    tmp1,65               ; Set ASCII 65 (char A)
     7656 0041 
0079 7658 1011  14         jmp   fm.browse.fname.suffix.store
0080                       ;------------------------------------------------------
0081                       ; Decrease ASCII value last character in filename
0082                       ;------------------------------------------------------
0083               fm.browse.fname.suffix.dec:
0084 765A 0285  22         ci    tmp1,48               ; ASCII 48 (char 0) ?
     765C 0030 
0085 765E 1310  14         jeq   fm.browse.fname.suffix.exit
0086                                                   ; Already first numeric character, so exit
0087 7660 0285  22         ci    tmp1,57               ; ASCII 57 (char 9) ?
     7662 0039 
0088 7664 1207  14         jle   !                     ; Previous character
0089 7666 0285  22         ci    tmp1,65               ; ASCII 65 (char A) ?
     7668 0041 
0090 766A 1306  14         jeq   fm.browse.fname.suffix.dec.numeric
0091                                                   ; Switch to numeric range 0..9
0092 766C 11ED  14         jlt   fm.browse.fname.suffix.inc.crash
0093                                                   ; Invalid character
0094 766E 0285  22         ci    tmp1,132              ; ASCII 132 (char Z) ?
     7670 0084 
0095 7672 1306  14         jeq   fm.browse.fname.suffix.exit
0096 7674 0605  14 !       dec   tmp1                  ; Decrease ASCII value
0097 7676 1002  14         jmp   fm.browse.fname.suffix.store
0098               fm.browse.fname.suffix.dec.numeric:
0099 7678 0205  20         li    tmp1,57               ; Set ASCII 57 (char 9)
     767A 0039 
0100                       ;------------------------------------------------------
0101                       ; Store updatec character
0102                       ;------------------------------------------------------
0103               fm.browse.fname.suffix.store:
0104 767C 0A85  56         sla   tmp1,8                ; LSB to MSB
0105 767E D505  30         movb  tmp1,*tmp0            ; Store updated character
0106                       ;------------------------------------------------------
0107                       ; Exit
0108                       ;------------------------------------------------------
0109               fm.browse.fname.suffix.exit:
0110 7680 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0111 7682 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0112 7684 C2F9  30         mov   *stack+,r11           ; Pop R11
0113 7686 045B  20         b     *r11                  ; Return to caller
**** **** ****     > stevie_b1.asm.2389682
0165                       ;-----------------------------------------------------------------------
...
0010               ****************************************************************
0011               hook.keyscan:
0012 7688 20A0  38         coc   @wbit11,config        ; ANYKEY pressed ?
     768A 2014 
0013 768C 1612  14         jne   hook.keyscan.clear_kbbuffer
0014                                                   ; No, clear buffer and exit
0015 768E C820  54         mov   @waux1,@keycode1      ; Save current key pressed
     7690 833C 
     7692 2F40 
0016               *---------------------------------------------------------------
0017               * Identical key pressed ?
0018               *---------------------------------------------------------------
0019 7694 40A0  34         szc   @wbit11,config        ; Reset ANYKEY
     7696 2014 
0020 7698 8820  54         c     @keycode1,@keycode2   ; Still pressing previous key?
     769A 2F40 
     769C 2F42 
0021 769E 130D  14         jeq   hook.keyscan.bounce   ; Do keyboard bounce delay and return
0022               *--------------------------------------------------------------
0023               * New key pressed
0024               *--------------------------------------------------------------
0025 76A0 0204  20         li    tmp0,500              ; \
     76A2 01F4 
0026 76A4 0604  14 !       dec   tmp0                  ; | Inline keyboard bounce delay
0027 76A6 16FE  14         jne   -!                    ; /
0028 76A8 C820  54         mov   @keycode1,@keycode2   ; Save as previous key
     76AA 2F40 
     76AC 2F42 
0029 76AE 0460  28         b     @edkey.key.process    ; Process key
     76B0 60E4 
0030               *--------------------------------------------------------------
0031               * Clear keyboard buffer if no key pressed
0032               *--------------------------------------------------------------
0033               hook.keyscan.clear_kbbuffer:
0034 76B2 04E0  34         clr   @keycode1
     76B4 2F40 
0035 76B6 04E0  34         clr   @keycode2
     76B8 2F42 
0036               *--------------------------------------------------------------
0037               * Delay to avoid key bouncing
0038               *--------------------------------------------------------------
0039               hook.keyscan.bounce:
0040 76BA 0204  20         li    tmp0,2000             ; Avoid key bouncing
     76BC 07D0 
0041                       ;------------------------------------------------------
0042                       ; Delay loop
0043                       ;------------------------------------------------------
0044               hook.keyscan.bounce.loop:
0045 76BE 0604  14         dec   tmp0
0046 76C0 16FE  14         jne   hook.keyscan.bounce.loop
0047 76C2 0460  28         b     @hookok               ; Return
     76C4 2D1A 
0048               
**** **** ****     > stevie_b1.asm.2389682
...
0010               ********|*****|*********************|**************************
0011               task.vdp.panes:
0012 76C6 C820  54         mov   @wyx,@fb.yxsave       ; Backup cursor
     76C8 832A 
     76CA A114 
0013                       ;------------------------------------------------------
...
0017 76CC 20A0  38         coc   @wbit10,config
     76CE 2016 
0018 76D0 1305  14         jeq   task.vdp.panes.alpha_lock.down
0019                       ;------------------------------------------------------
0020                       ; AlPHA-Lock is up
0021                       ;------------------------------------------------------
0022 76D2 06A0  32         bl    @putat
     76D4 2450 
0023 76D6 1D4F                   byte   pane.botrow,79
0024 76D8 3368                   data   txt.alpha.up
0025 76DA 1004  14         jmp   task.vdp.panes.cmdb.check
0026                       ;------------------------------------------------------
0027                       ; AlPHA-Lock is down
0028                       ;------------------------------------------------------
0029               task.vdp.panes.alpha_lock.down:
0030 76DC 06A0  32         bl    @putat
     76DE 2450 
0031 76E0 1D4F                   byte   pane.botrow,79
0032 76E2 336A                   data   txt.alpha.down
0033                       ;------------------------------------------------------
0034                       ; Command buffer visible ?
0035                       ;------------------------------------------------------
0036               task.vdp.panes.cmdb.check
0037 76E4 C820  54         mov   @fb.yxsave,@wyx       ; Restore cursor
     76E6 A114 
     76E8 832A 
0038 76EA C120  34         mov   @cmdb.visible,tmp0    ; CMDB pane visible ?
     76EC A302 
0039 76EE 1309  14         jeq   !                     ; No, skip CMDB pane
0040 76F0 1000  14         jmp   task.vdp.panes.cmdb.draw
0041                       ;-------------------------------------------------------
0042                       ; Draw command buffer pane if dirty
0043                       ;-------------------------------------------------------
0044               task.vdp.panes.cmdb.draw:
0045 76F2 C120  34         mov   @cmdb.dirty,tmp0      ; Command buffer dirty?
     76F4 A318 
0046 76F6 1348  14         jeq   task.vdp.panes.exit   ; No, skip update
0047               
0048 76F8 06A0  32         bl    @pane.cmdb.draw       ; Draw CMDB pane
     76FA 7A82 
0049 76FC 04E0  34         clr   @cmdb.dirty           ; Reset CMDB dirty flag
     76FE A318 
0050 7700 1043  14         jmp   task.vdp.panes.exit   ; Exit early
0051                       ;-------------------------------------------------------
0052                       ; Check if frame buffer dirty
0053                       ;-------------------------------------------------------
0054 7702 C120  34 !       mov   @fb.dirty,tmp0        ; Is frame buffer dirty?
     7704 A116 
0055 7706 133E  14         jeq   task.vdp.panes.botline.draw
0056                                                   ; No, skip update
0057               
0058 7708 C820  54         mov   @wyx,@fb.yxsave       ; Backup VDP cursor position
     770A 832A 
     770C A114 
0059                       ;------------------------------------------------------
0060                       ; Determine how many rows to copy
0061                       ;------------------------------------------------------
0062 770E 8820  54         c     @edb.lines,@fb.scrrows
     7710 A204 
     7712 A118 
0063 7714 1103  14         jlt   task.vdp.panes.setrows.small
0064 7716 C160  34         mov   @fb.scrrows,tmp1      ; Lines to copy
     7718 A118 
0065 771A 1003  14         jmp   task.vdp.panes.copy.framebuffer
0066                       ;------------------------------------------------------
0067                       ; Less lines in editor buffer as rows in frame buffer
0068                       ;------------------------------------------------------
0069               task.vdp.panes.setrows.small:
0070 771C C160  34         mov   @edb.lines,tmp1       ; Lines to copy
     771E A204 
0071 7720 0585  14         inc   tmp1
0072                       ;------------------------------------------------------
0073                       ; Determine area to copy
0074                       ;------------------------------------------------------
0075               task.vdp.panes.copy.framebuffer:
0076 7722 3960  72         mpy   @fb.colsline,tmp1     ; columns per line * rows on screen
     7724 A10E 
0077                                                   ; 16 bit part is in tmp2!
0078 7726 04C4  14         clr   tmp0                  ; VDP target address (1nd line on screen!)
0079 7728 C160  34         mov   @fb.top.ptr,tmp1      ; RAM Source address
     772A A100 
0080                       ;------------------------------------------------------
0081                       ; Copy memory block
0082                       ;------------------------------------------------------
0083 772C 0286  22         ci    tmp2,0                ; Something to copy?
     772E 0000 
0084 7730 1304  14         jeq   task.vdp.panes.copy.eof
0085                                                   ; No, skip copy
0086               
0087 7732 06A0  32         bl    @xpym2v               ; Copy to VDP
     7734 245E 
0088                                                   ; \ i  tmp0 = VDP target address
0089                                                   ; | i  tmp1 = RAM source address
0090                                                   ; / i  tmp2 = Bytes to copy
0091 7736 04E0  34         clr   @fb.dirty             ; Reset frame buffer dirty flag
     7738 A116 
0092                       ;-------------------------------------------------------
0093                       ; Draw EOF marker at end-of-file
0094                       ;-------------------------------------------------------
0095               task.vdp.panes.copy.eof:
0096 773A 04E0  34         clr   @fb.dirty             ; Reset frame buffer dirty flag
     773C A116 
0097 773E C120  34         mov   @edb.lines,tmp0
     7740 A204 
0098 7742 6120  34         s     @fb.topline,tmp0      ; Y = @edb.lines - @fb.topline
     7744 A104 
0099               
0100 7746 8120  34         c     @fb.scrrows,tmp0      ; Hide if last line on screen
     7748 A118 
0101 774A 121C  14         jle   task.vdp.panes.botline.draw
0102                                                   ; Skip drawing EOF maker
0103                       ;-------------------------------------------------------
0104                       ; Do actual drawing of EOF marker
0105                       ;-------------------------------------------------------
0106               task.vdp.panes.draw_marker:
0107 774C 0A84  56         sla   tmp0,8                ; Move LSB to MSB (Y), X=0
0108 774E C804  38         mov   tmp0,@wyx             ; Set VDP cursor
     7750 832A 
0109               
0110 7752 06A0  32         bl    @putstr
     7754 242C 
0111 7756 330C                   data txt.marker       ; Display *EOF*
0112               
0113 7758 06A0  32         bl    @setx
     775A 26B6 
0114 775C 0005                   data 5                ; Cursor after *EOF* string
0115                       ;-------------------------------------------------------
0116                       ; Clear rest of screen
0117                       ;-------------------------------------------------------
0118               task.vdp.panes.clear_screen:
0119 775E C120  34         mov   @fb.colsline,tmp0     ; tmp0 = Columns per line
     7760 A10E 
0120               
0121 7762 C160  34         mov   @wyx,tmp1             ;
     7764 832A 
0122 7766 0985  56         srl   tmp1,8                ; tmp1 = cursor Y position
0123 7768 0505  16         neg   tmp1                  ; tmp1 = -Y position
0124 776A A160  34         a     @fb.scrrows,tmp1      ; tmp1 = -Y position + fb.scrrows
     776C A118 
0125               
0126 776E 3944  56         mpy   tmp0,tmp1             ; tmp2 = tmp0 * tmp1
0127 7770 0226  22         ai    tmp2, -5              ; Adjust offset (becaise of *EOF* string)
     7772 FFFB 
0128               
0129 7774 06A0  32         bl    @yx2pnt               ; Set VDP address in tmp0
     7776 2408 
0130                                                   ; \ i  @wyx = Cursor position
0131                                                   ; / o  tmp0 = VDP address
0132               
0133 7778 04C5  14         clr   tmp1                  ; Character to write (null!)
0134 777A 06A0  32         bl    @xfilv                ; Fill VDP memory
     777C 22A2 
0135                                                   ; \ i  tmp0 = VDP destination
0136                                                   ; | i  tmp1 = byte to write
0137                                                   ; / i  tmp2 = Number of bytes to write
0138               
0139 777E C820  54         mov   @fb.yxsave,@wyx       ; Restore cursor postion
     7780 A114 
     7782 832A 
0140                       ;-------------------------------------------------------
...
0144 7784 06A0  32         bl    @pane.botline.draw    ; Draw status bottom line
     7786 7C32 
0145                       ;------------------------------------------------------
0146                       ; Exit task
0147                       ;------------------------------------------------------
0148               task.vdp.panes.exit:
0149 7788 0460  28         b     @slotok
     778A 2D96 
**** **** ****     > stevie_b1.asm.2389682
...
0012 778C C120  34         mov   @tv.pane.focus,tmp0
     778E A01C 
0013 7790 130A  14         jeq   !                     ; Frame buffer has focus
0014               
0015 7792 0284  22         ci    tmp0,pane.focus.cmdb
     7794 0001 
0016 7796 1304  14         jeq   task.vdp.copy.sat.cmdb
0017                                                   ; Command buffer has focus
0018                       ;------------------------------------------------------
0019                       ; Assert failed. Invalid value
0020                       ;------------------------------------------------------
0021 7798 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     779A FFCE 
0022 779C 06A0  32         bl    @cpu.crash            ; / Halt system.
     779E 2030 
0023                       ;------------------------------------------------------
0024                       ; Command buffer has focus, position cursor
0025                       ;------------------------------------------------------
0026               task.vdp.copy.sat.cmdb:
0027 77A0 C820  54         mov   @cmdb.cursor,@wyx     ; Position cursor in CMDB pane
     77A2 A30A 
     77A4 832A 
0028                       ;------------------------------------------------------
0029                       ; Position cursor
0030                       ;------------------------------------------------------
0031 77A6 E0A0  34 !       soc   @wbit0,config         ; Sprite adjustment on
     77A8 202A 
0032 77AA 06A0  32         bl    @yx2px                ; \ Calculate pixel position
     77AC 26C2 
0033                                                   ; | i  @WYX = Cursor YX
0034                                                   ; / o  tmp0 = Pixel YX
0035 77AE C804  38         mov   tmp0,@ramsat          ; Set cursor YX
     77B0 2F54 
0036               
0037 77B2 06A0  32         bl    @cpym2v               ; Copy sprite SAT to VDP
     77B4 2458 
0038 77B6 2180                   data sprsat,ramsat,4  ; \ i  tmp0 = VDP destination
     77B8 2F54 
     77BA 0004 
...
0045 77BC 0460  28         b     @slotok               ; Exit task
     77BE 2D96 
**** **** ****     > stevie_b1.asm.2389682
...
0012 77C0 0560  34         inv   @fb.curtoggle          ; Flip cursor shape flag
     77C2 A112 
0013 77C4 1303  14         jeq   task.vdp.cursor.visible
0014 77C6 04E0  34         clr   @ramsat+2              ; Hide cursor
     77C8 2F56 
0015 77CA 1015  14         jmp   task.vdp.cursor.copy.sat
0016                                                    ; Update VDP SAT and exit task
0017               task.vdp.cursor.visible:
0018 77CC C120  34         mov   @edb.insmode,tmp0      ; Get Editor buffer insert mode
     77CE A20A 
0019 77D0 130B  14         jeq   task.vdp.cursor.visible.overwrite_mode
0020                       ;------------------------------------------------------
0021                       ; Cursor in insert mode
0022                       ;------------------------------------------------------
0023               task.vdp.cursor.visible.insert_mode:
0024 77D2 C120  34         mov   @tv.pane.focus,tmp0    ; Get pane with focus
     77D4 A01C 
0025 77D6 1303  14         jeq   task.vdp.cursor.visible.insert_mode.fb
0026                                                    ; Framebuffer has focus
0027 77D8 0284  22         ci    tmp0,pane.focus.cmdb
     77DA 0001 
0028 77DC 1302  14         jeq   task.vdp.cursor.visible.insert_mode.cmdb
0029                       ;------------------------------------------------------
0030                       ; Editor cursor (insert mode)
0031                       ;------------------------------------------------------
0032               task.vdp.cursor.visible.insert_mode.fb:
0033 77DE 04C4  14         clr   tmp0                   ; Cursor FB insert mode
0034 77E0 1005  14         jmp   task.vdp.cursor.visible.cursorshape
0035                       ;------------------------------------------------------
0036                       ; Command buffer cursor (insert mode)
0037                       ;------------------------------------------------------
0038               task.vdp.cursor.visible.insert_mode.cmdb:
0039 77E2 0204  20         li    tmp0,>0100             ; Cursor CMDB insert mode
     77E4 0100 
0040 77E6 1002  14         jmp   task.vdp.cursor.visible.cursorshape
0041                       ;------------------------------------------------------
0042                       ; Cursor in overwrite mode
0043                       ;------------------------------------------------------
0044               task.vdp.cursor.visible.overwrite_mode:
0045 77E8 0204  20         li    tmp0,>0200             ; Cursor overwrite mode
     77EA 0200 
0046                       ;------------------------------------------------------
0047                       ; Set cursor shape
0048                       ;------------------------------------------------------
0049               task.vdp.cursor.visible.cursorshape:
0050 77EC D804  38         movb  tmp0,@tv.curshape      ; Save cursor shape
     77EE A014 
0051 77F0 C820  54         mov   @tv.curshape,@ramsat+2 ; Get cursor shape and color
     77F2 A014 
     77F4 2F56 
0052                       ;------------------------------------------------------
0053                       ; Copy SAT
...
0056 77F6 06A0  32         bl    @cpym2v                ; Copy sprite SAT to VDP
     77F8 2458 
0057 77FA 2180                   data sprsat,ramsat,4   ; \ i  p0 = VDP destination
     77FC 2F54 
     77FE 0004 
...
0062                       ;-------------------------------------------------------
0063 7800 C120  34         mov   @cmdb.visible,tmp0     ; Check if CMDB pane is visible
     7802 A302 
0064 7804 1602  14         jne   task.vdp.cursor.exit   ; Exit, if visible
0065 7806 06A0  32         bl    @pane.botline.draw     ; Draw status bottom line
     7808 7C32 
0066                       ;------------------------------------------------------
0067                       ; Exit
0068                       ;------------------------------------------------------
0069               task.vdp.cursor.exit:
0070 780A 0460  28         b     @slotok                ; Exit task
     780C 2D96 
**** **** ****     > stevie_b1.asm.2389682
0172                       copy  "task.oneshot.asm"    ; Task - One shot
**** **** ****     > task.oneshot.asm
0001               task.oneshot:
0002 780E C120  34         mov   @tv.task.oneshot,tmp0  ; Get pointer to one-shot task
     7810 A01E 
0003 7812 1301  14         jeq   task.oneshot.exit
0004               
0005 7814 0694  24         bl    *tmp0                  ; Execute one-shot task
0006                       ;------------------------------------------------------
0007                       ; Exit
0008                       ;------------------------------------------------------
0009               task.oneshot.exit:
0010 7816 0460  28         b     @slotok                ; Exit task
     7818 2D96 
**** **** ****     > stevie_b1.asm.2389682
0173                       ;-----------------------------------------------------------------------
...
0026 781A 0649  14         dect  stack
0027 781C C64B  30         mov   r11,*stack            ; Save return address
0028 781E 0649  14         dect  stack
0029 7820 C644  30         mov   tmp0,*stack           ; Push tmp0
0030 7822 0649  14         dect  stack
0031 7824 C645  30         mov   tmp1,*stack           ; Push tmp1
0032 7826 0649  14         dect  stack
0033 7828 C646  30         mov   tmp2,*stack           ; Push tmp2
0034 782A 0649  14         dect  stack
0035 782C C647  30         mov   tmp3,*stack           ; Push tmp3
0036                       ;-------------------------------------------------------
0037                       ; Display string
0038                       ;-------------------------------------------------------
0039 782E C820  54         mov   @parm1,@wyx           ; Set cursor
     7830 2F20 
     7832 832A 
0040 7834 C160  34         mov   @parm2,tmp1           ; Get string to display
     7836 2F22 
0041 7838 06A0  32         bl    @xutst0               ; Display string
     783A 242E 
0042                       ;-------------------------------------------------------
0043                       ; Get number of bytes to fill ...
0044                       ;-------------------------------------------------------
0045 783C C120  34         mov   @parm2,tmp0
     783E 2F22 
0046 7840 D114  26         movb  *tmp0,tmp0            ; Get length byte of hint
0047 7842 0984  56         srl   tmp0,8                ; Right justify
0048 7844 C184  18         mov   tmp0,tmp2
0049 7846 C1C4  18         mov   tmp0,tmp3             ; Work copy
0050 7848 0506  16         neg   tmp2
0051 784A 0226  22         ai    tmp2,80               ; Number of bytes to fill
     784C 0050 
0052                       ;-------------------------------------------------------
0053                       ; ... and clear until end of line
0054                       ;-------------------------------------------------------
0055 784E C120  34         mov   @parm1,tmp0           ; \ Restore YX position
     7850 2F20 
0056 7852 A107  18         a     tmp3,tmp0             ; | Adjust X position to end of string
0057 7854 C804  38         mov   tmp0,@wyx             ; / Set cursor
     7856 832A 
0058               
0059 7858 06A0  32         bl    @yx2pnt               ; Get VDP PNT address for current YX pos.
     785A 2408 
0060                                                   ; \ i  @wyx = Cursor position
0061                                                   ; / o  tmp0 = VDP target address
0062               
0063 785C 0205  20         li    tmp1,32               ; Byte to fill
     785E 0020 
0064               
0065 7860 06A0  32         bl    @xfilv                ; Clear line
     7862 22A2 
...
0073 7864 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0074 7866 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0075 7868 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0076 786A C139  30         mov   *stack+,tmp0          ; Pop tmp0
0077 786C C2F9  30         mov   *stack+,r11           ; Pop R11
0078 786E 045B  20         b     *r11                  ; Return to caller
0079               
0080               
0081               
0082               ***************************************************************
...
0098               ********|*****|*********************|**************************
0099               pane.show_hint:
0100 7870 C83B  50         mov   *r11+,@parm1          ; Get parameter 1
     7872 2F20 
0101 7874 C83B  50         mov   *r11+,@parm2          ; Get parameter 2
     7876 2F22 
0102 7878 0649  14         dect  stack
0103 787A C64B  30         mov   r11,*stack            ; Save return address
0104                       ;-------------------------------------------------------
0105                       ; Display pane hint
0106                       ;-------------------------------------------------------
0107 787C 06A0  32         bl    @pane.show_hintx      ; Display pane hint
     787E 781A 
0108                       ;-------------------------------------------------------
0109                       ; Exit
0110                       ;-------------------------------------------------------
0111               pane.show_hint.exit:
0112 7880 C2F9  30         mov   *stack+,r11           ; Pop R11
0113 7882 045B  20         b     *r11                  ; Return to caller
0114               
0115               
0116               
0117               ***************************************************************
...
0133 7884 0649  14         dect  stack
0134 7886 C64B  30         mov   r11,*stack            ; Save return address
0135                       ;-------------------------------------------------------
0136                       ; Hide cursor
0137                       ;-------------------------------------------------------
0138 7888 06A0  32         bl    @filv                 ; Clear sprite SAT in VDP RAM
     788A 229C 
0139 788C 2180                   data sprsat,>00,4     ; \ i  p0 = VDP destination
     788E 0000 
     7890 0004 
0140                                                   ; | i  p1 = Byte to write
0141                                                   ; / i  p2 = Number of bytes to write
0142               
0143 7892 06A0  32         bl    @clslot
     7894 2DF2 
0144 7896 0001                   data 1                ; Terminate task.vdp.copy.sat
0145               
0146 7898 06A0  32         bl    @clslot
     789A 2DF2 
0147 789C 0002                   data 2                ; Terminate task.vdp.copy.sat
0148               
0149                       ;-------------------------------------------------------
0150                       ; Exit
0151                       ;-------------------------------------------------------
0152               pane.cursor.hide.exit:
0153 789E C2F9  30         mov   *stack+,r11           ; Pop R11
0154 78A0 045B  20         b     *r11                  ; Return to caller
0155               
0156               
0157               
0158               ***************************************************************
...
0174 78A2 0649  14         dect  stack
0175 78A4 C64B  30         mov   r11,*stack            ; Save return address
0176                       ;-------------------------------------------------------
0177                       ; Hide cursor
0178                       ;-------------------------------------------------------
0179 78A6 06A0  32         bl    @filv                 ; Clear sprite SAT in VDP RAM
     78A8 229C 
0180 78AA 2180                   data sprsat,>00,4     ; \ i  p0 = VDP destination
     78AC 0000 
     78AE 0004 
0181                                                   ; | i  p1 = Byte to write
0182                                                   ; / i  p2 = Number of bytes to write
0183               
0184 78B0 06A0  32         bl    @mkslot
     78B2 2DD4 
0185 78B4 0102                   data >0102,task.vdp.copy.sat ; Task 1 - Update cursor position
     78B6 778C 
0186 78B8 020F                   data >020f,task.vdp.cursor   ; Task 2 - Toggle cursor shape
     78BA 77C0 
0187 78BC FFFF                   data eol
0188                       ;-------------------------------------------------------
0189                       ; Exit
0190                       ;-------------------------------------------------------
0191               pane.cursor.blink.exit:
0192 78BE C2F9  30         mov   *stack+,r11           ; Pop R11
0193 78C0 045B  20         b     *r11                  ; Return to caller
**** **** ****     > stevie_b1.asm.2389682
...
0022 78C4 C64B  30         mov   r11,*stack            ; Push return address
0023 78C6 0649  14         dect  stack
0024 78C8 C644  30         mov   tmp0,*stack           ; Push tmp0
0025               
0026 78CA C120  34         mov   @tv.colorscheme,tmp0  ; Load color scheme index
     78CC A012 
0027 78CE 0284  22         ci    tmp0,tv.colorscheme.entries - 1
     78D0 0008 
0028                                                   ; Last entry reached?
0029 78D2 1102  14         jlt   !
0030 78D4 04C4  14         clr   tmp0
0031 78D6 1001  14         jmp   pane.action.colorscheme.switch
0032 78D8 0584  14 !       inc   tmp0
0033                       ;-------------------------------------------------------
0034                       ; switch to new color scheme
0035                       ;-------------------------------------------------------
0036               pane.action.colorscheme.switch:
0037 78DA C804  38         mov   tmp0,@tv.colorscheme  ; Save index of color scheme
     78DC A012 
0038 78DE 06A0  32         bl    @pane.action.colorscheme.load
     78E0 794A 
0039                       ;-------------------------------------------------------
0040                       ; Show current color scheme message
0041                       ;-------------------------------------------------------
0042 78E2 C820  54         mov   @wyx,@waux1           ; Save cursor YX position
     78E4 832A 
     78E6 833C 
0043               
0044 78E8 06A0  32         bl    @filv
     78EA 229C 
0045 78EC 1840                   data >1840,>1F,16     ; VDP start address (frame buffer area)
     78EE 001F 
     78F0 0010 
0046               
0047 78F2 06A0  32         bl    @putnum
     78F4 2A24 
0048 78F6 004B                   byte 0,75
0049 78F8 A012                   data tv.colorscheme,rambuf,>3020
     78FA 2F64 
     78FC 3020 
0050               
0051 78FE 06A0  32         bl    @putat
     7900 2450 
0052 7902 0040                   byte 0,64
0053 7904 363E                   data txt.colorscheme  ; Show color scheme message
0054               
0055               
0056 7906 C820  54         mov   @waux1,@wyx           ; Restore cursor YX position
     7908 833C 
     790A 832A 
0057                       ;-------------------------------------------------------
0058                       ; Delay
0059                       ;-------------------------------------------------------
0060 790C 0204  20         li    tmp0,12000
     790E 2EE0 
0061 7910 0604  14 !       dec   tmp0
0062 7912 16FE  14         jne   -!
0063                       ;-------------------------------------------------------
0064                       ; Setup one shot task for removing message
0065                       ;-------------------------------------------------------
0066 7914 0204  20         li    tmp0,pane.action.colorscheme.task.callback
     7916 7928 
0067 7918 C804  38         mov   tmp0,@tv.task.oneshot
     791A A01E 
0068               
0069 791C 06A0  32         bl    @rsslot               ; \ Reset loop counter slot 3
     791E 2E00 
0070 7920 0003                   data 3                ; / for getting consistent delay
0071                       ;-------------------------------------------------------
0072                       ; Exit
0073                       ;-------------------------------------------------------
0074               pane.action.colorscheme.cycle.exit:
0075 7922 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0076 7924 C2F9  30         mov   *stack+,r11           ; Pop R11
0077 7926 045B  20         b     *r11                  ; Return to caller
0078                       ;-------------------------------------------------------
0079                       ; Remove colorscheme message (triggered by oneshot task)
0080                       ;-------------------------------------------------------
0081               pane.action.colorscheme.task.callback:
0082 7928 0649  14         dect  stack
0083 792A C64B  30         mov   r11,*stack            ; Push return address
0084               
0085 792C 06A0  32         bl    @filv
     792E 229C 
0086 7930 003C                   data >003C,>00,20     ; Remove message
     7932 0000 
     7934 0014 
0087               
0088 7936 0720  34         seto  @parm1
     7938 2F20 
0089 793A 06A0  32         bl    @pane.action.colorscheme.load
     793C 794A 
0090                                                   ; Reload current colorscheme
0091                                                   ; \ i  parm1 = Do not turn screen off
0092                                                   ; /
0093               
0094 793E 0720  34         seto  @fb.dirty             ; Trigger frame buffer refresh
     7940 A116 
0095 7942 04E0  34         clr   @tv.task.oneshot      ; Reset oneshot task
     7944 A01E 
0096               
0097 7946 C2F9  30         mov   *stack+,r11           ; Pop R11
0098 7948 045B  20         b     *r11                  ; Return to task
0099               
0100               
0101               
0102               ***************************************************************
...
0119 794A 0649  14         dect  stack
0120 794C C64B  30         mov   r11,*stack            ; Save return address
0121 794E 0649  14         dect  stack
0122 7950 C644  30         mov   tmp0,*stack           ; Push tmp0
0123 7952 0649  14         dect  stack
0124 7954 C645  30         mov   tmp1,*stack           ; Push tmp1
0125 7956 0649  14         dect  stack
0126 7958 C646  30         mov   tmp2,*stack           ; Push tmp2
0127 795A 0649  14         dect  stack
0128 795C C647  30         mov   tmp3,*stack           ; Push tmp3
0129 795E 0649  14         dect  stack
0130 7960 C648  30         mov   tmp4,*stack           ; Push tmp4
0131 7962 0649  14         dect  stack
0132 7964 C660  46         mov   @parm1,*stack         ; Push parm1
     7966 2F20 
0133                       ;-------------------------------------------------------
0134                       ; Turn screen of
0135                       ;-------------------------------------------------------
0136 7968 C120  34         mov   @parm1,tmp0
     796A 2F20 
0137 796C 0284  22         ci    tmp0,>ffff            ; Skip flag set?
     796E FFFF 
0138 7970 1302  14         jeq   !                     ; Yes, so skip screen off
0139 7972 06A0  32         bl    @scroff               ; Turn screen off
     7974 2660 
0140                       ;-------------------------------------------------------
0141                       ; Get framebuffer foreground/background color
0142                       ;-------------------------------------------------------
0143 7976 C120  34 !       mov   @tv.colorscheme,tmp0  ; Get color scheme index
     7978 A012 
0144 797A 0A34  56         sla   tmp0,3                ; Offset into color scheme data table
0145 797C 0224  22         ai    tmp0,tv.colorscheme.table
     797E 314A 
0146                                                   ; Add base for color scheme data table
0147 7980 C1F4  30         mov   *tmp0+,tmp3           ; Get colors ABCD
0148 7982 C807  38         mov   tmp3,@tv.color        ; Save colors ABCD
     7984 A018 
0149                       ;-------------------------------------------------------
0150                       ; Get and save cursor color
0151                       ;-------------------------------------------------------
0152 7986 C214  26         mov   *tmp0,tmp4            ; Get colors EFGH
0153 7988 0248  22         andi  tmp4,>00ff            ; Only keep LSB (GH)
     798A 00FF 
0154 798C C808  38         mov   tmp4,@tv.curcolor     ; Save cursor color
     798E A016 
0155                       ;-------------------------------------------------------
0156                       ; Get CMDB pane foreground/background color
0157                       ;-------------------------------------------------------
0158 7990 C234  30         mov   *tmp0+,tmp4           ; Get colors EFGH again
0159 7992 0248  22         andi  tmp4,>ff00            ; Only keep MSB (EF)
     7994 FF00 
0160 7996 0988  56         srl   tmp4,8                ; MSB to LSB
0161               
0162 7998 C134  30         mov   *tmp0+,tmp0           ; Get colors IJKL
0163 799A 0244  22         andi  tmp0,>ff00            ; Only keep MSB (IJ)
     799C FF00 
0164 799E 0984  56         srl   tmp0,8                ; MSB to LSB
0165 79A0 C804  38         mov   tmp0,@tv.busycolor    ; Save colors IJ
     79A2 A01A 
0166                       ;-------------------------------------------------------
0167                       ; Dump colors to VDP register 7 (text mode)
0168                       ;-------------------------------------------------------
0169 79A4 C147  18         mov   tmp3,tmp1             ; Get work copy
0170 79A6 0985  56         srl   tmp1,8                ; MSB to LSB (frame buffer colors)
0171 79A8 0265  22         ori   tmp1,>0700
     79AA 0700 
0172 79AC C105  18         mov   tmp1,tmp0
0173 79AE 06A0  32         bl    @putvrx               ; Write VDP register
     79B0 2342 
0174                       ;-------------------------------------------------------
0175                       ; Dump colors for frame buffer pane (TAT)
0176                       ;-------------------------------------------------------
0177 79B2 0204  20         li    tmp0,>1800            ; VDP start address (frame buffer area)
     79B4 1800 
0178 79B6 C147  18         mov   tmp3,tmp1             ; Get work copy of colors
0179 79B8 0985  56         srl   tmp1,8                ; MSB to LSB (frame buffer colors)
0180 79BA 0206  20         li    tmp2,29*80            ; Number of bytes to fill
     79BC 0910 
0181 79BE 06A0  32         bl    @xfilv                ; Fill colors
     79C0 22A2 
0182                                                   ; i \  tmp0 = start address
0183                                                   ; i |  tmp1 = byte to fill
0184                                                   ; i /  tmp2 = number of bytes to fill
0185                       ;-------------------------------------------------------
0186                       ; Dump colors for CMDB pane (TAT)
0187                       ;-------------------------------------------------------
0188               pane.action.colorscheme.cmdbpane:
0189 79C2 C120  34         mov   @cmdb.visible,tmp0
     79C4 A302 
0190 79C6 1307  14         jeq   pane.action.colorscheme.errpane
0191                                                   ; Skip if CMDB pane is hidden
0192               
0193 79C8 0204  20         li    tmp0,>1fd0            ; VDP start address (bottom status line)
     79CA 1FD0 
0194 79CC C148  18         mov   tmp4,tmp1             ; Get work copy fg/bg color
0195 79CE 0206  20         li    tmp2,5*80             ; Number of bytes to fill
     79D0 0190 
0196 79D2 06A0  32         bl    @xfilv                ; Fill colors
     79D4 22A2 
0197                                                   ; i \  tmp0 = start address
0198                                                   ; i |  tmp1 = byte to fill
0199                                                   ; i /  tmp2 = number of bytes to fill
0200                       ;-------------------------------------------------------
0201                       ; Dump fixed colors for error line pane (TAT)
0202                       ;-------------------------------------------------------
0203               pane.action.colorscheme.errpane:
0204 79D6 C120  34         mov   @tv.error.visible,tmp0
     79D8 A020 
0205 79DA 1306  14         jeq   pane.action.colorscheme.statusline
0206                                                   ; Skip if error line pane is hidden
0207               
0208 79DC 0205  20         li    tmp1,>00f6            ; White on dark red
     79DE 00F6 
0209 79E0 C805  38         mov   tmp1,@parm1           ; Pass color combination
     79E2 2F20 
0210               
0211 79E4 06A0  32         bl    @pane.action.colorcombo.errline
     79E6 7A16 
0212                                                   ; Load color combination for error line
0213                                                   ; \ i  @parm1 = Color combination
0214                                                   ; /
0215                       ;-------------------------------------------------------
0216                       ; Dump colors for bottom status line pane (TAT)
0217                       ;-------------------------------------------------------
0218               pane.action.colorscheme.statusline:
0219 79E8 C820  54         mov   @tv.color,@parm1      ; Pass color combination
     79EA A018 
     79EC 2F20 
0220               
0221 79EE 06A0  32         bl    @pane.action.colorcombo.botline
     79F0 7A4A 
0222                                                   ; Load color combination for status line
0223                                                   ; \ i  @parm1 = Color combination
0224                                                   ; /
0225                       ;-------------------------------------------------------
0226                       ; Dump cursor FG color to sprite table (SAT)
0227                       ;-------------------------------------------------------
0228               pane.action.colorscheme.cursorcolor:
0229 79F2 C220  34         mov   @tv.curcolor,tmp4     ; Get cursor color
     79F4 A016 
0230 79F6 0A88  56         sla   tmp4,8                ; Move to MSB
0231 79F8 D808  38         movb  tmp4,@ramsat+3        ; Update FG color in sprite table (SAT)
     79FA 2F57 
0232 79FC D808  38         movb  tmp4,@tv.curshape+1   ; Save cursor color
     79FE A015 
0233                       ;-------------------------------------------------------
0234                       ; Exit
0235                       ;-------------------------------------------------------
0236               pane.action.colorscheme.load.exit:
0237 7A00 06A0  32         bl    @scron                ; Turn screen on
     7A02 2668 
0238 7A04 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     7A06 2F20 
0239 7A08 C239  30         mov   *stack+,tmp4          ; Pop tmp4
0240 7A0A C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0241 7A0C C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0242 7A0E C179  30         mov   *stack+,tmp1          ; Pop tmp1
0243 7A10 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0244 7A12 C2F9  30         mov   *stack+,r11           ; Pop R11
0245 7A14 045B  20         b     *r11                  ; Return to caller
0246               
0247               
0248               
0249               ***************************************************************
0250               * pane.action.colorcombo.errline
0251               * Load color scheme for error line
0252               ***************************************************************
0253               * bl  @pane.action.colorcombo.errline
0254               *--------------------------------------------------------------
0255               * INPUT
0256               * @parm1 = Foreground / Background color
0257               *--------------------------------------------------------------
0258               * OUTPUT
0259               * none
0260               *--------------------------------------------------------------
...
0262               * tmp0,tmp1,tmp2
0263               ********|*****|*********************|**************************
0264               pane.action.colorcombo.errline:
0265 7A16 0649  14         dect  stack
0266 7A18 C64B  30         mov   r11,*stack            ; Save return address
0267 7A1A 0649  14         dect  stack
0268 7A1C C644  30         mov   tmp0,*stack           ; Push tmp0
0269 7A1E 0649  14         dect  stack
0270 7A20 C645  30         mov   tmp1,*stack           ; Push tmp1
0271 7A22 0649  14         dect  stack
0272 7A24 C646  30         mov   tmp2,*stack           ; Push tmp2
0273 7A26 0649  14         dect  stack
0274 7A28 C660  46         mov   @parm1,*stack         ; Push parm1
     7A2A 2F20 
0275                       ;-------------------------------------------------------
0276                       ; Load error line colors
0277                       ;-------------------------------------------------------
0278 7A2C C160  34         mov   @parm1,tmp1           ; Get FG/BG color
     7A2E 2F20 
0279               
0280 7A30 0204  20         li    tmp0,>20C0            ; VDP start address (error line)
     7A32 20C0 
0281 7A34 0206  20         li    tmp2,80               ; Number of bytes to fill
     7A36 0050 
0282 7A38 06A0  32         bl    @xfilv                ; Fill colors
     7A3A 22A2 
0283                                                   ; i \  tmp0 = start address
0284                                                   ; i |  tmp1 = byte to fill
0285                                                   ; i /  tmp2 = number of bytes to fill
0286                       ;-------------------------------------------------------
0287                       ; Exit
0288                       ;-------------------------------------------------------
0289               pane.action.colorcombo.errline.exit:
0290 7A3C C839  50         mov   *stack+,@parm1        ; Pop @parm1
     7A3E 2F20 
0291 7A40 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0292 7A42 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0293 7A44 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0294 7A46 C2F9  30         mov   *stack+,r11           ; Pop R11
0295 7A48 045B  20         b     *r11                  ; Return to caller
0296               
0297               
0298               
0299               
...
0301               
0302               ***************************************************************
0303               * pane.action.colorcombo.botline
0304               * Load color combination for error line
0305               ***************************************************************
0306               * bl  @pane.action.colorcombo.botline
0307               *--------------------------------------------------------------
0308               * INPUT
0309               * @parm1 = Foreground / Background color
0310               *--------------------------------------------------------------
0311               * OUTPUT
0312               * none
0313               *--------------------------------------------------------------
...
0315               * tmp0,tmp1,tmp2
0316               ********|*****|*********************|**************************
0317               pane.action.colorcombo.botline:
0318 7A4A 0649  14         dect  stack
0319 7A4C C64B  30         mov   r11,*stack            ; Save return address
0320 7A4E 0649  14         dect  stack
0321 7A50 C644  30         mov   tmp0,*stack           ; Push tmp0
0322 7A52 0649  14         dect  stack
0323 7A54 C645  30         mov   tmp1,*stack           ; Push tmp1
0324 7A56 0649  14         dect  stack
0325 7A58 C646  30         mov   tmp2,*stack           ; Push tmp2
0326 7A5A 0649  14         dect  stack
0327 7A5C C660  46         mov   @parm1,*stack         ; Push parm1
     7A5E 2F20 
0328                       ;-------------------------------------------------------
0329                       ; Dump colors for bottom status line pane (TAT)
0330                       ;-------------------------------------------------------
0331 7A60 0204  20         li    tmp0,>2110            ; VDP start address (bottom status line)
     7A62 2110 
0332 7A64 C160  34         mov   @parm1,tmp1           ; Get color
     7A66 2F20 
0333 7A68 0245  22         andi  tmp1,>00ff            ; Only keep LSB (status line colors)
     7A6A 00FF 
0334 7A6C 0206  20         li    tmp2,80               ; Number of bytes to fill
     7A6E 0050 
0335 7A70 06A0  32         bl    @xfilv                ; Fill colors
     7A72 22A2 
0336                                                   ; i \  tmp0 = start address
0337                                                   ; i |  tmp1 = byte to fill
0338                                                   ; i /  tmp2 = number of bytes to fill
0339                       ;-------------------------------------------------------
0340                       ; Exit
0341                       ;-------------------------------------------------------
0342               pane.action.colorcombo.botline.exit:
0343 7A74 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     7A76 2F20 
0344 7A78 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0345 7A7A C179  30         mov   *stack+,tmp1          ; Pop tmp1
0346 7A7C C139  30         mov   *stack+,tmp0          ; Pop tmp0
0347 7A7E C2F9  30         mov   *stack+,r11           ; Pop R11
0348 7A80 045B  20         b     *r11                  ; Return to caller
**** **** ****     > stevie_b1.asm.2389682
...
0031                       ;------------------------------------------------------
0032 7A92 06A0  32         bl    @hchar
     7A94 2794 
0033 7A96 190F                   byte pane.botrow-4,15,1,65
     7A98 0141 
0034 7A9A FFFF                   data eol
0035               
0036 7A9C C820  54         mov   @cmdb.yxtop,@wyx      ; \
     7A9E A30E 
     7AA0 832A 
0037 7AA2 C160  34         mov   @cmdb.panhead,tmp1    ; | Display pane header
     7AA4 A31C 
0038 7AA6 06A0  32         bl    @xutst0               ; /
     7AA8 242E 
0039               
0040                       ;------------------------------------------------------
0041                       ; Check dialog id
0042                       ;------------------------------------------------------
0043 7AAA 04E0  34         clr   @waux1                ; Default is show prompt
     7AAC 833C 
0044               
0045 7AAE C120  34         mov   @cmdb.dialog,tmp0
     7AB0 A31A 
0046 7AB2 0284  22         ci    tmp0,100              ; \ Hide prompt and no keyboard
     7AB4 0064 
0047 7AB6 120C  14         jle   pane.cmdb.draw.clear  ; | buffer input if dialog ID > 100
0048 7AB8 0720  34         seto  @waux1                ; /
     7ABA 833C 
0049                       ;------------------------------------------------------
0050                       ; Show warning message if in "Unsaved changes" dialog
0051                       ;------------------------------------------------------
0052 7ABC 0284  22         ci    tmp0,id.dialog.unsaved
     7ABE 0065 
0053 7AC0 1607  14         jne   pane.cmdb.draw.clear  ; Display normal prompt
0054               
0055 7AC2 06A0  32         bl    @putat                ; \ Show warning message
     7AC4 2450 
0056 7AC6 1A00                   byte pane.botrow-3,0  ; |
0057 7AC8 3532                   data txt.warn.unsaved ; /
0058               
0059 7ACA C820  54         mov   @txt.warn.unsaved,@cmdb.cmdlen
     7ACC 3532 
     7ACE A324 
0060                       ;------------------------------------------------------
...
0064 7AD0 C120  34         mov   @cmdb.cmdlen,tmp0     ; \
     7AD2 A324 
0065 7AD4 0984  56         srl   tmp0,8                ; | Set cursor after command prompt
0066 7AD6 A120  34         a     @cmdb.yxprompt,tmp0   ; |
     7AD8 A310 
0067 7ADA C804  38         mov   tmp0,@wyx             ; /
     7ADC 832A 
0068               
0069 7ADE 06A0  32         bl    @yx2pnt               ; Get VDP PNT address for current YX pos.
     7AE0 2408 
0070                                                   ; \ i  @wyx = Cursor position
0071                                                   ; / o  tmp0 = VDP target address
0072               
0073 7AE2 0205  20         li    tmp1,32
     7AE4 0020 
0074               
0075 7AE6 C1A0  34         mov   @cmdb.cmdlen,tmp2     ; \
     7AE8 A324 
0076 7AEA 0986  56         srl   tmp2,8                ; | Determine number of bytes to fill.
0077 7AEC 0506  16         neg   tmp2                  ; | Based on command & prompt length
0078 7AEE 0226  22         ai    tmp2,2*80 - 1         ; /
     7AF0 009F 
0079               
0080 7AF2 06A0  32         bl    @xfilv                ; \ Copy CPU memory to VDP memory
     7AF4 22A2 
...
0088 7AF6 0204  20         li    tmp0,pane.botrow - 1  ; \
     7AF8 001C 
0089 7AFA 0A84  56         sla   tmp0,8                ; / Y=bottom row - 1, X=0
0090 7AFC C804  38         mov   tmp0,@parm1           ; Set parameter
     7AFE 2F20 
0091 7B00 C820  54         mov   @cmdb.panhint,@parm2  ; Pane hint to display
     7B02 A31E 
     7B04 2F22 
0092               
0093 7B06 06A0  32         bl    @pane.show_hintx      ; Display pane hint
     7B08 781A 
...
0098                       ;------------------------------------------------------
0099 7B0A 0204  20         li    tmp0,pane.botrow      ; \
     7B0C 001D 
0100 7B0E 0A84  56         sla   tmp0,8                ; / Y=bottom row, X=0
0101 7B10 C804  38         mov   tmp0,@parm1           ; Set parameter
     7B12 2F20 
0102 7B14 C820  54         mov   @cmdb.pankeys,@parm2  ; Pane hint to display
     7B16 A320 
     7B18 2F22 
0103               
0104 7B1A 06A0  32         bl    @pane.show_hintx      ; Display pane hint
     7B1C 781A 
...
0109                       ;------------------------------------------------------
0110 7B1E 20A0  38         coc   @wbit10,config
     7B20 2016 
0111 7B22 1305  14         jeq   pane.cmdb.draw.alpha.down
0112                       ;------------------------------------------------------
0113                       ; AlPHA-Lock is up
0114                       ;------------------------------------------------------
0115 7B24 06A0  32         bl    @putat
     7B26 2450 
0116 7B28 1D4F                   byte   pane.botrow,79
0117 7B2A 3368                   data   txt.alpha.up
0118               
0119 7B2C 1004  14         jmp   pane.cmdb.draw.promptcmd
0120                       ;------------------------------------------------------
0121                       ; AlPHA-Lock is down
0122                       ;------------------------------------------------------
0123               pane.cmdb.draw.alpha.down:
0124 7B2E 06A0  32         bl    @putat
     7B30 2450 
0125 7B32 1D4F                   byte   pane.botrow,79
0126 7B34 336A                   data   txt.alpha.down
0127                       ;------------------------------------------------------
0128                       ; Command buffer content
0129                       ;------------------------------------------------------
0130               pane.cmdb.draw.promptcmd:
0131 7B36 C120  34         mov   @waux1,tmp0           ; Flag set?
     7B38 833C 
0132 7B3A 1602  14         jne   pane.cmdb.draw.exit   ; Yes, so exit early
0133 7B3C 06A0  32         bl    @cmdb.refresh         ; Refresh command buffer content
     7B3E 6EE8 
0134                       ;------------------------------------------------------
0135                       ; Exit
0136                       ;------------------------------------------------------
0137               pane.cmdb.draw.exit:
0138 7B40 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0139 7B42 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0140 7B44 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0141 7B46 C2F9  30         mov   *stack+,r11           ; Pop r11
0142 7B48 045B  20         b     *r11                  ; Return
0143               
0144               
0145               ***************************************************************
0146               * pane.cmdb.show
...
0161               ********|*****|*********************|**************************
0162               pane.cmdb.show:
0163 7B4A 0649  14         dect  stack
0164 7B4C C64B  30         mov   r11,*stack            ; Save return address
0165 7B4E 0649  14         dect  stack
0166 7B50 C644  30         mov   tmp0,*stack           ; Push tmp0
0167                       ;------------------------------------------------------
0168                       ; Show command buffer pane
0169                       ;------------------------------------------------------
0170 7B52 C820  54         mov   @wyx,@cmdb.fb.yxsave
     7B54 832A 
     7B56 A304 
0171                                                   ; Save YX position in frame buffer
0172               
0173 7B58 C120  34         mov   @fb.scrrows.max,tmp0
     7B5A A11A 
0174 7B5C 6120  34         s     @cmdb.scrrows,tmp0
     7B5E A306 
0175 7B60 C804  38         mov   tmp0,@fb.scrrows      ; Resize framebuffer
     7B62 A118 
0176               
0177 7B64 0A84  56         sla   tmp0,8                ; LSB to MSB (Y), X=0
0178 7B66 C804  38         mov   tmp0,@cmdb.yxtop      ; Set position of command buffer header line
     7B68 A30E 
0179               
0180 7B6A 0224  22         ai    tmp0,>0100
     7B6C 0100 
0181 7B6E C804  38         mov   tmp0,@cmdb.yxprompt   ; Screen position of prompt in cmdb pane
     7B70 A310 
0182 7B72 0584  14         inc   tmp0
0183 7B74 C804  38         mov   tmp0,@cmdb.cursor     ; Screen position of cursor in cmdb pane
     7B76 A30A 
0184               
0185 7B78 0720  34         seto  @cmdb.visible         ; Show pane
     7B7A A302 
0186 7B7C 0720  34         seto  @cmdb.dirty           ; Set CMDB dirty flag (trigger redraw)
     7B7E A318 
0187               
0188 7B80 0204  20         li    tmp0,pane.focus.cmdb  ; \ CMDB pane has focus
     7B82 0001 
0189 7B84 C804  38         mov   tmp0,@tv.pane.focus   ; /
     7B86 A01C 
0190               
0191 7B88 06A0  32         bl    @pane.errline.hide    ; Hide error pane
     7B8A 7C12 
0192               
0193 7B8C 0720  34         seto  @parm1                ; Do not turn screen off while
     7B8E 2F20 
0194                                                   ; reloading color scheme
0195               
0196 7B90 06A0  32         bl    @pane.action.colorscheme.load
     7B92 794A 
...
0202                       ; Exit
0203                       ;------------------------------------------------------
0204 7B94 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0205 7B96 C2F9  30         mov   *stack+,r11           ; Pop r11
0206 7B98 045B  20         b     *r11                  ; Return to caller
0207               
0208               
0209               
0210               ***************************************************************
...
0227               ********|*****|*********************|**************************
0228               pane.cmdb.hide:
0229 7B9A 0649  14         dect  stack
0230 7B9C C64B  30         mov   r11,*stack            ; Save return address
0231                       ;------------------------------------------------------
0232                       ; Hide command buffer pane
0233                       ;------------------------------------------------------
0234 7B9E C820  54         mov   @fb.scrrows.max,@fb.scrrows
     7BA0 A11A 
     7BA2 A118 
0235                       ;------------------------------------------------------
0236                       ; Adjust frame buffer size if error pane visible
0237                       ;------------------------------------------------------
0238 7BA4 C820  54         mov   @tv.error.visible,@tv.error.visible
     7BA6 A020 
     7BA8 A020 
0239 7BAA 1302  14         jeq   !
0240 7BAC 0620  34         dec   @fb.scrrows
     7BAE A118 
0241                       ;------------------------------------------------------
0242                       ; Clear error/hint & status line
0243                       ;------------------------------------------------------
0244 7BB0 06A0  32 !       bl    @hchar
     7BB2 2794 
0245 7BB4 1C00                   byte pane.botrow-1,0,32,80*2
     7BB6 20A0 
0246 7BB8 FFFF                   data EOL
0247                       ;------------------------------------------------------
0248                       ; Hide command buffer pane (rest)
0249                       ;------------------------------------------------------
0250 7BBA C820  54         mov   @cmdb.fb.yxsave,@wyx  ; Position cursor in framebuffer
     7BBC A304 
     7BBE 832A 
0251 7BC0 04E0  34         clr   @cmdb.visible         ; Hide command buffer pane
     7BC2 A302 
0252 7BC4 0720  34         seto  @fb.dirty             ; Redraw framebuffer
     7BC6 A116 
0253 7BC8 04E0  34         clr   @tv.pane.focus        ; Framebuffer has focus!
     7BCA A01C 
0254                       ;------------------------------------------------------
0255                       ; Reload current color scheme
0256                       ;------------------------------------------------------
0257 7BCC 0720  34         seto  @parm1                ; Do not turn screen off while
     7BCE 2F20 
0258                                                   ; reloading color scheme
0259               
0260 7BD0 06A0  32         bl    @pane.action.colorscheme.load
     7BD2 794A 
...
0265                       ;------------------------------------------------------
0266 7BD4 06A0  32         bl    @pane.cursor.blink
     7BD6 78A2 
0267                       ;------------------------------------------------------
0268                       ; Exit
0269                       ;------------------------------------------------------
0270               pane.cmdb.hide.exit:
0271 7BD8 C2F9  30         mov   *stack+,r11           ; Pop r11
0272 7BDA 045B  20         b     *r11                  ; Return to caller
**** **** ****     > stevie_b1.asm.2389682
...
0027 7BDE C64B  30         mov   r11,*stack            ; Save return address
0028 7BE0 0649  14         dect  stack
0029 7BE2 C644  30         mov   tmp0,*stack           ; Push tmp0
0030 7BE4 0649  14         dect  stack
0031 7BE6 C645  30         mov   tmp1,*stack           ; Push tmp1
0032               
0033 7BE8 0205  20         li    tmp1,>00f6            ; White on dark red
     7BEA 00F6 
0034 7BEC C805  38         mov   tmp1,@parm1
     7BEE 2F20 
0035               
0036 7BF0 06A0  32         bl    @pane.action.colorcombo.errline
     7BF2 7A16 
...
0042                       ;------------------------------------------------------
0043 7BF4 06A0  32         bl    @putat                ; Display error message
     7BF6 2450 
0044 7BF8 1C00                   byte pane.botrow-1,0
0045 7BFA A022                   data tv.error.msg
0046               
0047 7BFC C120  34         mov   @fb.scrrows.max,tmp0
     7BFE A11A 
0048 7C00 0604  14         dec   tmp0
0049 7C02 C804  38         mov   tmp0,@fb.scrrows      ; Decrease size of frame buffer
     7C04 A118 
0050               
0051 7C06 0720  34         seto  @tv.error.visible     ; Error line is visible
     7C08 A020 
0052                       ;------------------------------------------------------
0053                       ; Exit
0054                       ;------------------------------------------------------
0055               pane.errline.show.exit:
0056 7C0A C179  30         mov   *stack+,tmp1          ; Pop tmp1
0057 7C0C C139  30         mov   *stack+,tmp0          ; Pop tmp0
0058 7C0E C2F9  30         mov   *stack+,r11           ; Pop r11
0059 7C10 045B  20         b     *r11                  ; Return to caller
0060               
0061               
0062               
0063               ***************************************************************
...
0081 7C12 0649  14         dect  stack
0082 7C14 C64B  30         mov   r11,*stack            ; Save return address
0083 7C16 0649  14         dect  stack
0084 7C18 C644  30         mov   tmp0,*stack           ; Push tmp0
0085                       ;------------------------------------------------------
0086                       ; Hide command buffer pane
0087                       ;------------------------------------------------------
0088 7C1A 06A0  32 !       bl    @errline.init         ; Clear error line
     7C1C 6F9A 
0089               
0090 7C1E C120  34         mov   @tv.color,tmp0        ; Get colors
     7C20 A018 
0091 7C22 0984  56         srl   tmp0,8                ; Right aligns
0092 7C24 C804  38         mov   tmp0,@parm1           ; set foreground/background color
     7C26 2F20 
0093               
0094 7C28 06A0  32         bl    @pane.action.colorcombo.errline
     7C2A 7A16 
...
0101 7C2C C139  30         mov   *stack+,tmp0          ; Pop tmp0
0102 7C2E C2F9  30         mov   *stack+,r11           ; Pop r11
0103 7C30 045B  20         b     *r11                  ; Return to caller
**** **** ****     > stevie_b1.asm.2389682
...
0021 7C32 0649  14         dect  stack
0022 7C34 C64B  30         mov   r11,*stack            ; Save return address
0023 7C36 0649  14         dect  stack
0024 7C38 C644  30         mov   tmp0,*stack           ; Push tmp0
0025               
0026 7C3A C820  54         mov   @wyx,@fb.yxsave
     7C3C 832A 
     7C3E A114 
0027                       ;------------------------------------------------------
0028                       ; Show separators
0029                       ;------------------------------------------------------
0030 7C40 06A0  32         bl    @hchar
     7C42 2794 
0031 7C44 1D2A                   byte pane.botrow,42,16,1       ; Vertical line 1
     7C46 1001 
0032 7C48 1D32                   byte pane.botrow,50,16,1       ; Vertical line 2
     7C4A 1001 
0033 7C4C 1D47                   byte pane.botrow,71,16,1       ; Vertical line 3
     7C4E 1001 
0034 7C50 FFFF                   data eol
0035                       ;------------------------------------------------------
0036                       ; Show buffer number
0037                       ;------------------------------------------------------
0038               pane.botline.bufnum:
0039 7C52 06A0  32         bl    @putat
     7C54 2450 
0040 7C56 1D00                   byte  pane.botrow,0
0041 7C58 334C                   data  txt.bufnum
0042                       ;------------------------------------------------------
0043                       ; Show current file
0044                       ;------------------------------------------------------
0045               pane.botline.show_file:
0046 7C5A 06A0  32         bl    @at
     7C5C 26A0 
0047 7C5E 1D03                   byte  pane.botrow,3   ; Position cursor
0048 7C60 C160  34         mov   @edb.filename.ptr,tmp1
     7C62 A20E 
0049                                                   ; Get string to display
0050 7C64 06A0  32         bl    @xutst0               ; Display string
     7C66 242E 
0051                       ;------------------------------------------------------
0052                       ; Show text editing mode
0053                       ;------------------------------------------------------
0054               pane.botline.show_mode:
0055 7C68 C120  34         mov   @edb.insmode,tmp0
     7C6A A20A 
0056 7C6C 1605  14         jne   pane.botline.show_mode.insert
0057                       ;------------------------------------------------------
0058                       ; Overwrite mode
0059                       ;------------------------------------------------------
...
0061 7C6E 06A0  32         bl    @putat
     7C70 2450 
0062 7C72 1D2C                   byte  pane.botrow,44
0063 7C74 3318                   data  txt.ovrwrite
0064 7C76 1004  14         jmp   pane.botline.show_changed
0065                       ;------------------------------------------------------
0066                       ; Insert  mode
0067                       ;------------------------------------------------------
0068               pane.botline.show_mode.insert:
0069 7C78 06A0  32         bl    @putat
     7C7A 2450 
0070 7C7C 1D2C                   byte  pane.botrow,44
0071 7C7E 331C                   data  txt.insert
0072                       ;------------------------------------------------------
0073                       ; Show if text was changed in editor buffer
0074                       ;------------------------------------------------------
0075               pane.botline.show_changed:
0076 7C80 C120  34         mov   @edb.dirty,tmp0
     7C82 A206 
0077 7C84 1305  14         jeq   pane.botline.show_linecol
0078                       ;------------------------------------------------------
0079                       ; Show "*"
0080                       ;------------------------------------------------------
0081 7C86 06A0  32         bl    @putat
     7C88 2450 
0082 7C8A 1D30                   byte pane.botrow,48
0083 7C8C 3320                   data txt.star
0084 7C8E 1000  14         jmp   pane.botline.show_linecol
0085                       ;------------------------------------------------------
0086                       ; Show "line,column"
0087                       ;------------------------------------------------------
0088               pane.botline.show_linecol:
0089 7C90 C820  54         mov   @fb.row,@parm1
     7C92 A106 
     7C94 2F20 
0090 7C96 06A0  32         bl    @fb.row2line          ; Row to editor line
     7C98 690C 
0091                                                   ; \ i @fb.topline = Top line in frame buffer
0092                                                   ; | i @parm1      = Row in frame buffer
0093                                                   ; / o @outparm1   = Matching line in EB
0094               
0095 7C9A 05A0  34         inc   @outparm1             ; Add base 1
     7C9C 2F30 
0096                       ;------------------------------------------------------
0097                       ; Show line
0098                       ;------------------------------------------------------
0099 7C9E 06A0  32         bl    @putnum
     7CA0 2A24 
0100 7CA2 1D3B                   byte  pane.botrow,59  ; YX
0101 7CA4 2F30                   data  outparm1,rambuf
     7CA6 2F64 
0102 7CA8 3020                   byte  48              ; ASCII offset
0103                             byte  32              ; Padding character
0104                       ;------------------------------------------------------
0105                       ; Show comma
0106                       ;------------------------------------------------------
0107 7CAA 06A0  32         bl    @putat
     7CAC 2450 
0108 7CAE 1D40                   byte  pane.botrow,64
0109 7CB0 3309                   data  txt.delim
0110                       ;------------------------------------------------------
0111                       ; Show column
0112                       ;------------------------------------------------------
0113 7CB2 06A0  32         bl    @film
     7CB4 2244 
0114 7CB6 2F69                   data rambuf+5,32,12   ; Clear work buffer with space character
     7CB8 0020 
     7CBA 000C 
0115               
0116 7CBC C820  54         mov   @fb.column,@waux1
     7CBE A10C 
     7CC0 833C 
0117 7CC2 05A0  34         inc   @waux1                ; Offset 1
     7CC4 833C 
0118               
0119 7CC6 06A0  32         bl    @mknum                ; Convert unsigned number to string
     7CC8 29A6 
0120 7CCA 833C                   data  waux1,rambuf
     7CCC 2F64 
0121 7CCE 3020                   byte  48              ; ASCII offset
0122                             byte  32              ; Fill character
0123               
0124 7CD0 06A0  32         bl    @trimnum              ; Trim number to the left
     7CD2 29FE 
0125 7CD4 2F64                   data  rambuf,rambuf+5,32
     7CD6 2F69 
     7CD8 0020 
0126               
0127 7CDA 0204  20         li    tmp0,>0600            ; "Fix" number length to clear junk chars
     7CDC 0600 
0128 7CDE D804  38         movb  tmp0,@rambuf+5        ; Set length byte
     7CE0 2F69 
0129               
0130                       ;------------------------------------------------------
0131                       ; Decide if row length is to be shown
0132                       ;------------------------------------------------------
0133 7CE2 C120  34         mov   @fb.column,tmp0       ; \ Base 1 for comparison
     7CE4 A10C 
0134 7CE6 0584  14         inc   tmp0                  ; /
0135 7CE8 8804  38         c     tmp0,@fb.row.length   ; Check if cursor on last column on row
     7CEA A108 
0136 7CEC 1101  14         jlt   pane.botline.show_linecol.linelen
0137 7CEE 102B  14         jmp   pane.botline.show_linecol.colstring
0138                                                   ; Yes, skip showing row length
0139                       ;------------------------------------------------------
0140                       ; Add '/' delimiter and length of line to string
0141                       ;------------------------------------------------------
0142               pane.botline.show_linecol.linelen:
0143 7CF0 C120  34         mov   @fb.column,tmp0       ; \
     7CF2 A10C 
0144 7CF4 0205  20         li    tmp1,rambuf+7         ; | Determine column position for '-' char
     7CF6 2F6B 
0145 7CF8 0284  22         ci    tmp0,9                ; | based on number of digits in cursor X
     7CFA 0009 
0146 7CFC 1101  14         jlt   !                     ; | column.
0147 7CFE 0585  14         inc   tmp1                  ; /
0148               
0149 7D00 0204  20 !       li    tmp0,>2d00            ; \ ASCII 2d '-'
     7D02 2D00 
0150 7D04 DD44  32         movb  tmp0,*tmp1+           ; / Add delimiter to string
0151               
0152 7D06 C805  38         mov   tmp1,@waux1           ; Backup position in ram buffer
     7D08 833C 
0153               
0154 7D0A 06A0  32         bl    @mknum
     7D0C 29A6 
0155 7D0E A108                   data  fb.row.length,rambuf
     7D10 2F64 
0156 7D12 3020                   byte  48              ; ASCII offset
0157                             byte  32              ; Padding character
0158               
0159 7D14 C160  34         mov   @waux1,tmp1           ; Restore position in ram buffer
     7D16 833C 
0160               
0161 7D18 C120  34         mov   @fb.row.length,tmp0   ; \ Get length of line
     7D1A A108 
0162 7D1C 0284  22         ci    tmp0,10               ; /
     7D1E 000A 
0163 7D20 110B  14         jlt   pane.botline.show_line.1digit
0164                       ;------------------------------------------------------
0165                       ; Sanity check
0166                       ;------------------------------------------------------
0167 7D22 0284  22         ci    tmp0,80
     7D24 0050 
0168 7D26 1204  14         jle   pane.botline.show_line.2digits
0169                       ;------------------------------------------------------
0170                       ; Sanity checks failed
0171                       ;------------------------------------------------------
0172 7D28 C80B  38 !       mov   r11,@>ffce            ; \ Save caller address
     7D2A FFCE 
0173 7D2C 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     7D2E 2030 
0174                       ;------------------------------------------------------
0175                       ; Show length of line (2 digits)
0176                       ;------------------------------------------------------
0177               pane.botline.show_line.2digits:
0178 7D30 0204  20         li    tmp0,rambuf+3
     7D32 2F67 
0179 7D34 DD74  42         movb  *tmp0+,*tmp1+         ; 1st digit row length
0180 7D36 1002  14         jmp   pane.botline.show_line.rest
0181                       ;------------------------------------------------------
0182                       ; Show length of line (1 digits)
0183                       ;------------------------------------------------------
0184               pane.botline.show_line.1digit:
0185 7D38 0204  20         li    tmp0,rambuf+4
     7D3A 2F68 
0186               pane.botline.show_line.rest:
0187 7D3C DD74  42         movb  *tmp0+,*tmp1+         ; 1st/Next digit row length
0188 7D3E DD60  48         movb  @rambuf+0,*tmp1+      ; Append a whitespace character
     7D40 2F64 
0189 7D42 DD60  48         movb  @rambuf+0,*tmp1+      ; Append a whitespace character
     7D44 2F64 
0190                       ;------------------------------------------------------
0191                       ; Show column string
0192                       ;------------------------------------------------------
0193               pane.botline.show_linecol.colstring:
0194 7D46 06A0  32         bl    @putat
     7D48 2450 
0195 7D4A 1D41                   byte pane.botrow,65
0196 7D4C 2F69                   data rambuf+5         ; Show string
0197                       ;------------------------------------------------------
0198                       ; Show lines in buffer unless on last line in file
0199                       ;------------------------------------------------------
0200 7D4E C820  54         mov   @fb.row,@parm1
     7D50 A106 
     7D52 2F20 
0201 7D54 06A0  32         bl    @fb.row2line
     7D56 690C 
0202 7D58 8820  54         c     @edb.lines,@outparm1
     7D5A A204 
     7D5C 2F30 
0203 7D5E 1605  14         jne   pane.botline.show_lines_in_buffer
0204               
0205 7D60 06A0  32         bl    @putat
     7D62 2450 
0206 7D64 1D49                   byte pane.botrow,73
0207 7D66 3312                   data txt.bottom
0208               
0209 7D68 1009  14         jmp   pane.botline.exit
0210                       ;------------------------------------------------------
0211                       ; Show lines in buffer
0212                       ;------------------------------------------------------
0213               pane.botline.show_lines_in_buffer:
0214 7D6A C820  54         mov   @edb.lines,@waux1
     7D6C A204 
     7D6E 833C 
0215               
0216 7D70 06A0  32         bl    @putnum
     7D72 2A24 
0217 7D74 1D49                   byte pane.botrow,73   ; YX
0218 7D76 833C                   data waux1,rambuf
     7D78 2F64 
0219 7D7A 3020                   byte 48
0220                             byte 32
0221                       ;------------------------------------------------------
0222                       ; Exit
0223                       ;------------------------------------------------------
0224               pane.botline.exit:
0225 7D7C C820  54         mov   @fb.yxsave,@wyx
     7D7E A114 
     7D80 832A 
0226 7D82 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0227 7D84 C2F9  30         mov   *stack+,r11           ; Pop r11
0228 7D86 045B  20         b     *r11                  ; Return
**** **** ****     > stevie_b1.asm.2389682
0185                       ;-----------------------------------------------------------------------
0186                       ; Dialogs
0187                       ;-----------------------------------------------------------------------
...
0013                       ; Setup dialog
0014                       ;-------------------------------------------------------
0015 7D88 0204  20         li    tmp0,id.dialog.about
     7D8A 0066 
0016 7D8C C804  38         mov   tmp0,@cmdb.dialog     ; Set dialog ID
     7D8E A31A 
0017               
0018 7D90 06A0  32         bl    @dialog.about.content ; display content in modal dialog
     7D92 7DB0 
0019               
0020 7D94 0204  20         li    tmp0,txt.head.about
     7D96 3566 
0021 7D98 C804  38         mov   tmp0,@cmdb.panhead    ; Header for dialog
     7D9A A31C 
0022               
0023 7D9C 0204  20         li    tmp0,txt.hint.about
     7D9E 3574 
0024 7DA0 C804  38         mov   tmp0,@cmdb.panhint    ; Hint in bottom line
     7DA2 A31E 
0025               
0026 7DA4 0204  20         li    tmp0,txt.keys.about
     7DA6 35A2 
0027 7DA8 C804  38         mov   tmp0,@cmdb.pankeys    ; Keylist in status line
     7DAA A320 
0028               
0029 7DAC 0460  28         b     @edkey.action.cmdb.show
     7DAE 67C4 
...
0049 7DB0 0649  14         dect  stack
0050 7DB2 C64B  30         mov   r11,*stack            ; Save return address
0051 7DB4 0649  14         dect  stack
0052 7DB6 C644  30         mov   tmp0,*stack           ; Push tmp0
0053 7DB8 0649  14         dect  stack
0054 7DBA C645  30         mov   tmp1,*stack           ; Push tmp1
0055 7DBC 0649  14         dect  stack
0056 7DBE C646  30         mov   tmp2,*stack           ; Push tmp2
0057               
0058 7DC0 C820  54         mov   @wyx,@fb.yxsave       ; Save cursor
     7DC2 832A 
     7DC4 A114 
0059                       ;-------------------------------------------------------
0060                       ; Clear VDP screen buffer
0061                       ;-------------------------------------------------------
0062 7DC6 06A0  32         bl    @pane.cursor.hide     ; Hide cursor
     7DC8 7884 
0063               
0064 7DCA C160  34         mov   @fb.scrrows,tmp1
     7DCC A118 
0065 7DCE 3960  72         mpy   @fb.colsline,tmp1     ; columns per line * rows on screen
     7DD0 A10E 
0066                                                   ; 16 bit part is in tmp2!
0067               
0068 7DD2 04C4  14         clr   tmp0                  ; VDP target address (1nd row on screen!)
0069 7DD4 0205  20         li    tmp1,32               ; Character to fill
     7DD6 0020 
0070               
0071 7DD8 06A0  32         bl    @xfilv                ; Fill VDP memory
     7DDA 22A2 
...
0077                       ;------------------------------------------------------
0078 7DDC 06A0  32 !       bl    @hchar
     7DDE 2794 
0079 7DE0 0214                   byte 2,20,3,40
     7DE2 0328 
0080 7DE4 0C14                   byte 12,20,3,40
     7DE6 0328 
0081 7DE8 FFFF                   data EOL
0082               
0083 7DEA 06A0  32         bl    @putat
     7DEC 2450 
0084 7DEE 0421                   byte   4,33
0085 7DF0 3192                   data   txt.about.program
0086 7DF2 06A0  32         bl    @putat
     7DF4 2450 
0087 7DF6 0616                   byte   6,22
0088 7DF8 31A0                   data   txt.about.purpose
0089 7DFA 06A0  32         bl    @putat
     7DFC 2450 
0090 7DFE 0719                   byte   7,25
0091 7E00 31C4                   data   txt.about.author
0092 7E02 06A0  32         bl    @putat
     7E04 2450 
0093 7E06 091A                   byte   9,26
0094 7E08 31E2                   data   txt.about.website
0095 7E0A 06A0  32         bl    @putat
     7E0C 2450 
0096 7E0E 0B1D                   byte   11,29
0097 7E10 31FE                   data   txt.about.build
0098               
0099 7E12 06A0  32         bl    @putat
     7E14 2450 
0100 7E16 0E03                   byte   14,3
0101 7E18 3214                   data   txt.about.msg1
0102 7E1A 06A0  32         bl    @putat
     7E1C 2450 
0103 7E1E 0F03                   byte   15,3
0104 7E20 323A                   data   txt.about.msg2
0105 7E22 06A0  32         bl    @putat
     7E24 2450 
0106 7E26 1003                   byte   16,3
0107 7E28 325E                   data   txt.about.msg3
0108 7E2A 06A0  32         bl    @putat
     7E2C 2450 
0109 7E2E 0E32                   byte   14,50
0110 7E30 3278                   data   txt.about.msg4
0111 7E32 06A0  32         bl    @putat
     7E34 2450 
0112 7E36 0F32                   byte   15,50
0113 7E38 3296                   data   txt.about.msg5
0114 7E3A 06A0  32         bl    @putat
     7E3C 2450 
0115 7E3E 1032                   byte   16,50
0116 7E40 32B4                   data   txt.about.msg6
0117               
0118 7E42 06A0  32         bl    @putat
     7E44 2450 
0119 7E46 120A                   byte   18,10
0120 7E48 32D0                   data   txt.about.msg7
0121                       ;------------------------------------------------------
0122                       ; Exit
0123                       ;------------------------------------------------------
0124               _dialog.about.content.exit:
0125 7E4A C820  54         mov   @fb.yxsave,@wyx
     7E4C A114 
     7E4E 832A 
0126 7E50 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0127 7E52 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0128 7E54 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0129 7E56 C2F9  30         mov   *stack+,r11           ; Pop r11
0130 7E58 045B  20         b     *r11                  ; Return
0131               
**** **** ****     > stevie_b1.asm.2389682
...
0029                       ;-------------------------------------------------------
0030 7E5A C120  34         mov   @edb.dirty,tmp0
     7E5C A206 
0031 7E5E 1302  14         jeq   dialog.load.setup
0032 7E60 0460  28         b     @dialog.unsaved       ; Show dialog and exit
     7E62 7ED0 
0033                       ;-------------------------------------------------------
0034                       ; Setup dialog
0035                       ;-------------------------------------------------------
0036               dialog.load.setup:
0037 7E64 0204  20         li    tmp0,id.dialog.load
     7E66 000A 
0038 7E68 C804  38         mov   tmp0,@cmdb.dialog     ; Set dialog ID
     7E6A A31A 
0039               
0040 7E6C 0204  20         li    tmp0,txt.head.load
     7E6E 336E 
0041 7E70 C804  38         mov   tmp0,@cmdb.panhead    ; Header for dialog
     7E72 A31C 
0042               
0043 7E74 0204  20         li    tmp0,txt.hint.load
     7E76 337E 
0044 7E78 C804  38         mov   tmp0,@cmdb.panhint    ; Hint line in dialog
     7E7A A31E 
0045               
0046 7E7C 0760  38         abs   @fh.offsetopcode      ; FastMode is off ?
     7E7E A44E 
0047 7E80 1303  14         jeq   !
0048                       ;-------------------------------------------------------
0049                       ; Show that FastMode is on
0050                       ;-------------------------------------------------------
0051 7E82 0204  20         li    tmp0,txt.keys.load2   ; Highlight FastMode
     7E84 3404 
0052 7E86 1002  14         jmp   dialog.load.keylist
0053                       ;-------------------------------------------------------
0054                       ; Show that FastMode is off
0055                       ;-------------------------------------------------------
0056 7E88 0204  20 !       li    tmp0,txt.keys.load
     7E8A 33CC 
0057                       ;-------------------------------------------------------
0058                       ; Show dialog
0059                       ;-------------------------------------------------------
0060               dialog.load.keylist:
0061 7E8C C804  38         mov   tmp0,@cmdb.pankeys    ; Keylist in status line
     7E8E A320 
0062               
0063 7E90 0460  28         b     @edkey.action.cmdb.show
     7E92 67C4 
...
0029                       ;-------------------------------------------------------
0030 7E94 8820  54         c     @fb.row.dirty,@w$ffff
     7E96 A10A 
     7E98 202C 
0031 7E9A 1604  14         jne   !                     ; Skip crunching if clean
0032 7E9C 06A0  32         bl    @edb.line.pack        ; Copy line to editor buffer
     7E9E 6CA2 
0033 7EA0 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     7EA2 A10A 
0034                       ;-------------------------------------------------------
0035                       ; Setup dialog
0036                       ;-------------------------------------------------------
0037 7EA4 0204  20 !       li    tmp0,id.dialog.save
     7EA6 000B 
0038 7EA8 C804  38         mov   tmp0,@cmdb.dialog     ; Set dialog ID
     7EAA A31A 
0039               
0040 7EAC 0204  20         li    tmp0,txt.head.save
     7EAE 343C 
0041 7EB0 C804  38         mov   tmp0,@cmdb.panhead    ; Header for dialog
     7EB2 A31C 
0042               
0043 7EB4 0204  20         li    tmp0,txt.hint.save
     7EB6 344C 
0044 7EB8 C804  38         mov   tmp0,@cmdb.panhint    ; Hint line in dialog
     7EBA A31E 
0045               
0046 7EBC 0204  20         li    tmp0,txt.keys.save
     7EBE 348C 
0047 7EC0 C804  38         mov   tmp0,@cmdb.pankeys    ; Keylist in status line
     7EC2 A320 
0048               
0049 7EC4 04E0  34         clr   @fh.offsetopcode      ; Data buffer in VDP RAM
     7EC6 A44E 
0050               
0051 7EC8 06A0  32         bl    @pane.cursor.blink    ; Show cursor
     7ECA 78A2 
0052               
0053 7ECC 0460  28         b     @edkey.action.cmdb.show
     7ECE 67C4 
...
0025               ********|*****|*********************|**************************
0026               dialog.unsaved:
0027 7ED0 0204  20         li    tmp0,id.dialog.unsaved
     7ED2 0065 
0028 7ED4 C804  38         mov   tmp0,@cmdb.dialog     ; Set dialog ID
     7ED6 A31A 
0029               
0030 7ED8 0204  20         li    tmp0,txt.head.unsaved
     7EDA 34B6 
0031 7EDC C804  38         mov   tmp0,@cmdb.panhead    ; Header for dialog
     7EDE A31C 
0032               
0033 7EE0 0204  20         li    tmp0,txt.hint.unsaved
     7EE2 34C8 
0034 7EE4 C804  38         mov   tmp0,@cmdb.panhint    ; Hint in bottom line
     7EE6 A31E 
0035               
0036 7EE8 0204  20         li    tmp0,txt.keys.unsaved
     7EEA 3508 
0037 7EEC C804  38         mov   tmp0,@cmdb.pankeys    ; Keylist in status line
     7EEE A320 
0038               
0039 7EF0 06A0  32         bl    @pane.cursor.hide     ; Hide cursor
     7EF2 7884 
0040               
0041 7EF4 0460  28         b     @edkey.action.cmdb.show
     7EF6 67C4 
...
0009                       ; Movement keys
0010                       ;-------------------------------------------------------
0011 7EF8 0D00             data  key.enter, pane.focus.fb, edkey.action.enter
     7EFA 0000 
     7EFC 65F0 
0012 7EFE 0800             data  key.fctn.s, pane.focus.fb, edkey.action.left
     7F00 0000 
     7F02 6172 
0013 7F04 0900             data  key.fctn.d, pane.focus.fb, edkey.action.right
     7F06 0000 
     7F08 6188 
0014 7F0A 0B00             data  key.fctn.e, pane.focus.fb, edkey.action.up
     7F0C 0000 
     7F0E 6288 
0015 7F10 0A00             data  key.fctn.x, pane.focus.fb, edkey.action.down
     7F12 0000 
     7F14 62DA 
0016 7F16 8100             data  key.ctrl.a, pane.focus.fb, edkey.action.home
     7F18 0000 
     7F1A 61A0 
0017 7F1C 8600             data  key.ctrl.f, pane.focus.fb, edkey.action.end
     7F1E 0000 
     7F20 61B8 
0018 7F22 9300             data  key.ctrl.s, pane.focus.fb, edkey.action.pword
     7F24 0000 
     7F26 61D6 
0019 7F28 8400             data  key.ctrl.d, pane.focus.fb, edkey.action.nword
     7F2A 0000 
     7F2C 6228 
0020 7F2E 8500             data  key.ctrl.e, pane.focus.fb, edkey.action.ppage
     7F30 0000 
     7F32 6346 
0021 7F34 9800             data  key.ctrl.x, pane.focus.fb, edkey.action.npage
     7F36 0000 
     7F38 637A 
0022 7F3A 9400             data  key.ctrl.t, pane.focus.fb, edkey.action.top
     7F3C 0000 
     7F3E 63C8 
0023 7F40 8200             data  key.ctrl.b, pane.focus.fb, edkey.action.bot
     7F42 0000 
     7F44 63DE 
0024                       ;-------------------------------------------------------
0025                       ; Modifier keys - Delete
0026                       ;-------------------------------------------------------
0027 7F46 0300             data  key.fctn.1, pane.focus.fb, edkey.action.del_char
     7F48 0000 
     7F4A 6408 
0028 7F4C 0700             data  key.fctn.3, pane.focus.fb, edkey.action.del_line
     7F4E 0000 
     7F50 64BA 
0029 7F52 0200             data  key.fctn.4, pane.focus.fb, edkey.action.del_eol
     7F54 0000 
     7F56 6486 
0030               
0031                       ;-------------------------------------------------------
...
0033                       ;-------------------------------------------------------
0034 7F58 0400             data  key.fctn.2, pane.focus.fb, edkey.action.ins_char.ws
     7F5A 0000 
     7F5C 6532 
0035 7F5E B900             data  key.fctn.dot, pane.focus.fb, edkey.action.ins_onoff
     7F60 0000 
     7F62 6660 
0036 7F64 0E00             data  key.fctn.5, pane.focus.fb, edkey.action.ins_line
     7F66 0000 
     7F68 65AC 
0037                       ;-------------------------------------------------------
0038                       ; Other action keys
0039                       ;-------------------------------------------------------
0040 7F6A 0500             data  key.fctn.plus, pane.focus.fb, edkey.action.quit
     7F6C 0000 
     7F6E 66D4 
0041 7F70 9A00             data  key.ctrl.z, pane.focus.fb, pane.action.colorscheme.cycle
     7F72 0000 
     7F74 78C2 
0042                       ;-------------------------------------------------------
0043                       ; Dialog keys
0044                       ;-------------------------------------------------------
0045 7F76 8000             data  key.ctrl.comma, pane.focus.fb, edkey.action.fb.fname.dec.load
     7F78 0000 
     7F7A 66E6 
0046 7F7C 9B00             data  key.ctrl.dot, pane.focus.fb, edkey.action.fb.fname.inc.load
     7F7E 0000 
     7F80 66F2 
0047 7F82 0100             data  key.fctn.7, pane.focus.fb, edkey.action.about
     7F84 0000 
     7F86 7D88 
0048 7F88 8B00             data  key.ctrl.k, pane.focus.fb, dialog.save
     7F8A 0000 
     7F8C 7E94 
0049 7F8E 8C00             data  key.ctrl.l, pane.focus.fb, dialog.load
     7F90 0000 
     7F92 7E5A 
0050                       ;-------------------------------------------------------
0051                       ; End of list
0052                       ;-------------------------------------------------------
0053 7F94 FFFF             data  EOL                           ; EOL
0054               
0055               
0056               
0057               
...
0064                       ;-------------------------------------------------------
0065 7F96 0E00             data  key.fctn.5, id.dialog.load, edkey.action.cmdb.fastmode.toggle
     7F98 000A 
     7F9A 6852 
0066                       ;-------------------------------------------------------
0067                       ; Dialog specific: Unsaved changes
0068                       ;-------------------------------------------------------
0069 7F9C 0C00             data  key.fctn.6, id.dialog.unsaved, edkey.action.cmdb.proceed
     7F9E 0065 
     7FA0 6828 
0070 7FA2 0D00             data  key.enter, id.dialog.unsaved, dialog.save
     7FA4 0065 
     7FA6 7E94 
0071                       ;-------------------------------------------------------
0072                       ; Dialog specific: About
0073                       ;-------------------------------------------------------
0074 7FA8 0D00             data  key.enter, id.dialog.about, edkey.action.cmdb.close.dialog
     7FAA 0066 
     7FAC 685E 
0075                       ;-------------------------------------------------------
0076                       ; Movement keys
0077                       ;-------------------------------------------------------
0078 7FAE 0800             data  key.fctn.s, pane.focus.cmdb, edkey.action.cmdb.left
     7FB0 0001 
     7FB2 671C 
0079 7FB4 0900             data  key.fctn.d, pane.focus.cmdb, edkey.action.cmdb.right
     7FB6 0001 
     7FB8 672E 
0080 7FBA 8100             data  key.ctrl.a, pane.focus.cmdb, edkey.action.cmdb.home
     7FBC 0001 
     7FBE 6746 
0081 7FC0 8600             data  key.ctrl.f, pane.focus.cmdb, edkey.action.cmdb.end
     7FC2 0001 
     7FC4 675A 
0082                       ;-------------------------------------------------------
0083                       ; Modifier keys
0084                       ;-------------------------------------------------------
0085 7FC6 0700             data  key.fctn.3, pane.focus.cmdb, edkey.action.cmdb.clear
     7FC8 0001 
     7FCA 6772 
0086 7FCC 0D00             data  key.enter, pane.focus.cmdb, edkey.action.cmdb.enter
     7FCE 0001 
     7FD0 67B6 
0087                       ;-------------------------------------------------------
0088                       ; Other action keys
0089                       ;-------------------------------------------------------
0090 7FD2 0F00             data  key.fctn.9, pane.focus.cmdb, edkey.action.cmdb.close.dialog
     7FD4 0001 
     7FD6 685E 
0091 7FD8 0500             data  key.fctn.plus, pane.focus.cmdb, edkey.action.quit
     7FDA 0001 
     7FDC 66D4 
0092 7FDE 9A00             data  key.ctrl.z, pane.focus.cmdb, pane.action.colorscheme.cycle
     7FE0 0001 
     7FE2 78C2 
0093                       ;------------------------------------------------------
0094                       ; End of list
0095                       ;-------------------------------------------------------
0096 7FE4 FFFF             data  EOL                           ; EOL
**** **** ****     > stevie_b1.asm.2389682
0196                                                   ; Data segment - Keyboard actions
0200 7FE6 7FE6                   data $                ; Bank 1 ROM size OK.
0202               
0203               *--------------------------------------------------------------
