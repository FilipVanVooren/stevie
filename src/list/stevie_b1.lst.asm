...
0008               ***************************************************************
0009               * File: stevie_b1.asm               ; Version 211012-8671
0010               *
0011               * Bank 1 "James"
0012               * Editor core
0013               ***************************************************************
...
0260 6217   42             text  'Build-ID  211012-8671'
     6218 7569     
     621A 6C64     
     621C 2D49     
     621E 4420     
...
0074 6090 06A0  32         bl    @cpym2m
     6092 24D0     
0075 6094 344C                   data romsat,ramsat,14 ; Load sprite SAT
     6096 A180     
     6098 000E     
0076               
...
0023 6898 36F6                   data txt.io.nofile
0024               
...
0023 68DC 36F6                   data txt.io.nofile
0024               
...
0071 731A 06A0  32         bl    @cpym2m
     731C 24D0     
0072 731E 3718                   data txt.block.inside,tv.error.msg,53
     7320 A22A     
     7322 0035     
0073               
...
0099 734C 355C                   data txt.block.copy   ; Display "Copying block...."
...
0105 7356 356E                   data txt.block.move   ; Display "Moving block...."
0106                       ;------------------------------------------------------
...
0068 7402 3548                   data txt.block.del    ; Display "Deleting block...."
0069                       ;------------------------------------------------------
...
0033 74DA 3652                   data txt.alpha.down
0034                       ;------------------------------------------------------
...
0048 7672 3750                   data txt.colorscheme  ; Show color palette message
0049               
...
0058 78F6 35C4                   data txt.m1           ; Show M1 marker message
0059               
...
0080 7920 35C8                   data txt.m2           ; Show M2 marker message
0081               
...
0033 79FC 35D4                   data txt.keys.block   ; Show block shortcuts
0034               
...
0042 7A06 35CC                   data txt.keys.default ; Show default shortcuts
0043                       ;------------------------------------------------------
...
0062 7A1E 365A                   data txt.ws1          ; Single white space
0063                       ;------------------------------------------------------
...
0074 7A2C 3526                   data  txt.ovrwrite
...
0082 7A36 352A                   data  txt.insert
0083                       ;------------------------------------------------------
...
0099 7A4C A010                   data  outparm1,rambuf
     7A4E A140     
0100 7A50 30                     byte  48              ; ASCII offset
0101 7A51   20                   byte  32              ; Padding character
0102                       ;------------------------------------------------------
0103                       ; Show comma
0104                       ;------------------------------------------------------
...
0118 7A72 833C                   data  waux1,rambuf
     7A74 A140     
0119 7A76 30                     byte  48              ; ASCII offset
0120 7A77   20                   byte  32              ; Fill character
0121               
...
0153 7AB6 A308                   data  fb.row.length,rambuf
     7AB8 A140     
0154 7ABA 30                     byte  48              ; ASCII offset
0155 7ABB   20                   byte  32              ; Padding character
0156               
...
0205 7B0E 3520                   data txt.bottom
0206               
...
0216 7B1E 833C                   data waux1,rambuf
     7B20 A140     
0217 7B22 30                     byte 48
0218 7B23   20                   byte 32
0219                       ;------------------------------------------------------
0220                       ; Exit
0221                       ;------------------------------------------------------
...
0187      342E     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
