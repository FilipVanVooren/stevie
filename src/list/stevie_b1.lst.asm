...
0008               ***************************************************************
0009               * File: stevie_b1.asm               ; Version 210714-724860
0010               *
0011               * Bank 1 "James"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210714-724860'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0018 3443 ....             text  'Build: 210714-724860 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0023 69BA 38F6                   data txt.io.nofile
0024               
...
0023 69FE 38F6                   data txt.io.nofile
0024               
...
0071 72B2 06A0  32         bl    @cpym2m
     72B4 24DC 
0072 72B6 3918                   data txt.block.inside,tv.error.msg,53
     72B8 A02A 
     72BA 0035 
0073               
...
0054 742E 06A0  32         bl    @putstr
     7430 2420 
0055 7432 394E                   data txt.cmdb.prompt
0056                       ;------------------------------------------------------
0057                       ; Exit
0058                       ;------------------------------------------------------
...
0033 751C 35DC                   data txt.alpha.down
0034                       ;------------------------------------------------------
...
0048 771E 3950                   data txt.colorscheme  ; Show color palette message
0049               
...
0107 7AA2 06A0  32         bl    @putstr
     7AA4 2420 
0108 7AA6 35E2                   data txt.keymarker    ; Show key marker
0109               
...
0160 7AEC 35DC                   data   txt.alpha.down
0161                       ;------------------------------------------------------
...
0041 7B24 35E4                   data txt.ws1          ; Single white space
0042                       ;------------------------------------------------------
...
0034 7C6A 3558                   data txt.keys.block   ; Show block shortcuts
0035               
...
0034 7EFE B900             data  key.fctn.dot, pane.focus.fb, edkey.action.ins_onoff
     7F00 0000 
     7F02 6700 
0035 7F04 0100             data  key.fctn.7, pane.focus.fb, edkey.action.fb.tab.next
     7F06 0000 
     7F08 68BE 
0036 7F0A 0600             data  key.fctn.8, pane.focus.fb, edkey.action.ins_line
     7F0C 0000 
     7F0E 6614 
0037                       ;-------------------------------------------------------
