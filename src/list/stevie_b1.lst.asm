...
0008               ***************************************************************
0009               * File: stevie_b1.asm               ; Version 220122-1637410
0010               *
0011               * Bank 1 "James"
0012               * Editor core
0013               ***************************************************************
...
0061 6011   53             text  'STEVIE 1.2S (24X80)'
     6012 5445     
     6014 5649     
     6016 4520     
     6018 312E     
...
0270 21ED   42             text  'Build-ID  220122-1637410'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0016 7FD2 701A     vec.10  data  edb.line.pack.fb      ;
0017 7FD4 7112     vec.11  data  edb.line.unpack.fb    ;
0018 7FD6 7AD2     vec.12  data  edb.clear.sams        ;
0019 7FD8 2026     vec.13  data  cpu.crash             ;
0020 7FDA 2026     vec.14  data  cpu.crash             ;
0021 7FDC 69D8     vec.15  data  edkey.action.cmdb.show
0022 7FDE 2026     vec.16  data  cpu.crash             ;
0023 7FE0 2026     vec.17  data  cpu.crash             ;
0024 7FE2 2026     vec.18  data  cpu.crash             ;
0025 7FE4 7A3C     vec.19  data  cmdb.cmd.clear        ;
0026 7FE6 6F6E     vec.20  data  fb.refresh            ;
0027 7FE8 7AC0     vec.21  data  fb.vdpdump            ;
...
0033 7FF4 769C     vec.27  data  pane.errline.hide     ;
0034 7FF6 74E0     vec.28  data  pane.cursor.blink     ;
0035 7FF8 74C2     vec.29  data  pane.cursor.hide      ;
0036 7FFA 763A     vec.30  data  pane.errline.show     ;
0037 7FFC 72B6     vec.31  data  pane.action.colorscheme.load
0038 7FFE 74A8     vec.32  data  pane.action.colorscheme.statlines
                   < stevie_b1.asm.28071
...
0182      35CC     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
