...
0008               ***************************************************************
0009               * File: stevie_b1.asm               ; Version 220203-1924450
0010               *
0011               * Bank 1 "James"
0012               * Editor core
0013               ***************************************************************
...
0355               *--------------------------------------------------------------
0356      A900     sp2.stktop        equ  >a900           ; \
0357                                                      ; | The stack grows from high memory
0358                                                      ; | towards low memory.
0359                                                      ; |
0360                                                      ; | Stack leaking is checked in SP2
0361                                                      ; | user hook "edkey.keyscan.hook"
0362                                                      ; /
0363               *--------------------------------------------------------------
0364               * Scratchpad memory work copy         @>ad00-aeff   (256 bytes)
0365               *--------------------------------------------------------------
0366      7E00     cpu.scrpad.src    equ  >7e00           ; \ Dump of OS monitor scratchpad
0367                                                      ; / stored in cartridge ROM bank7.asm
0368               
0369      F000     cpu.scrpad.tgt    equ  >f000           ; \ Fixed memory location used for
0370                                                      ; | scratchpad backup/restore routines.
0371                                                      ; /
0372               
0373      8300     cpu.scrpad1       equ  >8300           ; Stevie primary scratchpad
0374               
0375      AD00     cpu.scrpad2       equ  >ad00           ; Stevie secondary scratchpad, used when
0376                                                      ; calling TI Basic/External programs
0377               
0378               *--------------------------------------------------------------
...
0393               *--------------------------------------------------------------
0394               * Frame buffer & Default devices      @>d000-dfff  (4096 bytes)
0395               *--------------------------------------------------------------
0396      D000     fb.top            equ  >d000           ; Frame buffer (80x30)
0397      0960     fb.size           equ  80*30           ; Frame buffer size
0398      D960     tv.printer.fname  equ  >d960           ; Default printer   (80 char)
0399      D9B0     tv.clip.fname     equ  >d9b0           ; Default clipboard (80 char)
0400               *--------------------------------------------------------------
0401               * Command buffer history              @>e000-efff  (4096 bytes)
0402               *--------------------------------------------------------------
0403      E000     cmdb.top          equ  >e000           ; Top of command history buffer
0404      1000     cmdb.size         equ  4096            ; Command buffer size
0405               *--------------------------------------------------------------
0406               * Heap                                @>f000-ffff  (4096 bytes)
0407               *--------------------------------------------------------------
0408      F000     heap.top          equ  >f000           ; Top of heap
0409               
0410               
0411               *--------------------------------------------------------------
0412               * Stevie specific equates
0413               *--------------------------------------------------------------
0414      0000     fh.fopmode.none           equ  0       ; No file operation in progress
0415      0001     fh.fopmode.readfile       equ  1       ; Read file from disk to memory
0416      0002     fh.fopmode.writefile      equ  2       ; Save file from memory to disk
0417      A028     rom0_kscan_out            equ  keycode1; Where to store value of key pressed
0418               
0419      0050     vdp.fb.toprow.sit         equ  >0050   ; VDP SIT address of 1st Framebuffer row
0420      1850     vdp.fb.toprow.tat         equ  >1850   ; VDP TAT address of 1st Framebuffer row
0421      1DF0     vdp.cmdb.toprow.tat       equ  >1800 + ((pane.botrow - 4) * 80)
0422                                                      ; VDP TAT address of 1st CMDB row
0423      0000     vdp.sit.base              equ  >0000   ; VDP SIT base address
0424      0780     vdp.sit.size              equ  (pane.botrow + 1) * 80
0425                                                      ; VDP SIT size 80 columns, 24/30 rows
...
0270 21ED   42             text  'Build-ID  220203-1924450'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0020 65E4 C1A0  34         mov   @fb.row.length,tmp2   ; Get line length
     65E6 A308     
0021 65E8 133A  14         jeq   edkey.action.ins_char.append
...
0036 6600 C660  46         mov   @parm1,*stack         ; Save character to add
     6602 A006     
0037 6604 06A0  32         bl    @fb.cursor.down       ; Move cursor down 1 line
     6606 6DFC     
0038 6608 06A0  32         bl    @fb.insert.line       ; Insert empty line
     660A 6E9E     
0039 660C C839  50         mov   *stack+,@parm1        ; Restore character to add
     660E A006     
0040 6610 04C6  14         clr   tmp2                  ; Clear line length
0041 6612 1025  14         jmp   edkey.action.ins_char.append
0042                       ;-------------------------------------------------------
0043                       ; Check 3 - EOL
0044                       ;-------------------------------------------------------
0045 6614 8820  54 !       c     @fb.column,@fb.row.length
     6616 A30C     
     6618 A308     
0046 661A 1321  14         jeq   edkey.action.ins_char.append
0047                                                   ; Add character in append mode
0048                       ;-------------------------------------------------------
0049                       ; Check 4 - Insert only until line length reaches 80th column
0050                       ;-------------------------------------------------------
0051 661C C160  34         mov   @fb.row.length,tmp1
     661E A308     
0052 6620 0285  22         ci    tmp1,colrow
     6622 0050     
0053 6624 1101  14         jlt   edkey.action.ins_char.prep
0054 6626 101D  14         jmp   edkey.action.ins_char.exit
0055                       ;-------------------------------------------------------
0056                       ; Calculate number of characters to move
0057                       ;-------------------------------------------------------
0058               edkey.action.ins_char.prep:
0059 6628 C1C6  18         mov   tmp2,tmp3             ; tmp3=line length
0060 662A 61E0  34         s     @fb.column,tmp3
     662C A30C     
0061 662E 0607  14         dec   tmp3                  ; Remove base 1 offset
0062 6630 A107  18         a     tmp3,tmp0             ; tmp0=Pointer to last char in line
0063 6632 C144  18         mov   tmp0,tmp1
0064 6634 0585  14         inc   tmp1                  ; tmp1=tmp0+1
0065 6636 61A0  34         s     @fb.column,tmp2       ; tmp2=amount of characters to move
     6638 A30C     
0066                       ;-------------------------------------------------------
0067                       ; Loop from end of line until current character
0068                       ;-------------------------------------------------------
0069               edkey.action.ins_char.loop:
0070 663A D554  38         movb  *tmp0,*tmp1           ; Move char to the right
0071 663C 0604  14         dec   tmp0
0072 663E 0605  14         dec   tmp1
0073 6640 0606  14         dec   tmp2
0074 6642 16FB  14         jne   edkey.action.ins_char.loop
0075                       ;-------------------------------------------------------
0076                       ; Insert specified character at current position
0077                       ;-------------------------------------------------------
0078 6644 D560  46         movb  @parm1,*tmp1          ; MSB has character to insert
     6646 A006     
0079                       ;-------------------------------------------------------
0080                       ; Save variables and exit
0081                       ;-------------------------------------------------------
0082 6648 0720  34         seto  @fb.row.dirty         ; Current row needs to be crunched/packed
     664A A30A     
0083 664C 0720  34         seto  @fb.dirty             ; Trigger screen refresh
     664E A316     
0084 6650 05A0  34         inc   @fb.column
     6652 A30C     
0085 6654 05A0  34         inc   @wyx
     6656 832A     
0086 6658 05A0  34         inc   @fb.row.length        ; @fb.row.length
     665A A308     
0087 665C 1002  14         jmp   edkey.action.ins_char.exit
0088                       ;-------------------------------------------------------
0089                       ; Add character in append mode
0090                       ;-------------------------------------------------------
0091               edkey.action.ins_char.append:
0092 665E 0460  28         b     @edkey.action.char.overwrite
     6660 673C     
0093                       ;-------------------------------------------------------
0094                       ; Exit
0095                       ;-------------------------------------------------------
0096               edkey.action.ins_char.exit:
0097 6662 0460  28         b     @edkey.keyscan.hook.debounce
     6664 614C     
...
0107 6666 04E0  34         clr   @parm1                ; Insert new line on curren line
     6668 A006     
0108 666A 06A0  32         bl    @fb.insert.line       ; Insert new line
     666C 6E9E     
0109                       ;-------------------------------------------------------
0110                       ; Exit
0111                       ;-------------------------------------------------------
0112               edkey.action.ins_line.exit:
0113 666E 0460  28         b     @edkey.keyscan.hook.debounce
     6670 614C     
...
0121 6672 0720  34         seto  @parm1                ; Insert new line on following line
     6674 A006     
0122 6676 06A0  32         bl    @fb.insert.line       ; Insert new line
     6678 6E9E     
0123                       ;-------------------------------------------------------
0124                       ; Exit
0125                       ;-------------------------------------------------------
0126               edkey.action.ins_line_after.exit:
0127 667A 0460  28         b     @edkey.keyscan.hook.debounce
     667C 614C     
...
0012 6682 8820  54         c     @fb.row.dirty,@w$ffff
     6684 A30A     
     6686 2022     
0013 6688 1606  14         jne   edkey.action.enter.newline
...
0021 6696 C120  34         mov   @edb.insmode,tmp0     ; Insert mode or overwrite mode?
     6698 A50A     
0022 669A 1304  14         jeq   edkey.action.enter.upd_counter
0023                                                   ; Overwrite mode, skip insert
0024               
0025 669C 0720  34         seto  @parm1                ; Insert line on following line
     669E A006     
0026 66A0 06A0  32         bl    @fb.insert.line       ; Insert a new line
     66A2 6E9E     
...
0033 66A4 C120  34         mov   @fb.topline,tmp0
     66A6 A304     
0034 66A8 A120  34         a     @fb.row,tmp0
     66AA A306     
0035 66AC 0584  14         inc   tmp0
0036 66AE 8804  38         c     tmp0,@edb.lines       ; Last line in editor buffer?
     66B0 A504     
0037 66B2 1102  14         jlt   edkey.action.newline  ; No, continue newline
0038 66B4 05A0  34         inc   @edb.lines            ; Total lines++
     66B6 A504     
0039                       ;-------------------------------------------------------
...
0045                       ;-------------------------------------------------------
0046 66B8 C120  34         mov   @fb.scrrows,tmp0
     66BA A31A     
0047 66BC 0604  14         dec   tmp0
0048 66BE 8120  34         c     @fb.row,tmp0
     66C0 A306     
0049 66C2 110C  14         jlt   edkey.action.newline.down
0050                       ;-------------------------------------------------------
0051                       ; Scroll
0052                       ;-------------------------------------------------------
0053 66C4 C120  34         mov   @fb.scrrows,tmp0
     66C6 A31A     
0054 66C8 C820  54         mov   @fb.topline,@parm1
     66CA A304     
     66CC A006     
0055 66CE 05A0  34         inc   @parm1
     66D0 A006     
0056 66D2 06A0  32         bl    @fb.refresh
     66D4 6F80     
0057 66D6 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     66D8 A310     
0058 66DA 1004  14         jmp   edkey.action.newline.rest
0059                       ;-------------------------------------------------------
0060                       ; Move cursor down a row, there are still rows left
0061                       ;-------------------------------------------------------
0062               edkey.action.newline.down:
0063 66DC 05A0  34         inc   @fb.row               ; Row++ in screen buffer
     66DE A306     
0064 66E0 06A0  32         bl    @down                 ; Row++ VDP cursor
     66E2 26E0     
0065                       ;-------------------------------------------------------
0066                       ; Set VDP cursor and save variables
0067                       ;-------------------------------------------------------
0068               edkey.action.newline.rest:
0069 66E4 06A0  32         bl    @fb.get.firstnonblank
     66E6 6F38     
0070 66E8 C120  34         mov   @outparm1,tmp0
     66EA A016     
0071 66EC C804  38         mov   tmp0,@fb.column
     66EE A30C     
0072 66F0 06A0  32         bl    @xsetx                ; Set Column=tmp0 (VDP cursor)
     66F2 26F2     
0073 66F4 06A0  32         bl    @edb.line.getlength2  ; Get length of new row length
     66F6 3588     
0074 66F8 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     66FA 6D76     
0075 66FC 0720  34         seto  @fb.dirty             ; Trigger screen refresh
     66FE A316     
0076                       ;-------------------------------------------------------
0077                       ; Exit
0078                       ;-------------------------------------------------------
0079               edkey.action.newline.exit:
0080 6700 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     6702 614C     
0081               
0082               
0083               
...
0089 6704 0649  14         dect  stack
0090 6706 C64B  30         mov   r11,*stack            ; Save return address
0091               
0092 6708 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     670A A318     
0093 670C 0560  34         inv   @edb.insmode          ; Toggle insert/overwrite mode
     670E A50A     
0094                       ;-------------------------------------------------------
0095                       ; Exit
0096                       ;-------------------------------------------------------
0097               edkey.action.ins_onoff.exit:
0098 6710 C2F9  30         mov   *stack+,r11           ; Pop r11
0099 6712 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     6714 614C     
0100               
0101               
0102               
...
0107 6716 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6718 A318     
0108                       ;-------------------------------------------------------
0109                       ; Asserts
0110                       ;-------------------------------------------------------
0111 671A D105  18         movb  tmp1,tmp0             ; Get keycode
0112 671C 0984  56         srl   tmp0,8                ; MSB to LSB
0113               
0114 671E 0284  22         ci    tmp0,32               ; Keycode < ASCII 32 ?
     6720 0020     
0115 6722 112B  14         jlt   edkey.action.char.exit
0116                                                   ; Yes, skip
0117               
0118 6724 0284  22         ci    tmp0,126              ; Keycode > ASCII 126 ?
     6726 007E     
0119 6728 1528  14         jgt   edkey.action.char.exit
0120                                                   ; Yes, skip
0121                       ;-------------------------------------------------------
0122                       ; Setup
0123                       ;-------------------------------------------------------
0124 672A 0720  34         seto  @edb.dirty            ; Editor buffer dirty (text changed!)
     672C A506     
0125 672E D805  38         movb  tmp1,@parm1           ; Store character for insert
     6730 A006     
0126 6732 C120  34         mov   @edb.insmode,tmp0     ; Insert mode or overwrite mode?
     6734 A50A     
0127 6736 1302  14         jeq   edkey.action.char.overwrite
0128                       ;-------------------------------------------------------
0129                       ; Insert mode
0130                       ;-------------------------------------------------------
0131               edkey.action.char.insert:
0132 6738 0460  28         b     @edkey.action.ins_char
     673A 65D8     
0133                       ;-------------------------------------------------------
0134                       ; Overwrite mode - Write character
0135                       ;-------------------------------------------------------
0136               edkey.action.char.overwrite:
0137 673C 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     673E 6D76     
0138 6740 C120  34         mov   @fb.current,tmp0      ; Get pointer
     6742 A302     
0139               
0140 6744 D520  46         movb  @parm1,*tmp0          ; Store character in editor buffer
     6746 A006     
0141 6748 0720  34         seto  @fb.row.dirty         ; Current row needs to be crunched/packed
     674A A30A     
0142 674C 0720  34         seto  @fb.dirty             ; Trigger screen refresh
     674E A316     
0143                       ;-------------------------------------------------------
0144                       ; Last column on screen reached?
0145                       ;-------------------------------------------------------
0146 6750 C160  34         mov   @fb.column,tmp1       ; \ Columns are counted from 0 to 79.
     6752 A30C     
0147 6754 0285  22         ci    tmp1,colrow - 1       ; / Last column on screen?
     6756 004F     
0148 6758 1105  14         jlt   edkey.action.char.overwrite.incx
0149                                                   ; No, increase X position
0150               
0151 675A 0205  20         li    tmp1,colrow           ; \
     675C 0050     
0152 675E C805  38         mov   tmp1,@fb.row.length   ; / Yes, Set row length and exit.
     6760 A308     
0153 6762 100B  14         jmp   edkey.action.char.exit
0154                       ;-------------------------------------------------------
0155                       ; Increase column
0156                       ;-------------------------------------------------------
0157               edkey.action.char.overwrite.incx:
0158 6764 05A0  34         inc   @fb.column            ; Column++ in screen buffer
     6766 A30C     
0159 6768 05A0  34         inc   @wyx                  ; Column++ VDP cursor
     676A 832A     
0160                       ;-------------------------------------------------------
0161                       ; Update line length in frame buffer
0162                       ;-------------------------------------------------------
0163 676C 8820  54         c     @fb.column,@fb.row.length
     676E A30C     
     6770 A308     
0164                                                   ; column < line length ?
0165 6772 1103  14         jlt   edkey.action.char.exit
0166                                                   ; Yes, don't update row length
0167 6774 C820  54         mov   @fb.column,@fb.row.length
     6776 A30C     
     6778 A308     
0168                                                   ; Set row length
0169                       ;-------------------------------------------------------
...
0173 677A 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     677C 614C     
                   < stevie_b1.asm.14478
...
0008 677E 0649  14         dect  stack
0009 6780 C644  30         mov   tmp0,*stack           ; Push tmp0
0010 6782 0649  14         dect  stack
0011 6784 C660  46         mov   @wyx,*stack           ; Push cursor YX
     6786 832A     
0012                       ;-------------------------------------------------------
0013                       ; Toggle ruler visibility
0014                       ;-------------------------------------------------------
0015 6788 C120  34         mov   @tv.ruler.visible,tmp0
     678A A210     
0016                                                   ; Ruler currently off?
0017 678C 1305  14         jeq   edkey.action.toggle.ruler.on
0018                                                   ; Yes, turn it on
0019                       ;-------------------------------------------------------
0020                       ; Turn ruler off
0021                       ;-------------------------------------------------------
0022               edkey.action.toggle.ruler.off:
0023 678E 0720  34         seto  @fb.dirty             ; Screen refresh necessary
     6790 A316     
0024 6792 04E0  34         clr   @tv.ruler.visible     ; Toggle ruler visibility
     6794 A210     
0025 6796 100C  14         jmp   edkey.action.toggle.ruler.fb
0026                       ;-------------------------------------------------------
0027                       ; Turn ruler on
0028                       ;-------------------------------------------------------
0029               edkey.action.toggle.ruler.on:
0030 6798 C120  34         mov   @fb.scrrows,tmp0      ; \ Check if on last row in
     679A A31A     
0031 679C 0604  14         dec   tmp0                  ; | frame buffer, if yes
0032 679E 8120  34         c     @fb.row,tmp0          ; | silenty exit without any
     67A0 A306     
0033                                                   ; | action, preventing
0034                                                   ; / overflow on bottom row.
0035 67A2 1308  14         jeq   edkey.action.toggle.ruler.exit
0036               
0037 67A4 0720  34         seto  @fb.dirty             ; Screen refresh necessary
     67A6 A316     
0038 67A8 0720  34         seto  @tv.ruler.visible     ; Set ruler visibility
     67AA A210     
0039 67AC 06A0  32         bl    @fb.ruler.init        ; Setup ruler in RAM
     67AE 7AC6     
0040                       ;-------------------------------------------------------
0041                       ; Update framebuffer pane
0042                       ;-------------------------------------------------------
0043               edkey.action.toggle.ruler.fb:
0044 67B0 06A0  32         bl    @pane.cmdb.hide       ; Same actions as when hiding CMDB
     67B2 7A3E     
0045                       ;-------------------------------------------------------
0046                       ; Exit
0047                       ;-------------------------------------------------------
0048               edkey.action.toggle.ruler.exit:
0049 67B4 C839  50         mov   *stack+,@wyx          ; Pop cursor YX
     67B6 832A     
0050 67B8 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0051 67BA 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     67BC 614C     
                   < stevie_b1.asm.14478
...
0010                       ;-------------------------------------------------------
0011 67BE C120  34         mov   @edb.dirty,tmp0
     67C0 A506     
0012 67C2 1302  14         jeq   !
0013 67C4 0460  28         b     @dialog.unsaved       ; Show dialog and exit
     67C6 79AE     
0014                       ;-------------------------------------------------------
0015                       ; Quit Stevie
0016                       ;-------------------------------------------------------
0017 67C8 0460  28 !       b     @tv.quit
     67CA 326E     
0018               
0019               
0020               *---------------------------------------------------------------
...
0024 67CC 8820  54         c     @edb.block.m1,@w$ffff ; Marker M1 unset?
     67CE A50C     
     67D0 2022     
0025 67D2 1302  14         jeq   !
0026 67D4 0460  28         b     @edkey.action.block.copy
     67D6 6840     
0027                                                   ; Copy code block
0028 67D8 0460  28 !       b     @dialog.clipboard     ; Open "Insert from clipboard" dialog
     67DA 79BC     
                   < stevie_b1.asm.14478
...
0017 67DC 0649  14         dect  stack
0018 67DE C644  30         mov   tmp0,*stack           ; Push tmp0
0019                       ;------------------------------------------------------
0020                       ; Adjust filename
0021                       ;------------------------------------------------------
0022 67E0 04E0  34         clr   @parm2                ; Decrease ASCII value of char in suffix
     67E2 A008     
0023               
0024 67E4 0204  20         li    tmp0,edkey.action.fb.fname.dec.load
     67E6 67DC     
0025 67E8 C804  38         mov   tmp0,@cmdb.action.ptr ; Set deferred action to run if proceeding
     67EA A728     
0026                                                   ; in "Unsaved changes" dialog
0027               
0028 67EC 1008  14         jmp   edkey.action.fb.fname.doit
0029               
0030               
0031               edkey.action.fb.fname.inc.load:
0032 67EE 0649  14         dect  stack
0033 67F0 C644  30         mov   tmp0,*stack           ; Push tmp0
0034                       ;------------------------------------------------------
0035                       ; Adjust filename
0036                       ;------------------------------------------------------
0037 67F2 0720  34         seto  @parm2                ; Increase ASCII value of char in suffix
     67F4 A008     
0038               
0039 67F6 0204  20         li    tmp0,edkey.action.fb.fname.inc.load
     67F8 67EE     
0040 67FA C804  38         mov   tmp0,@cmdb.action.ptr ; Set deferred action to run if proceeding
     67FC A728     
...
0047 67FE C120  34         mov   @edb.filename.ptr,tmp0
     6800 A512     
0048 6802 1311  14         jeq   edkey.action.fb.fname.exit
0049                                                   ; Exit early if new file.
0050               
0051 6804 0284  22         ci    tmp0,txt.newfile
     6806 37D6     
0052 6808 130E  14         jeq   edkey.action.fb.fname.exit
0053                                                   ; Exit early if "[New file]"
0054               
0055 680A C804  38         mov   tmp0,@parm1           ; Set filename
     680C A006     
0056                       ;------------------------------------------------------
0057                       ; Show dialog "Unsaved changed" if editor buffer dirty
0058                       ;------------------------------------------------------
0059 680E C120  34         mov   @edb.dirty,tmp0
     6810 A506     
0060 6812 1303  14         jeq   !
0061 6814 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0062 6816 0460  28         b     @dialog.unsaved       ; Show dialog and exit
     6818 79AE     
0063                       ;------------------------------------------------------
0064                       ; Update suffix
0065                       ;------------------------------------------------------
0066 681A 06A0  32 !       bl    @fm.browse.fname.suffix
     681C 7928     
...
0074 681E 06A0  32         bl    @pane.cmdb.hide       ; Hide CMDB pane
     6820 7A3E     
0075               
0076 6822 06A0  32         bl    @fm.loadfile          ; Load DV80 file
     6824 78EA     
...
0085 6826 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0086 6828 0460  28         b    @edkey.action.top      ; Goto 1st line in editor buffer
     682A 63C8     
                   < stevie_b1.asm.14478
...
0008 682C 06A0  32         bl    @edb.block.mark       ; Set M1/M2 marker
     682E 7B10     
0009                       ;-------------------------------------------------------
0010                       ; Exit
0011                       ;-------------------------------------------------------
0012 6830 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     6832 614C     
0013               
0014               
0015               *---------------------------------------------------------------
...
0019 6834 06A0  32         bl    @pane.errline.hide    ; Hide error line if visible
     6836 76BC     
0020 6838 06A0  32         bl    @edb.block.reset      ; Reset block markers M1/M2
     683A 7B38     
0021                       ;-------------------------------------------------------
0022                       ; Exit
0023                       ;-------------------------------------------------------
0024 683C 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     683E 614C     
0025               
0026               
0027               *---------------------------------------------------------------
...
0031 6840 0649  14         dect  stack
0032 6842 C644  30         mov   tmp0,*stack           ; Push tmp0
0033                       ;-------------------------------------------------------
0034                       ; Exit early if nothing to do
0035                       ;-------------------------------------------------------
0036 6844 8820  54         c     @edb.block.m2,@w$ffff ; Marker M2 unset?
     6846 A50E     
     6848 2022     
0037 684A 1315  14         jeq   edkey.action.block.copy.exit
0038                                                   ; Yes, exit early
0039                       ;-------------------------------------------------------
0040                       ; Init
0041                       ;-------------------------------------------------------
0042 684C C120  34         mov   @wyx,tmp0             ; Get cursor position
     684E 832A     
0043 6850 0244  22         andi  tmp0,>ff00            ; Move cursor home (X=00)
     6852 FF00     
0044 6854 C804  38         mov   tmp0,@fb.yxsave       ; Backup cursor position
     6856 A314     
0045                       ;-------------------------------------------------------
0046                       ; Copy
0047                       ;-------------------------------------------------------
0048 6858 06A0  32         bl    @pane.errline.hide    ; Hide error line if visible
     685A 76BC     
0049               
0050 685C 04E0  34         clr   @parm1                ; Set message to "Copying block..."
     685E A006     
0051 6860 06A0  32         bl    @edb.block.copy       ; Copy code block
     6862 7B4C     
0052                                                   ; \ i  @parm1    = Message flag
0053                                                   ; / o  @outparm1 = >ffff if success
0054               
0055 6864 8820  54         c     @outparm1,@w$0000     ; Copy skipped?
     6866 A016     
     6868 2000     
0056 686A 1305  14         jeq   edkey.action.block.copy.exit
0057                                                   ; If yes, exit early
0058               
0059 686C C820  54         mov   @fb.yxsave,@parm1
     686E A314     
     6870 A006     
0060 6872 06A0  32         bl    @fb.restore           ; Restore frame buffer layout
     6874 6FF0     
...
0067 6876 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0068 6878 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     687A 614C     
0069               
0070               
0071               
...
0079                       ;-------------------------------------------------------
0080 687C 8820  54         c     @edb.block.m2,@w$ffff ; Marker M2 unset?
     687E A50E     
     6880 2022     
0081 6882 130F  14         jeq   edkey.action.block.delete.exit
0082                                                   ; Yes, exit early
0083                       ;-------------------------------------------------------
0084                       ; Delete
0085                       ;-------------------------------------------------------
0086 6884 06A0  32         bl    @pane.errline.hide    ; Hide error message if visible
     6886 76BC     
0087               
0088 6888 04E0  34         clr   @parm1                ; Display message "Deleting block...."
     688A A006     
0089 688C 06A0  32         bl    @edb.block.delete     ; Delete code block
     688E 7B42     
...
0094                       ;-------------------------------------------------------
0095 6890 8820  54         c     @outparm1,@w$0000     ; Delete skipped?
     6892 A016     
     6894 2000     
0096 6896 1305  14         jeq   edkey.action.block.delete.exit
0097                                                   ; If yes, exit early
0098               
0099 6898 C820  54         mov   @fb.topline,@parm1
     689A A304     
     689C A006     
0100 689E 0460  28         b     @edkey.goto.fb.toprow ; Position on top row in frame buffer
     68A0 647A     
...
0107 68A2 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     68A4 614C     
0108               
0109               
0110               *---------------------------------------------------------------
...
0116                       ;-------------------------------------------------------
0117 68A6 8820  54         c     @edb.block.m2,@w$ffff ; Marker M2 unset?
     68A8 A50E     
     68AA 2022     
0118 68AC 1313  14         jeq   edkey.action.block.move.exit
0119                                                   ; Yes, exit early
0120                       ;-------------------------------------------------------
0121                       ; Delete
0122                       ;-------------------------------------------------------
0123 68AE 06A0  32         bl    @pane.errline.hide    ; Hide error message if visible
     68B0 76BC     
0124               
0125 68B2 0720  34         seto  @parm1                ; Set message to "Moving block..."
     68B4 A006     
0126 68B6 06A0  32         bl    @edb.block.copy       ; Copy code block
     68B8 7B4C     
0127                                                   ; \ i  @parm1    = Message flag
0128                                                   ; / o  @outparm1 = >ffff if success
0129               
0130 68BA 0720  34         seto  @parm1                ; Don't display delete message
     68BC A006     
0131 68BE 06A0  32         bl    @edb.block.delete     ; Delete code block
     68C0 7B42     
...
0136                       ;-------------------------------------------------------
0137 68C2 8820  54         c     @outparm1,@w$0000     ; Delete skipped?
     68C4 A016     
     68C6 2000     
0138 68C8 13EC  14         jeq   edkey.action.block.delete.exit
0139                                                   ; If yes, exit early
0140               
0141 68CA C820  54         mov   @fb.topline,@parm1
     68CC A304     
     68CE A006     
0142 68D0 0460  28         b     @edkey.goto.fb.toprow ; Position on top row in frame buffer
     68D2 647A     
...
0149 68D4 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     68D6 614C     
0150               
0151               
0152               *---------------------------------------------------------------
...
0156 68D8 8820  54         c     @edb.block.m1,@w$ffff ; Marker M1 unset?
     68DA A50C     
     68DC 2022     
0157 68DE 1307  14         jeq   edkey.action.block.goto.m1.exit
0158                                                   ; Yes, exit early
0159                       ;-------------------------------------------------------
0160                       ; Goto marker M1
0161                       ;-------------------------------------------------------
0162 68E0 C820  54         mov   @edb.block.m1,@parm1
     68E2 A50C     
     68E4 A006     
0163 68E6 0620  34         dec   @parm1                ; Base 0 offset
     68E8 A006     
0164               
0165 68EA 0460  28         b     @edkey.action.goto    ; Goto specified line in editor bufer
     68EC 649A     
...
0172 68EE 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     68F0 614C     
                   < stevie_b1.asm.14478
...
0008 68F2 0649  14         dect  stack
0009 68F4 C64B  30         mov   r11,*stack            ; Save return address
0010 68F6 06A0  32         bl    @fb.tab.next          ; Jump to next tab position on line
     68F8 7AB4     
0011                       ;------------------------------------------------------
0012                       ; Exit
0013                       ;------------------------------------------------------
0014               edkey.action.fb.tab.next.exit:
0015 68FA C2F9  30         mov   *stack+,r11           ; Pop r11
0016 68FC 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     68FE 614C     
                   < stevie_b1.asm.14478
...
0016 6900 0204  20         li    tmp0,clip1
     6902 3100     
0017 6904 100B  14         jmp   !
0018               edkey.action.fb.clip.save.2:
0019 6906 0204  20         li    tmp0,clip2
     6908 3200     
0020 690A 1008  14         jmp   !
0021               edkey.action.fb.clip.save.3:
0022 690C 0204  20         li    tmp0,clip3
     690E 3300     
0023 6910 1005  14         jmp   !
0024               edkey.action.fb.clip.save.4:
0025 6912 0204  20         li    tmp0,clip4
     6914 3400     
0026 6916 1002  14         jmp   !
0027               edkey.action.fb.clip.save.5:
0028 6918 0204  20         li    tmp0,clip5
     691A 3500     
0029                       ;-------------------------------------------------------
0030                       ; Save block to clipboard
0031                       ;-------------------------------------------------------
0032 691C C804  38 !       mov   tmp0,@parm1
     691E A006     
0033 6920 06A0  32         bl    @edb.block.clip       ; Save block to clipboard
     6922 7B2E     
...
0040 6924 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0041               
0042 6926 C820  54         mov   @fb.topline,@parm1    ; Get topline
     6928 A304     
     692A A006     
0043 692C 0460  28         b     @edkey.goto.fb.toprow ; \ Position cursor and exit
     692E 647A     
...
0008 6930 C120  34         mov   @cmdb.column,tmp0
     6932 A712     
0009 6934 1304  14         jeq   !                     ; column=0 ? Skip further processing
0010                       ;-------------------------------------------------------
0011                       ; Update
0012                       ;-------------------------------------------------------
0013 6936 0620  34         dec   @cmdb.column          ; Column-- in command buffer
     6938 A712     
0014 693A 0620  34         dec   @cmdb.cursor          ; Column-- CMDB cursor
     693C A70A     
0015                       ;-------------------------------------------------------
0016                       ; Exit
0017                       ;-------------------------------------------------------
0018 693E 0460  28 !       b     @edkey.keyscan.hook.debounce; Back to editor main
     6940 614C     
0019               
0020               
0021               *---------------------------------------------------------------
...
0025 6942 06A0  32         bl    @cmdb.cmd.getlength
     6944 7A66     
0026 6946 8820  54         c     @cmdb.column,@outparm1
     6948 A712     
     694A A016     
0027 694C 1404  14         jhe   !                     ; column > length line ? Skip processing
0028                       ;-------------------------------------------------------
0029                       ; Update
0030                       ;-------------------------------------------------------
0031 694E 05A0  34         inc   @cmdb.column          ; Column++ in command buffer
     6950 A712     
0032 6952 05A0  34         inc   @cmdb.cursor          ; Column++ CMDB cursor
     6954 A70A     
0033                       ;-------------------------------------------------------
0034                       ; Exit
0035                       ;-------------------------------------------------------
0036 6956 0460  28 !       b     @edkey.keyscan.hook.debounce; Back to editor main
     6958 614C     
0037               
0038               
0039               
...
0044 695A 04C4  14         clr   tmp0
0045 695C C804  38         mov   tmp0,@cmdb.column      ; First column
     695E A712     
0046 6960 0584  14         inc   tmp0
0047 6962 D120  34         movb  @cmdb.cursor,tmp0      ; Get CMDB cursor position
     6964 A70A     
0048 6966 C804  38         mov   tmp0,@cmdb.cursor      ; Reposition CMDB cursor
     6968 A70A     
0049               
0050 696A 0460  28         b     @edkey.keyscan.hook.debounce ; Back to editor main
     696C 614C     
0051               
0052               *---------------------------------------------------------------
...
0056 696E D120  34         movb  @cmdb.cmdlen,tmp0      ; Get length byte of current command
     6970 A72A     
0057 6972 0984  56         srl   tmp0,8                 ; Right justify
0058 6974 C804  38         mov   tmp0,@cmdb.column      ; Save column position
     6976 A712     
0059 6978 0584  14         inc   tmp0                   ; One time adjustment command prompt
0060 697A 0224  22         ai    tmp0,>1a00             ; Y=26
     697C 1A00     
0061 697E C804  38         mov   tmp0,@cmdb.cursor      ; Set cursor position
     6980 A70A     
0062                       ;-------------------------------------------------------
0063                       ; Exit
0064                       ;-------------------------------------------------------
0065 6982 0460  28         b     @edkey.keyscan.hook.debounce ; Back to editor main
     6984 614C     
                   < stevie_b1.asm.14478
...
0024                       ;-------------------------------------------------------
0025 6986 06A0  32         bl    @cmdb.cmd.clear       ; Clear current command
     6988 7A5C     
0026 698A 0720  34         seto  @cmdb.dirty           ; Command buffer dirty (text changed!)
     698C A718     
0027                       ;-------------------------------------------------------
0028                       ; Exit
0029                       ;-------------------------------------------------------
0030               edkey.action.cmdb.clear.exit:
0031 698E 0460  28         b     @edkey.action.cmdb.home
     6990 695A     
...
0057 6992 0649  14         dect  stack
0058 6994 C644  30         mov   tmp0,*stack           ; Push tmp0
0059 6996 0649  14         dect  stack
0060 6998 C645  30         mov   tmp1,*stack           ; Push tmp1
0061                       ;-------------------------------------------------------
0062                       ; Asserts
0063                       ;-------------------------------------------------------
0064 699A C120  34         mov   @keycode1,tmp0        ; Get keycode
     699C A028     
0065 699E 0284  22         ci    tmp0,32               ; Keycode < ASCII 32 ?
     69A0 0020     
0066 69A2 111C  14         jlt   edkey.action.cmdb.char.exit
0067                                                   ; Yes, skip
0068               
0069 69A4 0284  22         ci    tmp0,126              ; Keycode > ASCII 126 ?
     69A6 007E     
0070 69A8 1519  14         jgt   edkey.action.cmdb.char.exit
0071                                                   ; Yes, skip
0072               
0073 69AA 0284  22         ci    tmp0,96               ; ASCII 97 'a'
     69AC 0060     
0074 69AE 1102  14         jlt   !
0075 69B0 0224  22         ai    tmp0,-32              ; Make uppercase
     69B2 FFE0     
0076                       ;-------------------------------------------------------
0077                       ; Add character
0078                       ;-------------------------------------------------------
0079 69B4 C144  18 !       mov   tmp0,tmp1             ; \
0080 69B6 0A85  56         sla   tmp1,8                ; / Move keycode to MSB
0081               
0082 69B8 0720  34         seto  @cmdb.dirty           ; Command buffer dirty (text changed!)
     69BA A718     
0083               
0084 69BC 0204  20         li    tmp0,cmdb.cmd         ; Get beginning of command
     69BE A72B     
0085 69C0 A120  34         a     @cmdb.column,tmp0     ; Add current column to command
     69C2 A712     
0086 69C4 D505  30         movb  tmp1,*tmp0            ; Add character
0087 69C6 05A0  34         inc   @cmdb.column          ; Next column
     69C8 A712     
0088 69CA 05A0  34         inc   @cmdb.cursor          ; Next column cursor
     69CC A70A     
0089               
0090 69CE 06A0  32         bl    @cmdb.cmd.getlength   ; Get length of current command
     69D0 7A66     
...
0094                       ; Addjust length
0095                       ;-------------------------------------------------------
0096 69D2 C120  34         mov   @outparm1,tmp0
     69D4 A016     
0097 69D6 0A84  56         sla   tmp0,8               ; Move to MSB
0098 69D8 D804  38         movb  tmp0,@cmdb.cmdlen    ; Set length-prefix of command line string
     69DA A72A     
0099                       ;-------------------------------------------------------
0100                       ; Exit
0101                       ;-------------------------------------------------------
0102               edkey.action.cmdb.char.exit:
0103 69DC C179  30         mov   *stack+,tmp1          ; Pop tmp1
0104 69DE C139  30         mov   *stack+,tmp0          ; Pop tmp0
0105 69E0 0460  28         b     @edkey.keyscan.hook.debounce
     69E2 614C     
...
0008 69E4 C120  34         mov   @cmdb.visible,tmp0
     69E6 A702     
0009 69E8 1605  14         jne   edkey.action.cmdb.hide
0010                       ;-------------------------------------------------------
0011                       ; Show pane
0012                       ;-------------------------------------------------------
0013               edkey.action.cmdb.show:
0014 69EA 04E0  34         clr   @cmdb.column          ; Column = 0
     69EC A712     
0015 69EE 06A0  32         bl    @pane.cmdb.show       ; Show command buffer pane
     69F0 7A34     
0016 69F2 1002  14         jmp   edkey.action.cmdb.toggle.exit
0017                       ;-------------------------------------------------------
0018                       ; Hide pane
0019                       ;-------------------------------------------------------
0020               edkey.action.cmdb.hide:
0021 69F4 06A0  32         bl    @pane.cmdb.hide       ; Hide command buffer pane
     69F6 7A3E     
0022                       ;-------------------------------------------------------
0023                       ; Exit
0024                       ;-------------------------------------------------------
0025               edkey.action.cmdb.toggle.exit:
0026 69F8 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     69FA 614C     
0027               
0028               
0029               
...
0009                       ; New file
0010                       ;-------------------------------------------------------
0011 69FC 0649  14         dect  stack
0012 69FE C64B  30         mov   r11,*stack            ; Save return address
0013 6A00 0649  14         dect  stack
0014 6A02 C644  30         mov   tmp0,*stack           ; Push tmp0
0015                       ;-------------------------------------------------------
0016                       ; Show dialog "Unsaved changes" if editor buffer dirty
0017                       ;-------------------------------------------------------
0018 6A04 C120  34         mov   @edb.dirty,tmp0       ; Editor dirty?
     6A06 A506     
0019 6A08 1303  14         jeq   !                     ; No, skip "Unsaved changes"
0020               
0021 6A0A 06A0  32         bl    @dialog.unsaved       ; Show dialog
     6A0C 79AE     
0022 6A0E 1004  14         jmp   edkey.action.cmdb.file.new.exit
0023                       ;-------------------------------------------------------
0024                       ; Reset editor
0025                       ;-------------------------------------------------------
0026 6A10 06A0  32 !       bl    @pane.cmdb.hide       ; Hide CMDB pane
     6A12 7A3E     
0027 6A14 06A0  32         bl    @fm.newfile           ; New file in editor
     6A16 794C     
0028                       ;-------------------------------------------------------
0029                       ; Exit
0030                       ;-------------------------------------------------------
0031               edkey.action.cmdb.file.new.exit:
0032 6A18 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0033 6A1A C2F9  30         mov   *stack+,r11           ; Pop R11
0034 6A1C 0460  28         b     @edkey.action.top     ; Goto 1st line in editor buffer
     6A1E 63C8     
                   < stevie_b1.asm.14478
...
0009                       ; Load file
0010                       ;-------------------------------------------------------
0011 6A20 06A0  32         bl    @pane.cmdb.hide       ; Hide CMDB pane
     6A22 7A3E     
0012               
0013 6A24 06A0  32         bl    @cmdb.cmd.getlength   ; Get length of current command
     6A26 7A66     
0014 6A28 C120  34         mov   @outparm1,tmp0        ; Length == 0 ?
     6A2A A016     
0015 6A2C 1607  14         jne   !                     ; No, prepare for load
0016                       ;-------------------------------------------------------
0017                       ; No filename specified
0018                       ;-------------------------------------------------------
0019 6A2E 0204  20         li    tmp0,txt.io.nofile    ; \
     6A30 38E6     
0020 6A32 C804  38         mov   tmp0,@parm1           ; / Error message
     6A34 A006     
0021               
0022 6A36 06A0  32         bl    @error.display        ; Show error message
     6A38 7A20     
0023                                                   ; \ i  @parm1 = Pointer to error message
0024                                                   ; /
0025               
0026 6A3A 1012  14         jmp   edkey.action.cmdb.load.exit
0027                       ;-------------------------------------------------------
0028                       ; Get filename
0029                       ;-------------------------------------------------------
0030 6A3C 0A84  56 !       sla   tmp0,8               ; LSB to MSB
0031 6A3E D804  38         movb  tmp0,@cmdb.cmdlen    ; Set length-prefix of command line string
     6A40 A72A     
0032               
0033 6A42 06A0  32         bl    @cpym2m
     6A44 24EE     
0034 6A46 A72A                   data cmdb.cmdlen,heap.top,80
     6A48 F000     
     6A4A 0050     
...
0038                       ;-------------------------------------------------------
0039 6A4C 0204  20         li    tmp0,heap.top         ; 1st line in heap
     6A4E F000     
0040 6A50 C804  38         mov   tmp0,@parm1
     6A52 A006     
0041                       ;-------------------------------------------------------
0042                       ; Load file
0043                       ;-------------------------------------------------------
0044               edkey.action.cmdb.load.file:
0045 6A54 0204  20         li    tmp0,heap.top         ; 1st line in heap
     6A56 F000     
0046 6A58 C804  38         mov   tmp0,@parm1
     6A5A A006     
0047               
0048 6A5C 06A0  32         bl    @fm.loadfile          ; Load DV80 file
     6A5E 78EA     
...
0055 6A60 0460  28         b    @edkey.action.top      ; Goto 1st line in editor buffer
     6A62 63C8     
                   < stevie_b1.asm.14478
...
0008 6A64 0649  14         dect  stack
0009 6A66 C644  30         mov   tmp0,*stack           ; Push tmp0
0010 6A68 0649  14         dect  stack
0011 6A6A C660  46         mov   @fb.topline,*stack    ; Push line number of fb top row
     6A6C A304     
0012                       ;-------------------------------------------------------
0013                       ; Insert file at current line in editor buffer
0014                       ;-------------------------------------------------------
0015 6A6E 06A0  32         bl    @pane.cmdb.hide       ; Hide CMDB pane
     6A70 7A3E     
0016               
0017 6A72 06A0  32         bl    @cmdb.cmd.getlength   ; Get length of current command
     6A74 7A66     
0018 6A76 C120  34         mov   @outparm1,tmp0        ; Length == 0 ?
     6A78 A016     
0019 6A7A 1607  14         jne   !                     ; No, prepare for load
0020                       ;-------------------------------------------------------
0021                       ; No filename specified
0022                       ;-------------------------------------------------------
0023 6A7C 0204  20         li    tmp0,txt.io.nofile    ; \
     6A7E 38E6     
0024 6A80 C804  38         mov   tmp0,@parm1           ; / Error message
     6A82 A006     
0025               
0026 6A84 06A0  32         bl    @error.display        ; Show error message
     6A86 7A20     
0027                                                   ; \ i  @parm1 = Pointer to error message
0028                                                   ; /
0029               
0030 6A88 1029  14         jmp   edkey.action.cmdb.insert.exit
0031                       ;-------------------------------------------------------
0032                       ; Get filename
0033                       ;-------------------------------------------------------
0034 6A8A 0A84  56 !       sla   tmp0,8               ; LSB to MSB
0035 6A8C D804  38         movb  tmp0,@cmdb.cmdlen    ; Set length-prefix of command line string
     6A8E A72A     
0036               
0037 6A90 06A0  32         bl    @cpym2m
     6A92 24EE     
0038 6A94 A72A                   data cmdb.cmdall,heap.top,80
     6A96 F000     
     6A98 0050     
...
0042                       ;-------------------------------------------------------
0043 6A9A 0204  20         li    tmp0,heap.top         ; 1st line in heap
     6A9C F000     
0044 6A9E C804  38         mov   tmp0,@parm1
     6AA0 A006     
0045                       ;-------------------------------------------------------
...
0050                       ; Get line
0051                       ;-------------------------------------------------------
0052 6AA2 C820  54         mov   @fb.row,@parm1
     6AA4 A306     
     6AA6 A006     
0053 6AA8 06A0  32         bl    @fb.row2line          ; Row to editor line
     6AAA 6D5C     
0054                                                   ; \ i @fb.topline = Top line in frame buffer
0055                                                   ; | i @parm1      = Row in frame buffer
0056                                                   ; / o @outparm1   = Matching line in EB
0057               
0058 6AAC C820  54         mov   @outparm1,@parm2      ; \ Line to insert file at is the editor
     6AAE A016     
     6AB0 A008     
0059 6AB2 05A0  34         inc   @parm2                ; / line where the cursor is at +1
     6AB4 A008     
0060                       ;-------------------------------------------------------
0061                       ; Get device/filename
0062                       ;-------------------------------------------------------
0063 6AB6 0204  20         li    tmp0,heap.top         ; 1st line in heap
     6AB8 F000     
0064 6ABA C804  38         mov   tmp0,@parm1
     6ABC A006     
0065                       ;-------------------------------------------------------
0066                       ; Insert file
0067                       ;-------------------------------------------------------
0068 6ABE 0204  20         li    tmp0,id.file.insertfile
     6AC0 0002     
0069 6AC2 C804  38         mov   tmp0,@parm3           ; Set work mode
     6AC4 A00A     
0070               
0071 6AC6 06A0  32         bl    @fm.insertfile        ; Insert DV80 file
     6AC8 7910     
...
0078                       ;-------------------------------------------------------
0079 6ACA 0720  34         seto  @fb.dirty             ; Refresh frame buffer
     6ACC A316     
0080 6ACE 0720  34         seto  @edb.dirty            ; Editor buffer dirty
     6AD0 A506     
0081               
0082 6AD2 C820  54         mov   @fb.topline,@parm1
     6AD4 A304     
     6AD6 A006     
0083 6AD8 06A0  32         bl    @fb.refresh           ; \ Refresh frame buffer
     6ADA 6F80     
...
0091 6ADC C839  50         mov   *stack+,@parm1        ; Pop top row
     6ADE A006     
0092 6AE0 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0093 6AE2 0460  28         b     @edkey.goto.fb.toprow ; \ Position cursor and exit
     6AE4 647A     
...
0008 6AE6 0649  14         dect  stack
0009 6AE8 C644  30         mov   tmp0,*stack           ; Push tmp0
0010 6AEA 0649  14         dect  stack
0011 6AEC C660  46         mov   @fb.topline,*stack    ; Push line number of fb top row
     6AEE A304     
0012                       ;-------------------------------------------------------
0013                       ; Append file after last line in editor buffer
0014                       ;-------------------------------------------------------
0015 6AF0 06A0  32         bl    @pane.cmdb.hide       ; Hide CMDB pane
     6AF2 7A3E     
0016               
0017 6AF4 06A0  32         bl    @cmdb.cmd.getlength   ; Get length of current command
     6AF6 7A66     
0018 6AF8 C120  34         mov   @outparm1,tmp0        ; Length == 0 ?
     6AFA A016     
0019 6AFC 1607  14         jne   !                     ; No, prepare for load
0020                       ;-------------------------------------------------------
0021                       ; No filename specified
0022                       ;-------------------------------------------------------
0023 6AFE 0204  20         li    tmp0,txt.io.nofile    ; \
     6B00 38E6     
0024 6B02 C804  38         mov   tmp0,@parm1           ; / Error message
     6B04 A006     
0025               
0026 6B06 06A0  32         bl    @error.display        ; Show error message
     6B08 7A20     
0027                                                   ; \ i  @parm1 = Pointer to error message
0028                                                   ; /
0029               
0030 6B0A 1022  14         jmp   edkey.action.cmdb.append.exit
0031                       ;-------------------------------------------------------
0032                       ; Get filename
0033                       ;-------------------------------------------------------
0034 6B0C 0A84  56 !       sla   tmp0,8               ; LSB to MSB
0035 6B0E D804  38         movb  tmp0,@cmdb.cmdlen    ; Set length-prefix of command line string
     6B10 A72A     
0036               
0037 6B12 06A0  32         bl    @cpym2m
     6B14 24EE     
0038 6B16 A72A                   data cmdb.cmdall,heap.top,80
     6B18 F000     
     6B1A 0050     
0039                                                   ; Copy filename from command line to buffer
0040                       ;-------------------------------------------------------
0041                       ; Pass filename as parm1
0042                       ;-------------------------------------------------------
0043 6B1C 0204  20         li    tmp0,heap.top         ; 1st line in heap
     6B1E F000     
0044 6B20 C804  38         mov   tmp0,@parm1
     6B22 A006     
0045                       ;-------------------------------------------------------
0046                       ; Append file
0047                       ;-------------------------------------------------------
0048               edkey.action.cmdb.append.file:
0049 6B24 C820  54         mov   @edb.lines,@parm2     ; \ Append file after last line in
     6B26 A504     
     6B28 A008     
...
0053                       ;-------------------------------------------------------
0054 6B2A 0204  20         li    tmp0,heap.top         ; 1st line in heap
     6B2C F000     
0055 6B2E C804  38         mov   tmp0,@parm1
     6B30 A006     
0056                       ;-------------------------------------------------------
0057                       ; Append file
0058                       ;-------------------------------------------------------
0059 6B32 0204  20         li    tmp0,id.file.appendfile
     6B34 0003     
0060 6B36 C804  38         mov   tmp0,@parm3           ; Set work mode
     6B38 A00A     
0061               
0062 6B3A 06A0  32         bl    @fm.insertfile        ; Insert DV80 file
     6B3C 7910     
...
0069                       ;-------------------------------------------------------
0070 6B3E 0720  34         seto  @fb.dirty             ; Refresh frame buffer
     6B40 A316     
0071 6B42 0720  34         seto  @edb.dirty            ; Editor buffer dirty
     6B44 A506     
0072               
0073 6B46 C820  54         mov   @fb.topline,@parm1
     6B48 A304     
     6B4A A006     
0074 6B4C 06A0  32         bl    @fb.refresh           ; \ Refresh frame buffer
     6B4E 6F80     
...
0082 6B50 C839  50         mov   *stack+,@parm1        ; Pop top row
     6B52 A006     
0083 6B54 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0084 6B56 0460  28         b     @edkey.goto.fb.toprow ; \ Position cursor and exit
     6B58 647A     
...
0008 6B5A 0204  20         li    tmp0,clip1
     6B5C 3100     
0009 6B5E 100C  14         jmp   edkey.action.cmdb.clip
0010               
0011               edkey.action.cmdb.clip.2
0012 6B60 0204  20         li    tmp0,clip2
     6B62 3200     
0013 6B64 1009  14         jmp   edkey.action.cmdb.clip
0014               
0015               edkey.action.cmdb.clip.3
0016 6B66 0204  20         li    tmp0,clip3
     6B68 3300     
0017 6B6A 1006  14         jmp   edkey.action.cmdb.clip
0018               
0019               edkey.action.cmdb.clip.4
0020 6B6C 0204  20         li    tmp0,clip4
     6B6E 3400     
0021 6B70 1003  14         jmp   edkey.action.cmdb.clip
0022               
0023               edkey.action.cmdb.clip.5
0024 6B72 0204  20         li    tmp0,clip5
     6B74 3500     
0025 6B76 1000  14         jmp   edkey.action.cmdb.clip
0026               
0027               
0028               edkey.action.cmdb.clip:
0029 6B78 C804  38         mov   tmp0,@parm1           ; Get clipboard suffix 0-9
     6B7A A006     
0030               
0031 6B7C 06A0  32         bl    @film
     6B7E 224A     
0032 6B80 A72A                   data cmdb.cmdall,>00,80
     6B82 0000     
     6B84 0050     
0033               
0034 6B86 06A0  32         bl    @cpym2m
     6B88 24EE     
0035 6B8A D9B0                   data tv.clip.fname,cmdb.cmdall,80
     6B8C A72A     
     6B8E 0050     
0036                       ;------------------------------------------------------
0037                       ; Append suffix character to clipboard device/filename
0038                       ;------------------------------------------------------
0039 6B90 C120  34         mov   @tv.clip.fname,tmp0
     6B92 D9B0     
0040 6B94 C144  18         mov   tmp0,tmp1
0041 6B96 0984  56         srl   tmp0,8                ; Get string length
0042 6B98 0224  22         ai    tmp0,cmdb.cmdall      ; Add base
     6B9A A72A     
0043 6B9C 0584  14         inc   tmp0                  ; Consider length-prefix byte
0044 6B9E D520  46         movb  @parm1,*tmp0          ; Append suffix
     6BA0 A006     
0045               
0046 6BA2 0460  28         b     @edkey.action.cmdb.insert
     6BA4 6A64     
0047                                                   ; Insert file
                   < stevie_b1.asm.14478
...
0009                       ; Configure
0010                       ;-------------------------------------------------------
0011 6BA6 06A0  32         bl    @pane.cmdb.hide       ; Hide CMDB pane
     6BA8 7A3E     
0012               
0013 6BAA 06A0  32         bl    @cmdb.cmd.getlength   ; Get length of current command
     6BAC 7A66     
0014 6BAE C120  34         mov   @outparm1,tmp0        ; Length == 0 ?
     6BB0 A016     
0015 6BB2 1607  14         jne   !                     ; No, set clipboard device and filename
0016                       ;-------------------------------------------------------
0017                       ; No filename specified
0018                       ;-------------------------------------------------------
0019 6BB4 0204  20         li    tmp0,txt.io.nofile    ; \
     6BB6 38E6     
0020 6BB8 C804  38         mov   tmp0,@parm1           ; / Error message
     6BBA A006     
0021               
0022 6BBC 06A0  32         bl    @error.display        ; Show error message
     6BBE 7A20     
0023                                                   ; \ i  @parm1 = Pointer to error message
0024                                                   ; /
0025               
0026 6BC0 1018  14         jmp   edkey.action.cmdb.clipdev.configure.exit
0027                       ;-------------------------------------------------------
0028                       ; Set clipboard device and filename
0029                       ;-------------------------------------------------------
0030 6BC2 0A84  56 !       sla   tmp0,8               ; LSB to MSB
0031 6BC4 D804  38         movb  tmp0,@cmdb.cmdlen    ; Set length-prefix of command line string
     6BC6 A72A     
0032               
0033 6BC8 06A0  32         bl    @cpym2m
     6BCA 24EE     
0034 6BCC A72A                   data cmdb.cmdall,tv.clip.fname,80
     6BCE D9B0     
     6BD0 0050     
0035                                                   ; Copy filename from command line to buffer
0036               
...
0041 6BD2 06A0  32         bl    @hchar
     6BD4 27E6     
0042 6BD6 0034                   byte 0,52,32,20
     6BD8 2014     
0043 6BDA FFFF                   data EOL              ; Erase any previous message
0044               
0045 6BDC 06A0  32         bl    @putat
     6BDE 2456     
0046 6BE0 0034                   byte 0,52
0047 6BE2 37B4                   data txt.done.clipdev
0048                       ;-------------------------------------------------------
0049                       ; Setup one shot task for removing overlay message
0050                       ;-------------------------------------------------------
0051 6BE4 0204  20         li    tmp0,pane.topline.oneshot.clearmsg
     6BE6 35AC     
0052 6BE8 C804  38         mov   tmp0,@tv.task.oneshot
     6BEA A224     
0053               
0054 6BEC 06A0  32         bl    @rsslot               ; \ Reset loop counter slot 3
     6BEE 2ECC     
0055 6BF0 0003                   data 3                ; / for getting consistent delay
0056                       ;-------------------------------------------------------
0057                       ; Exit
0058                       ;-------------------------------------------------------
0059               edkey.action.cmdb.clipdev.configure.exit:
0060 6BF2 0460  28         b    @edkey.action.top      ; Goto 1st line in editor buffer
     6BF4 63C8     
                   < stevie_b1.asm.14478
...
0008 6BF6 0649  14         dect  stack
0009 6BF8 C644  30         mov   tmp0,*stack           ; Push tmp0
0010 6BFA 0649  14         dect  stack
0011 6BFC C660  46         mov   @fb.topline,*stack    ; Push line number of fb top row
     6BFE A304     
0012                       ;-------------------------------------------------------
0013                       ; Save file
0014                       ;-------------------------------------------------------
0015 6C00 06A0  32         bl    @pane.cmdb.hide       ; Hide CMDB pane
     6C02 7A3E     
0016               
0017 6C04 06A0  32         bl    @cmdb.cmd.getlength   ; Get length of current command
     6C06 7A66     
0018 6C08 C120  34         mov   @outparm1,tmp0        ; Length == 0 ?
     6C0A A016     
0019 6C0C 1607  14         jne   !                     ; No, prepare for save
0020                       ;-------------------------------------------------------
0021                       ; No filename specified
0022                       ;-------------------------------------------------------
0023 6C0E 0204  20         li    tmp0,txt.io.nofile    ; \
     6C10 38E6     
0024 6C12 C804  38         mov   tmp0,@parm1           ; / Error message
     6C14 A006     
0025               
0026 6C16 06A0  32         bl    @error.display        ; Show error message
     6C18 7A20     
0027                                                   ; \ i  @parm1 = Pointer to error message
0028                                                   ; /
0029               
0030 6C1A 1026  14         jmp   edkey.action.cmdb.save.exit
0031                       ;-------------------------------------------------------
0032                       ; Get filename
0033                       ;-------------------------------------------------------
0034 6C1C 0A84  56 !       sla   tmp0,8               ; LSB to MSB
0035 6C1E D804  38         movb  tmp0,@cmdb.cmdlen    ; Set length-prefix of command line string
     6C20 A72A     
0036               
0037 6C22 06A0  32         bl    @cpym2m
     6C24 24EE     
0038 6C26 A72A                   data cmdb.cmdlen,heap.top,80
     6C28 F000     
     6C2A 0050     
0039                                                   ; Copy filename from command line to buffer
0040                       ;-------------------------------------------------------
0041                       ; Pass filename as parm1
0042                       ;-------------------------------------------------------
0043 6C2C 0204  20         li    tmp0,heap.top         ; 1st line in heap
     6C2E F000     
0044 6C30 C804  38         mov   tmp0,@parm1
     6C32 A006     
0045                       ;-------------------------------------------------------
0046                       ; Save all lines in editor buffer?
0047                       ;-------------------------------------------------------
0048 6C34 8820  54         c     @edb.block.m2,@w$ffff ; Marker M2 unset?
     6C36 A50E     
     6C38 2022     
0049 6C3A 130B  14         jeq   edkey.action.cmdb.save.all
0050                                                   ; Yes, so save all lines in editor buffer
0051                       ;-------------------------------------------------------
0052                       ; Only save code block M1-M2
0053                       ;-------------------------------------------------------
0054 6C3C C820  54         mov   @edb.block.m1,@parm2  ; \ First line to save (base 0)
     6C3E A50C     
     6C40 A008     
0055 6C42 0620  34         dec   @parm2                ; /
     6C44 A008     
0056               
0057 6C46 C820  54         mov   @edb.block.m2,@parm3  ; Last line to save (base 0) + 1
     6C48 A50E     
     6C4A A00A     
0058               
0059 6C4C 0204  20         li    tmp0,id.file.saveblock
     6C4E 0005     
0060 6C50 1007  14         jmp   edkey.action.cmdb.save.file
0061                       ;-------------------------------------------------------
0062                       ; Save all lines in editor buffer
0063                       ;-------------------------------------------------------
0064               edkey.action.cmdb.save.all:
0065 6C52 04E0  34         clr   @parm2                ; First line to save
     6C54 A008     
0066 6C56 C820  54         mov   @edb.lines,@parm3     ; Last line to save
     6C58 A504     
     6C5A A00A     
0067               
0068 6C5C 0204  20         li    tmp0,id.file.savefile
     6C5E 0004     
0069                       ;-------------------------------------------------------
0070                       ; Save file
0071                       ;-------------------------------------------------------
0072               edkey.action.cmdb.save.file:
0073 6C60 C804  38         mov   tmp0,@parm4           ; Set work mode
     6C62 A00C     
0074               
0075 6C64 06A0  32         bl    @fm.savefile          ; Save DV80 file
     6C66 793A     
...
0086 6C68 C839  50         mov   *stack+,@parm1        ; Pop top row
     6C6A A006     
0087 6C6C C139  30         mov   *stack+,tmp0          ; Pop tmp0
0088 6C6E 0460  28         b     @edkey.goto.fb.toprow ; \ Position cursor and exit
     6C70 647A     
...
0018 6C84 C120  34         mov   @outparm1,tmp0        ; Length == 0 ?
     6C86 A016     
0019 6C88 1607  14         jne   !                     ; No, prepare for print
0020                       ;-------------------------------------------------------
0021                       ; No filename specified
0022                       ;-------------------------------------------------------
...
0028                                                   ; /
0029               
0030 6C96 1026  14         jmp   edkey.action.cmdb.print.exit
0031                       ;-------------------------------------------------------
0032                       ; Get filename
0033                       ;-------------------------------------------------------
...
0048 6CB0 8820  54         c     @edb.block.m2,@w$ffff ; Marker M2 unset?
     6CB2 A50E     
     6CB4 2022     
0049 6CB6 130B  14         jeq   edkey.action.cmdb.print.all
...
0057 6CC2 C820  54         mov   @edb.block.m2,@parm3  ; Last line to save (base 0) + 1
     ...
     6CC6 A00A     
0058               
0059 6CC8 0204  20         li    tmp0,id.file.printblock
     6CCA 0008     
0060 6CCC 1007  14         jmp   edkey.action.cmdb.print.file
0061                       ;-------------------------------------------------------
...
0066 6CD2 C820  54         mov   @edb.lines,@parm3     ; Last line to save
     ...
     6CD6 A00A     
0067               
0068 6CD8 0204  20         li    tmp0,id.file.printfile
     6CDA 0007     
0069                       ;-------------------------------------------------------
0070                       ; Print file
0071                       ;-------------------------------------------------------
...
0018                       ; Intialisation
0019                       ;-------------------------------------------------------
0020 6CEE 04E0  34         clr   @edb.dirty            ; Clear editor buffer dirty flag
     6CF0 A506     
0021 6CF2 06A0  32         bl    @pane.cursor.blink    ; Show cursor again
     6CF4 7500     
0022 6CF6 06A0  32         bl    @cmdb.cmd.clear       ; Clear current command
     6CF8 7A5C     
0023 6CFA C120  34         mov   @cmdb.action.ptr,tmp0 ; Get pointer to keyboard action
     6CFC A728     
0024                       ;-------------------------------------------------------
0025                       ; Asserts
0026                       ;-------------------------------------------------------
0027 6CFE 0284  22         ci    tmp0,>2000
     6D00 2000     
0028 6D02 1104  14         jlt   !                     ; Invalid address, crash
0029               
0030 6D04 0284  22         ci    tmp0,>7fff
     6D06 7FFF     
0031 6D08 1501  14         jgt   !                     ; Invalid address, crash
0032                       ;------------------------------------------------------
0033                       ; All Asserts passed
0034                       ;------------------------------------------------------
0035 6D0A 0454  20         b     *tmp0                 ; Execute action
0036                       ;------------------------------------------------------
0037                       ; Asserts failed
0038                       ;------------------------------------------------------
0039 6D0C C80B  38 !       mov   r11,@>ffce            ; \ Save caller address
     6D0E FFCE     
0040 6D10 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     6D12 2026     
0041                       ;-------------------------------------------------------
0042                       ; Exit
0043                       ;-------------------------------------------------------
0044               edkey.action.cmdb.proceed.exit:
0045 6D14 0460  28         b     @edkey.keyscan.hook.debounce
     6D16 614C     
...
0064 6D18 06A0  32        bl    @fm.fastmode           ; Toggle fast mode.
     6D1A 7A98     
0065 6D1C 0720  34        seto  @cmdb.dirty            ; Command buffer dirty (text changed!)
     6D1E A718     
0066 6D20 0460  28        b     @edkey.keyscan.hook.debounce
     6D22 614C     
...
0083 6D24 06A0  32        bl    @tibasic.sid.toggle    ; Toggle SID mode.
     6D26 7A8E     
0084 6D28 0720  34        seto  @cmdb.dirty            ; Command buffer dirty (text changed!)
     6D2A A718     
0085 6D2C 0460  28        b     @edkey.keyscan.hook.debounce
     6D2E 614C     
...
0103 6D30 06A0  32        bl    @cmdb.cmd.preset       ; Set preset
     6D32 7A70     
0104 6D34 0460  28        b     @edkey.keyscan.hook.debounce
     6D36 614C     
...
0122 6D38 04E0  34         clr   @cmdb.dialog.var      ; Reset to Help page 1
     6D3A A71C     
0123                       ;------------------------------------------------------
0124                       ; Erase header line
0125                       ;------------------------------------------------------
0126 6D3C 06A0  32         bl    @hchar
     6D3E 27E6     
0127 6D40 0000                   byte 0,0,32,80*2
     6D42 20A0     
0128 6D44 FFFF                   data EOL
0129               
0130 6D46 1000  14         jmp   edkey.action.cmdb.close.dialog
0131               
0132               
0133               
0134               ***************************************************************
...
0148                       ; Close dialog
0149                       ;------------------------------------------------------
0150 6D48 04E0  34         clr   @cmdb.dialog          ; Reset dialog ID
     6D4A A71A     
0151 6D4C 06A0  32         bl    @pane.cursor.blink    ; Show cursor
     6D4E 7500     
0152 6D50 06A0  32         bl    @pane.cmdb.hide       ; Hide command buffer pane
     6D52 7A3E     
0153 6D54 0720  34         seto  @fb.status.dirty      ; Trigger status lines update
     6D56 A318     
0154                       ;-------------------------------------------------------
0155                       ; Exit
0156                       ;-------------------------------------------------------
0157               edkey.action.cmdb.close.dialog.exit:
0158 6D58 0460  28         b     @edkey.keyscan.hook.debounce
     6D5A 614C     
...
0022               ********|*****|*********************|**************************
0023               fb.row2line:
0024 6D5C 0649  14         dect  stack
0025 6D5E C64B  30         mov   r11,*stack            ; Save return address
0026 6D60 0649  14         dect  stack
0027 6D62 C644  30         mov   tmp0,*stack           ; Push tmp0
0028                       ;------------------------------------------------------
0029                       ; Calculate line in editor buffer
0030                       ;------------------------------------------------------
0031 6D64 C120  34         mov   @parm1,tmp0
     6D66 A006     
0032 6D68 A120  34         a     @fb.topline,tmp0
     6D6A A304     
0033 6D6C C804  38         mov   tmp0,@outparm1
     6D6E A016     
0034                       ;------------------------------------------------------
0035                       ; Exit
0036                       ;------------------------------------------------------
0037               fb.row2line.exit:
0038 6D70 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0039 6D72 C2F9  30         mov   *stack+,r11           ; Pop r11
0040 6D74 045B  20         b     *r11                  ; Return to caller
0041               
0042               
0043               
0044               
...
0068 6D76 0649  14         dect  stack
0069 6D78 C64B  30         mov   r11,*stack            ; Save return address
0070 6D7A 0649  14         dect  stack
0071 6D7C C644  30         mov   tmp0,*stack           ; Push tmp0
0072 6D7E 0649  14         dect  stack
0073 6D80 C645  30         mov   tmp1,*stack           ; Push tmp1
0074                       ;------------------------------------------------------
0075                       ; Calculate pointer
0076                       ;------------------------------------------------------
0077 6D82 C120  34         mov   @fb.row,tmp0
     6D84 A306     
0078 6D86 3920  72         mpy   @fb.colsline,tmp0     ; tmp1 = row  * colsline
     6D88 A30E     
0079 6D8A A160  34         a     @fb.column,tmp1       ; tmp1 = tmp1 + column
     6D8C A30C     
0080 6D8E A160  34         a     @fb.top.ptr,tmp1      ; tmp1 = tmp1 + base
     6D90 A300     
0081 6D92 C805  38         mov   tmp1,@fb.current
     6D94 A302     
0082                       ;------------------------------------------------------
0083                       ; Exit
0084                       ;------------------------------------------------------
0085               fb.calc_pointer.exit:
0086 6D96 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0087 6D98 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0088 6D9A C2F9  30         mov   *stack+,r11           ; Pop r11
0089 6D9C 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.14478
...
0025                       ;-------------------------------------------------------
0026 6DA2 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6DA4 A318     
0027 6DA6 8820  54         c     @fb.row.dirty,@w$ffff
     6DA8 A30A     
     6DAA 2022     
0028 6DAC 1604  14         jne   fb.cursor.up.cursor
0029 6DAE 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     6DB0 702C     
0030 6DB2 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     6DB4 A30A     
0031                       ;-------------------------------------------------------
0032                       ; Move cursor
0033                       ;-------------------------------------------------------
0034               fb.cursor.up.cursor:
0035 6DB6 C120  34         mov   @fb.row,tmp0
     6DB8 A306     
0036 6DBA 150B  14         jgt   fb.cursor.up.cursor_up
0037                                                   ; Move cursor up if fb.row > 0
0038 6DBC C120  34         mov   @fb.topline,tmp0      ; Do we need to scroll?
     6DBE A304     
0039 6DC0 130C  14         jeq   fb.cursor.up.set_cursorx
0040                                                   ; At top, only position cursor X
0041                       ;-------------------------------------------------------
0042                       ; Scroll 1 line
0043                       ;-------------------------------------------------------
0044 6DC2 0604  14         dec   tmp0                  ; fb.topline--
0045 6DC4 C804  38         mov   tmp0,@parm1           ; Scroll one line up
     6DC6 A006     
0046               
0047 6DC8 06A0  32         bl    @fb.refresh           ; \ Refresh frame buffer
     6DCA 6F80     
0048                                                   ; | i  @parm1 = Line to start with
0049                                                   ; /             (becomes @fb.topline)
0050               
0051 6DCC 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     6DCE A310     
0052 6DD0 1004  14         jmp   fb.cursor.up.set_cursorx
0053                       ;-------------------------------------------------------
0054                       ; Move cursor up
0055                       ;-------------------------------------------------------
0056               fb.cursor.up.cursor_up:
0057 6DD2 0620  34         dec   @fb.row               ; Row-- in screen buffer
     6DD4 A306     
0058 6DD6 06A0  32         bl    @up                   ; Row-- VDP cursor
     6DD8 26E8     
0059                       ;-------------------------------------------------------
0060                       ; Check line length and position cursor
0061                       ;-------------------------------------------------------
0062               fb.cursor.up.set_cursorx:
0063 6DDA 06A0  32         bl    @edb.line.getlength2  ; \ Get length current line
     6DDC 3588     
0064                                                   ; | i  @fb.row        = Row in frame buffer
0065                                                   ; / o  @fb.row.length = Length of row
0066               
0067 6DDE 8820  54         c     @fb.column,@fb.row.length
     6DE0 A30C     
     6DE2 A308     
0068 6DE4 1207  14         jle   fb.cursor.up.exit
0069                       ;-------------------------------------------------------
0070                       ; Adjust cursor column position
0071                       ;-------------------------------------------------------
0072 6DE6 C820  54         mov   @fb.row.length,@fb.column
     6DE8 A308     
     6DEA A30C     
0073 6DEC C120  34         mov   @fb.column,tmp0
     6DEE A30C     
0074 6DF0 06A0  32         bl    @xsetx                ; Set VDP cursor X
     6DF2 26F2     
0075                       ;-------------------------------------------------------
0076                       ; Exit
0077                       ;-------------------------------------------------------
0078               fb.cursor.up.exit:
0079 6DF4 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6DF6 6D76     
0080 6DF8 C2F9  30         mov   *stack+,r11           ; Pop r11
0081 6DFA 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.14478
...
0019               ********|*****|*********************|**************************
0020               fb.cursor.down:
0021 6DFC 0649  14         dect  stack
0022 6DFE C64B  30         mov   r11,*stack            ; Save return address
0023                       ;------------------------------------------------------
0024                       ; Last line?
0025                       ;------------------------------------------------------
0026 6E00 8820  54         c     @fb.row,@edb.lines    ; Last line in editor buffer ?
     6E02 A306     
     6E04 A504     
0027 6E06 1332  14         jeq   fb.cursor.down.exit
0028                                                   ; Yes, skip further processing
0029 6E08 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6E0A A318     
0030                       ;-------------------------------------------------------
0031                       ; Crunch current row if dirty
0032                       ;-------------------------------------------------------
0033 6E0C 8820  54         c     @fb.row.dirty,@w$ffff
     6E0E A30A     
     6E10 2022     
0034 6E12 1604  14         jne   fb.cursor.down.move
0035 6E14 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     6E16 702C     
0036 6E18 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     6E1A A30A     
0037                       ;-------------------------------------------------------
0038                       ; Move cursor
0039                       ;-------------------------------------------------------
...
0042                       ; EOF reached?
0043                       ;-------------------------------------------------------
0044 6E1C C120  34         mov   @fb.topline,tmp0
     6E1E A304     
0045 6E20 A120  34         a     @fb.row,tmp0
     6E22 A306     
0046 6E24 8120  34         c     @edb.lines,tmp0       ; fb.topline + fb.row = edb.lines ?
     6E26 A504     
0047 6E28 1314  14         jeq   fb.cursor.down.set_cursorx
0048                                                   ; Yes, only position cursor X
0049                       ;-------------------------------------------------------
0050                       ; Check if scrolling required
0051                       ;-------------------------------------------------------
0052 6E2A C120  34         mov   @fb.scrrows,tmp0
     6E2C A31A     
0053 6E2E 0604  14         dec   tmp0
0054 6E30 8120  34         c     @fb.row,tmp0
     6E32 A306     
0055 6E34 110A  14         jlt   fb.cursor.down.cursor
0056                       ;-------------------------------------------------------
0057                       ; Scroll 1 line
0058                       ;-------------------------------------------------------
0059 6E36 C820  54         mov   @fb.topline,@parm1
     6E38 A304     
     6E3A A006     
0060 6E3C 05A0  34         inc   @parm1
     6E3E A006     
0061               
0062 6E40 06A0  32         bl    @fb.refresh           ; \ Refresh frame buffer
     6E42 6F80     
0063                                                   ; | i  @parm1 = Line to start with
0064                                                   ; /             (becomes @fb.topline)
0065               
0066 6E44 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     6E46 A310     
0067 6E48 1004  14         jmp   fb.cursor.down.set_cursorx
0068                       ;-------------------------------------------------------
0069                       ; Move cursor down a row, there are still rows left
0070                       ;-------------------------------------------------------
0071               fb.cursor.down.cursor:
0072 6E4A 05A0  34         inc   @fb.row               ; Row++ in screen buffer
     6E4C A306     
0073 6E4E 06A0  32         bl    @down                 ; Row++ VDP cursor
     6E50 26E0     
0074                       ;-------------------------------------------------------
0075                       ; Check line length and position cursor
0076                       ;-------------------------------------------------------
0077               fb.cursor.down.set_cursorx:
0078 6E52 06A0  32         bl    @edb.line.getlength2  ; \ Get length current line
     6E54 3588     
0079                                                   ; | i  @fb.row        = Row in frame buffer
0080                                                   ; / o  @fb.row.length = Length of row
0081               
0082 6E56 8820  54         c     @fb.column,@fb.row.length
     6E58 A30C     
     6E5A A308     
0083 6E5C 1207  14         jle   fb.cursor.down.exit
0084                                                   ; Exit
0085                       ;-------------------------------------------------------
0086                       ; Adjust cursor column position
0087                       ;-------------------------------------------------------
0088 6E5E C820  54         mov   @fb.row.length,@fb.column
     6E60 A308     
     6E62 A30C     
0089 6E64 C120  34         mov   @fb.column,tmp0
     6E66 A30C     
0090 6E68 06A0  32         bl    @xsetx                ; Set VDP cursor X
     6E6A 26F2     
0091                       ;-------------------------------------------------------
0092                       ; Exit
0093                       ;-------------------------------------------------------
0094               fb.cursor.down.exit:
0095 6E6C 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6E6E 6D76     
0096 6E70 C2F9  30         mov   *stack+,r11           ; Pop r11
0097 6E72 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.14478
...
0019               ********|*****|*********************|**************************
0020               fb.cursor.home:
0021 6E74 0649  14         dect  stack
0022 6E76 C64B  30         mov   r11,*stack            ; Save return address
0023 6E78 0649  14         dect  stack
0024 6E7A C644  30         mov   tmp0,*stack           ; Push tmp0
0025                       ;------------------------------------------------------
0026                       ; Cursor home
0027                       ;------------------------------------------------------
0028 6E7C 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6E7E A318     
0029 6E80 C120  34         mov   @wyx,tmp0
     6E82 832A     
0030 6E84 0244  22         andi  tmp0,>ff00            ; Reset cursor X position to 0
     6E86 FF00     
0031 6E88 C804  38         mov   tmp0,@wyx             ; VDP cursor column=0
     6E8A 832A     
0032 6E8C 04E0  34         clr   @fb.column
     6E8E A30C     
0033 6E90 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6E92 6D76     
0034 6E94 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6E96 A318     
0035                       ;-------------------------------------------------------
0036                       ; Exit
0037                       ;-------------------------------------------------------
0038               fb.cursor.home.exit:
0039 6E98 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0040 6E9A C2F9  30         mov   *stack+,r11           ; Pop r11
0041 6E9C 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.14478
...
0020               ********|*****|*********************|**************************
0021               fb.insert.line:
0022 6E9E 0649  14         dect  stack
0023 6EA0 C64B  30         mov   r11,*stack            ; Save return address
0024 6EA2 0649  14         dect  stack
0025 6EA4 C644  30         mov   tmp0,*stack           ; Push tmp0
0026 6EA6 0649  14         dect  stack
0027 6EA8 C645  30         mov   tmp1,*stack           ; Push tmp1
0028                       ;-------------------------------------------------------
0029                       ; Initialisation
0030                       ;-------------------------------------------------------
0031 6EAA 0720  34         seto  @edb.dirty            ; Editor buffer dirty (text changed!)
     6EAC A506     
0032 6EAE 04C5  14         clr   tmp1                  ; Offset current line
0033 6EB0 C120  34         mov   @parm1,tmp0           ; Insert on current line or following line?
     6EB2 A006     
0034 6EB4 1301  14         jeq   !                     ; Current line
0035 6EB6 0585  14         inc   tmp1                  ; Following line
0036                       ;-------------------------------------------------------
0037                       ; Crunch current line if dirty
0038                       ;-------------------------------------------------------
0039 6EB8 8820  54 !       c     @fb.row.dirty,@w$ffff
     6EBA A30A     
     6EBC 2022     
0040 6EBE 1604  14         jne   fb.insert.line.insert
0041 6EC0 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     6EC2 702C     
0042 6EC4 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     6EC6 A30A     
0043                       ;-------------------------------------------------------
0044                       ; Insert entry in index
0045                       ;-------------------------------------------------------
0046               fb.insert.line.insert:
0047 6EC8 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6ECA 6D76     
0048 6ECC C820  54         mov   @fb.topline,@parm1
     6ECE A304     
     6ED0 A006     
0049 6ED2 A820  54         a     @fb.row,@parm1        ; Line number to insert
     6ED4 A306     
     6ED6 A006     
0050 6ED8 A805  38         a     tmp1,@parm1           ; Add optional offset (for following line)
     6EDA A006     
0051 6EDC C820  54         mov   @edb.lines,@parm2     ; Last line to reorganize
     6EDE A504     
     6EE0 A008     
0052               
0053 6EE2 06A0  32         bl    @idx.entry.insert     ; Reorganize index
     6EE4 349A     
0054                                                   ; \ i  parm1 = Line for insert
0055                                                   ; / i  parm2 = Last line to reorg
0056               
0057 6EE6 05A0  34         inc   @edb.lines            ; One line added to editor buffer
     6EE8 A504     
0058 6EEA 04E0  34         clr   @fb.row.length        ; Current row length = 0
     6EEC A308     
0059                       ;-------------------------------------------------------
0060                       ; Check/Adjust marker M1
0061                       ;-------------------------------------------------------
0062               fb.insert.line.m1:
0063 6EEE 8820  54         c     @edb.block.m1,@w$ffff ; Marker M1 unset?
     6EF0 A50C     
     6EF2 2022     
0064 6EF4 1308  14         jeq   fb.insert.line.m2
0065                                                   ; Yes, skip to M2 check
0066               
0067 6EF6 8820  54         c     @parm1,@edb.block.m1
     6EF8 A006     
     6EFA A50C     
0068 6EFC 1504  14         jgt   fb.insert.line.m2
0069 6EFE 05A0  34         inc   @edb.block.m1         ; M1++
     6F00 A50C     
0070 6F02 0720  34         seto  @fb.colorize          ; Set colorize flag
     6F04 A310     
0071                       ;-------------------------------------------------------
0072                       ; Check/Adjust marker M2
0073                       ;-------------------------------------------------------
0074               fb.insert.line.m2:
0075 6F06 8820  54         c     @edb.block.m2,@w$ffff ; Marker M1 unset?
     6F08 A50E     
     6F0A 2022     
0076 6F0C 1308  14         jeq   fb.insert.line.refresh
0077                                                   ; Yes, skip to refresh frame buffer
0078               
0079 6F0E 8820  54         c     @parm1,@edb.block.m2
     6F10 A006     
     6F12 A50E     
0080 6F14 1504  14         jgt   fb.insert.line.refresh
0081 6F16 05A0  34         inc   @edb.block.m2         ; M2++
     6F18 A50E     
0082 6F1A 0720  34         seto  @fb.colorize          ; Set colorize flag
     6F1C A310     
0083                       ;-------------------------------------------------------
0084                       ; Refresh frame buffer and physical screen
0085                       ;-------------------------------------------------------
0086               fb.insert.line.refresh:
0087 6F1E C820  54         mov   @fb.topline,@parm1
     6F20 A304     
     6F22 A006     
0088               
0089 6F24 06A0  32         bl    @fb.refresh           ; \ Refresh frame buffer
     6F26 6F80     
0090                                                   ; | i  @parm1 = Line to start with
0091                                                   ; /             (becomes @fb.topline)
0092               
0093 6F28 0720  34         seto  @fb.dirty             ; Trigger screen refresh
     6F2A A316     
0094 6F2C 06A0  32         bl    @fb.cursor.home       ; Move cursor home
     6F2E 6E74     
0095                       ;-------------------------------------------------------
0096                       ; Exit
0097                       ;-------------------------------------------------------
0098               fb.insert.line.exit:
0099 6F30 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0100 6F32 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0101 6F34 C2F9  30         mov   *stack+,r11           ; Pop r11
0102 6F36 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.14478
...
0015 6F38 0649  14         dect  stack
0016 6F3A C64B  30         mov   r11,*stack            ; Save return address
0017                       ;------------------------------------------------------
0018                       ; Prepare for scanning
0019                       ;------------------------------------------------------
0020 6F3C 04E0  34         clr   @fb.column
     6F3E A30C     
0021 6F40 06A0  32         bl    @fb.calc_pointer
     6F42 6D76     
0022 6F44 06A0  32         bl    @edb.line.getlength2  ; Get length current line
     6F46 3588     
0023 6F48 C1A0  34         mov   @fb.row.length,tmp2   ; Set loop counter
     6F4A A308     
0024 6F4C 1313  14         jeq   fb.get.firstnonblank.nomatch
0025                                                   ; Exit if empty line
0026 6F4E C120  34         mov   @fb.current,tmp0      ; Pointer to current char
     6F50 A302     
0027 6F52 04C5  14         clr   tmp1
0028                       ;------------------------------------------------------
0029                       ; Scan line for non-blank character
0030                       ;------------------------------------------------------
0031               fb.get.firstnonblank.loop:
0032 6F54 D174  28         movb  *tmp0+,tmp1           ; Get character
0033 6F56 130E  14         jeq   fb.get.firstnonblank.nomatch
0034                                                   ; Exit if empty line
0035 6F58 0285  22         ci    tmp1,>2000            ; Whitespace?
     6F5A 2000     
0036 6F5C 1503  14         jgt   fb.get.firstnonblank.match
0037 6F5E 0606  14         dec   tmp2                  ; Counter--
0038 6F60 16F9  14         jne   fb.get.firstnonblank.loop
0039 6F62 1008  14         jmp   fb.get.firstnonblank.nomatch
0040                       ;------------------------------------------------------
0041                       ; Non-blank character found
0042                       ;------------------------------------------------------
0043               fb.get.firstnonblank.match:
0044 6F64 6120  34         s     @fb.current,tmp0      ; Calculate column
     6F66 A302     
0045 6F68 0604  14         dec   tmp0
0046 6F6A C804  38         mov   tmp0,@outparm1        ; Save column
     6F6C A016     
0047 6F6E D805  38         movb  tmp1,@outparm2        ; Save character
     6F70 A018     
0048 6F72 1004  14         jmp   fb.get.firstnonblank.exit
0049                       ;------------------------------------------------------
0050                       ; No non-blank character found
0051                       ;------------------------------------------------------
0052               fb.get.firstnonblank.nomatch:
0053 6F74 04E0  34         clr   @outparm1             ; X=0
     6F76 A016     
0054 6F78 04E0  34         clr   @outparm2             ; Null
     6F7A A018     
0055                       ;------------------------------------------------------
0056                       ; Exit
0057                       ;------------------------------------------------------
0058               fb.get.firstnonblank.exit:
0059 6F7C C2F9  30         mov   *stack+,r11           ; Pop r11
0060 6F7E 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.14478
...
0018               ********|*****|*********************|**************************
0019               fb.refresh:
0020 6F80 0649  14         dect  stack
0021 6F82 C64B  30         mov   r11,*stack            ; Push return address
0022 6F84 0649  14         dect  stack
0023 6F86 C644  30         mov   tmp0,*stack           ; Push tmp0
0024 6F88 0649  14         dect  stack
0025 6F8A C645  30         mov   tmp1,*stack           ; Push tmp1
0026 6F8C 0649  14         dect  stack
0027 6F8E C646  30         mov   tmp2,*stack           ; Push tmp2
0028                       ;------------------------------------------------------
0029                       ; Setup starting position in index
0030                       ;------------------------------------------------------
0031 6F90 C820  54         mov   @parm1,@fb.topline
     6F92 A006     
     6F94 A304     
0032 6F96 04E0  34         clr   @parm2                ; Target row in frame buffer
     6F98 A008     
0033                       ;------------------------------------------------------
0034                       ; Check if already at EOF
0035                       ;------------------------------------------------------
0036 6F9A 8820  54         c     @parm1,@edb.lines     ; EOF reached?
     6F9C A006     
     6F9E A504     
0037 6FA0 130F  14         jeq   fb.refresh.erase_eob  ; Yes, no need to unpack
0038                       ;------------------------------------------------------
0039                       ; Unpack line to frame buffer
0040                       ;------------------------------------------------------
0041               fb.refresh.unpack_line:
0042 6FA2 06A0  32         bl    @edb.line.unpack.fb   ; Unpack line from editor buffer
     6FA4 7124     
0043                                                   ; \ i  parm1    = Line to unpack
0044                                                   ; | i  parm2    = Target row in frame buffer
0045                                                   ; / o  outparm1 = Length of line
0046               
0047 6FA6 05A0  34         inc   @parm1                ; Next line in editor buffer
     6FA8 A006     
0048 6FAA 05A0  34         inc   @parm2                ; Next row in frame buffer
     6FAC A008     
0049                       ;------------------------------------------------------
0050                       ; Last row in editor buffer reached ?
0051                       ;------------------------------------------------------
0052 6FAE 8820  54         c     @parm1,@edb.lines     ; BOT reached?
     6FB0 A006     
     6FB2 A504     
0053 6FB4 1305  14         jeq   fb.refresh.erase_eob  ; yes, erase until end of frame buffer
0054               
0055 6FB6 8820  54         c     @parm2,@fb.scrrows
     6FB8 A008     
     6FBA A31A     
0056 6FBC 11F2  14         jlt   fb.refresh.unpack_line
0057                                                   ; No, unpack next line
0058 6FBE 1011  14         jmp   fb.refresh.exit       ; Yes, exit without erasing
0059                       ;------------------------------------------------------
0060                       ; Erase until end of frame buffer
0061                       ;------------------------------------------------------
0062               fb.refresh.erase_eob:
0063 6FC0 C120  34         mov   @parm2,tmp0           ; Current row
     6FC2 A008     
0064 6FC4 C160  34         mov   @fb.scrrows,tmp1      ; Rows framebuffer
     6FC6 A31A     
0065 6FC8 6144  18         s     tmp0,tmp1             ; tmp1 = rows framebuffer - current row
0066 6FCA 3960  72         mpy   @fb.colsline,tmp1     ; tmp2 = cols per row * tmp1
     6FCC A30E     
0067               
0068 6FCE C186  18         mov   tmp2,tmp2             ; Already at end of frame buffer?
0069 6FD0 1308  14         jeq   fb.refresh.exit       ; Yes, so exit
0070               
0071 6FD2 3920  72         mpy   @fb.colsline,tmp0     ; cols per row * tmp0 (Result in tmp1!)
     6FD4 A30E     
0072 6FD6 A160  34         a     @fb.top.ptr,tmp1      ; Add framebuffer base
     6FD8 A300     
0073               
0074 6FDA C105  18         mov   tmp1,tmp0             ; tmp0 = Memory start address
0075 6FDC 04C5  14         clr   tmp1                  ; Clear with >00 character
0076               
0077 6FDE 06A0  32         bl    @xfilm                ; \ Fill memory
     6FE0 2250     
...
0085 6FE2 0720  34         seto  @fb.dirty             ; Refresh screen
     6FE4 A316     
0086               
0087 6FE6 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0088 6FE8 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0089 6FEA C139  30         mov   *stack+,tmp0          ; Pop tmp0
0090 6FEC C2F9  30         mov   *stack+,r11           ; Pop r11
0091 6FEE 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.14478
...
0019               ********|*****|*********************|**************************
0020               fb.restore:
0021 6FF0 0649  14         dect  stack
0022 6FF2 C64B  30         mov   r11,*stack            ; Save return address
0023 6FF4 0649  14         dect  stack
0024 6FF6 C660  46         mov   @parm1,*stack         ; Push @parm1
     6FF8 A006     
0025                       ;------------------------------------------------------
0026                       ; Refresh framebuffer
0027                       ;------------------------------------------------------
0028 6FFA C820  54         mov   @fb.topline,@parm1
     6FFC A304     
     6FFE A006     
0029 7000 06A0  32         bl    @fb.refresh           ; Refresh frame buffer content
     7002 6F80     
0030                                                   ; \ @i  parm1 = Line to start with
0031                       ;------------------------------------------------------
0032                       ; Color marked lines
0033                       ;------------------------------------------------------
0034 7004 0720  34         seto  @parm1                ; Skip Asserts
     7006 A006     
0035 7008 06A0  32         bl    @fb.colorlines        ; Colorize frame buffer content
     700A 7AD8     
...
0040                       ;------------------------------------------------------
0041 700C C820  54         mov   @tv.color,@parm1      ; Set normal color
     700E A218     
     7010 A006     
0042 7012 06A0  32         bl    @pane.action.colorscheme.statlines
     7014 74C8     
...
0048                       ;------------------------------------------------------
0049 7016 0720  34         seto  @fb.status.dirty      ; Trigger status line update
     7018 A318     
0050               
0051 701A 06A0  32         bl    @pane.cursor.blink    ; Show cursor
     701C 7500     
0052                       ;------------------------------------------------------
0053                       ; Exit
0054                       ;------------------------------------------------------
0055               fb.restore.exit:
0056 701E C839  50         mov   *stack+,@parm1        ; Pop @parm1
     7020 A006     
0057 7022 C820  54         mov   @parm1,@wyx           ; Set cursor position
     7024 A006     
     7026 832A     
0058 7028 C2F9  30         mov   *stack+,r11           ; Pop R11
0059 702A 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.14478
0111                       ;-----------------------------------------------------------------------
...
0027 702C 0649  14         dect  stack
0028 702E C64B  30         mov   r11,*stack            ; Save return address
0029 7030 0649  14         dect  stack
0030 7032 C644  30         mov   tmp0,*stack           ; Push tmp0
0031 7034 0649  14         dect  stack
0032 7036 C645  30         mov   tmp1,*stack           ; Push tmp1
0033 7038 0649  14         dect  stack
0034 703A C646  30         mov   tmp2,*stack           ; Push tmp2
0035 703C 0649  14         dect  stack
0036 703E C647  30         mov   tmp3,*stack           ; Push tmp3
0037                       ;------------------------------------------------------
0038                       ; Get values
0039                       ;------------------------------------------------------
0040 7040 C820  54         mov   @fb.column,@rambuf    ; Save @fb.column
     7042 A30C     
     7044 A100     
0041 7046 04E0  34         clr   @fb.column
     7048 A30C     
0042 704A 06A0  32         bl    @fb.calc_pointer      ; Beginning of row
     704C 6D76     
0043                       ;------------------------------------------------------
0044                       ; Prepare scan
0045                       ;------------------------------------------------------
0046 704E 04C4  14         clr   tmp0                  ; Counter
0047 7050 04C7  14         clr   tmp3                  ; Counter for whitespace
0048 7052 C160  34         mov   @fb.current,tmp1      ; Get position
     7054 A302     
0049 7056 C805  38         mov   tmp1,@rambuf+2        ; Save beginning of row
     7058 A102     
0050                       ;------------------------------------------------------
0051                       ; Scan line for >00 byte termination
0052                       ;------------------------------------------------------
0053               edb.line.pack.fb.scan:
0054 705A D1B5  28         movb  *tmp1+,tmp2           ; Get char
0055 705C 0986  56         srl   tmp2,8                ; Right justify
0056 705E 130D  14         jeq   edb.line.pack.fb.check_setpage
0057                                                   ; Stop scan if >00 found
0058 7060 0584  14         inc   tmp0                  ; Increase string length
0059                       ;------------------------------------------------------
0060                       ; Check for trailing whitespace
0061                       ;------------------------------------------------------
0062 7062 0286  22         ci    tmp2,32               ; Was it a space character?
     7064 0020     
0063 7066 1301  14         jeq   edb.line.pack.fb.check80
0064 7068 C1C4  18         mov   tmp0,tmp3
0065                       ;------------------------------------------------------
0066                       ; Not more than 80 characters
0067                       ;------------------------------------------------------
0068               edb.line.pack.fb.check80:
0069 706A 0284  22         ci    tmp0,colrow
     706C 0050     
0070 706E 1305  14         jeq   edb.line.pack.fb.check_setpage
0071                                                   ; Stop scan if 80 characters processed
0072 7070 10F4  14         jmp   edb.line.pack.fb.scan ; Next character
0073                       ;------------------------------------------------------
0074                       ; Check failed, crash CPU!
0075                       ;------------------------------------------------------
0076               edb.line.pack.fb.crash:
0077 7072 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     7074 FFCE     
0078 7076 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     7078 2026     
0079                       ;------------------------------------------------------
0080                       ; Check if highest SAMS page needs to be increased
0081                       ;------------------------------------------------------
0082               edb.line.pack.fb.check_setpage:
0083 707A 8107  18         c     tmp3,tmp0             ; Trailing whitespace in line?
0084 707C 1103  14         jlt   edb.line.pack.fb.rtrim
0085 707E C804  38         mov   tmp0,@rambuf+4        ; Save full length of line
     7080 A104     
0086 7082 100C  14         jmp   !
0087               edb.line.pack.fb.rtrim:
0088                       ;------------------------------------------------------
0089                       ; Remove trailing blanks from line
0090                       ;------------------------------------------------------
0091 7084 C807  38         mov   tmp3,@rambuf+4        ; Save line length without trailing blanks
     7086 A104     
0092               
0093 7088 04C5  14         clr   tmp1                  ; tmp1 = Character to fill (>00)
0094               
0095 708A C184  18         mov   tmp0,tmp2             ; \
0096 708C 6187  18         s     tmp3,tmp2             ; | tmp2 = Repeat count
0097 708E 0586  14         inc   tmp2                  ; /
0098               
0099 7090 C107  18         mov   tmp3,tmp0             ; \
0100 7092 A120  34         a     @rambuf+2,tmp0        ; / tmp0 = Start address in CPU memory
     7094 A102     
0101               
0102               edb.line.pack.fb.rtrim.loop:
0103 7096 DD05  32         movb  tmp1,*tmp0+
0104 7098 0606  14         dec   tmp2
0105 709A 15FD  14         jgt   edb.line.pack.fb.rtrim.loop
0106                       ;------------------------------------------------------
0107                       ; Check and increase highest SAMS page
0108                       ;------------------------------------------------------
0109 709C 06A0  32 !       bl    @edb.hipage.alloc     ; Check and increase highest SAMS page
     709E 7B06     
...
0116 70A0 C820  54         mov   @fb.topline,@parm1    ; \ parm1 = fb.topline + fb.row
     70A2 A304     
     70A4 A006     
0117 70A6 A820  54         a     @fb.row,@parm1        ; /
     70A8 A306     
     70AA A006     
0118                       ;------------------------------------------------------
...
0122 70AC C820  54         mov   @edb.next_free.ptr,@parm2
     70AE A508     
     70B0 A008     
0123                                                   ; Pointer to new line
0124 70B2 C820  54         mov   @edb.sams.hipage,@parm3
     70B4 A518     
     70B6 A00A     
0125                                                   ; SAMS page to use
0126               
0127 70B8 06A0  32         bl    @idx.entry.update     ; Update index
     70BA 334A     
...
0134                       ;------------------------------------------------------
0135 70BC C120  34         mov   @rambuf+2,tmp0        ; Source for memory copy
     70BE A102     
0136 70C0 C160  34         mov   @edb.next_free.ptr,tmp1
     70C2 A508     
0137                                                   ; Address of line in editor buffer
0138               
0139 70C4 05E0  34         inct  @edb.next_free.ptr    ; Adjust pointer
     70C6 A508     
0140               
0141 70C8 C1A0  34         mov   @rambuf+4,tmp2        ; Get line length
     70CA A104     
0142 70CC CD46  34         mov   tmp2,*tmp1+           ; Set line length as line prefix
0143 70CE 1317  14         jeq   edb.line.pack.fb.prepexit
0144                                                   ; Nothing to copy if empty line
0145                       ;------------------------------------------------------
0146                       ; 4. Copy line from framebuffer to editor buffer
0147                       ;------------------------------------------------------
0148               edb.line.pack.fb.copyline:
0149 70D0 0286  22         ci    tmp2,2
     70D2 0002     
0150 70D4 1603  14         jne   edb.line.pack.fb.copyline.checkbyte
0151 70D6 DD74  42         movb  *tmp0+,*tmp1+         ; \ Copy single word on possible
0152 70D8 DD74  42         movb  *tmp0+,*tmp1+         ; / uneven address
0153 70DA 1007  14         jmp   edb.line.pack.fb.copyline.align16
0154               
0155               edb.line.pack.fb.copyline.checkbyte:
0156 70DC 0286  22         ci    tmp2,1
     70DE 0001     
0157 70E0 1602  14         jne   edb.line.pack.fb.copyline.block
0158 70E2 D554  38         movb  *tmp0,*tmp1           ; Copy single byte
0159 70E4 1002  14         jmp   edb.line.pack.fb.copyline.align16
0160               
0161               edb.line.pack.fb.copyline.block:
0162 70E6 06A0  32         bl    @xpym2m               ; Copy memory block
     70E8 24F4     
0163                                                   ; \ i  tmp0 = source
...
0170 70EA A820  54         a     @rambuf+4,@edb.next_free.ptr
     70EC A104     
     70EE A508     
0171                                                      ; Add length of line
0172               
0173 70F0 C120  34         mov   @edb.next_free.ptr,tmp0  ; \ Round up to next multiple of 16.
     70F2 A508     
0174 70F4 0504  16         neg   tmp0                     ; | tmp0 = tmp0 + (-tmp0 & 15)
0175 70F6 0244  22         andi  tmp0,15                  ; | Hacker's Delight 2nd Edition
     70F8 000F     
0176 70FA A804  38         a     tmp0,@edb.next_free.ptr  ; / Chapter 2
     70FC A508     
0177                       ;------------------------------------------------------
0178                       ; 6: Restore SAMS page and prepare for exit
0179                       ;------------------------------------------------------
0180               edb.line.pack.fb.prepexit:
0181 70FE C820  54         mov   @rambuf,@fb.column    ; Retrieve @fb.column
     7100 A100     
     7102 A30C     
0182               
0183 7104 8820  54         c     @edb.sams.hipage,@edb.sams.page
     7106 A518     
     7108 A516     
0184 710A 1306  14         jeq   edb.line.pack.fb.exit ; Exit early if SAMS page already mapped
0185               
0186 710C C120  34         mov   @edb.sams.page,tmp0
     710E A516     
0187 7110 C160  34         mov   @edb.top.ptr,tmp1
     7112 A500     
0188 7114 06A0  32         bl    @xsams.page.set       ; Set SAMS page
     7116 258A     
...
0195 7118 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0196 711A C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0197 711C C179  30         mov   *stack+,tmp1          ; Pop tmp1
0198 711E C139  30         mov   *stack+,tmp0          ; Pop tmp0
0199 7120 C2F9  30         mov   *stack+,r11           ; Pop R11
0200 7122 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.14478
...
0029 7126 C64B  30         mov   r11,*stack            ; Save return address
0030 7128 0649  14         dect  stack
0031 712A C644  30         mov   tmp0,*stack           ; Push tmp0
0032 712C 0649  14         dect  stack
0033 712E C645  30         mov   tmp1,*stack           ; Push tmp1
0034 7130 0649  14         dect  stack
0035 7132 C646  30         mov   tmp2,*stack           ; Push tmp2
0036                       ;------------------------------------------------------
0037                       ; Save parameters
0038                       ;------------------------------------------------------
0039 7134 C820  54         mov   @parm1,@rambuf
     7136 A006     
     7138 A100     
0040 713A C820  54         mov   @parm2,@rambuf+2
     713C A008     
     713E A102     
0041                       ;------------------------------------------------------
0042                       ; Calculate offset in frame buffer
0043                       ;------------------------------------------------------
0044 7140 C120  34         mov   @fb.colsline,tmp0
     7142 A30E     
0045 7144 3920  72         mpy   @parm2,tmp0           ; Offset is in tmp1!
     7146 A008     
0046 7148 C1A0  34         mov   @fb.top.ptr,tmp2
     714A A300     
0047 714C A146  18         a     tmp2,tmp1             ; Add base to offset
0048 714E C805  38         mov   tmp1,@rambuf+6        ; Destination row in frame buffer
     7150 A106     
0049                       ;------------------------------------------------------
0050                       ; Return empty row if requested line beyond editor buffer
0051                       ;------------------------------------------------------
0052 7152 8820  54         c     @parm1,@edb.lines     ; Requested line at BOT?
     7154 A006     
     7156 A504     
0053 7158 1103  14         jlt   !                     ; No, continue processing
0054               
0055 715A 04E0  34         clr   @rambuf+8             ; Set length=0
     715C A108     
0056 715E 1013  14         jmp   edb.line.unpack.fb.clear
0057                       ;------------------------------------------------------
0058                       ; Get pointer to line & page-in editor buffer page
0059                       ;------------------------------------------------------
0060 7160 C120  34 !       mov   @parm1,tmp0
     7162 A006     
0061 7164 06A0  32         bl    @edb.line.mappage     ; Activate editor buffer SAMS page for line
     7166 34F2     
0062                                                   ; \ i  tmp0     = Line number
...
0067                       ;------------------------------------------------------
0068 7168 C120  34         mov   @outparm1,tmp0        ; Get pointer to line
     716A A016     
0069 716C 1603  14         jne   edb.line.unpack.fb.getlen
0070                                                   ; Continue if pointer is set
0071               
0072 716E 04E0  34         clr   @rambuf+8             ; Set length=0
     7170 A108     
0073 7172 1009  14         jmp   edb.line.unpack.fb.clear
0074                       ;------------------------------------------------------
0075                       ; Get line length
0076                       ;------------------------------------------------------
0077               edb.line.unpack.fb.getlen:
0078 7174 C174  30         mov   *tmp0+,tmp1           ; Get line length
0079 7176 C804  38         mov   tmp0,@rambuf+4        ; Source memory address for block copy
     7178 A104     
0080 717A C805  38         mov   tmp1,@rambuf+8        ; Save line length
     717C A108     
0081                       ;------------------------------------------------------
0082                       ; Assert on line length
0083                       ;------------------------------------------------------
0084 717E 0285  22         ci    tmp1,80               ; \ Continue if length <= 80
     7180 0050     
0085                                                   ; /
0086 7182 1201  14         jle   edb.line.unpack.fb.clear
0087                       ;------------------------------------------------------
0088                       ; Crash the system or limit length to 80
0089                       ;------------------------------------------------------
0097 7184 100C  14         jmp   edb.line.unpack.fb.prepare
0098                                                   ; Length was >80, don't erase
0100                       ;------------------------------------------------------
0101                       ; Erase chars from last column until column 80
0102                       ;------------------------------------------------------
0103               edb.line.unpack.fb.clear:
0104 7186 C120  34         mov   @rambuf+6,tmp0        ; Start of row in frame buffer
     7188 A106     
0105 718A A120  34         a     @rambuf+8,tmp0        ; Skip until end of row in frame buffer
     718C A108     
0106               
0107 718E 04C5  14         clr   tmp1                  ; Fill with >00
0108 7190 C1A0  34         mov   @fb.colsline,tmp2
     7192 A30E     
0109 7194 61A0  34         s     @rambuf+8,tmp2        ; Calculate number of bytes to clear
     7196 A108     
0110 7198 0586  14         inc   tmp2
0111               
0112 719A 06A0  32         bl    @xfilm                ; Fill CPU memory
     719C 2250     
...
0120 719E C1A0  34         mov   @rambuf+8,tmp2        ; Line length
     71A0 A108     
0121 71A2 130D  14         jeq   edb.line.unpack.fb.exit
0122                                                   ; Exit if length = 0
0123 71A4 C120  34         mov   @rambuf+4,tmp0        ; Pointer to line in editor buffer
     71A6 A104     
0124 71A8 C160  34         mov   @rambuf+6,tmp1        ; Pointer to row in frame buffer
     71AA A106     
0125                       ;------------------------------------------------------
0126                       ; Assert on line length
0127                       ;------------------------------------------------------
0128               edb.line.unpack.fb.copy:
0129 71AC 0286  22         ci    tmp2,80               ; Check line length
     71AE 0050     
0130 71B0 1202  14         jle   edb.line.unpack.fb.copy.doit
0131                       ;------------------------------------------------------
0132                       ; Crash the system or limit length to 80
0133                       ;------------------------------------------------------
0138 71B2 0206  20         li    tmp2,80               ; Only process first 80 characters
     71B4 0050     
0140                       ;------------------------------------------------------
0141                       ; Copy memory block
0142                       ;------------------------------------------------------
0143               edb.line.unpack.fb.copy.doit:
0144 71B6 C806  38         mov   tmp2,@outparm1        ; Length of unpacked line
     71B8 A016     
0145               
0146 71BA 06A0  32         bl    @xpym2m               ; Copy line to frame buffer
     71BC 24F4     
...
0154 71BE C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0155 71C0 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0156 71C2 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0157 71C4 C2F9  30         mov   *stack+,r11           ; Pop r11
0158 71C6 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.14478
0116                       ;-----------------------------------------------------------------------
...
0008 71C8 0649  14         dect  stack
0009 71CA C64B  30         mov   r11,*stack            ; Save return address
0010 71CC 0649  14         dect  stack
0011 71CE C644  30         mov   tmp0,*stack           ; Push tmp0
0012 71D0 0649  14         dect  stack
0013 71D2 C645  30         mov   tmp1,*stack           ; Push tmp1
0014 71D4 0649  14         dect  stack
0015 71D6 C646  30         mov   tmp2,*stack           ; Push tmp2
0016 71D8 0649  14         dect  stack
0017 71DA C660  46         mov   @wyx,*stack           ; Push cursor position
     71DC 832A     
0018                       ;------------------------------------------------------
0019                       ; Get pane with focus
0020                       ;------------------------------------------------------
0021 71DE C120  34         mov   @tv.pane.focus,tmp0   ; Get pane with focus
     71E0 A222     
0022               
0023 71E2 0284  22         ci    tmp0,pane.focus.fb
     71E4 0000     
0024 71E6 1310  14         jeq   task.vdp.cursor.fb    ; Frame buffer has focus
0025               
0026 71E8 0284  22         ci    tmp0,pane.focus.cmdb
     71EA 0001     
0027 71EC 1304  14         jeq   task.vdp.cursor.cmdb  ; CMDB buffer has focus
0028                       ;------------------------------------------------------
0029                       ; Assert failed. Invalid value
0030                       ;------------------------------------------------------
0031 71EE C80B  38         mov   r11,@>ffce            ; \ Save caller address
     71F0 FFCE     
0032 71F2 06A0  32         bl    @cpu.crash            ; / Halt system.
     71F4 2026     
0033                       ;------------------------------------------------------
0034                       ; CMDB buffer has focus, position CMDB cursor
0035                       ;------------------------------------------------------
0036               task.vdp.cursor.cmdb:
0037 71F6 C820  54         mov   @cmdb.cursor,@wyx     ; Position cursor in CMDB pane
     71F8 A70A     
     71FA 832A     
0038 71FC 0560  34         inv   @fb.curtoggle         ; Flip cursor shape flag
     71FE A312     
0039 7200 1319  14         jeq   task.vdp.cursor.dump  ; Show CMDB cursor
0040                       ;------------------------------------------------------
0041                       ; Hide CMDB cursor
0042                       ;------------------------------------------------------
0043               task.vdp.cursor.cmdb.hide:
0044 7202 0720  34         seto  @cmdb.dirty
     7204 A718     
0045 7206 101C  14         jmp   task.vdp.cursor.exit
0046                       ;------------------------------------------------------
0047                       ; Frame buffer has focus, position FB cursor
0048                       ;------------------------------------------------------
0049               task.vdp.cursor.fb:
0050 7208 0560  34         inv   @fb.curtoggle         ; Flip cursor shape flag
     720A A312     
0051 720C 1303  14         jeq   task.vdp.cursor.fb.visible
0052                                                   ; Show FB cursor
0053                       ;------------------------------------------------------
0054                       ; Hide FB cursor
0055                       ;------------------------------------------------------
0056 720E 0720  34         seto  @fb.dirty             ; Trigger refresh
     7210 A316     
0057 7212 1016  14         jmp   task.vdp.cursor.exit
0058                       ;------------------------------------------------------
0059                       ; Show FB cursor
0060                       ;------------------------------------------------------
0061               task.vdp.cursor.fb.visible:
0062 7214 C120  34         mov   @tv.ruler.visible,tmp0
     7216 A210     
0063 7218 1307  14         jeq   task.vdp.cursor.fb.visible.noruler
0064                       ;------------------------------------------------------
0065                       ; Cursor position adjustment, ruler visible
0066                       ;------------------------------------------------------
0067 721A C120  34         mov   @wyx,tmp0             ; Get cursor YX
     721C 832A     
0068 721E 0224  22         ai    tmp0,>0200            ; Topline + ruler adjustment
     7220 0200     
0069 7222 C804  38         mov   tmp0,@wyx             ; Save cursor YX
     7224 832A     
0070 7226 1006  14         jmp   task.vdp.cursor.dump
0071                       ;------------------------------------------------------
0072                       ; Cursor position adjustment, ruler hidden
0073                       ;------------------------------------------------------
0074               task.vdp.cursor.fb.visible.noruler:
0075 7228 C120  34         mov   @wyx,tmp0             ; Get cursor YX
     722A 832A     
0076 722C 0224  22         ai    tmp0,>0100            ; Topline adjustment
     722E 0100     
0077 7230 C804  38         mov   tmp0,@wyx             ; Save cursor YX
     7232 832A     
0078                       ;------------------------------------------------------
0079                       ; Dump cursor to VDP
0080                       ;------------------------------------------------------
0081               task.vdp.cursor.dump:
0082 7234 06A0  32         bl    @yx2pnt               ; Calculate VDP address from @WYX
     7236 240E     
0083                                                   ; \ i  @wyx = Cursor position
0084                                                   ; / o  tmp0 = VDP address
0085               
0086 7238 0205  20         li    tmp1,26               ; Cursor character
     723A 001A     
0087               
0088 723C 06A0  32         bl    @xvputb               ; VDP put single byte
     723E 22E0     
...
0095 7240 C839  50         mov   *stack+,@wyx          ; Pop cursor position
     7242 832A     
0096 7244 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0097 7246 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0098 7248 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0099 724A C2F9  30         mov   *stack+,r11           ; Pop r11
0100 724C 0460  28         b     @slotok               ; Exit task
     724E 2E58     
                   < stevie_b1.asm.14478
0125               
...
0006               ********|*****|*********************|**************************
0007               task.vdp.panes:
0008 7250 0649  14         dect  stack
0009 7252 C64B  30         mov   r11,*stack            ; Save return address
0010                       ;------------------------------------------------------
0011                       ; Dump panes to VDP memory
0012                       ;------------------------------------------------------
0013 7254 06A0  32         bl    @pane.vdpdump
     7256 7828     
0014                       ;------------------------------------------------------
0015                       ; Exit task
0016                       ;------------------------------------------------------
0017               task.vdp.panes.exit:
0018 7258 C2F9  30         mov   *stack+,r11           ; Pop r11
0019 725A 0460  28         b     @slotok
     725C 2E58     
                   < stevie_b1.asm.14478
...
0007               
0008               task.oneshot:
0009 725E C120  34         mov   @tv.task.oneshot,tmp0  ; Get pointer to one-shot task
     7260 A224     
0010 7262 1301  14         jeq   task.oneshot.exit
0011               
0012 7264 0694  24         bl    *tmp0                  ; Execute one-shot task
0013                       ;------------------------------------------------------
0014                       ; Exit
0015                       ;------------------------------------------------------
0016               task.oneshot.exit:
0017 7266 0460  28         b     @slotok                ; Exit task
     7268 2E58     
                   < stevie_b1.asm.14478
0128                       ;-----------------------------------------------------------------------
...
0020 726A 0649  14         dect  stack
0021 726C C64B  30         mov   r11,*stack            ; Push return address
0022 726E 0649  14         dect  stack
0023 7270 C644  30         mov   tmp0,*stack           ; Push tmp0
0024               
0025 7272 C120  34         mov   @tv.colorscheme,tmp0  ; Load color scheme index
     7274 A212     
0026 7276 0284  22         ci    tmp0,tv.colorscheme.entries
     7278 000A     
0027                                                   ; Last entry reached?
0028 727A 1103  14         jlt   !
0029 727C 0204  20         li    tmp0,1                ; Reset color scheme index
     727E 0001     
0030 7280 1001  14         jmp   pane.action.colorscheme.switch
0031 7282 0584  14 !       inc   tmp0
0032                       ;-------------------------------------------------------
0033                       ; Switch to new color scheme
0034                       ;-------------------------------------------------------
0035               pane.action.colorscheme.switch:
0036 7284 C804  38         mov   tmp0,@tv.colorscheme  ; Save index of color scheme
     7286 A212     
0037               
0038 7288 06A0  32         bl    @pane.action.colorscheme.load
     728A 72C8     
0039                                                   ; Load current color scheme
0040                       ;-------------------------------------------------------
0041                       ; Show current color palette message
0042                       ;-------------------------------------------------------
0043 728C C820  54         mov   @wyx,@waux1           ; Save cursor YX position
     728E 832A     
     7290 833C     
0044               
0045 7292 06A0  32         bl    @putnum
     7294 2A38     
0046 7296 003E                   byte 0,62
0047 7298 A212                   data tv.colorscheme,rambuf,>3020
     729A A100     
     729C 3020     
0048               
0049 729E 06A0  32         bl    @putat
     72A0 2456     
0050 72A2 0034                   byte 0,52
0051 72A4 395C                   data txt.colorscheme  ; Show color palette message
0052               
0053 72A6 C820  54         mov   @waux1,@wyx           ; Restore cursor YX position
     72A8 833C     
     72AA 832A     
0054                       ;-------------------------------------------------------
0055                       ; Delay
0056                       ;-------------------------------------------------------
0057 72AC 0204  20         li    tmp0,12000
     72AE 2EE0     
0058 72B0 0604  14 !       dec   tmp0
0059 72B2 16FE  14         jne   -!
0060                       ;-------------------------------------------------------
0061                       ; Setup one shot task for removing message
0062                       ;-------------------------------------------------------
0063 72B4 0204  20         li    tmp0,pane.topline.oneshot.clearmsg
     72B6 35AC     
0064 72B8 C804  38         mov   tmp0,@tv.task.oneshot
     72BA A224     
0065               
0066 72BC 06A0  32         bl    @rsslot               ; \ Reset loop counter slot 3
     72BE 2ECC     
0067 72C0 0003                   data 3                ; / for getting consistent delay
0068                       ;-------------------------------------------------------
0069                       ; Exit
0070                       ;-------------------------------------------------------
0071               pane.action.colorscheme.cycle.exit:
0072 72C2 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0073 72C4 C2F9  30         mov   *stack+,r11           ; Pop R11
0074 72C6 045B  20         b     *r11                  ; Return to caller
0075               
0076               
0077               
0078               ***************************************************************
...
0097 72C8 0649  14         dect  stack
0098 72CA C64B  30         mov   r11,*stack            ; Save return address
0099 72CC 0649  14         dect  stack
0100 72CE C644  30         mov   tmp0,*stack           ; Push tmp0
0101 72D0 0649  14         dect  stack
0102 72D2 C645  30         mov   tmp1,*stack           ; Push tmp1
0103 72D4 0649  14         dect  stack
0104 72D6 C646  30         mov   tmp2,*stack           ; Push tmp2
0105 72D8 0649  14         dect  stack
0106 72DA C647  30         mov   tmp3,*stack           ; Push tmp3
0107 72DC 0649  14         dect  stack
0108 72DE C648  30         mov   tmp4,*stack           ; Push tmp4
0109 72E0 0649  14         dect  stack
0110 72E2 C660  46         mov   @parm1,*stack         ; Push parm1
     72E4 A006     
0111 72E6 0649  14         dect  stack
0112 72E8 C660  46         mov   @parm2,*stack         ; Push parm2
     72EA A008     
0113 72EC 0649  14         dect  stack
0114 72EE C660  46         mov   @parm3,*stack         ; Push parm3
     72F0 A00A     
0115                       ;-------------------------------------------------------
0116                       ; Turn screen off
0117                       ;-------------------------------------------------------
0118 72F2 C120  34         mov   @parm1,tmp0
     72F4 A006     
0119 72F6 0284  22         ci    tmp0,>ffff            ; Skip flag set?
     72F8 FFFF     
0120 72FA 1302  14         jeq   !                     ; Yes, so skip screen off
0121 72FC 06A0  32         bl    @scroff               ; Turn screen off
     72FE 269A     
0122                       ;-------------------------------------------------------
0123                       ; Get FG/BG colors framebuffer text
0124                       ;-------------------------------------------------------
0125 7300 C120  34 !       mov   @tv.colorscheme,tmp0  ; Get color scheme index
     7302 A212     
0126 7304 0604  14         dec   tmp0                  ; Internally work with base 0
0127               
0128 7306 0A34  56         sla   tmp0,3                ; Offset into color scheme data table
0129 7308 0224  22         ai    tmp0,tv.colorscheme.table
     730A 35F8     
0130                                                   ; Add base for color scheme data table
0131 730C C1F4  30         mov   *tmp0+,tmp3           ; Get colors ABCD
0132 730E C807  38         mov   tmp3,@tv.color        ; Save colors ABCD
     7310 A218     
0133                       ;-------------------------------------------------------
0134                       ; Get and save cursor color
0135                       ;-------------------------------------------------------
0136 7312 C214  26         mov   *tmp0,tmp4            ; Get colors EFGH
0137 7314 0248  22         andi  tmp4,>00ff            ; Only keep LSB (GH)
     7316 00FF     
0138 7318 C808  38         mov   tmp4,@tv.curcolor     ; Save cursor color
     731A A216     
0139                       ;-------------------------------------------------------
0140                       ; Get FG/BG colors framebuffer marked text & CMDB pane
0141                       ;-------------------------------------------------------
0142 731C C234  30         mov   *tmp0+,tmp4           ; Get colors EFGH again
0143 731E 0248  22         andi  tmp4,>ff00            ; Only keep MSB (EF)
     7320 FF00     
0144 7322 0988  56         srl   tmp4,8                ; MSB to LSB
0145               
0146 7324 C174  30         mov   *tmp0+,tmp1           ; Get colors IJKL
0147 7326 C185  18         mov   tmp1,tmp2             ; \ Right align IJ and
0148 7328 0986  56         srl   tmp2,8                ; | save to @tv.busycolor
0149 732A C806  38         mov   tmp2,@tv.busycolor    ; /
     732C A21C     
0150               
0151 732E 0245  22         andi  tmp1,>00ff            ; | save KL to @tv.markcolor
     7330 00FF     
0152 7332 C805  38         mov   tmp1,@tv.markcolor    ; /
     7334 A21A     
0153               
0154 7336 C154  26         mov   *tmp0,tmp1            ; Get colors MNOP
0155 7338 0985  56         srl   tmp1,8                ; \ Right align MN and
0156 733A C805  38         mov   tmp1,@tv.cmdb.hcolor  ; / save to @tv.cmdb.hcolor
     733C A220     
0157                       ;-------------------------------------------------------
0158                       ; Check if only CMDB needs to be colorized
0159                       ;-------------------------------------------------------
0160 733E 8820  54         c     @parm3,@w$ffff        ; Only colorize CMDB pane ?
     7340 A00A     
     7342 2022     
0161 7344 133E  14         jeq   pane.action.colorscheme.cmdbpane
0162                                                   ; Yes, shortcut jump to CMDB pane
0163                       ;-------------------------------------------------------
0164                       ; Get FG color for ruler
0165                       ;-------------------------------------------------------
0166 7346 C154  26         mov   *tmp0,tmp1            ; Get colors MNOP
0167 7348 0245  22         andi  tmp1,>000f            ; Only keep P
     734A 000F     
0168 734C 0A45  56         sla   tmp1,4                ; Make it a FG/BG combination
0169 734E C805  38         mov   tmp1,@tv.rulercolor   ; Save to @tv.rulercolor
     7350 A21E     
0170                       ;-------------------------------------------------------
0171                       ; Write sprite color of line and column indicators to SAT
0172                       ;-------------------------------------------------------
0173 7352 C154  26         mov   *tmp0,tmp1            ; Get colors MNOP
0174 7354 0245  22         andi  tmp1,>00f0            ; Only keep O
     7356 00F0     
0175 7358 0A45  56         sla   tmp1,4                ; Move O to MSB
0176 735A D805  38         movb  tmp1,@ramsat+7        ; Line indicator FG color to SAT
     735C A05D     
0177 735E D805  38         movb  tmp1,@ramsat+11       ; Column indicator FG color to SAT
     7360 A061     
0178                       ;-------------------------------------------------------
0179                       ; Dump colors to VDP register 7 (text mode)
0180                       ;-------------------------------------------------------
0181 7362 C147  18         mov   tmp3,tmp1             ; Get work copy
0182 7364 0985  56         srl   tmp1,8                ; MSB to LSB (frame buffer colors)
0183 7366 0265  22         ori   tmp1,>0700
     7368 0700     
0184 736A C105  18         mov   tmp1,tmp0
0185 736C 06A0  32         bl    @putvrx               ; Write VDP register
     736E 2348     
0186                       ;-------------------------------------------------------
0187                       ; Dump colors for frame buffer pane (TAT)
0188                       ;-------------------------------------------------------
0189 7370 C120  34         mov   @tv.ruler.visible,tmp0
     7372 A210     
0190 7374 130A  14         jeq   pane.action.colorscheme.fbdump.noruler
0191               
0192 7376 C120  34         mov   @cmdb.dialog,tmp0
     7378 A71A     
0193 737A 0284  22         ci    tmp0,id.dialog.help   ; Help dialog active?
     737C 0068     
0194 737E 1305  14         jeq   pane.action.colorscheme.fbdump.noruler
0195                                                   ; Yes, skip ruler
0196                       ;-------------------------------------------------------
0197                       ; Ruler visible on screen (TAT)
0198                       ;-------------------------------------------------------
0199 7380 0204  20         li    tmp0,vdp.fb.toprow.tat+80
     7382 18A0     
0200                                                   ; VDP start address (frame buffer area)
0201               
0202 7384 0206  20         li    tmp2,(pane.botrow-2)*80
     7386 0690     
0203                                                   ; Number of bytes to fill
0204 7388 1004  14         jmp   pane.action.colorscheme.checkcmdb
0205               
0206               pane.action.colorscheme.fbdump.noruler:
0207                       ;-------------------------------------------------------
0208                       ; No ruler visible on screen (TAT)
0209                       ;-------------------------------------------------------
0210 738A 0204  20         li    tmp0,vdp.fb.toprow.tat
     738C 1850     
0211                                                   ; VDP start address (frame buffer area)
0212 738E 0206  20         li    tmp2,(pane.botrow-1)*80
     7390 06E0     
...
0218 7392 C820  54         mov   @cmdb.visible,@cmdb.visible
     7394 A702     
     7396 A702     
0219 7398 1302  14         jeq   pane.action.colorscheme.fbdump
0220                                                   ; Not visible, skip adjustment
0221 739A 0226  22         ai    tmp2,-320             ; CMDB adjustment
     739C FEC0     
0222                       ;-------------------------------------------------------
0223                       ; Dump colors to VDP (TAT)
0224                       ;-------------------------------------------------------
0225               pane.action.colorscheme.fbdump:
0226 739E C147  18         mov   tmp3,tmp1             ; Get work copy of colors ABCD
0227 73A0 0985  56         srl   tmp1,8                ; MSB to LSB (frame buffer colors)
0228               
0229 73A2 06A0  32         bl    @xfilv                ; Fill colors
     73A4 22A8     
...
0235                       ;-------------------------------------------------------
0236 73A6 C120  34         mov   @cmdb.dialog,tmp0
     73A8 A71A     
0237 73AA 0284  22         ci    tmp0,id.dialog.help   ; Help dialog active?
     73AC 0068     
0238 73AE 1309  14         jeq   pane.action.colorscheme.cmdbpane
0239                                                   ; Yes, skip marked lines
0240               
0241 73B0 C120  34         mov   @parm2,tmp0
     73B2 A008     
0242 73B4 0284  22         ci    tmp0,>ffff            ; Skip colorize flag is on?
     73B6 FFFF     
0243 73B8 1304  14         jeq   pane.action.colorscheme.cmdbpane
0244               
0245 73BA 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     73BC A310     
0246 73BE 06A0  32         bl    @fb.colorlines
     73C0 7AD8     
0247                       ;-------------------------------------------------------
0248                       ; Dump colors for CMDB header line (TAT)
0249                       ;-------------------------------------------------------
0250               pane.action.colorscheme.cmdbpane:
0251 73C2 C120  34         mov   @cmdb.visible,tmp0
     73C4 A702     
0252 73C6 1330  14         jeq   pane.action.colorscheme.errpane
0253                                                   ; Skip if CMDB pane is hidden
0254               
0255 73C8 0204  20         li    tmp0,vdp.cmdb.toprow.tat
     73CA 1DF0     
0256                                                   ; VDP start address (CMDB top line)
0257               
0258 73CC C160  34         mov   @tv.cmdb.hcolor,tmp1  ; set color for header line
     73CE A220     
0259 73D0 0206  20         li    tmp2,1*67             ; Number of bytes to fill
     73D2 0043     
0260 73D4 06A0  32         bl    @xfilv                ; Fill colors
     73D6 22A8     
...
0266                       ;-------------------------------------------------------
0267 73D8 0204  20         li    tmp0,vdp.cmdb.toprow.tat+67
     73DA 1E33     
0268 73DC C160  34         mov   @tv.cmdb.hcolor,tmp1  ;
     73DE A220     
0269 73E0 D160  34         movb  @tv.cmdb.hcolor+1,tmp1
     73E2 A221     
0270                                                   ; Copy same value into MSB
0271 73E4 0945  56         srl   tmp1,4                ;
0272 73E6 0245  22         andi  tmp1,>00ff            ; Only keep LSB
     73E8 00FF     
0273               
0274 73EA 0206  20         li    tmp2,13               ; Number of bytes to fill
     73EC 000D     
0275 73EE 06A0  32         bl    @xfilv                ; Fill colors
     73F0 22A8     
...
0281                       ;-------------------------------------------------------
0282 73F2 0204  20         li    tmp0,vdp.cmdb.toprow.tat + 80
     73F4 1E40     
0283                                                   ; VDP start address (CMDB top line + 1)
0284 73F6 C148  18         mov   tmp4,tmp1             ; Get work copy fg/bg color
0285 73F8 0206  20         li    tmp2,1*80             ; Number of bytes to fill
     73FA 0050     
0286 73FC 06A0  32         bl    @xfilv                ; Fill colors
     73FE 22A8     
0287                                                   ; i \  tmp0 = start address
0288                                                   ; i |  tmp1 = byte to fill
0289                                                   ; i /  tmp2 = number of bytes to fill
0290               
0291 7400 0204  20         li    tmp0,vdp.cmdb.toprow.tat + 160
     7402 1E90     
0292                                                   ; VDP start address (CMDB top line + 2)
0293 7404 C160  34         mov   @tv.cmdb.hcolor,tmp1  ; Same color as header line
     7406 A220     
0294 7408 0206  20         li    tmp2,1*80             ; Number of bytes to fill
     740A 0050     
0295 740C 06A0  32         bl    @xfilv                ; Fill colors
     740E 22A8     
0296                                                   ; i \  tmp0 = start address
0297                                                   ; i |  tmp1 = byte to fill
0298                                                   ; i /  tmp2 = number of bytes to fill
0299               
0300 7410 0204  20         li    tmp0,vdp.cmdb.toprow.tat + 240
     7412 1EE0     
0301                                                   ; VDP start address (CMDB top line + 3)
0302 7414 C148  18         mov   tmp4,tmp1             ; Get work copy fg/bg color
0303 7416 0206  20         li    tmp2,1*80             ; Number of bytes to fill
     7418 0050     
0304 741A 06A0  32         bl    @xfilv                ; Fill colors
     741C 22A8     
...
0310                       ;-------------------------------------------------------
0311 741E C120  34         mov   @parm3,tmp0
     7420 A00A     
0312 7422 0284  22         ci    tmp0,>ffff            ; Only colorize CMDB pane ?
     7424 FFFF     
0313 7426 1336  14         jeq   pane.action.colorscheme.cursorcolor.cmdb
0314                                                   ; Yes, shortcut to CMDB cursor color
0315                       ;-------------------------------------------------------
0316                       ; Dump colors for error pane (TAT)
0317                       ;-------------------------------------------------------
0318               pane.action.colorscheme.errpane:
0319 7428 C120  34         mov   @tv.error.visible,tmp0
     742A A228     
0320 742C 1306  14         jeq   pane.action.colorscheme.statline
0321                                                   ; Skip if error pane is hidden
0322               
0323 742E 0205  20         li    tmp1,>00f6            ; White on dark red
     7430 00F6     
0324 7432 C805  38         mov   tmp1,@parm1           ; Pass color combination
     7434 A006     
0325               
0326 7436 06A0  32         bl    @pane.errline.drawcolor
     7438 7628     
...
0334 743A C160  34         mov   @tv.color,tmp1
     743C A218     
0335 743E 0245  22         andi  tmp1,>00ff            ; Only keep LSB (status line colors)
     7440 00FF     
0336 7442 C805  38         mov   tmp1,@parm1           ; Set color combination
     7444 A006     
0337               
0338               
0339 7446 04E0  34         clr   @parm2                ; Top row on screen
     7448 A008     
0340 744A 06A0  32         bl    @colors.line.set      ; Load color combination for line
     744C 751C     
0341                                                   ; \ i  @parm1 = Color combination
0342                                                   ; / i  @parm2 = Row on physical screen
0343               
0344 744E 0205  20         li    tmp1,pane.botrow
     7450 0017     
0345 7452 C805  38         mov   tmp1,@parm2           ; Bottom row on screen
     7454 A008     
0346 7456 06A0  32         bl    @colors.line.set      ; Load color combination for line
     7458 751C     
...
0351                       ;-------------------------------------------------------
0352 745A C160  34         mov   @cmdb.dialog,tmp1
     745C A71A     
0353 745E 0285  22         ci    tmp1,id.dialog.basic  ; TI Basic dialog active?
     7460 006B     
0354 7462 1602  14         jne   pane.action.colorscheme.ruler
0355               
0356 7464 06A0  32         bl    @tibasic.hearts.tat   ; Dump colors for hearts
     7466 7A84     
0357                       ;-------------------------------------------------------
0358                       ; Dump colors for ruler if visible (TAT)
0359                       ;-------------------------------------------------------
0360               pane.action.colorscheme.ruler:
0361 7468 C160  34         mov   @cmdb.dialog,tmp1
     746A A71A     
0362 746C 0285  22         ci    tmp1,id.dialog.help   ; Help dialog active?
     746E 0068     
0363 7470 130A  14         jeq   pane.action.colorscheme.cursorcolor
0364                                                   ; Yes, skip ruler
0365               
0366 7472 C160  34         mov   @tv.ruler.visible,tmp1
     7474 A210     
0367 7476 1307  14         jeq   pane.action.colorscheme.cursorcolor
0368               
0369 7478 06A0  32         bl    @fb.ruler.init        ; Setup ruler with tab-positions in memory
     747A 7AC6     
0370 747C 06A0  32         bl    @cpym2v
     747E 249A     
0371 7480 1850                   data vdp.fb.toprow.tat
0372 7482 A36E                   data fb.ruler.tat
0373 7484 0050                   data 80               ; Show ruler colors
0374                       ;-------------------------------------------------------
0375                       ; Dump cursor FG color to sprite table (SAT)
0376                       ;-------------------------------------------------------
0377               pane.action.colorscheme.cursorcolor:
0378 7486 C220  34         mov   @tv.curcolor,tmp4     ; Get cursor color
     7488 A216     
0379               
0380 748A C120  34         mov   @tv.pane.focus,tmp0   ; Get pane with focus
     748C A222     
0381 748E 0284  22         ci    tmp0,pane.focus.fb    ; Frame buffer has focus?
     7490 0000     
0382 7492 1304  14         jeq   pane.action.colorscheme.cursorcolor.fb
0383                                                   ; Yes, set cursor color
0384               
0385               pane.action.colorscheme.cursorcolor.cmdb:
0386 7494 0248  22         andi  tmp4,>f0              ; Only keep high-nibble -> Word 2 (G)
     7496 00F0     
0387 7498 0A48  56         sla   tmp4,4                ; Move to MSB
0388 749A 1003  14         jmp   !
0389               
0390               pane.action.colorscheme.cursorcolor.fb:
0391 749C 0248  22         andi  tmp4,>0f              ; Only keep low-nibble -> Word 2 (H)
     749E 000F     
0392 74A0 0A88  56         sla   tmp4,8                ; Move to MSB
0393               
0394 74A2 D808  38 !       movb  tmp4,@ramsat+3        ; Update FG color in sprite table (SAT)
     74A4 A059     
0395 74A6 D808  38         movb  tmp4,@tv.curshape+1   ; Save cursor color
     74A8 A215     
0396                       ;-------------------------------------------------------
0397                       ; Exit
0398                       ;-------------------------------------------------------
0399               pane.action.colorscheme.load.exit:
0400 74AA 06A0  32         bl    @scron                ; Turn screen on
     74AC 26A2     
0401 74AE C839  50         mov   *stack+,@parm3        ; Pop @parm3
     74B0 A00A     
0402 74B2 C839  50         mov   *stack+,@parm2        ; Pop @parm2
     74B4 A008     
0403 74B6 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     74B8 A006     
0404 74BA C239  30         mov   *stack+,tmp4          ; Pop tmp4
0405 74BC C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0406 74BE C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0407 74C0 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0408 74C2 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0409 74C4 C2F9  30         mov   *stack+,r11           ; Pop R11
0410 74C6 045B  20         b     *r11                  ; Return to caller
0411               
0412               
0413               
0414               ***************************************************************
...
0430 74C8 0649  14         dect  stack
0431 74CA C64B  30         mov   r11,*stack            ; Save return address
0432 74CC 0649  14         dect  stack
0433 74CE C644  30         mov   tmp0,*stack           ; Push tmp0
0434                       ;------------------------------------------------------
0435                       ; Bottom line
0436                       ;------------------------------------------------------
0437 74D0 0204  20         li    tmp0,pane.botrow
     74D2 0017     
0438 74D4 C804  38         mov   tmp0,@parm2           ; Last row on screen
     74D6 A008     
0439 74D8 06A0  32         bl    @colors.line.set      ; Load color combination for line
     74DA 751C     
...
0446 74DC C139  30         mov   *stack+,tmp0          ; Pop tmp0
0447 74DE C2F9  30         mov   *stack+,r11           ; Pop R11
0448 74E0 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.14478
...
0020 74E2 0649  14         dect  stack
0021 74E4 C64B  30         mov   r11,*stack            ; Save return address
0022                       ;-------------------------------------------------------
0023                       ; Hide cursor
0024                       ;-------------------------------------------------------
0025 74E6 06A0  32         bl    @filv                 ; Clear sprite SAT in VDP RAM
     74E8 22A2     
0026 74EA 2180                   data sprsat,>00,8     ; \ i  p0 = VDP destination
     74EC 0000     
     74EE 0008     
0027                                                   ; | i  p1 = Byte to write
0028                                                   ; / i  p2 = Number of bytes to write
0029               
0030 74F0 06A0  32         bl    @clslot
     74F2 2EBE     
0031 74F4 0001                   data 1                ; Terminate task.vdp.copy.sat
0032               
0033 74F6 06A0  32         bl    @clslot
     74F8 2EBE     
0034 74FA 0002                   data 2                ; Terminate task.vdp.cursor
0035                       ;-------------------------------------------------------
0036                       ; Exit
0037                       ;-------------------------------------------------------
0038               pane.cursor.hide.exit:
0039 74FC C2F9  30         mov   *stack+,r11           ; Pop R11
0040 74FE 045B  20         b     *r11                  ; Return to caller
0041               
0042               
0043               
0044               ***************************************************************
...
0060 7500 0649  14         dect  stack
0061 7502 C64B  30         mov   r11,*stack            ; Save return address
0062                       ;-------------------------------------------------------
0063                       ; Hide cursor
0064                       ;-------------------------------------------------------
0065 7504 06A0  32         bl    @filv                 ; Clear sprite SAT in VDP RAM
     7506 22A2     
0066 7508 2180                   data sprsat,>00,4     ; \ i  p0 = VDP destination
     750A 0000     
     750C 0004     
...
0069               
0078               
0079 750E 06A0  32         bl    @mkslot
     7510 2EA0     
0080 7512 020F                   data >020f,task.vdp.cursor   ; Task 2 - Toggle cursor shape
     7514 71C8     
0081 7516 FFFF                   data eol
0082               
0084               
0085                       ;-------------------------------------------------------
0086                       ; Exit
...
0089 7518 C2F9  30         mov   *stack+,r11           ; Pop R11
0090 751A 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.14478
0133                       ;-----------------------------------------------------------------------
0134                       ; Screen panes
0135                       ;-----------------------------------------------------------------------
...
0021 751C 0649  14         dect  stack
0022 751E C64B  30         mov   r11,*stack            ; Save return address
0023 7520 0649  14         dect  stack
0024 7522 C644  30         mov   tmp0,*stack           ; Push tmp0
0025 7524 0649  14         dect  stack
0026 7526 C645  30         mov   tmp1,*stack           ; Push tmp1
0027 7528 0649  14         dect  stack
0028 752A C646  30         mov   tmp2,*stack           ; Push tmp2
0029 752C 0649  14         dect  stack
0030 752E C660  46         mov   @parm1,*stack         ; Push parm1
     7530 A006     
0031 7532 0649  14         dect  stack
0032 7534 C660  46         mov   @parm2,*stack         ; Push parm2
     7536 A008     
0033                       ;-------------------------------------------------------
0034                       ; Dump colors for line in TAT
0035                       ;-------------------------------------------------------
0036 7538 C120  34         mov   @parm2,tmp0           ; Get target line
     753A A008     
0037 753C 0205  20         li    tmp1,colrow           ; Columns per row (spectra2)
     753E 0050     
0038 7540 3944  56         mpy   tmp0,tmp1             ; Calculate VDP address (results in tmp2!)
0039               
0040 7542 C106  18         mov   tmp2,tmp0             ; Set VDP start address
0041 7544 0224  22         ai    tmp0,vdp.tat.base     ; Add TAT base address
     7546 1800     
0042 7548 C160  34         mov   @parm1,tmp1           ; Get foreground/background color
     754A A006     
0043 754C 0206  20         li    tmp2,80               ; Number of bytes to fill
     754E 0050     
0044               
0045 7550 06A0  32         bl    @xfilv                ; Fill colors
     7552 22A8     
...
0053 7554 C839  50         mov   *stack+,@parm2        ; Pop @parm2
     7556 A008     
0054 7558 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     755A A006     
0055 755C C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0056 755E C179  30         mov   *stack+,tmp1          ; Pop tmp1
0057 7560 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0058 7562 C2F9  30         mov   *stack+,r11           ; Pop R11
0059 7564 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.14478
...
0018 7568 C64B  30         mov   r11,*stack            ; Save return address
0019 756A 0649  14         dect  stack
0020 756C C644  30         mov   tmp0,*stack           ; Push tmp0
0021 756E 0649  14         dect  stack
0022 7570 C660  46         mov   @wyx,*stack           ; Push cursor position
     7572 832A     
0023                       ;------------------------------------------------------
0024                       ; Show current file
0025                       ;------------------------------------------------------
0026               pane.topline.file:
0027 7574 06A0  32         bl    @at
     7576 26DA     
0028 7578 0000                   byte 0,0              ; y=0, x=0
0029               
0030 757A C820  54         mov   @edb.filename.ptr,@parm1
     757C A512     
     757E A006     
0031                                                   ; Get string to display
0032 7580 0204  20         li    tmp0,47
     7582 002F     
0033 7584 C804  38         mov   tmp0,@parm2           ; Set requested length
     7586 A008     
0034 7588 0204  20         li    tmp0,32
     758A 0020     
0035 758C C804  38         mov   tmp0,@parm3           ; Set character to fill
     758E A00A     
0036 7590 0204  20         li    tmp0,rambuf
     7592 A100     
0037 7594 C804  38         mov   tmp0,@parm4           ; Set pointer to buffer for output string
     7596 A00C     
0038               
0039               
0040 7598 06A0  32         bl    @tv.pad.string        ; Pad string to specified length
     759A 32D2     
...
0045                                                   ; /             output string
0046               
0047 759C C160  34         mov   @outparm1,tmp1        ; \ Display padded filename
     759E A016     
0048 75A0 06A0  32         bl    @xutst0               ; /
     75A2 2434     
0049                       ;------------------------------------------------------
0050                       ; Show if text was changed in editor buffer
0051                       ;------------------------------------------------------
0052               pane.topline.show_dirty:
0053 75A4 C120  34         mov   @edb.dirty,tmp0
     75A6 A506     
0054 75A8 1305  14         jeq   pane.topline.nochange
0055                       ;------------------------------------------------------
0056                       ; Show "*"
0057                       ;------------------------------------------------------
0058 75AA 06A0  32         bl    @putat
     75AC 2456     
0059 75AE 004F                   byte 0,79             ; y=0, x=79
0060 75B0 366C                   data txt.star
0061 75B2 1004  14         jmp   pane.topline.showmarkers
0062                       ;------------------------------------------------------
0063                       ; Show " "
0064                       ;------------------------------------------------------
0065               pane.topline.nochange:
0066 75B4 06A0  32         bl    @putat
     75B6 2456     
0067 75B8 004F                   byte 0,79             ; y=0, x=79
0068 75BA 3888                   data txt.ws1          ; Single white space
0069                       ;------------------------------------------------------
0070                       ; Check if M1/M2 markers need to be shown
0071                       ;------------------------------------------------------
0072               pane.topline.showmarkers:
0073 75BC C120  34         mov   @edb.block.m1,tmp0    ; \
     75BE A50C     
0074 75C0 0284  22         ci    tmp0,>ffff            ; | Exit early if M1 unset (>ffff)
     75C2 FFFF     
0075 75C4 132C  14         jeq   pane.topline.exit     ; /
0076               
0077 75C6 C120  34         mov   @tv.task.oneshot,tmp0 ; \
     75C8 A224     
0078 75CA 0284  22         ci    tmp0,pane.topline.oneshot.clearmsg
     75CC 35AC     
0079                                                   ; | Exit early if overlay message visible
0080 75CE 1327  14         jeq   pane.topline.exit     ; /
0081                       ;------------------------------------------------------
0082                       ; Show M1 marker
0083                       ;------------------------------------------------------
0084 75D0 06A0  32         bl    @putat
     75D2 2456     
0085 75D4 0034                   byte 0,52
0086 75D6 37E8                   data txt.m1           ; Show M1 marker message
0087               
0088 75D8 C820  54         mov   @edb.block.m1,@parm1
     75DA A50C     
     75DC A006     
0089 75DE 06A0  32         bl    @tv.unpack.uint16     ; Unpack 16 bit unsigned integer to string
     75E0 32A6     
0090                                                   ; \ i @parm1           = uint16
0091                                                   ; / o @unpacked.string = Output string
0092               
0093 75E2 0204  20         li    tmp0,>0500
     75E4 0500     
0094 75E6 D804  38         movb  tmp0,@unpacked.string ; Set string length to 5 (padding)
     75E8 A02C     
0095               
0096 75EA 06A0  32         bl    @putat
     75EC 2456     
0097 75EE 0037                   byte 0,55
0098 75F0 A02C                   data unpacked.string  ; Show M1 value
0099                       ;------------------------------------------------------
0100                       ; Show M2 marker
0101                       ;------------------------------------------------------
0102 75F2 C120  34         mov   @edb.block.m2,tmp0    ; \
     75F4 A50E     
0103 75F6 0284  22         ci    tmp0,>ffff            ; | Exit early if M2 unset (>ffff)
     75F8 FFFF     
0104 75FA 1311  14         jeq   pane.topline.exit     ; /
0105               
0106 75FC 06A0  32         bl    @putat
     75FE 2456     
0107 7600 003E                   byte 0,62
0108 7602 37EC                   data txt.m2           ; Show M2 marker message
0109               
0110 7604 C820  54         mov   @edb.block.m2,@parm1
     7606 A50E     
     7608 A006     
0111 760A 06A0  32         bl    @tv.unpack.uint16     ; Unpack 16 bit unsigned integer to string
     760C 32A6     
0112                                                   ; \ i @parm1           = uint16
0113                                                   ; / o @unpacked.string = Output string
0114               
0115 760E 0204  20         li    tmp0,>0500
     7610 0500     
0116 7612 D804  38         movb  tmp0,@unpacked.string ; Set string length to 5 (padding)
     7614 A02C     
0117               
0118 7616 06A0  32         bl    @putat
     7618 2456     
0119 761A 0041                   byte 0,65
0120 761C A02C                   data unpacked.string  ; Show M2 value
0121                       ;------------------------------------------------------
0122                       ; Exit
0123                       ;------------------------------------------------------
0124               pane.topline.exit:
0125 761E C839  50         mov   *stack+,@wyx          ; Pop cursor position
     7620 832A     
0126 7622 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0127 7624 C2F9  30         mov   *stack+,r11           ; Pop r11
0128 7626 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.14478
...
0023 7628 0649  14         dect  stack
0024 762A C64B  30         mov   r11,*stack            ; Save return address
0025 762C 0649  14         dect  stack
0026 762E C644  30         mov   tmp0,*stack           ; Push tmp0
0027 7630 0649  14         dect  stack
0028 7632 C645  30         mov   tmp1,*stack           ; Push tmp1
0029 7634 0649  14         dect  stack
0030 7636 C646  30         mov   tmp2,*stack           ; Push tmp2
0031                       ;-------------------------------------------------------
0032                       ; Determine 1st row in error pane
0033                       ;-------------------------------------------------------
0034 7638 0204  20         li    tmp0,pane.botrow      ; Get rows on screen
     763A 0017     
0035 763C C144  18         mov   tmp0,tmp1             ; \ Get first row in error pane
0036 763E 6160  34         s     @tv.error.rows,tmp1   ; /
     7640 A22A     
0037                       ;-------------------------------------------------------
0038                       ; Dump colors for row
0039                       ;-------------------------------------------------------
0040               pane.errline.drawcolor.loop:
0041 7642 C805  38         mov   tmp1,@parm2           ; Row on physical screen
     7644 A008     
0042               
0043 7646 06A0  32         bl    @colors.line.set      ; Load color combination for line
     7648 751C     
0044                                                   ; \ i  @parm1 = Color combination
0045                                                   ; / i  @parm2 = Row on physical screen
0046               
0047 764A 0585  14         inc   tmp1                  ; Next row
0048 764C 8105  18         c     tmp1,tmp0             ; Last row reached?
0049 764E 11F9  14         jlt   pane.errline.drawcolor.loop
0050                                                   ; Not yet, next iteration
0051                       ;-------------------------------------------------------
0052                       ; Exit
0053                       ;-------------------------------------------------------
0054               pane.errline.drawcolor.exit:
0055 7650 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0056 7652 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0057 7654 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0058 7656 C2F9  30         mov   *stack+,r11           ; Pop R11
0059 7658 045B  20         b     *r11                  ; Return to caller
0060               
0061               
0062               
0063               
...
0082 765A 0649  14         dect  stack
0083 765C C64B  30         mov   r11,*stack            ; Save return address
0084 765E 0649  14         dect  stack
0085 7660 C644  30         mov   tmp0,*stack           ; Push tmp0
0086 7662 0649  14         dect  stack
0087 7664 C645  30         mov   tmp1,*stack           ; Push tmp1
0088               
0089 7666 0205  20         li    tmp1,>00f6            ; White on dark red
     7668 00F6     
0090 766A C805  38         mov   tmp1,@parm1
     766C A006     
0091               
0092 766E 06A0  32         bl    @pane.errline.drawcolor
     7670 7628     
...
0098                       ;------------------------------------------------------
0099 7672 0204  20         li    tmp0,tv.error.msg
     7674 A230     
0100 7676 C804  38         mov   tmp0,@parm1           ; Get pointer to string
     7678 A006     
0101               
0102 767A 0204  20         li    tmp0,240
     767C 00F0     
0103 767E C804  38         mov   tmp0,@parm2           ; Set requested length
     7680 A008     
0104               
0105 7682 0204  20         li    tmp0,32
     7684 0020     
0106 7686 C804  38         mov   tmp0,@parm3           ; Set character to fill
     7688 A00A     
0107               
0108 768A 0204  20         li    tmp0,rambuf
     768C A100     
0109 768E C804  38         mov   tmp0,@parm4           ; Set pointer to buffer for output string
     7690 A00C     
0110               
0111 7692 06A0  32         bl    @tv.pad.string        ; Pad string to specified length
     7694 32D2     
...
0119                       ;------------------------------------------------------
0120 7696 06A0  32         bl    @at
     7698 26DA     
0121 769A 1400                   byte pane.botrow-3,0  ; Set cursor
0122               
0123 769C C160  34         mov   @outparm1,tmp1        ; \ Display error message
     769E A016     
0124 76A0 06A0  32         bl    @xutst0               ; /
     76A2 2434     
0125               
0126 76A4 C120  34         mov   @fb.scrrows.max,tmp0  ; \
     76A6 A31C     
0127 76A8 6120  34         s     @tv.error.rows,tmp0   ; | Adjust number of rows in frame buffer
     76AA A22A     
0128 76AC C804  38         mov   tmp0,@fb.scrrows      ; /
     76AE A31A     
0129               
0130 76B0 0720  34         seto  @tv.error.visible     ; Error line is visible
     76B2 A228     
0131                       ;------------------------------------------------------
0132                       ; Exit
0133                       ;------------------------------------------------------
0134               pane.errline.show.exit:
0135 76B4 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0136 76B6 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0137 76B8 C2F9  30         mov   *stack+,r11           ; Pop r11
0138 76BA 045B  20         b     *r11                  ; Return to caller
0139               
0140               
0141               
0142               ***************************************************************
...
0160 76BC 0649  14         dect  stack
0161 76BE C64B  30         mov   r11,*stack            ; Save return address
0162 76C0 0649  14         dect  stack
0163 76C2 C644  30         mov   tmp0,*stack           ; Push tmp0
0164                       ;------------------------------------------------------
0165                       ; Get color combination
0166                       ;------------------------------------------------------
0167 76C4 06A0  32         bl    @errpane.init         ; Clear error line string in RAM
     76C6 31F8     
0168               
0169 76C8 C120  34         mov   @cmdb.visible,tmp0
     76CA A702     
0170 76CC 1303  14         jeq   pane.errline.hide.fbcolor
0171                       ;------------------------------------------------------
0172                       ; CMDB pane color
0173                       ;------------------------------------------------------
0174 76CE C120  34         mov   @tv.cmdb.hcolor,tmp0  ; Get colors of CMDB header line
     76D0 A220     
0175 76D2 1003  14         jmp   !
0176                       ;------------------------------------------------------
0177                       ; Frame buffer color
0178                       ;------------------------------------------------------
0179               pane.errline.hide.fbcolor:
0180 76D4 C120  34         mov   @tv.color,tmp0        ; Get colors
     76D6 A218     
0181 76D8 0984  56         srl   tmp0,8                ; Get rid of status line colors
0182                       ;------------------------------------------------------
0183                       ; Dump colors
0184                       ;------------------------------------------------------
0185 76DA C804  38 !       mov   tmp0,@parm1           ; set foreground/background color
     76DC A006     
0186               
0187 76DE 06A0  32         bl    @pane.errline.drawcolor
     76E0 7628     
0188                                                   ; Draw color on rows in error pane
0189                                                   ; \ i  @tv.error.rows = Number of rows
0190                                                   ; / i  @parm1         = Color combination
0191               
0192 76E2 04E0  34         clr   @tv.error.visible     ; Error line no longer visible
     76E4 A228     
0193 76E6 C820  54         mov   @fb.scrrows.max,@fb.scrrows
     76E8 A31C     
     76EA A31A     
...
0199 76EC C139  30         mov   *stack+,tmp0          ; Pop tmp0
0200 76EE C2F9  30         mov   *stack+,r11           ; Pop r11
0201 76F0 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.14478
...
0015               ********|*****|*********************|**************************
0016               pane.botline:
0017 76F2 0649  14         dect  stack
0018 76F4 C64B  30         mov   r11,*stack            ; Save return address
0019 76F6 0649  14         dect  stack
0020 76F8 C644  30         mov   tmp0,*stack           ; Push tmp0
0021 76FA 0649  14         dect  stack
0022 76FC C660  46         mov   @wyx,*stack           ; Push cursor position
     76FE 832A     
0023                       ;------------------------------------------------------
0024                       ; Show block shortcuts if set
0025                       ;------------------------------------------------------
0026 7700 C120  34         mov   @edb.block.m2,tmp0    ; \
     7702 A50E     
0027 7704 0584  14         inc   tmp0                  ; | Skip if M2 unset (>ffff)
0028                                                   ; /
0029 7706 1305  14         jeq   pane.botline.show_keys
0030               
0031 7708 06A0  32         bl    @putat
     770A 2456     
0032 770C 1700                   byte pane.botrow,0
0033 770E 37F8                   data txt.keys.block   ; Show block shortcuts
0034               
0035 7710 1004  14         jmp   pane.botline.show_mode
0036                       ;------------------------------------------------------
0037                       ; Show default message
0038                       ;------------------------------------------------------
0039               pane.botline.show_keys:
0040 7712 06A0  32         bl    @putat
     7714 2456     
0041 7716 1700                   byte pane.botrow,0
0042 7718 37F0                   data txt.keys.default ; Show default shortcuts
0043                       ;------------------------------------------------------
0044                       ; Show text editing mode
0045                       ;------------------------------------------------------
0046               pane.botline.show_mode:
0047 771A C120  34         mov   @edb.insmode,tmp0
     771C A50A     
0048 771E 1605  14         jne   pane.botline.show_mode.insert
0049                       ;------------------------------------------------------
0050                       ; Overwrite mode
0051                       ;------------------------------------------------------
0052 7720 06A0  32         bl    @putat
     7722 2456     
0053 7724 1737                   byte  pane.botrow,55
0054 7726 3664                   data  txt.ovrwrite
0055 7728 1004  14         jmp   pane.botline.show_linecol
0056                       ;------------------------------------------------------
0057                       ; Insert mode
0058                       ;------------------------------------------------------
0059               pane.botline.show_mode.insert:
0060 772A 06A0  32         bl    @putat
     772C 2456     
0061 772E 1737                   byte  pane.botrow,55
0062 7730 3668                   data  txt.insert
0063                       ;------------------------------------------------------
0064                       ; Show "line,column"
0065                       ;------------------------------------------------------
0066               pane.botline.show_linecol:
0067 7732 C820  54         mov   @fb.row,@parm1
     7734 A306     
     7736 A006     
0068 7738 06A0  32         bl    @fb.row2line          ; Row to editor line
     773A 6D5C     
0069                                                   ; \ i @fb.topline = Top line in frame buffer
0070                                                   ; | i @parm1      = Row in frame buffer
0071                                                   ; / o @outparm1   = Matching line in EB
0072               
0073 773C 05A0  34         inc   @outparm1             ; Add base 1
     773E A016     
0074                       ;------------------------------------------------------
0075                       ; Show line
0076                       ;------------------------------------------------------
0077 7740 06A0  32         bl    @putnum
     7742 2A38     
0078 7744 173B                   byte  pane.botrow,59  ; YX
0079 7746 A016                   data  outparm1,rambuf
     7748 A100     
0080 774A 30                     byte  48              ; ASCII offset
0081 774B   20                   byte  32              ; Padding character
0082                       ;------------------------------------------------------
0083                       ; Show comma
0084                       ;------------------------------------------------------
0085 774C 06A0  32         bl    @putat
     774E 2456     
0086 7750 1740                   byte  pane.botrow,64
0087 7752 365C                   data  txt.delim
0088                       ;------------------------------------------------------
0089                       ; Show column
0090                       ;------------------------------------------------------
0091 7754 06A0  32         bl    @film
     7756 224A     
0092 7758 A105                   data rambuf+5,32,12   ; Clear work buffer with space character
     775A 0020     
     775C 000C     
0093               
0094 775E C820  54         mov   @fb.column,@waux1
     7760 A30C     
     7762 833C     
0095 7764 05A0  34         inc   @waux1                ; Offset 1
     7766 833C     
0096               
0097 7768 06A0  32         bl    @mknum                ; Convert unsigned number to string
     776A 29BA     
0098 776C 833C                   data  waux1,rambuf
     776E A100     
0099 7770 30                     byte  48              ; ASCII offset
0100 7771   20                   byte  32              ; Fill character
0101               
0102 7772 06A0  32         bl    @trimnum              ; Trim number to the left
     7774 2A12     
0103 7776 A100                   data  rambuf,rambuf+5,32
     7778 A105     
     777A 0020     
0104               
0105 777C 0204  20         li    tmp0,>0600            ; "Fix" number length to clear junk chars
     777E 0600     
0106 7780 D804  38         movb  tmp0,@rambuf+5        ; Set length byte
     7782 A105     
0107               
0108                       ;------------------------------------------------------
0109                       ; Decide if row length is to be shown
0110                       ;------------------------------------------------------
0111 7784 C120  34         mov   @fb.column,tmp0       ; \ Base 1 for comparison
     7786 A30C     
0112 7788 0584  14         inc   tmp0                  ; /
0113 778A 8804  38         c     tmp0,@fb.row.length   ; Check if cursor on last column on row
     778C A308     
0114 778E 1101  14         jlt   pane.botline.show_linecol.linelen
0115 7790 102B  14         jmp   pane.botline.show_linecol.colstring
0116                                                   ; Yes, skip showing row length
0117                       ;------------------------------------------------------
0118                       ; Add ',' delimiter and length of line to string
0119                       ;------------------------------------------------------
0120               pane.botline.show_linecol.linelen:
0121 7792 C120  34         mov   @fb.column,tmp0       ; \
     7794 A30C     
0122 7796 0205  20         li    tmp1,rambuf+7         ; | Determine column position for '-' char
     7798 A107     
0123 779A 0284  22         ci    tmp0,9                ; | based on number of digits in cursor X
     779C 0009     
0124 779E 1101  14         jlt   !                     ; | column.
0125 77A0 0585  14         inc   tmp1                  ; /
0126               
0127 77A2 0204  20 !       li    tmp0,>2f00            ; \ ASCII '/'
     77A4 2F00     
0128 77A6 DD44  32         movb  tmp0,*tmp1+           ; / Add delimiter to string
0129               
0130 77A8 C805  38         mov   tmp1,@waux1           ; Backup position in ram buffer
     77AA 833C     
0131               
0132 77AC 06A0  32         bl    @mknum
     77AE 29BA     
0133 77B0 A308                   data  fb.row.length,rambuf
     77B2 A100     
0134 77B4 30                     byte  48              ; ASCII offset
0135 77B5   20                   byte  32              ; Padding character
0136               
0137 77B6 C160  34         mov   @waux1,tmp1           ; Restore position in ram buffer
     77B8 833C     
0138               
0139 77BA C120  34         mov   @fb.row.length,tmp0   ; \ Get length of line
     77BC A308     
0140 77BE 0284  22         ci    tmp0,10               ; /
     77C0 000A     
0141 77C2 110B  14         jlt   pane.botline.show_line.1digit
0142                       ;------------------------------------------------------
0143                       ; Assert
0144                       ;------------------------------------------------------
0145 77C4 0284  22         ci    tmp0,80
     77C6 0050     
0146 77C8 1204  14         jle   pane.botline.show_line.2digits
0147                       ;------------------------------------------------------
0148                       ; Asserts failed
0149                       ;------------------------------------------------------
0150 77CA C80B  38 !       mov   r11,@>ffce            ; \ Save caller address
     77CC FFCE     
0151 77CE 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     77D0 2026     
0152                       ;------------------------------------------------------
0153                       ; Show length of line (2 digits)
0154                       ;------------------------------------------------------
0155               pane.botline.show_line.2digits:
0156 77D2 0204  20         li    tmp0,rambuf+3
     77D4 A103     
0157 77D6 DD74  42         movb  *tmp0+,*tmp1+         ; 1st digit row length
0158 77D8 1002  14         jmp   pane.botline.show_line.rest
0159                       ;------------------------------------------------------
0160                       ; Show length of line (1 digits)
0161                       ;------------------------------------------------------
0162               pane.botline.show_line.1digit:
0163 77DA 0204  20         li    tmp0,rambuf+4
     77DC A104     
0164               pane.botline.show_line.rest:
0165 77DE DD74  42         movb  *tmp0+,*tmp1+         ; 1st/Next digit row length
0166 77E0 DD60  48         movb  @rambuf+0,*tmp1+      ; Append a whitespace character
     77E2 A100     
0167 77E4 DD60  48         movb  @rambuf+0,*tmp1+      ; Append a whitespace character
     77E6 A100     
0168                       ;------------------------------------------------------
0169                       ; Show column string
0170                       ;------------------------------------------------------
0171               pane.botline.show_linecol.colstring:
0172 77E8 06A0  32         bl    @putat
     77EA 2456     
0173 77EC 1741                   byte pane.botrow,65
0174 77EE A105                   data rambuf+5         ; Show string
0175                       ;------------------------------------------------------
0176                       ; Show lines in buffer unless on last line in file
0177                       ;------------------------------------------------------
0178 77F0 C820  54         mov   @fb.row,@parm1
     77F2 A306     
     77F4 A006     
0179 77F6 06A0  32         bl    @fb.row2line
     77F8 6D5C     
0180 77FA 8820  54         c     @edb.lines,@outparm1
     77FC A504     
     77FE A016     
0181 7800 1605  14         jne   pane.botline.show_lines_in_buffer
0182               
0183 7802 06A0  32         bl    @putat
     7804 2456     
0184 7806 1748                   byte pane.botrow,72
0185 7808 365E                   data txt.bottom
0186               
0187 780A 1009  14         jmp   pane.botline.exit
0188                       ;------------------------------------------------------
0189                       ; Show lines in buffer
0190                       ;------------------------------------------------------
0191               pane.botline.show_lines_in_buffer:
0192 780C C820  54         mov   @edb.lines,@waux1
     780E A504     
     7810 833C     
0193               
0194 7812 06A0  32         bl    @putnum
     7814 2A38     
0195 7816 1748                   byte pane.botrow,72   ; YX
0196 7818 833C                   data waux1,rambuf
     781A A100     
0197 781C 30                     byte 48
0198 781D   20                   byte 32
0199                       ;------------------------------------------------------
0200                       ; Exit
0201                       ;------------------------------------------------------
0202               pane.botline.exit:
0203 781E C839  50         mov   *stack+,@wyx          ; Pop cursor position
     7820 832A     
0204 7822 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0205 7824 C2F9  30         mov   *stack+,r11           ; Pop r11
0206 7826 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.14478
...
0022               ********|*****|*********************|**************************
0023               pane.vdpdump:
0024 7828 0649  14         dect  stack
0025 782A C64B  30         mov   r11,*stack            ; Save return address
0026 782C 0649  14         dect  stack
0027 782E C644  30         mov   tmp0,*stack           ; Push tmp0
0028 7830 0649  14         dect  stack
0029 7832 C660  46         mov   @wyx,*stack           ; Push cursor position
     7834 832A     
0030                       ;------------------------------------------------------
0031                       ; ALPHA-Lock key down?
0032                       ;------------------------------------------------------
0033               pane.vdpdump.alpha_lock:
0034 7836 20A0  38         coc   @wbit10,config
     7838 200C     
0035 783A 1305  14         jeq   pane.vdpdump.alpha_lock.down
0036                       ;------------------------------------------------------
0037                       ; AlPHA-Lock is up
0038                       ;------------------------------------------------------
0039 783C 06A0  32         bl    @putat
     783E 2456     
0040 7840 174E                   byte pane.botrow,78
0041 7842 3892                   data txt.ws4
0042 7844 1004  14         jmp   pane.vdpdump.cmdb.check
0043                       ;------------------------------------------------------
0044                       ; AlPHA-Lock is down
0045                       ;------------------------------------------------------
0046               pane.vdpdump.alpha_lock.down:
0047 7846 06A0  32         bl    @putat
     7848 2456     
0048 784A 174E                   byte pane.botrow,78
0049 784C 3880                   data txt.alpha.down
0050                       ;------------------------------------------------------
0051                       ; Command buffer visible ?
0052                       ;------------------------------------------------------
0053               pane.vdpdump.cmdb.check
0054 784E C120  34         mov   @cmdb.visible,tmp0    ; CMDB pane visible ?
     7850 A702     
0055 7852 1324  14         jeq   !                     ; No, skip CMDB pane
0056                       ;-------------------------------------------------------
0057                       ; Draw command buffer pane if dirty
0058                       ;-------------------------------------------------------
0059               pane.vdpdump.cmdb.draw:
0060 7854 C120  34         mov   @cmdb.dirty,tmp0      ; Command buffer dirty?
     7856 A718     
0061 7858 1343  14         jeq   pane.vdpdump.exit     ; No, skip update
0062                       ;-------------------------------------------------------
0063                       ; "one-time only" flag set?
0064                       ;-------------------------------------------------------
0065 785A 0284  22         ci    tmp0,tv.1timeonly
     785C 00FE     
0066 785E 1619  14         jne   pane.vdpdump.cmdb.draw.content
0067                                                   ; No, skip CMDB colorization
0068                       ;-------------------------------------------------------
0069                       ; Colorize the CMDB pane
0070                       ;-------------------------------------------------------
0071               pane.vdpdump.cmdb.draw.colorscheme:
0072 7860 0649  14         dect  stack
0073 7862 C660  46         mov   @parm1,*stack         ; Push @parm1
     7864 A006     
0074 7866 0649  14         dect  stack
0075 7868 C660  46         mov   @parm2,*stack         ; Push @parm2
     786A A008     
0076 786C 0649  14         dect  stack
0077 786E C660  46         mov   @parm3,*stack         ; Push @parm3
     7870 A00A     
0078               
0079 7872 0720  34         seto  @parm1                ; Do not turn screen off
     7874 A006     
0080 7876 0720  34         seto  @parm2                ; Skip colorzing marked lines
     7878 A008     
0081 787A 0720  34         seto  @parm3                ; Only colorize CMDB pane
     787C A00A     
0082               
0083 787E 06A0  32         bl    @pane.action.colorscheme.load
     7880 72C8     
...
0089                                                   ; /             if >FFFF
0090               
0091 7882 C839  50         mov   *stack+,@parm3        ; Pop @parm3
     7884 A00A     
0092 7886 C839  50         mov   *stack+,@parm2        ; Pop @parm2
     7888 A008     
0093 788A C839  50         mov   *stack+,@parm1        ; Pop @parm1
     788C A006     
0094               
0095 788E 0720  34         seto  @cmdb.dirty           ; Remove special "one-time only" flag
     7890 A718     
0096                       ;-------------------------------------------------------
0097                       ; Show content in CMDB pane
0098                       ;-------------------------------------------------------
0099               pane.vdpdump.cmdb.draw.content:
0100 7892 06A0  32         bl    @pane.cmdb.draw       ; Draw CMDB pane
     7894 7A48     
0101 7896 04E0  34         clr   @cmdb.dirty           ; Reset CMDB dirty flag
     7898 A718     
0102 789A 1022  14         jmp   pane.vdpdump.exit     ; Exit early
0103                       ;-------------------------------------------------------
0104                       ; Check if frame buffer dirty
0105                       ;-------------------------------------------------------
0106 789C C120  34 !       mov   @fb.dirty,tmp0        ; Is frame buffer dirty?
     789E A316     
0107 78A0 130E  14         jeq   pane.vdpdump.statlines
0108                                                   ; No, skip update
0109 78A2 C820  54         mov   @fb.scrrows,@parm1    ; Number of lines to dump
     78A4 A31A     
     78A6 A006     
0110               
0111               pane.vdpdump.dump:
0112 78A8 06A0  32         bl    @fb.vdpdump           ; Dump frame buffer to VDP SIT
     78AA 7AEA     
...
0117                       ;------------------------------------------------------
0118 78AC C120  34         mov   @fb.colorize,tmp0     ; Check if colorization necessary
     78AE A310     
0119 78B0 1302  14         jeq   pane.vdpdump.dumped   ; Skip if flag reset
0120               
0121 78B2 06A0  32         bl    @fb.colorlines        ; Colorize lines M1/M2
     78B4 7AD8     
0122                       ;-------------------------------------------------------
0123                       ; Finished with frame buffer
0124                       ;-------------------------------------------------------
0125               pane.vdpdump.dumped:
0126 78B6 04E0  34         clr   @fb.dirty             ; Reset framebuffer dirty flag
     78B8 A316     
0127 78BA 0720  34         seto  @fb.status.dirty      ; Do trigger status lines update
     78BC A318     
0128                       ;-------------------------------------------------------
0129                       ; Refresh top and bottom line
0130                       ;-------------------------------------------------------
0131               pane.vdpdump.statlines:
0132 78BE C120  34         mov   @fb.status.dirty,tmp0 ; Are status lines dirty?
     78C0 A318     
0133 78C2 130E  14         jeq   pane.vdpdump.exit     ; No, skip update
0134               
0135 78C4 06A0  32         bl    @pane.topline         ; Draw top line
     78C6 7566     
0136 78C8 06A0  32         bl    @pane.botline         ; Draw bottom line
     78CA 76F2     
0137 78CC 04E0  34         clr   @fb.status.dirty      ; Reset status lines dirty flag
     78CE A318     
0138                       ;------------------------------------------------------
0139                       ; Show ruler with tab positions
0140                       ;------------------------------------------------------
0141 78D0 C120  34         mov   @tv.ruler.visible,tmp0
     78D2 A210     
0142                                                   ; Should ruler be visible?
0143 78D4 1305  14         jeq   pane.vdpdump.exit     ; No, so exit
0144               
0145 78D6 06A0  32         bl    @cpym2v
     78D8 249A     
0146 78DA 0050                   data vdp.fb.toprow.sit
0147 78DC A31E                   data fb.ruler.sit
0148 78DE 0050                   data 80               ; Show ruler
0149                       ;------------------------------------------------------
0150                       ; Exit task
0151                       ;------------------------------------------------------
0152               pane.vdpdump.exit:
0153 78E0 C839  50         mov   *stack+,@wyx          ; Pop cursor position
     78E2 832A     
0154 78E4 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0155 78E6 C2F9  30         mov   *stack+,r11           ; Pop r11
0156 78E8 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.14478
0141                       ;-----------------------------------------------------------------------
0142                       ; Stubs
0143                       ;-----------------------------------------------------------------------
...
0007               ********|*****|*********************|**************************
0008               fm.loadfile:
0009 78EA 0649  14         dect  stack
0010 78EC C64B  30         mov   r11,*stack            ; Save return address
0011 78EE 0649  14         dect  stack
0012 78F0 C644  30         mov   tmp0,*stack           ; Push tmp0
0013                       ;------------------------------------------------------
0014                       ; Call function in bank 2
0015                       ;------------------------------------------------------
0016 78F2 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     78F4 2F84     
0017 78F6 6004                   data bank2.rom        ; | i  p0 = bank address
0018 78F8 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0019 78FA 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0020                       ;------------------------------------------------------
0021                       ; Show "Unsaved changes" dialog if editor buffer dirty
0022                       ;------------------------------------------------------
0023 78FC C120  34         mov   @outparm1,tmp0
     78FE A016     
0024 7900 1304  14         jeq   fm.loadfile.exit
0025               
0026 7902 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0027 7904 C2F9  30         mov   *stack+,r11           ; Pop r11
0028 7906 0460  28         b     @dialog.unsaved       ; Show dialog and exit
     7908 79AE     
0029                       ;------------------------------------------------------
0030                       ; Exit
0031                       ;------------------------------------------------------
0032               fm.loadfile.exit:
0033 790A C139  30         mov   *stack+,tmp0          ; Pop tmp0
0034 790C C2F9  30         mov   *stack+,r11           ; Pop r11
0035 790E 045B  20         b     *r11                  ; Return to caller
0036               
0037               
0038               ***************************************************************
...
0041               ********|*****|*********************|**************************
0042               fm.insertfile:
0043 7910 0649  14         dect  stack
0044 7912 C64B  30         mov   r11,*stack            ; Save return address
0045 7914 0649  14         dect  stack
0046 7916 C644  30         mov   tmp0,*stack           ; Push tmp0
0047                       ;------------------------------------------------------
0048                       ; Call function in bank 2
0049                       ;------------------------------------------------------
0050 7918 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     791A 2F84     
0051 791C 6004                   data bank2.rom        ; | i  p0 = bank address
0052 791E 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0053 7920 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0054                       ;------------------------------------------------------
0055                       ; Exit
0056                       ;------------------------------------------------------
0057               fm.insertfile.exit:
0058 7922 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0059 7924 C2F9  30         mov   *stack+,r11           ; Pop r11
0060 7926 045B  20         b     *r11                  ; Return to caller
0061               
0062               
0063               **************************************************************
...
0068 7928 0649  14         dect  stack
0069 792A C64B  30         mov   r11,*stack            ; Save return address
0070                       ;------------------------------------------------------
0071                       ; Call function in bank 2
0072                       ;------------------------------------------------------
0073 792C 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     792E 2F84     
0074 7930 6004                   data bank2.rom        ; | i  p0 = bank address
0075 7932 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0076 7934 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0077                       ;------------------------------------------------------
0078                       ; Exit
0079                       ;------------------------------------------------------
0080 7936 C2F9  30         mov   *stack+,r11           ; Pop r11
0081 7938 045B  20         b     *r11                  ; Return to caller
0082               
0083               
0084               ***************************************************************
...
0087               ********|*****|*********************|**************************
0088               fm.savefile:
0089 793A 0649  14         dect  stack
0090 793C C64B  30         mov   r11,*stack            ; Save return address
0091                       ;------------------------------------------------------
0092                       ; Call function in bank 2
0093                       ;------------------------------------------------------
0094 793E 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7940 2F84     
0095 7942 6004                   data bank2.rom        ; | i  p0 = bank address
0096 7944 7FC6                   data vec.4            ; | i  p1 = Vector with target address
0097 7946 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0098                       ;------------------------------------------------------
0099                       ; Exit
0100                       ;------------------------------------------------------
0101 7948 C2F9  30         mov   *stack+,r11           ; Pop r11
0102 794A 045B  20         b     *r11                  ; Return to caller
0103               
0104               
0105               ***************************************************************
...
0108               ********|*****|*********************|**************************
0109               fm.newfile:
0110 794C 0649  14         dect  stack
0111 794E C64B  30         mov   r11,*stack            ; Save return address
0112                       ;------------------------------------------------------
0113                       ; Call function in bank 2
0114                       ;------------------------------------------------------
0115 7950 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7952 2F84     
0116 7954 6004                   data bank2.rom        ; | i  p0 = bank address
0117 7956 7FC8                   data vec.5            ; | i  p1 = Vector with target address
0118 7958 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0119                       ;------------------------------------------------------
0120                       ; Exit
0121                       ;------------------------------------------------------
0122 795A C2F9  30         mov   *stack+,r11           ; Pop r11
0123 795C 045B  20         b     *r11                  ; Return to caller
0124               
0125               
0126               ***************************************************************
...
0131 795E 8820  54         c     @w$0008,@cmdb.dialog.var
     7960 2008     
     7962 A71C     
0132 7964 1304  14         jeq   !
0133 7966 A820  54         a     @w$0008,@cmdb.dialog.var
     7968 2008     
     796A A71C     
0134 796C 1002  14         jmp   dialog.help
0135 796E 04E0  34 !       clr   @cmdb.dialog.var
     7970 A71C     
0136               dialog.help:
0137 7972 C820  54         mov   @dialog.help.vector,@trmpvector
     7974 797A     
     7976 A054     
0138 7978 104A  14         jmp   _trampoline.bank3     ; Show dialog
0139               dialog.help.vector:
0140 797A 7FC0             data  vec.1
0141               
0142               
0143               ***************************************************************
...
0146               ********|*****|*********************|**************************
0147               dialog.load:
0148 797C C820  54         mov   @dialog.load.vector,@trmpvector
     797E 7984     
     7980 A054     
0149 7982 1045  14         jmp   _trampoline.bank3     ; Show dialog
0150               dialog.load.vector:
0151 7984 7FC2             data  vec.2
0152               
0153               
0154               ***************************************************************
...
0157               ********|*****|*********************|**************************
0158               dialog.save:
0159 7986 C820  54         mov   @dialog.save.vector,@trmpvector
     7988 798E     
     798A A054     
0160 798C 1040  14         jmp   _trampoline.bank3     ; Show dialog
0161               dialog.save.vector:
0162 798E 7FC4             data  vec.3
0163               
0164               
0165               ***************************************************************
...
0168               ********|*****|*********************|**************************
0169               dialog.insert:
0170 7990 C820  54         mov   @dialog.insert.vector,@trmpvector
     7992 7998     
     7994 A054     
0171 7996 103B  14         jmp   _trampoline.bank3     ; Show dialog
0172               dialog.insert.vector:
0173 7998 7FC6             data  vec.4
0174               
0175               
0176               ***************************************************************
...
0179               ********|*****|*********************|**************************
0180               dialog.print:
0181 799A C820  54         mov   @dialog.print.vector,@trmpvector
     799C 79A2     
     799E A054     
0182 79A0 1036  14         jmp   _trampoline.bank3    ; Show dialog
0183               dialog.print.vector:
0184 79A2 7FC8             data  vec.5
0185               
0186               
0187               ***************************************************************
...
0190               ********|*****|*********************|**************************
0191               dialog.file:
0192 79A4 C820  54         mov   @dialog.file.vector,@trmpvector
     79A6 79AC     
     79A8 A054     
0193 79AA 1031  14         jmp   _trampoline.bank3     ; Show dialog
0194               dialog.file.vector:
0195 79AC 7FCA             data  vec.6
0196               
0197               
0198               ***************************************************************
...
0201               ********|*****|*********************|**************************
0202               dialog.unsaved:
0203 79AE 04E0  34         clr   @cmdb.panmarkers      ; No key markers
     79B0 A724     
0204 79B2 C820  54         mov   @dialog.unsaved.vector,@trmpvector
     79B4 79BA     
     79B6 A054     
0205 79B8 102A  14         jmp   _trampoline.bank3     ; Show dialog
0206               dialog.unsaved.vector:
0207 79BA 7FCC             data  vec.7
0208               
0209               
0210               ***************************************************************
...
0215 79BC C820  54         mov   @dialog.clipboard.vector,@trmpvector
     79BE 79C4     
     79C0 A054     
0216 79C2 1025  14         jmp   _trampoline.bank3     ; Show dialog
0217               dialog.clipboard.vector:
0218 79C4 7FCE             data  vec.8
0219               
0220               
0221               ***************************************************************
...
0224               ********|*****|*********************|**************************
0225               dialog.clipdev:
0226 79C6 C820  54         mov   @dialog.clipdev.vector,@trmpvector
     79C8 79CE     
     79CA A054     
0227 79CC 1020  14         jmp   _trampoline.bank3     ; Show dialog
0228               dialog.clipdev.vector:
0229 79CE 7FD0             data  vec.9
0230               
0231               
0232               ***************************************************************
...
0235               ********|*****|*********************|**************************
0236               dialog.config:
0237 79D0 C820  54         mov   @dialog.config.vector,@trmpvector
     79D2 79D8     
     79D4 A054     
0238 79D6 101B  14         jmp   _trampoline.bank3     ; Show dialog
0239               dialog.config.vector:
0240 79D8 7FD2             data  vec.10
0241               
0242               
0243               ***************************************************************
...
0246               ********|*****|*********************|**************************
0247               dialog.append:
0248 79DA C820  54         mov   @dialog.append.vector,@trmpvector
     79DC 79E2     
     79DE A054     
0249 79E0 1016  14         jmp   _trampoline.bank3     ; Show dialog
0250               dialog.append.vector:
0251 79E2 7FD4             data  vec.11
0252               
0253               
0254               ***************************************************************
...
0259 79E4 C820  54         mov   @dialog.cartridge.vector,@trmpvector
     79E6 79EC     
     79E8 A054     
0260 79EA 1011  14         jmp   _trampoline.bank3     ; Show dialog
0261               dialog.cartridge.vector:
0262 79EC 7FD6             data  vec.12
0263               
0264               
0265               ***************************************************************
...
0268               ********|*****|*********************|**************************
0269               dialog.basic:
0270 79EE C820  54         mov   @dialog.basic.vector,@trmpvector
     79F0 79F6     
     79F2 A054     
0271 79F4 100C  14         jmp   _trampoline.bank3     ; Show dialog
0272               dialog.basic.vector:
0273 79F6 7FD8             data  vec.13
0274               
0275               
0276               ***************************************************************
...
0283                       ;------------------------------------------------------
0284 79F8 C120  34         mov   @edb.block.m2,tmp0    ; \
     79FA A50E     
0285 79FC 0584  14         inc   tmp0                  ; | Skip if M2 unset (>ffff)
0286                                                   ; /
0287 79FE 1302  14         jeq   !                     : Block mode inactive, show dialog
0288                       ;------------------------------------------------------
0289                       ; Special treatment for block mode
0290                       ;------------------------------------------------------
0291 7A00 0460  28         b     @edkey.action.block.reset
     7A02 6834     
0292                                                   ; Reset block mode
0293                       ;------------------------------------------------------
0294                       ; Show dialog
0295                       ;------------------------------------------------------
0296 7A04 C820  54 !       mov   @dialog.menu.vector,@trmpvector
     7A06 7A0C     
     7A08 A054     
0297 7A0A 1001  14         jmp   _trampoline.bank3     ; Show dialog
0298               dialog.menu.vector:
0299 7A0C 7FFA             data  vec.30
0300               
0301               
0302               
0303               ***************************************************************
...
0307 7A0E 06A0  32         bl    @pane.cursor.hide     ; Hide cursor
     7A10 74E2     
0308                       ;------------------------------------------------------
0309                       ; Call routine in specified bank
0310                       ;------------------------------------------------------
0311 7A12 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7A14 2F84     
0312 7A16 6006                   data bank3.rom        ; | i  p0 = bank address
0313 7A18 FFFF                   data >ffff            ; | i  p1 = Vector with target address
0314                                                   ; |         (deref @trmpvector)
0315 7A1A 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0316                       ;------------------------------------------------------
0317                       ; Exit
0318                       ;------------------------------------------------------
0319 7A1C 0460  28         b     @edkey.action.cmdb.show
     7A1E 69EA     
...
0326               ********|*****|*********************|**************************
0327               error.display:
0328 7A20 C820  54         mov   @error.display.vector,@trmpvector
     7A22 7A28     
     7A24 A054     
0329 7A26 103D  14         jmp   _trampoline.bank3.ret ; Longjump
0330               error.display.vector:
0331 7A28 7FE2             data  vec.18
0332               
0333               
0334               ***************************************************************
...
0339 7A2A C820  54         mov   @pane.show_hintx.vector,@trmpvector
     7A2C 7A32     
     7A2E A054     
0340 7A30 1038  14         jmp   _trampoline.bank3.ret ; Longjump
0341               pane.show_hintx.vector:
0342 7A32 7FE4             data  vec.19
0343               
0344               
0345               ***************************************************************
...
0348               ********|*****|*********************|**************************
0349               pane.cmdb.show:
0350 7A34 C820  54         mov   @pane.cmdb.show.vector,@trmpvector
     7A36 7A3C     
     7A38 A054     
0351 7A3A 1033  14         jmp   _trampoline.bank3.ret ; Longjump
0352               pane.cmdb.show.vector:
0353 7A3C 7FE6             data  vec.20
0354               
0355               
0356               ***************************************************************
...
0359               ********|*****|*********************|**************************
0360               pane.cmdb.hide:
0361 7A3E C820  54         mov   @pane.cmdb.hide.vector,@trmpvector
     7A40 7A46     
     7A42 A054     
0362 7A44 102E  14         jmp   _trampoline.bank3.ret ; Longjump
0363               pane.cmdb.hide.vector:
0364 7A46 7FE8             data  vec.21
0365               
0366               
0367               ***************************************************************
...
0370               ********|*****|*********************|**************************
0371               pane.cmdb.draw:
0372 7A48 C820  54         mov   @pane.cmdb.draw.vector,@trmpvector
     7A4A 7A50     
     7A4C A054     
0373 7A4E 1029  14         jmp   _trampoline.bank3.ret ; Longjump
0374               pane.cmdb.draw.vector:
0375 7A50 7FEA             data  vec.22
0376               
0377               
0378               ***************************************************************
...
0381               ********|*****|*********************|**************************
0382               cmdb.refresh:
0383 7A52 C820  54         mov   @cmdb.refresh.vector,@trmpvector
     7A54 7A5A     
     7A56 A054     
0384 7A58 1024  14         jmp   _trampoline.bank3.ret ; Longjump
0385               cmdb.refresh.vector:
0386 7A5A 7FEE             data  vec.24
0387               
0388               
0389               ***************************************************************
...
0392               ********|*****|*********************|**************************
0393               cmdb.cmd.clear:
0394 7A5C C820  54         mov   @cmdb.cmd.clear.vector,@trmpvector
     7A5E 7A64     
     7A60 A054     
0395 7A62 101F  14         jmp   _trampoline.bank3.ret ; Longjump
0396               cmdb.cmd.clear.vector:
0397 7A64 7FF0             data  vec.25
0398               
0399               
0400               ***************************************************************
...
0405 7A66 C820  54         mov   @cmdb.cmd.getlength.vector,@trmpvector
     7A68 7A6E     
     7A6A A054     
0406 7A6C 101A  14         jmp   _trampoline.bank3.ret ; Longjump
0407               cmdb.cmd.getlength.vector:
0408 7A6E 7FF2             data  vec.26
0409               
0410               
0411               ***************************************************************
...
0416 7A70 C820  54         mov   @cmdb.cmd.preset.vector,@trmpvector
     7A72 7A78     
     7A74 A054     
0417 7A76 1015  14         jmp   _trampoline.bank3.ret ; Longjump
0418               cmdb.cmd.preset.vector:
0419 7A78 7FF4             data  vec.27
0420               
0421               
0422               ***************************************************************
...
0425               ********|*****|*********************|**************************
0426               cmdb.cmd.set:
0427 7A7A C820  54         mov   @cmdb.cmd.set.vector,@trmpvector
     7A7C 7A82     
     7A7E A054     
0428 7A80 1010  14         jmp   _trampoline.bank3.ret ; Longjump
0429               cmdb.cmd.set.vector:
0430 7A82 7FF6             data  vec.28
0431               
0432               
0433               
0434               ***************************************************************
...
0439 7A84 C820  54         mov   @tibasic.hearts.tat.vector,@trmpvector
     7A86 7A8C     
     7A88 A054     
0440 7A8A 100B  14         jmp   _trampoline.bank3.ret ; Longjump
0441               tibasic.hearts.tat.vector:
0442 7A8C 7FF8             data  vec.29
0443               
0444               
0445               
0446               **************************************************************
...
0451 7A8E C820  54         mov   @tibasic.sid.toggle.vector,@trmpvector
     7A90 7A96     
     7A92 A054     
0452 7A94 1006  14         jmp   _trampoline.bank3.ret ; Longjump
0453               tibasic.sid.toggle.vector:
0454 7A96 7FFC             data  vec.31
0455               
0456               
0457               **************************************************************
...
0460               ********|*****|*********************|**************************
0461               fm.fastmode:
0462 7A98 C820  54         mov   @fm.fastmode.vector,@trmpvector
     7A9A 7AA0     
     7A9C A054     
0463 7A9E 1001  14         jmp   _trampoline.bank3.ret ; Longjump
0464               fm.fastmode.vector:
0465 7AA0 7FFE             data  vec.32
0466               
0467               
0468               
0469               
...
0474 7AA2 0649  14         dect  stack
0475 7AA4 C64B  30         mov   r11,*stack            ; Save return address
0476                       ;------------------------------------------------------
0477                       ; Call routine in specified bank
0478                       ;------------------------------------------------------
0479 7AA6 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7AA8 2F84     
0480 7AAA 6006                   data bank3.rom        ; | i  p0 = bank address
0481 7AAC FFFF                   data >ffff            ; | i  p1 = Vector with target address
0482                                                   ; |         (deref @trmpvector)
0483 7AAE 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0484                       ;------------------------------------------------------
0485                       ; Exit
0486                       ;------------------------------------------------------
0487 7AB0 C2F9  30         mov   *stack+,r11           ; Pop r11
0488 7AB2 045B  20         b     *r11                  ; Return to caller
0489               
0490               
0491               
0492               ***************************************************************
...
0495               ********|*****|*********************|**************************
0496               fb.tab.next:
0497 7AB4 0649  14         dect  stack
0498 7AB6 C64B  30         mov   r11,*stack            ; Save return address
0499                       ;------------------------------------------------------
0500                       ; Put cursor on next tab position
0501                       ;------------------------------------------------------
0502 7AB8 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7ABA 2F84     
0503 7ABC 6008                   data bank4.rom        ; | i  p0 = bank address
0504 7ABE 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0505 7AC0 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0506                       ;------------------------------------------------------
0507                       ; Exit
0508                       ;------------------------------------------------------
0509 7AC2 C2F9  30         mov   *stack+,r11           ; Pop r11
0510 7AC4 045B  20         b     *r11                  ; Return to caller
0511               
0512               
0513               ***************************************************************
...
0516               ********|*****|*********************|**************************
0517               fb.ruler.init:
0518 7AC6 0649  14         dect  stack
0519 7AC8 C64B  30         mov   r11,*stack            ; Save return address
0520                       ;------------------------------------------------------
0521                       ; Setup ruler in memory
0522                       ;------------------------------------------------------
0523 7ACA 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7ACC 2F84     
0524 7ACE 6008                   data bank4.rom        ; | i  p0 = bank address
0525 7AD0 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0526 7AD2 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0527                       ;------------------------------------------------------
0528                       ; Exit
0529                       ;------------------------------------------------------
0530 7AD4 C2F9  30         mov   *stack+,r11           ; Pop r11
0531 7AD6 045B  20         b     *r11                  ; Return to caller
0532               
0533               
0534               ***************************************************************
...
0537               ********|*****|*********************|**************************
0538               fb.colorlines:
0539 7AD8 0649  14         dect  stack
0540 7ADA C64B  30         mov   r11,*stack            ; Save return address
0541                       ;------------------------------------------------------
0542                       ; Colorize frame buffer content
0543                       ;------------------------------------------------------
0544 7ADC 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7ADE 2F84     
0545 7AE0 6008                   data bank4.rom        ; | i  p0 = bank address
0546 7AE2 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0547 7AE4 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0548                       ;------------------------------------------------------
0549                       ; Exit
0550                       ;------------------------------------------------------
0551 7AE6 C2F9  30         mov   *stack+,r11           ; Pop r11
0552 7AE8 045B  20         b     *r11                  ; Return to caller
0553               
0554               
0555               ***************************************************************
...
0558               ********|*****|*********************|**************************
0559               fb.vdpdump:
0560 7AEA 0649  14         dect  stack
0561 7AEC C64B  30         mov   r11,*stack            ; Save return address
0562                       ;------------------------------------------------------
0563                       ; Colorize frame buffer content
0564                       ;------------------------------------------------------
0565 7AEE 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7AF0 2F84     
0566 7AF2 6008                   data bank4.rom        ; | i  p0 = bank address
0567 7AF4 7FC6                   data vec.4            ; | i  p1 = Vector with target address
0568 7AF6 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0569                       ;------------------------------------------------------
0570                       ; Exit
0571                       ;------------------------------------------------------
0572 7AF8 C2F9  30         mov   *stack+,r11           ; Pop r11
0573 7AFA 045B  20         b     *r11                  ; Return to caller
0574               
0575               
0576               
0577               **************************************************************
...
0580               ********|*****|*********************|**************************
0581               edb.clear.sams:
0582 7AFC C820  54         mov   @edb.clear.sams.vector,@trmpvector
     7AFE 7B04     
     7B00 A054     
0583 7B02 102E  14         jmp   _trampoline.bank5.ret ; Longjump
0584               edb.clear.sams.vector:
0585 7B04 7FC0             data  vec.1
0586               
0587               
0588               **************************************************************
...
0593 7B06 C820  54         mov   @edb.hipage.alloc.vector,@trmpvector
     7B08 7B0E     
     7B0A A054     
0594 7B0C 1029  14         jmp   _trampoline.bank5.ret ; Longjump
0595               edb.hipage.alloc.vector:
0596 7B0E 7FC2             data  vec.2
0597               
0598               
0599               **************************************************************
...
0602               ********|*****|*********************|**************************
0603               edb.block.mark:
0604 7B10 C820  54         mov   @edb.block.mark.vector,@trmpvector
     7B12 7B18     
     7B14 A054     
0605 7B16 1024  14         jmp   _trampoline.bank5.ret ; Longjump
0606               edb.block.mark.vector:
0607 7B18 7FC4             data  vec.3
0608               
0609               
0610               **************************************************************
...
0615 7B1A C820  54         mov   @edb.block.mark.m1.vector,@trmpvector
     7B1C 7B22     
     7B1E A054     
0616 7B20 101F  14         jmp   _trampoline.bank5.ret ; Longjump
0617               edb.block.mark.m1.vector:
0618 7B22 7FC6             data  vec.4
0619               
0620               
0621               **************************************************************
...
0626 7B24 C820  54         mov   @edb.block.mark.m2.vector,@trmpvector
     7B26 7B2C     
     7B28 A054     
0627 7B2A 101A  14         jmp   _trampoline.bank5.ret ; Longjump
0628               edb.block.mark.m2.vector:
0629 7B2C 7FC8             data  vec.5
0630               
0631               
0632               **************************************************************
...
0635               ********|*****|*********************|**************************
0636               edb.block.clip:
0637 7B2E C820  54         mov   @edb.block.clip.vector,@trmpvector
     7B30 7B36     
     7B32 A054     
0638 7B34 1015  14         jmp   _trampoline.bank5.ret ; Longjump
0639               edb.block.clip.vector:
0640 7B36 7FCA             data  vec.6
0641               
0642               
0643               **************************************************************
...
0648 7B38 C820  54         mov   @edb.block.reset.vector,@trmpvector
     7B3A 7B40     
     7B3C A054     
0649 7B3E 1010  14         jmp   _trampoline.bank5.ret ; Longjump
0650               edb.block.reset.vector:
0651 7B40 7FCC             data  vec.7
0652               
0653               
0654               **************************************************************
...
0659 7B42 C820  54         mov   @edb.block.delete.vector,@trmpvector
     7B44 7B4A     
     7B46 A054     
0660 7B48 100B  14         jmp   _trampoline.bank5.ret ; Longjump
0661               edb.block.delete.vector:
0662 7B4A 7FCE             data  vec.8
0663               
0664               
0665               **************************************************************
...
0668               ********|*****|*********************|**************************
0669               edb.block.copy:
0670 7B4C C820  54         mov   @edb.block.copy.vector,@trmpvector
     7B4E 7B54     
     7B50 A054     
0671 7B52 1006  14         jmp   _trampoline.bank5.ret ; Longjump
0672               edb.block.copy.vector:
0673 7B54 7FD0             data  vec.9
0674               
0675               
0676               **************************************************************
...
0679               ********|*****|*********************|**************************
0680               edb.line.del:
0681 7B56 C820  54         mov   @edb.line.del.vector,@trmpvector
     7B58 7B5E     
     7B5A A054     
0682 7B5C 1001  14         jmp   _trampoline.bank5.ret ; Longjump
0683               edb.line.del.vector:
0684 7B5E 7FD2             data  vec.10
0685               
0686               
0687               
0688               ***************************************************************
...
0692 7B60 0649  14         dect  stack
0693 7B62 C64B  30         mov   r11,*stack            ; Save return address
0694                       ;------------------------------------------------------
0695                       ; Call routine in specified bank
0696                       ;------------------------------------------------------
0697 7B64 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7B66 2F84     
0698 7B68 600A                   data bank5.rom        ; | i  p0 = bank address
0699 7B6A FFFF                   data >ffff            ; | i  p1 = Vector with target address
0700                                                   ; |         (deref @trmpvector)
0701 7B6C 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0702                       ;------------------------------------------------------
0703                       ; Exit
0704                       ;------------------------------------------------------
0705 7B6E C2F9  30         mov   *stack+,r11           ; Pop r11
0706 7B70 045B  20         b     *r11                  ; Return to caller
0707               
0708               
0709               ***************************************************************
...
0714 7B72 0649  14         dect  stack
0715 7B74 C64B  30         mov   r11,*stack            ; Save return address
0716                       ;------------------------------------------------------
0717                       ; Dump VDP patterns
0718                       ;------------------------------------------------------
0719 7B76 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7B78 2F84     
0720 7B7A 600C                   data bank6.rom        ; | i  p0 = bank address
0721 7B7C 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0722 7B7E 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0723                       ;------------------------------------------------------
0724                       ; Exit
0725                       ;------------------------------------------------------
0726 7B80 C2F9  30         mov   *stack+,r11           ; Pop r11
0727 7B82 045B  20         b     *r11                  ; Return to caller
0728               
0729               
0730               
0731               ***************************************************************
...
0734               ********|*****|*********************|**************************
0735               tibasic1:
0736 7B84 0204  20         li    tmp0,1
     7B86 0001     
0737 7B88 C804  38         mov   tmp0,@tibasic.session
     7B8A A034     
0738 7B8C 1013  14         jmp   tibasic
0739               tibasic2:
0740 7B8E 0204  20         li    tmp0,2
     7B90 0002     
0741 7B92 C804  38         mov   tmp0,@tibasic.session
     7B94 A034     
0742 7B96 100E  14         jmp   tibasic
0743               tibasic3:
0744 7B98 0204  20         li    tmp0,3
     7B9A 0003     
0745 7B9C C804  38         mov   tmp0,@tibasic.session
     7B9E A034     
0746 7BA0 1009  14         jmp   tibasic
0747               tibasic4:
0748 7BA2 0204  20         li    tmp0,4
     7BA4 0004     
0749 7BA6 C804  38         mov   tmp0,@tibasic.session
     7BA8 A034     
0750 7BAA 1004  14         jmp   tibasic
0751               tibasic5:
0752 7BAC 0204  20         li    tmp0,5
     7BAE 0005     
0753 7BB0 C804  38         mov   tmp0,@tibasic.session
     7BB2 A034     
0754               tibasic:
0755 7BB4 0649  14         dect  stack
0756 7BB6 C64B  30         mov   r11,*stack            ; Save return address
0757                       ;------------------------------------------------------
0758                       ; Run TI Basic session
0759                       ;------------------------------------------------------
0760 7BB8 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7BBA 2F84     
0761 7BBC 600E                   data bank7.rom        ; | i  p0 = bank address
0762 7BBE 7FD2                   data vec.10           ; | i  p1 = Vector with target address
0763 7BC0 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0764               
0765                      ; bl    @dialog.basic         ; Refresh TI Basic dialog upon return
0766                       ;------------------------------------------------------
0767                       ; Exit
0768                       ;------------------------------------------------------
0769 7BC2 C2F9  30         mov   *stack+,r11           ; Pop r11
0770 7BC4 045B  20         b     *r11                  ; Return to caller
0771               
0772               
0773               
0774               ***************************************************************
...
0779 7BC6 0649  14         dect  stack
0780 7BC8 C64B  30         mov   r11,*stack            ; Save return address
0781                       ;------------------------------------------------------
0782                       ; Uncrunch TI basic program
0783                       ;------------------------------------------------------
0784 7BCA C820  54         mov   @w$0001,@parm1
     7BCC 2002     
     7BCE A006     
0785 7BD0 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7BD2 2F84     
0786 7BD4 600E                   data bank7.rom        ; | i  p0 = bank address
0787 7BD6 7FD4                   data vec.11           ; | i  p1 = Vector with target address
0788 7BD8 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0789                       ;------------------------------------------------------
0790                       ; Exit
0791                       ;------------------------------------------------------
0792 7BDA C2F9  30         mov   *stack+,r11           ; Pop r11
0793 7BDC 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.14478
...
0034 7BDE 0649  14         dect  stack
0035 7BE0 C64B  30         mov   r11,*stack            ; Save return address
0036                       ;------------------------------------------------------
0037                       ; Dump VDP patterns
0038                       ;------------------------------------------------------
0039 7BE2 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7BE4 2F84     
0040 7BE6 600E                   data bank7.rom        ; | i  p0 = bank address
0041 7BE8 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0042 7BEA 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0043                       ;------------------------------------------------------
0044                       ; Exit
0045                       ;------------------------------------------------------
0046 7BEC C2F9  30         mov   *stack+,r11           ; Pop r11
0047 7BEE 045B  20         b     *r11                  ; Return to caller
0049               
0050               
0052               ***************************************************************
...
0057 7BF0 0649  14         dect  stack
0058 7BF2 C64B  30         mov   r11,*stack            ; Save return address
0059                       ;------------------------------------------------------
0060                       ; Dump VDP patterns
0061                       ;------------------------------------------------------
0062 7BF4 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7BF6 2F84     
0063 7BF8 600E                   data bank7.rom        ; | i  p0 = bank address
0064 7BFA 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0065 7BFC 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0066                       ;------------------------------------------------------
0067                       ; Exit
0068                       ;------------------------------------------------------
0069 7BFE C2F9  30         mov   *stack+,r11           ; Pop r11
0070 7C00 045B  20         b     *r11                  ; Return to caller
0072               
0073               
0075               ***************************************************************
...
0080 7C02 0649  14         dect  stack
0081 7C04 C64B  30         mov   r11,*stack            ; Save return address
0082                       ;------------------------------------------------------
0083                       ; Dump VDP patterns
0084                       ;------------------------------------------------------
0085 7C06 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7C08 2F84     
0086 7C0A 600E                   data bank7.rom        ; | i  p0 = bank address
0087 7C0C 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0088 7C0E 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0089                       ;------------------------------------------------------
0090                       ; Exit
0091                       ;------------------------------------------------------
0092 7C10 C2F9  30         mov   *stack+,r11           ; Pop r11
0093 7C12 045B  20         b     *r11                  ; Return to caller
0095               
0096               
0098               ***************************************************************
...
0101               ********|*****|*********************|**************************
0102               magic.set:
0103 7C14 0649  14         dect  stack
0104 7C16 C64B  30         mov   r11,*stack            ; Save return address
0105                       ;------------------------------------------------------
0106                       ; Dump VDP patterns
0107                       ;------------------------------------------------------
0108 7C18 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7C1A 2F84     
0109 7C1C 600E                   data bank7.rom        ; | i  p0 = bank address
0110 7C1E 7FE6                   data vec.20           ; | i  p1 = Vector with target address
0111 7C20 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0112                       ;------------------------------------------------------
0113                       ; Exit
0114                       ;------------------------------------------------------
0115 7C22 C2F9  30         mov   *stack+,r11           ; Pop r11
0116 7C24 045B  20         b     *r11                  ; Return to caller
0118               
0119               
0121               ***************************************************************
...
0124               ********|*****|*********************|**************************
0125               magic.clear:
0126 7C26 0649  14         dect  stack
0127 7C28 C64B  30         mov   r11,*stack            ; Save return address
0128                       ;------------------------------------------------------
0129                       ; Dump VDP patterns
0130                       ;------------------------------------------------------
0131 7C2A 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7C2C 2F84     
0132 7C2E 600E                   data bank7.rom        ; | i  p0 = bank address
0133 7C30 7FE8                   data vec.21           ; | i  p1 = Vector with target address
0134 7C32 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0135                       ;------------------------------------------------------
0136                       ; Exit
0137                       ;------------------------------------------------------
0138 7C34 C2F9  30         mov   *stack+,r11           ; Pop r11
0139 7C36 045B  20         b     *r11                  ; Return to caller
0141               
0142               
0144               ***************************************************************
...
0147               ********|*****|*********************|**************************
0148               magic.check:
0149 7C38 0649  14         dect  stack
0150 7C3A C64B  30         mov   r11,*stack            ; Save return address
0151                       ;------------------------------------------------------
0152                       ; Dump VDP patterns
0153                       ;------------------------------------------------------
0154 7C3C 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7C3E 2F84     
0155 7C40 600E                   data bank7.rom        ; | i  p0 = bank address
0156 7C42 7FEA                   data vec.22           ; | i  p1 = Vector with target address
0157 7C44 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0158                       ;------------------------------------------------------
0159                       ; Exit
0160                       ;------------------------------------------------------
0161 7C46 C2F9  30         mov   *stack+,r11           ; Pop r11
0162 7C48 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.14478
0146                       ;-----------------------------------------------------------------------
0147                       ; Program data
0148                       ;-----------------------------------------------------------------------
...
0009                       ; Movement keys
0010                       ;-------------------------------------------------------
0011 7C4A 0D00             byte  key.enter, pane.focus.fb
0012 7C4C 667E             data  edkey.action.enter
0013               
0014 7C4E 0800             byte  key.fctn.s, pane.focus.fb
0015 7C50 6230             data  edkey.action.left
0016               
0017 7C52 0900             byte  key.fctn.d, pane.focus.fb
0018 7C54 624A             data  edkey.action.right
0019               
0020 7C56 0B00             byte  key.fctn.e, pane.focus.fb
0021 7C58 6342             data  edkey.action.up
0022               
0023 7C5A 0A00             byte  key.fctn.x, pane.focus.fb
0024 7C5C 634A             data  edkey.action.down
0025               
0026 7C5E BF00             byte  key.fctn.h, pane.focus.fb
0027 7C60 6266             data  edkey.action.home
0028               
0029 7C62 C000             byte  key.fctn.j, pane.focus.fb
0030 7C64 6290             data  edkey.action.pword
0031               
0032 7C66 C100             byte  key.fctn.k, pane.focus.fb
0033 7C68 62E2             data  edkey.action.nword
0034               
0035 7C6A C200             byte  key.fctn.l, pane.focus.fb
0036 7C6C 626E             data  edkey.action.end
0037               
0038 7C6E 0C00             byte  key.fctn.6, pane.focus.fb
0039 7C70 6352             data  edkey.action.ppage
0040               
0041 7C72 0200             byte  key.fctn.4, pane.focus.fb
0042 7C74 638E             data  edkey.action.npage
0043               
0044 7C76 8500             byte  key.ctrl.e, pane.focus.fb
0045 7C78 6352             data  edkey.action.ppage
0046               
0047 7C7A 9800             byte  key.ctrl.x, pane.focus.fb
0048 7C7C 638E             data  edkey.action.npage
0049               
0050 7C7E 7F00             byte  key.fctn.v, pane.focus.fb
0051 7C80 63E4             data  edkey.action.topscr
0052               
0053 7C82 BE00             byte  key.fctn.b, pane.focus.fb
0054 7C84 642E             data  edkey.action.botscr
0055               
0056 7C86 9600             byte  key.ctrl.v, pane.focus.fb
0057 7C88 63C8             data  edkey.action.top
0058               
0059 7C8A 8200             byte  key.ctrl.b, pane.focus.fb
0060 7C8C 63FE             data  edkey.action.bot
0061                       ;-------------------------------------------------------
0062                       ; Modifier keys - Delete
0063                       ;-------------------------------------------------------
0064 7C8E 0300             byte  key.fctn.1, pane.focus.fb
0065 7C90 64BC             data  edkey.action.del_char
0066               
0067 7C92 0700             byte  key.fctn.3, pane.focus.fb
0068 7C94 656E             data  edkey.action.del_line
0069               
0070 7C96 8C00             byte  key.ctrl.l, pane.focus.fb
0071 7C98 653A             data  edkey.action.del_eol
0072                       ;-------------------------------------------------------
0073                       ; Modifier keys - Insert
0074                       ;-------------------------------------------------------
0075 7C9A 0400             byte  key.fctn.2, pane.focus.fb
0076 7C9C 65D0             data  edkey.action.ins_char.ws
0077               
0078 7C9E B900             byte  key.fctn.dot, pane.focus.fb
0079 7CA0 6704             data  edkey.action.ins_onoff
0080               
0081 7CA2 0100             byte  key.fctn.7, pane.focus.fb
0082 7CA4 68F2             data  edkey.action.fb.tab.next
0083               
0084 7CA6 9400             byte  key.ctrl.t, pane.focus.fb
0085 7CA8 68F2             data  edkey.action.fb.tab.next
0086               
0087 7CAA 0600             byte  key.fctn.8, pane.focus.fb
0088 7CAC 6666             data  edkey.action.ins_line
0089                       ;-------------------------------------------------------
0090                       ; Block marking/modifier
0091                       ;-------------------------------------------------------
0092 7CAE F000             byte  key.ctrl.space, pane.focus.fb
0093 7CB0 682C             data  edkey.action.block.mark
0094               
0095 7CB2 8300             byte  key.ctrl.c, pane.focus.fb
0096 7CB4 67CC             data  edkey.action.copyblock_or_clipboard
0097               
0098 7CB6 8400             byte  key.ctrl.d, pane.focus.fb
0099 7CB8 687C             data  edkey.action.block.delete
0100               
0101 7CBA 8D00             byte  key.ctrl.m, pane.focus.fb
0102 7CBC 68A6             data  edkey.action.block.move
0103               
0104 7CBE 8700             byte  key.ctrl.g, pane.focus.fb
0105 7CC0 68D8             data  edkey.action.block.goto.m1
0106                       ;-------------------------------------------------------
0107                       ; Clipboards
0108                       ;-------------------------------------------------------
0109 7CC2 B100             byte  key.ctrl.1, pane.focus.fb
0110 7CC4 6900             data  edkey.action.fb.clip.save.1
0111               
0112 7CC6 B200             byte  key.ctrl.2, pane.focus.fb
0113 7CC8 6906             data  edkey.action.fb.clip.save.2
0114               
0115 7CCA B300             byte  key.ctrl.3, pane.focus.fb
0116 7CCC 690C             data  edkey.action.fb.clip.save.3
0117               
0118 7CCE B400             byte  key.ctrl.4, pane.focus.fb
0119 7CD0 6912             data  edkey.action.fb.clip.save.4
0120               
0121 7CD2 B500             byte  key.ctrl.5, pane.focus.fb
0122 7CD4 6918             data  edkey.action.fb.clip.save.5
0123                       ;-------------------------------------------------------
0124                       ; Other action keys
0125                       ;-------------------------------------------------------
0126 7CD6 0500             byte  key.fctn.plus, pane.focus.fb
0127 7CD8 67BE             data  edkey.action.quit
0128               
0129 7CDA 9100             byte  key.ctrl.q, pane.focus.fb
0130 7CDC 67BE             data  edkey.action.quit
0131               
0132 7CDE 9500             byte  key.ctrl.u, pane.focus.fb
0133 7CE0 677E             data  edkey.action.toggle.ruler
0134               
0135 7CE2 9A00             byte  key.ctrl.z, pane.focus.fb
0136 7CE4 726A             data  pane.action.colorscheme.cycle
0137               
0138 7CE6 8000             byte  key.ctrl.comma, pane.focus.fb
0139 7CE8 67DC             data  edkey.action.fb.fname.dec.load
0140               
0141 7CEA 9B00             byte  key.ctrl.dot, pane.focus.fb
0142 7CEC 67EE             data  edkey.action.fb.fname.inc.load
0143               
0144 7CEE BB00             byte  key.ctrl.slash, pane.focus.fb
0145 7CF0 79EE             data  dialog.basic
0146                       ;-------------------------------------------------------
0147                       ; Dialog keys
0148                       ;-------------------------------------------------------
0149 7CF2 8100             byte  key.ctrl.a, pane.focus.fb
0150 7CF4 79DA             data  dialog.append
0151               
0152 7CF6 8800             byte  key.ctrl.h, pane.focus.fb
0153 7CF8 7972             data  dialog.help
0154               
0155 7CFA 8600             byte  key.ctrl.f, pane.focus.fb
0156 7CFC 79A4             data  dialog.file
0157               
0158 7CFE 8900             byte  key.ctrl.i, pane.focus.fb
0159 7D00 7990             data  dialog.insert
0160               
0161 7D02 9300             byte  key.ctrl.s, pane.focus.fb
0162 7D04 7986             data  dialog.save
0163               
0164 7D06 8F00             byte  key.ctrl.o, pane.focus.fb
0165 7D08 797C             data  dialog.load
0166               
0167 7D0A 9000             byte  key.ctrl.p, pane.focus.fb
0168 7D0C 799A             data  dialog.print
0169               
0170                       ;
0171                       ; FCTN-9 has multiple purposes, if block mode is on it
0172                       ; resets the block, otherwise show dialog "Main Menu".
0173                       ;
0174 7D0E 0F00             byte  key.fctn.9, pane.focus.fb
0175 7D10 79F8             data  dialog.menu
0176                       ;-------------------------------------------------------
0177                       ; End of list
0178                       ;-------------------------------------------------------
0179 7D12 FFFF             data  EOL                           ; EOL
0180               
0181               
0182               
0183               *---------------------------------------------------------------
...
0189                       ;-------------------------------------------------------
0190 7D14 4664             byte  key.uc.f, id.dialog.menu
0191 7D16 79A4             data  dialog.file
0192               
0193 7D18 4364             byte  key.uc.c, id.dialog.menu
0194 7D1A 79E4             data  dialog.cartridge
0195               
0196 7D1C 4864             byte  key.uc.h, id.dialog.menu
0197 7D1E 7972             data  dialog.help
0198               
0199 7D20 5164             byte  key.uc.q, id.dialog.menu
0200 7D22 67BE             data  edkey.action.quit
0201                       ;-------------------------------------------------------
0202                       ; Dialog: File
0203                       ;-------------------------------------------------------
0204 7D24 4E69             byte  key.uc.n, id.dialog.file
0205 7D26 69FC             data  edkey.action.cmdb.file.new
0206               
0207 7D28 5369             byte  key.uc.s, id.dialog.file
0208 7D2A 7986             data  dialog.save
0209               
0210 7D2C 4F69             byte  key.uc.o, id.dialog.file
0211 7D2E 797C             data  dialog.load
0212               
0213 7D30 5069             byte  key.uc.p, id.dialog.file
0214 7D32 799A             data  dialog.print
0215               
0216 7D34 4369             byte  key.uc.c, id.dialog.file
0217 7D36 79D0             data  dialog.config
0218                       ;-------------------------------------------------------
0219                       ; Dialog: Open file
0220                       ;-------------------------------------------------------
0221 7D38 0E0A             byte  key.fctn.5, id.dialog.load
0222 7D3A 6D18             data  edkey.action.cmdb.fastmode.toggle
0223               
0224 7D3C 0D0A             byte  key.enter, id.dialog.load
0225 7D3E 6A20             data  edkey.action.cmdb.load
0226                       ;-------------------------------------------------------
0227                       ; Dialog: Insert file at line ...
0228                       ;-------------------------------------------------------
0229 7D40 0E0D             byte  key.fctn.5, id.dialog.insert
0230 7D42 6D18             data  edkey.action.cmdb.fastmode.toggle
0231               
0232 7D44 0D0D             byte  key.enter, id.dialog.insert
0233 7D46 6A64             data  edkey.action.cmdb.insert
0234                       ;-------------------------------------------------------
0235                       ; Dialog: Append file
0236                       ;-------------------------------------------------------
0237 7D48 0E0E             byte  key.fctn.5, id.dialog.append
0238 7D4A 6D18             data  edkey.action.cmdb.fastmode.toggle
0239               
0240 7D4C 0D0E             byte  key.enter, id.dialog.append
0241 7D4E 6AE6             data  edkey.action.cmdb.append
0242                       ;-------------------------------------------------------
0243                       ; Dialog: Copy clipboard to line ...
0244                       ;-------------------------------------------------------
0245 7D50 0E67             byte  key.fctn.5, id.dialog.clipboard
0246 7D52 6D18             data  edkey.action.cmdb.fastmode.toggle
0247               
0248 7D54 0167             byte  key.fctn.7, id.dialog.clipboard
0249 7D56 79C6             data  dialog.clipdev
0250               
0251 7D58 3167             byte  key.num.1, id.dialog.clipboard
0252 7D5A 6B5A             data  edkey.action.cmdb.clip.1
0253               
0254 7D5C 3267             byte  key.num.2, id.dialog.clipboard
0255 7D5E 6B60             data  edkey.action.cmdb.clip.2
0256               
0257 7D60 3367             byte  key.num.3, id.dialog.clipboard
0258 7D62 6B66             data  edkey.action.cmdb.clip.3
0259               
0260 7D64 3467             byte  key.num.4, id.dialog.clipboard
0261 7D66 6B6C             data  edkey.action.cmdb.clip.4
0262               
0263 7D68 3567             byte  key.num.5, id.dialog.clipboard
0264 7D6A 6B72             data  edkey.action.cmdb.clip.5
0265                       ;-------------------------------------------------------
0266                       ; Dialog: Configure clipboard device
0267                       ;-------------------------------------------------------
0268 7D6C 0D11             byte  key.enter, id.dialog.clipdev
0269 7D6E 6BA6             data  edkey.action.cmdb.clipdev.configure
0270                       ;-------------------------------------------------------
0271                       ; Dialog: Configure
0272                       ;-------------------------------------------------------
0273 7D70 436C             byte  key.uc.c, id.dialog.config
0274 7D72 79C6             data  dialog.clipdev
0275                       ;-------------------------------------------------------
0276                       ; Dialog: Save file
0277                       ;-------------------------------------------------------
0278 7D74 0D0B             byte  key.enter, id.dialog.save
0279 7D76 6BF6             data  edkey.action.cmdb.save
0280               
0281 7D78 0D0C             byte  key.enter, id.dialog.saveblock
0282 7D7A 6BF6             data  edkey.action.cmdb.save
0283                       ;-------------------------------------------------------
0284                       ; Dialog: Print file
0285                       ;-------------------------------------------------------
0286 7D7C 0D0F             byte  key.enter, id.dialog.print
0287 7D7E 6C72             data  edkey.action.cmdb.print
0288               
0289 7D80 0D10             byte  key.enter, id.dialog.printblock
0290 7D82 6C72             data  edkey.action.cmdb.print
0291                       ;-------------------------------------------------------
0292                       ; Dialog: Unsaved changes
0293                       ;-------------------------------------------------------
0294 7D84 0C65             byte  key.fctn.6, id.dialog.unsaved
0295 7D86 6CEE             data  edkey.action.cmdb.proceed
0296               
0297 7D88 2065             byte  key.space, id.dialog.unsaved
0298 7D8A 6CEE             data  edkey.action.cmdb.proceed
0299               
0300 7D8C 0D65             byte  key.enter, id.dialog.unsaved
0301 7D8E 7986             data  dialog.save
0302                       ;-------------------------------------------------------
0303                       ; Dialog: Cartridge
0304                       ;-------------------------------------------------------
0305 7D90 426A             byte  key.uc.b, id.dialog.cartridge
0306 7D92 79EE             data  dialog.basic
0307                       ;-------------------------------------------------------
0308                       ; Dialog: Basic
0309                       ;-------------------------------------------------------
0310 7D94 316B             byte  key.num.1, id.dialog.basic
0311 7D96 7B84             data  tibasic1
0312               
0313 7D98 326B             byte  key.num.2, id.dialog.basic
0314 7D9A 7B8E             data  tibasic2
0315               
0316 7D9C 336B             byte  key.num.3, id.dialog.basic
0317 7D9E 7B98             data  tibasic3
0318               
0319 7DA0 346B             byte  key.num.4, id.dialog.basic
0320 7DA2 7BA2             data  tibasic4
0321               
0322 7DA4 356B             byte  key.num.5, id.dialog.basic
0323 7DA6 7BAC             data  tibasic5
0324               
0325 7DA8 0E6B             byte  key.fctn.5, id.dialog.basic
0326 7DAA 6D24             data  edkey.action.cmdb.sid.toggle
0327               
0328 7DAC B16B             byte  key.ctrl.1, id.dialog.basic
0329 7DAE 7BC6             data  tibasic.uncrunch
0330                       ;-------------------------------------------------------
0331                       ; Dialog: Help
0332                       ;-------------------------------------------------------
0333 7DB0 2068             byte  key.space, id.dialog.help
0334 7DB2 795E             data  dialog.help.next
0335               
0336 7DB4 0F68             byte  key.fctn.9, id.dialog.help
0337 7DB6 6D38             data  edkey.action.cmdb.close.about
0338               
0339 7DB8 0D68             byte  key.enter, id.dialog.help
0340 7DBA 6D38             data  edkey.action.cmdb.close.about
0341                       ;-------------------------------------------------------
0342                       ; Movement keys
0343                       ;-------------------------------------------------------
0344 7DBC 0801             byte  key.fctn.s, pane.focus.cmdb
0345 7DBE 6930             data  edkey.action.cmdb.left
0346               
0347 7DC0 0901             byte  key.fctn.d, pane.focus.cmdb
0348 7DC2 6942             data  edkey.action.cmdb.right
0349               
0350 7DC4 BF01             byte  key.fctn.h, pane.focus.cmdb
0351 7DC6 695A             data  edkey.action.cmdb.home
0352               
0353 7DC8 C201             byte  key.fctn.l, pane.focus.cmdb
0354 7DCA 696E             data  edkey.action.cmdb.end
0355                       ;-------------------------------------------------------
0356                       ; Modifier keys
0357                       ;-------------------------------------------------------
0358 7DCC 0701             byte  key.fctn.3, pane.focus.cmdb
0359 7DCE 6986             data  edkey.action.cmdb.clear
0360                       ;-------------------------------------------------------
0361                       ; Other action keys
0362                       ;-------------------------------------------------------
0363 7DD0 0F01             byte  key.fctn.9, pane.focus.cmdb
0364 7DD2 6D48             data  edkey.action.cmdb.close.dialog
0365               
0366 7DD4 0501             byte  key.fctn.plus, pane.focus.cmdb
0367 7DD6 67BE             data  edkey.action.quit
0368               
0369 7DD8 8101             byte  key.ctrl.a, pane.focus.cmdb
0370 7DDA 6D30             data  edkey.action.cmdb.preset
0371               
0372 7DDC 8201             byte  key.ctrl.b, pane.focus.cmdb
0373 7DDE 6D30             data  edkey.action.cmdb.preset
0374               
0375 7DE0 8301             byte  key.ctrl.c, pane.focus.cmdb
0376 7DE2 6D30             data  edkey.action.cmdb.preset
0377               
0378 7DE4 9A01             byte  key.ctrl.z, pane.focus.cmdb
0379 7DE6 726A             data  pane.action.colorscheme.cycle
0380                       ;------------------------------------------------------
0381                       ; End of list
0382                       ;-------------------------------------------------------
0383 7DE8 FFFF             data  EOL                           ; EOL
                   < stevie_b1.asm.14478
0150                       ;-----------------------------------------------------------------------
...
0028 7FD2 702C     vec.10  data  edb.line.pack.fb      ;
0029 7FD4 7124     vec.11  data  edb.line.unpack.fb    ;
0030 7FD6 7AFC     vec.12  data  edb.clear.sams        ;
0031 7FD8 2026     vec.13  data  cpu.crash             ;
0032 7FDA 2026     vec.14  data  cpu.crash             ;
0033 7FDC 69EA     vec.15  data  edkey.action.cmdb.show
0034 7FDE 2026     vec.16  data  cpu.crash             ;
0035 7FE0 2026     vec.17  data  cpu.crash             ;
0036 7FE2 2026     vec.18  data  cpu.crash             ;
0037 7FE4 7A5C     vec.19  data  cmdb.cmd.clear        ;
0038 7FE6 6F80     vec.20  data  fb.refresh            ;
0039 7FE8 7AEA     vec.21  data  fb.vdpdump            ;
0040 7FEA 6D5C     vec.22  data  fb.row2line           ;
...
0045 7FF4 76BC     vec.27  data  pane.errline.hide     ;
0046 7FF6 7500     vec.28  data  pane.cursor.blink     ;
0047 7FF8 74E2     vec.29  data  pane.cursor.hide      ;
0048 7FFA 765A     vec.30  data  pane.errline.show     ;
0049 7FFC 72C8     vec.31  data  pane.action.colorscheme.load
0050 7FFE 74C8     vec.32  data  pane.action.colorscheme.statlines
                   < stevie_b1.asm.14478
