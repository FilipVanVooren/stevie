...
0008               ***************************************************************
0009               * File: stevie_b1.asm               ; Version 220103-2028000
0010               *
0011               * Bank 1 "James"
0012               * Editor core
0013               ***************************************************************
...
0270 21ED   42             text  'Build-ID  220103-2028000'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0012                       ;------------------------------------------------------
0013 715C 06A0  32         bl    @pane.vdpdump
     715E 7766     
0014                       ;------------------------------------------------------
0015                       ; Exit task
0016                       ;------------------------------------------------------
0017               task.vdp.panes.exit:
0018 7160 C2F9  30         mov   *stack+,r11           ; Pop r11
0019 7162 0460  28         b     @slotok
     7164 2F52     
                   < stevie_b1.asm.24106
0120               
0125                       copy  "task.vdp.cursor.9938.asm"    ; Set cursor shape in VDP (blink)
...
0008 7166 0649  14         dect  stack
0009 7168 C64B  30         mov   r11,*stack            ; Save return address
0010 716A 0649  14         dect  stack
0011 716C C644  30         mov   tmp0,*stack           ; Push tmp0
0012 716E 0649  14         dect  stack
0013 7170 C645  30         mov   tmp1,*stack           ; Push tmp1
0014 7172 0649  14         dect  stack
0015 7174 C660  46         mov   @wyx,*stack           ; Push cursor position
     7176 832A     
0016               
0017 7178 C120  34         mov   @wyx,tmp0
     717A 832A     
0018 717C 0224  22         ai    tmp0,>0100
     717E 0100     
0019 7180 C804  38         mov   tmp0,@wyx
     7182 832A     
0020                       ;------------------------------------------------------
0021                       ; Toggle cursor
0022                       ;------------------------------------------------------
0023 7184 0560  34         inv   @fb.curtoggle         ; Flip cursor shape flag
     7186 A312     
0024 7188 1303  14         jeq   task.vdp.cursor.visible
0025                       ;------------------------------------------------------
0026                       ; Hide cursor
0027                       ;------------------------------------------------------
0028 718A 0720  34         seto  @fb.dirty             ; Refresh frame buffer
     718C A316     
0029 718E 1006  14         jmp   task.vdp.cursor.exit
0030                       ;------------------------------------------------------
0031                       ; Show cursor
0032                       ;------------------------------------------------------
0033               task.vdp.cursor.visible:
0034 7190 0205  20         li    tmp1,26               ; Cursor
     7192 001A     
0035                       ;------------------------------------------------------
0036                       ; Dump byte to VDP
0037                       ;------------------------------------------------------
0038               task.vdp.cursor.dump:
0039 7194 06A0  32         bl    @yx2pnt               ; Calculate VDP address from @WYX
     7196 240E     
0040                                                   ; \ i  @wyx = Cursor position
0041                                                   ; / o  tmp0 = VDP write address
0042               
0043 7198 06A0  32         bl    @xvputb               ; VDP put single byte
     719A 22E0     
0044                                                   ; \ i  tmp0 = VDP write address
0045                                                   ; / i  tmp1 = Byte to write
0046                       ;------------------------------------------------------
0047                       ; Exit
0048                       ;------------------------------------------------------
0049               task.vdp.cursor.exit:
0050 719C C839  50         mov   *stack+,@wyx          ; Pop cursor position
     719E 832A     
0051 71A0 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0052 71A2 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0053 71A4 C2F9  30         mov   *stack+,r11           ; Pop r11
0054 71A6 0460  28         b     @slotok               ; Exit task
     71A8 2F52     
                   < stevie_b1.asm.24106
0127               
...
0007               
0008               task.oneshot:
0009 71AA C120  34         mov   @tv.task.oneshot,tmp0  ; Get pointer to one-shot task
     71AC A224     
0010 71AE 1301  14         jeq   task.oneshot.exit
0011               
0012 71B0 0694  24         bl    *tmp0                  ; Execute one-shot task
0013                       ;------------------------------------------------------
0014                       ; Exit
0015                       ;------------------------------------------------------
0016               task.oneshot.exit:
0017 71B2 0460  28         b     @slotok                ; Exit task
     71B4 2F52     
                   < stevie_b1.asm.24106
0129                       ;-----------------------------------------------------------------------
...
0022 71BA 0649  14         dect  stack
0023 71BC C644  30         mov   tmp0,*stack           ; Push tmp0
0024               
0025 71BE C120  34         mov   @tv.colorscheme,tmp0  ; Load color scheme index
     71C0 A212     
0026 71C2 0284  22         ci    tmp0,tv.colorscheme.entries
     71C4 000A     
0027                                                   ; Last entry reached?
0028 71C6 1103  14         jlt   !
0029 71C8 0204  20         li    tmp0,1                ; Reset color scheme index
     71CA 0001     
0030 71CC 1001  14         jmp   pane.action.colorscheme.switch
0031 71CE 0584  14 !       inc   tmp0
0032                       ;-------------------------------------------------------
0033                       ; Switch to new color scheme
0034                       ;-------------------------------------------------------
0035               pane.action.colorscheme.switch:
0036 71D0 C804  38         mov   tmp0,@tv.colorscheme  ; Save index of color scheme
     71D2 A212     
0037               
0038 71D4 06A0  32         bl    @pane.action.colorscheme.load
     71D6 7214     
0039                                                   ; Load current color scheme
0040                       ;-------------------------------------------------------
0041                       ; Show current color palette message
0042                       ;-------------------------------------------------------
0043 71D8 C820  54         mov   @wyx,@waux1           ; Save cursor YX position
     71DA 832A     
     71DC 833C     
0044               
0045 71DE 06A0  32         bl    @putnum
     71E0 2B32     
0046 71E2 003E                   byte 0,62
0047 71E4 A212                   data tv.colorscheme,rambuf,>3020
     71E6 A100     
     71E8 3020     
0048               
0049 71EA 06A0  32         bl    @putat
     71EC 2456     
0050 71EE 0034                   byte 0,52
0051 71F0 3A5A                   data txt.colorscheme  ; Show color palette message
0052               
0053 71F2 C820  54         mov   @waux1,@wyx           ; Restore cursor YX position
     71F4 833C     
     71F6 832A     
0054                       ;-------------------------------------------------------
0055                       ; Delay
0056                       ;-------------------------------------------------------
0057 71F8 0204  20         li    tmp0,12000
     71FA 2EE0     
0058 71FC 0604  14 !       dec   tmp0
0059 71FE 16FE  14         jne   -!
0060                       ;-------------------------------------------------------
0061                       ; Setup one shot task for removing message
0062                       ;-------------------------------------------------------
0063 7200 0204  20         li    tmp0,pane.topline.oneshot.clearmsg
     7202 36AA     
0064 7204 C804  38         mov   tmp0,@tv.task.oneshot
     7206 A224     
0065               
0066 7208 06A0  32         bl    @rsslot               ; \ Reset loop counter slot 3
     720A 2FC6     
0067 720C 0003                   data 3                ; / for getting consistent delay
0068                       ;-------------------------------------------------------
0069                       ; Exit
0070                       ;-------------------------------------------------------
0071               pane.action.colorscheme.cycle.exit:
0072 720E C139  30         mov   *stack+,tmp0          ; Pop tmp0
0073 7210 C2F9  30         mov   *stack+,r11           ; Pop R11
0074 7212 045B  20         b     *r11                  ; Return to caller
0075               
0076               
0077               
0078               ***************************************************************
...
0097 7214 0649  14         dect  stack
0098 7216 C64B  30         mov   r11,*stack            ; Save return address
0099 7218 0649  14         dect  stack
0100 721A C644  30         mov   tmp0,*stack           ; Push tmp0
0101 721C 0649  14         dect  stack
0102 721E C645  30         mov   tmp1,*stack           ; Push tmp1
0103 7220 0649  14         dect  stack
0104 7222 C646  30         mov   tmp2,*stack           ; Push tmp2
0105 7224 0649  14         dect  stack
0106 7226 C647  30         mov   tmp3,*stack           ; Push tmp3
0107 7228 0649  14         dect  stack
0108 722A C648  30         mov   tmp4,*stack           ; Push tmp4
0109 722C 0649  14         dect  stack
0110 722E C660  46         mov   @parm1,*stack         ; Push parm1
     7230 A000     
0111 7232 0649  14         dect  stack
0112 7234 C660  46         mov   @parm2,*stack         ; Push parm2
     7236 A002     
0113 7238 0649  14         dect  stack
0114 723A C660  46         mov   @parm3,*stack         ; Push parm3
     723C A004     
0115                       ;-------------------------------------------------------
0116                       ; Turn screen off
0117                       ;-------------------------------------------------------
0118 723E C120  34         mov   @parm1,tmp0
     7240 A000     
0119 7242 0284  22         ci    tmp0,>ffff            ; Skip flag set?
     7244 FFFF     
0120 7246 1302  14         jeq   !                     ; Yes, so skip screen off
0121 7248 06A0  32         bl    @scroff               ; Turn screen off
     724A 269A     
0122                       ;-------------------------------------------------------
0123                       ; Get FG/BG colors framebuffer text
0124                       ;-------------------------------------------------------
0125 724C C120  34 !       mov   @tv.colorscheme,tmp0  ; Get color scheme index
     724E A212     
0126 7250 0604  14         dec   tmp0                  ; Internally work with base 0
0127               
0128 7252 0A34  56         sla   tmp0,3                ; Offset into color scheme data table
0129 7254 0224  22         ai    tmp0,tv.colorscheme.table
     7256 36F6     
0130                                                   ; Add base for color scheme data table
0131 7258 C1F4  30         mov   *tmp0+,tmp3           ; Get colors ABCD
0132 725A C807  38         mov   tmp3,@tv.color        ; Save colors ABCD
     725C A218     
0133                       ;-------------------------------------------------------
0134                       ; Get and save cursor color
0135                       ;-------------------------------------------------------
0136 725E C214  26         mov   *tmp0,tmp4            ; Get colors EFGH
0137 7260 0248  22         andi  tmp4,>00ff            ; Only keep LSB (GH)
     7262 00FF     
0138 7264 C808  38         mov   tmp4,@tv.curcolor     ; Save cursor color
     7266 A216     
0139                       ;-------------------------------------------------------
0140                       ; Get FG/BG colors framebuffer marked text & CMDB pane
0141                       ;-------------------------------------------------------
0142 7268 C234  30         mov   *tmp0+,tmp4           ; Get colors EFGH again
0143 726A 0248  22         andi  tmp4,>ff00            ; Only keep MSB (EF)
     726C FF00     
0144 726E 0988  56         srl   tmp4,8                ; MSB to LSB
0145               
0146 7270 C174  30         mov   *tmp0+,tmp1           ; Get colors IJKL
0147 7272 C185  18         mov   tmp1,tmp2             ; \ Right align IJ and
0148 7274 0986  56         srl   tmp2,8                ; | save to @tv.busycolor
0149 7276 C806  38         mov   tmp2,@tv.busycolor    ; /
     7278 A21C     
0150               
0151 727A 0245  22         andi  tmp1,>00ff            ; | save KL to @tv.markcolor
     727C 00FF     
0152 727E C805  38         mov   tmp1,@tv.markcolor    ; /
     7280 A21A     
0153               
0154 7282 C154  26         mov   *tmp0,tmp1            ; Get colors MNOP
0155 7284 0985  56         srl   tmp1,8                ; \ Right align MN and
0156 7286 C805  38         mov   tmp1,@tv.cmdb.hcolor  ; / save to @tv.cmdb.hcolor
     7288 A220     
0157                       ;-------------------------------------------------------
0158                       ; Check if only CMDB needs to be colorized
0159                       ;-------------------------------------------------------
0160 728A 8820  54         c     @parm3,@w$ffff        ; Only colorize CMDB pane ?
     728C A004     
     728E 2022     
0161 7290 133E  14         jeq   pane.action.colorscheme.cmdbpane
0162                                                   ; Yes, shortcut jump to CMDB pane
0163                       ;-------------------------------------------------------
0164                       ; Get FG color for ruler
0165                       ;-------------------------------------------------------
0166 7292 C154  26         mov   *tmp0,tmp1            ; Get colors MNOP
0167 7294 0245  22         andi  tmp1,>000f            ; Only keep P
     7296 000F     
0168 7298 0A45  56         sla   tmp1,4                ; Make it a FG/BG combination
0169 729A C805  38         mov   tmp1,@tv.rulercolor   ; Save to @tv.rulercolor
     729C A21E     
0170                       ;-------------------------------------------------------
0171                       ; Write sprite color of line and column indicators to SAT
0172                       ;-------------------------------------------------------
0173 729E C154  26         mov   *tmp0,tmp1            ; Get colors MNOP
0174 72A0 0245  22         andi  tmp1,>00f0            ; Only keep O
     72A2 00F0     
0175 72A4 0A45  56         sla   tmp1,4                ; Move O to MSB
0176 72A6 D805  38         movb  tmp1,@ramsat+7        ; Line indicator FG color to SAT
     72A8 A043     
0177 72AA D805  38         movb  tmp1,@ramsat+11       ; Column indicator FG color to SAT
     72AC A047     
0178                       ;-------------------------------------------------------
0179                       ; Dump colors to VDP register 7 (text mode)
0180                       ;-------------------------------------------------------
0181 72AE C147  18         mov   tmp3,tmp1             ; Get work copy
0182 72B0 0985  56         srl   tmp1,8                ; MSB to LSB (frame buffer colors)
0183 72B2 0265  22         ori   tmp1,>0700
     72B4 0700     
0184 72B6 C105  18         mov   tmp1,tmp0
0185 72B8 06A0  32         bl    @putvrx               ; Write VDP register
     72BA 2348     
0186                       ;-------------------------------------------------------
0187                       ; Dump colors for frame buffer pane (TAT)
0188                       ;-------------------------------------------------------
0189 72BC C120  34         mov   @tv.ruler.visible,tmp0
     72BE A210     
0190 72C0 130A  14         jeq   pane.action.colorscheme.fbdump.noruler
0191               
0192 72C2 C120  34         mov   @cmdb.dialog,tmp0
     72C4 A71A     
0193 72C6 0284  22         ci    tmp0,id.dialog.help   ; Help dialog active?
     72C8 0068     
0194 72CA 1305  14         jeq   pane.action.colorscheme.fbdump.noruler
0195                                                   ; Yes, skip ruler
0196                       ;-------------------------------------------------------
0197                       ; Ruler visible on screen (TAT)
0198                       ;-------------------------------------------------------
0199 72CC 0204  20         li    tmp0,vdp.fb.toprow.tat+80
     72CE 18A0     
0200                                                   ; VDP start address (frame buffer area)
0201               
0202 72D0 0206  20         li    tmp2,(pane.botrow-2)*80
     72D2 0690     
0203                                                   ; Number of bytes to fill
0204 72D4 1004  14         jmp   pane.action.colorscheme.checkcmdb
0205               
0206               pane.action.colorscheme.fbdump.noruler:
0207                       ;-------------------------------------------------------
0208                       ; No ruler visible on screen (TAT)
0209                       ;-------------------------------------------------------
0210 72D6 0204  20         li    tmp0,vdp.fb.toprow.tat
     72D8 1850     
0211                                                   ; VDP start address (frame buffer area)
0212 72DA 0206  20         li    tmp2,(pane.botrow-1)*80
     72DC 06E0     
...
0218 72DE C820  54         mov   @cmdb.visible,@cmdb.visible
     72E0 A702     
     72E2 A702     
0219 72E4 1302  14         jeq   pane.action.colorscheme.fbdump
0220                                                   ; Not visible, skip adjustment
0221 72E6 0226  22         ai    tmp2,-320             ; CMDB adjustment
     72E8 FEC0     
0222                       ;-------------------------------------------------------
0223                       ; Dump colors to VDP (TAT)
0224                       ;-------------------------------------------------------
0225               pane.action.colorscheme.fbdump:
0226 72EA C147  18         mov   tmp3,tmp1             ; Get work copy of colors ABCD
0227 72EC 0985  56         srl   tmp1,8                ; MSB to LSB (frame buffer colors)
0228               
0229 72EE 06A0  32         bl    @xfilv                ; Fill colors
     72F0 22A8     
...
0235                       ;-------------------------------------------------------
0236 72F2 C120  34         mov   @cmdb.dialog,tmp0
     72F4 A71A     
0237 72F6 0284  22         ci    tmp0,id.dialog.help   ; Help dialog active?
     72F8 0068     
0238 72FA 1309  14         jeq   pane.action.colorscheme.cmdbpane
0239                                                   ; Yes, skip marked lines
0240               
0241 72FC C120  34         mov   @parm2,tmp0
     72FE A002     
0242 7300 0284  22         ci    tmp0,>ffff            ; Skip colorize flag is on?
     7302 FFFF     
0243 7304 1304  14         jeq   pane.action.colorscheme.cmdbpane
0244               
0245 7306 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     7308 A310     
0246 730A 06A0  32         bl    @fb.colorlines
     730C 79F8     
0247                       ;-------------------------------------------------------
0248                       ; Dump colors for CMDB header line (TAT)
0249                       ;-------------------------------------------------------
0250               pane.action.colorscheme.cmdbpane:
0251 730E C120  34         mov   @cmdb.visible,tmp0
     7310 A702     
0252 7312 1330  14         jeq   pane.action.colorscheme.errpane
0253                                                   ; Skip if CMDB pane is hidden
0254               
0255 7314 0204  20         li    tmp0,vdp.cmdb.toprow.tat
     7316 1DF0     
0256                                                   ; VDP start address (CMDB top line)
0257               
0258 7318 C160  34         mov   @tv.cmdb.hcolor,tmp1  ; set color for header line
     731A A220     
0259 731C 0206  20         li    tmp2,1*67             ; Number of bytes to fill
     731E 0043     
0260 7320 06A0  32         bl    @xfilv                ; Fill colors
     7322 22A8     
...
0266                       ;-------------------------------------------------------
0267 7324 0204  20         li    tmp0,vdp.cmdb.toprow.tat+67
     7326 1E33     
0268 7328 C160  34         mov   @tv.cmdb.hcolor,tmp1  ;
     732A A220     
0269 732C D160  34         movb  @tv.cmdb.hcolor+1,tmp1
     732E A221     
0270                                                   ; Copy same value into MSB
0271 7330 0945  56         srl   tmp1,4                ;
0272 7332 0245  22         andi  tmp1,>00ff            ; Only keep LSB
     7334 00FF     
0273               
0274 7336 0206  20         li    tmp2,13               ; Number of bytes to fill
     7338 000D     
0275 733A 06A0  32         bl    @xfilv                ; Fill colors
     733C 22A8     
...
0281                       ;-------------------------------------------------------
0282 733E 0204  20         li    tmp0,vdp.cmdb.toprow.tat + 80
     7340 1E40     
0283                                                   ; VDP start address (CMDB top line + 1)
0284 7342 C148  18         mov   tmp4,tmp1             ; Get work copy fg/bg color
0285 7344 0206  20         li    tmp2,1*80             ; Number of bytes to fill
     7346 0050     
0286 7348 06A0  32         bl    @xfilv                ; Fill colors
     734A 22A8     
0287                                                   ; i \  tmp0 = start address
0288                                                   ; i |  tmp1 = byte to fill
0289                                                   ; i /  tmp2 = number of bytes to fill
0290               
0291 734C 0204  20         li    tmp0,vdp.cmdb.toprow.tat + 160
     734E 1E90     
0292                                                   ; VDP start address (CMDB top line + 2)
0293 7350 C160  34         mov   @tv.cmdb.hcolor,tmp1  ; Same color as header line
     7352 A220     
0294 7354 0206  20         li    tmp2,1*80             ; Number of bytes to fill
     7356 0050     
0295 7358 06A0  32         bl    @xfilv                ; Fill colors
     735A 22A8     
0296                                                   ; i \  tmp0 = start address
0297                                                   ; i |  tmp1 = byte to fill
0298                                                   ; i /  tmp2 = number of bytes to fill
0299               
0300 735C 0204  20         li    tmp0,vdp.cmdb.toprow.tat + 240
     735E 1EE0     
0301                                                   ; VDP start address (CMDB top line + 3)
0302 7360 C148  18         mov   tmp4,tmp1             ; Get work copy fg/bg color
0303 7362 0206  20         li    tmp2,1*80             ; Number of bytes to fill
     7364 0050     
0304 7366 06A0  32         bl    @xfilv                ; Fill colors
     7368 22A8     
...
0310                       ;-------------------------------------------------------
0311 736A C120  34         mov   @parm3,tmp0
     736C A004     
0312 736E 0284  22         ci    tmp0,>ffff            ; Only colorize CMDB pane ?
     7370 FFFF     
0313 7372 132F  14         jeq   pane.action.colorscheme.cursorcolor.cmdb
0314                                                   ; Yes, shortcut to CMDB cursor color
0315                       ;-------------------------------------------------------
0316                       ; Dump colors for error pane (TAT)
0317                       ;-------------------------------------------------------
0318               pane.action.colorscheme.errpane:
0319 7374 C120  34         mov   @tv.error.visible,tmp0
     7376 A228     
0320 7378 1306  14         jeq   pane.action.colorscheme.statline
0321                                                   ; Skip if error pane is hidden
0322               
0323 737A 0205  20         li    tmp1,>00f6            ; White on dark red
     737C 00F6     
0324 737E C805  38         mov   tmp1,@parm1           ; Pass color combination
     7380 A000     
0325               
0326 7382 06A0  32         bl    @pane.errline.drawcolor
     7384 7566     
...
0334 7386 C160  34         mov   @tv.color,tmp1
     7388 A218     
0335 738A 0245  22         andi  tmp1,>00ff            ; Only keep LSB (status line colors)
     738C 00FF     
0336 738E C805  38         mov   tmp1,@parm1           ; Set color combination
     7390 A000     
0337               
0338               
0339 7392 04E0  34         clr   @parm2                ; Top row on screen
     7394 A002     
0340 7396 06A0  32         bl    @colors.line.set      ; Load color combination for line
     7398 745A     
0341                                                   ; \ i  @parm1 = Color combination
0342                                                   ; / i  @parm2 = Row on physical screen
0343               
0344 739A 0205  20         li    tmp1,pane.botrow
     739C 0017     
0345 739E C805  38         mov   tmp1,@parm2           ; Bottom row on screen
     73A0 A002     
0346 73A2 06A0  32         bl    @colors.line.set      ; Load color combination for line
     73A4 745A     
...
0351                       ;-------------------------------------------------------
0352 73A6 C160  34         mov   @cmdb.dialog,tmp1
     73A8 A71A     
0353 73AA 0285  22         ci    tmp1,id.dialog.help   ; Help dialog active?
     73AC 0068     
0354 73AE 130A  14         jeq   pane.action.colorscheme.cursorcolor
0355                                                   ; Yes, skip ruler
0356               
0357 73B0 C160  34         mov   @tv.ruler.visible,tmp1
     73B2 A210     
0358 73B4 1307  14         jeq   pane.action.colorscheme.cursorcolor
0359               
0360 73B6 06A0  32         bl    @fb.ruler.init        ; Setup ruler with tab-positions in memory
     73B8 79E6     
0361 73BA 06A0  32         bl    @cpym2v
     73BC 249A     
0362 73BE 1850                   data vdp.fb.toprow.tat
0363 73C0 A36E                   data fb.ruler.tat
0364 73C2 0050                   data 80               ; Show ruler colors
0365                       ;-------------------------------------------------------
0366                       ; Dump cursor FG color to sprite table (SAT)
0367                       ;-------------------------------------------------------
0368               pane.action.colorscheme.cursorcolor:
0369 73C4 C220  34         mov   @tv.curcolor,tmp4     ; Get cursor color
     73C6 A216     
0370               
0371 73C8 C120  34         mov   @tv.pane.focus,tmp0   ; Get pane with focus
     73CA A222     
0372 73CC 0284  22         ci    tmp0,pane.focus.fb    ; Frame buffer has focus?
     73CE 0000     
0373 73D0 1304  14         jeq   pane.action.colorscheme.cursorcolor.fb
0374                                                   ; Yes, set cursor color
0375               
0376               pane.action.colorscheme.cursorcolor.cmdb:
0377 73D2 0248  22         andi  tmp4,>f0              ; Only keep high-nibble -> Word 2 (G)
     73D4 00F0     
0378 73D6 0A48  56         sla   tmp4,4                ; Move to MSB
0379 73D8 1003  14         jmp   !
0380               
0381               pane.action.colorscheme.cursorcolor.fb:
0382 73DA 0248  22         andi  tmp4,>0f              ; Only keep low-nibble -> Word 2 (H)
     73DC 000F     
0383 73DE 0A88  56         sla   tmp4,8                ; Move to MSB
0384               
0385 73E0 D808  38 !       movb  tmp4,@ramsat+3        ; Update FG color in sprite table (SAT)
     73E2 A03F     
0386 73E4 D808  38         movb  tmp4,@tv.curshape+1   ; Save cursor color
     73E6 A215     
0387                       ;-------------------------------------------------------
0388                       ; Exit
0389                       ;-------------------------------------------------------
0390               pane.action.colorscheme.load.exit:
0391 73E8 06A0  32         bl    @scron                ; Turn screen on
     73EA 26A2     
0392 73EC C839  50         mov   *stack+,@parm3        ; Pop @parm3
     73EE A004     
0393 73F0 C839  50         mov   *stack+,@parm2        ; Pop @parm2
     73F2 A002     
0394 73F4 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     73F6 A000     
0395 73F8 C239  30         mov   *stack+,tmp4          ; Pop tmp4
0396 73FA C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0397 73FC C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0398 73FE C179  30         mov   *stack+,tmp1          ; Pop tmp1
0399 7400 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0400 7402 C2F9  30         mov   *stack+,r11           ; Pop R11
0401 7404 045B  20         b     *r11                  ; Return to caller
0402               
0403               
0404               
0405               ***************************************************************
...
0421 7406 0649  14         dect  stack
0422 7408 C64B  30         mov   r11,*stack            ; Save return address
0423 740A 0649  14         dect  stack
0424 740C C644  30         mov   tmp0,*stack           ; Push tmp0
0425                       ;------------------------------------------------------
0426                       ; Bottom line
0427                       ;------------------------------------------------------
0428 740E 0204  20         li    tmp0,pane.botrow
     7410 0017     
0429 7412 C804  38         mov   tmp0,@parm2           ; Last row on screen
     7414 A002     
0430 7416 06A0  32         bl    @colors.line.set      ; Load color combination for line
     7418 745A     
...
0437 741A C139  30         mov   *stack+,tmp0          ; Pop tmp0
0438 741C C2F9  30         mov   *stack+,r11           ; Pop R11
0439 741E 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.24106
...
0021 7422 C64B  30         mov   r11,*stack            ; Save return address
0022                       ;-------------------------------------------------------
0023                       ; Hide cursor
0024                       ;-------------------------------------------------------
0025 7424 06A0  32         bl    @filv                 ; Clear sprite SAT in VDP RAM
     7426 22A2     
0026 7428 2180                   data sprsat,>00,8     ; \ i  p0 = VDP destination
     742A 0000     
     742C 0008     
0027                                                   ; | i  p1 = Byte to write
0028                                                   ; / i  p2 = Number of bytes to write
0029               
0030 742E 06A0  32         bl    @clslot
     7430 2FB8     
0031 7432 0001                   data 1                ; Terminate task.vdp.copy.sat
0032               
0033 7434 06A0  32         bl    @clslot
     7436 2FB8     
0034 7438 0002                   data 2                ; Terminate task.vdp.cursor
0035                       ;-------------------------------------------------------
0036                       ; Exit
0037                       ;-------------------------------------------------------
0038               pane.cursor.hide.exit:
0039 743A C2F9  30         mov   *stack+,r11           ; Pop R11
0040 743C 045B  20         b     *r11                  ; Return to caller
0041               
0042               
0043               
0044               ***************************************************************
...
0060 743E 0649  14         dect  stack
0061 7440 C64B  30         mov   r11,*stack            ; Save return address
0062                       ;-------------------------------------------------------
0063                       ; Hide cursor
0064                       ;-------------------------------------------------------
0065 7442 06A0  32         bl    @filv                 ; Clear sprite SAT in VDP RAM
     7444 22A2     
0066 7446 2180                   data sprsat,>00,4     ; \ i  p0 = VDP destination
     7448 0000     
     744A 0004     
...
0069               
0078               
0079 744C 06A0  32         bl    @mkslot
     744E 2F9A     
0080 7450 020F                   data >020f,task.vdp.cursor   ; Task 2 - Toggle cursor shape
     7452 7166     
0081 7454 FFFF                   data eol
0082               
0084               
0085                       ;-------------------------------------------------------
0086                       ; Exit
...
0089 7456 C2F9  30         mov   *stack+,r11           ; Pop R11
0090 7458 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.24106
0134                       ;-----------------------------------------------------------------------
0135                       ; Screen panes
0136                       ;-----------------------------------------------------------------------
...
0021 745A 0649  14         dect  stack
0022 745C C64B  30         mov   r11,*stack            ; Save return address
0023 745E 0649  14         dect  stack
0024 7460 C644  30         mov   tmp0,*stack           ; Push tmp0
0025 7462 0649  14         dect  stack
0026 7464 C645  30         mov   tmp1,*stack           ; Push tmp1
0027 7466 0649  14         dect  stack
0028 7468 C646  30         mov   tmp2,*stack           ; Push tmp2
0029 746A 0649  14         dect  stack
0030 746C C660  46         mov   @parm1,*stack         ; Push parm1
     746E A000     
0031 7470 0649  14         dect  stack
0032 7472 C660  46         mov   @parm2,*stack         ; Push parm2
     7474 A002     
0033                       ;-------------------------------------------------------
0034                       ; Dump colors for line in TAT
0035                       ;-------------------------------------------------------
0036 7476 C120  34         mov   @parm2,tmp0           ; Get target line
     7478 A002     
0037 747A 0205  20         li    tmp1,colrow           ; Columns per row (spectra2)
     747C 0050     
0038 747E 3944  56         mpy   tmp0,tmp1             ; Calculate VDP address (results in tmp2!)
0039               
0040 7480 C106  18         mov   tmp2,tmp0             ; Set VDP start address
0041 7482 0224  22         ai    tmp0,vdp.tat.base     ; Add TAT base address
     7484 1800     
0042 7486 C160  34         mov   @parm1,tmp1           ; Get foreground/background color
     7488 A000     
0043 748A 0206  20         li    tmp2,80               ; Number of bytes to fill
     748C 0050     
0044               
0045 748E 06A0  32         bl    @xfilv                ; Fill colors
     7490 22A8     
...
0053 7492 C839  50         mov   *stack+,@parm2        ; Pop @parm2
     7494 A002     
0054 7496 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     7498 A000     
0055 749A C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0056 749C C179  30         mov   *stack+,tmp1          ; Pop tmp1
0057 749E C139  30         mov   *stack+,tmp0          ; Pop tmp0
0058 74A0 C2F9  30         mov   *stack+,r11           ; Pop R11
0059 74A2 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.24106
...
0015               ********|*****|*********************|**************************
0016               pane.topline:
0017 74A4 0649  14         dect  stack
0018 74A6 C64B  30         mov   r11,*stack            ; Save return address
0019 74A8 0649  14         dect  stack
0020 74AA C644  30         mov   tmp0,*stack           ; Push tmp0
0021 74AC 0649  14         dect  stack
0022 74AE C660  46         mov   @wyx,*stack           ; Push cursor position
     74B0 832A     
0023                       ;------------------------------------------------------
0024                       ; Show current file
0025                       ;------------------------------------------------------
0026               pane.topline.file:
0027 74B2 06A0  32         bl    @at
     74B4 26DA     
0028 74B6 0000                   byte 0,0              ; y=0, x=0
0029               
0030 74B8 C820  54         mov   @edb.filename.ptr,@parm1
     74BA A512     
     74BC A000     
0031                                                   ; Get string to display
0032 74BE 0204  20         li    tmp0,47
     74C0 002F     
0033 74C2 C804  38         mov   tmp0,@parm2           ; Set requested length
     74C4 A002     
0034 74C6 0204  20         li    tmp0,32
     74C8 0020     
0035 74CA C804  38         mov   tmp0,@parm3           ; Set character to fill
     74CC A004     
0036 74CE 0204  20         li    tmp0,rambuf
     74D0 A100     
0037 74D2 C804  38         mov   tmp0,@parm4           ; Set pointer to buffer for output string
     74D4 A006     
0038               
0039               
0040 74D6 06A0  32         bl    @tv.pad.string        ; Pad string to specified length
     74D8 33CC     
...
0045                                                   ; /             output string
0046               
0047 74DA C160  34         mov   @outparm1,tmp1        ; \ Display padded filename
     74DC A010     
0048 74DE 06A0  32         bl    @xutst0               ; /
     74E0 2434     
0049                       ;------------------------------------------------------
0050                       ; Show if text was changed in editor buffer
0051                       ;------------------------------------------------------
0052               pane.topline.show_dirty:
0053 74E2 C120  34         mov   @edb.dirty,tmp0
     74E4 A506     
0054 74E6 1305  14         jeq   pane.topline.nochange
0055                       ;------------------------------------------------------
0056                       ; Show "*"
0057                       ;------------------------------------------------------
0058 74E8 06A0  32         bl    @putat
     74EA 2456     
0059 74EC 004F                   byte 0,79             ; y=0, x=79
0060 74EE 376A                   data txt.star
0061 74F0 1004  14         jmp   pane.topline.showmarkers
0062                       ;------------------------------------------------------
0063                       ; Show " "
0064                       ;------------------------------------------------------
0065               pane.topline.nochange:
0066 74F2 06A0  32         bl    @putat
     74F4 2456     
0067 74F6 004F                   byte 0,79             ; y=0, x=79
0068 74F8 3986                   data txt.ws1          ; Single white space
0069                       ;------------------------------------------------------
0070                       ; Check if M1/M2 markers need to be shown
0071                       ;------------------------------------------------------
0072               pane.topline.showmarkers:
0073 74FA C120  34         mov   @edb.block.m1,tmp0    ; \
     74FC A50C     
0074 74FE 0284  22         ci    tmp0,>ffff            ; | Exit early if M1 unset (>ffff)
     7500 FFFF     
0075 7502 132C  14         jeq   pane.topline.exit     ; /
0076               
0077 7504 C120  34         mov   @tv.task.oneshot,tmp0 ; \
     7506 A224     
0078 7508 0284  22         ci    tmp0,pane.topline.oneshot.clearmsg
     750A 36AA     
0079                                                   ; | Exit early if overlay message visible
0080 750C 1327  14         jeq   pane.topline.exit     ; /
0081                       ;------------------------------------------------------
0082                       ; Show M1 marker
0083                       ;------------------------------------------------------
0084 750E 06A0  32         bl    @putat
     7510 2456     
0085 7512 0034                   byte 0,52
0086 7514 38E6                   data txt.m1           ; Show M1 marker message
0087               
0088 7516 C820  54         mov   @edb.block.m1,@parm1
     7518 A50C     
     751A A000     
0089 751C 06A0  32         bl    @tv.unpack.uint16     ; Unpack 16 bit unsigned integer to string
     751E 33A0     
0090                                                   ; \ i @parm1           = uint16
0091                                                   ; / o @unpacked.string = Output string
0092               
0093 7520 0204  20         li    tmp0,>0500
     7522 0500     
0094 7524 D804  38         movb  tmp0,@unpacked.string ; Set string length to 5 (padding)
     7526 A026     
0095               
0096 7528 06A0  32         bl    @putat
     752A 2456     
0097 752C 0037                   byte 0,55
0098 752E A026                   data unpacked.string  ; Show M1 value
0099                       ;------------------------------------------------------
0100                       ; Show M2 marker
0101                       ;------------------------------------------------------
0102 7530 C120  34         mov   @edb.block.m2,tmp0    ; \
     7532 A50E     
0103 7534 0284  22         ci    tmp0,>ffff            ; | Exit early if M2 unset (>ffff)
     7536 FFFF     
0104 7538 1311  14         jeq   pane.topline.exit     ; /
0105               
0106 753A 06A0  32         bl    @putat
     753C 2456     
0107 753E 003E                   byte 0,62
0108 7540 38EA                   data txt.m2           ; Show M2 marker message
0109               
0110 7542 C820  54         mov   @edb.block.m2,@parm1
     7544 A50E     
     7546 A000     
0111 7548 06A0  32         bl    @tv.unpack.uint16     ; Unpack 16 bit unsigned integer to string
     754A 33A0     
0112                                                   ; \ i @parm1           = uint16
0113                                                   ; / o @unpacked.string = Output string
0114               
0115 754C 0204  20         li    tmp0,>0500
     754E 0500     
0116 7550 D804  38         movb  tmp0,@unpacked.string ; Set string length to 5 (padding)
     7552 A026     
0117               
0118 7554 06A0  32         bl    @putat
     7556 2456     
0119 7558 0041                   byte 0,65
0120 755A A026                   data unpacked.string  ; Show M2 value
0121                       ;------------------------------------------------------
0122                       ; Exit
0123                       ;------------------------------------------------------
0124               pane.topline.exit:
0125 755C C839  50         mov   *stack+,@wyx          ; Pop cursor position
     755E 832A     
0126 7560 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0127 7562 C2F9  30         mov   *stack+,r11           ; Pop r11
0128 7564 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.24106
...
0120 75D4 06A0  32         bl    @at
     75D6 26DA     
0121 75D8 1400                   byte pane.botrow-3,0  ; Set cursor
0122               
...
0180 7612 C120  34         mov   @tv.color,tmp0        ; Get colors
     7614 A218     
0181 7616 0984  56         srl   tmp0,8                ; Get rid of status line colors
0182                       ;------------------------------------------------------
0183                       ; Dump colors
0184                       ;------------------------------------------------------
...
0022 763A C660  46         mov   @wyx,*stack           ; Push cursor position
     763C 832A     
0023                       ;------------------------------------------------------
0024                       ; Show block shortcuts if set
0025                       ;------------------------------------------------------
0026 763E C120  34         mov   @edb.block.m2,tmp0    ; \
     7640 A50E     
0027 7642 0584  14         inc   tmp0                  ; | Skip if M2 unset (>ffff)
0028                                                   ; /
0029 7644 1305  14         jeq   pane.botline.show_keys
0030               
0031 7646 06A0  32         bl    @putat
     7648 2456     
0032 764A 1700                   byte pane.botrow,0
0033 764C 38F6                   data txt.keys.block   ; Show block shortcuts
0034               
0035 764E 1004  14         jmp   pane.botline.show_mode
0036                       ;------------------------------------------------------
0037                       ; Show default message
0038                       ;------------------------------------------------------
0039               pane.botline.show_keys:
0040 7650 06A0  32         bl    @putat
     7652 2456     
0041 7654 1700                   byte pane.botrow,0
0042 7656 38EE                   data txt.keys.default ; Show default shortcuts
0043                       ;------------------------------------------------------
0044                       ; Show text editing mode
0045                       ;------------------------------------------------------
0046               pane.botline.show_mode:
0047 7658 C120  34         mov   @edb.insmode,tmp0
     765A A50A     
0048 765C 1605  14         jne   pane.botline.show_mode.insert
0049                       ;------------------------------------------------------
0050                       ; Overwrite mode
0051                       ;------------------------------------------------------
0052 765E 06A0  32         bl    @putat
     7660 2456     
0053 7662 1737                   byte  pane.botrow,55
0054 7664 3762                   data  txt.ovrwrite
0055 7666 1004  14         jmp   pane.botline.show_linecol
0056                       ;------------------------------------------------------
0057                       ; Insert mode
0058                       ;------------------------------------------------------
0059               pane.botline.show_mode.insert:
0060 7668 06A0  32         bl    @putat
     766A 2456     
0061 766C 1737                   byte  pane.botrow,55
0062 766E 3766                   data  txt.insert
0063                       ;------------------------------------------------------
0064                       ; Show "line,column"
0065                       ;------------------------------------------------------
0066               pane.botline.show_linecol:
0067 7670 C820  54         mov   @fb.row,@parm1
     7672 A306     
     7674 A000     
0068 7676 06A0  32         bl    @fb.row2line          ; Row to editor line
     7678 6CA2     
0069                                                   ; \ i @fb.topline = Top line in frame buffer
0070                                                   ; | i @parm1      = Row in frame buffer
0071                                                   ; / o @outparm1   = Matching line in EB
0072               
0073 767A 05A0  34         inc   @outparm1             ; Add base 1
     767C A010     
0074                       ;------------------------------------------------------
0075                       ; Show line
0076                       ;------------------------------------------------------
0077 767E 06A0  32         bl    @putnum
     7680 2B32     
0078 7682 173B                   byte  pane.botrow,59  ; YX
0079 7684 A010                   data  outparm1,rambuf
     7686 A100     
0080 7688 30                     byte  48              ; ASCII offset
0081 7689   20                   byte  32              ; Padding character
0082                       ;------------------------------------------------------
0083                       ; Show comma
0084                       ;------------------------------------------------------
0085 768A 06A0  32         bl    @putat
     768C 2456     
0086 768E 1740                   byte  pane.botrow,64
0087 7690 375A                   data  txt.delim
0088                       ;------------------------------------------------------
0089                       ; Show column
0090                       ;------------------------------------------------------
0091 7692 06A0  32         bl    @film
     7694 224A     
0092 7696 A105                   data rambuf+5,32,12   ; Clear work buffer with space character
     7698 0020     
     769A 000C     
0093               
0094 769C C820  54         mov   @fb.column,@waux1
     769E A30C     
     76A0 833C     
0095 76A2 05A0  34         inc   @waux1                ; Offset 1
     76A4 833C     
0096               
0097 76A6 06A0  32         bl    @mknum                ; Convert unsigned number to string
     76A8 2AB4     
0098 76AA 833C                   data  waux1,rambuf
     76AC A100     
0099 76AE 30                     byte  48              ; ASCII offset
0100 76AF   20                   byte  32              ; Fill character
0101               
0102 76B0 06A0  32         bl    @trimnum              ; Trim number to the left
     76B2 2B0C     
0103 76B4 A100                   data  rambuf,rambuf+5,32
     76B6 A105     
     76B8 0020     
0104               
0105 76BA 0204  20         li    tmp0,>0600            ; "Fix" number length to clear junk chars
     76BC 0600     
0106 76BE D804  38         movb  tmp0,@rambuf+5        ; Set length byte
     76C0 A105     
0107               
0108                       ;------------------------------------------------------
0109                       ; Decide if row length is to be shown
0110                       ;------------------------------------------------------
0111 76C2 C120  34         mov   @fb.column,tmp0       ; \ Base 1 for comparison
     76C4 A30C     
0112 76C6 0584  14         inc   tmp0                  ; /
0113 76C8 8804  38         c     tmp0,@fb.row.length   ; Check if cursor on last column on row
     76CA A308     
0114 76CC 1101  14         jlt   pane.botline.show_linecol.linelen
0115 76CE 102B  14         jmp   pane.botline.show_linecol.colstring
0116                                                   ; Yes, skip showing row length
0117                       ;------------------------------------------------------
0118                       ; Add ',' delimiter and length of line to string
0119                       ;------------------------------------------------------
0120               pane.botline.show_linecol.linelen:
0121 76D0 C120  34         mov   @fb.column,tmp0       ; \
     76D2 A30C     
0122 76D4 0205  20         li    tmp1,rambuf+7         ; | Determine column position for '-' char
     76D6 A107     
0123 76D8 0284  22         ci    tmp0,9                ; | based on number of digits in cursor X
     76DA 0009     
0124 76DC 1101  14         jlt   !                     ; | column.
0125 76DE 0585  14         inc   tmp1                  ; /
0126               
0127 76E0 0204  20 !       li    tmp0,>2f00            ; \ ASCII '/'
     76E2 2F00     
0128 76E4 DD44  32         movb  tmp0,*tmp1+           ; / Add delimiter to string
0129               
0130 76E6 C805  38         mov   tmp1,@waux1           ; Backup position in ram buffer
     76E8 833C     
0131               
0132 76EA 06A0  32         bl    @mknum
     76EC 2AB4     
0133 76EE A308                   data  fb.row.length,rambuf
     76F0 A100     
0134 76F2 30                     byte  48              ; ASCII offset
0135 76F3   20                   byte  32              ; Padding character
0136               
0137 76F4 C160  34         mov   @waux1,tmp1           ; Restore position in ram buffer
     76F6 833C     
0138               
0139 76F8 C120  34         mov   @fb.row.length,tmp0   ; \ Get length of line
     76FA A308     
0140 76FC 0284  22         ci    tmp0,10               ; /
     76FE 000A     
0141 7700 110B  14         jlt   pane.botline.show_line.1digit
0142                       ;------------------------------------------------------
0143                       ; Assert
0144                       ;------------------------------------------------------
0145 7702 0284  22         ci    tmp0,80
     7704 0050     
0146 7706 1204  14         jle   pane.botline.show_line.2digits
0147                       ;------------------------------------------------------
0148                       ; Asserts failed
0149                       ;------------------------------------------------------
0150 7708 C80B  38 !       mov   r11,@>ffce            ; \ Save caller address
     770A FFCE     
0151 770C 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     770E 2026     
0152                       ;------------------------------------------------------
0153                       ; Show length of line (2 digits)
0154                       ;------------------------------------------------------
0155               pane.botline.show_line.2digits:
0156 7710 0204  20         li    tmp0,rambuf+3
     7712 A103     
0157 7714 DD74  42         movb  *tmp0+,*tmp1+         ; 1st digit row length
0158 7716 1002  14         jmp   pane.botline.show_line.rest
0159                       ;------------------------------------------------------
0160                       ; Show length of line (1 digits)
0161                       ;------------------------------------------------------
0162               pane.botline.show_line.1digit:
0163 7718 0204  20         li    tmp0,rambuf+4
     771A A104     
0164               pane.botline.show_line.rest:
0165 771C DD74  42         movb  *tmp0+,*tmp1+         ; 1st/Next digit row length
0166 771E DD60  48         movb  @rambuf+0,*tmp1+      ; Append a whitespace character
     7720 A100     
0167 7722 DD60  48         movb  @rambuf+0,*tmp1+      ; Append a whitespace character
     7724 A100     
0168                       ;------------------------------------------------------
0169                       ; Show column string
0170                       ;------------------------------------------------------
0171               pane.botline.show_linecol.colstring:
0172 7726 06A0  32         bl    @putat
     7728 2456     
0173 772A 1741                   byte pane.botrow,65
0174 772C A105                   data rambuf+5         ; Show string
0175                       ;------------------------------------------------------
0176                       ; Show lines in buffer unless on last line in file
0177                       ;------------------------------------------------------
0178 772E C820  54         mov   @fb.row,@parm1
     7730 A306     
     7732 A000     
0179 7734 06A0  32         bl    @fb.row2line
     7736 6CA2     
0180 7738 8820  54         c     @edb.lines,@outparm1
     773A A504     
     773C A010     
0181 773E 1605  14         jne   pane.botline.show_lines_in_buffer
0182               
0183 7740 06A0  32         bl    @putat
     7742 2456     
0184 7744 1748                   byte pane.botrow,72
0185 7746 375C                   data txt.bottom
0186               
0187 7748 1009  14         jmp   pane.botline.exit
0188                       ;------------------------------------------------------
0189                       ; Show lines in buffer
0190                       ;------------------------------------------------------
0191               pane.botline.show_lines_in_buffer:
0192 774A C820  54         mov   @edb.lines,@waux1
     774C A504     
     774E 833C     
0193               
0194 7750 06A0  32         bl    @putnum
     7752 2B32     
0195 7754 1748                   byte pane.botrow,72   ; YX
0196 7756 833C                   data waux1,rambuf
     7758 A100     
0197 775A 30                     byte 48
0198 775B   20                   byte 32
0199                       ;------------------------------------------------------
0200                       ; Exit
0201                       ;------------------------------------------------------
0202               pane.botline.exit:
0203 775C C839  50         mov   *stack+,@wyx          ; Pop cursor position
     775E 832A     
0204 7760 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0205 7762 C2F9  30         mov   *stack+,r11           ; Pop r11
0206 7764 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.24106
...
0022               ********|*****|*********************|**************************
0023               pane.vdpdump:
0024 7766 0649  14         dect  stack
0025 7768 C64B  30         mov   r11,*stack            ; Save return address
0026 776A 0649  14         dect  stack
0027 776C C644  30         mov   tmp0,*stack           ; Push tmp0
0028 776E 0649  14         dect  stack
0029 7770 C660  46         mov   @wyx,*stack           ; Push cursor position
     7772 832A     
0030                       ;------------------------------------------------------
0031                       ; ALPHA-Lock key down?
0032                       ;------------------------------------------------------
0033               pane.vdpdump.alpha_lock:
0034 7774 20A0  38         coc   @wbit10,config
     7776 200C     
0035 7778 1305  14         jeq   pane.vdpdump.alpha_lock.down
0036                       ;------------------------------------------------------
0037                       ; AlPHA-Lock is up
0038                       ;------------------------------------------------------
0039 777A 06A0  32         bl    @putat
     777C 2456     
0040 777E 174E                   byte pane.botrow,78
0041 7780 3990                   data txt.ws4
0042 7782 1004  14         jmp   pane.vdpdump.cmdb.check
0043                       ;------------------------------------------------------
0044                       ; AlPHA-Lock is down
0045                       ;------------------------------------------------------
0046               pane.vdpdump.alpha_lock.down:
0047 7784 06A0  32         bl    @putat
     7786 2456     
0048 7788 174E                   byte pane.botrow,78
0049 778A 397E                   data txt.alpha.down
0050                       ;------------------------------------------------------
0051                       ; Command buffer visible ?
0052                       ;------------------------------------------------------
0053               pane.vdpdump.cmdb.check
0054 778C C120  34         mov   @cmdb.visible,tmp0    ; CMDB pane visible ?
     778E A702     
0055 7790 1324  14         jeq   !                     ; No, skip CMDB pane
0056                       ;-------------------------------------------------------
0057                       ; Draw command buffer pane if dirty
0058                       ;-------------------------------------------------------
0059               pane.vdpdump.cmdb.draw:
0060 7792 C120  34         mov   @cmdb.dirty,tmp0      ; Command buffer dirty?
     7794 A718     
0061 7796 1343  14         jeq   pane.vdpdump.exit     ; No, skip update
0062                       ;-------------------------------------------------------
0063                       ; "one-time only" flag set?
0064                       ;-------------------------------------------------------
0065 7798 0284  22         ci    tmp0,tv.1timeonly
     779A 00FE     
0066 779C 1619  14         jne   pane.vdpdump.cmdb.draw.content
0067                                                   ; No, skip CMDB colorization
0068                       ;-------------------------------------------------------
0069                       ; Colorize the CMDB pane
0070                       ;-------------------------------------------------------
0071               pane.vdpdump.cmdb.draw.colorscheme:
0072 779E 0649  14         dect  stack
0073 77A0 C660  46         mov   @parm1,*stack         ; Push @parm1
     77A2 A000     
0074 77A4 0649  14         dect  stack
0075 77A6 C660  46         mov   @parm2,*stack         ; Push @parm2
     77A8 A002     
0076 77AA 0649  14         dect  stack
0077 77AC C660  46         mov   @parm3,*stack         ; Push @parm3
     77AE A004     
0078               
0079 77B0 0720  34         seto  @parm1                ; Do not turn screen off
     77B2 A000     
0080 77B4 0720  34         seto  @parm2                ; Skip colorzing marked lines
     77B6 A002     
0081 77B8 0720  34         seto  @parm3                ; Only colorize CMDB pane
     77BA A004     
0082               
0083 77BC 06A0  32         bl    @pane.action.colorscheme.load
     77BE 7214     
...
0089                                                   ; /             if >FFFF
0090               
0091 77C0 C839  50         mov   *stack+,@parm3        ; Pop @parm3
     77C2 A004     
0092 77C4 C839  50         mov   *stack+,@parm2        ; Pop @parm2
     77C6 A002     
0093 77C8 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     77CA A000     
0094               
0095 77CC 0720  34         seto  @cmdb.dirty           ; Remove special "one-time only" flag
     77CE A718     
0096                       ;-------------------------------------------------------
0097                       ; Show content in CMDB pane
0098                       ;-------------------------------------------------------
0099               pane.vdpdump.cmdb.draw.content:
0100 77D0 06A0  32         bl    @pane.cmdb.draw       ; Draw CMDB pane
     77D2 7972     
0101 77D4 04E0  34         clr   @cmdb.dirty           ; Reset CMDB dirty flag
     77D6 A718     
0102 77D8 1022  14         jmp   pane.vdpdump.exit     ; Exit early
0103                       ;-------------------------------------------------------
0104                       ; Check if frame buffer dirty
0105                       ;-------------------------------------------------------
0106 77DA C120  34 !       mov   @fb.dirty,tmp0        ; Is frame buffer dirty?
     77DC A316     
0107 77DE 130E  14         jeq   pane.vdpdump.statlines
0108                                                   ; No, skip update
0109 77E0 C820  54         mov   @fb.scrrows,@parm1    ; Number of lines to dump
     77E2 A31A     
     77E4 A000     
0110               
0111               pane.vdpdump.dump:
0112 77E6 06A0  32         bl    @fb.vdpdump           ; Dump frame buffer to VDP SIT
     77E8 7A0A     
...
0117                       ;------------------------------------------------------
0118 77EA C120  34         mov   @fb.colorize,tmp0     ; Check if colorization necessary
     77EC A310     
0119 77EE 1302  14         jeq   pane.vdpdump.dumped   ; Skip if flag reset
0120               
0121 77F0 06A0  32         bl    @fb.colorlines        ; Colorize lines M1/M2
     77F2 79F8     
0122                       ;-------------------------------------------------------
0123                       ; Finished with frame buffer
0124                       ;-------------------------------------------------------
0125               pane.vdpdump.dumped:
0126 77F4 04E0  34         clr   @fb.dirty             ; Reset framebuffer dirty flag
     77F6 A316     
0127 77F8 0720  34         seto  @fb.status.dirty      ; Do trigger status lines update
     77FA A318     
0128                       ;-------------------------------------------------------
0129                       ; Refresh top and bottom line
0130                       ;-------------------------------------------------------
0131               pane.vdpdump.statlines:
0132 77FC C120  34         mov   @fb.status.dirty,tmp0 ; Are status lines dirty?
     77FE A318     
0133 7800 130E  14         jeq   pane.vdpdump.exit     ; No, skip update
0134               
0135 7802 06A0  32         bl    @pane.topline         ; Draw top line
     7804 74A4     
0136 7806 06A0  32         bl    @pane.botline         ; Draw bottom line
     7808 7630     
0137 780A 04E0  34         clr   @fb.status.dirty      ; Reset status lines dirty flag
     780C A318     
0138                       ;------------------------------------------------------
0139                       ; Show ruler with tab positions
0140                       ;------------------------------------------------------
0141 780E C120  34         mov   @tv.ruler.visible,tmp0
     7810 A210     
0142                                                   ; Should ruler be visible?
0143 7812 1305  14         jeq   pane.vdpdump.exit     ; No, so exit
0144               
0145 7814 06A0  32         bl    @cpym2v
     7816 249A     
0146 7818 0050                   data vdp.fb.toprow.sit
0147 781A A31E                   data fb.ruler.sit
0148 781C 0050                   data 80               ; Show ruler
0149                       ;------------------------------------------------------
0150                       ; Exit task
0151                       ;------------------------------------------------------
0152               pane.vdpdump.exit:
0153 781E C839  50         mov   *stack+,@wyx          ; Pop cursor position
     7820 832A     
0154 7822 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0155 7824 C2F9  30         mov   *stack+,r11           ; Pop r11
0156 7826 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.24106
0142                       ;-----------------------------------------------------------------------
0143                       ; Stubs
0144                       ;-----------------------------------------------------------------------
...
0007               ********|*****|*********************|**************************
0008               fm.loadfile:
0009 7828 0649  14         dect  stack
0010 782A C64B  30         mov   r11,*stack            ; Save return address
0011 782C 0649  14         dect  stack
0012 782E C644  30         mov   tmp0,*stack           ; Push tmp0
0013                       ;------------------------------------------------------
0014                       ; Call function in bank 2
0015                       ;------------------------------------------------------
0016 7830 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7832 307E     
0017 7834 6004                   data bank2.rom        ; | i  p0 = bank address
0018 7836 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0019 7838 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0020                       ;------------------------------------------------------
0021                       ; Show "Unsaved changes" dialog if editor buffer dirty
0022                       ;------------------------------------------------------
0023 783A C120  34         mov   @outparm1,tmp0
     783C A010     
0024 783E 1304  14         jeq   fm.loadfile.exit
0025               
0026 7840 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0027 7842 C2F9  30         mov   *stack+,r11           ; Pop r11
0028 7844 0460  28         b     @dialog.unsaved       ; Show dialog and exit
     7846 78D8     
0029                       ;------------------------------------------------------
0030                       ; Exit
0031                       ;------------------------------------------------------
0032               fm.loadfile.exit:
0033 7848 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0034 784A C2F9  30         mov   *stack+,r11           ; Pop r11
0035 784C 045B  20         b     *r11                  ; Return to caller
0036               
0037               
0038               ***************************************************************
...
0041               ********|*****|*********************|**************************
0042               fm.insertfile:
0043 784E 0649  14         dect  stack
0044 7850 C64B  30         mov   r11,*stack            ; Save return address
0045 7852 0649  14         dect  stack
0046 7854 C644  30         mov   tmp0,*stack           ; Push tmp0
0047                       ;------------------------------------------------------
0048                       ; Call function in bank 2
0049                       ;------------------------------------------------------
0050 7856 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7858 307E     
0051 785A 6004                   data bank2.rom        ; | i  p0 = bank address
0052 785C 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0053 785E 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0054                       ;------------------------------------------------------
0055                       ; Exit
0056                       ;------------------------------------------------------
0057               fm.insertfile.exit:
0058 7860 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0059 7862 C2F9  30         mov   *stack+,r11           ; Pop r11
0060 7864 045B  20         b     *r11                  ; Return to caller
0061               
0062               
0063               **************************************************************
...
0068 7866 0649  14         dect  stack
0069 7868 C64B  30         mov   r11,*stack            ; Save return address
0070                       ;------------------------------------------------------
0071                       ; Call function in bank 2
0072                       ;------------------------------------------------------
0073 786A 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     786C 307E     
0074 786E 6004                   data bank2.rom        ; | i  p0 = bank address
0075 7870 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0076 7872 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0077                       ;------------------------------------------------------
0078                       ; Exit
0079                       ;------------------------------------------------------
0080 7874 C2F9  30         mov   *stack+,r11           ; Pop r11
0081 7876 045B  20         b     *r11                  ; Return to caller
0082               
0083               
0084               ***************************************************************
...
0087               ********|*****|*********************|**************************
0088               fm.savefile:
0089 7878 0649  14         dect  stack
0090 787A C64B  30         mov   r11,*stack            ; Save return address
0091                       ;------------------------------------------------------
0092                       ; Call function in bank 2
0093                       ;------------------------------------------------------
0094 787C 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     787E 307E     
0095 7880 6004                   data bank2.rom        ; | i  p0 = bank address
0096 7882 7FC6                   data vec.4            ; | i  p1 = Vector with target address
0097 7884 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0098                       ;------------------------------------------------------
0099                       ; Exit
0100                       ;------------------------------------------------------
0101 7886 C2F9  30         mov   *stack+,r11           ; Pop r11
0102 7888 045B  20         b     *r11                  ; Return to caller
0103               
0104               
0105               ***************************************************************
...
0108               ********|*****|*********************|**************************
0109               fm.newfile:
0110 788A 0649  14         dect  stack
0111 788C C64B  30         mov   r11,*stack            ; Save return address
0112                       ;------------------------------------------------------
0113                       ; Call function in bank 2
0114                       ;------------------------------------------------------
0115 788E 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7890 307E     
0116 7892 6004                   data bank2.rom        ; | i  p0 = bank address
0117 7894 7FC8                   data vec.5            ; | i  p1 = Vector with target address
0118 7896 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0119                       ;------------------------------------------------------
0120                       ; Exit
0121                       ;------------------------------------------------------
0122 7898 C2F9  30         mov   *stack+,r11           ; Pop r11
0123 789A 045B  20         b     *r11                  ; Return to caller
0124               
0125               
0126               ***************************************************************
...
0131 789C C820  54         mov   @edkey.action.about.vector,@trmpvector
     789E 78A4     
     78A0 A03A     
0132 78A2 104A  14         jmp   _trampoline.bank3     ; Show dialog
0133               edkey.action.about.vector:
0134 78A4 7FC0             data  vec.1
0135               
0136               
0137               ***************************************************************
...
0140               ********|*****|*********************|**************************
0141               dialog.load:
0142 78A6 C820  54         mov   @dialog.load.vector,@trmpvector
     78A8 78AE     
     78AA A03A     
0143 78AC 1045  14         jmp   _trampoline.bank3     ; Show dialog
0144               dialog.load.vector:
0145 78AE 7FC2             data  vec.2
0146               
0147               
0148               ***************************************************************
...
0151               ********|*****|*********************|**************************
0152               dialog.save:
0153 78B0 C820  54         mov   @dialog.save.vector,@trmpvector
     78B2 78B8     
     78B4 A03A     
0154 78B6 1040  14         jmp   _trampoline.bank3     ; Show dialog
0155               dialog.save.vector:
0156 78B8 7FC4             data  vec.3
0157               
0158               
0159               ***************************************************************
...
0162               ********|*****|*********************|**************************
0163               dialog.insert:
0164 78BA C820  54         mov   @dialog.insert.vector,@trmpvector
     78BC 78C2     
     78BE A03A     
0165 78C0 103B  14         jmp   _trampoline.bank3     ; Show dialog
0166               dialog.insert.vector:
0167 78C2 7FC6             data  vec.4
0168               
0169               
0170               ***************************************************************
...
0173               ********|*****|*********************|**************************
0174               dialog.print:
0175 78C4 C820  54         mov   @dialog.print.vector,@trmpvector
     78C6 78CC     
     78C8 A03A     
0176 78CA 1036  14         jmp   _trampoline.bank3    ; Show dialog
0177               dialog.print.vector:
0178 78CC 7FC8             data  vec.5
0179               
0180               
0181               ***************************************************************
...
0184               ********|*****|*********************|**************************
0185               dialog.file:
0186 78CE C820  54         mov   @dialog.file.vector,@trmpvector
     78D0 78D6     
     78D2 A03A     
0187 78D4 1031  14         jmp   _trampoline.bank3     ; Show dialog
0188               dialog.file.vector:
0189 78D6 7FCA             data  vec.6
0190               
0191               
0192               ***************************************************************
...
0195               ********|*****|*********************|**************************
0196               dialog.unsaved:
0197 78D8 04E0  34         clr   @cmdb.panmarkers      ; No key markers
     78DA A722     
0198 78DC C820  54         mov   @dialog.unsaved.vector,@trmpvector
     78DE 78E4     
     78E0 A03A     
0199 78E2 102A  14         jmp   _trampoline.bank3     ; Show dialog
0200               dialog.unsaved.vector:
0201 78E4 7FCC             data  vec.7
0202               
0203               
0204               ***************************************************************
...
0209 78E6 C820  54         mov   @dialog.clipboard.vector,@trmpvector
     78E8 78EE     
     78EA A03A     
0210 78EC 1025  14         jmp   _trampoline.bank3     ; Show dialog
0211               dialog.clipboard.vector:
0212 78EE 7FCE             data  vec.8
0213               
0214               
0215               ***************************************************************
...
0218               ********|*****|*********************|**************************
0219               dialog.clipdev:
0220 78F0 C820  54         mov   @dialog.clipdev.vector,@trmpvector
     78F2 78F8     
     78F4 A03A     
0221 78F6 1020  14         jmp   _trampoline.bank3     ; Show dialog
0222               dialog.clipdev.vector:
0223 78F8 7FD0             data  vec.9
0224               
0225               
0226               ***************************************************************
...
0229               ********|*****|*********************|**************************
0230               dialog.config:
0231 78FA C820  54         mov   @dialog.config.vector,@trmpvector
     78FC 7902     
     78FE A03A     
0232 7900 101B  14         jmp   _trampoline.bank3     ; Show dialog
0233               dialog.config.vector:
0234 7902 7FD2             data  vec.10
0235               
0236               
0237               ***************************************************************
...
0240               ********|*****|*********************|**************************
0241               dialog.append:
0242 7904 C820  54         mov   @dialog.append.vector,@trmpvector
     7906 790C     
     7908 A03A     
0243 790A 1016  14         jmp   _trampoline.bank3     ; Show dialog
0244               dialog.append.vector:
0245 790C 7FD4             data  vec.11
0246               
0247               
0248               ***************************************************************
...
0253 790E C820  54         mov   @dialog.cartridge.vector,@trmpvector
     7910 7916     
     7912 A03A     
0254 7914 1011  14         jmp   _trampoline.bank3     ; Show dialog
0255               dialog.cartridge.vector:
0256 7916 7FD6             data  vec.12
0257               
0258               
0259               ***************************************************************
...
0262               ********|*****|*********************|**************************
0263               dialog.basic:
0264 7918 C820  54         mov   @dialog.basic.vector,@trmpvector
     791A 7920     
     791C A03A     
0265 791E 100C  14         jmp   _trampoline.bank3     ; Show dialog
0266               dialog.basic.vector:
0267 7920 7FD8             data  vec.13
0268               
0269               
0270               ***************************************************************
...
0277                       ;------------------------------------------------------
0278 7922 C120  34         mov   @edb.block.m2,tmp0    ; \
     7924 A50E     
0279 7926 0584  14         inc   tmp0                  ; | Skip if M2 unset (>ffff)
0280                                                   ; /
0281 7928 1302  14         jeq   !                     : Block mode inactive, show dialog
0282                       ;------------------------------------------------------
0283                       ; Special treatment for block mode
0284                       ;------------------------------------------------------
0285 792A 0460  28         b     @edkey.action.block.reset
     792C 6798     
0286                                                   ; Reset block mode
0287                       ;------------------------------------------------------
0288                       ; Show dialog
0289                       ;------------------------------------------------------
0290 792E C820  54 !       mov   @dialog.menu.vector,@trmpvector
     7930 7936     
     7932 A03A     
0291 7934 1001  14         jmp   _trampoline.bank3     ; Show dialog
0292               dialog.menu.vector:
0293 7936 7FFA             data  vec.30
0294               
0295               
0296               
0297               ***************************************************************
...
0301 7938 06A0  32         bl    @pane.cursor.hide     ; Hide cursor
     793A 7420     
0302                       ;------------------------------------------------------
0303                       ; Call routine in specified bank
0304                       ;------------------------------------------------------
0305 793C 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     793E 307E     
0306 7940 6006                   data bank3.rom        ; | i  p0 = bank address
0307 7942 FFFF                   data >ffff            ; | i  p1 = Vector with target address
0308                                                   ; |         (deref @trmpvector)
0309 7944 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0310                       ;------------------------------------------------------
0311                       ; Exit
0312                       ;------------------------------------------------------
0313 7946 0460  28         b     @edkey.action.cmdb.show
     7948 6934     
...
0320               ********|*****|*********************|**************************
0321               error.display:
0322 794A C820  54         mov   @error.display.vector,@trmpvector
     794C 7952     
     794E A03A     
0323 7950 1038  14         jmp   _trampoline.bank3.ret ; Longjump
0324               error.display.vector:
0325 7952 7FE2             data  vec.18
0326               
0327               
0328               ***************************************************************
...
0333 7954 C820  54         mov   @pane.show_hintx.vector,@trmpvector
     7956 795C     
     7958 A03A     
0334 795A 1033  14         jmp   _trampoline.bank3.ret ; Longjump
0335               pane.show_hintx.vector:
0336 795C 7FE4             data  vec.19
0337               
0338               
0339               ***************************************************************
...
0342               ********|*****|*********************|**************************
0343               pane.cmdb.show:
0344 795E C820  54         mov   @pane.cmdb.show.vector,@trmpvector
     7960 7966     
     7962 A03A     
0345 7964 102E  14         jmp   _trampoline.bank3.ret ; Longjump
0346               pane.cmdb.show.vector:
0347 7966 7FE6             data  vec.20
0348               
0349               
0350               ***************************************************************
...
0353               ********|*****|*********************|**************************
0354               pane.cmdb.hide:
0355 7968 C820  54         mov   @pane.cmdb.hide.vector,@trmpvector
     796A 7970     
     796C A03A     
0356 796E 1029  14         jmp   _trampoline.bank3.ret ; Longjump
0357               pane.cmdb.hide.vector:
0358 7970 7FE8             data  vec.21
0359               
0360               
0361               ***************************************************************
...
0364               ********|*****|*********************|**************************
0365               pane.cmdb.draw:
0366 7972 C820  54         mov   @pane.cmdb.draw.vector,@trmpvector
     7974 797A     
     7976 A03A     
0367 7978 1024  14         jmp   _trampoline.bank3.ret ; Longjump
0368               pane.cmdb.draw.vector:
0369 797A 7FEA             data  vec.22
0370               
0371               
0372               ***************************************************************
...
0375               ********|*****|*********************|**************************
0376               cmdb.refresh:
0377 797C C820  54         mov   @cmdb.refresh.vector,@trmpvector
     797E 7984     
     7980 A03A     
0378 7982 101F  14         jmp   _trampoline.bank3.ret ; Longjump
0379               cmdb.refresh.vector:
0380 7984 7FEE             data  vec.24
0381               
0382               
0383               ***************************************************************
...
0386               ********|*****|*********************|**************************
0387               cmdb.cmd.clear:
0388 7986 C820  54         mov   @cmdb.cmd.clear.vector,@trmpvector
     7988 798E     
     798A A03A     
0389 798C 101A  14         jmp   _trampoline.bank3.ret ; Longjump
0390               cmdb.cmd.clear.vector:
0391 798E 7FF0             data  vec.25
0392               
0393               
0394               ***************************************************************
...
0399 7990 C820  54         mov   @cmdb.cmd.getlength.vector,@trmpvector
     7992 7998     
     7994 A03A     
0400 7996 1015  14         jmp   _trampoline.bank3.ret ; Longjump
0401               cmdb.cmd.getlength.vector:
0402 7998 7FF2             data  vec.26
0403               
0404               
0405               ***************************************************************
...
0410 799A C820  54         mov   @cmdb.cmd.preset.vector,@trmpvector
     799C 79A2     
     799E A03A     
0411 79A0 1010  14         jmp   _trampoline.bank3.ret ; Longjump
0412               cmdb.cmd.preset.vector:
0413 79A2 7FF4             data  vec.27
0414               
0415               
0416               ***************************************************************
...
0419               ********|*****|*********************|**************************
0420               cmdb.cmd.set:
0421 79A4 C820  54         mov   @cmdb.cmd.set.vector,@trmpvector
     79A6 79AC     
     79A8 A03A     
0422 79AA 100B  14         jmp   _trampoline.bank3.ret ; Longjump
0423               cmdb.cmd.set.vector:
0424 79AC 7FF6             data  vec.28
0425               
0426               
0427               **************************************************************
...
0432 79AE C820  54         mov   @tibasic.sid.toggle.vector,@trmpvector
     79B0 79B6     
     79B2 A03A     
0433 79B4 1006  14         jmp   _trampoline.bank3.ret ; Longjump
0434               tibasic.sid.toggle.vector:
0435 79B6 7FFC             data  vec.31
0436               
0437               
0438               **************************************************************
...
0441               ********|*****|*********************|**************************
0442               fm.fastmode:
0443 79B8 C820  54         mov   @fm.fastmode.vector,@trmpvector
     79BA 79C0     
     79BC A03A     
0444 79BE 1001  14         jmp   _trampoline.bank3.ret ; Longjump
0445               fm.fastmode.vector:
0446 79C0 7FFE             data  vec.32
0447               
0448               
0449               
0450               
...
0455 79C2 0649  14         dect  stack
0456 79C4 C64B  30         mov   r11,*stack            ; Save return address
0457                       ;------------------------------------------------------
0458                       ; Call routine in specified bank
0459                       ;------------------------------------------------------
0460 79C6 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     79C8 307E     
0461 79CA 6006                   data bank3.rom        ; | i  p0 = bank address
0462 79CC FFFF                   data >ffff            ; | i  p1 = Vector with target address
0463                                                   ; |         (deref @trmpvector)
0464 79CE 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0465                       ;------------------------------------------------------
0466                       ; Exit
0467                       ;------------------------------------------------------
0468 79D0 C2F9  30         mov   *stack+,r11           ; Pop r11
0469 79D2 045B  20         b     *r11                  ; Return to caller
0470               
0471               
0472               
0473               ***************************************************************
...
0476               ********|*****|*********************|**************************
0477               fb.tab.next:
0478 79D4 0649  14         dect  stack
0479 79D6 C64B  30         mov   r11,*stack            ; Save return address
0480                       ;------------------------------------------------------
0481                       ; Put cursor on next tab position
0482                       ;------------------------------------------------------
0483 79D8 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     79DA 307E     
0484 79DC 6008                   data bank4.rom        ; | i  p0 = bank address
0485 79DE 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0486 79E0 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0487                       ;------------------------------------------------------
0488                       ; Exit
0489                       ;------------------------------------------------------
0490 79E2 C2F9  30         mov   *stack+,r11           ; Pop r11
0491 79E4 045B  20         b     *r11                  ; Return to caller
0492               
0493               
0494               ***************************************************************
...
0497               ********|*****|*********************|**************************
0498               fb.ruler.init:
0499 79E6 0649  14         dect  stack
0500 79E8 C64B  30         mov   r11,*stack            ; Save return address
0501                       ;------------------------------------------------------
0502                       ; Setup ruler in memory
0503                       ;------------------------------------------------------
0504 79EA 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     79EC 307E     
0505 79EE 6008                   data bank4.rom        ; | i  p0 = bank address
0506 79F0 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0507 79F2 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0508                       ;------------------------------------------------------
0509                       ; Exit
0510                       ;------------------------------------------------------
0511 79F4 C2F9  30         mov   *stack+,r11           ; Pop r11
0512 79F6 045B  20         b     *r11                  ; Return to caller
0513               
0514               
0515               ***************************************************************
...
0518               ********|*****|*********************|**************************
0519               fb.colorlines:
0520 79F8 0649  14         dect  stack
0521 79FA C64B  30         mov   r11,*stack            ; Save return address
0522                       ;------------------------------------------------------
0523                       ; Colorize frame buffer content
0524                       ;------------------------------------------------------
0525 79FC 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     79FE 307E     
0526 7A00 6008                   data bank4.rom        ; | i  p0 = bank address
0527 7A02 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0528 7A04 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0529                       ;------------------------------------------------------
0530                       ; Exit
0531                       ;------------------------------------------------------
0532 7A06 C2F9  30         mov   *stack+,r11           ; Pop r11
0533 7A08 045B  20         b     *r11                  ; Return to caller
0534               
0535               
0536               ***************************************************************
...
0539               ********|*****|*********************|**************************
0540               fb.vdpdump:
0541 7A0A 0649  14         dect  stack
0542 7A0C C64B  30         mov   r11,*stack            ; Save return address
0543                       ;------------------------------------------------------
0544                       ; Colorize frame buffer content
0545                       ;------------------------------------------------------
0546 7A0E 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7A10 307E     
0547 7A12 6008                   data bank4.rom        ; | i  p0 = bank address
0548 7A14 7FC6                   data vec.4            ; | i  p1 = Vector with target address
0549 7A16 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0550                       ;------------------------------------------------------
0551                       ; Exit
0552                       ;------------------------------------------------------
0553 7A18 C2F9  30         mov   *stack+,r11           ; Pop r11
0554 7A1A 045B  20         b     *r11                  ; Return to caller
0555               
0556               
0557               
0558               **************************************************************
...
0561               ********|*****|*********************|**************************
0562               edb.clear.sams:
0563 7A1C C820  54         mov   @edb.clear.sams.vector,@trmpvector
     7A1E 7A24     
     7A20 A03A     
0564 7A22 102E  14         jmp   _trampoline.bank5.ret ; Longjump
0565               edb.clear.sams.vector:
0566 7A24 7FC0             data  vec.1
0567               
0568               
0569               **************************************************************
...
0574 7A26 C820  54         mov   @edb.hipage.alloc.vector,@trmpvector
     7A28 7A2E     
     7A2A A03A     
0575 7A2C 1029  14         jmp   _trampoline.bank5.ret ; Longjump
0576               edb.hipage.alloc.vector:
0577 7A2E 7FC2             data  vec.2
0578               
0579               
0580               **************************************************************
...
0583               ********|*****|*********************|**************************
0584               edb.block.mark:
0585 7A30 C820  54         mov   @edb.block.mark.vector,@trmpvector
     7A32 7A38     
     7A34 A03A     
0586 7A36 1024  14         jmp   _trampoline.bank5.ret ; Longjump
0587               edb.block.mark.vector:
0588 7A38 7FC4             data  vec.3
0589               
0590               
0591               **************************************************************
...
0596 7A3A C820  54         mov   @edb.block.mark.m1.vector,@trmpvector
     7A3C 7A42     
     7A3E A03A     
0597 7A40 101F  14         jmp   _trampoline.bank5.ret ; Longjump
0598               edb.block.mark.m1.vector:
0599 7A42 7FC6             data  vec.4
0600               
0601               
0602               **************************************************************
...
0607 7A44 C820  54         mov   @edb.block.mark.m2.vector,@trmpvector
     7A46 7A4C     
     7A48 A03A     
0608 7A4A 101A  14         jmp   _trampoline.bank5.ret ; Longjump
0609               edb.block.mark.m2.vector:
0610 7A4C 7FC8             data  vec.5
0611               
0612               
0613               **************************************************************
...
0616               ********|*****|*********************|**************************
0617               edb.block.clip:
0618 7A4E C820  54         mov   @edb.block.clip.vector,@trmpvector
     7A50 7A56     
     7A52 A03A     
0619 7A54 1015  14         jmp   _trampoline.bank5.ret ; Longjump
0620               edb.block.clip.vector:
0621 7A56 7FCA             data  vec.6
0622               
0623               
0624               **************************************************************
...
0629 7A58 C820  54         mov   @edb.block.reset.vector,@trmpvector
     7A5A 7A60     
     7A5C A03A     
0630 7A5E 1010  14         jmp   _trampoline.bank5.ret ; Longjump
0631               edb.block.reset.vector:
0632 7A60 7FCC             data  vec.7
0633               
0634               
0635               **************************************************************
...
0640 7A62 C820  54         mov   @edb.block.delete.vector,@trmpvector
     7A64 7A6A     
     7A66 A03A     
0641 7A68 100B  14         jmp   _trampoline.bank5.ret ; Longjump
0642               edb.block.delete.vector:
0643 7A6A 7FCE             data  vec.8
0644               
0645               
0646               **************************************************************
...
0649               ********|*****|*********************|**************************
0650               edb.block.copy:
0651 7A6C C820  54         mov   @edb.block.copy.vector,@trmpvector
     7A6E 7A74     
     7A70 A03A     
0652 7A72 1006  14         jmp   _trampoline.bank5.ret ; Longjump
0653               edb.block.copy.vector:
0654 7A74 7FD0             data  vec.9
0655               
0656               
0657               **************************************************************
...
0660               ********|*****|*********************|**************************
0661               edb.line.del:
0662 7A76 C820  54         mov   @edb.line.del.vector,@trmpvector
     7A78 7A7E     
     7A7A A03A     
0663 7A7C 1001  14         jmp   _trampoline.bank5.ret ; Longjump
0664               edb.line.del.vector:
0665 7A7E 7FD2             data  vec.10
0666               
0667               
0668               
0669               ***************************************************************
...
0673 7A80 0649  14         dect  stack
0674 7A82 C64B  30         mov   r11,*stack            ; Save return address
0675                       ;------------------------------------------------------
0676                       ; Call routine in specified bank
0677                       ;------------------------------------------------------
0678 7A84 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7A86 307E     
0679 7A88 600A                   data bank5.rom        ; | i  p0 = bank address
0680 7A8A FFFF                   data >ffff            ; | i  p1 = Vector with target address
0681                                                   ; |         (deref @trmpvector)
0682 7A8C 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0683                       ;------------------------------------------------------
0684                       ; Exit
0685                       ;------------------------------------------------------
0686 7A8E C2F9  30         mov   *stack+,r11           ; Pop r11
0687 7A90 045B  20         b     *r11                  ; Return to caller
0688               
0689               
0690               ***************************************************************
...
0695 7A92 0649  14         dect  stack
0696 7A94 C64B  30         mov   r11,*stack            ; Save return address
0697                       ;------------------------------------------------------
0698                       ; Dump VDP patterns
0699                       ;------------------------------------------------------
0700 7A96 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7A98 307E     
0701 7A9A 600C                   data bank6.rom        ; | i  p0 = bank address
0702 7A9C 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0703 7A9E 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0704                       ;------------------------------------------------------
0705                       ; Exit
0706                       ;------------------------------------------------------
0707 7AA0 C2F9  30         mov   *stack+,r11           ; Pop r11
0708 7AA2 045B  20         b     *r11                  ; Return to caller
0709               
0710               
0711               
0712               ***************************************************************
...
0715               ********|*****|*********************|**************************
0716               tibasic1:
0717 7AA4 0204  20         li    tmp0,1
     7AA6 0001     
0718 7AA8 C804  38         mov   tmp0,@tibasic.session
     7AAA A02E     
0719 7AAC 1013  14         jmp   tibasic
0720               tibasic2:
0721 7AAE 0204  20         li    tmp0,2
     7AB0 0002     
0722 7AB2 C804  38         mov   tmp0,@tibasic.session
     7AB4 A02E     
0723 7AB6 100E  14         jmp   tibasic
0724               tibasic3:
0725 7AB8 0204  20         li    tmp0,3
     7ABA 0003     
0726 7ABC C804  38         mov   tmp0,@tibasic.session
     7ABE A02E     
0727 7AC0 1009  14         jmp   tibasic
0728               tibasic4:
0729 7AC2 0204  20         li    tmp0,4
     7AC4 0004     
0730 7AC6 C804  38         mov   tmp0,@tibasic.session
     7AC8 A02E     
0731 7ACA 1004  14         jmp   tibasic
0732               tibasic5:
0733 7ACC 0204  20         li    tmp0,5
     7ACE 0005     
0734 7AD0 C804  38         mov   tmp0,@tibasic.session
     7AD2 A02E     
0735               tibasic:
0736 7AD4 0649  14         dect  stack
0737 7AD6 C64B  30         mov   r11,*stack            ; Save return address
0738                       ;------------------------------------------------------
0739                       ; Dump VDP patterns
0740                       ;------------------------------------------------------
0741 7AD8 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7ADA 307E     
0742 7ADC 600E                   data bank7.rom        ; | i  p0 = bank address
0743 7ADE 7FD2                   data vec.10           ; | i  p1 = Vector with target address
0744 7AE0 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0745                       ;------------------------------------------------------
0746                       ; Exit
0747                       ;------------------------------------------------------
0748 7AE2 C2F9  30         mov   *stack+,r11           ; Pop r11
0749 7AE4 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.24106
...
0038 7AE6 0649  14         dect  stack
0039 7AE8 C64B  30         mov   r11,*stack            ; Save return address
0040                       ;------------------------------------------------------
0041                       ; Dump VDP patterns
0042                       ;------------------------------------------------------
0043 7AEA 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7AEC 307E     
0044 7AEE 600E                   data bank7.rom        ; | i  p0 = bank address
0045 7AF0 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0046 7AF2 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0047                       ;------------------------------------------------------
0048                       ; Exit
0049                       ;------------------------------------------------------
0050 7AF4 C2F9  30         mov   *stack+,r11           ; Pop r11
0051 7AF6 045B  20         b     *r11                  ; Return to caller
0052               
0054               
0055               
0056               ***************************************************************
...
0063 7AF8 0649  14         dect  stack
0064 7AFA C64B  30         mov   r11,*stack            ; Save return address
0065                       ;------------------------------------------------------
0066                       ; Dump VDP patterns
0067                       ;------------------------------------------------------
0068 7AFC 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7AFE 307E     
0069 7B00 600E                   data bank7.rom        ; | i  p0 = bank address
0070 7B02 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0071 7B04 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0072                       ;------------------------------------------------------
0073                       ; Exit
0074                       ;------------------------------------------------------
0075 7B06 C2F9  30         mov   *stack+,r11           ; Pop r11
0076 7B08 045B  20         b     *r11                  ; Return to caller
0077               
0079               
0080               
0081               ***************************************************************
...
0088 7B0A 0649  14         dect  stack
0089 7B0C C64B  30         mov   r11,*stack            ; Save return address
0090                       ;------------------------------------------------------
0091                       ; Dump VDP patterns
0092                       ;------------------------------------------------------
0093 7B0E 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7B10 307E     
0094 7B12 600E                   data bank7.rom        ; | i  p0 = bank address
0095 7B14 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0096 7B16 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0097                       ;------------------------------------------------------
0098                       ; Exit
0099                       ;------------------------------------------------------
0100 7B18 C2F9  30         mov   *stack+,r11           ; Pop r11
0101 7B1A 045B  20         b     *r11                  ; Return to caller
0102               
0104               
0105               
0106               
...
0009                       ; Movement keys
0010                       ;-------------------------------------------------------
0011 7B1C 0D00             byte  key.enter, pane.focus.fb
0012 7B1E 65F0             data  edkey.action.enter
0013               
0014 7B20 0800             byte  key.fctn.s, pane.focus.fb
0015 7B22 61B2             data  edkey.action.left
0016               
0017 7B24 0900             byte  key.fctn.d, pane.focus.fb
0018 7B26 61CC             data  edkey.action.right
0019               
0020 7B28 0B00             byte  key.fctn.e, pane.focus.fb
0021 7B2A 62C4             data  edkey.action.up
0022               
0023 7B2C 0A00             byte  key.fctn.x, pane.focus.fb
0024 7B2E 62CC             data  edkey.action.down
0025               
0026 7B30 BF00             byte  key.fctn.h, pane.focus.fb
0027 7B32 61E8             data  edkey.action.home
0028               
0029 7B34 C000             byte  key.fctn.j, pane.focus.fb
0030 7B36 6212             data  edkey.action.pword
0031               
0032 7B38 C100             byte  key.fctn.k, pane.focus.fb
0033 7B3A 6264             data  edkey.action.nword
0034               
0035 7B3C C200             byte  key.fctn.l, pane.focus.fb
0036 7B3E 61F0             data  edkey.action.end
0037               
0038 7B40 0C00             byte  key.fctn.6, pane.focus.fb
0039 7B42 62D4             data  edkey.action.ppage
0040               
0041 7B44 0200             byte  key.fctn.4, pane.focus.fb
0042 7B46 6310             data  edkey.action.npage
0043               
0044 7B48 8500             byte  key.ctrl.e, pane.focus.fb
0045 7B4A 62D4             data  edkey.action.ppage
0046               
0047 7B4C 9800             byte  key.ctrl.x, pane.focus.fb
0048 7B4E 6310             data  edkey.action.npage
0049               
0050 7B50 7F00             byte  key.fctn.v, pane.focus.fb
0051 7B52 6366             data  edkey.action.topscr
0052               
0053 7B54 BE00             byte  key.fctn.b, pane.focus.fb
0054 7B56 63B0             data  edkey.action.botscr
0055               
0056 7B58 9600             byte  key.ctrl.v, pane.focus.fb
0057 7B5A 634A             data  edkey.action.top
0058               
0059 7B5C 8200             byte  key.ctrl.b, pane.focus.fb
0060 7B5E 6380             data  edkey.action.bot
0061                       ;-------------------------------------------------------
0062                       ; Modifier keys - Delete
0063                       ;-------------------------------------------------------
0064 7B60 0300             byte  key.fctn.1, pane.focus.fb
0065 7B62 643E             data  edkey.action.del_char
0066               
0067 7B64 0700             byte  key.fctn.3, pane.focus.fb
0068 7B66 64F0             data  edkey.action.del_line
0069               
0070 7B68 8C00             byte  key.ctrl.l, pane.focus.fb
0071 7B6A 64BC             data  edkey.action.del_eol
0072                       ;-------------------------------------------------------
0073                       ; Modifier keys - Insert
0074                       ;-------------------------------------------------------
0075 7B6C 0400             byte  key.fctn.2, pane.focus.fb
0076 7B6E 6552             data  edkey.action.ins_char.ws
0077               
0078 7B70 B900             byte  key.fctn.dot, pane.focus.fb
0079 7B72 6668             data  edkey.action.ins_onoff
0080               
0081 7B74 0100             byte  key.fctn.7, pane.focus.fb
0082 7B76 6856             data  edkey.action.fb.tab.next
0083               
0084 7B78 9400             byte  key.ctrl.t, pane.focus.fb
0085 7B7A 6856             data  edkey.action.fb.tab.next
0086               
0087 7B7C 0600             byte  key.fctn.8, pane.focus.fb
0088 7B7E 65E8             data  edkey.action.ins_line
0089                       ;-------------------------------------------------------
0090                       ; Block marking/modifier
0091                       ;-------------------------------------------------------
0092 7B80 F000             byte  key.ctrl.space, pane.focus.fb
0093 7B82 6790             data  edkey.action.block.mark
0094               
0095 7B84 8300             byte  key.ctrl.c, pane.focus.fb
0096 7B86 6730             data  edkey.action.copyblock_or_clipboard
0097               
0098 7B88 8400             byte  key.ctrl.d, pane.focus.fb
0099 7B8A 67E0             data  edkey.action.block.delete
0100               
0101 7B8C 8D00             byte  key.ctrl.m, pane.focus.fb
0102 7B8E 680A             data  edkey.action.block.move
0103               
0104 7B90 8700             byte  key.ctrl.g, pane.focus.fb
0105 7B92 683C             data  edkey.action.block.goto.m1
0106                       ;-------------------------------------------------------
0107                       ; Clipboards
0108                       ;-------------------------------------------------------
0109 7B94 B100             byte  key.ctrl.1, pane.focus.fb
0110 7B96 6864             data  edkey.action.fb.clip.save.1
0111               
0112 7B98 B200             byte  key.ctrl.2, pane.focus.fb
0113 7B9A 686A             data  edkey.action.fb.clip.save.2
0114               
0115 7B9C B300             byte  key.ctrl.3, pane.focus.fb
0116 7B9E 6870             data  edkey.action.fb.clip.save.3
0117               
0118 7BA0 B400             byte  key.ctrl.4, pane.focus.fb
0119 7BA2 6876             data  edkey.action.fb.clip.save.4
0120               
0121 7BA4 B500             byte  key.ctrl.5, pane.focus.fb
0122 7BA6 687C             data  edkey.action.fb.clip.save.5
0123                       ;-------------------------------------------------------
0124                       ; Other action keys
0125                       ;-------------------------------------------------------
0126 7BA8 0500             byte  key.fctn.plus, pane.focus.fb
0127 7BAA 6722             data  edkey.action.quit
0128               
0129 7BAC 9100             byte  key.ctrl.q, pane.focus.fb
0130 7BAE 6722             data  edkey.action.quit
0131               
0132 7BB0 9500             byte  key.ctrl.u, pane.focus.fb
0133 7BB2 66E2             data  edkey.action.toggle.ruler
0134               
0135 7BB4 9A00             byte  key.ctrl.z, pane.focus.fb
0136 7BB6 71B6             data  pane.action.colorscheme.cycle
0137               
0138 7BB8 8000             byte  key.ctrl.comma, pane.focus.fb
0139 7BBA 6740             data  edkey.action.fb.fname.dec.load
0140               
0141 7BBC 9B00             byte  key.ctrl.dot, pane.focus.fb
0142 7BBE 6752             data  edkey.action.fb.fname.inc.load
0143               
0144 7BC0 BB00             byte  key.ctrl.slash, pane.focus.fb
0145 7BC2 7918             data  dialog.basic
0146                       ;-------------------------------------------------------
0147                       ; Dialog keys
0148                       ;-------------------------------------------------------
0149 7BC4 8100             byte  key.ctrl.a, pane.focus.fb
0150 7BC6 7904             data  dialog.append
0151               
0152 7BC8 8800             byte  key.ctrl.h, pane.focus.fb
0153 7BCA 789C             data  edkey.action.about
0154               
0155 7BCC 8600             byte  key.ctrl.f, pane.focus.fb
0156 7BCE 78CE             data  dialog.file
0157               
0158 7BD0 8900             byte  key.ctrl.i, pane.focus.fb
0159 7BD2 78BA             data  dialog.insert
0160               
0161 7BD4 9300             byte  key.ctrl.s, pane.focus.fb
0162 7BD6 78B0             data  dialog.save
0163               
0164 7BD8 8F00             byte  key.ctrl.o, pane.focus.fb
0165 7BDA 78A6             data  dialog.load
0166               
0167 7BDC 9000             byte  key.ctrl.p, pane.focus.fb
0168 7BDE 78C4             data  dialog.print
0169               
0170                       ;
0171                       ; FCTN-9 has multiple purposes, if block mode is on it
0172                       ; resets the block, otherwise show dialog "Main Menu".
0173                       ;
0174 7BE0 0F00             byte  key.fctn.9, pane.focus.fb
0175 7BE2 7922             data  dialog.menu
0176                       ;-------------------------------------------------------
0177                       ; End of list
0178                       ;-------------------------------------------------------
0179 7BE4 FFFF             data  EOL                           ; EOL
0180               
0181               
0182               
0183               *---------------------------------------------------------------
...
0189                       ;-------------------------------------------------------
0190 7BE6 4664             byte  key.uc.f, id.dialog.menu
0191 7BE8 78CE             data  dialog.file
0192               
0193 7BEA 4364             byte  key.uc.c, id.dialog.menu
0194 7BEC 790E             data  dialog.cartridge
0195               
0196 7BEE 4864             byte  key.uc.h, id.dialog.menu
0197 7BF0 789C             data  edkey.action.about
0198               
0199 7BF2 5164             byte  key.uc.q, id.dialog.menu
0200 7BF4 6722             data  edkey.action.quit
0201                       ;-------------------------------------------------------
0202                       ; Dialog: File
0203                       ;-------------------------------------------------------
0204 7BF6 4E69             byte  key.uc.n, id.dialog.file
0205 7BF8 6946             data  edkey.action.cmdb.file.new
0206               
0207 7BFA 5369             byte  key.uc.s, id.dialog.file
0208 7BFC 78B0             data  dialog.save
0209               
0210 7BFE 4F69             byte  key.uc.o, id.dialog.file
0211 7C00 78A6             data  dialog.load
0212               
0213 7C02 5069             byte  key.uc.p, id.dialog.file
0214 7C04 78C4             data  dialog.print
0215               
0216 7C06 4369             byte  key.uc.c, id.dialog.file
0217 7C08 78FA             data  dialog.config
0218                       ;-------------------------------------------------------
0219                       ; Dialog: Open file
0220                       ;-------------------------------------------------------
0221 7C0A 0E0A             byte  key.fctn.5, id.dialog.load
0222 7C0C 6C62             data  edkey.action.cmdb.fastmode.toggle
0223               
0224 7C0E 0D0A             byte  key.enter, id.dialog.load
0225 7C10 696A             data  edkey.action.cmdb.load
0226                       ;-------------------------------------------------------
0227                       ; Dialog: Insert file at line ...
0228                       ;-------------------------------------------------------
0229 7C12 0E0D             byte  key.fctn.5, id.dialog.insert
0230 7C14 6C62             data  edkey.action.cmdb.fastmode.toggle
0231               
0232 7C16 0D0D             byte  key.enter, id.dialog.insert
0233 7C18 69AE             data  edkey.action.cmdb.insert
0234                       ;-------------------------------------------------------
0235                       ; Dialog: Append file
0236                       ;-------------------------------------------------------
0237 7C1A 0E0E             byte  key.fctn.5, id.dialog.append
0238 7C1C 6C62             data  edkey.action.cmdb.fastmode.toggle
0239               
0240 7C1E 0D0E             byte  key.enter, id.dialog.append
0241 7C20 6A30             data  edkey.action.cmdb.append
0242                       ;-------------------------------------------------------
0243                       ; Dialog: Copy clipboard to line ...
0244                       ;-------------------------------------------------------
0245 7C22 0E67             byte  key.fctn.5, id.dialog.clipboard
0246 7C24 6C62             data  edkey.action.cmdb.fastmode.toggle
0247               
0248 7C26 0167             byte  key.fctn.7, id.dialog.clipboard
0249 7C28 78F0             data  dialog.clipdev
0250               
0251 7C2A 3167             byte  key.num.1, id.dialog.clipboard
0252 7C2C 6AA4             data  edkey.action.cmdb.clip.1
0253               
0254 7C2E 3267             byte  key.num.2, id.dialog.clipboard
0255 7C30 6AAA             data  edkey.action.cmdb.clip.2
0256               
0257 7C32 3367             byte  key.num.3, id.dialog.clipboard
0258 7C34 6AB0             data  edkey.action.cmdb.clip.3
0259               
0260 7C36 3467             byte  key.num.4, id.dialog.clipboard
0261 7C38 6AB6             data  edkey.action.cmdb.clip.4
0262               
0263 7C3A 3567             byte  key.num.5, id.dialog.clipboard
0264 7C3C 6ABC             data  edkey.action.cmdb.clip.5
0265                       ;-------------------------------------------------------
0266                       ; Dialog: Configure clipboard device
0267                       ;-------------------------------------------------------
0268 7C3E 0D11             byte  key.enter, id.dialog.clipdev
0269 7C40 6AF0             data  edkey.action.cmdb.clipdev.configure
0270                       ;-------------------------------------------------------
0271                       ; Dialog: Configure
0272                       ;-------------------------------------------------------
0273 7C42 436C             byte  key.uc.c, id.dialog.config
0274 7C44 78F0             data  dialog.clipdev
0275                       ;-------------------------------------------------------
0276                       ; Dialog: Save file
0277                       ;-------------------------------------------------------
0278 7C46 0D0B             byte  key.enter, id.dialog.save
0279 7C48 6B40             data  edkey.action.cmdb.save
0280               
0281 7C4A 0D0C             byte  key.enter, id.dialog.saveblock
0282 7C4C 6B40             data  edkey.action.cmdb.save
0283                       ;-------------------------------------------------------
0284                       ; Dialog: Print file
0285                       ;-------------------------------------------------------
0286 7C4E 0D0F             byte  key.enter, id.dialog.print
0287 7C50 6BBC             data  edkey.action.cmdb.print
0288               
0289 7C52 0D10             byte  key.enter, id.dialog.printblock
0290 7C54 6BBC             data  edkey.action.cmdb.print
0291                       ;-------------------------------------------------------
0292                       ; Dialog: Unsaved changes
0293                       ;-------------------------------------------------------
0294 7C56 0C65             byte  key.fctn.6, id.dialog.unsaved
0295 7C58 6C38             data  edkey.action.cmdb.proceed
0296               
0297 7C5A 2065             byte  key.space, id.dialog.unsaved
0298 7C5C 6C38             data  edkey.action.cmdb.proceed
0299               
0300 7C5E 0D65             byte  key.enter, id.dialog.unsaved
0301 7C60 78B0             data  dialog.save
0302                       ;-------------------------------------------------------
0303                       ; Dialog: Cartridge
0304                       ;-------------------------------------------------------
0305 7C62 426A             byte  key.uc.b, id.dialog.cartridge
0306 7C64 7918             data  dialog.basic
0307                       ;-------------------------------------------------------
0308                       ; Dialog: Basic
0309                       ;-------------------------------------------------------
0310 7C66 316B             byte  key.num.1, id.dialog.basic
0311 7C68 7AA4             data  tibasic1
0312 7C6A 326B             byte  key.num.2, id.dialog.basic
0313 7C6C 7AAE             data  tibasic2
0314 7C6E 336B             byte  key.num.3, id.dialog.basic
0315 7C70 7AB8             data  tibasic3
0316 7C72 346B             byte  key.num.4, id.dialog.basic
0317 7C74 7AC2             data  tibasic4
0318 7C76 356B             byte  key.num.5, id.dialog.basic
0319 7C78 7ACC             data  tibasic5
0320 7C7A 0E6B             byte  key.fctn.5, id.dialog.basic
0321 7C7C 6C6E             data  edkey.action.cmdb.sid.toggle
0322                       ;-------------------------------------------------------
0323                       ; Dialog: Help
0324                       ;-------------------------------------------------------
0325 7C7E 0F68             byte  key.fctn.9, id.dialog.help
0326 7C80 6C82             data  edkey.action.cmdb.close.about
0327               
0328 7C82 0D68             byte  key.enter, id.dialog.help
0329 7C84 6C82             data  edkey.action.cmdb.close.about
0330                       ;-------------------------------------------------------
0331                       ; Movement keys
0332                       ;-------------------------------------------------------
0333 7C86 0801             byte  key.fctn.s, pane.focus.cmdb
0334 7C88 6894             data  edkey.action.cmdb.left
0335               
0336 7C8A 0901             byte  key.fctn.d, pane.focus.cmdb
0337 7C8C 68A6             data  edkey.action.cmdb.right
0338               
0339 7C8E BF01             byte  key.fctn.h, pane.focus.cmdb
0340 7C90 68BE             data  edkey.action.cmdb.home
0341               
0342 7C92 C201             byte  key.fctn.l, pane.focus.cmdb
0343 7C94 68D2             data  edkey.action.cmdb.end
0344                       ;-------------------------------------------------------
0345                       ; Modifier keys
0346                       ;-------------------------------------------------------
0347 7C96 0701             byte  key.fctn.3, pane.focus.cmdb
0348 7C98 68EA             data  edkey.action.cmdb.clear
0349                       ;-------------------------------------------------------
0350                       ; Other action keys
0351                       ;-------------------------------------------------------
0352 7C9A 0F01             byte  key.fctn.9, pane.focus.cmdb
0353 7C9C 6C8E             data  edkey.action.cmdb.close.dialog
0354               
0355 7C9E 0501             byte  key.fctn.plus, pane.focus.cmdb
0356 7CA0 6722             data  edkey.action.quit
0357               
0358 7CA2 8101             byte  key.ctrl.a, pane.focus.cmdb
0359 7CA4 6C7A             data  edkey.action.cmdb.preset
0360               
0361 7CA6 8201             byte  key.ctrl.b, pane.focus.cmdb
0362 7CA8 6C7A             data  edkey.action.cmdb.preset
0363               
0364 7CAA 8301             byte  key.ctrl.c, pane.focus.cmdb
0365 7CAC 6C7A             data  edkey.action.cmdb.preset
0366               
0367 7CAE 9A01             byte  key.ctrl.z, pane.focus.cmdb
0368 7CB0 71B6             data  pane.action.colorscheme.cycle
0369                       ;------------------------------------------------------
0370                       ; End of list
0371                       ;-------------------------------------------------------
0372 7CB2 FFFF             data  EOL                           ; EOL
                   < stevie_b1.asm.24106
0151                       ;-----------------------------------------------------------------------
...
0018 7FD6 7A1C     vec.12  data  edb.clear.sams        ;
...
0025 7FE4 7986     vec.19  data  cmdb.cmd.clear        ;
0026 7FE6 6EAC     vec.20  data  fb.refresh            ;
0027 7FE8 7A0A     vec.21  data  fb.vdpdump            ;
...
0033 7FF4 75FA     vec.27  data  pane.errline.hide     ;
0034 7FF6 743E     vec.28  data  pane.cursor.blink     ;
0035 7FF8 7420     vec.29  data  pane.cursor.hide      ;
0036 7FFA 7598     vec.30  data  pane.errline.show     ;
0037 7FFC 7214     vec.31  data  pane.action.colorscheme.load
0038 7FFE 7406     vec.32  data  pane.action.colorscheme.statlines
                   < stevie_b1.asm.24106
...
0183      36CA     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
