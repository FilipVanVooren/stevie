...
0008               ***************************************************************
0009               * File: stevie_b1.asm               ; Version 211112-2119280
0010               *
0011               * Bank 1 "James"
0012               * Editor core
0013               ***************************************************************
...
0270 6231   42             text  'Build-ID  211112-2119280'
     6232 7569     
     6234 6C64     
     6236 2D49     
     6238 4420     
...
0252                       ; Movement keys
0253                       ;-------------------------------------------------------
0254 7F64 0801             byte  key.fctn.s, pane.focus.cmdb
0255 7F66 6844             data  edkey.action.cmdb.left
0256               
0257 7F68 0901             byte  key.fctn.d, pane.focus.cmdb
0258 7F6A 6856             data  edkey.action.cmdb.right
0259               
0260 7F6C BF01             byte  key.fctn.h, pane.focus.cmdb
0261 7F6E 686E             data  edkey.action.cmdb.home
0262               
0263 7F70 C201             byte  key.fctn.l, pane.focus.cmdb
0264 7F72 6882             data  edkey.action.cmdb.end
0265                       ;-------------------------------------------------------
0266                       ; Modifier keys
0267                       ;-------------------------------------------------------
0268 7F74 0701             byte  key.fctn.3, pane.focus.cmdb
0269 7F76 689A             data  edkey.action.cmdb.clear
0270                       ;-------------------------------------------------------
0271                       ; Other action keys
0272                       ;-------------------------------------------------------
0273 7F78 0F01             byte  key.fctn.9, pane.focus.cmdb
0274 7F7A 6A86             data  edkey.action.cmdb.close.dialog
0275               
0276 7F7C 0501             byte  key.fctn.plus, pane.focus.cmdb
0277 7F7E 6702             data  edkey.action.quit
0278               
0279 7F80 9A01             byte  key.ctrl.z, pane.focus.cmdb
0280 7F82 76A6             data  pane.action.colorscheme.cycle
0281                       ;------------------------------------------------------
0282                       ; End of list
0283                       ;-------------------------------------------------------
0284 7F84 FFFF             data  EOL                           ; EOL
                   < stevie_b1.asm.61284
0172                       ;-----------------------------------------------------------------------
