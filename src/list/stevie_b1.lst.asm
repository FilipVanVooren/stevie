...
0008               ***************************************************************
0009               * File: stevie_b1.asm               ; Version 220110-2051430
0010               *
0011               * Bank 1 "James"
0012               * Editor core
0013               ***************************************************************
...
0270 21ED   42             text  'Build-ID  220110-2051430'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0056                       ;------------------------------------------------------
0057               rkscan.prepare:
0058 28EA C820  54         mov   @scrpad.83c6,@>83c6   ; Required for lowercase support
     28EC 292A     
     28EE 83C6     
0059 28F0 C820  54         mov   @scrpad.83fa,@>83fa   ; Load GPLWS R13
     28F2 292C     
     28F4 83FA     
0060 28F6 C820  54         mov   @scrpad.83fe,@>83fe   ; Load GPLWS R15
     28F8 292E     
     28FA 83FE     
0061               
0062 28FC 04C4  14         clr   tmp0                  ; \ Keyboard mode in MSB
0063                                                   ; / 00=Scan all of keyboard
0064               
0065 28FE D804  38         movb  tmp0,@>8374           ; Set keyboard mode at @>8374
     2900 8374     
0066                                                   ; (scan entire keyboard)
0067               
0068 2902 02E0  18         lwpi  >83e0                 ; Activate GPL workspace
     2904 83E0     
0069 2906 06A0  32         bl    @kscan                ; Call KSCAN
     2908 000E     
0070 290A 02E0  18         lwpi  ws1                   ; Activate user workspace
     290C 8300     
0071                       ;------------------------------------------------------
0072                       ; (3) Check if key pressed
0073                       ;------------------------------------------------------
0074 290E D120  34         movb  @>837c,tmp0           ; Get flag
     2910 837C     
0075 2912 0A34  56         sla   tmp0,3                ; Flag value is >20
0076 2914 1707  14         jnc   rkscan.exit           ; No key pressed, exit early
0077                       ;------------------------------------------------------
0078                       ; (4) Key detected, store in memory
0079                       ;------------------------------------------------------
0080 2916 D120  34         movb  @>8375,tmp0           ; \ Key pressed is at @>8375
     2918 8375     
0081 291A 0984  56         srl   tmp0,8                ; / Move to LSB
0083 291C C804  38         mov   tmp0,@rom0_kscan_out  ; Store ASCII value in user location
     291E A022     
0087 2920 E0A0  34         soc   @wbit11,config        ; Set ANYKEY flag in CONFIG register
     2922 200A     
0088                       ;------------------------------------------------------
0089                       ; Exit
0090                       ;------------------------------------------------------
0091               rkscan.exit:
0092 2924 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0093 2926 C2F9  30         mov   *stack+,r11           ; Pop r11
0094 2928 045B  20         b     *r11                  ; Return to caller
0095               
0096               
0097 292A 0200     scrpad.83c6   data >0200            ; Required for KSCAN to support lowercase
0098 292C 9800     scrpad.83fa   data >9800
0099               
0100               ; Dummy value for GPLWS R15 (instead of VDP write address port 8c02)
0101               ; We do not want console KSCAN to fiddle with VDP registers while Stevie
0102               ; is running
0103               
0104 292E 83A0     scrpad.83fe   data >83a0            ; 8c02
                   < runlib.asm
0190               
...
0022               ********|*****|*********************|**************************
0023 2930 C13B  30 mkhex   mov   *r11+,tmp0            ; P0: Address of word
0024 2932 C83B  50         mov   *r11+,@waux3          ; P1: Pointer to string buffer
     2934 8340     
0025 2936 04E0  34         clr   @waux1
     2938 833C     
0026 293A 04E0  34         clr   @waux2
     293C 833E     
0027 293E 0207  20         li    tmp3,waux1            ; We store results in WAUX1 and WAUX2
     2940 833C     
0028 2942 C114  26         mov   *tmp0,tmp0            ; Get word
0029               *--------------------------------------------------------------
0030               *    Convert nibbles to bytes (is in wrong order)
0031               *--------------------------------------------------------------
0032 2944 0205  20         li    tmp1,4                ; 4 nibbles
     2946 0004     
0033 2948 C184  18 mkhex1  mov   tmp0,tmp2             ; Make work copy
0034 294A 0246  22         andi  tmp2,>000f            ; Only keep LSN
     294C 000F     
0035                       ;------------------------------------------------------
0036                       ; Determine offset for ASCII char
0037                       ;------------------------------------------------------
0038 294E 0286  22         ci    tmp2,>000a
     2950 000A     
0039 2952 1105  14         jlt   mkhex1.digit09
0040                       ;------------------------------------------------------
0041                       ; Add ASCII offset for digits A-F
0042                       ;------------------------------------------------------
0043               mkhex1.digitaf:
0044 2954 C21B  26         mov   *r11,tmp4
0045 2956 0988  56         srl   tmp4,8                ; Right justify
0046 2958 0228  22         ai    tmp4,-10              ; Adjust offset for 'A-F'
     295A FFF6     
0047 295C 1003  14         jmp   mkhex2
0048               
0049               mkhex1.digit09:
0050                       ;------------------------------------------------------
0051                       ; Add ASCII offset for digits 0-9
0052                       ;------------------------------------------------------
0053 295E C21B  26         mov   *r11,tmp4
0054 2960 0248  22         andi  tmp4,>00ff            ; Only keep LSB
     2962 00FF     
0055               
0056 2964 A188  18 mkhex2  a     tmp4,tmp2             ; Add ASCII-offset
0057 2966 06C6  14         swpb  tmp2
0058 2968 DDC6  32         movb  tmp2,*tmp3+           ; Save byte
0059 296A 0944  56         srl   tmp0,4                ; Next nibble
0060 296C 0605  14         dec   tmp1
0061 296E 16EC  14         jne   mkhex1                ; Repeat until all nibbles processed
0062 2970 0242  22         andi  config,>bfff          ; Reset bit 1 in config register
     2972 BFFF     
0063               *--------------------------------------------------------------
0064               *    Build first 2 bytes in correct order
0065               *--------------------------------------------------------------
0066 2974 C160  34         mov   @waux3,tmp1           ; Get pointer
     2976 8340     
0067 2978 04D5  26         clr   *tmp1                 ; Set length byte to 0
0068 297A 0585  14         inc   tmp1                  ; Next byte, not word!
0069 297C C120  34         mov   @waux2,tmp0
     297E 833E     
0070 2980 06C4  14         swpb  tmp0
0071 2982 DD44  32         movb  tmp0,*tmp1+
0072 2984 06C4  14         swpb  tmp0
0073 2986 DD44  32         movb  tmp0,*tmp1+
0074               *--------------------------------------------------------------
0075               *    Set length byte
0076               *--------------------------------------------------------------
0077 2988 C120  34         mov   @waux3,tmp0           ; Get start of string buffer
     298A 8340     
0078 298C D520  46         movb  @hb$04,*tmp0          ; Set lengh byte to 4
     298E 2016     
0079 2990 05CB  14         inct  r11                   ; Skip Parameter P2
0080               *--------------------------------------------------------------
0081               *    Build last 2 bytes in correct order
0082               *--------------------------------------------------------------
0083 2992 C120  34         mov   @waux1,tmp0
     2994 833C     
0084 2996 06C4  14         swpb  tmp0
0085 2998 DD44  32         movb  tmp0,*tmp1+
0086 299A 06C4  14         swpb  tmp0
0087 299C DD44  32         movb  tmp0,*tmp1+
0088               *--------------------------------------------------------------
0089               *    Display hex number ?
0090               *--------------------------------------------------------------
0091 299E 20A0  38         coc   @wbit0,config         ; Check if 'display' bit is set
     29A0 2020     
0092 29A2 1301  14         jeq   mkhex3                ; Yes, so show at current YX position
0093 29A4 045B  20         b     *r11                  ; Exit
0094               *--------------------------------------------------------------
0095               *  Display hex number on screen at current YX position
0096               *--------------------------------------------------------------
0097 29A6 0242  22 mkhex3  andi  config,>7fff          ; Reset bit 0
     29A8 7FFF     
0098 29AA C160  34         mov   @waux3,tmp1           ; Get Pointer to string
     29AC 8340     
0099 29AE 0460  28         b     @xutst0               ; Display string
     29B0 2434     
0100 29B2 0610     prefix  data  >0610                 ; Length byte + blank
0101               
0102               
0103               
0104               ***************************************************************
...
0120               ********|*****|*********************|**************************
0121 29B4 C83B  50 puthex  mov   *r11+,@wyx            ; Set cursor
     29B6 832A     
0122 29B8 0262  22         ori   config,>8000          ; CONFIG register bit 0=1
     29BA 8000     
0123 29BC 10B9  14         jmp   mkhex                 ; Convert number and display
0124               
                   < runlib.asm
0194               
...
0018               ********|*****|*********************|**************************
0019 29BE 0207  20 mknum   li    tmp3,5                ; Digit counter
     29C0 0005     
0020 29C2 C17B  30         mov   *r11+,tmp1            ; \ Get 16 bit unsigned number
0021 29C4 C155  26         mov   *tmp1,tmp1            ; /
0022 29C6 C23B  30         mov   *r11+,tmp4            ; Pointer to string buffer
0023 29C8 0228  22         ai    tmp4,4                ; Get end of buffer
     29CA 0004     
0024 29CC 0206  20         li    tmp2,10               ; Divide by 10 to isolate last digit
     29CE 000A     
0025               *--------------------------------------------------------------
0026               *  Do string conversion
0027               *--------------------------------------------------------------
0028 29D0 04C4  14 mknum1  clr   tmp0                  ; Clear the high word of the dividend
0029 29D2 3D06 128         div   tmp2,tmp0             ; (TMP0:TMP1) / 10 (TMP2)
0030 29D4 06C5  14         swpb  tmp1                  ; Move to high-byte for writing to buffer
0031 29D6 B15B  26         ab    *r11,tmp1             ; Add offset for ASCII digit
0032 29D8 D605  30         movb  tmp1,*tmp4            ; Write remainder to string buffer
0033 29DA C144  18         mov   tmp0,tmp1             ; Move integer result into R4 for next digit
0034 29DC 0608  14         dec   tmp4                  ; Adjust string pointer for next digit
0035 29DE 0607  14         dec   tmp3                  ; Decrease counter
0036 29E0 16F7  14         jne   mknum1                ; Do next digit
0037               *--------------------------------------------------------------
0038               *  Replace leading 0's with fill character
0039               *--------------------------------------------------------------
0040 29E2 0207  20         li    tmp3,4                ; Check first 4 digits
     29E4 0004     
0041 29E6 0588  14         inc   tmp4                  ; Too far, back to buffer start
0042 29E8 C11B  26         mov   *r11,tmp0
0043 29EA 0A84  56         sla   tmp0,8                ; Only keep fill character in HB
0044 29EC 96D8  38 mknum2  cb    *tmp4,*r11            ; Digit = 0 ?
0045 29EE 1305  14         jeq   mknum4                ; Yes, replace with fill character
0046 29F0 05CB  14 mknum3  inct  r11
0047 29F2 20A0  38         coc   @wbit0,config         ; Check if 'display' bit is set
     29F4 2020     
0048 29F6 1305  14         jeq   mknum5                ; Yes, so show at current YX position
0049 29F8 045B  20         b     *r11                  ; Exit
0050 29FA DE04  32 mknum4  movb  tmp0,*tmp4+           ; Replace leading 0 with fill character
0051 29FC 0607  14         dec   tmp3                  ; 4th digit processed ?
0052 29FE 13F8  14         jeq   mknum3                ; Yes, exit
0053 2A00 10F5  14         jmp   mknum2                ; No, next one
0054               *--------------------------------------------------------------
0055               *  Display integer on screen at current YX position
0056               *--------------------------------------------------------------
0057 2A02 0242  22 mknum5  andi  config,>7fff          ; Reset bit 0
     2A04 7FFF     
0058 2A06 C10B  18         mov   r11,tmp0
0059 2A08 0224  22         ai    tmp0,-4
     2A0A FFFC     
0060 2A0C C154  26         mov   *tmp0,tmp1            ; Get buffer address
0061 2A0E 0206  20         li    tmp2,>0500            ; String length = 5
     2A10 0500     
0062 2A12 0460  28         b     @xutstr               ; Display string
     2A14 2436     
0063               
0064               
0065               
...
0091               ********|*****|*********************|**************************
0092               trimnum:
0093 2A16 C13B  30         mov   *r11+,tmp0            ; Get pointer to input string
0094 2A18 C17B  30         mov   *r11+,tmp1            ; Get pointer to output string
0095 2A1A C1BB  30         mov   *r11+,tmp2            ; Get padding character
0096 2A1C 06C6  14         swpb  tmp2                  ; LO <-> HI
0097 2A1E 0207  20         li    tmp3,5                ; Set counter
     2A20 0005     
0098                       ;------------------------------------------------------
0099                       ; Scan for padding character from left to right
0100                       ;------------------------------------------------------:
0101               trimnum_scan:
0102 2A22 9194  26         cb    *tmp0,tmp2            ; Matches padding character ?
0103 2A24 1604  14         jne   trimnum_setlen        ; No, exit loop
0104 2A26 0584  14         inc   tmp0                  ; Next character
0105 2A28 0607  14         dec   tmp3                  ; Last digit reached ?
0106 2A2A 1301  14         jeq   trimnum_setlen        ; yes, exit loop
0107 2A2C 10FA  14         jmp   trimnum_scan
0108                       ;------------------------------------------------------
0109                       ; Scan completed, set length byte new string
0110                       ;------------------------------------------------------
0111               trimnum_setlen:
0112 2A2E 06C7  14         swpb  tmp3                  ; LO <-> HI
0113 2A30 DD47  32         movb  tmp3,*tmp1+           ; Update string-length in work buffer
0114 2A32 06C7  14         swpb  tmp3                  ; LO <-> HI
0115                       ;------------------------------------------------------
0116                       ; Start filling new string
0117                       ;------------------------------------------------------
0118               trimnum_fill:
0119 2A34 DD74  42         movb  *tmp0+,*tmp1+         ; Copy character
0120 2A36 0607  14         dec   tmp3                  ; Last character ?
0121 2A38 16FD  14         jne   trimnum_fill          ; Not yet, repeat
0122 2A3A 045B  20         b     *r11                  ; Return
0123               
0124               
0125               
0126               
...
0138               ********|*****|*********************|**************************
0139 2A3C C83B  50 putnum  mov   *r11+,@wyx            ; Set cursor
     2A3E 832A     
0140 2A40 0262  22         ori   config,>8000          ; CONFIG register bit 0=1
     2A42 8000     
0141 2A44 10BC  14         jmp   mknum                 ; Convert number and display
                   < runlib.asm
0198               
0202               
0206               
...
0020               ********|*****|*********************|**************************
0021               string.ltrim:
0022 2A46 0649  14         dect  stack
0023 2A48 C64B  30         mov   r11,*stack            ; Save return address
0024 2A4A 0649  14         dect  stack
0025 2A4C C644  30         mov   tmp0,*stack           ; Push tmp0
0026 2A4E 0649  14         dect  stack
0027 2A50 C645  30         mov   tmp1,*stack           ; Push tmp1
0028 2A52 0649  14         dect  stack
0029 2A54 C646  30         mov   tmp2,*stack           ; Push tmp2
0030 2A56 0649  14         dect  stack
0031 2A58 C647  30         mov   tmp3,*stack           ; Push tmp3
0032                       ;-----------------------------------------------------------------------
0033                       ; Get parameter values
0034                       ;-----------------------------------------------------------------------
0035 2A5A C13B  30         mov   *r11+,tmp0            ; Pointer to length-prefixed string
0036 2A5C C17B  30         mov   *r11+,tmp1            ; RAM work buffer
0037 2A5E C1BB  30         mov   *r11+,tmp2            ; Fill character
0038 2A60 100A  14         jmp   !
0039                       ;-----------------------------------------------------------------------
0040                       ; Register version
0041                       ;-----------------------------------------------------------------------
0042               xstring.ltrim:
0043 2A62 0649  14         dect  stack
0044 2A64 C64B  30         mov   r11,*stack            ; Save return address
0045 2A66 0649  14         dect  stack
0046 2A68 C644  30         mov   tmp0,*stack           ; Push tmp0
0047 2A6A 0649  14         dect  stack
0048 2A6C C645  30         mov   tmp1,*stack           ; Push tmp1
0049 2A6E 0649  14         dect  stack
0050 2A70 C646  30         mov   tmp2,*stack           ; Push tmp2
0051 2A72 0649  14         dect  stack
0052 2A74 C647  30         mov   tmp3,*stack           ; Push tmp3
0053                       ;-----------------------------------------------------------------------
0054                       ; Start
0055                       ;-----------------------------------------------------------------------
0056 2A76 C1D4  26 !       mov   *tmp0,tmp3
0057 2A78 06C7  14         swpb  tmp3                  ; LO <-> HI
0058 2A7A 0247  22         andi  tmp3,>00ff            ; Discard HI byte tmp2 (only keep length)
     2A7C 00FF     
0059 2A7E 0A86  56         sla   tmp2,8                ; LO -> HI fill character
0060                       ;-----------------------------------------------------------------------
0061                       ; Scan string from left to right and compare with fill character
0062                       ;-----------------------------------------------------------------------
0063               string.ltrim.scan:
0064 2A80 9194  26         cb    *tmp0,tmp2            ; Do we have a fill character?
0065 2A82 1604  14         jne   string.ltrim.move     ; No, now move string left
0066 2A84 0584  14         inc   tmp0                  ; Next byte
0067 2A86 0607  14         dec   tmp3                  ; Shorten string length
0068 2A88 1301  14         jeq   string.ltrim.move     ; Exit if all characters processed
0069 2A8A 10FA  14         jmp   string.ltrim.scan     ; Scan next characer
0070                       ;-----------------------------------------------------------------------
0071                       ; Copy part of string to RAM work buffer (This is the left-justify)
0072                       ;-----------------------------------------------------------------------
0073               string.ltrim.move:
0074 2A8C 9194  26         cb    *tmp0,tmp2            ; Do we have a fill character?
0075 2A8E C1C7  18         mov   tmp3,tmp3             ; String length = 0 ?
0076 2A90 1306  14         jeq   string.ltrim.panic    ; File length assert
0077 2A92 C187  18         mov   tmp3,tmp2
0078 2A94 06C7  14         swpb  tmp3                  ; HI <-> LO
0079 2A96 DD47  32         movb  tmp3,*tmp1+           ; Set new string length byte in RAM workbuf
0080               
0081 2A98 06A0  32         bl    @xpym2m               ; tmp0 = Memory source address
     2A9A 24F4     
0082                                                   ; tmp1 = Memory target address
0083                                                   ; tmp2 = Number of bytes to copy
0084 2A9C 1004  14         jmp   string.ltrim.exit
0085                       ;-----------------------------------------------------------------------
0086                       ; CPU crash
0087                       ;-----------------------------------------------------------------------
0088               string.ltrim.panic:
0089 2A9E C80B  38         mov   r11,@>ffce            ; \ Save caller address
     2AA0 FFCE     
0090 2AA2 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     2AA4 2026     
0091                       ;----------------------------------------------------------------------
0092                       ; Exit
0093                       ;----------------------------------------------------------------------
0094               string.ltrim.exit:
0095 2AA6 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0096 2AA8 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0097 2AAA C179  30         mov   *stack+,tmp1          ; Pop tmp1
0098 2AAC C139  30         mov   *stack+,tmp0          ; Pop tmp0
0099 2AAE C2F9  30         mov   *stack+,r11           ; Pop r11
0100 2AB0 045B  20         b     *r11                  ; Return to caller
0101               
0102               
0103               
0104               
...
0121               ********|*****|*********************|**************************
0122               string.getlenc:
0123 2AB2 0649  14         dect  stack
0124 2AB4 C64B  30         mov   r11,*stack            ; Save return address
0125 2AB6 05D9  26         inct  *stack                ; Skip "data P0"
0126 2AB8 05D9  26         inct  *stack                ; Skip "data P1"
0127 2ABA 0649  14         dect  stack
0128 2ABC C644  30         mov   tmp0,*stack           ; Push tmp0
0129 2ABE 0649  14         dect  stack
0130 2AC0 C645  30         mov   tmp1,*stack           ; Push tmp1
0131 2AC2 0649  14         dect  stack
0132 2AC4 C646  30         mov   tmp2,*stack           ; Push tmp2
0133                       ;-----------------------------------------------------------------------
0134                       ; Get parameter values
0135                       ;-----------------------------------------------------------------------
0136 2AC6 C13B  30         mov   *r11+,tmp0            ; Pointer to C-style string
0137 2AC8 C17B  30         mov   *r11+,tmp1            ; String termination character
0138 2ACA 1008  14         jmp   !
0139                       ;-----------------------------------------------------------------------
0140                       ; Register version
0141                       ;-----------------------------------------------------------------------
0142               xstring.getlenc:
0143 2ACC 0649  14         dect  stack
0144 2ACE C64B  30         mov   r11,*stack            ; Save return address
0145 2AD0 0649  14         dect  stack
0146 2AD2 C644  30         mov   tmp0,*stack           ; Push tmp0
0147 2AD4 0649  14         dect  stack
0148 2AD6 C645  30         mov   tmp1,*stack           ; Push tmp1
0149 2AD8 0649  14         dect  stack
0150 2ADA C646  30         mov   tmp2,*stack           ; Push tmp2
0151                       ;-----------------------------------------------------------------------
0152                       ; Start
0153                       ;-----------------------------------------------------------------------
0154 2ADC 0A85  56 !       sla   tmp1,8                ; LSB to MSB
0155 2ADE 04C6  14         clr   tmp2                  ; Loop counter
0156                       ;-----------------------------------------------------------------------
0157                       ; Scan string for termination character
0158                       ;-----------------------------------------------------------------------
0159               string.getlenc.loop:
0160 2AE0 0586  14         inc   tmp2
0161 2AE2 9174  28         cb    *tmp0+,tmp1           ; Compare character
0162 2AE4 1304  14         jeq   string.getlenc.putlength
0163                       ;-----------------------------------------------------------------------
0164                       ; Assert on string length
0165                       ;-----------------------------------------------------------------------
0166 2AE6 0286  22         ci    tmp2,255
     2AE8 00FF     
0167 2AEA 1505  14         jgt   string.getlenc.panic
0168 2AEC 10F9  14         jmp   string.getlenc.loop
0169                       ;-----------------------------------------------------------------------
0170                       ; Return length
0171                       ;-----------------------------------------------------------------------
0172               string.getlenc.putlength:
0173 2AEE 0606  14         dec   tmp2                  ; One time adjustment
0174 2AF0 C806  38         mov   tmp2,@waux1           ; Store length
     2AF2 833C     
0175 2AF4 1004  14         jmp   string.getlenc.exit   ; Exit
0176                       ;-----------------------------------------------------------------------
0177                       ; CPU crash
0178                       ;-----------------------------------------------------------------------
0179               string.getlenc.panic:
0180 2AF6 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     2AF8 FFCE     
0181 2AFA 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     2AFC 2026     
0182                       ;----------------------------------------------------------------------
0183                       ; Exit
0184                       ;----------------------------------------------------------------------
0185               string.getlenc.exit:
0186 2AFE C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0187 2B00 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0188 2B02 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0189 2B04 C2F9  30         mov   *stack+,r11           ; Pop r11
0190 2B06 045B  20         b     *r11                  ; Return to caller
                   < runlib.asm
0218               
0222               
...
0023 2B08 C800  38         mov   r0,@cpu.scrpad.tgt    ; Save @>8300 (r0)
     2B0A F960     
0024 2B0C C801  38         mov   r1,@cpu.scrpad.tgt+2  ; Save @>8302 (r1)
     2B0E F962     
0025 2B10 C802  38         mov   r2,@cpu.scrpad.tgt+4  ; Save @>8304 (r2)
     2B12 F964     
0026                       ;------------------------------------------------------
0027                       ; Prepare for copy loop
0028                       ;------------------------------------------------------
0029 2B14 0200  20         li    r0,>8306              ; Scratchpad source address
     2B16 8306     
0030 2B18 0201  20         li    r1,cpu.scrpad.tgt+6   ; RAM target address
     2B1A F966     
0031 2B1C 0202  20         li    r2,62                 ; Loop counter
     2B1E 003E     
0032                       ;------------------------------------------------------
0033                       ; Copy memory range >8306 - >83ff
0034                       ;------------------------------------------------------
0035               cpu.scrpad.backup.copy:
0036 2B20 CC70  46         mov   *r0+,*r1+
0037 2B22 CC70  46         mov   *r0+,*r1+
0038 2B24 0642  14         dect  r2
0039 2B26 16FC  14         jne   cpu.scrpad.backup.copy
0040 2B28 C820  54         mov   @>83fe,@cpu.scrpad.tgt + >fe
     2B2A 83FE     
     2B2C FA5E     
0041                                                   ; Copy last word
0042                       ;------------------------------------------------------
...
0044                       ;------------------------------------------------------
0045 2B2E C020  34         mov   @cpu.scrpad.tgt,r0    ; Restore r0
     2B30 F960     
0046 2B32 C060  34         mov   @cpu.scrpad.tgt+2,r1  ; Restore r1
     2B34 F962     
0047 2B36 C0A0  34         mov   @cpu.scrpad.tgt+4,r2  ; Restore r2
     2B38 F964     
0048                       ;------------------------------------------------------
0049                       ; Exit
0050                       ;------------------------------------------------------
0051               cpu.scrpad.backup.exit:
0052 2B3A 045B  20         b     *r11                  ; Return to caller
0053               
0054               
0055               ***************************************************************
...
0073                       ;------------------------------------------------------
0074 2B3C 0200  20         li    r0,cpu.scrpad.tgt
     2B3E F960     
0075 2B40 0201  20         li    r1,>8300
     2B42 8300     
0076                       ;------------------------------------------------------
0077                       ; Copy 256 bytes from @cpu.scrpad.tgt to >8300
0078                       ;------------------------------------------------------
0079               cpu.scrpad.restore.copy:
0080 2B44 CC70  46         mov   *r0+,*r1+
0081 2B46 CC70  46         mov   *r0+,*r1+
0082 2B48 0281  22         ci    r1,>8400
     2B4A 8400     
0083 2B4C 11FB  14         jlt   cpu.scrpad.restore.copy
0084                       ;------------------------------------------------------
0085                       ; Exit
0086                       ;------------------------------------------------------
0087               cpu.scrpad.restore.exit:
0088 2B4E 045B  20         b     *r11                  ; Return to caller
                   < runlib.asm
...
0038 2B50 C15B  26         mov   *r11,tmp1             ; tmp1 = Memory target address
0039                       ;------------------------------------------------------
0040                       ; Copy registers r0-r7
0041                       ;------------------------------------------------------
0042 2B52 CD40  34         mov   r0,*tmp1+             ; Backup r0
0043 2B54 CD41  34         mov   r1,*tmp1+             ; Backup r1
0044 2B56 CD42  34         mov   r2,*tmp1+             ; Backup r2
0045 2B58 CD43  34         mov   r3,*tmp1+             ; Backup r3
0046 2B5A CD44  34         mov   r4,*tmp1+             ; Backup r4
0047 2B5C CD45  34         mov   r5,*tmp1+             ; Backup r5 (is tmp1, so is bogus)
0048 2B5E CD46  34         mov   r6,*tmp1+             ; Backup r6
0049 2B60 CD47  34         mov   r7,*tmp1+             ; Backup r7
0050                       ;------------------------------------------------------
0051                       ; Copy scratchpad memory to destination
0052                       ;------------------------------------------------------
0053               xcpu.scrpad.pgout:
0054 2B62 0204  20         li    tmp0,>8310            ; tmp0 = Memory source address
     2B64 8310     
0055                                                   ;        as of register r8
0056 2B66 0206  20         li    tmp2,15               ; tmp2 = 15 iterations
     2B68 000F     
0057                       ;------------------------------------------------------
0058                       ; Copy memory
0059                       ;------------------------------------------------------
0060 2B6A CD74  46 !       mov   *tmp0+,*tmp1+         ; Copy word 1
0061 2B6C CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 2
0062 2B6E CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 3
0063 2B70 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 4
0064 2B72 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 5
0065 2B74 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 6
0066 2B76 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 7
0067 2B78 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 8
0068 2B7A 0606  14         dec   tmp2
0069 2B7C 16F6  14         jne   -!                    ; Loop until done
0070                       ;------------------------------------------------------
0071                       ; Switch to newly copied workspace
0072                       ;------------------------------------------------------
0073 2B7E C37B  30         mov   *r11+,r13             ; R13=WP   (pop tmp1 from stack)
0074 2B80 020E  20         li    r14,cpu.scrpad.pgout.after.rtwp
     2B82 2B88     
0075                                                   ; R14=PC
0076 2B84 04CF  14         clr   r15                   ; R15=STATUS
0077                       ;------------------------------------------------------
0078                       ; If we get here, WS was copied to specified
0079                       ; destination.  Also contents of r13,r14,r15
0080                       ; are about to be overwritten by rtwp instruction.
0081                       ;------------------------------------------------------
0082 2B86 0380  18         rtwp                        ; Activate copied workspace
0083                                                   ; in non-scratchpad memory!
0084               
0085               cpu.scrpad.pgout.after.rtwp:
0086 2B88 0460  28         b     @cpu.scrpad.restore   ; Restore scratchpad memory
     2B8A 2B3C     
...
0093 2B8C 045B  20         b     *r11                  ; Return to caller
0094               
0095               
0096               ***************************************************************
...
0120 2B8E C13B  30         mov   *r11+,tmp0            ; tmp0 = Memory source address
0121                       ;------------------------------------------------------
0122                       ; Copy scratchpad memory to destination
0123                       ;------------------------------------------------------
0124               xcpu.scrpad.pgin:
0125 2B90 0205  20         li    tmp1,>8300            ; tmp1 = Memory destination address
     2B92 8300     
0126 2B94 0206  20         li    tmp2,16               ; tmp2 = 256/16
     2B96 0010     
0127                       ;------------------------------------------------------
0128                       ; Copy memory
0129                       ;------------------------------------------------------
0130 2B98 CD74  46 !       mov   *tmp0+,*tmp1+         ; Copy word 1
0131 2B9A CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 2
0132 2B9C CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 3
0133 2B9E CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 4
0134 2BA0 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 5
0135 2BA2 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 6
0136 2BA4 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 7
0137 2BA6 CD74  46         mov   *tmp0+,*tmp1+         ; Copy word 8
0138 2BA8 0606  14         dec   tmp2
0139 2BAA 16F6  14         jne   -!                    ; Loop until done
0140                       ;------------------------------------------------------
0141                       ; Switch workspace to scratchpad memory
0142                       ;------------------------------------------------------
0143 2BAC 02E0  18         lwpi  >8300                 ; Activate copied workspace
     2BAE 8300     
0144                       ;------------------------------------------------------
0145                       ; Exit
0146                       ;------------------------------------------------------
0147               cpu.scrpad.pgin.exit:
0148 2BB0 045B  20         b     *r11                  ; Return to caller
                   < runlib.asm
0227               
...
0055               ********|*****|*********************|**************************
0056 2BB2 A400     dsrlnk  data  dsrlnk.dsrlws         ; dsrlnk workspace
0057 2BB4 2BB6             data  dsrlnk.init           ; Entry point
0058                       ;------------------------------------------------------
0059                       ; DSRLNK entry point
0060                       ;------------------------------------------------------
0061               dsrlnk.init:
0062 2BB6 C17E  30         mov   *r14+,r5              ; Get pgm type for link
0063 2BB8 C805  38         mov   r5,@dsrlnk.sav8a      ; Save data following blwp @dsrlnk (8 or >a)
     2BBA A428     
0064 2BBC 53E0  34         szcb  @hb$20,r15            ; Reset equal bit in status register
     2BBE 201C     
0065 2BC0 C020  34         mov   @>8356,r0             ; Get pointer to PAB+9 in VDP
     2BC2 8356     
0066 2BC4 C240  18         mov   r0,r9                 ; Save pointer
0067                       ;------------------------------------------------------
0068                       ; Fetch file descriptor length from PAB
0069                       ;------------------------------------------------------
0070 2BC6 0229  22         ai    r9,>fff8              ; Adjust r9 to addr PAB byte 1
     2BC8 FFF8     
0071                                                   ; FLAG byte->(pabaddr+9)-8
0072 2BCA C809  38         mov   r9,@dsrlnk.flgptr     ; Save pointer to PAB byte 1
     2BCC A434     
0073                       ;---------------------------; Inline VSBR start
0074 2BCE 06C0  14         swpb  r0                    ;
0075 2BD0 D800  38         movb  r0,@vdpa              ; Send low byte
     2BD2 8C02     
0076 2BD4 06C0  14         swpb  r0                    ;
0077 2BD6 D800  38         movb  r0,@vdpa              ; Send high byte
     2BD8 8C02     
0078 2BDA D0E0  34         movb  @vdpr,r3              ; Read byte from VDP RAM
     2BDC 8800     
0079                       ;---------------------------; Inline VSBR end
0080 2BDE 0983  56         srl   r3,8                  ; Move to low byte
0081               
0082                       ;------------------------------------------------------
0083                       ; Fetch file descriptor device name from PAB
0084                       ;------------------------------------------------------
0085 2BE0 0704  14         seto  r4                    ; Init counter
0086 2BE2 0202  20         li    r2,dsrlnk.namsto      ; Point to 8-byte CPU buffer
     2BE4 A420     
0087 2BE6 0580  14 !       inc   r0                    ; Point to next char of name
0088 2BE8 0584  14         inc   r4                    ; Increment char counter
0089 2BEA 0284  22         ci    r4,>0007              ; Check if length more than 7 chars
     2BEC 0007     
0090 2BEE 1573  14         jgt   dsrlnk.error.devicename_invalid
0091                                                   ; Yes, error
0092 2BF0 80C4  18         c     r4,r3                 ; End of name?
0093 2BF2 130C  14         jeq   dsrlnk.device_name.get_length
0094                                                   ; Yes
0095               
0096                       ;---------------------------; Inline VSBR start
0097 2BF4 06C0  14         swpb  r0                    ;
0098 2BF6 D800  38         movb  r0,@vdpa              ; Send low byte
     2BF8 8C02     
0099 2BFA 06C0  14         swpb  r0                    ;
0100 2BFC D800  38         movb  r0,@vdpa              ; Send high byte
     2BFE 8C02     
0101 2C00 D060  34         movb  @vdpr,r1              ; Read byte from VDP RAM
     2C02 8800     
...
0106                       ;------------------------------------------------------
0107 2C04 DC81  32         movb  r1,*r2+               ; Move into buffer
0108 2C06 9801  38         cb    r1,@dsrlnk.period     ; Is character a '.'
     2C08 2D22     
0109 2C0A 16ED  14         jne   -!                    ; No, loop next char
0110                       ;------------------------------------------------------
0111                       ; Determine device name length
0112                       ;------------------------------------------------------
0113               dsrlnk.device_name.get_length:
0114 2C0C C104  18         mov   r4,r4                 ; Check if length = 0
0115 2C0E 1363  14         jeq   dsrlnk.error.devicename_invalid
0116                                                   ; Yes, error
0117 2C10 04E0  34         clr   @>83d0
     2C12 83D0     
0118 2C14 C804  38         mov   r4,@>8354             ; Save name length for search (length
     2C16 8354     
0119                                                   ; goes to >8355 but overwrites >8354!)
0120 2C18 C804  38         mov   r4,@dsrlnk.savlen     ; Save name length for nextr dsrlnk call
     2C1A A432     
0121               
0122 2C1C 0584  14         inc   r4                    ; Adjust for dot
0123 2C1E A804  38         a     r4,@>8356             ; Point to position after name
     2C20 8356     
0124 2C22 C820  54         mov   @>8356,@dsrlnk.savpab ; Save pointer for next dsrlnk call
     2C24 8356     
     2C26 A42E     
0125                       ;------------------------------------------------------
...
0129 2C28 02E0  18         lwpi  >83e0                 ; Use GPL WS
     2C2A 83E0     
0130 2C2C 04C1  14         clr   r1                    ; Version found of dsr
0131 2C2E 020C  20         li    r12,>0f00             ; Init cru address
     2C30 0F00     
0132                       ;------------------------------------------------------
0133                       ; Turn off ROM on current card
0134                       ;------------------------------------------------------
0135               dsrlnk.dsrscan.cardoff:
0136 2C32 C30C  18         mov   r12,r12               ; Anything to turn off?
0137 2C34 1301  14         jeq   dsrlnk.dsrscan.cardloop
0138                                                   ; No, loop over cards
0139 2C36 1E00  20         sbz   0                     ; Yes, turn off
0140                       ;------------------------------------------------------
0141                       ; Loop over cards and look if DSR present
0142                       ;------------------------------------------------------
0143               dsrlnk.dsrscan.cardloop:
0144 2C38 022C  22         ai    r12,>0100             ; Next ROM to turn on
     2C3A 0100     
0145 2C3C 04E0  34         clr   @>83d0                ; Clear in case we are done
     2C3E 83D0     
0146 2C40 028C  22         ci    r12,>2000             ; Card scan complete? (>1000 to >1F00)
     2C42 2000     
0147 2C44 1346  14         jeq   dsrlnk.error.nodsr_found
0148                                                   ; Yes, no matching DSR found
0149 2C46 C80C  38         mov   r12,@>83d0            ; Save address of next cru
     2C48 83D0     
0150                       ;------------------------------------------------------
0151                       ; Look at card ROM (@>4000 eq 'AA' ?)
0152                       ;------------------------------------------------------
0153 2C4A 1D00  20         sbo   0                     ; Turn on ROM
0154 2C4C 0202  20         li    r2,>4000              ; Start at beginning of ROM
     2C4E 4000     
0155 2C50 9812  46         cb    *r2,@dsrlnk.$aa00     ; Check for a valid DSR header
     2C52 2D1E     
0156 2C54 16EE  14         jne   dsrlnk.dsrscan.cardoff
...
0164                       ;------------------------------------------------------
0165 2C56 A0A0  34         a     @dsrlnk.dstype,r2     ; Goto first pointer (byte 8 or 10)
     2C58 A40A     
0166 2C5A 1003  14         jmp   dsrlnk.dsrscan.getentry
0167                       ;------------------------------------------------------
0168                       ; Next DSR entry
0169                       ;------------------------------------------------------
0170               dsrlnk.dsrscan.nextentry:
0171 2C5C C0A0  34         mov   @>83d2,r2             ; Offset 0 > Fetch link to next DSR or
     2C5E 83D2     
0172                                                   ; subprogram
0173               
0174 2C60 1D00  20         sbo   0                     ; Turn ROM back on
0175                       ;------------------------------------------------------
0176                       ; Get DSR entry
0177                       ;------------------------------------------------------
0178               dsrlnk.dsrscan.getentry:
0179 2C62 C092  26         mov   *r2,r2                ; Is address a zero? (end of chain?)
0180 2C64 13E6  14         jeq   dsrlnk.dsrscan.cardoff
0181                                                   ; Yes, no more DSRs or programs to check
0182 2C66 C802  38         mov   r2,@>83d2             ; Offset 0 > Store link to next DSR or
     2C68 83D2     
0183                                                   ; subprogram
0184               
0185 2C6A 05C2  14         inct  r2                    ; Offset 2 > Has call address of current
0186                                                   ; DSR/subprogram code
0187               
0188 2C6C C272  30         mov   *r2+,r9               ; Store call address in r9. Move r2 to
0189                                                   ; offset 4 (DSR/subprogram name)
0190                       ;------------------------------------------------------
0191                       ; Check file descriptor in DSR
0192                       ;------------------------------------------------------
0193 2C6E 04C5  14         clr   r5                    ; Remove any old stuff
0194 2C70 D160  34         movb  @>8355,r5             ; Get length as counter
     2C72 8355     
0195 2C74 1309  14         jeq   dsrlnk.dsrscan.call_dsr
0196                                                   ; If zero, do not further check, call DSR
0197                                                   ; program
0198               
0199 2C76 9C85  32         cb    r5,*r2+               ; See if length matches
0200 2C78 16F1  14         jne   dsrlnk.dsrscan.nextentry
0201                                                   ; No, length does not match.
0202                                                   ; Go process next DSR entry
0203               
0204 2C7A 0985  56         srl   r5,8                  ; Yes, move to low byte
0205 2C7C 0206  20         li    r6,dsrlnk.namsto      ; Point to 8-byte CPU buffer
     2C7E A420     
0206 2C80 9CB6  42 !       cb    *r6+,*r2+             ; Compare byte in CPU buffer with byte in
0207                                                   ; DSR ROM
0208 2C82 16EC  14         jne   dsrlnk.dsrscan.nextentry
0209                                                   ; Try next DSR entry if no match
0210 2C84 0605  14         dec   r5                    ; Update loop counter
0211 2C86 16FC  14         jne   -!                    ; Loop until full length checked
0212                       ;------------------------------------------------------
0213                       ; Call DSR program in card/device
0214                       ;------------------------------------------------------
0215               dsrlnk.dsrscan.call_dsr:
0216 2C88 0581  14         inc   r1                    ; Next version found
0217 2C8A C80C  38         mov   r12,@dsrlnk.savcru    ; Save CRU address
     2C8C A42A     
0218 2C8E C809  38         mov   r9,@dsrlnk.savent     ; Save DSR entry address
     2C90 A42C     
0219 2C92 C801  38         mov   r1,@dsrlnk.savver     ; Save DSR Version number
     2C94 A430     
0220               
0221 2C96 020D  20         li    r13,>9800             ; Set GROM base to >9800 to prevent
     2C98 9800     
0222                                                   ; lockup of TI Disk Controller DSR.
0223               
0224 2C9A 020F  20         li    r15,>8C02             ; Set VDP port address, needed to prevent
     2C9C 8C02     
0225                                                   ; lockup of TI Disk Controller DSR.
0226               
0227 2C9E 0699  24         bl    *r9                   ; Execute DSR
0228                       ;
0229                       ; Depending on IO result the DSR in card ROM does RET
0230                       ; or (INCT R11 + RET), meaning either (1) or (2) get executed.
0231                       ;
0232 2CA0 10DD  14         jmp   dsrlnk.dsrscan.nextentry
0233                                                   ; (1) error return
0234 2CA2 1E00  20         sbz   0                     ; (2) turn off card/device if good return
0235 2CA4 02E0  18         lwpi  dsrlnk.dsrlws         ; (2) restore workspace
     2CA6 A400     
0236 2CA8 C009  18         mov   r9,r0                 ; Point to flag byte (PAB+1) in VDP PAB
0237                       ;------------------------------------------------------
0238                       ; Returned from DSR
0239                       ;------------------------------------------------------
0240               dsrlnk.dsrscan.return_dsr:
0241 2CAA C060  34         mov   @dsrlnk.sav8a,r1      ; get back data following blwp @dsrlnk
     2CAC A428     
0242                                                   ; (8 or >a)
0243 2CAE 0281  22         ci    r1,8                  ; was it 8?
     2CB0 0008     
0244 2CB2 1303  14         jeq   dsrlnk.dsrscan.dsr.8  ; yes, jump: normal dsrlnk
0245 2CB4 D060  34         movb  @>8350,r1             ; no, we have a data >a.
     2CB6 8350     
0246                                                   ; Get error byte from @>8350
0247 2CB8 1008  14         jmp   dsrlnk.dsrscan.dsr.a  ; go and return error byte to the caller
0248               
0249                       ;------------------------------------------------------
...
0254 2CBA 06C0  14         swpb  r0                    ;
0255 2CBC D800  38         movb  r0,@vdpa              ; send low byte
     2CBE 8C02     
0256 2CC0 06C0  14         swpb  r0                    ;
0257 2CC2 D800  38         movb  r0,@vdpa              ; send high byte
     2CC4 8C02     
0258 2CC6 D060  34         movb  @vdpr,r1              ; read byte from VDP ram
     2CC8 8800     
...
0265 2CCA 09D1  56         srl   r1,13                 ; just keep error bits
0266 2CCC 1605  14         jne   dsrlnk.error.io_error
0267                                                   ; handle IO error
0268 2CCE 0380  18         rtwp                        ; Return from DSR workspace to caller
0269                                                   ; workspace
0270               
0271                       ;------------------------------------------------------
...
0275 2CD0 1E00  20         sbz   >00                   ; Turn card off, nomatter what
0276               dsrlnk.error.nodsr_found:
0277 2CD2 02E0  18         lwpi  dsrlnk.dsrlws         ; No DSR found, restore workspace
     2CD4 A400     
0278               dsrlnk.error.devicename_invalid:
0279 2CD6 04C1  14         clr   r1                    ; clear flag for error 0 = bad device name
0280               dsrlnk.error.io_error:
0281 2CD8 06C1  14         swpb  r1                    ; put error in hi byte
0282 2CDA D741  30         movb  r1,*r13               ; store error flags in callers r0
0283 2CDC F3E0  34         socb  @hb$20,r15            ; \ Set equal bit in copy of status register
     2CDE 201C     
0284                                                   ; / to indicate error
0285 2CE0 0380  18         rtwp                        ; Return from DSR workspace to caller
0286                                                   ; workspace
0287               
0288               
0289               ***************************************************************
...
0310               ********|*****|*********************|**************************
0311               dsrlnk.reuse:
0312 2CE2 A400             data  dsrlnk.dsrlws         ; dsrlnk workspace
0313 2CE4 2CE6             data  dsrlnk.reuse.init     ; entry point
0314                       ;------------------------------------------------------
0315                       ; DSRLNK entry point
0316                       ;------------------------------------------------------
0317               dsrlnk.reuse.init:
0318 2CE6 02E0  18         lwpi  >83e0                 ; Use GPL WS
     2CE8 83E0     
0319               
0320 2CEA 53E0  34         szcb  @hb$20,r15            ; reset equal bit in status register
     2CEC 201C     
0321                       ;------------------------------------------------------
0322                       ; Restore dsrlnk variables of previous DSR call
0323                       ;------------------------------------------------------
0324 2CEE 020B  20         li    r11,dsrlnk.savcru     ; Get pointer to last used CRU
     2CF0 A42A     
0325 2CF2 C33B  30         mov   *r11+,r12             ; Get CRU address         < @dsrlnk.savcru
0326 2CF4 C27B  30         mov   *r11+,r9              ; Get DSR entry address   < @dsrlnk.savent
0327 2CF6 C83B  50         mov   *r11+,@>8356          ; \ Get pointer to Device name or
     2CF8 8356     
0328                                                   ; / or subprogram in PAB  < @dsrlnk.savpab
0329 2CFA C07B  30         mov   *r11+,R1              ; Get DSR Version number  < @dsrlnk.savver
0330 2CFC C81B  46         mov   *r11,@>8354           ; Get device name length  < @dsrlnk.savlen
     2CFE 8354     
0331                       ;------------------------------------------------------
0332                       ; Call DSR program in card/device
0333                       ;------------------------------------------------------
0334 2D00 020F  20         li    r15,>8C02             ; Set VDP port address, needed to prevent
     2D02 8C02     
0335                                                   ; lockup of TI Disk Controller DSR.
0336               
0337 2D04 1D00  20         sbo   >00                   ; Open card/device ROM
0338               
0339 2D06 9820  54         cb    @>4000,@dsrlnk.$aa00  ; Valid identifier found?
     2D08 4000     
     2D0A 2D1E     
0340 2D0C 16E2  14         jne   dsrlnk.error.nodsr_found
...
0345               
0346 2D0E 0699  24         bl    *r9                   ; Execute DSR
0347                       ;
0348                       ; Depending on IO result the DSR in card ROM does RET
0349                       ; or (INCT R11 + RET), meaning either (1) or (2) get executed.
0350                       ;
0351 2D10 10DF  14         jmp   dsrlnk.error.nodsr_found_off
0352                                                   ; (1) error return
0353 2D12 1E00  20         sbz   >00                   ; (2) turn off card ROM if good return
0354                       ;------------------------------------------------------
0355                       ; Now check if any DSR error occured
0356                       ;------------------------------------------------------
0357 2D14 02E0  18         lwpi  dsrlnk.dsrlws         ; Restore workspace
     2D16 A400     
0358 2D18 C020  34         mov   @dsrlnk.flgptr,r0     ; Get pointer to VDP PAB byte 1
     2D1A A434     
0359               
0360 2D1C 10C6  14         jmp   dsrlnk.dsrscan.return_dsr
0361                                                   ; Rest is the same as with normal DSRLNK
0362               
0363               
0364               ********************************************************************************
0365               
0366 2D1E AA00     dsrlnk.$aa00      data   >aa00      ; Used for identifying DSR header
0367 2D20 0008     dsrlnk.$0008      data   >0008      ; 8 is the data that usually follows
0368                                                   ; a @blwp @dsrlnk
0369 2D22 2E       dsrlnk.period     text  '.'         ; For finding end of device name
0370               
0371                       even
                   < runlib.asm
...
0043               ********|*****|*********************|**************************
0044               file.open:
0045 2D24 C03B  30         mov   *r11+,r0              ; Get file descriptor (P0)
0046 2D26 C07B  30         mov   *r11+,r1              ; Get file type/mode
0047               *--------------------------------------------------------------
0048               * Initialisation
0049               *--------------------------------------------------------------
0050               xfile.open:
0051 2D28 0649  14         dect  stack
0052 2D2A C64B  30         mov   r11,*stack            ; Save return address
0053                       ;------------------------------------------------------
0054                       ; Initialisation
0055                       ;------------------------------------------------------
0056 2D2C 0204  20         li    tmp0,dsrlnk.savcru
     2D2E A42A     
0057 2D30 04F4  30         clr   *tmp0+                ; Clear @dsrlnk.savcru
0058 2D32 04F4  30         clr   *tmp0+                ; Clear @dsrlnk.savent
0059 2D34 04F4  30         clr   *tmp0+                ; Clear @dsrlnk.savver
0060 2D36 04D4  26         clr   *tmp0                 ; Clear @dsrlnk.pabflg
0061                       ;------------------------------------------------------
0062                       ; Set pointer to VDP disk buffer header
0063                       ;------------------------------------------------------
0064 2D38 0205  20         li    tmp1,>37D7            ; \ VDP Disk buffer header
     2D3A 37D7     
0065 2D3C C805  38         mov   tmp1,@>8370           ; | Pointer at Fixed scratchpad
     2D3E 8370     
0066                                                   ; / location
0067 2D40 C801  38         mov   r1,@fh.filetype       ; Set file type/mode
     2D42 A44C     
0068 2D44 04C5  14         clr   tmp1                  ; io.op.open
0069 2D46 101F  14         jmp   _file.record.fop      ; Do file operation
0070               
0071               
0072               
0073               ***************************************************************
...
0089               ********|*****|*********************|**************************
0090               file.close:
0091 2D48 C03B  30         mov   *r11+,r0              ; Get file descriptor (P0)
0092               *--------------------------------------------------------------
0093               * Initialisation
0094               *--------------------------------------------------------------
0095               xfile.close:
0096 2D4A 0649  14         dect  stack
0097 2D4C C64B  30         mov   r11,*stack            ; Save return address
0098 2D4E 0205  20         li    tmp1,io.op.close      ; io.op.close
     2D50 0001     
0099 2D52 1019  14         jmp   _file.record.fop      ; Do file operation
0100               
0101               
0102               ***************************************************************
...
0120 2D54 C03B  30         mov   *r11+,r0              ; Get file descriptor (P0)
0121               *--------------------------------------------------------------
0122               * Initialisation
0123               *--------------------------------------------------------------
0124 2D56 0649  14         dect  stack
0125 2D58 C64B  30         mov   r11,*stack            ; Save return address
0126               
0127 2D5A 0205  20         li    tmp1,io.op.read       ; io.op.read
     2D5C 0002     
0128 2D5E 1013  14         jmp   _file.record.fop      ; Do file operation
0129               
0130               
0131               
0132               ***************************************************************
...
0150 2D60 C03B  30         mov   *r11+,r0              ; Get file descriptor (P0)
0151               *--------------------------------------------------------------
0152               * Initialisation
0153               *--------------------------------------------------------------
0154 2D62 0649  14         dect  stack
0155 2D64 C64B  30         mov   r11,*stack            ; Save return address
0156               
0157 2D66 C100  18         mov   r0,tmp0               ; VDP write address (PAB byte 0)
0158 2D68 0224  22         ai    tmp0,5                ; Position to PAB byte 5
     2D6A 0005     
0159               
0160 2D6C C160  34         mov   @fh.reclen,tmp1       ; Get record length
     2D6E A43E     
0161               
0162 2D70 06A0  32         bl    @xvputb               ; Write character count to PAB
     2D72 22E0     
0163                                                   ; \ i  tmp0 = VDP target address
0164                                                   ; / i  tmp1 = Byte to write
0165               
0166 2D74 0205  20         li    tmp1,io.op.write      ; io.op.write
     2D76 0003     
0167 2D78 1006  14         jmp   _file.record.fop      ; Do file operation
0168               
0169               
0170               
0171               file.record.seek:
0172 2D7A 1000  14         nop
0173               
0174               
0175               file.image.load:
0176 2D7C 1000  14         nop
0177               
0178               
0179               file.image.save:
0180 2D7E 1000  14         nop
0181               
0182               
0183               file.delete:
0184 2D80 1000  14         nop
0185               
0186               
0187               file.rename:
0188 2D82 1000  14         nop
0189               
0190               
0191               file.status:
0192 2D84 1000  14         nop
0193               
0194               
0195               
0196               ***************************************************************
...
0226                       ;------------------------------------------------------
0227 2D86 C800  38         mov   r0,@fh.pab.ptr        ; Backup of pointer to current VDP PAB
     2D88 A436     
0228                       ;------------------------------------------------------
0229                       ; Set file opcode in VDP PAB
0230                       ;------------------------------------------------------
0231 2D8A C100  18         mov   r0,tmp0               ; VDP write address (PAB byte 0)
0232               
0233 2D8C A160  34         a     @fh.offsetopcode,tmp1 ; Inject offset for file I/O opcode
     2D8E A44E     
0234                                                   ; >00 = Data buffer in VDP RAM
0235                                                   ; >40 = Data buffer in CPU RAM
0236               
0237 2D90 06A0  32         bl    @xvputb               ; Write file I/O opcode to VDP
     2D92 22E0     
...
0242                       ;------------------------------------------------------
0243 2D94 C100  18         mov   r0,tmp0               ; VDP write address (PAB byte 0)
0244 2D96 0584  14         inc   tmp0                  ; Next byte in PAB
0245 2D98 C160  34         mov   @fh.filetype,tmp1     ; Get file type/mode
     2D9A A44C     
0246               
0247 2D9C 06A0  32         bl    @xvputb               ; Write file type/mode to VDP
     2D9E 22E0     
...
0252                       ;------------------------------------------------------
0253 2DA0 0220  22 !       ai    r0,9                  ; Move to file descriptor length
     2DA2 0009     
0254 2DA4 C800  38         mov   r0,@>8356             ; Pass file descriptor to DSRLNK
     2DA6 8356     
0255               *--------------------------------------------------------------
0256               * Call DSRLINK for doing file operation
0257               *--------------------------------------------------------------
0258 2DA8 C820  54         mov   @>8322,@waux1         ; Save word at @>8322
     2DAA 8322     
     2DAC 833C     
0259               
0260 2DAE C120  34         mov   @dsrlnk.savcru,tmp0   ; Call optimized or standard version?
     2DB0 A42A     
0261 2DB2 1504  14         jgt   _file.record.fop.optimized
0262                                                   ; Optimized version
0263               
0264                       ;------------------------------------------------------
0265                       ; First IO call. Call standard DSRLNK
0266                       ;------------------------------------------------------
0267 2DB4 0420  54         blwp  @dsrlnk               ; Call DSRLNK
     2DB6 2BB2     
0268 2DB8 0008                   data >8               ; \ i  p0 = >8 (DSR)
0269                                                   ; / o  r0 = Copy of VDP PAB byte 1
0270 2DBA 1002  14         jmp  _file.record.fop.pab   ; Return PAB to caller
0271               
0272                       ;------------------------------------------------------
0273                       ; Recurring IO call. Call optimized DSRLNK
0274                       ;------------------------------------------------------
0275               _file.record.fop.optimized:
0276 2DBC 0420  54         blwp  @dsrlnk.reuse         ; Call DSRLNK
     2DBE 2CE2     
0277               
0278               *--------------------------------------------------------------
...
0282 2DC0 02C6  12         stst  tmp2                  ; Store status register contents in tmp2
0283                                                   ; Upon DSRLNK return status register EQ bit
0284                                                   ; 1 = No file error
0285                                                   ; 0 = File error occured
0286               
0287 2DC2 C820  54         mov   @waux1,@>8322         ; Restore word at @>8322
     2DC4 833C     
     2DC6 8322     
0288               *--------------------------------------------------------------
0289               * Get PAB byte 5 from VDP ram into tmp1 (character count)
0290               *--------------------------------------------------------------
0291 2DC8 C120  34         mov   @fh.pab.ptr,tmp0      ; Get VDP address of current PAB
     2DCA A436     
0292 2DCC 0224  22         ai    tmp0,5                ; Get address of VDP PAB byte 5
     2DCE 0005     
0293 2DD0 06A0  32         bl    @xvgetb               ; VDP read PAB status byte into tmp0
     2DD2 22F8     
0294 2DD4 C144  18         mov   tmp0,tmp1             ; Move to destination
0295               *--------------------------------------------------------------
0296               * Get PAB byte 1 from VDP ram into tmp0 (status)
0297               *--------------------------------------------------------------
0298 2DD6 C100  18         mov   r0,tmp0               ; VDP PAB byte 1 (status)
...
0319 2DD8 C2F9  30         mov   *stack+,r11           ; Pop R11
0320 2DDA 045B  20         b     *r11                  ; Return to caller
                   < runlib.asm
0233               
0234               *//////////////////////////////////////////////////////////////
0235               *                            TIMERS
...
0019               ********|*****|*********************|**************************
0020 2DDC 0300  24 tmgr    limi  0                     ; No interrupt processing
     2DDE 0000     
0021               *--------------------------------------------------------------
0022               * Read VDP status register
0023               *--------------------------------------------------------------
0024 2DE0 D360  34 tmgr1   movb  @vdps,r13             ; Save copy of VDP status register in R13
     2DE2 8802     
0025               *--------------------------------------------------------------
0026               * Latch sprite collision flag
0027               *--------------------------------------------------------------
0028 2DE4 2360  38         coc   @wbit2,r13            ; C flag on ?
     2DE6 201C     
0029 2DE8 1602  14         jne   tmgr1a                ; No, so move on
0030 2DEA E0A0  34         soc   @wbit12,config        ; Latch bit 12 in config register
     2DEC 2008     
0031               *--------------------------------------------------------------
0032               * Interrupt flag
0033               *--------------------------------------------------------------
0034 2DEE 2360  38 tmgr1a  coc   @wbit0,r13            ; Interupt flag set ?
     2DF0 2020     
0035 2DF2 1311  14         jeq   tmgr4                 ; Yes, process slots 0..n
0036               *--------------------------------------------------------------
...
0046               *--------------------------------------------------------------
0047 2DF4 20A0  38 tmgr2   coc   @wbit8,config         ; Kernel thread blocked ?
     2DF6 2010     
0048 2DF8 1305  14         jeq   tmgr3                 ; Yes, skip to user hook
0049 2DFA 20A0  38         coc   @wbit9,config         ; Kernel thread enabled ?
     2DFC 200E     
0050 2DFE 1602  14         jne   tmgr3                 ; No, skip to user hook
0051 2E00 0460  28         b     @kthread              ; Run kernel thread
     2E02 2E7A     
0052               *--------------------------------------------------------------
0053               * Run user hook
0054               *--------------------------------------------------------------
0055 2E04 20A0  38 tmgr3   coc   @wbit6,config         ; User hook blocked ?
     2E06 2014     
0056 2E08 13EB  14         jeq   tmgr1
0057 2E0A 20A0  38         coc   @wbit7,config         ; User hook enabled ?
     2E0C 2012     
0058 2E0E 16E8  14         jne   tmgr1
0059 2E10 C120  34         mov   @wtiusr,tmp0
     2E12 832E     
0060 2E14 0454  20         b     *tmp0                 ; Run user hook
0061               *--------------------------------------------------------------
0062               * Do internal housekeeping
0063               *--------------------------------------------------------------
0064 2E16 40A0  34 tmgr4   szc   @tmdat,config         ; Unblock kernel thread and user hook
     2E18 2E78     
0065 2E1A C10A  18         mov   r10,tmp0
0066 2E1C 0244  22         andi  tmp0,>00ff            ; Clear HI byte
     2E1E 00FF     
0067 2E20 20A0  38         coc   @wbit2,config         ; PAL flag set ?
     2E22 201C     
0068 2E24 1303  14         jeq   tmgr5
0069 2E26 0284  22         ci    tmp0,60               ; 1 second reached ?
     2E28 003C     
0070 2E2A 1002  14         jmp   tmgr6
0071 2E2C 0284  22 tmgr5   ci    tmp0,50
     2E2E 0032     
0072 2E30 1101  14 tmgr6   jlt   tmgr7                 ; No, continue
0073 2E32 1001  14         jmp   tmgr8
0074 2E34 058A  14 tmgr7   inc   r10                   ; Increase tick counter
0075               *--------------------------------------------------------------
0076               * Loop over slots
0077               *--------------------------------------------------------------
0078 2E36 C120  34 tmgr8   mov   @wtitab,tmp0          ; Pointer to timer table
     2E38 832C     
0079 2E3A 024A  22         andi  r10,>ff00             ; Use R10LB as slot counter. Reset.
     2E3C FF00     
0080 2E3E C1D4  26 tmgr9   mov   *tmp0,tmp3            ; Is slot empty ?
0081 2E40 1316  14         jeq   tmgr11                ; Yes, get next slot
0082               *--------------------------------------------------------------
0083               *  Check if slot should be executed
0084               *--------------------------------------------------------------
0085 2E42 05C4  14         inct  tmp0                  ; Second word of slot data
0086 2E44 0594  26         inc   *tmp0                 ; Update tick count in slot
0087 2E46 C194  26         mov   *tmp0,tmp2            ; Get second word of slot data
0088 2E48 9820  54         cb    @tmp2hb,@tmp2lb       ; Slot target count = Slot internal counter ?
     2E4A 830C     
     2E4C 830D     
0089 2E4E 1608  14         jne   tmgr10                ; No, get next slot
0090 2E50 0246  22         andi  tmp2,>ff00            ; Clear internal counter
     2E52 FF00     
0091 2E54 C506  30         mov   tmp2,*tmp0            ; Update timer table
0092               *--------------------------------------------------------------
0093               *  Run slot, we only need TMP0 to survive
0094               *--------------------------------------------------------------
0095 2E56 C804  38         mov   tmp0,@wtitmp          ; Save TMP0
     2E58 8330     
0096 2E5A 0697  24         bl    *tmp3                 ; Call routine in slot
0097 2E5C C120  34 slotok  mov   @wtitmp,tmp0          ; Restore TMP0
     2E5E 8330     
0098               *--------------------------------------------------------------
0099               *  Prepare for next slot
0100               *--------------------------------------------------------------
0101 2E60 058A  14 tmgr10  inc   r10                   ; Next slot
0102 2E62 9820  54         cb    @r10lb,@btihi         ; Last slot done ?
     2E64 8315     
     2E66 8314     
0103 2E68 1504  14         jgt   tmgr12                ; yes, Wait for next VDP interrupt
0104 2E6A 05C4  14         inct  tmp0                  ; Offset for next slot
0105 2E6C 10E8  14         jmp   tmgr9                 ; Process next slot
0106 2E6E 05C4  14 tmgr11  inct  tmp0                  ; Skip 2nd word of slot data
0107 2E70 10F7  14         jmp   tmgr10                ; Process next slot
0108 2E72 024A  22 tmgr12  andi  r10,>ff00             ; Use R10LB as tick counter. Reset.
     2E74 FF00     
0109 2E76 10B4  14         jmp   tmgr1
0110 2E78 0280     tmdat   data  >0280                 ; Bit 8 (kernel thread) and bit 6 (user hook)
0111               
                   < runlib.asm
...
0014               ********|*****|*********************|**************************
0015 2E7A E0A0  34 kthread soc   @wbit8,config         ; Block kernel thread
     2E7C 2010     
0016               *--------------------------------------------------------------
0017               * Run sound player
0018               *--------------------------------------------------------------
0022 2E7E 20A0  38         coc   @wbit13,config        ; Sound player on ?
     2E80 2006     
0023 2E82 1602  14         jne   kthread_kb
0024 2E84 06A0  32         bl    @sdpla1               ; Run sound player
     2E86 284A     
0026               *--------------------------------------------------------------
...
0037               *--------------------------------------------------------------
0042 2E88 06A0  32         bl    @rkscan               ; Scan full keyboard with ROM#0 KSCAN
     2E8A 28CA     
0047               *--------------------------------------------------------------
0048               kthread_exit
0049 2E8C 0460  28         b     @tmgr3                ; Exit
     2E8E 2E04     
                   < runlib.asm
...
0016               ********|*****|*********************|**************************
0017 2E90 C83B  50 mkhook  mov   *r11+,@wtiusr         ; Set user hook address
     2E92 832E     
0018 2E94 E0A0  34         soc   @wbit7,config         ; Enable user hook
     2E96 2012     
0019 2E98 045B  20 mkhoo1  b     *r11                  ; Return
0020      2DE0     hookok  equ   tmgr1                 ; Exit point for user hook
0021               
0022               
0023               ***************************************************************
...
0026               *  BL    @CLHOOK
0027               ********|*****|*********************|**************************
0028 2E9A 04E0  34 clhook  clr   @wtiusr               ; Unset user hook address
     2E9C 832E     
0029 2E9E 0242  22         andi  config,>feff          ; Disable user hook (bit 7=0)
     2EA0 FEFF     
0030 2EA2 045B  20         b     *r11                  ; Return
                   < runlib.asm
0241               
...
0016               ********|*****|*********************|**************************
0017 2EA4 C13B  30 mkslot  mov   *r11+,tmp0
0018 2EA6 C17B  30         mov   *r11+,tmp1
0019               *--------------------------------------------------------------
0020               *  Calculate address of slot
0021               *--------------------------------------------------------------
0022 2EA8 C184  18         mov   tmp0,tmp2
0023 2EAA 0966  56         srl   tmp2,6                ; Right align & TMP2 = TMP2 * 4
0024 2EAC A1A0  34         a     @wtitab,tmp2          ; Add table base
     2EAE 832C     
0025               *--------------------------------------------------------------
0026               *  Add slot to table
0027               *--------------------------------------------------------------
0028 2EB0 CD85  34         mov   tmp1,*tmp2+           ; Store address of subroutine
0029 2EB2 0A84  56         sla   tmp0,8                ; Get rid of slot number
0030 2EB4 C584  30         mov   tmp0,*tmp2            ; Store target count and reset tick count
0031               *--------------------------------------------------------------
0032               *  Check for end of list
0033               *--------------------------------------------------------------
0034 2EB6 881B  46         c     *r11,@w$ffff          ; End of list ?
     2EB8 2022     
0035 2EBA 1301  14         jeq   mkslo1                ; Yes, exit
0036 2EBC 10F3  14         jmp   mkslot                ; Process next entry
0037               *--------------------------------------------------------------
0038               *  Exit
0039               *--------------------------------------------------------------
0040 2EBE 05CB  14 mkslo1  inct  r11
0041 2EC0 045B  20         b     *r11                  ; Exit
0042               
0043               
0044               ***************************************************************
...
0050               *  P0 = Slot number
0051               ********|*****|*********************|**************************
0052 2EC2 C13B  30 clslot  mov   *r11+,tmp0
0053 2EC4 0A24  56 xlslot  sla   tmp0,2                ; TMP0 = TMP0*4
0054 2EC6 A120  34         a     @wtitab,tmp0          ; Add table base
     2EC8 832C     
0055 2ECA 04F4  30         clr   *tmp0+                ; Clear 1st word of slot
0056 2ECC 04D4  26         clr   *tmp0                 ; Clear 2nd word of slot
0057 2ECE 045B  20         b     *r11                  ; Exit
0058               
0059               
0060               ***************************************************************
...
0066               *  P0 = Slot number
0067               ********|*****|*********************|**************************
0068 2ED0 C13B  30 rsslot  mov   *r11+,tmp0
0069 2ED2 0A24  56         sla   tmp0,2                ; TMP0 = TMP0*4
0070 2ED4 A120  34         a     @wtitab,tmp0          ; Add table base
     2ED6 832C     
0071 2ED8 05C4  14         inct  tmp0                  ; Skip 1st word of slot
0072 2EDA C154  26         mov   *tmp0,tmp1
0073 2EDC 0245  22         andi  tmp1,>ff00            ; Clear LSB (loop counter)
     2EDE FF00     
0074 2EE0 C505  30         mov   tmp1,*tmp0
0075 2EE2 045B  20         b     *r11                  ; Exit
                   < runlib.asm
0245               
0246               
0247               
...
0264               ********|*****|*********************|**************************
0271 2EE4 04E0  34 runlib  clr   @>8302                ; Reset exit flag (R1 in workspace WS1!)
     2EE6 8302     
0273               *--------------------------------------------------------------
0274               * Alternative entry point
0275               *--------------------------------------------------------------
0276 2EE8 0300  24 runli1  limi  0                     ; Turn off interrupts
     2EEA 0000     
0277 2EEC 02E0  18         lwpi  ws1                   ; Activate workspace 1
     2EEE 8300     
0278 2EF0 C0E0  34         mov   @>83c0,r3             ; Get random seed from OS monitor
     2EF2 83C0     
0279               *--------------------------------------------------------------
0280               * Clear scratch-pad memory from R4 upwards
0281               *--------------------------------------------------------------
0282 2EF4 0202  20 runli2  li    r2,>8308
     2EF6 8308     
0283 2EF8 04F2  30 runli3  clr   *r2+                  ; Clear scratchpad >8306->83FF
0284 2EFA 0282  22         ci    r2,>8400
     2EFC 8400     
0285 2EFE 16FC  14         jne   runli3
0286               *--------------------------------------------------------------
0287               * Exit to TI-99/4A title screen ?
0288               *--------------------------------------------------------------
0289 2F00 0281  22 runli3a ci    r1,>ffff              ; Exit flag set ?
     2F02 FFFF     
0290 2F04 1602  14         jne   runli4                ; No, continue
0291 2F06 0420  54         blwp  @0                    ; Yes, bye bye
     2F08 0000     
0292               *--------------------------------------------------------------
0293               * Determine if VDP is PAL or NTSC
0294               *--------------------------------------------------------------
0295 2F0A C803  38 runli4  mov   r3,@waux1             ; Store random seed
     2F0C 833C     
0296 2F0E 04C1  14         clr   r1                    ; Reset counter
0297 2F10 0202  20         li    r2,10                 ; We test 10 times
     2F12 000A     
0298 2F14 C0E0  34 runli5  mov   @vdps,r3
     2F16 8802     
0299 2F18 20E0  38         coc   @wbit0,r3             ; Interupt flag set ?
     2F1A 2020     
0300 2F1C 1302  14         jeq   runli6
0301 2F1E 0581  14         inc   r1                    ; Increase counter
0302 2F20 10F9  14         jmp   runli5
0303 2F22 0602  14 runli6  dec   r2                    ; Next test
0304 2F24 16F7  14         jne   runli5
0305 2F26 0281  22         ci    r1,>1250              ; Max for NTSC reached ?
     2F28 1250     
0306 2F2A 1202  14         jle   runli7                ; No, so it must be NTSC
0307 2F2C 0262  22         ori   config,palon          ; Yes, it must be PAL, set flag
     2F2E 201C     
0308               *--------------------------------------------------------------
0309               * Copy machine code to scratchpad (prepare tight loop)
0310               *--------------------------------------------------------------
0311 2F30 06A0  32 runli7  bl    @loadmc
     2F32 222E     
0312               *--------------------------------------------------------------
0313               * Initialize registers, memory, ...
0314               *--------------------------------------------------------------
0315 2F34 04C1  14 runli9  clr   r1
0316 2F36 04C2  14         clr   r2
0317 2F38 04C3  14         clr   r3
0318 2F3A 0209  20         li    stack,sp2.stktop      ; Set top of stack (grows downwards!)
     2F3C A900     
0319 2F3E 020F  20         li    r15,vdpw              ; Set VDP write address
     2F40 8C00     
0321 2F42 06A0  32         bl    @mute                 ; Mute sound generators
     2F44 280E     
0323               *--------------------------------------------------------------
0324               * Setup video memory
0325               *--------------------------------------------------------------
0327 2F46 0280  22         ci    r0,>4a4a              ; Crash flag set?
     2F48 4A4A     
0328 2F4A 1605  14         jne   runlia
0329 2F4C 06A0  32         bl    @filv                 ; Clear 12K VDP memory instead
     2F4E 22A2     
0330 2F50 0000             data  >0000,>00,>3000       ; of 16K, so that PABs survive
     2F52 0000     
     2F54 3000     
0335 2F56 06A0  32 runlia  bl    @filv
     2F58 22A2     
0336 2F5A 0FC0             data  pctadr,spfclr,16      ; Load color table
     2F5C 00F4     
     2F5E 0010     
0337               *--------------------------------------------------------------
...
0362               *--------------------------------------------------------------
0363 2F60 06A0  32 runlic  bl    @vidtab               ; Load video mode table into VDP
     2F62 230C     
0364 2F64 35D0             data  spvmod                ; Equate selected video mode table
0365 2F66 0204  20         li    tmp0,spfont           ; Get font option
     2F68 000C     
0366 2F6A 0544  14         inv   tmp0                  ; NOFONT (>FFFF) specified ?
0367 2F6C 1304  14         jeq   runlid                ; Yes, skip it
0368 2F6E 06A0  32         bl    @ldfnt
     2F70 2374     
0369 2F72 1100             data  fntadr,spfont         ; Load specified font
     2F74 000C     
0370               *--------------------------------------------------------------
0371               * Did a system crash occur before runlib was called?
0372               *--------------------------------------------------------------
0373 2F76 0280  22 runlid  ci    r0,>4a4a              ; Crash flag set?
     2F78 4A4A     
0374 2F7A 1602  14         jne   runlie                ; No, continue
0375 2F7C 0460  28         b     @cpu.crash.main       ; Yes, back to crash handler
     2F7E 2086     
0376               *--------------------------------------------------------------
0377               * Branch to main program
0378               *--------------------------------------------------------------
0379 2F80 0262  22 runlie  ori   config,>0040          ; Enable kernel thread (bit 9 on)
     2F82 0040     
0380 2F84 0460  28         b     @main                 ; Give control to main program
     2F86 6046     
                   < stevie_b1.asm.27722
...
0019               ********|*****|*********************|**************************
0020               rom.farjump:
0021 2F88 C13B  30         mov   *r11+,tmp0            ; P0
0022 2F8A C17B  30         mov   *r11+,tmp1            ; P1
0023 2F8C C1BB  30         mov   *r11+,tmp2            ; P2
0024                       ;------------------------------------------------------
0025                       ; Push registers to value stack (but not r11!)
0026                       ;------------------------------------------------------
0027               xrom.farjump:
0028 2F8E 0649  14         dect  stack
0029 2F90 C644  30         mov   tmp0,*stack           ; Push tmp0
0030 2F92 0649  14         dect  stack
0031 2F94 C645  30         mov   tmp1,*stack           ; Push tmp1
0032 2F96 0649  14         dect  stack
0033 2F98 C646  30         mov   tmp2,*stack           ; Push tmp2
0034 2F9A 0649  14         dect  stack
0035 2F9C C647  30         mov   tmp3,*stack           ; Push tmp3
0036                       ;------------------------------------------------------
0037                       ; Push to farjump return stack
0038                       ;------------------------------------------------------
0039 2F9E 0284  22         ci    tmp0,>6000            ; Invalid bank write address?
     2FA0 6000     
0040 2FA2 1116  14         jlt   rom.farjump.bankswitch.failed1
0041                                                   ; Crash if bogus value in bank write address
0042               
0043 2FA4 C1E0  34         mov   @tv.fj.stackpnt,tmp3  ; Get farjump stack pointer
     2FA6 A226     
0044 2FA8 0647  14         dect  tmp3
0045 2FAA C5CB  30         mov   r11,*tmp3             ; Push return address to farjump stack
0046 2FAC 0647  14         dect  tmp3
0047 2FAE C5C6  30         mov   tmp2,*tmp3            ; Push source ROM bank to farjump stack
0048 2FB0 C807  38         mov   tmp3,@tv.fj.stackpnt  ; Set farjump stack pointer
     2FB2 A226     
0049               
0053               
0054                       ;------------------------------------------------------
...
0058 2FB4 04D4  26         clr   *tmp0                 ; Switch to target ROM bank 8K >6000
0059 2FB6 1004  14         jmp   rom.farjump.bankswitch.tgt.done
0060                       ;------------------------------------------------------
0061                       ; Bankswitch to target 4K ROM / 4K RAM banks (FG99 advanced mode)
0062                       ;------------------------------------------------------
0063               rom.farjump.bankswitch.tgt.advfg99:
0064 2FB8 04D4  26         clr   *tmp0                 ; Switch to target ROM bank 4K >6000
0065 2FBA 0224  22         ai    tmp0,>0800
     2FBC 0800     
0066 2FBE 04D4  26         clr   *tmp0                 ; Switch to target RAM bank 4K >7000
0067                       ;------------------------------------------------------
...
0073                       ;------------------------------------------------------
0074 2FC0 0285  22         ci    tmp1,>ffff
     2FC2 FFFF     
0075 2FC4 1602  14         jne   !
0076 2FC6 C160  34         mov   @trmpvector,tmp1
     2FC8 A03A     
0077                       ;------------------------------------------------------
0078                       ; Deref value in vector
0079                       ;------------------------------------------------------
0080 2FCA C115  26 !       mov   *tmp1,tmp0            ; Deref value in vector address
0081 2FCC 1301  14         jeq   rom.farjump.bankswitch.failed1
0082                                                   ; Crash if null-pointer in vector
0083               
0084 2FCE 1004  14         jmp   rom.farjump.bankswitch.call
0085                                                   ; Call function in target bank
0086                       ;------------------------------------------------------
0087                       ; Assert 1 failed before bank-switch
0088                       ;------------------------------------------------------
0089               rom.farjump.bankswitch.failed1:
0090 2FD0 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     2FD2 FFCE     
0091 2FD4 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     2FD6 2026     
0092                       ;------------------------------------------------------
0093                       ; Call function in target bank
0094                       ;------------------------------------------------------
0095               rom.farjump.bankswitch.call:
0096 2FD8 0694  24         bl    *tmp0                 ; Call function
0097                       ;------------------------------------------------------
0098                       ; Bankswitch back to source bank
0099                       ;------------------------------------------------------
0100               rom.farjump.return:
0101 2FDA C120  34         mov   @tv.fj.stackpnt,tmp0  ; Get farjump stack pointer
     2FDC A226     
0102 2FDE C154  26         mov   *tmp0,tmp1            ; Get bank write address of caller
0103 2FE0 1312  14         jeq   rom.farjump.bankswitch.failed2
0104                                                   ; Crash if null-pointer in address
0105               
0106 2FE2 04F4  30         clr   *tmp0+                ; Remove bank write address from
0107                                                   ; farjump stack
0108               
0109 2FE4 C2D4  26         mov   *tmp0,r11             ; Get return addr of caller for return
0110               
0111 2FE6 04F4  30         clr   *tmp0+                ; Remove return address of caller from
0112                                                   ; farjump stack
0113               
0114 2FE8 028B  22         ci    r11,>6000
     2FEA 6000     
0115 2FEC 110C  14         jlt   rom.farjump.bankswitch.failed2
0116 2FEE 028B  22         ci    r11,>7fff
     2FF0 7FFF     
0117 2FF2 1509  14         jgt   rom.farjump.bankswitch.failed2
0118               
0119 2FF4 C804  38         mov   tmp0,@tv.fj.stackpnt  ; Update farjump return stack pointer
     2FF6 A226     
0120               
0124               
0125                       ;------------------------------------------------------
...
0129 2FF8 04D5  26         clr   *tmp1                 ; Switch to source ROM bank 8K >6000
0130 2FFA 1009  14         jmp   rom.farjump.exit
0131                       ;------------------------------------------------------
0132                       ; Bankswitch to source 4K ROM / 4K RAM banks (FG99 advanced mode)
0133                       ;------------------------------------------------------
0134               rom.farjump.bankswitch.src.advfg99:
0135 2FFC 04D5  26         clr   *tmp1                 ; Switch to source ROM bank 4K >6000
0136 2FFE 0225  22         ai    tmp1,>0800
     3000 0800     
0137 3002 04D5  26         clr   *tmp1                 ; Switch to source RAM bank 4K >7000
0138 3004 1004  14         jmp   rom.farjump.exit
0139                       ;------------------------------------------------------
0140                       ; Assert 2 failed after bank-switch
0141                       ;------------------------------------------------------
0142               rom.farjump.bankswitch.failed2:
0143 3006 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     3008 FFCE     
0144 300A 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     300C 2026     
0145                       ;-------------------------------------------------------
0146                       ; Exit
0147                       ;-------------------------------------------------------
0148               rom.farjump.exit:
0149 300E C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0150 3010 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0151 3012 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0152 3014 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0153 3016 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0018               ********|*****|*********************|**************************
0019               fb.init:
0020 3018 0649  14         dect  stack
0021 301A C64B  30         mov   r11,*stack            ; Save return address
0022 301C 0649  14         dect  stack
0023 301E C644  30         mov   tmp0,*stack           ; Push tmp0
0024 3020 0649  14         dect  stack
0025 3022 C645  30         mov   tmp1,*stack           ; Push tmp1
0026                       ;------------------------------------------------------
0027                       ; Initialize
0028                       ;------------------------------------------------------
0029 3024 0204  20         li    tmp0,fb.top
     3026 D000     
0030 3028 C804  38         mov   tmp0,@fb.top.ptr      ; Set pointer to framebuffer
     302A A300     
0031 302C 04E0  34         clr   @fb.topline           ; Top line in framebuffer
     302E A304     
0032 3030 04E0  34         clr   @fb.row               ; Current row=0
     3032 A306     
0033 3034 04E0  34         clr   @fb.column            ; Current column=0
     3036 A30C     
0034               
0035 3038 0204  20         li    tmp0,colrow
     303A 0050     
0036 303C C804  38         mov   tmp0,@fb.colsline     ; Columns per row=80
     303E A30E     
0037                       ;------------------------------------------------------
0038                       ; Determine size of rows on screen
0039                       ;------------------------------------------------------
0040 3040 C160  34         mov   @tv.ruler.visible,tmp1
     3042 A210     
0041 3044 1303  14         jeq   !                     ; Skip if ruler is hidden
0042 3046 0204  20         li    tmp0,pane.botrow-2
     3048 0015     
0043 304A 1002  14         jmp   fb.init.cont
0044 304C 0204  20 !       li    tmp0,pane.botrow-1
     304E 0016     
0045                       ;------------------------------------------------------
0046                       ; Continue initialisation
0047                       ;------------------------------------------------------
0048               fb.init.cont:
0049 3050 C804  38         mov   tmp0,@fb.scrrows      ; Physical rows on screen for fb
     3052 A31A     
0050 3054 C804  38         mov   tmp0,@fb.scrrows.max  ; Maximum number of physical rows for fb
     3056 A31C     
0051               
0052 3058 04E0  34         clr   @tv.pane.focus        ; Frame buffer has focus!
     305A A222     
0053 305C 04E0  34         clr   @fb.colorize          ; Don't colorize M1/M2 lines
     305E A310     
0054 3060 0720  34         seto  @fb.dirty             ; Set dirty flag (trigger screen update)
     3062 A316     
0055 3064 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     3066 A318     
0056                       ;------------------------------------------------------
0057                       ; Clear frame buffer
0058                       ;------------------------------------------------------
0059 3068 06A0  32         bl    @film
     306A 224A     
0060 306C D000             data  fb.top,>00,fb.size    ; Clear it all the way
     306E 0000     
     3070 0960     
0061                       ;------------------------------------------------------
0062                       ; Exit
0063                       ;------------------------------------------------------
0064               fb.init.exit:
0065 3072 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0066 3074 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0067 3076 C2F9  30         mov   *stack+,r11           ; Pop r11
0068 3078 045B  20         b     *r11                  ; Return to caller
0069               
                   < ram.resident.asm
...
0049               ********|*****|*********************|**************************
0050               idx.init:
0051 307A 0649  14         dect  stack
0052 307C C64B  30         mov   r11,*stack            ; Save return address
0053 307E 0649  14         dect  stack
0054 3080 C644  30         mov   tmp0,*stack           ; Push tmp0
0055                       ;------------------------------------------------------
0056                       ; Initialize
0057                       ;------------------------------------------------------
0058 3082 0204  20         li    tmp0,idx.top
     3084 B000     
0059 3086 C804  38         mov   tmp0,@edb.index.ptr   ; Set pointer to index in editor structure
     3088 A502     
0060               
0061 308A C120  34         mov   @tv.sams.b000,tmp0
     308C A206     
0062 308E C804  38         mov   tmp0,@idx.sams.page   ; Set current SAMS page
     3090 A600     
0063 3092 C804  38         mov   tmp0,@idx.sams.lopage ; Set 1st SAMS page
     3094 A602     
0064                       ;------------------------------------------------------
0065                       ; Clear all index pages
0066                       ;------------------------------------------------------
0067 3096 0224  22         ai    tmp0,4                ; \ Let's clear all index pages
     3098 0004     
0068 309A C804  38         mov   tmp0,@idx.sams.hipage ; /
     309C A604     
0069               
0070 309E 06A0  32         bl    @_idx.sams.mapcolumn.on
     30A0 30BC     
0071                                                   ; Index in continuous memory region
0072               
0073 30A2 06A0  32         bl    @film
     30A4 224A     
0074 30A6 B000                   data idx.top,>00,idx.size * 5
     30A8 0000     
     30AA 5000     
0075                                                   ; Clear index
0076               
0077 30AC 06A0  32         bl    @_idx.sams.mapcolumn.off
     30AE 30F0     
0078                                                   ; Restore memory window layout
0079               
0080 30B0 C820  54         mov   @idx.sams.lopage,@idx.sams.hipage
     30B2 A602     
     30B4 A604     
...
0084                       ;------------------------------------------------------
0085               idx.init.exit:
0086 30B6 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0087 30B8 C2F9  30         mov   *stack+,r11           ; Pop r11
0088 30BA 045B  20         b     *r11                  ; Return to caller
0089               
0090               
0091               ***************************************************************
...
0101 30BC 0649  14         dect  stack
0102 30BE C64B  30         mov   r11,*stack            ; Push return address
0103 30C0 0649  14         dect  stack
0104 30C2 C644  30         mov   tmp0,*stack           ; Push tmp0
0105 30C4 0649  14         dect  stack
0106 30C6 C645  30         mov   tmp1,*stack           ; Push tmp1
0107 30C8 0649  14         dect  stack
0108 30CA C646  30         mov   tmp2,*stack           ; Push tmp2
0109               *--------------------------------------------------------------
0110               * Map index pages into memory window  (b000-ffff)
0111               *--------------------------------------------------------------
0112 30CC C120  34         mov   @idx.sams.lopage,tmp0 ; Get lowest index page
     30CE A602     
0113 30D0 0205  20         li    tmp1,idx.top
     30D2 B000     
0114 30D4 0206  20         li    tmp2,5                ; Set loop counter. all pages of index
     30D6 0005     
0115                       ;-------------------------------------------------------
0116                       ; Loop over banks
0117                       ;-------------------------------------------------------
0118 30D8 06A0  32 !       bl    @xsams.page.set       ; Set SAMS page
     30DA 258A     
0119                                                   ; \ i  tmp0  = SAMS page number
0120                                                   ; / i  tmp1  = Memory address
0121               
0122 30DC 0584  14         inc   tmp0                  ; Next SAMS index page
0123 30DE 0225  22         ai    tmp1,>1000            ; Next memory region
     30E0 1000     
0124 30E2 0606  14         dec   tmp2                  ; Update loop counter
0125 30E4 15F9  14         jgt   -!                    ; Next iteration
0126               *--------------------------------------------------------------
0127               * Exit
0128               *--------------------------------------------------------------
0129               _idx.sams.mapcolumn.on.exit:
0130 30E6 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0131 30E8 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0132 30EA C139  30         mov   *stack+,tmp0          ; Pop tmp0
0133 30EC C2F9  30         mov   *stack+,r11           ; Pop return address
0134 30EE 045B  20         b     *r11                  ; Return to caller
0135               
0136               
0137               ***************************************************************
...
0150 30F0 0649  14         dect  stack
0151 30F2 C64B  30         mov   r11,*stack            ; Push return address
0152 30F4 0649  14         dect  stack
0153 30F6 C644  30         mov   tmp0,*stack           ; Push tmp0
0154 30F8 0649  14         dect  stack
0155 30FA C645  30         mov   tmp1,*stack           ; Push tmp1
0156 30FC 0649  14         dect  stack
0157 30FE C646  30         mov   tmp2,*stack           ; Push tmp2
0158 3100 0649  14         dect  stack
0159 3102 C647  30         mov   tmp3,*stack           ; Push tmp3
0160               *--------------------------------------------------------------
0161               * Map index pages into memory window  (b000-????)
0162               *--------------------------------------------------------------
0163 3104 0205  20         li    tmp1,idx.top
     3106 B000     
0164 3108 0206  20         li    tmp2,5                ; Always 5 pages
     310A 0005     
0165 310C 0207  20         li    tmp3,tv.sams.b000     ; Pointer to fist SAMS page
     310E A206     
0166                       ;-------------------------------------------------------
0167                       ; Loop over table in memory (@tv.sams.b000:@tv.sams.f000)
0168                       ;-------------------------------------------------------
0169 3110 C137  30 !       mov   *tmp3+,tmp0           ; Get SAMS page
0170               
0171 3112 06A0  32         bl    @xsams.page.set       ; Set SAMS page
     3114 258A     
0172                                                   ; \ i  tmp0  = SAMS page number
0173                                                   ; / i  tmp1  = Memory address
0174               
0175 3116 0225  22         ai    tmp1,>1000            ; Next memory region
     3118 1000     
0176 311A 0606  14         dec   tmp2                  ; Update loop counter
0177 311C 15F9  14         jgt   -!                    ; Next iteration
0178               *--------------------------------------------------------------
0179               * Exit
0180               *--------------------------------------------------------------
0181               _idx.sams.mapcolumn.off.exit:
0182 311E C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0183 3120 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0184 3122 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0185 3124 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0186 3126 C2F9  30         mov   *stack+,r11           ; Pop return address
0187 3128 045B  20         b     *r11                  ; Return to caller
0188               
0189               
0190               
0191               ***************************************************************
...
0211 312A 0649  14         dect  stack
0212 312C C64B  30         mov   r11,*stack            ; Save return address
0213 312E 0649  14         dect  stack
0214 3130 C644  30         mov   tmp0,*stack           ; Push tmp0
0215 3132 0649  14         dect  stack
0216 3134 C645  30         mov   tmp1,*stack           ; Push tmp1
0217 3136 0649  14         dect  stack
0218 3138 C646  30         mov   tmp2,*stack           ; Push tmp2
0219                       ;------------------------------------------------------
0220                       ; Determine SAMS index page
0221                       ;------------------------------------------------------
0222 313A C184  18         mov   tmp0,tmp2             ; Line number
0223 313C 04C5  14         clr   tmp1                  ; MSW (tmp1) = 0 / LSW (tmp2) = Line number
0224 313E 0204  20         li    tmp0,2048             ; Index entries in 4K SAMS page
     3140 0800     
0225               
0226 3142 3D44 128         div   tmp0,tmp1             ; \ Divide 32 bit value by 2048
0227                                                   ; | tmp1 = quotient  (SAMS page offset)
0228                                                   ; / tmp2 = remainder
0229               
0230 3144 0A16  56         sla   tmp2,1                ; line number * 2
0231 3146 C806  38         mov   tmp2,@outparm1        ; Offset index entry
     3148 A010     
0232               
0233 314A A160  34         a     @idx.sams.lopage,tmp1 ; Add SAMS page base
     314C A602     
0234 314E 8805  38         c     tmp1,@idx.sams.page   ; Page already active?
     3150 A600     
0235               
0236 3152 130E  14         jeq   _idx.samspage.get.exit
0237                                                   ; Yes, so exit
0238                       ;------------------------------------------------------
0239                       ; Activate SAMS index page
0240                       ;------------------------------------------------------
0241 3154 C805  38         mov   tmp1,@idx.sams.page   ; Set current SAMS page
     3156 A600     
0242 3158 C805  38         mov   tmp1,@tv.sams.b000    ; Also keep SAMS window synced in Stevie
     315A A206     
0243 315C C105  18         mov   tmp1,tmp0             ; Destination SAMS page
0244               
0245 315E 0205  20         li    tmp1,>b000            ; Memory window for index page
     3160 B000     
0246               
0247 3162 06A0  32         bl    @xsams.page.set       ; Switch to SAMS page
     3164 258A     
...
0252                       ;------------------------------------------------------
0253 3166 8804  38         c     tmp0,@idx.sams.hipage ; New highest page?
     3168 A604     
0254 316A 1202  14         jle   _idx.samspage.get.exit
0255                                                   ; No, exit
0256 316C C804  38         mov   tmp0,@idx.sams.hipage ; Yes, set highest SAMS index page
     316E A604     
0257                       ;------------------------------------------------------
0258                       ; Exit
0259                       ;------------------------------------------------------
0260               _idx.samspage.get.exit:
0261 3170 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0262 3172 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0263 3174 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0264 3176 C2F9  30         mov   *stack+,r11           ; Pop r11
0265 3178 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0020               ***************************************************************
0021               edb.init:
0022 317A 0649  14         dect  stack
0023 317C C64B  30         mov   r11,*stack            ; Save return address
0024 317E 0649  14         dect  stack
0025 3180 C644  30         mov   tmp0,*stack           ; Push tmp0
0026                       ;------------------------------------------------------
0027                       ; Initialize
0028                       ;------------------------------------------------------
0029 3182 0204  20         li    tmp0,edb.top          ; \
     3184 C000     
0030 3186 C804  38         mov   tmp0,@edb.top.ptr     ; / Set pointer to top of editor buffer
     3188 A500     
0031 318A C804  38         mov   tmp0,@edb.next_free.ptr
     318C A508     
0032                                                   ; Set pointer to next free line
0033               
0034 318E 0720  34         seto  @edb.insmode          ; Turn on insert mode for this editor buffer
     3190 A50A     
0035               
0036 3192 0204  20         li    tmp0,1
     3194 0001     
0037 3196 C804  38         mov   tmp0,@edb.lines       ; Lines=1
     3198 A504     
0038               
0039 319A 0720  34         seto  @edb.block.m1         ; Reset block start line
     319C A50C     
0040 319E 0720  34         seto  @edb.block.m2         ; Reset block end line
     31A0 A50E     
0041               
0042 31A2 0204  20         li    tmp0,txt.newfile      ; "New file"
     31A4 37DA     
0043 31A6 C804  38         mov   tmp0,@edb.filename.ptr
     31A8 A512     
0044               
0045 31AA 04E0  34         clr   @fh.kilobytes         ; \ Clear kilobytes processed
     31AC A440     
0046 31AE 04E0  34         clr   @fh.kilobytes.prev    ; /
     31B0 A45C     
0047               
0048 31B2 0204  20         li    tmp0,txt.filetype.none
     31B4 3896     
0049 31B6 C804  38         mov   tmp0,@edb.filetype.ptr
     31B8 A514     
0050               
0051               edb.init.exit:
0052                       ;------------------------------------------------------
0053                       ; Exit
0054                       ;------------------------------------------------------
0055 31BA C139  30         mov   *stack+,tmp0          ; Pop tmp0
0056 31BC C2F9  30         mov   *stack+,r11           ; Pop r11
0057 31BE 045B  20         b     *r11                  ; Return to caller
0058               
0059               
0060               
0061               
...
0020               ********|*****|*********************|**************************
0021               cmdb.init:
0022 31C0 0649  14         dect  stack
0023 31C2 C64B  30         mov   r11,*stack            ; Save return address
0024 31C4 0649  14         dect  stack
0025 31C6 C644  30         mov   tmp0,*stack           ; Push tmp0
0026                       ;------------------------------------------------------
0027                       ; Initialize
0028                       ;------------------------------------------------------
0029 31C8 0204  20         li    tmp0,cmdb.top         ; \ Set pointer to command buffer
     31CA E000     
0030 31CC C804  38         mov   tmp0,@cmdb.top.ptr    ; /
     31CE A700     
0031               
0032 31D0 04E0  34         clr   @cmdb.visible         ; Hide command buffer
     31D2 A702     
0033 31D4 0204  20         li    tmp0,4
     31D6 0004     
0034 31D8 C804  38         mov   tmp0,@cmdb.scrrows    ; Set current command buffer size
     31DA A706     
0035 31DC C804  38         mov   tmp0,@cmdb.default    ; Set default command buffer size
     31DE A708     
0036               
0037 31E0 04E0  34         clr   @cmdb.lines           ; Number of lines in cmdb buffer
     31E2 A716     
0038 31E4 04E0  34         clr   @cmdb.dirty           ; Command buffer is clean
     31E6 A718     
0039 31E8 04E0  34         clr   @cmdb.action.ptr      ; Reset action to execute pointer
     31EA A726     
0040                       ;------------------------------------------------------
0041                       ; Clear command buffer
0042                       ;------------------------------------------------------
0043 31EC 06A0  32         bl    @film
     31EE 224A     
0044 31F0 E000             data  cmdb.top,>00,cmdb.size
     31F2 0000     
     31F4 1000     
...
0048                       ; Exit
0049                       ;------------------------------------------------------
0050 31F6 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0051 31F8 C2F9  30         mov   *stack+,r11           ; Pop r11
0052 31FA 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0026 3204 0649  14         dect  stack
0027 3206 C645  30         mov   tmp1,*stack           ; Push tmp1
0028 3208 0649  14         dect  stack
0029 320A C646  30         mov   tmp2,*stack           ; Push tmp2
0030                       ;------------------------------------------------------
0031                       ; Initialize
0032                       ;------------------------------------------------------
0033 320C 04E0  34         clr   @tv.error.visible     ; Set to hidden
     320E A228     
0034 3210 0204  20         li    tmp0,3
     3212 0003     
0035 3214 C804  38         mov   tmp0,@tv.error.rows   ; Number of rows in error pane
     3216 A22A     
0036               
0037 3218 06A0  32         bl    @film
     321A 224A     
0038 321C A22E                   data tv.error.msg,0,160
     321E 0000     
     3220 00A0     
0039                       ;-------------------------------------------------------
0040                       ; Exit
0041                       ;-------------------------------------------------------
0042               errpane.exit:
0043 3222 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0044 3224 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0045 3226 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0046 3228 C2F9  30         mov   *stack+,r11           ; Pop R11
0047 322A 045B  20         b     *r11                  ; Return to caller
0048               
                   < ram.resident.asm
...
0020               ***************************************************************
0021               tv.init:
0022 322C 0649  14         dect  stack
0023 322E C64B  30         mov   r11,*stack            ; Save return address
0024 3230 0649  14         dect  stack
0025 3232 C644  30         mov   tmp0,*stack           ; Push tmp0
0026 3234 0649  14         dect  stack
0027 3236 C645  30         mov   tmp1,*stack           ; Push tmp1
0028 3238 0649  14         dect  stack
0029 323A C646  30         mov   tmp2,*stack           ; Push tmp2
0030                       ;------------------------------------------------------
0031                       ; Initialize
0032                       ;------------------------------------------------------
0033 323C 0204  20         li    tmp0,1                ; \ Set default color scheme
     323E 0001     
0034 3240 C804  38         mov   tmp0,@tv.colorscheme  ; /
     3242 A212     
0035               
0036 3244 04E0  34         clr   @tv.task.oneshot      ; Reset pointer to oneshot task
     3246 A224     
0037 3248 E0A0  34         soc   @wbit10,config        ; Assume ALPHA LOCK is down
     324A 200C     
0038               
0039 324C 0204  20         li    tmp0,fj.bottom
     324E B000     
0040 3250 C804  38         mov   tmp0,@tv.fj.stackpnt  ; Set pointer to farjump return stack
     3252 A226     
0041                       ;------------------------------------------------------
0042                       ; Set defaults
0043                       ;------------------------------------------------------
0044 3254 06A0  32         bl    @cpym2m
     3256 24EE     
0045 3258 396E                   data def.printer.fname,tv.printer.fname,7
     325A D960     
     325C 0007     
0046               
0047 325E 06A0  32         bl    @cpym2m
     3260 24EE     
0048 3262 3976                   data def.clip.fname,tv.clip.fname,10
     3264 D9B0     
     3266 000A     
0049                       ;-------------------------------------------------------
0050                       ; Exit
0051                       ;-------------------------------------------------------
0052               tv.init.exit:
0053 3268 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0054 326A C179  30         mov   *stack+,tmp1          ; Pop tmp1
0055 326C C139  30         mov   *stack+,tmp0          ; Pop tmp0
0056 326E C2F9  30         mov   *stack+,r11           ; Pop R11
0057 3270 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0022                       ;-------------------------------------------------------
0023 3272 06A0  32         bl    @f18rst               ; Reset and lock the F18A
     3274 27BA     
0024                       ;-------------------------------------------------------
0025                       ; Load legacy SAMS page layout and exit to monitor
0026                       ;-------------------------------------------------------
0027 3276 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     3278 2F88     
0028 327A 600E                   data bank7.rom        ; | i  p0 = bank address
0029 327C 7FC0                   data bankx.vectab     ; | i  p1 = Vector with target address
0030 327E 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0031               
...
0021               ***************************************************************
0022               tv.reset:
0023 3280 0649  14         dect  stack
0024 3282 C64B  30         mov   r11,*stack            ; Save return address
0025                       ;------------------------------------------------------
0026                       ; Reset editor
0027                       ;------------------------------------------------------
0028 3284 06A0  32         bl    @cmdb.init            ; Initialize command buffer
     3286 31C0     
0029 3288 06A0  32         bl    @edb.init             ; Initialize editor buffer
     328A 317A     
0030 328C 06A0  32         bl    @idx.init             ; Initialize index
     328E 307A     
0031 3290 06A0  32         bl    @fb.init              ; Initialize framebuffer
     3292 3018     
0032 3294 06A0  32         bl    @errpane.init         ; Initialize error pane
     3296 31FC     
0033                       ;------------------------------------------------------
0034                       ; Remove markers and shortcuts
0035                       ;------------------------------------------------------
0036 3298 06A0  32         bl    @hchar
     329A 27E6     
0037 329C 0034                   byte 0,52,32,18           ; Remove markers
     329E 2012     
0038 32A0 1700                   byte pane.botrow,0,32,51  ; Remove block shortcuts
     32A2 2033     
0039 32A4 FFFF                   data eol
0040                       ;-------------------------------------------------------
0041                       ; Exit
0042                       ;-------------------------------------------------------
0043               tv.reset.exit:
0044 32A6 C2F9  30         mov   *stack+,r11           ; Pop R11
0045 32A8 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0027 32B2 06A0  32         bl    @mknum                ; Convert unsigned number to string
     32B4 29BE     
0028 32B6 A000                   data parm1            ; \ i p0  = Pointer to 16bit unsigned number
0029 32B8 A100                   data rambuf           ; | i p1  = Pointer to 5 byte string buffer
0030 32BA 30                     byte 48               ; | i p2H = Offset for ASCII digit 0
0031 32BB   20                   byte 32               ; / i p2L = Char for replacing leading 0's
0032               
...
0038 32C6 06A0  32         bl    @trimnum              ; Trim unsigned number string
     32C8 2A16     
0039 32CA A100                   data rambuf           ; \ i p0  = Pointer to 5 byte string buffer
0040 32CC A026                   data unpacked.string  ; | i p1  = Pointer to output buffer
...
0022               ***************************************************************
0023               tv.pad.string:
0024 32D6 0649  14         dect  stack
0025 32D8 C64B  30         mov   r11,*stack            ; Push return address
0026 32DA 0649  14         dect  stack
0027 32DC C644  30         mov   tmp0,*stack           ; Push tmp0
0028 32DE 0649  14         dect  stack
0029 32E0 C645  30         mov   tmp1,*stack           ; Push tmp1
0030 32E2 0649  14         dect  stack
0031 32E4 C646  30         mov   tmp2,*stack           ; Push tmp2
0032 32E6 0649  14         dect  stack
0033 32E8 C647  30         mov   tmp3,*stack           ; Push tmp3
0034                       ;------------------------------------------------------
0035                       ; Asserts
0036                       ;------------------------------------------------------
0037 32EA C120  34         mov   @parm1,tmp0           ; \ Get string prefix (length-byte)
     32EC A000     
0038 32EE D194  26         movb  *tmp0,tmp2            ; /
0039 32F0 0986  56         srl   tmp2,8                ; Right align
0040 32F2 C1C6  18         mov   tmp2,tmp3             ; Make copy of length-byte for later use
0041               
0042 32F4 8806  38         c     tmp2,@parm2           ; String length > requested length?
     32F6 A002     
0043 32F8 1520  14         jgt   tv.pad.string.panic   ; Yes, crash
0044                       ;------------------------------------------------------
0045                       ; Copy string to buffer
0046                       ;------------------------------------------------------
0047 32FA C120  34         mov   @parm1,tmp0           ; Get source address
     32FC A000     
0048 32FE C160  34         mov   @parm4,tmp1           ; Get destination address
     3300 A006     
0049 3302 0586  14         inc   tmp2                  ; Also include length-byte in copy
0050               
0051 3304 0649  14         dect  stack
0052 3306 C647  30         mov   tmp3,*stack           ; Push tmp3 (get overwritten by xpym2m)
0053               
0054 3308 06A0  32         bl    @xpym2m               ; Copy length-prefix string to buffer
     330A 24F4     
0055                                                   ; \ i  tmp0 = Source CPU memory address
0056                                                   ; | i  tmp1 = Target CPU memory address
0057                                                   ; / i  tmp2 = Number of bytes to copy
0058               
0059 330C C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0060                       ;------------------------------------------------------
0061                       ; Set length of new string
0062                       ;------------------------------------------------------
0063 330E C120  34         mov   @parm2,tmp0           ; Get requested length
     3310 A002     
0064 3312 0A84  56         sla   tmp0,8                ; Left align
0065 3314 C160  34         mov   @parm4,tmp1           ; Get pointer to buffer
     3316 A006     
0066 3318 D544  30         movb  tmp0,*tmp1            ; Set new length of string
0067 331A A147  18         a     tmp3,tmp1             ; \ Skip to end of string
0068 331C 0585  14         inc   tmp1                  ; /
0069                       ;------------------------------------------------------
0070                       ; Prepare for padding string
0071                       ;------------------------------------------------------
0072 331E C1A0  34         mov   @parm2,tmp2           ; \ Get number of bytes to fill
     3320 A002     
0073 3322 6187  18         s     tmp3,tmp2             ; |
0074 3324 0586  14         inc   tmp2                  ; /
0075               
0076 3326 C120  34         mov   @parm3,tmp0           ; Get byte to padd
     3328 A004     
0077 332A 0A84  56         sla   tmp0,8                ; Left align
0078                       ;------------------------------------------------------
0079                       ; Right-pad string to destination length
0080                       ;------------------------------------------------------
0081               tv.pad.string.loop:
0082 332C DD44  32         movb  tmp0,*tmp1+           ; Pad character
0083 332E 0606  14         dec   tmp2                  ; Update loop counter
0084 3330 15FD  14         jgt   tv.pad.string.loop    ; Next character
0085               
0086 3332 C820  54         mov   @parm4,@outparm1      ; Set pointer to padded string
     3334 A006     
     3336 A010     
0087 3338 1004  14         jmp   tv.pad.string.exit    ; Exit
0088                       ;-----------------------------------------------------------------------
0089                       ; CPU crash
0090                       ;-----------------------------------------------------------------------
0091               tv.pad.string.panic:
0092 333A C80B  38         mov   r11,@>ffce            ; \ Save caller address
     333C FFCE     
0093 333E 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     3340 2026     
0094                       ;------------------------------------------------------
0095                       ; Exit
0096                       ;------------------------------------------------------
0097               tv.pad.string.exit:
0098 3342 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0099 3344 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0100 3346 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0101 3348 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0102 334A C2F9  30         mov   *stack+,r11           ; Pop r11
0103 334C 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
0018                       ;-----------------------------------------------------------------------
...
0022 334E 0649  14         dect  stack
0023 3350 C64B  30         mov   r11,*stack            ; Save return address
0024 3352 0649  14         dect  stack
0025 3354 C644  30         mov   tmp0,*stack           ; Push tmp0
0026 3356 0649  14         dect  stack
0027 3358 C645  30         mov   tmp1,*stack           ; Push tmp1
0028                       ;------------------------------------------------------
0029                       ; Get parameters
0030                       ;------------------------------------------------------
0031 335A C120  34         mov   @parm1,tmp0           ; Get line number
     335C A000     
0032 335E C160  34         mov   @parm2,tmp1           ; Get pointer
     3360 A002     
0033 3362 1312  14         jeq   idx.entry.update.clear
0034                                                   ; Special handling for "null"-pointer
0035                       ;------------------------------------------------------
0036                       ; Calculate LSB value index slot (pointer offset)
0037                       ;------------------------------------------------------
0038 3364 0245  22         andi  tmp1,>0fff            ; Remove high-nibble from pointer
     3366 0FFF     
0039 3368 0945  56         srl   tmp1,4                ; Get offset (divide by 16)
0040                       ;------------------------------------------------------
0041                       ; Calculate MSB value index slot (SAMS page editor buffer)
0042                       ;------------------------------------------------------
0043 336A 06E0  34         swpb  @parm3
     336C A004     
0044 336E D160  34         movb  @parm3,tmp1           ; Put SAMS page in MSB
     3370 A004     
0045 3372 06E0  34         swpb  @parm3                ; \ Restore original order again,
     3374 A004     
...
0051 3376 06A0  32         bl    @_idx.samspage.get    ; Get SAMS page for index
     3378 312A     
0052                                                   ; \ i  tmp0     = Line number
0053                                                   ; / o  outparm1 = Slot offset in SAMS page
0054               
0055 337A C120  34         mov   @outparm1,tmp0        ; \ Update index slot
     337C A010     
0056 337E C905  38         mov   tmp1,@idx.top(tmp0)   ; /
     3380 B000     
0057 3382 C804  38         mov   tmp0,@outparm1        ; Pointer to updated index entry
     3384 A010     
0058 3386 1008  14         jmp   idx.entry.update.exit
0059                       ;------------------------------------------------------
0060                       ; Special handling for "null"-pointer
0061                       ;------------------------------------------------------
0062               idx.entry.update.clear:
0063 3388 06A0  32         bl    @_idx.samspage.get    ; Get SAMS page for index
     338A 312A     
0064                                                   ; \ i  tmp0     = Line number
0065                                                   ; / o  outparm1 = Slot offset in SAMS page
0066               
0067 338C C120  34         mov   @outparm1,tmp0        ; \ Clear index slot
     338E A010     
0068 3390 04E4  34         clr   @idx.top(tmp0)        ; /
     3392 B000     
0069 3394 C804  38         mov   tmp0,@outparm1        ; Pointer to updated index entry
     3396 A010     
0070                       ;------------------------------------------------------
0071                       ; Exit
0072                       ;------------------------------------------------------
0073               idx.entry.update.exit:
0074 3398 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0075 339A C139  30         mov   *stack+,tmp0          ; Pop tmp0
0076 339C C2F9  30         mov   *stack+,r11           ; Pop r11
0077 339E 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0021 33A0 0649  14         dect  stack
0022 33A2 C64B  30         mov   r11,*stack            ; Save return address
0023 33A4 0649  14         dect  stack
0024 33A6 C644  30         mov   tmp0,*stack           ; Push tmp0
0025 33A8 0649  14         dect  stack
0026 33AA C645  30         mov   tmp1,*stack           ; Push tmp1
0027 33AC 0649  14         dect  stack
0028 33AE C646  30         mov   tmp2,*stack           ; Push tmp2
0029                       ;------------------------------------------------------
0030                       ; Get slot entry
0031                       ;------------------------------------------------------
0032 33B0 C120  34         mov   @parm1,tmp0           ; Line number in editor buffer
     33B2 A000     
0033               
0034 33B4 06A0  32         bl    @_idx.samspage.get    ; Get SAMS page with index slot
     33B6 312A     
0035                                                   ; \ i  tmp0     = Line number
0036                                                   ; / o  outparm1 = Slot offset in SAMS page
0037               
0038 33B8 C120  34         mov   @outparm1,tmp0        ; \ Get slot entry
     33BA A010     
0039 33BC C164  34         mov   @idx.top(tmp0),tmp1   ; /
     33BE B000     
0040               
0041 33C0 130C  14         jeq   idx.pointer.get.parm.null
0042                                                   ; Skip if index slot empty
0043                       ;------------------------------------------------------
0044                       ; Calculate MSB (SAMS page)
0045                       ;------------------------------------------------------
0046 33C2 C185  18         mov   tmp1,tmp2             ; \
0047 33C4 0986  56         srl   tmp2,8                ; / Right align SAMS page
0048                       ;------------------------------------------------------
0049                       ; Calculate LSB (pointer address)
0050                       ;------------------------------------------------------
0051 33C6 0245  22         andi  tmp1,>00ff            ; Get rid of MSB (SAMS page)
     33C8 00FF     
0052 33CA 0A45  56         sla   tmp1,4                ; Multiply with 16
0053 33CC 0225  22         ai    tmp1,edb.top          ; Add editor buffer base address
     33CE C000     
0054                       ;------------------------------------------------------
0055                       ; Return parameters
0056                       ;------------------------------------------------------
0057               idx.pointer.get.parm:
0058 33D0 C805  38         mov   tmp1,@outparm1        ; Index slot -> Pointer
     33D2 A010     
0059 33D4 C806  38         mov   tmp2,@outparm2        ; Index slot -> SAMS page
     33D6 A012     
0060 33D8 1004  14         jmp   idx.pointer.get.exit
0061                       ;------------------------------------------------------
0062                       ; Special handling for "null"-pointer
0063                       ;------------------------------------------------------
0064               idx.pointer.get.parm.null:
0065 33DA 04E0  34         clr   @outparm1
     33DC A010     
0066 33DE 04E0  34         clr   @outparm2
     33E0 A012     
0067                       ;------------------------------------------------------
0068                       ; Exit
0069                       ;------------------------------------------------------
0070               idx.pointer.get.exit:
0071 33E2 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0072 33E4 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0073 33E6 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0074 33E8 C2F9  30         mov   *stack+,r11           ; Pop r11
0075 33EA 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0016                       ;------------------------------------------------------
0017 33EC 0224  22         ai    tmp0,idx.top          ; Add index base to offset
     33EE B000     
0018 33F0 C144  18         mov   tmp0,tmp1             ; a = current slot
0019 33F2 05C5  14         inct  tmp1                  ; b = current slot + 2
0020                       ;------------------------------------------------------
0021                       ; Loop forward until end of index
0022                       ;------------------------------------------------------
0023               _idx.entry.delete.reorg.loop:
0024 33F4 CD35  46         mov   *tmp1+,*tmp0+         ; Copy b -> a
0025 33F6 0606  14         dec   tmp2                  ; tmp2--
0026 33F8 16FD  14         jne   _idx.entry.delete.reorg.loop
0027                                                   ; Loop unless completed
0028 33FA 045B  20         b     *r11                  ; Return to caller
0029               
0030               
0031               
0032               ***************************************************************
...
0046 33FC 0649  14         dect  stack
0047 33FE C64B  30         mov   r11,*stack            ; Save return address
0048 3400 0649  14         dect  stack
0049 3402 C644  30         mov   tmp0,*stack           ; Push tmp0
0050 3404 0649  14         dect  stack
0051 3406 C645  30         mov   tmp1,*stack           ; Push tmp1
0052 3408 0649  14         dect  stack
0053 340A C646  30         mov   tmp2,*stack           ; Push tmp2
0054 340C 0649  14         dect  stack
0055 340E C647  30         mov   tmp3,*stack           ; Push tmp3
0056                       ;------------------------------------------------------
0057                       ; Get index slot
0058                       ;------------------------------------------------------
0059 3410 C120  34         mov   @parm1,tmp0           ; Line number in editor buffer
     3412 A000     
0060               
0061 3414 06A0  32         bl    @_idx.samspage.get    ; Get SAMS page for index
     3416 312A     
0062                                                   ; \ i  tmp0     = Line number
0063                                                   ; / o  outparm1 = Slot offset in SAMS page
0064               
0065 3418 C120  34         mov   @outparm1,tmp0        ; Index offset
     341A A010     
0066                       ;------------------------------------------------------
0067                       ; Prepare for index reorg
0068                       ;------------------------------------------------------
0069 341C C1A0  34         mov   @parm2,tmp2           ; Get last line to check
     341E A002     
0070 3420 1303  14         jeq   idx.entry.delete.lastline
0071                                                   ; Exit early if last line = 0
0072               
0073 3422 61A0  34         s     @parm1,tmp2           ; Calculate loop
     3424 A000     
0074 3426 1504  14         jgt   idx.entry.delete.reorg
0075                                                   ; Reorganize if loop counter > 0
0076                       ;------------------------------------------------------
0077                       ; Special treatment for last line
0078                       ;------------------------------------------------------
0079               idx.entry.delete.lastline:
0080 3428 0224  22         ai    tmp0,idx.top          ; Add index base to offset
     342A B000     
0081 342C 04D4  26         clr   *tmp0                 ; Clear index entry
0082 342E 1012  14         jmp   idx.entry.delete.exit ; Exit early
0083                       ;------------------------------------------------------
0084                       ; Reorganize index entries
0085                       ;------------------------------------------------------
0086               idx.entry.delete.reorg:
0087 3430 C1E0  34         mov   @parm2,tmp3           ; Get last line to reorganize
     3432 A002     
0088 3434 0287  22         ci    tmp3,2048
     3436 0800     
0089 3438 120A  14         jle   idx.entry.delete.reorg.simple
...
0096 343A 06A0  32         bl    @_idx.sams.mapcolumn.on
     343C 30BC     
...
0101                       ;-------------------------------------------------------
0102 343E C120  34         mov   @parm1,tmp0           ; Restore line number
     3440 A000     
0103 3442 0A14  56         sla   tmp0,1                ; Calculate offset
0104               
0105 3444 06A0  32         bl    @_idx.entry.delete.reorg
     3446 33EC     
0106                                                   ; Reorganize index
0107                                                   ; \ i  tmp0 = Index offset
0108                                                   ; / i  tmp2 = Loop count
0109               
0110 3448 06A0  32         bl    @_idx.sams.mapcolumn.off
     344A 30F0     
0111                                                   ; Restore memory window layout
0112               
0113 344C 1002  14         jmp   !
0114                       ;------------------------------------------------------
0115                       ; Simple index reorganization
0116                       ;------------------------------------------------------
0117               idx.entry.delete.reorg.simple:
0118 344E 06A0  32         bl    @_idx.entry.delete.reorg
     3450 33EC     
0119                       ;------------------------------------------------------
0120                       ; Clear index entry (base + offset already set)
0121                       ;------------------------------------------------------
0122 3452 04D4  26 !       clr   *tmp0                 ; Clear index entry
0123                       ;------------------------------------------------------
0124                       ; Exit
0125                       ;------------------------------------------------------
0126               idx.entry.delete.exit:
0127 3454 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0128 3456 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0129 3458 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0130 345A C139  30         mov   *stack+,tmp0          ; Pop tmp0
0131 345C C2F9  30         mov   *stack+,r11           ; Pop r11
0132 345E 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0015                       ; Assert 1
0016                       ;------------------------------------------------------
0017 3460 0286  22         ci    tmp2,2048*5           ; Crash if loop counter value is unrealistic
     3462 2800     
0018                                                   ; Max. 5 SAMS pages, each with 2048 index
0019                                                   ; entries.
0020               
0021 3464 1204  14         jle   !                     ; Continue if ok
0022                       ;------------------------------------------------------
0023                       ; Crash and burn
0024                       ;------------------------------------------------------
0025               _idx.entry.insert.reorg.crash:
0026 3466 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     3468 FFCE     
0027 346A 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     346C 2026     
0028                       ;------------------------------------------------------
0029                       ; Reorganize index entries
0030                       ;------------------------------------------------------
0031 346E 0224  22 !       ai    tmp0,idx.top          ; Add index base to offset
     3470 B000     
0032 3472 C144  18         mov   tmp0,tmp1             ; a = current slot
0033 3474 05C5  14         inct  tmp1                  ; b = current slot + 2
0034 3476 0586  14         inc   tmp2                  ; One time adjustment for current line
0035                       ;------------------------------------------------------
0036                       ; Assert 2
0037                       ;------------------------------------------------------
0038 3478 C1C6  18         mov   tmp2,tmp3             ; Number of slots to reorganize
0039 347A 0A17  56         sla   tmp3,1                ; adjust to slot size
0040 347C 0507  16         neg   tmp3                  ; tmp3 = -tmp3
0041 347E A1C4  18         a     tmp0,tmp3             ; tmp3 = tmp3 + tmp0
0042 3480 0287  22         ci    tmp3,idx.top - 4      ; Address before top of index ?
     3482 AFFC     
0043 3484 1504  14         jgt   _idx.entry.insert.reorg.loop
0044                                                   ; No, jump to loop start
0045                       ;------------------------------------------------------
0046                       ; Crash and burn
0047                       ;------------------------------------------------------
0048 3486 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     3488 FFCE     
0049 348A 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     348C 2026     
0050                       ;------------------------------------------------------
0051                       ; Loop backwards from end of index up to insert point
0052                       ;------------------------------------------------------
0053               _idx.entry.insert.reorg.loop:
0054 348E C554  38         mov   *tmp0,*tmp1           ; Copy a -> b
0055 3490 0644  14         dect  tmp0                  ; Move pointer up
0056 3492 0645  14         dect  tmp1                  ; Move pointer up
0057 3494 0606  14         dec   tmp2                  ; Next index entry
0058 3496 15FB  14         jgt   _idx.entry.insert.reorg.loop
0059                                                   ; Repeat until done
0060                       ;------------------------------------------------------
0061                       ; Clear index entry at insert point
0062                       ;------------------------------------------------------
0063 3498 05C4  14         inct  tmp0                  ; \ Clear index entry for line
0064 349A 04D4  26         clr   *tmp0                 ; / following insert point
0065               
0066 349C 045B  20         b     *r11                  ; Return to caller
0067               
0068               
0069               
0070               
...
0088 349E 0649  14         dect  stack
0089 34A0 C64B  30         mov   r11,*stack            ; Save return address
0090 34A2 0649  14         dect  stack
0091 34A4 C644  30         mov   tmp0,*stack           ; Push tmp0
0092 34A6 0649  14         dect  stack
0093 34A8 C645  30         mov   tmp1,*stack           ; Push tmp1
0094 34AA 0649  14         dect  stack
0095 34AC C646  30         mov   tmp2,*stack           ; Push tmp2
0096 34AE 0649  14         dect  stack
0097 34B0 C647  30         mov   tmp3,*stack           ; Push tmp3
0098                       ;------------------------------------------------------
0099                       ; Prepare for index reorg
0100                       ;------------------------------------------------------
0101 34B2 C1A0  34         mov   @parm2,tmp2           ; Get last line to check
     34B4 A002     
0102 34B6 61A0  34         s     @parm1,tmp2           ; Calculate loop
     34B8 A000     
0103 34BA 130F  14         jeq   idx.entry.insert.reorg.simple
0104                                                   ; Special treatment if last line
0105                       ;------------------------------------------------------
0106                       ; Reorganize index entries
0107                       ;------------------------------------------------------
0108               idx.entry.insert.reorg:
0109 34BC C1E0  34         mov   @parm2,tmp3
     34BE A002     
0110 34C0 0287  22         ci    tmp3,2048
     34C2 0800     
0111 34C4 110A  14         jlt   idx.entry.insert.reorg.simple
...
0118 34C6 06A0  32         bl    @_idx.sams.mapcolumn.on
     34C8 30BC     
0119                                                   ; Index in continuous memory region
0120                                                   ; b000 - ffff (5 SAMS pages)
0121               
0122 34CA C120  34         mov   @parm2,tmp0           ; Last line number in editor buffer
     34CC A002     
0123 34CE 0A14  56         sla   tmp0,1                ; tmp0 * 2
0124               
0125 34D0 06A0  32         bl    @_idx.entry.insert.reorg
     34D2 3460     
0126                                                   ; Reorganize index
0127                                                   ; \ i  tmp0 = Last line in index
0128                                                   ; / i  tmp2 = Num. of index entries to move
0129               
0130 34D4 06A0  32         bl    @_idx.sams.mapcolumn.off
     34D6 30F0     
0131                                                   ; Restore memory window layout
0132               
0133 34D8 1008  14         jmp   idx.entry.insert.exit
0134                       ;------------------------------------------------------
0135                       ; Simple index reorganization
0136                       ;------------------------------------------------------
0137               idx.entry.insert.reorg.simple:
0138 34DA C120  34         mov   @parm2,tmp0           ; Last line number in editor buffer
     34DC A002     
0139               
0140 34DE 06A0  32         bl    @_idx.samspage.get    ; Get SAMS page for index
     34E0 312A     
0141                                                   ; \ i  tmp0     = Line number
0142                                                   ; / o  outparm1 = Slot offset in SAMS page
0143               
0144 34E2 C120  34         mov   @outparm1,tmp0        ; Index offset
     34E4 A010     
0145               
0146 34E6 06A0  32         bl    @_idx.entry.insert.reorg
     34E8 3460     
...
0155 34EA C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0156 34EC C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0157 34EE C179  30         mov   *stack+,tmp1          ; Pop tmp1
0158 34F0 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0159 34F2 C2F9  30         mov   *stack+,r11           ; Pop r11
0160 34F4 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
0025                       ;-----------------------------------------------------------------------
...
0022 34F8 C64B  30         mov   r11,*stack            ; Push return address
...
0028                       ; Assert
0029                       ;------------------------------------------------------
0030 3502 8804  38         c     tmp0,@edb.lines       ; Non-existing line?
     3504 A504     
0031 3506 1204  14         jle   edb.line.mappage.lookup
0032                                                   ; All checks passed, continue
0033                                                   ;--------------------------
0034                                                   ; Assert failed
0035                                                   ;--------------------------
0036 3508 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     350A FFCE     
0037 350C 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     350E 2026     
0038                       ;------------------------------------------------------
0039                       ; Lookup SAMS page for line in parm1
0040                       ;------------------------------------------------------
0041               edb.line.mappage.lookup:
0042 3510 C804  38         mov   tmp0,@parm1           ; Set line number in editor buffer
     3512 A000     
0043               
0044 3514 06A0  32         bl    @idx.pointer.get      ; Get pointer to line
     3516 33A0     
0045                                                   ; \ i  parm1    = Line number
0046                                                   ; | o  outparm1 = Pointer to line
0047                                                   ; / o  outparm2 = SAMS page
0048               
0049 3518 C120  34         mov   @outparm2,tmp0        ; SAMS page
     351A A012     
0050 351C C160  34         mov   @outparm1,tmp1        ; Pointer to line
     351E A010     
0051 3520 130B  14         jeq   edb.line.mappage.exit ; Nothing to page-in if NULL pointer
0052                                                   ; (=empty line)
0053                       ;------------------------------------------------------
0054                       ; Determine if requested SAMS page is already active
0055                       ;------------------------------------------------------
0056 3522 8120  34         c     @tv.sams.c000,tmp0    ; Compare with active page editor buffer
     3524 A208     
0057 3526 1308  14         jeq   edb.line.mappage.exit ; Request page already active, so exit
0058                       ;------------------------------------------------------
0059                       ; Activate requested SAMS page
0060                       ;-----------------------------------------------------
0061 3528 06A0  32         bl    @xsams.page.set       ; Switch SAMS memory page
     352A 258A     
0062                                                   ; \ i  tmp0 = SAMS page
0063                                                   ; / i  tmp1 = Memory address
0064               
0065 352C C820  54         mov   @outparm2,@tv.sams.c000
     352E A012     
     3530 A208     
0066                                                   ; Set page in shadow registers
0067               
0068 3532 C820  54         mov   @outparm2,@edb.sams.page
     3534 A012     
     3536 A516     
...
0074 3538 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0075 353A C139  30         mov   *stack+,tmp0          ; Pop tmp0
0076 353C C2F9  30         mov   *stack+,r11           ; Pop r11
0077 353E 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
...
0021 3540 0649  14         dect  stack
0022 3542 C64B  30         mov   r11,*stack            ; Push return address
0023 3544 0649  14         dect  stack
0024 3546 C644  30         mov   tmp0,*stack           ; Push tmp0
0025 3548 0649  14         dect  stack
0026 354A C645  30         mov   tmp1,*stack           ; Push tmp1
0027                       ;------------------------------------------------------
0028                       ; Initialisation
0029                       ;------------------------------------------------------
0030 354C 04E0  34         clr   @outparm1             ; Reset length
     354E A010     
0031 3550 04E0  34         clr   @outparm2             ; Reset SAMS bank
     3552 A012     
0032                       ;------------------------------------------------------
0033                       ; Exit if requested line beyond editor buffer
0034                       ;------------------------------------------------------
0035 3554 C120  34         mov   @parm1,tmp0           ; \
     3556 A000     
0036 3558 0584  14         inc   tmp0                  ; /  base 1
0037               
0038 355A 8804  38         c     tmp0,@edb.lines       ; Requested line at BOT?
     355C A504     
0039 355E 1101  14         jlt   !                     ; No, continue processing
0040 3560 100F  14         jmp   edb.line.getlength.null
0041                                                   ; Set length 0 and exit early
0042                       ;------------------------------------------------------
0043                       ; Map SAMS page
0044                       ;------------------------------------------------------
0045 3562 C120  34 !       mov   @parm1,tmp0           ; Get line
     3564 A000     
0046               
0047 3566 06A0  32         bl    @edb.line.mappage     ; Activate editor buffer SAMS page for line
     3568 34F6     
0048                                                   ; \ i  tmp0     = Line number
0049                                                   ; | o  outparm1 = Pointer to line
0050                                                   ; / o  outparm2 = SAMS page
0051               
0052 356A C120  34         mov   @outparm1,tmp0        ; Store pointer in tmp0
     356C A010     
0053 356E 1308  14         jeq   edb.line.getlength.null
0054                                                   ; Set length to 0 if null-pointer
0055                       ;------------------------------------------------------
0056                       ; Process line prefix
0057                       ;------------------------------------------------------
0058 3570 C154  26         mov   *tmp0,tmp1            ; Get length into tmp1
0059 3572 C805  38         mov   tmp1,@outparm1        ; Save length
     3574 A010     
0060                       ;------------------------------------------------------
0061                       ; Assert
0062                       ;------------------------------------------------------
0063 3576 0285  22         ci    tmp1,80               ; Line length <= 80 ?
     3578 0050     
0064 357A 1204  14         jle   edb.line.getlength.exit
0065                                                   ; Yes, exit
0066                       ;------------------------------------------------------
0067                       ; Crash the system or limit length to 80
0068                       ;------------------------------------------------------
0073 357C 0205  20         li    tmp1,80               ; Only process first 80 characters
     357E 0050     
0075                       ;------------------------------------------------------
0076                       ; Set length to 0 if null-pointer
0077                       ;------------------------------------------------------
0078               edb.line.getlength.null:
0079 3580 04E0  34         clr   @outparm1             ; Set length to 0, was a null-pointer
     3582 A010     
0080                       ;------------------------------------------------------
0081                       ; Exit
0082                       ;------------------------------------------------------
0083               edb.line.getlength.exit:
0084 3584 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0085 3586 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0086 3588 C2F9  30         mov   *stack+,r11           ; Pop r11
0087 358A 045B  20         b     *r11                  ; Return to caller
0088               
0089               
0090               
0091               ***************************************************************
...
0107 358C 0649  14         dect  stack
0108 358E C64B  30         mov   r11,*stack            ; Save return address
0109 3590 0649  14         dect  stack
0110 3592 C644  30         mov   tmp0,*stack           ; Push tmp0
0111                       ;------------------------------------------------------
0112                       ; Calculate line in editor buffer
0113                       ;------------------------------------------------------
0114 3594 C120  34         mov   @fb.topline,tmp0      ; Get top line in frame buffer
     3596 A304     
0115 3598 A120  34         a     @fb.row,tmp0          ; Get current row in frame buffer
     359A A306     
0116                       ;------------------------------------------------------
0117                       ; Get length
0118                       ;------------------------------------------------------
0119 359C C804  38         mov   tmp0,@parm1
     359E A000     
0120 35A0 06A0  32         bl    @edb.line.getlength
     35A2 3540     
0121 35A4 C820  54         mov   @outparm1,@fb.row.length
     35A6 A010     
     35A8 A308     
...
0127 35AA C139  30         mov   *stack+,tmp0          ; Pop tmp0
0128 35AC C2F9  30         mov   *stack+,r11           ; Pop R11
0129 35AE 045B  20         b     *r11                  ; Return to caller
                   < ram.resident.asm
0030                       ;-----------------------------------------------------------------------
...
0021 35B0 0649  14         dect  stack
0022 35B2 C64B  30         mov   r11,*stack            ; Push return address
0023 35B4 0649  14         dect  stack
0024 35B6 C660  46         mov   @wyx,*stack           ; Push cursor position
     35B8 832A     
0025                       ;-------------------------------------------------------
0026                       ; Clear message
0027                       ;-------------------------------------------------------
0028 35BA 06A0  32         bl    @hchar
     35BC 27E6     
0029 35BE 0034                   byte 0,52,32,18
     35C0 2012     
0030 35C2 FFFF                   data EOL              ; Clear message
0031               
0032 35C4 04E0  34         clr   @tv.task.oneshot      ; Reset oneshot task
     35C6 A224     
0033                       ;-------------------------------------------------------
0034                       ; Exit
0035                       ;-------------------------------------------------------
0036               pane.topline.oneshot.clearmsg.exit:
0037 35C8 C839  50         mov   *stack+,@wyx          ; Pop cursor position
     35CA 832A     
0038 35CC C2F9  30         mov   *stack+,r11           ; Pop R11
0039 35CE 045B  20         b     *r11                  ; Return to task
                   < ram.resident.asm
...
0031               ***************************************************************
0032               stevie.80x30:
0033 35D0 04F0             byte  >04,>f0,>00,>3f,>02,>43,>05,SPFCLR,0,80
     35D2 003F     
     35D4 0243     
     35D6 05F4     
     35D8 0050     
...
0038               *--------------------------------------------------------------
0039               tibasic.32x24:
0040 35DA 00E2             byte  >00,>e2,>00,>0c,>00,>06,>00,>07,0,32
     35DC 000C     
     35DE 0006     
     35E0 0007     
     35E2 0020     
...
0065               *--------------------------------------------------------------
0066               tibasic.32x30:
0067 35E4 00E2             byte  >00,>e2,>00,>0c,>00,>06,>00,>07,0,32
     35E6 000C     
     35E8 0006     
     35EA 0007     
     35EC 0020     
...
0098 35EE 0000             data  >0000,>0001           ; Cursor
     35F0 0001     
0099 35F2 0000             data  >0000,>0101           ; Current line indicator     <
     35F4 0101     
0100 35F6 0820             data  >0820,>0201           ; Current column indicator   v
     35F8 0201     
0101               nosprite:
0102 35FA D000             data  >d000                 ; End-of-Sprites list
0103               
0104               
0105               
0106               
...
0157 35FC F417             data  >f417,>f171,>1b1f,>71b1 ; 1  White on blue with cyan touch
     35FE F171     
     3600 1B1F     
     3602 71B1     
0158 3604 A11A             data  >a11a,>f0ff,>1f1a,>f1ff ; 2  Dark yellow on black
     3606 F0FF     
     3608 1F1A     
     360A F1FF     
0159 360C 2112             data  >2112,>f0ff,>1f12,>f1f6 ; 3  Dark green on black
     360E F0FF     
     3610 1F12     
     3612 F1F6     
0160 3614 F41F             data  >f41f,>1e11,>1a17,>1e11 ; 4  White on blue
     3616 1E11     
     3618 1A17     
     361A 1E11     
0161 361C E11E             data  >e11e,>e1ff,>1f1e,>e1ff ; 5  Grey on black
     361E E1FF     
     3620 1F1E     
     3622 E1FF     
0162 3624 1771             data  >1771,>1016,>1b71,>1711 ; 6  Black on cyan
     3626 1016     
     3628 1B71     
     362A 1711     
0163 362C 1FF1             data  >1ff1,>1011,>f1f1,>1f11 ; 7  Black on white
     362E 1011     
     3630 F1F1     
     3632 1F11     
0164 3634 1AF1             data  >1af1,>a1ff,>1f1f,>f11f ; 8  Black on dark yellow
     3636 A1FF     
     3638 1F1F     
     363A F11F     
0165 363C 21F0             data  >21f0,>12ff,>1b12,>12ff ; 9  Dark green on black
     363E 12FF     
     3640 1B12     
     3642 12FF     
0166 3644 F5F1             data  >f5f1,>e1ff,>1b1f,>f131 ; 10 White on light blue
     3646 E1FF     
     3648 1B1F     
     364A F131     
0167                       even
0168               
0169               tv.tabs.table:
0170 364C 0007             byte  0,7,12,25               ; \   Default tab positions as used
     364E 0C19     
0171 3650 1E2D             byte  30,45,59,79             ; |   in Editor/Assembler module.
     3652 3B4F     
0172 3654 FF00             byte  >ff,0,0,0               ; |
     3656 0000     
0173 3658 0000             byte  0,0,0,0                 ; |   Up to 20 positions supported.
     365A 0000     
0174 365C 0000             byte  0,0,0,0                 ; /   >ff means end-of-list.
     365E 0000     
0175                       even
                   < ram.resident.asm
...
0018               txt.ovrwrite
0019 3668 03               byte  3
0020 3669   4F             text  'OVR'
     366A 5652     
0021                       even
0022               
0023               txt.insert
0024 366C 03               byte  3
0025 366D   49             text  'INS'
     366E 4E53     
0026                       even
0027               
0028               txt.star
...
0032               
0033               txt.loading
0034 3672 0A               byte  10
0035 3673   4C             text  'Loading...'
     3674 6F61     
     3676 6469     
     3678 6E67     
     367A 2E2E     
...
0037               
0038               txt.saving
0039 367E 0A               byte  10
0040 367F   53             text  'Saving....'
     3680 6176     
     3682 696E     
     3684 672E     
     3686 2E2E     
...
0042               
0043               txt.printing
0044 368A 12               byte  18
0045 368B   50             text  'Printing file.....'
     368C 7269     
     368E 6E74     
     3690 696E     
     3692 6720     
...
0047               
0048               txt.block.del
0049 369E 12               byte  18
0050 369F   44             text  'Deleting block....'
     36A0 656C     
     36A2 6574     
     36A4 696E     
     36A6 6720     
...
0052               
0053               txt.block.copy
0054 36B2 11               byte  17
0055 36B3   43             text  'Copying block....'
     36B4 6F70     
     36B6 7969     
     36B8 6E67     
     36BA 2062     
...
0057               
0058               txt.block.move
0059 36C4 10               byte  16
0060 36C5   4D             text  'Moving block....'
     36C6 6F76     
     36C8 696E     
     36CA 6720     
     36CC 626C     
...
0062               
0063               txt.block.save
0064 36D6 18               byte  24
0065 36D7   53             text  'Saving block to file....'
     36D8 6176     
     36DA 696E     
     36DC 6720     
     36DE 626C     
...
0067               
0068               txt.block.clip
0069 36F0 18               byte  24
0070 36F1   43             text  'Copying to clipboard....'
     36F2 6F70     
     36F4 7969     
     36F6 6E67     
     36F8 2074     
...
0074 370A 12               byte  18
0075 370B   50             text  'Printing block....'
     370C 7269     
     370E 6E74     
     3710 696E     
     3712 6720     
...
0077               
0078               txt.clearmem
0079 371E 13               byte  19
0080 371F   43             text  'Clearing memory....'
     3720 6C65     
     3722 6172     
     3724 696E     
     3726 6720     
...
0082               
0083               txt.done.load
0084 3732 0E               byte  14
0085 3733   4C             text  'Load completed'
     3734 6F61     
     3736 6420     
     3738 636F     
     373A 6D70     
...
0089 3742 10               byte  16
0090 3743   49             text  'Insert completed'
     3744 6E73     
     3746 6572     
     3748 7420     
     374A 636F     
...
0094 3754 10               byte  16
0095 3755   41             text  'Append completed'
     3756 7070     
     3758 656E     
     375A 6420     
     375C 636F     
...
0097               
0098               txt.done.save
0099 3766 0E               byte  14
0100 3767   53             text  'Save completed'
     3768 6176     
     376A 6520     
     376C 636F     
     376E 6D70     
...
0102               
0103               txt.done.copy
0104 3776 0E               byte  14
0105 3777   43             text  'Copy completed'
     3778 6F70     
     377A 7920     
     377C 636F     
     377E 6D70     
...
0107               
0108               txt.done.print
0109 3786 0F               byte  15
0110 3787   50             text  'Print completed'
     3788 7269     
     378A 6E74     
     378C 2063     
     378E 6F6D     
...
0114 3796 10               byte  16
0115 3797   44             text  'Delete completed'
     3798 656C     
     379A 6574     
     379C 6520     
     379E 636F     
...
0119 37A8 0F               byte  15
0120 37A9   43             text  'Clipboard saved'
     37AA 6C69     
     37AC 7062     
     37AE 6F61     
     37B0 7264     
...
0124 37B8 0D               byte  13
0125 37B9   43             text  'Clipboard set'
     37BA 6C69     
     37BC 7062     
     37BE 6F61     
     37C0 7264     
...
0133               txt.kb
0134 37D0 02               byte  2
0135 37D1   6B             text  'kb'
     37D2 62       
0136                       even
0137               
0138               txt.lines
0139 37D4 05               byte  5
0140 37D5   4C             text  'Lines'
     37D6 696E     
     37D8 6573     
0141                       even
0142               
0143               txt.newfile
0144 37DA 0A               byte  10
0145 37DB   5B             text  '[New file]'
     37DC 4E65     
     37DE 7720     
     37E0 6669     
     37E2 6C65     
...
0153               txt.m1
0154 37EC 03               byte  3
0155 37ED   4D             text  'M1='
     37EE 313D     
0156                       even
0157               
0158               txt.m2
0159 37F0 03               byte  3
0160 37F1   4D             text  'M2='
     37F2 323D     
0161                       even
0162               
0163               txt.keys.default
0164 37F4 07               byte  7
0165 37F5   46             text  'F9-Menu'
     37F6 392D     
     37F8 4D65     
     37FA 6E75     
0166                       even
0167               
0168               txt.keys.block
0169 37FC 36               byte  54
0170 37FD   46             text  'F9-Back  ^Copy  ^Move  ^Del  ^Save  ^Print  ^[1-5]Clip'
     37FE 392D     
     3800 4261     
     3802 636B     
     3804 2020     
...
0171                       even
0172               
0173 3834 2E2E     txt.ruler          text    '.........'
     3836 2E2E     
     3838 2E2E     
     383A 2E2E     
     383C 2E       
0174 383D   12                        byte    18
0175 383E 2E2E                        text    '.........'
     3840 2E2E     
     3842 2E2E     
     3844 2E2E     
     3846 2E       
0176 3847   13                        byte    19
0177 3848 2E2E                        text    '.........'
     384A 2E2E     
     384C 2E2E     
     384E 2E2E     
     3850 2E       
0178 3851   14                        byte    20
0179 3852 2E2E                        text    '.........'
     3854 2E2E     
     3856 2E2E     
     3858 2E2E     
     385A 2E       
0180 385B   15                        byte    21
0181 385C 2E2E                        text    '.........'
     385E 2E2E     
     3860 2E2E     
     3862 2E2E     
     3864 2E       
0182 3865   16                        byte    22
0183 3866 2E2E                        text    '.........'
     3868 2E2E     
     386A 2E2E     
     386C 2E2E     
     386E 2E       
0184 386F   17                        byte    23
0185 3870 2E2E                        text    '.........'
     3872 2E2E     
     3874 2E2E     
     3876 2E2E     
     3878 2E       
0186 3879   18                        byte    24
0187 387A 2E2E                        text    '.........'
     387C 2E2E     
     387E 2E2E     
     3880 2E2E     
     3882 2E       
0188 3883   19                        byte    25
0189                                  even
0190 3884 020E     txt.alpha.down     data >020e,>0f00
     3886 0F00     
0191 3888 0110     txt.vertline       data >0110
0192 388A 011C     txt.keymarker      byte 1,28
0193               
0194               txt.ws1
0195 388C 01               byte  1
0196 388D   20             text  ' '
...
0217                       even
0218               
0219      3896     txt.filetype.none  equ txt.ws4
0220               
0221               
0222               ;--------------------------------------------------------------
...
0224               ;--------------------------------------------------------------
0225               txt.ioerr.load
0226 38A2 15               byte  21
0227 38A3   46             text  'Failed loading file: '
     38A4 6169     
     38A6 6C65     
     38A8 6420     
     38AA 6C6F     
...
0229               
0230               txt.ioerr.save
0231 38B8 14               byte  20
0232 38B9   46             text  'Failed saving file: '
     38BA 6169     
     38BC 6C65     
     38BE 6420     
     38C0 7361     
...
0236 38CE 1B               byte  27
0237 38CF   46             text  'Failed printing to device: '
     38D0 6169     
     38D2 6C65     
     38D4 6420     
     38D6 7072     
...
0239               
0240               txt.io.nofile
0241 38EA 16               byte  22
0242 38EB   4E             text  'No filename specified.'
     38EC 6F20     
     38EE 6669     
     38F0 6C65     
     38F2 6E61     
...
0246 3902 2D               byte  45
0247 3903   49             text  'Index full. File too large for editor buffer.'
     3904 6E64     
     3906 6578     
     3908 2066     
     390A 756C     
...
0251 3930 2D               byte  45
0252 3931   43             text  'Copy/Move target must be outside M1-M2 range.'
     3932 6F70     
     3934 792F     
     3936 4D6F     
     3938 7665     
...
0265 3960 0D               byte  13
0266 3961   43             text  'Color scheme:'
     3962 6F6C     
     3964 6F72     
     3966 2073     
     3968 6368     
...
0026               
0027               def.devices
0028 3994 2F               byte  47
0029 3995   2C             text  ',DSK,HDX,IDE,PI.,PIO,TIPI.,RD,SCS,SDD,WDS,RS232'
     3996 4453     
     3998 4B2C     
     399A 4844     
     399C 582C     
...
0040                       ;------------------------------------------------------
0041 39C4 04E0  34         clr   @bank1.rom            ; Activate bank 1 "James" ROM
     39C6 6002     
0042               
0046               
0047 39C8 0460  28         b     @kickstart.code2      ; Jump to entry routine
     39CA 6046     
0048               ***************************************************************
...
0070 6086 06A0  32         bl    @cpym2m
     6088 24EE     
0071 608A 35EE                   data romsat,ramsat,14 ; Load sprite SAT
     608C A03C     
     608E 000E     
0072               
...
0047 6BCA 37B8                   data txt.done.clipdev
0048                       ;-------------------------------------------------------
...
0038 71C6 0560  34         inv   @fb.curtoggle         ; Flip cursor shape flag
     71C8 A312     
0039 71CA 1319  14         jeq   task.vdp.cursor.dump  ; Show CMDB cursor
0040                       ;------------------------------------------------------
...
0044 71CC 0720  34         seto  @cmdb.dirty
     71CE A718     
0045 71D0 101C  14         jmp   task.vdp.cursor.exit
0046                       ;------------------------------------------------------
...
0056 71D8 0720  34         seto  @fb.dirty             ; Trigger refresh
     71DA A316     
0057 71DC 1016  14         jmp   task.vdp.cursor.exit
0058                       ;------------------------------------------------------
0059                       ; Show FB cursor
0060                       ;------------------------------------------------------
0061               task.vdp.cursor.fb.visible:
0062 71DE C120  34         mov   @tv.ruler.visible,tmp0
     71E0 A210     
0063 71E2 1307  14         jeq   task.vdp.cursor.fb.visible.noruler
0064                       ;------------------------------------------------------
0065                       ; Cursor position adjustment, ruler visible
0066                       ;------------------------------------------------------
0067 71E4 C120  34         mov   @wyx,tmp0             ; Get cursor YX
     71E6 832A     
0068 71E8 0224  22         ai    tmp0,>0200            ; Topline + ruler adjustment
     71EA 0200     
0069 71EC C804  38         mov   tmp0,@wyx             ; Save cursor YX
     71EE 832A     
0070 71F0 1006  14         jmp   task.vdp.cursor.dump
0071                       ;------------------------------------------------------
0072                       ; Cursor position adjustment, ruler hidden
0073                       ;------------------------------------------------------
0074               task.vdp.cursor.fb.visible.noruler:
0075 71F2 C120  34         mov   @wyx,tmp0             ; Get cursor YX
     71F4 832A     
0076 71F6 0224  22         ai    tmp0,>0100            ; Topline adjustment
     71F8 0100     
0077 71FA C804  38         mov   tmp0,@wyx             ; Save cursor YX
     71FC 832A     
0078                       ;------------------------------------------------------
0079                       ; Dump cursor to VDP
0080                       ;------------------------------------------------------
0081               task.vdp.cursor.dump:
0082 71FE 06A0  32         bl    @yx2pnt               ; Calculate VDP address from @WYX
     7200 240E     
0083                                                   ; \ i  @wyx = Cursor position
0084                                                   ; / o  tmp0 = VDP address
0085               
0086 7202 0205  20         li    tmp1,26               ; Cursor character
     7204 001A     
0087               
0088 7206 06A0  32         bl    @xvputb               ; VDP put single byte
     7208 22E0     
...
0095 720A C839  50         mov   *stack+,@wyx          ; Pop cursor position
     720C 832A     
0096 720E C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0097 7210 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0098 7212 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0099 7214 C2F9  30         mov   *stack+,r11           ; Pop r11
0100 7216 0460  28         b     @slotok               ; Exit task
     7218 2E5C     
                   < stevie_b1.asm.27722
0125               
...
0006               ********|*****|*********************|**************************
0007               task.vdp.panes:
0008 721A 0649  14         dect  stack
0009 721C C64B  30         mov   r11,*stack            ; Save return address
0010                       ;------------------------------------------------------
0011                       ; Dump panes to VDP memory
0012                       ;------------------------------------------------------
0013 721E 06A0  32         bl    @pane.vdpdump
     7220 77E4     
0014                       ;------------------------------------------------------
0015                       ; Exit task
0016                       ;------------------------------------------------------
0017               task.vdp.panes.exit:
0018 7222 C2F9  30         mov   *stack+,r11           ; Pop r11
0019 7224 0460  28         b     @slotok
     7226 2E5C     
                   < stevie_b1.asm.27722
...
0007               
0008               task.oneshot:
0009 7228 C120  34         mov   @tv.task.oneshot,tmp0  ; Get pointer to one-shot task
     722A A224     
0010 722C 1301  14         jeq   task.oneshot.exit
0011               
0012 722E 0694  24         bl    *tmp0                  ; Execute one-shot task
0013                       ;------------------------------------------------------
0014                       ; Exit
0015                       ;------------------------------------------------------
0016               task.oneshot.exit:
0017 7230 0460  28         b     @slotok                ; Exit task
     7232 2E5C     
                   < stevie_b1.asm.27722
0128                       ;-----------------------------------------------------------------------
...
0020 7234 0649  14         dect  stack
0021 7236 C64B  30         mov   r11,*stack            ; Push return address
0022 7238 0649  14         dect  stack
0023 723A C644  30         mov   tmp0,*stack           ; Push tmp0
0024               
0025 723C C120  34         mov   @tv.colorscheme,tmp0  ; Load color scheme index
     723E A212     
0026 7240 0284  22         ci    tmp0,tv.colorscheme.entries
     7242 000A     
0027                                                   ; Last entry reached?
0028 7244 1103  14         jlt   !
0029 7246 0204  20         li    tmp0,1                ; Reset color scheme index
     7248 0001     
0030 724A 1001  14         jmp   pane.action.colorscheme.switch
0031 724C 0584  14 !       inc   tmp0
0032                       ;-------------------------------------------------------
0033                       ; Switch to new color scheme
0034                       ;-------------------------------------------------------
0035               pane.action.colorscheme.switch:
0036 724E C804  38         mov   tmp0,@tv.colorscheme  ; Save index of color scheme
     7250 A212     
0037               
0038 7252 06A0  32         bl    @pane.action.colorscheme.load
     7254 7292     
0039                                                   ; Load current color scheme
0040                       ;-------------------------------------------------------
0041                       ; Show current color palette message
0042                       ;-------------------------------------------------------
0043 7256 C820  54         mov   @wyx,@waux1           ; Save cursor YX position
     7258 832A     
     725A 833C     
0044               
0045 725C 06A0  32         bl    @putnum
     725E 2A3C     
0046 7260 003E                   byte 0,62
0047 7262 A212                   data tv.colorscheme,rambuf,>3020
     7264 A100     
     7266 3020     
0048               
0049 7268 06A0  32         bl    @putat
     726A 2456     
0050 726C 0034                   byte 0,52
0051 726E 3960                   data txt.colorscheme  ; Show color palette message
0052               
0053 7270 C820  54         mov   @waux1,@wyx           ; Restore cursor YX position
     7272 833C     
     7274 832A     
0054                       ;-------------------------------------------------------
0055                       ; Delay
0056                       ;-------------------------------------------------------
0057 7276 0204  20         li    tmp0,12000
     7278 2EE0     
0058 727A 0604  14 !       dec   tmp0
0059 727C 16FE  14         jne   -!
0060                       ;-------------------------------------------------------
0061                       ; Setup one shot task for removing message
0062                       ;-------------------------------------------------------
0063 727E 0204  20         li    tmp0,pane.topline.oneshot.clearmsg
     7280 35B0     
0064 7282 C804  38         mov   tmp0,@tv.task.oneshot
     7284 A224     
0065               
0066 7286 06A0  32         bl    @rsslot               ; \ Reset loop counter slot 3
     7288 2ED0     
0067 728A 0003                   data 3                ; / for getting consistent delay
0068                       ;-------------------------------------------------------
0069                       ; Exit
0070                       ;-------------------------------------------------------
0071               pane.action.colorscheme.cycle.exit:
0072 728C C139  30         mov   *stack+,tmp0          ; Pop tmp0
0073 728E C2F9  30         mov   *stack+,r11           ; Pop R11
0074 7290 045B  20         b     *r11                  ; Return to caller
0075               
0076               
0077               
0078               ***************************************************************
...
0097 7292 0649  14         dect  stack
0098 7294 C64B  30         mov   r11,*stack            ; Save return address
0099 7296 0649  14         dect  stack
0100 7298 C644  30         mov   tmp0,*stack           ; Push tmp0
0101 729A 0649  14         dect  stack
0102 729C C645  30         mov   tmp1,*stack           ; Push tmp1
0103 729E 0649  14         dect  stack
0104 72A0 C646  30         mov   tmp2,*stack           ; Push tmp2
0105 72A2 0649  14         dect  stack
0106 72A4 C647  30         mov   tmp3,*stack           ; Push tmp3
0107 72A6 0649  14         dect  stack
0108 72A8 C648  30         mov   tmp4,*stack           ; Push tmp4
0109 72AA 0649  14         dect  stack
0110 72AC C660  46         mov   @parm1,*stack         ; Push parm1
     72AE A000     
0111 72B0 0649  14         dect  stack
0112 72B2 C660  46         mov   @parm2,*stack         ; Push parm2
     72B4 A002     
0113 72B6 0649  14         dect  stack
0114 72B8 C660  46         mov   @parm3,*stack         ; Push parm3
     72BA A004     
0115                       ;-------------------------------------------------------
0116                       ; Turn screen off
0117                       ;-------------------------------------------------------
0118 72BC C120  34         mov   @parm1,tmp0
     72BE A000     
0119 72C0 0284  22         ci    tmp0,>ffff            ; Skip flag set?
     72C2 FFFF     
0120 72C4 1302  14         jeq   !                     ; Yes, so skip screen off
0121 72C6 06A0  32         bl    @scroff               ; Turn screen off
     72C8 269A     
0122                       ;-------------------------------------------------------
0123                       ; Get FG/BG colors framebuffer text
0124                       ;-------------------------------------------------------
0125 72CA C120  34 !       mov   @tv.colorscheme,tmp0  ; Get color scheme index
     72CC A212     
0126 72CE 0604  14         dec   tmp0                  ; Internally work with base 0
0127               
0128 72D0 0A34  56         sla   tmp0,3                ; Offset into color scheme data table
0129 72D2 0224  22         ai    tmp0,tv.colorscheme.table
     72D4 35FC     
0130                                                   ; Add base for color scheme data table
0131 72D6 C1F4  30         mov   *tmp0+,tmp3           ; Get colors ABCD
0132 72D8 C807  38         mov   tmp3,@tv.color        ; Save colors ABCD
     72DA A218     
0133                       ;-------------------------------------------------------
0134                       ; Get and save cursor color
0135                       ;-------------------------------------------------------
0136 72DC C214  26         mov   *tmp0,tmp4            ; Get colors EFGH
0137 72DE 0248  22         andi  tmp4,>00ff            ; Only keep LSB (GH)
     72E0 00FF     
0138 72E2 C808  38         mov   tmp4,@tv.curcolor     ; Save cursor color
     72E4 A216     
0139                       ;-------------------------------------------------------
0140                       ; Get FG/BG colors framebuffer marked text & CMDB pane
0141                       ;-------------------------------------------------------
0142 72E6 C234  30         mov   *tmp0+,tmp4           ; Get colors EFGH again
0143 72E8 0248  22         andi  tmp4,>ff00            ; Only keep MSB (EF)
     72EA FF00     
0144 72EC 0988  56         srl   tmp4,8                ; MSB to LSB
0145               
0146 72EE C174  30         mov   *tmp0+,tmp1           ; Get colors IJKL
0147 72F0 C185  18         mov   tmp1,tmp2             ; \ Right align IJ and
0148 72F2 0986  56         srl   tmp2,8                ; | save to @tv.busycolor
0149 72F4 C806  38         mov   tmp2,@tv.busycolor    ; /
     72F6 A21C     
0150               
0151 72F8 0245  22         andi  tmp1,>00ff            ; | save KL to @tv.markcolor
     72FA 00FF     
0152 72FC C805  38         mov   tmp1,@tv.markcolor    ; /
     72FE A21A     
0153               
0154 7300 C154  26         mov   *tmp0,tmp1            ; Get colors MNOP
0155 7302 0985  56         srl   tmp1,8                ; \ Right align MN and
0156 7304 C805  38         mov   tmp1,@tv.cmdb.hcolor  ; / save to @tv.cmdb.hcolor
     7306 A220     
0157                       ;-------------------------------------------------------
0158                       ; Check if only CMDB needs to be colorized
0159                       ;-------------------------------------------------------
0160 7308 8820  54         c     @parm3,@w$ffff        ; Only colorize CMDB pane ?
     730A A004     
     730C 2022     
0161 730E 133E  14         jeq   pane.action.colorscheme.cmdbpane
0162                                                   ; Yes, shortcut jump to CMDB pane
0163                       ;-------------------------------------------------------
0164                       ; Get FG color for ruler
0165                       ;-------------------------------------------------------
0166 7310 C154  26         mov   *tmp0,tmp1            ; Get colors MNOP
0167 7312 0245  22         andi  tmp1,>000f            ; Only keep P
     7314 000F     
0168 7316 0A45  56         sla   tmp1,4                ; Make it a FG/BG combination
0169 7318 C805  38         mov   tmp1,@tv.rulercolor   ; Save to @tv.rulercolor
     731A A21E     
0170                       ;-------------------------------------------------------
0171                       ; Write sprite color of line and column indicators to SAT
0172                       ;-------------------------------------------------------
0173 731C C154  26         mov   *tmp0,tmp1            ; Get colors MNOP
0174 731E 0245  22         andi  tmp1,>00f0            ; Only keep O
     7320 00F0     
0175 7322 0A45  56         sla   tmp1,4                ; Move O to MSB
0176 7324 D805  38         movb  tmp1,@ramsat+7        ; Line indicator FG color to SAT
     7326 A043     
0177 7328 D805  38         movb  tmp1,@ramsat+11       ; Column indicator FG color to SAT
     732A A047     
0178                       ;-------------------------------------------------------
0179                       ; Dump colors to VDP register 7 (text mode)
0180                       ;-------------------------------------------------------
0181 732C C147  18         mov   tmp3,tmp1             ; Get work copy
0182 732E 0985  56         srl   tmp1,8                ; MSB to LSB (frame buffer colors)
0183 7330 0265  22         ori   tmp1,>0700
     7332 0700     
0184 7334 C105  18         mov   tmp1,tmp0
0185 7336 06A0  32         bl    @putvrx               ; Write VDP register
     7338 2348     
0186                       ;-------------------------------------------------------
0187                       ; Dump colors for frame buffer pane (TAT)
0188                       ;-------------------------------------------------------
0189 733A C120  34         mov   @tv.ruler.visible,tmp0
     733C A210     
0190 733E 130A  14         jeq   pane.action.colorscheme.fbdump.noruler
0191               
0192 7340 C120  34         mov   @cmdb.dialog,tmp0
     7342 A71A     
0193 7344 0284  22         ci    tmp0,id.dialog.help   ; Help dialog active?
     7346 0068     
0194 7348 1305  14         jeq   pane.action.colorscheme.fbdump.noruler
0195                                                   ; Yes, skip ruler
0196                       ;-------------------------------------------------------
0197                       ; Ruler visible on screen (TAT)
0198                       ;-------------------------------------------------------
0199 734A 0204  20         li    tmp0,vdp.fb.toprow.tat+80
     734C 18A0     
0200                                                   ; VDP start address (frame buffer area)
0201               
0202 734E 0206  20         li    tmp2,(pane.botrow-2)*80
     7350 0690     
0203                                                   ; Number of bytes to fill
0204 7352 1004  14         jmp   pane.action.colorscheme.checkcmdb
0205               
0206               pane.action.colorscheme.fbdump.noruler:
0207                       ;-------------------------------------------------------
0208                       ; No ruler visible on screen (TAT)
0209                       ;-------------------------------------------------------
0210 7354 0204  20         li    tmp0,vdp.fb.toprow.tat
     7356 1850     
0211                                                   ; VDP start address (frame buffer area)
0212 7358 0206  20         li    tmp2,(pane.botrow-1)*80
     735A 06E0     
...
0218 735C C820  54         mov   @cmdb.visible,@cmdb.visible
     735E A702     
     7360 A702     
0219 7362 1302  14         jeq   pane.action.colorscheme.fbdump
0220                                                   ; Not visible, skip adjustment
0221 7364 0226  22         ai    tmp2,-320             ; CMDB adjustment
     7366 FEC0     
0222                       ;-------------------------------------------------------
0223                       ; Dump colors to VDP (TAT)
0224                       ;-------------------------------------------------------
0225               pane.action.colorscheme.fbdump:
0226 7368 C147  18         mov   tmp3,tmp1             ; Get work copy of colors ABCD
0227 736A 0985  56         srl   tmp1,8                ; MSB to LSB (frame buffer colors)
0228               
0229 736C 06A0  32         bl    @xfilv                ; Fill colors
     736E 22A8     
...
0235                       ;-------------------------------------------------------
0236 7370 C120  34         mov   @cmdb.dialog,tmp0
     7372 A71A     
0237 7374 0284  22         ci    tmp0,id.dialog.help   ; Help dialog active?
     7376 0068     
0238 7378 1309  14         jeq   pane.action.colorscheme.cmdbpane
0239                                                   ; Yes, skip marked lines
0240               
0241 737A C120  34         mov   @parm2,tmp0
     737C A002     
0242 737E 0284  22         ci    tmp0,>ffff            ; Skip colorize flag is on?
     7380 FFFF     
0243 7382 1304  14         jeq   pane.action.colorscheme.cmdbpane
0244               
0245 7384 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     7386 A310     
0246 7388 06A0  32         bl    @fb.colorlines
     738A 7A76     
0247                       ;-------------------------------------------------------
0248                       ; Dump colors for CMDB header line (TAT)
0249                       ;-------------------------------------------------------
0250               pane.action.colorscheme.cmdbpane:
0251 738C C120  34         mov   @cmdb.visible,tmp0
     738E A702     
0252 7390 1330  14         jeq   pane.action.colorscheme.errpane
0253                                                   ; Skip if CMDB pane is hidden
0254               
0255 7392 0204  20         li    tmp0,vdp.cmdb.toprow.tat
     7394 1DF0     
0256                                                   ; VDP start address (CMDB top line)
0257               
0258 7396 C160  34         mov   @tv.cmdb.hcolor,tmp1  ; set color for header line
     7398 A220     
0259 739A 0206  20         li    tmp2,1*67             ; Number of bytes to fill
     739C 0043     
0260 739E 06A0  32         bl    @xfilv                ; Fill colors
     73A0 22A8     
...
0266                       ;-------------------------------------------------------
0267 73A2 0204  20         li    tmp0,vdp.cmdb.toprow.tat+67
     73A4 1E33     
0268 73A6 C160  34         mov   @tv.cmdb.hcolor,tmp1  ;
     73A8 A220     
0269 73AA D160  34         movb  @tv.cmdb.hcolor+1,tmp1
     73AC A221     
0270                                                   ; Copy same value into MSB
0271 73AE 0945  56         srl   tmp1,4                ;
0272 73B0 0245  22         andi  tmp1,>00ff            ; Only keep LSB
     73B2 00FF     
0273               
0274 73B4 0206  20         li    tmp2,13               ; Number of bytes to fill
     73B6 000D     
0275 73B8 06A0  32         bl    @xfilv                ; Fill colors
     73BA 22A8     
...
0281                       ;-------------------------------------------------------
0282 73BC 0204  20         li    tmp0,vdp.cmdb.toprow.tat + 80
     73BE 1E40     
0283                                                   ; VDP start address (CMDB top line + 1)
0284 73C0 C148  18         mov   tmp4,tmp1             ; Get work copy fg/bg color
0285 73C2 0206  20         li    tmp2,1*80             ; Number of bytes to fill
     73C4 0050     
0286 73C6 06A0  32         bl    @xfilv                ; Fill colors
     73C8 22A8     
0287                                                   ; i \  tmp0 = start address
0288                                                   ; i |  tmp1 = byte to fill
0289                                                   ; i /  tmp2 = number of bytes to fill
0290               
0291 73CA 0204  20         li    tmp0,vdp.cmdb.toprow.tat + 160
     73CC 1E90     
0292                                                   ; VDP start address (CMDB top line + 2)
0293 73CE C160  34         mov   @tv.cmdb.hcolor,tmp1  ; Same color as header line
     73D0 A220     
0294 73D2 0206  20         li    tmp2,1*80             ; Number of bytes to fill
     73D4 0050     
0295 73D6 06A0  32         bl    @xfilv                ; Fill colors
     73D8 22A8     
0296                                                   ; i \  tmp0 = start address
0297                                                   ; i |  tmp1 = byte to fill
0298                                                   ; i /  tmp2 = number of bytes to fill
0299               
0300 73DA 0204  20         li    tmp0,vdp.cmdb.toprow.tat + 240
     73DC 1EE0     
0301                                                   ; VDP start address (CMDB top line + 3)
0302 73DE C148  18         mov   tmp4,tmp1             ; Get work copy fg/bg color
0303 73E0 0206  20         li    tmp2,1*80             ; Number of bytes to fill
     73E2 0050     
0304 73E4 06A0  32         bl    @xfilv                ; Fill colors
     73E6 22A8     
...
0310                       ;-------------------------------------------------------
0311 73E8 C120  34         mov   @parm3,tmp0
     73EA A004     
0312 73EC 0284  22         ci    tmp0,>ffff            ; Only colorize CMDB pane ?
     73EE FFFF     
0313 73F0 132F  14         jeq   pane.action.colorscheme.cursorcolor.cmdb
0314                                                   ; Yes, shortcut to CMDB cursor color
0315                       ;-------------------------------------------------------
0316                       ; Dump colors for error pane (TAT)
0317                       ;-------------------------------------------------------
0318               pane.action.colorscheme.errpane:
0319 73F2 C120  34         mov   @tv.error.visible,tmp0
     73F4 A228     
0320 73F6 1306  14         jeq   pane.action.colorscheme.statline
0321                                                   ; Skip if error pane is hidden
0322               
0323 73F8 0205  20         li    tmp1,>00f6            ; White on dark red
     73FA 00F6     
0324 73FC C805  38         mov   tmp1,@parm1           ; Pass color combination
     73FE A000     
0325               
0326 7400 06A0  32         bl    @pane.errline.drawcolor
     7402 75E4     
...
0334 7404 C160  34         mov   @tv.color,tmp1
     7406 A218     
0335 7408 0245  22         andi  tmp1,>00ff            ; Only keep LSB (status line colors)
     740A 00FF     
0336 740C C805  38         mov   tmp1,@parm1           ; Set color combination
     740E A000     
0337               
0338               
0339 7410 04E0  34         clr   @parm2                ; Top row on screen
     7412 A002     
0340 7414 06A0  32         bl    @colors.line.set      ; Load color combination for line
     7416 74D8     
0341                                                   ; \ i  @parm1 = Color combination
0342                                                   ; / i  @parm2 = Row on physical screen
0343               
0344 7418 0205  20         li    tmp1,pane.botrow
     741A 0017     
0345 741C C805  38         mov   tmp1,@parm2           ; Bottom row on screen
     741E A002     
0346 7420 06A0  32         bl    @colors.line.set      ; Load color combination for line
     7422 74D8     
...
0351                       ;-------------------------------------------------------
0352 7424 C160  34         mov   @cmdb.dialog,tmp1
     7426 A71A     
0353 7428 0285  22         ci    tmp1,id.dialog.help   ; Help dialog active?
     742A 0068     
0354 742C 130A  14         jeq   pane.action.colorscheme.cursorcolor
0355                                                   ; Yes, skip ruler
0356               
0357 742E C160  34         mov   @tv.ruler.visible,tmp1
     7430 A210     
0358 7432 1307  14         jeq   pane.action.colorscheme.cursorcolor
0359               
0360 7434 06A0  32         bl    @fb.ruler.init        ; Setup ruler with tab-positions in memory
     7436 7A64     
0361 7438 06A0  32         bl    @cpym2v
     743A 249A     
0362 743C 1850                   data vdp.fb.toprow.tat
0363 743E A36E                   data fb.ruler.tat
0364 7440 0050                   data 80               ; Show ruler colors
0365                       ;-------------------------------------------------------
0366                       ; Dump cursor FG color to sprite table (SAT)
0367                       ;-------------------------------------------------------
0368               pane.action.colorscheme.cursorcolor:
0369 7442 C220  34         mov   @tv.curcolor,tmp4     ; Get cursor color
     7444 A216     
0370               
0371 7446 C120  34         mov   @tv.pane.focus,tmp0   ; Get pane with focus
     7448 A222     
0372 744A 0284  22         ci    tmp0,pane.focus.fb    ; Frame buffer has focus?
     744C 0000     
0373 744E 1304  14         jeq   pane.action.colorscheme.cursorcolor.fb
0374                                                   ; Yes, set cursor color
0375               
0376               pane.action.colorscheme.cursorcolor.cmdb:
0377 7450 0248  22         andi  tmp4,>f0              ; Only keep high-nibble -> Word 2 (G)
     7452 00F0     
0378 7454 0A48  56         sla   tmp4,4                ; Move to MSB
0379 7456 1003  14         jmp   !
0380               
0381               pane.action.colorscheme.cursorcolor.fb:
0382 7458 0248  22         andi  tmp4,>0f              ; Only keep low-nibble -> Word 2 (H)
     745A 000F     
0383 745C 0A88  56         sla   tmp4,8                ; Move to MSB
0384               
0385 745E D808  38 !       movb  tmp4,@ramsat+3        ; Update FG color in sprite table (SAT)
     7460 A03F     
0386 7462 D808  38         movb  tmp4,@tv.curshape+1   ; Save cursor color
     7464 A215     
0387                       ;-------------------------------------------------------
0388                       ; Exit
0389                       ;-------------------------------------------------------
0390               pane.action.colorscheme.load.exit:
0391 7466 06A0  32         bl    @scron                ; Turn screen on
     7468 26A2     
0392 746A C839  50         mov   *stack+,@parm3        ; Pop @parm3
     746C A004     
0393 746E C839  50         mov   *stack+,@parm2        ; Pop @parm2
     7470 A002     
0394 7472 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     7474 A000     
0395 7476 C239  30         mov   *stack+,tmp4          ; Pop tmp4
0396 7478 C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0397 747A C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0398 747C C179  30         mov   *stack+,tmp1          ; Pop tmp1
0399 747E C139  30         mov   *stack+,tmp0          ; Pop tmp0
0400 7480 C2F9  30         mov   *stack+,r11           ; Pop R11
0401 7482 045B  20         b     *r11                  ; Return to caller
0402               
0403               
0404               
0405               ***************************************************************
...
0421 7484 0649  14         dect  stack
0422 7486 C64B  30         mov   r11,*stack            ; Save return address
0423 7488 0649  14         dect  stack
0424 748A C644  30         mov   tmp0,*stack           ; Push tmp0
0425                       ;------------------------------------------------------
0426                       ; Bottom line
0427                       ;------------------------------------------------------
0428 748C 0204  20         li    tmp0,pane.botrow
     748E 0017     
0429 7490 C804  38         mov   tmp0,@parm2           ; Last row on screen
     7492 A002     
0430 7494 06A0  32         bl    @colors.line.set      ; Load color combination for line
     7496 74D8     
...
0437 7498 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0438 749A C2F9  30         mov   *stack+,r11           ; Pop R11
0439 749C 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.27722
...
0023                       ; Hide cursor
0024                       ;-------------------------------------------------------
0025 74A2 06A0  32         bl    @filv                 ; Clear sprite SAT in VDP RAM
     74A4 22A2     
0026 74A6 2180                   data sprsat,>00,8     ; \ i  p0 = VDP destination
     74A8 0000     
     74AA 0008     
0027                                                   ; | i  p1 = Byte to write
0028                                                   ; / i  p2 = Number of bytes to write
0029               
0030 74AC 06A0  32         bl    @clslot
     74AE 2EC2     
0031 74B0 0001                   data 1                ; Terminate task.vdp.copy.sat
0032               
0033 74B2 06A0  32         bl    @clslot
     74B4 2EC2     
0034 74B6 0002                   data 2                ; Terminate task.vdp.cursor
0035                       ;-------------------------------------------------------
0036                       ; Exit
0037                       ;-------------------------------------------------------
0038               pane.cursor.hide.exit:
0039 74B8 C2F9  30         mov   *stack+,r11           ; Pop R11
0040 74BA 045B  20         b     *r11                  ; Return to caller
0041               
0042               
0043               
0044               ***************************************************************
...
0060 74BC 0649  14         dect  stack
0061 74BE C64B  30         mov   r11,*stack            ; Save return address
0062                       ;-------------------------------------------------------
0063                       ; Hide cursor
0064                       ;-------------------------------------------------------
0065 74C0 06A0  32         bl    @filv                 ; Clear sprite SAT in VDP RAM
     74C2 22A2     
0066 74C4 2180                   data sprsat,>00,4     ; \ i  p0 = VDP destination
     74C6 0000     
     74C8 0004     
...
0069               
0078               
0079 74CA 06A0  32         bl    @mkslot
     74CC 2EA4     
0080 74CE 020F                   data >020f,task.vdp.cursor   ; Task 2 - Toggle cursor shape
     74D0 7192     
0081 74D2 FFFF                   data eol
0082               
0084               
0085                       ;-------------------------------------------------------
0086                       ; Exit
...
0089 74D4 C2F9  30         mov   *stack+,r11           ; Pop R11
0090 74D6 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.27722
0133                       ;-----------------------------------------------------------------------
0134                       ; Screen panes
0135                       ;-----------------------------------------------------------------------
...
0021 74D8 0649  14         dect  stack
0022 74DA C64B  30         mov   r11,*stack            ; Save return address
0023 74DC 0649  14         dect  stack
0024 74DE C644  30         mov   tmp0,*stack           ; Push tmp0
0025 74E0 0649  14         dect  stack
0026 74E2 C645  30         mov   tmp1,*stack           ; Push tmp1
0027 74E4 0649  14         dect  stack
0028 74E6 C646  30         mov   tmp2,*stack           ; Push tmp2
0029 74E8 0649  14         dect  stack
0030 74EA C660  46         mov   @parm1,*stack         ; Push parm1
     74EC A000     
0031 74EE 0649  14         dect  stack
0032 74F0 C660  46         mov   @parm2,*stack         ; Push parm2
     74F2 A002     
0033                       ;-------------------------------------------------------
0034                       ; Dump colors for line in TAT
0035                       ;-------------------------------------------------------
0036 74F4 C120  34         mov   @parm2,tmp0           ; Get target line
     74F6 A002     
0037 74F8 0205  20         li    tmp1,colrow           ; Columns per row (spectra2)
     74FA 0050     
0038 74FC 3944  56         mpy   tmp0,tmp1             ; Calculate VDP address (results in tmp2!)
0039               
0040 74FE C106  18         mov   tmp2,tmp0             ; Set VDP start address
0041 7500 0224  22         ai    tmp0,vdp.tat.base     ; Add TAT base address
     7502 1800     
0042 7504 C160  34         mov   @parm1,tmp1           ; Get foreground/background color
     7506 A000     
0043 7508 0206  20         li    tmp2,80               ; Number of bytes to fill
     750A 0050     
0044               
0045 750C 06A0  32         bl    @xfilv                ; Fill colors
     750E 22A8     
...
0053 7510 C839  50         mov   *stack+,@parm2        ; Pop @parm2
     7512 A002     
0054 7514 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     7516 A000     
0055 7518 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0056 751A C179  30         mov   *stack+,tmp1          ; Pop tmp1
0057 751C C139  30         mov   *stack+,tmp0          ; Pop tmp0
0058 751E C2F9  30         mov   *stack+,r11           ; Pop R11
0059 7520 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.27722
...
0015               ********|*****|*********************|**************************
0016               pane.topline:
0017 7522 0649  14         dect  stack
0018 7524 C64B  30         mov   r11,*stack            ; Save return address
0019 7526 0649  14         dect  stack
0020 7528 C644  30         mov   tmp0,*stack           ; Push tmp0
0021 752A 0649  14         dect  stack
0022 752C C660  46         mov   @wyx,*stack           ; Push cursor position
     752E 832A     
0023                       ;------------------------------------------------------
0024                       ; Show current file
0025                       ;------------------------------------------------------
0026               pane.topline.file:
0027 7530 06A0  32         bl    @at
     7532 26DA     
0028 7534 0000                   byte 0,0              ; y=0, x=0
0029               
0030 7536 C820  54         mov   @edb.filename.ptr,@parm1
     7538 A512     
     753A A000     
0031                                                   ; Get string to display
0032 753C 0204  20         li    tmp0,47
     753E 002F     
0033 7540 C804  38         mov   tmp0,@parm2           ; Set requested length
     7542 A002     
0034 7544 0204  20         li    tmp0,32
     7546 0020     
0035 7548 C804  38         mov   tmp0,@parm3           ; Set character to fill
     754A A004     
0036 754C 0204  20         li    tmp0,rambuf
     754E A100     
0037 7550 C804  38         mov   tmp0,@parm4           ; Set pointer to buffer for output string
     7552 A006     
0038               
0039               
0040 7554 06A0  32         bl    @tv.pad.string        ; Pad string to specified length
     7556 32D6     
...
0045                                                   ; /             output string
0046               
0047 7558 C160  34         mov   @outparm1,tmp1        ; \ Display padded filename
     755A A010     
0048 755C 06A0  32         bl    @xutst0               ; /
     755E 2434     
0049                       ;------------------------------------------------------
0050                       ; Show if text was changed in editor buffer
0051                       ;------------------------------------------------------
0052               pane.topline.show_dirty:
0053 7560 C120  34         mov   @edb.dirty,tmp0
     7562 A506     
0054 7564 1305  14         jeq   pane.topline.nochange
0055                       ;------------------------------------------------------
0056                       ; Show "*"
0057                       ;------------------------------------------------------
0058 7566 06A0  32         bl    @putat
     7568 2456     
0059 756A 004F                   byte 0,79             ; y=0, x=79
0060 756C 3670                   data txt.star
0061 756E 1004  14         jmp   pane.topline.showmarkers
0062                       ;------------------------------------------------------
0063                       ; Show " "
0064                       ;------------------------------------------------------
0065               pane.topline.nochange:
0066 7570 06A0  32         bl    @putat
     7572 2456     
0067 7574 004F                   byte 0,79             ; y=0, x=79
0068 7576 388C                   data txt.ws1          ; Single white space
0069                       ;------------------------------------------------------
0070                       ; Check if M1/M2 markers need to be shown
0071                       ;------------------------------------------------------
0072               pane.topline.showmarkers:
0073 7578 C120  34         mov   @edb.block.m1,tmp0    ; \
     757A A50C     
0074 757C 0284  22         ci    tmp0,>ffff            ; | Exit early if M1 unset (>ffff)
     757E FFFF     
0075 7580 132C  14         jeq   pane.topline.exit     ; /
0076               
0077 7582 C120  34         mov   @tv.task.oneshot,tmp0 ; \
     7584 A224     
0078 7586 0284  22         ci    tmp0,pane.topline.oneshot.clearmsg
     7588 35B0     
0079                                                   ; | Exit early if overlay message visible
0080 758A 1327  14         jeq   pane.topline.exit     ; /
0081                       ;------------------------------------------------------
0082                       ; Show M1 marker
0083                       ;------------------------------------------------------
0084 758C 06A0  32         bl    @putat
     758E 2456     
0085 7590 0034                   byte 0,52
0086 7592 37EC                   data txt.m1           ; Show M1 marker message
0087               
0088 7594 C820  54         mov   @edb.block.m1,@parm1
     7596 A50C     
     7598 A000     
0089 759A 06A0  32         bl    @tv.unpack.uint16     ; Unpack 16 bit unsigned integer to string
     759C 32AA     
0090                                                   ; \ i @parm1           = uint16
0091                                                   ; / o @unpacked.string = Output string
0092               
0093 759E 0204  20         li    tmp0,>0500
     75A0 0500     
0094 75A2 D804  38         movb  tmp0,@unpacked.string ; Set string length to 5 (padding)
     75A4 A026     
0095               
0096 75A6 06A0  32         bl    @putat
     75A8 2456     
0097 75AA 0037                   byte 0,55
0098 75AC A026                   data unpacked.string  ; Show M1 value
0099                       ;------------------------------------------------------
0100                       ; Show M2 marker
0101                       ;------------------------------------------------------
0102 75AE C120  34         mov   @edb.block.m2,tmp0    ; \
     75B0 A50E     
0103 75B2 0284  22         ci    tmp0,>ffff            ; | Exit early if M2 unset (>ffff)
     75B4 FFFF     
0104 75B6 1311  14         jeq   pane.topline.exit     ; /
0105               
0106 75B8 06A0  32         bl    @putat
     75BA 2456     
0107 75BC 003E                   byte 0,62
0108 75BE 37F0                   data txt.m2           ; Show M2 marker message
0109               
0110 75C0 C820  54         mov   @edb.block.m2,@parm1
     75C2 A50E     
     75C4 A000     
0111 75C6 06A0  32         bl    @tv.unpack.uint16     ; Unpack 16 bit unsigned integer to string
     75C8 32AA     
0112                                                   ; \ i @parm1           = uint16
0113                                                   ; / o @unpacked.string = Output string
0114               
0115 75CA 0204  20         li    tmp0,>0500
     75CC 0500     
0116 75CE D804  38         movb  tmp0,@unpacked.string ; Set string length to 5 (padding)
     75D0 A026     
0117               
0118 75D2 06A0  32         bl    @putat
     75D4 2456     
0119 75D6 0041                   byte 0,65
0120 75D8 A026                   data unpacked.string  ; Show M2 value
0121                       ;------------------------------------------------------
0122                       ; Exit
0123                       ;------------------------------------------------------
0124               pane.topline.exit:
0125 75DA C839  50         mov   *stack+,@wyx          ; Pop cursor position
     75DC 832A     
0126 75DE C139  30         mov   *stack+,tmp0          ; Pop tmp0
0127 75E0 C2F9  30         mov   *stack+,r11           ; Pop r11
0128 75E2 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.27722
...
0023 75E4 0649  14         dect  stack
0024 75E6 C64B  30         mov   r11,*stack            ; Save return address
0025 75E8 0649  14         dect  stack
0026 75EA C644  30         mov   tmp0,*stack           ; Push tmp0
0027 75EC 0649  14         dect  stack
0028 75EE C645  30         mov   tmp1,*stack           ; Push tmp1
0029 75F0 0649  14         dect  stack
0030 75F2 C646  30         mov   tmp2,*stack           ; Push tmp2
0031                       ;-------------------------------------------------------
0032                       ; Determine 1st row in error pane
0033                       ;-------------------------------------------------------
0034 75F4 0204  20         li    tmp0,pane.botrow      ; Get rows on screen
     75F6 0017     
0035 75F8 C144  18         mov   tmp0,tmp1             ; \ Get first row in error pane
0036 75FA 6160  34         s     @tv.error.rows,tmp1   ; /
     75FC A22A     
0037                       ;-------------------------------------------------------
0038                       ; Dump colors for row
0039                       ;-------------------------------------------------------
0040               pane.errline.drawcolor.loop:
0041 75FE C805  38         mov   tmp1,@parm2           ; Row on physical screen
     7600 A002     
0042               
0043 7602 06A0  32         bl    @colors.line.set      ; Load color combination for line
     7604 74D8     
0044                                                   ; \ i  @parm1 = Color combination
0045                                                   ; / i  @parm2 = Row on physical screen
0046               
0047 7606 0585  14         inc   tmp1                  ; Next row
0048 7608 8105  18         c     tmp1,tmp0             ; Last row reached?
0049 760A 11F9  14         jlt   pane.errline.drawcolor.loop
0050                                                   ; Not yet, next iteration
0051                       ;-------------------------------------------------------
0052                       ; Exit
0053                       ;-------------------------------------------------------
0054               pane.errline.drawcolor.exit:
0055 760C C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0056 760E C179  30         mov   *stack+,tmp1          ; Pop tmp1
0057 7610 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0058 7612 C2F9  30         mov   *stack+,r11           ; Pop R11
0059 7614 045B  20         b     *r11                  ; Return to caller
0060               
0061               
0062               
0063               
...
0082 7616 0649  14         dect  stack
0083 7618 C64B  30         mov   r11,*stack            ; Save return address
0084 761A 0649  14         dect  stack
0085 761C C644  30         mov   tmp0,*stack           ; Push tmp0
0086 761E 0649  14         dect  stack
0087 7620 C645  30         mov   tmp1,*stack           ; Push tmp1
0088               
0089 7622 0205  20         li    tmp1,>00f6            ; White on dark red
     7624 00F6     
0090 7626 C805  38         mov   tmp1,@parm1
     7628 A000     
0091               
0092 762A 06A0  32         bl    @pane.errline.drawcolor
     762C 75E4     
...
0098                       ;------------------------------------------------------
0099 762E 0204  20         li    tmp0,tv.error.msg
     7630 A22E     
0100 7632 C804  38         mov   tmp0,@parm1           ; Get pointer to string
     7634 A000     
0101               
0102 7636 0204  20         li    tmp0,240
     7638 00F0     
0103 763A C804  38         mov   tmp0,@parm2           ; Set requested length
     763C A002     
0104               
0105 763E 0204  20         li    tmp0,32
     7640 0020     
0106 7642 C804  38         mov   tmp0,@parm3           ; Set character to fill
     7644 A004     
0107               
0108 7646 0204  20         li    tmp0,rambuf
     7648 A100     
0109 764A C804  38         mov   tmp0,@parm4           ; Set pointer to buffer for output string
     764C A006     
0110               
0111 764E 06A0  32         bl    @tv.pad.string        ; Pad string to specified length
     7650 32D6     
...
0119                       ;------------------------------------------------------
0120 7652 06A0  32         bl    @at
     7654 26DA     
0121 7656 1400                   byte pane.botrow-3,0  ; Set cursor
0122               
0123 7658 C160  34         mov   @outparm1,tmp1        ; \ Display error message
     765A A010     
0124 765C 06A0  32         bl    @xutst0               ; /
     765E 2434     
0125               
0126 7660 C120  34         mov   @fb.scrrows.max,tmp0  ; \
     7662 A31C     
0127 7664 6120  34         s     @tv.error.rows,tmp0   ; | Adjust number of rows in frame buffer
     7666 A22A     
0128 7668 C804  38         mov   tmp0,@fb.scrrows      ; /
     766A A31A     
0129               
0130 766C 0720  34         seto  @tv.error.visible     ; Error line is visible
     766E A228     
0131                       ;------------------------------------------------------
0132                       ; Exit
0133                       ;------------------------------------------------------
0134               pane.errline.show.exit:
0135 7670 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0136 7672 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0137 7674 C2F9  30         mov   *stack+,r11           ; Pop r11
0138 7676 045B  20         b     *r11                  ; Return to caller
0139               
0140               
0141               
0142               ***************************************************************
...
0160 7678 0649  14         dect  stack
0161 767A C64B  30         mov   r11,*stack            ; Save return address
0162 767C 0649  14         dect  stack
0163 767E C644  30         mov   tmp0,*stack           ; Push tmp0
0164                       ;------------------------------------------------------
0165                       ; Get color combination
0166                       ;------------------------------------------------------
0167 7680 06A0  32         bl    @errpane.init         ; Clear error line string in RAM
     7682 31FC     
0168               
0169 7684 C120  34         mov   @cmdb.visible,tmp0
     7686 A702     
0170 7688 1303  14         jeq   pane.errline.hide.fbcolor
0171                       ;------------------------------------------------------
0172                       ; CMDB pane color
0173                       ;------------------------------------------------------
0174 768A C120  34         mov   @tv.cmdb.hcolor,tmp0  ; Get colors of CMDB header line
     768C A220     
0175 768E 1003  14         jmp   !
0176                       ;------------------------------------------------------
0177                       ; Frame buffer color
0178                       ;------------------------------------------------------
0179               pane.errline.hide.fbcolor:
0180 7690 C120  34         mov   @tv.color,tmp0        ; Get colors
     7692 A218     
0181 7694 0984  56         srl   tmp0,8                ; Get rid of status line colors
0182                       ;------------------------------------------------------
0183                       ; Dump colors
0184                       ;------------------------------------------------------
0185 7696 C804  38 !       mov   tmp0,@parm1           ; set foreground/background color
     7698 A000     
0186               
0187 769A 06A0  32         bl    @pane.errline.drawcolor
     769C 75E4     
0188                                                   ; Draw color on rows in error pane
0189                                                   ; \ i  @tv.error.rows = Number of rows
0190                                                   ; / i  @parm1         = Color combination
0191               
0192 769E 04E0  34         clr   @tv.error.visible     ; Error line no longer visible
     76A0 A228     
0193 76A2 C820  54         mov   @fb.scrrows.max,@fb.scrrows
     76A4 A31C     
     76A6 A31A     
...
0199 76A8 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0200 76AA C2F9  30         mov   *stack+,r11           ; Pop r11
0201 76AC 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.27722
...
0015               ********|*****|*********************|**************************
0016               pane.botline:
0017 76AE 0649  14         dect  stack
0018 76B0 C64B  30         mov   r11,*stack            ; Save return address
0019 76B2 0649  14         dect  stack
0020 76B4 C644  30         mov   tmp0,*stack           ; Push tmp0
0021 76B6 0649  14         dect  stack
0022 76B8 C660  46         mov   @wyx,*stack           ; Push cursor position
     76BA 832A     
0023                       ;------------------------------------------------------
0024                       ; Show block shortcuts if set
0025                       ;------------------------------------------------------
0026 76BC C120  34         mov   @edb.block.m2,tmp0    ; \
     76BE A50E     
0027 76C0 0584  14         inc   tmp0                  ; | Skip if M2 unset (>ffff)
0028                                                   ; /
0029 76C2 1305  14         jeq   pane.botline.show_keys
0030               
0031 76C4 06A0  32         bl    @putat
     76C6 2456     
0032 76C8 1700                   byte pane.botrow,0
0033 76CA 37FC                   data txt.keys.block   ; Show block shortcuts
0034               
0035 76CC 1004  14         jmp   pane.botline.show_mode
0036                       ;------------------------------------------------------
0037                       ; Show default message
0038                       ;------------------------------------------------------
0039               pane.botline.show_keys:
0040 76CE 06A0  32         bl    @putat
     76D0 2456     
0041 76D2 1700                   byte pane.botrow,0
0042 76D4 37F4                   data txt.keys.default ; Show default shortcuts
0043                       ;------------------------------------------------------
0044                       ; Show text editing mode
0045                       ;------------------------------------------------------
0046               pane.botline.show_mode:
0047 76D6 C120  34         mov   @edb.insmode,tmp0
     76D8 A50A     
0048 76DA 1605  14         jne   pane.botline.show_mode.insert
0049                       ;------------------------------------------------------
0050                       ; Overwrite mode
0051                       ;------------------------------------------------------
0052 76DC 06A0  32         bl    @putat
     76DE 2456     
0053 76E0 1737                   byte  pane.botrow,55
0054 76E2 3668                   data  txt.ovrwrite
0055 76E4 1004  14         jmp   pane.botline.show_linecol
0056                       ;------------------------------------------------------
0057                       ; Insert mode
0058                       ;------------------------------------------------------
0059               pane.botline.show_mode.insert:
0060 76E6 06A0  32         bl    @putat
     76E8 2456     
0061 76EA 1737                   byte  pane.botrow,55
0062 76EC 366C                   data  txt.insert
0063                       ;------------------------------------------------------
0064                       ; Show "line,column"
0065                       ;------------------------------------------------------
0066               pane.botline.show_linecol:
0067 76EE C820  54         mov   @fb.row,@parm1
     76F0 A306     
     76F2 A000     
0068 76F4 06A0  32         bl    @fb.row2line          ; Row to editor line
     76F6 6D40     
0069                                                   ; \ i @fb.topline = Top line in frame buffer
0070                                                   ; | i @parm1      = Row in frame buffer
0071                                                   ; / o @outparm1   = Matching line in EB
0072               
0073 76F8 05A0  34         inc   @outparm1             ; Add base 1
     76FA A010     
0074                       ;------------------------------------------------------
0075                       ; Show line
0076                       ;------------------------------------------------------
0077 76FC 06A0  32         bl    @putnum
     76FE 2A3C     
0078 7700 173B                   byte  pane.botrow,59  ; YX
0079 7702 A010                   data  outparm1,rambuf
     7704 A100     
0080 7706 30                     byte  48              ; ASCII offset
0081 7707   20                   byte  32              ; Padding character
0082                       ;------------------------------------------------------
0083                       ; Show comma
0084                       ;------------------------------------------------------
0085 7708 06A0  32         bl    @putat
     770A 2456     
0086 770C 1740                   byte  pane.botrow,64
0087 770E 3660                   data  txt.delim
0088                       ;------------------------------------------------------
0089                       ; Show column
0090                       ;------------------------------------------------------
0091 7710 06A0  32         bl    @film
     7712 224A     
0092 7714 A105                   data rambuf+5,32,12   ; Clear work buffer with space character
     7716 0020     
     7718 000C     
0093               
0094 771A C820  54         mov   @fb.column,@waux1
     771C A30C     
     771E 833C     
0095 7720 05A0  34         inc   @waux1                ; Offset 1
     7722 833C     
0096               
0097 7724 06A0  32         bl    @mknum                ; Convert unsigned number to string
     7726 29BE     
0098 7728 833C                   data  waux1,rambuf
     772A A100     
0099 772C 30                     byte  48              ; ASCII offset
0100 772D   20                   byte  32              ; Fill character
0101               
0102 772E 06A0  32         bl    @trimnum              ; Trim number to the left
     7730 2A16     
0103 7732 A100                   data  rambuf,rambuf+5,32
     7734 A105     
     7736 0020     
0104               
0105 7738 0204  20         li    tmp0,>0600            ; "Fix" number length to clear junk chars
     773A 0600     
0106 773C D804  38         movb  tmp0,@rambuf+5        ; Set length byte
     773E A105     
0107               
0108                       ;------------------------------------------------------
0109                       ; Decide if row length is to be shown
0110                       ;------------------------------------------------------
0111 7740 C120  34         mov   @fb.column,tmp0       ; \ Base 1 for comparison
     7742 A30C     
0112 7744 0584  14         inc   tmp0                  ; /
0113 7746 8804  38         c     tmp0,@fb.row.length   ; Check if cursor on last column on row
     7748 A308     
0114 774A 1101  14         jlt   pane.botline.show_linecol.linelen
0115 774C 102B  14         jmp   pane.botline.show_linecol.colstring
0116                                                   ; Yes, skip showing row length
0117                       ;------------------------------------------------------
0118                       ; Add ',' delimiter and length of line to string
0119                       ;------------------------------------------------------
0120               pane.botline.show_linecol.linelen:
0121 774E C120  34         mov   @fb.column,tmp0       ; \
     7750 A30C     
0122 7752 0205  20         li    tmp1,rambuf+7         ; | Determine column position for '-' char
     7754 A107     
0123 7756 0284  22         ci    tmp0,9                ; | based on number of digits in cursor X
     7758 0009     
0124 775A 1101  14         jlt   !                     ; | column.
0125 775C 0585  14         inc   tmp1                  ; /
0126               
0127 775E 0204  20 !       li    tmp0,>2f00            ; \ ASCII '/'
     7760 2F00     
0128 7762 DD44  32         movb  tmp0,*tmp1+           ; / Add delimiter to string
0129               
0130 7764 C805  38         mov   tmp1,@waux1           ; Backup position in ram buffer
     7766 833C     
0131               
0132 7768 06A0  32         bl    @mknum
     776A 29BE     
0133 776C A308                   data  fb.row.length,rambuf
     776E A100     
0134 7770 30                     byte  48              ; ASCII offset
0135 7771   20                   byte  32              ; Padding character
0136               
0137 7772 C160  34         mov   @waux1,tmp1           ; Restore position in ram buffer
     7774 833C     
0138               
0139 7776 C120  34         mov   @fb.row.length,tmp0   ; \ Get length of line
     7778 A308     
0140 777A 0284  22         ci    tmp0,10               ; /
     777C 000A     
0141 777E 110B  14         jlt   pane.botline.show_line.1digit
0142                       ;------------------------------------------------------
0143                       ; Assert
0144                       ;------------------------------------------------------
0145 7780 0284  22         ci    tmp0,80
     7782 0050     
0146 7784 1204  14         jle   pane.botline.show_line.2digits
0147                       ;------------------------------------------------------
0148                       ; Asserts failed
0149                       ;------------------------------------------------------
0150 7786 C80B  38 !       mov   r11,@>ffce            ; \ Save caller address
     7788 FFCE     
0151 778A 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     778C 2026     
0152                       ;------------------------------------------------------
0153                       ; Show length of line (2 digits)
0154                       ;------------------------------------------------------
0155               pane.botline.show_line.2digits:
0156 778E 0204  20         li    tmp0,rambuf+3
     7790 A103     
0157 7792 DD74  42         movb  *tmp0+,*tmp1+         ; 1st digit row length
0158 7794 1002  14         jmp   pane.botline.show_line.rest
0159                       ;------------------------------------------------------
0160                       ; Show length of line (1 digits)
0161                       ;------------------------------------------------------
0162               pane.botline.show_line.1digit:
0163 7796 0204  20         li    tmp0,rambuf+4
     7798 A104     
0164               pane.botline.show_line.rest:
0165 779A DD74  42         movb  *tmp0+,*tmp1+         ; 1st/Next digit row length
0166 779C DD60  48         movb  @rambuf+0,*tmp1+      ; Append a whitespace character
     779E A100     
0167 77A0 DD60  48         movb  @rambuf+0,*tmp1+      ; Append a whitespace character
     77A2 A100     
0168                       ;------------------------------------------------------
0169                       ; Show column string
0170                       ;------------------------------------------------------
0171               pane.botline.show_linecol.colstring:
0172 77A4 06A0  32         bl    @putat
     77A6 2456     
0173 77A8 1741                   byte pane.botrow,65
0174 77AA A105                   data rambuf+5         ; Show string
0175                       ;------------------------------------------------------
0176                       ; Show lines in buffer unless on last line in file
0177                       ;------------------------------------------------------
0178 77AC C820  54         mov   @fb.row,@parm1
     77AE A306     
     77B0 A000     
0179 77B2 06A0  32         bl    @fb.row2line
     77B4 6D40     
0180 77B6 8820  54         c     @edb.lines,@outparm1
     77B8 A504     
     77BA A010     
0181 77BC 1605  14         jne   pane.botline.show_lines_in_buffer
0182               
0183 77BE 06A0  32         bl    @putat
     77C0 2456     
0184 77C2 1748                   byte pane.botrow,72
0185 77C4 3662                   data txt.bottom
0186               
0187 77C6 1009  14         jmp   pane.botline.exit
0188                       ;------------------------------------------------------
0189                       ; Show lines in buffer
0190                       ;------------------------------------------------------
0191               pane.botline.show_lines_in_buffer:
0192 77C8 C820  54         mov   @edb.lines,@waux1
     77CA A504     
     77CC 833C     
0193               
0194 77CE 06A0  32         bl    @putnum
     77D0 2A3C     
0195 77D2 1748                   byte pane.botrow,72   ; YX
0196 77D4 833C                   data waux1,rambuf
     77D6 A100     
0197 77D8 30                     byte 48
0198 77D9   20                   byte 32
0199                       ;------------------------------------------------------
0200                       ; Exit
0201                       ;------------------------------------------------------
0202               pane.botline.exit:
0203 77DA C839  50         mov   *stack+,@wyx          ; Pop cursor position
     77DC 832A     
0204 77DE C139  30         mov   *stack+,tmp0          ; Pop tmp0
0205 77E0 C2F9  30         mov   *stack+,r11           ; Pop r11
0206 77E2 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.27722
...
0022               ********|*****|*********************|**************************
0023               pane.vdpdump:
0024 77E4 0649  14         dect  stack
0025 77E6 C64B  30         mov   r11,*stack            ; Save return address
0026 77E8 0649  14         dect  stack
0027 77EA C644  30         mov   tmp0,*stack           ; Push tmp0
0028 77EC 0649  14         dect  stack
0029 77EE C660  46         mov   @wyx,*stack           ; Push cursor position
     77F0 832A     
0030                       ;------------------------------------------------------
0031                       ; ALPHA-Lock key down?
0032                       ;------------------------------------------------------
0033               pane.vdpdump.alpha_lock:
0034 77F2 20A0  38         coc   @wbit10,config
     77F4 200C     
0035 77F6 1305  14         jeq   pane.vdpdump.alpha_lock.down
0036                       ;------------------------------------------------------
0037                       ; AlPHA-Lock is up
0038                       ;------------------------------------------------------
0039 77F8 06A0  32         bl    @putat
     77FA 2456     
0040 77FC 174E                   byte pane.botrow,78
0041 77FE 3896                   data txt.ws4
0042 7800 1004  14         jmp   pane.vdpdump.cmdb.check
0043                       ;------------------------------------------------------
0044                       ; AlPHA-Lock is down
0045                       ;------------------------------------------------------
0046               pane.vdpdump.alpha_lock.down:
0047 7802 06A0  32         bl    @putat
     7804 2456     
0048 7806 174E                   byte pane.botrow,78
0049 7808 3884                   data txt.alpha.down
0050                       ;------------------------------------------------------
0051                       ; Command buffer visible ?
0052                       ;------------------------------------------------------
0053               pane.vdpdump.cmdb.check
0054 780A C120  34         mov   @cmdb.visible,tmp0    ; CMDB pane visible ?
     780C A702     
0055 780E 1324  14         jeq   !                     ; No, skip CMDB pane
0056                       ;-------------------------------------------------------
0057                       ; Draw command buffer pane if dirty
0058                       ;-------------------------------------------------------
0059               pane.vdpdump.cmdb.draw:
0060 7810 C120  34         mov   @cmdb.dirty,tmp0      ; Command buffer dirty?
     7812 A718     
0061 7814 1343  14         jeq   pane.vdpdump.exit     ; No, skip update
0062                       ;-------------------------------------------------------
0063                       ; "one-time only" flag set?
0064                       ;-------------------------------------------------------
0065 7816 0284  22         ci    tmp0,tv.1timeonly
     7818 00FE     
0066 781A 1619  14         jne   pane.vdpdump.cmdb.draw.content
0067                                                   ; No, skip CMDB colorization
0068                       ;-------------------------------------------------------
0069                       ; Colorize the CMDB pane
0070                       ;-------------------------------------------------------
0071               pane.vdpdump.cmdb.draw.colorscheme:
0072 781C 0649  14         dect  stack
0073 781E C660  46         mov   @parm1,*stack         ; Push @parm1
     7820 A000     
0074 7822 0649  14         dect  stack
0075 7824 C660  46         mov   @parm2,*stack         ; Push @parm2
     7826 A002     
0076 7828 0649  14         dect  stack
0077 782A C660  46         mov   @parm3,*stack         ; Push @parm3
     782C A004     
0078               
0079 782E 0720  34         seto  @parm1                ; Do not turn screen off
     7830 A000     
0080 7832 0720  34         seto  @parm2                ; Skip colorzing marked lines
     7834 A002     
0081 7836 0720  34         seto  @parm3                ; Only colorize CMDB pane
     7838 A004     
0082               
0083 783A 06A0  32         bl    @pane.action.colorscheme.load
     783C 7292     
...
0089                                                   ; /             if >FFFF
0090               
0091 783E C839  50         mov   *stack+,@parm3        ; Pop @parm3
     7840 A004     
0092 7842 C839  50         mov   *stack+,@parm2        ; Pop @parm2
     7844 A002     
0093 7846 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     7848 A000     
0094               
0095 784A 0720  34         seto  @cmdb.dirty           ; Remove special "one-time only" flag
     784C A718     
0096                       ;-------------------------------------------------------
0097                       ; Show content in CMDB pane
0098                       ;-------------------------------------------------------
0099               pane.vdpdump.cmdb.draw.content:
0100 784E 06A0  32         bl    @pane.cmdb.draw       ; Draw CMDB pane
     7850 79F0     
0101 7852 04E0  34         clr   @cmdb.dirty           ; Reset CMDB dirty flag
     7854 A718     
0102 7856 1022  14         jmp   pane.vdpdump.exit     ; Exit early
0103                       ;-------------------------------------------------------
0104                       ; Check if frame buffer dirty
0105                       ;-------------------------------------------------------
0106 7858 C120  34 !       mov   @fb.dirty,tmp0        ; Is frame buffer dirty?
     785A A316     
0107 785C 130E  14         jeq   pane.vdpdump.statlines
0108                                                   ; No, skip update
0109 785E C820  54         mov   @fb.scrrows,@parm1    ; Number of lines to dump
     7860 A31A     
     7862 A000     
0110               
0111               pane.vdpdump.dump:
0112 7864 06A0  32         bl    @fb.vdpdump           ; Dump frame buffer to VDP SIT
     7866 7A88     
...
0117                       ;------------------------------------------------------
0118 7868 C120  34         mov   @fb.colorize,tmp0     ; Check if colorization necessary
     786A A310     
0119 786C 1302  14         jeq   pane.vdpdump.dumped   ; Skip if flag reset
0120               
0121 786E 06A0  32         bl    @fb.colorlines        ; Colorize lines M1/M2
     7870 7A76     
0122                       ;-------------------------------------------------------
0123                       ; Finished with frame buffer
0124                       ;-------------------------------------------------------
0125               pane.vdpdump.dumped:
0126 7872 04E0  34         clr   @fb.dirty             ; Reset framebuffer dirty flag
     7874 A316     
0127 7876 0720  34         seto  @fb.status.dirty      ; Do trigger status lines update
     7878 A318     
0128                       ;-------------------------------------------------------
0129                       ; Refresh top and bottom line
0130                       ;-------------------------------------------------------
0131               pane.vdpdump.statlines:
0132 787A C120  34         mov   @fb.status.dirty,tmp0 ; Are status lines dirty?
     787C A318     
0133 787E 130E  14         jeq   pane.vdpdump.exit     ; No, skip update
0134               
0135 7880 06A0  32         bl    @pane.topline         ; Draw top line
     7882 7522     
0136 7884 06A0  32         bl    @pane.botline         ; Draw bottom line
     7886 76AE     
0137 7888 04E0  34         clr   @fb.status.dirty      ; Reset status lines dirty flag
     788A A318     
0138                       ;------------------------------------------------------
0139                       ; Show ruler with tab positions
0140                       ;------------------------------------------------------
0141 788C C120  34         mov   @tv.ruler.visible,tmp0
     788E A210     
0142                                                   ; Should ruler be visible?
0143 7890 1305  14         jeq   pane.vdpdump.exit     ; No, so exit
0144               
0145 7892 06A0  32         bl    @cpym2v
     7894 249A     
0146 7896 0050                   data vdp.fb.toprow.sit
0147 7898 A31E                   data fb.ruler.sit
0148 789A 0050                   data 80               ; Show ruler
0149                       ;------------------------------------------------------
0150                       ; Exit task
0151                       ;------------------------------------------------------
0152               pane.vdpdump.exit:
0153 789C C839  50         mov   *stack+,@wyx          ; Pop cursor position
     789E 832A     
0154 78A0 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0155 78A2 C2F9  30         mov   *stack+,r11           ; Pop r11
0156 78A4 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.27722
0141                       ;-----------------------------------------------------------------------
0142                       ; Stubs
0143                       ;-----------------------------------------------------------------------
...
0007               ********|*****|*********************|**************************
0008               fm.loadfile:
0009 78A6 0649  14         dect  stack
0010 78A8 C64B  30         mov   r11,*stack            ; Save return address
0011 78AA 0649  14         dect  stack
0012 78AC C644  30         mov   tmp0,*stack           ; Push tmp0
0013                       ;------------------------------------------------------
0014                       ; Call function in bank 2
0015                       ;------------------------------------------------------
0016 78AE 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     78B0 2F88     
0017 78B2 6004                   data bank2.rom        ; | i  p0 = bank address
0018 78B4 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0019 78B6 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0020                       ;------------------------------------------------------
0021                       ; Show "Unsaved changes" dialog if editor buffer dirty
0022                       ;------------------------------------------------------
0023 78B8 C120  34         mov   @outparm1,tmp0
     78BA A010     
0024 78BC 1304  14         jeq   fm.loadfile.exit
0025               
0026 78BE C139  30         mov   *stack+,tmp0          ; Pop tmp0
0027 78C0 C2F9  30         mov   *stack+,r11           ; Pop r11
0028 78C2 0460  28         b     @dialog.unsaved       ; Show dialog and exit
     78C4 7956     
0029                       ;------------------------------------------------------
0030                       ; Exit
0031                       ;------------------------------------------------------
0032               fm.loadfile.exit:
0033 78C6 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0034 78C8 C2F9  30         mov   *stack+,r11           ; Pop r11
0035 78CA 045B  20         b     *r11                  ; Return to caller
0036               
0037               
0038               ***************************************************************
...
0041               ********|*****|*********************|**************************
0042               fm.insertfile:
0043 78CC 0649  14         dect  stack
0044 78CE C64B  30         mov   r11,*stack            ; Save return address
0045 78D0 0649  14         dect  stack
0046 78D2 C644  30         mov   tmp0,*stack           ; Push tmp0
0047                       ;------------------------------------------------------
0048                       ; Call function in bank 2
0049                       ;------------------------------------------------------
0050 78D4 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     78D6 2F88     
0051 78D8 6004                   data bank2.rom        ; | i  p0 = bank address
0052 78DA 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0053 78DC 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0054                       ;------------------------------------------------------
0055                       ; Exit
0056                       ;------------------------------------------------------
0057               fm.insertfile.exit:
0058 78DE C139  30         mov   *stack+,tmp0          ; Pop tmp0
0059 78E0 C2F9  30         mov   *stack+,r11           ; Pop r11
0060 78E2 045B  20         b     *r11                  ; Return to caller
0061               
0062               
0063               **************************************************************
...
0068 78E4 0649  14         dect  stack
0069 78E6 C64B  30         mov   r11,*stack            ; Save return address
0070                       ;------------------------------------------------------
0071                       ; Call function in bank 2
0072                       ;------------------------------------------------------
0073 78E8 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     78EA 2F88     
0074 78EC 6004                   data bank2.rom        ; | i  p0 = bank address
0075 78EE 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0076 78F0 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0077                       ;------------------------------------------------------
0078                       ; Exit
0079                       ;------------------------------------------------------
0080 78F2 C2F9  30         mov   *stack+,r11           ; Pop r11
0081 78F4 045B  20         b     *r11                  ; Return to caller
0082               
0083               
0084               ***************************************************************
...
0087               ********|*****|*********************|**************************
0088               fm.savefile:
0089 78F6 0649  14         dect  stack
0090 78F8 C64B  30         mov   r11,*stack            ; Save return address
0091                       ;------------------------------------------------------
0092                       ; Call function in bank 2
0093                       ;------------------------------------------------------
0094 78FA 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     78FC 2F88     
0095 78FE 6004                   data bank2.rom        ; | i  p0 = bank address
0096 7900 7FC6                   data vec.4            ; | i  p1 = Vector with target address
0097 7902 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0098                       ;------------------------------------------------------
0099                       ; Exit
0100                       ;------------------------------------------------------
0101 7904 C2F9  30         mov   *stack+,r11           ; Pop r11
0102 7906 045B  20         b     *r11                  ; Return to caller
0103               
0104               
0105               ***************************************************************
...
0108               ********|*****|*********************|**************************
0109               fm.newfile:
0110 7908 0649  14         dect  stack
0111 790A C64B  30         mov   r11,*stack            ; Save return address
0112                       ;------------------------------------------------------
0113                       ; Call function in bank 2
0114                       ;------------------------------------------------------
0115 790C 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     790E 2F88     
0116 7910 6004                   data bank2.rom        ; | i  p0 = bank address
0117 7912 7FC8                   data vec.5            ; | i  p1 = Vector with target address
0118 7914 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0119                       ;------------------------------------------------------
0120                       ; Exit
0121                       ;------------------------------------------------------
0122 7916 C2F9  30         mov   *stack+,r11           ; Pop r11
0123 7918 045B  20         b     *r11                  ; Return to caller
0124               
0125               
0126               ***************************************************************
...
0131 791A C820  54         mov   @edkey.action.about.vector,@trmpvector
     791C 7922     
     791E A03A     
0132 7920 104A  14         jmp   _trampoline.bank3     ; Show dialog
0133               edkey.action.about.vector:
0134 7922 7FC0             data  vec.1
0135               
0136               
0137               ***************************************************************
...
0140               ********|*****|*********************|**************************
0141               dialog.load:
0142 7924 C820  54         mov   @dialog.load.vector,@trmpvector
     7926 792C     
     7928 A03A     
0143 792A 1045  14         jmp   _trampoline.bank3     ; Show dialog
0144               dialog.load.vector:
0145 792C 7FC2             data  vec.2
0146               
0147               
0148               ***************************************************************
...
0151               ********|*****|*********************|**************************
0152               dialog.save:
0153 792E C820  54         mov   @dialog.save.vector,@trmpvector
     7930 7936     
     7932 A03A     
0154 7934 1040  14         jmp   _trampoline.bank3     ; Show dialog
0155               dialog.save.vector:
0156 7936 7FC4             data  vec.3
0157               
0158               
0159               ***************************************************************
...
0162               ********|*****|*********************|**************************
0163               dialog.insert:
0164 7938 C820  54         mov   @dialog.insert.vector,@trmpvector
     793A 7940     
     793C A03A     
0165 793E 103B  14         jmp   _trampoline.bank3     ; Show dialog
0166               dialog.insert.vector:
0167 7940 7FC6             data  vec.4
0168               
0169               
0170               ***************************************************************
...
0173               ********|*****|*********************|**************************
0174               dialog.print:
0175 7942 C820  54         mov   @dialog.print.vector,@trmpvector
     7944 794A     
     7946 A03A     
0176 7948 1036  14         jmp   _trampoline.bank3    ; Show dialog
0177               dialog.print.vector:
0178 794A 7FC8             data  vec.5
0179               
0180               
0181               ***************************************************************
...
0184               ********|*****|*********************|**************************
0185               dialog.file:
0186 794C C820  54         mov   @dialog.file.vector,@trmpvector
     794E 7954     
     7950 A03A     
0187 7952 1031  14         jmp   _trampoline.bank3     ; Show dialog
0188               dialog.file.vector:
0189 7954 7FCA             data  vec.6
0190               
0191               
0192               ***************************************************************
...
0195               ********|*****|*********************|**************************
0196               dialog.unsaved:
0197 7956 04E0  34         clr   @cmdb.panmarkers      ; No key markers
     7958 A722     
0198 795A C820  54         mov   @dialog.unsaved.vector,@trmpvector
     795C 7962     
     795E A03A     
0199 7960 102A  14         jmp   _trampoline.bank3     ; Show dialog
0200               dialog.unsaved.vector:
0201 7962 7FCC             data  vec.7
0202               
0203               
0204               ***************************************************************
...
0209 7964 C820  54         mov   @dialog.clipboard.vector,@trmpvector
     7966 796C     
     7968 A03A     
0210 796A 1025  14         jmp   _trampoline.bank3     ; Show dialog
0211               dialog.clipboard.vector:
0212 796C 7FCE             data  vec.8
0213               
0214               
0215               ***************************************************************
...
0218               ********|*****|*********************|**************************
0219               dialog.clipdev:
0220 796E C820  54         mov   @dialog.clipdev.vector,@trmpvector
     7970 7976     
     7972 A03A     
0221 7974 1020  14         jmp   _trampoline.bank3     ; Show dialog
0222               dialog.clipdev.vector:
0223 7976 7FD0             data  vec.9
0224               
0225               
0226               ***************************************************************
...
0229               ********|*****|*********************|**************************
0230               dialog.config:
0231 7978 C820  54         mov   @dialog.config.vector,@trmpvector
     797A 7980     
     797C A03A     
0232 797E 101B  14         jmp   _trampoline.bank3     ; Show dialog
0233               dialog.config.vector:
0234 7980 7FD2             data  vec.10
0235               
0236               
0237               ***************************************************************
...
0240               ********|*****|*********************|**************************
0241               dialog.append:
0242 7982 C820  54         mov   @dialog.append.vector,@trmpvector
     7984 798A     
     7986 A03A     
0243 7988 1016  14         jmp   _trampoline.bank3     ; Show dialog
0244               dialog.append.vector:
0245 798A 7FD4             data  vec.11
0246               
0247               
0248               ***************************************************************
...
0253 798C C820  54         mov   @dialog.cartridge.vector,@trmpvector
     798E 7994     
     7990 A03A     
0254 7992 1011  14         jmp   _trampoline.bank3     ; Show dialog
0255               dialog.cartridge.vector:
0256 7994 7FD6             data  vec.12
0257               
0258               
0259               ***************************************************************
...
0262               ********|*****|*********************|**************************
0263               dialog.basic:
0264 7996 C820  54         mov   @dialog.basic.vector,@trmpvector
     7998 799E     
     799A A03A     
0265 799C 100C  14         jmp   _trampoline.bank3     ; Show dialog
0266               dialog.basic.vector:
0267 799E 7FD8             data  vec.13
0268               
0269               
0270               ***************************************************************
...
0277                       ;------------------------------------------------------
0278 79A0 C120  34         mov   @edb.block.m2,tmp0    ; \
     79A2 A50E     
0279 79A4 0584  14         inc   tmp0                  ; | Skip if M2 unset (>ffff)
0280                                                   ; /
0281 79A6 1302  14         jeq   !                     : Block mode inactive, show dialog
0282                       ;------------------------------------------------------
0283                       ; Special treatment for block mode
0284                       ;------------------------------------------------------
0285 79A8 0460  28         b     @edkey.action.block.reset
     79AA 681C     
0286                                                   ; Reset block mode
0287                       ;------------------------------------------------------
0288                       ; Show dialog
0289                       ;------------------------------------------------------
0290 79AC C820  54 !       mov   @dialog.menu.vector,@trmpvector
     79AE 79B4     
     79B0 A03A     
0291 79B2 1001  14         jmp   _trampoline.bank3     ; Show dialog
0292               dialog.menu.vector:
0293 79B4 7FFA             data  vec.30
0294               
0295               
0296               
0297               ***************************************************************
...
0301 79B6 06A0  32         bl    @pane.cursor.hide     ; Hide cursor
     79B8 749E     
0302                       ;------------------------------------------------------
0303                       ; Call routine in specified bank
0304                       ;------------------------------------------------------
0305 79BA 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     79BC 2F88     
0306 79BE 6006                   data bank3.rom        ; | i  p0 = bank address
0307 79C0 FFFF                   data >ffff            ; | i  p1 = Vector with target address
0308                                                   ; |         (deref @trmpvector)
0309 79C2 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0310                       ;------------------------------------------------------
0311                       ; Exit
0312                       ;------------------------------------------------------
0313 79C4 0460  28         b     @edkey.action.cmdb.show
     79C6 69D2     
...
0320               ********|*****|*********************|**************************
0321               error.display:
0322 79C8 C820  54         mov   @error.display.vector,@trmpvector
     79CA 79D0     
     79CC A03A     
0323 79CE 1038  14         jmp   _trampoline.bank3.ret ; Longjump
0324               error.display.vector:
0325 79D0 7FE2             data  vec.18
0326               
0327               
0328               ***************************************************************
...
0333 79D2 C820  54         mov   @pane.show_hintx.vector,@trmpvector
     79D4 79DA     
     79D6 A03A     
0334 79D8 1033  14         jmp   _trampoline.bank3.ret ; Longjump
0335               pane.show_hintx.vector:
0336 79DA 7FE4             data  vec.19
0337               
0338               
0339               ***************************************************************
...
0342               ********|*****|*********************|**************************
0343               pane.cmdb.show:
0344 79DC C820  54         mov   @pane.cmdb.show.vector,@trmpvector
     79DE 79E4     
     79E0 A03A     
0345 79E2 102E  14         jmp   _trampoline.bank3.ret ; Longjump
0346               pane.cmdb.show.vector:
0347 79E4 7FE6             data  vec.20
0348               
0349               
0350               ***************************************************************
...
0353               ********|*****|*********************|**************************
0354               pane.cmdb.hide:
0355 79E6 C820  54         mov   @pane.cmdb.hide.vector,@trmpvector
     79E8 79EE     
     79EA A03A     
0356 79EC 1029  14         jmp   _trampoline.bank3.ret ; Longjump
0357               pane.cmdb.hide.vector:
0358 79EE 7FE8             data  vec.21
0359               
0360               
0361               ***************************************************************
...
0364               ********|*****|*********************|**************************
0365               pane.cmdb.draw:
0366 79F0 C820  54         mov   @pane.cmdb.draw.vector,@trmpvector
     79F2 79F8     
     79F4 A03A     
0367 79F6 1024  14         jmp   _trampoline.bank3.ret ; Longjump
0368               pane.cmdb.draw.vector:
0369 79F8 7FEA             data  vec.22
0370               
0371               
0372               ***************************************************************
...
0375               ********|*****|*********************|**************************
0376               cmdb.refresh:
0377 79FA C820  54         mov   @cmdb.refresh.vector,@trmpvector
     79FC 7A02     
     79FE A03A     
0378 7A00 101F  14         jmp   _trampoline.bank3.ret ; Longjump
0379               cmdb.refresh.vector:
0380 7A02 7FEE             data  vec.24
0381               
0382               
0383               ***************************************************************
...
0386               ********|*****|*********************|**************************
0387               cmdb.cmd.clear:
0388 7A04 C820  54         mov   @cmdb.cmd.clear.vector,@trmpvector
     7A06 7A0C     
     7A08 A03A     
0389 7A0A 101A  14         jmp   _trampoline.bank3.ret ; Longjump
0390               cmdb.cmd.clear.vector:
0391 7A0C 7FF0             data  vec.25
0392               
0393               
0394               ***************************************************************
...
0399 7A0E C820  54         mov   @cmdb.cmd.getlength.vector,@trmpvector
     7A10 7A16     
     7A12 A03A     
0400 7A14 1015  14         jmp   _trampoline.bank3.ret ; Longjump
0401               cmdb.cmd.getlength.vector:
0402 7A16 7FF2             data  vec.26
0403               
0404               
0405               ***************************************************************
...
0410 7A18 C820  54         mov   @cmdb.cmd.preset.vector,@trmpvector
     7A1A 7A20     
     7A1C A03A     
0411 7A1E 1010  14         jmp   _trampoline.bank3.ret ; Longjump
0412               cmdb.cmd.preset.vector:
0413 7A20 7FF4             data  vec.27
0414               
0415               
0416               ***************************************************************
...
0419               ********|*****|*********************|**************************
0420               cmdb.cmd.set:
0421 7A22 C820  54         mov   @cmdb.cmd.set.vector,@trmpvector
     7A24 7A2A     
     7A26 A03A     
0422 7A28 100B  14         jmp   _trampoline.bank3.ret ; Longjump
0423               cmdb.cmd.set.vector:
0424 7A2A 7FF6             data  vec.28
0425               
0426               
0427               **************************************************************
...
0432 7A2C C820  54         mov   @tibasic.sid.toggle.vector,@trmpvector
     7A2E 7A34     
     7A30 A03A     
0433 7A32 1006  14         jmp   _trampoline.bank3.ret ; Longjump
0434               tibasic.sid.toggle.vector:
0435 7A34 7FFC             data  vec.31
0436               
0437               
0438               **************************************************************
...
0441               ********|*****|*********************|**************************
0442               fm.fastmode:
0443 7A36 C820  54         mov   @fm.fastmode.vector,@trmpvector
     7A38 7A3E     
     7A3A A03A     
0444 7A3C 1001  14         jmp   _trampoline.bank3.ret ; Longjump
0445               fm.fastmode.vector:
0446 7A3E 7FFE             data  vec.32
0447               
0448               
0449               
0450               
...
0455 7A40 0649  14         dect  stack
0456 7A42 C64B  30         mov   r11,*stack            ; Save return address
0457                       ;------------------------------------------------------
0458                       ; Call routine in specified bank
0459                       ;------------------------------------------------------
0460 7A44 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7A46 2F88     
0461 7A48 6006                   data bank3.rom        ; | i  p0 = bank address
0462 7A4A FFFF                   data >ffff            ; | i  p1 = Vector with target address
0463                                                   ; |         (deref @trmpvector)
0464 7A4C 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0465                       ;------------------------------------------------------
0466                       ; Exit
0467                       ;------------------------------------------------------
0468 7A4E C2F9  30         mov   *stack+,r11           ; Pop r11
0469 7A50 045B  20         b     *r11                  ; Return to caller
0470               
0471               
0472               
0473               ***************************************************************
...
0476               ********|*****|*********************|**************************
0477               fb.tab.next:
0478 7A52 0649  14         dect  stack
0479 7A54 C64B  30         mov   r11,*stack            ; Save return address
0480                       ;------------------------------------------------------
0481                       ; Put cursor on next tab position
0482                       ;------------------------------------------------------
0483 7A56 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7A58 2F88     
0484 7A5A 6008                   data bank4.rom        ; | i  p0 = bank address
0485 7A5C 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0486 7A5E 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0487                       ;------------------------------------------------------
0488                       ; Exit
0489                       ;------------------------------------------------------
0490 7A60 C2F9  30         mov   *stack+,r11           ; Pop r11
0491 7A62 045B  20         b     *r11                  ; Return to caller
0492               
0493               
0494               ***************************************************************
...
0497               ********|*****|*********************|**************************
0498               fb.ruler.init:
0499 7A64 0649  14         dect  stack
0500 7A66 C64B  30         mov   r11,*stack            ; Save return address
0501                       ;------------------------------------------------------
0502                       ; Setup ruler in memory
0503                       ;------------------------------------------------------
0504 7A68 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7A6A 2F88     
0505 7A6C 6008                   data bank4.rom        ; | i  p0 = bank address
0506 7A6E 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0507 7A70 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0508                       ;------------------------------------------------------
0509                       ; Exit
0510                       ;------------------------------------------------------
0511 7A72 C2F9  30         mov   *stack+,r11           ; Pop r11
0512 7A74 045B  20         b     *r11                  ; Return to caller
0513               
0514               
0515               ***************************************************************
...
0518               ********|*****|*********************|**************************
0519               fb.colorlines:
0520 7A76 0649  14         dect  stack
0521 7A78 C64B  30         mov   r11,*stack            ; Save return address
0522                       ;------------------------------------------------------
0523                       ; Colorize frame buffer content
0524                       ;------------------------------------------------------
0525 7A7A 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7A7C 2F88     
0526 7A7E 6008                   data bank4.rom        ; | i  p0 = bank address
0527 7A80 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0528 7A82 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0529                       ;------------------------------------------------------
0530                       ; Exit
0531                       ;------------------------------------------------------
0532 7A84 C2F9  30         mov   *stack+,r11           ; Pop r11
0533 7A86 045B  20         b     *r11                  ; Return to caller
0534               
0535               
0536               ***************************************************************
...
0539               ********|*****|*********************|**************************
0540               fb.vdpdump:
0541 7A88 0649  14         dect  stack
0542 7A8A C64B  30         mov   r11,*stack            ; Save return address
0543                       ;------------------------------------------------------
0544                       ; Colorize frame buffer content
0545                       ;------------------------------------------------------
0546 7A8C 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7A8E 2F88     
0547 7A90 6008                   data bank4.rom        ; | i  p0 = bank address
0548 7A92 7FC6                   data vec.4            ; | i  p1 = Vector with target address
0549 7A94 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0550                       ;------------------------------------------------------
0551                       ; Exit
0552                       ;------------------------------------------------------
0553 7A96 C2F9  30         mov   *stack+,r11           ; Pop r11
0554 7A98 045B  20         b     *r11                  ; Return to caller
0555               
0556               
0557               
0558               **************************************************************
...
0561               ********|*****|*********************|**************************
0562               edb.clear.sams:
0563 7A9A C820  54         mov   @edb.clear.sams.vector,@trmpvector
     7A9C 7AA2     
     7A9E A03A     
0564 7AA0 102E  14         jmp   _trampoline.bank5.ret ; Longjump
0565               edb.clear.sams.vector:
0566 7AA2 7FC0             data  vec.1
0567               
0568               
0569               **************************************************************
...
0574 7AA4 C820  54         mov   @edb.hipage.alloc.vector,@trmpvector
     7AA6 7AAC     
     7AA8 A03A     
0575 7AAA 1029  14         jmp   _trampoline.bank5.ret ; Longjump
0576               edb.hipage.alloc.vector:
0577 7AAC 7FC2             data  vec.2
0578               
0579               
0580               **************************************************************
...
0583               ********|*****|*********************|**************************
0584               edb.block.mark:
0585 7AAE C820  54         mov   @edb.block.mark.vector,@trmpvector
     7AB0 7AB6     
     7AB2 A03A     
0586 7AB4 1024  14         jmp   _trampoline.bank5.ret ; Longjump
0587               edb.block.mark.vector:
0588 7AB6 7FC4             data  vec.3
0589               
0590               
0591               **************************************************************
...
0596 7AB8 C820  54         mov   @edb.block.mark.m1.vector,@trmpvector
     7ABA 7AC0     
     7ABC A03A     
0597 7ABE 101F  14         jmp   _trampoline.bank5.ret ; Longjump
0598               edb.block.mark.m1.vector:
0599 7AC0 7FC6             data  vec.4
0600               
0601               
0602               **************************************************************
...
0607 7AC2 C820  54         mov   @edb.block.mark.m2.vector,@trmpvector
     7AC4 7ACA     
     7AC6 A03A     
0608 7AC8 101A  14         jmp   _trampoline.bank5.ret ; Longjump
0609               edb.block.mark.m2.vector:
0610 7ACA 7FC8             data  vec.5
0611               
0612               
0613               **************************************************************
...
0616               ********|*****|*********************|**************************
0617               edb.block.clip:
0618 7ACC C820  54         mov   @edb.block.clip.vector,@trmpvector
     7ACE 7AD4     
     7AD0 A03A     
0619 7AD2 1015  14         jmp   _trampoline.bank5.ret ; Longjump
0620               edb.block.clip.vector:
0621 7AD4 7FCA             data  vec.6
0622               
0623               
0624               **************************************************************
...
0629 7AD6 C820  54         mov   @edb.block.reset.vector,@trmpvector
     7AD8 7ADE     
     7ADA A03A     
0630 7ADC 1010  14         jmp   _trampoline.bank5.ret ; Longjump
0631               edb.block.reset.vector:
0632 7ADE 7FCC             data  vec.7
0633               
0634               
0635               **************************************************************
...
0640 7AE0 C820  54         mov   @edb.block.delete.vector,@trmpvector
     7AE2 7AE8     
     7AE4 A03A     
0641 7AE6 100B  14         jmp   _trampoline.bank5.ret ; Longjump
0642               edb.block.delete.vector:
0643 7AE8 7FCE             data  vec.8
0644               
0645               
0646               **************************************************************
...
0649               ********|*****|*********************|**************************
0650               edb.block.copy:
0651 7AEA C820  54         mov   @edb.block.copy.vector,@trmpvector
     7AEC 7AF2     
     7AEE A03A     
0652 7AF0 1006  14         jmp   _trampoline.bank5.ret ; Longjump
0653               edb.block.copy.vector:
0654 7AF2 7FD0             data  vec.9
0655               
0656               
0657               **************************************************************
...
0660               ********|*****|*********************|**************************
0661               edb.line.del:
0662 7AF4 C820  54         mov   @edb.line.del.vector,@trmpvector
     7AF6 7AFC     
     7AF8 A03A     
0663 7AFA 1001  14         jmp   _trampoline.bank5.ret ; Longjump
0664               edb.line.del.vector:
0665 7AFC 7FD2             data  vec.10
0666               
0667               
0668               
0669               ***************************************************************
...
0673 7AFE 0649  14         dect  stack
0674 7B00 C64B  30         mov   r11,*stack            ; Save return address
0675                       ;------------------------------------------------------
0676                       ; Call routine in specified bank
0677                       ;------------------------------------------------------
0678 7B02 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7B04 2F88     
0679 7B06 600A                   data bank5.rom        ; | i  p0 = bank address
0680 7B08 FFFF                   data >ffff            ; | i  p1 = Vector with target address
0681                                                   ; |         (deref @trmpvector)
0682 7B0A 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0683                       ;------------------------------------------------------
0684                       ; Exit
0685                       ;------------------------------------------------------
0686 7B0C C2F9  30         mov   *stack+,r11           ; Pop r11
0687 7B0E 045B  20         b     *r11                  ; Return to caller
0688               
0689               
0690               ***************************************************************
...
0695 7B10 0649  14         dect  stack
0696 7B12 C64B  30         mov   r11,*stack            ; Save return address
0697                       ;------------------------------------------------------
0698                       ; Dump VDP patterns
0699                       ;------------------------------------------------------
0700 7B14 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7B16 2F88     
0701 7B18 600C                   data bank6.rom        ; | i  p0 = bank address
0702 7B1A 7FC0                   data vec.1            ; | i  p1 = Vector with target address
...
0715               ********|*****|*********************|**************************
0716               tibasic1:
0717 7B22 0204  20         li    tmp0,1
     7B24 0001     
0718 7B26 C804  38         mov   tmp0,@tibasic.session
     7B28 A02E     
0719 7B2A 1013  14         jmp   tibasic
0720               tibasic2:
0721 7B2C 0204  20         li    tmp0,2
     7B2E 0002     
0722 7B30 C804  38         mov   tmp0,@tibasic.session
     7B32 A02E     
0723 7B34 100E  14         jmp   tibasic
0724               tibasic3:
0725 7B36 0204  20         li    tmp0,3
     7B38 0003     
0726 7B3A C804  38         mov   tmp0,@tibasic.session
     7B3C A02E     
0727 7B3E 1009  14         jmp   tibasic
0728               tibasic4:
0729 7B40 0204  20         li    tmp0,4
     7B42 0004     
0730 7B44 C804  38         mov   tmp0,@tibasic.session
     7B46 A02E     
0731 7B48 1004  14         jmp   tibasic
0732               tibasic5:
0733 7B4A 0204  20         li    tmp0,5
     7B4C 0005     
0734 7B4E C804  38         mov   tmp0,@tibasic.session
     7B50 A02E     
0735               tibasic:
0736 7B52 0649  14         dect  stack
0737 7B54 C64B  30         mov   r11,*stack            ; Save return address
0738                       ;------------------------------------------------------
0739                       ; Dump VDP patterns
0740                       ;------------------------------------------------------
0741 7B56 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7B58 2F88     
0742 7B5A 600E                   data bank7.rom        ; | i  p0 = bank address
0743 7B5C 7FD2                   data vec.10           ; | i  p1 = Vector with target address
0744 7B5E 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0745                       ;------------------------------------------------------
0746                       ; Exit
0747                       ;------------------------------------------------------
0748 7B60 C2F9  30         mov   *stack+,r11           ; Pop r11
0749 7B62 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.27722
...
0038 7B64 0649  14         dect  stack
0039 7B66 C64B  30         mov   r11,*stack            ; Save return address
0040                       ;------------------------------------------------------
0041                       ; Dump VDP patterns
0042                       ;------------------------------------------------------
0043 7B68 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7B6A 2F88     
0044 7B6C 600E                   data bank7.rom        ; | i  p0 = bank address
0045 7B6E 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0046 7B70 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0047                       ;------------------------------------------------------
0048                       ; Exit
0049                       ;------------------------------------------------------
0050 7B72 C2F9  30         mov   *stack+,r11           ; Pop r11
0051 7B74 045B  20         b     *r11                  ; Return to caller
0052               
0054               
0055               
0056               ***************************************************************
...
0063 7B76 0649  14         dect  stack
0064 7B78 C64B  30         mov   r11,*stack            ; Save return address
0065                       ;------------------------------------------------------
0066                       ; Dump VDP patterns
0067                       ;------------------------------------------------------
0068 7B7A 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7B7C 2F88     
0069 7B7E 600E                   data bank7.rom        ; | i  p0 = bank address
0070 7B80 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0071 7B82 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0072                       ;------------------------------------------------------
0073                       ; Exit
0074                       ;------------------------------------------------------
0075 7B84 C2F9  30         mov   *stack+,r11           ; Pop r11
0076 7B86 045B  20         b     *r11                  ; Return to caller
0077               
0079               
0080               
0081               ***************************************************************
...
0088 7B88 0649  14         dect  stack
0089 7B8A C64B  30         mov   r11,*stack            ; Save return address
0090                       ;------------------------------------------------------
0091                       ; Dump VDP patterns
0092                       ;------------------------------------------------------
0093 7B8C 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7B8E 2F88     
0094 7B90 600E                   data bank7.rom        ; | i  p0 = bank address
0095 7B92 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0096 7B94 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0097                       ;------------------------------------------------------
0098                       ; Exit
0099                       ;------------------------------------------------------
0100 7B96 C2F9  30         mov   *stack+,r11           ; Pop r11
0101 7B98 045B  20         b     *r11                  ; Return to caller
0102               
0104               
0105               
0106               
...
0009                       ; Movement keys
0010                       ;-------------------------------------------------------
0011 7B9A 0D00             byte  key.enter, pane.focus.fb
0012 7B9C 6674             data  edkey.action.enter
0013               
0014 7B9E 0800             byte  key.fctn.s, pane.focus.fb
0015 7BA0 6236             data  edkey.action.left
0016               
0017 7BA2 0900             byte  key.fctn.d, pane.focus.fb
0018 7BA4 6250             data  edkey.action.right
0019               
0020 7BA6 0B00             byte  key.fctn.e, pane.focus.fb
0021 7BA8 6348             data  edkey.action.up
0022               
0023 7BAA 0A00             byte  key.fctn.x, pane.focus.fb
0024 7BAC 6350             data  edkey.action.down
0025               
0026 7BAE BF00             byte  key.fctn.h, pane.focus.fb
0027 7BB0 626C             data  edkey.action.home
0028               
0029 7BB2 C000             byte  key.fctn.j, pane.focus.fb
0030 7BB4 6296             data  edkey.action.pword
0031               
0032 7BB6 C100             byte  key.fctn.k, pane.focus.fb
0033 7BB8 62E8             data  edkey.action.nword
0034               
0035 7BBA C200             byte  key.fctn.l, pane.focus.fb
0036 7BBC 6274             data  edkey.action.end
0037               
0038 7BBE 0C00             byte  key.fctn.6, pane.focus.fb
0039 7BC0 6358             data  edkey.action.ppage
0040               
0041 7BC2 0200             byte  key.fctn.4, pane.focus.fb
0042 7BC4 6394             data  edkey.action.npage
0043               
0044 7BC6 8500             byte  key.ctrl.e, pane.focus.fb
0045 7BC8 6358             data  edkey.action.ppage
0046               
0047 7BCA 9800             byte  key.ctrl.x, pane.focus.fb
0048 7BCC 6394             data  edkey.action.npage
0049               
0050 7BCE 7F00             byte  key.fctn.v, pane.focus.fb
0051 7BD0 63EA             data  edkey.action.topscr
0052               
0053 7BD2 BE00             byte  key.fctn.b, pane.focus.fb
0054 7BD4 6434             data  edkey.action.botscr
0055               
0056 7BD6 9600             byte  key.ctrl.v, pane.focus.fb
0057 7BD8 63CE             data  edkey.action.top
0058               
0059 7BDA 8200             byte  key.ctrl.b, pane.focus.fb
0060 7BDC 6404             data  edkey.action.bot
0061                       ;-------------------------------------------------------
0062                       ; Modifier keys - Delete
0063                       ;-------------------------------------------------------
0064 7BDE 0300             byte  key.fctn.1, pane.focus.fb
0065 7BE0 64C2             data  edkey.action.del_char
0066               
0067 7BE2 0700             byte  key.fctn.3, pane.focus.fb
0068 7BE4 6574             data  edkey.action.del_line
0069               
0070 7BE6 8C00             byte  key.ctrl.l, pane.focus.fb
0071 7BE8 6540             data  edkey.action.del_eol
0072                       ;-------------------------------------------------------
0073                       ; Modifier keys - Insert
0074                       ;-------------------------------------------------------
0075 7BEA 0400             byte  key.fctn.2, pane.focus.fb
0076 7BEC 65D6             data  edkey.action.ins_char.ws
0077               
0078 7BEE B900             byte  key.fctn.dot, pane.focus.fb
0079 7BF0 66EC             data  edkey.action.ins_onoff
0080               
0081 7BF2 0100             byte  key.fctn.7, pane.focus.fb
0082 7BF4 68DA             data  edkey.action.fb.tab.next
0083               
0084 7BF6 9400             byte  key.ctrl.t, pane.focus.fb
0085 7BF8 68DA             data  edkey.action.fb.tab.next
0086               
0087 7BFA 0600             byte  key.fctn.8, pane.focus.fb
0088 7BFC 666C             data  edkey.action.ins_line
0089                       ;-------------------------------------------------------
0090                       ; Block marking/modifier
0091                       ;-------------------------------------------------------
0092 7BFE F000             byte  key.ctrl.space, pane.focus.fb
0093 7C00 6814             data  edkey.action.block.mark
0094               
0095 7C02 8300             byte  key.ctrl.c, pane.focus.fb
0096 7C04 67B4             data  edkey.action.copyblock_or_clipboard
0097               
0098 7C06 8400             byte  key.ctrl.d, pane.focus.fb
0099 7C08 6864             data  edkey.action.block.delete
0100               
0101 7C0A 8D00             byte  key.ctrl.m, pane.focus.fb
0102 7C0C 688E             data  edkey.action.block.move
0103               
0104 7C0E 8700             byte  key.ctrl.g, pane.focus.fb
0105 7C10 68C0             data  edkey.action.block.goto.m1
0106                       ;-------------------------------------------------------
0107                       ; Clipboards
0108                       ;-------------------------------------------------------
0109 7C12 B100             byte  key.ctrl.1, pane.focus.fb
0110 7C14 68E8             data  edkey.action.fb.clip.save.1
0111               
0112 7C16 B200             byte  key.ctrl.2, pane.focus.fb
0113 7C18 68EE             data  edkey.action.fb.clip.save.2
0114               
0115 7C1A B300             byte  key.ctrl.3, pane.focus.fb
0116 7C1C 68F4             data  edkey.action.fb.clip.save.3
0117               
0118 7C1E B400             byte  key.ctrl.4, pane.focus.fb
0119 7C20 68FA             data  edkey.action.fb.clip.save.4
0120               
0121 7C22 B500             byte  key.ctrl.5, pane.focus.fb
0122 7C24 6900             data  edkey.action.fb.clip.save.5
0123                       ;-------------------------------------------------------
0124                       ; Other action keys
0125                       ;-------------------------------------------------------
0126 7C26 0500             byte  key.fctn.plus, pane.focus.fb
0127 7C28 67A6             data  edkey.action.quit
0128               
0129 7C2A 9100             byte  key.ctrl.q, pane.focus.fb
0130 7C2C 67A6             data  edkey.action.quit
0131               
0132 7C2E 9500             byte  key.ctrl.u, pane.focus.fb
0133 7C30 6766             data  edkey.action.toggle.ruler
0134               
0135 7C32 9A00             byte  key.ctrl.z, pane.focus.fb
0136 7C34 7234             data  pane.action.colorscheme.cycle
0137               
0138 7C36 8000             byte  key.ctrl.comma, pane.focus.fb
0139 7C38 67C4             data  edkey.action.fb.fname.dec.load
0140               
0141 7C3A 9B00             byte  key.ctrl.dot, pane.focus.fb
0142 7C3C 67D6             data  edkey.action.fb.fname.inc.load
0143               
0144 7C3E BB00             byte  key.ctrl.slash, pane.focus.fb
0145 7C40 7996             data  dialog.basic
0146                       ;-------------------------------------------------------
0147                       ; Dialog keys
0148                       ;-------------------------------------------------------
0149 7C42 8100             byte  key.ctrl.a, pane.focus.fb
0150 7C44 7982             data  dialog.append
0151               
0152 7C46 8800             byte  key.ctrl.h, pane.focus.fb
0153 7C48 791A             data  edkey.action.about
0154               
0155 7C4A 8600             byte  key.ctrl.f, pane.focus.fb
0156 7C4C 794C             data  dialog.file
0157               
0158 7C4E 8900             byte  key.ctrl.i, pane.focus.fb
0159 7C50 7938             data  dialog.insert
0160               
0161 7C52 9300             byte  key.ctrl.s, pane.focus.fb
0162 7C54 792E             data  dialog.save
0163               
0164 7C56 8F00             byte  key.ctrl.o, pane.focus.fb
0165 7C58 7924             data  dialog.load
0166               
0167 7C5A 9000             byte  key.ctrl.p, pane.focus.fb
0168 7C5C 7942             data  dialog.print
0169               
0170                       ;
0171                       ; FCTN-9 has multiple purposes, if block mode is on it
0172                       ; resets the block, otherwise show dialog "Main Menu".
0173                       ;
0174 7C5E 0F00             byte  key.fctn.9, pane.focus.fb
0175 7C60 79A0             data  dialog.menu
0176                       ;-------------------------------------------------------
0177                       ; End of list
0178                       ;-------------------------------------------------------
0179 7C62 FFFF             data  EOL                           ; EOL
0180               
0181               
0182               
0183               *---------------------------------------------------------------
...
0189                       ;-------------------------------------------------------
0190 7C64 4664             byte  key.uc.f, id.dialog.menu
0191 7C66 794C             data  dialog.file
0192               
0193 7C68 4364             byte  key.uc.c, id.dialog.menu
0194 7C6A 798C             data  dialog.cartridge
0195               
0196 7C6C 4864             byte  key.uc.h, id.dialog.menu
0197 7C6E 791A             data  edkey.action.about
0198               
0199 7C70 5164             byte  key.uc.q, id.dialog.menu
0200 7C72 67A6             data  edkey.action.quit
0201                       ;-------------------------------------------------------
0202                       ; Dialog: File
0203                       ;-------------------------------------------------------
0204 7C74 4E69             byte  key.uc.n, id.dialog.file
0205 7C76 69E4             data  edkey.action.cmdb.file.new
0206               
0207 7C78 5369             byte  key.uc.s, id.dialog.file
0208 7C7A 792E             data  dialog.save
0209               
0210 7C7C 4F69             byte  key.uc.o, id.dialog.file
0211 7C7E 7924             data  dialog.load
0212               
0213 7C80 5069             byte  key.uc.p, id.dialog.file
0214 7C82 7942             data  dialog.print
0215               
0216 7C84 4369             byte  key.uc.c, id.dialog.file
0217 7C86 7978             data  dialog.config
0218                       ;-------------------------------------------------------
0219                       ; Dialog: Open file
0220                       ;-------------------------------------------------------
0221 7C88 0E0A             byte  key.fctn.5, id.dialog.load
0222 7C8A 6D00             data  edkey.action.cmdb.fastmode.toggle
0223               
0224 7C8C 0D0A             byte  key.enter, id.dialog.load
0225 7C8E 6A08             data  edkey.action.cmdb.load
0226                       ;-------------------------------------------------------
0227                       ; Dialog: Insert file at line ...
0228                       ;-------------------------------------------------------
0229 7C90 0E0D             byte  key.fctn.5, id.dialog.insert
0230 7C92 6D00             data  edkey.action.cmdb.fastmode.toggle
0231               
0232 7C94 0D0D             byte  key.enter, id.dialog.insert
0233 7C96 6A4C             data  edkey.action.cmdb.insert
0234                       ;-------------------------------------------------------
0235                       ; Dialog: Append file
0236                       ;-------------------------------------------------------
0237 7C98 0E0E             byte  key.fctn.5, id.dialog.append
0238 7C9A 6D00             data  edkey.action.cmdb.fastmode.toggle
0239               
0240 7C9C 0D0E             byte  key.enter, id.dialog.append
0241 7C9E 6ACE             data  edkey.action.cmdb.append
0242                       ;-------------------------------------------------------
0243                       ; Dialog: Copy clipboard to line ...
0244                       ;-------------------------------------------------------
0245 7CA0 0E67             byte  key.fctn.5, id.dialog.clipboard
0246 7CA2 6D00             data  edkey.action.cmdb.fastmode.toggle
0247               
0248 7CA4 0167             byte  key.fctn.7, id.dialog.clipboard
0249 7CA6 796E             data  dialog.clipdev
0250               
0251 7CA8 3167             byte  key.num.1, id.dialog.clipboard
0252 7CAA 6B42             data  edkey.action.cmdb.clip.1
0253               
0254 7CAC 3267             byte  key.num.2, id.dialog.clipboard
0255 7CAE 6B48             data  edkey.action.cmdb.clip.2
0256               
0257 7CB0 3367             byte  key.num.3, id.dialog.clipboard
0258 7CB2 6B4E             data  edkey.action.cmdb.clip.3
0259               
0260 7CB4 3467             byte  key.num.4, id.dialog.clipboard
0261 7CB6 6B54             data  edkey.action.cmdb.clip.4
0262               
0263 7CB8 3567             byte  key.num.5, id.dialog.clipboard
0264 7CBA 6B5A             data  edkey.action.cmdb.clip.5
0265                       ;-------------------------------------------------------
0266                       ; Dialog: Configure clipboard device
0267                       ;-------------------------------------------------------
0268 7CBC 0D11             byte  key.enter, id.dialog.clipdev
0269 7CBE 6B8E             data  edkey.action.cmdb.clipdev.configure
0270                       ;-------------------------------------------------------
0271                       ; Dialog: Configure
0272                       ;-------------------------------------------------------
0273 7CC0 436C             byte  key.uc.c, id.dialog.config
0274 7CC2 796E             data  dialog.clipdev
0275                       ;-------------------------------------------------------
0276                       ; Dialog: Save file
0277                       ;-------------------------------------------------------
0278 7CC4 0D0B             byte  key.enter, id.dialog.save
0279 7CC6 6BDE             data  edkey.action.cmdb.save
0280               
0281 7CC8 0D0C             byte  key.enter, id.dialog.saveblock
0282 7CCA 6BDE             data  edkey.action.cmdb.save
0283                       ;-------------------------------------------------------
0284                       ; Dialog: Print file
0285                       ;-------------------------------------------------------
0286 7CCC 0D0F             byte  key.enter, id.dialog.print
0287 7CCE 6C5A             data  edkey.action.cmdb.print
0288               
0289 7CD0 0D10             byte  key.enter, id.dialog.printblock
0290 7CD2 6C5A             data  edkey.action.cmdb.print
0291                       ;-------------------------------------------------------
0292                       ; Dialog: Unsaved changes
0293                       ;-------------------------------------------------------
0294 7CD4 0C65             byte  key.fctn.6, id.dialog.unsaved
0295 7CD6 6CD6             data  edkey.action.cmdb.proceed
0296               
0297 7CD8 2065             byte  key.space, id.dialog.unsaved
0298 7CDA 6CD6             data  edkey.action.cmdb.proceed
0299               
0300 7CDC 0D65             byte  key.enter, id.dialog.unsaved
0301 7CDE 792E             data  dialog.save
0302                       ;-------------------------------------------------------
0303                       ; Dialog: Cartridge
0304                       ;-------------------------------------------------------
0305 7CE0 426A             byte  key.uc.b, id.dialog.cartridge
0306 7CE2 7996             data  dialog.basic
0307                       ;-------------------------------------------------------
0308                       ; Dialog: Basic
0309                       ;-------------------------------------------------------
0310 7CE4 316B             byte  key.num.1, id.dialog.basic
0311 7CE6 7B22             data  tibasic1
0312 7CE8 326B             byte  key.num.2, id.dialog.basic
0313 7CEA 7B2C             data  tibasic2
0314 7CEC 336B             byte  key.num.3, id.dialog.basic
0315 7CEE 7B36             data  tibasic3
0316 7CF0 346B             byte  key.num.4, id.dialog.basic
0317 7CF2 7B40             data  tibasic4
0318 7CF4 356B             byte  key.num.5, id.dialog.basic
0319 7CF6 7B4A             data  tibasic5
0320 7CF8 0E6B             byte  key.fctn.5, id.dialog.basic
0321 7CFA 6D0C             data  edkey.action.cmdb.sid.toggle
0322                       ;-------------------------------------------------------
0323                       ; Dialog: Help
0324                       ;-------------------------------------------------------
0325 7CFC 0F68             byte  key.fctn.9, id.dialog.help
0326 7CFE 6D20             data  edkey.action.cmdb.close.about
0327               
0328 7D00 0D68             byte  key.enter, id.dialog.help
0329 7D02 6D20             data  edkey.action.cmdb.close.about
0330                       ;-------------------------------------------------------
0331                       ; Movement keys
0332                       ;-------------------------------------------------------
0333 7D04 0801             byte  key.fctn.s, pane.focus.cmdb
0334 7D06 6918             data  edkey.action.cmdb.left
0335               
0336 7D08 0901             byte  key.fctn.d, pane.focus.cmdb
0337 7D0A 692A             data  edkey.action.cmdb.right
0338               
0339 7D0C BF01             byte  key.fctn.h, pane.focus.cmdb
0340 7D0E 6942             data  edkey.action.cmdb.home
0341               
0342 7D10 C201             byte  key.fctn.l, pane.focus.cmdb
0343 7D12 6956             data  edkey.action.cmdb.end
0344                       ;-------------------------------------------------------
0345                       ; Modifier keys
0346                       ;-------------------------------------------------------
0347 7D14 0701             byte  key.fctn.3, pane.focus.cmdb
0348 7D16 696E             data  edkey.action.cmdb.clear
0349                       ;-------------------------------------------------------
0350                       ; Other action keys
0351                       ;-------------------------------------------------------
0352 7D18 0F01             byte  key.fctn.9, pane.focus.cmdb
0353 7D1A 6D2C             data  edkey.action.cmdb.close.dialog
0354               
0355 7D1C 0501             byte  key.fctn.plus, pane.focus.cmdb
0356 7D1E 67A6             data  edkey.action.quit
0357               
0358 7D20 8101             byte  key.ctrl.a, pane.focus.cmdb
0359 7D22 6D18             data  edkey.action.cmdb.preset
0360               
0361 7D24 8201             byte  key.ctrl.b, pane.focus.cmdb
0362 7D26 6D18             data  edkey.action.cmdb.preset
0363               
0364 7D28 8301             byte  key.ctrl.c, pane.focus.cmdb
0365 7D2A 6D18             data  edkey.action.cmdb.preset
0366               
0367 7D2C 9A01             byte  key.ctrl.z, pane.focus.cmdb
0368 7D2E 7234             data  pane.action.colorscheme.cycle
0369                       ;------------------------------------------------------
0370                       ; End of list
0371                       ;-------------------------------------------------------
0372 7D30 FFFF             data  EOL                           ; EOL
                   < stevie_b1.asm.27722
0150                       ;-----------------------------------------------------------------------
...
0018 7FD6 7A9A     vec.12  data  edb.clear.sams        ;
...
0025 7FE4 7A04     vec.19  data  cmdb.cmd.clear        ;
0026 7FE6 6F4A     vec.20  data  fb.refresh            ;
0027 7FE8 7A88     vec.21  data  fb.vdpdump            ;
...
0033 7FF4 7678     vec.27  data  pane.errline.hide     ;
0034 7FF6 74BC     vec.28  data  pane.cursor.blink     ;
0035 7FF8 749E     vec.29  data  pane.cursor.hide      ;
0036 7FFA 7616     vec.30  data  pane.errline.show     ;
0037 7FFC 7292     vec.31  data  pane.action.colorscheme.load
0038 7FFE 7484     vec.32  data  pane.action.colorscheme.statlines
                   < stevie_b1.asm.27722
...
0182      35D0     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
