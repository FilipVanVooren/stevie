...
0008               ***************************************************************
0009               * File: stevie_b1.asm               ; Version 220202-2219300
0010               *
0011               * Bank 1 "James"
0012               * Editor core
0013               ***************************************************************
...
0165      A032     tibasic.hidesid   equ  core1.top + 50  ; Hide TI-Basic session ID
0166      A034     tibasic.session   equ  core1.top + 52  ; Current TI-Basic session (1-5)
0167      A036     tibasic1.status   equ  core1.top + 54  ; TI Basic session 1
0168      A038     tibasic2.status   equ  core1.top + 56  ; TI Basic session 2
0169      A03A     tibasic3.status   equ  core1.top + 58  ; TI Basic session 3
0170      A03C     tibasic4.status   equ  core1.top + 60  ; TI Basic session 4
0171      A03E     tibasic5.status   equ  core1.top + 62  ; TI Basic session 5
0172      A040     tibasic.var1      equ  core1.top + 64  ; Temp variable 1
0173      A042     tibasic.var2      equ  core1.top + 66  ; Temp variable 2
0174      A044     tibasic.var3      equ  core1.top + 68  ; Temp variable 3
0175      A046     tibasic.var4      equ  core1.top + 70  ; Temp variable 4
0176      A048     tibasic.var5      equ  core1.top + 72  ; Temp variable 5
0177      A04A     tibasic.var6      equ  core1.top + 74  ; Temp variable 6
0178      A04C     tibasic.var7      equ  core1.top + 76  ; Temp variable 7
0179      A04E     tibasic.var8      equ  core1.top + 78  ; Temp variable 8
0180      A050     tibasic.var9      equ  core1.top + 80  ; Temp variable 9
0181      A052     tibasic.var10     equ  core1.top + 82  ; Temp variable 10
0182      A054     trmpvector        equ  core1.top + 84  ; Vector trampoline (if p1|tmp1 = >ffff)
0183      A056     ramsat            equ  core1.top + 86  ; Sprite Attr. Table in RAM (14 bytes)
0184      A064     timers            equ  core1.top + 100 ; Timers (80 bytes)
0185      A0B4     core1.free        equ  core1.top + 180 ; End of structure
0186               *--------------------------------------------------------------
...
0196      A200     tv.sams.2000      equ  tv.top + 0      ; SAMS page in window >2000-2fff
0197      A202     tv.sams.3000      equ  tv.top + 2      ; SAMS page in window >3000-3fff
0198      A204     tv.sams.a000      equ  tv.top + 4      ; SAMS page in window >a000-afff
0199      A206     tv.sams.b000      equ  tv.top + 6      ; SAMS page in window >b000-bfff
0200      A208     tv.sams.c000      equ  tv.top + 8      ; SAMS page in window >c000-cfff
0201      A20A     tv.sams.d000      equ  tv.top + 10     ; SAMS page in window >d000-dfff
0202      A20C     tv.sams.e000      equ  tv.top + 12     ; SAMS page in window >e000-efff
0203      A20E     tv.sams.f000      equ  tv.top + 14     ; SAMS page in window >f000-ffff
...
0218      A22C     tv.sp2.conf       equ  tv.top + 44     ; Backup of SP2 config register
0219      A22C     tv.sp2.stack      equ  tv.top + 44     ; Backup of SP2 stack register
0220      A230     tv.error.msg      equ  tv.top + 48     ; Error message (max. 160 characters)
0221      A2D0     tv.free           equ  tv.top + 208    ; End of structure
0222               *--------------------------------------------------------------
0223               * Frame buffer structure              @>a300-a3ff   (256 bytes)
0224               *--------------------------------------------------------------
0225      A300     fb.struct         equ  >a300           ; Structure begin
0226      A300     fb.top.ptr        equ  fb.struct       ; Pointer to frame buffer
0227      A302     fb.current        equ  fb.struct + 2   ; Pointer to current pos. in frame buffer
0228      A304     fb.topline        equ  fb.struct + 4   ; Top line in frame buffer (matching
0229                                                      ; line X in editor buffer).
0230      A306     fb.row            equ  fb.struct + 6   ; Current row in frame buffer
0231                                                      ; (offset 0 .. @fb.scrrows)
0232      A308     fb.row.length     equ  fb.struct + 8   ; Length of current row in frame buffer
0233      A30A     fb.row.dirty      equ  fb.struct + 10  ; Current row dirty flag in frame buffer
0234      A30C     fb.column         equ  fb.struct + 12  ; Current column (0-79) in frame buffer
0235      A30E     fb.colsline       equ  fb.struct + 14  ; Columns per line in frame buffer
0236      A310     fb.colorize       equ  fb.struct + 16  ; M1/M2 colorize refresh required
0237      A312     fb.curtoggle      equ  fb.struct + 18  ; Cursor shape toggle
0238      A314     fb.yxsave         equ  fb.struct + 20  ; Copy of cursor YX position
0239      A316     fb.dirty          equ  fb.struct + 22  ; Frame buffer dirty flag
0240      A318     fb.status.dirty   equ  fb.struct + 24  ; Status line(s) dirty flag
0241      A31A     fb.scrrows        equ  fb.struct + 26  ; Rows on physical screen for framebuffer
0242      A31C     fb.scrrows.max    equ  fb.struct + 28  ; Max # of rows on physical screen for fb
0243      A31E     fb.ruler.sit      equ  fb.struct + 30  ; 80 char ruler  (no length-prefix!)
0244      A36E     fb.ruler.tat      equ  fb.struct + 110 ; 80 char colors (no length-prefix!)
0245      A3BE     fb.free           equ  fb.struct + 190 ; End of structure
0246               *--------------------------------------------------------------
...
0281      A458     fh.callback5      equ  fh.struct + 88  ; Pointer to callback function 5
0282      A45A     fh.workmode       equ  fh.struct + 90  ; Working mode (used in callbacks)
0283      A45C     fh.kilobytes.prev equ  fh.struct + 92  ; Kilobytes processed (previous)
0284      A45E     fh.line           equ  fh.struct + 94  ; Editor buffer line currently processing
0285      A460     fh.temp1          equ  fh.struct + 96  ; Temporary variable 1
0286      A462     fh.temp2          equ  fh.struct + 98  ; Temporary variable 2
0287      A464     fh.temp3          equ  fh.struct +100  ; Temporary variable 3
0288      A466     fh.membuffer      equ  fh.struct +102  ; 80 bytes file memory buffer
0289      A4B6     fh.free           equ  fh.struct +182  ; End of structure
0290      0960     fh.vrecbuf        equ  >0960           ; VDP address record buffer
0291      0A60     fh.vpab           equ  >0a60           ; VDP address PAB
0292               *--------------------------------------------------------------
0293               * Editor buffer structure             @>a500-a5ff   (256 bytes)
0294               *--------------------------------------------------------------
0295      A500     edb.struct        equ  >a500           ; Begin structure
0296      A500     edb.top.ptr       equ  edb.struct      ; Pointer to editor buffer
0297      A502     edb.index.ptr     equ  edb.struct + 2  ; Pointer to index
0298      A504     edb.lines         equ  edb.struct + 4  ; Total lines in editor buffer - 1
0299      A506     edb.dirty         equ  edb.struct + 6  ; Editor buffer dirty (Text changed!)
0300      A508     edb.next_free.ptr equ  edb.struct + 8  ; Pointer to next free line
0301      A50A     edb.insmode       equ  edb.struct + 10 ; Insert mode (>ffff = insert)
0302      A50C     edb.block.m1      equ  edb.struct + 12 ; Block start line marker (>ffff = unset)
0303      A50E     edb.block.m2      equ  edb.struct + 14 ; Block end line marker   (>ffff = unset)
0304      A510     edb.block.var     equ  edb.struct + 16 ; Local var used in block operation
0305      A512     edb.filename.ptr  equ  edb.struct + 18 ; Pointer to length-prefixed string
0306                                                      ; with current filename.
0307      A514     edb.filetype.ptr  equ  edb.struct + 20 ; Pointer to length-prefixed string
0308                                                      ; with current file type.
0309      A516     edb.sams.page     equ  edb.struct + 22 ; Current SAMS page
0310      A518     edb.sams.hipage   equ  edb.struct + 24 ; Highest SAMS page in use
0311      A51A     edb.filename      equ  edb.struct + 26 ; 80 characters inline buffer reserved
0312                                                      ; for filename, but not always used.
0313      A56A     edb.free          equ  edb.struct + 106; End of structure
0314               *--------------------------------------------------------------
...
0327      A702     cmdb.visible      equ  cmdb.struct + 2 ; Command buffer visible? (>ffff=visible)
0328      A704     cmdb.fb.yxsave    equ  cmdb.struct + 4 ; Copy of FB WYX when entering cmdb pane
...
0333      A70E     cmdb.yxtop        equ  cmdb.struct + 14; YX position of CMDB pane header line
0334      A710     cmdb.yxprompt     equ  cmdb.struct + 16; YX position of command buffer prompt
0335      A712     cmdb.column       equ  cmdb.struct + 18; Current column in command buffer pane
0336      A714     cmdb.length       equ  cmdb.struct + 20; Length of current row in CMDB
0337      A716     cmdb.lines        equ  cmdb.struct + 22; Total lines in CMDB
0338      A718     cmdb.dirty        equ  cmdb.struct + 24; Command buffer dirty (Text changed!)
0339      A71A     cmdb.dialog       equ  cmdb.struct + 26; Dialog identifier
0340      A71C     cmdb.dialog.var   equ  cmdb.struct + 28; Dialog private variable or pointer
0341      A71E     cmdb.panhead      equ  cmdb.struct + 30; Pointer to string pane header
0342      A720     cmdb.paninfo      equ  cmdb.struct + 32; Pointer to string pane info (1st line)
0343      A722     cmdb.panhint      equ  cmdb.struct + 34; Pointer to string pane hint (2nd line)
0344      A724     cmdb.panmarkers   equ  cmdb.struct + 36; Pointer to key marker list  (3rd line)
0345      A726     cmdb.pankeys      equ  cmdb.struct + 38; Pointer to string pane keys (stat line)
0346      A728     cmdb.action.ptr   equ  cmdb.struct + 40; Pointer to function to execute
0347      A72A     cmdb.cmdall       equ  cmdb.struct + 42; Current command including length-byte
0348      A72A     cmdb.cmdlen       equ  cmdb.struct + 42; Length of current command (MSB byte!)
0349      A72B     cmdb.cmd          equ  cmdb.struct + 43; Current command (80 bytes max.)
0350      A77C     cmdb.panhead.buf  equ  cmdb.struct +124; String buffer for pane header
0351      A7AE     cmdb.dflt.fname   equ  cmdb.struct +174; Default for filename
0352      A800     cmdb.free         equ  cmdb.struct +256; End of structure
0353               *--------------------------------------------------------------
0354               * Stevie value stack                  @>a800-a8ff   (256 bytes)
0355               *--------------------------------------------------------------
0356      A900     sp2.stktop        equ  >a900           ; \ SP2 stack >a800 - >a8ff
0357                                                      ; | The stack grows from high memory
0358                                                      ; / to low memory.
0359               *--------------------------------------------------------------
0360               * Scratchpad memory work copy         @>ad00-aeff   (256 bytes)
0361               *--------------------------------------------------------------
0362      7E00     cpu.scrpad.src    equ  >7e00           ; \ Dump of OS monitor scratchpad
0363                                                      ; / stored in cartridge ROM bank7.asm
0364               
0365      F000     cpu.scrpad.tgt    equ  >f000           ; \ Fixed memory location used for
0366                                                      ; | scratchpad backup/restore routines.
0367                                                      ; /
0368               
0369      8300     cpu.scrpad1       equ  >8300           ; Stevie primary scratchpad
0370               
0371      AD00     cpu.scrpad2       equ  >ad00           ; Stevie secondary scratchpad, used when
0372                                                      ; calling TI Basic/External programs
0373               
0374               *--------------------------------------------------------------
0375               * Farjump return stack                @>af00-afff   (256 bytes)
0376               *--------------------------------------------------------------
0377      B000     fj.bottom         equ  >b000           ; Return stack for trampoline function
0378                                                      ; Grows downwards from high to low.
0379               *--------------------------------------------------------------
0380               * Index                               @>b000-bfff  (4096 bytes)
0381               *--------------------------------------------------------------
0382      B000     idx.top           equ  >b000           ; Top of index
0383      1000     idx.size          equ  4096            ; Index size
0384               *--------------------------------------------------------------
0385               * Editor buffer                       @>c000-cfff  (4096 bytes)
0386               *--------------------------------------------------------------
0387      C000     edb.top           equ  >c000           ; Editor buffer high memory
0388      1000     edb.size          equ  4096            ; Editor buffer size
0389               *--------------------------------------------------------------
0390               * Frame buffer & Default devices      @>d000-dfff  (4096 bytes)
0391               *--------------------------------------------------------------
0392      D000     fb.top            equ  >d000           ; Frame buffer (80x30)
0393      0960     fb.size           equ  80*30           ; Frame buffer size
0394      D960     tv.printer.fname  equ  >d960           ; Default printer   (80 char)
0395      D9B0     tv.clip.fname     equ  >d9b0           ; Default clipboard (80 char)
0396               *--------------------------------------------------------------
0397               * Command buffer history              @>e000-efff  (4096 bytes)
0398               *--------------------------------------------------------------
0399      E000     cmdb.top          equ  >e000           ; Top of command history buffer
0400      1000     cmdb.size         equ  4096            ; Command buffer size
0401               *--------------------------------------------------------------
0402               * Heap                                @>f000-ffff  (4096 bytes)
0403               *--------------------------------------------------------------
0404      F000     heap.top          equ  >f000           ; Top of heap
0405               
0406               
0407               *--------------------------------------------------------------
0408               * Stevie specific equates
0409               *--------------------------------------------------------------
0410      0000     fh.fopmode.none           equ  0       ; No file operation in progress
0411      0001     fh.fopmode.readfile       equ  1       ; Read file from disk to memory
0412      0002     fh.fopmode.writefile      equ  2       ; Save file from memory to disk
0413      A028     rom0_kscan_out            equ  keycode1; Where to store value of key pressed
0414               
0415      0050     vdp.fb.toprow.sit         equ  >0050   ; VDP SIT address of 1st Framebuffer row
0416      1850     vdp.fb.toprow.tat         equ  >1850   ; VDP TAT address of 1st Framebuffer row
0417      1DF0     vdp.cmdb.toprow.tat       equ  >1800 + ((pane.botrow - 4) * 80)
0418                                                      ; VDP TAT address of 1st CMDB row
0419      0000     vdp.sit.base              equ  >0000   ; VDP SIT base address
0420      0780     vdp.sit.size              equ  (pane.botrow + 1) * 80
0421                                                      ; VDP SIT size 80 columns, 24/30 rows
0422      1800     vdp.tat.base              equ  >1800   ; VDP TAT base address
0423      9900     tv.colorize.reset         equ  >9900   ; Colorization off
0424      00FE     tv.1timeonly              equ  254     ; One-time only flag indicator
                   < stevie_b1.asm.61466
...
0270 21ED   42             text  'Build-ID  220202-2219300'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0009 610A 20A0  38         coc   @wbit11,config        ; ANYKEY pressed ?
     610C 200A     
0010 610E 160A  14         jne   edkey.keyscan.hook.clear
0011                                                   ; No, clear buffer and exit
0012                       ;------------------------------------------------------
0013                       ; Reset flags
0014                       ;------------------------------------------------------
0015 6110 40A0  34         szc   @wbit11,config        ; Reset ANYKEY
     6112 200A     
0016 6114 4820  54         szc   @w$0001,@kbflags      ; Remove keyboard buffer cleared flag
     6116 2002     
     6118 A026     
0017                       ;------------------------------------------------------
0018                       ; Key pressed
0019                       ;------------------------------------------------------
0020 611A C820  54         mov   @keycode1,@keycode2   ; Save as previous key
     611C A028     
     611E A02A     
0021 6120 0460  28         b     @edkey.key.process    ; Process key
     6122 6144     
0022                       ;------------------------------------------------------
0023                       ; Clear keyboard buffer if no key pressed
0024                       ;------------------------------------------------------
0025               edkey.keyscan.hook.clear:
0026 6124 C120  34         mov   @kbflags,tmp0         ; Get keyboard control flags
     6126 A026     
0027 6128 2120  38         coc   @w$0001,tmp0          ; Keyboard buffer already cleared?
     612A 2002     
0028 612C 1309  14         jeq   edkey.keyscan.hook.exit
0029                                                   ; Yes, skip to exit
0030               
0031 612E 04E0  34         clr   @keycode1             ; \
     6130 A028     
0032 6132 04E0  34         clr   @keycode2             ; | Clear keyboard buffer and set
     6134 A02A     
0033 6136 0264  22         ori   tmp0,kbf.kbclear      ; | keyboard buffer cleared flag
     6138 0001     
0034 613A C804  38         mov   tmp0,@kbflags         ; /
     613C A026     
0035                       ;------------------------------------------------------
0036                       ; Keyboard debounce
0037                       ;------------------------------------------------------
0038               edkey.keyscan.hook.debounce:
0039 613E 1000  14         nop                         ; No purpose anymore, but branched to
...
0046 6140 0460  28         b     @hookok               ; Return
     6142 2DDC     
                   < stevie_b1.asm.61466
...
0008 6144 C160  34         mov   @keycode1,tmp1        ; Get key pressed
     6146 A028     
0009 6148 0A85  56         sla   tmp1,8                ; Move to MSB
0010 614A 0707  14         seto  tmp3                  ; EOL marker
0011                       ;-------------------------------------------------------
0012                       ; (1) Process key depending on pane with focus
0013                       ;-------------------------------------------------------
0014 614C C1A0  34         mov   @tv.pane.focus,tmp2
     614E A222     
0015 6150 0286  22         ci    tmp2,pane.focus.fb    ; Framebuffer has focus ?
     6152 0000     
0016 6154 1307  14         jeq   edkey.key.process.special
0017                                                   ; First check special key combinations
0018               
0019 6156 0286  22         ci    tmp2,pane.focus.cmdb  ; Command buffer has focus ?
     6158 0001     
0020 615A 1322  14         jeq   edkey.key.process.loadmap.cmdb
0021                                                   ; Yes, so load CMDB keymap
0022                       ;-------------------------------------------------------
0023                       ; Pane without focus, crash
0024                       ;-------------------------------------------------------
0025 615C C80B  38         mov   r11,@>ffce            ; \ Save caller address
     615E FFCE     
0026 6160 06A0  32         bl    @cpu.crash            ; / File error occured. Halt system.
     6162 2026     
0027                       ;-------------------------------------------------------
0028                       ; (2) Check special key combination
0029                       ;-------------------------------------------------------
0030               edkey.key.process.special:
0031 6164 0285  22         ci    tmp1,>2000            ; Space key pressed?
     6166 2000     
0032 6168 1618  14         jne   edkey.key.process.loadmap.editor
0033                                                   ; No, continue with normal checks
0034                       ;-------------------------------------------------------
0035                       ; (2a) Look for <ctrl> key
0036                       ;-------------------------------------------------------
0037 616A 0649  14         dect  stack
0038 616C C644  30         mov   tmp0,*stack           ; Push tmp0
0039 616E 0649  14         dect  stack
0040 6170 C645  30         mov   tmp1,*stack           ; Push tmp1
0041 6172 0649  14         dect  stack
0042 6174 C64C  30         mov   r12,*stack            ; Push r12
0043               
0044 6176 04C4  14         clr   tmp0                  ; Keyboard column 0
0045 6178 020C  20         li    r12,>0024             ; CRU address decoder
     617A 0024     
0046 617C 30C4  56         ldcr  tmp0,3                ; Select column
0047 617E 020C  20         li    r12,>0006             ; Address of the first row
     6180 0006     
0048 6182 3605  64         stcr  tmp1,8                ; Read 8 rows
0049 6184 0245  22         andi  tmp1,>4000            ; Test ctrl key
     6186 4000     
0050 6188 1605  14         jne   edkey.key.process.special.postprocess
0051                                                   ; No ctrl key pressed
0052                       ;-------------------------------------------------------
0053                       ; <ctrl> + space key pressed
0054                       ;-------------------------------------------------------
0055 618A C339  30         mov   *stack+,r12           ; Pop r12
0056 618C C179  30         mov   *stack+,tmp1          ; Pop tmp1
0057 618E C139  30         mov   *stack+,tmp0          ; Pop tmp0
0058 6190 0460  28         b     @edkey.action.block.mark
     6192 681E     
...
0064 6194 C339  30         mov   *stack+,r12           ; Pop r12
0065 6196 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0066 6198 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0067                       ;-------------------------------------------------------
0068                       ; (3) Load Editor keyboard map
0069                       ;-------------------------------------------------------
0070               edkey.key.process.loadmap.editor:
0071 619A 0206  20         li    tmp2,keymap_actions.editor
     619C 7C40     
0072 619E 1002  14         jmp   edkey.key.check.next
0073                       ;-------------------------------------------------------
0074                       ; (4) Load CMDB keyboard map
0075                       ;-------------------------------------------------------
0076               edkey.key.process.loadmap.cmdb:
0077 61A0 0206  20         li    tmp2,keymap_actions.cmdb
     61A2 7D0A     
0078                       ;-------------------------------------------------------
0079                       ; (5) Iterate over keyboard map for matching action key
0080                       ;-------------------------------------------------------
0081               edkey.key.check.next:
0082 61A4 91D6  26         cb    *tmp2,tmp3            ; EOL reached ?
0083 61A6 1328  14         jeq   edkey.key.process.addbuffer
0084                                                   ; Yes, means no action key pressed,
0085                                                   ; so add character to buffer
0086                       ;-------------------------------------------------------
0087                       ; (6) Check for action key match
0088                       ;-------------------------------------------------------
0089 61A8 9585  30         cb    tmp1,*tmp2            ; Action key matched?
0090 61AA 130F  14         jeq   edkey.key.check.scope
0091                                                   ; Yes, check scope
0092                       ;-------------------------------------------------------
0093                       ; If key in range 'a..z' then also check 'A..Z'
0094                       ;-------------------------------------------------------
0095 61AC 0285  22         ci    tmp1,>6100            ; ASCII 97 'a'
     61AE 6100     
0096 61B0 1109  14         jlt   edkey.key.check.next.entry
0097               
0098 61B2 0285  22         ci    tmp1,>7a00            ; ASCII 122 'z'
     61B4 7A00     
0099 61B6 1506  14         jgt   edkey.key.check.next.entry
0100               
0101 61B8 0225  22         ai    tmp1,->2000           ; Make uppercase
     61BA E000     
0102 61BC 9585  30         cb    tmp1,*tmp2            ; Action key matched?
0103 61BE 1305  14         jeq   edkey.key.check.scope
0104                                                   ; Yes, check scope
0105                       ;-------------------------------------------------------
0106                       ; Key is no action key, keep case for later (buffer)
0107                       ;-------------------------------------------------------
0108 61C0 0225  22         ai    tmp1,>2000            ; Make lowercase
     61C2 2000     
0109               
0110               edkey.key.check.next.entry:
0111 61C4 0226  22         ai    tmp2,4                ; Skip current entry
     61C6 0004     
0112 61C8 10ED  14         jmp   edkey.key.check.next  ; Check next entry
0113                       ;-------------------------------------------------------
0114                       ; (7) Check scope of key
0115                       ;-------------------------------------------------------
0116               edkey.key.check.scope:
0117 61CA 0586  14         inc   tmp2                  ; Move to scope
0118 61CC 9816  46         cb    *tmp2,@tv.pane.focus+1
     61CE A223     
0119                                                   ; (1) Process key if scope matches pane
0120 61D0 1309  14         jeq   edkey.key.process.action
0121               
0122 61D2 9816  46         cb    *tmp2,@cmdb.dialog+1  ; (2) Process key if scope matches dialog
     61D4 A71B     
0123 61D6 1306  14         jeq   edkey.key.process.action
0124                       ;-------------------------------------------------------
0125                       ; (8) Key pressed outside valid scope, ignore action entry
0126                       ;-------------------------------------------------------
0127 61D8 0226  22         ai    tmp2,3                ; Skip current entry
     61DA 0003     
0128 61DC C160  34         mov   @keycode1,tmp1        ; Restore original case of key
     61DE A028     
0129 61E0 0A85  56         sla   tmp1,8                ; Move to MSB
0130 61E2 10E0  14         jmp   edkey.key.check.next  ; Process next action entry
0131                       ;-------------------------------------------------------
0132                       ; (9) Trigger keyboard action
0133                       ;-------------------------------------------------------
0134               edkey.key.process.action:
0135 61E4 0586  14         inc   tmp2                  ; Move to action address
0136 61E6 C196  26         mov   *tmp2,tmp2            ; Get action address
0137               
0138 61E8 0204  20         li    tmp0,id.dialog.unsaved
     61EA 0065     
0139 61EC 8120  34         c     @cmdb.dialog,tmp0
     61EE A71A     
0140 61F0 1302  14         jeq   !                     ; Skip store pointer if in "Unsaved changes"
0141               
0142 61F2 C806  38         mov   tmp2,@cmdb.action.ptr ; Store action address as pointer
     61F4 A728     
0143 61F6 0456  20 !       b     *tmp2                 ; Process key action
0144                       ;-------------------------------------------------------
0145                       ; (10) Add character to editor or cmdb buffer
0146                       ;-------------------------------------------------------
0147               edkey.key.process.addbuffer:
0148 61F8 C120  34         mov   @tv.pane.focus,tmp0   ; Frame buffer has focus?
     61FA A222     
0149 61FC 1602  14         jne   !                     ; No, skip frame buffer
0150 61FE 0460  28         b     @edkey.action.char    ; Add character to frame buffer
     6200 6708     
0151                       ;-------------------------------------------------------
0152                       ; (11) CMDB buffer
0153                       ;-------------------------------------------------------
0154 6202 0284  22 !       ci    tmp0,pane.focus.cmdb  ; CMDB has focus ?
     6204 0001     
0155 6206 1607  14         jne   edkey.key.process.crash
0156                                                   ; No, crash
0157                       ;-------------------------------------------------------
0158                       ; Don't add character if dialog has ID >= 100
0159                       ;-------------------------------------------------------
0160 6208 C120  34         mov   @cmdb.dialog,tmp0
     620A A71A     
0161 620C 0284  22         ci    tmp0,99
     620E 0063     
0162 6210 1506  14         jgt   edkey.key.process.exit
0163                       ;-------------------------------------------------------
0164                       ; Add character to CMDB
0165                       ;-------------------------------------------------------
0166 6212 0460  28         b     @edkey.action.cmdb.char
     6214 6984     
...
0172 6216 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     6218 FFCE     
0173 621A 06A0  32         bl    @cpu.crash            ; / File error occured. Halt system.
     621C 2026     
0174                       ;-------------------------------------------------------
0175                       ; Exit
0176                       ;-------------------------------------------------------
0177               edkey.key.process.exit:
0178 621E 0460  28         b     @edkey.keyscan.hook.debounce
     6220 613E     
...
0008 6222 C120  34         mov   @fb.column,tmp0
     6224 A30C     
0009 6226 1308  14         jeq   !                     ; column=0 ? Skip further processing
0010                       ;-------------------------------------------------------
0011                       ; Update
0012                       ;-------------------------------------------------------
0013 6228 0620  34         dec   @fb.column            ; Column-- in screen buffer
     622A A30C     
0014 622C 0620  34         dec   @wyx                  ; Column-- VDP cursor
     622E 832A     
0015 6230 0620  34         dec   @fb.current
     6232 A302     
0016 6234 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6236 A318     
0017                       ;-------------------------------------------------------
0018                       ; Exit
0019                       ;-------------------------------------------------------
0020 6238 0460  28 !       b     @edkey.keyscan.hook.debounce; Back to editor main
     623A 613E     
0021               
0022               
0023               *---------------------------------------------------------------
...
0027 623C 8820  54         c     @fb.column,@fb.row.length
     623E A30C     
     6240 A308     
0028 6242 1408  14         jhe   !                     ; column > length line ? Skip processing
0029                       ;-------------------------------------------------------
0030                       ; Update
0031                       ;-------------------------------------------------------
0032 6244 05A0  34         inc   @fb.column            ; Column++ in screen buffer
     6246 A30C     
0033 6248 05A0  34         inc   @wyx                  ; Column++ VDP cursor
     624A 832A     
0034 624C 05A0  34         inc   @fb.current
     624E A302     
0035 6250 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6252 A318     
0036                       ;-------------------------------------------------------
0037                       ; Exit
0038                       ;-------------------------------------------------------
0039 6254 0460  28 !       b     @edkey.keyscan.hook.debounce; Back to editor main
     6256 613E     
0040               
0041               
0042               *---------------------------------------------------------------
...
0046 6258 06A0  32         bl    @fb.cursor.home       ; Move cursor to beginning of line
     625A 6E66     
0047                       ;-------------------------------------------------------
0048                       ; Exit
0049                       ;-------------------------------------------------------
0050 625C 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     625E 613E     
0051               
0052               
0053               *---------------------------------------------------------------
...
0057 6260 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6262 A318     
0058 6264 C120  34         mov   @fb.row.length,tmp0   ; \ Get row length
     6266 A308     
0059 6268 0284  22         ci    tmp0,80               ; | Adjust if necessary, normally cursor
     626A 0050     
0060 626C 1102  14         jlt   !                     ; | is right of last character on line,
0061 626E 0204  20         li    tmp0,79               ; / except if 80 characters on line.
     6270 004F     
0062                       ;-------------------------------------------------------
0063                       ; Set cursor X position
0064                       ;-------------------------------------------------------
0065 6272 C804  38 !       mov   tmp0,@fb.column       ; Set X position, cursor following char.
     6274 A30C     
0066 6276 06A0  32         bl    @xsetx                ; Set VDP cursor column position
     6278 26F2     
0067 627A 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     627C 6D68     
0068                       ;-------------------------------------------------------
0069                       ; Exit
0070                       ;-------------------------------------------------------
0071 627E 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     6280 613E     
                   < stevie_b1.asm.61466
...
0008 6282 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6284 A318     
0009 6286 C120  34         mov   @fb.column,tmp0
     6288 A30C     
0010 628A 1322  14         jeq   !                     ; column=0 ? Skip further processing
0011                       ;-------------------------------------------------------
0012                       ; Prepare 2 char buffer
0013                       ;-------------------------------------------------------
0014 628C C160  34         mov   @fb.current,tmp1      ; Get pointer to char in frame buffer
     628E A302     
0015 6290 0707  14         seto  tmp3                  ; Fill 2 char buffer with >ffff
0016 6292 1003  14         jmp   edkey.action.pword_scan_char
0017                       ;-------------------------------------------------------
0018                       ; Scan backwards to first character following space
0019                       ;-------------------------------------------------------
0020               edkey.action.pword_scan
0021 6294 0605  14         dec   tmp1
0022 6296 0604  14         dec   tmp0                  ; Column-- in screen buffer
0023 6298 1315  14         jeq   edkey.action.pword_done
0024                                                   ; Column=0 ? Skip further processing
0025                       ;-------------------------------------------------------
0026                       ; Check character
0027                       ;-------------------------------------------------------
0028               edkey.action.pword_scan_char
0029 629A D195  26         movb  *tmp1,tmp2            ; Get character
0030 629C 0987  56         srl   tmp3,8                ; Shift-out old character in buffer
0031 629E D1C6  18         movb  tmp2,tmp3             ; Shift-in new character in buffer
0032 62A0 0986  56         srl   tmp2,8                ; Right justify
0033 62A2 0286  22         ci    tmp2,32               ; Space character found?
     62A4 0020     
0034 62A6 16F6  14         jne   edkey.action.pword_scan
0035                                                   ; No space found, try again
0036                       ;-------------------------------------------------------
0037                       ; Space found, now look closer
0038                       ;-------------------------------------------------------
0039 62A8 0287  22         ci    tmp3,>2020            ; current and previous char both spaces?
     62AA 2020     
0040 62AC 13F3  14         jeq   edkey.action.pword_scan
0041                                                   ; Yes, so continue scanning
0042 62AE 0287  22         ci    tmp3,>20ff            ; First character is space
     62B0 20FF     
0043 62B2 13F0  14         jeq   edkey.action.pword_scan
0044                       ;-------------------------------------------------------
0045                       ; Check distance travelled
0046                       ;-------------------------------------------------------
0047 62B4 C1E0  34         mov   @fb.column,tmp3       ; re-use tmp3
     62B6 A30C     
0048 62B8 61C4  18         s     tmp0,tmp3
0049 62BA 0287  22         ci    tmp3,2                ; Did we move at least 2 positions?
     62BC 0002     
0050 62BE 11EA  14         jlt   edkey.action.pword_scan
0051                                                   ; Didn't move enough so keep on scanning
0052                       ;--------------------------------------------------------
0053                       ; Set cursor following space
0054                       ;--------------------------------------------------------
0055 62C0 0585  14         inc   tmp1
0056 62C2 0584  14         inc   tmp0                  ; Column++ in screen buffer
0057                       ;-------------------------------------------------------
0058                       ; Save position and position hardware cursor
0059                       ;-------------------------------------------------------
0060               edkey.action.pword_done:
0061 62C4 C804  38         mov   tmp0,@fb.column       ; tmp0 also input for @xsetx
     62C6 A30C     
0062 62C8 06A0  32         bl    @xsetx                ; Set VDP cursor X
     62CA 26F2     
0063                       ;-------------------------------------------------------
0064                       ; Exit
0065                       ;-------------------------------------------------------
0066               edkey.action.pword.exit:
0067 62CC 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     62CE 6D68     
0068 62D0 0460  28 !       b     @edkey.keyscan.hook.debounce; Back to editor main
     62D2 613E     
0069               
0070               
0071               
...
0076 62D4 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     62D6 A318     
0077 62D8 04C8  14         clr   tmp4                  ; Reset multiple spaces mode
0078 62DA C120  34         mov   @fb.column,tmp0
     62DC A30C     
0079 62DE 8804  38         c     tmp0,@fb.row.length
     62E0 A308     
0080 62E2 1426  14         jhe   !                     ; column=last char ? Skip further processing
0081                       ;-------------------------------------------------------
0082                       ; Prepare 2 char buffer
0083                       ;-------------------------------------------------------
0084 62E4 C160  34         mov   @fb.current,tmp1      ; Get pointer to char in frame buffer
     62E6 A302     
0085 62E8 0707  14         seto  tmp3                  ; Fill 2 char buffer with >ffff
0086 62EA 1006  14         jmp   edkey.action.nword_scan_char
0087                       ;-------------------------------------------------------
0088                       ; Multiple spaces mode
0089                       ;-------------------------------------------------------
0090               edkey.action.nword_ms:
0091 62EC 0708  14         seto  tmp4                  ; Set multiple spaces mode
0092                       ;-------------------------------------------------------
0093                       ; Scan forward to first character following space
0094                       ;-------------------------------------------------------
0095               edkey.action.nword_scan
0096 62EE 0585  14         inc   tmp1
0097 62F0 0584  14         inc   tmp0                  ; Column++ in screen buffer
0098 62F2 8804  38         c     tmp0,@fb.row.length
     62F4 A308     
0099 62F6 1316  14         jeq   edkey.action.nword_done
0100                                                   ; Column=last char ? Skip further processing
0101                       ;-------------------------------------------------------
0102                       ; Check character
0103                       ;-------------------------------------------------------
0104               edkey.action.nword_scan_char
0105 62F8 D195  26         movb  *tmp1,tmp2            ; Get character
0106 62FA 0987  56         srl   tmp3,8                ; Shift-out old character in buffer
0107 62FC D1C6  18         movb  tmp2,tmp3             ; Shift-in new character in buffer
0108 62FE 0986  56         srl   tmp2,8                ; Right justify
0109               
0110 6300 0288  22         ci    tmp4,>ffff            ; Multiple space mode on?
     6302 FFFF     
0111 6304 1604  14         jne   edkey.action.nword_scan_char_other
0112                       ;-------------------------------------------------------
0113                       ; Special handling if multiple spaces found
0114                       ;-------------------------------------------------------
0115               edkey.action.nword_scan_char_ms:
0116 6306 0286  22         ci    tmp2,32
     6308 0020     
0117 630A 160C  14         jne   edkey.action.nword_done
0118                                                   ; Exit if non-space found
0119 630C 10F0  14         jmp   edkey.action.nword_scan
0120                       ;-------------------------------------------------------
0121                       ; Normal handling
0122                       ;-------------------------------------------------------
0123               edkey.action.nword_scan_char_other:
0124 630E 0286  22         ci    tmp2,32               ; Space character found?
     6310 0020     
0125 6312 16ED  14         jne   edkey.action.nword_scan
0126                                                   ; No space found, try again
0127                       ;-------------------------------------------------------
0128                       ; Space found, now look closer
0129                       ;-------------------------------------------------------
0130 6314 0287  22         ci    tmp3,>2020            ; current and previous char both spaces?
     6316 2020     
0131 6318 13E9  14         jeq   edkey.action.nword_ms
0132                                                   ; Yes, so continue scanning
0133 631A 0287  22         ci    tmp3,>20ff            ; First characer is space?
     631C 20FF     
0134 631E 13E7  14         jeq   edkey.action.nword_scan
0135                       ;--------------------------------------------------------
0136                       ; Set cursor following space
0137                       ;--------------------------------------------------------
0138 6320 0585  14         inc   tmp1
0139 6322 0584  14         inc   tmp0                  ; Column++ in screen buffer
0140                       ;-------------------------------------------------------
0141                       ; Save position and position hardware cursor
0142                       ;-------------------------------------------------------
0143               edkey.action.nword_done:
0144 6324 C804  38         mov   tmp0,@fb.column       ; tmp0 also input for @xsetx
     6326 A30C     
0145 6328 06A0  32         bl    @xsetx                ; Set VDP cursor X
     632A 26F2     
0146                       ;-------------------------------------------------------
0147                       ; Exit
0148                       ;-------------------------------------------------------
0149               edkey.action.nword.exit:
0150 632C 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     632E 6D68     
0151 6330 0460  28 !       b     @edkey.keyscan.hook.debounce; Back to editor main
     6332 613E     
0152               
0153               
                   < stevie_b1.asm.61466
...
0008 6334 06A0  32         bl    @fb.cursor.up         ; Move cursor up
     6336 6D90     
0009                       ;-------------------------------------------------------
0010                       ; Exit
0011                       ;-------------------------------------------------------
0012               edkey.action.up.exit:
0013 6338 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     633A 613E     
0014               
0015               
0016               
...
0021 633C 06A0  32         bl    @fb.cursor.down       ; Move cursor down
     633E 6DEE     
0022                       ;-------------------------------------------------------
0023                       ; Exit
0024                       ;-------------------------------------------------------
0025               edkey.action.down.exit:
0026 6340 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     6342 613E     
                   < stevie_b1.asm.61466
...
0008 6344 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6346 A318     
0009                       ;-------------------------------------------------------
0010                       ; Crunch current row if dirty
0011                       ;-------------------------------------------------------
0012 6348 8820  54         c     @fb.row.dirty,@w$ffff
     634A A30A     
     634C 2022     
0013 634E 1604  14         jne   edkey.action.ppage.sanity
0014 6350 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     6352 701E     
0015 6354 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     6356 A30A     
0016                       ;-------------------------------------------------------
0017                       ; Assert
0018                       ;-------------------------------------------------------
0019               edkey.action.ppage.sanity:
0020 6358 C120  34         mov   @fb.topline,tmp0      ; Exit if already on line 1
     635A A304     
0021 635C 130F  14         jeq   edkey.action.ppage.exit
0022                       ;-------------------------------------------------------
0023                       ; Special treatment top page
0024                       ;-------------------------------------------------------
0025 635E 8804  38         c     tmp0,@fb.scrrows      ; topline > rows on screen?
     6360 A31A     
0026 6362 1503  14         jgt   edkey.action.ppage.topline
0027 6364 04E0  34         clr   @fb.topline           ; topline = 0
     6366 A304     
0028 6368 1003  14         jmp   edkey.action.ppage.refresh
0029                       ;-------------------------------------------------------
0030                       ; Adjust topline
0031                       ;-------------------------------------------------------
0032               edkey.action.ppage.topline:
0033 636A 6820  54         s     @fb.scrrows,@fb.topline
     636C A31A     
     636E A304     
0034                       ;-------------------------------------------------------
0035                       ; Refresh page
...
0038 6370 C820  54         mov   @fb.topline,@parm1
     6372 A304     
     6374 A006     
0039 6376 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     6378 A310     
0040               
0041 637A 1078  14         jmp   edkey.goto.fb.toprow  ; \ Position cursor and exit
0042                                                   ; / i  @parm1 = Line in editor buffer
0043                       ;-------------------------------------------------------
0044                       ; Exit
0045                       ;-------------------------------------------------------
0046               edkey.action.ppage.exit:
0047 637C 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     637E 613E     
0048               
0049               
0050               
...
0056 6380 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6382 A318     
0057                       ;-------------------------------------------------------
0058                       ; Crunch current row if dirty
0059                       ;-------------------------------------------------------
0060 6384 8820  54         c     @fb.row.dirty,@w$ffff
     6386 A30A     
     6388 2022     
0061 638A 1604  14         jne   edkey.action.npage.sanity
0062 638C 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     638E 701E     
0063 6390 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     6392 A30A     
0064                       ;-------------------------------------------------------
0065                       ; Assert
0066                       ;-------------------------------------------------------
0067               edkey.action.npage.sanity:
0068 6394 C120  34         mov   @fb.topline,tmp0
     6396 A304     
0069 6398 A120  34         a     @fb.scrrows,tmp0
     639A A31A     
0070 639C 0584  14         inc   tmp0                  ; Base 1 offset !
0071 639E 8804  38         c     tmp0,@edb.lines       ; Exit if on last page
     63A0 A504     
0072 63A2 1509  14         jgt   edkey.action.npage.exit
0073                       ;-------------------------------------------------------
0074                       ; Adjust topline
0075                       ;-------------------------------------------------------
0076               edkey.action.npage.topline:
0077 63A4 A820  54         a     @fb.scrrows,@fb.topline
     63A6 A31A     
     63A8 A304     
0078                       ;-------------------------------------------------------
0079                       ; Refresh page
...
0082 63AA C820  54         mov   @fb.topline,@parm1
     63AC A304     
     63AE A006     
0083 63B0 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     63B2 A310     
0084               
0085 63B4 105B  14         jmp   edkey.goto.fb.toprow  ; \ Position cursor and exit
0086                                                   ; / i  @parm1 = Line in editor buffer
0087                       ;-------------------------------------------------------
0088                       ; Exit
0089                       ;-------------------------------------------------------
0090               edkey.action.npage.exit:
0091 63B6 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     63B8 613E     
                   < stevie_b1.asm.61466
...
0010                       ;-------------------------------------------------------
0011 63BA 8820  54         c     @fb.row.dirty,@w$ffff
     63BC A30A     
     63BE 2022     
0012 63C0 1604  14         jne   edkey.action.top.refresh
0013 63C2 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     63C4 701E     
0014 63C6 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     63C8 A30A     
0015                       ;-------------------------------------------------------
0016                       ; Refresh page
0017                       ;-------------------------------------------------------
0018               edkey.action.top.refresh:
0019 63CA 04E0  34         clr   @parm1                ; Set to 1st line in editor buffer
     63CC A006     
0020 63CE 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     63D0 A310     
0021               
0022 63D2 0460  28         b     @edkey.goto.fb.toprow ; \ Position cursor and exit
     63D4 646C     
...
0032                       ;-------------------------------------------------------
0033 63D6 8820  54         c     @fb.row.dirty,@w$ffff
     63D8 A30A     
     63DA 2022     
0034 63DC 1604  14         jne   edkey.action.topscr.refresh
0035 63DE 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     63E0 701E     
0036 63E2 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     63E4 A30A     
0037               edkey.action.topscr.refresh:
0038 63E6 C820  54         mov   @fb.topline,@parm1    ; Set to top line in frame buffer
     63E8 A304     
     63EA A006     
0039 63EC 0460  28         b     @edkey.goto.fb.toprow ; \ Position cursor and exit
     63EE 646C     
...
0050                       ;-------------------------------------------------------
0051 63F0 8820  54         c     @fb.row.dirty,@w$ffff
     63F2 A30A     
     63F4 2022     
0052 63F6 1604  14         jne   edkey.action.bot.refresh
0053 63F8 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     63FA 701E     
0054 63FC 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     63FE A30A     
0055                       ;-------------------------------------------------------
0056                       ; Refresh page
0057                       ;-------------------------------------------------------
0058               edkey.action.bot.refresh:
0059 6400 8820  54         c     @edb.lines,@fb.scrrows
     6402 A504     
     6404 A31A     
0060 6406 120A  14         jle   edkey.action.bot.exit ; Skip if whole editor buffer on screen
0061               
0062 6408 C120  34         mov   @edb.lines,tmp0
     640A A504     
0063 640C 6120  34         s     @fb.scrrows,tmp0
     640E A31A     
0064 6410 C804  38         mov   tmp0,@parm1           ; Set to last page in editor buffer
     6412 A006     
0065 6414 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     6416 A310     
0066               
0067 6418 0460  28         b     @edkey.goto.fb.toprow ; \ Position cursor and exit
     641A 646C     
...
0073 641C 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     641E 613E     
0074               
0075               
0076               
...
0081 6420 0649  14         dect  stack
0082 6422 C644  30         mov   tmp0,*stack           ; Push tmp0
0083                       ;-------------------------------------------------------
0084                       ; Crunch current row if dirty
0085                       ;-------------------------------------------------------
0086 6424 8820  54         c     @fb.row.dirty,@w$ffff
     6426 A30A     
     6428 2022     
0087 642A 1604  14         jne   edkey.action.botscr.cursor
0088 642C 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     642E 701E     
0089 6430 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     6432 A30A     
0090                       ;-------------------------------------------------------
0091                       ; Position cursor
0092                       ;-------------------------------------------------------
0093               edkey.action.botscr.cursor:
0094 6434 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6436 A318     
0095               
0096 6438 8820  54         c     @fb.scrrows,@edb.lines
     643A A31A     
     643C A504     
0097 643E 1503  14         jgt   edkey.action.botscr.eof
0098 6440 C120  34         mov   @fb.scrrows,tmp0      ; Get bottom row
     6442 A31A     
0099 6444 1002  14         jmp   !
0100                       ;-------------------------------------------------------
0101                       ; Cursor at EOF
0102                       ;-------------------------------------------------------
0103               edkey.action.botscr.eof:
0104 6446 C120  34         mov   @edb.lines,tmp0       ; Get last line in file
     6448 A504     
0105                       ;-------------------------------------------------------
0106                       ; Position cursor
0107                       ;-------------------------------------------------------
0108 644A 0604  14 !       dec   tmp0                  ; Base 0
0109 644C C804  38         mov   tmp0,@fb.row          ; Frame buffer bottom line
     644E A306     
0110 6450 04E0  34         clr   @fb.column            ; Frame buffer column 0
     6452 A30C     
0111               
0112 6454 C120  34         mov   @fb.row,tmp0          ;
     6456 A306     
0113 6458 0A84  56         sla   tmp0,8                ; Position cursor
0114 645A C804  38         mov   tmp0,@wyx             ;
     645C 832A     
0115               
0116 645E 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6460 6D68     
0117               
0118 6462 06A0  32         bl    @edb.line.getlength2  ; \ Get length current line
     6464 3588     
...
0125 6466 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0126 6468 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     646A 613E     
                   < stevie_b1.asm.61466
...
0022 646C 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     646E A318     
0023               
0024 6470 06A0  32         bl    @fb.refresh           ; \ Refresh frame buffer
     6472 6F72     
0025                                                   ; | i  @parm1 = Line to start with
0026                                                   ; /             (becomes @fb.topline)
0027               
0028 6474 04E0  34         clr   @fb.row               ; Frame buffer line 0
     6476 A306     
0029 6478 04E0  34         clr   @fb.column            ; Frame buffer column 0
     647A A30C     
0030 647C 04E0  34         clr   @wyx                  ; Position VDP cursor
     647E 832A     
0031 6480 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6482 6D68     
0032               
0033 6484 06A0  32         bl    @edb.line.getlength2  ; \ Get length current line
     6486 3588     
0034                                                   ; | i  @fb.row        = Row in frame buffer
0035                                                   ; / o  @fb.row.length = Length of row
0036               
0037 6488 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     648A 613E     
0038               
0039               
0040               *---------------------------------------------------------------
...
0046                       ;-------------------------------------------------------
0047 648C 8820  54         c     @fb.row.dirty,@w$ffff
     648E A30A     
     6490 2022     
0048 6492 1609  14         jne   edkey.action.goto.refresh
0049               
0050 6494 0649  14         dect  stack
0051 6496 C660  46         mov   @parm1,*stack         ; Push parm1
     6498 A006     
0052 649A 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     649C 701E     
0053 649E C839  50         mov   *stack+,@parm1        ; Pop parm1
     64A0 A006     
0054               
0055 64A2 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     64A4 A30A     
0056                       ;-------------------------------------------------------
0057                       ; Refresh page
0058                       ;-------------------------------------------------------
0059               edkey.action.goto.refresh:
0060 64A6 0720  34         seto  @fb.colorize           ; Colorize M1/M2 marked lines (if present)
     64A8 A310     
0061               
0062 64AA 0460  28         b     @edkey.goto.fb.toprow  ; Position cursor and exit
     64AC 646C     
...
0008 64AE 0720  34         seto  @edb.dirty            ; Editor buffer dirty (text changed!)
     64B0 A506     
0009 64B2 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     64B4 6D68     
0010                       ;-------------------------------------------------------
0011                       ; Assert 1 - Empty line
0012                       ;-------------------------------------------------------
0013               edkey.action.del_char.sanity1:
0014 64B6 C1A0  34         mov   @fb.row.length,tmp2   ; Get line length
     64B8 A308     
0015 64BA 1336  14         jeq   edkey.action.del_char.exit
0016                                                   ; Exit if empty line
0017               
0018 64BC C120  34         mov   @fb.current,tmp0      ; Get pointer
     64BE A302     
0019                       ;-------------------------------------------------------
0020                       ; Assert 2 - Already at EOL
0021                       ;-------------------------------------------------------
0022               edkey.action.del_char.sanity2:
0023 64C0 C1C6  18         mov   tmp2,tmp3             ; \
0024 64C2 0607  14         dec   tmp3                  ; / tmp3 = line length - 1
0025 64C4 81E0  34         c     @fb.column,tmp3
     64C6 A30C     
0026 64C8 110A  14         jlt   edkey.action.del_char.sanity3
0027               
0028                       ;------------------------------------------------------
0029                       ; At EOL - clear current character
0030                       ;------------------------------------------------------
0031 64CA 04C5  14         clr   tmp1                  ; \ Overwrite with character >00
0032 64CC D505  30         movb  tmp1,*tmp0            ; /
0033 64CE C820  54         mov   @fb.column,@fb.row.length
     64D0 A30C     
     64D2 A308     
0034                                                   ; Row length - 1
0035 64D4 0720  34         seto  @fb.row.dirty         ; Current row needs to be crunched/packed
     64D6 A30A     
0036 64D8 0720  34         seto  @fb.dirty             ; Trigger screen refresh
     64DA A316     
0037 64DC 1025  14         jmp  edkey.action.del_char.exit
0038                       ;-------------------------------------------------------
0039                       ; Assert 3 - Abort if row length > 80
0040                       ;-------------------------------------------------------
0041               edkey.action.del_char.sanity3:
0042 64DE 0286  22         ci    tmp2,colrow
     64E0 0050     
0043 64E2 1204  14         jle   edkey.action.del_char.prep
0044                                                   ; Continue if row length <= 80
0045                       ;-----------------------------------------------------------------------
0046                       ; CPU crash
0047                       ;-----------------------------------------------------------------------
0048 64E4 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     64E6 FFCE     
0049 64E8 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     64EA 2026     
0050                       ;-------------------------------------------------------
0051                       ; Calculate number of characters to move
0052                       ;-------------------------------------------------------
0053               edkey.action.del_char.prep:
0054 64EC C1C6  18         mov   tmp2,tmp3             ; tmp3=line length
0055 64EE 61E0  34         s     @fb.column,tmp3
     64F0 A30C     
0056 64F2 0607  14         dec   tmp3                  ; Remove base 1 offset
0057 64F4 A107  18         a     tmp3,tmp0             ; tmp0=Pointer to last char in line
0058 64F6 C144  18         mov   tmp0,tmp1
0059 64F8 0585  14         inc   tmp1                  ; tmp1=tmp0+1
0060 64FA 61A0  34         s     @fb.column,tmp2       ; tmp2=amount of characters to move
     64FC A30C     
0061                       ;-------------------------------------------------------
0062                       ; Setup pointers
0063                       ;-------------------------------------------------------
0064 64FE C120  34         mov   @fb.current,tmp0      ; Get pointer
     6500 A302     
0065 6502 C144  18         mov   tmp0,tmp1             ; \ tmp0 = Current character
0066 6504 0585  14         inc   tmp1                  ; / tmp1 = Next character
0067                       ;-------------------------------------------------------
0068                       ; Loop from current character until end of line
0069                       ;-------------------------------------------------------
0070               edkey.action.del_char.loop:
0071 6506 DD35  42         movb  *tmp1+,*tmp0+         ; Overwrite current char with next char
0072 6508 0606  14         dec   tmp2
0073 650A 16FD  14         jne   edkey.action.del_char.loop
0074                       ;-------------------------------------------------------
0075                       ; Special treatment if line 80 characters long
0076                       ;-------------------------------------------------------
0077 650C 0206  20         li    tmp2,colrow
     650E 0050     
0078 6510 81A0  34         c     @fb.row.length,tmp2
     6512 A308     
0079 6514 1603  14         jne   edkey.action.del_char.save
0080 6516 0604  14         dec   tmp0                  ; One time adjustment
0081 6518 04C5  14         clr   tmp1
0082 651A D505  30         movb  tmp1,*tmp0            ; Write >00 character
0083                       ;-------------------------------------------------------
0084                       ; Save variables
0085                       ;-------------------------------------------------------
0086               edkey.action.del_char.save:
0087 651C 0720  34         seto  @fb.row.dirty         ; Current row needs to be crunched/packed
     651E A30A     
0088 6520 0720  34         seto  @fb.dirty             ; Trigger screen refresh
     6522 A316     
0089 6524 0620  34         dec   @fb.row.length        ; @fb.row.length--
     6526 A308     
0090                       ;-------------------------------------------------------
0091                       ; Exit
0092                       ;-------------------------------------------------------
0093               edkey.action.del_char.exit:
0094 6528 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     652A 613E     
0095               
0096               
0097               *---------------------------------------------------------------
...
0101 652C 0720  34         seto  @edb.dirty            ; Editor buffer dirty (text changed!)
     652E A506     
0102 6530 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6532 6D68     
0103 6534 C1A0  34         mov   @fb.row.length,tmp2   ; Get line length
     6536 A308     
0104 6538 1311  14         jeq   edkey.action.del_eol.exit
0105                                                   ; Exit if empty line
0106                       ;-------------------------------------------------------
0107                       ; Prepare for erase operation
0108                       ;-------------------------------------------------------
0109 653A C120  34         mov   @fb.current,tmp0      ; Get pointer
     653C A302     
0110 653E C1A0  34         mov   @fb.colsline,tmp2
     6540 A30E     
0111 6542 61A0  34         s     @fb.column,tmp2
     6544 A30C     
0112 6546 04C5  14         clr   tmp1
0113                       ;-------------------------------------------------------
0114                       ; Loop until last column in frame buffer
0115                       ;-------------------------------------------------------
0116               edkey.action.del_eol_loop:
0117 6548 DD05  32         movb  tmp1,*tmp0+           ; Overwrite current char with >00
0118 654A 0606  14         dec   tmp2
0119 654C 16FD  14         jne   edkey.action.del_eol_loop
0120                       ;-------------------------------------------------------
0121                       ; Save variables
0122                       ;-------------------------------------------------------
0123 654E 0720  34         seto  @fb.row.dirty         ; Current row needs to be crunched/packed
     6550 A30A     
0124 6552 0720  34         seto  @fb.dirty             ; Trigger screen refresh
     6554 A316     
0125               
0126 6556 C820  54         mov   @fb.column,@fb.row.length
     6558 A30C     
     655A A308     
...
0132 655C 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     655E 613E     
0133               
0134               
0135               *---------------------------------------------------------------
...
0141                       ;-------------------------------------------------------
0142 6560 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6562 6D68     
0143 6564 04E0  34         clr   @fb.row.dirty         ; Discard current line
     6566 A30A     
0144               
0145 6568 C820  54         mov   @fb.topline,@parm1    ; \
     656A A304     
     656C A006     
0146 656E A820  54         a     @fb.row,@parm1        ; | Line number to delete (base 1)
     6570 A306     
     6572 A006     
0147 6574 05A0  34         inc   @parm1                ; /
     6576 A006     
0148               
0149                       ;-------------------------------------------------------
0150                       ; Special handling if at BOT (no real line)
0151                       ;-------------------------------------------------------
0152 6578 8820  54         c     @parm1,@edb.lines     ; At BOT in editor buffer?
     657A A006     
     657C A504     
0153 657E 1207  14         jle   edkey.action.del_line.doit
0154                                                   ; No, is real line. Continue with delete.
0155               
0156 6580 C820  54         mov   @fb.topline,@parm1    ; Line to start with (becomes @fb.topline)
     6582 A304     
     6584 A006     
0157 6586 06A0  32         bl    @fb.refresh           ; Refresh frame buffer with EB content
     6588 6F72     
0158                                                   ; \ i  @parm1 = Line to start with
0159                                                   ; /
0160 658A 0460  28         b     @edkey.action.up      ; Move cursor one line up
     658C 6334     
0161                       ;-------------------------------------------------------
0162                       ; Delete line in editor buffer
0163                       ;-------------------------------------------------------
0164               edkey.action.del_line.doit:
0165 658E 06A0  32         bl    @edb.line.del         ; Delete line in editor buffer
     6590 7B48     
0166                                                   ; \ i  @parm1 = Line number to delete
0167                                                   ; /
0168               
0169 6592 8820  54         c     @parm1,@edb.lines     ; Now at BOT in editor buffer after delete?
     6594 A006     
     6596 A504     
0170 6598 1302  14         jeq   edkey.action.del_line.refresh
0171                                                   ; Yes, skip get length. No need for garbage.
0172                       ;-------------------------------------------------------
0173                       ; Get length of current row in frame buffer
0174                       ;-------------------------------------------------------
0175 659A 06A0  32         bl   @edb.line.getlength2   ; Get length of current row
     659C 3588     
...
0182 659E C820  54         mov   @fb.topline,@parm1    ; Line to start with (becomes @fb.topline)
     65A0 A304     
     65A2 A006     
0183               
0184 65A4 06A0  32         bl    @fb.refresh           ; Refresh frame buffer with EB content
     65A6 6F72     
0185                                                   ; \ i  @parm1 = Line to start with
0186                                                   ; /
0187               
0188 65A8 0720  34         seto  @edb.dirty            ; Editor buffer dirty (text changed!)
     65AA A506     
0189                       ;-------------------------------------------------------
0190                       ; Special treatment if current line was last line
0191                       ;-------------------------------------------------------
0192 65AC C120  34         mov   @fb.topline,tmp0
     65AE A304     
0193 65B0 A120  34         a     @fb.row,tmp0
     65B2 A306     
0194               
0195 65B4 8804  38         c     tmp0,@edb.lines       ; Was last line?
     65B6 A504     
0196 65B8 1102  14         jlt   edkey.action.del_line.exit
0197               
0198 65BA 0460  28         b     @edkey.action.up      ; Move cursor one line up
     65BC 6334     
0199                       ;-------------------------------------------------------
0200                       ; Exit
0201                       ;-------------------------------------------------------
0202               edkey.action.del_line.exit:
0203 65BE 0460  28         b     @edkey.action.home    ; Move cursor to home and return
     65C0 6258     
                   < stevie_b1.asm.61466
...
0010 65C2 0204  20         li    tmp0,>2000            ; White space
     65C4 2000     
0011 65C6 C804  38         mov   tmp0,@parm1
     65C8 A006     
0012               edkey.action.ins_char:
0013 65CA 0720  34         seto  @edb.dirty            ; Editor buffer dirty (text changed!)
     65CC A506     
0014 65CE 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     65D0 6D68     
0015                       ;-------------------------------------------------------
0016                       ; Check 1 - Empty line
0017                       ;-------------------------------------------------------
0018               edkey.actions.ins.char.empty_line:
0019 65D2 C120  34         mov   @fb.current,tmp0      ; Get pointer
     65D4 A302     
0020 65D6 C1A0  34         mov   @fb.row.length,tmp2   ; Get line length
     65D8 A308     
0021 65DA 133A  14         jeq   edkey.action.ins_char.append
0022                                                   ; Add character in append mode
0023                       ;-------------------------------------------------------
0024                       ; Check 2 - line-wrap if at character 80
0025                       ;-------------------------------------------------------
0026 65DC C160  34         mov   @fb.column,tmp1
     65DE A30C     
0027 65E0 0285  22         ci    tmp1,colrow-1         ; At 80th character?
     65E2 004F     
0028 65E4 1110  14         jlt   !
0029 65E6 C160  34         mov   @fb.row.length,tmp1
     65E8 A308     
0030 65EA 0285  22         ci    tmp1,colrow
     65EC 0050     
0031 65EE 160B  14         jne   !
0032                       ;-------------------------------------------------------
0033                       ; Wrap to new line
0034                       ;-------------------------------------------------------
0035 65F0 0649  14         dect  Stack
0036 65F2 C660  46         mov   @parm1,*stack         ; Save character to add
     65F4 A006     
0037 65F6 06A0  32         bl    @fb.cursor.down       ; Move cursor down 1 line
     65F8 6DEE     
0038 65FA 06A0  32         bl    @fb.insert.line       ; Insert empty line
     65FC 6E90     
0039 65FE C839  50         mov   *stack+,@parm1        ; Restore character to add
     6600 A006     
0040 6602 04C6  14         clr   tmp2                  ; Clear line length
0041 6604 1025  14         jmp   edkey.action.ins_char.append
0042                       ;-------------------------------------------------------
0043                       ; Check 3 - EOL
0044                       ;-------------------------------------------------------
0045 6606 8820  54 !       c     @fb.column,@fb.row.length
     6608 A30C     
     660A A308     
0046 660C 1321  14         jeq   edkey.action.ins_char.append
0047                                                   ; Add character in append mode
0048                       ;-------------------------------------------------------
0049                       ; Check 4 - Insert only until line length reaches 80th column
0050                       ;-------------------------------------------------------
0051 660E C160  34         mov   @fb.row.length,tmp1
     6610 A308     
0052 6612 0285  22         ci    tmp1,colrow
     6614 0050     
0053 6616 1101  14         jlt   edkey.action.ins_char.prep
0054 6618 101D  14         jmp   edkey.action.ins_char.exit
0055                       ;-------------------------------------------------------
0056                       ; Calculate number of characters to move
0057                       ;-------------------------------------------------------
0058               edkey.action.ins_char.prep:
0059 661A C1C6  18         mov   tmp2,tmp3             ; tmp3=line length
0060 661C 61E0  34         s     @fb.column,tmp3
     661E A30C     
0061 6620 0607  14         dec   tmp3                  ; Remove base 1 offset
0062 6622 A107  18         a     tmp3,tmp0             ; tmp0=Pointer to last char in line
0063 6624 C144  18         mov   tmp0,tmp1
0064 6626 0585  14         inc   tmp1                  ; tmp1=tmp0+1
0065 6628 61A0  34         s     @fb.column,tmp2       ; tmp2=amount of characters to move
     662A A30C     
0066                       ;-------------------------------------------------------
0067                       ; Loop from end of line until current character
0068                       ;-------------------------------------------------------
0069               edkey.action.ins_char.loop:
0070 662C D554  38         movb  *tmp0,*tmp1           ; Move char to the right
0071 662E 0604  14         dec   tmp0
0072 6630 0605  14         dec   tmp1
0073 6632 0606  14         dec   tmp2
0074 6634 16FB  14         jne   edkey.action.ins_char.loop
0075                       ;-------------------------------------------------------
0076                       ; Insert specified character at current position
0077                       ;-------------------------------------------------------
0078 6636 D560  46         movb  @parm1,*tmp1          ; MSB has character to insert
     6638 A006     
0079                       ;-------------------------------------------------------
0080                       ; Save variables and exit
0081                       ;-------------------------------------------------------
0082 663A 0720  34         seto  @fb.row.dirty         ; Current row needs to be crunched/packed
     663C A30A     
0083 663E 0720  34         seto  @fb.dirty             ; Trigger screen refresh
     6640 A316     
0084 6642 05A0  34         inc   @fb.column
     6644 A30C     
0085 6646 05A0  34         inc   @wyx
     6648 832A     
0086 664A 05A0  34         inc   @fb.row.length        ; @fb.row.length
     664C A308     
0087 664E 1002  14         jmp   edkey.action.ins_char.exit
0088                       ;-------------------------------------------------------
0089                       ; Add character in append mode
0090                       ;-------------------------------------------------------
0091               edkey.action.ins_char.append:
0092 6650 0460  28         b     @edkey.action.char.overwrite
     6652 672E     
0093                       ;-------------------------------------------------------
0094                       ; Exit
0095                       ;-------------------------------------------------------
0096               edkey.action.ins_char.exit:
0097 6654 0460  28         b     @edkey.keyscan.hook.debounce
     6656 613E     
...
0107 6658 04E0  34         clr   @parm1                ; Insert new line on curren line
     665A A006     
0108 665C 06A0  32         bl    @fb.insert.line       ; Insert new line
     665E 6E90     
0109                       ;-------------------------------------------------------
0110                       ; Exit
0111                       ;-------------------------------------------------------
0112               edkey.action.ins_line.exit:
0113 6660 0460  28         b     @edkey.keyscan.hook.debounce
     6662 613E     
...
0121 6664 0720  34         seto  @parm1                ; Insert new line on following line
     6666 A006     
0122 6668 06A0  32         bl    @fb.insert.line       ; Insert new line
     666A 6E90     
0123                       ;-------------------------------------------------------
0124                       ; Exit
0125                       ;-------------------------------------------------------
0126               edkey.action.ins_line_after.exit:
0127 666C 0460  28         b     @edkey.keyscan.hook.debounce
     666E 613E     
...
0012 6674 8820  54         c     @fb.row.dirty,@w$ffff
     6676 A30A     
     6678 2022     
0013 667A 1606  14         jne   edkey.action.enter.newline
...
0021 6688 C120  34         mov   @edb.insmode,tmp0     ; Insert mode or overwrite mode?
     668A A50A     
0022 668C 1304  14         jeq   edkey.action.enter.upd_counter
0023                                                   ; Overwrite mode, skip insert
0024               
0025 668E 0720  34         seto  @parm1                ; Insert line on following line
     6690 A006     
0026 6692 06A0  32         bl    @fb.insert.line       ; Insert a new line
     6694 6E90     
...
0033 6696 C120  34         mov   @fb.topline,tmp0
     6698 A304     
0034 669A A120  34         a     @fb.row,tmp0
     669C A306     
0035 669E 0584  14         inc   tmp0
0036 66A0 8804  38         c     tmp0,@edb.lines       ; Last line in editor buffer?
     66A2 A504     
0037 66A4 1102  14         jlt   edkey.action.newline  ; No, continue newline
0038 66A6 05A0  34         inc   @edb.lines            ; Total lines++
     66A8 A504     
0039                       ;-------------------------------------------------------
...
0045                       ;-------------------------------------------------------
0046 66AA C120  34         mov   @fb.scrrows,tmp0
     66AC A31A     
0047 66AE 0604  14         dec   tmp0
0048 66B0 8120  34         c     @fb.row,tmp0
     66B2 A306     
0049 66B4 110C  14         jlt   edkey.action.newline.down
0050                       ;-------------------------------------------------------
0051                       ; Scroll
0052                       ;-------------------------------------------------------
0053 66B6 C120  34         mov   @fb.scrrows,tmp0
     66B8 A31A     
0054 66BA C820  54         mov   @fb.topline,@parm1
     66BC A304     
     66BE A006     
0055 66C0 05A0  34         inc   @parm1
     66C2 A006     
0056 66C4 06A0  32         bl    @fb.refresh
     66C6 6F72     
0057 66C8 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     66CA A310     
0058 66CC 1004  14         jmp   edkey.action.newline.rest
0059                       ;-------------------------------------------------------
0060                       ; Move cursor down a row, there are still rows left
0061                       ;-------------------------------------------------------
0062               edkey.action.newline.down:
0063 66CE 05A0  34         inc   @fb.row               ; Row++ in screen buffer
     66D0 A306     
0064 66D2 06A0  32         bl    @down                 ; Row++ VDP cursor
     66D4 26E0     
0065                       ;-------------------------------------------------------
0066                       ; Set VDP cursor and save variables
0067                       ;-------------------------------------------------------
0068               edkey.action.newline.rest:
0069 66D6 06A0  32         bl    @fb.get.firstnonblank
     66D8 6F2A     
0070 66DA C120  34         mov   @outparm1,tmp0
     66DC A016     
0071 66DE C804  38         mov   tmp0,@fb.column
     66E0 A30C     
0072 66E2 06A0  32         bl    @xsetx                ; Set Column=tmp0 (VDP cursor)
     66E4 26F2     
0073 66E6 06A0  32         bl    @edb.line.getlength2  ; Get length of new row length
     66E8 3588     
0074 66EA 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     66EC 6D68     
0075 66EE 0720  34         seto  @fb.dirty             ; Trigger screen refresh
     66F0 A316     
0076                       ;-------------------------------------------------------
0077                       ; Exit
0078                       ;-------------------------------------------------------
0079               edkey.action.newline.exit:
0080 66F2 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     66F4 613E     
0081               
0082               
0083               
...
0089 66F6 0649  14         dect  stack
0090 66F8 C64B  30         mov   r11,*stack            ; Save return address
0091               
0092 66FA 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     66FC A318     
0093 66FE 0560  34         inv   @edb.insmode          ; Toggle insert/overwrite mode
     6700 A50A     
0094                       ;-------------------------------------------------------
0095                       ; Exit
0096                       ;-------------------------------------------------------
0097               edkey.action.ins_onoff.exit:
0098 6702 C2F9  30         mov   *stack+,r11           ; Pop r11
0099 6704 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     6706 613E     
0100               
0101               
0102               
...
0107 6708 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     670A A318     
0108                       ;-------------------------------------------------------
0109                       ; Asserts
0110                       ;-------------------------------------------------------
0111 670C D105  18         movb  tmp1,tmp0             ; Get keycode
0112 670E 0984  56         srl   tmp0,8                ; MSB to LSB
0113               
0114 6710 0284  22         ci    tmp0,32               ; Keycode < ASCII 32 ?
     6712 0020     
0115 6714 112B  14         jlt   edkey.action.char.exit
0116                                                   ; Yes, skip
0117               
0118 6716 0284  22         ci    tmp0,126              ; Keycode > ASCII 126 ?
     6718 007E     
0119 671A 1528  14         jgt   edkey.action.char.exit
0120                                                   ; Yes, skip
0121                       ;-------------------------------------------------------
0122                       ; Setup
0123                       ;-------------------------------------------------------
0124 671C 0720  34         seto  @edb.dirty            ; Editor buffer dirty (text changed!)
     671E A506     
0125 6720 D805  38         movb  tmp1,@parm1           ; Store character for insert
     6722 A006     
0126 6724 C120  34         mov   @edb.insmode,tmp0     ; Insert mode or overwrite mode?
     6726 A50A     
0127 6728 1302  14         jeq   edkey.action.char.overwrite
0128                       ;-------------------------------------------------------
0129                       ; Insert mode
0130                       ;-------------------------------------------------------
0131               edkey.action.char.insert:
0132 672A 0460  28         b     @edkey.action.ins_char
     672C 65CA     
0133                       ;-------------------------------------------------------
0134                       ; Overwrite mode - Write character
0135                       ;-------------------------------------------------------
0136               edkey.action.char.overwrite:
0137 672E 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6730 6D68     
0138 6732 C120  34         mov   @fb.current,tmp0      ; Get pointer
     6734 A302     
0139               
0140 6736 D520  46         movb  @parm1,*tmp0          ; Store character in editor buffer
     6738 A006     
0141 673A 0720  34         seto  @fb.row.dirty         ; Current row needs to be crunched/packed
     673C A30A     
0142 673E 0720  34         seto  @fb.dirty             ; Trigger screen refresh
     6740 A316     
0143                       ;-------------------------------------------------------
0144                       ; Last column on screen reached?
0145                       ;-------------------------------------------------------
0146 6742 C160  34         mov   @fb.column,tmp1       ; \ Columns are counted from 0 to 79.
     6744 A30C     
0147 6746 0285  22         ci    tmp1,colrow - 1       ; / Last column on screen?
     6748 004F     
0148 674A 1105  14         jlt   edkey.action.char.overwrite.incx
0149                                                   ; No, increase X position
0150               
0151 674C 0205  20         li    tmp1,colrow           ; \
     674E 0050     
0152 6750 C805  38         mov   tmp1,@fb.row.length   ; / Yes, Set row length and exit.
     6752 A308     
0153 6754 100B  14         jmp   edkey.action.char.exit
0154                       ;-------------------------------------------------------
0155                       ; Increase column
0156                       ;-------------------------------------------------------
0157               edkey.action.char.overwrite.incx:
0158 6756 05A0  34         inc   @fb.column            ; Column++ in screen buffer
     6758 A30C     
0159 675A 05A0  34         inc   @wyx                  ; Column++ VDP cursor
     675C 832A     
0160                       ;-------------------------------------------------------
0161                       ; Update line length in frame buffer
0162                       ;-------------------------------------------------------
0163 675E 8820  54         c     @fb.column,@fb.row.length
     6760 A30C     
     6762 A308     
0164                                                   ; column < line length ?
0165 6764 1103  14         jlt   edkey.action.char.exit
0166                                                   ; Yes, don't update row length
0167 6766 C820  54         mov   @fb.column,@fb.row.length
     6768 A30C     
     676A A308     
0168                                                   ; Set row length
0169                       ;-------------------------------------------------------
...
0173 676C 0460  28         b     @edkey.keyscan.hook.debounce; Back to editor main
     676E 613E     
                   < stevie_b1.asm.61466
...
0033 6A34 06A0  32         bl    @cpym2m
     6A36 24EE     
0034 6A38 A72A                   data cmdb.cmdlen,heap.top,80
     6A3A F000     
     6A3C 0050     
...
0037 6A82 06A0  32         bl    @cpym2m
     6A84 24EE     
0038 6A86 A72A                   data cmdb.cmdall,heap.top,80
     6A88 F000     
     6A8A 0050     
...
0037 6B04 06A0  32         bl    @cpym2m
     6B06 24EE     
0038 6B08 A72A                   data cmdb.cmdall,heap.top,80
     6B0A F000     
     6B0C 0050     
0039                                                   ; Copy filename from command line to buffer
0040                       ;-------------------------------------------------------
...
0031 6B6E 06A0  32         bl    @film
     6B70 224A     
0032 6B72 A72A                   data cmdb.cmdall,>00,80
     6B74 0000     
     6B76 0050     
0033               
...
0033 6BBA 06A0  32         bl    @cpym2m
     6BBC 24EE     
0034 6BBE A72A                   data cmdb.cmdall,tv.clip.fname,80
     6BC0 D9B0     
     6BC2 0050     
0035                                                   ; Copy filename from command line to buffer
0036               
...
0047 6BD4 37B4                   data txt.done.clipdev
0048                       ;-------------------------------------------------------
...
0037 6C14 06A0  32         bl    @cpym2m
     6C16 24EE     
0038 6C18 A72A                   data cmdb.cmdlen,heap.top,80
     6C1A F000     
     6C1C 0050     
0039                                                   ; Copy filename from command line to buffer
0040                       ;-------------------------------------------------------
...
0037 6C90 06A0  32         bl    @cpym2m
     6C92 24EE     
0038 6C94 A72A                   data cmdb.cmdlen,heap.top,80
     6C96 F000     
     6C98 0050     
0039                                                   ; Copy filename from command line to buffer
0040                       ;-------------------------------------------------------
...
0122 6D2A 04E0  34         clr   @cmdb.dialog.var      ; Reset to Help page 1
     6D2C A71C     
0123                       ;------------------------------------------------------
0124                       ; Erase header line
0125                       ;------------------------------------------------------
0126 6D2E 06A0  32         bl    @hchar
     6D30 27E6     
0127 6D32 0000                   byte 0,0,32,80*2
     6D34 20A0     
0128 6D36 FFFF                   data EOL
0129               
0130 6D38 1000  14         jmp   edkey.action.cmdb.close.dialog
0131               
0132               
0133               
0134               ***************************************************************
...
0148                       ; Close dialog
0149                       ;------------------------------------------------------
0150 6D3A 04E0  34         clr   @cmdb.dialog          ; Reset dialog ID
     6D3C A71A     
0151 6D3E 06A0  32         bl    @pane.cursor.blink    ; Show cursor
     6D40 74F2     
0152 6D42 06A0  32         bl    @pane.cmdb.hide       ; Hide command buffer pane
     6D44 7A30     
0153 6D46 0720  34         seto  @fb.status.dirty      ; Trigger status lines update
     6D48 A318     
0154                       ;-------------------------------------------------------
0155                       ; Exit
0156                       ;-------------------------------------------------------
0157               edkey.action.cmdb.close.dialog.exit:
0158 6D4A 0460  28         b     @edkey.keyscan.hook.debounce
     6D4C 613E     
...
0025 6D50 C64B  30         mov   r11,*stack            ; Save return address
0026 6D52 0649  14         dect  stack
0027 6D54 C644  30         mov   tmp0,*stack           ; Push tmp0
0028                       ;------------------------------------------------------
0029                       ; Calculate line in editor buffer
0030                       ;------------------------------------------------------
0031 6D56 C120  34         mov   @parm1,tmp0
     6D58 A006     
0032 6D5A A120  34         a     @fb.topline,tmp0
     6D5C A304     
0033 6D5E C804  38         mov   tmp0,@outparm1
     6D60 A016     
0034                       ;------------------------------------------------------
0035                       ; Exit
0036                       ;------------------------------------------------------
0037               fb.row2line.exit:
0038 6D62 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0039 6D64 C2F9  30         mov   *stack+,r11           ; Pop r11
0040 6D66 045B  20         b     *r11                  ; Return to caller
0041               
0042               
0043               
0044               
...
0068 6D68 0649  14         dect  stack
0069 6D6A C64B  30         mov   r11,*stack            ; Save return address
0070 6D6C 0649  14         dect  stack
0071 6D6E C644  30         mov   tmp0,*stack           ; Push tmp0
0072 6D70 0649  14         dect  stack
0073 6D72 C645  30         mov   tmp1,*stack           ; Push tmp1
0074                       ;------------------------------------------------------
0075                       ; Calculate pointer
0076                       ;------------------------------------------------------
0077 6D74 C120  34         mov   @fb.row,tmp0
     6D76 A306     
0078 6D78 3920  72         mpy   @fb.colsline,tmp0     ; tmp1 = row  * colsline
     6D7A A30E     
0079 6D7C A160  34         a     @fb.column,tmp1       ; tmp1 = tmp1 + column
     6D7E A30C     
0080 6D80 A160  34         a     @fb.top.ptr,tmp1      ; tmp1 = tmp1 + base
     6D82 A300     
0081 6D84 C805  38         mov   tmp1,@fb.current
     6D86 A302     
0082                       ;------------------------------------------------------
0083                       ; Exit
0084                       ;------------------------------------------------------
0085               fb.calc_pointer.exit:
0086 6D88 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0087 6D8A C139  30         mov   *stack+,tmp0          ; Pop tmp0
0088 6D8C C2F9  30         mov   *stack+,r11           ; Pop r11
0089 6D8E 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.61466
...
0019               ********|*****|*********************|**************************
0020               fb.cursor.up
0021 6D90 0649  14         dect  stack
0022 6D92 C64B  30         mov   r11,*stack            ; Save return address
0023                       ;-------------------------------------------------------
0024                       ; Crunch current line if dirty
0025                       ;-------------------------------------------------------
0026 6D94 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6D96 A318     
0027 6D98 8820  54         c     @fb.row.dirty,@w$ffff
     6D9A A30A     
     6D9C 2022     
0028 6D9E 1604  14         jne   fb.cursor.up.cursor
0029 6DA0 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     6DA2 701E     
0030 6DA4 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     6DA6 A30A     
0031                       ;-------------------------------------------------------
0032                       ; Move cursor
0033                       ;-------------------------------------------------------
0034               fb.cursor.up.cursor:
0035 6DA8 C120  34         mov   @fb.row,tmp0
     6DAA A306     
0036 6DAC 150B  14         jgt   fb.cursor.up.cursor_up
0037                                                   ; Move cursor up if fb.row > 0
0038 6DAE C120  34         mov   @fb.topline,tmp0      ; Do we need to scroll?
     6DB0 A304     
0039 6DB2 130C  14         jeq   fb.cursor.up.set_cursorx
0040                                                   ; At top, only position cursor X
0041                       ;-------------------------------------------------------
0042                       ; Scroll 1 line
0043                       ;-------------------------------------------------------
0044 6DB4 0604  14         dec   tmp0                  ; fb.topline--
0045 6DB6 C804  38         mov   tmp0,@parm1           ; Scroll one line up
     6DB8 A006     
0046               
0047 6DBA 06A0  32         bl    @fb.refresh           ; \ Refresh frame buffer
     6DBC 6F72     
0048                                                   ; | i  @parm1 = Line to start with
0049                                                   ; /             (becomes @fb.topline)
0050               
0051 6DBE 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     6DC0 A310     
0052 6DC2 1004  14         jmp   fb.cursor.up.set_cursorx
0053                       ;-------------------------------------------------------
0054                       ; Move cursor up
0055                       ;-------------------------------------------------------
0056               fb.cursor.up.cursor_up:
0057 6DC4 0620  34         dec   @fb.row               ; Row-- in screen buffer
     6DC6 A306     
0058 6DC8 06A0  32         bl    @up                   ; Row-- VDP cursor
     6DCA 26E8     
0059                       ;-------------------------------------------------------
0060                       ; Check line length and position cursor
0061                       ;-------------------------------------------------------
0062               fb.cursor.up.set_cursorx:
0063 6DCC 06A0  32         bl    @edb.line.getlength2  ; \ Get length current line
     6DCE 3588     
0064                                                   ; | i  @fb.row        = Row in frame buffer
0065                                                   ; / o  @fb.row.length = Length of row
0066               
0067 6DD0 8820  54         c     @fb.column,@fb.row.length
     6DD2 A30C     
     6DD4 A308     
0068 6DD6 1207  14         jle   fb.cursor.up.exit
0069                       ;-------------------------------------------------------
0070                       ; Adjust cursor column position
0071                       ;-------------------------------------------------------
0072 6DD8 C820  54         mov   @fb.row.length,@fb.column
     6DDA A308     
     6DDC A30C     
0073 6DDE C120  34         mov   @fb.column,tmp0
     6DE0 A30C     
0074 6DE2 06A0  32         bl    @xsetx                ; Set VDP cursor X
     6DE4 26F2     
0075                       ;-------------------------------------------------------
0076                       ; Exit
0077                       ;-------------------------------------------------------
0078               fb.cursor.up.exit:
0079 6DE6 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6DE8 6D68     
0080 6DEA C2F9  30         mov   *stack+,r11           ; Pop r11
0081 6DEC 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.61466
...
0019               ********|*****|*********************|**************************
0020               fb.cursor.down:
0021 6DEE 0649  14         dect  stack
0022 6DF0 C64B  30         mov   r11,*stack            ; Save return address
0023                       ;------------------------------------------------------
0024                       ; Last line?
0025                       ;------------------------------------------------------
0026 6DF2 8820  54         c     @fb.row,@edb.lines    ; Last line in editor buffer ?
     6DF4 A306     
     6DF6 A504     
0027 6DF8 1332  14         jeq   fb.cursor.down.exit
0028                                                   ; Yes, skip further processing
0029 6DFA 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6DFC A318     
0030                       ;-------------------------------------------------------
0031                       ; Crunch current row if dirty
0032                       ;-------------------------------------------------------
0033 6DFE 8820  54         c     @fb.row.dirty,@w$ffff
     6E00 A30A     
     6E02 2022     
0034 6E04 1604  14         jne   fb.cursor.down.move
0035 6E06 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     6E08 701E     
0036 6E0A 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     6E0C A30A     
0037                       ;-------------------------------------------------------
0038                       ; Move cursor
0039                       ;-------------------------------------------------------
...
0042                       ; EOF reached?
0043                       ;-------------------------------------------------------
0044 6E0E C120  34         mov   @fb.topline,tmp0
     6E10 A304     
0045 6E12 A120  34         a     @fb.row,tmp0
     6E14 A306     
0046 6E16 8120  34         c     @edb.lines,tmp0       ; fb.topline + fb.row = edb.lines ?
     6E18 A504     
0047 6E1A 1314  14         jeq   fb.cursor.down.set_cursorx
0048                                                   ; Yes, only position cursor X
0049                       ;-------------------------------------------------------
0050                       ; Check if scrolling required
0051                       ;-------------------------------------------------------
0052 6E1C C120  34         mov   @fb.scrrows,tmp0
     6E1E A31A     
0053 6E20 0604  14         dec   tmp0
0054 6E22 8120  34         c     @fb.row,tmp0
     6E24 A306     
0055 6E26 110A  14         jlt   fb.cursor.down.cursor
0056                       ;-------------------------------------------------------
0057                       ; Scroll 1 line
0058                       ;-------------------------------------------------------
0059 6E28 C820  54         mov   @fb.topline,@parm1
     6E2A A304     
     6E2C A006     
0060 6E2E 05A0  34         inc   @parm1
     6E30 A006     
0061               
0062 6E32 06A0  32         bl    @fb.refresh           ; \ Refresh frame buffer
     6E34 6F72     
0063                                                   ; | i  @parm1 = Line to start with
0064                                                   ; /             (becomes @fb.topline)
0065               
0066 6E36 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     6E38 A310     
0067 6E3A 1004  14         jmp   fb.cursor.down.set_cursorx
0068                       ;-------------------------------------------------------
0069                       ; Move cursor down a row, there are still rows left
0070                       ;-------------------------------------------------------
0071               fb.cursor.down.cursor:
0072 6E3C 05A0  34         inc   @fb.row               ; Row++ in screen buffer
     6E3E A306     
0073 6E40 06A0  32         bl    @down                 ; Row++ VDP cursor
     6E42 26E0     
0074                       ;-------------------------------------------------------
0075                       ; Check line length and position cursor
0076                       ;-------------------------------------------------------
0077               fb.cursor.down.set_cursorx:
0078 6E44 06A0  32         bl    @edb.line.getlength2  ; \ Get length current line
     6E46 3588     
0079                                                   ; | i  @fb.row        = Row in frame buffer
0080                                                   ; / o  @fb.row.length = Length of row
0081               
0082 6E48 8820  54         c     @fb.column,@fb.row.length
     6E4A A30C     
     6E4C A308     
0083 6E4E 1207  14         jle   fb.cursor.down.exit
0084                                                   ; Exit
0085                       ;-------------------------------------------------------
0086                       ; Adjust cursor column position
0087                       ;-------------------------------------------------------
0088 6E50 C820  54         mov   @fb.row.length,@fb.column
     6E52 A308     
     6E54 A30C     
0089 6E56 C120  34         mov   @fb.column,tmp0
     6E58 A30C     
0090 6E5A 06A0  32         bl    @xsetx                ; Set VDP cursor X
     6E5C 26F2     
0091                       ;-------------------------------------------------------
0092                       ; Exit
0093                       ;-------------------------------------------------------
0094               fb.cursor.down.exit:
0095 6E5E 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6E60 6D68     
0096 6E62 C2F9  30         mov   *stack+,r11           ; Pop r11
0097 6E64 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.61466
...
0019               ********|*****|*********************|**************************
0020               fb.cursor.home:
0021 6E66 0649  14         dect  stack
0022 6E68 C64B  30         mov   r11,*stack            ; Save return address
0023 6E6A 0649  14         dect  stack
0024 6E6C C644  30         mov   tmp0,*stack           ; Push tmp0
0025                       ;------------------------------------------------------
0026                       ; Cursor home
0027                       ;------------------------------------------------------
0028 6E6E 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6E70 A318     
0029 6E72 C120  34         mov   @wyx,tmp0
     6E74 832A     
0030 6E76 0244  22         andi  tmp0,>ff00            ; Reset cursor X position to 0
     6E78 FF00     
0031 6E7A C804  38         mov   tmp0,@wyx             ; VDP cursor column=0
     6E7C 832A     
0032 6E7E 04E0  34         clr   @fb.column
     6E80 A30C     
0033 6E82 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6E84 6D68     
0034 6E86 0720  34         seto  @fb.status.dirty      ; Trigger refresh of status lines
     6E88 A318     
0035                       ;-------------------------------------------------------
0036                       ; Exit
0037                       ;-------------------------------------------------------
0038               fb.cursor.home.exit:
0039 6E8A C139  30         mov   *stack+,tmp0          ; Pop tmp0
0040 6E8C C2F9  30         mov   *stack+,r11           ; Pop r11
0041 6E8E 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.61466
...
0023 6E92 C64B  30         mov   r11,*stack            ; Save return address
0024 6E94 0649  14         dect  stack
0025 6E96 C644  30         mov   tmp0,*stack           ; Push tmp0
0026 6E98 0649  14         dect  stack
0027 6E9A C645  30         mov   tmp1,*stack           ; Push tmp1
0028                       ;-------------------------------------------------------
0029                       ; Initialisation
0030                       ;-------------------------------------------------------
0031 6E9C 0720  34         seto  @edb.dirty            ; Editor buffer dirty (text changed!)
     6E9E A506     
0032 6EA0 04C5  14         clr   tmp1                  ; Offset current line
0033 6EA2 C120  34         mov   @parm1,tmp0           ; Insert on current line or following line?
     6EA4 A006     
0034 6EA6 1301  14         jeq   !                     ; Current line
0035 6EA8 0585  14         inc   tmp1                  ; Following line
0036                       ;-------------------------------------------------------
0037                       ; Crunch current line if dirty
0038                       ;-------------------------------------------------------
0039 6EAA 8820  54 !       c     @fb.row.dirty,@w$ffff
     6EAC A30A     
     6EAE 2022     
0040 6EB0 1604  14         jne   fb.insert.line.insert
0041 6EB2 06A0  32         bl    @edb.line.pack.fb     ; Copy line to editor buffer
     6EB4 701E     
0042 6EB6 04E0  34         clr   @fb.row.dirty         ; Current row no longer dirty
     6EB8 A30A     
0043                       ;-------------------------------------------------------
0044                       ; Insert entry in index
0045                       ;-------------------------------------------------------
0046               fb.insert.line.insert:
0047 6EBA 06A0  32         bl    @fb.calc_pointer      ; Calculate position in frame buffer
     6EBC 6D68     
0048 6EBE C820  54         mov   @fb.topline,@parm1
     6EC0 A304     
     6EC2 A006     
0049 6EC4 A820  54         a     @fb.row,@parm1        ; Line number to insert
     6EC6 A306     
     6EC8 A006     
0050 6ECA A805  38         a     tmp1,@parm1           ; Add optional offset (for following line)
     6ECC A006     
0051 6ECE C820  54         mov   @edb.lines,@parm2     ; Last line to reorganize
     6ED0 A504     
     6ED2 A008     
0052               
0053 6ED4 06A0  32         bl    @idx.entry.insert     ; Reorganize index
     6ED6 349A     
0054                                                   ; \ i  parm1 = Line for insert
0055                                                   ; / i  parm2 = Last line to reorg
0056               
0057 6ED8 05A0  34         inc   @edb.lines            ; One line added to editor buffer
     6EDA A504     
0058 6EDC 04E0  34         clr   @fb.row.length        ; Current row length = 0
     6EDE A308     
0059                       ;-------------------------------------------------------
0060                       ; Check/Adjust marker M1
0061                       ;-------------------------------------------------------
0062               fb.insert.line.m1:
0063 6EE0 8820  54         c     @edb.block.m1,@w$ffff ; Marker M1 unset?
     6EE2 A50C     
     6EE4 2022     
0064 6EE6 1308  14         jeq   fb.insert.line.m2
0065                                                   ; Yes, skip to M2 check
0066               
0067 6EE8 8820  54         c     @parm1,@edb.block.m1
     6EEA A006     
     6EEC A50C     
0068 6EEE 1504  14         jgt   fb.insert.line.m2
0069 6EF0 05A0  34         inc   @edb.block.m1         ; M1++
     6EF2 A50C     
0070 6EF4 0720  34         seto  @fb.colorize          ; Set colorize flag
     6EF6 A310     
0071                       ;-------------------------------------------------------
0072                       ; Check/Adjust marker M2
0073                       ;-------------------------------------------------------
0074               fb.insert.line.m2:
0075 6EF8 8820  54         c     @edb.block.m2,@w$ffff ; Marker M1 unset?
     6EFA A50E     
     6EFC 2022     
0076 6EFE 1308  14         jeq   fb.insert.line.refresh
0077                                                   ; Yes, skip to refresh frame buffer
0078               
0079 6F00 8820  54         c     @parm1,@edb.block.m2
     6F02 A006     
     6F04 A50E     
0080 6F06 1504  14         jgt   fb.insert.line.refresh
0081 6F08 05A0  34         inc   @edb.block.m2         ; M2++
     6F0A A50E     
0082 6F0C 0720  34         seto  @fb.colorize          ; Set colorize flag
     6F0E A310     
0083                       ;-------------------------------------------------------
0084                       ; Refresh frame buffer and physical screen
0085                       ;-------------------------------------------------------
0086               fb.insert.line.refresh:
0087 6F10 C820  54         mov   @fb.topline,@parm1
     6F12 A304     
     6F14 A006     
0088               
0089 6F16 06A0  32         bl    @fb.refresh           ; \ Refresh frame buffer
     6F18 6F72     
0090                                                   ; | i  @parm1 = Line to start with
0091                                                   ; /             (becomes @fb.topline)
0092               
0093 6F1A 0720  34         seto  @fb.dirty             ; Trigger screen refresh
     6F1C A316     
0094 6F1E 06A0  32         bl    @fb.cursor.home       ; Move cursor home
     6F20 6E66     
0095                       ;-------------------------------------------------------
0096                       ; Exit
0097                       ;-------------------------------------------------------
0098               fb.insert.line.exit:
0099 6F22 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0100 6F24 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0101 6F26 C2F9  30         mov   *stack+,r11           ; Pop r11
0102 6F28 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.61466
...
0015 6F2A 0649  14         dect  stack
0016 6F2C C64B  30         mov   r11,*stack            ; Save return address
0017                       ;------------------------------------------------------
0018                       ; Prepare for scanning
0019                       ;------------------------------------------------------
0020 6F2E 04E0  34         clr   @fb.column
     6F30 A30C     
0021 6F32 06A0  32         bl    @fb.calc_pointer
     6F34 6D68     
0022 6F36 06A0  32         bl    @edb.line.getlength2  ; Get length current line
     6F38 3588     
0023 6F3A C1A0  34         mov   @fb.row.length,tmp2   ; Set loop counter
     6F3C A308     
0024 6F3E 1313  14         jeq   fb.get.firstnonblank.nomatch
0025                                                   ; Exit if empty line
0026 6F40 C120  34         mov   @fb.current,tmp0      ; Pointer to current char
     6F42 A302     
0027 6F44 04C5  14         clr   tmp1
0028                       ;------------------------------------------------------
0029                       ; Scan line for non-blank character
0030                       ;------------------------------------------------------
0031               fb.get.firstnonblank.loop:
0032 6F46 D174  28         movb  *tmp0+,tmp1           ; Get character
0033 6F48 130E  14         jeq   fb.get.firstnonblank.nomatch
0034                                                   ; Exit if empty line
0035 6F4A 0285  22         ci    tmp1,>2000            ; Whitespace?
     6F4C 2000     
0036 6F4E 1503  14         jgt   fb.get.firstnonblank.match
0037 6F50 0606  14         dec   tmp2                  ; Counter--
0038 6F52 16F9  14         jne   fb.get.firstnonblank.loop
0039 6F54 1008  14         jmp   fb.get.firstnonblank.nomatch
0040                       ;------------------------------------------------------
0041                       ; Non-blank character found
0042                       ;------------------------------------------------------
0043               fb.get.firstnonblank.match:
0044 6F56 6120  34         s     @fb.current,tmp0      ; Calculate column
     6F58 A302     
0045 6F5A 0604  14         dec   tmp0
0046 6F5C C804  38         mov   tmp0,@outparm1        ; Save column
     6F5E A016     
0047 6F60 D805  38         movb  tmp1,@outparm2        ; Save character
     6F62 A018     
0048 6F64 1004  14         jmp   fb.get.firstnonblank.exit
0049                       ;------------------------------------------------------
0050                       ; No non-blank character found
0051                       ;------------------------------------------------------
0052               fb.get.firstnonblank.nomatch:
0053 6F66 04E0  34         clr   @outparm1             ; X=0
     6F68 A016     
0054 6F6A 04E0  34         clr   @outparm2             ; Null
     6F6C A018     
0055                       ;------------------------------------------------------
0056                       ; Exit
0057                       ;------------------------------------------------------
0058               fb.get.firstnonblank.exit:
0059 6F6E C2F9  30         mov   *stack+,r11           ; Pop r11
...
0018               ********|*****|*********************|**************************
0019               fb.refresh:
0020 6F72 0649  14         dect  stack
0021 6F74 C64B  30         mov   r11,*stack            ; Push return address
0022 6F76 0649  14         dect  stack
0023 6F78 C644  30         mov   tmp0,*stack           ; Push tmp0
0024 6F7A 0649  14         dect  stack
0025 6F7C C645  30         mov   tmp1,*stack           ; Push tmp1
0026 6F7E 0649  14         dect  stack
0027 6F80 C646  30         mov   tmp2,*stack           ; Push tmp2
0028                       ;------------------------------------------------------
0029                       ; Setup starting position in index
0030                       ;------------------------------------------------------
0031 6F82 C820  54         mov   @parm1,@fb.topline
     6F84 A006     
     6F86 A304     
0032 6F88 04E0  34         clr   @parm2                ; Target row in frame buffer
     6F8A A008     
0033                       ;------------------------------------------------------
0034                       ; Check if already at EOF
0035                       ;------------------------------------------------------
0036 6F8C 8820  54         c     @parm1,@edb.lines     ; EOF reached?
     6F8E A006     
     6F90 A504     
0037 6F92 130F  14         jeq   fb.refresh.erase_eob  ; Yes, no need to unpack
0038                       ;------------------------------------------------------
0039                       ; Unpack line to frame buffer
0040                       ;------------------------------------------------------
0041               fb.refresh.unpack_line:
0042 6F94 06A0  32         bl    @edb.line.unpack.fb   ; Unpack line from editor buffer
     6F96 7116     
0043                                                   ; \ i  parm1    = Line to unpack
0044                                                   ; | i  parm2    = Target row in frame buffer
0045                                                   ; / o  outparm1 = Length of line
0046               
0047 6F98 05A0  34         inc   @parm1                ; Next line in editor buffer
     6F9A A006     
0048 6F9C 05A0  34         inc   @parm2                ; Next row in frame buffer
     6F9E A008     
0049                       ;------------------------------------------------------
0050                       ; Last row in editor buffer reached ?
0051                       ;------------------------------------------------------
0052 6FA0 8820  54         c     @parm1,@edb.lines     ; BOT reached?
     6FA2 A006     
     6FA4 A504     
0053 6FA6 1305  14         jeq   fb.refresh.erase_eob  ; yes, erase until end of frame buffer
0054               
0055 6FA8 8820  54         c     @parm2,@fb.scrrows
     6FAA A008     
     6FAC A31A     
0056 6FAE 11F2  14         jlt   fb.refresh.unpack_line
0057                                                   ; No, unpack next line
0058 6FB0 1011  14         jmp   fb.refresh.exit       ; Yes, exit without erasing
0059                       ;------------------------------------------------------
0060                       ; Erase until end of frame buffer
0061                       ;------------------------------------------------------
0062               fb.refresh.erase_eob:
0063 6FB2 C120  34         mov   @parm2,tmp0           ; Current row
     6FB4 A008     
0064 6FB6 C160  34         mov   @fb.scrrows,tmp1      ; Rows framebuffer
     6FB8 A31A     
0065 6FBA 6144  18         s     tmp0,tmp1             ; tmp1 = rows framebuffer - current row
0066 6FBC 3960  72         mpy   @fb.colsline,tmp1     ; tmp2 = cols per row * tmp1
     6FBE A30E     
0067               
0068 6FC0 C186  18         mov   tmp2,tmp2             ; Already at end of frame buffer?
0069 6FC2 1308  14         jeq   fb.refresh.exit       ; Yes, so exit
0070               
0071 6FC4 3920  72         mpy   @fb.colsline,tmp0     ; cols per row * tmp0 (Result in tmp1!)
     6FC6 A30E     
0072 6FC8 A160  34         a     @fb.top.ptr,tmp1      ; Add framebuffer base
     6FCA A300     
0073               
0074 6FCC C105  18         mov   tmp1,tmp0             ; tmp0 = Memory start address
0075 6FCE 04C5  14         clr   tmp1                  ; Clear with >00 character
0076               
0077 6FD0 06A0  32         bl    @xfilm                ; \ Fill memory
     6FD2 2250     
...
0085 6FD4 0720  34         seto  @fb.dirty             ; Refresh screen
     6FD6 A316     
0086               
0087 6FD8 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0088 6FDA C179  30         mov   *stack+,tmp1          ; Pop tmp1
0089 6FDC C139  30         mov   *stack+,tmp0          ; Pop tmp0
0090 6FDE C2F9  30         mov   *stack+,r11           ; Pop r11
0091 6FE0 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.61466
...
0019               ********|*****|*********************|**************************
0020               fb.restore:
0021 6FE2 0649  14         dect  stack
0022 6FE4 C64B  30         mov   r11,*stack            ; Save return address
0023 6FE6 0649  14         dect  stack
0024 6FE8 C660  46         mov   @parm1,*stack         ; Push @parm1
     6FEA A006     
0025                       ;------------------------------------------------------
0026                       ; Refresh framebuffer
0027                       ;------------------------------------------------------
0028 6FEC C820  54         mov   @fb.topline,@parm1
     6FEE A304     
     6FF0 A006     
0029 6FF2 06A0  32         bl    @fb.refresh           ; Refresh frame buffer content
     6FF4 6F72     
0030                                                   ; \ @i  parm1 = Line to start with
0031                       ;------------------------------------------------------
0032                       ; Color marked lines
0033                       ;------------------------------------------------------
0034 6FF6 0720  34         seto  @parm1                ; Skip Asserts
     6FF8 A006     
0035 6FFA 06A0  32         bl    @fb.colorlines        ; Colorize frame buffer content
     6FFC 7ACA     
...
0040                       ;------------------------------------------------------
0041 6FFE C820  54         mov   @tv.color,@parm1      ; Set normal color
     7000 A218     
     7002 A006     
0042 7004 06A0  32         bl    @pane.action.colorscheme.statlines
     7006 74BA     
...
0048                       ;------------------------------------------------------
0049 7008 0720  34         seto  @fb.status.dirty      ; Trigger status line update
     700A A318     
0050               
0051 700C 06A0  32         bl    @pane.cursor.blink    ; Show cursor
     700E 74F2     
0052                       ;------------------------------------------------------
0053                       ; Exit
0054                       ;------------------------------------------------------
0055               fb.restore.exit:
0056 7010 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     7012 A006     
0057 7014 C820  54         mov   @parm1,@wyx           ; Set cursor position
     7016 A006     
     7018 832A     
0058 701A C2F9  30         mov   *stack+,r11           ; Pop R11
0059 701C 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.61466
0111                       ;-----------------------------------------------------------------------
...
0027 701E 0649  14         dect  stack
0028 7020 C64B  30         mov   r11,*stack            ; Save return address
0029 7022 0649  14         dect  stack
0030 7024 C644  30         mov   tmp0,*stack           ; Push tmp0
0031 7026 0649  14         dect  stack
0032 7028 C645  30         mov   tmp1,*stack           ; Push tmp1
0033 702A 0649  14         dect  stack
0034 702C C646  30         mov   tmp2,*stack           ; Push tmp2
0035 702E 0649  14         dect  stack
0036 7030 C647  30         mov   tmp3,*stack           ; Push tmp3
0037                       ;------------------------------------------------------
0038                       ; Get values
0039                       ;------------------------------------------------------
0040 7032 C820  54         mov   @fb.column,@rambuf    ; Save @fb.column
     7034 A30C     
     7036 A100     
0041 7038 04E0  34         clr   @fb.column
     703A A30C     
0042 703C 06A0  32         bl    @fb.calc_pointer      ; Beginning of row
     703E 6D68     
0043                       ;------------------------------------------------------
0044                       ; Prepare scan
0045                       ;------------------------------------------------------
0046 7040 04C4  14         clr   tmp0                  ; Counter
0047 7042 04C7  14         clr   tmp3                  ; Counter for whitespace
0048 7044 C160  34         mov   @fb.current,tmp1      ; Get position
     7046 A302     
0049 7048 C805  38         mov   tmp1,@rambuf+2        ; Save beginning of row
     704A A102     
0050                       ;------------------------------------------------------
0051                       ; Scan line for >00 byte termination
0052                       ;------------------------------------------------------
0053               edb.line.pack.fb.scan:
0054 704C D1B5  28         movb  *tmp1+,tmp2           ; Get char
0055 704E 0986  56         srl   tmp2,8                ; Right justify
0056 7050 130D  14         jeq   edb.line.pack.fb.check_setpage
0057                                                   ; Stop scan if >00 found
0058 7052 0584  14         inc   tmp0                  ; Increase string length
0059                       ;------------------------------------------------------
0060                       ; Check for trailing whitespace
0061                       ;------------------------------------------------------
0062 7054 0286  22         ci    tmp2,32               ; Was it a space character?
     7056 0020     
0063 7058 1301  14         jeq   edb.line.pack.fb.check80
0064 705A C1C4  18         mov   tmp0,tmp3
0065                       ;------------------------------------------------------
0066                       ; Not more than 80 characters
0067                       ;------------------------------------------------------
0068               edb.line.pack.fb.check80:
0069 705C 0284  22         ci    tmp0,colrow
     705E 0050     
0070 7060 1305  14         jeq   edb.line.pack.fb.check_setpage
0071                                                   ; Stop scan if 80 characters processed
0072 7062 10F4  14         jmp   edb.line.pack.fb.scan ; Next character
0073                       ;------------------------------------------------------
0074                       ; Check failed, crash CPU!
0075                       ;------------------------------------------------------
0076               edb.line.pack.fb.crash:
0077 7064 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     7066 FFCE     
0078 7068 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     706A 2026     
0079                       ;------------------------------------------------------
0080                       ; Check if highest SAMS page needs to be increased
0081                       ;------------------------------------------------------
0082               edb.line.pack.fb.check_setpage:
0083 706C 8107  18         c     tmp3,tmp0             ; Trailing whitespace in line?
0084 706E 1103  14         jlt   edb.line.pack.fb.rtrim
0085 7070 C804  38         mov   tmp0,@rambuf+4        ; Save full length of line
     7072 A104     
0086 7074 100C  14         jmp   !
0087               edb.line.pack.fb.rtrim:
0088                       ;------------------------------------------------------
0089                       ; Remove trailing blanks from line
0090                       ;------------------------------------------------------
0091 7076 C807  38         mov   tmp3,@rambuf+4        ; Save line length without trailing blanks
     7078 A104     
0092               
0093 707A 04C5  14         clr   tmp1                  ; tmp1 = Character to fill (>00)
0094               
0095 707C C184  18         mov   tmp0,tmp2             ; \
0096 707E 6187  18         s     tmp3,tmp2             ; | tmp2 = Repeat count
0097 7080 0586  14         inc   tmp2                  ; /
0098               
0099 7082 C107  18         mov   tmp3,tmp0             ; \
0100 7084 A120  34         a     @rambuf+2,tmp0        ; / tmp0 = Start address in CPU memory
     7086 A102     
0101               
0102               edb.line.pack.fb.rtrim.loop:
0103 7088 DD05  32         movb  tmp1,*tmp0+
0104 708A 0606  14         dec   tmp2
0105 708C 15FD  14         jgt   edb.line.pack.fb.rtrim.loop
0106                       ;------------------------------------------------------
0107                       ; Check and increase highest SAMS page
0108                       ;------------------------------------------------------
0109 708E 06A0  32 !       bl    @edb.hipage.alloc     ; Check and increase highest SAMS page
     7090 7AF8     
...
0116 7092 C820  54         mov   @fb.topline,@parm1    ; \ parm1 = fb.topline + fb.row
     7094 A304     
     7096 A006     
0117 7098 A820  54         a     @fb.row,@parm1        ; /
     709A A306     
     709C A006     
0118                       ;------------------------------------------------------
...
0122 709E C820  54         mov   @edb.next_free.ptr,@parm2
     70A0 A508     
     70A2 A008     
0123                                                   ; Pointer to new line
0124 70A4 C820  54         mov   @edb.sams.hipage,@parm3
     70A6 A518     
     70A8 A00A     
0125                                                   ; SAMS page to use
0126               
0127 70AA 06A0  32         bl    @idx.entry.update     ; Update index
     70AC 334A     
...
0134                       ;------------------------------------------------------
0135 70AE C120  34         mov   @rambuf+2,tmp0        ; Source for memory copy
     70B0 A102     
0136 70B2 C160  34         mov   @edb.next_free.ptr,tmp1
     70B4 A508     
0137                                                   ; Address of line in editor buffer
0138               
0139 70B6 05E0  34         inct  @edb.next_free.ptr    ; Adjust pointer
     70B8 A508     
0140               
0141 70BA C1A0  34         mov   @rambuf+4,tmp2        ; Get line length
     70BC A104     
0142 70BE CD46  34         mov   tmp2,*tmp1+           ; Set line length as line prefix
0143 70C0 1317  14         jeq   edb.line.pack.fb.prepexit
0144                                                   ; Nothing to copy if empty line
0145                       ;------------------------------------------------------
0146                       ; 4. Copy line from framebuffer to editor buffer
0147                       ;------------------------------------------------------
0148               edb.line.pack.fb.copyline:
0149 70C2 0286  22         ci    tmp2,2
     70C4 0002     
0150 70C6 1603  14         jne   edb.line.pack.fb.copyline.checkbyte
0151 70C8 DD74  42         movb  *tmp0+,*tmp1+         ; \ Copy single word on possible
0152 70CA DD74  42         movb  *tmp0+,*tmp1+         ; / uneven address
0153 70CC 1007  14         jmp   edb.line.pack.fb.copyline.align16
0154               
0155               edb.line.pack.fb.copyline.checkbyte:
0156 70CE 0286  22         ci    tmp2,1
     70D0 0001     
0157 70D2 1602  14         jne   edb.line.pack.fb.copyline.block
0158 70D4 D554  38         movb  *tmp0,*tmp1           ; Copy single byte
0159 70D6 1002  14         jmp   edb.line.pack.fb.copyline.align16
0160               
0161               edb.line.pack.fb.copyline.block:
0162 70D8 06A0  32         bl    @xpym2m               ; Copy memory block
     70DA 24F4     
0163                                                   ; \ i  tmp0 = source
...
0170 70DC A820  54         a     @rambuf+4,@edb.next_free.ptr
     70DE A104     
     70E0 A508     
0171                                                      ; Add length of line
0172               
0173 70E2 C120  34         mov   @edb.next_free.ptr,tmp0  ; \ Round up to next multiple of 16.
     70E4 A508     
0174 70E6 0504  16         neg   tmp0                     ; | tmp0 = tmp0 + (-tmp0 & 15)
0175 70E8 0244  22         andi  tmp0,15                  ; | Hacker's Delight 2nd Edition
     70EA 000F     
0176 70EC A804  38         a     tmp0,@edb.next_free.ptr  ; / Chapter 2
     70EE A508     
0177                       ;------------------------------------------------------
0178                       ; 6: Restore SAMS page and prepare for exit
0179                       ;------------------------------------------------------
0180               edb.line.pack.fb.prepexit:
0181 70F0 C820  54         mov   @rambuf,@fb.column    ; Retrieve @fb.column
     70F2 A100     
     70F4 A30C     
0182               
0183 70F6 8820  54         c     @edb.sams.hipage,@edb.sams.page
     70F8 A518     
     70FA A516     
0184 70FC 1306  14         jeq   edb.line.pack.fb.exit ; Exit early if SAMS page already mapped
0185               
0186 70FE C120  34         mov   @edb.sams.page,tmp0
     7100 A516     
0187 7102 C160  34         mov   @edb.top.ptr,tmp1
     7104 A500     
0188 7106 06A0  32         bl    @xsams.page.set       ; Set SAMS page
     7108 258A     
...
0195 710A C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0196 710C C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0197 710E C179  30         mov   *stack+,tmp1          ; Pop tmp1
0198 7110 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0199 7112 C2F9  30         mov   *stack+,r11           ; Pop R11
0200 7114 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.61466
...
0028 7116 0649  14         dect  stack
0029 7118 C64B  30         mov   r11,*stack            ; Save return address
0030 711A 0649  14         dect  stack
0031 711C C644  30         mov   tmp0,*stack           ; Push tmp0
0032 711E 0649  14         dect  stack
0033 7120 C645  30         mov   tmp1,*stack           ; Push tmp1
0034 7122 0649  14         dect  stack
0035 7124 C646  30         mov   tmp2,*stack           ; Push tmp2
0036                       ;------------------------------------------------------
0037                       ; Save parameters
0038                       ;------------------------------------------------------
0039 7126 C820  54         mov   @parm1,@rambuf
     7128 A006     
     712A A100     
0040 712C C820  54         mov   @parm2,@rambuf+2
     712E A008     
     7130 A102     
0041                       ;------------------------------------------------------
0042                       ; Calculate offset in frame buffer
0043                       ;------------------------------------------------------
0044 7132 C120  34         mov   @fb.colsline,tmp0
     7134 A30E     
0045 7136 3920  72         mpy   @parm2,tmp0           ; Offset is in tmp1!
     7138 A008     
0046 713A C1A0  34         mov   @fb.top.ptr,tmp2
     713C A300     
0047 713E A146  18         a     tmp2,tmp1             ; Add base to offset
0048 7140 C805  38         mov   tmp1,@rambuf+6        ; Destination row in frame buffer
     7142 A106     
0049                       ;------------------------------------------------------
0050                       ; Return empty row if requested line beyond editor buffer
0051                       ;------------------------------------------------------
0052 7144 8820  54         c     @parm1,@edb.lines     ; Requested line at BOT?
     7146 A006     
     7148 A504     
0053 714A 1103  14         jlt   !                     ; No, continue processing
0054               
0055 714C 04E0  34         clr   @rambuf+8             ; Set length=0
     714E A108     
0056 7150 1013  14         jmp   edb.line.unpack.fb.clear
0057                       ;------------------------------------------------------
0058                       ; Get pointer to line & page-in editor buffer page
0059                       ;------------------------------------------------------
0060 7152 C120  34 !       mov   @parm1,tmp0
     7154 A006     
0061 7156 06A0  32         bl    @edb.line.mappage     ; Activate editor buffer SAMS page for line
     7158 34F2     
0062                                                   ; \ i  tmp0     = Line number
...
0067                       ;------------------------------------------------------
0068 715A C120  34         mov   @outparm1,tmp0        ; Get pointer to line
     715C A016     
0069 715E 1603  14         jne   edb.line.unpack.fb.getlen
0070                                                   ; Continue if pointer is set
0071               
0072 7160 04E0  34         clr   @rambuf+8             ; Set length=0
     7162 A108     
0073 7164 1009  14         jmp   edb.line.unpack.fb.clear
0074                       ;------------------------------------------------------
0075                       ; Get line length
0076                       ;------------------------------------------------------
0077               edb.line.unpack.fb.getlen:
0078 7166 C174  30         mov   *tmp0+,tmp1           ; Get line length
0079 7168 C804  38         mov   tmp0,@rambuf+4        ; Source memory address for block copy
     716A A104     
0080 716C C805  38         mov   tmp1,@rambuf+8        ; Save line length
     716E A108     
0081                       ;------------------------------------------------------
0082                       ; Assert on line length
0083                       ;------------------------------------------------------
0084 7170 0285  22         ci    tmp1,80               ; \ Continue if length <= 80
     7172 0050     
0085                                                   ; /
0086 7174 1201  14         jle   edb.line.unpack.fb.clear
0087                       ;------------------------------------------------------
0088                       ; Crash the system or limit length to 80
0089                       ;------------------------------------------------------
0097 7176 100C  14         jmp   edb.line.unpack.fb.prepare
0098                                                   ; Length was >80, don't erase
0100                       ;------------------------------------------------------
0101                       ; Erase chars from last column until column 80
0102                       ;------------------------------------------------------
0103               edb.line.unpack.fb.clear:
0104 7178 C120  34         mov   @rambuf+6,tmp0        ; Start of row in frame buffer
     717A A106     
0105 717C A120  34         a     @rambuf+8,tmp0        ; Skip until end of row in frame buffer
     717E A108     
0106               
0107 7180 04C5  14         clr   tmp1                  ; Fill with >00
0108 7182 C1A0  34         mov   @fb.colsline,tmp2
     7184 A30E     
0109 7186 61A0  34         s     @rambuf+8,tmp2        ; Calculate number of bytes to clear
     7188 A108     
0110 718A 0586  14         inc   tmp2
0111               
0112 718C 06A0  32         bl    @xfilm                ; Fill CPU memory
     718E 2250     
...
0120 7190 C1A0  34         mov   @rambuf+8,tmp2        ; Line length
     7192 A108     
0121 7194 130D  14         jeq   edb.line.unpack.fb.exit
0122                                                   ; Exit if length = 0
0123 7196 C120  34         mov   @rambuf+4,tmp0        ; Pointer to line in editor buffer
     7198 A104     
0124 719A C160  34         mov   @rambuf+6,tmp1        ; Pointer to row in frame buffer
     719C A106     
0125                       ;------------------------------------------------------
0126                       ; Assert on line length
0127                       ;------------------------------------------------------
0128               edb.line.unpack.fb.copy:
0129 719E 0286  22         ci    tmp2,80               ; Check line length
     71A0 0050     
0130 71A2 1202  14         jle   edb.line.unpack.fb.copy.doit
0131                       ;------------------------------------------------------
0132                       ; Crash the system or limit length to 80
0133                       ;------------------------------------------------------
0138 71A4 0206  20         li    tmp2,80               ; Only process first 80 characters
     71A6 0050     
0140                       ;------------------------------------------------------
0141                       ; Copy memory block
0142                       ;------------------------------------------------------
0143               edb.line.unpack.fb.copy.doit:
0144 71A8 C806  38         mov   tmp2,@outparm1        ; Length of unpacked line
     71AA A016     
0145               
0146 71AC 06A0  32         bl    @xpym2m               ; Copy line to frame buffer
     71AE 24F4     
...
0154 71B0 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0155 71B2 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0156 71B4 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0157 71B6 C2F9  30         mov   *stack+,r11           ; Pop r11
0158 71B8 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.61466
0116                       ;-----------------------------------------------------------------------
...
0008 71BA 0649  14         dect  stack
0009 71BC C64B  30         mov   r11,*stack            ; Save return address
0010 71BE 0649  14         dect  stack
0011 71C0 C644  30         mov   tmp0,*stack           ; Push tmp0
0012 71C2 0649  14         dect  stack
0013 71C4 C645  30         mov   tmp1,*stack           ; Push tmp1
0014 71C6 0649  14         dect  stack
0015 71C8 C646  30         mov   tmp2,*stack           ; Push tmp2
0016 71CA 0649  14         dect  stack
0017 71CC C660  46         mov   @wyx,*stack           ; Push cursor position
     71CE 832A     
0018                       ;------------------------------------------------------
0019                       ; Get pane with focus
0020                       ;------------------------------------------------------
0021 71D0 C120  34         mov   @tv.pane.focus,tmp0   ; Get pane with focus
     71D2 A222     
0022               
0023 71D4 0284  22         ci    tmp0,pane.focus.fb
     71D6 0000     
0024 71D8 1310  14         jeq   task.vdp.cursor.fb    ; Frame buffer has focus
0025               
0026 71DA 0284  22         ci    tmp0,pane.focus.cmdb
     71DC 0001     
0027 71DE 1304  14         jeq   task.vdp.cursor.cmdb  ; CMDB buffer has focus
0028                       ;------------------------------------------------------
0029                       ; Assert failed. Invalid value
0030                       ;------------------------------------------------------
0031 71E0 C80B  38         mov   r11,@>ffce            ; \ Save caller address
     71E2 FFCE     
0032 71E4 06A0  32         bl    @cpu.crash            ; / Halt system.
     71E6 2026     
0033                       ;------------------------------------------------------
0034                       ; CMDB buffer has focus, position CMDB cursor
0035                       ;------------------------------------------------------
0036               task.vdp.cursor.cmdb:
0037 71E8 C820  54         mov   @cmdb.cursor,@wyx     ; Position cursor in CMDB pane
     71EA A70A     
     71EC 832A     
0038 71EE 0560  34         inv   @fb.curtoggle         ; Flip cursor shape flag
     71F0 A312     
0039 71F2 1319  14         jeq   task.vdp.cursor.dump  ; Show CMDB cursor
0040                       ;------------------------------------------------------
0041                       ; Hide CMDB cursor
0042                       ;------------------------------------------------------
0043               task.vdp.cursor.cmdb.hide:
0044 71F4 0720  34         seto  @cmdb.dirty
     71F6 A718     
0045 71F8 101C  14         jmp   task.vdp.cursor.exit
0046                       ;------------------------------------------------------
0047                       ; Frame buffer has focus, position FB cursor
0048                       ;------------------------------------------------------
0049               task.vdp.cursor.fb:
0050 71FA 0560  34         inv   @fb.curtoggle         ; Flip cursor shape flag
     71FC A312     
0051 71FE 1303  14         jeq   task.vdp.cursor.fb.visible
0052                                                   ; Show FB cursor
0053                       ;------------------------------------------------------
0054                       ; Hide FB cursor
0055                       ;------------------------------------------------------
0056 7200 0720  34         seto  @fb.dirty             ; Trigger refresh
     7202 A316     
0057 7204 1016  14         jmp   task.vdp.cursor.exit
0058                       ;------------------------------------------------------
0059                       ; Show FB cursor
0060                       ;------------------------------------------------------
0061               task.vdp.cursor.fb.visible:
0062 7206 C120  34         mov   @tv.ruler.visible,tmp0
     7208 A210     
0063 720A 1307  14         jeq   task.vdp.cursor.fb.visible.noruler
0064                       ;------------------------------------------------------
0065                       ; Cursor position adjustment, ruler visible
0066                       ;------------------------------------------------------
0067 720C C120  34         mov   @wyx,tmp0             ; Get cursor YX
     720E 832A     
0068 7210 0224  22         ai    tmp0,>0200            ; Topline + ruler adjustment
     7212 0200     
0069 7214 C804  38         mov   tmp0,@wyx             ; Save cursor YX
     7216 832A     
0070 7218 1006  14         jmp   task.vdp.cursor.dump
0071                       ;------------------------------------------------------
0072                       ; Cursor position adjustment, ruler hidden
0073                       ;------------------------------------------------------
0074               task.vdp.cursor.fb.visible.noruler:
0075 721A C120  34         mov   @wyx,tmp0             ; Get cursor YX
     721C 832A     
0076 721E 0224  22         ai    tmp0,>0100            ; Topline adjustment
     7220 0100     
0077 7222 C804  38         mov   tmp0,@wyx             ; Save cursor YX
     7224 832A     
0078                       ;------------------------------------------------------
0079                       ; Dump cursor to VDP
0080                       ;------------------------------------------------------
0081               task.vdp.cursor.dump:
0082 7226 06A0  32         bl    @yx2pnt               ; Calculate VDP address from @WYX
     7228 240E     
0083                                                   ; \ i  @wyx = Cursor position
0084                                                   ; / o  tmp0 = VDP address
0085               
0086 722A 0205  20         li    tmp1,26               ; Cursor character
     722C 001A     
0087               
0088 722E 06A0  32         bl    @xvputb               ; VDP put single byte
     7230 22E0     
...
0095 7232 C839  50         mov   *stack+,@wyx          ; Pop cursor position
     7234 832A     
0096 7236 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0097 7238 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0098 723A C139  30         mov   *stack+,tmp0          ; Pop tmp0
0099 723C C2F9  30         mov   *stack+,r11           ; Pop r11
0100 723E 0460  28         b     @slotok               ; Exit task
     7240 2E58     
                   < stevie_b1.asm.61466
0125               
...
0006               ********|*****|*********************|**************************
0007               task.vdp.panes:
0008 7242 0649  14         dect  stack
0009 7244 C64B  30         mov   r11,*stack            ; Save return address
0010                       ;------------------------------------------------------
0011                       ; Dump panes to VDP memory
0012                       ;------------------------------------------------------
0013 7246 06A0  32         bl    @pane.vdpdump
     7248 781A     
0014                       ;------------------------------------------------------
0015                       ; Exit task
0016                       ;------------------------------------------------------
0017               task.vdp.panes.exit:
0018 724A C2F9  30         mov   *stack+,r11           ; Pop r11
0019 724C 0460  28         b     @slotok
     724E 2E58     
                   < stevie_b1.asm.61466
...
0007               
0008               task.oneshot:
0009 7250 C120  34         mov   @tv.task.oneshot,tmp0  ; Get pointer to one-shot task
     7252 A224     
0010 7254 1301  14         jeq   task.oneshot.exit
0011               
0012 7256 0694  24         bl    *tmp0                  ; Execute one-shot task
0013                       ;------------------------------------------------------
0014                       ; Exit
0015                       ;------------------------------------------------------
0016               task.oneshot.exit:
0017 7258 0460  28         b     @slotok                ; Exit task
     725A 2E58     
                   < stevie_b1.asm.61466
0128                       ;-----------------------------------------------------------------------
...
0020 725C 0649  14         dect  stack
0021 725E C64B  30         mov   r11,*stack            ; Push return address
0022 7260 0649  14         dect  stack
0023 7262 C644  30         mov   tmp0,*stack           ; Push tmp0
0024               
0025 7264 C120  34         mov   @tv.colorscheme,tmp0  ; Load color scheme index
     7266 A212     
0026 7268 0284  22         ci    tmp0,tv.colorscheme.entries
     726A 000A     
0027                                                   ; Last entry reached?
0028 726C 1103  14         jlt   !
0029 726E 0204  20         li    tmp0,1                ; Reset color scheme index
     7270 0001     
0030 7272 1001  14         jmp   pane.action.colorscheme.switch
0031 7274 0584  14 !       inc   tmp0
0032                       ;-------------------------------------------------------
0033                       ; Switch to new color scheme
0034                       ;-------------------------------------------------------
0035               pane.action.colorscheme.switch:
0036 7276 C804  38         mov   tmp0,@tv.colorscheme  ; Save index of color scheme
     7278 A212     
0037               
0038 727A 06A0  32         bl    @pane.action.colorscheme.load
     727C 72BA     
0039                                                   ; Load current color scheme
0040                       ;-------------------------------------------------------
0041                       ; Show current color palette message
0042                       ;-------------------------------------------------------
0043 727E C820  54         mov   @wyx,@waux1           ; Save cursor YX position
     7280 832A     
     7282 833C     
0044               
0045 7284 06A0  32         bl    @putnum
     7286 2A38     
0046 7288 003E                   byte 0,62
0047 728A A212                   data tv.colorscheme,rambuf,>3020
     728C A100     
     728E 3020     
0048               
0049 7290 06A0  32         bl    @putat
     7292 2456     
0050 7294 0034                   byte 0,52
0051 7296 395C                   data txt.colorscheme  ; Show color palette message
0052               
0053 7298 C820  54         mov   @waux1,@wyx           ; Restore cursor YX position
     729A 833C     
     729C 832A     
0054                       ;-------------------------------------------------------
0055                       ; Delay
0056                       ;-------------------------------------------------------
0057 729E 0204  20         li    tmp0,12000
     72A0 2EE0     
0058 72A2 0604  14 !       dec   tmp0
0059 72A4 16FE  14         jne   -!
0060                       ;-------------------------------------------------------
0061                       ; Setup one shot task for removing message
0062                       ;-------------------------------------------------------
0063 72A6 0204  20         li    tmp0,pane.topline.oneshot.clearmsg
     72A8 35AC     
0064 72AA C804  38         mov   tmp0,@tv.task.oneshot
     72AC A224     
0065               
0066 72AE 06A0  32         bl    @rsslot               ; \ Reset loop counter slot 3
     72B0 2ECC     
0067 72B2 0003                   data 3                ; / for getting consistent delay
0068                       ;-------------------------------------------------------
0069                       ; Exit
0070                       ;-------------------------------------------------------
0071               pane.action.colorscheme.cycle.exit:
0072 72B4 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0073 72B6 C2F9  30         mov   *stack+,r11           ; Pop R11
0074 72B8 045B  20         b     *r11                  ; Return to caller
0075               
0076               
0077               
0078               ***************************************************************
...
0097 72BA 0649  14         dect  stack
0098 72BC C64B  30         mov   r11,*stack            ; Save return address
0099 72BE 0649  14         dect  stack
0100 72C0 C644  30         mov   tmp0,*stack           ; Push tmp0
0101 72C2 0649  14         dect  stack
0102 72C4 C645  30         mov   tmp1,*stack           ; Push tmp1
0103 72C6 0649  14         dect  stack
0104 72C8 C646  30         mov   tmp2,*stack           ; Push tmp2
0105 72CA 0649  14         dect  stack
0106 72CC C647  30         mov   tmp3,*stack           ; Push tmp3
0107 72CE 0649  14         dect  stack
0108 72D0 C648  30         mov   tmp4,*stack           ; Push tmp4
0109 72D2 0649  14         dect  stack
0110 72D4 C660  46         mov   @parm1,*stack         ; Push parm1
     72D6 A006     
0111 72D8 0649  14         dect  stack
0112 72DA C660  46         mov   @parm2,*stack         ; Push parm2
     72DC A008     
0113 72DE 0649  14         dect  stack
0114 72E0 C660  46         mov   @parm3,*stack         ; Push parm3
     72E2 A00A     
0115                       ;-------------------------------------------------------
0116                       ; Turn screen off
0117                       ;-------------------------------------------------------
0118 72E4 C120  34         mov   @parm1,tmp0
     72E6 A006     
0119 72E8 0284  22         ci    tmp0,>ffff            ; Skip flag set?
     72EA FFFF     
0120 72EC 1302  14         jeq   !                     ; Yes, so skip screen off
0121 72EE 06A0  32         bl    @scroff               ; Turn screen off
     72F0 269A     
0122                       ;-------------------------------------------------------
0123                       ; Get FG/BG colors framebuffer text
0124                       ;-------------------------------------------------------
0125 72F2 C120  34 !       mov   @tv.colorscheme,tmp0  ; Get color scheme index
     72F4 A212     
0126 72F6 0604  14         dec   tmp0                  ; Internally work with base 0
0127               
0128 72F8 0A34  56         sla   tmp0,3                ; Offset into color scheme data table
0129 72FA 0224  22         ai    tmp0,tv.colorscheme.table
     72FC 35F8     
0130                                                   ; Add base for color scheme data table
0131 72FE C1F4  30         mov   *tmp0+,tmp3           ; Get colors ABCD
0132 7300 C807  38         mov   tmp3,@tv.color        ; Save colors ABCD
     7302 A218     
0133                       ;-------------------------------------------------------
0134                       ; Get and save cursor color
0135                       ;-------------------------------------------------------
0136 7304 C214  26         mov   *tmp0,tmp4            ; Get colors EFGH
0137 7306 0248  22         andi  tmp4,>00ff            ; Only keep LSB (GH)
     7308 00FF     
0138 730A C808  38         mov   tmp4,@tv.curcolor     ; Save cursor color
     730C A216     
0139                       ;-------------------------------------------------------
0140                       ; Get FG/BG colors framebuffer marked text & CMDB pane
0141                       ;-------------------------------------------------------
0142 730E C234  30         mov   *tmp0+,tmp4           ; Get colors EFGH again
0143 7310 0248  22         andi  tmp4,>ff00            ; Only keep MSB (EF)
     7312 FF00     
0144 7314 0988  56         srl   tmp4,8                ; MSB to LSB
0145               
0146 7316 C174  30         mov   *tmp0+,tmp1           ; Get colors IJKL
0147 7318 C185  18         mov   tmp1,tmp2             ; \ Right align IJ and
0148 731A 0986  56         srl   tmp2,8                ; | save to @tv.busycolor
0149 731C C806  38         mov   tmp2,@tv.busycolor    ; /
     731E A21C     
0150               
0151 7320 0245  22         andi  tmp1,>00ff            ; | save KL to @tv.markcolor
     7322 00FF     
0152 7324 C805  38         mov   tmp1,@tv.markcolor    ; /
     7326 A21A     
0153               
0154 7328 C154  26         mov   *tmp0,tmp1            ; Get colors MNOP
0155 732A 0985  56         srl   tmp1,8                ; \ Right align MN and
0156 732C C805  38         mov   tmp1,@tv.cmdb.hcolor  ; / save to @tv.cmdb.hcolor
     732E A220     
0157                       ;-------------------------------------------------------
0158                       ; Check if only CMDB needs to be colorized
0159                       ;-------------------------------------------------------
0160 7330 8820  54         c     @parm3,@w$ffff        ; Only colorize CMDB pane ?
     7332 A00A     
     7334 2022     
0161 7336 133E  14         jeq   pane.action.colorscheme.cmdbpane
0162                                                   ; Yes, shortcut jump to CMDB pane
0163                       ;-------------------------------------------------------
0164                       ; Get FG color for ruler
0165                       ;-------------------------------------------------------
0166 7338 C154  26         mov   *tmp0,tmp1            ; Get colors MNOP
0167 733A 0245  22         andi  tmp1,>000f            ; Only keep P
     733C 000F     
0168 733E 0A45  56         sla   tmp1,4                ; Make it a FG/BG combination
0169 7340 C805  38         mov   tmp1,@tv.rulercolor   ; Save to @tv.rulercolor
     7342 A21E     
0170                       ;-------------------------------------------------------
0171                       ; Write sprite color of line and column indicators to SAT
0172                       ;-------------------------------------------------------
0173 7344 C154  26         mov   *tmp0,tmp1            ; Get colors MNOP
0174 7346 0245  22         andi  tmp1,>00f0            ; Only keep O
     7348 00F0     
0175 734A 0A45  56         sla   tmp1,4                ; Move O to MSB
0176 734C D805  38         movb  tmp1,@ramsat+7        ; Line indicator FG color to SAT
     734E A05D     
0177 7350 D805  38         movb  tmp1,@ramsat+11       ; Column indicator FG color to SAT
     7352 A061     
0178                       ;-------------------------------------------------------
0179                       ; Dump colors to VDP register 7 (text mode)
0180                       ;-------------------------------------------------------
0181 7354 C147  18         mov   tmp3,tmp1             ; Get work copy
0182 7356 0985  56         srl   tmp1,8                ; MSB to LSB (frame buffer colors)
0183 7358 0265  22         ori   tmp1,>0700
     735A 0700     
0184 735C C105  18         mov   tmp1,tmp0
0185 735E 06A0  32         bl    @putvrx               ; Write VDP register
     7360 2348     
0186                       ;-------------------------------------------------------
0187                       ; Dump colors for frame buffer pane (TAT)
0188                       ;-------------------------------------------------------
0189 7362 C120  34         mov   @tv.ruler.visible,tmp0
     7364 A210     
0190 7366 130A  14         jeq   pane.action.colorscheme.fbdump.noruler
0191               
0192 7368 C120  34         mov   @cmdb.dialog,tmp0
     736A A71A     
0193 736C 0284  22         ci    tmp0,id.dialog.help   ; Help dialog active?
     736E 0068     
0194 7370 1305  14         jeq   pane.action.colorscheme.fbdump.noruler
0195                                                   ; Yes, skip ruler
0196                       ;-------------------------------------------------------
0197                       ; Ruler visible on screen (TAT)
0198                       ;-------------------------------------------------------
0199 7372 0204  20         li    tmp0,vdp.fb.toprow.tat+80
     7374 18A0     
0200                                                   ; VDP start address (frame buffer area)
0201               
0202 7376 0206  20         li    tmp2,(pane.botrow-2)*80
     7378 0690     
0203                                                   ; Number of bytes to fill
0204 737A 1004  14         jmp   pane.action.colorscheme.checkcmdb
0205               
0206               pane.action.colorscheme.fbdump.noruler:
0207                       ;-------------------------------------------------------
0208                       ; No ruler visible on screen (TAT)
0209                       ;-------------------------------------------------------
0210 737C 0204  20         li    tmp0,vdp.fb.toprow.tat
     737E 1850     
0211                                                   ; VDP start address (frame buffer area)
0212 7380 0206  20         li    tmp2,(pane.botrow-1)*80
     7382 06E0     
...
0218 7384 C820  54         mov   @cmdb.visible,@cmdb.visible
     7386 A702     
     7388 A702     
0219 738A 1302  14         jeq   pane.action.colorscheme.fbdump
0220                                                   ; Not visible, skip adjustment
0221 738C 0226  22         ai    tmp2,-320             ; CMDB adjustment
     738E FEC0     
0222                       ;-------------------------------------------------------
0223                       ; Dump colors to VDP (TAT)
0224                       ;-------------------------------------------------------
0225               pane.action.colorscheme.fbdump:
0226 7390 C147  18         mov   tmp3,tmp1             ; Get work copy of colors ABCD
0227 7392 0985  56         srl   tmp1,8                ; MSB to LSB (frame buffer colors)
0228               
0229 7394 06A0  32         bl    @xfilv                ; Fill colors
     7396 22A8     
...
0235                       ;-------------------------------------------------------
0236 7398 C120  34         mov   @cmdb.dialog,tmp0
     739A A71A     
0237 739C 0284  22         ci    tmp0,id.dialog.help   ; Help dialog active?
     739E 0068     
0238 73A0 1309  14         jeq   pane.action.colorscheme.cmdbpane
0239                                                   ; Yes, skip marked lines
0240               
0241 73A2 C120  34         mov   @parm2,tmp0
     73A4 A008     
0242 73A6 0284  22         ci    tmp0,>ffff            ; Skip colorize flag is on?
     73A8 FFFF     
0243 73AA 1304  14         jeq   pane.action.colorscheme.cmdbpane
0244               
0245 73AC 0720  34         seto  @fb.colorize          ; Colorize M1/M2 marked lines (if present)
     73AE A310     
0246 73B0 06A0  32         bl    @fb.colorlines
     73B2 7ACA     
0247                       ;-------------------------------------------------------
0248                       ; Dump colors for CMDB header line (TAT)
0249                       ;-------------------------------------------------------
0250               pane.action.colorscheme.cmdbpane:
0251 73B4 C120  34         mov   @cmdb.visible,tmp0
     73B6 A702     
0252 73B8 1330  14         jeq   pane.action.colorscheme.errpane
0253                                                   ; Skip if CMDB pane is hidden
0254               
0255 73BA 0204  20         li    tmp0,vdp.cmdb.toprow.tat
     73BC 1DF0     
0256                                                   ; VDP start address (CMDB top line)
0257               
0258 73BE C160  34         mov   @tv.cmdb.hcolor,tmp1  ; set color for header line
     73C0 A220     
0259 73C2 0206  20         li    tmp2,1*67             ; Number of bytes to fill
     73C4 0043     
0260 73C6 06A0  32         bl    @xfilv                ; Fill colors
     73C8 22A8     
...
0266                       ;-------------------------------------------------------
0267 73CA 0204  20         li    tmp0,vdp.cmdb.toprow.tat+67
     73CC 1E33     
0268 73CE C160  34         mov   @tv.cmdb.hcolor,tmp1  ;
     73D0 A220     
0269 73D2 D160  34         movb  @tv.cmdb.hcolor+1,tmp1
     73D4 A221     
0270                                                   ; Copy same value into MSB
0271 73D6 0945  56         srl   tmp1,4                ;
0272 73D8 0245  22         andi  tmp1,>00ff            ; Only keep LSB
     73DA 00FF     
0273               
0274 73DC 0206  20         li    tmp2,13               ; Number of bytes to fill
     73DE 000D     
0275 73E0 06A0  32         bl    @xfilv                ; Fill colors
     73E2 22A8     
...
0281                       ;-------------------------------------------------------
0282 73E4 0204  20         li    tmp0,vdp.cmdb.toprow.tat + 80
     73E6 1E40     
0283                                                   ; VDP start address (CMDB top line + 1)
0284 73E8 C148  18         mov   tmp4,tmp1             ; Get work copy fg/bg color
0285 73EA 0206  20         li    tmp2,1*80             ; Number of bytes to fill
     73EC 0050     
0286 73EE 06A0  32         bl    @xfilv                ; Fill colors
     73F0 22A8     
0287                                                   ; i \  tmp0 = start address
0288                                                   ; i |  tmp1 = byte to fill
0289                                                   ; i /  tmp2 = number of bytes to fill
0290               
0291 73F2 0204  20         li    tmp0,vdp.cmdb.toprow.tat + 160
     73F4 1E90     
0292                                                   ; VDP start address (CMDB top line + 2)
0293 73F6 C160  34         mov   @tv.cmdb.hcolor,tmp1  ; Same color as header line
     73F8 A220     
0294 73FA 0206  20         li    tmp2,1*80             ; Number of bytes to fill
     73FC 0050     
0295 73FE 06A0  32         bl    @xfilv                ; Fill colors
     7400 22A8     
0296                                                   ; i \  tmp0 = start address
0297                                                   ; i |  tmp1 = byte to fill
0298                                                   ; i /  tmp2 = number of bytes to fill
0299               
0300 7402 0204  20         li    tmp0,vdp.cmdb.toprow.tat + 240
     7404 1EE0     
0301                                                   ; VDP start address (CMDB top line + 3)
0302 7406 C148  18         mov   tmp4,tmp1             ; Get work copy fg/bg color
0303 7408 0206  20         li    tmp2,1*80             ; Number of bytes to fill
     740A 0050     
0304 740C 06A0  32         bl    @xfilv                ; Fill colors
     740E 22A8     
...
0310                       ;-------------------------------------------------------
0311 7410 C120  34         mov   @parm3,tmp0
     7412 A00A     
0312 7414 0284  22         ci    tmp0,>ffff            ; Only colorize CMDB pane ?
     7416 FFFF     
0313 7418 1336  14         jeq   pane.action.colorscheme.cursorcolor.cmdb
0314                                                   ; Yes, shortcut to CMDB cursor color
0315                       ;-------------------------------------------------------
0316                       ; Dump colors for error pane (TAT)
0317                       ;-------------------------------------------------------
0318               pane.action.colorscheme.errpane:
0319 741A C120  34         mov   @tv.error.visible,tmp0
     741C A228     
0320 741E 1306  14         jeq   pane.action.colorscheme.statline
0321                                                   ; Skip if error pane is hidden
0322               
0323 7420 0205  20         li    tmp1,>00f6            ; White on dark red
     7422 00F6     
0324 7424 C805  38         mov   tmp1,@parm1           ; Pass color combination
     7426 A006     
0325               
0326 7428 06A0  32         bl    @pane.errline.drawcolor
     742A 761A     
...
0334 742C C160  34         mov   @tv.color,tmp1
     742E A218     
0335 7430 0245  22         andi  tmp1,>00ff            ; Only keep LSB (status line colors)
     7432 00FF     
0336 7434 C805  38         mov   tmp1,@parm1           ; Set color combination
     7436 A006     
0337               
0338               
0339 7438 04E0  34         clr   @parm2                ; Top row on screen
     743A A008     
0340 743C 06A0  32         bl    @colors.line.set      ; Load color combination for line
     743E 750E     
0341                                                   ; \ i  @parm1 = Color combination
0342                                                   ; / i  @parm2 = Row on physical screen
0343               
0344 7440 0205  20         li    tmp1,pane.botrow
     7442 0017     
0345 7444 C805  38         mov   tmp1,@parm2           ; Bottom row on screen
     7446 A008     
0346 7448 06A0  32         bl    @colors.line.set      ; Load color combination for line
     744A 750E     
...
0351                       ;-------------------------------------------------------
0352 744C C160  34         mov   @cmdb.dialog,tmp1
     744E A71A     
0353 7450 0285  22         ci    tmp1,id.dialog.basic  ; TI Basic dialog active?
     7452 006B     
0354 7454 1602  14         jne   pane.action.colorscheme.ruler
0355               
0356 7456 06A0  32         bl    @tibasic.hearts.tat   ; Dump colors for hearts
     7458 7A76     
0357                       ;-------------------------------------------------------
0358                       ; Dump colors for ruler if visible (TAT)
0359                       ;-------------------------------------------------------
0360               pane.action.colorscheme.ruler:
0361 745A C160  34         mov   @cmdb.dialog,tmp1
     745C A71A     
0362 745E 0285  22         ci    tmp1,id.dialog.help   ; Help dialog active?
     7460 0068     
0363 7462 130A  14         jeq   pane.action.colorscheme.cursorcolor
0364                                                   ; Yes, skip ruler
0365               
0366 7464 C160  34         mov   @tv.ruler.visible,tmp1
     7466 A210     
0367 7468 1307  14         jeq   pane.action.colorscheme.cursorcolor
0368               
0369 746A 06A0  32         bl    @fb.ruler.init        ; Setup ruler with tab-positions in memory
     746C 7AB8     
0370 746E 06A0  32         bl    @cpym2v
     7470 249A     
0371 7472 1850                   data vdp.fb.toprow.tat
0372 7474 A36E                   data fb.ruler.tat
0373 7476 0050                   data 80               ; Show ruler colors
0374                       ;-------------------------------------------------------
0375                       ; Dump cursor FG color to sprite table (SAT)
0376                       ;-------------------------------------------------------
0377               pane.action.colorscheme.cursorcolor:
0378 7478 C220  34         mov   @tv.curcolor,tmp4     ; Get cursor color
     747A A216     
0379               
0380 747C C120  34         mov   @tv.pane.focus,tmp0   ; Get pane with focus
     747E A222     
0381 7480 0284  22         ci    tmp0,pane.focus.fb    ; Frame buffer has focus?
     7482 0000     
0382 7484 1304  14         jeq   pane.action.colorscheme.cursorcolor.fb
0383                                                   ; Yes, set cursor color
0384               
0385               pane.action.colorscheme.cursorcolor.cmdb:
0386 7486 0248  22         andi  tmp4,>f0              ; Only keep high-nibble -> Word 2 (G)
     7488 00F0     
0387 748A 0A48  56         sla   tmp4,4                ; Move to MSB
0388 748C 1003  14         jmp   !
0389               
0390               pane.action.colorscheme.cursorcolor.fb:
0391 748E 0248  22         andi  tmp4,>0f              ; Only keep low-nibble -> Word 2 (H)
     7490 000F     
0392 7492 0A88  56         sla   tmp4,8                ; Move to MSB
0393               
0394 7494 D808  38 !       movb  tmp4,@ramsat+3        ; Update FG color in sprite table (SAT)
     7496 A059     
0395 7498 D808  38         movb  tmp4,@tv.curshape+1   ; Save cursor color
     749A A215     
0396                       ;-------------------------------------------------------
0397                       ; Exit
0398                       ;-------------------------------------------------------
0399               pane.action.colorscheme.load.exit:
0400 749C 06A0  32         bl    @scron                ; Turn screen on
     749E 26A2     
0401 74A0 C839  50         mov   *stack+,@parm3        ; Pop @parm3
     74A2 A00A     
0402 74A4 C839  50         mov   *stack+,@parm2        ; Pop @parm2
     74A6 A008     
0403 74A8 C839  50         mov   *stack+,@parm1        ; Pop @parm1
     74AA A006     
0404 74AC C239  30         mov   *stack+,tmp4          ; Pop tmp4
0405 74AE C1F9  30         mov   *stack+,tmp3          ; Pop tmp3
0406 74B0 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0407 74B2 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0408 74B4 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0409 74B6 C2F9  30         mov   *stack+,r11           ; Pop R11
0410 74B8 045B  20         b     *r11                  ; Return to caller
0411               
0412               
0413               
0414               ***************************************************************
...
0430 74BA 0649  14         dect  stack
0431 74BC C64B  30         mov   r11,*stack            ; Save return address
0432 74BE 0649  14         dect  stack
0433 74C0 C644  30         mov   tmp0,*stack           ; Push tmp0
0434                       ;------------------------------------------------------
0435                       ; Bottom line
0436                       ;------------------------------------------------------
0437 74C2 0204  20         li    tmp0,pane.botrow
     74C4 0017     
0438 74C6 C804  38         mov   tmp0,@parm2           ; Last row on screen
     74C8 A008     
0439 74CA 06A0  32         bl    @colors.line.set      ; Load color combination for line
     74CC 750E     
...
0446 74CE C139  30         mov   *stack+,tmp0          ; Pop tmp0
0447 74D0 C2F9  30         mov   *stack+,r11           ; Pop R11
0448 74D2 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.61466
...
0021 74D6 C64B  30         mov   r11,*stack            ; Save return address
0022                       ;-------------------------------------------------------
0023                       ; Hide cursor
0024                       ;-------------------------------------------------------
0025 74D8 06A0  32         bl    @filv                 ; Clear sprite SAT in VDP RAM
     74DA 22A2     
0026 74DC 2180                   data sprsat,>00,8     ; \ i  p0 = VDP destination
     74DE 0000     
     74E0 0008     
0027                                                   ; | i  p1 = Byte to write
0028                                                   ; / i  p2 = Number of bytes to write
0029               
0030 74E2 06A0  32         bl    @clslot
     74E4 2EBE     
0031 74E6 0001                   data 1                ; Terminate task.vdp.copy.sat
0032               
0033 74E8 06A0  32         bl    @clslot
     74EA 2EBE     
0034 74EC 0002                   data 2                ; Terminate task.vdp.cursor
0035                       ;-------------------------------------------------------
0036                       ; Exit
0037                       ;-------------------------------------------------------
0038               pane.cursor.hide.exit:
0039 74EE C2F9  30         mov   *stack+,r11           ; Pop R11
0040 74F0 045B  20         b     *r11                  ; Return to caller
0041               
0042               
0043               
0044               ***************************************************************
...
0060 74F2 0649  14         dect  stack
0061 74F4 C64B  30         mov   r11,*stack            ; Save return address
0062                       ;-------------------------------------------------------
0063                       ; Hide cursor
0064                       ;-------------------------------------------------------
0065 74F6 06A0  32         bl    @filv                 ; Clear sprite SAT in VDP RAM
     74F8 22A2     
0066 74FA 2180                   data sprsat,>00,4     ; \ i  p0 = VDP destination
     74FC 0000     
     74FE 0004     
...
0069               
0078               
0079 7500 06A0  32         bl    @mkslot
     7502 2EA0     
0080 7504 020F                   data >020f,task.vdp.cursor   ; Task 2 - Toggle cursor shape
     7506 71BA     
0081 7508 FFFF                   data eol
0082               
0084               
0085                       ;-------------------------------------------------------
0086                       ; Exit
...
0089 750A C2F9  30         mov   *stack+,r11           ; Pop R11
0090 750C 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.61466
0133                       ;-----------------------------------------------------------------------
0134                       ; Screen panes
0135                       ;-----------------------------------------------------------------------
...
0021 750E 0649  14         dect  stack
0022 7510 C64B  30         mov   r11,*stack            ; Save return address
0023 7512 0649  14         dect  stack
0024 7514 C644  30         mov   tmp0,*stack           ; Push tmp0
0025 7516 0649  14         dect  stack
0026 7518 C645  30         mov   tmp1,*stack           ; Push tmp1
0027 751A 0649  14         dect  stack
0028 751C C646  30         mov   tmp2,*stack           ; Push tmp2
0029 751E 0649  14         dect  stack
0030 7520 C660  46         mov   @parm1,*stack         ; Push parm1
     7522 A006     
0031 7524 0649  14         dect  stack
0032 7526 C660  46         mov   @parm2,*stack         ; Push parm2
     7528 A008     
0033                       ;-------------------------------------------------------
0034                       ; Dump colors for line in TAT
0035                       ;-------------------------------------------------------
0036 752A C120  34         mov   @parm2,tmp0           ; Get target line
     752C A008     
0037 752E 0205  20         li    tmp1,colrow           ; Columns per row (spectra2)
     7530 0050     
0038 7532 3944  56         mpy   tmp0,tmp1             ; Calculate VDP address (results in tmp2!)
0039               
0040 7534 C106  18         mov   tmp2,tmp0             ; Set VDP start address
0041 7536 0224  22         ai    tmp0,vdp.tat.base     ; Add TAT base address
     7538 1800     
0042 753A C160  34         mov   @parm1,tmp1           ; Get foreground/background color
     753C A006     
0043 753E 0206  20         li    tmp2,80               ; Number of bytes to fill
     7540 0050     
0044               
0045 7542 06A0  32         bl    @xfilv                ; Fill colors
     7544 22A8     
...
0053 7546 C839  50         mov   *stack+,@parm2        ; Pop @parm2
     7548 A008     
0054 754A C839  50         mov   *stack+,@parm1        ; Pop @parm1
     754C A006     
0055 754E C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0056 7550 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0057 7552 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0058 7554 C2F9  30         mov   *stack+,r11           ; Pop R11
0059 7556 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.61466
...
0015               ********|*****|*********************|**************************
0016               pane.topline:
0017 7558 0649  14         dect  stack
0018 755A C64B  30         mov   r11,*stack            ; Save return address
0019 755C 0649  14         dect  stack
0020 755E C644  30         mov   tmp0,*stack           ; Push tmp0
0021 7560 0649  14         dect  stack
0022 7562 C660  46         mov   @wyx,*stack           ; Push cursor position
     7564 832A     
0023                       ;------------------------------------------------------
0024                       ; Show current file
0025                       ;------------------------------------------------------
0026               pane.topline.file:
0027 7566 06A0  32         bl    @at
     7568 26DA     
0028 756A 0000                   byte 0,0              ; y=0, x=0
0029               
0030 756C C820  54         mov   @edb.filename.ptr,@parm1
     756E A512     
     7570 A006     
0031                                                   ; Get string to display
0032 7572 0204  20         li    tmp0,47
     7574 002F     
0033 7576 C804  38         mov   tmp0,@parm2           ; Set requested length
     7578 A008     
0034 757A 0204  20         li    tmp0,32
     757C 0020     
0035 757E C804  38         mov   tmp0,@parm3           ; Set character to fill
     7580 A00A     
0036 7582 0204  20         li    tmp0,rambuf
     7584 A100     
0037 7586 C804  38         mov   tmp0,@parm4           ; Set pointer to buffer for output string
     7588 A00C     
0038               
0039               
0040 758A 06A0  32         bl    @tv.pad.string        ; Pad string to specified length
     758C 32D2     
...
0045                                                   ; /             output string
0046               
0047 758E C160  34         mov   @outparm1,tmp1        ; \ Display padded filename
     7590 A016     
0048 7592 06A0  32         bl    @xutst0               ; /
     7594 2434     
0049                       ;------------------------------------------------------
0050                       ; Show if text was changed in editor buffer
0051                       ;------------------------------------------------------
0052               pane.topline.show_dirty:
0053 7596 C120  34         mov   @edb.dirty,tmp0
     7598 A506     
0054 759A 1305  14         jeq   pane.topline.nochange
0055                       ;------------------------------------------------------
0056                       ; Show "*"
0057                       ;------------------------------------------------------
0058 759C 06A0  32         bl    @putat
     759E 2456     
0059 75A0 004F                   byte 0,79             ; y=0, x=79
0060 75A2 366C                   data txt.star
0061 75A4 1004  14         jmp   pane.topline.showmarkers
0062                       ;------------------------------------------------------
0063                       ; Show " "
0064                       ;------------------------------------------------------
0065               pane.topline.nochange:
0066 75A6 06A0  32         bl    @putat
     75A8 2456     
0067 75AA 004F                   byte 0,79             ; y=0, x=79
0068 75AC 3888                   data txt.ws1          ; Single white space
0069                       ;------------------------------------------------------
0070                       ; Check if M1/M2 markers need to be shown
0071                       ;------------------------------------------------------
0072               pane.topline.showmarkers:
0073 75AE C120  34         mov   @edb.block.m1,tmp0    ; \
     75B0 A50C     
0074 75B2 0284  22         ci    tmp0,>ffff            ; | Exit early if M1 unset (>ffff)
     75B4 FFFF     
0075 75B6 132C  14         jeq   pane.topline.exit     ; /
0076               
0077 75B8 C120  34         mov   @tv.task.oneshot,tmp0 ; \
     75BA A224     
0078 75BC 0284  22         ci    tmp0,pane.topline.oneshot.clearmsg
     75BE 35AC     
0079                                                   ; | Exit early if overlay message visible
0080 75C0 1327  14         jeq   pane.topline.exit     ; /
0081                       ;------------------------------------------------------
0082                       ; Show M1 marker
0083                       ;------------------------------------------------------
0084 75C2 06A0  32         bl    @putat
     75C4 2456     
0085 75C6 0034                   byte 0,52
0086 75C8 37E8                   data txt.m1           ; Show M1 marker message
0087               
0088 75CA C820  54         mov   @edb.block.m1,@parm1
     75CC A50C     
     75CE A006     
0089 75D0 06A0  32         bl    @tv.unpack.uint16     ; Unpack 16 bit unsigned integer to string
     75D2 32A6     
0090                                                   ; \ i @parm1           = uint16
0091                                                   ; / o @unpacked.string = Output string
0092               
0093 75D4 0204  20         li    tmp0,>0500
     75D6 0500     
0094 75D8 D804  38         movb  tmp0,@unpacked.string ; Set string length to 5 (padding)
     75DA A02C     
0095               
0096 75DC 06A0  32         bl    @putat
     75DE 2456     
0097 75E0 0037                   byte 0,55
0098 75E2 A02C                   data unpacked.string  ; Show M1 value
0099                       ;------------------------------------------------------
0100                       ; Show M2 marker
0101                       ;------------------------------------------------------
0102 75E4 C120  34         mov   @edb.block.m2,tmp0    ; \
     75E6 A50E     
0103 75E8 0284  22         ci    tmp0,>ffff            ; | Exit early if M2 unset (>ffff)
     75EA FFFF     
0104 75EC 1311  14         jeq   pane.topline.exit     ; /
0105               
0106 75EE 06A0  32         bl    @putat
     75F0 2456     
0107 75F2 003E                   byte 0,62
0108 75F4 37EC                   data txt.m2           ; Show M2 marker message
0109               
0110 75F6 C820  54         mov   @edb.block.m2,@parm1
     75F8 A50E     
     75FA A006     
0111 75FC 06A0  32         bl    @tv.unpack.uint16     ; Unpack 16 bit unsigned integer to string
     75FE 32A6     
0112                                                   ; \ i @parm1           = uint16
0113                                                   ; / o @unpacked.string = Output string
0114               
0115 7600 0204  20         li    tmp0,>0500
     7602 0500     
0116 7604 D804  38         movb  tmp0,@unpacked.string ; Set string length to 5 (padding)
     7606 A02C     
0117               
0118 7608 06A0  32         bl    @putat
     760A 2456     
0119 760C 0041                   byte 0,65
0120 760E A02C                   data unpacked.string  ; Show M2 value
0121                       ;------------------------------------------------------
0122                       ; Exit
0123                       ;------------------------------------------------------
0124               pane.topline.exit:
0125 7610 C839  50         mov   *stack+,@wyx          ; Pop cursor position
     7612 832A     
0126 7614 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0127 7616 C2F9  30         mov   *stack+,r11           ; Pop r11
0128 7618 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.61466
...
0024 761C C64B  30         mov   r11,*stack            ; Save return address
0025 761E 0649  14         dect  stack
0026 7620 C644  30         mov   tmp0,*stack           ; Push tmp0
0027 7622 0649  14         dect  stack
0028 7624 C645  30         mov   tmp1,*stack           ; Push tmp1
0029 7626 0649  14         dect  stack
0030 7628 C646  30         mov   tmp2,*stack           ; Push tmp2
0031                       ;-------------------------------------------------------
0032                       ; Determine 1st row in error pane
0033                       ;-------------------------------------------------------
0034 762A 0204  20         li    tmp0,pane.botrow      ; Get rows on screen
     762C 0017     
0035 762E C144  18         mov   tmp0,tmp1             ; \ Get first row in error pane
0036 7630 6160  34         s     @tv.error.rows,tmp1   ; /
     7632 A22A     
0037                       ;-------------------------------------------------------
0038                       ; Dump colors for row
0039                       ;-------------------------------------------------------
0040               pane.errline.drawcolor.loop:
0041 7634 C805  38         mov   tmp1,@parm2           ; Row on physical screen
     7636 A008     
0042               
0043 7638 06A0  32         bl    @colors.line.set      ; Load color combination for line
     763A 750E     
0044                                                   ; \ i  @parm1 = Color combination
0045                                                   ; / i  @parm2 = Row on physical screen
0046               
0047 763C 0585  14         inc   tmp1                  ; Next row
0048 763E 8105  18         c     tmp1,tmp0             ; Last row reached?
0049 7640 11F9  14         jlt   pane.errline.drawcolor.loop
0050                                                   ; Not yet, next iteration
0051                       ;-------------------------------------------------------
0052                       ; Exit
0053                       ;-------------------------------------------------------
0054               pane.errline.drawcolor.exit:
0055 7642 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0056 7644 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0057 7646 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0058 7648 C2F9  30         mov   *stack+,r11           ; Pop R11
0059 764A 045B  20         b     *r11                  ; Return to caller
0060               
0061               
0062               
0063               
...
0082 764C 0649  14         dect  stack
0083 764E C64B  30         mov   r11,*stack            ; Save return address
0084 7650 0649  14         dect  stack
0085 7652 C644  30         mov   tmp0,*stack           ; Push tmp0
0086 7654 0649  14         dect  stack
0087 7656 C645  30         mov   tmp1,*stack           ; Push tmp1
0088               
0089 7658 0205  20         li    tmp1,>00f6            ; White on dark red
     765A 00F6     
0090 765C C805  38         mov   tmp1,@parm1
     765E A006     
0091               
0092 7660 06A0  32         bl    @pane.errline.drawcolor
     7662 761A     
...
0098                       ;------------------------------------------------------
0099 7664 0204  20         li    tmp0,tv.error.msg
     7666 A230     
0100 7668 C804  38         mov   tmp0,@parm1           ; Get pointer to string
     766A A006     
0101               
0102 766C 0204  20         li    tmp0,240
     766E 00F0     
0103 7670 C804  38         mov   tmp0,@parm2           ; Set requested length
     7672 A008     
0104               
0105 7674 0204  20         li    tmp0,32
     7676 0020     
0106 7678 C804  38         mov   tmp0,@parm3           ; Set character to fill
     767A A00A     
0107               
0108 767C 0204  20         li    tmp0,rambuf
     767E A100     
0109 7680 C804  38         mov   tmp0,@parm4           ; Set pointer to buffer for output string
     7682 A00C     
0110               
0111 7684 06A0  32         bl    @tv.pad.string        ; Pad string to specified length
     7686 32D2     
...
0119                       ;------------------------------------------------------
0120 7688 06A0  32         bl    @at
     768A 26DA     
0121 768C 1400                   byte pane.botrow-3,0  ; Set cursor
0122               
0123 768E C160  34         mov   @outparm1,tmp1        ; \ Display error message
     7690 A016     
0124 7692 06A0  32         bl    @xutst0               ; /
     7694 2434     
0125               
0126 7696 C120  34         mov   @fb.scrrows.max,tmp0  ; \
     7698 A31C     
0127 769A 6120  34         s     @tv.error.rows,tmp0   ; | Adjust number of rows in frame buffer
     769C A22A     
0128 769E C804  38         mov   tmp0,@fb.scrrows      ; /
     76A0 A31A     
0129               
0130 76A2 0720  34         seto  @tv.error.visible     ; Error line is visible
     76A4 A228     
0131                       ;------------------------------------------------------
0132                       ; Exit
0133                       ;------------------------------------------------------
0134               pane.errline.show.exit:
0135 76A6 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0136 76A8 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0137 76AA C2F9  30         mov   *stack+,r11           ; Pop r11
0138 76AC 045B  20         b     *r11                  ; Return to caller
0139               
0140               
0141               
0142               ***************************************************************
...
0160 76AE 0649  14         dect  stack
0161 76B0 C64B  30         mov   r11,*stack            ; Save return address
0162 76B2 0649  14         dect  stack
0163 76B4 C644  30         mov   tmp0,*stack           ; Push tmp0
0164                       ;------------------------------------------------------
0165                       ; Get color combination
0166                       ;------------------------------------------------------
0167 76B6 06A0  32         bl    @errpane.init         ; Clear error line string in RAM
     76B8 31F8     
0168               
0169 76BA C120  34         mov   @cmdb.visible,tmp0
     76BC A702     
0170 76BE 1303  14         jeq   pane.errline.hide.fbcolor
0171                       ;------------------------------------------------------
0172                       ; CMDB pane color
0173                       ;------------------------------------------------------
0174 76C0 C120  34         mov   @tv.cmdb.hcolor,tmp0  ; Get colors of CMDB header line
     76C2 A220     
0175 76C4 1003  14         jmp   !
0176                       ;------------------------------------------------------
0177                       ; Frame buffer color
0178                       ;------------------------------------------------------
0179               pane.errline.hide.fbcolor:
0180 76C6 C120  34         mov   @tv.color,tmp0        ; Get colors
     76C8 A218     
0181 76CA 0984  56         srl   tmp0,8                ; Get rid of status line colors
0182                       ;------------------------------------------------------
0183                       ; Dump colors
0184                       ;------------------------------------------------------
0185 76CC C804  38 !       mov   tmp0,@parm1           ; set foreground/background color
     76CE A006     
0186               
0187 76D0 06A0  32         bl    @pane.errline.drawcolor
     76D2 761A     
0188                                                   ; Draw color on rows in error pane
0189                                                   ; \ i  @tv.error.rows = Number of rows
0190                                                   ; / i  @parm1         = Color combination
0191               
0192 76D4 04E0  34         clr   @tv.error.visible     ; Error line no longer visible
     76D6 A228     
0193 76D8 C820  54         mov   @fb.scrrows.max,@fb.scrrows
     76DA A31C     
     76DC A31A     
...
0199 76DE C139  30         mov   *stack+,tmp0          ; Pop tmp0
0200 76E0 C2F9  30         mov   *stack+,r11           ; Pop r11
0201 76E2 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.61466
...
0018 76E6 C64B  30         mov   r11,*stack            ; Save return address
0019 76E8 0649  14         dect  stack
0020 76EA C644  30         mov   tmp0,*stack           ; Push tmp0
0021 76EC 0649  14         dect  stack
0022 76EE C660  46         mov   @wyx,*stack           ; Push cursor position
     76F0 832A     
0023                       ;------------------------------------------------------
0024                       ; Show block shortcuts if set
0025                       ;------------------------------------------------------
0026 76F2 C120  34         mov   @edb.block.m2,tmp0    ; \
     76F4 A50E     
0027 76F6 0584  14         inc   tmp0                  ; | Skip if M2 unset (>ffff)
0028                                                   ; /
0029 76F8 1305  14         jeq   pane.botline.show_keys
0030               
0031 76FA 06A0  32         bl    @putat
     76FC 2456     
0032 76FE 1700                   byte pane.botrow,0
0033 7700 37F8                   data txt.keys.block   ; Show block shortcuts
0034               
0035 7702 1004  14         jmp   pane.botline.show_mode
0036                       ;------------------------------------------------------
0037                       ; Show default message
0038                       ;------------------------------------------------------
0039               pane.botline.show_keys:
0040 7704 06A0  32         bl    @putat
     7706 2456     
0041 7708 1700                   byte pane.botrow,0
0042 770A 37F0                   data txt.keys.default ; Show default shortcuts
0043                       ;------------------------------------------------------
0044                       ; Show text editing mode
0045                       ;------------------------------------------------------
0046               pane.botline.show_mode:
0047 770C C120  34         mov   @edb.insmode,tmp0
     770E A50A     
0048 7710 1605  14         jne   pane.botline.show_mode.insert
0049                       ;------------------------------------------------------
0050                       ; Overwrite mode
0051                       ;------------------------------------------------------
0052 7712 06A0  32         bl    @putat
     7714 2456     
0053 7716 1737                   byte  pane.botrow,55
0054 7718 3664                   data  txt.ovrwrite
0055 771A 1004  14         jmp   pane.botline.show_linecol
0056                       ;------------------------------------------------------
0057                       ; Insert mode
0058                       ;------------------------------------------------------
0059               pane.botline.show_mode.insert:
0060 771C 06A0  32         bl    @putat
     771E 2456     
0061 7720 1737                   byte  pane.botrow,55
0062 7722 3668                   data  txt.insert
0063                       ;------------------------------------------------------
0064                       ; Show "line,column"
0065                       ;------------------------------------------------------
0066               pane.botline.show_linecol:
0067 7724 C820  54         mov   @fb.row,@parm1
     7726 A306     
     7728 A006     
0068 772A 06A0  32         bl    @fb.row2line          ; Row to editor line
     772C 6D4E     
0069                                                   ; \ i @fb.topline = Top line in frame buffer
0070                                                   ; | i @parm1      = Row in frame buffer
0071                                                   ; / o @outparm1   = Matching line in EB
0072               
0073 772E 05A0  34         inc   @outparm1             ; Add base 1
     7730 A016     
0074                       ;------------------------------------------------------
0075                       ; Show line
0076                       ;------------------------------------------------------
0077 7732 06A0  32         bl    @putnum
     7734 2A38     
0078 7736 173B                   byte  pane.botrow,59  ; YX
0079 7738 A016                   data  outparm1,rambuf
     773A A100     
0080 773C 30                     byte  48              ; ASCII offset
0081 773D   20                   byte  32              ; Padding character
0082                       ;------------------------------------------------------
0083                       ; Show comma
0084                       ;------------------------------------------------------
0085 773E 06A0  32         bl    @putat
     7740 2456     
0086 7742 1740                   byte  pane.botrow,64
0087 7744 365C                   data  txt.delim
0088                       ;------------------------------------------------------
0089                       ; Show column
0090                       ;------------------------------------------------------
0091 7746 06A0  32         bl    @film
     7748 224A     
0092 774A A105                   data rambuf+5,32,12   ; Clear work buffer with space character
     774C 0020     
     774E 000C     
0093               
0094 7750 C820  54         mov   @fb.column,@waux1
     7752 A30C     
     7754 833C     
0095 7756 05A0  34         inc   @waux1                ; Offset 1
     7758 833C     
0096               
0097 775A 06A0  32         bl    @mknum                ; Convert unsigned number to string
     775C 29BA     
0098 775E 833C                   data  waux1,rambuf
     7760 A100     
0099 7762 30                     byte  48              ; ASCII offset
0100 7763   20                   byte  32              ; Fill character
0101               
0102 7764 06A0  32         bl    @trimnum              ; Trim number to the left
     7766 2A12     
0103 7768 A100                   data  rambuf,rambuf+5,32
     776A A105     
     776C 0020     
0104               
0105 776E 0204  20         li    tmp0,>0600            ; "Fix" number length to clear junk chars
     7770 0600     
0106 7772 D804  38         movb  tmp0,@rambuf+5        ; Set length byte
     7774 A105     
0107               
0108                       ;------------------------------------------------------
0109                       ; Decide if row length is to be shown
0110                       ;------------------------------------------------------
0111 7776 C120  34         mov   @fb.column,tmp0       ; \ Base 1 for comparison
     7778 A30C     
0112 777A 0584  14         inc   tmp0                  ; /
0113 777C 8804  38         c     tmp0,@fb.row.length   ; Check if cursor on last column on row
     777E A308     
0114 7780 1101  14         jlt   pane.botline.show_linecol.linelen
0115 7782 102B  14         jmp   pane.botline.show_linecol.colstring
0116                                                   ; Yes, skip showing row length
0117                       ;------------------------------------------------------
0118                       ; Add ',' delimiter and length of line to string
0119                       ;------------------------------------------------------
0120               pane.botline.show_linecol.linelen:
0121 7784 C120  34         mov   @fb.column,tmp0       ; \
     7786 A30C     
0122 7788 0205  20         li    tmp1,rambuf+7         ; | Determine column position for '-' char
     778A A107     
0123 778C 0284  22         ci    tmp0,9                ; | based on number of digits in cursor X
     778E 0009     
0124 7790 1101  14         jlt   !                     ; | column.
0125 7792 0585  14         inc   tmp1                  ; /
0126               
0127 7794 0204  20 !       li    tmp0,>2f00            ; \ ASCII '/'
     7796 2F00     
0128 7798 DD44  32         movb  tmp0,*tmp1+           ; / Add delimiter to string
0129               
0130 779A C805  38         mov   tmp1,@waux1           ; Backup position in ram buffer
     779C 833C     
0131               
0132 779E 06A0  32         bl    @mknum
     77A0 29BA     
0133 77A2 A308                   data  fb.row.length,rambuf
     77A4 A100     
0134 77A6 30                     byte  48              ; ASCII offset
0135 77A7   20                   byte  32              ; Padding character
0136               
0137 77A8 C160  34         mov   @waux1,tmp1           ; Restore position in ram buffer
     77AA 833C     
0138               
0139 77AC C120  34         mov   @fb.row.length,tmp0   ; \ Get length of line
     77AE A308     
0140 77B0 0284  22         ci    tmp0,10               ; /
     77B2 000A     
0141 77B4 110B  14         jlt   pane.botline.show_line.1digit
0142                       ;------------------------------------------------------
0143                       ; Assert
0144                       ;------------------------------------------------------
0145 77B6 0284  22         ci    tmp0,80
     77B8 0050     
0146 77BA 1204  14         jle   pane.botline.show_line.2digits
0147                       ;------------------------------------------------------
0148                       ; Asserts failed
0149                       ;------------------------------------------------------
0150 77BC C80B  38 !       mov   r11,@>ffce            ; \ Save caller address
     77BE FFCE     
0151 77C0 06A0  32         bl    @cpu.crash            ; / Crash and halt system
     77C2 2026     
0152                       ;------------------------------------------------------
0153                       ; Show length of line (2 digits)
0154                       ;------------------------------------------------------
0155               pane.botline.show_line.2digits:
0156 77C4 0204  20         li    tmp0,rambuf+3
     77C6 A103     
0157 77C8 DD74  42         movb  *tmp0+,*tmp1+         ; 1st digit row length
0158 77CA 1002  14         jmp   pane.botline.show_line.rest
0159                       ;------------------------------------------------------
0160                       ; Show length of line (1 digits)
0161                       ;------------------------------------------------------
0162               pane.botline.show_line.1digit:
0163 77CC 0204  20         li    tmp0,rambuf+4
     77CE A104     
0164               pane.botline.show_line.rest:
0165 77D0 DD74  42         movb  *tmp0+,*tmp1+         ; 1st/Next digit row length
0166 77D2 DD60  48         movb  @rambuf+0,*tmp1+      ; Append a whitespace character
     77D4 A100     
0167 77D6 DD60  48         movb  @rambuf+0,*tmp1+      ; Append a whitespace character
     77D8 A100     
0168                       ;------------------------------------------------------
0169                       ; Show column string
0170                       ;------------------------------------------------------
0171               pane.botline.show_linecol.colstring:
0172 77DA 06A0  32         bl    @putat
     77DC 2456     
0173 77DE 1741                   byte pane.botrow,65
0174 77E0 A105                   data rambuf+5         ; Show string
0175                       ;------------------------------------------------------
0176                       ; Show lines in buffer unless on last line in file
0177                       ;------------------------------------------------------
0178 77E2 C820  54         mov   @fb.row,@parm1
     77E4 A306     
     77E6 A006     
0179 77E8 06A0  32         bl    @fb.row2line
     77EA 6D4E     
0180 77EC 8820  54         c     @edb.lines,@outparm1
     77EE A504     
     77F0 A016     
0181 77F2 1605  14         jne   pane.botline.show_lines_in_buffer
0182               
0183 77F4 06A0  32         bl    @putat
     77F6 2456     
0184 77F8 1748                   byte pane.botrow,72
0185 77FA 365E                   data txt.bottom
0186               
0187 77FC 1009  14         jmp   pane.botline.exit
0188                       ;------------------------------------------------------
0189                       ; Show lines in buffer
0190                       ;------------------------------------------------------
0191               pane.botline.show_lines_in_buffer:
0192 77FE C820  54         mov   @edb.lines,@waux1
     7800 A504     
     7802 833C     
0193               
0194 7804 06A0  32         bl    @putnum
     7806 2A38     
0195 7808 1748                   byte pane.botrow,72   ; YX
0196 780A 833C                   data waux1,rambuf
     780C A100     
0197 780E 30                     byte 48
0198 780F   20                   byte 32
0199                       ;------------------------------------------------------
0200                       ; Exit
0201                       ;------------------------------------------------------
0202               pane.botline.exit:
0203 7810 C839  50         mov   *stack+,@wyx          ; Pop cursor position
     7812 832A     
0204 7814 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0205 7816 C2F9  30         mov   *stack+,r11           ; Pop r11
0206 7818 045B  20         b     *r11                  ; Return
                   < stevie_b1.asm.61466
...
0022               ********|*****|*********************|**************************
0023               pane.vdpdump:
0024 781A 0649  14         dect  stack
0025 781C C64B  30         mov   r11,*stack            ; Save return address
0026 781E 0649  14         dect  stack
0027 7820 C644  30         mov   tmp0,*stack           ; Push tmp0
0028 7822 0649  14         dect  stack
0029 7824 C660  46         mov   @wyx,*stack           ; Push cursor position
     7826 832A     
0030                       ;------------------------------------------------------
0031                       ; ALPHA-Lock key down?
0032                       ;------------------------------------------------------
0033               pane.vdpdump.alpha_lock:
0034 7828 20A0  38         coc   @wbit10,config
     782A 200C     
0035 782C 1305  14         jeq   pane.vdpdump.alpha_lock.down
0036                       ;------------------------------------------------------
0037                       ; AlPHA-Lock is up
0038                       ;------------------------------------------------------
0039 782E 06A0  32         bl    @putat
     7830 2456     
0040 7832 174E                   byte pane.botrow,78
0041 7834 3892                   data txt.ws4
0042 7836 1004  14         jmp   pane.vdpdump.cmdb.check
0043                       ;------------------------------------------------------
0044                       ; AlPHA-Lock is down
0045                       ;------------------------------------------------------
0046               pane.vdpdump.alpha_lock.down:
0047 7838 06A0  32         bl    @putat
     783A 2456     
0048 783C 174E                   byte pane.botrow,78
0049 783E 3880                   data txt.alpha.down
0050                       ;------------------------------------------------------
0051                       ; Command buffer visible ?
0052                       ;------------------------------------------------------
0053               pane.vdpdump.cmdb.check
0054 7840 C120  34         mov   @cmdb.visible,tmp0    ; CMDB pane visible ?
     7842 A702     
0055 7844 1324  14         jeq   !                     ; No, skip CMDB pane
0056                       ;-------------------------------------------------------
0057                       ; Draw command buffer pane if dirty
0058                       ;-------------------------------------------------------
0059               pane.vdpdump.cmdb.draw:
0060 7846 C120  34         mov   @cmdb.dirty,tmp0      ; Command buffer dirty?
     7848 A718     
0061 784A 1343  14         jeq   pane.vdpdump.exit     ; No, skip update
0062                       ;-------------------------------------------------------
0063                       ; "one-time only" flag set?
0064                       ;-------------------------------------------------------
0065 784C 0284  22         ci    tmp0,tv.1timeonly
     784E 00FE     
0066 7850 1619  14         jne   pane.vdpdump.cmdb.draw.content
0067                                                   ; No, skip CMDB colorization
0068                       ;-------------------------------------------------------
0069                       ; Colorize the CMDB pane
0070                       ;-------------------------------------------------------
0071               pane.vdpdump.cmdb.draw.colorscheme:
0072 7852 0649  14         dect  stack
0073 7854 C660  46         mov   @parm1,*stack         ; Push @parm1
     7856 A006     
0074 7858 0649  14         dect  stack
0075 785A C660  46         mov   @parm2,*stack         ; Push @parm2
     785C A008     
0076 785E 0649  14         dect  stack
0077 7860 C660  46         mov   @parm3,*stack         ; Push @parm3
     7862 A00A     
0078               
0079 7864 0720  34         seto  @parm1                ; Do not turn screen off
     7866 A006     
0080 7868 0720  34         seto  @parm2                ; Skip colorzing marked lines
     786A A008     
0081 786C 0720  34         seto  @parm3                ; Only colorize CMDB pane
     786E A00A     
0082               
0083 7870 06A0  32         bl    @pane.action.colorscheme.load
     7872 72BA     
...
0089                                                   ; /             if >FFFF
0090               
0091 7874 C839  50         mov   *stack+,@parm3        ; Pop @parm3
     7876 A00A     
0092 7878 C839  50         mov   *stack+,@parm2        ; Pop @parm2
     787A A008     
0093 787C C839  50         mov   *stack+,@parm1        ; Pop @parm1
     787E A006     
0094               
0095 7880 0720  34         seto  @cmdb.dirty           ; Remove special "one-time only" flag
     7882 A718     
0096                       ;-------------------------------------------------------
0097                       ; Show content in CMDB pane
0098                       ;-------------------------------------------------------
0099               pane.vdpdump.cmdb.draw.content:
0100 7884 06A0  32         bl    @pane.cmdb.draw       ; Draw CMDB pane
     7886 7A3A     
0101 7888 04E0  34         clr   @cmdb.dirty           ; Reset CMDB dirty flag
     788A A718     
0102 788C 1022  14         jmp   pane.vdpdump.exit     ; Exit early
0103                       ;-------------------------------------------------------
0104                       ; Check if frame buffer dirty
0105                       ;-------------------------------------------------------
0106 788E C120  34 !       mov   @fb.dirty,tmp0        ; Is frame buffer dirty?
     7890 A316     
0107 7892 130E  14         jeq   pane.vdpdump.statlines
0108                                                   ; No, skip update
0109 7894 C820  54         mov   @fb.scrrows,@parm1    ; Number of lines to dump
     7896 A31A     
     7898 A006     
0110               
0111               pane.vdpdump.dump:
0112 789A 06A0  32         bl    @fb.vdpdump           ; Dump frame buffer to VDP SIT
     789C 7ADC     
...
0117                       ;------------------------------------------------------
0118 789E C120  34         mov   @fb.colorize,tmp0     ; Check if colorization necessary
     78A0 A310     
0119 78A2 1302  14         jeq   pane.vdpdump.dumped   ; Skip if flag reset
0120               
0121 78A4 06A0  32         bl    @fb.colorlines        ; Colorize lines M1/M2
     78A6 7ACA     
0122                       ;-------------------------------------------------------
0123                       ; Finished with frame buffer
0124                       ;-------------------------------------------------------
0125               pane.vdpdump.dumped:
0126 78A8 04E0  34         clr   @fb.dirty             ; Reset framebuffer dirty flag
     78AA A316     
0127 78AC 0720  34         seto  @fb.status.dirty      ; Do trigger status lines update
     78AE A318     
0128                       ;-------------------------------------------------------
0129                       ; Refresh top and bottom line
0130                       ;-------------------------------------------------------
0131               pane.vdpdump.statlines:
0132 78B0 C120  34         mov   @fb.status.dirty,tmp0 ; Are status lines dirty?
     78B2 A318     
0133 78B4 130E  14         jeq   pane.vdpdump.exit     ; No, skip update
0134               
0135 78B6 06A0  32         bl    @pane.topline         ; Draw top line
     78B8 7558     
0136 78BA 06A0  32         bl    @pane.botline         ; Draw bottom line
     78BC 76E4     
0137 78BE 04E0  34         clr   @fb.status.dirty      ; Reset status lines dirty flag
     78C0 A318     
0138                       ;------------------------------------------------------
0139                       ; Show ruler with tab positions
0140                       ;------------------------------------------------------
0141 78C2 C120  34         mov   @tv.ruler.visible,tmp0
     78C4 A210     
0142                                                   ; Should ruler be visible?
0143 78C6 1305  14         jeq   pane.vdpdump.exit     ; No, so exit
0144               
0145 78C8 06A0  32         bl    @cpym2v
     78CA 249A     
0146 78CC 0050                   data vdp.fb.toprow.sit
0147 78CE A31E                   data fb.ruler.sit
0148 78D0 0050                   data 80               ; Show ruler
0149                       ;------------------------------------------------------
0150                       ; Exit task
0151                       ;------------------------------------------------------
0152               pane.vdpdump.exit:
0153 78D2 C839  50         mov   *stack+,@wyx          ; Pop cursor position
     78D4 832A     
0154 78D6 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0155 78D8 C2F9  30         mov   *stack+,r11           ; Pop r11
0156 78DA 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.61466
0141                       ;-----------------------------------------------------------------------
0142                       ; Stubs
0143                       ;-----------------------------------------------------------------------
...
0007               ********|*****|*********************|**************************
0008               fm.loadfile:
0009 78DC 0649  14         dect  stack
0010 78DE C64B  30         mov   r11,*stack            ; Save return address
0011 78E0 0649  14         dect  stack
0012 78E2 C644  30         mov   tmp0,*stack           ; Push tmp0
0013                       ;------------------------------------------------------
0014                       ; Call function in bank 2
0015                       ;------------------------------------------------------
0016 78E4 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     78E6 2F84     
0017 78E8 6004                   data bank2.rom        ; | i  p0 = bank address
0018 78EA 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0019 78EC 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0020                       ;------------------------------------------------------
0021                       ; Show "Unsaved changes" dialog if editor buffer dirty
0022                       ;------------------------------------------------------
0023 78EE C120  34         mov   @outparm1,tmp0
     78F0 A016     
0024 78F2 1304  14         jeq   fm.loadfile.exit
0025               
0026 78F4 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0027 78F6 C2F9  30         mov   *stack+,r11           ; Pop r11
0028 78F8 0460  28         b     @dialog.unsaved       ; Show dialog and exit
     78FA 79A0     
0029                       ;------------------------------------------------------
0030                       ; Exit
0031                       ;------------------------------------------------------
0032               fm.loadfile.exit:
0033 78FC C139  30         mov   *stack+,tmp0          ; Pop tmp0
0034 78FE C2F9  30         mov   *stack+,r11           ; Pop r11
0035 7900 045B  20         b     *r11                  ; Return to caller
0036               
0037               
0038               ***************************************************************
...
0041               ********|*****|*********************|**************************
0042               fm.insertfile:
0043 7902 0649  14         dect  stack
0044 7904 C64B  30         mov   r11,*stack            ; Save return address
0045 7906 0649  14         dect  stack
0046 7908 C644  30         mov   tmp0,*stack           ; Push tmp0
0047                       ;------------------------------------------------------
0048                       ; Call function in bank 2
0049                       ;------------------------------------------------------
0050 790A 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     790C 2F84     
0051 790E 6004                   data bank2.rom        ; | i  p0 = bank address
0052 7910 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0053 7912 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0054                       ;------------------------------------------------------
0055                       ; Exit
0056                       ;------------------------------------------------------
0057               fm.insertfile.exit:
0058 7914 C139  30         mov   *stack+,tmp0          ; Pop tmp0
0059 7916 C2F9  30         mov   *stack+,r11           ; Pop r11
0060 7918 045B  20         b     *r11                  ; Return to caller
0061               
0062               
0063               **************************************************************
...
0068 791A 0649  14         dect  stack
0069 791C C64B  30         mov   r11,*stack            ; Save return address
0070                       ;------------------------------------------------------
0071                       ; Call function in bank 2
0072                       ;------------------------------------------------------
0073 791E 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7920 2F84     
0074 7922 6004                   data bank2.rom        ; | i  p0 = bank address
0075 7924 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0076 7926 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0077                       ;------------------------------------------------------
0078                       ; Exit
0079                       ;------------------------------------------------------
0080 7928 C2F9  30         mov   *stack+,r11           ; Pop r11
0081 792A 045B  20         b     *r11                  ; Return to caller
0082               
0083               
0084               ***************************************************************
...
0087               ********|*****|*********************|**************************
0088               fm.savefile:
0089 792C 0649  14         dect  stack
0090 792E C64B  30         mov   r11,*stack            ; Save return address
0091                       ;------------------------------------------------------
0092                       ; Call function in bank 2
0093                       ;------------------------------------------------------
0094 7930 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7932 2F84     
0095 7934 6004                   data bank2.rom        ; | i  p0 = bank address
0096 7936 7FC6                   data vec.4            ; | i  p1 = Vector with target address
0097 7938 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0098                       ;------------------------------------------------------
0099                       ; Exit
0100                       ;------------------------------------------------------
0101 793A C2F9  30         mov   *stack+,r11           ; Pop r11
0102 793C 045B  20         b     *r11                  ; Return to caller
0103               
0104               
0105               ***************************************************************
...
0108               ********|*****|*********************|**************************
0109               fm.newfile:
0110 793E 0649  14         dect  stack
0111 7940 C64B  30         mov   r11,*stack            ; Save return address
0112                       ;------------------------------------------------------
0113                       ; Call function in bank 2
0114                       ;------------------------------------------------------
0115 7942 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7944 2F84     
0116 7946 6004                   data bank2.rom        ; | i  p0 = bank address
0117 7948 7FC8                   data vec.5            ; | i  p1 = Vector with target address
0118 794A 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0119                       ;------------------------------------------------------
0120                       ; Exit
0121                       ;------------------------------------------------------
0122 794C C2F9  30         mov   *stack+,r11           ; Pop r11
0123 794E 045B  20         b     *r11                  ; Return to caller
0124               
0125               
0126               ***************************************************************
...
0131 7950 8820  54         c     @w$0008,@cmdb.dialog.var
     7952 2008     
     7954 A71C     
0132 7956 1304  14         jeq   !
0133 7958 A820  54         a     @w$0008,@cmdb.dialog.var
     795A 2008     
     795C A71C     
0134 795E 1002  14         jmp   dialog.help
0135 7960 04E0  34 !       clr   @cmdb.dialog.var
     7962 A71C     
0136               dialog.help:
0137 7964 C820  54         mov   @dialog.help.vector,@trmpvector
     7966 796C     
     7968 A054     
0138 796A 104A  14         jmp   _trampoline.bank3     ; Show dialog
0139               dialog.help.vector:
0140 796C 7FC0             data  vec.1
0141               
0142               
0143               ***************************************************************
...
0146               ********|*****|*********************|**************************
0147               dialog.load:
0148 796E C820  54         mov   @dialog.load.vector,@trmpvector
     7970 7976     
     7972 A054     
0149 7974 1045  14         jmp   _trampoline.bank3     ; Show dialog
0150               dialog.load.vector:
0151 7976 7FC2             data  vec.2
0152               
0153               
0154               ***************************************************************
...
0157               ********|*****|*********************|**************************
0158               dialog.save:
0159 7978 C820  54         mov   @dialog.save.vector,@trmpvector
     797A 7980     
     797C A054     
0160 797E 1040  14         jmp   _trampoline.bank3     ; Show dialog
0161               dialog.save.vector:
0162 7980 7FC4             data  vec.3
0163               
0164               
0165               ***************************************************************
...
0168               ********|*****|*********************|**************************
0169               dialog.insert:
0170 7982 C820  54         mov   @dialog.insert.vector,@trmpvector
     7984 798A     
     7986 A054     
0171 7988 103B  14         jmp   _trampoline.bank3     ; Show dialog
0172               dialog.insert.vector:
0173 798A 7FC6             data  vec.4
0174               
0175               
0176               ***************************************************************
...
0179               ********|*****|*********************|**************************
0180               dialog.print:
0181 798C C820  54         mov   @dialog.print.vector,@trmpvector
     798E 7994     
     7990 A054     
0182 7992 1036  14         jmp   _trampoline.bank3    ; Show dialog
0183               dialog.print.vector:
0184 7994 7FC8             data  vec.5
0185               
0186               
0187               ***************************************************************
...
0190               ********|*****|*********************|**************************
0191               dialog.file:
0192 7996 C820  54         mov   @dialog.file.vector,@trmpvector
     7998 799E     
     799A A054     
0193 799C 1031  14         jmp   _trampoline.bank3     ; Show dialog
0194               dialog.file.vector:
0195 799E 7FCA             data  vec.6
0196               
0197               
0198               ***************************************************************
...
0201               ********|*****|*********************|**************************
0202               dialog.unsaved:
0203 79A0 04E0  34         clr   @cmdb.panmarkers      ; No key markers
     79A2 A724     
0204 79A4 C820  54         mov   @dialog.unsaved.vector,@trmpvector
     79A6 79AC     
     79A8 A054     
0205 79AA 102A  14         jmp   _trampoline.bank3     ; Show dialog
0206               dialog.unsaved.vector:
0207 79AC 7FCC             data  vec.7
0208               
0209               
0210               ***************************************************************
...
0215 79AE C820  54         mov   @dialog.clipboard.vector,@trmpvector
     79B0 79B6     
     79B2 A054     
0216 79B4 1025  14         jmp   _trampoline.bank3     ; Show dialog
0217               dialog.clipboard.vector:
0218 79B6 7FCE             data  vec.8
0219               
0220               
0221               ***************************************************************
...
0224               ********|*****|*********************|**************************
0225               dialog.clipdev:
0226 79B8 C820  54         mov   @dialog.clipdev.vector,@trmpvector
     79BA 79C0     
     79BC A054     
0227 79BE 1020  14         jmp   _trampoline.bank3     ; Show dialog
0228               dialog.clipdev.vector:
0229 79C0 7FD0             data  vec.9
0230               
0231               
0232               ***************************************************************
...
0235               ********|*****|*********************|**************************
0236               dialog.config:
0237 79C2 C820  54         mov   @dialog.config.vector,@trmpvector
     79C4 79CA     
     79C6 A054     
0238 79C8 101B  14         jmp   _trampoline.bank3     ; Show dialog
0239               dialog.config.vector:
0240 79CA 7FD2             data  vec.10
0241               
0242               
0243               ***************************************************************
...
0246               ********|*****|*********************|**************************
0247               dialog.append:
0248 79CC C820  54         mov   @dialog.append.vector,@trmpvector
     79CE 79D4     
     79D0 A054     
0249 79D2 1016  14         jmp   _trampoline.bank3     ; Show dialog
0250               dialog.append.vector:
0251 79D4 7FD4             data  vec.11
0252               
0253               
0254               ***************************************************************
...
0259 79D6 C820  54         mov   @dialog.cartridge.vector,@trmpvector
     79D8 79DE     
     79DA A054     
0260 79DC 1011  14         jmp   _trampoline.bank3     ; Show dialog
0261               dialog.cartridge.vector:
0262 79DE 7FD6             data  vec.12
0263               
0264               
0265               ***************************************************************
...
0268               ********|*****|*********************|**************************
0269               dialog.basic:
0270 79E0 C820  54         mov   @dialog.basic.vector,@trmpvector
     79E2 79E8     
     79E4 A054     
0271 79E6 100C  14         jmp   _trampoline.bank3     ; Show dialog
0272               dialog.basic.vector:
0273 79E8 7FD8             data  vec.13
0274               
0275               
0276               ***************************************************************
...
0283                       ;------------------------------------------------------
0284 79EA C120  34         mov   @edb.block.m2,tmp0    ; \
     79EC A50E     
0285 79EE 0584  14         inc   tmp0                  ; | Skip if M2 unset (>ffff)
0286                                                   ; /
0287 79F0 1302  14         jeq   !                     : Block mode inactive, show dialog
0288                       ;------------------------------------------------------
0289                       ; Special treatment for block mode
0290                       ;------------------------------------------------------
0291 79F2 0460  28         b     @edkey.action.block.reset
     79F4 6826     
0292                                                   ; Reset block mode
0293                       ;------------------------------------------------------
0294                       ; Show dialog
0295                       ;------------------------------------------------------
0296 79F6 C820  54 !       mov   @dialog.menu.vector,@trmpvector
     79F8 79FE     
     79FA A054     
0297 79FC 1001  14         jmp   _trampoline.bank3     ; Show dialog
0298               dialog.menu.vector:
0299 79FE 7FFA             data  vec.30
0300               
0301               
0302               
0303               ***************************************************************
...
0307 7A00 06A0  32         bl    @pane.cursor.hide     ; Hide cursor
     7A02 74D4     
0308                       ;------------------------------------------------------
0309                       ; Call routine in specified bank
0310                       ;------------------------------------------------------
0311 7A04 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7A06 2F84     
0312 7A08 6006                   data bank3.rom        ; | i  p0 = bank address
0313 7A0A FFFF                   data >ffff            ; | i  p1 = Vector with target address
0314                                                   ; |         (deref @trmpvector)
0315 7A0C 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0316                       ;------------------------------------------------------
0317                       ; Exit
0318                       ;------------------------------------------------------
0319 7A0E 0460  28         b     @edkey.action.cmdb.show
     7A10 69DC     
...
0326               ********|*****|*********************|**************************
0327               error.display:
0328 7A12 C820  54         mov   @error.display.vector,@trmpvector
     7A14 7A1A     
     7A16 A054     
0329 7A18 103D  14         jmp   _trampoline.bank3.ret ; Longjump
0330               error.display.vector:
0331 7A1A 7FE2             data  vec.18
0332               
0333               
0334               ***************************************************************
...
0339 7A1C C820  54         mov   @pane.show_hintx.vector,@trmpvector
     7A1E 7A24     
     7A20 A054     
0340 7A22 1038  14         jmp   _trampoline.bank3.ret ; Longjump
0341               pane.show_hintx.vector:
0342 7A24 7FE4             data  vec.19
0343               
0344               
0345               ***************************************************************
...
0348               ********|*****|*********************|**************************
0349               pane.cmdb.show:
0350 7A26 C820  54         mov   @pane.cmdb.show.vector,@trmpvector
     7A28 7A2E     
     7A2A A054     
0351 7A2C 1033  14         jmp   _trampoline.bank3.ret ; Longjump
0352               pane.cmdb.show.vector:
0353 7A2E 7FE6             data  vec.20
0354               
0355               
0356               ***************************************************************
...
0359               ********|*****|*********************|**************************
0360               pane.cmdb.hide:
0361 7A30 C820  54         mov   @pane.cmdb.hide.vector,@trmpvector
     7A32 7A38     
     7A34 A054     
0362 7A36 102E  14         jmp   _trampoline.bank3.ret ; Longjump
0363               pane.cmdb.hide.vector:
0364 7A38 7FE8             data  vec.21
0365               
0366               
0367               ***************************************************************
...
0370               ********|*****|*********************|**************************
0371               pane.cmdb.draw:
0372 7A3A C820  54         mov   @pane.cmdb.draw.vector,@trmpvector
     7A3C 7A42     
     7A3E A054     
0373 7A40 1029  14         jmp   _trampoline.bank3.ret ; Longjump
0374               pane.cmdb.draw.vector:
0375 7A42 7FEA             data  vec.22
0376               
0377               
0378               ***************************************************************
...
0381               ********|*****|*********************|**************************
0382               cmdb.refresh:
0383 7A44 C820  54         mov   @cmdb.refresh.vector,@trmpvector
     7A46 7A4C     
     7A48 A054     
0384 7A4A 1024  14         jmp   _trampoline.bank3.ret ; Longjump
0385               cmdb.refresh.vector:
0386 7A4C 7FEE             data  vec.24
0387               
0388               
0389               ***************************************************************
...
0392               ********|*****|*********************|**************************
0393               cmdb.cmd.clear:
0394 7A4E C820  54         mov   @cmdb.cmd.clear.vector,@trmpvector
     7A50 7A56     
     7A52 A054     
0395 7A54 101F  14         jmp   _trampoline.bank3.ret ; Longjump
0396               cmdb.cmd.clear.vector:
0397 7A56 7FF0             data  vec.25
0398               
0399               
0400               ***************************************************************
...
0405 7A58 C820  54         mov   @cmdb.cmd.getlength.vector,@trmpvector
     7A5A 7A60     
     7A5C A054     
0406 7A5E 101A  14         jmp   _trampoline.bank3.ret ; Longjump
0407               cmdb.cmd.getlength.vector:
0408 7A60 7FF2             data  vec.26
0409               
0410               
0411               ***************************************************************
...
0416 7A62 C820  54         mov   @cmdb.cmd.preset.vector,@trmpvector
     7A64 7A6A     
     7A66 A054     
0417 7A68 1015  14         jmp   _trampoline.bank3.ret ; Longjump
0418               cmdb.cmd.preset.vector:
0419 7A6A 7FF4             data  vec.27
0420               
0421               
0422               ***************************************************************
...
0425               ********|*****|*********************|**************************
0426               cmdb.cmd.set:
0427 7A6C C820  54         mov   @cmdb.cmd.set.vector,@trmpvector
     7A6E 7A74     
     7A70 A054     
0428 7A72 1010  14         jmp   _trampoline.bank3.ret ; Longjump
0429               cmdb.cmd.set.vector:
0430 7A74 7FF6             data  vec.28
0431               
0432               
0433               
0434               ***************************************************************
...
0439 7A76 C820  54         mov   @tibasic.hearts.tat.vector,@trmpvector
     7A78 7A7E     
     7A7A A054     
0440 7A7C 100B  14         jmp   _trampoline.bank3.ret ; Longjump
0441               tibasic.hearts.tat.vector:
0442 7A7E 7FF8             data  vec.29
0443               
0444               
0445               
0446               **************************************************************
...
0451 7A80 C820  54         mov   @tibasic.sid.toggle.vector,@trmpvector
     7A82 7A88     
     7A84 A054     
0452 7A86 1006  14         jmp   _trampoline.bank3.ret ; Longjump
0453               tibasic.sid.toggle.vector:
0454 7A88 7FFC             data  vec.31
0455               
0456               
0457               **************************************************************
...
0460               ********|*****|*********************|**************************
0461               fm.fastmode:
0462 7A8A C820  54         mov   @fm.fastmode.vector,@trmpvector
     7A8C 7A92     
     7A8E A054     
0463 7A90 1001  14         jmp   _trampoline.bank3.ret ; Longjump
0464               fm.fastmode.vector:
0465 7A92 7FFE             data  vec.32
0466               
0467               
0468               
0469               
...
0474 7A94 0649  14         dect  stack
0475 7A96 C64B  30         mov   r11,*stack            ; Save return address
0476                       ;------------------------------------------------------
0477                       ; Call routine in specified bank
0478                       ;------------------------------------------------------
0479 7A98 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7A9A 2F84     
0480 7A9C 6006                   data bank3.rom        ; | i  p0 = bank address
0481 7A9E FFFF                   data >ffff            ; | i  p1 = Vector with target address
0482                                                   ; |         (deref @trmpvector)
0483 7AA0 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0484                       ;------------------------------------------------------
0485                       ; Exit
0486                       ;------------------------------------------------------
0487 7AA2 C2F9  30         mov   *stack+,r11           ; Pop r11
0488 7AA4 045B  20         b     *r11                  ; Return to caller
0489               
0490               
0491               
0492               ***************************************************************
...
0495               ********|*****|*********************|**************************
0496               fb.tab.next:
0497 7AA6 0649  14         dect  stack
0498 7AA8 C64B  30         mov   r11,*stack            ; Save return address
0499                       ;------------------------------------------------------
0500                       ; Put cursor on next tab position
0501                       ;------------------------------------------------------
0502 7AAA 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7AAC 2F84     
0503 7AAE 6008                   data bank4.rom        ; | i  p0 = bank address
0504 7AB0 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0505 7AB2 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0506                       ;------------------------------------------------------
0507                       ; Exit
0508                       ;------------------------------------------------------
0509 7AB4 C2F9  30         mov   *stack+,r11           ; Pop r11
0510 7AB6 045B  20         b     *r11                  ; Return to caller
0511               
0512               
0513               ***************************************************************
...
0516               ********|*****|*********************|**************************
0517               fb.ruler.init:
0518 7AB8 0649  14         dect  stack
0519 7ABA C64B  30         mov   r11,*stack            ; Save return address
0520                       ;------------------------------------------------------
0521                       ; Setup ruler in memory
0522                       ;------------------------------------------------------
0523 7ABC 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7ABE 2F84     
0524 7AC0 6008                   data bank4.rom        ; | i  p0 = bank address
0525 7AC2 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0526 7AC4 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0527                       ;------------------------------------------------------
0528                       ; Exit
0529                       ;------------------------------------------------------
0530 7AC6 C2F9  30         mov   *stack+,r11           ; Pop r11
0531 7AC8 045B  20         b     *r11                  ; Return to caller
0532               
0533               
0534               ***************************************************************
...
0537               ********|*****|*********************|**************************
0538               fb.colorlines:
0539 7ACA 0649  14         dect  stack
0540 7ACC C64B  30         mov   r11,*stack            ; Save return address
0541                       ;------------------------------------------------------
0542                       ; Colorize frame buffer content
0543                       ;------------------------------------------------------
0544 7ACE 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7AD0 2F84     
0545 7AD2 6008                   data bank4.rom        ; | i  p0 = bank address
0546 7AD4 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0547 7AD6 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0548                       ;------------------------------------------------------
0549                       ; Exit
0550                       ;------------------------------------------------------
0551 7AD8 C2F9  30         mov   *stack+,r11           ; Pop r11
0552 7ADA 045B  20         b     *r11                  ; Return to caller
0553               
0554               
0555               ***************************************************************
...
0558               ********|*****|*********************|**************************
0559               fb.vdpdump:
0560 7ADC 0649  14         dect  stack
0561 7ADE C64B  30         mov   r11,*stack            ; Save return address
0562                       ;------------------------------------------------------
0563                       ; Colorize frame buffer content
0564                       ;------------------------------------------------------
0565 7AE0 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7AE2 2F84     
0566 7AE4 6008                   data bank4.rom        ; | i  p0 = bank address
0567 7AE6 7FC6                   data vec.4            ; | i  p1 = Vector with target address
0568 7AE8 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0569                       ;------------------------------------------------------
0570                       ; Exit
0571                       ;------------------------------------------------------
0572 7AEA C2F9  30         mov   *stack+,r11           ; Pop r11
0573 7AEC 045B  20         b     *r11                  ; Return to caller
0574               
0575               
0576               
0577               **************************************************************
...
0580               ********|*****|*********************|**************************
0581               edb.clear.sams:
0582 7AEE C820  54         mov   @edb.clear.sams.vector,@trmpvector
     7AF0 7AF6     
     7AF2 A054     
0583 7AF4 102E  14         jmp   _trampoline.bank5.ret ; Longjump
0584               edb.clear.sams.vector:
0585 7AF6 7FC0             data  vec.1
0586               
0587               
0588               **************************************************************
...
0593 7AF8 C820  54         mov   @edb.hipage.alloc.vector,@trmpvector
     7AFA 7B00     
     7AFC A054     
0594 7AFE 1029  14         jmp   _trampoline.bank5.ret ; Longjump
0595               edb.hipage.alloc.vector:
0596 7B00 7FC2             data  vec.2
0597               
0598               
0599               **************************************************************
...
0602               ********|*****|*********************|**************************
0603               edb.block.mark:
0604 7B02 C820  54         mov   @edb.block.mark.vector,@trmpvector
     7B04 7B0A     
     7B06 A054     
0605 7B08 1024  14         jmp   _trampoline.bank5.ret ; Longjump
0606               edb.block.mark.vector:
0607 7B0A 7FC4             data  vec.3
0608               
0609               
0610               **************************************************************
...
0615 7B0C C820  54         mov   @edb.block.mark.m1.vector,@trmpvector
     7B0E 7B14     
     7B10 A054     
0616 7B12 101F  14         jmp   _trampoline.bank5.ret ; Longjump
0617               edb.block.mark.m1.vector:
0618 7B14 7FC6             data  vec.4
0619               
0620               
0621               **************************************************************
...
0626 7B16 C820  54         mov   @edb.block.mark.m2.vector,@trmpvector
     7B18 7B1E     
     7B1A A054     
0627 7B1C 101A  14         jmp   _trampoline.bank5.ret ; Longjump
0628               edb.block.mark.m2.vector:
0629 7B1E 7FC8             data  vec.5
0630               
0631               
0632               **************************************************************
...
0635               ********|*****|*********************|**************************
0636               edb.block.clip:
0637 7B20 C820  54         mov   @edb.block.clip.vector,@trmpvector
     7B22 7B28     
     7B24 A054     
0638 7B26 1015  14         jmp   _trampoline.bank5.ret ; Longjump
0639               edb.block.clip.vector:
0640 7B28 7FCA             data  vec.6
0641               
0642               
0643               **************************************************************
...
0648 7B2A C820  54         mov   @edb.block.reset.vector,@trmpvector
     7B2C 7B32     
     7B2E A054     
0649 7B30 1010  14         jmp   _trampoline.bank5.ret ; Longjump
0650               edb.block.reset.vector:
0651 7B32 7FCC             data  vec.7
0652               
0653               
0654               **************************************************************
...
0659 7B34 C820  54         mov   @edb.block.delete.vector,@trmpvector
     7B36 7B3C     
     7B38 A054     
0660 7B3A 100B  14         jmp   _trampoline.bank5.ret ; Longjump
0661               edb.block.delete.vector:
0662 7B3C 7FCE             data  vec.8
0663               
0664               
0665               **************************************************************
...
0668               ********|*****|*********************|**************************
0669               edb.block.copy:
0670 7B3E C820  54         mov   @edb.block.copy.vector,@trmpvector
     7B40 7B46     
     7B42 A054     
0671 7B44 1006  14         jmp   _trampoline.bank5.ret ; Longjump
0672               edb.block.copy.vector:
0673 7B46 7FD0             data  vec.9
0674               
0675               
0676               **************************************************************
...
0679               ********|*****|*********************|**************************
0680               edb.line.del:
0681 7B48 C820  54         mov   @edb.line.del.vector,@trmpvector
     7B4A 7B50     
     7B4C A054     
0682 7B4E 1001  14         jmp   _trampoline.bank5.ret ; Longjump
0683               edb.line.del.vector:
0684 7B50 7FD2             data  vec.10
0685               
0686               
0687               
0688               ***************************************************************
...
0692 7B52 0649  14         dect  stack
0693 7B54 C64B  30         mov   r11,*stack            ; Save return address
0694                       ;------------------------------------------------------
0695                       ; Call routine in specified bank
0696                       ;------------------------------------------------------
0697 7B56 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7B58 2F84     
0698 7B5A 600A                   data bank5.rom        ; | i  p0 = bank address
0699 7B5C FFFF                   data >ffff            ; | i  p1 = Vector with target address
0700                                                   ; |         (deref @trmpvector)
0701 7B5E 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0702                       ;------------------------------------------------------
0703                       ; Exit
0704                       ;------------------------------------------------------
0705 7B60 C2F9  30         mov   *stack+,r11           ; Pop r11
0706 7B62 045B  20         b     *r11                  ; Return to caller
0707               
0708               
0709               ***************************************************************
...
0714 7B64 0649  14         dect  stack
0715 7B66 C64B  30         mov   r11,*stack            ; Save return address
0716                       ;------------------------------------------------------
0717                       ; Dump VDP patterns
0718                       ;------------------------------------------------------
0719 7B68 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7B6A 2F84     
0720 7B6C 600C                   data bank6.rom        ; | i  p0 = bank address
0721 7B6E 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0722 7B70 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0723                       ;------------------------------------------------------
0724                       ; Exit
0725                       ;------------------------------------------------------
0726 7B72 C2F9  30         mov   *stack+,r11           ; Pop r11
0727 7B74 045B  20         b     *r11                  ; Return to caller
0728               
0729               
0730               
0731               ***************************************************************
...
0734               ********|*****|*********************|**************************
0735               tibasic1:
0736 7B76 0204  20         li    tmp0,1
     7B78 0001     
0737 7B7A C804  38         mov   tmp0,@tibasic.session
     7B7C A034     
0738 7B7E 1013  14         jmp   tibasic
0739               tibasic2:
0740 7B80 0204  20         li    tmp0,2
     7B82 0002     
0741 7B84 C804  38         mov   tmp0,@tibasic.session
     7B86 A034     
0742 7B88 100E  14         jmp   tibasic
0743               tibasic3:
0744 7B8A 0204  20         li    tmp0,3
     7B8C 0003     
0745 7B8E C804  38         mov   tmp0,@tibasic.session
     7B90 A034     
0746 7B92 1009  14         jmp   tibasic
0747               tibasic4:
0748 7B94 0204  20         li    tmp0,4
     7B96 0004     
0749 7B98 C804  38         mov   tmp0,@tibasic.session
     7B9A A034     
0750 7B9C 1004  14         jmp   tibasic
0751               tibasic5:
0752 7B9E 0204  20         li    tmp0,5
     7BA0 0005     
0753 7BA2 C804  38         mov   tmp0,@tibasic.session
     7BA4 A034     
0754               tibasic:
0755 7BA6 0649  14         dect  stack
0756 7BA8 C64B  30         mov   r11,*stack            ; Save return address
0757                       ;------------------------------------------------------
0758                       ; Run TI Basic session
0759                       ;------------------------------------------------------
0760 7BAA 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7BAC 2F84     
0761 7BAE 600E                   data bank7.rom        ; | i  p0 = bank address
0762 7BB0 7FD2                   data vec.10           ; | i  p1 = Vector with target address
0763 7BB2 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0764               
0765 7BB4 06A0  32         bl    @dialog.basic         ; Refresh TI Basic dialog upon return
     7BB6 79E0     
0766                       ;------------------------------------------------------
0767                       ; Exit
0768                       ;------------------------------------------------------
0769 7BB8 C2F9  30         mov   *stack+,r11           ; Pop r11
0770 7BBA 045B  20         b     *r11                  ; Return to caller
0771               
0772               
0773               
0774               ***************************************************************
0775               * Stub for "tibasic.uncrunch"
0776               * bank7 vec.11
0777               ********|*****|*********************|**************************
0778               tibasic.uncrunch:
0779 7BBC 0649  14         dect  stack
0780 7BBE C64B  30         mov   r11,*stack            ; Save return address
0781                       ;------------------------------------------------------
0782                       ; Uncrunch TI basic program
0783                       ;------------------------------------------------------
0784 7BC0 C820  54         mov   @w$0001,@parm1
     7BC2 2002     
     7BC4 A006     
0785 7BC6 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7BC8 2F84     
0786 7BCA 600E                   data bank7.rom        ; | i  p0 = bank address
0787 7BCC 7FD4                   data vec.11           ; | i  p1 = Vector with target address
0788 7BCE 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0789                       ;------------------------------------------------------
0790                       ; Exit
0791                       ;------------------------------------------------------
0792 7BD0 C2F9  30         mov   *stack+,r11           ; Pop r11
0793 7BD2 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.61466
...
0034 7BD4 0649  14         dect  stack
0035 7BD6 C64B  30         mov   r11,*stack            ; Save return address
0036                       ;------------------------------------------------------
0037                       ; Dump VDP patterns
0038                       ;------------------------------------------------------
0039 7BD8 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7BDA 2F84     
0040 7BDC 600E                   data bank7.rom        ; | i  p0 = bank address
0041 7BDE 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0042 7BE0 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0043                       ;------------------------------------------------------
0044                       ; Exit
0045                       ;------------------------------------------------------
0046 7BE2 C2F9  30         mov   *stack+,r11           ; Pop r11
0047 7BE4 045B  20         b     *r11                  ; Return to caller
0049               
0050               
0052               ***************************************************************
...
0057 7BE6 0649  14         dect  stack
0058 7BE8 C64B  30         mov   r11,*stack            ; Save return address
0059                       ;------------------------------------------------------
0060                       ; Dump VDP patterns
0061                       ;------------------------------------------------------
0062 7BEA 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7BEC 2F84     
0063 7BEE 600E                   data bank7.rom        ; | i  p0 = bank address
0064 7BF0 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0065 7BF2 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0066                       ;------------------------------------------------------
0067                       ; Exit
0068                       ;------------------------------------------------------
0069 7BF4 C2F9  30         mov   *stack+,r11           ; Pop r11
0070 7BF6 045B  20         b     *r11                  ; Return to caller
0072               
0073               
0075               ***************************************************************
...
0080 7BF8 0649  14         dect  stack
0081 7BFA C64B  30         mov   r11,*stack            ; Save return address
0082                       ;------------------------------------------------------
0083                       ; Dump VDP patterns
0084                       ;------------------------------------------------------
0085 7BFC 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7BFE 2F84     
0086 7C00 600E                   data bank7.rom        ; | i  p0 = bank address
0087 7C02 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0088 7C04 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0089                       ;------------------------------------------------------
0090                       ; Exit
0091                       ;------------------------------------------------------
0092 7C06 C2F9  30         mov   *stack+,r11           ; Pop r11
0093 7C08 045B  20         b     *r11                  ; Return to caller
0095               
0096               
0098               ***************************************************************
...
0101               ********|*****|*********************|**************************
0102               magic.set:
0103 7C0A 0649  14         dect  stack
0104 7C0C C64B  30         mov   r11,*stack            ; Save return address
0105                       ;------------------------------------------------------
0106                       ; Dump VDP patterns
0107                       ;------------------------------------------------------
0108 7C0E 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7C10 2F84     
0109 7C12 600E                   data bank7.rom        ; | i  p0 = bank address
0110 7C14 7FE6                   data vec.20           ; | i  p1 = Vector with target address
0111 7C16 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0112                       ;------------------------------------------------------
0113                       ; Exit
0114                       ;------------------------------------------------------
0115 7C18 C2F9  30         mov   *stack+,r11           ; Pop r11
0116 7C1A 045B  20         b     *r11                  ; Return to caller
0118               
0119               
0121               ***************************************************************
...
0124               ********|*****|*********************|**************************
0125               magic.clear:
0126 7C1C 0649  14         dect  stack
0127 7C1E C64B  30         mov   r11,*stack            ; Save return address
0128                       ;------------------------------------------------------
0129                       ; Dump VDP patterns
0130                       ;------------------------------------------------------
0131 7C20 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7C22 2F84     
0132 7C24 600E                   data bank7.rom        ; | i  p0 = bank address
0133 7C26 7FE8                   data vec.21           ; | i  p1 = Vector with target address
0134 7C28 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0135                       ;------------------------------------------------------
0136                       ; Exit
0137                       ;------------------------------------------------------
0138 7C2A C2F9  30         mov   *stack+,r11           ; Pop r11
0139 7C2C 045B  20         b     *r11                  ; Return to caller
0141               
0142               
0144               ***************************************************************
...
0147               ********|*****|*********************|**************************
0148               magic.check:
0149 7C2E 0649  14         dect  stack
0150 7C30 C64B  30         mov   r11,*stack            ; Save return address
0151                       ;------------------------------------------------------
0152                       ; Dump VDP patterns
0153                       ;------------------------------------------------------
0154 7C32 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     7C34 2F84     
0155 7C36 600E                   data bank7.rom        ; | i  p0 = bank address
0156 7C38 7FEA                   data vec.22           ; | i  p1 = Vector with target address
0157 7C3A 6002                   data bankid           ; / i  p2 = Source ROM bank for return
0158                       ;------------------------------------------------------
0159                       ; Exit
0160                       ;------------------------------------------------------
0161 7C3C C2F9  30         mov   *stack+,r11           ; Pop r11
0162 7C3E 045B  20         b     *r11                  ; Return to caller
                   < stevie_b1.asm.61466
0146                       ;-----------------------------------------------------------------------
0147                       ; Program data
0148                       ;-----------------------------------------------------------------------
...
0009                       ; Movement keys
0010                       ;-------------------------------------------------------
0011 7C40 0D00             byte  key.enter, pane.focus.fb
0012 7C42 6670             data  edkey.action.enter
0013               
0014 7C44 0800             byte  key.fctn.s, pane.focus.fb
0015 7C46 6222             data  edkey.action.left
0016               
0017 7C48 0900             byte  key.fctn.d, pane.focus.fb
0018 7C4A 623C             data  edkey.action.right
0019               
0020 7C4C 0B00             byte  key.fctn.e, pane.focus.fb
0021 7C4E 6334             data  edkey.action.up
0022               
0023 7C50 0A00             byte  key.fctn.x, pane.focus.fb
0024 7C52 633C             data  edkey.action.down
0025               
0026 7C54 BF00             byte  key.fctn.h, pane.focus.fb
0027 7C56 6258             data  edkey.action.home
0028               
0029 7C58 C000             byte  key.fctn.j, pane.focus.fb
0030 7C5A 6282             data  edkey.action.pword
0031               
0032 7C5C C100             byte  key.fctn.k, pane.focus.fb
0033 7C5E 62D4             data  edkey.action.nword
0034               
0035 7C60 C200             byte  key.fctn.l, pane.focus.fb
0036 7C62 6260             data  edkey.action.end
0037               
0038 7C64 0C00             byte  key.fctn.6, pane.focus.fb
0039 7C66 6344             data  edkey.action.ppage
0040               
0041 7C68 0200             byte  key.fctn.4, pane.focus.fb
0042 7C6A 6380             data  edkey.action.npage
0043               
0044 7C6C 8500             byte  key.ctrl.e, pane.focus.fb
0045 7C6E 6344             data  edkey.action.ppage
0046               
0047 7C70 9800             byte  key.ctrl.x, pane.focus.fb
0048 7C72 6380             data  edkey.action.npage
0049               
0050 7C74 7F00             byte  key.fctn.v, pane.focus.fb
0051 7C76 63D6             data  edkey.action.topscr
0052               
0053 7C78 BE00             byte  key.fctn.b, pane.focus.fb
0054 7C7A 6420             data  edkey.action.botscr
0055               
0056 7C7C 9600             byte  key.ctrl.v, pane.focus.fb
0057 7C7E 63BA             data  edkey.action.top
0058               
0059 7C80 8200             byte  key.ctrl.b, pane.focus.fb
0060 7C82 63F0             data  edkey.action.bot
0061                       ;-------------------------------------------------------
0062                       ; Modifier keys - Delete
0063                       ;-------------------------------------------------------
0064 7C84 0300             byte  key.fctn.1, pane.focus.fb
0065 7C86 64AE             data  edkey.action.del_char
0066               
0067 7C88 0700             byte  key.fctn.3, pane.focus.fb
0068 7C8A 6560             data  edkey.action.del_line
0069               
0070 7C8C 8C00             byte  key.ctrl.l, pane.focus.fb
0071 7C8E 652C             data  edkey.action.del_eol
0072                       ;-------------------------------------------------------
0073                       ; Modifier keys - Insert
0074                       ;-------------------------------------------------------
0075 7C90 0400             byte  key.fctn.2, pane.focus.fb
0076 7C92 65C2             data  edkey.action.ins_char.ws
0077               
0078 7C94 B900             byte  key.fctn.dot, pane.focus.fb
0079 7C96 66F6             data  edkey.action.ins_onoff
0080               
0081 7C98 0100             byte  key.fctn.7, pane.focus.fb
0082 7C9A 68E4             data  edkey.action.fb.tab.next
0083               
0084 7C9C 9400             byte  key.ctrl.t, pane.focus.fb
0085 7C9E 68E4             data  edkey.action.fb.tab.next
0086               
0087 7CA0 0600             byte  key.fctn.8, pane.focus.fb
0088 7CA2 6658             data  edkey.action.ins_line
0089                       ;-------------------------------------------------------
0090                       ; Block marking/modifier
0091                       ;-------------------------------------------------------
0092 7CA4 F000             byte  key.ctrl.space, pane.focus.fb
0093 7CA6 681E             data  edkey.action.block.mark
0094               
0095 7CA8 8300             byte  key.ctrl.c, pane.focus.fb
0096 7CAA 67BE             data  edkey.action.copyblock_or_clipboard
0097               
0098 7CAC 8400             byte  key.ctrl.d, pane.focus.fb
0099 7CAE 686E             data  edkey.action.block.delete
0100               
0101 7CB0 8D00             byte  key.ctrl.m, pane.focus.fb
0102 7CB2 6898             data  edkey.action.block.move
0103               
0104 7CB4 8700             byte  key.ctrl.g, pane.focus.fb
0105 7CB6 68CA             data  edkey.action.block.goto.m1
0106                       ;-------------------------------------------------------
0107                       ; Clipboards
0108                       ;-------------------------------------------------------
0109 7CB8 B100             byte  key.ctrl.1, pane.focus.fb
0110 7CBA 68F2             data  edkey.action.fb.clip.save.1
0111               
0112 7CBC B200             byte  key.ctrl.2, pane.focus.fb
0113 7CBE 68F8             data  edkey.action.fb.clip.save.2
0114               
0115 7CC0 B300             byte  key.ctrl.3, pane.focus.fb
0116 7CC2 68FE             data  edkey.action.fb.clip.save.3
0117               
0118 7CC4 B400             byte  key.ctrl.4, pane.focus.fb
0119 7CC6 6904             data  edkey.action.fb.clip.save.4
0120               
0121 7CC8 B500             byte  key.ctrl.5, pane.focus.fb
0122 7CCA 690A             data  edkey.action.fb.clip.save.5
0123                       ;-------------------------------------------------------
0124                       ; Other action keys
0125                       ;-------------------------------------------------------
0126 7CCC 0500             byte  key.fctn.plus, pane.focus.fb
0127 7CCE 67B0             data  edkey.action.quit
0128               
0129 7CD0 9100             byte  key.ctrl.q, pane.focus.fb
0130 7CD2 67B0             data  edkey.action.quit
0131               
0132 7CD4 9500             byte  key.ctrl.u, pane.focus.fb
0133 7CD6 6770             data  edkey.action.toggle.ruler
0134               
0135 7CD8 9A00             byte  key.ctrl.z, pane.focus.fb
0136 7CDA 725C             data  pane.action.colorscheme.cycle
0137               
0138 7CDC 8000             byte  key.ctrl.comma, pane.focus.fb
0139 7CDE 67CE             data  edkey.action.fb.fname.dec.load
0140               
0141 7CE0 9B00             byte  key.ctrl.dot, pane.focus.fb
0142 7CE2 67E0             data  edkey.action.fb.fname.inc.load
0143               
0144 7CE4 BB00             byte  key.ctrl.slash, pane.focus.fb
0145 7CE6 79E0             data  dialog.basic
0146                       ;-------------------------------------------------------
0147                       ; Dialog keys
0148                       ;-------------------------------------------------------
0149 7CE8 8100             byte  key.ctrl.a, pane.focus.fb
0150 7CEA 79CC             data  dialog.append
0151               
0152 7CEC 8800             byte  key.ctrl.h, pane.focus.fb
0153 7CEE 7964             data  dialog.help
0154               
0155 7CF0 8600             byte  key.ctrl.f, pane.focus.fb
0156 7CF2 7996             data  dialog.file
0157               
0158 7CF4 8900             byte  key.ctrl.i, pane.focus.fb
0159 7CF6 7982             data  dialog.insert
0160               
0161 7CF8 9300             byte  key.ctrl.s, pane.focus.fb
0162 7CFA 7978             data  dialog.save
0163               
0164 7CFC 8F00             byte  key.ctrl.o, pane.focus.fb
0165 7CFE 796E             data  dialog.load
0166               
0167 7D00 9000             byte  key.ctrl.p, pane.focus.fb
0168 7D02 798C             data  dialog.print
0169               
0170                       ;
0171                       ; FCTN-9 has multiple purposes, if block mode is on it
0172                       ; resets the block, otherwise show dialog "Main Menu".
0173                       ;
0174 7D04 0F00             byte  key.fctn.9, pane.focus.fb
0175 7D06 79EA             data  dialog.menu
0176                       ;-------------------------------------------------------
0177                       ; End of list
0178                       ;-------------------------------------------------------
0179 7D08 FFFF             data  EOL                           ; EOL
0180               
0181               
0182               
0183               *---------------------------------------------------------------
...
0189                       ;-------------------------------------------------------
0190 7D0A 4664             byte  key.uc.f, id.dialog.menu
0191 7D0C 7996             data  dialog.file
0192               
0193 7D0E 4364             byte  key.uc.c, id.dialog.menu
0194 7D10 79D6             data  dialog.cartridge
0195               
0196 7D12 4864             byte  key.uc.h, id.dialog.menu
0197 7D14 7964             data  dialog.help
0198               
0199 7D16 5164             byte  key.uc.q, id.dialog.menu
0200 7D18 67B0             data  edkey.action.quit
0201                       ;-------------------------------------------------------
0202                       ; Dialog: File
0203                       ;-------------------------------------------------------
0204 7D1A 4E69             byte  key.uc.n, id.dialog.file
0205 7D1C 69EE             data  edkey.action.cmdb.file.new
0206               
0207 7D1E 5369             byte  key.uc.s, id.dialog.file
0208 7D20 7978             data  dialog.save
0209               
0210 7D22 4F69             byte  key.uc.o, id.dialog.file
0211 7D24 796E             data  dialog.load
0212               
0213 7D26 5069             byte  key.uc.p, id.dialog.file
0214 7D28 798C             data  dialog.print
0215               
0216 7D2A 4369             byte  key.uc.c, id.dialog.file
0217 7D2C 79C2             data  dialog.config
0218                       ;-------------------------------------------------------
0219                       ; Dialog: Open file
0220                       ;-------------------------------------------------------
0221 7D2E 0E0A             byte  key.fctn.5, id.dialog.load
0222 7D30 6D0A             data  edkey.action.cmdb.fastmode.toggle
0223               
0224 7D32 0D0A             byte  key.enter, id.dialog.load
0225 7D34 6A12             data  edkey.action.cmdb.load
0226                       ;-------------------------------------------------------
0227                       ; Dialog: Insert file at line ...
0228                       ;-------------------------------------------------------
0229 7D36 0E0D             byte  key.fctn.5, id.dialog.insert
0230 7D38 6D0A             data  edkey.action.cmdb.fastmode.toggle
0231               
0232 7D3A 0D0D             byte  key.enter, id.dialog.insert
0233 7D3C 6A56             data  edkey.action.cmdb.insert
0234                       ;-------------------------------------------------------
0235                       ; Dialog: Append file
0236                       ;-------------------------------------------------------
0237 7D3E 0E0E             byte  key.fctn.5, id.dialog.append
0238 7D40 6D0A             data  edkey.action.cmdb.fastmode.toggle
0239               
0240 7D42 0D0E             byte  key.enter, id.dialog.append
0241 7D44 6AD8             data  edkey.action.cmdb.append
0242                       ;-------------------------------------------------------
0243                       ; Dialog: Copy clipboard to line ...
0244                       ;-------------------------------------------------------
0245 7D46 0E67             byte  key.fctn.5, id.dialog.clipboard
0246 7D48 6D0A             data  edkey.action.cmdb.fastmode.toggle
0247               
0248 7D4A 0167             byte  key.fctn.7, id.dialog.clipboard
0249 7D4C 79B8             data  dialog.clipdev
0250               
0251 7D4E 3167             byte  key.num.1, id.dialog.clipboard
0252 7D50 6B4C             data  edkey.action.cmdb.clip.1
0253               
0254 7D52 3267             byte  key.num.2, id.dialog.clipboard
0255 7D54 6B52             data  edkey.action.cmdb.clip.2
0256               
0257 7D56 3367             byte  key.num.3, id.dialog.clipboard
0258 7D58 6B58             data  edkey.action.cmdb.clip.3
0259               
0260 7D5A 3467             byte  key.num.4, id.dialog.clipboard
0261 7D5C 6B5E             data  edkey.action.cmdb.clip.4
0262               
0263 7D5E 3567             byte  key.num.5, id.dialog.clipboard
0264 7D60 6B64             data  edkey.action.cmdb.clip.5
0265                       ;-------------------------------------------------------
0266                       ; Dialog: Configure clipboard device
0267                       ;-------------------------------------------------------
0268 7D62 0D11             byte  key.enter, id.dialog.clipdev
0269 7D64 6B98             data  edkey.action.cmdb.clipdev.configure
0270                       ;-------------------------------------------------------
0271                       ; Dialog: Configure
0272                       ;-------------------------------------------------------
0273 7D66 436C             byte  key.uc.c, id.dialog.config
0274 7D68 79B8             data  dialog.clipdev
0275                       ;-------------------------------------------------------
0276                       ; Dialog: Save file
0277                       ;-------------------------------------------------------
0278 7D6A 0D0B             byte  key.enter, id.dialog.save
0279 7D6C 6BE8             data  edkey.action.cmdb.save
0280               
0281 7D6E 0D0C             byte  key.enter, id.dialog.saveblock
0282 7D70 6BE8             data  edkey.action.cmdb.save
0283                       ;-------------------------------------------------------
0284                       ; Dialog: Print file
0285                       ;-------------------------------------------------------
0286 7D72 0D0F             byte  key.enter, id.dialog.print
0287 7D74 6C64             data  edkey.action.cmdb.print
0288               
0289 7D76 0D10             byte  key.enter, id.dialog.printblock
0290 7D78 6C64             data  edkey.action.cmdb.print
0291                       ;-------------------------------------------------------
0292                       ; Dialog: Unsaved changes
0293                       ;-------------------------------------------------------
0294 7D7A 0C65             byte  key.fctn.6, id.dialog.unsaved
0295 7D7C 6CE0             data  edkey.action.cmdb.proceed
0296               
0297 7D7E 2065             byte  key.space, id.dialog.unsaved
0298 7D80 6CE0             data  edkey.action.cmdb.proceed
0299               
0300 7D82 0D65             byte  key.enter, id.dialog.unsaved
0301 7D84 7978             data  dialog.save
0302                       ;-------------------------------------------------------
0303                       ; Dialog: Cartridge
0304                       ;-------------------------------------------------------
0305 7D86 426A             byte  key.uc.b, id.dialog.cartridge
0306 7D88 79E0             data  dialog.basic
0307                       ;-------------------------------------------------------
0308                       ; Dialog: Basic
0309                       ;-------------------------------------------------------
0310 7D8A 316B             byte  key.num.1, id.dialog.basic
0311 7D8C 7B76             data  tibasic1
0312               
0313 7D8E 326B             byte  key.num.2, id.dialog.basic
0314 7D90 7B80             data  tibasic2
0315               
0316 7D92 336B             byte  key.num.3, id.dialog.basic
0317 7D94 7B8A             data  tibasic3
0318               
0319 7D96 346B             byte  key.num.4, id.dialog.basic
0320 7D98 7B94             data  tibasic4
0321               
0322 7D9A 356B             byte  key.num.5, id.dialog.basic
0323 7D9C 7B9E             data  tibasic5
0324               
0325 7D9E 0E6B             byte  key.fctn.5, id.dialog.basic
0326 7DA0 6D16             data  edkey.action.cmdb.sid.toggle
0327               
0328 7DA2 B16B             byte  key.ctrl.1, id.dialog.basic
0329 7DA4 7BBC             data  tibasic.uncrunch
0330                       ;-------------------------------------------------------
0331                       ; Dialog: Help
0332                       ;-------------------------------------------------------
0333 7DA6 2068             byte  key.space, id.dialog.help
0334 7DA8 7950             data  dialog.help.next
0335               
0336 7DAA 0F68             byte  key.fctn.9, id.dialog.help
0337 7DAC 6D2A             data  edkey.action.cmdb.close.about
0338               
0339 7DAE 0D68             byte  key.enter, id.dialog.help
0340 7DB0 6D2A             data  edkey.action.cmdb.close.about
0341                       ;-------------------------------------------------------
0342                       ; Movement keys
0343                       ;-------------------------------------------------------
0344 7DB2 0801             byte  key.fctn.s, pane.focus.cmdb
0345 7DB4 6922             data  edkey.action.cmdb.left
0346               
0347 7DB6 0901             byte  key.fctn.d, pane.focus.cmdb
0348 7DB8 6934             data  edkey.action.cmdb.right
0349               
0350 7DBA BF01             byte  key.fctn.h, pane.focus.cmdb
0351 7DBC 694C             data  edkey.action.cmdb.home
0352               
0353 7DBE C201             byte  key.fctn.l, pane.focus.cmdb
0354 7DC0 6960             data  edkey.action.cmdb.end
0355                       ;-------------------------------------------------------
0356                       ; Modifier keys
0357                       ;-------------------------------------------------------
0358 7DC2 0701             byte  key.fctn.3, pane.focus.cmdb
0359 7DC4 6978             data  edkey.action.cmdb.clear
0360                       ;-------------------------------------------------------
0361                       ; Other action keys
0362                       ;-------------------------------------------------------
0363 7DC6 0F01             byte  key.fctn.9, pane.focus.cmdb
0364 7DC8 6D3A             data  edkey.action.cmdb.close.dialog
0365               
0366 7DCA 0501             byte  key.fctn.plus, pane.focus.cmdb
0367 7DCC 67B0             data  edkey.action.quit
0368               
0369 7DCE 8101             byte  key.ctrl.a, pane.focus.cmdb
0370 7DD0 6D22             data  edkey.action.cmdb.preset
0371               
0372 7DD2 8201             byte  key.ctrl.b, pane.focus.cmdb
0373 7DD4 6D22             data  edkey.action.cmdb.preset
0374               
0375 7DD6 8301             byte  key.ctrl.c, pane.focus.cmdb
0376 7DD8 6D22             data  edkey.action.cmdb.preset
0377               
0378 7DDA 9A01             byte  key.ctrl.z, pane.focus.cmdb
0379 7DDC 725C             data  pane.action.colorscheme.cycle
0380                       ;------------------------------------------------------
0381                       ; End of list
0382                       ;-------------------------------------------------------
0383 7DDE FFFF             data  EOL                           ; EOL
                   < stevie_b1.asm.61466
0150                       ;-----------------------------------------------------------------------
...
0028 7FD2 701E     vec.10  data  edb.line.pack.fb      ;
0029 7FD4 7116     vec.11  data  edb.line.unpack.fb    ;
0030 7FD6 7AEE     vec.12  data  edb.clear.sams        ;
0031 7FD8 2026     vec.13  data  cpu.crash             ;
0032 7FDA 2026     vec.14  data  cpu.crash             ;
0033 7FDC 69DC     vec.15  data  edkey.action.cmdb.show
0034 7FDE 2026     vec.16  data  cpu.crash             ;
0035 7FE0 2026     vec.17  data  cpu.crash             ;
0036 7FE2 2026     vec.18  data  cpu.crash             ;
0037 7FE4 7A4E     vec.19  data  cmdb.cmd.clear        ;
0038 7FE6 6F72     vec.20  data  fb.refresh            ;
0039 7FE8 7ADC     vec.21  data  fb.vdpdump            ;
0040 7FEA 6D4E     vec.22  data  fb.row2line           ;
...
0045 7FF4 76AE     vec.27  data  pane.errline.hide     ;
0046 7FF6 74F2     vec.28  data  pane.cursor.blink     ;
0047 7FF8 74D4     vec.29  data  pane.cursor.hide      ;
0048 7FFA 764C     vec.30  data  pane.errline.show     ;
0049 7FFC 72BA     vec.31  data  pane.action.colorscheme.load
0050 7FFE 74BA     vec.32  data  pane.action.colorscheme.statlines
                   < stevie_b1.asm.61466
