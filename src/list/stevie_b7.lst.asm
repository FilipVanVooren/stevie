...
0008               ***************************************************************
0009               * File: stevie_b7.asm               ; Version 211223-2003580
0010               *
0011               * Bank 7 "Jonas"
0012               * Empty
0013               ***************************************************************
...
0031 6040 04E0  34         clr   @bank0.rom            ; Switch to bank 0 "Jill"
     6042 6000     
0032               ***************************************************************
0033               * Step 2: Copy spectra2 library into cartridge space
0034               ********|*****|*********************|**************************
0035               main:
0036                       aorg  kickstart.code2       ; >6046
0037 6046 06A0  32         bl    @cpu.crash            ; Should never get here
     6048 6070     
0038               
...
0098 6102 A100                   data rambuf           ; | i  p2 = Pointer to ram buffer
...
0110 6116 A100                   data rambuf           ; | i  p2 = Pointer to ram buffer
...
0159 6164 A100                   data rambuf           ; | i  p1 = Pointer to ram buffer
...
0170 6176 06A0  32         bl    @putstr               ; Put length-byte prefixed string at current YX
     6178 647C     
0171 617A A100                   data rambuf           ; \ i  p0 = Pointer to ram buffer
0172                                                   ; /
0173               
...
0187 6198 A100                   data rambuf           ; | i  p1 = Pointer to ram buffer
...
0196 61A2 A100                   data rambuf           ; | i  p1 = Pointer to ram buffer
...
0214 61C0 06A0  32         bl    @putstr               ; Put length-byte prefixed string at current YX
     61C2 647C     
0215 61C4 A100                   data rambuf           ; \ i  p0 = Pointer to ram buffer
0216                                                   ; /
0217               
...
0270 6237   42             text  'Build-ID  211223-2003580'
     6238 7569     
     623A 6C64     
     623C 2D49     
     623E 4420     
...
0041               ********|*****|*********************|**************************
0042 67B0 C20B  18 f18idl  mov   r11,tmp4              ; Save R11
0043 67B2 06A0  32         bl    @putvr                ; VR56 >38, value 00000000
     67B4 6390     
0044 67B6 3800             data  >3800                 ; Reset and load PC (GPU idle!)
0045 67B8 0458  20         b     *tmp4                 ; Exit
0046               
0047               
0048               
0049               ***************************************************************
...
0057               ********|*****|*********************|**************************
0058 67BA C20B  18 f18chk  mov   r11,tmp4              ; Save R11
0059 67BC 06A0  32         bl    @cpym2v
     67BE 64E4     
0060 67C0 3F00             data  >3f00,f18chk_gpu,8    ; Copy F18A GPU code to VRAM
     67C2 6804     
     67C4 0008     
0061 67C6 06A0  32         bl    @putvr
     67C8 6390     
0062 67CA 363F             data  >363f                 ; Load MSB of GPU PC (>3f) into VR54 (>36)
0063 67CC 06A0  32         bl    @putvr
     67CE 6390     
0064 67D0 3700             data  >3700                 ; Load LSB of GPU PC (>00) into VR55 (>37)
0065                                                   ; GPU code should run now
0066               
0067 67D2 06A0  32         bl    @putvr                ; VR56 >38, value 00000000
     67D4 6390     
0068 67D6 3800             data  >3800                 ; Reset and load PC (GPU idle!)
0069               ***************************************************************
0070               * VDP @>3f00 == 0 ? F18A present : F18a not present
0071               ***************************************************************
0072 67D8 0204  20         li    tmp0,>3f00
     67DA 3F00     
0073 67DC 06A0  32         bl    @vdra                 ; Set VDP read address to >3f00
     67DE 6318     
0074 67E0 D120  34         movb  @vdpr,tmp0            ; Read MSB byte
     67E2 8800     
0075 67E4 0984  56         srl   tmp0,8
0076 67E6 D120  34         movb  @vdpr,tmp0            ; Read LSB byte
     67E8 8800     
0077 67EA C104  18         mov   tmp0,tmp0             ; For comparing with 0
0078 67EC 1303  14         jeq   f18chk_yes
0079               f18chk_no:
0080 67EE 0242  22         andi  config,>bfff          ; CONFIG Register bit 1=0
     67F0 BFFF     
0081 67F2 1002  14         jmp   f18chk_exit
0082               f18chk_yes:
0083 67F4 0262  22         ori   config,>4000          ; CONFIG Register bit 1=1
     67F6 4000     
0084               
0085               f18chk_exit:
0086 67F8 06A0  32         bl    @filv                 ; Clear VDP mem >3f00->3f05
     67FA 62EC     
0087 67FC 3F00             data  >3f00,>00,6
     67FE 0000     
     6800 0006     
0088 6802 0458  20         b     *tmp4                 ; Exit
0089               ***************************************************************
0090               * GPU code
0091               ********|*****|*********************|**************************
0092               f18chk_gpu
0093 6804 04E0             data  >04e0                 ; 3f00 \ 04e0  clr @>3f00
0094 6806 3F00             data  >3f00                 ; 3f02 / 3f00
0095 6808 0340             data  >0340                 ; 3f04   0340  idle
0096 680A 10FF             data  >10ff                 ; 3f06   10ff  \ jmp $
...
0118               ********|*****|*********************|**************************
0119 680C C20B  18 f18rst  mov   r11,tmp4              ; Save R11
0120                       ;------------------------------------------------------
0121                       ; Reset all F18a VDP registers to power-on defaults
0122                       ;------------------------------------------------------
0123 680E 06A0  32         bl    @putvr
     6810 6390     
0124 6812 3280             data  >3280                 ; F18a VR50 (>32), MSB 8=1
0125               
0126 6814 06A0  32         bl    @putvr                ; VR1/57, value 00000000
     6816 6390     
0127 6818 3900             data  >3900                 ; Lock the F18a
0128 681A 0458  20         b     *tmp4                 ; Exit
0129               
0130               
0131               
0132               ***************************************************************
...
0146               ********|*****|*********************|**************************
0147 681C C20B  18 f18fwv  mov   r11,tmp4              ; Save R11
0148 681E 20A0  38         coc   @wbit1,config         ; CONFIG bit 1 set ?
     6820 6068     
0149 6822 1609  14         jne   f18fw1
0150               ***************************************************************
0151               * Read F18A major/minor version
0152               ***************************************************************
0153 6824 C120  34         mov   @vdps,tmp0            ; Clear VDP status register
     6826 8802     
0154 6828 06A0  32         bl    @putvr                ; Write to VR#15 for setting F18A status
     682A 6390     
0155 682C 0F0E             data  >0f0e                 ; register to read (0e=VR#14)
0156 682E 04C4  14         clr   tmp0
0157 6830 D120  34         movb  @vdps,tmp0
     6832 8802     
0158 6834 0984  56         srl   tmp0,8
0159 6836 0458  20 f18fw1  b     *tmp4                 ; Exit
                   < runlib.asm
0144               
...
0118 6A40 5CB9             data  >5cb9,>7c03,>bc22,>bdBA
     ...
     6A44 BC22     
     6A46 BDBA     
0119 6A48 FF00     kbctrl  data  >ff00,>0000,>ff0d,>f09D
     6A4A 0000     
     6A4C FF0D     
     6A4E F09D     
...
0057 6D16 6D18             data  dsrlnk.init           ; Entry point
0058                       ;------------------------------------------------------
...
0310 6E42 6E44             data  dsrlnk.reuse.init     ; entry point
0311                       ;------------------------------------------------------
...
0353 70D8 06A0  32 runlic  bl    @vidtab               ; Load video mode table into VDP
     70DA 6356     
0354 70DC 7100             data  spvmod                ; Equate selected video mode table
...
0041                       ; Stubs
0042                       ;-----------------------------------------------------------------------
0043                       copy  "rom.stubs.bank7.asm" ; Stubs for functions in other banks
     **** ****     > rom.stubs.bank7.asm
...
0045                       ; Program data
0046                       ;-----------------------------------------------------------------------
0047                       copy  "data.constants.asm"  ; Need some constants for SAMS layout
     **** ****     > data.constants.asm
...
0031               ***************************************************************
0032               stevie.80x30:
0033 7100 04F0             byte  >04,>f0,>00,>3f,>02,>43,>05,SPFCLR,0,80
     7102 003F     
     7104 0243     
     7106 05F4     
     7108 0050     
...
0038               *--------------------------------------------------------------
0039               tibasic.32x24:
0040 710A 00E2             byte  >00,>e2,>00,>0c,>00,>06,>00,>07,0,32
     710C 000C     
     710E 0006     
     7110 0007     
     7112 0020     
...
0065               *--------------------------------------------------------------
0066               tibasic.32x30:
0067 7114 00E2             byte  >00,>e2,>00,>0c,>00,>06,>00,>07,0,32
     7116 000C     
     7118 0006     
     711A 0007     
     711C 0020     
...
0098 711E 0000             data  >0000,>0001           ; Cursor
     7120 0001     
0099 7122 0000             data  >0000,>0101           ; Current line indicator     <
     7124 0101     
0100 7126 0820             data  >0820,>0201           ; Current column indicator   v
     7128 0201     
0101               nosprite:
0102 712A D000             data  >d000                 ; End-of-Sprites list
0103               
0104               
0105               ***************************************************************
...
0109 712C 2000             data  >2000,>0000           ; >2000-2fff, SAMS page >00
     712E 0000     
0110 7130 3000             data  >3000,>0001           ; >3000-3fff, SAMS page >01
     7132 0001     
0111 7134 A000             data  >a000,>000a           ; >a000-afff, SAMS page >04
     7136 000A     
0112 7138 B000             data  >b000,>0020           ; >b000-bfff, SAMS page >20
     713A 0020     
0113                                                   ; \
0114                                                   ; | Index can allocate
0115                                                   ; | pages >20 to >3f.
0116                                                   ; /
0117 713C C000             data  >c000,>0040           ; >c000-cfff, SAMS page >40
     713E 0040     
0118                                                   ; \
0119                                                   ; | Editor buffer can allocate
0120                                                   ; | pages >40 to >ff.
0121                                                   ; /
0122 7140 D000             data  >d000,>0005           ; >d000-dfff, SAMS page >05
     7142 0005     
0123 7144 E000             data  >e000,>0006           ; >e000-efff, SAMS page >06
     7146 0006     
0124 7148 F000             data  >f000,>0007           ; >f000-ffff, SAMS page >07
     714A 0007     
0125               
0126               
0127               ***************************************************************
...
0131 714C 2000             data  >2000,>0002           ; >2000-2fff, SAMS page >00
     714E 0002     
0132 7150 3000             data  >3000,>0003           ; >3000-3fff, SAMS page >01
     7152 0003     
0133 7154 A000             data  >a000,>000a           ; >a000-afff, SAMS page >04
     7156 000A     
0134 7158 B000             data  >b000,>0010           ; >b000-efff, SAMS page >10
     715A 0010     
0135 715C C000             data  >c000,>0011           ; \
     715E 0011     
0136 7160 D000             data  >d000,>0012           ; | TI Basic can allocate
     7162 0012     
0137 7164 E000             data  >e000,>0013           ; | pages >10 to >1f.
     7166 0013     
0138                                                   ; /
0139 7168 F000             data  >f000,>0007           ; >f000-ffff, SAMS page >07
     716A 0007     
0140               
0141               
0142               ***************************************************************
...
0146 716C 2000             data  >2000,>0002           ; >2000-2fff, SAMS page >02
     716E 0002     
0147 7170 3000             data  >3000,>0003           ; >3000-3fff, SAMS page >03
     7172 0003     
0148 7174 A000             data  >a000,>000a           ; >a000-afff, SAMS page >0a
     7176 000A     
0149 7178 B000             data  >b000,>000b           ; >b000-bfff, SAMS page >0b
     717A 000B     
0150 717C C000             data  >c000,>000c           ; >c000-cfff, SAMS page >0c
     717E 000C     
0151 7180 D000             data  >d000,>000d           ; >d000-dfff, SAMS page >0d
     7182 000D     
0152 7184 E000             data  >e000,>000e           ; >e000-efff, SAMS page >0e
     7186 000E     
0153 7188 F000             data  >f000,>000f           ; >f000-ffff, SAMS page >0f
     718A 000F     
0154               
0155               
0156               
...
0207 718C F417             data  >f417,>f171,>1b1f,>71b1 ; 1  White on blue with cyan touch
     718E F171     
     7190 1B1F     
     7192 71B1     
0208 7194 A11A             data  >a11a,>f0ff,>1f1a,>f1ff ; 2  Dark yellow on black
     7196 F0FF     
     7198 1F1A     
     719A F1FF     
0209 719C 2112             data  >2112,>f0ff,>1f12,>f1f6 ; 3  Dark green on black
     719E F0FF     
     71A0 1F12     
     71A2 F1F6     
0210 71A4 F41F             data  >f41f,>1e11,>1a17,>1e11 ; 4  White on blue
     71A6 1E11     
     71A8 1A17     
     71AA 1E11     
0211 71AC E11E             data  >e11e,>e1ff,>1f1e,>e1ff ; 5  Grey on black
     71AE E1FF     
     71B0 1F1E     
     71B2 E1FF     
0212 71B4 1771             data  >1771,>1016,>1b71,>1711 ; 6  Black on cyan
     71B6 1016     
     71B8 1B71     
     71BA 1711     
0213 71BC 1FF1             data  >1ff1,>1011,>f1f1,>1f11 ; 7  Black on white
     71BE 1011     
     71C0 F1F1     
     71C2 1F11     
0214 71C4 1AF1             data  >1af1,>a1ff,>1f1f,>f11f ; 8  Black on dark yellow
     71C6 A1FF     
     71C8 1F1F     
     71CA F11F     
0215 71CC 21F0             data  >21f0,>12ff,>1b12,>12ff ; 9  Dark green on black
     71CE 12FF     
     71D0 1B12     
     71D2 12FF     
0216 71D4 F5F1             data  >f5f1,>e1ff,>1b1f,>f131 ; 10 White on light blue
     71D6 E1FF     
     71D8 1B1F     
     71DA F131     
0217                       even
0218               
0219               tv.tabs.table:
0220 71DC 0007             byte  0,7,12,25               ; \   Default tab positions as used
     71DE 0C19     
0221 71E0 1E2D             byte  30,45,59,79             ; |   in Editor/Assembler module.
     71E2 3B4F     
0222 71E4 FF00             byte  >ff,0,0,0               ; |
     71E6 0000     
0223 71E8 0000             byte  0,0,0,0                 ; |   Up to 20 positions supported.
     71EA 0000     
0224 71EC 0000             byte  0,0,0,0                 ; /   >ff means end-of-list.
     71EE 0000     
0225                       even
                   < stevie_b7.asm.37497
0048                       ;-----------------------------------------------------------------------
0049                       ; Bank full check
0050                       ;-----------------------------------------------------------------------
0054                       ;-----------------------------------------------------------------------
0055                       ; Show ROM bank in CPU crash screen
0056                       ;-----------------------------------------------------------------------
0057               cpu.crash.showbank:
0058                       aorg >7fb0
0059 7FB0 06A0  32         bl    @putat
     7FB2 64A0     
0060 7FB4 0314                   byte 3,20
0061 7FB6 7FBA                   data cpu.crash.showbank.bankstr
0062 7FB8 10FF  14         jmp   $
0063               cpu.crash.showbank.bankstr:
0064               
0065 7FBA 05               byte  5
0066 7FBB   52             text  'ROM#7'
     7FBC 4F4D     
     7FBE 2337     
0067                       even
0068               
...
0071                       ;-----------------------------------------------------------------------
0072                       aorg  >7fc0
0073                       copy  "rom.vectors.bank7.asm"
...
0081      7100     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
