...
0008               ***************************************************************
0009               * File: stevie_b7.asm               ; Version 220122-2127580
0010               *
0011               * Bank 7 "Jonas"
...
0031 6038 04E0  34         clr   @bank7.rom            ; Switch to bank 7 "Jonas"
     603A 600E     
0032 603C 0460  28         b     @tibasic.return       ; Resume Stevie session
     603E 636E     
0033               
...
0270 21ED   42             text  'Build-ID  220122-2127580'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0030 3294 600E                   data bankid           ; / i  p2 = Source ROM bank for return
0031               
...
0044                       ;------------------------------------------------------
0045 39DA 04E0  34         clr   @bank1.rom            ; Activate bank 1 "James" ROM
     39DC 6002     
0046               
0050               
0051 39DE 0460  28         b     @kickstart.code2      ; Jump to entry routine
     39E0 6046     
0052               ***************************************************************
...
0065 6168 06A0  32         bl    @vidtab               ; Load video mode table into VDP
     616A 230C     
0066 616C 35F0                   data tibasic.32x24    ; Equate selected video mode table
0067                       ;-------------------------------------------------------
...
0510 63C0 06A0  32         bl    @vidtab               ; Load video mode table into VDP
     63C2 230C     
0511 63C4 35E6                   data stevie.80x30     ; Equate selected video mode table
0512               
...
0100      35E6     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
