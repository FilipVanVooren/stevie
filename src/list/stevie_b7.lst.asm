...
0008               ***************************************************************
0009               * File: stevie_b7.asm               ; Version 211225-2053130
0010               *
0011               * Bank 7 "Jonas"
0012               * SAMS support routines
0013               ***************************************************************
...
0270 21ED   42             text  'Build-ID  211225-2053130'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0059                       ; Stubs
0060                       ;-----------------------------------------------------------------------
0061                       copy  "rom.stubs.bank7.asm" ; Bank specific stubs
     **** ****     > rom.stubs.bank7.asm
0001               * FILE......: rom.stubs.bank7.asm
0002               * Purpose...: Bank 7 stubs for functions in other banks
                   < stevie_b7.asm.143168
0062                       copy  "rom.stubs.bankx.asm" ; Stubs to include in all banks > 0
     **** ****     > rom.stubs.bankx.asm
...
0013 60FC 0649  14         dect  stack
0014 60FE C64B  30         mov   r11,*stack            ; Save return address
0015                       ;------------------------------------------------------
0016                       ; Call function in bank 1
0017                       ;------------------------------------------------------
0018 6100 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6102 30AE     
0019 6104 6002                   data bank1.rom        ; | i  p0 = bank address
0020 6106 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0021 6108 600E                   data bankid           ; / i  p2 = Source ROM bank for return
0022                       ;------------------------------------------------------
0023                       ; Exit
0024                       ;------------------------------------------------------
0025 610A C2F9  30         mov   *stack+,r11           ; Pop r11
0026 610C 045B  20         b     *r11                  ; Return to caller
0027               
0029               
0030               
0031               ***************************************************************
...
0066                       ;
0067                       ;-----------------------------------------------------------------------
0068                       ; Bank full check
0069                       ;-----------------------------------------------------------------------
0073                       ;-----------------------------------------------------------------------
0074                       ; Show ROM bank in CPU crash screen
0075                       ;-----------------------------------------------------------------------
0076               cpu.crash.showbank:
0077                       aorg >7fb0
0078 7FB0 06A0  32         bl    @putat
     7FB2 2456     
0079 7FB4 0314                   byte 3,20
0080 7FB6 7FBA                   data cpu.crash.showbank.bankstr
0081 7FB8 10FF  14         jmp   $
0082               cpu.crash.showbank.bankstr:
0083               
0084 7FBA 05               byte  5
0085 7FBB   52             text  'ROM#7'
     7FBC 4F4D     
     7FBE 2337     
0086                       even
0087               
...
0100      3644     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
