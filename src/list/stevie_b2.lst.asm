...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210829-1401086
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210829-1401086'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0018 3459 ....             text  'Build: 210829-1401086 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0077 6046 06A0  32         bl    @cpu.crash            ; Should never get here
     6048 2026 
0078                       ;-----------------------------------------------------------------------
0079                       ; Include files - Utility functions
0080                       ;-----------------------------------------------------------------------
0081                       copy  "colors.line.set.asm" ; Set color combination for line
**** **** ****     > colors.line.set.asm
...
0083                       ; File handling
0084                       ;-----------------------------------------------------------------------
0085                       copy  "fh.read.edb.asm"     ; Read file to editor buffer
**** **** ****     > fh.read.edb.asm
...
**** **** ****     > stevie_b2.asm.1401086
0086                       copy  "fh.write.edb.asm"    ; Write editor buffer to file
**** **** ****     > fh.write.edb.asm
...
**** **** ****     > stevie_b2.asm.1401086
0087                       copy  "fm.load.asm"         ; Load DV80 file into editor buffer
**** **** ****     > fm.load.asm
...
**** **** ****     > stevie_b2.asm.1401086
0088                       copy  "fm.save.asm"         ; Save DV80 file from editor buffer
**** **** ****     > fm.save.asm
...
**** **** ****     > stevie_b2.asm.1401086
0089                       copy  "fm.callbacks.asm"    ; Callbacks for file operations
**** **** ****     > fm.callbacks.asm
...
0051 65EA 34C4                   data txt.saving       ; Display "Saving...."
...
0059 65F4 3508                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 6608 34B8                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0090 6624 3526                   data txt.fastmode     ; Display "FastMode"
0091                       ;------------------------------------------------------
0092                       ; Exit
0093                       ;------------------------------------------------------
...
0150 6670 3530                   data txt.kb           ; Show "kb" string
0151               
...
0193 66B2 3530                   data txt.kb           ; Show "kb" string
0194               
...
0241 66F6 06A0  32         bl    @cpym2m
     66F8 24E8 
0242 66FA 3917                   data txt.ioerr.load+1
...
0250 6702 06A0  32         bl    @cpym2m
     6704 24E8 
0251 6706 3939                   data txt.ioerr.save+1
...
0333 6776 06A0  32         bl    @cpym2m
     6778 24E8 
0334 677A 395A                   data txt.memfull.load
...
**** **** ****     > stevie_b2.asm.1401086
0090                       copy  "fm.browse.asm"       ; File manager browse support routines
**** **** ****     > fm.browse.asm
...
**** **** ****     > stevie_b2.asm.1401086
0092                       ;-----------------------------------------------------------------------
0093                       ; Stubs using trampoline
0094                       ;-----------------------------------------------------------------------
0095                       copy  "rom.stubs.bank2.asm" ; Stubs for functions in other banks
**** **** ****     > rom.stubs.bank2.asm
...
0104                       ;-----------------------------------------------------------------------
0105                       aorg  >7fc0
0106                       copy  "rom.vectors.bank2.asm"      ; Vector table bank 2
...
0113      33B0     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
