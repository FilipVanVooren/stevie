...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210419-373778
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210419-373778'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0013 3423 ....             text  'Build: 210419-373778 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0014                       even
0015               
0016               ;--------------------------------------------------------------
...
0051 65DA 348C                   data txt.saving       ; Display "Saving...."
...
0059 65E4 34D0                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 65F8 3480                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0098 6622 34EE                   data txt.fastmode     ; Display "FastMode"
0099                       ;------------------------------------------------------
0100                       ; Exit
0101                       ;------------------------------------------------------
...
0158 666E 34F8                   data txt.kb           ; Show "kb" string
0159               
0160 6670 06A0  32         bl    @putnum
     6672 2A54 
0161 6674 1D49                   byte pane.botrow,73   ; Show lines processed
...
0201 66B0 34F8                   data txt.kb           ; Show "kb" string
0202               
0203 66B2 06A0  32         bl    @putnum
     66B4 2A54 
0204 66B6 1D49                   byte pane.botrow,73   ; Show lines processed
...
0249 66F4 06A0  32         bl    @cpym2m
     66F6 24DC 
0250 66F8 3821                   data txt.ioerr.load+1
...
0258 6700 06A0  32         bl    @cpym2m
     6702 24DC 
0259 6704 3843                   data txt.ioerr.save+1
...
0341 6774 06A0  32         bl    @cpym2m
     6776 24DC 
0342 6778 3864                   data txt.memfull.load
