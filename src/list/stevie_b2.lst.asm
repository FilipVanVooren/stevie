...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 211217-1828190
0010               *
0011               * Bank 2 "Jacky"
...
0270 21ED   42             text  'Build-ID  211217-1828190'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0041 66E6 3814                   data txt.clearmem     ; Display "Clearing memory...."
0042               *--------------------------------------------------------------
...
0085 6790 3774                   data txt.saving       ; Display "Saving...."
...
0093 679A 37CC                   data txt.block.save   ; Display "Saving block...."
0094               
...
0102 67A4 3780                   data txt.printing    ; Display "Printing...."
...
0110 67AE 3800                   data txt.block.print  ; Display "Printing block...."
...
0118 67B8 37E6                   data txt.block.clip  ; Display "Copying to clipboard...."
...
0127 67C2 3768                   data txt.loading      ; Display "Loading file...."
0128               
...
0158 67FC 38BC                   data txt.fastmode     ; Display "FastMode"
0159                       ;------------------------------------------------------
0160                       ; Exit
0161                       ;------------------------------------------------------
...
0257 6888 38C6                   data txt.kb           ; Show "kb" string
0258               
...
0322 68F0 38C6                   data txt.kb           ; Show "kb" string
0323               
...
0373 693C 3828             data  txt.done.load         ; id.file.loadfile
0374 693E 3838             data  txt.done.insert       ; id.file.insertfile
0375 6940 384A             data  txt.done.append       ; id.file.appendfile
0376 6942 385C             data  txt.done.save         ; id.file.savefile
0377 6944 385C             data  txt.done.save         ; id.file.saveblock
0378 6946 389E             data  txt.done.clipboard    ; id.file.clipblock
0379 6948 387C             data  txt.done.print        ; id.file.printfile
0380 694A 387C             data  txt.done.print        ; id.file.printblock
0381               
0382               *---------------------------------------------------------------
...
0428 6996 06A0  32         bl    @cpym2m
     6998 24EE     
0429 699A 3998                   data txt.ioerr.load
...
0437 69A2 06A0  32         bl    @cpym2m
     69A4 24EE     
0438 69A6 39AE                   data txt.ioerr.save
...
0446 69AE 06A0  32         bl    @cpym2m
     69B0 24EE     
0447 69B2 39C4                   data txt.ioerr.print
...
0543 6A3A 06A0  32         bl    @cpym2m
     6A3C 24EE     
0544 6A3E 39F8                   data txt.memfull.load
...
0114      3666     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
