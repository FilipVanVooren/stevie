...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210331-270040
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210331-270040'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0019 34CD ....             text  'Build: 210331-270040 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0020                       even
0021               
0022               ;--------------------------------------------------------------
...
0249 66EA 06A0  32         bl    @cpym2m
     66EC 24A0 
0250 66EE 385F                   data txt.ioerr.load+1
...
0258 66F6 06A0  32         bl    @cpym2m
     66F8 24A0 
0259 66FA 3881                   data txt.ioerr.save+1
...
0341 676A 06A0  32         bl    @cpym2m
     676C 24A0 
0342 676E 38A2                   data txt.memfull.load
