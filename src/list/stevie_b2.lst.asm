...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210602-780355
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210602-780355'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0018 3443 ....             text  'Build: 210602-780355 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0051 65DA 34AC                   data txt.saving       ; Display "Saving...."
...
0059 65E4 34F0                   data txt.block.save   ; Display "Saving block...."
0060               
0061 65E6 1017  14         jmp   fm.loadsave.cb.indicator1.exit
0062                       ;------------------------------------------------------
...
0072 65F8 34A0                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0090 6614 350E                   data txt.fastmode     ; Display "FastMode"
0091                       ;------------------------------------------------------
0092                       ; Exit
0093                       ;------------------------------------------------------
...
0150 6660 3518                   data txt.kb           ; Show "kb" string
0151               
...
0193 66A2 3518                   data txt.kb           ; Show "kb" string
0194               
...
0241 66E6 06A0  32         bl    @cpym2m
     66E8 24DC 
0242 66EA 381F                   data txt.ioerr.load+1
...
0250 66F2 06A0  32         bl    @cpym2m
     66F4 24DC 
0251 66F6 3841                   data txt.ioerr.save+1
...
0333 6766 06A0  32         bl    @cpym2m
     6768 24DC 
0334 676A 3862                   data txt.memfull.load
