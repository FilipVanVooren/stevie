...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210717-2104675
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0029                       ;-------------------------------------------------------
0030                       ; Vector table bank 2: >6000 - >603f
0031                       ;-------------------------------------------------------
0032                       copy  "rom.vectors.bank2.asm"
...
0006               *--------------------------------------------------------------
0007 6000 646A     vec.1   data  fm.loadfile           ;
0008 6002 652C     vec.2   data  fm.savefile           ;
0009 6004 6796     vec.3   data  fm.browse.fname.suffix
0010 6006 6818     vec.4   data  fm.fastmode           ;
...
0260 21D3 ....             text  'Build-ID  210717-2104675'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0049                       ;------------------------------------------------------
0050 2EFA DEAD             data >dead,>beef,>dead,>beef
     2EFC BEEF 
     2EFE DEAD 
     2F00 BEEF 
0052               ***************************************************************
...
0018 3443 ....             text  'Build: 210717-2104675 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0113 353E 1546             byte  21
0114 353F ....             text  'F9=Menu  ^Help  ^File'
0115                       even
0116               
0117               txt.keys.block
0118 3554 3342             byte  51
0119 3555 ....             text  'Block: F9=Back  ^Del  ^Copy  ^Move  ^Goto M1  ^Save'
0120                       even
0121               
0122 3588 ....     txt.ruler          text    '.........'
0123                                  byte    18
0124 3592 ....                        text    '.........'
0125                                  byte    19
0126 359C ....                        text    '.........'
...
0137                                  byte    25
0138                                  even
0139 35D8 020E     txt.alpha.down     data >020e,>0f00
     35DA 0F00 
0140 35DC 0110     txt.vertline       data >0110
0141 35DE 011C     txt.keymarker      byte 1,28
0142               
0143               txt.ws1
0144 35E0 0120             byte  1
0145 35E1 ....             text  ' '
0146                       even
0147               
0148               txt.ws2
0149 35E2 0220             byte  2
0150 35E3 ....             text  '  '
0151                       even
0152               
0153               txt.ws3
0154 35E6 0320             byte  3
0155 35E7 ....             text  '   '
0156                       even
0157               
0158               txt.ws4
0159 35EA 0420             byte  4
0160 35EB ....             text  '    '
0161                       even
0162               
0163               txt.ws5
0164 35F0 0520             byte  5
0165 35F1 ....             text  '     '
0166                       even
0167               
...
0173               ;--------------------------------------------------------------
0174 35F6 1301     txt.head.load      byte 19,1,3,32
     35F8 0320 
0175 35FA ....                        text 'Open DV80 file '
0176                                  byte 2
0177               txt.hint.load
0178 360A 3D53             byte  61
0179 360B ....             text  'Select Fastmode for file buffer in CPU RAM (HRD/HDX/IDE only)'
0180                       even
0181               
0182               
0183 3648 3C46     txt.keys.load      byte 60
0184 3649 ....                        text 'File'
0185                                  byte 27
0186 364E ....                        text 'Open: F9=Back  F3=Clear  F5=Fastmode  F-H=Home  F-L=End '
0187               
0188 3686 3D46     txt.keys.load2     byte 61
0189 3687 ....                        text 'File'
0190                                  byte 27
0191 368C ....                        text 'Open: F9=Back  F3=Clear  *F5=Fastmode  F-H=Home  F-L=End '
0192               
0193               ;--------------------------------------------------------------
0194               ; Dialog Save DV 80 file
0195               ;--------------------------------------------------------------
0196 36C6 0103     txt.head.save      byte 19,1,3,32
     36C8 2053 
0197 36C9 ....                        text 'Save DV80 file '
0198 36D8 0223                        byte 2
0199 36DA 0103     txt.head.save2     byte 35,1,3,32
     36DC 2053 
0200 36DD ....                        text 'Save marked block to DV80 file '
0201 36FC 0201                        byte 2
0202               txt.hint.save
0203                       byte  1
0204 36FE ....             text  ' '
0205                       even
0206               
0207               
0208 3700 2F46     txt.keys.save      byte 47
0209 3701 ....                        text 'File'
0210                                  byte 27
0211 3706 ....                        text 'Save: F9=Back  F3=Clear  F-H=Home  F-L=End'
0212               
0213               ;--------------------------------------------------------------
0214               ; Dialog "Unsaved changes"
0215               ;--------------------------------------------------------------
0216 3730 1401     txt.head.unsaved   byte 20,1,3,32
     3732 0320 
0217 3734 ....                        text 'Unsaved changes '
0218 3744 0221                        byte 2
0219               txt.info.unsaved
0220                       byte  33
0221 3746 ....             text  'Warning! Unsaved changes in file.'
0222                       even
0223               
0224               txt.hint.unsaved
0225 3768 2A50             byte  42
0226 3769 ....             text  'Press F6 to proceed or ENTER to save file.'
0227                       even
0228               
0229               txt.keys.unsaved
0230 3794 2843             byte  40
0231 3795 ....             text  'Confirm: F9=Back  F6=Proceed  ENTER=Save'
0232                       even
0233               
0234               
0235               ;--------------------------------------------------------------
0236               ; Dialog "About"
0237               ;--------------------------------------------------------------
0238 37BE 0A01     txt.head.about     byte 10,1,3,32
     37C0 0320 
0239 37C2 ....                        text 'About '
0240 37C8 0200                        byte 2
0241               
0242               txt.info.about
0243                       byte  0
0244 37CA ....             text
...
0246               
0247               txt.hint.about
0248 37CA 1D50             byte  29
0249 37CB ....             text  'Press F9 to return to editor.'
0250                       even
0251               
0252 37E8 2148     txt.keys.about     byte 33
0253 37E9 ....                        text 'Help: F9=Back  '
0254 37F8 0E0F                        byte 14,15
0255 37FA ....                        text '=Alpha Lock down'
0256               
0257               
0258               ;--------------------------------------------------------------
0259               ; Dialog "Menu"
0260               ;--------------------------------------------------------------
0261 380A 1001     txt.head.menu      byte 16,1,3,32
     380C 0320 
0262 380E ....                        text 'Stevie Menu '
0263 381A 0210                        byte 2
0264               
0265               txt.info.menu
0266                       byte  16
0267 381C ....             text  'File, Help, Quit'
0268                       even
0269               
0270 382C 0006     pos.info.menu      byte 0,6,12,>ff
     382E 0CFF 
0271               txt.hint.menu
0272 3830 2650             byte  38
0273 3831 ....             text  'Press F,H,Q or F9 to return to editor.'
0274                       even
0275               
0276               txt.keys.menu
0277 3858 0D4D             byte  13
0278 3859 ....             text  'Menu: F9=Back'
0279                       even
0280               
0281               
0282               
...
0284               ; Dialog "File"
0285               ;--------------------------------------------------------------
0286 3866 0901     txt.head.file      byte 9,1,3,32
     3868 0320 
0287 386A ....                        text 'File '
0288                                  byte 2
0289               
0290               txt.info.file
0291 3870 1C4E             byte  28
0292 3871 ....             text  'New, Open, Print, Save, Quit'
0293                       even
0294               
0295 388E 0005     pos.info.file      byte 0,5,11,18,24,>ff
     3890 0B12 
     3892 18FF 
0296               txt.hint.file
0297 3894 2A50             byte  42
0298 3895 ....             text  'Press N,O,P,S,Q or F9 to return to editor.'
0299                       even
0300               
0301               txt.keys.file
0302 38C0 0D46             byte  13
0303 38C1 ....             text  'File: F9=Back'
0304                       even
0305               
0306               
0307               
...
0311               ;--------------------------------------------------------------
0312               txt.ioerr.load
0313 38CE 2049             byte  32
0314 38CF ....             text  'I/O error. Failed loading file: '
0315                       even
0316               
0317               txt.ioerr.save
0318 38F0 2049             byte  32
0319 38F1 ....             text  'I/O error. Failed saving file:  '
0320                       even
0321               
0322               txt.memfull.load
0323 3912 4049             byte  64
0324 3913 ....             text  'Index memory full. Could not fully load file into editor buffer.'
0325                       even
0326               
0327               txt.io.nofile
0328 3954 2149             byte  33
0329 3955 ....             text  'I/O error. No filename specified.'
0330                       even
0331               
0332               txt.block.inside
0333 3976 3445             byte  52
0334 3977 ....             text  'Error. Copy/Move target must be outside block M1-M2.'
0335                       even
0336               
0337               
0338               ;--------------------------------------------------------------
...
0342 39AC 013E             byte  1
0343 39AD ....             text  '>'
0344                       even
0345               
0346               txt.colorscheme
0347 39AE 0D43             byte  13
0348 39AF ....             text  'Color scheme:'
0349                       even
0350               
**** **** ****     > ram.resident.3000.asm
...
0021                       ;------------------------------------------------------
0022 39BC DEAD             data  >dead,>beef,>dead,>beef
     39BE BEEF 
     39C0 DEAD 
     39C2 BEEF 
**** **** ****     > stevie_b2.asm.2104675
...
0075 6046 06A0  32         bl    @cpu.crash            ; Should never get here
     6048 2026 
0076                       ;-----------------------------------------------------------------------
0077                       ; Include files - Utility functions
0078                       ;-----------------------------------------------------------------------
0079                       copy  "colors.line.set.asm" ; Set color combination for line
**** **** ****     > colors.line.set.asm
...
0081                       ; File handling
0082                       ;-----------------------------------------------------------------------
0083                       copy  "fh.read.edb.asm"     ; Read file to editor buffer
**** **** ****     > fh.read.edb.asm
...
0051 65EA 34AE                   data txt.saving       ; Display "Saving...."
...
0059 65F4 34F2                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 6608 34A2                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0090 6624 3510                   data txt.fastmode     ; Display "FastMode"
0091                       ;------------------------------------------------------
0092                       ; Exit
0093                       ;------------------------------------------------------
...
0150 6670 351A                   data txt.kb           ; Show "kb" string
0151               
...
0193 66B2 351A                   data txt.kb           ; Show "kb" string
0194               
0195 66B4 06A0  32         bl    @putnum
     66B6 2A58 
0196 66B8 1D48                   byte pane.botrow,72   ; Show lines processed
0197 66BA A204                   data edb.lines,rambuf,>3020
     66BC 2F6A 
     66BE 3020 
0198                       ;------------------------------------------------------
0199                       ; Exit
...
0241 66F6 06A0  32         bl    @cpym2m
     66F8 24DE 
0242 66FA 38CF                   data txt.ioerr.load+1
0243 66FC A02B                   data tv.error.msg+1
...
0250 6702 06A0  32         bl    @cpym2m
     6704 24DE 
0251 6706 38F1                   data txt.ioerr.save+1
0252 6708 A02B                   data tv.error.msg+1
...
0333 6776 06A0  32         bl    @cpym2m
     6778 24DE 
0334 677A 3912                   data txt.memfull.load
0335 677C A02A                   data tv.error.msg
...
0021 681A C64B  30         mov   r11,*stack            ; Save return address
0022 681C 0649  14         dect  stack
0023 681E C644  30         mov   tmp0,*stack           ; Push tmp0
0024               
0025 6820 C120  34         mov   @fh.offsetopcode,tmp0
     6822 A44E 
0026 6824 1307  14         jeq   !
0027                       ;------------------------------------------------------
0028                       ; Turn fast mode off
0029                       ;------------------------------------------------------
0030 6826 04E0  34         clr   @fh.offsetopcode      ; Data buffer in VDP RAM
     6828 A44E 
0031 682A 0204  20         li    tmp0,txt.keys.load
     682C 3648 
0032 682E C804  38         mov   tmp0,@cmdb.pankeys    ; Keylist in status line
     6830 A324 
0033 6832 1008  14         jmp   fm.fastmode.exit
0034                       ;------------------------------------------------------
0035                       ; Turn fast mode on
0036                       ;------------------------------------------------------
0037 6834 0204  20 !       li    tmp0,>40              ; Data buffer in CPU RAM
     6836 0040 
0038 6838 C804  38         mov   tmp0,@fh.offsetopcode
     683A A44E 
0039 683C 0204  20         li    tmp0,txt.keys.load2
     683E 3686 
0040 6840 C804  38         mov   tmp0,@cmdb.pankeys    ; Keylist in status line
     6842 A324 
0041               *--------------------------------------------------------------
0042               * Exit
0043               *--------------------------------------------------------------
...
0092                       ;-----------------------------------------------------------------------
0093                       copy  "rom.stubs.bank2.asm" ; Stubs for functions in other banks
**** **** ****     > rom.stubs.bank2.asm
...
0009 684A 0649  14         dect  stack
0010 684C C64B  30         mov   r11,*stack            ; Save return address
0011                       ;------------------------------------------------------
0012                       ; Call function in bank 1
0013                       ;------------------------------------------------------
0014 684E 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6850 3008 
0015 6852 6002                   data bank1.rom        ; | i  p0 = bank address
0016 6854 6002                   data vec.2            ; | i  p1 = Vector with target address
0017 6856 6004                   data bankid           ; / i  p2 = Source ROM bank for return
0018                       ;------------------------------------------------------
0019                       ; Exit
0020                       ;------------------------------------------------------
0021 6858 C2F9  30         mov   *stack+,r11           ; Pop r11
0022 685A 045B  20         b     *r11                  ; Return to caller
0023               
0024               
0025               ***************************************************************
...
0030 685C 0649  14         dect  stack
0031 685E C64B  30         mov   r11,*stack            ; Save return address
0032                       ;------------------------------------------------------
0033                       ; Call function in bank 1
0034                       ;------------------------------------------------------
0035 6860 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6862 3008 
0036 6864 6002                   data bank1.rom        ; | i  p0 = bank address
0037 6866 6006                   data vec.4            ; | i  p1 = Vector with target address
0038 6868 6004                   data bankid           ; / i  p2 = Source ROM bank for return
0039                       ;------------------------------------------------------
0040                       ; Exit
0041                       ;------------------------------------------------------
0042 686A C2F9  30         mov   *stack+,r11           ; Pop r11
0043 686C 045B  20         b     *r11                  ; Return to caller
0044               
0045               
0046               
0047               ***************************************************************
...
0052 686E 0649  14         dect  stack
0053 6870 C64B  30         mov   r11,*stack            ; Save return address
0054                       ;------------------------------------------------------
0055                       ; Call function in bank 1
0056                       ;------------------------------------------------------
0057 6872 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6874 3008 
0058 6876 6002                   data bank1.rom        ; | i  p0 = bank address
0059 6878 6014                   data vec.11           ; | i  p1 = Vector with target address
0060 687A 6004                   data bankid           ; / i  p2 = Source ROM bank for return
0061                       ;------------------------------------------------------
0062                       ; Exit
0063                       ;------------------------------------------------------
0064 687C C2F9  30         mov   *stack+,r11           ; Pop r11
0065 687E 045B  20         b     *r11                  ; Return to caller
0066               
0067               
0068               ***************************************************************
...
0071               ********|*****|*********************|**************************
0072               fb.refresh:
0073 6880 0649  14         dect  stack
0074 6882 C64B  30         mov   r11,*stack            ; Save return address
0075                       ;------------------------------------------------------
0076                       ; Call function in bank 1
0077                       ;------------------------------------------------------
0078 6884 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6886 3008 
0079 6888 6002                   data bank1.rom        ; | i  p0 = bank address
0080 688A 6026                   data vec.20           ; | i  p1 = Vector with target address
0081 688C 6004                   data bankid           ; / i  p2 = Source ROM bank for return
0082                       ;------------------------------------------------------
0083                       ; Exit
0084                       ;------------------------------------------------------
0085 688E C2F9  30         mov   *stack+,r11           ; Pop r11
0086 6890 045B  20         b     *r11                  ; Return to caller
0087               
0088               
0089               
0090               ***************************************************************
...
0093               ********|*****|*********************|**************************
0094               fb.vdpdump:
0095 6892 0649  14         dect  stack
0096 6894 C64B  30         mov   r11,*stack            ; Save return address
0097                       ;------------------------------------------------------
0098                       ; Call function in bank 1
0099                       ;------------------------------------------------------
0100 6896 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6898 3008 
0101 689A 6002                   data bank1.rom        ; | i  p0 = bank address
0102 689C 6028                   data vec.21           ; | i  p1 = Vector with target address
0103 689E 6004                   data bankid           ; / i  p2 = Source ROM bank for return
0104                       ;------------------------------------------------------
0105                       ; Exit
0106                       ;------------------------------------------------------
0107 68A0 C2F9  30         mov   *stack+,r11           ; Pop r11
0108 68A2 045B  20         b     *r11                  ; Return to caller
0109               
0110               
0111               
0112               
...
0118 68A4 0649  14         dect  stack
0119 68A6 C64B  30         mov   r11,*stack            ; Save return address
0120                       ;------------------------------------------------------
0121                       ; Call function in bank 1
0122                       ;------------------------------------------------------
0123 68A8 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     68AA 3008 
0124 68AC 6002                   data bank1.rom        ; | i  p0 = bank address
0125 68AE 603A                   data vec.30           ; | i  p1 = Vector with target address
0126 68B0 6004                   data bankid           ; / i  p2 = Source ROM bank for return
0127                       ;------------------------------------------------------
0128                       ; Exit
0129                       ;------------------------------------------------------
0130 68B2 C2F9  30         mov   *stack+,r11           ; Pop r11
0131 68B4 045B  20         b     *r11                  ; Return to caller
0132               
0133               
0134               ***************************************************************
...
0139 68B6 0649  14         dect  stack
0140 68B8 C64B  30         mov   r11,*stack            ; Save return address
0141                       ;------------------------------------------------------
0142                       ; Call function in bank 1
0143                       ;------------------------------------------------------
0144 68BA 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     68BC 3008 
0145 68BE 6002                   data bank1.rom        ; | i  p0 = bank address
0146 68C0 603C                   data vec.31           ; | i  p1 = Vector with target address
0147 68C2 6004                   data bankid           ; / i  p2 = Source ROM bank for return
0148                       ;------------------------------------------------------
0149                       ; Exit
0150                       ;------------------------------------------------------
0151 68C4 C2F9  30         mov   *stack+,r11           ; Pop r11
0152 68C6 045B  20         b     *r11                  ; Return to caller
0153               
0154               
0155               ***************************************************************
...
0160 68C8 0649  14         dect  stack
0161 68CA C64B  30         mov   r11,*stack            ; Save return address
0162                       ;------------------------------------------------------
0163                       ; Call function in bank 1
0164                       ;------------------------------------------------------
0165 68CC 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     68CE 3008 
0166 68D0 6002                   data bank1.rom        ; | i  p0 = bank address
0167 68D2 603E                   data vec.32           ; | i  p1 = Vector with target address
0168 68D4 6004                   data bankid           ; / i  p2 = Source ROM bank for return
0169                       ;------------------------------------------------------
0170                       ; Exit
0171                       ;------------------------------------------------------
...
0096                       ;-----------------------------------------------------------------------
0100 68DA 68DA                   data $                ; Bank 2 ROM size OK.
0102               
0103               *--------------------------------------------------------------
