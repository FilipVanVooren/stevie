...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210822-88925
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210822-88925'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0018 3459 ....             text  'Build: 210822-88925 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0241 66F6 06A0  32         bl    @cpym2m
     66F8 24DC 
0242 66FA 394D                   data txt.ioerr.load+1
...
0250 6702 06A0  32         bl    @cpym2m
     6704 24DC 
0251 6706 396F                   data txt.ioerr.save+1
...
0333 6776 06A0  32         bl    @cpym2m
     6778 24DC 
0334 677A 3990                   data txt.memfull.load
