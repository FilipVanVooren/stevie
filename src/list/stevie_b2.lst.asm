...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210405-1261290
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210405-1261290'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0013 34A7 ....             text  'Build: 210405-1261290 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0014                       even
0015               
0016               ;--------------------------------------------------------------
...
0249 66EA 06A0  32         bl    @cpym2m
     66EC 24A2 
0250 66EE 388D                   data txt.ioerr.load+1
...
0258 66F6 06A0  32         bl    @cpym2m
     66F8 24A2 
0259 66FA 38AF                   data txt.ioerr.save+1
...
0341 676A 06A0  32         bl    @cpym2m
     676C 24A2 
0342 676E 38D0                   data txt.memfull.load
