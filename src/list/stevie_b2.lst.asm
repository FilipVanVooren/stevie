...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210912-1050404
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 6217 ....             text  'Build-ID  210912-1050404'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0018 7525 ....             text  'Build: 210912-1050404 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0057 6046 06A0  32         bl    @cpu.crash            ; Should never get here
     6048 2026 
0058                       ;-----------------------------------------------------------------------
0059                       ; Include files - Utility functions
0060                       ;-----------------------------------------------------------------------
0061                       copy  "colors.line.set.asm" ; Set color combination for line
**** **** ****     > colors.line.set.asm
...
0063                       ; File handling
0064                       ;-----------------------------------------------------------------------
0065                       copy  "fh.read.edb.asm"     ; Read file to editor buffer
**** **** ****     > fh.read.edb.asm
...
**** **** ****     > stevie_b2.asm.1050404
0066                       copy  "fh.write.edb.asm"    ; Write editor buffer to file
**** **** ****     > fh.write.edb.asm
...
**** **** ****     > stevie_b2.asm.1050404
0067                       copy  "fm.load.asm"         ; Load DV80 file into editor buffer
**** **** ****     > fm.load.asm
...
**** **** ****     > stevie_b2.asm.1050404
0068                       copy  "fm.save.asm"         ; Save DV80 file from editor buffer
**** **** ****     > fm.save.asm
...
0051 65EA 354C                   data txt.saving       ; Display "Saving...."
...
0059 65F4 3590                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 6608 3540                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0090 6624 35AE                   data txt.fastmode     ; Display "FastMode"
0091                       ;------------------------------------------------------
0092                       ; Exit
0093                       ;------------------------------------------------------
...
0150 6670 35B8                   data txt.kb           ; Show "kb" string
0151               
...
0193 66B2 35B8                   data txt.kb           ; Show "kb" string
0194               
...
0241 66F6 06A0  32         bl    @cpym2m
     66F8 24E8 
0242 66FA 399F                   data txt.ioerr.load+1
...
0250 6702 06A0  32         bl    @cpym2m
     6704 24E8 
0251 6706 39C1                   data txt.ioerr.save+1
...
0333 6776 06A0  32         bl    @cpym2m
     6778 24E8 
0334 677A 39E2                   data txt.memfull.load
...
**** **** ****     > stevie_b2.asm.1050404
0071                       copy  "fm.fastmode.asm"     ; Turn fastmode on/off for file operation
**** **** ****     > fm.fastmode.asm
...
0093      3438     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
