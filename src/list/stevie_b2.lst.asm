...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210919-3437614
0010               *
0011               * Bank 2 "Jacky"
...
0260 6217 ....             text  'Build-ID  210919-3437614'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0051 65EA 3500                   data txt.saving       ; Display "Saving...."
...
0059 65F4 3544                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 6608 34F4                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0090 6624 3562                   data txt.fastmode     ; Display "FastMode"
0091                       ;------------------------------------------------------
0092                       ; Exit
0093                       ;------------------------------------------------------
...
0150 6670 356C                   data txt.kb           ; Show "kb" string
0151               
...
0193 66B2 356C                   data txt.kb           ; Show "kb" string
0194               
...
0241 66F6 06A0  32         bl    @cpym2m
     66F8 24E8 
0242 66FA 363B                   data txt.ioerr.load+1
...
0250 6702 06A0  32         bl    @cpym2m
     6704 24E8 
0251 6706 365D                   data txt.ioerr.save+1
...
0333 6776 06A0  32         bl    @cpym2m
     6778 24E8 
0334 677A 367E                   data txt.memfull.load
...
0093      3446     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
