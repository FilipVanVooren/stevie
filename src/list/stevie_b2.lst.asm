...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 211012-9059
0010               *
0011               * Bank 2 "Jacky"
...
0260 6217   42             text  'Build-ID  211012-9059'
     6218 7569     
     621A 6C64     
     621C 2D49     
     621E 4420     
...
0051 65EA 353C                   data txt.saving       ; Display "Saving...."
...
0059 65F4 3580                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 6608 3530                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0090 6624 359E                   data txt.fastmode     ; Display "FastMode"
0091                       ;------------------------------------------------------
0092                       ; Exit
0093                       ;------------------------------------------------------
...
0150 6670 35A8                   data txt.kb           ; Show "kb" string
0151               
...
0193 66B2 35A8                   data txt.kb           ; Show "kb" string
0194               
...
0241 66F6 06A0  32         bl    @cpym2m
     66F8 24D0     
0242 66FA 3671                   data txt.ioerr.load+1
...
0250 6702 06A0  32         bl    @cpym2m
     6704 24D0     
0251 6706 3693                   data txt.ioerr.save+1
...
0333 6776 06A0  32         bl    @cpym2m
     6778 24D0     
0334 677A 36B4                   data txt.memfull.load
...
0093      342E     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
