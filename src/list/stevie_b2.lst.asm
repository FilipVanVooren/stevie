...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210518-2097250
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210518-2097250'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0013 3437 ....             text  'Build: 210518-2097250 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0014                       even
0015               
0016               ;--------------------------------------------------------------
...
0051 65DA 34A2                   data txt.saving       ; Display "Saving...."
...
0059 65E4 34E6                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 65F8 3496                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0098 6622 3504                   data txt.fastmode     ; Display "FastMode"
0099                       ;------------------------------------------------------
0100                       ; Exit
0101                       ;------------------------------------------------------
...
0158 666E 350E                   data txt.kb           ; Show "kb" string
0159               
...
0201 66B0 350E                   data txt.kb           ; Show "kb" string
0202               
...
0249 66F4 06A0  32         bl    @cpym2m
     66F6 24DE 
0250 66F8 3824                   data txt.ioerr.load+1
...
0258 6700 06A0  32         bl    @cpym2m
     6702 24DE 
0259 6704 3845                   data txt.ioerr.save+1
...
0341 6774 06A0  32         bl    @cpym2m
     6776 24DE 
0342 6778 3866                   data txt.memfull.load
...
0102      339A     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
