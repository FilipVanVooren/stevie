...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210409-2129088
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210409-2129088'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0013 3423 ....             text  'Build: 210409-2129088 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0014                       even
0015               
0016               ;--------------------------------------------------------------
...
0051 65D0 348E                   data txt.saving       ; Display "Saving...."
...
0059 65DA 34D2                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 65EE 3482                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0098 6618 34F0                   data txt.fastmode     ; Display "FastMode"
0099                       ;------------------------------------------------------
0100                       ; Exit
0101                       ;------------------------------------------------------
...
0158 6664 34FA                   data txt.kb           ; Show "kb" string
0159               
...
0201 66A6 34FA                   data txt.kb           ; Show "kb" string
0202               
...
0249 66EA 06A0  32         bl    @cpym2m
     66EC 24A2 
0250 66EE 3823                   data txt.ioerr.load+1
...
0258 66F6 06A0  32         bl    @cpym2m
     66F8 24A2 
0259 66FA 3845                   data txt.ioerr.save+1
...
0341 676A 06A0  32         bl    @cpym2m
     676C 24A2 
0342 676E 3866                   data txt.memfull.load
