...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210714-740374
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210714-740374'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0018 3443 ....             text  'Build: 210714-740374 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0051 65EA 34AC                   data txt.saving       ; Display "Saving...."
...
0059 65F4 34F0                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 6608 34A0                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0090 6624 350E                   data txt.fastmode     ; Display "FastMode"
0091                       ;------------------------------------------------------
0092                       ; Exit
0093                       ;------------------------------------------------------
...
0150 6670 3518                   data txt.kb           ; Show "kb" string
0151               
...
0193 66B2 3518                   data txt.kb           ; Show "kb" string
0194               
...
0241 66F6 06A0  32         bl    @cpym2m
     66F8 24DC 
0242 66FA 3871                   data txt.ioerr.load+1
...
0250 6702 06A0  32         bl    @cpym2m
     6704 24DC 
0251 6706 3893                   data txt.ioerr.save+1
...
0333 6776 06A0  32         bl    @cpym2m
     6778 24DC 
0334 677A 38B4                   data txt.memfull.load
