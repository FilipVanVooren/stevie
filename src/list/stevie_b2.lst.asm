...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210523-3172033
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210523-3172033'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0018 344B ....             text  'Build: 210523-3172033 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0051 65DA 34B6                   data txt.saving       ; Display "Saving...."
...
0059 65E4 34FA                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 65F8 34AA                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0088 660E 06A0  32         bl    @putat
     6610 2446 
0089 6612 1D26                   byte pane.botrow,38
0090 6614 3518                   data txt.fastmode     ; Display "FastMode"
0091                       ;------------------------------------------------------
0092                       ; Exit
0093                       ;------------------------------------------------------
...
0150 6660 3522                   data txt.kb           ; Show "kb" string
0151               
0152 6662 06A0  32         bl    @putnum
     6664 2A58 
0153 6666 1D48                   byte pane.botrow,72   ; Show lines processed
...
0177 667C 06A0  32         bl    @hchar
     667E 27C8 
0178 6680 1D00                   byte pane.botrow,0,32,50
     6682 2032 
...
0193 66A2 3522                   data txt.kb           ; Show "kb" string
0194               
0195 66A4 06A0  32         bl    @putnum
     66A6 2A58 
0196 66A8 1D48                   byte pane.botrow,72   ; Show lines processed
...
0230 66D2 06A0  32         bl    @hchar
     66D4 27C8 
0231 66D6 1D00                   byte pane.botrow,0,32,50
     66D8 2032 
...
0241 66E6 06A0  32         bl    @cpym2m
     66E8 24DE 
0242 66EA 3801                   data txt.ioerr.load+1
...
0250 66F2 06A0  32         bl    @cpym2m
     66F4 24DE 
0251 66F6 3823                   data txt.ioerr.save+1
...
0327 675C 06A0  32         bl    @hchar
     675E 27C8 
0328 6760 1D00                   byte pane.botrow,0,32,50
     6762 2032 
...
0333 6766 06A0  32         bl    @cpym2m
     6768 24DE 
0334 676A 3844                   data txt.memfull.load
...
0108      33A2     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
