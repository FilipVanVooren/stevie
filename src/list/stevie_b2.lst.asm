...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210405-1297388
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210405-1297388'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0013 34A7 ....             text  'Build: 210405-1297388 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0014                       even
0015               
0016               ;--------------------------------------------------------------
...
0051 65D0 3512                   data txt.saving       ; Display "Saving...."
...
0059 65DA 3556                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 65EE 3506                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0098 6618 3574                   data txt.fastmode     ; Display "FastMode"
0099                       ;------------------------------------------------------
0100                       ; Exit
0101                       ;------------------------------------------------------
...
0158 6664 357E                   data txt.kb           ; Show "kb" string
0159               
...
0201 66A6 357E                   data txt.kb           ; Show "kb" string
0202               
...
0249 66EA 06A0  32         bl    @cpym2m
     66EC 24A2 
0250 66EE 38A9                   data txt.ioerr.load+1
...
0258 66F6 06A0  32         bl    @cpym2m
     66F8 24A2 
0259 66FA 38CB                   data txt.ioerr.save+1
...
0341 676A 06A0  32         bl    @cpym2m
     676C 24A2 
0342 676E 38EC                   data txt.memfull.load
...
0102      336E     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
