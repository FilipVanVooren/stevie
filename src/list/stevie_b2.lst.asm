...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210922-278052
0010               *
0011               * Bank 2 "Jacky"
...
0260 6217 ....             text  'Build-ID  210922-278052'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0051 65EA 3516                   data txt.saving       ; Display "Saving...."
...
0059 65F4 355A                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 6608 350A                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0090 6624 3578                   data txt.fastmode     ; Display "FastMode"
0091                       ;------------------------------------------------------
0092                       ; Exit
0093                       ;------------------------------------------------------
...
0150 6670 3582                   data txt.kb           ; Show "kb" string
0151               
...
0193 66B2 3582                   data txt.kb           ; Show "kb" string
0194               
...
0241 66F6 06A0  32         bl    @cpym2m
     66F8 24E6 
0242 66FA 3651                   data txt.ioerr.load+1
...
0250 6702 06A0  32         bl    @cpym2m
     6704 24E6 
0251 6706 3673                   data txt.ioerr.save+1
...
0333 6776 06A0  32         bl    @cpym2m
     6778 24E6 
0334 677A 3694                   data txt.memfull.load
...
0093      343C     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
