...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210930-1067560
0010               *
0011               * Bank 2 "Jacky"
...
0260 6217 ....             text  'Build-ID  210930-1067560'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0051 65EA 3520                   data txt.saving       ; Display "Saving...."
...
0059 65F4 3564                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 6608 3514                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0090 6624 3582                   data txt.fastmode     ; Display "FastMode"
0091                       ;------------------------------------------------------
0092                       ; Exit
0093                       ;------------------------------------------------------
...
0150 6670 358C                   data txt.kb           ; Show "kb" string
0151               
...
0193 66B2 358C                   data txt.kb           ; Show "kb" string
0194               
...
0241 66F6 06A0  32         bl    @cpym2m
     66F8 24D4 
0242 66FA 365B                   data txt.ioerr.load+1
...
0250 6702 06A0  32         bl    @cpym2m
     6704 24D4 
0251 6706 367D                   data txt.ioerr.save+1
...
0333 6776 06A0  32         bl    @cpym2m
     6778 24D4 
0334 677A 369E                   data txt.memfull.load
