...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 220212-1923220
0010               *
0011               * Bank 2 "Jacky"
...
0270 21ED   42             text  'Build-ID  220212-1923220'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0044 3250 06A0  32         bl    @cpym2m
     3252 24EE     
0045 3254 39B0                   data def.printer.fname,tv.printer.fname,7
     3256 DE00     
     3258 0007     
0046               
0047 325A 06A0  32         bl    @cpym2m
     325C 24EE     
0048 325E 39B8                   data def.clip.fname,tv.clip.fname,10
     3260 DE50     
     3262 000A     
0049                       ;-------------------------------------------------------
0050                       ; Exit
...
0133               txt.kb
0134 3812 02               byte  2
0135 3813   6B             text  'kb'
     3814 62       
0136                       even
0137               
0138               txt.lines
0139 3816 05               byte  5
0140 3817   4C             text  'Lines'
     3818 696E     
     381A 6573     
0141                       even
0142               
0143               txt.newfile
0144 381C 0A               byte  10
0145 381D   5B             text  '[New file]'
     381E 4E65     
     3820 7720     
     3822 6669     
     3824 6C65     
...
0153               txt.m1
0154 382E 03               byte  3
0155 382F   4D             text  'M1='
     3830 313D     
0156                       even
0157               
0158               txt.m2
0159 3832 03               byte  3
0160 3833   4D             text  'M2='
     3834 323D     
0161                       even
0162               
0163               txt.keys.default
0164 3836 07               byte  7
0165 3837   46             text  'F9-Menu'
     3838 392D     
     383A 4D65     
     383C 6E75     
0166                       even
0167               
0168               txt.keys.block
0169 383E 36               byte  54
0170 383F   46             text  'F9-Back  ^Copy  ^Move  ^Del  ^Save  ^Print  ^[1-5]Clip'
     3840 392D     
     3842 4261     
     3844 636B     
     3846 2020     
...
0171                       even
0172               
0173 3876 2E2E     txt.ruler          text    '.........'
     3878 2E2E     
     387A 2E2E     
     387C 2E2E     
     387E 2E       
0174 387F   12                        byte    18
0175 3880 2E2E                        text    '.........'
     3882 2E2E     
     3884 2E2E     
     3886 2E2E     
     3888 2E       
0176 3889   13                        byte    19
0177 388A 2E2E                        text    '.........'
     388C 2E2E     
     388E 2E2E     
     3890 2E2E     
     3892 2E       
0178 3893   14                        byte    20
0179 3894 2E2E                        text    '.........'
     3896 2E2E     
     3898 2E2E     
     389A 2E2E     
     389C 2E       
0180 389D   15                        byte    21
0181 389E 2E2E                        text    '.........'
     38A0 2E2E     
     38A2 2E2E     
     38A4 2E2E     
     38A6 2E       
0182 38A7   16                        byte    22
0183 38A8 2E2E                        text    '.........'
     38AA 2E2E     
     38AC 2E2E     
     38AE 2E2E     
     38B0 2E       
0184 38B1   17                        byte    23
0185 38B2 2E2E                        text    '.........'
     38B4 2E2E     
     38B6 2E2E     
     38B8 2E2E     
     38BA 2E       
0186 38BB   18                        byte    24
0187 38BC 2E2E                        text    '.........'
     38BE 2E2E     
     38C0 2E2E     
     38C2 2E2E     
     38C4 2E       
0188 38C5   19                        byte    25
0189                                  even
0190 38C6 020E     txt.alpha.down     data >020e,>0f00
     38C8 0F00     
0191 38CA 0110     txt.vertline       data >0110
0192 38CC 011C     txt.keymarker      byte 1,28
0193               
0194               txt.ws1
0195 38CE 01               byte  1
0196 38CF   20             text  ' '
...
0217                       even
0218               
0219      38D8     txt.filetype.none  equ txt.ws4
0220               
0221               
0222               ;--------------------------------------------------------------
...
0224               ;--------------------------------------------------------------
0225               txt.ioerr.load
0226 38E4 15               byte  21
0227 38E5   46             text  'Failed loading file: '
     38E6 6169     
     38E8 6C65     
     38EA 6420     
     38EC 6C6F     
...
0229               
0230               txt.ioerr.save
0231 38FA 14               byte  20
0232 38FB   46             text  'Failed saving file: '
     38FC 6169     
     38FE 6C65     
     3900 6420     
     3902 7361     
...
0236 3910 1B               byte  27
0237 3911   46             text  'Failed printing to device: '
     3912 6169     
     3914 6C65     
     3916 6420     
     3918 7072     
...
0239               
0240               txt.io.nofile
0241 392C 16               byte  22
0242 392D   4E             text  'No filename specified.'
     392E 6F20     
     3930 6669     
     3932 6C65     
     3934 6E61     
...
0246 3944 2D               byte  45
0247 3945   49             text  'Index full. File too large for editor buffer.'
     3946 6E64     
     3948 6578     
     394A 2066     
     394C 756C     
...
0251 3972 2D               byte  45
0252 3973   43             text  'Copy/Move target must be outside M1-M2 range.'
     3974 6F70     
     3976 792F     
     3978 4D6F     
     397A 7665     
...
0265 39A2 0D               byte  13
0266 39A3   43             text  'Color scheme:'
     39A4 6F6C     
     39A6 6F72     
     39A8 2073     
     39AA 6368     
...
0026               
0027               def.devices
0028 39D6 2F               byte  47
0029 39D7   2C             text  ',DSK,HDX,IDE,PI.,PIO,TIPI.,RD,SCS,SDD,WDS,RS232'
     39D8 4453     
     39DA 4B2C     
     39DC 4844     
     39DE 582C     
...
0040                       ;------------------------------------------------------
0041 3A06 04E0  34         clr   @bank1.rom            ; Activate bank 1 "James" ROM
     3A08 6002     
0042               
0046               
0047 3A0A 0460  28         b     @kickstart.code2      ; Jump to entry routine
     3A0C 6046     
0048               ***************************************************************
...
0257 689C 3812                   data txt.kb           ; Show "kb" string
0258               
...
0322 6904 3812                   data txt.kb           ; Show "kb" string
0323               
...
0428 69AA 06A0  32         bl    @cpym2m
     69AC 24EE     
0429 69AE 38E4                   data txt.ioerr.load
...
0437 69B6 06A0  32         bl    @cpym2m
     69B8 24EE     
0438 69BA 38FA                   data txt.ioerr.save
...
0446 69C2 06A0  32         bl    @cpym2m
     69C4 24EE     
0447 69C6 3910                   data txt.ioerr.print
...
0543 6A4E 06A0  32         bl    @cpym2m
     6A50 24EE     
0544 6A52 3944                   data txt.memfull.load
