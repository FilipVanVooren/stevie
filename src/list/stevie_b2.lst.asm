...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 220306-1812140
0010               *
0011               * Bank 2 "Jacky"
...
0270 21ED   42             text  'Build-ID  220306-1812140'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0428 69AA 06A0  32         bl    @cpym2m
     69AC 24EE     
0429 69AE 39BE                   data txt.ioerr.load
...
0437 69B6 06A0  32         bl    @cpym2m
     69B8 24EE     
0438 69BA 39D4                   data txt.ioerr.save
...
0446 69C2 06A0  32         bl    @cpym2m
     69C4 24EE     
0447 69C6 39EA                   data txt.ioerr.print
...
0543 6A4E 06A0  32         bl    @cpym2m
     6A50 24EE     
0544 6A52 3A1E                   data txt.memfull.load
