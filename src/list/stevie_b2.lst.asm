...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 211223-2003340
0010               *
0011               * Bank 2 "Jacky"
...
0270 21ED   42             text  'Build-ID  211223-2003340'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0041 66E6 381A                   data txt.clearmem     ; Display "Clearing memory...."
0042               *--------------------------------------------------------------
...
0085 6790 377A                   data txt.saving       ; Display "Saving...."
...
0093 679A 37D2                   data txt.block.save   ; Display "Saving block...."
0094               
...
0102 67A4 3786                   data txt.printing    ; Display "Printing...."
...
0110 67AE 3806                   data txt.block.print  ; Display "Printing block...."
...
0118 67B8 37EC                   data txt.block.clip  ; Display "Copying to clipboard...."
...
0127 67C2 376E                   data txt.loading      ; Display "Loading file...."
0128               
...
0158 67FC 38C2                   data txt.fastmode     ; Display "FastMode"
0159                       ;------------------------------------------------------
0160                       ; Exit
0161                       ;------------------------------------------------------
...
0257 6888 38CC                   data txt.kb           ; Show "kb" string
0258               
...
0322 68F0 38CC                   data txt.kb           ; Show "kb" string
0323               
...
0373 693C 382E             data  txt.done.load         ; id.file.loadfile
0374 693E 383E             data  txt.done.insert       ; id.file.insertfile
0375 6940 3850             data  txt.done.append       ; id.file.appendfile
0376 6942 3862             data  txt.done.save         ; id.file.savefile
0377 6944 3862             data  txt.done.save         ; id.file.saveblock
0378 6946 38A4             data  txt.done.clipboard    ; id.file.clipblock
0379 6948 3882             data  txt.done.print        ; id.file.printfile
0380 694A 3882             data  txt.done.print        ; id.file.printblock
0381               
0382               *---------------------------------------------------------------
...
0428 6996 06A0  32         bl    @cpym2m
     6998 24EE     
0429 699A 399E                   data txt.ioerr.load
...
0437 69A2 06A0  32         bl    @cpym2m
     69A4 24EE     
0438 69A6 39B4                   data txt.ioerr.save
...
0446 69AE 06A0  32         bl    @cpym2m
     69B0 24EE     
0447 69B2 39CA                   data txt.ioerr.print
...
0543 6A3A 06A0  32         bl    @cpym2m
     6A3C 24EE     
0544 6A3E 39FE                   data txt.memfull.load
...
0070                       ; Stubs
0071                       ;-----------------------------------------------------------------------
0072                       copy  "rom.stubs.bank2.asm" ; Stubs for functions in other banks
     **** ****     > rom.stubs.bank2.asm
...
0093               
0094 7FBA 0D               byte  13
0095 7FBB   52             text  'ROM#2'
     7FBC 4F4D     
     7FBE 2332     
0096                       even
0097               
...
0100                       ;-----------------------------------------------------------------------
0101                       aorg  >7fc0
0102                       copy  "rom.vectors.bank2.asm"      ; Vector table bank 2
