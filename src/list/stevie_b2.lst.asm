...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 220306-2002430
0010               *
0011               * Bank 2 "Jacky"
...
0270 21ED   42             text  'Build-ID  220306-2002430'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0041 66FA 37BE                   data txt.clearmem     ; Display "Clearing memory...."
0042               *--------------------------------------------------------------
...
0085 67A4 371E                   data txt.saving       ; Display "Saving...."
...
0093 67AE 3776                   data txt.block.save   ; Display "Saving block...."
0094               
...
0102 67B8 372A                   data txt.printing    ; Display "Printing...."
...
0110 67C2 37AA                   data txt.block.print  ; Display "Printing block...."
...
0118 67CC 3790                   data txt.block.clip  ; Display "Copying to clipboard...."
...
0127 67D6 3712                   data txt.loading      ; Display "Loading file...."
0128               
...
0158 6810 3866                   data txt.fastmode     ; Display "FastMode"
0159                       ;------------------------------------------------------
0160                       ; Exit
0161                       ;------------------------------------------------------
...
0257 689C 388C                   data txt.kb           ; Show "kb" string
0258               
...
0322 6904 388C                   data txt.kb           ; Show "kb" string
0323               
...
0373 6950 37D2             data  txt.done.load         ; id.file.loadfile
0374 6952 37E2             data  txt.done.insert       ; id.file.insertfile
0375 6954 37F4             data  txt.done.append       ; id.file.appendfile
0376 6956 3806             data  txt.done.save         ; id.file.savefile
0377 6958 3806             data  txt.done.save         ; id.file.saveblock
0378 695A 3848             data  txt.done.clipboard    ; id.file.clipblock
0379 695C 3826             data  txt.done.print        ; id.file.printfile
0380 695E 3826             data  txt.done.print        ; id.file.printblock
0381               
0382               *---------------------------------------------------------------
...
0428 69AA 06A0  32         bl    @cpym2m
     69AC 24EE     
0429 69AE 39F8                   data txt.ioerr.load
...
0437 69B6 06A0  32         bl    @cpym2m
     69B8 24EE     
0438 69BA 3A0E                   data txt.ioerr.save
...
0446 69C2 06A0  32         bl    @cpym2m
     69C4 24EE     
0447 69C6 3A24                   data txt.ioerr.print
...
0543 6A4E 06A0  32         bl    @cpym2m
     6A50 24EE     
0544 6A52 3A58                   data txt.memfull.load
