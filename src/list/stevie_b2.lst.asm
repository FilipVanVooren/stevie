...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210717-2120299
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210717-2120299'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0013 3437 ....             text  'STEVIE 1.1N'
0014                       even
0015               
0016               txt.about.build
0017 3442 4C42             byte  76
0018 3443 ....             text  'Build: 210717-2120299 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0289               
0290               txt.info.file
0291 3870 164E             byte  22
0292 3871 ....             text  'New, Open, Print, Save'
0293                       even
0294               
0295 3888 0005     pos.info.file      byte 0,5,11,18,>ff
     388A 0B12 
     388C FF28 
0296               txt.hint.file
0297                       byte  40
0298 388E ....             text  'Press N,O,P,S or F9 to return to editor.'
0299                       even
0300               
0301               txt.keys.file
0302 38B6 0D46             byte  13
0303 38B7 ....             text  'File: F9=Back'
0304                       even
0305               
0306               
0307               
...
0311               ;--------------------------------------------------------------
0312               txt.ioerr.load
0313 38C4 2049             byte  32
0314 38C5 ....             text  'I/O error. Failed loading file: '
0315                       even
0316               
0317               txt.ioerr.save
0318 38E6 2049             byte  32
0319 38E7 ....             text  'I/O error. Failed saving file:  '
0320                       even
0321               
0322               txt.memfull.load
0323 3908 4049             byte  64
0324 3909 ....             text  'Index memory full. Could not fully load file into editor buffer.'
0325                       even
0326               
0327               txt.io.nofile
0328 394A 2149             byte  33
0329 394B ....             text  'I/O error. No filename specified.'
0330                       even
0331               
0332               txt.block.inside
0333 396C 3445             byte  52
0334 396D ....             text  'Error. Copy/Move target must be outside block M1-M2.'
0335                       even
0336               
0337               
0338               ;--------------------------------------------------------------
...
0342 39A2 013E             byte  1
0343 39A3 ....             text  '>'
0344                       even
0345               
0346               txt.colorscheme
0347 39A4 0D43             byte  13
0348 39A5 ....             text  'Color scheme:'
0349                       even
0350               
**** **** ****     > ram.resident.3000.asm
...
0021                       ;------------------------------------------------------
0022 39B2 DEAD             data  >dead,>beef,>dead,>beef
     39B4 BEEF 
     39B6 DEAD 
     39B8 BEEF 
**** **** ****     > stevie_b2.asm.2120299
...
0241 66F6 06A0  32         bl    @cpym2m
     66F8 24DE 
0242 66FA 38C5                   data txt.ioerr.load+1
...
0250 6702 06A0  32         bl    @cpym2m
     6704 24DE 
0251 6706 38E7                   data txt.ioerr.save+1
...
0333 6776 06A0  32         bl    @cpym2m
     6778 24DE 
0334 677A 3908                   data txt.memfull.load
