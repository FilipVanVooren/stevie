...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 211027-2006110
0010               *
0011               * Bank 2 "Jacky"
...
0270 6231   42             text  'Build-ID  211027-2006110'
     6232 7569     
     6234 6C64     
     6236 2D49     
     6238 4420     
...
0051 669A 355E                   data txt.saving       ; Display "Saving...."
...
0059 66A4 35A2                   data txt.block.save   ; Display "Saving block...."
0060               
...
0068 66AE 3552                   data txt.loading      ; Display "Loading file...."
0069               
...
0094 66DE 35C0                   data txt.fastmode     ; Display "FastMode"
0095                       ;------------------------------------------------------
0096                       ; Exit
0097                       ;------------------------------------------------------
...
0175 6752 35CA                   data txt.kb           ; Show "kb" string
0176               
...
0219 6794 35CA                   data txt.kb           ; Show "kb" string
0220               
...
0267 67D8 06A0  32         bl    @cpym2m
     67DA 24EE     
0268 67DC 3693                   data txt.ioerr.load+1
...
0276 67E4 06A0  32         bl    @cpym2m
     67E6 24EE     
0277 67E8 36B5                   data txt.ioerr.save+1
...
0359 6858 06A0  32         bl    @cpym2m
     685A 24EE     
0360 685C 36D6                   data txt.memfull.load
...
0094      3450     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
