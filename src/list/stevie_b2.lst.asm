...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210928-689046
0010               *
0011               * Bank 2 "Jacky"
...
0260 6217 ....             text  'Build-ID  210928-689046'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0051 65EA 351E                   data txt.saving       ; Display "Saving...."
...
0059 65F4 3562                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 6608 3512                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0090 6624 3580                   data txt.fastmode     ; Display "FastMode"
0091                       ;------------------------------------------------------
0092                       ; Exit
0093                       ;------------------------------------------------------
...
0150 6670 358A                   data txt.kb           ; Show "kb" string
0151               
...
0193 66B2 358A                   data txt.kb           ; Show "kb" string
0194               
...
0241 66F6 06A0  32         bl    @cpym2m
     66F8 24D2 
0242 66FA 3659                   data txt.ioerr.load+1
...
0250 6702 06A0  32         bl    @cpym2m
     6704 24D2 
0251 6706 367B                   data txt.ioerr.save+1
...
0333 6776 06A0  32         bl    @cpym2m
     6778 24D2 
0334 677A 369C                   data txt.memfull.load
...
0093      3430     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
