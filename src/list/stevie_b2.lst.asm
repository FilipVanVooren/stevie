...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210909-56576
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210909-56576'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0018 3459 ....             text  'Build: 210909-56576 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
**** **** ****     > stevie_b2.asm.56576
0071                       copy  "/2TBHDD/bitbucket/projects/ti994a/spectra2/src/modules/snd_player.asm"
**** **** ****     > snd_player.asm
...
0078 6046 06A0  32         bl    @cpu.crash            ; Should never get here
     6048 2026 
0079                       ;-----------------------------------------------------------------------
0080                       ; Include files - Utility functions
0081                       ;-----------------------------------------------------------------------
0082                       copy  "colors.line.set.asm" ; Set color combination for line
**** **** ****     > colors.line.set.asm
...
0084                       ; File handling
0085                       ;-----------------------------------------------------------------------
0086                       copy  "fh.read.edb.asm"     ; Read file to editor buffer
**** **** ****     > fh.read.edb.asm
...
**** **** ****     > stevie_b2.asm.56576
0087                       copy  "fh.write.edb.asm"    ; Write editor buffer to file
**** **** ****     > fh.write.edb.asm
...
**** **** ****     > stevie_b2.asm.56576
0088                       copy  "fm.load.asm"         ; Load DV80 file into editor buffer
**** **** ****     > fm.load.asm
...
**** **** ****     > stevie_b2.asm.56576
0089                       copy  "fm.save.asm"         ; Save DV80 file from editor buffer
**** **** ****     > fm.save.asm
...
**** **** ****     > stevie_b2.asm.56576
0090                       copy  "fm.callbacks.asm"    ; Callbacks for file operations
**** **** ****     > fm.callbacks.asm
...
0051 65EA 34C2                   data txt.saving       ; Display "Saving...."
...
0059 65F4 3506                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 6608 34B6                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0090 6624 3524                   data txt.fastmode     ; Display "FastMode"
0091                       ;------------------------------------------------------
0092                       ; Exit
0093                       ;------------------------------------------------------
...
0150 6670 352E                   data txt.kb           ; Show "kb" string
0151               
...
0193 66B2 352E                   data txt.kb           ; Show "kb" string
0194               
...
0241 66F6 06A0  32         bl    @cpym2m
     66F8 24E6 
0242 66FA 3915                   data txt.ioerr.load+1
...
0250 6702 06A0  32         bl    @cpym2m
     6704 24E6 
0251 6706 3937                   data txt.ioerr.save+1
...
0333 6776 06A0  32         bl    @cpym2m
     6778 24E6 
0334 677A 3958                   data txt.memfull.load
...
**** **** ****     > stevie_b2.asm.56576
0091                       copy  "fm.browse.asm"       ; File manager browse support routines
**** **** ****     > fm.browse.asm
...
**** **** ****     > stevie_b2.asm.56576
0092                       copy  "fm.fastmode.asm"     ; Turn fastmode on/off for file operation
**** **** ****     > fm.fastmode.asm
...
**** **** ****     > stevie_b2.asm.56576
0093                       ;-----------------------------------------------------------------------
0094                       ; Stubs using trampoline
0095                       ;-----------------------------------------------------------------------
0096                       copy  "rom.stubs.bank2.asm" ; Stubs for functions in other banks
**** **** ****     > rom.stubs.bank2.asm
...
0016 6854 7FC2                   data vec.2            ; | i  p1 = Vector with target address
...
0037 6866 7FC6                   data vec.4            ; | i  p1 = Vector with target address
...
0059 6878 7FD4                   data vec.11           ; | i  p1 = Vector with target address
...
0080 688A 7FE6                   data vec.20           ; | i  p1 = Vector with target address
...
0102 689C 7FE8                   data vec.21           ; | i  p1 = Vector with target address
...
0125 68AE 7FFA                   data vec.30           ; | i  p1 = Vector with target address
...
0146 68C0 7FFC                   data vec.31           ; | i  p1 = Vector with target address
...
0167 68D2 7FFE                   data vec.32           ; | i  p1 = Vector with target address
...
0010 7FC6 6818     vec.4   data  fm.fastmode           ;
...
0114      33B0     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
