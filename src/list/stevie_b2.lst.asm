...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 220108-2143490
0010               *
0011               * Bank 2 "Jacky"
...
0270 21ED   42             text  'Build-ID  220108-2143490'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0030 3292 6004                   data bankid           ; / i  p2 = Source ROM bank for return
0031               
...
0041 66FA 3732                   data txt.clearmem     ; Display "Clearing memory...."
0042               *--------------------------------------------------------------
...
0085 67A4 3692                   data txt.saving       ; Display "Saving...."
...
0093 67AE 36EA                   data txt.block.save   ; Display "Saving block...."
0094               
...
0102 67B8 369E                   data txt.printing    ; Display "Printing...."
...
0110 67C2 371E                   data txt.block.print  ; Display "Printing block...."
...
0118 67CC 3704                   data txt.block.clip  ; Display "Copying to clipboard...."
...
0127 67D6 3686                   data txt.loading      ; Display "Loading file...."
0128               
...
0158 6810 37DA                   data txt.fastmode     ; Display "FastMode"
0159                       ;------------------------------------------------------
0160                       ; Exit
0161                       ;------------------------------------------------------
...
0257 689C 37E4                   data txt.kb           ; Show "kb" string
0258               
...
0322 6904 37E4                   data txt.kb           ; Show "kb" string
0323               
...
0373 6950 3746             data  txt.done.load         ; id.file.loadfile
0374 6952 3756             data  txt.done.insert       ; id.file.insertfile
0375 6954 3768             data  txt.done.append       ; id.file.appendfile
0376 6956 377A             data  txt.done.save         ; id.file.savefile
0377 6958 377A             data  txt.done.save         ; id.file.saveblock
0378 695A 37BC             data  txt.done.clipboard    ; id.file.clipblock
0379 695C 379A             data  txt.done.print        ; id.file.printfile
0380 695E 379A             data  txt.done.print        ; id.file.printblock
0381               
0382               *---------------------------------------------------------------
...
0428 69AA 06A0  32         bl    @cpym2m
     69AC 24EE     
0429 69AE 38B6                   data txt.ioerr.load
...
0437 69B6 06A0  32         bl    @cpym2m
     69B8 24EE     
0438 69BA 38CC                   data txt.ioerr.save
...
0446 69C2 06A0  32         bl    @cpym2m
     69C4 24EE     
0447 69C6 38E2                   data txt.ioerr.print
...
0543 6A4E 06A0  32         bl    @cpym2m
     6A50 24EE     
0544 6A52 3916                   data txt.memfull.load
...
0110      35E4     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
