...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 211113-2116590
0010               *
0011               * Bank 2 "Jacky"
...
0270 6231   42             text  'Build-ID  211113-2116590'
     6232 7569     
     6234 6C64     
     6236 2D49     
     6238 4420     
...
0044 73A4 06A0  32         bl    @cpym2m
     73A6 24EE     
0045 73A8 36C2                   data txt.clipboard,edb.clip.filename,20
     73AA A56A     
     73AC 0014     
0046                       ;-------------------------------------------------------
0047                       ; Exit
...
0107               
0108               txt.keys.block
0109 7668 2E               byte  46
0110 7669   46             text  'F9-Back  ^Copy  ^Move  ^Del  ^Save  Clip^0..^9'
     766A 392D     
     766C 4261     
     766E 636B     
     7670 2020     
...
0111                       even
0112               
0113 7698 2E2E     txt.ruler          text    '.........'
     769A 2E2E     
     769C 2E2E     
     769E 2E2E     
     76A0 2E       
0114 76A1   12                        byte    18
0115 76A2 2E2E                        text    '.........'
     76A4 2E2E     
     76A6 2E2E     
     76A8 2E2E     
     76AA 2E       
0116 76AB   13                        byte    19
0117 76AC 2E2E                        text    '.........'
     76AE 2E2E     
     76B0 2E2E     
     76B2 2E2E     
     76B4 2E       
0118 76B5   14                        byte    20
0119 76B6 2E2E                        text    '.........'
     76B8 2E2E     
     76BA 2E2E     
     76BC 2E2E     
     76BE 2E       
0120 76BF   15                        byte    21
0121 76C0 2E2E                        text    '.........'
     76C2 2E2E     
     76C4 2E2E     
     76C6 2E2E     
     76C8 2E       
0122 76C9   16                        byte    22
0123 76CA 2E2E                        text    '.........'
     76CC 2E2E     
     76CE 2E2E     
     76D0 2E2E     
     76D2 2E       
0124 76D3   17                        byte    23
0125 76D4 2E2E                        text    '.........'
     76D6 2E2E     
     76D8 2E2E     
     76DA 2E2E     
     76DC 2E       
0126 76DD   18                        byte    24
0127 76DE 2E2E                        text    '.........'
     76E0 2E2E     
     76E2 2E2E     
     76E4 2E2E     
     76E6 2E       
0128 76E7   19                        byte    25
0129                                  even
0130 76E8 020E     txt.alpha.down     data >020e,>0f00
     76EA 0F00     
0131 76EC 0110     txt.vertline       data >0110
0132 76EE 011C     txt.keymarker      byte 1,28
0133               
0134               txt.ws1
0135 76F0 01               byte  1
0136 76F1   20             text  ' '
...
0157                       even
0158               
0159      36B6     txt.filetype.none  equ txt.ws4
0160               txt.clipboard
0161 7706 09               byte  9
0162 7707   44             text  'DSK1.CLIP'
     7708 534B     
     770A 312E     
     770C 434C     
     770E 4950     
...
0168               ;--------------------------------------------------------------
0169               txt.ioerr.load
0170 7710 20               byte  32
0171 7711   49             text  'I/O error. Failed loading file: '
     7712 2F4F     
     7714 2065     
     7716 7272     
     7718 6F72     
...
0173               
0174               txt.ioerr.save
0175 7732 20               byte  32
0176 7733   49             text  'I/O error. Failed saving file:  '
     7734 2F4F     
     7736 2065     
     7738 7272     
     773A 6F72     
...
0180 7754 40               byte  64
0181 7755   49             text  'Index memory full. Could not fully load file into editor buffer.'
     7756 6E64     
     7758 6578     
     775A 206D     
     775C 656D     
...
0183               
0184               txt.io.nofile
0185 7796 21               byte  33
0186 7797   49             text  'I/O error. No filename specified.'
     7798 2F4F     
     779A 2065     
     779C 7272     
     779E 6F72     
...
0190 77B8 34               byte  52
0191 77B9   45             text  'Error. Copy/Move target must be outside block M1-M2.'
     77BA 7272     
     77BC 6F72     
     77BE 2E20     
     77C0 436F     
...
0204 77F0 0D               byte  13
0205 77F1   43             text  'Color scheme:'
     77F2 6F6C     
     77F4 6F72     
     77F6 2073     
     77F8 6368     
...
0045                       ;------------------------------------------------------
0046 77FE 04E0  34         clr   @bank1.rom            ; Activate bank 1 "James" ROM
     7800 6002     
0047               
0051               
0052 7802 0460  28         b     @kickstart.code2      ; Jump to entry routine
     7804 6046     
0053               ***************************************************************
...
0041 6696 35DA                   data txt.clearmem     ; Display "Clearing memory...."
0042               *--------------------------------------------------------------
...
0060 670C 357C                   data txt.saving       ; Display "Saving...."
...
0068 6716 35C0                   data txt.block.save   ; Display "Saving block...."
0069               
...
0077 6720 3570                   data txt.loading      ; Display "Loading file...."
0078               
...
0104 6750 35EE                   data txt.fastmode     ; Display "FastMode"
0105                       ;------------------------------------------------------
0106                       ; Exit
0107                       ;------------------------------------------------------
...
0181 67B8 35F8                   data txt.kb           ; Show "kb" string
0182               
...
0225 67FA 35F8                   data txt.kb           ; Show "kb" string
0226               
...
0273 683E 06A0  32         bl    @cpym2m
     6840 24EE     
0274 6842 36CD                   data txt.ioerr.load+1
...
0282 684A 06A0  32         bl    @cpym2m
     684C 24EE     
0283 684E 36EF                   data txt.ioerr.save+1
...
0365 68BE 06A0  32         bl    @cpym2m
     68C0 24EE     
0366 68C2 3710                   data txt.memfull.load
...
0102 69AC 7FE6                   data vec.20           ; | i  p1 = Vector with target address
...
0115               ********|*****|*********************|**************************
0116               fb.vdpdump:
0117 69B4 0649  14         dect  stack
0118 69B6 C64B  30         mov   r11,*stack            ; Save return address
0119                       ;------------------------------------------------------
0120                       ; Call function in bank 1
0121                       ;------------------------------------------------------
0122 69B8 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     69BA 30A4     
0123 69BC 6002                   data bank1.rom        ; | i  p0 = bank address
0124 69BE 7FE8                   data vec.21           ; | i  p1 = Vector with target address
0125 69C0 6004                   data bankid           ; / i  p2 = Source ROM bank for return
0126                       ;------------------------------------------------------
0127                       ; Exit
0128                       ;------------------------------------------------------
0129 69C2 C2F9  30         mov   *stack+,r11           ; Pop r11
0130 69C4 045B  20         b     *r11                  ; Return to caller
0131               
0132               
0133               
0134               
...
0140 69C6 0649  14         dect  stack
0141 69C8 C64B  30         mov   r11,*stack            ; Save return address
0142                       ;------------------------------------------------------
0143                       ; Call function in bank 1
0144                       ;------------------------------------------------------
0145 69CA 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     69CC 30A4     
0146 69CE 6002                   data bank1.rom        ; | i  p0 = bank address
0147 69D0 7FFA                   data vec.30           ; | i  p1 = Vector with target address
0148 69D2 6004                   data bankid           ; / i  p2 = Source ROM bank for return
0149                       ;------------------------------------------------------
0150                       ; Exit
0151                       ;------------------------------------------------------
0152 69D4 C2F9  30         mov   *stack+,r11           ; Pop r11
0153 69D6 045B  20         b     *r11                  ; Return to caller
0154               
0155               
0156               ***************************************************************
...
0168 69E2 7FFC                   data vec.31           ; | i  p1 = Vector with target address
...
0189 69F4 7FFE                   data vec.32           ; | i  p1 = Vector with target address
...
0208 6A00 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6A02 30A4     
0209 6A04 600A                   data bank5.rom        ; | i  p0 = bank address
0210 6A06 7FC0                   data vec.1            ; | i  p1 = Vector with target address
