...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210403-868175
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210403-868175'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0013 3499 ....             text  'Build: 210403-868175 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0014                       even
0015               
0016               ;--------------------------------------------------------------
...
0051 65D0 3502                   data txt.saving       ; Display "Saving...."
...
0059 65DA 3546                   data txt.block.save   ; Display "Saving block...."
0060               
...
0072 65EE 34F6                   data txt.loading      ; Display "Loading file...."
0073                       ;------------------------------------------------------
...
0098 6618 3564                   data txt.fastmode     ; Display "FastMode"
0099                       ;------------------------------------------------------
0100                       ; Exit
0101                       ;------------------------------------------------------
...
0158 6664 356E                   data txt.kb           ; Show "kb" string
0159               
...
0201 66A6 356E                   data txt.kb           ; Show "kb" string
0202               
...
0249 66EA 06A0  32         bl    @cpym2m
     66EC 24A0 
0250 66EE 3847                   data txt.ioerr.load+1
...
0258 66F6 06A0  32         bl    @cpym2m
     66F8 24A0 
0259 66FA 3869                   data txt.ioerr.save+1
...
0341 676A 06A0  32         bl    @cpym2m
     676C 24A0 
0342 676E 388A                   data txt.memfull.load
