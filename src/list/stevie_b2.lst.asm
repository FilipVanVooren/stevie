...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 210822-38721
0010               *
0011               * Bank 2 "Jacky"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210822-38721'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0045                       ;------------------------------------------------------
0046 2EFC DEAD             data >dead,>beef,>dead,>beef
     2EFE BEEF 
     2F00 DEAD 
     2F02 BEEF 
0048               ***************************************************************
...
0018 3459 ....             text  'Build: 210822-38721 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0068               ********|*****|*********************|**************************
0069               main:
0070                       aorg  kickstart.code2       ; >6046
0071 6046 06A0  32         bl    @cpu.crash            ; Should never get here
     6048 2026 
0072                       ;-----------------------------------------------------------------------
...
**** **** ****     > stevie_b2.asm.38721
0090                       ;-----------------------------------------------------------------------
0091                       ; Bank full check
0092                       ;-----------------------------------------------------------------------
0096                       ;-----------------------------------------------------------------------
0097                       ; Vector table
0098                       ;-----------------------------------------------------------------------
0099                       aorg  >7fc0
0100                       copy  "rom.vectors.bank2.asm"      ; Vector table bank 2
...
0107      33B0     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
