...
0008               ***************************************************************
0009               * File: stevie_b2.asm               ; Version 211013-2107510
0010               *
0011               * Bank 2 "Jacky"
...
0260 6217   42             text  'Build-ID  211013-2107510'
     6218 7569     
     621A 6C64     
     621C 2D49     
     621E 4420     
...
0412 62F8 00               byte  io.op.open            ;  0    - OPEN
0413 62F9   14             byte  io.seq.inp.dis.var    ;  1    - INPUT, VARIABLE, DISPLAY
0414 62FA 0960             data  fh.vrecbuf            ;  2-3  - Record buffer in VDP memory
0415 62FC 50               byte  80                    ;  4    - Record length (80 chars max)
0416 62FD   00             byte  00                    ;  5    - Character count
0417 62FE 0000             data  >0000                 ;  6-7  - Seek record (only for fixed recs)
0418 6300 00               byte  >00                   ;  8    - Screen offset (cassette DSR only)
0419                       ;------------------------------------------------------
