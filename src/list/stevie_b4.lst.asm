...
0008               ***************************************************************
0009               * File: stevie_b4.asm               ; Version 210912-1051591
0010               *
0011               * Bank 4 "Janine"
0012               *
0013               ***************************************************************
...
0260 6217 ....             text  'Build-ID  210912-1051591'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0018 7525 ....             text  'Build: 210912-1051591 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0057 6046 06A0  32         bl    @cpu.crash            ; Should never get here
     6048 2026 
0058                       ;-----------------------------------------------------------------------
0059                       ; Logic for Framebuffer (2)
0060                       ;-----------------------------------------------------------------------
0061                       copy  "fb.utils.asm"        ; Framebuffer utilities
**** **** ****     > fb.utils.asm
...
**** **** ****     > stevie_b4.asm.1051591
0062                       copy  "fb.null2char.asm"    ; Replace null characters in framebuffer row
**** **** ****     > fb.null2char.asm
...
**** **** ****     > stevie_b4.asm.1051591
0063                       copy  "fb.tab.next.asm"     ; Move cursor to next tab position
**** **** ****     > fb.tab.next.asm
...
**** **** ****     > stevie_b4.asm.1051591
0064                       copy  "fb.ruler.asm"        ; Setup ruler with tab positions in memory
**** **** ****     > fb.ruler.asm
...
0028 617A 06A0  32         bl    @cpym2m
     617C 24E8 
0029 617E 3618                   data txt.ruler,fb.ruler.sit,80
     6180 A31E 
     6182 0050 
...
**** **** ****     > stevie_b4.asm.1051591
0065                       copy  "fb.colorlines.asm"   ; Colorize lines in framebuffer
**** **** ****     > fb.colorlines.asm
...
**** **** ****     > stevie_b4.asm.1051591
0066                       copy  "fb.vdpdump.asm"      ; Dump framebuffer to VDP SIT
**** **** ****     > fb.vdpdump.asm
...
**** **** ****     > stevie_b4.asm.1051591
0067                       ;-----------------------------------------------------------------------
0068                       ; Stubs using trampoline
0069                       ;-----------------------------------------------------------------------
0070                       copy  "rom.stubs.bank4.asm" ; Stubs for functions in other banks
**** **** ****     > rom.stubs.bank4.asm
...
0079                       ;-----------------------------------------------------------------------
0080                       aorg  >7fc0
0081                       copy  "rom.vectors.bank4.asm"
...
**** **** ****     > stevie_b4.asm.1051591
0082                                                   ; Vector table bank 4
0083               
0084               *--------------------------------------------------------------
0085               * Video mode configuration
0086               *--------------------------------------------------------------
0087      00F4     spfclr  equ   >f4                   ; Foreground/Background color for font.
0088      0004     spfbck  equ   >04                   ; Screen background color.
0089      3438     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
0090      000C     spfont  equ   fnopt3                ; Font to load. See LDFONT for details.
0091      0050     colrow  equ   80                    ; Columns per row
0092      0FC0     pctadr  equ   >0fc0                 ; VDP color table base
0093      1100     fntadr  equ   >1100                 ; VDP font start address (in PDT range)
0094      2180     sprsat  equ   >2180                 ; VDP sprite attribute table
0095      2800     sprpdt  equ   >2800                 ; VDP sprite pattern table
