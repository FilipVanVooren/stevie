...
0008               ***************************************************************
0009               * File: stevie_b4.asm               ; Version 211209-1936290
0010               *
0011               * Bank 4 "Janine"
0012               * Framebuffer methods delegated from bank 1
0013               ***************************************************************
0014                       copy  "rom.build.asm"     s  ; Cartridge build options
     **** ****     > rom.build.asm
...
0270 21ED   42             text  'Build-ID  211209-1936290'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0028 617A 06A0  32         bl    @cpym2m
     617C 24EE     
0029 617E 3906                   data txt.ruler,fb.ruler.sit,80
     6180 A31E     
     6182 0050     
...
0099                       ;-----------------------------------------------------------------------
0100                       aorg  >7fc0
0101                       copy  "rom.vectors.bank4.asm"
...
0109      3654     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
