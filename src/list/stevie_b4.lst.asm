...
0008               ***************************************************************
0009               * File: stevie_b4.asm               ; Version 210523-3154487
0010               *
0011               * Bank 4 "Janine"
0012               *
0013               ***************************************************************
...
0086               *--------------------------------------------------------------
0092               
0093      0017     pane.botrow               equ  23      ; Bottom row on screen
0094               
0096               *--------------------------------------------------------------
...
0109      1DF0     vdp.cmdb.toprow.tat       equ  >1800 + ((pane.botrow - 4) * 80)
0110                                                      ; VDP TAT address of 1st CMDB row
0111      0780     vdp.sit.size              equ  (pane.botrow + 1) * 80
...
0260 21D3 ....             text  'Build-ID  210523-3154487'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0018 3443 ....             text  'Build: 210523-3154487 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0028 616A 06A0  32         bl    @cpym2m
     616C 24DE 
0029 616E 3582                   data txt.ruler,fb.ruler.sit,80
     6170 A11E 
     6172 0050 
