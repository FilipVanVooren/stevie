...
0008               ***************************************************************
0009               * File: stevie_b3.asm               ; Version 220103-2056020
0010               *
0011               * Bank 3 "John"
...
0270 21ED   42             text  'Build-ID  220103-2056020'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0030 338E 6006                   data bankid           ; / i  p2 = Source ROM bank for return
0031               
...
0120 6CA0 06A0  32         bl    @putstr
     6CA2 2432     
0121 6CA4 399E                   data txt.keymarker    ; Show key marker
0122               
...
0171 6CEA 3998                   data   txt.alpha.down
0172                       ;------------------------------------------------------
...
0054 6D66 06A0  32         bl    @putstr
     6D68 2432     
0055 6D6A 3A72                   data txt.cmdb.prompt
0056                       ;------------------------------------------------------
0057                       ; Exit
0058                       ;------------------------------------------------------
...
0203 7407   42             text  'Build: 220103-2056020 / 2018-2022 Filip Van Vooren / retroclouds on Atariage'
     7408 7569     
     740A 6C64     
     740C 3A20     
     740E 3232     
...
0137      36E4     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
