...
0008               ***************************************************************
0009               * File: stevie_b3.asm               ; Version 211230-1857000
0010               *
0011               * Bank 3 "John"
...
0270 21ED   42             text  'Build-ID  211230-1857000'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0203 73E1   42             text  'Build: 211230-1857000 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
     73E2 7569     
     73E4 6C64     
     73E6 3A20     
     73E8 3231     
...
0289               
0290               txt.info.basic
0291 7505   16             byte  22
0292 7506 5365             text  'Session: 1  2  3  4  5'
     7508 7373     
     750A 696F     
     750C 6E3A     
     750E 2031     
...
0293                       even
0294               
0295 751C 090C     pos.info.basic     byte 9,12,15,18,21,>ff
     751E 0F12     
     7520 15FF     
0296               txt.hint.basic
0297 7522 3F               byte  63
0298 7523   50             text  'Pick session 1 to 5. Press F9 in Basic for returning to Stevie.'
     7524 6963     
     7526 6B20     
     7528 7365     
     752A 7373     
...
0315               ;--------------------------------------------------------------
0316 7572 0E01     txt.head.config    byte 14,1,1
     7574 01       
0317 7575   20                        text ' Configure '
     7576 436F     
     7578 6E66     
     757A 6967     
     757C 7572     
...
0323                       even
0324               
0325 758C 00FF     pos.info.config    byte 0,>ff
...
0010                       ;-------------------------------------------------------
0011 7598 0011             data  id.dialog.clipdev,key.ctrl.a,def.clip.fname
     759A 0081     
     759C 39C8     
0012 759E 0011             data  id.dialog.clipdev,key.ctrl.b,def.clip.fname.b
     75A0 0082     
     75A2 39D2     
0013 75A4 0011             data  id.dialog.clipdev,key.ctrl.c,def.clip.fname.C
     75A6 0083     
     75A8 39DC     
0014                       ;------------------------------------------------------
0015                       ; End of list
0016                       ;-------------------------------------------------------
0017 75AA FFFF             data  EOL                   ; EOL
                   < stevie_b3.asm.7434
0102                       ;-----------------------------------------------------------------------
