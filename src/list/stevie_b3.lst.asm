...
0008               ***************************************************************
0009               * File: stevie_b3.asm               ; Version 210822-39116
0010               *
0011               * Bank 3 "John"
0012               *
0013               ***************************************************************
...
0260 21D3 ....             text  'Build-ID  210822-39116'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0018 3459 ....             text  'Build: 210822-39116 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0078                       ;-----------------------------------------------------------------------
0079                       copy  "dialog.menu.asm"     ; Dialog "Stevie Menu"
**** **** ****     > dialog.menu.asm
...
**** **** ****     > stevie_b3.asm.39116
0080                       copy  "dialog.about.asm"    ; Dialog "About"
**** **** ****     > dialog.about.asm
...
0329               
**** **** ****     > stevie_b3.asm.39116
0081                       copy  "dialog.file.asm"     ; Dialog "File"
**** **** ****     > dialog.file.asm
...
**** **** ****     > stevie_b3.asm.39116
0082                       copy  "dialog.load.asm"     ; Dialog "Load DV80 file"
**** **** ****     > dialog.load.asm
...
**** **** ****     > stevie_b3.asm.39116
0083                       copy  "dialog.save.asm"     ; Dialog "Save DV80 file"
**** **** ****     > dialog.save.asm
...
**** **** ****     > stevie_b3.asm.39116
0084                       copy  "dialog.unsaved.asm"  ; Dialog "Unsaved changes"
**** **** ****     > dialog.unsaved.asm
...
**** **** ****     > stevie_b3.asm.39116
0085                       copy  "dialog.basic.asm"    ; Dialog "Basic"
**** **** ****     > dialog.basic.asm
...
**** **** ****     > stevie_b3.asm.39116
0086                       ;-----------------------------------------------------------------------
0087                       ; Basic interpreter handling
0088                       ;-----------------------------------------------------------------------
0089                       copy  "run.tibasic.asm"     ; Run TI Basic in GPL Interpreter
**** **** ****     > run.tibasic.asm
...
0092                       ;-----------------------------------------------------------------------
0093                       copy  "cmdb.refresh.asm"    ; Refresh command buffer contents
**** **** ****     > cmdb.refresh.asm
...
**** **** ****     > stevie_b3.asm.39116
0094                       copy  "cmdb.cmd.asm"        ; Command line handling
**** **** ****     > cmdb.cmd.asm
...
0016 67E8 7FD2                   data vec.10           ; | i  p1 = Vector with target address
...
0037 67FA 7FDC                   data vec.15           ; | i  p1 = Vector with target address
...
0059 680C 7FF6                   data vec.28           ; | i  p1 = Vector with target address
...
0079 681E 7FF8                   data vec.29           ; | i  p1 = Vector with target address
...
0107                       ;-----------------------------------------------------------------------
0108                       aorg  >7fc0
0109                       copy  "rom.vectors.bank3.asm"
...
0026 7FE6 6700     vec.20  data  run.tibasic           ; Run TI Basic interpreter
0027 7FE8 2026     vec.21  data  cpu.crash             ;
0028 7FEA 2026     vec.22  data  cpu.crash             ;
0029 7FEC 2026     vec.23  data  cpu.crash             ;
0030 7FEE 6734     vec.24  data  cmdb.refresh          ;
0031 7FF0 677E     vec.25  data  cmdb.cmd.clear        ;
0032 7FF2 67B0     vec.26  data  cmdb.cmd.getlength    ;
0033 7FF4 67C6     vec.27  data  cmdb.cmd.history.add  ;
...
0118      33B0     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
