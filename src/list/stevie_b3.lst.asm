...
0008               ***************************************************************
0009               * File: stevie_b3.asm               ; Version 211012-9490
0010               *
0011               * Bank 3 "John"
...
0260 6217   42             text  'Build-ID  211012-9490'
     6218 7569     
     621A 6C64     
     621C 2D49     
     621E 4420     
...
0107 68DE 06A0  32         bl    @putstr
     68E0 2414     
0108 68E2 3658                   data txt.keymarker    ; Show key marker
0109               
...
0160 6928 3652                   data   txt.alpha.down
0161                       ;------------------------------------------------------
...
0054 6972 06A0  32         bl    @putstr
     6974 2414     
0055 6976 374E                   data txt.cmdb.prompt
0056                       ;------------------------------------------------------
0057                       ; Exit
0058                       ;------------------------------------------------------
...
0036 6A9A 06A0  32         bl    @sams.layout
     6A9C 25D8     
0037 6A9E 347A                   data mem.sams.external
...
0046 6AAA 06A0  32         bl    @sams.layout
     6AAC 25D8     
0047 6AAE 349A                   data mem.sams.tibasic ; Load SAMS page layout for TI Basic
0048                       ;-------------------------------------------------------
...
0053 6AB4 06A0  32         bl    @vidtab               ; Load video mode table into VDP
     6AB6 22EE     
0054 6AB8 3438                   data tibasic.32x24    ; Equate selected video mode table
0055                       ;-------------------------------------------------------
...
0212 6B96 06A0  32         bl    @sams.layout
     6B98 25D8     
0213 6B9A 347A                   data mem.sams.external
...
0254 6BEC 06A0  32         bl    @vidtab               ; Load video mode table into VDP
     6BEE 22EE     
0255 6BF0 342E                   data stevie.80x30     ; Equate selected video mode table
0256               
...
0102 6DEA 49               byte  73
0103 6DEB   42             text  'Build: 211012-9490 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
     6DEC 7569     
     6DEE 6C64     
     6DF0 3A20     
     6DF2 3231     
...
0109               ; Dialog "Menu"
0110               ;--------------------------------------------------------------
0111 6E34 1001     txt.head.menu      byte 16,1,3
     6E36 03       
0112 6E37   20                        text ' Stevie 1.1X '
     6E38 5374     
     6E3A 6576     
     6E3C 6965     
     6E3E 2031     
...
0114               
0115               txt.info.menu
0116 6E45   1A             byte  26
0117 6E46 4669             text  'File   Basic   Help   Quit'
     6E48 6C65     
     6E4A 2020     
     6E4C 2042     
     6E4E 6173     
...
0118                       even
0119               
0120 6E60 0007     pos.info.menu      byte 0,7,15,22,>ff
     6E62 0F16     
     6E64 FF       
0121               txt.hint.menu
0122 6E65   02             byte  2
...
0134               ; Dialog "File"
0135               ;--------------------------------------------------------------
0136 6E70 0901     txt.head.file      byte 9,1,3
     6E72 03       
0137 6E73   20                        text ' File '
     6E74 4669     
     6E76 6C65     
     6E78 20       
0138 6E79   02                        byte 2
0139               
0140               txt.info.file
0141 6E7A 11               byte  17
0142 6E7B   4E             text  'New   Open   Save'
     6E7C 6577     
     6E7E 2020     
     6E80 204F     
     6E82 7065     
...
0143                       even
0144               
0145 6E8C 0006     pos.info.file      byte 0,6,13,>ff
     6E8E 0DFF     
0146               txt.hint.file
0147 6E90 01               byte  1
0148 6E91   20             text  ' '
...
0158               ; Dialog "Basic"
0159               ;--------------------------------------------------------------
0160 6E9A 0E01     txt.head.basic     byte 14,1,3
     6E9C 03       
0161 6E9D   20                        text ' Run basic '
     6E9E 5275     
     6EA0 6E20     
     6EA2 6261     
     6EA4 7369     
...
0163               
0164               txt.info.basic
0165 6EA9   1C             byte  28
0166 6EAA 5449             text  'TI Basic   TI Extended Basic'
     6EAC 2042     
     6EAE 6173     
     6EB0 6963     
     6EB2 2020     
...
0167                       even
0168               
0169 6EC6 030E     pos.info.basic     byte 3,14,>ff
     6EC8 FF       
0170               txt.hint.basic
0171 6EC9   02             byte  2
0172 6ECA 00               text  ''
...
0122      342E     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
