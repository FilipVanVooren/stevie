...
0008               ***************************************************************
0009               * File: stevie_b3.asm               ; Version 220103-2028110
0010               *
0011               * Bank 3 "John"
...
0270 21ED   42             text  'Build-ID  220103-2028110'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0030 3374 6006                   data bankid           ; / i  p2 = Source ROM bank for return
0031               
...
0040 6BA4 06A0  32 !       bl    @hchar
     6BA6 27E6     
0041 6BA8 1300                   byte pane.botrow-4,0,32,80*3
     6BAA 20F0     
0042 6BAC 1600                   byte pane.botrow-1,0,32,80*2
     6BAE 20A0     
...
0087 6C6C 06A0  32         bl    @at
     6C6E 26DA     
0088 6C70 1400                   byte pane.botrow-3,0  ; Position cursor
0089               
...
0096 6C7A 06A0  32         bl    @hchar
     6C7C 27E6     
0097 6C7E 1500                   byte pane.botrow-2,0,32,80
     6C80 2050     
...
0120 6CA0 06A0  32         bl    @putstr
     6CA2 2432     
0121 6CA4 3984                   data txt.keymarker    ; Show key marker
0122               
...
0160 6CD8 06A0  32         bl    @hchar
     6CDA 27E6     
0161 6CDC 174E                   byte pane.botrow,78,32,2
     6CDE 2002     
...
0169 6CE4 06A0  32         bl    @putat
     6CE6 2456     
0170 6CE8 174E                   byte   pane.botrow,78
0171 6CEA 397E                   data   txt.alpha.down
0172                       ;------------------------------------------------------
...
0054 6D66 06A0  32         bl    @putstr
     6D68 2432     
0055 6D6A 3A58                   data txt.cmdb.prompt
0056                       ;------------------------------------------------------
0057                       ; Exit
0058                       ;------------------------------------------------------
...
0203 7407   42             text  'Build: 220103-2028110 / 2018-2022 Filip Van Vooren / retroclouds on Atariage'
     7408 7569     
     740A 6C64     
     740C 3A20     
     740E 3232     
...
0137      36CA     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
