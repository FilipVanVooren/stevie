...
0008               ***************************************************************
0009               * File: stevie_b1.asm               ; Version 201126-359343
0010               *
0011               * Bank 3 "John"
0012               *
0013               ***************************************************************
...
0007               *              (c)2018-2020 // Filip van Vooren
0008               ***************************************************************
0009               * File: equates.equ                 ; Version 201126-359343
0010               *--------------------------------------------------------------
...
0027               ********|*****|*********************|**************************
0028                       aorg  >6000
0029                       save  >6000,>7fff           ; Save bank 3
0030               *--------------------------------------------------------------
...
0255 21C5 ....             text  'Source    stevie_b3.lst.asm'
0256                       even
0257               
0258               cpu.crash.msg.id
0259 21E0 1742             byte  23
0260 21E1 ....             text  'Build-ID  201126-359343'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0033 33A7 ....             text  'Build: 201126-359343'
0034                       even
0035               
0036               
0037               txt.about.msg1
...
0098               ********|*****|*********************|**************************
0099               main:
0100 3BF6 10FF  14         jmp   $
0101               
0102               
0103                       ;-----------------------------------------------------------------------
0104                       ; Bank specific vector table
0105                       ;-----------------------------------------------------------------------
0109 3BF8 3BF8                   data $                ; Bank 1 ROM size OK.
0111               
0112                       aorg  >7fe0
0113               
0114 7FE0 7FE0     vector.0   data  $
0115 7FE2 7FE2     vector.1   data  $
0116 7FE4 7FE4     vector.2   data  $
0117 7FE6 7FE6     vector.3   data  $
0118 7FE8 7FE8     vector.4   data  $
0119 7FEA 7FEA     vector.5   data  $
0120 7FEC 7FEC     vector.6   data  $
0121 7FEE 7FEE     vector.7   data  $
0122 7FF0 7FF0     vector.8   data  $
0123 7FF2 7FF2     vector.9   data  $
0124 7FF4 7FF4     vector.a   data  $
0125 7FF6 7FF6     vector.b   data  $
0126 7FF8 7FF8     vector.c   data  $
0127 7FFA 7FFA     vector.d   data  $
0128 7FFC 7FFC     vector.e   data  $
0129 7FFE 7FFE     vector.f   data  $
0130               
0131               
0132               *--------------------------------------------------------------
...
0137      322C     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
