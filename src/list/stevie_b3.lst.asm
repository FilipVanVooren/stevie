...
0008               ***************************************************************
0009               * File: stevie_b3.asm               ; Version 211225-2033180
0010               *
0011               * Bank 3 "John"
...
0270 21ED   42             text  'Build-ID  211225-2033180'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0043 68A6 06A0  32         bl    @cpym2m
     68A8 24EE     
0044 68AA 729E                   data txt.head.insert,cmdb.panhead.buf,25
     68AC A77A     
     68AE 0019     
0045               
...
0039 69D2 06A0  32         bl    @cpym2m
     69D4 24EE     
0040 69D6 736A                   data txt.head.clipboard,cmdb.panhead.buf,27
     69D8 A77A     
     69DA 001B     
0041               
...
0048 6C0E 06A0  32         bl    @cpym2m
     6C10 24EE     
0049 6C12 7178                   data txt.stevie,rambuf+68,13
     6C14 A144     
     6C16 000D     
0050                                                   ;
...
0120 6C94 06A0  32         bl    @putstr
     6C96 2432     
0121 6C98 38FE                   data txt.keymarker    ; Show key marker
0122               
...
0171 6CDE 38F8                   data   txt.alpha.down
0172                       ;------------------------------------------------------
...
0054 6D5A 06A0  32         bl    @putstr
     6D5C 2432     
0055 6D5E 39D2                   data txt.cmdb.prompt
0056                       ;------------------------------------------------------
0057                       ; Exit
0058                       ;------------------------------------------------------
...
0216               
0217               ***************************************************************
0218               * Stub for "mem.sams.set.external"
0219               * bank7 vec.3
0220               ********|*****|*********************|**************************
0221               mem.sams.set.external:
0222 6FAA 0649  14         dect  stack
0223 6FAC C64B  30         mov   r11,*stack            ; Save return address
0224                       ;------------------------------------------------------
0225                       ; Call function in bank 7
0226                       ;------------------------------------------------------
0227 6FAE 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6FB0 30AE     
0228 6FB2 600E                   data bank7.rom        ; | i  p0 = bank address
0229 6FB4 7FC4                   data vec.3            ; | i  p1 = Vector with target address
0230 6FB6 6006                   data bankid           ; / i  p2 = Source ROM bank for return
0231                       ;------------------------------------------------------
0232                       ; Exit
0233                       ;------------------------------------------------------
0234 6FB8 C2F9  30         mov   *stack+,r11           ; Pop r11
0235 6FBA 045B  20         b     *r11                  ; Return to caller
0236               
0237               
0238               ***************************************************************
0239               
0240               ; TODO Include _trampoline.bank1.ret
0241               ; TODO Refactor stubs for using _trampoline.bank1.ret
                   < stevie_b3.asm.139486
...
0013 6FBC 0649  14         dect  stack
0014 6FBE C64B  30         mov   r11,*stack            ; Save return address
0015                       ;------------------------------------------------------
0016                       ; Call function in bank 1
0017                       ;------------------------------------------------------
0018 6FC0 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6FC2 30AE     
0019 6FC4 6002                   data bank1.rom        ; | i  p0 = bank address
0020 6FC6 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0021 6FC8 6006                   data bankid           ; / i  p2 = Source ROM bank for return
0022                       ;------------------------------------------------------
0023                       ; Exit
0024                       ;------------------------------------------------------
0025 6FCA C2F9  30         mov   *stack+,r11           ; Pop r11
0026 6FCC 045B  20         b     *r11                  ; Return to caller
0027               
0029               
0030               
0031               ***************************************************************
...
0038 6FCE 0649  14         dect  stack
0039 6FD0 C64B  30         mov   r11,*stack            ; Save return address
0040                       ;------------------------------------------------------
0041                       ; Dump VDP patterns
0042                       ;------------------------------------------------------
0043 6FD2 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6FD4 30AE     
0044 6FD6 600E                   data bank7.rom        ; | i  p0 = bank address
0045 6FD8 7FC0                   data vec.1            ; | i  p1 = Vector with target address
0046 6FDA 6006                   data bankid           ; / i  p2 = Source ROM bank for return
0047                       ;------------------------------------------------------
0048                       ; Exit
0049                       ;------------------------------------------------------
0050 6FDC C2F9  30         mov   *stack+,r11           ; Pop r11
0051 6FDE 045B  20         b     *r11                  ; Return to caller
0052               
0054               
0055               
0056               ***************************************************************
...
0063 6FE0 0649  14         dect  stack
0064 6FE2 C64B  30         mov   r11,*stack            ; Save return address
0065                       ;------------------------------------------------------
0066                       ; Dump VDP patterns
0067                       ;------------------------------------------------------
0068 6FE4 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6FE6 30AE     
0069 6FE8 600E                   data bank7.rom        ; | i  p0 = bank address
0070 6FEA 7FC2                   data vec.2            ; | i  p1 = Vector with target address
0071 6FEC 6006                   data bankid           ; / i  p2 = Source ROM bank for return
0072                       ;------------------------------------------------------
0073                       ; Exit
0074                       ;------------------------------------------------------
0075 6FEE C2F9  30         mov   *stack+,r11           ; Pop r11
0076 6FF0 045B  20         b     *r11                  ; Return to caller
0077               
                   < stevie_b3.asm.139486
0097                       ;-----------------------------------------------------------------------
0098                       ; Basic interpreter
0099                       ;-----------------------------------------------------------------------
0100                       copy  "tibasic.asm"         ; Run TI Basic session
     **** ****     > tibasic.asm
...
0020               ********|*****|*********************|**************************
0021               tibasic:
0022 6FF2 0649  14         dect  stack
0023 6FF4 C64B  30         mov   r11,*stack            ; Save return address
0024 6FF6 0649  14         dect  stack
0025 6FF8 C644  30         mov   tmp0,*stack           ; Push tmp0
0026 6FFA 0649  14         dect  stack
0027 6FFC C645  30         mov   tmp1,*stack           ; Push tmp1
0028 6FFE 0649  14         dect  stack
0029 7000 C64C  30         mov   r12,*stack            ; Push r12
0030                       ;-------------------------------------------------------
0031                       ; Setup SAMS memory
0032                       ;-------------------------------------------------------
0033 7002 06A0  32         bl    @sams.layout.copy     ; Backup Stevie SAMS page layout
     7004 2652     
0034 7006 A200                   data tv.sams.2000     ; \ @i = target address of 8 words table
0035                                                   ; /      that contains SAMS layout
0036               
0037 7008 06A0  32         bl    @scroff               ; Turn off screen
     700A 269A     
0038               
0039 700C 06A0  32         bl    @mem.sams.set.external
     700E 6FAA     
0040                                                   ; Load SAMS page layout (from cart space)
0041               
0042 7010 06A0  32         bl    @cpyv2m
     7012 24CC     
0043 7014 0000                   data >0000,>b000,16384
     7016 B000     
     7018 4000     
0044                                                   ; Copy Stevie 16K VDP memory to RAM buffer
0045                                                   ; buffer >b000->efff
0046               
0047 701A 06A0  32         bl    @mem.sams.set.standard
     701C 6FCE     
0048                                                   ; Load SAMS page layout (from cart space)
0049               
0050                       ;-------------------------------------------------------
0051                       ; Put VDP in TI Basic compatible mode (32x24)
0052                       ;-------------------------------------------------------
0053 701E 06A0  32         bl    @f18rst               ; Reset and lock the F18A
     7020 27BA     
0054               
0055 7022 06A0  32         bl    @vidtab               ; Load video mode table into VDP
     7024 230C     
0056 7026 364E                   data tibasic.32x24    ; Equate selected video mode table
0057               
0058                     ;  bl    @f18unl               ; Unlock the F18a
0059               
0060                     ;  bl    @putvr                ; Turn on 30 rows mode.
0061                     ;        data >3140            ; F18a VR49 (>31).
0062                       ;-------------------------------------------------------
0063                       ; Resume existing TI Basic session?
0064                       ;-------------------------------------------------------
0065 7028 C820  54         mov   @tibasic.status,@tibasic.status
     702A A02C     
     702C A02C     
0066                                                   ; New TI-Basic session?
0067 702E 152E  14         jgt   tibasic.resume        ; No, resume existing session
0068                       ;-------------------------------------------------------
0069                       ; New TI Basic session
0070                       ;-------------------------------------------------------
0071               tibasic.init:
0072 7030 06A0  32         bl    @cpym2m
     7032 24EE     
0073 7034 7E00                   data cpu.scrpad.src,cpu.scrpad.tgt,256
     7036 F960     
     7038 0100     
0074                                                   ; Initialize TI Basic scrpad memory in
0075                                                   ; @cpu.scrpad.tgt (SAMS bank #08) with dump
0076                                                   ; of OS Monitor scrpad stored at
0077                                                   ; @cpu.scrpad.src (bank 3).
0078               
0079 703A 06A0  32         bl    @ldfnt
     703C 2374     
0080 703E 0900                   data >0900,fnopt3     ; Load font (upper & lower case)
     7040 000C     
0081               
0082 7042 06A0  32         bl    @filv
     7044 22A2     
0083 7046 0300                   data >0300,>D0,2      ; No sprites
     7048 00D0     
     704A 0002     
0084               
0085 704C 06A0  32         bl    @cpu.scrpad.pgout     ; \ Copy 256 bytes stevie scratchpad to
     704E 2C60     
0086 7050 AD00                   data scrpad.copy      ; | >ad00 and then load TI Basic scrpad from
0087                                                   ; / predefined address @cpu.scrpad.target
0088               
0089 7052 04CB  14         clr   r11
0090 7054 C820  54         mov   @tibasic.scrpad.83d4,@>83d4
     7056 70A0     
     7058 83D4     
0091 705A C820  54         mov   @tibasic.scrpad.83fa,@>83fa
     705C 70A2     
     705E 83FA     
0092 7060 C820  54         mov   @tibasic.scrpad.83fc,@>83fc
     7062 70A4     
     7064 83FC     
0093 7066 C820  54         mov   @tibasic.scrpad.83fe,@>83fe
     7068 70A6     
     706A 83FE     
0094                       ;-------------------------------------------------------
0095                       ; Register ISR hook
0096                       ;-------------------------------------------------------
0097 706C 0201  20         li    r1,isr                ; \
     706E 7154     
0098 7070 C801  38         mov   r1,@>83c4             ; | >83c4 = Pointer to start address of ISR
     7072 83C4     
0099                                                   ; /
0100                       ;-------------------------------------------------------
0101                       ; Run TI Basic session in GPL Interpreter
0102                       ;-------------------------------------------------------
0103 7074 02E0  18         lwpi  >83e0
     7076 83E0     
0104 7078 0201  20         li    r1,>216f              ; Entrypoint for GPL TI Basic interpreter
     707A 216F     
0105 707C D801  38         movb  r1,@grmwa             ; \
     707E 9C02     
0106 7080 06C1  14         swpb  r1                    ; | Set GPL address
0107 7082 D801  38         movb  r1,@grmwa             ; /
     7084 9C02     
0108 7086 1000  14         nop
0109 7088 0460  28         b     @>70                  ; Start GPL interpreter
     708A 0070     
0110                       ;-------------------------------------------------------
0111                       ; Resume existing TI-Basic session
0112                       ;-------------------------------------------------------
0113               tibasic.resume:
0114 708C 06A0  32         bl    @cpym2v
     708E 249A     
0115 7090 0000                   data >0000,>b000,16384
     7092 B000     
     7094 4000     
0116                                                   ; Restore TI Basic 16K VDP memory from
0117                                                   ; RAM buffer >b000->efff (SAMS pages #04-07)
0118               
0119 7096 06A0  32         bl    @cpu.scrpad.pgout     ; \ Copy 256 bytes stevie scratchpad to
     7098 2C60     
0120 709A AD00                   data scrpad.copy      ; | >ad00 and then load TI Basic scrpad from
0121                                                   ; / predefined address @cpu.scrpad.target
0122               
0123 709C 0460  28         b     @>0ab8                ; Return from interrupt routine.
     709E 0AB8     
0124                                                   ; See TI Intern page 32 (german)
0125                       ;-------------------------------------------------------
0126                       ; Required values for scratchpad
0127                       ;-------------------------------------------------------
0128               tibasic.scrpad.83d4:
0129 70A0 E0D5             data  >e0d5
0130               tibasic.scrpad.83fa:
0131 70A2 9800             data  >9800
0132               tibasic.scrpad.83fc:
0133 70A4 0108             data  >0108
0134               tibasic.scrpad.83fe:
0135 70A6 8C02             data  >8c02
0136               
0137               
0138               ***************************************************************
0139               * tibasic.return
0140               * Return from TI Basic to Stevie
0141               ***************************************************************
0142               * bl   @tibasic.return
0143               *--------------------------------------------------------------
0144               * OUTPUT
0145               * none
0146               *--------------------------------------------------------------
0147               * Register usage
0148               * r1 in GPL WS, tmp0, tmp1
0149               *--------------------------------------------------------------
0150               * REMARKS
0151               * Called from ISR code
0152               ********|*****|*********************|**************************
0153               tibasic.return:
0154 70A8 02E0  18         lwpi  >ad00                 ; Activate Stevie workspace in core RAM 2
     70AA AD00     
0155               
0156               
0157 70AC D820  54         movb  @w$ffff,@>8375        ; Reset keycode
     70AE 2022     
     70B0 8375     
0158               
0159 70B2 06A0  32         bl    @cpym2m
     70B4 24EE     
0160 70B6 8300                   data >8300,cpu.scrpad.tgt,256
     70B8 F960     
     70BA 0100     
0161                                                   ; Backup TI Basic scratchpad to
0162                                                   ; @cpu.scrpad.tgt (SAMS bank #08)
0163               
0164 70BC 06A0  32         bl    @cpu.scrpad.pgin      ; Page in copy of Stevie scratch pad memory
     70BE 2C9E     
0165 70C0 AD00                   data scrpad.copy      ; and activate workspace at >8300
0166               
0167 70C2 06A0  32         bl    @mute                 ; Mute sound generators
     70C4 280E     
0168                       ;-------------------------------------------------------
0169                       ; Cleanup after return from TI Basic
0170                       ;-------------------------------------------------------
0171 70C6 06A0  32         bl    @scroff               ; Turn screen off
     70C8 269A     
0172 70CA 06A0  32         bl    @cpyv2m
     70CC 24CC     
0173 70CE 0000                   data >0000,>b000,16384
     70D0 B000     
     70D2 4000     
0174                                                   ; Dump TI Basic 16K VDP memory to ram buffer
0175                                                   ; >b000->efff
0176               
0177 70D4 C160  34         mov   @tibasic.status,tmp1  ; \
     70D6 A02C     
0178 70D8 0265  22         ori   tmp1,1                ; | Set TI Basic reentry flag
     70DA 0001     
0179 70DC C805  38         mov   tmp1,@tibasic.status  ; /
     70DE A02C     
0180               
0181               
0182 70E0 06A0  32         bl    @mem.sams.set.external
     70E2 6FAA     
0183                                                   ; Load SAMS page layout (from cart space)
0184               
0185                       ;-------------------------------------------------------
0186                       ; Restore SAMS memory layout for editor buffer and index
0187                       ;-------------------------------------------------------
0188 70E4 C120  34         mov   @tv.sams.b000,tmp0
     70E6 A206     
0189 70E8 0205  20         li    tmp1,>b000
     70EA B000     
0190 70EC 06A0  32         bl    @xsams.page.set       ; Set sams page for address >b000
     70EE 258A     
0191               
0192 70F0 C120  34         mov   @tv.sams.c000,tmp0
     70F2 A208     
0193 70F4 0205  20         li    tmp1,>c000
     70F6 C000     
0194 70F8 06A0  32         bl    @xsams.page.set       ; Set sams page for address >c000
     70FA 258A     
0195               
0196 70FC C120  34         mov   @tv.sams.d000,tmp0
     70FE A20A     
0197 7100 0205  20         li    tmp1,>d000
     7102 D000     
0198 7104 06A0  32         bl    @xsams.page.set       ; Set sams page for address >d000
     7106 258A     
0199               
0200 7108 C120  34         mov   @tv.sams.e000,tmp0
     710A A20C     
0201 710C 0205  20         li    tmp1,>e000
     710E E000     
0202 7110 06A0  32         bl    @xsams.page.set       ; Set sams page for address >e000
     7112 258A     
0203               
0204 7114 C120  34         mov   @tv.sams.f000,tmp0
     7116 A20E     
0205 7118 0205  20         li    tmp1,>f000
     711A F000     
0206 711C 06A0  32         bl    @xsams.page.set       ; Set sams page for address >f000
     711E 258A     
0207                       ;-------------------------------------------------------
0208                       ; Setup F18a 80x30 mode again
0209                       ;-------------------------------------------------------
0210 7120 06A0  32         bl    @f18unl               ; Unlock the F18a
     7122 273E     
0212               
0213 7124 06A0  32         bl    @putvr                ; Turn on 30 rows mode.
     7126 2346     
0214 7128 3140                   data >3140            ; F18a VR49 (>31), bit 40
0215               
0217               
0218 712A 06A0  32         bl    @vidtab               ; Load video mode table into VDP
     712C 230C     
0219 712E 3644                   data stevie.80x30     ; Equate selected video mode table
0220               
0221 7130 06A0  32         bl    @putvr                ; Turn on position based attributes
     7132 2346     
0222 7134 3202                   data >3202            ; F18a VR50 (>32), bit 2
0223               
0224 7136 06A0  32         bl    @putvr                ; Set VDP TAT base address for position
     7138 2346     
0225 713A 0360                   data >0360            ; based attributes (>40 * >60 = >1800)
0226               
0227 713C 04E0  34         clr   @parm1                ; Screen off while reloading color scheme
     713E A000     
0228 7140 04E0  34         clr   @parm2                ; Don't skip colorizing marked lines
     7142 A002     
0229 7144 04E0  34         clr   @parm3                ; Colorize all panes
     7146 A004     
0230               
0231 7148 06A0  32         bl    @pane.action.colorscheme.load
     714A 6F86     
0232                                                   ; Reload color scheme
0233                                                   ; \ i  @parm1 = Skip screen off if >FFFF
0234                                                   ; | i  @parm2 = Skip colorizing marked lines
0235                                                   ; |             if >FFFF
0236                                                   ; | i  @parm3 = Only colorize CMDB pane
0237                                                   ; /             if >FFFF
0238                       ;------------------------------------------------------
0239                       ; Exit
0240                       ;------------------------------------------------------
0241               tibasic.return.exit:
0242 714C C179  30         mov   *stack+,tmp1          ; Pop tmp1
0243 714E C139  30         mov   *stack+,tmp0          ; Pop tmp0
0244 7150 C2F9  30         mov   *stack+,r11           ; Pop r11
0245 7152 045B  20         b     *r11                  ; Return
0246               
0247               
0248               
0249               ***************************************************************
0250               * isr
0251               * Interrupt Service Routine in TI Basic
0252               ***************************************************************
0253               * Called from console rom at >0ab6
0254               * See TI Intern page 32 (german) for details
0255               *--------------------------------------------------------------
0256               * OUTPUT
0257               * none
0258               *--------------------------------------------------------------
...
0261               ********|*****|*********************|**************************
0262               isr:
0263 7154 0300  24         limi  0                     ; \ Turn off interrupts
     7156 0000     
0264                                                   ; / Prevent ISR reentry
0265               
0266 7158 C807  38         mov   r7,@rambuf            ; Backup R7
     715A A100     
0267 715C C80C  38         mov   r12,@rambuf+2         ; Backup R12
     715E A102     
0268                       ;-------------------------------------------------------
0269                       ; Hotkey pressed?
0270                       ;-------------------------------------------------------
0271 7160 C1E0  34         mov   @>8374,r7             ; Get keyboard scancode
     7162 8374     
0272 7164 0247  22         andi  r7,>00ff              ; LSB only
     7166 00FF     
0273 7168 0287  22         ci    r7,>0f                ; Hotkey fctn + '9' pressed?
     716A 000F     
0274 716C 139D  14         jeq   tibasic.return        ; Yes, return to Stevie
0275                       ;-------------------------------------------------------
0276                       ; Return from ISR
0277                       ;-------------------------------------------------------
0278               isr.exit:
0279 716E C320  34         mov   @rambuf+2,r12         ; Restore R12
     7170 A102     
0280 7172 C1E0  34         mov   @rambuf,r7            ; Restore R7
     7174 A100     
0281 7176 045B  20         b     *r11                  ; Return from ISR
                   < stevie_b3.asm.139486
0101                       ;-----------------------------------------------------------------------
0102                       ; Program data
0103                       ;-----------------------------------------------------------------------
...
0007               ***************************************************************
0008               
0009 7178 2053     txt.stevie         text ' Stevie 1.2L '
     717A 7465     
     717C 7669     
     717E 6520     
     7180 312E     
...
0012 7186 1E               byte  30
0013 7187   46             text  'F9-Back  F3-Clear  F5-Fastmode'
     7188 392D     
     718A 4261     
     718C 636B     
     718E 2020     
...
0017 71A6 1F               byte  31
0018 71A7   46             text  'F9-Back  F3-Clear  *F5-Fastmode'
     71A8 392D     
     71AA 4261     
     71AC 636B     
     71AE 2020     
...
0024               ;--------------------------------------------------------------
0025 71C6 0E01     txt.head.load      byte 14,1,1
     71C8 01       
0026 71C9   20                        text ' Open file '
     71CA 4F70     
     71CC 656E     
     71CE 2066     
     71D0 696C     
...
0027 71D4 01                          byte 1
0028               txt.hint.load
0029 71D5   1E             byte  30
0030 71D6 4769             text  'Give filename of file to open.'
     71D8 7665     
     71DA 2066     
     71DC 696C     
     71DE 656E     
...
0032               
0033               
0034      7186     txt.keys.load      equ txt.keys.default1
0035      71A6     txt.keys.load2     equ txt.keys.default2
0036               
0037               ;--------------------------------------------------------------
0038               ; Dialog "Save file"
0039               ;--------------------------------------------------------------
0040 71F4 0E01     txt.head.save      byte 14,1,1
     71F6 01       
0041 71F7   20                        text ' Save file '
     71F8 5361     
     71FA 7665     
     71FC 2066     
     71FE 696C     
     7200 6520     
0042 7202 01                          byte 1
0043 7203   16     txt.head.save2     byte 22,1,1
     7204 0101     
0044 7206 2053                        text ' Save block to file '
     7208 6176     
     720A 6520     
     720C 626C     
     720E 6F63     
...
0045 721A 01                          byte 1
0046               txt.hint.save
0047 721B   1E             byte  30
0048 721C 4769             text  'Give filename of file to save.'
     721E 7665     
     7220 2066     
     7222 696C     
     7224 656E     
...
0050               
0051               txt.keys.save
0052 723A 11               byte  17
0053 723B   46             text  'F9-Back  F3-Clear'
     723C 392D     
     723E 4261     
     7240 636B     
     7242 2020     
...
0060               ;--------------------------------------------------------------
0061 724C 1001     txt.head.append    byte 16,1,1
     724E 01       
0062 724F   20                        text ' Append file '
     7250 4170     
     7252 7065     
     7254 6E64     
     7256 2066     
...
0065 725D   3F             byte  63
0066 725E 4769             text  'Give filename of file to append at the end of the current file.'
     7260 7665     
     7262 2066     
     7264 696C     
     7266 656E     
...
0068               
0069               
0070      7186     txt.keys.append    equ txt.keys.default1
0071      71A6     txt.keys.append2   equ txt.keys.default2
0072               
0073               
0074               ;--------------------------------------------------------------
0075               ; Dialog "Insert file"
0076               ;--------------------------------------------------------------
0077 729E 1801     txt.head.insert    byte 24,1,1
     72A0 01       
0078 72A1   20                        text ' Insert file at line '
     72A2 496E     
     72A4 7365     
     72A6 7274     
     72A8 2066     
...
0081 72B7   20             byte  32
0082 72B8 4769             text  'Give filename of file to insert.'
     72BA 7665     
     72BC 2066     
     72BE 696C     
     72C0 656E     
...
0084               
0085               
0086      7186     txt.keys.insert    equ txt.keys.default1
0087      71A6     txt.keys.insert2   equ txt.keys.default2
0088               
0089               
0090               ;--------------------------------------------------------------
0091               ; Dialog "Configure clipboard device"
0092               ;--------------------------------------------------------------
0093 72D8 1F01     txt.head.clipdev   byte 31,1,1
     72DA 01       
0094 72DB   20                        text ' Configure clipboard device '
     72DC 436F     
     72DE 6E66     
     72E0 6967     
     72E2 7572     
...
0097 72F8 2D               byte  45
0098 72F9   47             text  'Give device and filename prefix of clipboard.'
     72FA 6976     
     72FC 6520     
     72FE 6465     
     7300 7669     
...
0102 7326 42               byte  66
0103 7327   46             text  'F9-Back  F3-Clear  ^A=DSK1.CLIP  ^B=DSK8.CLIP  ^C=TIPI.STEVIE.CLIP'
     7328 392D     
     732A 4261     
     732C 636B     
     732E 2020     
...
0110               ;--------------------------------------------------------------
0111 736A 1B01     txt.head.clipboard byte 27,1,1
     736C 01       
0112 736D   20                        text ' Copy clipboard to line '
     736E 436F     
     7370 7079     
     7372 2063     
     7374 6C69     
...
0115 7386 10               byte  16
0116 7387   43             text  'Clipboard [1-5]?'
     7388 6C69     
     738A 7062     
     738C 6F61     
     738E 7264     
...
0120 7398 47               byte  71
0121 7399   50             text  'Press 1 to 5 to copy clipboard, press F7 to configure clipboard device.'
     739A 7265     
     739C 7373     
     739E 2031     
     73A0 2074     
...
0126 73E0 22               byte  34
0127 73E1   46             text  'F9-Back  F5-Fastmode  F7-Configure'
     73E2 392D     
     73E4 4261     
     73E6 636B     
     73E8 2020     
...
0131 7404 23               byte  35
0132 7405   46             text  'F9-Back  *F5-Fastmode  F7-Configure'
     7406 392D     
     7408 4261     
     740A 636B     
     740C 2020     
...
0139               ;--------------------------------------------------------------
0140 7428 0F01     txt.head.print     byte 15,1,1
     742A 01       
0141 742B   20                        text ' Print file '
     742C 5072     
     742E 696E     
     7430 7420     
     7432 6669     
     ...
     7436 20       
0142 7437   01                        byte 1
0143 7438 1001     txt.head.print2    byte 16,1,1
     743A 01       
0144 743B   20                        text ' Print block '
     743C 5072     
     743E 696E     
     7440 7420     
     7442 626C     
...
0145 7448 01                          byte 1
0146               txt.hint.print
0147 7449   2B             byte  43
0148 744A 4769             text  'Give printer device name (PIO, PI.PIO, ...)'
     744C 7665     
     744E 2070     
     7450 7269     
     7452 6E74     
...
0150               
0151               txt.keys.print
0152 7476 11               byte  17
0153 7477   46             text  'F9-Back  F3-Clear'
     7478 392D     
     747A 4261     
     747C 636B     
     747E 2020     
...
0159               ;--------------------------------------------------------------
0160 7488 1401     txt.head.unsaved   byte 20,1,1
     748A 01       
0161 748B   20                        text ' Unsaved changes '
     748C 556E     
     748E 7361     
     7490 7665     
     7492 6420     
...
0164 749D   21             byte  33
0165 749E 5761             text  'Warning! Unsaved changes in file.'
     74A0 726E     
     74A2 696E     
     74A4 6721     
     74A6 2055     
...
0169 74C0 37               byte  55
0170 74C1   50             text  'Press F6 or SPACE to proceed. Press ENTER to save file.'
     74C2 7265     
     74C4 7373     
     74C6 2046     
     74C8 3620     
...
0174 74F8 25               byte  37
0175 74F9   46             text  'F9-Back  F6/SPACE-Proceed  ENTER-Save'
     74FA 392D     
     74FC 4261     
     74FE 636B     
     7500 2020     
...
0180               ; Dialog "Help"
0181               ;--------------------------------------------------------------
0182 751E 0901     txt.head.about     byte 9,1,1
     7520 01       
0183 7521   20                        text ' Help '
     7522 4865     
     7524 6C70     
     7526 20       
0184 7527   01                        byte 1
...
0190               
0191               txt.hint.about
0192 752A 26               byte  38
0193 752B   50             text  'Press F9 or ENTER to return to editor.'
     752C 7265     
     752E 7373     
     7530 2046     
     7532 3920     
...
0195               
0196               txt.keys.about
0197 7552 13               byte  19
0198 7553   46             text  'F9-Back  ENTER-Back'
     7554 392D     
     7556 4261     
     7558 636B     
     755A 2020     
...
0202 7566 4C               byte  76
0203 7567   42             text  'Build: 211225-2033180 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
     7568 7569     
     756A 6C64     
     756C 3A20     
     756E 3231     
...
0210               ;--------------------------------------------------------------
0211 75B4 0E01     txt.head.menu      byte 14,1,1
     75B6 01       
0212 75B7   20                        text ' Main Menu '
     75B8 4D61     
     75BA 696E     
     75BC 204D     
     75BE 656E     
...
0214               
0215               txt.info.menu
0216 75C3   1E             byte  30
0217 75C4 4669             text  'File   Cartridge   Help   Quit'
     75C6 6C65     
     75C8 2020     
     75CA 2043     
     75CC 6172     
...
0218                       even
0219               
0220 75E2 0007     pos.info.menu      byte 0,7,19,26,>ff
     75E4 131A     
     75E6 FF       
0221               txt.hint.menu
0222 75E7   01             byte  1
...
0234               ; Dialog "File"
0235               ;--------------------------------------------------------------
0236 75F2 0901     txt.head.file      byte 9,1,1
     75F4 01       
0237 75F5   20                        text ' File '
     75F6 4669     
     75F8 6C65     
     75FA 20       
0238 75FB   01                        byte 1
0239               
0240               txt.info.file
0241 75FC 25               byte  37
0242 75FD   4E             text  'New   Open   Save   Print   Configure'
     75FE 6577     
     7600 2020     
     7602 204F     
     7604 7065     
...
0243                       even
0244               
0245 7622 0006     pos.info.file      byte 0,6,13,20,28,>ff
     7624 0D14     
     7626 1CFF     
0246               txt.hint.file
0247 7628 01               byte  1
...
0260               ;--------------------------------------------------------------
0261 7632 0E01     txt.head.cartridge byte 14,1,1
     7634 01       
0262 7635   20                        text ' Cartridge '
     7636 4361     
     7638 7274     
     763A 7269     
     763C 6467     
...
0266 7641   16             byte  22
0267 7642 4261             text  'Basic   Extended Basic'
     7644 7369     
     7646 6320     
     7648 2020     
     764A 4578     
...
0268                       even
0269               
0270 7658 0008     pos.info.cartridge byte 0,8,>ff
     765A FF       
0271               txt.hint.cartridge
0272 765B   18             byte  24
0273 765C 5365             text  'Select cartridge to run.'
     765E 6C65     
     7660 6374     
     7662 2063     
     7664 6172     
...
0284               ; Dialog "Basic"
0285               ;--------------------------------------------------------------
0286 767C 0E01     txt.head.basic     byte 14,1,1
     767E 01       
0287 767F   20                        text ' Run Basic '
     7680 5275     
     7682 6E20     
     7684 4261     
     7686 7369     
...
0289               
0290               txt.info.basic
0291 768B   10             byte  16
0292 768C 5365             text  'Session: 1 2 3 4'
     768E 7373     
     7690 696F     
     7692 6E3A     
     7694 2031     
...
0293                       even
0294               
0295 769C 09FF     pos.info.basic     byte 9,>ff
0296               txt.hint.basic
0297 769E 3A               byte  58
0298 769F   50             text  'Pick a session. Press F9 in Basic for returning to Stevie.'
     76A0 6963     
     76A2 6B20     
     76A4 6120     
     76A6 7365     
...
0315               ;--------------------------------------------------------------
0316 76EA 0E01     txt.head.config    byte 14,1,1
     76EC 01       
0317 76ED   20                        text ' Configure '
     76EE 436F     
     76F0 6E66     
     76F2 6967     
     76F4 7572     
...
0323                       even
0324               
0325 7704 00FF     pos.info.config    byte 0,>ff
...
0010                       ;-------------------------------------------------------
0011 7710 0011             data  id.dialog.clipdev,key.ctrl.a,def.clip.fname
     7712 0081     
     7714 39EA     
0012 7716 0011             data  id.dialog.clipdev,key.ctrl.b,def.clip.fname.b
     7718 0082     
     771A 39F4     
0013 771C 0011             data  id.dialog.clipdev,key.ctrl.c,def.clip.fname.C
     771E 0083     
     7720 39FE     
0014                       ;------------------------------------------------------
0015                       ; End of list
0016                       ;-------------------------------------------------------
0017 7722 FFFF             data  EOL                   ; EOL
                   < stevie_b3.asm.139486
0106                       ;-----------------------------------------------------------------------
...
0114                       ;-----------------------------------------------------------------------
0115               cpu.crash.showbank:
0116                       aorg >7fb0
0117 7FB0 06A0  32         bl    @putat
     7FB2 2456     
0118 7FB4 0314                   byte 3,20
0119 7FB6 7FBA                   data cpu.crash.showbank.bankstr
0120 7FB8 10FF  14         jmp   $
0121               cpu.crash.showbank.bankstr:
0122               
0123 7FBA 0D               byte  13
0124 7FBB   52             text  'ROM#3'
     7FBC 4F4D     
     7FBE 2333     
0125                       even
0126               
0127                       ;-----------------------------------------------------------------------
0128                       ; Scratchpad memory dump
0129                       ;-----------------------------------------------------------------------
0130                       aorg >7e00
0131                       copy  "data.scrpad.asm"     ; Required for TI Basic
     **** ****     > data.scrpad.asm
...
0134                       ;-----------------------------------------------------------------------
0135                       aorg  >7fc0
0136                       copy  "rom.vectors.bank3.asm"
...
0021 7FDC 6FF2     vec.15  data  tibasic               ; Run TI Basic interpreter
...
0038 7FFE 6E44     vec.32  data  fm.fastmode           ; Toggle fastmode on/off in Load dialog
                   < stevie_b3.asm.139486
0137                                                   ; Vector table bank 3
0138               
0139               
0140               *--------------------------------------------------------------
0141               * Video mode configuration
0142               *--------------------------------------------------------------
0143      00F4     spfclr  equ   >f4                   ; Foreground/Background color for font.
0144      0004     spfbck  equ   >04                   ; Screen background color.
0145      3644     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
0146      000C     spfont  equ   fnopt3                ; Font to load. See LDFONT for details.
0147      0050     colrow  equ   80                    ; Columns per row
0148      0FC0     pctadr  equ   >0fc0                 ; VDP color table base
0149      1100     fntadr  equ   >1100                 ; VDP font start address (in PDT range)
0150      2180     sprsat  equ   >2180                 ; VDP sprite attribute table
0151      2800     sprpdt  equ   >2800                 ; VDP sprite pattern table
