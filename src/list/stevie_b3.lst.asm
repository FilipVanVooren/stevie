...
0008               ***************************************************************
0009               * File: stevie_b3.asm               ; Version 210523-3172407
0010               *
0011               * Bank 3 "John"
0012               *
0013               ***************************************************************
...
0024               * BANK 3
0025               ********|*****|*********************|**************************
0026      6006     bankid  equ   bank3.rom             ; Set bank identifier to current bank
0027                       aorg  >6000
...
0260 21D3 ....             text  'Build-ID  210523-3172407'
0261                       even
0262               
**** **** ****     > runlib.asm
...
0018 344B ....             text  'Build: 210523-3172407 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
0019                       even
0020               
0021               
0022               txt.delim
...
0071 6036 06A0  32         bl    @cpu.crash            ; Should never get here
     6038 2026 
0072                       ;-----------------------------------------------------------------------
0073                       ; Include files - Shared code
0074                       ;-----------------------------------------------------------------------
0075               
0076                       ;-----------------------------------------------------------------------
0077                       ; Include files - Dialogs
0078                       ;-----------------------------------------------------------------------
0079                       copy  "dialog.about.asm"    ; Dialog "About"
**** **** ****     > dialog.about.asm
...
0074 609C 343E                   data   txt.stevie     ; Show Stevie version
0075               
0076 609E 06A0  32         bl    @filv
     60A0 2292 
0077 60A2 0050                   data vdp.fb.toprow.sit,32,vdp.sit.size - 160
     60A4 0020 
     60A6 08C0 
0078                                                   ; Clear screen
0079               
...
0334               
**** **** ****     > stevie_b3.asm.3172407
0080                       copy  "dialog.load.asm"     ; Dialog "Load DV80 file"
**** **** ****     > dialog.load.asm
...
**** **** ****     > stevie_b3.asm.3172407
0081                       copy  "dialog.save.asm"     ; Dialog "Save DV80 file"
**** **** ****     > dialog.save.asm
...
**** **** ****     > stevie_b3.asm.3172407
0082                       copy  "dialog.unsaved.asm"  ; Dialog "Unsaved changes"
**** **** ****     > dialog.unsaved.asm
...
**** **** ****     > stevie_b3.asm.3172407
0083                       ;-----------------------------------------------------------------------
0084                       ; Stubs using trampoline
0085                       ;-----------------------------------------------------------------------
0086                       copy  "rom.stubs.bank3.asm" ; Stubs for functions in other banks
**** **** ****     > rom.stubs.bank3.asm
...
0014 6650 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6652 300C 
0015 6654 6002                   data bank1.rom        ; | i  p0 = bank address
...
0035 6662 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6664 300C 
0036 6666 6002                   data bank1.rom        ; | i  p0 = bank address
...
0056 6674 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6676 300C 
0057 6678 6002                   data bank1.rom        ; | i  p0 = bank address
...
0077 6686 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     6688 300C 
0078 668A 6002                   data bank1.rom        ; | i  p0 = bank address
...
0097 6698 06A0  32         bl    @rom.farjump          ; \ Trampoline jump to bank
     669A 300C 
0098 669C 6002                   data bank1.rom        ; | i  p0 = bank address
...
**** **** ****     > stevie_b3.asm.3172407
0087                       ;-----------------------------------------------------------------------
0088                       ; Bank specific vector table
0089                       ;-----------------------------------------------------------------------
0093 66A6 66A6                   data $                ; Bank 1 ROM size OK.
0095                       ;-------------------------------------------------------
0096                       ; Vector table bank 3: >7f9c - >7fff
0097                       ;-------------------------------------------------------
0098                       copy  "rom.vectors.bank3.asm"
...
0105      33A2     spvmod  equ   stevie.tx8030         ; Video mode.   See VIDTAB for details.
