...
0008               ***************************************************************
0009               * File: stevie_b3.asm               ; Version 211229-1852570
0010               *
0011               * Bank 3 "John"
...
0270 21ED   42             text  'Build-ID  211229-1852570'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0031 338E 6006                   data bankid           ; / i  p2 = Source ROM bank for return
0032               
...
0120 6C94 06A0  32         bl    @putstr
     6C96 2432     
0121 6C98 38E0                   data txt.keymarker    ; Show key marker
0122               
...
0171 6CDE 38DA                   data   txt.alpha.down
0172                       ;------------------------------------------------------
...
0054 6D5A 06A0  32         bl    @putstr
     6D5C 2432     
0055 6D5E 39B4                   data txt.cmdb.prompt
0056                       ;------------------------------------------------------
0057                       ; Exit
0058                       ;------------------------------------------------------
...
0203 73E1   42             text  'Build: 211229-1852570 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
     73E2 7569     
     73E4 6C64     
     73E6 3A20     
     73E8 3231     
...
0136      3626     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
