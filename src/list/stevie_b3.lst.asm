...
0008               ***************************************************************
0009               * File: stevie_b3.asm               ; Version 211217-1822330
0010               *
0011               * Bank 3 "John"
...
0270 21ED   42             text  'Build-ID  211217-1822330'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0120 6C52 06A0  32         bl    @putstr
     6C54 2432     
0121 6C56 3980                   data txt.keymarker    ; Show key marker
0122               
...
0171 6C9C 397A                   data   txt.alpha.down
0172                       ;------------------------------------------------------
...
0054 6D18 06A0  32         bl    @putstr
     6D1A 2432     
0055 6D1C 3A54                   data txt.cmdb.prompt
0056                       ;------------------------------------------------------
0057                       ; Exit
0058                       ;------------------------------------------------------
...
0036 6F7E 06A0  32         bl    @sams.layout
     6F80 25F6     
0037 6F82 36B2                   data mem.sams.external
...
0046 6F8E 06A0  32         bl    @sams.layout
     6F90 25F6     
0047 6F92 36D2                   data mem.sams.tibasic ; Load SAMS page layout for TI Basic
0048                       ;-------------------------------------------------------
...
0053 6F98 06A0  32         bl    @vidtab               ; Load video mode table into VDP
     6F9A 230C     
0054 6F9C 3670                   data tibasic.32x24    ; Equate selected video mode table
0055               
...
0217 707A 06A0  32         bl    @sams.layout
     707C 25F6     
0218 707E 36B2                   data mem.sams.external
...
0259 70D0 06A0  32         bl    @vidtab               ; Load video mode table into VDP
     70D2 230C     
0260 70D4 3666                   data stevie.80x30     ; Equate selected video mode table
0261               
...
0007               ***************************************************************
0008               
0009 70FA 2053     txt.stevie         text ' Stevie 1.2K '
     70FC 7465     
     70FE 7669     
     7100 6520     
     7102 312E     
...
0203 74E9   42             text  'Build: 211217-1822330 / 2018-2021 Filip Van Vooren / retroclouds on Atariage'
     74EA 7569     
     74EC 6C64     
     74EE 3A20     
     74F0 3231     
...
0148      3666     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
