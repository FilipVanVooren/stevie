...
0008               ***************************************************************
0009               * File: stevie_b3.asm               ; Version 220107-1655530
0010               *
0011               * Bank 3 "John"
...
0270 21ED   42             text  'Build-ID  220107-1655530'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0030 33B8 6006                   data bankid           ; / i  p2 = Source ROM bank for return
0031               
...
0120 6CB8 06A0  32         bl    @putstr
     6CBA 2432     
0121 6CBC 39C4                   data txt.keymarker    ; Show key marker
0122               
...
0171 6D02 39BE                   data   txt.alpha.down
0172                       ;------------------------------------------------------
...
0054 6D7E 06A0  32         bl    @putstr
     6D80 2432     
0055 6D82 3A98                   data txt.cmdb.prompt
0056                       ;------------------------------------------------------
0057                       ; Exit
0058                       ;------------------------------------------------------
...
0203 741F   42             text  'Build: 220107-1655530 / 2018-2022 Filip Van Vooren / retroclouds on Atariage'
     7420 7569     
     7422 6C64     
     7424 3A20     
     7426 3232     
...
0137      370A     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
