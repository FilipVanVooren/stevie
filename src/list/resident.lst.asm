...
0008               ***************************************************************
0009               * File: reident.asm                 ; Version 211204-2034300
0010               *
...
0270 21ED   42             text  'Build-ID  211204-2034300'
     21EE 7569     
     21F0 6C64     
     21F2 2D49     
     21F4 4420     
...
0088               
0089               ***************************************************************
0090               * Sprite Attribute Table
0091               *--------------------------------------------------------------
0092               romsat:
0093                                                   ; YX, initial shape and color
0094 365E 0000             data  >0000,>0001           ; Cursor
     3660 0001     
0095 3662 0000             data  >0000,>0101           ; Current line indicator     <
     3664 0101     
0096 3666 0820             data  >0820,>0201           ; Current column indicator   v
     3668 0201     
0097               nosprite:
0098 366A D000             data  >d000                 ; End-of-Sprites list
0099               
0100               
0101               ***************************************************************
0102               * SAMS page layout table for Stevie (16 words)
0103               *--------------------------------------------------------------
0104               mem.sams.layout.data:
0105 366C 2000             data  >2000,>0002           ; >2000-2fff, SAMS page >02
     366E 0002     
0106 3670 3000             data  >3000,>0003           ; >3000-3fff, SAMS page >03
     3672 0003     
0107 3674 A000             data  >a000,>000a           ; >a000-afff, SAMS page >0a
     3676 000A     
0108 3678 B000             data  >b000,>0020           ; >b000-bfff, SAMS page >20
     367A 0020     
0109                                                   ;   Index can allocate
0110                                                   ;   pages >20 to >3f.
0111 367C C000             data  >c000,>0040           ; >c000-cfff, SAMS page >40
     367E 0040     
0112                                                   ;   Editor buffer can allocate
0113                                                   ;   pages >40 to >ff.
0114 3680 D000             data  >d000,>000d           ; >d000-dfff, SAMS page >0d
     3682 000D     
0115 3684 E000             data  >e000,>000e           ; >e000-efff, SAMS page >0e
     3686 000E     
0116 3688 F000             data  >f000,>000f           ; >f000-ffff, SAMS page >0f
     368A 000F     
0117               
0118               
0119               ***************************************************************
0120               * SAMS page layout table for calling external progam (16 words)
0121               *--------------------------------------------------------------
0122               mem.sams.external:
0123 368C 2000             data  >2000,>0002           ; >2000-2fff, SAMS page >02
     368E 0002     
0124 3690 3000             data  >3000,>0003           ; >3000-3fff, SAMS page >03
     3692 0003     
0125 3694 A000             data  >a000,>000a           ; >a000-afff, SAMS page >0a
     3696 000A     
0126 3698 B000             data  >b000,>0030           ; >b000-bfff, SAMS page >30
     369A 0030     
0127 369C C000             data  >c000,>0031           ; >c000-cfff, SAMS page >31
     369E 0031     
0128 36A0 D000             data  >d000,>0032           ; >d000-dfff, SAMS page >32
     36A2 0032     
0129 36A4 E000             data  >e000,>0033           ; >e000-efff, SAMS page >33
     36A6 0033     
0130 36A8 F000             data  >f000,>0034           ; >f000-ffff, SAMS page >34
     36AA 0034     
0131               
0132               
0133               ***************************************************************
0134               * SAMS page layout table for TI Basic (16 words)
0135               *--------------------------------------------------------------
0136               mem.sams.tibasic:
0137 36AC 2000             data  >2000,>0002           ; >2000-2fff, SAMS page >02
     36AE 0002     
0138 36B0 3000             data  >3000,>0003           ; >3000-3fff, SAMS page >03
     36B2 0003     
0139 36B4 A000             data  >a000,>000a           ; >a000-afff, SAMS page >0a
     36B6 000A     
0140 36B8 B000             data  >b000,>0004           ; >b000-bfff, SAMS page >04
     36BA 0004     
0141 36BC C000             data  >c000,>0005           ; >c000-cfff, SAMS page >05
     36BE 0005     
0142 36C0 D000             data  >d000,>0006           ; >d000-dfff, SAMS page >06
     36C2 0006     
0143 36C4 E000             data  >e000,>0007           ; >e000-efff, SAMS page >07
     36C6 0007     
0144 36C8 F000             data  >f000,>0008           ; >f000-ffff, SAMS page >08
     36CA 0008     
0145               
0146               
0147               
0148               ***************************************************************
0149               * Stevie color schemes table
0150               *--------------------------------------------------------------
0151               * Word 1
0152               * A  MSB  high-nibble    Foreground color text line in frame buffer
0153               * B  MSB  low-nibble     Background color text line in frame buffer
0154               * C  LSB  high-nibble    Foreground color top/bottom line
0155               * D  LSB  low-nibble     Background color top/bottom line
0156               *
0157               * Word 2
0158               * E  MSB  high-nibble    Foreground color cmdb pane
0159               * F  MSB  low-nibble     Background color cmdb pane
0160               * G  LSB  high-nibble    Cursor foreground color cmdb pane
0161               * H  LSB  low-nibble     Cursor foreground color frame buffer
0162               *
0163               * Word 3
0164               * I  MSB  high-nibble    Foreground color busy top/bottom line
0165               * J  MSB  low-nibble     Background color busy top/bottom line
0166               * K  LSB  high-nibble    Foreground color marked line in frame buffer
0167               * L  LSB  low-nibble     Background color marked line in frame buffer
0168               *
0169               * Word 4
0170               * M  MSB  high-nibble    Foreground color command buffer header line
0171               * N  MSB  low-nibble     Background color command buffer header line
0172               * O  LSB  high-nibble    Foreground color line+column indicator frame buffer
0173               * P  LSB  low-nibble     Foreground color ruler frame buffer
0174               *
0175               * Colors
0176               * 0  Transparant
0177               * 1  black
...
0191               * F  White
0192               *--------------------------------------------------------------
0193      000A     tv.colorscheme.entries   equ 10 ; Entries in table
0194               
0195               tv.colorscheme.table:
0196                       ;                             ; #
0197                       ;      ABCD  EFGH  IJKL  MNOP ; -
0198 36CC F417             data  >f417,>f171,>1b1f,>71b1 ; 1  White on blue with cyan touch
     36CE F171     
     36D0 1B1F     
     36D2 71B1     
0199 36D4 A11A             data  >a11a,>f0ff,>1f1a,>f1ff ; 2  Dark yellow on black
     36D6 F0FF     
     36D8 1F1A     
     36DA F1FF     
0200 36DC 2112             data  >2112,>f0ff,>1f12,>f1f6 ; 3  Dark green on black
     36DE F0FF     
     36E0 1F12     
     36E2 F1F6     
0201 36E4 F41F             data  >f41f,>1e11,>1a17,>1e11 ; 4  White on blue
     36E6 1E11     
     36E8 1A17     
     36EA 1E11     
0202 36EC E11E             data  >e11e,>e1ff,>1f1e,>e1ff ; 5  Grey on black
     36EE E1FF     
     36F0 1F1E     
     36F2 E1FF     
0203 36F4 1771             data  >1771,>1016,>1b71,>1711 ; 6  Black on cyan
     36F6 1016     
     36F8 1B71     
     36FA 1711     
0204 36FC 1FF1             data  >1ff1,>1011,>f1f1,>1f11 ; 7  Black on white
     36FE 1011     
     3700 F1F1     
     3702 1F11     
0205 3704 1AF1             data  >1af1,>a1ff,>1f1f,>f11f ; 8  Black on dark yellow
     3706 A1FF     
     3708 1F1F     
     370A F11F     
0206 370C 21F0             data  >21f0,>12ff,>1b12,>12ff ; 9  Dark green on black
     370E 12FF     
     3710 1B12     
     3712 12FF     
0207 3714 F5F1             data  >f5f1,>e1ff,>1b1f,>f131 ; 10 White on light blue
     3716 E1FF     
     3718 1B1F     
     371A F131     
0208                       even
0209               
0210               tv.tabs.table:
0211 371C 0007             byte  0,7,12,25               ; \   Default tab positions as used
     371E 0C19     
0212 3720 1E2D             byte  30,45,59,79             ; |   in Editor/Assembler module.
     3722 3B4F     
0213 3724 FF00             byte  >ff,0,0,0               ; |
     3726 0000     
0214 3728 0000             byte  0,0,0,0                 ; |   Up to 20 positions supported.
     372A 0000     
0215 372C 0000             byte  0,0,0,0                 ; /   >ff means end-of-list.
     372E 0000     
0216                       even
                   < ram.resident.asm
...
0056                       ;------------------------------------------------------
0058               
0062 3A62 3A62                   data $                ; Bank 0 ROM size OK.
0064                       ;-----------------------------------------------------------------------
...
0085      3640     spvmod  equ   stevie.80x30          ; Video mode.   See VIDTAB for details.
