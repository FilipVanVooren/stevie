...
* Dummy vector table with single vector for starting jackalope basic
       aorg >7f70     ; Stevie trampoline expects table to start here
       data init      ; Vector 1

* Return to Stevie 
       aorg >7ff0
       clr  @>600e    ; Switch to bank 7 and continue at PC >7ff4