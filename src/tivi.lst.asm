...
0008               ***************************************************************
0009               * File: tivi.asm                    ; Version 200224-13103
0010               *--------------------------------------------------------------
...
0045      0001     skip_cpu_rle_compress     equ  1    ; Skip C
0046               PU RLE compression
0047      0001     skip_cpu_rle_decompress   equ  1    ; Skip CPU RLE decompression
0048      0001     skip_vdp_rle_decompress   equ  1    ; Skip VDP RLE decompression
0049      0001     skip_vdp_px2yx_calc       equ  1    ; Skip pixel to YX calculation
0050      0001     skip_sound_player         equ  1    ; Skip inclusion of sound player code
0051      0001     skip_speech_detection     equ  1    ; Skip speech synthesizer detection
0052      0001     skip_speech_player        equ  1    ; Skip inclusion of speech player code
0053      0001     skip_virtual_keyboard     equ  1    ; Skip virtual keyboard scan
0054      0001     skip_random_generator     equ  1    ; Skip random functions
0055      0001     skip_cpu_crc16            equ  1    ; Skip CPU memory CRC-16 calculation
0056               *--------------------------------------------------------------
0057               * SPECTRA2 / TiVi startup options
0058               *--------------------------------------------------------------
0059      0001     debug                    equ  1     ; Turn on spectra2 debugging
0060      0001     startup_backup_scrpad    equ  1     ; Backup scratchpad @>8300:>83ff to @>2000
0061      0001     startup_keep_vdpmemory   equ  1     ; Do not clear VDP vram upon startup
0062      00F4     spfclr                   equ  >f4   ; Foreground/Background color for font.
0063      0004     spfbck                   equ  >04   ; Screen background color.
0064      6100     kickstart                equ  >6100 ; Uniform aorg address accross ROM banks
0065      A000     cpu.scrpad.tgt           equ  >a000 ; Destination for cpu.scrpad.backup/restore
0066               
0067               *--------------------------------------------------------------
0068               * Scratchpad memory                 @>8300-83ff     (256 bytes)
0069               *--------------------------------------------------------------
0070               ;               equ  >8342          ; >8342-834F **free***
0071      8350     parm1           equ  >8350          ; Function parameter 1
0072      8352     parm2           equ  >8352          ; Function parameter 2
0073      8354     parm3           equ  >8354          ; Function parameter 3
0074      8356     parm4           equ  >8356          ; Function parameter 4
0075      8358     parm5           equ  >8358          ; Function parameter 5
0076      835A     parm6           equ  >835a          ; Function parameter 6
0077      835C     parm7           equ  >835c          ; Function parameter 7
0078      835E     parm8           equ  >835e          ; Function parameter 8
0079      8360     outparm1        equ  >8360          ; Function output parameter 1
0080      8362     outparm2        equ  >8362          ; Function output parameter 2
0081      8364     outparm3        equ  >8364          ; Function output parameter 3
0082      8366     outparm4        equ  >8366          ; Function output parameter 4
0083      8368     outparm5        equ  >8368          ; Function output parameter 5
0084      836A     outparm6        equ  >836a          ; Function output parameter 6
0085      836C     outparm7        equ  >836c          ; Function output parameter 7
0086      836E     outparm8        equ  >836e          ; Function output parameter 8
0087      8370     timers          equ  >8370          ; Timer table
0088      8380     ramsat          equ  >8380          ; Sprite Attribute Table in RAM
0089      8390     rambuf          equ  >8390          ; RAM workbuffer 1
0090               *--------------------------------------------------------------
0091               * Scratchpad backup 1               @>a000-a0ff     (256 bytes)
0092               * Scratchpad backup 2               @>a100-a1ff     (256 bytes)
0093               *--------------------------------------------------------------
0094      A000     scrpad.backup1  equ  >a000          ; Backup GPL layout
0095      A100     scrpad.backup2  equ  >a100          ; Backup spectra2 layout
0096               *--------------------------------------------------------------
0097               * TiVi Editor shared structures     @>a200-a27f     (128 bytes)
0098               *--------------------------------------------------------------
0099      A200     tv.top          equ  >a200          ; Structure begin
0100      A200     tv.sams.2000    equ  tv.top + 0     ; SAMS shadow register memory >2000-2fff
0101      A202     tv.sams.3000    equ  tv.top + 2     ; SAMS shadow register memory >3000-3fff
0102      A204     tv.sams.a000    equ  tv.top + 4     ; SAMS shadow register memory >a000-afff
0103      A206     tv.sams.b000    equ  tv.top + 6     ; SAMS shadow register memory >b000-bfff
0104      A208     tv.sams.c000    equ  tv.top + 8     ; SAMS shadow register memory >c000-cfff
0105      A20A     tv.sams.d000    equ  tv.top + 10    ; SAMS shadow register memory >d000-dfff
0106      A20C     tv.sams.e000    equ  tv.top + 12    ; SAMS shadow register memory >e000-efff
0107      A20E     tv.sams.f000    equ  tv.top + 14    ; SAMS shadow register memory >f000-ffff
0108      A210     tv.act_buffer   equ  tv.top + 16    ; Active editor buffer (0-9)
0109      A212     tv.end          equ  tv.top + 18    ; End of structure
0110               *--------------------------------------------------------------
...
0124      A290     fb.curshape     equ  fb.struct + 16 ; Cursor shape & colour
...
0144      A310     edb.sams.page     equ  edb.struct + 16 ; Current SAMS page
0145      A312     edb.end           equ  edb.struct + 18 ; End of structure
0146               *--------------------------------------------------------------
0147               * File handling structures          @>a400-a4ff     (256 bytes)
0148               *--------------------------------------------------------------
0149      A400     tfh.struct      equ  >a400           ; TiVi file handling structures
0150      A400     dsrlnk.dsrlws   equ  tfh.struct      ; Address of dsrlnk workspace 32 bytes
0151      A420     dsrlnk.namsto   equ  tfh.struct + 32 ; 8-byte RAM buffer for storing device name
0152      A428     file.pab.ptr    equ  tfh.struct + 40 ; Pointer to VDP PAB, needed by level 2 FIO
0153      A42A     tfh.pabstat     equ  tfh.struct + 42 ; Copy of VDP PAB status byte
0154      A42C     tfh.ioresult    equ  tfh.struct + 44 ; DSRLNK IO-status after file operation
0155      A42E     tfh.records     equ  tfh.struct + 46 ; File records counter
0156      A430     tfh.reclen      equ  tfh.struct + 48 ; Current record length
0157      A432     tfh.kilobytes   equ  tfh.struct + 50 ; Kilobytes processed (read/written)
0158      A434     tfh.counter     equ  tfh.struct + 52 ; Counter used in TiVi file operations
0159      A436     tfh.fname.ptr   equ  tfh.struct + 54 ; Pointer to device and filename
0160      A438     tfh.sams.page   equ  tfh.struct + 56 ; Current SAMS page during file operation
0161      A43A     tfh.sams.hpage  equ  tfh.struct + 58 ; Highest SAMS page used for file operation
0162      A43C     tfh.callback1   equ  tfh.struct + 60 ; Pointer to callback function 1
0163      A43E     tfh.callback2   equ  tfh.struct + 62 ; Pointer to callback function 2
0164      A440     tfh.callback3   equ  tfh.struct + 64 ; Pointer to callback function 3
0165      A442     tfh.callback4   equ  tfh.struct + 66 ; Pointer to callback function 4
0166      A444     tfh.rleonload   equ  tfh.struct + 68 ; RLE compression needed during file load
0167      A446     tfh.membuffer   equ  tfh.struct + 70 ; 80 bytes file memory buffer
0168      A496     tfh.end         equ  tfh.struct +150 ; End of structure
0169      0960     tfh.vrecbuf     equ  >0960           ; VDP address record buffer
0170      0A60     tfh.vpab        equ  >0a60           ; VDP address PAB
0171               *--------------------------------------------------------------
0172               * Command buffer structure          @>a500-a5ff     (256 bytes)
0173               *--------------------------------------------------------------
0174      A500     cmdb.struct     equ  >a500          ; Command Buffer structure
0175      A500     cmdb.top.ptr    equ  cmdb.struct    ; Pointer to command buffer
0176      A502     cmdb.visible    equ  cmdb.struct+2  ; Command buffer visible? (>ffff = visible)
0177      A504     cmdb.scrrows    equ  cmdb.struct+4  ; Current size of cmdb pane (in rows)
0178      A506     cmdb.default    equ  cmdb.struct+6  ; Default size of cmdb pane (in rows)
0179      A508     cmdb.end        equ  cmdb.struct+8  ; End of structure
0180               *--------------------------------------------------------------
0181               * Free for future use               @>a600-a64f     (80 bytes)
0182               *--------------------------------------------------------------
0183      A600     free.mem2       equ  >a600          ; >b600-b64f    80 bytes
0184               *--------------------------------------------------------------
0185               * Frame buffer                      @>a650-afff    (2480 bytes)
0186               *--------------------------------------------------------------
0187      A650     fb.top          equ  >a650          ; Frame buffer low memory 2400 bytes (80x30)
0188      09B0     fb.size         equ  2480           ; Frame buffer size
0189               *--------------------------------------------------------------
0190               * Command buffer                    @>b000-bfff    (4096 bytes)
0191               *--------------------------------------------------------------
0192      B000     cmdb.top        equ  >b000          ; Top of command buffer
0193      1000     cmdb.size       equ  4096           ; Command buffer size
0194               *--------------------------------------------------------------
0195               * Index                             @>c000-cfff    (4096 bytes)
0196               *--------------------------------------------------------------
0197      C000     idx.top         equ  >c000          ; Top of index
0198      1000     idx.size        equ  4096           ; Index size
0199               *--------------------------------------------------------------
0200               * SAMS shadow pages index           @>d000-dfff    (4096 bytes)
0201               *--------------------------------------------------------------
0202      D000     idx.shadow.top  equ  >d000          ; Top of shadow index
0203      1000     idx.shadow.size equ  4096           ; Shadow index size
0204               *--------------------------------------------------------------
0205               * Editor buffer                     @>e000-efff    (4096 bytes)
0206               *                                   @>f000-ffff    (4096 bytes)
0207               *--------------------------------------------------------------
0208      E000     edb.top         equ  >e000          ; Editor buffer high memory
0209      2000     edb.size        equ  8192           ; Editor buffer size
0210               *--------------------------------------------------------------
0211               
0212               
0213               
0214               ***************************************************************
0215               * BANK 0 - Cartridge header and spectra2 library
0216               ********|*****|*********************|**************************
0217                       aorg  >6000
0218                       bank  0
0219                       save  >6000,>7fff           ; Save bank 0
0220                       copy  "kickstart.asm"
**** **** ****     > kickstart.asm
...
0019               
0020               *--------------------------------------------------------------
0021               * Cartridge header
0022               *--------------------------------------------------------------
0023 6000 AA01             byte  >aa,1,1,0,0,0
     6002 0100 
     6004 0000 
0024 6006 6010             data  $+10
0025 6008 0000             byte  0,0,0,0,0,0,0,0
     600A 0000 
     600C 0000 
     600E 0000 
0026 6010 0000             data  0                     ; No more items following
0027 6012 6100             data  kickstart
0028               
0030               
0031 6014 1154             byte  17
0032 6015 ....             text  'TIVI 200224-13103'
0033                       even
0034               
0042               
0043                       aorg  kickstart
0044 6100 04E0  34         clr   @>6002                ; Switch to bank 0
     6102 6002 
0045               
0046 6104 06A0  32         bl    @cpym2m
     6106 6570 
0047 6108 6000                   data >6000,>2000,8192
     610A 2000 
     610C 2000 
0048                                                   ; Copy 8K bank to low memory expansion
0049               
0050 610E 0460  28         b     @runlib
     6110 6E20 
**** **** ****     > tivi.asm.13103
0221                       copy  "/mnt/2TBHDD/bitbucket/projects/ti994a/spectra2/src/runlib.asm"
**** **** ****     > runlib.asm
0001               *******************************************************************************
...
0024               ********|*****|*********************|**************************
0025 6112 C13B  30 swbnk   mov   *r11+,tmp0
0026 6114 C17B  30         mov   *r11+,tmp1
0027 6116 04D4  26 swbnkx  clr   *tmp0                 ; Select bank in TMP0
0028 6118 C155  26         mov   *tmp1,tmp1
0029 611A 0455  20         b     *tmp1                 ; Switch to routine in TMP1
**** **** ****     > runlib.asm
0084               
...
0012 611C 0000     w$0000  data  >0000                 ; >0000 0000000000000000
0013 611E 0001     w$0001  data  >0001                 ; >0001 0000000000000001
0014 6120 0002     w$0002  data  >0002                 ; >0002 0000000000000010
0015 6122 0004     w$0004  data  >0004                 ; >0004 0000000000000100
0016 6124 0008     w$0008  data  >0008                 ; >0008 0000000000001000
0017 6126 0010     w$0010  data  >0010                 ; >0010 0000000000010000
0018 6128 0020     w$0020  data  >0020                 ; >0020 0000000000100000
0019 612A 0040     w$0040  data  >0040                 ; >0040 0000000001000000
0020 612C 0080     w$0080  data  >0080                 ; >0080 0000000010000000
0021 612E 0100     w$0100  data  >0100                 ; >0100 0000000100000000
0022 6130 0200     w$0200  data  >0200                 ; >0200 0000001000000000
0023 6132 0400     w$0400  data  >0400                 ; >0400 0000010000000000
0024 6134 0800     w$0800  data  >0800                 ; >0800 0000100000000000
0025 6136 1000     w$1000  data  >1000                 ; >1000 0001000000000000
0026 6138 2000     w$2000  data  >2000                 ; >2000 0010000000000000
0027 613A 4000     w$4000  data  >4000                 ; >4000 0100000000000000
0028 613C 8000     w$8000  data  >8000                 ; >8000 1000000000000000
0029 613E FFFF     w$ffff  data  >ffff                 ; >ffff 1111111111111111
0030 6140 D000     w$d000  data  >d000                 ; >d000
0031               *--------------------------------------------------------------
0032               * Byte values - High byte (=MSB) for byte operations
0033               *--------------------------------------------------------------
0034      611C     hb$00   equ   w$0000                ; >0000
0035      612E     hb$01   equ   w$0100                ; >0100
0036      6130     hb$02   equ   w$0200                ; >0200
0037      6132     hb$04   equ   w$0400                ; >0400
0038      6134     hb$08   equ   w$0800                ; >0800
0039      6136     hb$10   equ   w$1000                ; >1000
0040      6138     hb$20   equ   w$2000                ; >2000
0041      613A     hb$40   equ   w$4000                ; >4000
0042      613C     hb$80   equ   w$8000                ; >8000
0043      6140     hb$d0   equ   w$d000                ; >d000
0044               *--------------------------------------------------------------
0045               * Byte values - Low byte (=LSB) for byte operations
0046               *--------------------------------------------------------------
0047      611C     lb$00   equ   w$0000                ; >0000
0048      611E     lb$01   equ   w$0001                ; >0001
0049      6120     lb$02   equ   w$0002                ; >0002
0050      6122     lb$04   equ   w$0004                ; >0004
0051      6124     lb$08   equ   w$0008                ; >0008
0052      6126     lb$10   equ   w$0010                ; >0010
0053      6128     lb$20   equ   w$0020                ; >0020
0054      612A     lb$40   equ   w$0040                ; >0040
0055      612C     lb$80   equ   w$0080                ; >0080
0056               *--------------------------------------------------------------
0057               * Bit values
0058               *--------------------------------------------------------------
0059               ;                                   ;       0123456789ABCDEF
0060      611E     wbit15  equ   w$0001                ; >0001 0000000000000001
0061      6120     wbit14  equ   w$0002                ; >0002 0000000000000010
0062      6122     wbit13  equ   w$0004                ; >0004 0000000000000100
0063      6124     wbit12  equ   w$0008                ; >0008 0000000000001000
0064      6126     wbit11  equ   w$0010                ; >0010 0000000000010000
0065      6128     wbit10  equ   w$0020                ; >0020 0000000000100000
0066      612A     wbit9   equ   w$0040                ; >0040 0000000001000000
0067      612C     wbit8   equ   w$0080                ; >0080 0000000010000000
0068      612E     wbit7   equ   w$0100                ; >0100 0000000100000000
0069      6130     wbit6   equ   w$0200                ; >0200 0000001000000000
0070      6132     wbit5   equ   w$0400                ; >0400 0000010000000000
0071      6134     wbit4   equ   w$0800                ; >0800 0000100000000000
0072      6136     wbit3   equ   w$1000                ; >1000 0001000000000000
0073      6138     wbit2   equ   w$2000                ; >2000 0010000000000000
0074      613A     wbit1   equ   w$4000                ; >4000 0100000000000000
0075      613C     wbit0   equ   w$8000                ; >8000 1000000000000000
**** **** ****     > runlib.asm
...
0026               ********|*****|*********************|**************************
0027      6138     palon   equ   wbit2                 ; bit 2=1   (VDP9918 PAL version)
0028      612E     enusr   equ   wbit7                 ; bit 7=1   (Enable user hook)
0029      612A     enknl   equ   wbit9                 ; bit 9=1   (Enable kernel thread)
0030      6126     anykey  equ   wbit11                ; BIT 11 in the CONFIG register
0031               ***************************************************************
0032               
**** **** ****     > runlib.asm
...
0036               ********|*****|*********************|**************************
0037               cpu.crash:
0038 6142 022B  22         ai    r11,-4                ; Remove opcode offset
     6144 FFFC 
0039               *--------------------------------------------------------------
0040               *    Save registers to high memory
0041               *--------------------------------------------------------------
0042 6146 C800  38         mov   r0,@>ffe0
     6148 FFE0 
0043 614A C801  38         mov   r1,@>ffe2
     614C FFE2 
0044 614E C802  38         mov   r2,@>ffe4
     6150 FFE4 
0045 6152 C803  38         mov   r3,@>ffe6
     6154 FFE6 
0046 6156 C804  38         mov   r4,@>ffe8
     6158 FFE8 
0047 615A C805  38         mov   r5,@>ffea
     615C FFEA 
0048 615E C806  38         mov   r6,@>ffec
     6160 FFEC 
0049 6162 C807  38         mov   r7,@>ffee
     6164 FFEE 
0050 6166 C808  38         mov   r8,@>fff0
     6168 FFF0 
0051 616A C809  38         mov   r9,@>fff2
     616C FFF2 
0052 616E C80A  38         mov   r10,@>fff4
     6170 FFF4 
0053 6172 C80B  38         mov   r11,@>fff6
     6174 FFF6 
0054 6176 C80C  38         mov   r12,@>fff8
     6178 FFF8 
0055 617A C80D  38         mov   r13,@>fffa
     617C FFFA 
0056 617E C80E  38         mov   r14,@>fffc
     6180 FFFC 
0057 6182 C80F  38         mov   r15,@>ffff
     6184 FFFF 
0058 6186 02A0  12         stwp  r0
0059 6188 C800  38         mov   r0,@>ffdc
     618A FFDC 
0060 618C 02C0  12         stst  r0
0061 618E C800  38         mov   r0,@>ffde
     6190 FFDE 
0062               *--------------------------------------------------------------
0063               *    Reset system
0064               *--------------------------------------------------------------
0065               cpu.crash.reset:
0066 6192 02E0  18         lwpi  ws1                   ; Activate workspace 1
     6194 8300 
0067 6196 04E0  34         clr   @>8302                ; Reset exit flag (R1 in workspace WS1!)
     6198 8302 
0068 619A 0200  20         li    r0,>4a4a              ; Note that a crash occured (Flag = >4a4a)
     619C 4A4A 
0069 619E 0460  28         b     @runli1               ; Initialize system again (VDP, Memory, etc.)
     61A0 6E28 
0070               *--------------------------------------------------------------
...
0076                       ;------------------------------------------------------
0077 61A2 06A0  32         bl    @putat                ; Show crash message
     61A4 6520 
0078 61A6 0000                   data >0000,cpu.crash.msg.crashed
     61A8 627C 
0079               
0080 61AA 06A0  32         bl    @puthex               ; Put hex value on screen
     61AC 6A56 
0081 61AE 0015                   byte 0,21             ; \ i  p0 = YX position
0082 61B0 FFF6                   data >fff6            ; | i  p1 = Pointer to 16 bit word
0083 61B2 8390                   data rambuf           ; | i  p2 = Pointer to ram buffer
0084 61B4 4130                   byte 65,48            ; | i  p3 = MSB offset for ASCII digit a-f
0085                                                   ; /         LSB offset for ASCII digit 0-9
0086                       ;------------------------------------------------------
0087                       ; Show caller details
0088                       ;------------------------------------------------------
0089 61B6 06A0  32         bl    @putat                ; Show caller message
     61B8 6520 
0090 61BA 0100                   data >0100,cpu.crash.msg.caller
     61BC 6292 
0091               
0092 61BE 06A0  32         bl    @puthex               ; Put hex value on screen
     61C0 6A56 
0093 61C2 0115                   byte 1,21             ; \ i  p0 = YX position
0094 61C4 FFCE                   data >ffce            ; | i  p1 = Pointer to 16 bit word
0095 61C6 8390                   data rambuf           ; | i  p2 = Pointer to ram buffer
0096 61C8 4130                   byte 65,48            ; | i  p3 = MSB offset for ASCII digit a-f
0097                                                   ; /         LSB offset for ASCII digit 0-9
0098                       ;------------------------------------------------------
0099                       ; Display labels
0100                       ;------------------------------------------------------
0101 61CA 06A0  32         bl    @putat
     61CC 6520 
0102 61CE 0300                   byte 3,0
0103 61D0 62AC                   data cpu.crash.msg.wp
0104 61D2 06A0  32         bl    @putat
     61D4 6520 
0105 61D6 0400                   byte 4,0
0106 61D8 62B2                   data cpu.crash.msg.st
0107 61DA 06A0  32         bl    @putat
     61DC 6520 
0108 61DE 1600                   byte 22,0
0109 61E0 62B8                   data cpu.crash.msg.source
0110 61E2 06A0  32         bl    @putat
     61E4 6520 
0111 61E6 1700                   byte 23,0
0112 61E8 62D0                   data cpu.crash.msg.id
0113                       ;------------------------------------------------------
0114                       ; Show crash registers WP, ST, R0 - R15
0115                       ;------------------------------------------------------
0116 61EA 06A0  32         bl    @at                   ; Put cursor at YX
     61EC 675E 
0117 61EE 0304                   byte 3,4              ; \ i p0 = YX position
0118                                                   ; /
0119               
0120 61F0 0204  20         li    tmp0,>ffdc            ; Crash registers >ffdc - >ffff
     61F2 FFDC 
0121 61F4 04C6  14         clr   tmp2                  ; Loop counter
0122               
0123               cpu.crash.showreg:
0124 61F6 C034  30         mov   *tmp0+,r0             ; Move crash register content to r0
0125               
0126 61F8 0649  14         dect  stack
0127 61FA C644  30         mov   tmp0,*stack           ; Push tmp0
0128 61FC 0649  14         dect  stack
0129 61FE C645  30         mov   tmp1,*stack           ; Push tmp1
0130 6200 0649  14         dect  stack
0131 6202 C646  30         mov   tmp2,*stack           ; Push tmp2
0132                       ;------------------------------------------------------
0133                       ; Display crash register number
0134                       ;------------------------------------------------------
0135               cpu.crash.showreg.label:
0136 6204 C046  18         mov   tmp2,r1               ; Save register number
0137 6206 0286  22         ci    tmp2,1                ; Skip labels WP/ST?
     6208 0001 
0138 620A 121C  14         jle   cpu.crash.showreg.content
0139                                                   ; Yes, skip
0140               
0141 620C 0641  14         dect  r1                    ; Adjust because of "dummy" WP/ST registers
0142 620E 06A0  32         bl    @mknum
     6210 6A60 
0143 6212 8302                   data r1hb             ; \ i  p0 = Pointer to 16 bit unsigned word
0144 6214 8390                   data rambuf           ; | i  p1 = Pointer to ram buffer
0145 6216 3020                   byte 48,32            ; | i  p2 = MSB offset for ASCII digit a-f
0146                                                   ; /         LSB offset for ASCII digit 0-9
0147               
0148 6218 06A0  32         bl    @setx                 ; Set cursor X position
     621A 6774 
0149 621C 0000                   data 0                ; \ i  p0 =  Cursor Y position
0150                                                   ; /
0151               
0152 621E 06A0  32         bl    @putstr               ; Put length-byte prefixed string at current YX
     6220 650E 
0153 6222 8390                   data rambuf           ; \ i  p0 = Pointer to ram buffer
0154                                                   ; /
0155               
0156 6224 06A0  32         bl    @setx                 ; Set cursor X position
     6226 6774 
0157 6228 0002                   data 2                ; \ i  p0 =  Cursor Y position
0158                                                   ; /
0159               
0160 622A 0281  22         ci    r1,10
     622C 000A 
0161 622E 1102  14         jlt   !
0162 6230 0620  34         dec   @wyx                  ; x=x-1
     6232 832A 
0163               
0164 6234 06A0  32 !       bl    @putstr
     6236 650E 
0165 6238 62A8                   data cpu.crash.msg.r
0166               
0167 623A 06A0  32         bl    @mknum
     623C 6A60 
0168 623E 8302                   data r1hb             ; \ i  p0 = Pointer to 16 bit unsigned word
0169 6240 8390                   data rambuf           ; | i  p1 = Pointer to ram buffer
0170 6242 3020                   byte 48,32            ; | i  p2 = MSB offset for ASCII digit a-f
0171                                                   ; /         LSB offset for ASCII digit 0-9
0172                       ;------------------------------------------------------
0173                       ; Display crash register content
0174                       ;------------------------------------------------------
0175               cpu.crash.showreg.content:
0176 6244 06A0  32         bl    @mkhex                ; Convert hex word to string
     6246 69D2 
0177 6248 8300                   data r0hb             ; \ i  p0 = Pointer to 16 bit word
0178 624A 8390                   data rambuf           ; | i  p1 = Pointer to ram buffer
0179 624C 4130                   byte 65,48            ; | i  p2 = MSB offset for ASCII digit a-f
0180                                                   ; /         LSB offset for ASCII digit 0-9
0181               
0182 624E 06A0  32         bl    @setx                 ; Set cursor X position
     6250 6774 
0183 6252 0006                   data 6                ; \ i  p0 =  Cursor Y position
0184                                                   ; /
0185               
0186 6254 06A0  32         bl    @putstr
     6256 650E 
0187 6258 62AA                   data cpu.crash.msg.marker
0188               
0189 625A 06A0  32         bl    @setx                 ; Set cursor X position
     625C 6774 
0190 625E 0007                   data 7                ; \ i  p0 =  Cursor Y position
0191                                                   ; /
0192               
0193 6260 06A0  32         bl    @putstr               ; Put length-byte prefixed string at current YX
     6262 650E 
0194 6264 8390                   data rambuf           ; \ i  p0 = Pointer to ram buffer
0195                                                   ; /
0196               
0197 6266 C1B9  30         mov   *stack+,tmp2          ; Pop tmp2
0198 6268 C179  30         mov   *stack+,tmp1          ; Pop tmp1
0199 626A C139  30         mov   *stack+,tmp0          ; Pop tmp0
0200               
0201 626C 06A0  32         bl    @down                 ; y=y+1
     626E 6764 
0202               
0203 6270 0586  14         inc   tmp2
0204 6272 0286  22         ci    tmp2,17
     6274 0011 
0205 6276 12BF  14         jle   cpu.crash.showreg     ; Show next register
0206                       ;------------------------------------------------------
0207                       ; Kernel takes over
0208                       ;------------------------------------------------------
0209 6278 0460  28         b     @tmgr                 ; Start kernel again for polling keyboard
     627A 6D36 
0210               
0211               
0212               cpu.crash.msg.crashed
0213 627C 1553             byte  21
0214 627D ....             text  'System crashed near >'
0215                       even
0216               
0217               cpu.crash.msg.caller
0218 6292 1543             byte  21
0219 6293 ....             text  'Caller address near >'
0220                       even
0221               
0222               cpu.crash.msg.r
0223 62A8 0152             byte  1
0224 62A9 ....             text  'R'
0225                       even
0226               
0227               cpu.crash.msg.marker
0228 62AA 013E             byte  1
0229 62AB ....             text  '>'
0230                       even
0231               
0232               cpu.crash.msg.wp
0233 62AC 042A             byte  4
0234 62AD ....             text  '**WP'
0235                       even
0236               
0237               cpu.crash.msg.st
0238 62B2 042A             byte  4
0239 62B3 ....             text  '**ST'
0240                       even
0241               
0242               cpu.crash.msg.source
0243 62B8 1653             byte  22
0244 62B9 ....             text  'Source    tivi.lst.asm'
0245                       even
0246               
0247               cpu.crash.msg.id
0248 62D0 1642             byte  22
0249 62D1 ....             text  'Build-ID  200224-13103'
0250                       even
0251               
**** **** ****     > runlib.asm
...
0323 6E9C 06A0  32 runlia  bl    @filv
     6E9E 637E 
0324                       data  pctadr,spfclr,16      ; Load color table
0325               *--------------------------------------------------------------
0326               * Check if there is a F18A present
0327               *--------------------------------------------------------------
0331 6EA0 06A0  32         bl    @f18unl               ; Unlock the F18A
     6EA2 67C2 
0332 6EA4 06A0  32         bl    @f18chk               ; Check if F18A is there
     6EA6 67DC 
0333 6EA8 06A0  32         bl    @f18lck               ; Lock the F18A again
     6EAA 67D2 
0335               *--------------------------------------------------------------
...
0345               *--------------------------------------------------------------
0346 6EAC 06A0  32 runlic  bl    @vidtab               ; Load video mode table into VDP
     6EAE 63E8 
0347                       data  spvmod                ; Equate selected video mode table
0348                       li    tmp0,spfont           ; Get font option
0349 6EB0 0544  14         inv   tmp0                  ; NOFONT (>FFFF) specified ?
0350 6EB2 130A  14         jeq   runlid                ; Yes, skip it
0351 6EB4 06A0  32         bl    @ldfnt
     6EB6 6450 
0352                       data  fntadr,spfont         ; Load specified font
0353               *--------------------------------------------------------------
0354               * Did a system crash occur before runlib was called?
0355               *--------------------------------------------------------------
0356 6EB8 0280  22 runlid  ci    r0,>4a4a              ; Crash flag set?
     6EBA 4A4A 
0357 6EBC 160A  14         jne   runlie                ; No, continue
0358 6EBE 0460  28         b     @cpu.crash.main       ; Yes, back to crash handler
     6EC0 61A2 
0359               *--------------------------------------------------------------
0360               * Branch to main program
0361               *--------------------------------------------------------------
0362 6EC2 0262  22 runlie  ori   config,>0040          ; Enable kernel thread (bit 9 on)
     6EC4 0040 
0363 6EC6 0460  28         b     @main                 ; Give control to main program
     6EC8 6EDA 
**** **** ****     > tivi.asm.13103
0222               
0223 6ECA 10FF  14 main    jmp   $
0224               
0228 6ECC 6ECC                   data $   ; Bank 0 ROM size OK.
0230               
0231               
0232               
0233               ***************************************************************
0234               * BANK 1 - TiVi support modules
0235               ********|*****|*********************|**************************
0236                       aorg  >6000
0237                       bank  1
0238                       save  >6000,>7fff           ; Save bank 1
0239                       copy  "kickstart.asm"       ; Kickstart code
**** **** ****     > kickstart.asm
0001               * FILE......: kickstart.asm
0002               * Purpose...: Bankswitch routine for starting TiVi
0003               
...
0240               
0242               
0243 6112 1154             byte  17
0244 6113 ....             text  'TIVI 200224-13103'
0245                       even
0246               
0254               
0255 6124 1000  14          nop
0256               ;        xorg  >2000                 ; Relocate support modules to >2000->3fff
0257               ;        copy  "editor.asm"          ; Main editor
0258               ;        copy  "edkey.asm"           ; Actions
0259               ;        copy  "edkey.mov.asm"       ; Actions for movement keys
0260               ;        copy  "edkey.mod.asm"       ; Actions for modifier keys
0261               ;        copy  "edkey.misc.asm"      ; Actions for miscelanneous keys
0262               ;        copy  "edkey.file.asm"      ; Actions for file related keys
0263               ;        copy  "mem.asm"             ; mem      - Memory Management
0264               ;v        copy  "fb.asm"              ; fb       - Framebuffer
0265               ;        copy  "idx.asm"             ; idx      - Index management
0266               ;        copy  "edb.asm"             ; edb      - Editor Buffer
0267               ;        copy  "cmdb.asm"            ; cmdb     - Command Buffer
0268               ;        copy  "tfh.read.sams.asm"   ; tfh.sams - File handler read file (SAMS)
0269               ;        copy  "fm.load.asm"         ; fm.load  - File manager loadfile
0270               ;        copy  "tasks.asm"           ; tsk      - Tasks
0271               ;        copy  "data.asm"            ; data     - Data segment
0272               
0276 6126 6126                   data $   ; Bank 1 ROM size OK.
0278               
0279               
0280               
0281               ***************************************************************
0282               * BANK 2 - TiBi support modules
0283               ********|*****|*********************|**************************
0284                       aorg  >6000
0285                       bank  2
0286                       save  >6000,>7fff           ; Save bank 2
0287                       copy  "kickstart.asm"       ; Kickstart code
**** **** ****     > kickstart.asm
0001               * FILE......: kickstart.asm
0002               * Purpose...: Bankswitch routine for starting TiVi
0003               
...
0288               
0290               
0291 6112 1154             byte  17
0292 6113 ....             text  'TIVI 200224-13103'
0293                       even
0294               
0302               
0303                       copy  "kickstart.asm"       ; Kickstart code
**** **** ****     > kickstart.asm
0001               * FILE......: kickstart.asm
0002               * Purpose...: Bankswitch routine for starting TiVi
0003               
...
0021               * Cartridge header
0022               *--------------------------------------------------------------
0023 6124 AA01             byte  >aa,1,1,0,0,0
     6126 0100 
     6128 0000 
0024 612A 6134             data  $+10
0025 612C 0000             byte  0,0,0,0,0,0,0,0
     612E 0000 
     6130 0000 
     6132 0000 
0026 6134 0000             data  0                     ; No more items following
0027 6136 6100             data  kickstart
0028               
0030               
0031 6138 1154             byte  17
0032 6139 ....             text  'TIVI 200224-13103'
0033                       even
0034               
0042               
0043                       aorg  kickstart
...
**** **** ****     > tivi.asm.13103
0304               
0308 6112 6112                   data $   ; Bank 2 ROM size OK.
0310               
0311               
0312               ***************************************************************
0313               * BANK 3 - TiVi support modules
0314               ********|*****|*********************|**************************
0315                       aorg  >6000
0316                       bank  3
0317                       save  >6000,>7fff           ; Save bank 3
0318                       copy  "kickstart.asm"       ; Kickstart code
**** **** ****     > kickstart.asm
0001               * FILE......: kickstart.asm
0002               * Purpose...: Bankswitch routine for starting TiVi
0003               
