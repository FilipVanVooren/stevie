...
skip_cpu_rle_compress     equ  1    ; Skip C
PU RLE compression
...
cpu.scrpad.tgt           equ  >a000 ; Destination for cpu.scrpad.backup/restore
...
***************************************************************
* BANK 0 - Cartridge header and spectra2 library
********|*****|*********************|**************************
        aorg  >6000
        bank  0
